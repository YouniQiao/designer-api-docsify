...
| 类型 | 说明 |
| -- | -- |
| int32_t | {@link ARKWEB_NET_OK} 0 -成功。  {@link ARKWEB_INVALID_PARAM} 17100101 -参数无效，errorInfo为nullptr。 |
...
| 类型 | 说明 |
| -- | -- |
| int32_t | {@link ARKWEB_NET_OK} 0 -成功。  {@link ARKWEB_INVALID_PARAM} 17100101 -参数无效。 |
