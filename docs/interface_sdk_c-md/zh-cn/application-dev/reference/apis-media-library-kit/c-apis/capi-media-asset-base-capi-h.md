...
| 参数项 | 描述 |
| -- | -- |
| (MediaLibrary_ErrorCode result | 处理所请求资源的结果[MediaLibrary_ErrorCode](capi-media-asset-base-capi-h.md#medialibrary_errorcode)。 |
...
| 参数项 | 描述 |
| -- | -- |
| (MediaLibrary_ErrorCode result | 处理所请求资源的结果。 |
