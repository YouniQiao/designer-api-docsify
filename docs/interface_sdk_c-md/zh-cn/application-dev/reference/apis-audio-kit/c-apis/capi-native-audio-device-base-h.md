...
| 枚举项 | 描述 |
| -- | -- |
| AUDIO_DEVICE_USAGE_MEDIA_OUTPUT = 1 | 媒体输出设备。<br>**起始版本：** 12 |
| AUDIO_DEVICE_USAGE_MEDIA_INPUT = 2 | 媒体输入设备。<br>**起始版本：** 12 |
| AUDIO_DEVICE_USAGE_MEDIA_ALL = 3 | 所有媒体设备。<br>**起始版本：** 12 |
| AUDIO_DEVICE_USAGE_CALL_OUTPUT = 4 | 通话输出设备。<br>**起始版本：** 12 |
| AUDIO_DEVICE_USAGE_CALL_INPUT = 8 | 通话输入设备。<br>**起始版本：** 12 |
| AUDIO_DEVICE_USAGE_CALL_ALL = 12 | 所有通话设备。<br>**起始版本：** 12 |
...
| 枚举项 | 描述 |
| -- | -- |
| AUDIO_DEVICE_UNBLOCKED = 0 | 音频设备未被堵塞。<br>**起始版本：** 13 |
| AUDIO_DEVICE_BLOCKED = 1 | 音频设备被堵塞。<br>**起始版本：** 13 |
...
| 参数项 | 描述 |
| -- | -- |
| [OH_AudioDeviceDescriptor](capi-ohaudio-oh-audiodevicedescriptor.md) *audioDeviceDescriptor | 音频设备描述符。通过 {@link OH_AudioRoutingManager_GetDevices} 或者{@link OH_AudioRoutingManager_OnDeviceChangedCallback}获取。 |
...
| -- | -- |
| [OH_AudioDeviceDescriptor](capi-ohaudio-oh-audiodevicedescriptor.md) *audioDeviceDescriptor | 音频设备描述符。通过 {@link OH_AudioRoutingManager_GetDevices} 或者{@link OH_AudioRoutingManager_OnDeviceChangedCallback}获取。 |
| OH_AudioStream_EncodingType **encodingTypes | 音频设备编码类型，指向{@link OH_AudioStream_EncodingType}。<br>不要单独释放音频设备编码类型指针，而是调用{@link OH_AudioRoutingManager_ReleaseDevices}，以便在不再使用时释放所有DeviceDescriptor数组。 |
