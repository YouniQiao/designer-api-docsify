...
| OH_AudioAccessoryInputStream \*stream | [in] 新创建的输入流引用。使用此句柄通过Register...Callback注册回调。 |
| OH_AudioStreamInfo \*streamInfo | [in] 正在打开的流的音频流信息指针。此参数描述请求的流格式，配件可使用此信息配置数据通路。 |
...
| OH_AudioAccessoryInputStream \*stream | [in] 已启动的输入流引用。 |
...
| -- | -- |
| OH_AudioAccessory \*accessory | [in] 拥有该流的音频配件。 |
| OH_AudioAccessoryInputStream \*stream | [in] 已停止的输入流引用。 |
...
| -- | -- |
| OH_AudioAccessory \*accessory | [in] 拥有该流的音频配件。 |
| OH_AudioAccessoryInputStream \*stream | [in] 已释放的输入流（录音/采集流）引用。 |
...
| -- | -- |
| OH_AudioAccessory \*accessory | [in] 拥有该流的音频配件。 |
| OH_AudioAccessoryInputStream \*stream | [in] 输入流引用。 |
...
注册输入流启动事件回调函数。<b>关键约束：注册时机限制</b>此函数必须在[OH_AudioAccessory_OpenInputStreamCallback](capi-native-audio-accessory-input-stream-manager-h.md#oh_audioaccessory_openinputstreamcallback)执行期间调用。在其他任何时间调用此函数将返回{@link AUDIOCOMMON_RESULT_ERROR_ILLEGAL_STATE}。<b>要求：</b>此回调必须注册。如果未注册，音频框架将拒绝流创建并触发清理。
...
| 参数项 | 描述 |
| -- | -- |
| OH_AudioAccessoryInputStream *stream | [in] 输入流句柄指针。 |
...
| 类型 | 说明 |
| -- | -- |
| OH_AudioCommon_Result | <ul>          <li>{@link AUDIOCOMMON_RESULT_SUCCESS}：函数执行成功。</li>          <li>{@link AUDIOCOMMON_RESULT_ERROR_INVALID_PARAM}：参数为空。</li>          <li>{@link AUDIOCOMMON_RESULT_ERROR_ILLEGAL_STATE}：在              [OH_AudioAccessory_OpenInputStreamCallback](capi-native-audio-accessory-input-stream-manager-h.md#oh_audioaccessory_openinputstreamcallback)外部调用或流已释放。</li>          </ul> |
...
注册输入流停止事件回调函数。此函数必须在[OH_AudioAccessory_OpenInputStreamCallback](capi-native-audio-accessory-input-stream-manager-h.md#oh_audioaccessory_openinputstreamcallback)执行期间调用。在其他任何时间调用此函数将返回{@link AUDIOCOMMON_RESULT_ERROR_ILLEGAL_STATE}。<b>要求：</b>此回调必须注册。如果未注册，音频框架将拒绝流创建并触发清理。
...
注册输入流释放事件回调函数。此函数必须在[OH_AudioAccessory_OpenInputStreamCallback](capi-native-audio-accessory-input-stream-manager-h.md#oh_audioaccessory_openinputstreamcallback)执行期间调用。在其他任何时间调用此函数将返回{@link AUDIOCOMMON_RESULT_ERROR_ILLEGAL_STATE}。<b>要求：</b>此回调必须注册。如果未注册，音频框架将拒绝流创建并触发清理。
...
注册输入流时延查询回调函数。<b>关键约束：注册时机限制</b>此函数必须在[OH_AudioAccessory_OpenInputStreamCallback](capi-native-audio-accessory-input-stream-manager-h.md#oh_audioaccessory_openinputstreamcallback)执行期间调用。在其他任何时间调用此函数将返回{@link AUDIOCOMMON_RESULT_ERROR_ILLEGAL_STATE}。<b>要求：</b>此回调必须注册。如果未注册，音频框架将拒绝流创建并触发清理。
...
注册输入流帧位置查询回调函数。<b>关键约束：注册时机限制</b>此函数必须在[OH_AudioAccessory_OpenInputStreamCallback](capi-native-audio-accessory-input-stream-manager-h.md#oh_audioaccessory_openinputstreamcallback)执行期间调用。在其他任何时间调用此函数将返回{@link AUDIOCOMMON_RESULT_ERROR_ILLEGAL_STATE}。<b>要求：</b>此回调必须注册。如果未注册，音频框架将拒绝流创建并触发清理。
...
| 类型 | 说明 |
| -- | -- |
| OH_AudioCommon_Result | <ul>          <li>{@link AUDIOCOMMON_RESULT_SUCCESS}：函数执行成功。</li>          <li>{@link AUDIOCOMMON_RESULT_ERROR_INVALID_PARAM}：参数为空。</li>          <li>{@link AUDIOCOMMON_RESULT_ERROR_FRAME_LENGTH_MISMATCH}：              dataSize与当前流配置下20ms音频数据不对应。</li>          <li>{@link AUDIOCOMMON_RESULT_ERROR_ILLEGAL_STATE}：流未启动或必须注册的流回调未全部注册。</li>          <li>{@link AUDIOCOMMON_RESULT_ERROR_SYSTEM}：音频服务进程死亡。</li>          </ul> |
...
| 类型 | 说明 |
| -- | -- |
| OH_AudioCommon_Result | <ul>          <li>{@link AUDIOCOMMON_RESULT_SUCCESS}：函数执行成功。</li>          <li>{@link AUDIOCOMMON_RESULT_ERROR_INVALID_PARAM}：参数为空。</li>          <li>{@link AUDIOCOMMON_RESULT_ERROR_ILLEGAL_STATE}：流已释放。</li>          </ul> |
