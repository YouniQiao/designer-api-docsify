...
| 名称 | typedef关键字 | 描述 |
| -- | -- | -- |
| [OH_AudioConverter_Format](capi-audioconverter-oh-audioconverter-format.md) | OH_AudioConverter_Format | 定义音频转换器格式数据结构，用于描述基本音频格式。 |
| [OH_AudioConverterStruct](capi-audioconverter-oh-audioconverterstruct.md) | OH_AudioConverter | 声明音频格式转换器。<br> 音频格式转换器句柄用于执行音频格式转换相关功能。 |
