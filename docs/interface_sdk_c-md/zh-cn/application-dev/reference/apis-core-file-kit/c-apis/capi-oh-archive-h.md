...
| OH_ARCHIVE_COMPRESS_DEFLATE = 8 | DEFLATE压缩算法。<br>**起始版本：** 26.0.0 |
...
| 枚举项 | 描述 |
| -- | -- |
| OH_ARCHIVE_OPEN_MODE_CREATE = 0 | 创建模式。新建一个文件，如果文件已存在，则覆盖。<br>**起始版本：** 26.0.0 |
...
| 类型 | 说明 |
| -- | -- |
| OH_Archive_Reader_Ctx | 返回文件读取器的上下文结构体，操作失败时返回NULL。 |
...
| 类型 | 说明 |
| -- | -- |
| OH_Archive_Writer_Ctx | 返回文件压缩器上下文句柄，操作失败时返回NULL。 |
...
| 参数项 | 描述 |
| -- | -- |
| OH_Archive_Writer_Ctx arc | 文件压缩器的上下文句柄。 |
...
| 类型 | 说明 |
| -- | -- |
| OH_Archive_StreamWrite_Ctx | 返回流式压缩的上下文结构体。创建失败时返回NULL。 |
...
| 类型 | 说明 |
| -- | -- |
| OH_Archive_StreamRead_Ctx | 返回流式解压缩的上下文结构体。创建失败时返回NULL。 |
