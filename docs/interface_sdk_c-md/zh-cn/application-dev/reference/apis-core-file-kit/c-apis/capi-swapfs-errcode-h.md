...
| SWAPFS_E_BUSY = 36200006 | 检测到并发冲突。<br> {@link OH_Swapfs_RemoveAllData}或{@link OH_Swapfs_DestroyManager}检测到有活跃操作正在进行。请稍后重试或等待当前操作完成。<br>**起始版本：** 26.0.0 |
...
| SWAPFS_E_SHUTTING_DOWN = 36200013 | 管理器正在关闭。<br> 新的{@link OH_Swapfs_SwapOut}、{@link OH_Swapfs_SwapIn}、{@link OH_Swapfs_RemoveData}或{@link OH_Swapfs_RemoveAllData}操作将被拒绝。<br>**起始版本：** 26.0.0 |
