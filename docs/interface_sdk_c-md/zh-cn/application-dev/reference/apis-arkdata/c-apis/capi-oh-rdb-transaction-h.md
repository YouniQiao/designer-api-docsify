...
| 名称 | typedef关键字 | 描述 |
| -- | -- | -- |
| [OH_RDB_TransOptions](capi-rdb-oh-rdb-transoptions.md) | OH_RDB_TransOptions | 定义OH_RDB_TransOptions结构体类型。 |
| [OH_Rdb_Transaction](capi-rdb-oh-rdb-transaction.md) | OH_Rdb_Transaction | 定义OH_Rdb_Transaction结构体类型。 |
