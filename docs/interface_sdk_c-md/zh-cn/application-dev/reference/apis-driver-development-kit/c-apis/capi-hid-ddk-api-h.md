...
| 参数项 | 描述 |
| -- | -- |
| [Hid_DeviceHandle](capi-hidddk-hid-devicehandle.md) **dev | 设备操作句柄，须通过[OH_Hid_Open](capi-hid-ddk-api-h.md#oh_hid_open)打开并获取，接口调用成功后会释放资源并置空。 |
...
| 参数项 | 描述 |
| -- | -- |
| [Hid_DeviceHandle](capi-hidddk-hid-devicehandle.md) *dev | 设备操作句柄，使用前须通过[OH_Hid_Open](capi-hid-ddk-api-h.md#oh_hid_open)打开并获取。 |
| uint8_t *data | 待写入的数据。 |
...
| -- | -- |
| [Hid_DeviceHandle](capi-hidddk-hid-devicehandle.md) *dev | 设备操作句柄，使用前须通过[OH_Hid_Open](capi-hid-ddk-api-h.md#oh_hid_open)打开并获取。 |
| int nonBlock | 是否启用非阻塞模式读取数据。1：启用非阻塞模式，调用[OH_Hid_Read](capi-hid-ddk-api-h.md#oh_hid_read)接口时，如果设备有可读的数据，读取并返回[HID_DDK_SUCCESS](capi-hid-ddk-types-h.md#hid_ddkerrcode)，如果设备没有数据可读，则返回[HID_DDK_TIMEOUT](capi-hid-ddk-types-h.md#hid_ddkerrcode)。0：禁用非阻塞模式，启用阻塞模式。 |
