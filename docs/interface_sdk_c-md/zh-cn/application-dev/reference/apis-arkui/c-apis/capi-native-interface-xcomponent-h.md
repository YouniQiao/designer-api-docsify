...
| [void OH_ArkUI_AccessibilityProvider_Dispose(ArkUI_AccessibilityProvider* provider)](#oh_arkui_accessibilityprovider_dispose) | 销毁由Native接口[OH_ArkUI_AccessibilityProvider_Create](capi-native-interface-xcomponent-h.md#oh_arkui_accessibilityprovider_create)创建的{@link ArkUI_AccessibilityProvider}实例。 |
...
| 类型 | 说明 |
| -- | -- |
| int32_t | 返回执行的状态代码。          返回 [OH_NATIVEXCOMPONENT_RESULT_SUCCESS](capi-native-interface-xcomponent-h.md#anonymous0) - 执行成功。          返回 [OH_NATIVEXCOMPONENT_RESULT_BAD_PARAMETER](capi-native-interface-xcomponent-h.md#anonymous0) - 传入参数异常。 |
...
| 类型 | 说明 |
| -- | -- |
| int32_t | 返回执行的状态代码。          [OH_NATIVEXCOMPONENT_RESULT_SUCCESS](capi-native-interface-xcomponent-h.md#anonymous0) 获取windowX成功。          [OH_NATIVEXCOMPONENT_RESULT_BAD_PARAMETER](capi-native-interface-xcomponent-h.md#anonymous0) component是空指针、windowX是空指针或者native XComponent是空指针。 |
...
| 类型 | 说明 |
| -- | -- |
| int32_t | 返回执行的状态代码。          [OH_NATIVEXCOMPONENT_RESULT_SUCCESS](capi-native-interface-xcomponent-h.md#anonymous0) 获取windowY成功。          [OH_NATIVEXCOMPONENT_RESULT_BAD_PARAMETER](capi-native-interface-xcomponent-h.md#anonymous0) component是空指针、windowY是空指针或者native XComponent是空指针。 |
...
| 类型 | 说明 |
| -- | -- |
| int32_t | 返回执行的状态代码。          [OH_NATIVEXCOMPONENT_RESULT_SUCCESS](capi-native-interface-xcomponent-h.md#anonymous0) 获取displayX成功。          [OH_NATIVEXCOMPONENT_RESULT_BAD_PARAMETER](capi-native-interface-xcomponent-h.md#anonymous0) component是空指针、displayX是空指针或者native XComponent是空指针。 |
...
| 类型 | 说明 |
| -- | -- |
| int32_t | 返回执行的状态代码。          [OH_NATIVEXCOMPONENT_RESULT_SUCCESS](capi-native-interface-xcomponent-h.md#anonymous0) 获取displayY成功。          [OH_NATIVEXCOMPONENT_RESULT_BAD_PARAMETER](capi-native-interface-xcomponent-h.md#anonymous0) component是空指针、displayY是空指针或者native XComponent是空指针。 |
...
| 类型 | 说明 |
| -- | -- |
| int32_t | 返回执行的状态代码。          返回 {@link ARKUI_ERROR_CODE_NO_ERROR} - 执行成功。          返回 {@link ARKUI_ERROR_CODE_PARAM_INVALID} - 传入参数异常。 |
...
| 类型 | 说明 |
| -- | -- |
| int32_t | 返回执行的状态代码。          返回 [OH_NATIVEXCOMPONENT_RESULT_SUCCESS](capi-native-interface-xcomponent-h.md#anonymous0) - 成功。          返回 [OH_NATIVEXCOMPONENT_RESULT_BAD_PARAMETER](capi-native-interface-xcomponent-h.md#anonymous0) - 参数异常。 |
...
| 类型 | 说明 |
| -- | -- |
| int32_t | 返回执行的状态代码。          返回 {@link ARKUI_ERROR_CODE_NO_ERROR} - 成功。          返回 {@link ARKUI_ERROR_CODE_PARAM_INVALID} - 参数异常。 |
...
| -- | -- |
| [OH_NativeXComponent](capi-oh-nativexcomponent-native-xcomponent-oh-nativexcomponent.md)* component | 表示指向[OH_NativeXComponent](capi-oh-nativexcomponent-native-xcomponent-oh-nativexcomponent.md)实例的指针。 |
| ArkUI_AccessibilityProvider** handle | 表示指向{@link ArkUI_AccessibilityProvider}实例的指针。 |
...
| 类型 | 说明 |
| -- | -- |
| int32_t | 返回执行的状态代码。          返回 {@link ARKUI_ERROR_CODE_NO_ERROR} - 执行成功。          返回 {@link ARKUI_ERROR_CODE_PARAM_INVALID} - 传入参数异常。          返回 {@link ARKUI_ERROR_CODE_XCOMPONENT_STATE_INVALID} - XComponent持有的Surface已经被初始化。 |
...
| 类型 | 说明 |
| -- | -- |
| int32_t | 返回执行的状态代码。          返回 {@link ARKUI_ERROR_CODE_NO_ERROR} - 执行成功。          返回 {@link ARKUI_ERROR_CODE_PARAM_INVALID} - 传入参数异常。          返回 {@link ARKUI_ERROR_CODE_XCOMPONENT_STATE_INVALID} - XComponent持有的Surface已经被销毁。 |
...
| 类型 | 说明 |
| -- | -- |
| ArkUI_AccessibilityProvider* | {@link ArkUI_AccessibilityProvider}类型的指针。 |
...
销毁由Native接口[OH_ArkUI_AccessibilityProvider_Create](capi-native-interface-xcomponent-h.md#oh_arkui_accessibilityprovider_create)创建的{@link ArkUI_AccessibilityProvider}实例。
...
| 参数项 | 描述 |
| -- | -- |
| ArkUI_AccessibilityProvider* provider | 表示由Native接口[OH_ArkUI_AccessibilityProvider_Create](capi-native-interface-xcomponent-h.md#oh_arkui_accessibilityprovider_create)创建的{@link ArkUI_AccessibilityProvider}实例。 |
...
| 类型 | 说明 |
| -- | -- |
| int32_t | 返回执行结果。          返回 {@link ARKUI_ERROR_CODE_NO_ERROR} - 执行成功。          返回 {@link ARKUI_ERROR_CODE_PARAM_INVALID} - 传入参数异常。 |
