...
| 参数项 | 描述 |
| -- | -- |
| rkUI_ContextHandle uiContext | UIContext对象，用以绑定实例。 |
...
| ArkUI_RawInputEventType type | 用于启用或禁用事件透传的原始输入事件类型 [ArkUI_RawInputEventType](capi-common-attributes-h.md#arkui_rawinputeventtype)。 |
