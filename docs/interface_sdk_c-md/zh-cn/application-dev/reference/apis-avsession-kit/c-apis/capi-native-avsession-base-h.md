...
| * @since 23 | 跳转到指定播放位置命令。 |
| CAST_CONTROL_CMD_SEEK = 7 | 跳转到指定播放位置命令。<br>**起始版本：** 23 |
| * @since 23 | 设置音量命令。 |
...
| 枚举项 | 描述 |
| -- | -- |
| * @since 23 | 以正常播速的0.75倍速播放音视频。 |
| SPEED_FORWARD_0_75_X = 0 | 以正常播速的0.75倍速播放音视频。<br>**起始版本：** 23 |
| * @since 23 | 以正常播速（1.00x）播放音视频。 |
| SPEED_FORWARD_1_00_X = 1 | 以正常播速（1.00x）播放音视频。<br>**起始版本：** 23 |
| * @since 23 | 以正常播速的1.25倍速播放音视频。 |
| SPEED_FORWARD_1_25_X = 2 | 以正常播速的1.25倍速播放音视频。<br>**起始版本：** 23 |
| * @since 23 | 以正常播速的1.75倍速播放音视频。 |
| SPEED_FORWARD_1_75_X = 3 | 以正常播速的1.75倍速播放音视频。<br>**起始版本：** 23 |
| * @since 23 | 以正常播速的2倍速播放音视频。 |
| SPEED_FORWARD_2_00_X = 4 | 以正常播速的2倍速播放音视频。<br>**起始版本：** 23 |
| * @since 23 | 以正常播速的0.5倍速播放音视频。 |
| SPEED_FORWARD_0_50_X = 5 | 以正常播速的0.5倍速播放音视频。<br>**起始版本：** 23 |
| * @since 23 | 以正常播速的1.5倍速播放音视频。 |
| SPEED_FORWARD_1_50_X = 6 | 以正常播速的1.5倍速播放音视频。<br>**起始版本：** 23 |
...
| -- | -- |
| * @since 23 | 过滤状态。 |
| FILTER_STATE = 1 << 0 | 过滤状态。<br>**起始版本：** 23 |
| * @since 23 | 过滤位置。 |
| FILTER_POSITION = 1 << 1 | 过滤位置。<br>**起始版本：** 23 |
| * @since 23 | 过滤倍速。 |
| FILTER_SPEED = 1 << 2 | 过滤倍速。<br>**起始版本：** 23 |
| * @since 23 | 过滤音量。 |
| FILTER_VOLUME = 1 << 3 | 过滤音量。<br>**起始版本：** 23 |
