...
| 类型 | 说明 |
| -- | -- |
| OH_Drawing_Brush* | 函数会返回一个指针，指针指向创建的画刷对象。如果返回NULL，表示创建失败；可能的原因是可用内存不足。 |
...
| 类型 | 说明 |
| -- | -- |
| OH_Drawing_Brush* | 函数会返回一个指针，指针指向创建的画刷对象副本{@link OH_Drawing_Brush}。如果返回NULL，表示创建失败；  可能的原因是可用内存不足，或者是brush为NULL。 |
...
| 参数项 | 描述 |
| -- | -- |
| OH_Drawing_Brush* brush | 表示指向{@link OH_Drawing_Brush}对象的指针。 |
...
| 类型 | 说明 |
| -- | -- |
| OH_Drawing_ErrorCode | 函数返回执行结果。      <br>返回OH_DRAWING_SUCCESS，表示执行成功。      <br>返回OH_DRAWING_ERROR_INVALID_PARAMETER，表示参数brush为NULL。 |
...
| 类型 | 说明 |
| -- | -- |
| OH_Drawing_ErrorCode | 函数返回执行结果。      <br>返回OH_DRAWING_SUCCESS，表示执行成功。      <br>返回OH_DRAWING_ERROR_INVALID_PARAMETER，表示参数brush或a为NULL。 |
...
| 类型 | 说明 |
| -- | -- |
| OH_Drawing_ErrorCode | 函数返回执行结果。      <br>返回OH_DRAWING_SUCCESS，表示执行成功。      <br>返回OH_DRAWING_ERROR_INVALID_PARAMETER，表示参数brush或r为NULL。 |
...
| 类型 | 说明 |
| -- | -- |
| OH_Drawing_ErrorCode | 函数返回执行结果。      <br>返回OH_DRAWING_SUCCESS，表示执行成功。      <br>返回OH_DRAWING_ERROR_INVALID_PARAMETER，表示参数brush或g为NULL。 |
...
| 类型 | 说明 |
| -- | -- |
| OH_Drawing_ErrorCode | 函数返回执行结果。      <br>返回OH_DRAWING_SUCCESS，表示执行成功。      <br>返回OH_DRAWING_ERROR_INVALID_PARAMETER，表示参数brush或b为NULL。 |
...
| -- | -- |
| OH_Drawing_Brush* brush | 指向画刷对象的指针。 |
| OH_Drawing_ShaderEffect* shaderEffect | 表示指向着色器对象的指针，为NULL表示清空画刷的着色器效果。 |
...
| -- | -- |
| OH_Drawing_Brush* brush | 指向画刷对象的指针。 |
| OH_Drawing_ShadowLayer* shadowLayer | 表示指向阴影层的指针，为NULL表示清空画刷的阴影层效果。 |
...
| -- | -- |
| OH_Drawing_Brush* brush | 指向画刷对象的指针。 |
| OH_Drawing_Filter* filter | 表示指向滤波器对象的指针，为NULL表示清空画刷滤波器。 |
