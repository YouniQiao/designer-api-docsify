...
| 类型 | 说明 |
| -- | -- |
| [Camera_ErrorCode](capi-camera-h.md#camera_errorcode) | CAMERA_OK：方法调用成功。<br>     <br>CAMERA_INVALID_ARGUMENT：参数丢失或参数类型不正确。<br>     <br>CAMERA_SESSION_NOT_RUNNING：捕获会话未运行。<br>     <br>CAMERA_SERVICE_FATAL_ERROR：相机服务异常。 |
...
| 类型 | 说明 |
| -- | -- |
| [Camera_ErrorCode](capi-camera-h.md#camera_errorcode) | <ul><br>    <br><li>CAMERA_OK：方法调用成功。</li><br>    <br><li>CAMERA_INVALID_ARGUMENT：参数丢失或参数类型不正确。</li><br>    <br><li>CAMERA_OPERATION_NOT_ALLOWED：操作不允许。</li><br>    <br><li>CAMERA_SESSION_NOT_CONFIG：会话未配置。</li><br>    <br><li>CAMERA_SERVICE_FATAL_ERROR：相机服务异常。</li><br>    <br></ul> |
