...
| 类型 | 说明 |
| -- | -- |
| OsAccount_ErrCode | <ul>          <li>{@link OS_ACCOUNT_ERR_OK} 操作成功。</li>          <li>{@link OS_ACCOUNT_ERR_INTERNAL_ERROR} 内部错误。</li>          <li>{@link OS_ACCOUNT_ERR_INVALID_PARAMETER} 表示buffer为空指针或名称长度（包括结束字符'\0'）大于buffer_size。</li>          </ul> |
...
| 类型 | 说明 |
| -- | -- |
| OsAccount_ErrCode | <ul>          <li>{@link OS_ACCOUNT_ERR_OK} 操作成功。</li>          <li>{@link OS_ACCOUNT_ERR_PERMISSION_DENIED} 权限不足。</li>          <li>{@link OS_ACCOUNT_ERR_INTERNAL_ERROR} 内部错误。</li>          <li>{@link OS_ACCOUNT_ERR_INVALID_PARAMETER} name为空指针或名称长度（包括结束字符'\0'）大于name_size。</li>          <li>{@link OS_ACCOUNT_ERR_ACCOUNT_NOT_FOUND} 账号不存在。</li>          <li>{@link OS_ACCOUNT_ERR_RESTRICTED_ACCOUNT} 受限账号。</li>          </ul> |
