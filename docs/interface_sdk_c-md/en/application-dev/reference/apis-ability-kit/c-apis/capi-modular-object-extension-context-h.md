...
| Type | Description |
| -- | -- |
| [OHIPCRemoteStub*](capi-ohipcparcel-ohipcremotestub.md) | Returns the pointer to the <b>OHIPCRemoteStub</b> object created if the operation is successful;  returns NULL otherwise. |
