...
| Type | Description |
| -- | -- |
| Camera_ErrorCode | <ul><br>         <li>CAMERA_OK: The operation is successful.</li><br>         <li>CAMERA_INVALID_ARGUMENT: A parameter is missing or the parameter type is incorrect.</li><br>         </ul> |
