...
| [Asset_Value](capi-assettype-asset-value.md) | Asset_Value | Defines the value (content) of an asset attribute. |
| [Asset_Attr](capi-assettype-asset-attr.md) | Asset_Attr | Defines an asset attribute, which consists of a tag and a value in the form of a key-value (KV) pair. |
...
| [Asset_SyncType](#asset_synctype) | Asset_SyncType | Asset sync type. |
| [Asset_WrapType](#asset_wraptype) | Asset_WrapType | Encrypted import/export type supported by the asset. |
| [Asset_ConflictResolution](#asset_conflictresolution) | Asset_ConflictResolution | Policy for resolving the conflict (for example, a duplicate alias). |
| [Asset_ReturnType](#asset_returntype) | Asset_ReturnType | Type of the asset query result to return. |
...
| Name | Description |
| -- | -- |
| ASSET_TAG_TYPE_MASK (0xF << 28)#ifdef __cplusplus} | Defines the mask used to obtain the key type of an asset attribute.<br>**Since**: 11 |
