...
- Module<!--basicserviceskit-module-->
    - [Pasteboard](capi-pasteboard.md)
    - [InitSync](capi-initsync.md)
...
- Struct<!--basicserviceskit-struct-->
