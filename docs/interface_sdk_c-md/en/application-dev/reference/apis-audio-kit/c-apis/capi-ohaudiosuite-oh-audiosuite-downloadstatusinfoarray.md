...
Define download status information array structure.
...
| Name | Description |
| -- | -- |
| uint32_t size | Array size.<br>**Since**: 26.0.0 |
| [OH_AudioSuite_DownloadStatusInfo](capi-ohaudiosuite-oh-audiosuite-downloadstatusinfo.md) **downloadStatusInfo | Array of download status info pointers.<br>**Since**: 26.0.0 |
