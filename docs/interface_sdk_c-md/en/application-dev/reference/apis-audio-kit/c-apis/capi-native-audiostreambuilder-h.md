...
| Type | Description |
| -- | -- |
| OH_AudioStream_Result | Function result code:          {@link AUDIOSTREAM_SUCCESS} If the execution is successful.          {@link AUDIOSTREAM_ERROR_INVALID_PARAM} The param of builder is nullptr.          {@link AUDIOSTREAM_ERROR_ILLEGAL_STATE} Execution status exception. |
...
| Type | Description |
| -- | -- |
| OH_AudioStream_Result | Function result code:          {@link AUDIOSTREAM_SUCCESS} If the execution is successful.          {@link AUDIOSTREAM_ERROR_INVALID_PARAM}:                                                  1.The param of builder is nullptr;                                                  2.The param of rate invalid. |
...
| Type | Description |
| -- | -- |
| OH_AudioStream_Result | Function result code:          {@link AUDIOSTREAM_SUCCESS} If the execution is successful.          {@link AUDIOSTREAM_ERROR_INVALID_PARAM}:                                                  1.The param of builder is nullptr;                                                  2.The param of channelCount invalid. |
...
| Type | Description |
| -- | -- |
| OH_AudioStream_Result | Function result code:          {@link AUDIOSTREAM_SUCCESS} If the execution is successful.          {@link AUDIOSTREAM_ERROR_INVALID_PARAM} The param of builder is nullptr. |
...
| Type | Description |
| -- | -- |
| OH_AudioStream_Result | Function result code:          {@link AUDIOSTREAM_SUCCESS} If the execution is successful.          {@link AUDIOSTREAM_ERROR_INVALID_PARAM}:                                                  1.The param of builder is nullptr;                                                  2.The param of usage invalid. |
...
| Type | Description |
| -- | -- |
| OH_AudioStream_Result | Function result code:          {@link AUDIOSTREAM_SUCCESS} If the execution is successful.          {@link AUDIOSTREAM_ERROR_INVALID_PARAM}:                                                  1.The param of builder is nullptr;                                                  2.The param of sourceType invalid. |
...
| Type | Description |
| -- | -- |
| OH_AudioStream_Result | Function result code:          {@link AUDIOSTREAM_SUCCESS} If the execution is successful.          {@link AUDIOSTREAM_ERROR_INVALID_PARAM}:                                                  1.The param of builder is nullptr;                                                  2.StreamType invalid. |
...
| Type | Description |
| -- | -- |
| OH_AudioStream_Result | Function result code:          {@link AUDIOSTREAM_SUCCESS} If the execution is successful.          {@link AUDIOSTREAM_ERROR_INVALID_PARAM}:                                                  1.The param of builder is nullptr;                                                  2.StreamType invalid;                                                  3.Create OHAudioRenderer failed. |
...
| Type | Description |
| -- | -- |
| OH_AudioStream_Result | Function result code:          {@link AUDIOSTREAM_SUCCESS} If the execution is successful.          {@link AUDIOSTREAM_ERROR_INVALID_PARAM}:                                                  1.The param of builder is nullptr;                                                  2.The param of mode invalid;                                                  3.StreamType invalid. |
...
| Type | Description |
| -- | -- |
| OH_AudioStream_Result | Result code.      {@link AUDIOSTREAM_SUCCESS} Success.      {@link AUDIOSTREAM_ERROR_INVALID_PARAM} Parameter is invalid, e.g. builder is nullptr, e.t.c. |
...
| Type | Description |
| -- | -- |
| OH_AudioStream_Result | Function result code:          {@link AUDIOSTREAM_SUCCESS} If the execution is successful.          {@link AUDIOSTREAM_ERROR_INVALID_PARAM}:                                                  1.The param of builder is nullptr;                                                  2.The param of volumeMode invalid. |
...
| Type | Description |
| -- | -- |
| OH_AudioStream_Result | Result code.      {@link AUDIOSTREAM_SUCCESS} is returned if the operation is successful.      {@link AUDIOSTREAM_ERROR_INVALID_PARAM} is returned if a parameter is invalid, for example, if builder  is nullptr. |
...
| Type | Description |
| -- | -- |
| OH_AudioStream_Result | @return      {@link AUDIOSTREAM_SUCCESS} if the execution is successful.      {@link AUDIOSTREAM_ERROR_INVALID_PARAM} the param of builder or callback is nullptr. |
...
Sets if the audio capturer can capture the audio data affected by loopback effect.When the same process enables reverb effect for audio loopback in hardware mode, and thetarget audio capturer is in {@link AUDIOSTREAM_LATENCY_MODE_FAST} mode, this functionwill take effect.
...
| Type | Description |
| -- | -- |
| OH_AudioStream_Result | <ul>      <li>{@link #AUDIOSTREAM_SUCCESS} If the execution is successful.</li>      <li>{@link #AUDIOSTREAM_ERROR_INVALID_PARAM} 1.The param of builder is nullptr;                         2.The param of mode is invalid.</li>      </ul> |
...
| Parameter | Description |
| -- | -- |
| OH_AudioStreamBuilder* builder | The pointer to the {@link OH_AudioStreamBuilder} object createdby [OH_AudioStreamBuilder_Create](capi-native-audiostreambuilder-h.md#oh_audiostreambuilder_create). |
...
| Type | Description |
| -- | -- |
| OH_AudioStream_Result | <ul>          <li>{@link AUDIOSTREAM_SUCCESS} If the execution is successful.</li>          <li>{@link AUDIOSTREAM_ERROR_INVALID_PARAM} The param of builder or callback is nullptr.</li>          </ul> |
...
| Type | Description |
| -- | -- |
| OH_AudioStream_Result | <ul>          <li>{@link AUDIOSTREAM_SUCCESS} If the execution is successful.</li>          <li>{@link AUDIOSTREAM_ERROR_INVALID_PARAM} The param of builder,               cellularRecordPhoneNum or cellularRecordToken is nullptr.</li>          </ul> |
