...
Represents the position of an audio object in three-dimensional space.The position can be expressed in either Cartesian or polar coordinates.
...
| OH_PolarPosition polar; } pos | Represents position by polar coordinates.<br>**Since**: 26.0.0 |
