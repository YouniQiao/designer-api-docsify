...
| -- | -- |
| const OH_Drawing_Matrix* matrix | Pointer to the {@link OH_Drawing_Matrix} object to be copied. |
...
| const OH_Drawing_Rect* src | Pointer to the {@link OH_Drawing_Rect} object of the mapping source. |
| const OH_Drawing_Rect* dst | Pointer to the {@link OH_Drawing_Rect} object of the mapping destination. |
...
| Parameter | Description |
| -- | -- |
| OH_Drawing_Matrix* total | Pointer to the {@link OH_Drawing_Matrix} object. |
| const OH_Drawing_Matrix* a | Pointer to {@link OH_Drawing_Matrix} object a. |
| const OH_Drawing_Matrix* b | Pointer to {@link OH_Drawing_Matrix} object b. |
...
| Parameter | Description |
| -- | -- |
| OH_Drawing_Matrix* a | Pointer to the {@link OH_Drawing_Matrix} object. |
| OH_Drawing_Matrix* b | Pointer to the {@link OH_Drawing_Matrix} object. |
...
| Parameter | Description |
| -- | -- |
| OH_Drawing_Matrix* matrix | Pointer to one {@link OH_Drawing_Matrix} object. |
| OH_Drawing_Matrix* other | Pointer to the other {@link OH_Drawing_Matrix} object. |
