...
| Type | Description |
| -- | -- |
| OH_Drawing_Surface* | Returns a pointer to the created {@link OH_Drawing_Surface} object. |
...
| Type | Description |
| -- | -- |
| OH_Drawing_Canvas* | Returns a pointer to the created {@link OH_Drawing_Canvas} object. The pointer returned does not need to be  managed by the caller. |
