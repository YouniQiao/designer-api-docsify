...
Creates a pointer to a typography line object [OH_Drawing_LineTypography](capi-drawing-oh-drawing-linetypography.md). The typography line objectserves as a container for storing text content and styles, and can be used to calculate single-line typographyinformation.
