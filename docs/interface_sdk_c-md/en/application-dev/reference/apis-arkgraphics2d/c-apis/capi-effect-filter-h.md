...
| [EffectTileMode](capi-effect-types-h.md#effecttilemode) tileMode | [in] Shader effect tile mode. Different modes determine differentprocessing methods for image edge areas. For details about the available options,see [EffectTileMode](capi-effect-types-h.md#effecttilemode). |
...
| Parameter | Description |
| -- | -- |
| [OH_Filter](capi-effectkit-oh-filter.md)* filter | [in] Filter pointer used to create a bitmap, which needs to be createdthrough OH_Filter_CreateEffect. Cannot be NULL. |
