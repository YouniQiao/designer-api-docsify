...
| Image_MetadataType dstType | Destination metadata type. It specifies the type under which the copied metadata will be stored in thedestination picture.<br>**Since**: 26.0.0 |
