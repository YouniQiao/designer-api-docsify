...
| Type | Description |
| -- | -- |
| OH_AVErrCode | Function result code.  [AV_ERR_OK](../AVCodecKit/capi-native-averrors-h.md#oh_averrcode): the execution is successful.  [AV_ERR_INVALID_VAL](../AVCodecKit/capi-native-averrors-h.md#oh_averrcode): input extractor is nullptr or input source is invalid. |
...
| Type | Description |
| -- | -- |
| OH_AVErrCode | Function result code.  [AV_ERR_OK](../AVCodecKit/capi-native-averrors-h.md#oh_averrcode): the execution is successful.  [AV_ERR_INVALID_VAL](../AVCodecKit/capi-native-averrors-h.md#oh_averrcode): input extractor is nullptr or input param is invalid. |
