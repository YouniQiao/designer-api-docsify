...
| Type | Description |
| -- | -- |
| OH_AVErrCode | Function result code.  [AV_ERR_OK](../AVCodecKit/capi-native-averrors-h.md#oh_averrcode): the execution is successful.  [AV_ERR_INVALID_VAL](../AVCodecKit/capi-native-averrors-h.md#oh_averrcode): input generator is nullptr or input param is invalid. |
