...
| NODE_REFRESH_CONTENT | Sets the custom content in the pull-down area.This attribute can be set and reset as required through APIs.**Format of the [ArkUI_AttributeItem](capi-arkui-nativemodule-arkui-attributeitem.md) parameter for setting the attribute:<ul><li>.object: The parameter type is [ArkUI_NodeHandle](capi-arkui-nativemodule-arkui-node8h.md).</li></ul> |
