...
| Type | Description |
| -- | -- |
| ArkUI_ErrorCode | <ul>          <li>{@link ARKUI_ERROR_CODE_NO_ERROR} if the operation is successful.</li>          <li>{@link ARKUI_ERROR_CODE_PARAM_INVALID} if a parameter exception occurs.</li>          <li>{@link ARKUI_ERROR_CODE_PARAM_ERROR} if the value is never set.</li>          </ul> |
...
| Type | Description |
| -- | -- |
| ArkUI_ErrorCode | <ul>          <li>{@link ARKUI_ERROR_CODE_NO_ERROR} if the operation is successful.</li>          <li>{@link ARKUI_ERROR_CODE_PARAM_INVALID} if a parameter exception occurs.</li>          <li>{@link ARKUI_ERROR_CODE_PARAM_ERROR} if lightEffect is never set or disabled.</li>          </ul> |
