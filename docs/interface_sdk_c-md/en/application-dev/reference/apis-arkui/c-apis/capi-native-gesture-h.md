...
| Type | Description |
| -- | -- |
| ArkUI_NodeHandle | Get component object of the specific touch recognizer. |
...
| Type | Description |
| -- | -- |
| ArkUI_NodeHandle | ARKUI component bound to the gesture.If Null is returned, it means event is an invalid value. |
...
| Parameter | Description |
| -- | -- |
| ArkUI_NodeHandle node | Handle to the node on which the callback is to be set. |
