...
| -- | -- | -- |
| [OH_Cursor](capi-rdb-oh-cursor.md) | OH_Cursor | Define the OH_Cursor structure type.Provides methods for accessing a database result set generated by query the database. |
