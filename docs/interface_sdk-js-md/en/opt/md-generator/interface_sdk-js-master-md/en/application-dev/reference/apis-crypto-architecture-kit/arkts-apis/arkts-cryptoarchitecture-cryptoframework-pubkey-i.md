...
[Key](arkts-cryptoarchitecture-cryptoframework-key-i.md#Key). It needs to be passed in during asymmetric encryption, signature verification,and key agreement.
