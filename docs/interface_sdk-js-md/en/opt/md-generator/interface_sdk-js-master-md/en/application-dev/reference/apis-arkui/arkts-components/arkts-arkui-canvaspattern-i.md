...
**CanvasPattern** represents an object, created by the [createPattern](arkts-arkui-canvasrenderer-c.md#createPattern) API, describing an image filling pattern based on the image and repetition mode.
