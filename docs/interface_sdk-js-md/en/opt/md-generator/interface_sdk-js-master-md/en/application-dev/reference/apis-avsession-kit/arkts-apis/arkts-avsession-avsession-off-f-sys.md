...
| callback | (session: AVSessionDescriptor) =&gt; void | No |
...
| callback | [Callback](../../apis-basic-service-kit/arkts-apis/arkts-basicservices-base-callback-i.md)&lt;Array&lt;AVSessionController&gt;&gt; | No |
...
| callback | (device: OutputDeviceInfo) =&gt; void | No |
...
| callback | (deviceId: string) =&gt; void | No |
...
| callback | [Callback](../../apis-basic-service-kit/arkts-apis/arkts-basicservices-base-callback-i.md)&lt;DeviceLogEventCode&gt; | No |
...
| callback | [Callback](../../apis-basic-service-kit/arkts-apis/arkts-basicservices-base-callback-i.md)&lt;DeviceState&gt; | No |
