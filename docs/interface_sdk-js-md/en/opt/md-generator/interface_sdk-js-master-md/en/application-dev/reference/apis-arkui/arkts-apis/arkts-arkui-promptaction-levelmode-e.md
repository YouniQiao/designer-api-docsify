...
The dialog box is a child of the page's route/navigation and is hidden when the page is hidden.&lt;br&gt;**NOTE：**&lt;br&gt;1. Currently, the dialog box can only be mounted to a **Page** or
