...
Enumerates the result codes. > **NOTE：**<br> > > This API is supported since API version 8 and deprecated since API version 9. For details, see > [Account Management Error Codes](../../apis-basic-services-kit/errorcode-account.md).
