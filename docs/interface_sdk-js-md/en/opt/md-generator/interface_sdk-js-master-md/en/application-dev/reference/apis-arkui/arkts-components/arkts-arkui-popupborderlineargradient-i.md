...
For details about how to set colors, see [ResourceColor](../arkts-apis/arkts-arkui-resourcecolor-t.md#ResourceColor). Colors that are not within the types of [ResourceColor](../arkts-apis/arkts-arkui-resourcecolor-t.md#ResourceColor) are invalid.
