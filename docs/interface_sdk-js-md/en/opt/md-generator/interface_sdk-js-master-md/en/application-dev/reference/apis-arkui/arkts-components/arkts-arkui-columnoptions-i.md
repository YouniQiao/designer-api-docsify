...
Vertical spacing between two adjacent child components.This parameter has no effect if the value specified is a negative number, or if  
...
**NOTE：**The value of **space** can be a number greater than or equal to 0 or a string that can be converted to a number.Default value: **0**.
