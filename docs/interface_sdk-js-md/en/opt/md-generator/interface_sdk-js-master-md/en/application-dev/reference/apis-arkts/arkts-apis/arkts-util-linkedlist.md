...
LinkedList is implemented based on the doubly linked list. Each node of the doubly linked list has references
 ...
 Unlike [List](@ohos.util.List), which is a singly linked list, LinkedList is a doubly linked list that supports
 insertion and removal at both ends.
 LinkedList is more efficient in data insertion than [ArrayList](arkts-arkts-util-arraylist-arraylist-c.md#ArrayList), but less efficient in
 data access.
 > **NOTE**
 >
