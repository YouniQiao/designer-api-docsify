...
**reuseDuration** parameter in [ReuseUnlockResult](arkts-userauthentication-userauth-reuseunlockresult-i.md#ReuseUnlockResult).
...
[AuthLockState](arkts-userauthentication-userauth-authlockstate-i.md#AuthLockState).
