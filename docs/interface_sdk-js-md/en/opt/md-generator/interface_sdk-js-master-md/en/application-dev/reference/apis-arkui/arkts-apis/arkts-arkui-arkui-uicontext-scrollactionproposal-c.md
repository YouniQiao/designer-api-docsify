...
[GestureHandlingResolution](arkts-arkui-arkui-uicontext-gesturehandlingresolution-c.md)'s **selectedProposal** to an object of this type triggers a scroll operation on the target component.
...
| --- | --- | --- |
| node | [FrameNode](../arkts-components/arkts-arkui-framenode-t.md) | Yes |
