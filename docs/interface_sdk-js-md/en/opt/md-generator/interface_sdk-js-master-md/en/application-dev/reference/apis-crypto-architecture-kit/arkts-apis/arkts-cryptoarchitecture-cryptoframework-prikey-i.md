...
[Key](arkts-cryptoarchitecture-cryptoframework-key-i.md#Key). It needs to be passed in during asymmetric decryption, signing, and key agreement.
...
&lt;br&gt;&lt;br&gt;**NOTE：**&lt;br&gt;It is recommended to prioritize the use of asynchronous API, [getKeyData](getKeyData). Synchronous API may take a long time and block the main thread due to system busyness, high load, and other reasons. Therefore,it is advised to invoke synchronous API within a child thread to avoid blocking the main thread.
