...
An object with properties reflecting the locale and formatting options computed during initialization of the `Intl.RelativeTimeFormat` object [MDN](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Intl/RelativeTimeFormat/resolvedOptions#Description).
...
**Type:** [UnicodeBCP47LocaleIdentifier](arkts-na-intl-unicodebcp47localeidentifier-t.md)
...
**Type:** [RelativeTimeFormatNumeric](arkts-na-intl-relativetimeformatnumeric-t.md)
...
**Type:** [RelativeTimeFormatStyle](arkts-na-intl-relativetimeformatstyle-t.md)
