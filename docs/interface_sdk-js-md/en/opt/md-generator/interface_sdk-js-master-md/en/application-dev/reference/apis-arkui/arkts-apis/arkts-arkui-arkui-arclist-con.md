...
Only the [ArcListItem](#ArcList) component is supported.
...
[ArcList](#ArcList) component and must be used in conjunction with **ArcList**.

> **NOTE：**

> - This component can be used only as a child of [ArcList](#ArcList).
> 
...
> [ArcList](#ArcList), its child components are created when it is laid out.
> 
