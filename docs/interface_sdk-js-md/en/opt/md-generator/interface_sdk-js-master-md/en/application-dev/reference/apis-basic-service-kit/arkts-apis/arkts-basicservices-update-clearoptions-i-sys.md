...
Use scenarios: If the upgrade fails (with the status of **UPGRADE_FAIL**), the system retains the error state to prevent the upgrade from being performed again. In this case, you need to call **status** passed by   
