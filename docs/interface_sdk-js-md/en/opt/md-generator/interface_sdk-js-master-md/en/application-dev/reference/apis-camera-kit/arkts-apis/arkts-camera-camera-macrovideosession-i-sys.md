...
**Inheritance/Implementation:** MacroVideoSession extends [Session](arkts-camera-camera-session-i.md#Session), [Flash](arkts-camera-camera-flash-i.md#Flash), [AutoExposure](arkts-camera-camera-autoexposure-i.md#AutoExposure), [Focus](arkts-camera-camera-focus-i.md#Focus), [Zoom](arkts-camera-camera-zoom-i.md#Zoom), [ColorEffect](arkts-camera-camera-coloreffect-i-sys.md#ColorEffect), [ManualFocus](arkts-camera-camera-manualfocus-i.md#ManualFocus), [ColorManagement](arkts-camera-camera-colormanagement-i.md#ColorManagement)
