...
Unix timestamp when the task is created, in milliseconds. The value is generated by the system of the current device. Note: When [request.agent.search](arkts-basicservices-agent-search-f.md#search) is used for query, this value must be within the range of [after,before] for the task ID to be obtained. For details about **before** and **after**, see [Filter](arkts-basicservices-agent-filter-i.md#filter).
...
Task value. - Use [request.agent.show](arkts-basicservices-agent-show-f.md#show) and [request.agent.touch](arkts-basicservices-agent-touch-f.md#touch) to query the value.
...
Task URL. - Use [request.agent.show](arkts-basicservices-agent-show-f.md#show) and [request.agent.touch](arkts-basicservices-agent-touch-f.md#touch) to query the value.
