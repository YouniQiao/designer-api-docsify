...
**NOTE：**1. The timeout period is not a precise time, and the actual timeout period may differ from the expected time.2. If the value is less than 1, it will be defaulted to **0**.3. The value is subject to system limitations. If it exceeds 2^31 �C 1, the value will be **0**.
