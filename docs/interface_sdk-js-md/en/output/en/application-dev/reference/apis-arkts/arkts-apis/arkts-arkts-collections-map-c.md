...
A non-linear data structure. > **NOTE** > > - This module can be imported only to ArkTS files (with the file name extension .ets). > This section uses the following to identify the use of generics: - K: key. - V: value. The K and V types must be any of the \_\_\_MD\_LINK\_DESC\_USD\_0\_\_\_. **Decorator**: \@Sendable
...
| Type | Description |
| --- | --- |
| \_\_\_MD\_LINK\_USD\_0\_\_\_&lt;[K, V]&gt; | Iterator object that yields key-value pairs. |
...
| Type | Description |
| --- | --- |
| boolean | Operation result. The value **true** is returned if the key exists and has been deleted; |
...
| Type | Description |
| --- | --- |
| \_\_\_MD\_LINK\_USD\_0\_\_\_&lt;[K, V]&gt; | Map iterator object. |
...
| Type | Description |
| --- | --- |
| boolean | Check result. The value **true** is returned if the key exists; otherwise, **false** is |
...
| Type | Description |
| --- | --- |
| \_\_\_MD\_LINK\_USD\_0\_\_\_&lt;K&gt; | Map iterator object. |
...
| Type | Description |
| --- | --- |
| \_\_\_MD\_LINK\_USD\_0\_\_\_&lt;V&gt; | Map iterator object. |
