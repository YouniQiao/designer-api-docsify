...
The stream module provides APIs to process basic types of streams. With streams, data is read or written by chunk, instead of being loaded to the memory at a time. There are four fundamental stream types: writable streams ([Writable]\_\_\_JSDOC\_LINK\_DESC\_USD\_0\_\_\_), readable streams ( [Readable]\_\_\_JSDOC\_LINK\_DESC\_USD\_1\_\_\_), duplex streams ([Duplex]\_\_\_JSDOC\_LINK\_DESC\_USD\_2\_\_\_), and transform streams ( [Transform]\_\_\_JSDOC\_LINK\_DESC\_USD\_3\_\_\_).
