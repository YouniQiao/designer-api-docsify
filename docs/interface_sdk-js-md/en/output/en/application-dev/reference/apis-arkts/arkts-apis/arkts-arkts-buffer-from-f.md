...
| --- | --- | --- | --- |
| array | ArkTS-Dyn: number[]  \_\_\_HTML\_TAG\_USD\_0\_\_\_ArkTS-Sta：double[] | Yes | Array to create a **Buffer** object. |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| buffer | \_\_\_MD\_LINK\_USD\_0\_\_\_ \| Uint8Array | Yes | Target object. |
...
| offsetOrEncoding | ArkTS-Dyn: number \| string  \_\_\_HTML\_TAG\_USD\_0\_\_\_ArkTS-Sta：int \| string | Yes | Byte offset or encoding format. |
| length | ArkTS-Dyn: number  \_\_\_HTML\_TAG\_USD\_0\_\_\_ArkTS-Sta：int | Yes | Length of the **Buffer** object to create, in bytes. This parameter is valid only when the return value of **valueOf()** of **object** is **ArrayBuffer**. Value range: 0 <= length <=ArrayBuffer.byteLength. Error 10200001 is reported if a value outside this range is reported. In other cases,you can set this parameter to any value of the number type. This parameter does not affect the result. |
