...
```TypeScript
export function includes(self: FixedArray<boolean>, val: boolean, fromIndex?: int): boolean
```
...
| fromIndex | int | No | The position in this array at which to begin searching for value.\_\_\_ESCAPED\_UNDERSCORE\_\_\_\_\_\_ESCAPED\_UNDERSCORE\_\_\_\_\_\_ESCAPED\_UNDERSCORE\_\_\_HTML\_\_\_ESCAPED\_UNDERSCORE\_\_\_TAG\_\_\_ESCAPED\_UNDERSCORE\_\_\_DESC\_\_\_ESCAPED\_UNDERSCORE\_\_\_USD\_\_\_ESCAPED\_UNDERSCORE\_\_\_0\_\_\_ESCAPED\_UNDERSCORE\_\_\_\_\_\_ESCAPED\_UNDERSCORE\_\_\_\_\_\_ESCAPED\_UNDERSCORE\_\_\_The value should be an integer. |
...
```TypeScript
export function includes(self: FixedArray<byte>, val: byte, fromIndex?: int): boolean
```
...
```TypeScript
export function includes(self: FixedArray<short>, val: short, fromIndex?: int): boolean
```
...
```TypeScript
export function includes(self: FixedArray<int>, val: int, fromIndex?: int): boolean
```
...
| val | int | Yes | The value to search for.\_\_\_ESCAPED\_UNDERSCORE\_\_\_\_\_\_ESCAPED\_UNDERSCORE\_\_\_\_\_\_ESCAPED\_UNDERSCORE\_\_\_HTML\_\_\_ESCAPED\_UNDERSCORE\_\_\_TAG\_\_\_ESCAPED\_UNDERSCORE\_\_\_DESC\_\_\_ESCAPED\_UNDERSCORE\_\_\_USD\_\_\_ESCAPED\_UNDERSCORE\_\_\_0\_\_\_ESCAPED\_UNDERSCORE\_\_\_\_\_\_ESCAPED\_UNDERSCORE\_\_\_\_\_\_ESCAPED\_UNDERSCORE\_\_\_The value should be an integer. |
| fromIndex | int | No | The position in this array at which to begin searching for value.\_\_\_ESCAPED\_UNDERSCORE\_\_\_\_\_\_ESCAPED\_UNDERSCORE\_\_\_\_\_\_ESCAPED\_UNDERSCORE\_\_\_HTML\_\_\_ESCAPED\_UNDERSCORE\_\_\_TAG\_\_\_ESCAPED\_UNDERSCORE\_\_\_DESC\_\_\_ESCAPED\_UNDERSCORE\_\_\_USD\_\_\_ESCAPED\_UNDERSCORE\_\_\_0\_\_\_ESCAPED\_UNDERSCORE\_\_\_\_\_\_ESCAPED\_UNDERSCORE\_\_\_\_\_\_ESCAPED\_UNDERSCORE\_\_\_The value should be an integer. |
...
```TypeScript
export function includes(self: FixedArray<long>, val: long, fromIndex?: int): boolean
```
...
```TypeScript
export function includes(self: FixedArray<float>, val: float, fromIndex?: int): boolean
```
...
```TypeScript
export function includes(self: FixedArray<double>, val: double, fromIndex?: int): boolean
```
...
```TypeScript
export function includes(self: FixedArray<char>, val: char, fromIndex?: int): boolean
```
