...
**Inheritance/Implementation:** Long extends [Integral](numeric-integral-c.md) and implements [Comparable<Long>](Comparable<Long>)
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| other | \_\_\_MD\_LINK\_USD\_0\_\_\_ | Yes | Long object to compare with. |

**Return value:**

| Type | Description |
| --- | --- |
| int | result of the comparison, -1 if this instance is less than provided object, |
