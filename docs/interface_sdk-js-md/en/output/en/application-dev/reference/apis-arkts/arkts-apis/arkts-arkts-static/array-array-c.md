...
| Type | Description |
| --- | --- |
| T | The value of the first element that satisfies the provided testing function; |
...
| Type | Description |
| --- | --- |
| Array&lt;T&gt; | Removes elements from an array and, if necessary, inserts new elements in their place, |
