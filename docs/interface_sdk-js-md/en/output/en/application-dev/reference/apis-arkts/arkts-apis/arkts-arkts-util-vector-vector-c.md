...
| Type | Description |
| --- | --- |
| boolean | Check result. The value **true** is returned if the Vector has the specified element; |
...
| Type | Description |
| --- | --- |
| boolean | Check result. The value **true** is returned if the Vector is empty; otherwise, **false** is |
...
| Type | Description |
| --- | --- |
| T | Element removed. If the Vector is empty, **undefined** is returned. If the index is out of range, an |
