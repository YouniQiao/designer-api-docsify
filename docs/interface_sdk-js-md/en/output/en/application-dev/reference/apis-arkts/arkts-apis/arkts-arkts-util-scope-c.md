...
| Type | Description |
| --- | --- |
| \_\_\_MD\_LINK\_USD\_0\_\_\_ | Returns **lowerObj** if the specified value is less than the lower limit; returns |
...
| Type | Description |
| --- | --- |
| boolean | Check result. The value **true** is returned if the value is within this **Scope**; |
...
| Type | Description |
| --- | --- |
| boolean | Check result. The value **true** is returned if the range is within this **Scope**; |
