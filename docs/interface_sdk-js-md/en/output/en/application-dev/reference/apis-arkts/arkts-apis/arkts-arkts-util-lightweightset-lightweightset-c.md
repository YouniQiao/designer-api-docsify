...
| Type | Description |
| --- | --- |
| boolean | Returns **true** if **obj** is a LightWeightSet or an array containing only strings or numbers |
...
| Type | Description |
| --- | --- |
| ArkTS-Dyn: number  \_\_\_HTML\_TAG\_USD\_0\_\_\_ArkTS-Sta：int | Position index of the element. If the element does not exist, a negative value is returned. The |
...
| Type | Description |
| --- | --- |
| boolean | Check result. The value **true** is returned if the LightWeightSet is empty; otherwise, |
