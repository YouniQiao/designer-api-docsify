...
Receives a function that uses the error-first callback mode, that is, uses \_\_\_INLINE\_CODE\_DESC\_USD\_0\_\_\_ as the last parameter, and uses a promise to return the result.
