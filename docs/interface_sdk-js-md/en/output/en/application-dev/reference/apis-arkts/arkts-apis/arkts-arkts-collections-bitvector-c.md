...
| Type | Description |
| --- | --- |
| \_\_\_MD\_LINK\_USD\_0\_\_\_&lt;int&gt; | A new iterable iterator object. |
...
| Type | Description |
| --- | --- |
| \_\_\_MD\_LINK\_USD\_0\_\_\_ | The BitVector type, returns the bit values in a range of indices in a bit vector. |
...
| Type | Description |
| --- | --- |
| int | The number type, return the first index of specified bit within a range, |
...
| Type | Description |
| --- | --- |
| int | The number type, return the last index of specified bit within a range, |
