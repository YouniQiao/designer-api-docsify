...
A special duplex stream that supports data conversion and result output. The **Transform** class inherits from [Duplex]\_\_\_JSDOC\_LINK\_DESC\_USD\_0\_\_\_ and supports all the APIs in **Duplex**.
