...
| Type | Description |
| --- | --- |
| boolean | boolean Indicates whether the URI is an absolute URI (whether the scheme component is |
...
| Type | Description |
| --- | --- |
| boolean | Query returns defaultValue if the key does not exist. |
...
| Type | Description |
| --- | --- |
| \_\_\_MD\_LINK\_USD\_0\_\_\_ | URI Used to normalize the path of this URI and return a URI object whose path has been |
