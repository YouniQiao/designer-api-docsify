...
A stream that is both readable and writable. A duplex stream allows data to be transmitted in two directions, that is, data can be read and written. The **Duplex** class inherits from [Readable]\_\_\_JSDOC\_LINK\_DESC\_USD\_0\_\_\_ and supports all the APIs in **Readable**.
...
| Type | Description |
| --- | --- |
| \_\_\_MD\_LINK\_USD\_0\_\_\_ | Current **Duplex** object. |
...
| Type | Description |
| --- | --- |
| boolean | Whether there is space in the buffer of the writable stream. The value **true** means that |
