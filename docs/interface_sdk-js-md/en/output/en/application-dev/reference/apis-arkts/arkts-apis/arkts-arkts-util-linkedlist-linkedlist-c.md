...
| Type | Description |
| --- | --- |
| boolean | Operation result. The value **true** is returned if the specified element is contained; |
...
| Type | Description |
| --- | --- |
| boolean | Returns **true** if the element is removed; returns **false** if the element fails to be |
