...
A linear data structure that is implemented on [ArkTS ArrayBuffer]\_\_\_JSDOC\_LINK\_DESC\_USD\_0\_\_\_. > **NOTE** > > - This module can be imported only to ArkTS files (with the file name extension .ets). > **Decorator**: \@Sendable
...
| --- | --- | --- | --- |
| index | number | Yes | The zero-based index of the desired code unit.\_\_\_ESCAPED\_UNDERSCORE\_\_\_\_\_\_ESCAPED\_UNDERSCORE\_\_\_\_\_\_ESCAPED\_UNDERSCORE\_\_\_HTML\_\_\_ESCAPED\_UNDERSCORE\_\_\_TAG\_\_\_ESCAPED\_UNDERSCORE\_\_\_DESC\_\_\_ESCAPED\_UNDERSCORE\_\_\_USD\_\_\_ESCAPED\_UNDERSCORE\_\_\_0\_\_\_ESCAPED\_UNDERSCORE\_\_\_\_\_\_ESCAPED\_UNDERSCORE\_\_\_\_\_\_ESCAPED\_UNDERSCORE\_\_\_A negative index will count back from the last item. |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| elements | Iterable&lt;number&gt; | Yes | An iterable collection of numbers used to construct an ArkTS Float32Array object. |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| array | \_\_\_MD\_LINK\_USD\_0\_\_\_&lt;number&gt; \| ArrayBuffer | Yes | Object used to construct the ArkTS Float32Array. When the parameter type is ArrayBuffer, the number of bytes occupied by the buffer must be an integer multiple of 4. |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| buffer | ArrayBuffer | Yes | ArrayBuffer object used to construct the ArkTS Float32Array. The number of bytes occupied by the buffer must be an integer multiple of 4. |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| predicate | \_\_\_MD\_LINK\_USD\_0\_\_\_&lt;number, Float32Array&gt; | Yes | Assertion function used for the test. |

**Return value:**

| Type | Description |
| --- | --- |
| boolean | Check result. The value **true** is returned if all elements meet the given condition; |
...
| Type | Description |
| --- | --- |
| Float32Array | Filled ArkTS Float32Array. |
...
| Type | Description |
| --- | --- |
| Float32Array | Filtered ArkTS Float32Array. |
...
| Type | Description |
| --- | --- |
| number | Value of the first element that passes the test. If none of the elements pass the |
...
| Type | Description |
| --- | --- |
| number | Index of the first element that passes the test. If none of the elements pass the test, |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| callbackFn | \_\_\_MD\_LINK\_USD\_0\_\_\_&lt;number, Float32Array&gt; | Yes | Callback function to run for each element. |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| arrayLike | \_\_\_MD\_LINK\_USD\_0\_\_\_&lt;number&gt; | Yes | Array-like object used to construct the ArkTS Float32Array. |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| arrayLike | \_\_\_MD\_LINK\_USD\_0\_\_\_&lt;T&gt; | Yes | An array-like object to convert to an Float32Array. |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| arrayLike | Iterable&lt;number&gt; | Yes | An iterable object to convert to an Float32Array. |
...
| Type | Description |
| --- | --- |
| boolean | Check result. The value **true** is returned if the element exists; otherwise, **false** is |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| callbackFn | \_\_\_MD\_LINK\_USD\_0\_\_\_&lt;number, Float32Array&gt; | Yes | A function that accepts up to three arguments.The map method calls the callbackfn function one time for each element in the array. |

**Return value:**

| Type | Description |
| --- | --- |
| Float32Array | New ArkTS Float32Array. |
...
| Type | Description |
| --- | --- |
| Float32Array | New ArkTS Float32Array instance. Possible causes: 1. Mandatory parameters are left unspecified; |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| callbackFn | \_\_\_MD\_LINK\_USD\_0\_\_\_&lt;number, number, Float32Array&gt; | Yes | A function that accepts up to four arguments.The reduce method calls the callbackfn function one time for each element in the array. |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| callbackFn | \_\_\_MD\_LINK\_USD\_0\_\_\_&lt;U, number, Float32Array&gt; | Yes | A function that accepts up to four arguments.The reduce method calls the callbackfn function one time for each element in the array. |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| callbackFn | \_\_\_MD\_LINK\_USD\_0\_\_\_&lt;U, number, Float32Array&gt; | Yes | A function that is called for each element in the Float32Array. |
| initialValue | U | Yes | A value to use as the first argument to the first call of the callback.\_\_\_ESCAPED\_UNDERSCORE\_\_\_\_\_\_ESCAPED\_UNDERSCORE\_\_\_\_\_\_ESCAPED\_UNDERSCORE\_\_\_HTML\_\_\_ESCAPED\_UNDERSCORE\_\_\_TAG\_\_\_ESCAPED\_UNDERSCORE\_\_\_DESC\_\_\_ESCAPED\_UNDERSCORE\_\_\_USD\_\_\_ESCAPED\_UNDERSCORE\_\_\_0\_\_\_ESCAPED\_UNDERSCORE\_\_\_\_\_\_ESCAPED\_UNDERSCORE\_\_\_\_\_\_ESCAPED\_UNDERSCORE\_\_\_If no initial value is provided, the last element of the Float32Array will be used,\_\_\_ESCAPED\_UNDERSCORE\_\_\_\_\_\_ESCAPED\_UNDERSCORE\_\_\_\_\_\_ESCAPED\_UNDERSCORE\_\_\_HTML\_\_\_ESCAPED\_UNDERSCORE\_\_\_TAG\_\_\_ESCAPED\_UNDERSCORE\_\_\_DESC\_\_\_ESCAPED\_UNDERSCORE\_\_\_USD\_\_\_ESCAPED\_UNDERSCORE\_\_\_1\_\_\_ESCAPED\_UNDERSCORE\_\_\_\_\_\_ESCAPED\_UNDERSCORE\_\_\_\_\_\_ESCAPED\_UNDERSCORE\_\_\_and the callback will start with the second-to-last element. |

**Return value:**

| Type | Description |
| --- | --- |
| U | Final result obtained from the last call of the reduce function. Possible causes: |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| callbackFn | \_\_\_MD\_LINK\_USD\_0\_\_\_&lt;number, number, Float32Array&gt; | Yes | A function that is called for each element in the Float32Array. |

**Return value:**

| Type | Description |
| --- | --- |
| number | Final result obtained from the last call of the reduce function. Possible causes: |
...
| Type | Description |
| --- | --- |
| Float32Array | Reversed ArkTS Float32Array. |
...
| Type | Description |
| --- | --- |
| boolean | Check result. The value **true** is returned if an element meeting the given condition |
...
| Type | Description |
| --- | --- |
| Float32Array | Sorted ArkTS Float32Array. |
