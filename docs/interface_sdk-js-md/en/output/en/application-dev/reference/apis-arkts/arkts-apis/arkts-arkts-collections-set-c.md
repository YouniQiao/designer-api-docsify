...
A non-linear data structure. > **NOTE** > > - This module can be imported only to ArkTS files (with the file name extension .ets). > This section uses the following to identify the use of generics: - T: type, which can be any of the \_\_\_MD\_LINK\_DESC\_USD\_0\_\_\_. **Decorator**: \@Sendable
...
| Type | Description |
| --- | --- |
| boolean | Operation result. The value **true** is returned if the key is deleted; otherwise, **false** |
...
| Type | Description |
| --- | --- |
| \_\_\_MD\_LINK\_USD\_0\_\_\_&lt;[T, T]&gt; | Returns a set iterator object that contains the key-value pair of each |
...
| Type | Description |
| --- | --- |
| boolean | Check result. The value **true** is returned if the value exists; otherwise, **false** is |
...
| Type | Description |
| --- | --- |
| \_\_\_MD\_LINK\_USD\_0\_\_\_&lt;T&gt; | Returns a set iterator object that contains the key of each element in this |
...
| Type | Description |
| --- | --- |
| \_\_\_MD\_LINK\_USD\_0\_\_\_&lt;T&gt; | Returns a set iterator object that contains the value of each element in this |
