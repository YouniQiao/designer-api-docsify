...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| other | Int16Array | Yes | data initializer |
...
Creates an Int16Array from FixedArray\_\_\_HTML\_TAG\_DESC\_USD\_0\_\_\_
...
Creates an Int16Array from Array\_\_\_HTML\_TAG\_DESC\_USD\_0\_\_\_
...
Creates an Int16Array with respect to data accessed via Iterable\_\_\_HTML\_TAG\_DESC\_USD\_0\_\_\_ interface
...
| buf | ArrayBuffer | Yes | data initializer |
| byteOffset | int | Yes | byte offset from begin of the buf\_\_\_ESCAPED\_UNDERSCORE\_\_\_\_\_\_ESCAPED\_UNDERSCORE\_\_\_\_\_\_ESCAPED\_UNDERSCORE\_\_\_HTML\_\_\_ESCAPED\_UNDERSCORE\_\_\_TAG\_\_\_ESCAPED\_UNDERSCORE\_\_\_DESC\_\_\_ESCAPED\_UNDERSCORE\_\_\_USD\_\_\_ESCAPED\_UNDERSCORE\_\_\_0\_\_\_ESCAPED\_UNDERSCORE\_\_\_\_\_\_ESCAPED\_UNDERSCORE\_\_\_\_\_\_ESCAPED\_UNDERSCORE\_\_\_The value should be an integer. |
| length | int | Yes | size of elements of type short in newly created Int16Array\_\_\_ESCAPED\_UNDERSCORE\_\_\_\_\_\_ESCAPED\_UNDERSCORE\_\_\_\_\_\_ESCAPED\_UNDERSCORE\_\_\_HTML\_\_\_ESCAPED\_UNDERSCORE\_\_\_TAG\_\_\_ESCAPED\_UNDERSCORE\_\_\_DESC\_\_\_ESCAPED\_UNDERSCORE\_\_\_USD\_\_\_ESCAPED\_UNDERSCORE\_\_\_0\_\_\_ESCAPED\_UNDERSCORE\_\_\_\_\_\_ESCAPED\_UNDERSCORE\_\_\_\_\_\_ESCAPED\_UNDERSCORE\_\_\_The value should be an integer. |
...
| length | double \| undefined | Yes | size of elements of type short in newly created Int16Array |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| predicate | (element: double, index: int, array: Int16Array) =&gt; boolean | Yes | A function that accepts three arguments.The every method calls the predicate function for each element in the array until the predicate returns a false, or until the end of the array. |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| fn | (val: double, index: int, array: Int16Array) =&gt; boolean | Yes | the condition to apply for each element |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| predicate | (value: double, index: int, obj: Int16Array) =&gt; boolean | Yes | find calls predicate once for each element of the array, in ascending order, until it finds one where predicate returns true. If such an element is found, find immediately returns that element value. Otherwise, find returns undefined |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| predicate | (value: double, index: int, obj: Int16Array) =&gt; boolean | Yes | find calls predicate once for each element of the array, in ascending order, until it finds one where predicate returns true. If such an element is found,findIndex immediately returns that element index. Otherwise, findIndex returns -1 |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| fn | (val: double, index: int, array: Int16Array) =&gt; boolean | Yes | A function to test each element. Called with (value, index, array).Should return true for the element to be found. |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| callbackfn | (value: double, index: int, array: Int16Array) =&gt; void | Yes | A function that accepts up to three arguments. forEach calls the callbackfn function one time for each element in the array. |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| arr | Int16Array | Yes | An array to convert to a new array. |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| arr | Uint16Array | Yes | An array to convert to a new array. |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| searchElement | short | Yes | The element to search for. The search starts at index 0. |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| fn | (val: double, index: int, array: Int16Array) =&gt; double | Yes | a function to apply for each element of current Int16Array |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| callbackfn | (previousValue: U, currentValue: double, currentIndex: int, array: Int16Array) =&gt; U | Yes | A function that accepts four arguments.The reduce method calls the callbackfn function one time for each element in the array. |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| callbackfn | (previousValue: U, currentValue: double, currentIndex: int, array: Int16Array) =&gt; U | Yes | A function that accepts four arguments.The reduceRight method calls the callbackfn function one time for each element in the array. |
...
| Type | Description |
| --- | --- |
| Int16Array | - a new Int16Array with elements of current Int16Array[begin;end), |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| predicate | (element: double, index: int, array: Int16Array) =&gt; boolean | Yes | A function that accepts three arguments.The some method calls the predicate function for each element in the array until the predicate returns a true or until the end of the array. |
...
| Type | Description |
| --- | --- |
| \_\_\_MD\_LINK\_USD\_0\_\_\_&lt;double&gt; | - an iterator |
