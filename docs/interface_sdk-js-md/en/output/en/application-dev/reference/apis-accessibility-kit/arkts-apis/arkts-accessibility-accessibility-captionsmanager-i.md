...
Implements configuration management for captions. Before calling any API of **CaptionsManager**, you must use the [accessibility.getCaptionsManager()]\_\_\_JSDOC\_LINK\_DESC\_USD\_0\_\_\_ API to obtain a **CaptionsManager** instance.
