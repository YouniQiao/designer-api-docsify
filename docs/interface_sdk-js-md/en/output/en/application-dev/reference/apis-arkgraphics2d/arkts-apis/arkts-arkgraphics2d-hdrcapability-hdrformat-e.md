...
Videos in HDR\_VIVID format. This API can be used in atomic services since API version 12.
...
Images in HDR\_VIVID format, stored in dual JPEG format. This API can be used in atomic services since API version 12.
...
Images in HDR\_VIVID format, stored in single HEIF format. This API can be used in atomic services since API version 12.
...
Images in HDR\_ISO format, stored in dual JPEG format. This API can be used in atomic services since API version 12.
...
Images in HDR\_ISO format, stored in single HEIF format. This API can be used in atomic services since API version 12.
