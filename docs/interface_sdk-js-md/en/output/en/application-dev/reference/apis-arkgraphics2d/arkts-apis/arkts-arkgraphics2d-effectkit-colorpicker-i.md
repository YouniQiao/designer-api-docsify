...
| Type | Description |
| --- | --- |
| \_\_\_MD\_LINK\_USD\_0\_\_\_ | Color value of the color with the highest saturation. If the operation fails, null is |
...
| Type | Description |
| --- | --- |
| \_\_\_MD\_LINK\_USD\_0\_\_\_ | Color value of the color with the largest proportion. If the operation fails, null is |
...
| Type | Description |
| --- | --- |
| Promise&lt;Color&gt; | Promise used to return the color value of the main color. If the operation fails, an |
