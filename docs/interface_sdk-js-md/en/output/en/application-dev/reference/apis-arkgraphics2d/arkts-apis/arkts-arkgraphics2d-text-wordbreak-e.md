...
Attempts to break words at the end of a line using a hyphen. If a hyphen cannot be added, it behaves like **BREAK\_WORD**. When using this word break strategy, you need to use the \_\_\_INLINE\_CODE\_DESC\_USD\_0\_\_\_ attribute in [TextStyle]\_\_\_JSDOC\_LINK\_DESC\_USD\_1\_\_\_ to define the language environment, which affects the word break effect.
