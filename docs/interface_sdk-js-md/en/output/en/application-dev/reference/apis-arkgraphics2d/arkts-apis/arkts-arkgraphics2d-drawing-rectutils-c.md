...
| Type | Description |
| --- | --- |
| boolean | Whether a rectangle completely contains another rectangle. **true** means yes; **false** |
...
| Type | Description |
| --- | --- |
| boolean | Whether a rectangle completely contains another rectangle defined by the coordinates of its |
...
| Type | Description |
| --- | --- |
| boolean | Whether the rectangle completely contains the point **(x, y)**. **true** means yes; |
...
| Type | Description |
| --- | --- |
| ArkTS-Dyn: number  \_\_\_HTML\_TAG\_USD\_0\_\_\_ArkTS-Sta：double | Height of the rectangle. If the top boundary is greater than the bottom, the height is |
...
| Type | Description |
| --- | --- |
| ArkTS-Dyn: number  \_\_\_HTML\_TAG\_USD\_0\_\_\_ArkTS-Sta：double | Width of a rectangle. If the left boundary is greater than the right, the width is negative. |
...
| Type | Description |
| --- | --- |
| boolean | Whether two rectangles have an intersection. **true** means yes; **false** otherwise. If the |
