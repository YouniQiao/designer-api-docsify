...
Web audio type in the application. The default value is [STREAM\_USAGE\_MUSIC]\_\_\_JSDOC\_LINK\_DESC\_USD\_0\_\_\_. This parameter changes the mapping between the component audio type and the system audio type, which affects the ArkWeb audio focus policy.
