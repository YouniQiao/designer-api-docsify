...
Whether the page is reloaded. The value **true** means that the page is reloaded by invoking the [refresh]\_\_\_JSDOC\_LINK\_DESC\_USD\_0\_\_\_ API, and **false** means the opposite.
