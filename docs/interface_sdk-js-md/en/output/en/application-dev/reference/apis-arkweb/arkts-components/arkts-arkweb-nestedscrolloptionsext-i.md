...
Nested scrolling options when the component scrolls down. Default value: **NestedScrollMode.SELF\_FIRST**.
...
Nested scrolling options when the component scrolls left. Default value: **NestedScrollMode.SELF\_FIRST**.
...
Nested scrolling options when the component scrolls right. Default value: **NestedScrollMode.SELF\_FIRST**.
...
Nested scrolling options when the component scrolls up. Default value: **NestedScrollMode.SELF\_FIRST**.
