...
Enumerates the context menu edit state flags. This enum can be used in bitwise OR mode. For example, to support **CAN\_CUT**, **CAN\_COPY**, and **CAN\_SELECT\_ALL** at the same time, use **CAN\_CUT | CAN\_COPY | CAN\_SELECT\_ALL**.
