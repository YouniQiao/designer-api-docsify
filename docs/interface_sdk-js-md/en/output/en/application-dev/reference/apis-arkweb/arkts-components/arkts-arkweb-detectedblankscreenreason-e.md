...
No contentful node is detected. This may be triggered when the detection policy is **DETECTION\_CONTENTFUL\_NODES\_SEVENTEEN**.
...
The number of contentful nodes detected is less than or equal to the threshold. This may be triggered when the detection policy is **DETECTION\_CONTENTFUL\_NODES\_SEVENTEEN** and **contentfulNodesCountThreshold** is set.
