...
Methods of the detection policy. The value is an array. **NOTE** 1. Duplicate values are ignored. Default value: **[BlankScreenDetectionMethod.DETECTION\_CONTENTFUL\_NODES\_SEVENTEEN]**.
