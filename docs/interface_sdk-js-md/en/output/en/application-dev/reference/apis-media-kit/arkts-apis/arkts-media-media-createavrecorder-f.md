...
| Type | Description |
| --- | --- |
| Promise&lt;AVRecorder&gt; | Promise used to return an **AVRecorder** instance, which can be used to record |
...
| Type | Description |
| --- | --- |
| Promise&lt;AVRecorder \| undefined&gt; | Promise used to return the result. If the operation is successful, |
