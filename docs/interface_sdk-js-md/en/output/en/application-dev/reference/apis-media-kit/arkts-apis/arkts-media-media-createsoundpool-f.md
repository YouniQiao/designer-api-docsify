...
| callback | \_\_\_MD\_LINK\_USD\_0\_\_\_&lt;SoundPool&gt; | Yes | Callback used to return the result. If the operation is successful, a SoundPool instance is returned; otherwise, **null** is returned. The instance is used for loading and playback. |
...
| callback | \_\_\_MD\_LINK\_USD\_0\_\_\_&lt;SoundPool \| undefined&gt; | Yes | Callback used to return the result. If the operation is successful, a **SoundPool** instance is returned; otherwise, **undefined** is returned.The instance is used for loading and playback. |
