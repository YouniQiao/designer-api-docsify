...
Type of the audio source to record. This parameter is mandatory for audio recording.\_\_\_HTML\_TAG\_DESC\_USD\_0\_\_\_**Atomic service API**: This API can be used in atomic services since API version 12.
...
Geographical location of the recorded video. By default, the geographical location information is not recorded. \_\_\_HTML\_TAG\_DESC\_USD\_0\_\_\_This API is supported since API version 6 and deprecated since API version 12. You are advised to use **AVMetadata.location** instead. If both parameters are set, **AVMetadata.location** is used.
...
Rotation angle of the recorded video, in degrees. The value can be 0 (default), 90, 180, or 270 for MP4 videos. \_\_\_HTML\_TAG\_DESC\_USD\_0\_\_\_This API is supported since API version 6 and deprecated since API version 12. You are advised to use. **AVMetadata.videoOrientation** instead. If both parameters are set, **AVMetadata.videoOrientation** is used.
...
Recording output URL: fd://xx (fd number).\_\_\_HTML\_TAG\_DESC\_USD\_0\_\_\_This parameter is mandatory.\_\_\_HTML\_TAG\_DESC\_USD\_1\_\_\_**Atomic service API**: This API can be used in atomic services since API version 12.
