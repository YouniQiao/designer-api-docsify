...
VideoPlayer is a class for video playback management. It provides APIs to manage and play videos. Before calling any API in VideoPlayer, you must use [createVideoPlayer()]\_\_\_JSDOC\_LINK\_DESC\_USD\_0\_\_\_ to create a VideoPlayer instance.
...
| Type | Description |
| --- | --- |
| Promise&lt;Array&lt;MediaDescription&gt;&gt; | Promise used to return the MediaDescription array that holds the |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| type | 'error' | Yes | Event type, which is **'error'** in this case.\_\_\_ESCAPED\_UNDERSCORE\_\_\_\_\_\_ESCAPED\_UNDERSCORE\_\_\_\_\_\_ESCAPED\_UNDERSCORE\_\_\_HTML\_\_\_ESCAPED\_UNDERSCORE\_\_\_TAG\_\_\_ESCAPED\_UNDERSCORE\_\_\_DESC\_\_\_ESCAPED\_UNDERSCORE\_\_\_USD\_\_\_ESCAPED\_UNDERSCORE\_\_\_0\_\_\_ESCAPED\_UNDERSCORE\_\_\_\_\_\_ESCAPED\_UNDERSCORE\_\_\_\_\_\_ESCAPED\_UNDERSCORE\_\_\_This event is triggered when an error occurs during video playback. |
...
**Substitutes:** [@ohos.multimedia.media:media.AVPlayer.pause](arkts-media-media-avplayer-i.md#pause)()
...
**Substitutes:** [@ohos.multimedia.media:media.AVPlayer.play](arkts-media-media-avplayer-i.md#play)()
...
**Substitutes:** [@ohos.multimedia.media:media.AVPlayer.prepare](arkts-media-media-avplayer-i.md#prepare)(callback:
...
**Substitutes:** [@ohos.multimedia.media:media.AVPlayer.prepare](arkts-media-media-avplayer-i.md#prepare)()
...
**Substitutes:** [@ohos.multimedia.media:media.AVPlayer.release](arkts-media-media-avplayer-i.md#release)()
...
**Substitutes:** [@ohos.multimedia.media:media.AVPlayer.reset](arkts-media-media-avplayer-i.md#reset)()
...
| callback | \_\_\_MD\_LINK\_USD\_0\_\_\_&lt;number&gt; | Yes | Callback used to return the result. If the operation is successful,**err** is **undefined** and **data** is the new playback position; otherwise, **err** is an error object. |
...
| --- | --- | --- | --- |
| timeMs | number | Yes | Position to seek to, in ms. The value range is [0, duration]. |
| mode | \_\_\_MD\_LINK\_USD\_0\_\_\_ | Yes | Seek mode. |
| callback | \_\_\_MD\_LINK\_USD\_0\_\_\_&lt;number&gt; | Yes | Callback used to return the result. If the operation is successful,**err** is **undefined** and **data** is the new playback position; otherwise, **err** is an error object. |
...
| --- | --- | --- | --- |
| timeMs | number | Yes | Position to seek to, in ms. The value range is [0, duration]. |
| mode | \_\_\_MD\_LINK\_USD\_0\_\_\_ | No | Seek mode based on the video I frame. The default value is **SEEK\_\_\_ESCAPED\_UNDERSCORE\_\_\_PREV\_\_\_ESCAPED\_UNDERSCORE\_\_\_SYNC**. |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| surfaceId | string | Yes | Surface ID, which is obtained from the **XComponent**. For details about how to obtain it, see [XComponent]\_\_\_ESCAPED\_UNDERSCORE\_\_\_\_\_\_ESCAPED\_UNDERSCORE\_\_\_\_\_\_ESCAPED\_UNDERSCORE\_\_\_JSDOC\_\_\_ESCAPED\_UNDERSCORE\_\_\_LINK\_\_\_ESCAPED\_UNDERSCORE\_\_\_DESC\_\_\_ESCAPED\_UNDERSCORE\_\_\_USD\_\_\_ESCAPED\_UNDERSCORE\_\_\_0\_\_\_ESCAPED\_UNDERSCORE\_\_\_\_\_\_ESCAPED\_UNDERSCORE\_\_\_\_\_\_ESCAPED\_UNDERSCORE\_\_\_. |
| callback | \_\_\_MD\_LINK\_USD\_0\_\_\_&lt;void&gt; | Yes | Callback used to return the result. If the setting is successful,**err** is **undefined**. Otherwise, **err** is an error object. |
...
**Substitutes:** [@ohos.multimedia.media:media.AVPlayer.setSpeed](arkts-media-media-avplayer-i.md#setspeed)
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| speed | number | Yes | Video playback speed. For details, see [PlaybackSpeed]\_\_\_ESCAPED\_UNDERSCORE\_\_\_\_\_\_ESCAPED\_UNDERSCORE\_\_\_\_\_\_ESCAPED\_UNDERSCORE\_\_\_JSDOC\_\_\_ESCAPED\_UNDERSCORE\_\_\_LINK\_\_\_ESCAPED\_UNDERSCORE\_\_\_DESC\_\_\_ESCAPED\_UNDERSCORE\_\_\_USD\_\_\_ESCAPED\_UNDERSCORE\_\_\_0\_\_\_ESCAPED\_UNDERSCORE\_\_\_\_\_\_ESCAPED\_UNDERSCORE\_\_\_\_\_\_ESCAPED\_UNDERSCORE\_\_\_. |
| callback | \_\_\_MD\_LINK\_USD\_0\_\_\_&lt;number&gt; | Yes | Callback used to return the result. If the operation is successful,**err** is **undefined** and **data** is the playback speed; otherwise, **err** is an error object. |
...
| Type | Description |
| --- | --- |
| Promise&lt;number&gt; | Promise used to return the playback speed. For details, see |
...
**Substitutes:** [@ohos.multimedia.media:media.AVPlayer.stop](arkts-media-media-avplayer-i.md#stop)()
...
**Substitutes:** ohos.multimedia.media/media.AVPlayer#height
...
Video URL. The video formats MP4, MPEG-TS, and MKV are supported. **Example of supported URLs**: 1. FD: fd://xx ![](../../../reference/apis-media-kit/figures/en-us\_image\_url.png) 2. HTTP: http://xx 3. HTTPS: https://xx 4. HLS: http://xx or https://xx 5. File type: file://xx **NOTE** WebM is no longer supported since API version 11.
...
Video scale type. The default value is **VIDEO\_SCALE\_TYPE\_FIT**.
...
**Substitutes:** ohos.multimedia.media/media.AVPlayer#videoScaleType
...
**Substitutes:** ohos.multimedia.media/media.AVPlayer#width
