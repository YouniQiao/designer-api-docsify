...
| callback | \_\_\_MD\_LINK\_USD\_0\_\_\_&lt;ScreenCaptureEvent&gt; | No | Callback invoked when the event is triggered,where ScreenCaptureEvent indicates the new state. If this parameter is not specified,the last subscription event is canceled. |
...
| --- | --- | --- | --- |
| type | 'systemScreenRecorder' | Yes | Event type, which is **'systemScreenRecorder'** in this case.This event is triggered when the state of the system screen recorder changes. |
| callback | \_\_\_MD\_LINK\_USD\_0\_\_\_&lt;ScreenCaptureEvent&gt; | Yes | Callback invoked when the event is triggered,where ScreenCaptureEvent indicates the new state. |
