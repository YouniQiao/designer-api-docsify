...
| [onConnectionStateChanged](arkts-connectivity-datatransfer-onconnectionstatechanged-f.md#onconnectionstatechanged) | Subscribes to the connection state change event. This event is accessible only to applications that granted the ohos.permission.NEARLINK\_\_\_ESCAPED\_UNDERSCORE\_\_\_ACCESS permission. |
| [onReadData](arkts-connectivity-datatransfer-onreaddata-f.md#onreaddata) | Subscribes to the event reported when data is read from the port. This event is accessible only to applications that granted the ohos.permission.NEARLINK\_\_\_ESCAPED\_UNDERSCORE\_\_\_ACCESS permission. |
