...
| [onAdvertisingStateChange](arkts-connectivity-advertising-onadvertisingstatechange-f.md#onadvertisingstatechange) | Subscribes to the advertising state change event. This event is accessible only to applications that granted the ohos.permission.NEARLINK\_\_\_ESCAPED\_UNDERSCORE\_\_\_ACCESS permission. |
