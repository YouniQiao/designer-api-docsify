...
Controls tag read and write. \_\_\_HTML\_TAG\_DESC\_USD\_0\_\_\_Classes for different types of tags inherit from this abstract class to control connections to tags, read data from tags, and write data to tags.
...
Connects to a tag. \_\_\_HTML\_TAG\_DESC\_USD\_0\_\_\_This method must be called before data is read from or written to the tag.
...
| Type | Description |
| --- | --- |
| ArkTS-Dyn: number  \_\_\_HTML\_TAG\_USD\_0\_\_\_ArkTS-Sta：int | Returns the maximum length of the data to be sent to the tag. |
...
| Type | Description |
| --- | --- |
| ArkTS-Dyn: number  \_\_\_HTML\_TAG\_USD\_0\_\_\_ArkTS-Sta：int | Returns the timeout duration. |
...
| Type | Description |
| --- | --- |
| Promise&lt;number[]&gt; | Returns bytes received in response. Or bytes with a length of 0 if the |
...
| --- | --- | --- | --- |
| data | number[] | Yes | Indicates the data to be written to the tag. |
| callback | \_\_\_MD\_LINK\_USD\_0\_\_\_&lt;number[]&gt; | Yes | The callback. |
...
Sets the timeout duration (ms) for sending data to a tag. \_\_\_HTML\_TAG\_DESC\_USD\_0\_\_\_If data is not sent to the tag within the duration, data sending fails.
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| timeout | ArkTS-Dyn: number  \_\_\_HTML\_TAG\_USD\_0\_\_\_ArkTS-Sta：int | Yes | Indicates the timeout duration to be set. |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| data | ArkTS-Dyn: number[]  \_\_\_HTML\_TAG\_USD\_0\_\_\_ArkTS-Sta：int[] | Yes | Indicates the data to be written to the tag. |

**Return value:**

| Type | Description |
| --- | --- |
| ArkTS-Dyn: Promise&lt;number[]&gt;  \_\_\_HTML\_TAG\_USD\_0\_\_\_ArkTS-Sta：Promise&lt;int[]&gt; | Returns bytes received in response. Or bytes with a length of 0 if the |
