...
Operation of adding an account implicitly. Note: This API is supported since API version 8 and deprecated since API version 9. Use **ACTION\_CREATE\_ACCOUNT\_IMPLICITLY** instead.
...
Authentication operation. Note: This API is supported since API version 8 and deprecated since API version 9. Use **ACTION\_AUTH** instead.
