...
| Type | Description |
| --- | --- |
| ArkTS-Dyn: number  \_\_\_HTML\_TAG\_USD\_0\_\_\_ArkTS-Sta：double | Power consumption of the hardware unit corresponding to the power consumption type, in unit |
