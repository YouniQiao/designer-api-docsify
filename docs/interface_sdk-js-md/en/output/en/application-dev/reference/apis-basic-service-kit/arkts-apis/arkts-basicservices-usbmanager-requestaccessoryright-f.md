...
Requests the permission to access a USB accessory for a specified application. This API uses a promise to return the result. You need to call [usbManager.getAccessoryList]\_\_\_JSDOC\_LINK\_DESC\_USD\_0\_\_\_ to obtain the accessory list and use [USBAccessory]\_\_\_JSDOC\_LINK\_DESC\_USD\_1\_\_\_ as a parameter.
...
| Type | Description |
| --- | --- |
| Promise&lt;boolean&gt; | Promise used to return the application result. The value **true** indicates that the |
