...
Indicates the list of radio signals to be disabled when airplane mode is enabled. Multiple radio signals are separated by commas (,). \_\_\_HTML\_TAG\_DESC\_USD\_0\_\_\_ \_\_\_HTML\_TAG\_DESC\_USD\_1\_\_\_{@code BLUETOOTH\_RADIO} - Bluetooth is disabled in airplane mode. \_\_\_HTML\_TAG\_DESC\_USD\_2\_\_\_{@code CELL\_RADIO} - Cellular radio is disabled in airplane mode. \_\_\_HTML\_TAG\_DESC\_USD\_3\_\_\_{@code NFC\_RADIO} - NFC is disabled in airplane mode. \_\_\_HTML\_TAG\_DESC\_USD\_4\_\_\_{@code WIFI\_RADIO} - Wi-Fi is disabled in airplane mode. \_\_\_HTML\_TAG\_DESC\_USD\_5\_\_\_
...
Indicates the duration (in seconds) that the device can be discovered through Bluetooth. \_\_\_HTML\_TAG\_DESC\_USD\_0\_\_\_After the duration expires, the device cannot be discovered through Bluetooth.
...
A constant of {@code AIRPLANE\_MODE\_RADIOS} to indicate that Bluetooth is disabled in airplane mode.
...
Specifies whether Bluetooth is enabled. \_\_\_HTML\_TAG\_DESC\_USD\_0\_\_\_If the value is {@code true}, Bluetooth is enabled. If the value is {@code false}, Bluetooth is disabled.
...
A constant of {@code AIRPLANE\_MODE\_RADIOS} to indicate that cellular radio is disabled in airplane mode.
...
A constant of {@code AIRPLANE\_MODE\_RADIOS} to indicate that NFC is disabled in airplane mode.
...
Specifies whether the Wi-Fi configuration created by the application of the device owner should be locked down. \_\_\_HTML\_TAG\_DESC\_USD\_0\_\_\_If the value is {@code true}, the Wi-Fi configuration should be locked down. If the value is {@code false}, the Wi-Fi configuration should not be locked down.
...
A constant of {@code AIRPLANE\_MODE\_RADIOS} to indicate that Wi-Fi is disabled in airplane mode.
...
Specifies whether Wi-Fi is enabled. \_\_\_HTML\_TAG\_DESC\_USD\_0\_\_\_If the value is {@code true}, Wi-Fi is enabled. If the value is {@code false}, Wi-Fi is disabled.
...
Specifies whether Wi-Fi watchdog is enabled. \_\_\_HTML\_TAG\_DESC\_USD\_0\_\_\_If the value is {@code true}, Wi-Fi watchdog is enabled. If the value is {@code false}, Wi-Fi watchdog is disabled.
