...
Set settingsdata value(synchronous method). [DEVICE\_SHARED, USER\_PROPERTY] domain need ohos.permission.MANAGE\_SETTINGS permission. [USER\_SECURE] domain need ohos.permission.MANAGE\_SECURE\_SETTINGS permission.
