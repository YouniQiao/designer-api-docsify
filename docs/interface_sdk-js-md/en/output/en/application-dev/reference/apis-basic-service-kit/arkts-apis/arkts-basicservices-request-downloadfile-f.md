...
Downloads a file. This API uses an asynchronous callback to return the result. HTTP is supported. You can use [on('complete'|'pause'|'remove')]\_\_\_JSDOC\_LINK\_DESC\_USD\_1\_\_\_ to obtain the download task state, including task completion, pause, and removal. You can also use [on('fail')]\_\_\_JSDOC\_LINK\_DESC\_USD\_2\_\_\_ to obtain the task download error information. > **NOTE** > > For details about how to obtain the context in the example, see > \_\_\_MD\_LINK\_DESC\_USD\_0\_\_\_ > .
