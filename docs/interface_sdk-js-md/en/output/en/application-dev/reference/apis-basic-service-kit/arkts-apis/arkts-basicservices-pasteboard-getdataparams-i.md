...
Function for canceling the paste task. This parameter is valid only when [ProgressIndicator]\_\_\_JSDOC\_LINK\_DESC\_USD\_0\_\_\_ is set to **NONE**. This parameter is left empty by default.
