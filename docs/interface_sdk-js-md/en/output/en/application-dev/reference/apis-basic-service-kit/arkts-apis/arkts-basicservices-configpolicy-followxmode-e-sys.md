...
In user-defined mode, configuration files are obtained based on the follow rule provided by **extra**, and the **followx\_file\_list.cfg** file at each configuration level is ignored.
