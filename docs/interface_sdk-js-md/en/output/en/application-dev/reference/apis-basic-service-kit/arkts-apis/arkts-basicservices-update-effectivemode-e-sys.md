...
Hot upgrade, which takes effect without requiring restarting the device. This mode applies to scenarios where app -layer components need to be upgraded or the device needs to keep running. For details, see \_\_\_MD\_LINK\_DESC\_USD\_0\_\_\_
