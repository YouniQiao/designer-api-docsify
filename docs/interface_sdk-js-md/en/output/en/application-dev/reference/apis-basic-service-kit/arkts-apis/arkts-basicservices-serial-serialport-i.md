...
| Type | Description |
| --- | --- |
| Promise&lt;boolean&gt; | - Promise used to return the CTS signal status, indicating whether data can be |
...
| Type | Description |
| --- | --- |
| Promise&lt;boolean&gt; | Promise used to return the result. The value **true** indicates the remote end |
