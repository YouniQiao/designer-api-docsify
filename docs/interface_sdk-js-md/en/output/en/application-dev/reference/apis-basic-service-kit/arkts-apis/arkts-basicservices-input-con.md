...
Specifies whether automatic capitalization is enabled for the text editor. \_\_\_HTML\_TAG\_DESC\_USD\_0\_\_\_If the value is {@code 0}, automatic capitalization is disabled. If the value {@code 1}, automatic capitalization is enabled.
...
Specifies whether automatic punctuation is enabled for the text editor. Automatic punctuation enables the text editor to convert two spaces into a period (.) and a space. \_\_\_HTML\_TAG\_DESC\_USD\_0\_\_\_If the value is {@code 0}, automatic punctuation is disabled. If the value {@code 1}, automatic punctuation is enabled.
...
Specifies whether autocorrect is enabled for the text editor. Autocorrect enables the text editor to correct typos. \_\_\_HTML\_TAG\_DESC\_USD\_0\_\_\_If the value is {@code 0}, autocorrect is disabled. If the value {@code 1}, autocorrect is enabled.
...
Specifies whether the input method selector is visible. \_\_\_HTML\_TAG\_DESC\_USD\_0\_\_\_If the value is {@code 1}, the input method selector is visible. If the value is {@code 0}, the input method selector is invisible.
...
Specifies whether password presentation is enabled in the text editor. Password presentation enables the text editor to show password characters when the user types them. \_\_\_HTML\_TAG\_DESC\_USD\_0\_\_\_If the value is {@code 0}, password presentation is disabled. If the value {@code 1}, password presentation is enabled.
