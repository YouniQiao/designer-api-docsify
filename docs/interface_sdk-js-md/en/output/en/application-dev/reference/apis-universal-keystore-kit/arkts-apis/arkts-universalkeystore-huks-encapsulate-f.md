...
| params | \_\_\_MD\_LINK\_USD\_0\_\_\_[] | Yes | indicates the encapsulation properties. |
...
| sharedKeyParams | \_\_\_MD\_LINK\_USD\_0\_\_\_[] | No | indicates the properties of the encapsulated key.If HUKS is used for key management, this parameter must be specified.If the application manages the key itself, this parameter is ignored. |
