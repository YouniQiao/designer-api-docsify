...
| huksOptions | \_\_\_MD\_LINK\_USD\_0\_\_\_ | Yes | Empty object (leave this parameter empty). |

**Return value:**

| Type | Description |
| --- | --- |
| Promise&lt;HuksReturnResult&gt; | Promise used to return the result. If the operation is successful, |
