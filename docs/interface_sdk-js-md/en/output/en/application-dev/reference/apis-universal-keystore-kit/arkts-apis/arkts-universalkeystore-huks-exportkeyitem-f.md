...
Exports a key. This API uses an asynchronous callback to return the result. > **NOTE** > > Exporting SE security level public keys defined in [HuksKeySecurityLevel]\_\_\_JSDOC\_LINK\_DESC\_USD\_0\_\_\_ > requires the ohos.permission.ACCESS\_SE\_KEY permission.
...
Exports a key. This API uses a promise to return the result. > **NOTE** > > Exporting SE security level public keys defined in [HuksKeySecurityLevel]\_\_\_JSDOC\_LINK\_DESC\_USD\_0\_\_\_ > requires the ohos.permission.ACCESS\_SE\_KEY permission.
