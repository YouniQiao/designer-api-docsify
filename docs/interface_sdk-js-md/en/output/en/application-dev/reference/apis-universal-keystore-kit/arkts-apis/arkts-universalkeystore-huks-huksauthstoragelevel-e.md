...
Enumerates the storage security levels of a key. > **NOTE** > > When using a key whose storage level is ECE, you are advised to clear the session resources created using the key > by detecting the > \_\_\_MD\_LINK\_DESC\_USD\_0\_\_\_ > to ensure security.
