...
Enumerates the **salt\_len** types to set when PSS padding is used in RSA signing or signature verification.
...
**salt\_len** is set to the digest length.
...
**salt\_len** is set to the maximum length.
