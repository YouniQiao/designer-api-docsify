...
Imports keys in secure mode. This API uses an asynchronous callback to return the result. > **NOTE** > > Importing SE security level wrapped keys defined in [HuksKeySecurityLevel]\_\_\_JSDOC\_LINK\_DESC\_USD\_0\_\_\_ > requires the ohos.permission.ACCESS\_SE\_KEY permission.
...
| options | \_\_\_MD\_LINK\_USD\_0\_\_\_ | Yes | Tags required for the import and the wrapped key to import. The algorithm, key purpose, and key length are mandatory. |
| callback | \_\_\_MD\_LINK\_USD\_0\_\_\_&lt;void&gt; | Yes | Callback used to return the result. If the operation is successful, no **err** value is returned; otherwise, an error code is returned. |
...
Imports keys in secure mode. This API uses a promise to return the result. > **NOTE** > > Importing SE security level wrapped keys defined in [HuksKeySecurityLevel]\_\_\_JSDOC\_LINK\_DESC\_USD\_0\_\_\_ > requires the ohos.permission.ACCESS\_SE\_KEY permission.
