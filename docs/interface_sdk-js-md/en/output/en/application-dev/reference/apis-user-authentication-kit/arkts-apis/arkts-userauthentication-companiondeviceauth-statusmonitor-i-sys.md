...
Status monitor object. It is used to listen for or obtain information such as the template status, continuous authentication status, and available device status. This object can be obtained by calling [getStatusMonitor]\_\_\_JSDOC\_LINK\_DESC\_USD\_0\_\_\_.
...
| Type | Description |
| --- | --- |
| Promise&lt;TemplateStatus[]&gt; | Promise used to return the status list of all templates of the current |
