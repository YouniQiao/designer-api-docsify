...
Color of the icon. The default value is **\$r('sys.color.ohos\_id\_color\_activated')**.
...
Callback used to return the user authentication result.\_\_\_HTML\_TAG\_DESC\_USD\_1\_\_\_The application must request the \_\_\_INLINE\_CODE\_DESC\_USD\_0\_\_\_ permission. Otherwise, it will only display the icon and cannot start the identity authentication components.
