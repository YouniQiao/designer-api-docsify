...
Enumerates the intermediate states of identity authentication. This enum is used to describe various intermediate states during authentication, including authentication failure, timeout, lockout, and loading and release of the authentication screen. Applications can subscribe to these intermediate states through the [on('authTip')]\_\_\_JSDOC\_LINK\_DESC\_USD\_0\_\_\_ API to provide more refined user feedback and status awareness during authentication.
