...
Obtains detailed information of a file, including attributes such as the file size, permission mode, access time, and modification time. Before calling an API of the **Stat** class, use [stat()]\_\_\_JSDOC\_LINK\_DESC\_USD\_0\_\_\_ to create a **Stat** instance.
...
| Type | Description |
| --- | --- |
| boolean | Whether the file is a block special file. The value **true** means the file |
...
| Type | Description |
| --- | --- |
| boolean | Whether the file is a character special device. The value **true** means the file is a |
...
| Type | Description |
| --- | --- |
| boolean | Whether the file is a directory. The value **true** means the file is a directory; the value |
...
| Type | Description |
| --- | --- |
| boolean | Whether the file is an FIFO. The value **true** means the file is an FIFO; |
...
| Type | Description |
| --- | --- |
| boolean | Whether the file is a regular file. The value **true** means that |
...
| Type | Description |
| --- | --- |
| boolean | Whether the file is a socket. The value **true** means that the file is a socket; the value |
...
| Type | Description |
| --- | --- |
| boolean | Whether the file is a symbolic link. The value **true** means that the file is a symbolic |
