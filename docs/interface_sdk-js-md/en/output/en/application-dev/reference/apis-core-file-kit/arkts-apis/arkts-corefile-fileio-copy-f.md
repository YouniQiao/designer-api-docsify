...
| options | \_\_\_MD\_LINK\_USD\_0\_\_\_ | No | Callback invoked to provide the copy progress. If this parameter is not set, the callback will not be invoked. |
...
| srcUri | string | Yes | URI of the file or directory to copy. |
| destUri | string | Yes | URI of the destination file or directory. |
| callback | \_\_\_MD\_LINK\_USD\_0\_\_\_&lt;void&gt; | Yes | Callback used to return the result. If the copy is successful, **err** is **undefined**. Otherwise, **err** is an error object. |
