...
Defines a readable stream. You need to use [fileIo.createReadStream]\_\_\_JSDOC\_LINK\_DESC\_USD\_0\_\_\_ to create a **ReadStream** instance, which is inherited from [stream.Readable]\_\_\_JSDOC\_LINK\_DESC\_USD\_1\_\_\_. The data obtained by **ReadStream** is a decoded string. Currently, only the UTF-8 format is supported.
