...
Size of the downloaded data, in bytes. The value range is [0, INT64\_MAX). If the progress is abnormal, **INT64\_MAX** is returned.
...
Number of files that fail to be downloaded. The value range is [0, INT32\_MAX]. If the progress is abnormal, **-1** is returned.
...
Total size of the files to be downloaded, in bytes. The value range is [0, INT64\_MAX). If the progress is abnormal, **INT64\_MAX** is returned.
