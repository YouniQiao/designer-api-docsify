...
Opens a stream based on an FD. This API uses a promise to return the result. To close the stream, use **close()** of [Stream]\_\_\_JSDOC\_LINK\_DESC\_USD\_0\_\_\_.
...
Opens a stream based on an FD. This API uses an asynchronous callback to return the result. To close the stream, use **close()** of [Stream]\_\_\_JSDOC\_LINK\_DESC\_USD\_0\_\_\_.
