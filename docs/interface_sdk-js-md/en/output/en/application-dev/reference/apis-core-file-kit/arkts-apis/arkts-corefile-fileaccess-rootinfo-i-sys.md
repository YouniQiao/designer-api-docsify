...
Obtains a **FileIterator** object that recursively retrieves the files matching the specified conditions from the device root directory. This API returns the result synchronously. [FileInfo]\_\_\_JSDOC\_LINK\_DESC\_USD\_0\_\_\_ is returned by [next]\_\_\_JSDOC\_LINK\_DESC\_USD\_1\_\_\_. Currently, this API supports only built-in storage devices.
