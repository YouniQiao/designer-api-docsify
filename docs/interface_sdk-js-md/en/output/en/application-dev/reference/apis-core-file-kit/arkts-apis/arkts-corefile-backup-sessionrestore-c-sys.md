...
| --- | --- | --- | --- |
| remoteCapabilitiesFd | ArkTS-Dyn: number  \_\_\_HTML\_TAG\_USD\_0\_\_\_ArkTS-Sta：int | Yes | Opened JSON file that stores remote device capabilities. |
...
| Type | Description |
| --- | --- |
| Promise&lt;FileData&gt; | Promise used to return A FileData holding the file descriptor. The returned |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| fileMeta | \_\_\_MD\_LINK\_USD\_0\_\_\_ | Yes | Metadata of the file to be sent. Note that all the files should come |
...
| Type | Description |
| --- | --- |
| Promise&lt;FileData&gt; | A FileData holding all the local capabilities. The returned file is a temporal file that will be |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| fileMeta | \_\_\_MD\_LINK\_USD\_0\_\_\_ | Yes | Metadata of the file to be sent. Make sure that the backup framework holds |
