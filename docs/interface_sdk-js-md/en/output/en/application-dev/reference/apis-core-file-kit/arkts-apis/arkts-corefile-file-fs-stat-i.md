...
Represents detailed file information. Before calling any API of the **Stat()** class, use \_\_\_MD\_LINK\_DESC\_USD\_0\_\_\_ to create a **Stat** instance.
...
| Type | Description |
| --- | --- |
| boolean | Whether the file is a block special file. The value **true** means the file is a block special |
...
| Type | Description |
| --- | --- |
| boolean | Whether the file is an FIFO. The value **true** means the file is an FIFO; the value **false** |
...
| Type | Description |
| --- | --- |
| boolean | Whether the file is a regular file. The value **true** means that the file is a regular file; |
...
| Type | Description |
| --- | --- |
| boolean | Whether the file is a symbolic link. The value **true** means that the file is a symbolic link |
