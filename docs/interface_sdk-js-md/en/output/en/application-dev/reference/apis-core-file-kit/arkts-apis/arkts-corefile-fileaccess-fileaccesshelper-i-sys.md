...
| Type | Description |
| --- | --- |
| Promise&lt;Array&lt;CopyResult&gt;&gt; | Promise used to return the result. If the file or directory is copied |
...
Obtains information about the device root nodes of the file management services associated with the **Helper** object. This API uses a promise to return a **RootIterator** object. You can use [next]\_\_\_JSDOC\_LINK\_DESC\_USD\_0\_\_\_ to return [RootInfo]\_\_\_JSDOC\_LINK\_DESC\_USD\_1\_\_\_.
...
Obtains information about the device root nodes of the file management services associated with the **Helper** object. This API uses an asynchronous callback to return a **RootIterator** object. You can use [next]\_\_\_JSDOC\_LINK\_DESC\_USD\_0\_\_\_ to return [RootInfo]\_\_\_JSDOC\_LINK\_DESC\_USD\_1\_\_\_.
...
| Type | Description |
| --- | --- |
| Promise&lt;string&gt; | Promise used to return the URI of the file or directory in the destination |
...
| Type | Description |
| --- | --- |
| Promise&lt;Array&lt;MoveResult&gt;&gt; | Promise used to return the result. If the operation is successful, no |
...
| Type | Description |
| --- | --- |
| Promise&lt;string&gt; | Promise used to return a JSON string that contains the file attribute and the value |
