...
Provides APIs for managing the system albums. This API will be deprecated. Use [Album]\_\_\_JSDOC\_LINK\_DESC\_USD\_0\_\_\_ instead.
...
Deletes a file from the system album. Only the files in the trash can be deleted. This API uses an asynchronous callback to return the result. This API will be deprecated. Use [Album.deletePhotoAssets]\_\_\_JSDOC\_LINK\_DESC\_USD\_0\_\_\_ instead.
...
Deletes a file from the system album. Only the files in the trash can be deleted. This API uses a promise to return the result. This API will be deprecated. Use [Album.deletePhotoAssets]\_\_\_JSDOC\_LINK\_DESC\_USD\_0\_\_\_ instead.
...
Recovers a file in the system album. Only the files in the trash can be recovered. This API uses an asynchronous callback to return the result. This API will be deprecated. Use [Album.recoverPhotoAssets]\_\_\_JSDOC\_LINK\_DESC\_USD\_0\_\_\_ instead.
...
Recovers a file in the system album. Only the files in the trash can be recovered. This API uses a promise to return the result. This API will be deprecated. Use [Album.recoverPhotoAssets]\_\_\_JSDOC\_LINK\_DESC\_USD\_0\_\_\_ instead.
