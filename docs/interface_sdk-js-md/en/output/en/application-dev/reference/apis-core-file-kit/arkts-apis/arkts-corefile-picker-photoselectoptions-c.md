...
Media file types to select. If this parameter is not specified, **IMAGE\_VIDEO\_TYPE** is used by default. **Note**: This API is supported since API version 9 and deprecated since API version 18.
