...
Adds an asset in the specified user space. This API uses a promise to return the result. To set \_\_\_JSDOC\_LINK\_DESC\_USD\_0\_\_\_, the application must have the ohos.permission.STORE\_PERSISTENT\_DATA permission.
