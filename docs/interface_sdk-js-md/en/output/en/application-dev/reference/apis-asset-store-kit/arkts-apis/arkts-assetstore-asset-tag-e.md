...
Sorting order of the query results. Currently, the results can be sorted only by **ASSET\_TAG\_DATA\_LABEL**. **Note**: By default, assets are returned in the order in which they are added.
