...
Queries one or more assets. If user authentication is required for the access to the asset, call [asset.preQuerySync]\_\_\_JSDOC\_LINK\_DESC\_USD\_1\_\_\_ before this API and call [asset.postQuerySync]\_\_\_JSDOC\_LINK\_DESC\_USD\_2\_\_\_ after this API. For details about the development procedure, see \_\_\_MD\_LINK\_DESC\_USD\_0\_\_\_. This API returns the result synchronously. If no asset is found, an exception indicating that no asset is found is thrown instead of returning an empty query result list.
