...
Adds an asset. This API returns the result synchronously. To set \_\_\_JSDOC\_LINK\_DESC\_USD\_0\_\_\_, the application must have the ohos.permission.STORE\_PERSISTENT\_DATA permission.
