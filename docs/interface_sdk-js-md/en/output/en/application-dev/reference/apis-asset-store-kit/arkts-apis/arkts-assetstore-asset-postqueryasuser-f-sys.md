...
Performs postprocessing for the asset query in the specified user space. This API is used when user authentication is required for the access to an asset. This API must be used with [asset.preQueryAsUser]\_\_\_JSDOC\_LINK\_DESC\_USD\_0\_\_\_ together. This API uses a promise to return the result.
