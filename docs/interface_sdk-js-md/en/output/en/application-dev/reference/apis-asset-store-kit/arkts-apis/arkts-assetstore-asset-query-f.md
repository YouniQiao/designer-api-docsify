...
Queries one or more assets. If user authentication is required for the access to the asset, call [asset.preQuery]\_\_\_JSDOC\_LINK\_DESC\_USD\_1\_\_\_ before this API and call [asset.postQuery]\_\_\_JSDOC\_LINK\_DESC\_USD\_2\_\_\_ after this API. For details about the development procedure, see \_\_\_MD\_LINK\_DESC\_USD\_0\_\_\_. This API uses a promise to return the result. If no asset is found, an exception indicating that no asset is found is thrown instead of returning an empty query result list.
