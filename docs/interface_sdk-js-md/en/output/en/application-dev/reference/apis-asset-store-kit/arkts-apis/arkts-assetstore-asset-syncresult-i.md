...
Sync result code of an asset. If the sync is successful, the result code is **0**. If the sync fails, see [ErrorCode]\_\_\_JSDOC\_LINK\_DESC\_USD\_0\_\_\_ for the result code.
