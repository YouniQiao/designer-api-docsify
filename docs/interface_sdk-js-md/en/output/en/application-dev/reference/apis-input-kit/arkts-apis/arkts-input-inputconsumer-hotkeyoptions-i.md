...
Modified key, which can be any key except the modifier keys and Meta key. For details about the keys, see [@ohos.multimodalInput.keyCode (Keycode)]\_\_\_JSDOC\_LINK\_DESC\_USD\_0\_\_\_. For example, in **Ctrl+Shift+Esc**, **Esc** is the modifier key.
