...
| [on](arkts-input-inputmonitor-on-f-sys.md#on-13) | Listens for the press and release events of the specified key, which can be the **META\_\_\_ESCAPED\_UNDERSCORE\_\_\_LEFT**, **META\_\_\_ESCAPED\_UNDERSCORE\_\_\_RIGHT**, power, or volume key. This API uses an asynchronous callback to return the result. |
