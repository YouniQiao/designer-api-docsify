...
Obtains the IDs of all input devices. This API uses an asynchronous callback to return the result. > **NOTE** > > This API is supported since API version 8 and deprecated since API version 9. Use > [inputDevice.getDeviceList]\_\_\_JSDOC\_LINK\_DESC\_USD\_0\_\_\_ instead.
...
Obtains the IDs of all input devices. This API uses a promise to return the result. > **NOTE** > > This API is supported since API version 8 and deprecated since API version 9. Use > [inputDevice.getDeviceList]\_\_\_JSDOC\_LINK\_DESC\_USD\_0\_\_\_ instead.
...
| Type | Description |
| --- | --- |
| Promise&lt;Array&lt;number&gt;&gt; | Promise used to return the IDs of all input devices. **id** is the unique ID of |
