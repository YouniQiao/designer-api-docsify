...
| Type | Description |
| --- | --- |
| ArkTS-Dyn: Promise&lt;number&gt;  \_\_\_HTML\_TAG\_USD\_0\_\_\_ArkTS-Sta：Promise&lt;int&gt; | Promise used to return the stream volume level. The volume range of a specified stream |
...
| Type | Description |
| --- | --- |
| ArkTS-Dyn: number  \_\_\_HTML\_TAG\_USD\_0\_\_\_ArkTS-Sta：int | Volume level of the stream. The volume range of a specified stream can be obtained by calling |
...
| Type | Description |
| --- | --- |
| boolean | Check result for whether the fixed volume mode is enabled. **true** if enabled, **false** |
...
Subscribes to the ringer mode change event, which is triggered when the [AudioRingMode]\_\_\_JSDOC\_LINK\_DESC\_USD\_0\_\_\_ changes. This API uses an asynchronous callback to return the result.
