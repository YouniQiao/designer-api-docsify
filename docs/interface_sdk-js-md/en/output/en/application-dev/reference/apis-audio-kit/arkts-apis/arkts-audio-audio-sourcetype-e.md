...
Voice communication source. (The 3A algorithm is not enabled if recording is started independently. It is enabled when the AudioRenderer of the [STREAM\_USAGE\_VOICE\_COMMUNICATION]\_\_\_JSDOC\_LINK\_DESC\_USD\_0\_\_\_ or [STREAM\_USAGE\_VIDEO\_COMMUNICATION]\_\_\_JSDOC\_LINK\_DESC\_USD\_1\_\_\_ type is also used to start playback.)
