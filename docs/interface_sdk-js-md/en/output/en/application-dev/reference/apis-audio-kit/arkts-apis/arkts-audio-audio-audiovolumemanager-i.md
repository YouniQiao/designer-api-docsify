...
This interface implements audio volume management. Before calling any API in AudioVolumeManager, you must use [getVolumeManager]\_\_\_JSDOC\_LINK\_DESC\_USD\_0\_\_\_ to obtain an AudioVolumeManager instance. > **NOTE** > > - The initial APIs of this interface are supported since API version 9.
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| callback | \_\_\_MD\_LINK\_USD\_0\_\_\_&lt;StreamVolumeEvent&gt; | No | Callback used to obtain the invoking volume change event. |
