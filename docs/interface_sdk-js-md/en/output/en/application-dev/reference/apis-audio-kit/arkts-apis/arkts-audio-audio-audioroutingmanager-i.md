...
| Type | Description |
| --- | --- |
| Promise&lt;AudioDeviceDescriptors&gt; | Promise used to return the information about the output device with |
...
| Type | Description |
| --- | --- |
| Promise&lt;AudioDeviceDescriptors&gt; | Promise used to return the information about the input device with |
...
| Type | Description |
| --- | --- |
| Promise&lt;boolean&gt; | Promise used to return the result, indicating the support for microphone blocking |
...
Sets a communication device to the active state. This API uses an asynchronous callback to return the result. This API will be deprecated in a later version due to function design is changed. You are not advised to use it. You are advised to use the \_\_\_MD\_LINK\_DESC\_USD\_0\_\_\_ provided by AVSession to switch between call devices.
...
Sets a communication device to the active state. This API uses a promise to return the result. This API will be deprecated in a later version due to function design is changed. You are not advised to use it. You are advised to use the \_\_\_MD\_LINK\_DESC\_USD\_0\_\_\_ provided by AVSession to switch between call devices.
