...
The audio stream can be recorded or screen-projected by other applications and is privacy-related. For example, if the privacy policy is **PRIVACY\_TYPE\_PUBLIC**, audio streams of the [STREAM\_USAGE\_VOICE\_COMMUNICATION]\_\_\_JSDOC\_LINK\_DESC\_USD\_0\_\_\_ type cannot be recorded or screen-projected by other applications. However, if the privacy policy is **PRIVACY\_TYPE\_SHARED**, these audio streams can be recorded or screen- projected by other applications.
