...
| callback | \_\_\_MD\_LINK\_USD\_0\_\_\_&lt;void&gt; | Yes | Callback invoked for the event. |
...
Reads the latest image from the ImageReceiver instance. This API uses a promise to return the result. > **NOTE** > > This API can be called to receive data only after the [on]\_\_\_JSDOC\_LINK\_DESC\_USD\_0\_\_\_ callback is > triggered. When the [Image]\_\_\_JSDOC\_LINK\_DESC\_USD\_1\_\_\_ object returned by this API is no longer needed, > call [release]\_\_\_JSDOC\_LINK\_DESC\_USD\_2\_\_\_ to release the object. New data can be received only after > the release.
