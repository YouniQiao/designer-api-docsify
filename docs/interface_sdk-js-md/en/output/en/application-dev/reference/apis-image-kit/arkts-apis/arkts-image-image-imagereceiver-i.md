...
The **ImageReceiver** class provides APIs to obtain the surface ID of a component, read the latest image, read the next image, and release the ImageReceiver instance. The ImageReceiver acts as the receiver and consumer of images. Its parameter properties do not actually affect the received images. The configuration of image properties should be done on the sending side (the producer), such as when creating a camera preview stream with [createPreviewOutput]\_\_\_JSDOC\_LINK\_DESC\_USD\_0\_\_\_ . Before calling any APIs in ImageReceiver, you must use [image.createImageReceiver]\_\_\_JSDOC\_LINK\_DESC\_USD\_1\_\_\_ to create an ImageReceiver instance. Since API version 23, you are advised to use [image.createImageReceiver]\_\_\_JSDOC\_LINK\_DESC\_USD\_2\_\_\_ to create an **ImageReceiver** instance based on the passed [ImageReceiverOptions]\_\_\_JSDOC\_LINK\_DESC\_USD\_3\_\_\_. Images occupy a large amount of memory. When you finish using an ImageReceiver instance, call [release]\_\_\_JSDOC\_LINK\_DESC\_USD\_4\_\_\_ to free the memory promptly. Before releasing the instance, ensure that all asynchronous operations associated with the instance have finished and the instance is no longer needed.
