...
| Type | Description |
| --- | --- |
| Promise&lt;\_\_\_MD\_LINK\_USD\_0\_\_\_&gt; | Promise used to return the **MakerNoteHuaweiMetadata** metadata |
...
| Type | Description |
| --- | --- |
| Promise&lt;Record&lt;string, string \| null&gt;&gt; | Promise used to return the obtained image metadata property |
...
Sets the values of specified properties in image metadata in batches. This API returns the result asynchronously through a promise. For details about the properties, see [PropertyKey]\_\_\_JSDOC\_LINK\_DESC\_USD\_0\_\_\_.
