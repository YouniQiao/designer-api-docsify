...
Enumerates the types of Exchangeable Image File Format (Exif) data of an image. - The key in the format example is **image.PropertyKey.*XXX*** (where *XXX* is the name of an enumeration name, for example, **image.PropertyKey.NEW\_SUBFILE\_TYPE**). - The format example is used only to show how to modify values and read results. For details about how to use them, see [modifyImageProperty]\_\_\_JSDOC\_LINK\_DESC\_USD\_0\_\_\_ (to modify a single Exif field), [modifyImageProperties]\_\_\_JSDOC\_LINK\_DESC\_USD\_1\_\_\_ (to modify multiple Exif fields), [getImageProperty]\_\_\_JSDOC\_LINK\_DESC\_USD\_2\_\_\_ (to read a single Exif field), and [getImageProperties]\_\_\_JSDOC\_LINK\_DESC\_USD\_3\_\_\_ ( to read multiple Exif fields).
