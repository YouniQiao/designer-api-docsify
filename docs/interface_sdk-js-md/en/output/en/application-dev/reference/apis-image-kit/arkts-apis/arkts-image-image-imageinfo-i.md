...
Whether the image is an HDR image. The value **true** means an HDR image, and **false** means an SDR image. For [ImageSource]\_\_\_JSDOC\_LINK\_DESC\_USD\_0\_\_\_, this parameter specifies whether the source image is in HDR format. For [PixelMap]\_\_\_JSDOC\_LINK\_DESC\_USD\_1\_\_\_, this parameter specifies whether the decoded PixelMap is in HDR format.
...
Actual image format (MIME type). The supported formats for image decoding and image encoding are different. Do not directly use the actual image format obtained after decoding as the value of **format** in [PackingOption]\_\_\_JSDOC\_LINK\_DESC\_USD\_0\_\_\_ during image encoding. You can use the **supportedFormats** property of [ImageSource]\_\_\_JSDOC\_LINK\_DESC\_USD\_1\_\_\_ and [ImagePacker]\_\_\_JSDOC\_LINK\_DESC\_USD\_2\_\_\_ to view the supported formats for decoding and encoding.
