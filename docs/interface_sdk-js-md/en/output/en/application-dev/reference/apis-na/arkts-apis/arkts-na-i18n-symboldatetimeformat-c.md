...
**Inheritance/Implementation:** SymbolDateTimeFormat extends [Intl.DateTimeFormat](arkts-na-intl-datetimeformat-i.md)
...
| Type | Description |
| --- | --- |
| long | Unix timestamp, which indicates the number of milliseconds that have elapsed since |
