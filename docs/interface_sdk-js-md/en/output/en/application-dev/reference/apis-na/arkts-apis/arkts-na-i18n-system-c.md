...
| Type | Description |
| --- | --- |
| string | If language is not passed, the application checks for dialects supported by the system based |
...
| Type | Description |
| --- | --- |
| boolean | Whether use of local digits is enabled. The value "true" indicates that use of local digits |
...
| Type | Description |
| --- | --- |
| boolean | Whether the 24-hour clock is used. The value "true" indicates that the 24-hour clock is |
...
| Type | Description |
| --- | --- |
| boolean | Whether a language is a suggested language. The value "true" indicates that the language |
