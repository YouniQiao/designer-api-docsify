...
Implements a GeolocationPermissions object. \_\_\_HTML\_TAG\_DESC\_USD\_0\_\_\_\_\_\_HTML\_TAG\_DESC\_USD\_1\_\_\_API Note\_\_\_HTML\_TAG\_DESC\_USD\_2\_\_\_:\_\_\_HTML\_TAG\_DESC\_USD\_3\_\_\_ You must load the Web component before calling the APIs in GeolocationPermissions. \_\_\_HTML\_TAG\_DESC\_USD\_4\_\_\_
...
| Type | Description |
| --- | --- |
| Promise&lt;boolean&gt; | A Promise instance that obtains the permission |
...
| --- | --- | --- | --- |
| origin | string | Yes | Url source. |
| callback | \_\_\_MD\_LINK\_USD\_0\_\_\_&lt;boolean&gt; | Yes | Returns the geolocation permission status for the specified source. Successful acquisition,true means authorized, false means access is denied. Failed to get, indicating that the permission status of the specified source does not exist. |
| incognito | boolean | No | {@code true} gets the geolocation permission status of the specified source in incognito mode; {@code false} otherwise. |
...
| Type | Description |
| --- | --- |
| Promise&lt;Array&lt;string&gt;&gt; | A Promise instance that gets all source information about |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| callback | \_\_\_MD\_LINK\_USD\_0\_\_\_&lt;Array&lt;string&gt;&gt; | Yes | Returns all source information for stored geolocation permission states. |
