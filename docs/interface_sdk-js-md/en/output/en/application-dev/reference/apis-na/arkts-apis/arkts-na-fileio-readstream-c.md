...
Defines a readable stream. You need to use fs.createReadStream to create a ReadStream instance, which is inherited from the stream base class. The data obtained by ReadStream is a decoded string. Currently, only the UTF-8 format is supported.
...
| whence | \_\_\_MD\_LINK\_USD\_0\_\_\_ | No | = WhenceType.SEEK\_\_\_ESCAPED\_UNDERSCORE\_\_\_SET] - Where to start the offset. The default value is SEEK\_\_\_ESCAPED\_UNDERSCORE\_\_\_SET, |

**Return value:**

| Type | Description |
| --- | --- |
| long | Returns the offset relative to starting position of stream, in bytes. |
