...
User ID, which must be greater than or equal to 0. You can call [getOsAccountLocalId]\_\_\_JSDOC\_LINK\_DESC\_USD\_0\_\_\_ of **@ohos.account.osAccount** to obtain the user ID.
...
The [unique identifier]\_\_\_JSDOC\_LINK\_DESC\_USD\_0\_\_\_ of an application. If an application does not have **appIdentifier**, **appId** can be used instead. Both **bundleInfo.signatureInfo.appIdentifier** and **bundleInfo.signatureInfo.appId** can be obtained via the [bundleManager.getBundleInfo]\_\_\_JSDOC\_LINK\_DESC\_USD\_1\_\_\_ API.
