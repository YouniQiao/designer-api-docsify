...
Installs specified applications. This API uses a promise to return the result. This API can be used to install only applications of the **enterprise\_mdm** (MDM application) or **enterprise\_normal** (common enterprise application) distribution type. You can call the [getBundleInfoForSelf]\_\_\_JSDOC\_LINK\_DESC\_USD\_0\_\_\_ API to query the [BundleInfo]\_\_\_JSDOC\_LINK\_DESC\_USD\_1\_\_\_ of an application, where **BundleInfo.appInfo.appDistributionType** indicates the distribution type. Since API version 26.0.0, you are advised to use [installForResult]\_\_\_JSDOC\_LINK\_DESC\_USD\_2\_\_\_ to obtain more detailed error code return values. > **NOTE** > > This API is time-consuming. Subsequent calls to other synchronous APIs in the application main thread must wait > for the asynchronous return of this API.
