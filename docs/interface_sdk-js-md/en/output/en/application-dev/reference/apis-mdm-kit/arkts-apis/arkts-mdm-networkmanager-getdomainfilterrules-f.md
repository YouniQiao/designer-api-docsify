...
| Type | Description |
| --- | --- |
| Array&lt;DomainFilterRule&gt; | A list of domain name filtering rules configured for the device is returned. |
