...
| Type | Description |
| --- | --- |
| Promise&lt;void&gt; | Promise that returns no value. When a log collection task fails to be created, an error |
