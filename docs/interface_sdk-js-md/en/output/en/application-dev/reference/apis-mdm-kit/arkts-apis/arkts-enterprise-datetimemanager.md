...
The **dateTimeManager** module provides APIs for system time management. > **NOTE** > > The APIs of this module are available only to > \_\_\_MD\_LINK\_DESC\_USD\_0\_\_\_, and can be > called only after the device administrator application is activated via > [enableAdmin]\_\_\_JSDOC\_LINK\_DESC\_USD\_1\_\_\_.
