...
| autoStartApp | \_\_\_MD\_LINK\_USD\_0\_\_\_ | Yes | Auto-start applications to add. **Want** must contain **bundleName** and **abilityName**. |
...
| Type | Description |
| --- | --- |
| boolean | Whether the user is prohibited from canceling application auto-startup. The value **true** |
