...
| callback | \_\_\_MD\_LINK\_USD\_0\_\_\_&lt;EnterpriseInfo&gt; | Yes | Callback invoked to return the result. If the operation is successful, **err** is **null** and **data** is the enterprise information of the device administrator application obtained. If the operation fails, **err** is an error object. |
...
| Type | Description |
| --- | --- |
| Promise&lt;EnterpriseInfo&gt; | Promise used to return the enterprise information of the device administrator |
