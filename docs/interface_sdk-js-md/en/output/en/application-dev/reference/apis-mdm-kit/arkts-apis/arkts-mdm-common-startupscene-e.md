...
Startup wizard completion scenario. When the initial switch to a sub-user (only on PCs), OTA upgrade, and first- time startup wizard are complete, the device system calls the [onStartupGuideCompleted]\_\_\_JSDOC\_LINK\_DESC\_USD\_0\_\_\_ API to notify the device administrator application.
