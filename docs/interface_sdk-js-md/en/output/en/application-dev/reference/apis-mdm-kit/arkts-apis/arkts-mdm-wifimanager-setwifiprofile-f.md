...
**Substitutes:** [wifiManager.setWifiProfileSync](arkts-mdm-wifimanager-setwifiprofilesync-f.md#setwifiprofilesync)
...
| profile | \_\_\_MD\_LINK\_USD\_0\_\_\_ | Yes | Wi-Fi configuration information. |
...
| Type | Description |
| --- | --- |
| Promise&lt;void&gt; | Promise that returns no value. An error object is thrown if the Wi-Fi fails to be |
