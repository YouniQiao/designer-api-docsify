...
Removes the USB device types that have been disallowed via [addDisallowedPermissiveUsbDevices]\_\_\_JSDOC\_LINK\_DESC\_USD\_0\_\_\_. The removed USB device types can be used normally.
