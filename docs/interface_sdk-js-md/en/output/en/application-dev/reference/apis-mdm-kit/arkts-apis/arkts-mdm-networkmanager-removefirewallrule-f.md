...
Removes a firewall rule. This API is suitable for enterprise network security policy adjustment scenarios, such as canceling certain network access restrictions, adjusting firewall policies, and clearing outdated or invalid rules. It helps enterprises flexibly adjust network security policies and ensure that network access control policies meet actual requirements. In API version 21 and earlier versions, only IPv4 is supported. IPv4 and IPv6 are supported since API version 22. [LogType]\_\_\_JSDOC\_LINK\_DESC\_USD\_0\_\_\_ is supported since API version 23. If there is no rule with [Action]\_\_\_JSDOC\_LINK\_DESC\_USD\_1\_\_\_ being **ALLOW** after the rule is removed, the **DENY** rules that are added by default with [addFirewallRule]\_\_\_JSDOC\_LINK\_DESC\_USD\_2\_\_\_ will be removed.
...
| firewallRule | \_\_\_MD\_LINK\_USD\_0\_\_\_ | No | Firewall rule to remove. If the value is empty, all firewall rules will be removed. |
