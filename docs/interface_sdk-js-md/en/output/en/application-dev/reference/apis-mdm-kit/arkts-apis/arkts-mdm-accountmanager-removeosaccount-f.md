...
Removes a system account. Currently, this API is supported only on phones and tablets. It can remove normal system accounts (of the normal type) created via [createNormalOsAccount]\_\_\_JSDOC\_LINK\_DESC\_USD\_0\_\_\_ and system accounts (of the admin, normal, and guest types) created via [addOsAccountAsync]\_\_\_JSDOC\_LINK\_DESC\_USD\_1\_\_\_. The default system account (ID: 100) cannot be removed.
