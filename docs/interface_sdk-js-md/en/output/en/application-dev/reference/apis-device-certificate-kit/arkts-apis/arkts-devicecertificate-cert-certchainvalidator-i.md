...
Validates an X.509 certificate chain. This API uses an asynchronous callback to return the result. \_\_\_HTML\_TAG\_DESC\_USD\_2\_\_\_Because the system time on the device is untrusted, the certificate chain validator does not verify the certificate validity period. To check the validity period of a certificate, use the [checkValidityWithDate()]\_\_\_JSDOC\_LINK\_DESC\_USD\_1\_\_\_ API of the **X509Cert** class. For details about certificate specifications, see \_\_\_MD\_LINK\_DESC\_USD\_0\_\_\_ .
...
| --- | --- | --- | --- |
| certChain | \_\_\_MD\_LINK\_USD\_0\_\_\_ | Yes | Serialized X.509 certificate chain data. |
...
Validates an X.509 certificate chain. This API uses a promise to return the result. \_\_\_HTML\_TAG\_DESC\_USD\_2\_\_\_Because the system time on the device is untrusted, the certificate chain validator does not verify the certificate validity period. To check the validity period of a certificate, use the [checkValidityWithDate()]\_\_\_JSDOC\_LINK\_DESC\_USD\_1\_\_\_ API of the **X509Cert** class. For details about certificate specifications, see \_\_\_MD\_LINK\_DESC\_USD\_0\_\_\_ .
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| cert | \_\_\_MD\_LINK\_USD\_0\_\_\_ | Yes | Certificate to verify. |
| params | \_\_\_MD\_LINK\_USD\_0\_\_\_ | Yes | Certificate validation parameters. |
