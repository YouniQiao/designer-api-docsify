...
Padding mode for an RSA signature. The default value is **PKCS1\_PADDING**. \_\_\_HTML\_TAG\_DESC\_USD\_0\_\_\_When **PKCS1\_PSS\_PADDING** is set, **mdName** must be set to **SHA256**, **SHA384**, or **SHA512**. > **NOTE** > > This parameter is valid only when the private key type of the signature is RSA.
