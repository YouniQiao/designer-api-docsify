...
Custom extended parameters. If the input parameter name and value do not meet the specifications, extended parameters are not configured by default. The specifications are as follows: \_\_\_HTML\_TAG\_DESC\_USD\_0\_\_\_- A parameter name is a string that contains a maximum of 32 characters, including digits (0 to 9), letters (a to z)(A to Z), underscore (\_), and dollar sign (\$). It must start with a letter or dollar sign (\$) and end with a digit or letter. \_\_\_HTML\_TAG\_DESC\_USD\_1\_\_\_- A parameter value is a string contains a maximum of 1024 characters. \_\_\_HTML\_TAG\_DESC\_USD\_2\_\_\_- The number of parameters must be less than 32. **Atomic service API**: This parameter can be used in atomic services since API version 12.
...
Name array of user IDs that can be reported by the data processor. **name** corresponds to the **name** parameter of the [setUserId]\_\_\_JSDOC\_LINK\_DESC\_USD\_0\_\_\_ API. The default value is an empty array. **Atomic service API**: This parameter can be used in atomic services since API version 11.
...
Name array of user properties that can be reported by the data processor. **name** corresponds to the **name** parameter of the [setUserProperty]\_\_\_JSDOC\_LINK\_DESC\_USD\_0\_\_\_ API. The default value is an empty array. **Atomic service API**: This parameter can be used in atomic services since API version 11.
