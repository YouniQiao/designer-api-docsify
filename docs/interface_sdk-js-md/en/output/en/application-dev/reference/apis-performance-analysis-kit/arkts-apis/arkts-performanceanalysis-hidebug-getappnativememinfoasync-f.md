...
Obtains the memory information of application processes by reading the data of the **\/proc/{pid}/smaps\_rollup** and **\/proc/{pid}/statm** nodes. This API uses a promise to return the result.
