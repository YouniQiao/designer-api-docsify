...
Obtains the memory information of the application process. This API is implemented by reading data from the **\/proc/{pid}/smaps\_rollup and /proc/{pid}/statm** node. > **NOTE** > > Reading the **\/proc/{pid}/smaps\_rollup** node takes a long time. You are advised to use the asynchronous API > [hidebug.getAppNativeMemInfoAsync]\_\_\_JSDOC\_LINK\_DESC\_USD\_0\_\_\_ to avoid frame loss or frame freezing. > > You are advised to use the [hidebug.getRssInfo]\_\_\_JSDOC\_LINK\_DESC\_USD\_1\_\_\_ API to obtain the RSS information of an > application.
