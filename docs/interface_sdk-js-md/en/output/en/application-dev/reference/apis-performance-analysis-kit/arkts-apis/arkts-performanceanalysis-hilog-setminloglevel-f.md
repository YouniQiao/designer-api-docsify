...
Sets the minimum log level. > **NOTE** > > If the set log level is lower than the > \_\_\_MD\_LINK\_DESC\_USD\_0\_\_\_, the setting does not take effect. > > This function does not take effect for debug applications.
