...
This module implements the delayed fault notification feature. When the crash and freeze events are subscribed by [HiAppEvent]\_\_\_JSDOC\_LINK\_DESC\_USD\_1\_\_\_, the previous event can be received only after the application restarts. If the application fails to start or remains unresponsive for a long time, the fault may not be reported in time. > **NOTE** > > - The APIs of this module can be used only in the stage model. > > - Exceptions may occur if some APIs are called by this module. For details, see > \_\_\_MD\_LINK\_DESC\_USD\_0\_\_\_ > .
...
Context of the FaultLogExtensionAbility. This context is inherited from [ExtensionContext]\_\_\_JSDOC\_LINK\_DESC\_USD\_0\_\_\_.
