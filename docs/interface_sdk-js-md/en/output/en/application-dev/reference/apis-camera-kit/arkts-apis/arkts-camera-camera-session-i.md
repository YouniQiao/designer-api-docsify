...
**Session** implements a session, which saves all [CameraInput]\_\_\_JSDOC\_LINK\_DESC\_USD\_0\_\_\_ and [CameraOutput]\_\_\_JSDOC\_LINK\_DESC\_USD\_1\_\_\_ instances required to run the camera and requests the camera to take a photo or record a video.
...
Checks whether a **CameraInput** instance can be added to this session. This API must be called after [beginConfig]\_\_\_JSDOC\_LINK\_DESC\_USD\_0\_\_\_ and before [commitConfig]\_\_\_JSDOC\_LINK\_DESC\_USD\_1\_\_\_.
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| cameraInput | \_\_\_MD\_LINK\_USD\_0\_\_\_ | Yes | **CameraInput** instance to add. The API does not take effect if the input parameter is invalid (for example, the value is out of range, null, or undefined). |

**Return value:**

| Type | Description |
| --- | --- |
| boolean | Check result for adding the **CameraInput** instance. **true** if it can be added, **false** |
...
Determines whether a CameraOutput instance can be added to this session. This API must be called after [addInput]\_\_\_JSDOC\_LINK\_DESC\_USD\_0\_\_\_ and before [commitConfig]\_\_\_JSDOC\_LINK\_DESC\_USD\_1\_\_\_.
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| cameraOutput | \_\_\_MD\_LINK\_USD\_0\_\_\_ | Yes | **CameraOutput** instance to add. The API does not take effect if the input parameter is invalid (for example, the value is out of range, null, or undefined). |

**Return value:**

| Type | Description |
| --- | --- |
| boolean | Check result for adding the **CameraOutput** instance. **true** if it can be added, |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| callback | \_\_\_MD\_LINK\_USD\_0\_\_\_&lt;void&gt; | Yes | Callback used to return the result. If the configuration is successfully committed, **err** is **undefined**; otherwise, **err** is an error object with an error code defined in [CameraErrorCode]\_\_\_ESCAPED\_UNDERSCORE\_\_\_\_\_\_ESCAPED\_UNDERSCORE\_\_\_\_\_\_ESCAPED\_UNDERSCORE\_\_\_JSDOC\_\_\_ESCAPED\_UNDERSCORE\_\_\_LINK\_\_\_ESCAPED\_UNDERSCORE\_\_\_DESC\_\_\_ESCAPED\_UNDERSCORE\_\_\_USD\_\_\_ESCAPED\_UNDERSCORE\_\_\_0\_\_\_ESCAPED\_UNDERSCORE\_\_\_\_\_\_ESCAPED\_UNDERSCORE\_\_\_\_\_\_ESCAPED\_UNDERSCORE\_\_\_. For example, if the aspect ratio of the preview stream is different from that of the video output stream, error code 7400201 is returned. |
...
Removes a [CameraInput]\_\_\_JSDOC\_LINK\_DESC\_USD\_0\_\_\_ instance from this session. This API must be called after [beginConfig]\_\_\_JSDOC\_LINK\_DESC\_USD\_1\_\_\_ and before [commitConfig]\_\_\_JSDOC\_LINK\_DESC\_USD\_2\_\_\_.
