...
Auto exposure. The metering point can be set by calling [AutoExposure.setMeteringPoint]\_\_\_JSDOC\_LINK\_DESC\_USD\_0\_\_\_. After this mode is used, it takes effect only for the first photo capture.
...
Manual exposure. The exposure duration can be set. In this mode, you can set the exposure duration by calling \_\_\_MD\_LINK\_DESC\_USD\_0\_\_\_.
