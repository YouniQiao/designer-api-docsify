...
Whether mirror photography is enabled (disabled by default). Before using this enumerated value, call [isMirrorSupported]\_\_\_JSDOC\_LINK\_DESC\_USD\_0\_\_\_ to check whether mirror photography is supported. **true** if enabled, **false** otherwise.
