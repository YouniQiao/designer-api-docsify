...
| Type | Description |
| --- | --- |
| ArkTS-Dyn: Array&lt;number&gt;  \_\_\_HTML\_TAG\_USD\_0\_\_\_ArkTS-Sta：Array&lt;int&gt; | Range of white balance values, for example, [2800, ...,10000], in units of K (Kelvin). |
...
| Type | Description |
| --- | --- |
| boolean | Check result for the support of the white balance mode. **true** if supported, **false** |
