...
Checks whether macro photography is supported in the current state. This API must be called after [commitConfig]\_\_\_JSDOC\_LINK\_DESC\_USD\_0\_\_\_.
...
| Type | Description |
| --- | --- |
| boolean | Check result for the support of macro photography. **true** if supported, **false** |
