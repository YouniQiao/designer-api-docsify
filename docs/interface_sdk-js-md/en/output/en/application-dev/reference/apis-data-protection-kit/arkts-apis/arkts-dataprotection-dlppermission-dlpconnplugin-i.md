...
Registers the callback capability with the system ability (SA). This API is used in the **registerPlugin** API. > **NOTE** > > [registerPlugin]\_\_\_JSDOC\_LINK\_DESC\_USD\_0\_\_\_ requires identical parameters to this API. > [connectServer]\_\_\_JSDOC\_LINK\_DESC\_USD\_1\_\_\_ is called by the SA and the parameters are > returned through the callback.
