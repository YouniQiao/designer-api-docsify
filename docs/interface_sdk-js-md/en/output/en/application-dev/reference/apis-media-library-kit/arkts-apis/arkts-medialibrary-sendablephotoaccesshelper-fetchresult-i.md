...
Obtains the next asset in the result set. This API uses a promise to return the result. Before using this API, you must use [isAfterLast()]\_\_\_JSDOC\_LINK\_DESC\_USD\_0\_\_\_ to check whether the current position is the end of the result set.
...
| Type | Description |
| --- | --- |
| boolean | Returns **true** if the cursor is in the last row of the result set; returns **false** |
