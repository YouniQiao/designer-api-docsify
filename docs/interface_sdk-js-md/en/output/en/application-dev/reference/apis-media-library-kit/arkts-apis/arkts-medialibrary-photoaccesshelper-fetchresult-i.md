...
| Type | Description |
| --- | --- |
| Promise&lt;boolean&gt; | Promise used to return the result. **true** indicates that the specified file asset |
...
| Type | Description |
| --- | --- |
| ArkTS-Dyn: Promise&lt;number&gt;  \_\_\_HTML\_TAG\_USD\_0\_\_\_ArkTS-Sta：Promise&lt;int&gt; | Promise used to return the result. If the object exists in the result set, the |
...
Obtains the next file asset in the result set. This API uses an asynchronous callback to return the result. Before using this API, you must use [isAfterLast()]\_\_\_JSDOC\_LINK\_DESC\_USD\_0\_\_\_ to check whether the current position is the end of the result set.
...
Obtains the next file asset in the result set. This API uses a promise to return the result. Before using this API, you must use [isAfterLast()]\_\_\_JSDOC\_LINK\_DESC\_USD\_0\_\_\_ to check whether the current position is the end of the result set.
...
| Type | Description |
| --- | --- |
| Promise&lt;T[]&gt; | Promise object, which returns the file asset array corresponding to the specified index |
...
| Error Code ID | Error Message |
| --- | --- |
| [202](../../errorcode-universal.md#202-permission-verification-failed-for-calling-a-system-api) | Called by non-system application\_\_\_HTML\_TAG\_USD\_0\_\_\_**Applicable version:** 21 - 22 |
...
| Type | Description |
| --- | --- |
| boolean | **true** is returned if the cursor is in the last row of the result set; **false** |
