...
Whether the moving photo badge is displayed in the photo browser page. **true** to display the badge, **false** to hide it. The default is **false**. If this parameter is set to **true**, [Photoselectresult]\_\_\_JSDOC\_LINK\_DESC\_USD\_0\_\_\_ returns the **movingPhotoBadgeStates** array. The default status of a moving photo is [MOVING\_PHOTO\_ENABLED]\_\_\_JSDOC\_LINK\_DESC\_USD\_1\_\_\_. Note: Use both **isMovingPhotoBadgeShown** and **MovingPhotoBadgeStateType** to determine whether a photo is a moving photo.
