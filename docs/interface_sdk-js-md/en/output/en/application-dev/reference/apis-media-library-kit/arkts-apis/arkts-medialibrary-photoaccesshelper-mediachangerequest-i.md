...
Media change request, which is the parent class of the asset change request and album change request. > **NOTE** > > The media change request takes effect only after > [applyChanges]\_\_\_JSDOC\_LINK\_DESC\_USD\_0\_\_\_ is called.
