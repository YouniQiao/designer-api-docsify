...
Enumerated value of the recommended content set by the user during the last selection. For details, see [RecommendationType]\_\_\_JSDOC\_LINK\_DESC\_USD\_0\_\_\_. If no recommendation was set during the last selection, the default value is **0**.
...
Enumerated value of the recommended content selected by the user during the last selection. For details, see [RecommendationType]\_\_\_JSDOC\_LINK\_DESC\_USD\_0\_\_\_. If no recommendation was selected during the last selection or **All** was selected, the default value is **0**.
