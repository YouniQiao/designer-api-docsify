...
Describes the updatable attributes of the **PhotoPickerComponent**. These attributes are a subset of [PickerOptions]\_\_\_JSDOC\_LINK\_DESC\_USD\_0\_\_\_.
...
Scrolling effect when the Picker grid page reaches the edge. The default value is [EdgeEffect.Spring]\_\_\_JSDOC\_LINK\_DESC\_USD\_0\_\_\_.
...
MIME types. If this parameter is not specified, **IMAGE\_VIDEO\_TYPE** is used by default.
...
Picker selection mode. **SINGLE\_SELECT** or **MULTI\_SELECT**. The default value is **MULTI\_SELECT**.
