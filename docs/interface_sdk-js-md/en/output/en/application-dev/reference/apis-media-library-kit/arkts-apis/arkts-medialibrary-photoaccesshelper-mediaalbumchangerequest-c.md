...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| album | \_\_\_MD\_LINK\_USD\_0\_\_\_ | Yes | Album to change. |
...
Obtains the album in the current album change request. > **NOTE** > > For the change request for creating an album, this API returns **null** before > [applyChanges]\_\_\_JSDOC\_LINK\_DESC\_USD\_0\_\_\_ is called > to apply the changes.
...
| Type | Description |
| --- | --- |
| \_\_\_MD\_LINK\_USD\_0\_\_\_ | Album obtained. |
...
| Type | Description |
| --- | --- |
| \_\_\_MD\_LINK\_USD\_0\_\_\_ | - Returns the album, if the operation fails, returns null |
