...
Creates an SMS message instance based on the protocol data unit (PDU) and the specified SMS protocol. \_\_\_HTML\_TAG\_DESC\_USD\_0\_\_\_After receiving the original PDU data, the system creates an SMS message instance according to the specified SMS protocol.
...
| Type | Description |
| --- | --- |
| Promise&lt;ShortMessage&gt; | Returns an SMS message instance; |
