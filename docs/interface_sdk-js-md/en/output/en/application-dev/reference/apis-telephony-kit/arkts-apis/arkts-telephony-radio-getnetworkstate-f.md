...
| callback | \_\_\_MD\_LINK\_USD\_0\_\_\_&lt;NetworkState&gt; | Yes | Indicates the callback for getting network registration state. |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| slotId | ArkTS-Dyn: number  \_\_\_HTML\_TAG\_USD\_0\_\_\_ArkTS-Sta：int | No | Indicates the card slot index number,ranging from 0 to the maximum card slot index number supported by the device.if no slotId is provided, the default slotId is 0. |
