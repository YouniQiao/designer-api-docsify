...
| --- | --- | --- | --- |
| callback | \_\_\_MD\_LINK\_USD\_0\_\_\_&lt;boolean&gt; | Yes | The callback of isNewCallAllowed. Returns {@code true} if the device currently allows new calls; returns {@code false} otherwise. |
