...
| callback | \_\_\_MD\_LINK\_USD\_0\_\_\_&lt;string&gt; | Yes | Returns an E.164 number.Returns an empty string if the input phone number is invalid. |
...
| Type | Description |
| --- | --- |
| Promise&lt;string&gt; | Returns an E.164 number. |
