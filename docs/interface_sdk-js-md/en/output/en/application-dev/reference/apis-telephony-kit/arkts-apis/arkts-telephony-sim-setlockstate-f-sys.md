...
| options | \_\_\_MD\_LINK\_USD\_0\_\_\_ | Yes | Indicates lock information. |
| callback | \_\_\_MD\_LINK\_USD\_0\_\_\_&lt;LockStatusResponse&gt; | Yes | Indicates the callback for getting the response to obtain the SIM card lock status of the specified card slot. |
...
| Type | Description |
| --- | --- |
| Promise&lt;LockStatusResponse&gt; | Returns the response to obtain |
