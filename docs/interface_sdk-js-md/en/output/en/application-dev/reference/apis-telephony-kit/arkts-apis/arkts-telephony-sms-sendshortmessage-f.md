...
Sends a text or data SMS message. \_\_\_HTML\_TAG\_DESC\_USD\_0\_\_\_This method checks whether the length of an SMS message exceeds the maximum length. If the maximum length is exceeded, the SMS message is split into multiple parts and sent separately.
...
| --- | --- | --- | --- |
| options | \_\_\_MD\_LINK\_USD\_0\_\_\_ | Yes | Indicates the parameters and callback for sending the SMS message. |
| callback | \_\_\_MD\_LINK\_USD\_0\_\_\_&lt;void&gt; | Yes | The callback of sendShortMessage. |
