...
| callback | \_\_\_MD\_LINK\_USD\_0\_\_\_&lt;string&gt; | Yes | Indicates the callback for getting the operator key;Returns an empty string if no SIM card is inserted or no operator key matched. |
...
| Type | Description |
| --- | --- |
| Promise&lt;string&gt; | Returns the operator key; |
