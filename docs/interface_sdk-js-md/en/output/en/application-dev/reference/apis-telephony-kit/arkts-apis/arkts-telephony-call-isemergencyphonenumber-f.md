...
| options | \_\_\_MD\_LINK\_USD\_0\_\_\_ | Yes | Indicates the additional information for emergency numbers. |
| callback | \_\_\_MD\_LINK\_USD\_0\_\_\_&lt;boolean&gt; | Yes | Indicates the callback for isEmergencyPhoneNumber.Returns {@code true} if the phone number is on the emergency number list. Returns {@code false} otherwise. |
...
| --- | --- | --- | --- |
| phoneNumber | string | Yes | Indicates the phone number to check. |
| options | \_\_\_MD\_LINK\_USD\_0\_\_\_ | No | Indicates the additional information for emergency numbers. |
