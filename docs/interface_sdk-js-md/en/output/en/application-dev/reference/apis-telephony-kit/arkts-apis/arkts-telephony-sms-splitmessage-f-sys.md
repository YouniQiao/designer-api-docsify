...
Splits a long SMS message into multiple fragments. \_\_\_HTML\_TAG\_DESC\_USD\_0\_\_\_If the length of an SMS message exceeds the maximum length allowed (140 bytes), the SMS message is split into multiple segments for processing.
...
| callback | \_\_\_MD\_LINK\_USD\_0\_\_\_&lt;Array&lt;string&gt;&gt; | Yes | Indicates the callback for getting a list of split segments,which can be combined into a complete SMS message;Returns an empty string if no permission is granted or the short message content is {@code null}. |
...
| Type | Description |
| --- | --- |
| Promise&lt;Array&lt;string&gt;&gt; | Returns a list of split segments, which can be combined into a complete SMS |
