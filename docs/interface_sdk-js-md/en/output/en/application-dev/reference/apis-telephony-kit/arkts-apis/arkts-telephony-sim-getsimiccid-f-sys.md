...
Obtains the ICCID of the SIM card in a specified slot. \_\_\_HTML\_TAG\_DESC\_USD\_0\_\_\_The ICCID is a unique identifier of a SIM card. It consists of 20 digits and is recorded in the EFICCID file of the SIM card.
...
| callback | \_\_\_MD\_LINK\_USD\_0\_\_\_&lt;string&gt; | Yes | Indicates the callback for getting the ICCID;returns an empty string if no SIM card is inserted. |
