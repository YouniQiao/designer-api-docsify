...
| Type | Description |
| --- | --- |
| Promise&lt;RemoteAbilityInfo&gt; | Promise used to return the result. If the operation is successful, the |
...
| Type | Description |
| --- | --- |
| Promise&lt;Array&lt;RemoteAbilityInfo&gt;&gt; | Promise used to return the result. If the operation is successful, |
