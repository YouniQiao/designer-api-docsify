...
Obtains all the developer IDs of the current user based on the given application [distribution type]\_\_\_JSDOC\_LINK\_DESC\_USD\_0\_\_\_.
...
| --- | --- | --- | --- |
| appDistributionType | ArkTS-Dyn: number  \_\_\_HTML\_TAG\_USD\_0\_\_\_ArkTS-Sta：int | No | Application distribution type. If this parameter is not specified, a list of developer IDs of all applications is returned. |
