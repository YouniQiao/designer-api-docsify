...
The ErrorObserver module defines an observer to listen for application errors. It can be used as an input parameter in [ErrorManager.on]\_\_\_JSDOC\_LINK\_DESC\_USD\_0\_\_\_ to listen for errors that occur in the current application.
