...
Mode in which the system processes the startup. For example, **wantConstant.Flags.FLAG\_INSTALL\_ON\_DEMAND** indicates that the installation-free capability is used.
