...
Defines an exception observer that can be used as an input parameter for [errorManager.on('globalErrorOccurred')]\_\_\_JSDOC\_LINK\_DESC\_USD\_0\_\_\_ and [errorManager.on('globalUnhandledRejectionDetected')]\_\_\_JSDOC\_LINK\_DESC\_USD\_1\_\_\_ to monitor event processing on the main thread of the current application.
