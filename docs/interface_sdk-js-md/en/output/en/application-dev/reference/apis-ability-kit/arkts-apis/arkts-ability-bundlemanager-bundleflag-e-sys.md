...
Used to obtain the bundle information of the application that has only a home screen icon. It is valid only in the [getAllBundleInfo]\_\_\_JSDOC\_LINK\_DESC\_USD\_0\_\_\_ API. **System API**: This flag can be used only in system APIs.
...
Used to obtain the bundle information of an application installed by any user. It must be used together with **GET\_BUNDLE\_INFO\_WITH\_APPLICATION**. It is valid only in the [getBundleInfo]\_\_\_JSDOC\_LINK\_DESC\_USD\_0\_\_\_ and [getAllBundleInfo]\_\_\_JSDOC\_LINK\_DESC\_USD\_1\_\_\_ APIs. **System API**: This flag can be used only in system APIs.
...
Used to obtain the bundle information of a main application (excluding its clones). It is valid only in the [getAllBundleInfo]\_\_\_JSDOC\_LINK\_DESC\_USD\_0\_\_\_ API. **System API**: This flag can be used only in system APIs.
...
Used to obtain the bundle information of an application that has device-cloud file synchronization or device- cloud structured data synchronization enabled. It is valid only in the [getAllBundleInfo]\_\_\_JSDOC\_LINK\_DESC\_USD\_0\_\_\_ API. **System API**: This flag can be used only in system APIs.
...
Used to obtain the bundle information of common app clones (appIndex: 1-5). It is valid only in the \_\_\_JSDOC\_LINK\_DESC\_USD\_0\_\_\_ API. **System API**: This flag can be used only in system APIs.
...
Used to obtain the bundle information of sandbox app clones (appIndex: 2000-3000). It is valid only in the \_\_\_JSDOC\_LINK\_DESC\_USD\_0\_\_\_ API. **System API**: This flag can be used only in system APIs.
