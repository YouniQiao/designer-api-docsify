...
| Type | Description |
| --- | --- |
| \_\_\_MD\_LINK\_USD\_0\_\_\_ | Context created based on the data encryption level. |
...
Creates an application context based on the specified display ID with screen information (including [ScreenDensity]\_\_\_JSDOC\_LINK\_DESC\_USD\_0\_\_\_ and [Direction]\_\_\_JSDOC\_LINK\_DESC\_USD\_1\_\_\_).
...
| Type | Description |
| --- | --- |
| \_\_\_MD\_LINK\_USD\_0\_\_\_ | Context with the specified screen information. |
...
Creates the context based on the module name. > **NOTE** > > - Only the context of other modules in the current application and the context of the intra-application HSP can > be obtained. The context of other applications cannot be obtained. > > - This API has been supported since API version 9 and deprecated since API version 12. You are advised to use > [application.createModuleContext]\_\_\_JSDOC\_LINK\_DESC\_USD\_0\_\_\_ > instead. Otherwise, resource acquisition may fail. > > - Creating a module context involves resource querying and initialization, which can be time-consuming. In > scenarios where application fluidity is critical, avoid frequently or repeatedly calling the > **createModuleContext** API to create multiple context instances, as this may negatively impact user experience.
...
| callback | \_\_\_MD\_LINK\_USD\_0\_\_\_&lt;string&gt; | Yes | Callback used to return the result. If the API call is successful,**err** is **undefined** and **data** is the shared directory obtained (or empty if or is empty if non-existent). Otherwise, an error object is returned.\_\_\_ESCAPED\_UNDERSCORE\_\_\_\_\_\_ESCAPED\_UNDERSCORE\_\_\_\_\_\_ESCAPED\_UNDERSCORE\_\_\_HTML\_\_\_ESCAPED\_UNDERSCORE\_\_\_TAG\_\_\_ESCAPED\_UNDERSCORE\_\_\_DESC\_\_\_ESCAPED\_UNDERSCORE\_\_\_USD\_\_\_ESCAPED\_UNDERSCORE\_\_\_0\_\_\_ESCAPED\_UNDERSCORE\_\_\_\_\_\_ESCAPED\_UNDERSCORE\_\_\_\_\_\_ESCAPED\_UNDERSCORE\_\_\_Note: Only the EL2 encryption level is supported. |
...
| Type | Description |
| --- | --- |
| Promise&lt;string&gt; | Promise used to return the result. If no shared directory exists, null is returned. |
...
Information about file partitions, which are divided according to the encryption level specified by [AreaMode]\_\_\_JSDOC\_LINK\_DESC\_USD\_0\_\_\_.
...
Bundle code directory. Do not access resource files using concatenated paths. Use [resource manager APIs]\_\_\_JSDOC\_LINK\_DESC\_USD\_1\_\_\_ instead. For details, see \_\_\_MD\_LINK\_DESC\_USD\_0\_\_\_.
...
Cache directory. For details, see \_\_\_MD\_LINK\_DESC\_USD\_0\_\_\_.
...
Database directory. For details, see \_\_\_MD\_LINK\_DESC\_USD\_0\_\_\_.
...
Distributed file directory. For details, see \_\_\_MD\_LINK\_DESC\_USD\_0\_\_\_.
...
File directory. For details, see \_\_\_MD\_LINK\_DESC\_USD\_0\_\_\_.
...
Preferences directory. For details, see \_\_\_MD\_LINK\_DESC\_USD\_0\_\_\_.
...
Temporary directory. For details, see \_\_\_MD\_LINK\_DESC\_USD\_0\_\_\_.
