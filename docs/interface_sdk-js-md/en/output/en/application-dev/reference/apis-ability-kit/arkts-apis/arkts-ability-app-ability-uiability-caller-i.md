...
A Caller UIAbility can use the [startAbilityByCall]\_\_\_JSDOC\_LINK\_DESC\_USD\_0\_\_\_ API to start the target Callee UIAbility. After the target UIAbility is started successfully, a Caller object is returned to the caller for communication.
