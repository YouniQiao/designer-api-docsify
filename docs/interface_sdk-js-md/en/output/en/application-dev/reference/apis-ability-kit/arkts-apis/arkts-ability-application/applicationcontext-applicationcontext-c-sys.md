...
**Substitutes:** [ApplicationContext#getRunningProcessInformation](applicationcontext-applicationcontext-c.md#getrunningprocessinformation)
...
Preloads a UIExtensionAbility instance. This API uses a promise to return the result. The preloaded UIExtensionAbility instance is sent to the **onCreate** lifecycle of the UIExtensionAbility and waits to be loaded by the current application. A UIExtensionAbility instance can be preloaded for multiple times. Each time a preloaded UIExtensionAbility instance is loaded, the next preloaded UIExtensionAbility instance is sent to the **onCreate** lifecycle of the UIExtensionAbility. | Name| Type| Mandatory| Description| | -------- | -------- | -------- | -------- | | want | [Want]\_\_\_JSDOC\_LINK\_DESC\_USD\_0\_\_\_ | Yes| Want information of the UIExtensionAbility.|
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| want | \_\_\_MD\_LINK\_USD\_0\_\_\_ | Yes | Want information of the UIExtensionAbility. |
...
Registers a listener to monitor the ability lifecycle of the application. This API uses an asynchronous callback to return the result. \_\_\_HTML\_TAG\_DESC\_USD\_0\_\_\_**NOTE**: \_\_\_HTML\_TAG\_DESC\_USD\_1\_\_\_It can be called only by the main thread. \_\_\_HTML\_TAG\_DESC\_USD\_2\_\_\_
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| abilityLifecycleCallback | \_\_\_MD\_LINK\_USD\_0\_\_\_ | Yes | Callback used to return the ID of the registered listener. |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| environmentCallback | \_\_\_MD\_LINK\_USD\_0\_\_\_ | Yes | Callback used to return the ID of the registered listener. |
...
Unregisters the listener that monitors the ability lifecycle of the application. This API uses an asynchronous callback to return the result. \_\_\_HTML\_TAG\_DESC\_USD\_0\_\_\_**NOTE**: \_\_\_HTML\_TAG\_DESC\_USD\_1\_\_\_It can be called only by the main thread. \_\_\_HTML\_TAG\_DESC\_USD\_2\_\_\_
...
| callback | \_\_\_MD\_LINK\_USD\_0\_\_\_&lt;void&gt; | Yes | Callback used to return the ID of the registered listener. |
...
Unregisters a listener for the lifecycle of a UIAbility within the application. This API uses a promise to return the result. It can be called only on the main thread. \_\_\_HTML\_TAG\_DESC\_USD\_0\_\_\_**NOTE**: \_\_\_HTML\_TAG\_DESC\_USD\_1\_\_\_It can be called only by the main thread. \_\_\_HTML\_TAG\_DESC\_USD\_2\_\_\_
...
| --- | --- | --- | --- |
| callbackId | number | Yes | Event type. |
| envcallback | \_\_\_MD\_LINK\_USD\_0\_\_\_&lt;void&gt; | Yes | Callback used to return the ID of the registered listener. |
