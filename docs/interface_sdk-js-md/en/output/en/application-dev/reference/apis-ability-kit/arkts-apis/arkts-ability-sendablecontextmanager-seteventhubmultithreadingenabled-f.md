...
Enables the cross-thread data transfer feature of [EventHub]\_\_\_JSDOC\_LINK\_DESC\_USD\_0\_\_\_ in [Context]\_\_\_JSDOC\_LINK\_DESC\_USD\_1\_\_\_. > **NOTE** > > - When multiple Context objects communicate, you need to call this API to set each Context object to support > EventHub cross-thread data transfer.
