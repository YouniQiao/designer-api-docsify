...
Enterprise MDM application that can be installed only on enterprise devices. To install a common enterprise application, you must have [administrator privileges]\_\_\_JSDOC\_LINK\_DESC\_USD\_0\_\_\_ .
