...
Checks whether the target application can be accessed based on the provided link. The scheme specified in the link must be configured in the **querySchemes** field of the \_\_\_MD\_LINK\_DESC\_USD\_0\_\_\_ file.
...
| Type | Description |
| --- | --- |
| boolean | Check result for whether the link can be opened. **true** if it can be opened, **false** |
