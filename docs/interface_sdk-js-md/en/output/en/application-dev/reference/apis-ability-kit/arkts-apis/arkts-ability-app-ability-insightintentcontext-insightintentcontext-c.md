...
The module provides the context for intent execution. It is used as a property in both the [intent execution base class]\_\_\_JSDOC\_LINK\_DESC\_USD\_0\_\_\_ and [base class decorated with @InsightIntentEntry]\_\_\_JSDOC\_LINK\_DESC\_USD\_1\_\_\_ , offering essential capabilities for intent implementation, for example, starting [UIAbility components]\_\_\_JSDOC\_LINK\_DESC\_USD\_2\_\_\_ within the same application.
...
Sets the return mode of the intent execution result. This API is applicable to intents with the execution mode set to [UI\_ABILITY\_FOREGROUND]\_\_\_JSDOC\_LINK\_DESC\_USD\_0\_\_\_.
...
Sets the return mode of the intent execution result. This API is applicable to intents with the execution mode set to [UI\_EXTENSION\_ABILITY]\_\_\_JSDOC\_LINK\_DESC\_USD\_0\_\_\_.
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| want | \_\_\_MD\_LINK\_USD\_0\_\_\_ | Yes | Want information for starting the UIAbility. |
...
Unique ID of an intent instance. Its execution result can be returned through [insightIntentProvider.sendExecuteResult]\_\_\_JSDOC\_LINK\_DESC\_USD\_0\_\_\_ and [insightIntentProvider.sendIntentResult]\_\_\_JSDOC\_LINK\_DESC\_USD\_1\_\_\_.
