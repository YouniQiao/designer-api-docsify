...
| --- | --- | --- | --- |
| request | \_\_\_MD\_LINK\_USD\_0\_\_\_ | Yes | Request for querying permission usage records. |
...
| --- | --- | --- | --- |
| request | \_\_\_MD\_LINK\_USD\_0\_\_\_ | Yes | Request for querying permission usage records. |
| callback | \_\_\_MD\_LINK\_USD\_0\_\_\_&lt;PermissionUsedResponse&gt; | Yes | Callback used to return the result. If the operation is successful, **err** is **undefined**, and data is the permission usage record is obtained. Otherwise,**err** is an error object. |
