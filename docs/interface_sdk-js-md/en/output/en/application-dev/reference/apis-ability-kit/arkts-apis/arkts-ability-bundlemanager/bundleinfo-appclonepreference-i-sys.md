...
Index of the application clone. This value is valid only when the mode is CLONE\_APP. The value ranges from 1 to 5 (maximum 5 clones are supported). The value should be an integer.
