...
Obtains the JSON string array of the current application's configuration file based on the given module name, ExtensionAbility name, and metadata name (name configured in \_\_\_MD\_LINK\_DESC\_USD\_0\_\_\_ of the **module.json5** file). This API uses an asynchronous callback to return the result.
...
Obtains the JSON string array of the current application's configuration file based on the given module name, ExtensionAbility name, and metadata name (name configured in \_\_\_MD\_LINK\_DESC\_USD\_0\_\_\_ of the **module.json5** file). This API uses a promise to return the result.
