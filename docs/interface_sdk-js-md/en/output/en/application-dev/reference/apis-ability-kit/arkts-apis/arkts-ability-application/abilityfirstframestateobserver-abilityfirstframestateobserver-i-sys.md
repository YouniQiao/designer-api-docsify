...
The module defines the observer used to listen for the first frame rendering completion event of a given ability. It is used as an input parameter of [on]\_\_\_JSDOC\_LINK\_DESC\_USD\_0\_\_\_ to listen for the completion event.
