...
Obtains the default application based on a system-defined application type, a file type that complies with the media type format (either specified by **type** or **subtype**), or a [uniform data type]\_\_\_JSDOC\_LINK\_DESC\_USD\_0\_\_\_. This API returns the result synchronously.
...
| Type | Description |
| --- | --- |
| \_\_\_MD\_LINK\_USD\_0\_\_\_ | Bundle information of the default application. |
