...
Enumerates the common preset keywords of the [Want.flags]\_\_\_JSDOC\_LINK\_DESC\_USD\_0\_\_\_ field. You can use these predefined keywords to set or retrieve additional flag information carried in application transitions.
...
In multi-device collaboration scenario, the caller application must initiate a request through the DMS, with this flag included in the **Flags** field, in order to invoke the lifecycle callback [onCollaborate()]\_\_\_JSDOC\_LINK\_DESC\_USD\_0\_\_\_ of the target application.
...
Disables the "No available applications" prompt during implicit application launches. When \_\_\_MD\_LINK\_DESC\_USD\_0\_\_\_, a prompt saying "No available applications" will appear if no matching application is found. You can use this flag to prevent this prompt from appearing.
