...
Any type of custom data in the \_\_\_MD\_LINK\_DESC\_USD\_0\_\_\_, that is, JSON string of the **customData** field. You need to call **JSON.parse** to parse the field.
...
User-defined string in the \_\_\_MD\_LINK\_DESC\_USD\_0\_\_\_, that is, value of the **data** field. This field is parsed by the system. You do not need to parse it.
