...
> **NOTE** > > This API has been supported since API version 7 and deprecated since API version 9. You are advised to use > [bundleManager.LaunchType]\_\_\_JSDOC\_LINK\_DESC\_USD\_0\_\_\_ instead. Enumerates the ability launch modes.
