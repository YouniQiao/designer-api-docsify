...
Obtains the [shortcut information]\_\_\_JSDOC\_LINK\_DESC\_USD\_0\_\_\_ of the specified user based on the given bundle name of a main application. To obtain shortcut information about an application clone, use [getShortcutInfoByAppIndex]\_\_\_JSDOC\_LINK\_DESC\_USD\_1\_\_\_. No permission is required for obtaining the caller's own information.
