...
In the following API examples, you must first use [getInputMethodEngine]\_\_\_JSDOC\_LINK\_DESC\_USD\_0\_\_\_ to obtain an **InputMethodEngine** instance, and then call the APIs using the obtained instance.
