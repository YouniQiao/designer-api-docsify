...
In the following API examples, you must first use [on('inputStart')]\_\_\_JSDOC\_LINK\_DESC\_USD\_0\_\_\_ to obtain a **TextInputClient** instance, and then call the APIs using the obtained instance.
...
| Type | Description |
| --- | --- |
| Promise&lt;boolean&gt; | Promise used to return the result. The value **true** means that the setting is |
