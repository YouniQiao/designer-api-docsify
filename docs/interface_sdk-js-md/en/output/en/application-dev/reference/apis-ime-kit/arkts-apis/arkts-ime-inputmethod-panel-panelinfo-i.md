...
State type of the input method panel. - The default value is **FLAG\_FIXED**. - Currently, this parameter is used to describe the state type of the soft keyboard.
