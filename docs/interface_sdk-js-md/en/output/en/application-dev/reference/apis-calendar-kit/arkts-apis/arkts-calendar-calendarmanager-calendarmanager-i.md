...
Before calling any of the following APIs to manage the calendar, you must use [getCalendarManager()]\_\_\_JSDOC\_LINK\_DESC\_USD\_0\_\_\_ to obtain a **CalendarManager** object first.
...
| Type | Description |
| --- | --- |
| Promise&lt;number&gt; | Promise used to return the event ID. The event ID is the unique identifier of an |
