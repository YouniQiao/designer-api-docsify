...
| --- | --- | --- | --- |
| config | \_\_\_MD\_LINK\_USD\_0\_\_\_ | Yes | Indicates the request parameters for obtaining the data required for locating. |

**Return value:**

| Type | Description |
| --- | --- |
| Promise&lt;Array&lt;LocatingRequiredData&gt;&gt; | The promise returned by the function, |
...
| [801](../../apis-ads-kit/errorcode-ads.md#801-ad-request-failure) | Capability not supported. Failed to call\_\_\_ESCAPED\_DOLLAR\_\_\_{geoLocationManager.getLocatingRequiredData} due to limited device capabilities. |
