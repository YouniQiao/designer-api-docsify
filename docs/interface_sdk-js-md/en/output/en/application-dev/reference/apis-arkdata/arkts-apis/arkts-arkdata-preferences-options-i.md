...
Application group ID. \_\_\_MD\_COMMENT\_DESC\_USD\_0\_\_\_Currently, this parameter is not supported.\_\_\_MD\_COMMENT\_DESC\_USD\_1\_\_\_ This parameter is optional. A **Preferences** instance will be created in the sandbox path corresponding to the specified **dataGroupId**. If this parameter is not specified, the **Preferences** instance is created in the sandbox directory of the application. This attribute can be used only in the stage model. This API can be used in atomic services since API version 11.
