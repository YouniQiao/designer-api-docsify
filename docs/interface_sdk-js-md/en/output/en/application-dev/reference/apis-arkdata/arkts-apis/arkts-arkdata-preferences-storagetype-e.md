...
\_\_\_MD\_LINK\_DESC\_USD\_0\_\_\_ format, which is the default storage type of **Preferences**. In this mode, data is stored in XML format. Data operations are performed in the memory. To persist data, call **flush()**.
...
\_\_\_MD\_LINK\_DESC\_USD\_0\_\_\_ format. Data is stored in GSKV mode. Data operations are flushed on a real-time basis without calling **flush()**.
