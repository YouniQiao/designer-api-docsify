...
| bindInfo | \_\_\_MD\_LINK\_USD\_0\_\_\_ | Yes | Information about the joint asset in the RDB store, including the RDB store name,table name, primary key, column name, and asset name in the RDB store. |
...
| --- | --- | --- | --- |
| type | 'change' | Yes | Event type. The value is 'change', which indicates data changes. |
| callback | \_\_\_MD\_LINK\_USD\_0\_\_\_ | No | Callback to unregister. If this parameter is not specified, this API unsubscribes from all callbacks for data changes of this distributed object. |
...
| callback | \_\_\_MD\_LINK\_USD\_0\_\_\_ | No | Callback to unregister. If this parameter is not specified, this API unsubscribes from all callbacks for status changes of this distributed object. |
...
| callback | \_\_\_MD\_LINK\_USD\_0\_\_\_ | No | Callback to unregister. If this parameter is not specified, this API unsubscribes from all callbacks for progress changes of this distributed object. |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| callback | \_\_\_MD\_LINK\_USD\_0\_\_\_ | No | The observer of object data changed, if not null, off the callback, if undefined, off all callbacks. |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| callback | \_\_\_MD\_LINK\_USD\_0\_\_\_ | No | Observer to be unregistered. |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| callback | \_\_\_MD\_LINK\_USD\_0\_\_\_ | No | The observer of object status changed, if not null, off the callback, if undefined, off all callbacks. |
...
| --- | --- | --- | --- |
| type | 'change' | Yes | Event type. The value is 'change', which indicates data changes. |
| callback | \_\_\_MD\_LINK\_USD\_0\_\_\_ | Yes | Callback used to listen for data changes of a distributed object. |
...
| --- | --- | --- | --- |
| type | 'status' | Yes | Event type. The value is 'status', which indicates the status changes of a distributed object. |
| callback | \_\_\_MD\_LINK\_USD\_0\_\_\_ | Yes | Callback used to listen for status changes of a distributed object. |
...
| --- | --- | --- | --- |
| type | 'progressChanged' | Yes | Event type. The value is 'progressChanged', which indicates the asset transfer progress changes. |
| callback | \_\_\_MD\_LINK\_USD\_0\_\_\_ | Yes | Callback used to listen for the asset transfer progress changes. |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| callback | \_\_\_MD\_LINK\_USD\_0\_\_\_ | Yes | The observer of object data changed. |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| callback | \_\_\_MD\_LINK\_USD\_0\_\_\_ | Yes | Observer to be registered. |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| callback | \_\_\_MD\_LINK\_USD\_0\_\_\_ | Yes | The observer of object status changed. |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| callback | \_\_\_MD\_LINK\_USD\_0\_\_\_&lt;RevokeSaveSuccessResponse&gt; | Yes | Callback used to return RevokeSaveSuccessResponse, which contains the session ID. |
...
| Type | Description |
| --- | --- |
| Promise&lt;RevokeSaveSuccessResponse&gt; | Promise used to return RevokeSaveSuccessResponse, which |
...
| callback | \_\_\_MD\_LINK\_USD\_0\_\_\_&lt;SaveSuccessResponse&gt; | Yes | Callback used to return SaveSuccessResponse, which contains information such as session ID, version, and device ID. |
...
| Type | Description |
| --- | --- |
| Promise&lt;SaveSuccessResponse&gt; | Promise used to return SaveSuccessResponse, which contains |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| sessionId | string | Yes | ID of a distributed data object on a trusted network. The value can contain only letters, digits, and underscores (\_\_\_ESCAPED\_UNDERSCORE\_\_\_), and cannot exceed 128 characters. If this parameter is set to "" or null, the distributed data object exits the network. |
| callback | \_\_\_MD\_LINK\_USD\_0\_\_\_&lt;void&gt; | Yes | Asynchronous callback invoked when the session ID is successfully set. |
...
| [401](../../apis-ads-kit/errorcode-ads.md#401-incorrect-ads-request-parameter) | Parameter error. Possible causes: 1. Incorrect parameter types;2. The sessionId allows only letters, digits, and underscores(\_\_\_ESCAPED\_UNDERSCORE\_\_\_), and cannot exceed 128 in length. |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| callback | \_\_\_MD\_LINK\_USD\_0\_\_\_&lt;void&gt; | Yes | Callback invoked when the distributed data object exits all sessions. |

**Error codes:**

| Error Code ID | Error Message |
| --- | --- |
| [201](../../errorcode-universal.md#201-permission-denied) | Permission verification failed.\_\_\_HTML\_TAG\_USD\_0\_\_\_**Applicable version:** 9 - 19 |
| [401](../../apis-ads-kit/errorcode-ads.md#401-incorrect-ads-request-parameter) | Parameter error. Incorrect parameter types. |
| [15400001](../errorcode-distributed-dataObject.md#15400001-failed-to-create-the-inmemory-database) | Failed to create the in-memory database. |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| sessionId | string | No | ID of a distributed data object on a trusted network. The value can contain only letters, digits, and underscores (\_\_\_ESCAPED\_UNDERSCORE\_\_\_), and cannot exceed 128 characters. If this parameter is set to "" or null, or left empty, the distributed data object exits the network. |
