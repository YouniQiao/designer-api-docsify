...
| --- | --- | --- | --- |
| options | \_\_\_MD\_LINK\_USD\_0\_\_\_ | Yes | Configuration for the data update operation. The **key** field is mandatory. If it is not specified, error code 401 will be returned. Only the DATA\_\_\_ESCAPED\_UNDERSCORE\_\_\_HUB channel of the **intention** parameter is supported. The settings of other parameters do not affect the use of this API. |
| data | \_\_\_MD\_LINK\_USD\_0\_\_\_ | Yes | Data to update. |
| callback | \_\_\_MD\_LINK\_USD\_0\_\_\_&lt;void&gt; | Yes | Callback used to return the result. If the data is updated successfully,**err** is **undefined**. Otherwise, **err** is an error object. |
