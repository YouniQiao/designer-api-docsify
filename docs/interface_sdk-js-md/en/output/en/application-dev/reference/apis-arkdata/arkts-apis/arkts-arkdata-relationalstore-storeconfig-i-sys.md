...
Specifies whether to clean up dirty data that is synchronized to the local but deleted on the remote device. \_\_\_HTML\_TAG\_DESC\_USD\_0\_\_\_Default value:true.
