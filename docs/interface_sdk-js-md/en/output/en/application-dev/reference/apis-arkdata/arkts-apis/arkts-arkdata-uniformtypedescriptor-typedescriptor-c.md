...
| --- | --- | --- | --- |
| type | string | Yes | Uniform data type specified, which is a value of [UniformDataType]\_\_\_ESCAPED\_UNDERSCORE\_\_\_\_\_\_ESCAPED\_UNDERSCORE\_\_\_\_\_\_ESCAPED\_UNDERSCORE\_\_\_JSDOC\_\_\_ESCAPED\_UNDERSCORE\_\_\_LINK\_\_\_ESCAPED\_UNDERSCORE\_\_\_DESC\_\_\_ESCAPED\_UNDERSCORE\_\_\_USD\_\_\_ESCAPED\_UNDERSCORE\_\_\_0\_\_\_ESCAPED\_UNDERSCORE\_\_\_\_\_\_ESCAPED\_UNDERSCORE\_\_\_\_\_\_ESCAPED\_UNDERSCORE\_\_\_. |

**Return value:**

| Type | Description |
| --- | --- |
| boolean | Returns **true** if the data type belongs to or is the same as the specified uniform data |
...
Checks whether this data type is the same as the specified uniform data type. That is, compares **typeId**s of two [TypeDescriptor]\_\_\_JSDOC\_LINK\_DESC\_USD\_0\_\_\_ objects.
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| typeDescriptor | \_\_\_MD\_LINK\_USD\_0\_\_\_ | Yes | Uniform data type to compare. |
...
Checks whether this data type is a higher-level type of the specified uniform data type. For example, **SOURCE\_CODE** is a higher-level type of **TYPE\_SCRIPT**, and **TEXT** is a higher-level type of **SOURCE\_CODE** and **TYPE\_SCRIPT**.
...
| Type | Description |
| --- | --- |
| boolean | Returns **true** if the data type is a higher-level type of the specified uniform data type; |
...
Checks whether this data type is a lower-level type of the specified uniform data type. For example, **TYPE\_SCRIPT** is a lower-level type of **SOURCE\_CODE**, and **TYPE\_SCRIPT** and **SOURCE\_CODE** are lower-level types of **TEXT**.
...
| Type | Description |
| --- | --- |
| boolean | Returns **true** if the data type is a lower-level type of the specified uniform data type; |
