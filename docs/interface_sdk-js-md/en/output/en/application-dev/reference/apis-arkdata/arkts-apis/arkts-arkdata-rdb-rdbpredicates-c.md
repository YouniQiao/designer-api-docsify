...
Creates an **RdbPredicates** object to specify the remote devices to connect on the network during distributed database sync. > **NOTE** > The value of **devices** can be obtained by using \_\_\_MD\_COMMENT\_DESC\_USD\_1\_\_\_ > [deviceManager.getTrustedDeviceListSync]\_\_\_JSDOC\_LINK\_DESC\_USD\_0\_\_\_ > . \_\_\_MD\_COMMENT\_DESC\_USD\_2\_\_\_The APIs of the **deviceManager** module are system interfaces and available only to system > applications.
