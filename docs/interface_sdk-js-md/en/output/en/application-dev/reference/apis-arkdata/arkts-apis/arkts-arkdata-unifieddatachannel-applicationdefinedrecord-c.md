...
Represents the custom data type for applications only. It is a child class of [UnifiedRecord]\_\_\_JSDOC\_LINK\_DESC\_USD\_0\_\_\_ and a base class of custom data types of applications. Applications can extend custom data types based on this class.
