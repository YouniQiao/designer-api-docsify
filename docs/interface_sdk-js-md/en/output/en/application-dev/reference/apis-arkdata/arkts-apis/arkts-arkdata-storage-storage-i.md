...
Provides APIs for obtaining and modifying storage data. Before calling the following APIs, use [data\_storage.getStorage]\_\_\_JSDOC\_LINK\_DESC\_USD\_0\_\_\_ or [data\_storage.getStorageSync]\_\_\_JSDOC\_LINK\_DESC\_USD\_1\_\_\_ to obtain the **Storage** instance.
...
| Type | Description |
| --- | --- |
| \_\_\_MD\_LINK\_USD\_0\_\_\_ | Value corresponding to the specified key. If the value is null or not in the default value |
...
| Type | Description |
| --- | --- |
| boolean | Returns **true** if the storage object contains data with the specified key; returns |
