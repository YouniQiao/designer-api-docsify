...
Represent the asset (such as a document, image, or video). **Asset** inherits from [lang.ISendable]\_\_\_JSDOC\_LINK\_DESC\_USD\_0\_\_\_ and is used to implement cross-thread transfer of asset data. The asset data does not support **Datashare** APIs. Use [sendableRelationalStore.toSendableAsset]\_\_\_JSDOC\_LINK\_DESC\_USD\_1\_\_\_ to create an **Asset** instance.
...
Asset status. For details, see [relationalStore.AssetStatus]\_\_\_JSDOC\_LINK\_DESC\_USD\_0\_\_\_. The default value is **relationalStore.AssetStatus.ASSET\_NORMAL**.
