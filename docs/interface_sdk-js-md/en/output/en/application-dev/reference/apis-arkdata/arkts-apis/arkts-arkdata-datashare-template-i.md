...
Predicates to use. When [**on**]\_\_\_JSDOC\_LINK\_DESC\_USD\_0\_\_\_ is called, the predicates are used to generate data. This parameter applies only to RDB data storage.
...
Update SQL statement of a specified template. The default value is an empty string. When [on]\_\_\_JSDOC\_LINK\_DESC\_USD\_0\_\_\_ is called, the **update** parameter is used to update data. This parameter applies only to RDB data storage.
