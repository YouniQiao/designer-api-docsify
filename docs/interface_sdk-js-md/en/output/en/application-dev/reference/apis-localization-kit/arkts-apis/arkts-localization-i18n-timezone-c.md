...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| date | ArkTS-Dyn: number  \_\_\_HTML\_TAG\_USD\_0\_\_\_ArkTS-Sta：double | No | Specified time, in milliseconds. The default value is the system time. |

**Return value:**

| Type | Description |
| --- | --- |
| ArkTS-Dyn: number  \_\_\_HTML\_TAG\_USD\_0\_\_\_ArkTS-Sta：int | Time zone offset, in milliseconds. When the DST is used, the time zone offset is the raw time |
...
| Type | Description |
| --- | --- |
| ArkTS-Dyn: number  \_\_\_HTML\_TAG\_USD\_0\_\_\_ArkTS-Sta：int | Raw offset of the time zone, in milliseconds. |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| longitude | ArkTS-Dyn: number  \_\_\_HTML\_TAG\_USD\_0\_\_\_ArkTS-Sta：double | Yes | Longitude. The value range is [-180, 179.9). A positive value is used for east longitude and a negative value is used for west longitude. |
| latitude | ArkTS-Dyn: number  \_\_\_HTML\_TAG\_USD\_0\_\_\_ArkTS-Sta：double | Yes | Latitude. The value range is [-90, 89.9). A positive value is used for north latitude and a negative value is used for south latitude. |
...
Obtains the time zone transition rules. For details about the time zone transition logic, see \_\_\_MD\_LINK\_DESC\_USD\_0\_\_\_.
...
| Type | Description |
| --- | --- |
| \_\_\_MD\_LINK\_USD\_0\_\_\_ | Time zone transition rule, including the transition time and the offset before and after |
