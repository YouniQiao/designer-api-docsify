...
Format of the output result. It determines whether numeric values are used to represent relative dates or times in the formatting result. The value can be **always** or **auto**. For details about their display effects, see \_\_\_MD\_LINK\_DESC\_USD\_0\_\_\_.
...
Length of an internationalized message. The value can be **long**, **short**, or **narrow**. For details about their display effects, see \_\_\_MD\_LINK\_DESC\_USD\_0\_\_\_.
