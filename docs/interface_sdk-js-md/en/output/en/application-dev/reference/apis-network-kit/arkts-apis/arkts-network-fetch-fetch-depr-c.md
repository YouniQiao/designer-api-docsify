...
<!--Device-Fetch-static fetch(options: {    /**     * Resource URL.     ***/    url: string;      /**     * Request parameter, which can be of the string type or a JSON object.     ***/    data?: string | object;      /**     * Request header, which accommodates all attributes of the request.     ***/    header?: Object;      /**     * Request methods available: OPTIONS, GET, HEAD, POST, PUT, DELETE and TRACE. The default value is GET.     ***/    method?: string;      /**     * The return type can be text, or JSON. By default, the return type is determined based on Content-Type in the header returned by the server.     ***/    responseType?: string;      /**     * Called when the network data is obtained successfully.     ***/    success?: (data: FetchResponse) => void;      /**     * Called when the network data fails to be obtained.     ***/    fail?: (data: any, code: number) => void;      /**     * Called when the execution is completed.     ***/    complete?: () => void;  }): void--><!--Device-Fetch-static fetch(options: {    /**     * Resource URL.     ***/    url: string;      /**     * Request parameter, which can be of the string type or a JSON object.     ***/    data?: string | object;      /**     * Request header, which accommodates all attributes of the request.     ***/    header?: Object;      /**     * Request methods available: OPTIONS, GET, HEAD, POST, PUT, DELETE and TRACE. The default value is GET.     ***/    method?: string;      /**     * The return type can be text, or JSON. By default, the return type is determined based on Content-Type in the header returned by the server.     ***/    responseType?: string;      /**     * Called when the network data is obtained successfully.     ***/    success?: (data: FetchResponse) => void;      /**     * Called when the network data fails to be obtained.     ***/    fail?: (data: any, code: number) => void;      /**     * Called when the execution is completed.     ***/    complete?: () => void;  }): void-End-->
