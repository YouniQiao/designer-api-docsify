...
| --- | --- | --- | --- |
| cert | \_\_\_MD\_LINK\_USD\_0\_\_\_ | Yes | Certificates to be verified. |
| caCert | \_\_\_MD\_LINK\_USD\_0\_\_\_ | No | Incoming custom CA cert. |

**Return value:**

| Type | Description |
| --- | --- |
| ArkTS-Dyn: number  \_\_\_HTML\_TAG\_USD\_0\_\_\_ArkTS-Sta：int | Returns 0 if verify of certification from server succeed, else verify failed. |
