...
\_\_\_HTML\_TAG\_DESC\_USD\_0\_\_\_Returns an object representing the peer certificate. If the peer does not provide a certificate, an empty object will be returned. If the socket is destroyed, null is returned.\_\_\_HTML\_TAG\_DESC\_USD\_1\_\_\_ It only contains the peer's certificate.
