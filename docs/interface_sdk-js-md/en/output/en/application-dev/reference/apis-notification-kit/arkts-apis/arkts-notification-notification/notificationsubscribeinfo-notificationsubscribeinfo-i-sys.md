...
Notification filtering range. The default value is **0**. The options are as follows: - **0**: All notifications are included in the subscription. - **1**: Filter out notifications whose slot type is [SOCIAL\_COMMUNICATION]\_\_\_JSDOC\_LINK\_DESC\_USD\_0\_\_\_ and [userInput]\_\_\_JSDOC\_LINK\_DESC\_USD\_1\_\_\_ is empty. - **2**: Filter out notifications whose slot type is [SOCIAL\_COMMUNICATION]\_\_\_JSDOC\_LINK\_DESC\_USD\_2\_\_\_ and [userInput]\_\_\_JSDOC\_LINK\_DESC\_USD\_3\_\_\_ is not empty.
