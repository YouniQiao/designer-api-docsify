...
Obtains all applications that have requested the ohos.permission.SUBSCRIBE\_NOTIFICATION permission and implemented [NotificationSubscriberExtensionAbility]\_\_\_JSDOC\_LINK\_DESC\_USD\_0\_\_\_. This API uses a promise to return the result.
...
| Type | Description |
| --- | --- |
| Promise&lt;BundleOption[]&gt; | Promise used to return the applications that have requested the |
