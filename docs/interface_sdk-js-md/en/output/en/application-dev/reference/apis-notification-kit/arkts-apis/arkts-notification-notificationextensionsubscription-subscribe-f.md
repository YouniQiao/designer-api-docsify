...
Subscribes to the notification extension. You can subscribe to the notification extension only after obtaining the unique address of the Bluetooth device by calling the APIs related to the \_\_\_MD\_LINK\_DESC\_USD\_0\_\_\_. This API uses a promise to return the result.
