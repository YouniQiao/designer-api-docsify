...
Represents the child class of [MacSpec]\_\_\_JSDOC\_LINK\_DESC\_USD\_0\_\_\_. It is used as an input parameter for CMAC computation. > **NOTE** > > **cipherName** specifies the symmetric cipher algorithm used by CMAC. It is mandatory.
