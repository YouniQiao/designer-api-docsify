...
Symmetric key generator interface, defining methods for generating symmetric keys. Before use, you must create a **SymKeyGenerator** instance by using [createSymKeyGenerator]\_\_\_JSDOC\_LINK\_DESC\_USD\_0\_\_\_.
...
| --- | --- | --- | --- |
| key | \_\_\_MD\_LINK\_USD\_0\_\_\_ | Yes | Data to convert. |
| callback | \_\_\_MD\_LINK\_USD\_0\_\_\_&lt;SymKey&gt; | Yes | Callback used to return the result. If the operation is successful,**err** is **undefined**, and **data** is the symmetric key obtained. Otherwise, **err** is an error object. |
...
| Type | Description |
| --- | --- |
| \_\_\_MD\_LINK\_USD\_0\_\_\_ | Symmetric key obtained. |
...
Generates a random key using this symmetric key generator. This API uses an asynchronous callback to return the result. \_\_\_HTML\_TAG\_DESC\_USD\_1\_\_\_OpenSSL RAND\_priv\_bytes() is currently used to generate random keys. > **NOTE** > > For symmetric keys used in the HMAC algorithm, if a hash algorithm (for example, **HMAC|SHA256**) is specified > when the symmetric key generator is created, a binary key matching the hash length (for example, a 256-bit key) > will be randomly generated. If no hash algorithm is specified, for example, only **HMAC** is specified, random > symmetric key generation is not supported. You can generate symmetric key data using > [convertKey]\_\_\_JSDOC\_LINK\_DESC\_USD\_0\_\_\_.
...
Generates a random key using this symmetric key generator. This API uses a promise to return the result. \_\_\_HTML\_TAG\_DESC\_USD\_0\_\_\_OpenSSL RAND\_priv\_bytes() is currently used to generate random keys.
...
Generates a random key using this symmetric key generator. This API returns the result synchronously. \_\_\_HTML\_TAG\_DESC\_USD\_2\_\_\_OpenSSL RAND\_priv\_bytes() is currently used to generate random keys. > **NOTE** > > For symmetric keys used in the HMAC algorithm, if a hash algorithm (for example, **HMAC|SHA256**) is specified > when the symmetric key generator is created, a binary key matching the hash length (for example, a 256-bit key) > will be randomly generated. If no hash algorithm is specified, for example, only **HMAC** is specified, random symmetric key generation is not supported. You can generate symmetric key data using [convertKeySync]\_\_\_JSDOC\_LINK\_DESC\_USD\_0\_\_\_. \_\_\_HTML\_TAG\_DESC\_USD\_3\_\_\_\_\_\_HTML\_TAG\_DESC\_USD\_4\_\_\_**NOTE** \_\_\_HTML\_TAG\_DESC\_USD\_5\_\_\_It is recommended to prioritize the use of asynchronous API, \_\_\_JSDOC\_LINK\_DESC\_USD\_1\_\_\_. Synchronous API may take a long time and block the main thread due to system busyness, high load, and other reasons. Therefore, it is advised to invoke synchronous API within a child thread to avoid blocking the main thread.
...
| Type | Description |
| --- | --- |
| \_\_\_MD\_LINK\_USD\_0\_\_\_ | Symmetric key generated. |
