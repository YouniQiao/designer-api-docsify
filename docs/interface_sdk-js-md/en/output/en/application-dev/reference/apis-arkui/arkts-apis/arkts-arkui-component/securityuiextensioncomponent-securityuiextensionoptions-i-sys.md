...
Set whether the current capability is used as a Caller.\_\_\_HTML\_TAG\_DESC\_USD\_0\_\_\_ If set to true, as a Caller, the current token of SecurityUIExtensionComponent is set to rootToken.
