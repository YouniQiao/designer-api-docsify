...
**XComponent** provides a [surface](docroot://ui/napi-xcomponent-guidelines.md#overview) for graphics rendering and media data input into your view. You can customize the position and size of the surface as needed. For details, see [Native XComponent](docroot://ui/napi-xcomponent-guidelines.md). > **NOTE**
...
Creates an **XComponent** component, whose lifecycle callbacks can be triggered from the native side. This API is deprecated since API version 12. You are advised to use \_\_\_MD\_LINK\_DESC\_USD\_0\_\_\_ instead.
