...
Image path. The image format can be .jpg, .jpeg, .svg, .png, .bmp, .webp, .ico, or .heif. The [Resource]\_\_\_JSDOC\_LINK\_DESC\_USD\_1\_\_\_ type is supported since API version 9, and the \_\_\_MD\_LINK\_DESC\_USD\_0\_\_\_ type is supported since API version 12.
