...
Visible area calculation mode. **true**: considers the parent's [clip]\_\_\_JSDOC\_LINK\_DESC\_USD\_0\_\_\_ attribute. If [clip]\_\_\_JSDOC\_LINK\_DESC\_USD\_1\_\_\_ is **false**, areas of the child component beyond the parent's bounds are counted as visible; if [clip]\_\_\_JSDOC\_LINK\_DESC\_USD\_2\_\_\_ is **true**, such areas are counted as invisible. **false**: ignores the parent's [clip]\_\_\_JSDOC\_LINK\_DESC\_USD\_3\_\_\_ attribute, treating areas beyond the parent's bounds as invisible. Default value: **false**. When **measureFromViewport** is set to **true**, and an ancestor node has the [scale]\_\_\_JSDOC\_LINK\_DESC\_USD\_4\_\_\_ attribute set, the component's visible ratio will be correctly calculated.
