...
The width of each page in the **Swiper** component equals the maximum width of child components. This enumerated value behaves the same as setting [displayCount]\_\_\_JSDOC\_LINK\_DESC\_USD\_0\_\_\_ to **'auto'** (string type). For details, see [displayCount]\_\_\_JSDOC\_LINK\_DESC\_USD\_1\_\_\_. Note: This API is supported since API version 7 and deprecated since API version 10. You are advised to use **AUTO\_LINEAR** instead.
...
The width of each page in the **Swiper** component equals the width of the leftmost child component in the viewport. This enumerated value behaves the same as setting [displayCount]\_\_\_JSDOC\_LINK\_DESC\_USD\_0\_\_\_ to **'auto'** (string type). For details, see [displayCount]\_\_\_JSDOC\_LINK\_DESC\_USD\_1\_\_\_. Note: This API is supported since API version 10 and deprecated since API version 12. You are advised to use [Scroller.scrollTo]\_\_\_JSDOC\_LINK\_DESC\_USD\_2\_\_\_ instead.
...
**Substitutes:** [Scroller#scrollTo](../../apis-na/arkts-apis/arkts-na-component/scroll-scroller-c.md#scrollto)
