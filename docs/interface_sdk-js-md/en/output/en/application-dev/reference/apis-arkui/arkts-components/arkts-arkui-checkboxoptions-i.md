...
Group name of the check box (that is, the name of the check box group to which the check box belongs). **NOTE** For the settings to take effect, this parameter must be used with the [CheckboxGroup]\_\_\_JSDOC\_LINK\_DESC\_USD\_0\_\_\_ component.
