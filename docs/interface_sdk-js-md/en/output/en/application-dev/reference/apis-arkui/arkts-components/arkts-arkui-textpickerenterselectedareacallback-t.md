...
| --- | --- | --- | --- |
| value | string \| string[] | Yes | Text of the selected item. Use the array type for multi-column pickers.\_\_\_HTML\_TAG\_USD\_0\_\_\_ **NOTE**\_\_\_HTML\_TAG\_USD\_1\_\_\_The return value is a text value for text or mixed content, and an empty string for image-only content.  |
