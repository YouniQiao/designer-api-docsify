...
Invoked when data is added to the position indicated by the specified index. > **NOTE** > > This API is supported since API version 7 and deprecated since API version 8. Use > [onDataAdd]\_\_\_JSDOC\_LINK\_DESC\_USD\_0\_\_\_ instead.
...
Invoked when data in the position indicated by the specified index is changed. > **NOTE** > > This API is supported since API version 7 and deprecated since API version 8. Use > [onDataChange]\_\_\_JSDOC\_LINK\_DESC\_USD\_0\_\_\_ instead.
...
Invoked when data is deleted from the position indicated by the specified index. LazyForEach will update the displayed content accordingly. > **NOTE** > > This API is supported since API version 7 and deprecated since API version 8. Use > [onDataDelete]\_\_\_JSDOC\_LINK\_DESC\_USD\_0\_\_\_ instead.
...
Invoked when data is moved, that is, when data is swapped between the **from** and **to** positions. > **NOTE** > > - This API is supported since API version 7 and deprecated since API version 8. Use > [onDataMove]\_\_\_JSDOC\_LINK\_DESC\_USD\_0\_\_\_ instead. > > - The ID must remain unchanged before and after data movement. If the ID changes, APIs for deleting and adding > data must be called.
