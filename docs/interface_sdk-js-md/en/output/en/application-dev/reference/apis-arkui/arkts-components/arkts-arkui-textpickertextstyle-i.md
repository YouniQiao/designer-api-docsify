...
Minimum font size for the text. Used with **maxFontSize** to enable font scaling. When both **minFontSize** and **maxFontSize** are set, the **size** property in **font** is ignored. By default, the maximum number of lines is 1, with the **MIN\_FONT\_SIZE\_FIRST** adaptation strategy. For details, see [minFontSize]\_\_\_JSDOC\_LINK\_DESC\_USD\_0\_\_\_.
...
Text overflow behavior. This property has no effect when set to **MARQUEE**. For details, see [textOverflow]\_\_\_JSDOC\_LINK\_DESC\_USD\_0\_\_\_.
