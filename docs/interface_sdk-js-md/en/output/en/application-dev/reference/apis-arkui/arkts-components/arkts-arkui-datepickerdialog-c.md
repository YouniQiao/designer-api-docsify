...
Shows a date picker dialog box. > **NOTE** > > Since API version 10, you can use the > \_\_\_MD\_LINK\_DESC\_USD\_0\_\_\_ API > in [UIContext]\_\_\_JSDOC\_LINK\_DESC\_USD\_1\_\_\_, which ensures that the date picker dialog box is shown in the > intended UI instance.
...
| --- | --- | --- | --- |
| options | \_\_\_MD\_LINK\_USD\_0\_\_\_ | No | Parameters of the date picker dialog box. |
