...
**Inheritance/Implementation:** TextEditControllerEx extends [TextBaseController](textcommon-textbasecontroller-i.md)
...
| Type | Description |
| --- | --- |
| boolean | - true means that the component is in editing state, |
