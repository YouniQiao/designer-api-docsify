...
Step value-to-text mappings for assistive technologies (for example, screen readers). Value range for **Key**: [0, INT32\_MAX]. If **Key** is set to a negative number or a decimal, the setting does not take effect. Default value: **{}**
