...
Sets the distortion animation mode for the dialog. Default Value: DistortionMode.DISTORTION\_AUTO
...
Sets the edge light animation mode for the dialog. Default value: EdgeLightMode.EDGELIGHT\_AUTO
