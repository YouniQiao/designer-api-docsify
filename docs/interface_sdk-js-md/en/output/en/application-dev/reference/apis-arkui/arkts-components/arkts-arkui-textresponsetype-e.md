...
When this type is registered but **RIGHT\_CLICK**, **LONG\_PRESS**, or **SELECT** types are not registered, this type will be triggered and displayed for right-click, long press, mouse selection, and [selection]\_\_\_JSDOC\_LINK\_DESC\_USD\_0\_\_\_ API calls.
