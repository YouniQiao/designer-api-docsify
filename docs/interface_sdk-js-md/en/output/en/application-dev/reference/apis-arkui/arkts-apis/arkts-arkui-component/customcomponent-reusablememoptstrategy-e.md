...
<!--Device-unnamed-export declare enum ReusableMemOptStrategy--><!--Device-unnamed-export declare enum ReusableMemOptStrategy-End-->
...
CustomComponent handle the memory optimization.
