...
**Inheritance/Implementation:** GestureEvent extends [BaseEvent](../../apis-na/arkts-apis/arkts-na-component/common-baseevent-i.md)
...
Velocity along the main axis. This parameter is used in [PanGesture]\_\_\_JSDOC\_LINK\_DESC\_USD\_0\_\_\_. The value is the arithmetic square root of the sum of squares of the velocity along the x- and y-axis. The unit is vp/s. Value range: [0, +∞)
