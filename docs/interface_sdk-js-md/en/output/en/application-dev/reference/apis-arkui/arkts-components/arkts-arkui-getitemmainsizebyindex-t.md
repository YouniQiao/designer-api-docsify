...
| --- | --- | --- | --- |
| index | number | Yes | Index of the target water flow item.\_\_\_HTML\_TAG\_USD\_0\_\_\_Value range: [0, total number of child nodes - 1].  |

**Return value:**

| Type | Description |
| --- | --- |
| number | Main axis size, in vp, of the water flow item at the specified index, which is the height for a |
