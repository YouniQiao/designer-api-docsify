...
Animation curve used by the keyframe. You are advised to specify the curve using the **Curve** or **ICurve** type. For the string type, this parameter indicates an animation interpolation curve. For available values, see the **curve** parameter in [AnimateParam]\_\_\_JSDOC\_LINK\_DESC\_USD\_0\_\_\_. Default value: **Curve.EaseInOut** **NOTE** Because the [springMotion]\_\_\_JSDOC\_LINK\_DESC\_USD\_1\_\_\_, [responsiveSpringMotion]\_\_\_JSDOC\_LINK\_DESC\_USD\_2\_\_\_, and [interpolatingSpring]\_\_\_JSDOC\_LINK\_DESC\_USD\_3\_\_\_ curves do not have effective duration settings, they are not supported.
