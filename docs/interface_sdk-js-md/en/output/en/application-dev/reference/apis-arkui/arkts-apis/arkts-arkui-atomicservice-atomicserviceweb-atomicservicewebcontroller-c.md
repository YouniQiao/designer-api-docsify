...
| Type | Description |
| --- | --- |
| boolean | Returns **true** if going to the previous page can be performed on the current page; returns |
...
| Type | Description |
| --- | --- |
| boolean | Returns **true** if going to the next page can be performed on the current page; returns |
...
| Type | Description |
| --- | --- |
| boolean | Whether the page can navigate forward or backward by the specified number of steps. Returns |
...
Moves to the previous page based on the history stack. This API is generally used together with [accessBackward]\_\_\_JSDOC\_LINK\_DESC\_USD\_0\_\_\_.
...
Moves to the next page based on the history stack. This API is generally used together with [accessForward]\_\_\_JSDOC\_LINK\_DESC\_USD\_0\_\_\_.
...
| Type | Description |
| --- | --- |
| string | Information about the custom user agent. For details about the specifications and usage |
...
| Type | Description |
| --- | --- |
| string | Default user agent. For details about the specifications and usage scenarios, see |
