...
| animationMode | \_\_\_MD\_LINK\_USD\_0\_\_\_ \| boolean | No | animation mode for changeIndex,true is equivalent to SwiperAnimationMode.DEFAULT\_\_\_ESCAPED\_UNDERSCORE\_\_\_ANIMATION, false is equivalent to SwiperAnimationMode.NO\_\_\_ESCAPED\_UNDERSCORE\_\_\_ANIMATION |
...
| Type | Description |
| --- | --- |
| boolean | If not in a fake drag progress, or no offset is consumed, return false. |
...
| Type | Description |
| --- | --- |
| boolean | If the fake drag started successfully, return true. |
...
| Type | Description |
| --- | --- |
| boolean | If the fake drag stopped successfully, return true. |
