...
Whether to display the number badge or the number displayed on the badge. For a number badge, the value range is [0, 2\_\_\_HTML\_TAG\_DESC\_USD\_0\_\_\_31\_\_\_HTML\_TAG\_DESC\_USD\_1\_\_\_-1]. Values outside this range will be processed as the default state. If the value specified is a floating-point number, only the integer part is displayed. **NOTE** When multiple items are dragged, use this API to set the number of items dragged. Default value: **true**.
