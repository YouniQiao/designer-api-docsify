...
Creates a child window or system window. This API uses an asynchronous callback to return the result. In non-\_\_\_MD\_LINK\_DESC\_USD\_0\_\_\_ mode, the child window created uses an \_\_\_MD\_LINK\_DESC\_USD\_1\_\_\_ by default. In freeform window mode, the child window created uses an immersive layout when [decorEnabled]\_\_\_JSDOC\_LINK\_DESC\_USD\_2\_\_\_ is set to **false**, and it uses a non-immersive layout when this parameter is set to **true**.
...
| [1300008](../errorcode-window.md#1300008-display-device-exception) | The display device is abnormal.\_\_\_HTML\_TAG\_USD\_0\_\_\_**Applicable version:** 9 - 16 |
...
Creates a child window or system window. This API uses a promise to return the result. In non-\_\_\_MD\_LINK\_DESC\_USD\_0\_\_\_ mode, the child window created uses an \_\_\_MD\_LINK\_DESC\_USD\_1\_\_\_ by default. In freeform window mode, the child window created uses an immersive layout when [decorEnabled]\_\_\_JSDOC\_LINK\_DESC\_USD\_2\_\_\_ is set to **false**, and it uses a non-immersive layout when this parameter is set to **true**.
