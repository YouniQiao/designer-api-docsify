...
Sets the background luminance color picking parameters, registers the luminance change listening callback, and unregisters the listening callback. > **NOTE** > > In the following API examples, you must first use [getLuminanceSampler]\_\_\_JSDOC\_LINK\_DESC\_USD\_0\_\_\_ in > **UIContext** to obtain a **LuminanceSampler** object, and then call the APIs using the obtained object.
