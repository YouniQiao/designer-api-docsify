...
Updates the progress of this interactive transition animation. (Non-interactive animations do not support setting the animation progress). > **NOTE** > > You are not advised to use stack operations in [aboutToAppear]\_\_\_JSDOC\_LINK\_DESC\_USD\_0\_\_\_, as the > page has not yet finished building at this stage, which may lead to issues such as white screens or navigation > failures.
