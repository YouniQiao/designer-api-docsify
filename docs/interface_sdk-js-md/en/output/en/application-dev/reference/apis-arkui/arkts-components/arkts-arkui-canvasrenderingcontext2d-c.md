...
Obtains a **CanvasRenderingContext2D** object from a **DrawingRenderingContext** object. This **CanvasRenderingContext2D** object is bound to the same **Canvas** component as the input **DrawingRenderingContext** object. > **NOTE** > > - The **CanvasRenderingContext2D** object obtained via this API cannot be used as a > parameter to create a [Canvas]\_\_\_JSDOC\_LINK\_DESC\_USD\_0\_\_\_ > component. Otherwise, the application crashes. > > - If the input **DrawingRenderingContext** object is not bound to a **Canvas** component, > an error code is returned.
...
| Type | Description |
| --- | --- |
| \_\_\_MD\_LINK\_USD\_0\_\_\_ | - Returns a **CanvasRenderingContext2D** object that is |
...
Subscribes to the event when a **CanvasRenderingContext2D** object is bound to a **Canvas** component. > **NOTE** > > A **CanvasRenderingContext2D** object can only be bound to one **Canvas** component > at a time.\_\_\_HTML\_TAG\_DESC\_USD\_2\_\_\_ > When a **CanvasRenderingContext2D** object is bound to a **Canvas** component, the > **onAttach** callback is triggered, indicating that the > [canvas]\_\_\_JSDOC\_LINK\_DESC\_USD\_0\_\_\_ > object is accessible.\_\_\_HTML\_TAG\_DESC\_USD\_3\_\_\_ > Avoid performing drawing operations in the **onAttach** callback. Make sure the > **Canvas** component has completed its > [onReady]\_\_\_JSDOC\_LINK\_DESC\_USD\_1\_\_\_ > event before performing any drawing.\_\_\_HTML\_TAG\_DESC\_USD\_4\_\_\_ > The **onAttach** callback is triggered when:\_\_\_HTML\_TAG\_DESC\_USD\_5\_\_\_ > 1. A **Canvas** component is created and bound to a **CanvasRenderingContext2D** > object.\_\_\_HTML\_TAG\_DESC\_USD\_6\_\_\_ > 2. A **CanvasRenderingContext2D** object is bound to a new **Canvas** component.
...
Subscribes to the event when a **CanvasRenderingContext2D** object is unbound from a **Canvas** component. > **NOTE** > > When a **CanvasRenderingContext2D** object is unbound from a **Canvas** component, > the **onDetach** callback is triggered. In this case, cease any drawing operations.\_\_\_HTML\_TAG\_DESC\_USD\_0\_\_\_ > The **onDetach** callback is triggered when:\_\_\_HTML\_TAG\_DESC\_USD\_1\_\_\_ > 1. A **Canvas** component is destroyed and unbound from a **CanvasRenderingContext2D** > object.\_\_\_HTML\_TAG\_DESC\_USD\_2\_\_\_ > 2. A **CanvasRenderingContext2D** object is bound to a different **Canvas** component, > causing the existing binding to be released.
...
Configures and starts the AI analyzer. This API uses a promise to return the result. Before use, set [enableAnalyzer]\_\_\_JSDOC\_LINK\_DESC\_USD\_0\_\_\_ to **true** to enable the image AI analyzer.\_\_\_HTML\_TAG\_DESC\_USD\_1\_\_\_Because the image frame used for analysis is the one captured when this API is called, pay attention to the invoking time of this API.\_\_\_HTML\_TAG\_DESC\_USD\_2\_\_\_ Repeated calls to this method before completion trigger an error callback. For the sample code, see the code for **stopImageAnalyzer**. > **NOTE** > > The image analysis type cannot be dynamically modified. > When image changes are detected, the analysis result is automatically destroyed. You can > call this API again to start analysis. > This API depends on device capabilities. If it is called on an incompatible device, an > error code is returned.
