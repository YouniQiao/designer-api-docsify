...
Time format. Default value: **TimePickerFormat.HOUR\_MINUTE**
...
Time of the selected item. Default value: current system time Since API version 10, this parameter supports two-way binding through \_\_\_MD\_LINK\_DESC\_USD\_0\_\_\_.
