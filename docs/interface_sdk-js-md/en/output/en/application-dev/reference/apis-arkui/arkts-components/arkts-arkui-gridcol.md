...
The **GridCol** component must be used as a child component of the [GridRow]{@link GridRow} container. > **Child Components** > > This component can contain only one child component.
