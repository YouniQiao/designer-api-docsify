...
| --- | --- | --- | --- |
| options | \_\_\_MD\_LINK\_USD\_0\_\_\_ | Yes | Text, background color, shadow, and other parameters of the **ArcButton** component. |
...
Type of the arc button. Default value: **ArcButtonPosition.BOTTOM\_EDGE**
...
Parameters for the progress indicator of the **ArcButton** component. If this property is not set, the **ArcButton** component is displayed as a button (see \_\_\_MD\_LINK\_DESC\_USD\_0\_\_\_ ). If this property is set, the component is displayed as a progress indicator (see \_\_\_MD\_LINK\_DESC\_USD\_1\_\_\_ ). The progress indicator style is not affected by the settings of the [ArcButtonStyleMode]\_\_\_JSDOC\_LINK\_DESC\_USD\_2\_\_\_ attribute. Default value: default values of all properties of [ArcButtonProgressConfig]\_\_\_JSDOC\_LINK\_DESC\_USD\_3\_\_\_
...
Style mode for the arc button. This style cannot be used together with the [ArcButtonProgressConfig]\_\_\_JSDOC\_LINK\_DESC\_USD\_0\_\_\_ style. Default value: **ArcButtonStyleMode.EMPHASIZED\_LIGHT**
