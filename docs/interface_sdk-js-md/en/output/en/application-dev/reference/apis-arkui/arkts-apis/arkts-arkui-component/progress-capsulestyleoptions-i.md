...
**Inheritance/Implementation:** CapsuleStyleOptions extends [ScanEffectOptions](progress-scaneffectoptions-i.md), [CommonProgressStyleOptions](progress-commonprogressstyleoptions-i.md)

**Since:** 23

**ArkTS mode:** ArkTS-Sta only, since version 23.

<!--Device-unnamed-export declare interface CapsuleStyleOptions extends ScanEffectOptions, CommonProgressStyleOptions--><!--Device-unnamed-export declare interface CapsuleStyleOptions extends ScanEffectOptions, CommonProgressStyleOptions-End-->
...
<!--Device-CapsuleStyleOptions-content?: string--><!--Device-CapsuleStyleOptions-content?: string-End-->
...
Set the text style. Default value: Text size (percentage setting is not supported): 12 fp Other text parameters follow the theme value of the [Text]\_\_\_JSDOC\_LINK\_DESC\_USD\_0\_\_\_ component.
