...
Password input mode. The entered text is briefly displayed before turning to dots by default. Since API version 12, the entered text is directly displayed as dots on PCs and 2-in-1 devices. The eye icon at the end of the input box is hidden by default on TV devices, and shown by default on other devices. The [decoration]\_\_\_JSDOC\_LINK\_DESC\_USD\_0\_\_\_, [showUnderline]\_\_\_JSDOC\_LINK\_DESC\_USD\_1\_\_\_, and [lineHeight]\_\_\_JSDOC\_LINK\_DESC\_USD\_2\_\_\_ attributes do not take effect in password input mode. If Password Vault is enabled, autofill is available for the username and password.
