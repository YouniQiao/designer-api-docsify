...
**Inheritance/Implementation:** ProgressStyleOptions extends [CommonProgressStyleOptions](progress-commonprogressstyleoptions-i.md)
...
Defines the scaleCount property. The value should be an integer. Default value: 120. \_\_\_HTML\_TAG\_DESC\_USD\_0\_\_\_If the value exceeds the value range, the progress bar is displayed as a ring without scale.
