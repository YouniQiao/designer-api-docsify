...
| Name | Description |
| --- | --- |
| [FolderStackOptions](folderstack-folderstackoptions-i.md) | FolderStack constructor options. |
| [HoverEventParam](folderstack-hovereventparam-i.md) | Defines the Embed Data info. |
| [OnFoldStatusChangeInfo](folderstack-onfoldstatuschangeinfo-i.md) | Information when onFolderStateChange. |
