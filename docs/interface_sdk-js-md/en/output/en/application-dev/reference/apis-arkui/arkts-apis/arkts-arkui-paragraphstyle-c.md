...
Vertical alignment mode of the text paragraph. The effect of this attribute is noticeable only when the same font size is used in a paragraph and [lineHeight]\_\_\_JSDOC\_LINK\_DESC\_USD\_0\_\_\_ is set, or when different font sizes are used in a paragraph and the font sizes are mixed. The **SuperscriptStyle** in [TextStyle]\_\_\_JSDOC\_LINK\_DESC\_USD\_1\_\_\_ takes effect only when the value of [TextVerticalAlign]\_\_\_JSDOC\_LINK\_DESC\_USD\_2\_\_\_ is set to **TextVerticalAlign.BASELINE**. In other vertical alignment modes, the superscript and subscript texts are displayed in the same way as the normal text.
