...
**Inheritance/Implementation:** SheetOptions extends [BindOptions](../../apis-na/arkts-apis/arkts-na-component/common-bindoptions-i.md)
...
Offset of the sheet. Bottom spacing, which is effective only when the sheet is a bottom sheet. The **detents** property of [SheetOptions]\_\_\_JSDOC\_LINK\_DESC\_USD\_0\_\_\_ is not supported. This property has no effect when the y-axis value is set to a negative number. Default value: 0 vp for both the x-axis and y-axis
