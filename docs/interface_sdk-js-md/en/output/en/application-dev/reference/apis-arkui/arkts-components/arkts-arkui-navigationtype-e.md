...
Navigates to the specified page in the application. **NOTE** This API is supported since API version 7 and deprecated since API version 13. You are advised to use [pushPath]\_\_\_JSDOC\_LINK\_DESC\_USD\_0\_\_\_ instead.
...
Replaces the current page with another one in the application and destroys the current page. **NOTE** This API is supported since API version 7 and deprecated since API version 13. You are advised to use [replacePath]\_\_\_JSDOC\_LINK\_DESC\_USD\_0\_\_\_ instead.
