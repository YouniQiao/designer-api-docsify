...
Whether the popup covers the pointing component during avoidance. Default value: **AvoidanceMode.COVER\_TARGET**
...
Background blur style of the popup. Default value: **BlurStyle.COMPONENT\_ULTRA\_THICK**
...
**Substitutes:** [PopupOptions#placement](../../apis-na/arkts-apis/arkts-na-component/common-popupoptions-i.md#placement)
...
Color of the popup. To remove the background blur, set **backgroundBlurStyle** to **BlurStyle.NONE**. Default value: [TRANSPARENT]\_\_\_JSDOC\_LINK\_DESC\_USD\_0\_\_\_ plus [COMPONENT\_ULTRA\_THICK]\_\_\_JSDOC\_LINK\_DESC\_USD\_1\_\_\_
...
Popup shadow. Default value: **ShadowStyle.OUTER\_DEFAULT\_MD**
