...
| Type | Description |
| --- | --- |
| Promise&lt;boolean&gt; | Promise used to return the auto-start PiP switch status. **true** if enabled, |
...
| Type | Description |
| --- | --- |
| Promise&lt;boolean&gt; | Promise used to return the PiP window status. **true** is returned if the PiP |
...
Unsubscribes from PiP action events. The **[off('controlEvent')]\_\_\_JSDOC\_LINK\_DESC\_USD\_0\_\_\_** API is preferred.
...
Subscribes to PiP action events. To avoid potential memory leaks, you are advised to stop listening when it is no longer needed. The [on('controlEvent')]\_\_\_JSDOC\_LINK\_DESC\_USD\_0\_\_\_ API is preferred.
