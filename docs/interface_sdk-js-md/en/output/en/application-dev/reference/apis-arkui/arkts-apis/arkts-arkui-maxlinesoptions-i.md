...
**overflowMode** can be used to set the non-inline mode for the [TextArea]\_\_\_JSDOC\_LINK\_DESC\_USD\_0\_\_\_ component. When the text exceeds the set value of **maxLines** (maximum number of lines), a scroll effect is enabled. This requires configuration of [textOverflow]\_\_\_JSDOC\_LINK\_DESC\_USD\_1\_\_\_, and **MaxLinesMode** takes effect only when **textOverflow** is set to **None** or **Clip**. The default value of **MaxLinesMode** is **Clip**, indicating that text is truncated when it exceeds the value of **maxLines**.
