...
Sets the parameters for the pinch gesture. Compared with [PinchGesture]\_\_\_JSDOC\_LINK\_DESC\_USD\_0\_\_\_)}, this API adds the **isFingerCountLimited** parameter to **options**, which determines whether to enforce the exact number of fingers touching the screen.
...
Triggered when a touch cancellation event occurs after successful pinch gesture recognition. Compared with [onActionCancel]\_\_\_JSDOC\_LINK\_DESC\_USD\_0\_\_\_, this callback returns gesture event information.
