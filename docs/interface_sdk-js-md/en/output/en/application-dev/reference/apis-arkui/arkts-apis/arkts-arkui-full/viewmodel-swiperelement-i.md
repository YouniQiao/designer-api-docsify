...
<!--Device-SwiperElement-swipeTo(position: {    /**     * specified position.     *     *****/    index: number;  }): void--><!--Device-SwiperElement-swipeTo(position: {    /**     * specified position.     *     *****/    index: number;  }): void-End-->
