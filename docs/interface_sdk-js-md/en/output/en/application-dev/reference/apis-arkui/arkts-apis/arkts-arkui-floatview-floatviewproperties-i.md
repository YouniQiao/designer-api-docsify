...
Avoid area for the content of the float view. Note: On the page loaded by [setUIContext]\_\_\_JSDOC\_LINK\_DESC\_USD\_0\_\_\_, components in the avoid area do not respond to gesture events. When adding components that require gesture response events, avoid the area.
