...
Font size. Default value: 16 fp. If **unit** of **LengthMetrics** is percent, the setting does not take effect, and 16 fp is used instead. Unit: [fp]\_\_\_JSDOC\_LINK\_DESC\_USD\_0\_\_\_
...
Text stroke join style. Default value: **StrokeJoinStyle.MITER\_JOIN**. **Since**: 26.0.0.
