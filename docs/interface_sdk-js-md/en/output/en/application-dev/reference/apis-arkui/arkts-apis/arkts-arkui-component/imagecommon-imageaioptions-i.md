...
Image AI analysis options. > **Description:** > > The types parameter in this feature has higher priority than the types parameter in > [ImageAnalyzerConfig]\_\_\_JSDOC\_LINK\_DESC\_USD\_0\_\_\_. When both are set, > the value set in this feature takes precedence. > > This feature depends on device capability and needs to be used with > the [enableAnalyzer]\_\_\_JSDOC\_LINK\_DESC\_USD\_1\_\_\_ interface > of the corresponding component (for example, [Image component]\_\_\_JSDOC\_LINK\_DESC\_USD\_2\_\_\_).
...
Image AI analysis controller. The enableAnalyzer interface of the corresponding component (for example, the [enableAnalyzer]\_\_\_JSDOC\_LINK\_DESC\_USD\_0\_\_\_ interface of the Image component) must be set to true for this to take effect. Currently, only ESValue type is supported.
