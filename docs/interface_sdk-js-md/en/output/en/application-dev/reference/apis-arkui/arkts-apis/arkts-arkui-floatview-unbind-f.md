...
Unbinds the float view and floating ball. The unbinding can be performed only after both the [float view controller]\_\_\_JSDOC\_LINK\_DESC\_USD\_0\_\_\_ and [floating ball controller]\_\_\_JSDOC\_LINK\_DESC\_USD\_1\_\_\_ are stopped. This API uses a promise to return the result.
