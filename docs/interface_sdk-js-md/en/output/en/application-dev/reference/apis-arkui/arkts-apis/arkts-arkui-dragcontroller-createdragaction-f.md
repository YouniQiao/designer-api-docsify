...
Initiates a drag action, with the object to be dragged and the drag information passed in. This API uses a promise to return the result. > **NOTE** > > - Since API version 11, you can use the > [getDragController]\_\_\_JSDOC\_LINK\_DESC\_USD\_0\_\_\_ API in > [UIContext]\_\_\_JSDOC\_LINK\_DESC\_USD\_1\_\_\_ to obtain the > [DragController]\_\_\_JSDOC\_LINK\_DESC\_USD\_2\_\_\_ object associated with the current UI context. > > - For optimal drag and drop performance, limit the number of drag previews.
...
| Type | Description |
| --- | --- |
| \_\_\_MD\_LINK\_USD\_0\_\_\_ | **DragAction** object, which is used to subscribe to drag state changes and start the |
