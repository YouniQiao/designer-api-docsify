...
Row gap of the section. If this parameter is not set, the [rowsGap]\_\_\_JSDOC\_LINK\_DESC\_USD\_0\_\_\_ of the **WaterFlow** component is used by default. If an invalid value is set, 0 vp is used.
