...
The \_\_\_HTML\_TAG\_DESC\_USD\_0\_\_\_ component provides menus as temporary pop-up windows to display operations that can be performed by users.

**Inheritance/Implementation:** MenuElement extends [Element](viewmodel-element-i.md)
