...
Array of breakpoint values and the corresponding reference based on the application window or container size. Default value: \_\_\_CODE\_BLOCK\_DESC\_USD\_0\_\_\_ Invalid values are treated as the default value. Unit: vp.
