...
Inherited from [AlertDialogParam]\_\_\_JSDOC\_LINK\_DESC\_USD\_0\_\_\_. Priorities of the **confirm** parameters: **fontColor** and **backgroundColor** > **style** > **defaultFocus**

**Inheritance/Implementation:** AlertDialogParamWithConfirm extends [AlertDialogParam](../../apis-na/arkts-apis/arkts-na-component/alertdialog-alertdialogparam-i.md)
