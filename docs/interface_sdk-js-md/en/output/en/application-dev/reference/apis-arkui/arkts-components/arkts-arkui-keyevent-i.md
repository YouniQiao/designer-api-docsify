...
| Type | Description |
| --- | --- |
| boolean | Whether the modifier key is pressed. **true** if the modifier key is pressed; **false** |
...
Intention corresponding to the key. Default value: **IntentionCode.INTENTION\_UNKNOWN**.
...
Key value. For details about the key values provided by the key-based input devices, see [KeyCode]\_\_\_JSDOC\_LINK\_DESC\_USD\_0\_\_\_.
