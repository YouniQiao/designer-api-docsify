...
| param | object \| Array&lt;any&gt; | No | Content used to replace placeholders during runtime. There are two types of placeholders available:1. Named placeholder, for example, {name}. The actual content must be of the object type, for example, \_\_\_ESCAPED\_DOLLAR\_\_\_t('strings.object', {name: 'Hello world'}).2. Digit placeholder, for example, {0}. The actual content must be of the array type, for example, \_\_\_ESCAPED\_DOLLAR\_\_\_t('strings.array', ['Hello world']). |
