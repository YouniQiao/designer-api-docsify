...
Define the font weight of the badge. Default value: FontWeight.Normal. \_\_\_HTML\_TAG\_DESC\_USD\_0\_\_\_Value range of the number type: [100, 900], with an interval of 100. A larger value indicates a thicker font. If the number type is out of the value range, the default value 400 is used. The value of the string type must be a string of values of the number type, for example, 400. The values of bold, bolter, lighter, regular, and medium correspond to the corresponding enumerated values in FontWeight, respectively.
