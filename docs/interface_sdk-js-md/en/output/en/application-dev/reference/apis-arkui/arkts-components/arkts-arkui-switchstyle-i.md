...
Color of the circular slider when the component is of the **Switch** type. Default value: **\$r('sys.color.ohos\_id\_color\_foreground\_contrary')**
...
Background color of the component when it is of the **Switch** type and is disabled. Default value: **0x337F7F7F** (applies to both dark and light modes). Since API version 20, when \_\_\_MD\_LINK\_DESC\_USD\_0\_\_\_ is enabled, the default value is **0x19000000** (black with 10% opacity) in light mode and **0x19FFFFFF** (white with 10% opacity) in dark mode.
