...
Placeholder for size changes, displayed when the UIExtensionComponent's size changes and the internal rendering of **UIExtension** is not completed. The key value can be **FOLD\_TO\_EXPAND** (size change for folding and expanding) or **UNDEFINED** (default size change).
...
Whether the DPI settings follow the host or UIExtensionAbility. Default value: **FOLLOW\_UI\_EXTENSION\_ABILITY\_DPI**
...
Following strategy of the window mode. Default value: **FOLLOW\_UI\_EXTENSION\_ABILITY\_WINDOW\_MODE**
