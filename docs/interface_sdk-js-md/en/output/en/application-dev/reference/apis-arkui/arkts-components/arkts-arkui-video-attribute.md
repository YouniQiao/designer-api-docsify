...
In addition to the [universal attributes]\_\_\_JSDOC\_LINK\_DESC\_USD\_0\_\_\_, the following attributes are supported. In addition to the [universal events]\_\_\_JSDOC\_LINK\_DESC\_USD\_1\_\_\_, the following events are supported.
...
Sets the AI image analysis types, including subject recognition, text recognition, and object lookup. This attribute can be dynamically set using [attributeModifier]\_\_\_JSDOC\_LINK\_DESC\_USD\_0\_\_\_. > **NOTE** > > This API can be called within [attributeModifier]\_\_\_JSDOC\_LINK\_DESC\_USD\_1\_\_\_ since API version 20.
...
Sets whether to enable autoplay. This attribute can be dynamically set using [attributeModifier]\_\_\_JSDOC\_LINK\_DESC\_USD\_0\_\_\_.
...
Sets whether to display the video playback control bar. This attribute can be dynamically set using [attributeModifier]\_\_\_JSDOC\_LINK\_DESC\_USD\_0\_\_\_.
...
Sets whether to enable the AI image analyzer, which supports subject recognition, text recognition, and object lookup. This attribute can be dynamically set using [attributeModifier]\_\_\_JSDOC\_LINK\_DESC\_USD\_0\_\_\_. After this feature is enabled, the video automatically enters an analysis state to process the current frame when playback is paused, and exits the analysis state when playback is resumed. Note that if this attribute and the [overlay]\_\_\_JSDOC\_LINK\_DESC\_USD\_1\_\_\_ attribute are both set, [CustomBuilder]\_\_\_JSDOC\_LINK\_DESC\_USD\_2\_\_\_ specified in [overlay]\_\_\_JSDOC\_LINK\_DESC\_USD\_3\_\_\_ has no effect. > **NOTE** > > This API can be called within [attributeModifier]\_\_\_JSDOC\_LINK\_DESC\_USD\_4\_\_\_ since API version 20. After this feature is enabled, the video automatically enters an analysis state to process the current frame when playback is paused, and exits the analysis state when playback is resumed.
...
Sets whether to repeat the video. This attribute can be dynamically set using [attributeModifier]\_\_\_JSDOC\_LINK\_DESC\_USD\_0\_\_\_.
...
Sets whether to mute the video. This attribute can be dynamically set using [attributeModifier]\_\_\_JSDOC\_LINK\_DESC\_USD\_0\_\_\_.
...
Sets the fill mode for the video content. This attribute can be dynamically set using [attributeModifier]\_\_\_JSDOC\_LINK\_DESC\_USD\_0\_\_\_.
