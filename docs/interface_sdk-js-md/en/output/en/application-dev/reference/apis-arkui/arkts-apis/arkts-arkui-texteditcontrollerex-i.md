...
Implements an extended text editing controller. Inherits [TextBaseController]\_\_\_JSDOC\_LINK\_DESC\_USD\_0\_\_\_.
...
| Type | Description |
| --- | --- |
| boolean | Editing status of the rich text. **true** means that the text is in editable state, and |
