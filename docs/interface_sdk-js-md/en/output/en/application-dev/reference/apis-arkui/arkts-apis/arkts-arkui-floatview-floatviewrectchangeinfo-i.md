...
Reason for the change of the rectangle area of the float view. The reasons and their meanings are as follows: **"POSITION\_CHANGE"**: The position changes. **"SIZE\_CHANGE"**: The size changes. **"RECT\_CHANGE"**: Both the position and size change.
