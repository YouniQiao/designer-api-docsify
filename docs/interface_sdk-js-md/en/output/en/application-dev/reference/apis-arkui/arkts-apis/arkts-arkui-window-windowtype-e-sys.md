...
Input method window. Note: This API is supported since API version 9 and deprecated since API version 13. There is no alternative window type. To control the input method, call \_\_\_MD\_LINK\_DESC\_USD\_0\_\_\_.
