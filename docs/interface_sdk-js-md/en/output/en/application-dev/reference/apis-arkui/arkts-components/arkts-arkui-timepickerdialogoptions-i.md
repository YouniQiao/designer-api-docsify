...
Defines the configuration options of the time picker dialog box. Inherited from [TimePickerOptions]\_\_\_JSDOC\_LINK\_DESC\_USD\_0\_\_\_.
...
Shadow of the dialog box. **NOTE** Default value on 2-in-1 devices: **ShadowStyle.OUTER\_FLOATING\_MD** when the dialog box is focused and **ShadowStyle.OUTER\_FLOATING\_SM** otherwise
