...
Represents the return value of the [getEvent('WaterFlow')]\_\_\_JSDOC\_LINK\_DESC\_USD\_0\_\_\_ method in **frameNode**, which can be used to set scroll events for a **WaterFlow** node.

**Inheritance/Implementation:** UIWaterFlowEvent extends [UIScrollableCommonEvent](../../apis-na/arkts-apis/arkts-na-component/common-uiscrollablecommonevent-i.md)
