...
**Inheritance/Implementation:** ClickEvent extends [BaseEvent](../../apis-na/arkts-apis/arkts-na-component/common-baseevent-i.md)
...
X coordinate of the click position in the \_\_\_MD\_LINK\_DESC\_USD\_0\_\_\_. Unit: vp Value range: (-∞, +∞).
...
Y coordinate of the click position in the \_\_\_MD\_LINK\_DESC\_USD\_0\_\_\_. Unit: vp Value range: (-∞, +∞).
...
**Substitutes:** [ClickEvent#windowX](../../apis-na/arkts-apis/arkts-na-component/common-clickevent-i.md#windowx)
...
**Substitutes:** [ClickEvent#windowY](../../apis-na/arkts-apis/arkts-na-component/common-clickevent-i.md#windowy)
...
X coordinate of the click position in the \_\_\_MD\_LINK\_DESC\_USD\_0\_\_\_ based on the clicked element. After [distanceThreshold]\_\_\_JSDOC\_LINK\_DESC\_USD\_1\_\_\_ is set for **onClick**, the click position is the lift-off point. If the event is triggered by a keyboard or gamepad device, the click position is the center of the clicked element. Unit: vp
