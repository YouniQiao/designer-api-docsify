...
| Type | Description |
| --- | --- |
| boolean | - whether the cancel operation is successful. For example, |
...
| Type | Description |
| --- | --- |
| boolean | - whether the createAnimation operation is successful. For example, |
...
| Type | Description |
| --- | --- |
| boolean | - Returns whether the node is in the render state. True indicates it is in the |
...
| Type | Description |
| --- | --- |
| boolean | - Returns true when the current FrameNode is a minimized FrameNode, |
...
| Type | Description |
| --- | --- |
| boolean | - Returns true if the FrameNode was converted between dynamic and static states, |
