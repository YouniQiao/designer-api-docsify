...
Alignment mode of the dialog box in the vertical direction. \_\_\_HTML\_TAG\_DESC\_USD\_0\_\_\_Default value: **DialogAlignment.Default** \_\_\_HTML\_TAG\_DESC\_USD\_1\_\_\_**NOTE** \_\_\_HTML\_TAG\_DESC\_USD\_2\_\_\_If **showInSubWindow** is set to **true** in **UIExtension**, the dialog box is aligned with the host window based on **UIExtension**.
...
Whether to dismiss the dialog box when the mask is touched. The value **true** means to dismiss the dialog box when the mask is touched, and **false** means the opposite.\_\_\_HTML\_TAG\_DESC\_USD\_0\_\_\_Default value: **true**.
...
Whether the dialog box can gain focus. \_\_\_HTML\_TAG\_DESC\_USD\_0\_\_\_**true**: The dialog box can gain focus. \_\_\_HTML\_TAG\_DESC\_USD\_1\_\_\_**false**: The dialog box cannot gain focus. \_\_\_HTML\_TAG\_DESC\_USD\_2\_\_\_Default value: **true**. \_\_\_HTML\_TAG\_DESC\_USD\_3\_\_\_**NOTE** \_\_\_HTML\_TAG\_DESC\_USD\_4\_\_\_Only dialog boxes that are displayed on top of the current window can gain focus.
...
Display area of the dialog box in the hover state. \_\_\_HTML\_TAG\_DESC\_USD\_0\_\_\_Default value: **HoverModeAreaType.BOTTOM\_SCREEN**
...
Distance between the dialog box and the keyboard after keyboard avoidance is applied. \_\_\_HTML\_TAG\_DESC\_USD\_0\_\_\_**NOTE** \_\_\_HTML\_TAG\_DESC\_USD\_1\_\_\_- Default value: **16vp** \_\_\_HTML\_TAG\_DESC\_USD\_2\_\_\_- Default unit: vp \_\_\_HTML\_TAG\_DESC\_USD\_3\_\_\_- This parameter takes effect only when **keyboardAvoidMode** is set to **DEFAULT**.
...
How the dialog box avoids the soft keyboard when it is brought up. \_\_\_HTML\_TAG\_DESC\_USD\_0\_\_\_Default value: **KeyboardAvoidMode.DEFAULT**
...
Mask color. \_\_\_HTML\_TAG\_DESC\_USD\_0\_\_\_Default value: **0x33000000**
...
Mask area. \_\_\_HTML\_TAG\_DESC\_USD\_1\_\_\_Default value: **{ x: 0, y: 0, width: '100%', height: '100%' }** \_\_\_HTML\_TAG\_DESC\_USD\_2\_\_\_**NOTE** \_\_\_HTML\_TAG\_DESC\_USD\_3\_\_\_**maskRect** does not take effect when **showInSubWindow** is set to **true**. \_\_\_HTML\_TAG\_DESC\_USD\_4\_\_\_If only some properties in \_\_\_MD\_LINK\_DESC\_USD\_0\_\_\_ are set, the unset properties default to 0.
...
Offset of the dialog box based on the **alignment** settings. \_\_\_HTML\_TAG\_DESC\_USD\_0\_\_\_Default value: **{&nbsp;dx:&nbsp;0&nbsp;,&nbsp;dy:&nbsp;0&nbsp;}**
...
Event callback after the dialog box appears. \_\_\_HTML\_TAG\_DESC\_USD\_0\_\_\_**NOTE** \_\_\_HTML\_TAG\_DESC\_USD\_1\_\_\_1. The normal timing sequence is as follows: onWillAppear > onDidAppear > (onDateAccept/onCancel/onDateChange) > onWillDisappear > onDidDisappear. \_\_\_HTML\_TAG\_DESC\_USD\_2\_\_\_2. You can set the callback event for changing the dialog box display effect in **onDidAppear**. The settings take effect next time the dialog box appears. \_\_\_HTML\_TAG\_DESC\_USD\_3\_\_\_3. If the user dismisses the dialog box immediately after it appears, **onWillDisappear** is invoked before **onDidAppear**. \_\_\_HTML\_TAG\_DESC\_USD\_4\_\_\_4. If the dialog box is dismissed before its appearance animation is finished, this callback is not invoked.
...
Event callback after the dialog box disappears. \_\_\_HTML\_TAG\_DESC\_USD\_0\_\_\_**NOTE** \_\_\_HTML\_TAG\_DESC\_USD\_1\_\_\_The normal timing sequence is as follows: onWillAppear > onDidAppear > (onDateAccept/onCancel/onDateChange) > onWillDisappear > onDidDisappear. \_\_\_HTML\_TAG\_DESC\_USD\_2\_\_\_This callback is not triggered if the dialog box disappearance animation is interrupted (for example, by page navigation).
...
Event callback when the dialog box is about to appear. \_\_\_HTML\_TAG\_DESC\_USD\_0\_\_\_**NOTE** \_\_\_HTML\_TAG\_DESC\_USD\_1\_\_\_1. The normal timing sequence is as follows: onWillAppear > onDidAppear > (onDateAccept/onCancel/onDateChange) > onWillDisappear > onDidDisappear. \_\_\_HTML\_TAG\_DESC\_USD\_2\_\_\_2. You can set the callback event for changing the dialog box display effect in **onWillAppear**. The settings take effect next time the dialog box appears.
...
Event callback when the dialog box is about to disappear. \_\_\_HTML\_TAG\_DESC\_USD\_0\_\_\_**NOTE** \_\_\_HTML\_TAG\_DESC\_USD\_1\_\_\_1. The normal timing sequence is as follows: onWillAppear > onDidAppear > (onDateAccept/onCancel/onDateChange) > onWillDisappear > onDidDisappear. \_\_\_HTML\_TAG\_DESC\_USD\_2\_\_\_2. If the user dismisses the dialog box immediately after it appears, **onWillDisappear** is invoked before **onDidAppear**.
...
Callback for interactive dismissal of the dialog box. \_\_\_HTML\_TAG\_DESC\_USD\_0\_\_\_**NOTE** \_\_\_HTML\_TAG\_DESC\_USD\_1\_\_\_1. If this callback is registered, the dialog box will not be dismissed immediately after the user touches the mask or the Back button, presses the Esc key, or swipes left or right on the screen. The **reason** parameter in the callback is used to determine whether the dialog box can be dismissed. The reason returned by the component does not support the value **CLOSE\_BUTTON**. \_\_\_HTML\_TAG\_DESC\_USD\_2\_\_\_2. In the **onWillDismiss** callback, another **onWillDismiss** callback is not allowed.
...
Whether to show the dialog box in a subwindow when the dialog box needs to be displayed outside the main window. \_\_\_HTML\_TAG\_DESC\_USD\_0\_\_\_**true**: The dialog box is shown in a subwindow. \_\_\_HTML\_TAG\_DESC\_USD\_1\_\_\_Default value: **false**, meaning the dialog box is displayed within the application, not in a separate subwindow
...
Transition effect for the appearance and disappearance of the dialog box.\_\_\_HTML\_TAG\_DESC\_USD\_0\_\_\_**NOTE** \_\_\_HTML\_TAG\_DESC\_USD\_1\_\_\_ 1. If this parameter is not set, the default effect is used. \_\_\_HTML\_TAG\_DESC\_USD\_2\_\_\_ 2. Touching the Back button during the appearance animation pauses the appearance animation and starts the disappearance animation. The final effect is one obtained after the curves of the appearance and disappearance animations are combined. \_\_\_HTML\_TAG\_DESC\_USD\_3\_\_\_ 3. Touching the Back button during the exit animation does not affect the animation playback. Touching the Back button again closes the application.
