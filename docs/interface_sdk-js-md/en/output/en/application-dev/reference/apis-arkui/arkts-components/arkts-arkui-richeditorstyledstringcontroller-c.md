...
Represents the controller of the **RichEditor** component constructed using the styled string. Inherits from [RichEditorBaseController]\_\_\_JSDOC\_LINK\_DESC\_USD\_0\_\_\_.
...
| Type | Description |
| --- | --- |
| \_\_\_MD\_LINK\_USD\_0\_\_\_ | Selection range. |
...
| Type | Description |
| --- | --- |
| \_\_\_MD\_LINK\_USD\_0\_\_\_ | Styled string displayed in the rich text component. |
...
Registers the callback for the text content change. This callback is triggered only when the text content is changed by backend programs, and is not triggered when [setStyledString]\_\_\_JSDOC\_LINK\_DESC\_USD\_0\_\_\_ is called.
