...
| Type | Description |
| --- | --- |
| boolean | Whether the current gesture recognizer is a built-in gesture. The value **true** means that |
...
| Type | Description |
| --- | --- |
| boolean | Enabled state of the gesture recognizer. The value **true** means that the gesture recognizer |
...
| Type | Description |
| --- | --- |
| boolean | Whether the preset gesture will detect the number of fingers on the screen. **true** if the |
...
| Type | Description |
| --- | --- |
| boolean | Whether the node bound to the current gesture recognizer is a descendant of the specified |
