...
Size of the rectangle that can be drawn in the window. The upper boundary and left boundary are calculated relative to the top-left vertex of the window. In the stage model, this property should be obtained after [loadContent()]\_\_\_JSDOC\_LINK\_DESC\_USD\_0\_\_\_ or [setUIContent()]\_\_\_JSDOC\_LINK\_DESC\_USD\_1\_\_\_ is called to load the page content.
...
Whether an \_\_\_MD\_LINK\_DESC\_USD\_0\_\_\_ is set for a child window. If an immersive-layout is set for the child window, the return value is **true**. Whether an \_\_\_MD\_LINK\_DESC\_USD\_1\_\_\_ is set for the main window and the main window is in full-screen mode. If an immersive-layout is set for the main window and the main window is in full-screen mode, the return value is **true**. In other cases, the return value is **false**.
...
Whether the window is in privacy mode. **true** if the window is in privacy mode, **false** otherwise. You can call [setWindowPrivacyMode()]\_\_\_JSDOC\_LINK\_DESC\_USD\_0\_\_\_ to set the privacy mode of the window.
...
Window size, which can be obtained from the page lifecycle [onPageShow]\_\_\_JSDOC\_LINK\_DESC\_USD\_0\_\_\_ or the application lifecycle [onForeground]\_\_\_JSDOC\_LINK\_DESC\_USD\_1\_\_\_.
