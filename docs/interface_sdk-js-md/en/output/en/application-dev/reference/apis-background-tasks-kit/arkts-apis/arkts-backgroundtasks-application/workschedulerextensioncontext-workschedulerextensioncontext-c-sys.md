...
The **WorkSchedulerExtensionContext** module, inherited from [ExtensionContext]\_\_\_JSDOC\_LINK\_DESC\_USD\_0\_\_\_, provides a context environment for the **WorkSchedulerExtensionAbility**. This module provides APIs for accessing the resources of a **WorkSchedulerExtensionAbility**.

**Inheritance/Implementation:** WorkSchedulerExtensionContext extends [ExtensionContext](../../../apis-ability-kit/arkts-apis/arkts-ability-application/extensioncontext-extensioncontext-c.md)
...
| --- | --- | --- | --- |
| want | \_\_\_MD\_LINK\_USD\_0\_\_\_ | Yes | Information about the **Want** used for starting an ability. |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| want | \_\_\_MD\_LINK\_USD\_0\_\_\_ | Yes | Information about the **Want** used for stopping an ability. |
