...
| bgMode | \_\_\_MD\_LINK\_USD\_0\_\_\_ | Yes | Background mode requested. |
| wantAgent | \_\_\_MD\_LINK\_USD\_0\_\_\_ | Yes | Notification parameter, which is used to specify the target page that is redirected to when a continuous task notification is clicked. |
