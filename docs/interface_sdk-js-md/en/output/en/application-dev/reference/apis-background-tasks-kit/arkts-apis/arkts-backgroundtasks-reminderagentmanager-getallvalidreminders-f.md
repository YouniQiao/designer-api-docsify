...
Obtains all \_\_\_MD\_LINK\_DESC\_USD\_0\_\_\_ set by the current application. This API uses a promise to return the result. To call this API, you need to request the ohos.permission.PUBLISH\_AGENT\_REMINDER permission.
