...
Car key. **NOTE** 1. The car key subtype takes effect only when a continuous task of the BLUETOOTH\_INTERACTION type is requested. 2. Continuous tasks of this type cannot be updated through the [updateBackgroundRunning]\_\_\_JSDOC\_LINK\_DESC\_USD\_0\_\_\_ API.
