...
| --- | --- | --- | --- |
| groupCallback | \_\_\_MD\_LINK\_USD\_0\_\_\_&lt;AppGroupCallbackInfo&gt; | Yes | callback of AppGroupCallbackInfo when the group of app changed. |
| callback | \_\_\_MD\_LINK\_USD\_0\_\_\_&lt;void&gt; | Yes | Callback used to return the result.If the registration is successful, **err** is **undefined**. Otherwise, **err** is an error object. |
