...
Publishes a reminder through the reminder agent. This API uses an asynchronous callback to return the result. It can be called only when notification is enabled for the application through [Notification.requestEnableNotification]\_\_\_JSDOC\_LINK\_DESC\_USD\_0\_\_\_
...
| --- | --- | --- | --- |
| reminderReq | \_\_\_MD\_LINK\_USD\_0\_\_\_ | Yes | Reminder to be published. |
| callback | \_\_\_MD\_LINK\_USD\_0\_\_\_&lt;number&gt; | Yes | Callback used to return the published reminder's ID. |
...
Publishes a reminder through the reminder agent. This API uses a promise to return the result. It can be called only when notification is enabled for the application through [Notification.requestEnableNotification]\_\_\_JSDOC\_LINK\_DESC\_USD\_0\_\_\_
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| reminderReq | \_\_\_MD\_LINK\_USD\_0\_\_\_ | Yes | Indicates the reminder instance to publish. |
