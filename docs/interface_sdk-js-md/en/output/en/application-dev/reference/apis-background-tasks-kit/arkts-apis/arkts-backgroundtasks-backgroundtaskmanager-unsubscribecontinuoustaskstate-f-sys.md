...
| --- | --- | --- | --- |
| subscriber | \_\_\_MD\_LINK\_USD\_0\_\_\_ | Yes | Background task listener that listens for continuous task state changes, including start, update and stop events. |
