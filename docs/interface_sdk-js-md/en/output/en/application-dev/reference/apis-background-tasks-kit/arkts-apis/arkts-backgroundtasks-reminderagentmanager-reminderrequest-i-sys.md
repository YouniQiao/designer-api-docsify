...
Whether notifications are forcibly displayed in all scenarios across devices. The default value is **false**. For details, see [NotificationRequest.forceDistributed]\_\_\_JSDOC\_LINK\_DESC\_USD\_0\_\_\_ - **true**: Notifications are displayed on all collaboration devices. - **false**: Notifications are displayed on the applications that are on the collaborative management list.
...
Whether notifications are not displayed in all scenarios across devices. The default value is **false**. For details, see [NotificationRequest.notDistributed]\_\_\_JSDOC\_LINK\_DESC\_USD\_0\_\_\_ - **true**: Notifications are displayed only on the local device. - **false**: Notifications are displayed on all collaborative devices.
