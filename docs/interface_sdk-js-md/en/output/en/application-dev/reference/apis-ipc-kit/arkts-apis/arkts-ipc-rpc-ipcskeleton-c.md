...
| Type | Description |
| --- | --- |
| number | Returns **0** if the operation is successful; returns an error code if the input object is |
...
| Type | Description |
| --- | --- |
| boolean | Returns **true** if the local and peer processes are on the same device; returns **false** |
