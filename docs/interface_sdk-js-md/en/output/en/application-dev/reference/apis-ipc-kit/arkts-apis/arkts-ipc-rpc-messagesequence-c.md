...
| Type | Description |
| --- | --- |
| boolean | Returns **true** if the **MessageSequence** object contains file descriptors; returns |
...
| Type | Description |
| --- | --- |
| \_\_\_MD\_LINK\_USD\_0\_\_\_[] | The **IRemoteObject** array is returned. If an empty array is written, **null** is |
