...
**Inheritance/Implementation:** DistributedExtensionContext extends [ExtensionContext](../../apis-ability-kit/arkts-apis/arkts-ability-application/extensioncontext-extensioncontext-c.md)
...
Connects to a remote Service extension ability. This method connects to a Service extension ability on a remote device. You must implement the \_\_\_JSDOC\_LINK\_DESC\_USD\_0\_\_\_ interface to obtain the proxy of the target service extension when connected.
...
| options | \_\_\_MD\_LINK\_USD\_0\_\_\_ | Yes | Indicates the callback of connection. |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| connection | ArkTS-Dyn: number  \_\_\_HTML\_TAG\_USD\_0\_\_\_ArkTS-Sta：long | Yes | the connection id returned from connectServiceExtensionAbility |
