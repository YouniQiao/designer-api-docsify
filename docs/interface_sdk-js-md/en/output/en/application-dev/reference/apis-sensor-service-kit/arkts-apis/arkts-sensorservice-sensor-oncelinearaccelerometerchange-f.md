...
Subscribe to linear acceleration sensor data once, {@code SensorId.LINEAR\_ACCELEROMETER}.
...
| --- | --- | --- | --- |
| callback | \_\_\_MD\_LINK\_USD\_0\_\_\_&lt;LinearAccelerometerResponse&gt; | Yes | callback linear accelerometer data. |
