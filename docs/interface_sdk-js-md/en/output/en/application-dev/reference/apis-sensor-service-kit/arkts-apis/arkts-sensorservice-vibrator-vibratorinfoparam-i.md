...
Device ID. The default value is **-1**, indicating the local device. Since API version 19, you can use [getVibratorInfoSync]\_\_\_JSDOC\_LINK\_DESC\_USD\_0\_\_\_ or [on]\_\_\_JSDOC\_LINK\_DESC\_USD\_1\_\_\_ to query the device ID.
