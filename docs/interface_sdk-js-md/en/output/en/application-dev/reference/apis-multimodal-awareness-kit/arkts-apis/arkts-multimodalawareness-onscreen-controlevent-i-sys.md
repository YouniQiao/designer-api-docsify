...
Hook ID corresponding to the control event. The hook ID and the session ID can be obtained from [PageContent]\_\_\_JSDOC\_LINK\_DESC\_USD\_0\_\_\_ of a session.
...
ID of the session to be operated. The hook ID and the session ID can be obtained from [PageContent]\_\_\_JSDOC\_LINK\_DESC\_USD\_0\_\_\_ of a session.
