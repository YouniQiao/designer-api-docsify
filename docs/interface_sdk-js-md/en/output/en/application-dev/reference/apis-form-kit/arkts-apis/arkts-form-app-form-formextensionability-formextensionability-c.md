...
| Type | Description |
| --- | --- |
| formBindingData.FormBindingData | A **formBindingData.FormBindingData** object containing the data to be |
...
Called when system configuration items change. The **onConfigurationUpdate** callback is triggered only when the FormExtensionAbility is alive. \_\_\_MD\_COMMENT\_DESC\_USD\_0\_\_\_Since API version 20, for system applications, the **onConfigurationUpdate** callback within the FormExtensionAbility will be triggered when the system language changes.\_\_\_MD\_COMMENT\_DESC\_USD\_1\_\_\_
...
| --- | --- | --- | --- |
| formId | string | Yes | Widget ID. |
| newDimension | formInfo.FormDimension | Yes | Widget dimension. For example, **Dimension\_\_\_ESCAPED\_UNDERSCORE\_\_\_1\_\_\_ESCAPED\_UNDERSCORE\_\_\_2** indicates a 1 x 2widget. |
...
Called to notify the widget provider that a widget is being updated, with update parameters carried. After obtaining the latest data, your application should call [updateForm]\_\_\_JSDOC\_LINK\_DESC\_USD\_0\_\_\_ of **formProvider** to update the widget data.
...
Context of the FormExtensionAbility. This context is inherited from [ExtensionContext]\_\_\_JSDOC\_LINK\_DESC\_USD\_0\_\_\_. This API can be used in atomic services since API version 11.
