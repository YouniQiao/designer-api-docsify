...
A continuous task of the **DATA_TRANSFER** type is requested, but the progress is not updated for a number time (the first update takes more than 10 minutes).
