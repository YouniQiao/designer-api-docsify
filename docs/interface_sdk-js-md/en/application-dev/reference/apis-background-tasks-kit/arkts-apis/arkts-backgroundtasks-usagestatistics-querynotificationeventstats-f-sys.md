...
| Type | Description |
| --- | --- |
| Promise&lt;Array&lt;[DeviceEventStats](arkts-backgroundtasks-usagestatistics-deviceeventstats-i-sys.md)&gt;&gt; | the promise returned by queryNotificationEventStats. the [DeviceEventStats](arkts-backgroundtasks-usagestatistics-deviceeventstats-i-sys.md) object Array containing the event states data. |
