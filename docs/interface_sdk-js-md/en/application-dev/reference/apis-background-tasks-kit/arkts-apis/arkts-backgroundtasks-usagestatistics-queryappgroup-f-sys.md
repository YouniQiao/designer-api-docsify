...
| --- | --- | --- | --- |
| callback | [AsyncCallback](../../apis-basic-service-kit/arkts-apis/arkts-basicservices-base-asynccallback-i.md)&lt;int&gt; | Yes | Callback used to return the result. If the query is successful, **err** is **undefined**, and data is the app group of the calling application. Otherwise, **err** is an error object. |
...
| Type | Description |
| --- | --- |
| Promise&lt;int&gt; | the promise returned by queryAppGroup. Returns the app group of the calling application. |
...
| callback | [AsyncCallback](../../apis-basic-service-kit/arkts-apis/arkts-basicservices-base-asynccallback-i.md)&lt;int&gt; | Yes | Callback used to return the result. If the query is successful, **err** is **undefined**, and data is the usage priority group of the calling application. Otherwise, **err** is an error object. |
...
| Type | Description |
| --- | --- |
| Promise&lt;int&gt; | Promise used to return the calling application. |
