...
| [ReminderRequestCalendar](arkts-backgroundtasks-reminderrequestcalendar-i-sys.md) | ReminderRequestCalendar extends ReminderRequestDefines a reminder for a calendar event. |
<!--DelEnd-->
