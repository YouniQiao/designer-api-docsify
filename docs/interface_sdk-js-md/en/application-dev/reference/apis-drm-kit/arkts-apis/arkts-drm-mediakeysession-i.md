...
| Type | Description |
| --- | --- |
| [MediaKeyStatus](arkts-drm-mediakeystatus-i.md)[] | A list of media key status description pairs. |
...
| initData | [Uint8Array](../../apis-na/arkts-apis/arkts-na-uint8array-i.md) | Yes | PSSH info. |
| mediaKeyType | number | Yes | Offline or online. |
| options | [OptionsData](arkts-drm-optionsdata-i.md)[] | No | Optional data the application set to drm framework. |

**Return value:**

| Type | Description |
| --- | --- |
| [Promise](../../apis-na/arkts-apis/arkts-na-promise-i.md)<MediaKeyRequest> | Promise with MediaKeyRequest used to return the result. |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| mediaKeyId | [Uint8Array](../../apis-na/arkts-apis/arkts-na-uint8array-i.md) | Yes | The mediaKeyId specifies which media content's media key request should be generated. |

**Return value:**

| Type | Description |
| --- | --- |
| [Promise](../../apis-na/arkts-apis/arkts-na-promise-i.md)<Uint8Array> | Promise with media key request in Uint8Array used to return the result. |
...
| Type | Description |
| --- | --- |
| [ContentProtectionLevel](arkts-drm-contentprotectionlevel-e.md) | MediaKeySession content protection level. |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| response | [Uint8Array](../../apis-na/arkts-apis/arkts-na-uint8array-i.md) | Yes | The response. |

**Return value:**

| Type | Description |
| --- | --- |
| [Promise](../../apis-na/arkts-apis/arkts-na-promise-i.md)<Uint8Array> | Promise with media key identifier in Uint8Array used to return the result. |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| mediaKeyId | [Uint8Array](../../apis-na/arkts-apis/arkts-na-uint8array-i.md) | Yes | The mediaKeyId specifies which media content's media key it is. |
| response | [Uint8Array](../../apis-na/arkts-apis/arkts-na-uint8array-i.md) | Yes | The offline media key. |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| mediaKeyId | [Uint8Array](../../apis-na/arkts-apis/arkts-na-uint8array-i.md) | Yes | The mediaKeyId specifies which media key should be restore. |
