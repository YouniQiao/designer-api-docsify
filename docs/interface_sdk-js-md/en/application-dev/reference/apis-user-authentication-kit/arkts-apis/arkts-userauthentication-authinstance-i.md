...
Cancels this authentication. > **NOTE** > > Use the [AuthInstance](arkts-userauthentication-authinstance-i.md#authinstance) instance obtained to call this API. The > [AuthInstance](arkts-userauthentication-authinstance-i.md#authinstance) instance must be the instance being authenticated.
...
Starts authentication. > **NOTE** > > Use the [AuthInstance](arkts-userauthentication-authinstance-i.md#authinstance) instance obtained to call this API.
