...
| --- | --- | --- | --- |
| challenge | Uint8Array | Yes | Random challenge value, which can be used to prevent replay attacks. The maximum length is 32 bytes. Uint8Array([]) can be passed. It is recommended that a random number generated by the [crypto framework](../../apis-crypto-architecture-kit/arkts-apis/arkts-security-cryptoframework.md#@ohos.security.cryptoFramework) be used as the challenge value to enhance security. |
