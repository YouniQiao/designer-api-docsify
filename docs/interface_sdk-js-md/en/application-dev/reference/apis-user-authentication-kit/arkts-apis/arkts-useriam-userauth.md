...
| Name | Description |
| --- | --- |
| [MAX_ALLOWABLE_REUSE_DURATION](arkts-userauthentication-userauth-con.md#maxallowablereuseduration) | Maximum reuse duration of the authentication result, in milliseconds. The value is 300000. The value range is all integers. |
| [PERMANENT_LOCKOUT_DURATION](arkts-userauthentication-userauth-con.md#permanentlockoutduration) | Permanent lockout duration, in milliseconds. The value is 0x7fffffff. The value range is all integers. |
