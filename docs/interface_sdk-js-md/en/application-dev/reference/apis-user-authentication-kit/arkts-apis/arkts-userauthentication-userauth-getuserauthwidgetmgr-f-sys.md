...
| Type | Description |
| --- | --- |
| \_\_\_MD\_LINK\_USD\_0\_\_\_ | Authentication widget manager object. It can be used to subscribe to and unsubscribe from commands from the user authentication framework. |
