...
| Type | Description |
| --- | --- |
| Array&lt;[Want](../../apis-ability-kit/arkts-apis/arkts-ability-appabilitywant-want-c.md)&gt; | List of the auto-start applications obtained. Since API version 24, the setting of whether the UI is hidden can be returned. |
...
| Type | Description |
| --- | --- |
| Array&lt;[Want](../../apis-ability-kit/arkts-apis/arkts-ability-appabilitywant-want-c.md)&gt; | List of the auto-start applications obtained. |
