...
| Name | Description |
| --- | --- |
| [getManagedBrowserPolicy](arkts-mdm-getmanagedbrowserpolicy-f.md#getmanagedbrowserpolicy-1) | Obtains the browser policy by application bundle name. |
...
| Name | Description |
| --- | --- |
| [getPolicies](arkts-mdm-getpolicies-f-sys.md#getpolicies-1) | Obtains the policy of the specified browser. This API uses an asynchronous callback to return the result. |
| [getPolicies](arkts-mdm-getpolicies-f-sys.md#getpolicies-2) | Obtains the policy of the specified browser. This API uses a promise to return the result. |
| [setPolicies](arkts-mdm-setpolicies-f-sys.md#setpolicies-1) | Sets the browsing policy for a specified browser. This API uses an asynchronous callback to return the result. |
| [setPolicies](arkts-mdm-setpolicies-f-sys.md#setpolicies-2) | Sets the browsing policy for a specified browser. This API uses a promise to return the result. |
<!--DelEnd-->
