...
| [finishLogCollected](arkts-mdm-finishlogcollected-f.md#finishlogcollected-1) | Deletes the device logs collected by the current MDM app under the current user. |
