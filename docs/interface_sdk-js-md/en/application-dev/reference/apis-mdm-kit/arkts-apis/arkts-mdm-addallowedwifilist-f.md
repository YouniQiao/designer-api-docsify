...
| list | [Array](../../apis-na/arkts-apis/arkts-na-array-i.md)<WifiAccessInfo> | Yes | Array of allowed Wi-Fi networks. The maximum length of the array is 200.For example, if there are already 100 Wi-Fi networks, a maximum of 100 more can be added. |
