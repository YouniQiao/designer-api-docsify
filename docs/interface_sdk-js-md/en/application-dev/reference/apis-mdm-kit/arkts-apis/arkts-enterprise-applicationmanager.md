...
> [applicationManager.isAppKioskAllowed](arkts-mdm-isappkioskallowed-f.md#isappkioskallowed-1) API is available to all  
> applications.
...
| [addAllowedRunningBundles](arkts-mdm-addallowedrunningbundles-f.md#addallowedrunningbundles-1) | Adds the applications that are allowed to run under specified users. |
...
| [removeDockApp](arkts-mdm-removedockapp-f.md#removedockapp-1) | Removes an application from the shortcut bar. |
