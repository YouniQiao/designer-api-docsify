...
| usbDevices | Array&lt;UsbDeviceType&gt; | Yes | Array of the USB devices to be removed, which can be obtained through[getDevices](../../apis-basic-service-kit/arkts-apis/arkts-basicservices-getdevices-f.md#getdevices-1). |
