...
| usbDevices | [Array](../../apis-na/arkts-apis/arkts-na-array-i.md)<UsbDeviceType> | Yes | Array of the USB devices to be removed, which can be obtained through [getDevices](../../apis-basic-service-kit/arkts-apis/arkts-basicservices-getdevices-f.md#getdevices-1). |
