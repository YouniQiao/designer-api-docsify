...
> 
> The global restriction policy is provided by **restrictions**. To disable USB globally, see &gt; [@ohos.enterprise.restrictions (restriction policy)](arkts-enterprise-restrictions.md).
