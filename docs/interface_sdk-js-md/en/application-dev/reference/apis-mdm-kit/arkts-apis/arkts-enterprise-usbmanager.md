...
| Name | Description |
| --- | --- |
| [disableUsb(USB Management)](arkts-mdm-usbmanager-disableusb-f-sys.md) | Enables or disables USB. |
| [isUsbDisabled(USB Management)](arkts-mdm-usbmanager-isusbdisabled-f-sys.md) | Queries whether the USB is disabled. |
| [setUsbPolicy(USB Management)](arkts-mdm-usbmanager-setusbpolicy-f-sys.md) | Sets the USB read/write policy. This API uses an asynchronous callback to return the result. |
| [setUsbPolicy(USB Management)](arkts-mdm-usbmanager-setusbpolicy-f-sys.md) | Sets the USB read/write policy. This API uses a promise to return the result. |
<!--DelEnd-->
