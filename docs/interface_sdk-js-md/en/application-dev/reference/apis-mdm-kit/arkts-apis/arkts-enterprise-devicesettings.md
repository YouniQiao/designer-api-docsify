...
| [getScreenOffTime](arkts-mdm-devicesettings-getscreenofftime-f-sys.md#getscreenofftime-system-api) | Obtains the device screen-off time. This API uses an asynchronous promise to return the result. |
...
| [installUserCertificate](arkts-mdm-devicesettings-installusercertificate-f-sys.md#installusercertificate-system-api) | Installs a user certificate. This API uses a promise to return the result. |
...
| [uninstallUserCertificate](arkts-mdm-devicesettings-uninstallusercertificate-f-sys.md#uninstallusercertificate-system-api) | Uninstalls a user certificate. This API uses a promise to return the result. |
<!--DelEnd-->
