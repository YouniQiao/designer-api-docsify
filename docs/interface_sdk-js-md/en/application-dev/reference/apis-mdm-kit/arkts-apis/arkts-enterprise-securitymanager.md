...
| [setWatermarkImage](arkts-mdm-setwatermarkimage-f.md#setwatermarkimage-1) | Sets a watermark policy for a specified application of a specified user. Currently, a maximum of 100 policies can be saved. |
