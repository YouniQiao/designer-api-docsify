...
| [removeDisallowedBluetoothProtocols](arkts-mdm-bluetoothmanager-removedisallowedbluetoothprotocols-f.md#removedisallowedbluetoothprotocols-1) | Removes protocol from the list of bluetooth server that are disallowed to use. |
...
| [TransferPolicy](arkts-mdm-bluetoothmanager-transferpolicy-e.md) | The transfer policy. |
