...
| hapFilePaths | [Array](../../apis-na/arkts-apis/arkts-na-array-i.md)<string> | Yes | indicates the path of the application to be installed. |
| installParam | [InstallParam](arkts-mdm-installparam-i.md) | No | installParam indicates the installation parameters.It may contain two fields: userId and installFlag.The flag can only be one of correct flags. |

**Return value:**

| Type | Description |
| --- | --- |
| [Promise](../../apis-na/arkts-apis/arkts-na-promise-i.md)<void> | the promise of installing application result. |
