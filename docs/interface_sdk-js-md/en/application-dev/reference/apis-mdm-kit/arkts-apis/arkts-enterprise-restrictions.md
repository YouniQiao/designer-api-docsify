...
| [setDisallowedPolicy](arkts-mdm-restrictions-setdisallowedpolicy-f.md) | Disallows a feature. &gt; **NOTE：**&gt; &gt; This API applies a device-level restriction policy that affects all users of the device. To set a restriction &gt; policy for a specific user, use the &gt; [setDisallowedPolicyForAccount](arkts-mdm-restrictions-setdisallowedpolicyforaccount-f.md) API. |
