...
| Name | Description |
| --- | --- |
| [operateDevice](arkts-mdm-devicecontrol-operatedevice-f.md#operatedevice) | Allows the specified device administrator application to operate devices. |
| [operateDevice](arkts-mdm-devicecontrol-operatedevice-f.md#operatedevice-1) | Allows the administrator to operate devices. |
