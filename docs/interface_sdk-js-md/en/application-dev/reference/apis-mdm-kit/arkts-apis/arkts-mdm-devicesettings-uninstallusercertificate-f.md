...
| certUri | string | Yes | Certificate URI, which is set and returned by the user certification installation API [installUserCertificate](arkts-mdm-devicesettings-installusercertificate-f.md#installUserCertificate). |
