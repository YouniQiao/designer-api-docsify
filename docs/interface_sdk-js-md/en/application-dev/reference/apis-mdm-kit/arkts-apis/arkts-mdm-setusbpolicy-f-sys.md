...
| usbPolicy | UsbPolicy | Yes | USB access policy. This API supports **READ_WRITE** and **READ_ONLY** only. |
...
| Type | Description |
| --- | --- |
| Promise&lt;void&gt; | Promise that returns no value. An error object is thrown when the USB policy fails to beset. |
