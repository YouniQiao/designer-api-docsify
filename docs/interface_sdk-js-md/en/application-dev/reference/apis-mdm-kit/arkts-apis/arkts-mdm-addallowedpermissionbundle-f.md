...
| applicationInstance | common.ApplicationInstance | Yes | applicationInstance indicatesthe application that need to be added to the list of applications allowed to grant the permission. |
