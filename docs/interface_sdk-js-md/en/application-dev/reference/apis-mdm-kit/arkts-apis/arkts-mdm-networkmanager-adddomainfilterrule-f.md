...
[LogType]\_\_\_JSDOC\_LINK\_DESC\_USD\_0\_\_\_ is supported since API version 23.
    **NOTE**  
    ...
    - After a rule with [Action]\_\_\_JSDOC\_LINK\_DESC\_USD\_1\_\_\_ set to **ALLOW** is added, a default **DENY** rule is  
    ...
    rules (added via [addFirewallRule]\_\_\_JSDOC\_LINK\_DESC\_USD\_2\_\_\_). Within both domain name rules and IP  
    rules, matching is performed in the order of ALLOW, DENY, and REJECT [actions]\_\_\_JSDOC\_LINK\_DESC\_USD\_3\_\_\_.
