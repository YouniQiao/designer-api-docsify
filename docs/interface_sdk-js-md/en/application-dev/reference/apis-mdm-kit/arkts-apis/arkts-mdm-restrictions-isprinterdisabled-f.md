...
| callback | [AsyncCallback](../../apis-basic-service-kit/arkts-apis/arkts-basicservices-asynccallback-t.md)&lt;boolean&gt; | Yes | Callback invoked to return the result. &lt;br&gt;The value **true** means that the printer is disabled; the value **false** means the opposite. |
