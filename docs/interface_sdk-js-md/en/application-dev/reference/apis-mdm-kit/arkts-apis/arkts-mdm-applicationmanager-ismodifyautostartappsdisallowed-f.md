...
| autoStartApp | [Want](../../apis-ability-kit/arkts-apis/arkts-ability-appabilitywant-want-c.md) | Yes | Auto-start applications to add. **Want** must contain **bundleName** and **abilityName**. |
