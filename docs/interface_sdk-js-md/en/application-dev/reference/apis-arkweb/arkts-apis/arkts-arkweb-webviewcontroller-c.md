...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| hostList | [Array](../../apis-na/arkts-apis/arkts-na-array-i.md)<string> | Yes | Hosts that bypass the Intelligent Tracking Prevention. |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| keys | [Array](../../apis-na/arkts-apis/arkts-na-array-i.md)<string> | No | Key value list on the pages using the blankless optimization solution. The |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| cacheKeyList | [Array](../../apis-na/arkts-apis/arkts-na-array-i.md)<string> | Yes | Key used to query the cache of prefetched resources. The value can contain only letters and digits. If this parameter is not passed or is left empty, **url** is used by default. |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| configuration | [PdfConfiguration](arkts-arkweb-pdfconfiguration-i.md) | Yes | Parameters required for creating a PDF file. |
| callback | [AsyncCallback](../../apis-basic-service-kit/arkts-apis/arkts-basicservices-asynccallback-i.md)<PdfData> | Yes | Callback used to return the data stream of an online PDF file. |
...
| Type | Description |
| --- | --- |
| [Promise](../../apis-na/arkts-apis/arkts-na-promise-i.md)<PdfData> | Promise used to return the data stream of a web page. |
...
| Type | Description |
| --- | --- |
| [Array](../../apis-na/arkts-apis/arkts-na-array-i.md)<WebMessagePort> | An array represent 2 WebMessagePort, then can use those ports to communication with html pages. |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| schemes | [Array](../../apis-na/arkts-apis/arkts-na-array-i.md)<WebCustomScheme> | Yes | Configuration of web custom scheme. |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| securityParams | [SecurityParams](arkts-arkweb-securityparams-i.md) | Yes | The parameters means which supported option or item will be disabled. |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| features | [BackForwardCacheSupportedFeatures](arkts-arkweb-backforwardcachesupportedfeatures-c.md) | Yes | The features that supports BackForwardCache. |
...
| Type | Description |
| --- | --- |
| [Promise](../../apis-na/arkts-apis/arkts-na-promise-i.md)<string> | A promise that resolves after the command is executed.This JSON-formatted value will be the result of command execution. |
...
| Type | Description |
| --- | --- |
| [ArkWebEngineVersion](arkts-arkweb-arkwebengineversion-e.md) | The ArkWeb kernel version defined by [ArkWebEngineVersion](arkts-arkweb-arkwebengineversion-e.md). |
...
| Type | Description |
| --- | --- |
| [ControllerAttachState](arkts-arkweb-controllerattachstate-e.md) | the attach state of controller |
...
| Type | Description |
| --- | --- |
| [BackForwardList](arkts-arkweb-backforwardlist-i.md) | Back forward list for current webview. |
...
Obtains the prediction information about blankless loading (for details, see [BlanklessInfo](arkts-arkweb-blanklessinfo-i.md)) and starts to generate the loading transition frame. The application determines whether to enable blankless loading based on the information. This API must be used together with the [setBlanklessLoadingWithKey](arkts-arkweb-webviewcontroller-c.md#setblanklessloadingwithkey-1)API before the page loading API is triggered or in **onLoadIntercept**, and after the **WebViewController** is bound to the **Web** component.
...
| Type | Description |
| --- | --- |
| [BlanklessInfo](arkts-arkweb-blanklessinfo-i.md) | Prediction information about blankless loading, including the first screen similarity and first screen loading duration. The application determines whether to enable blankless loading based on the prediction information. |
...
| Type | Description |
| --- | --- |
| [Promise](../../apis-na/arkts-apis/arkts-na-promise-i.md)<Array<cert.X509Cert>> | the promise of the current website's certificate. |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| callback | [AsyncCallback](../../apis-basic-service-kit/arkts-apis/arkts-basicservices-asynccallback-i.md)<Array<cert.X509Cert>> | Yes | the callback of getCertificate. |
...
| Type | Description |
| --- | --- |
| [WebHitTestType](arkts-arkweb-webhittesttype-e.md) | Element type of the area being clicked. |
...
| Type | Description |
| --- | --- |
| [HitTestValue](arkts-arkweb-hittestvalue-i.md) | Element information of the area being clicked. |
...
| Type | Description |
| --- | --- |
| [MediaPlaybackState](arkts-arkweb-mediaplaybackstate-e.md) | Playback control status of the current web page. The options are **NONE**,**PLAYING**, **PAUSED**, and **STOPPED**. |
...
| Type | Description |
| --- | --- |
| [ScrollOffset](arkts-arkweb-scrolloffset-i.md) | Current scrolling offset of the web page (excluding the over-scrolling offset). |
...
| Type | Description |
| --- | --- |
| [ScrollOffset](arkts-arkweb-scrolloffset-i.md) | Current scrolling offset (including the over-scrolling offset) of the web page. |
...
| Type | Description |
| --- | --- |
| [SecurityLevel](../../apis-arkdata/arkts-apis/arkts-arkdata-securitylevel-e.md) | the security level of current page. |
...
| Type | Description |
| --- | --- |
| [SiteIsolationMode](arkts-arkweb-siteisolationmode-e.md) | The site isolation mode of the application.@static |
...
| Type | Description |
| --- | --- |
| [UserAgentMetadata](arkts-arkweb-useragentmetadata-c.md) | The UserAgentMetadata for the userAgent. |
...
| Type | Description |
| --- | --- |
| [Promise](../../apis-na/arkts-apis/arkts-na-promise-i.md)<boolean> | Promise used to return the result.<br> The value **true** indicates that this page contains images, and the value **false** indicates the opposite. |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| callback | [AsyncCallback](../../apis-basic-service-kit/arkts-apis/arkts-basicservices-asynccallback-i.md)<boolean> | Yes | Callback used to return the result.<br> The value **true** indicates that this page contains images, and the value **false** indicates the opposite. |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| resourceMaps | [Array](../../apis-na/arkts-apis/arkts-na-array-i.md)<OfflineResourceMap> | Yes | Configuration object for local offline resources. A maximum of 30 resources can be injected in a single call, with a maximum size of 10 MB per individual resource. |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| callback | [CreateNativeMediaPlayerCallback](arkts-arkweb-createnativemediaplayercallback-t.md) | Yes | Callback when the application takes over media playback on the web page. |
...
| ports | [Array](../../apis-na/arkts-apis/arkts-na-array-i.md)<WebMessagePort> | Yes | Port number array information to send. |
...
| postData | [ArrayBuffer](../../apis-arkts/arkts-apis/arkts-arkts-arraybuffer-c.md) | Yes | This data will passed to "POST" request. |
...
| cacheOptions | [CacheOptions](arkts-arkweb-cacheoptions-i.md) | Yes | Whether to update the bytecode cache. |

**Return value:**

| Type | Description |
| --- | --- |
| [Promise](../../apis-na/arkts-apis/arkts-na-promise-i.md)<number> | - Promise used to return the error code for generating the bytecode cache. The value **0** indicates no error, and the value **-1** indicates an internal error. |
...
| additionalHeaders | [Array](../../apis-na/arkts-apis/arkts-na-array-i.md)<WebHeader> | No | Additional HTTP request header of the URL. |
...
| url | string | Yes | Which url to preresolve/preconnect. |
| additionalHeaders | [Array](../../apis-na/arkts-apis/arkts-na-array-i.md)<WebHeader> | No | Additional HTTP request header of the URL. |
| prefetchOptions | [PrefetchOptions](arkts-arkweb-prefetchoptions-c.md) | No | Prefetch behavior can be customized via ?prefetchOptions?,including ignoring Cache-Control: no-store and adjusting the throttling interval. |
...
Prefetches resource requests based on specified request information and additional HTTP request headers, saves the requests to the memory cache, and specifies the cache key and validity period to accelerate loading.Currently, only POST requests whose Content-Type is application/x-www-form-urlencoded are supported. A maximum of six POST requests can be pre-obtained. To prefetch the seventh post request, call [clearPrefetchedResource](arkts-arkweb-webviewcontroller-c.md#clearprefetchedresource-1) to clear the cache of unnecessary post requests. Otherwise, the cache of the earliest prefetched POST request will be automatically cleared. To use the prefetched resource cache, you need to add the key value **ArkWebPostCacheKey** to the header of the POST request. The content of the key value is the cacheKey of the corresponding cache.
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| request | [RequestInfo](../../apis-ability-kit/arkts-apis/arkts-ability-requestinfo-i.md) | Yes | Information about the prefetched request. |
| additionalHeaders | [Array](../../apis-na/arkts-apis/arkts-na-array-i.md)<WebHeader> | No | Additional HTTP request header of the prefetched request.<br>If **undefined** or **null** is passed, error code **401** will be thrown. |
...
| methodList | [Array](../../apis-na/arkts-apis/arkts-na-array-i.md)<string> | Yes | The method of the application side JavaScript object participating in the registration. |
| asyncMethodList | [Array](../../apis-na/arkts-apis/arkts-na-array-i.md)<string> | No | The async method of the application side JavaScript object participating in the registration.<br>**Since:** 12 |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| hostList | [Array](../../apis-na/arkts-apis/arkts-na-array-i.md)<string> | Yes | Hosts needs to remove from bypass list. |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| state | [Uint8Array](../../apis-na/arkts-apis/arkts-na-uint8array-i.md) | Yes | Web access stack after serialization. |
...
| Type | Description |
| --- | --- |
| [Promise](../../apis-na/arkts-apis/arkts-na-promise-i.md)<string> | A promise is solved after the JavaScript script is executed.This parameter will be the result of JavaScript script execution.If the JavaScript script fails to execute or has no return value,null will be returned. |
...
| --- | --- | --- | --- |
| script | string | Yes | JavaScript Script. |
| callback | [AsyncCallback](../../apis-basic-service-kit/arkts-apis/arkts-basicservices-asynccallback-i.md)<string> | Yes | Callbacks execute JavaScript script results. |
...
| Type | Description |
| --- | --- |
| [Promise](../../apis-na/arkts-apis/arkts-na-promise-i.md)<JsMessageExt> | A promise is solved after the JavaScript script is executed.This parameter will be the result of JavaScript script execution.If the JavaScript script fails to execute or has no return value,a none type value will be returned. |
...
| --- | --- | --- | --- |
| script | string \| ArrayBuffer | Yes | JavaScript Script.<br>**Since:** 12 |
| callback | [AsyncCallback](../../apis-basic-service-kit/arkts-apis/arkts-basicservices-asynccallback-i.md)<JsMessageExt> | Yes | Callbacks execute JavaScript script results. |
...
| Type | Description |
| --- | --- |
| [Uint8Array](../../apis-na/arkts-apis/arkts-na-uint8array-i.md) | Web access stack after serialization. |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| engineVersion | [ArkWebEngineVersion](arkts-arkweb-arkwebengineversion-e.md) | Yes | ArkWeb kernel version. |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| options | [BackForwardCacheOptions](arkts-arkweb-backforwardcacheoptions-c.md) | Yes | The configuration of BackForwardCache. |
...
Sets whether to enable blankless loading. This API must be used together with [getBlanklessInfoWithKey](arkts-arkweb-webviewcontroller-c.md#getblanklessinfowithkey-1).
...
| Type | Description |
| --- | --- |
| [WebBlanklessErrorCode](arkts-arkweb-webblanklesserrorcode-e.md) | Whether the API is successfully called. For details, see [WebBlanklessErrorCode](arkts-arkweb-webblanklesserrorcode-e.md). |
...
| param | [BlanklessLoadingParam](arkts-arkweb-blanklessloadingparam-i.md) | Yes | The blankless loading parameter.<br>None |

**Return value:**

| Type | Description |
| --- | --- |
| [WebBlanklessErrorCode](arkts-arkweb-webblanklesserrorcode-e.md) | WebBlanklessErrorCode. |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| delegate | [WebDownloadDelegate](arkts-arkweb-webdownloaddelegate-c.md) | Yes | Delegate used for download triggered from web. |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| secureDnsMode | [SecureDnsMode](arkts-arkweb-securednsmode-e.md) | Yes | using HttpDns. |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| pathList | [Array](../../apis-na/arkts-apis/arkts-na-array-i.md)<string> | Yes | The path list allow universal access. |
...
| type | [ScrollType](arkts-arkweb-scrolltype-e.md) | No | Scrolling type supported by the web page. The default value is supported.<br> - If the value of **enable** is set to **false**, the specified **ScrollType** is disabled. If **ScrollType** is set to the default value, all scrolling types are disabled.<br> - If the value of **enable** is set to **true**, all scrolling types are enabled regardless of the value of **ScrollType**.<br>If **null** or **undefined** is passed, error code **401** is thrown. |
...
Sets the global scrollbar mode in the web page. When this API is not explicitly called,[ScrollbarMode.OVERLAY_LAYOUT_SCROLLBAR](arkts-arkweb-scrollbarmode-e.md) is used by default,indicating that the scroll bar is not always displayed.
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| scrollbarMode | [ScrollbarMode](arkts-arkweb-scrollbarmode-e.md) | Yes | Scroll bar mode. |
...
| handler | [WebSchemeHandler](arkts-arkweb-webschemehandler-c.md) | Yes | Web scheme handler. |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| mode | [SiteIsolationMode](arkts-arkweb-siteisolationmode-e.md) | Yes | The site isolation mode of the application, |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| mode | [WebSoftKeyboardBehaviorMode](arkts-arkweb-websoftkeyboardbehaviormode-e.md) | Yes | The WebSoftKeyboardBehaviorMode of this web. |
...
| --- | --- | --- | --- |
| userAgent | string | Yes | The User-Agent string. |
| hosts | [Array](../../apis-na/arkts-apis/arkts-na-array-i.md)<string> | Yes | The hosts to which the User-Agent apply. |
...
| --- | --- | --- | --- |
| userAgent | string | Yes | The User-Agent string. |
| metaData | [UserAgentMetadata](arkts-arkweb-useragentmetadata-c.md) | Yes | The UserAgentMetadata for the userAgent. |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| mode | [WebDestroyMode](arkts-arkweb-webdestroymode-e.md) | Yes | web destroy mode, default NORMAL_MODE. |
...
| Type | Description |
| --- | --- |
| [Promise](../../apis-na/arkts-apis/arkts-na-promise-i.md)<string> | a promise resolved after the web archive has been stored. The parameter will either be the filename under which the file was stored, or empty if storing the file failed. |
...
| baseName | string | Yes | Where the generated offline webpage is stored, This value cannot be null. |
| autoName | boolean | Yes | Decide whether to automatically generate the file name. If false, it is stored by the file name of baseName. If true, the file name is automatically generated based on the current URL and stored in the file directory of baseName. |
| callback | [AsyncCallback](../../apis-basic-service-kit/arkts-apis/arkts-basicservices-asynccallback-i.md)<string> | Yes | called after the web archive has been stored. The parameter will either be the filename under which the file was stored,or empty if storing the file failed. |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| level | [PressureLevel](arkts-arkweb-pressurelevel-e.md) | Yes | The memory pressure level for the ArkWeb. |
...
| Type | Description |
| --- | --- |
| [Promise](../../apis-na/arkts-apis/arkts-na-promise-i.md)<ControllerAttachState> | Promise used to return the state of attach. |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| info | [SnapshotInfo](arkts-arkweb-snapshotinfo-i.md) | Yes | Information for obtaining the full drawing result. |
| callback | [AsyncCallback](../../apis-basic-service-kit/arkts-apis/arkts-basicservices-asynccallback-i.md)<SnapshotResult> | Yes | Callback used to return the result. |
