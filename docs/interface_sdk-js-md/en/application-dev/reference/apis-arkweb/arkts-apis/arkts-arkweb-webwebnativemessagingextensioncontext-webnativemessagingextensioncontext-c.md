...
Starts an ability. This API uses a promise to return the result. To obtain the return result when the started UIAbility exits, use [startAbilityForResult](../../apis-default/arkts-apis/arkts-webwebnativemessagingextensioncontext-webnativemessagingextensioncontext-c.md#startabilityforresult).
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| want | [Want](../../apis-ability-kit/arkts-apis/arkts-ability-appabilitywant-want-c.md) | Yes | Information about the UIAbility to start, including attributes such as bundleName and abilityName, used to specify the target UIAbility. |
