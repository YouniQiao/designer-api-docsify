...
Defines a **CreateNativeMediaPlayerCallback** object used as a parameter of the [onCreateNativeMediaPlayer](../../apis-na/arkts-apis/arkts-na-webview-webviewcontroller-c.md#onCreateNativeMediaPlayer) callback. This object is used to create a player to take over media playback of the web page.
...
| --- | --- | --- | --- |
| handler | [NativeMediaPlayerHandler](../../apis-na/arkts-apis/arkts-na-webview-nativemediaplayerhandler-i.md) | Yes | Object used to report the player status to the ArkWeb engine. |
