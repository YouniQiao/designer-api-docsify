...
Represents the event consumption result sent to the **Web** component. For details about the supported events, see [TouchType](../../apis-arkui/arkts-apis/arkts-arkui-enums-touchtype-e.md), [MouseAction](../../apis-arkui/arkts-apis/arkts-arkui-enums-mouseaction-e.md), and left, middle, and right buttons in [MouseButton](../../apis-arkui/arkts-apis/arkts-arkui-enums-mousebutton-e.md).
