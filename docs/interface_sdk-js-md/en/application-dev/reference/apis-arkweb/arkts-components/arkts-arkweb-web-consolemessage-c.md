...
| messageLevel | [MessageLevel](arkts-arkweb-web-messagelevel-e.md) | Yes | The console log level. |
...
| Type | Description |
| --- | --- |
| [MessageLevel](arkts-arkweb-web-messagelevel-e.md) | Return the message level of a console message, which can be {@link MessageLevel}. |
