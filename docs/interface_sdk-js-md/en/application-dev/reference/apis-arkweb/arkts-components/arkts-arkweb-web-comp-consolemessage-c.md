...
| Type | Description |
| --- | --- |
| [MessageLevel](arkts-arkweb-web-comp-messagelevel-e.md) | Level of the console message. |
...
| Type | Description |
| --- | --- |
| [ConsoleMessageSource](arkts-arkweb-web-comp-consolemessagesource-e.md) | Log source of the console message. |
