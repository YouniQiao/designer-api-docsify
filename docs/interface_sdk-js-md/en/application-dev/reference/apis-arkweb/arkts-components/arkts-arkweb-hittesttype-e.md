...
Enumerates the test result types of the click event. &gt; **NOTE：**&gt; &gt; Supported since API version 9 and deprecated since API version 21. You are advised to use &gt; [WebHitTestType](../../apis-na/arkts-apis/arkts-na-webview-webhittesttype-e.md) instead.

**Since:** 8

**Deprecated since:** 21

**Substitutes:** [WebHitTestType](../../apis-na/arkts-apis/arkts-na-webview-webhittesttype-e.md)
