...
Obtains the list of accessible resources requested for the web page. For details about the resource types, see [ProtectedResourceType](arkts-arkweb-web-protectedresourcetype-e.md).
...
| Type | Description |
| --- | --- |
| [Array](../../apis-na/arkts-apis/arkts-na-lib-es5-array-i.md)<string> | @syscap SystemCapability.Web.Webview.Core@crossplatform |
...
| --- | --- | --- | --- |
| resources | [Array](../../apis-na/arkts-apis/arkts-na-lib-es5-array-i.md)<string> | Yes | List of resources that can be requested by the web page with the permission to |
