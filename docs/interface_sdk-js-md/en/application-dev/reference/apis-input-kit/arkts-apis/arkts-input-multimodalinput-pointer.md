...
| [getTouchpadScrollDirection](arkts-input-pointer-gettouchpadscrolldirection-f.md#gettouchpadscrolldirection-1) | Obtains the scroll direction of the touchpad. This API uses a promise to return the result. |
