...
| --- | --- | --- | --- |
| receiver | [Callback](../../apis-basic-services-kit/arkts-apis/arkts-basicservices-callback-t.md)&lt;[ThreeFingersSwipe](arkts-input-multimodalinputgestureevent-threefingersswipe-i.md)&gt; | No | Callback used to receive the reported data. |
