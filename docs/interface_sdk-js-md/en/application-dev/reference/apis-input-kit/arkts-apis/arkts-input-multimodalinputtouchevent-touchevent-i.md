...
**Inheritance/Implementation:** TouchEvent extends [InputEvent](arkts-input-multimodalinputinputevent-inputevent-i.md)
...
**Type:** [Action](arkts-input-multimodalinputtouchevent-action-e.md)
...
**Type:** [SourceType](arkts-input-multimodalinputtouchevent-sourcetype-e.md)
