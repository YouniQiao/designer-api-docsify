...
| [setPointerColor](arkts-input-pointer-setpointercolor-f-sys.md#setpointercolor-1) | Sets the mouse pointer color. This API uses a promise to return the result.  > **NOTE：** >  > When performing this operation, you need to connect an external device, such as a mouse or Bluetooth device. |
