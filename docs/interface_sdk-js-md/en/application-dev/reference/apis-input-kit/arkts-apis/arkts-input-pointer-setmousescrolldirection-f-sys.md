...
| --- | --- | --- | --- |
| inverted | boolean | Yes | Scroll direction of the mouse wheel. The value **true** indicates that scroll direction matches the finger movement on the wheel, and the value **false** indicates that the scroll direction is opposite to the finger movement. The default value is **true**. |
