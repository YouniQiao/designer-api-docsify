...
| --- | --- | --- | --- |
| receiver | [Callback](../../apis-basic-services-kit/arkts-apis/arkts-basicservices-callback-t.md)&lt;[SwipeInward](arkts-input-multimodalinputgestureevent-swipeinward-i-sys.md)&gt; | No | Callback used to receive the reported data. |
