...
Subscribe to uncalibrated accelerometer sensor data, {@code SensorId.ACCELEROMETER\_UNCALIBRATED}.
...
| --- | --- | --- | --- |
| callback | \_\_\_MD\_LINK\_USD\_0\_\_\_&lt;AccelerometerUncalibratedResponse&gt; | Yes | callback uncalibrated accelerometer data. |
