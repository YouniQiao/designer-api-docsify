...
Describes the gravity sensor data. It extends from [Response](arkts-sensorservice-response-i.md).

**Inheritance/Implementation:** GravityResponse extends [Response](arkts-sensorservice-response-i.md)
