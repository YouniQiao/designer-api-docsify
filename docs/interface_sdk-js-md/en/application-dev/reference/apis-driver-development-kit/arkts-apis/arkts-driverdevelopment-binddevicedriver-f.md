...
| callback | [AsyncCallback](../../apis-basic-service-kit/arkts-apis/arkts-basicservices-asynccallback-i.md)<RemoteDeviceDriver> | Yes | Callback used to return the result. When the device driver is successfully bound, **err** is **undefined** and **data** is a [RemoteDeviceDriver](arkts-driverdevelopment-remotedevicedriver-i.md) object that contains the device ID and remote object. Otherwise, **err** is an error object. |
