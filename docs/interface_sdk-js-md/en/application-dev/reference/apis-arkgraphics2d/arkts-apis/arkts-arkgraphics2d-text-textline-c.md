...
Before calling any of the following APIs, you must use [getTextLines()]\_\_\_JSDOC\_LINK\_DESC\_USD\_0\_\_\_ of the  
[Paragraph]\_\_\_JSDOC\_LINK\_DESC\_USD\_1\_\_\_ class or [createLine()]\_\_\_JSDOC\_LINK\_DESC\_USD\_2\_\_\_ of the  
[LineTypeset]\_\_\_JSDOC\_LINK\_DESC\_USD\_3\_\_\_ class to create a **TextLine** object.
...
| ellipsisMode | \_\_\_MD\_LINK\_USD\_0\_\_\_ | Yes | Ellipsis mode. Currently, only **START** and **END** are supported. |
...
| ellipsisMode | \_\_\_MD\_LINK\_USD\_0\_\_\_ | Yes | Text ellipsis mode, EllipsisMode:MIDDLE is not supported. |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| callback | \_\_\_MD\_LINK\_USD\_0\_\_\_ | Yes | Custom function, which contains the offset and index of each character in the text line. |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| alignmentFactor | ArkTS-Dyn: number  \_\_\_HTML\_TAG\_USD\_0\_\_\_ArkTS-Sta：double | Yes | Alignment factor, which determines how text is aligned. The value is a floating point number. A value less than or equal to 0.0 means that the text is left-aligned; a value between 0.0 and 0.5 means that the text is slightly left-aligned; the value 0.5 means that the text is centered; a value between 0.5 and 1 means that the text is slightly right-aligned; a value greater than or equal to 1.0 means that the text is right-aligned. |
| alignmentWidth | ArkTS-Dyn: number  \_\_\_HTML\_TAG\_USD\_0\_\_\_ArkTS-Sta：double | Yes | Alignment width, namely the width of the text line, which is a floating-point value, in physical pixels (px). If the width is less than the actual width of the text line, **0** is returned. |

**Return value:**

| Type | Description |
| --- | --- |
| ArkTS-Dyn: number  \_\_\_HTML\_TAG\_USD\_0\_\_\_ArkTS-Sta：double | Calculated offset required for alignment, which is a floating-point value, in physical pixels (px). |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| index | ArkTS-Dyn: number  \_\_\_HTML\_TAG\_USD\_0\_\_\_ArkTS-Sta：int | Yes | Index of the character. The value is an integer. |

**Return value:**

| Type | Description |
| --- | --- |
| ArkTS-Dyn: number  \_\_\_HTML\_TAG\_USD\_0\_\_\_ArkTS-Sta：double | Offset at the given string index, which is a floating-point value, in physical pixels (px). |
...
| Type | Description |
| --- | --- |
| ArkTS-Dyn: number  \_\_\_HTML\_TAG\_USD\_0\_\_\_ArkTS-Sta：int | Index of the character in the text line. The value is an integer. |
...
| Type | Description |
| --- | --- |
| \_\_\_MD\_LINK\_USD\_0\_\_\_ | Range of the text in this text line in the entire paragraph. |
...
| Type | Description |
| --- | --- |
| ArkTS-Dyn: number  \_\_\_HTML\_TAG\_USD\_0\_\_\_ArkTS-Sta：double | Width of trailing whitespace characters in the text line, which is a floating-point value, in physical pixels (px). |
...
| Type | Description |
| --- | --- |
| \_\_\_MD\_LINK\_USD\_0\_\_\_ | Describes the typographic boundaries of a text line. |
