...
| Type | Description |
| --- | --- |
| [TextBlob](arkts-arkgraphics2d-textblob-c.md) | **TextBlob** object. |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| pos | [Array](../../apis-na/arkts-apis/arkts-na-array-i.md)<TextBlobRunBuffer> | Yes | **TextBlobRunBuffer** array. |
| font | [Font](../../apis-arkui/arkts-apis/arkts-arkui-font-c.md) | Yes | **Font** object. |
...
| text | string | Yes | Content to be used for drawing the text blob. |
| font | [Font](../../apis-arkui/arkts-apis/arkts-arkui-font-c.md) | Yes | **Font** object. |
| encoding | [TextEncoding](arkts-arkgraphics2d-textencoding-e.md) | No | Encoding type. The default value is **TEXT_ENCODING_UTF8**. Currently, only **TEXT_ENCODING_UTF8** takes effect, and other encoding types are treated as **TEXT_ENCODING_UTF8**. |
