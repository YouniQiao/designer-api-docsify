...
| pathDirection | [PathDirection](arkts-arkgraphics2d-pathdirection-e.md) | No | Direction of the path. The default direction is clockwise. |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| path | [Path](arkts-arkgraphics2d-path-c.md) | Yes | Source **Path** object. |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| points | [Array](../../apis-na/arkts-apis/arkts-na-array-i.md)<common2D.Point> | Yes | Array that holds the vertex coordinates of the polygon. |
...
| Type | Description |
| --- | --- |
| [Array](../../apis-na/arkts-apis/arkts-na-array-i.md)<number> | An array of points in the approximate path, which contains at least two points. Each point consists of three values:<br>1. Length ratio of the point to the start point of the path. The value range is [0.0, 1.0].<br>2. X coordinate of a point.<br>3. Y coordinate of a point. |
...
| weight | number | Yes | Weight of the curve, which determines its shape. The larger the value, the closer of the curve to the control point. If the value is less than or equal to 0, this API has the same effect as [lineTo](arkts-arkgraphics2d-path-c.md#lineto-1). If the value is 1, it has the same effect as [quadTo](arkts-arkgraphics2d-path-c.md#quadto-1). The value is a floating point number. |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| path | [Path](arkts-arkgraphics2d-path-c.md) | Yes | Path to copy. |
...
| Type | Description |
| --- | --- |
| [Array](../../apis-na/arkts-apis/arkts-na-array-i.md)<number> | path conic weight array. |
...
| Type | Description |
| --- | --- |
| [PathFillType](arkts-arkgraphics2d-pathfilltype-e.md) | Fill type of a path. |
...
| matrix | [Matrix](arkts-arkgraphics2d-matrix-c.md) | Yes | **Matrix** object used to store the matrix obtained. |
| flags | [PathMeasureMatrixFlags](arkts-arkgraphics2d-pathmeasurematrixflags-e.md) | Yes | Type of the matrix information obtained. |
...
| Type | Description |
| --- | --- |
| [PathIterator](arkts-arkgraphics2d-pathiterator-c.md) | **Iterator** object of the path. |
...
| Type | Description |
| --- | --- |
| [Array](../../apis-na/arkts-apis/arkts-na-array-i.md)<common2D.Point> | path points array. |
...
| startWithMoveTo | boolean | Yes | Whether to execute [moveTo](arkts-arkgraphics2d-path-c.md#moveto-1) in the destination path to move to its start point. The value **true** means to move to the start point, and **false** means the opposite. |
| dst | [Path](arkts-arkgraphics2d-path-c.md) | Yes | Destination path. If the extraction succeeds, the segment is appended to the path. If the extraction fails, nothing changes. |
...
| Type | Description |
| --- | --- |
| [Array](../../apis-na/arkts-apis/arkts-na-array-i.md)<PathIteratorVerb> | path verbs array. |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| other | [Path](arkts-arkgraphics2d-path-c.md) | Yes | Another path object. |
| weight | number | Yes | Interpolation weight, which must be within the range of [0.0, 1.0]. The value is a floating point number. |
| interpolatedPath | [Path](arkts-arkgraphics2d-path-c.md) | Yes | Target path object used to store the interpolation result. |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| path | [Path](arkts-arkgraphics2d-path-c.md) | Yes | Another Path object to compare. |
...
| Type | Description |
| --- | --- |
| [Path](arkts-arkgraphics2d-path-c.md) | New path generated. |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| path | [Path](arkts-arkgraphics2d-path-c.md) | Yes | Path object, which will be combined with the current path. |
| pathOp | [PathOp](arkts-arkgraphics2d-pathop-e.md) | Yes | Defines an enum for the operation modes available for a path. |
...
| weight | number | Yes | Weight of the curve, which determines its shape. The larger the value, the closer of the curve to the control point. If the value is less than or equal to 0, this API is equivalent to [rLineTo](arkts-arkgraphics2d-path-c.md#rlineto-1), that is, adding a line segment from the last point of the path to the target point. If the value is 1, this API is equivalent to [rQuadTo](arkts-arkgraphics2d-path-c.md#rquadto-1). The value is a floating point number. |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| src | [Path](arkts-arkgraphics2d-path-c.md) | Yes | Path for the update. |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| pathFillType | [PathFillType](arkts-arkgraphics2d-pathfilltype-e.md) | Yes | Fill type of the path. |
