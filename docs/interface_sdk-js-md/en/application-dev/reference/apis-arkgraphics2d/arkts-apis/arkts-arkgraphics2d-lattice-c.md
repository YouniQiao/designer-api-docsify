...
| --- | --- | --- | --- |
| xDivs | [Array](../../apis-na/arkts-apis/arkts-na-array-i.md)<number> | Yes | Array of X coordinates used to divide the image. The value is an integer. |
| yDivs | [Array](../../apis-na/arkts-apis/arkts-na-array-i.md)<number> | Yes | Array of Y coordinates used to divide the image. The value is an integer. |
...
| fRectTypes | [Array](../../apis-na/arkts-apis/arkts-na-array-i.md)<RectType> \| null | No | Array that holds the rectangle types. The default value is null.If this parameter is specified, the array size must be (fXCount + 1) * (fYCount + 1). |
| fColors | [Array](../../apis-na/arkts-apis/arkts-na-array-i.md)<common2D.Color> \| null | No | Array that holds the colors used to fill the lattices. The default value is null. If this parameter is specified, the array size must be (fXCount + 1) * (fYCount + 1). |

**Return value:**

| Type | Description |
| --- | --- |
| [Lattice](arkts-arkgraphics2d-lattice-c.md) | **Lattice** object obtained. |
