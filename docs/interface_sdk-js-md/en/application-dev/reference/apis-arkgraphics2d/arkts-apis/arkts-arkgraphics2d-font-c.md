...
| Type | Description |
| --- | --- |
| [Path](arkts-arkgraphics2d-path-c.md) | Outline path of the glyph. |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| glyphs | [Array](../../apis-na/arkts-apis/arkts-na-array-i.md)<number> | Yes | Glyph array, which can be generated by [textToGlyphs](arkts-arkgraphics2d-font-c.md#texttoglyphs-1). |

**Return value:**

| Type | Description |
| --- | --- |
| [Array](../../apis-na/arkts-apis/arkts-na-array-i.md)<common2D.Rect> | Array that holds the rectangular bounding boxes. |
...
| Type | Description |
| --- | --- |
| [FontEdging](arkts-arkgraphics2d-fontedging-e.md) | Font edging effect. |
...
| Type | Description |
| --- | --- |
| [FontHinting](arkts-arkgraphics2d-fonthinting-e.md) | Font hinting effect. |
...
| Type | Description |
| --- | --- |
| [FontMetrics](arkts-arkgraphics2d-fontmetrics-i.md) | Font metrics. |
...
| Type | Description |
| --- | --- |
| [Path](arkts-arkgraphics2d-path-c.md) | Outline path of the text. |
...
| Type | Description |
| --- | --- |
| [Typeface](arkts-arkgraphics2d-typeface-c.md) | Font. |
...
| Type | Description |
| --- | --- |
| [Array](../../apis-na/arkts-apis/arkts-na-array-i.md)<number> | Glyph width array. |
...
| --- | --- | --- | --- |
| text | string | Yes | Content of the item in the operation area. |
| encoding | [TextEncoding](arkts-arkgraphics2d-textencoding-e.md) | Yes | Pointer to the encoding format. |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| edging | [FontEdging](arkts-arkgraphics2d-fontedging-e.md) | Yes | Font edging effect. |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| hinting | [FontHinting](arkts-arkgraphics2d-fonthinting-e.md) | Yes | Font hinting effect. |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| typeface | [Typeface](arkts-arkgraphics2d-typeface-c.md) | Yes | Typeface style (including attributes such as font name, weight, and italic). |
...
| glyphCount | number | No | Number of glyphs represented by the text. The value must be the same as the value obtained from [countText](arkts-arkgraphics2d-font-c.md#counttext-1). The default value is the number of characters in the text string. The value is an integer. |

**Return value:**

| Type | Description |
| --- | --- |
| [Array](../../apis-na/arkts-apis/arkts-na-array-i.md)<number> | Array that holds the glyph indexes. |
