...
| --- | --- | --- | --- |
| outer | [PathEffect](arkts-arkgraphics2d-patheffect-c.md) | Yes | Path effect that is applied second, overlaying the first effect. |
| inner | [PathEffect](arkts-arkgraphics2d-patheffect-c.md) | Yes | Inner path effect that is applied first. |

**Return value:**

| Type | Description |
| --- | --- |
| [PathEffect](arkts-arkgraphics2d-patheffect-c.md) | **PathEffect** object created. |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| intervals | [Array](../../apis-na/arkts-apis/arkts-na-array-i.md)<number> | Yes | Array of the lengths of the ON (solid line) and OFF (blank) parts of the dashed path. The number of elements in the array must be an even number and greater than or equal to 2. The value of this parameter is a positive integer. |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| path | [Path](arkts-arkgraphics2d-path-c.md) | Yes | Path that defines the shape to be used for filling each dash in the pattern. |
...
| style | [PathDashStyle](arkts-arkgraphics2d-pathdashstyle-e.md) | Yes | Style of the dashed path effect. |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| firstPathEffect | [PathEffect](arkts-arkgraphics2d-patheffect-c.md) | Yes | First path effect. |
| secondPathEffect | [PathEffect](arkts-arkgraphics2d-patheffect-c.md) | Yes | Second path effect. |
