...
Loads the custom font. This API uses a promise to return the result. In this API, **name** specifies the alias of the font, and the custom font effect can be displayed only when the value of **name** is set in **fontFamilies**  
in **[TextStyle]\_\_\_JSDOC\_LINK\_DESC\_USD\_0\_\_\_**. The supported font file formats are TTF and OTF.
...
**[TextStyle]\_\_\_JSDOC\_LINK\_DESC\_USD\_0\_\_\_**. The supported font file formats are TTF and OTF.
...
Loads a custom font. This API returns the result synchronously. In this API, **name** specifies the alias of the font, and the custom font effect can be displayed only when the value of **name** is set in **fontFamilies** in  
**[TextStyle]\_\_\_JSDOC\_LINK\_DESC\_USD\_0\_\_\_**. The supported font file formats are TTF, OTF, and TTC.
...
Loads a custom font. This API uses a promise to return the result. In this API, **name** specifies the alias of the font, and the custom font effect can be displayed only when the value of **name** is set in **fontFamilies**  
in **[TextStyle]\_\_\_JSDOC\_LINK\_DESC\_USD\_0\_\_\_**. The supported font file formats are TTF, OTF, and TTC.
