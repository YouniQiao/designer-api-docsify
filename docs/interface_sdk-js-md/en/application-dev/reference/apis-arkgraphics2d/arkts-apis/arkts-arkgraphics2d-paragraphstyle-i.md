...
1. The font file must support the ss08 feature in [FontFeature](arkts-arkgraphics2d-fontfeature-i.md).Otherwise, compression cannot be performed.2. Only the punctuations within the punctuation compression range at the beginning of a line are in the scope of this feature.
