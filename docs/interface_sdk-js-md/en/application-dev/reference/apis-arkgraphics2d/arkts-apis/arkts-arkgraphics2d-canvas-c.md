...
| --- | --- | --- | --- |
| brush | [Brush](arkts-arkgraphics2d-brush-c.md) | Yes | **Brush** object. |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| pen | [Pen](arkts-arkgraphics2d-pen-c.md) | Yes | **Pen** object. |
...
| clipOp | [ClipOp](arkts-arkgraphics2d-clipop-e.md) | No | Clip mode. The default value is **INTERSECT**. |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| region | [Region](../../apis-image-kit/arkts-apis/arkts-image-region-i.md) | Yes | **Region** object, which indicates the range to clip. |
| clipOp | [ClipOp](arkts-arkgraphics2d-clipop-e.md) | No | Clipping mode. The default value is **INTERSECT**. |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| roundRect | [RoundRect](arkts-arkgraphics2d-roundrect-c.md) | Yes | **RoundRect** object, which indicates the range to clip. |
| clipOp | [ClipOp](arkts-arkgraphics2d-clipop-e.md) | No | Clipping mode. The default value is **INTERSECT**. |
| doAntiAlias | boolean | No | Whether to enable anti-aliasing. The value **true** means to enable anti-aliasing, and **false** means the opposite. Default value: **false**. |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| matrix | [Matrix](arkts-arkgraphics2d-matrix-c.md) | Yes | Matrix object. |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| glyphIds | [Array](../../apis-na/arkts-apis/arkts-na-array-i.md)<number> | Yes | Indicates an array of glyph IDs. |
| glyphIdOffset | number | Yes | Indicates the number of elements to skip before drawing in glyphIds array. |
| positions | [Array](../../apis-na/arkts-apis/arkts-na-array-i.md)<common2D.Point> | Yes | Indicates an array of positions. |
...
| font | [Font](../../apis-arkui/arkts-apis/arkts-arkui-font-c.md) | Yes | Indicates the font used for drawing. |
...
| samplingOptions | [SamplingOptions](arkts-arkgraphics2d-samplingoptions-c.md) | No | Sampling options. By default, the **SamplingOptions** object created using the no-argument constructor is used.<br>**Since:** 12 |
...
| lattice | [Lattice](arkts-arkgraphics2d-lattice-c.md) | Yes | Lattice object. |
| dstRect | common2D.Rect | Yes | Target rectangle. |
| filterMode | [FilterMode](arkts-arkgraphics2d-filtermode-e.md) | Yes | Filter mode. |
...
| samplingOptions | [SamplingOptions](arkts-arkgraphics2d-samplingoptions-c.md) | No | Sampling options. By default, the **SamplingOptions** object created using the no-argument constructor is used. |
...
| dstRect | common2D.Rect | Yes | **Rectangle** object, which specifies the area of the canvas onto which the image will be drawn. |
| samplingOptions | [SamplingOptions](arkts-arkgraphics2d-samplingoptions-c.md) | No | Sampling options. By default, the **SamplingOptions** object created using the no-argument constructor is used. |
| constraint | [SrcRectConstraint](arkts-arkgraphics2d-srcrectconstraint-e.md) | No | Constraint type of the source rectangle. The default value is **STRICT**. |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| outer | [RoundRect](arkts-arkgraphics2d-roundrect-c.md) | Yes | Outer rounded rectangle. |
| inner | [RoundRect](arkts-arkgraphics2d-roundrect-c.md) | Yes | Inner rounded rectangle. |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| path | [Path](arkts-arkgraphics2d-path-c.md) | Yes | **Path** object to draw. |
...
| vertices | [Array](../../apis-na/arkts-apis/arkts-na-array-i.md)<number> | Yes | Array of vertices, which specify the position to draw. The value is a floating-point array and the size must be ((meshWidth+1) * (meshHeight+1) + vertOffset) * 2. |
| vertOffset | number | Yes | Number of vert elements to skip before drawing. The value is an integer greater than or equal to 0. |
| colors | [Array](../../apis-na/arkts-apis/arkts-na-array-i.md)<number> \| null | Yes | Array of colors, which specify the color at each vertex. The value is an integer array and can be null. The size must be (meshWidth+1) * (meshHeight+1) + colorOffset.<br>**Since:** 20 |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| points | [Array](../../apis-na/arkts-apis/arkts-na-array-i.md)<common2D.Point> | Yes | Array that holds the points to draw. The length cannot be **0**. |
| mode | [PointMode](arkts-arkgraphics2d-pointmode-e.md) | No | Mode in which the points are drawn. The default value is **drawing.PointMode.POINTS**. |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| region | [Region](../../apis-image-kit/arkts-apis/arkts-image-region-i.md) | Yes | Region to draw. |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| roundRect | [RoundRect](arkts-arkgraphics2d-roundrect-c.md) | Yes | Rounded rectangle. |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| path | [Path](arkts-arkgraphics2d-path-c.md) | Yes | **Path** object, which is used to outline the shadow. |
...
| flag | [ShadowFlag](arkts-arkgraphics2d-shadowflag-e.md) | Yes | Defines an enum for the shadow flags. |
...
| font | [Font](../../apis-arkui/arkts-apis/arkts-arkui-font-c.md) | Yes | **Font** object. |
...
| features | [Array](../../apis-na/arkts-apis/arkts-na-array-i.md)<FontFeature> | Yes | Array of the font feature object. For an empty array, the preset font features in the TrueType Font (TTF) file are used. |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| blob | [TextBlob](arkts-arkgraphics2d-textblob-c.md) | Yes | **TextBlob** object. |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| vertexMode | [VertexMode](arkts-arkgraphics2d-vertexmode-e.md) | Yes | Connection mode of the vertex to be drawn. |
| vertexCount | number | Yes | Number of elements in the vertex array. The value is an integer greater than or equal to 3. |
| positions | [Array](../../apis-na/arkts-apis/arkts-na-array-i.md)<common2D.Point> | Yes | Array that holds the position of every vertex. The array cannot be null and its length must be equal to the value of **vertexCount**. |
| texs | [Array](../../apis-na/arkts-apis/arkts-na-array-i.md)<common2D.Point> \| null | Yes | Array of texture space coordinates corresponding to the vertices.This array can be null, which indicates that the texture space is invalid. If not null, the length of the array must be equal to the value of **vertexCount**. |
| colors | [Array](../../apis-na/arkts-apis/arkts-na-array-i.md)<number> \| null | Yes | Array of colors corresponding to the vertices, which is used for interpolation in triangles. This array can be null, which indicates that the color effect is the default color set by the user. If not null, the length of the array must be equal to the value of **vertexCount**. |
...
| indices | [Array](../../apis-na/arkts-apis/arkts-na-array-i.md)<number> \| null | Yes | Array of vertex indices. The value can be null. In this case, the value of **indexCount** is ignored (an integer greater than or equal to 3 or equal to 0). If not null, the value length must be the same as that of **indexCount**. |
...
| Type | Description |
| --- | --- |
| [Matrix](arkts-arkgraphics2d-matrix-c.md) | Canvas matrix. |
