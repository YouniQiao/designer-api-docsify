...
| --- | --- | --- | --- |
| path | [Path](arkts-arkgraphics2d-path-c.md) | Yes | **Path** object bound to the iterator. |
...
| Type | Description |
| --- | --- |
| [PathIteratorVerb](arkts-arkgraphics2d-pathiteratorverb-e.md) | Path operation type contained in the iterator. |
