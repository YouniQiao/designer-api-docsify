...
| callback | [AsyncCallback](../../apis-basic-service-kit/arkts-apis/arkts-basicservices-asynccallback-t.md)&lt;[NetCapabilities](arkts-network-connection-netcapabilities-i.md)&gt; | Yes | the callback of getNetCapabilities.[NetCapabilities](arkts-network-connection-netcapabilities-i.md#NetCapabilities). |
