...
Obtains the list of data networks that are activated.To invoke this method, you must have the {@code ohos.permission.GET\_NETWORK\_INFO} permission.
...
| --- | --- | --- | --- |
| callback | \_\_\_MD\_LINK\_USD\_0\_\_\_&lt;Array&lt;NetHandle&gt;&gt; | Yes | the callback of getAllNets. |
