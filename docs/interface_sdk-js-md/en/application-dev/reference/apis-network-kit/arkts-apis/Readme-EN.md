...
- [@system.fetch](arkts-fetch.md)
  - [Fetch](arkts-network-fetch-fetch-depr-c.md)
  - [FetchResponse](arkts-network-fetch-fetchresponse-depr-i.md)
- [@system.network](arkts-network.md)
  - [Network](arkts-network-network-network-depr-c.md)
  - [NetworkResponse](arkts-network-network-networkresponse-depr-i.md)
- application<!--arkts-networkkit-application-->
  - [application/VpnExtensionContext](arkts-application/vpnextensioncontext.md)
    - [VpnExtensionContext](vpnextensioncontext-vpnextensioncontext-c.md)