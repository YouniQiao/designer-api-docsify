...
| [off_netStatsChange](arkts-network-statistics-offnetstatschange-f-sys.md#offnetstatschange) | Unregister notifications of network traffic updates. |
...
| [on_netStatsChange](arkts-network-statistics-onnetstatschange-f-sys.md#onnetstatschange) | Register notifications of network traffic updates. |
