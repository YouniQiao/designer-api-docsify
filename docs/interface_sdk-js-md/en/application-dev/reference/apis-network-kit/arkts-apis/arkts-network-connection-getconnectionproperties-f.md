...
| callback | [AsyncCallback](../../apis-basic-service-kit/arkts-apis/arkts-basicservices-asynccallback-t.md)&lt;[ConnectionProperties](arkts-network-connection-connectionproperties-i.md)&gt; | Yes | the callback of getConnectionProperties.[ConnectionProperties](arkts-network-connection-connectionproperties-i.md#ConnectionProperties). |
