...
| --- | --- | --- | --- |
| enable | boolean | Yes | Enabling status of the intelligent priority notification service.    - **true**: The intelligent priority notification service is enabled.    - **false**: The intelligent priority notification service is disabled. |
