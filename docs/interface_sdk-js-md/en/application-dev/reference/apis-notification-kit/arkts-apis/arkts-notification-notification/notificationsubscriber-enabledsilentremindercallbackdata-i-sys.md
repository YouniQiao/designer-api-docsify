...
- **USER\_MODIFIED\_OFF**: disabled state set by the user.  
- **USER\_MODIFIED\_ON**: enabled state set by the user.  
- **SYSTEM\_DEFAULT\_OFF**: initial disabled state before user setting.  
- **SYSTEM\_DEFAULT\_ON**: initial enabled state before user setting.
