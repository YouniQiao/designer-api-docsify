...
Settings of banner for the notification. The default value is **TYPE\_NONE**. Only TYPE\_CLOSE takes effect.
...
Settings of screen lock for the notification. The default value is **TYPE\_NONE**. Only TYPE\_CLOSE takes effect.
...
Settings of sound for the notification. The default value is **TYPE\_NONE**. This parameter becomes writable starting from API version 23. Only TYPE\_CLOSE takes effect.
...
Settings of vibration for the notification. The default value is **TYPE\_NONE**. This parameter becomes writable starting from API version 23. Only TYPE\_CLOSE takes effect.
