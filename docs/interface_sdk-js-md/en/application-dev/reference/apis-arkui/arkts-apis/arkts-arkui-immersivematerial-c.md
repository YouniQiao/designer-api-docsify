...
Immersive material class, which inherits from [Material](arkts-arkui-materialtype-e-sys.md).
...
**Inheritance/Implementation:** ImmersiveMaterial extends [Material](arkts-arkui-material-c-sys.md)
