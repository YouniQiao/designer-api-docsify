...
| --- | --- | --- | --- |
| options | [GestureGroupGestureHandlerOptions](arkts-arkui-gesture-gesturegroupgesturehandleroptions-i.md) | No | Parameters of the gesture group handler. |
...
Sets the cancellation callback for the gesture group handler. The callback is triggered when a sequence gesture ([GestureMode](arkts-arkui-gesture-gesturemode-e.md).Sequence) is cancelled.
...
| Type | Description |
| --- | --- |
| [GestureGroupHandler](arkts-arkui-gesture-gesturegrouphandler-c.md) | Current gesture group handler object. |
