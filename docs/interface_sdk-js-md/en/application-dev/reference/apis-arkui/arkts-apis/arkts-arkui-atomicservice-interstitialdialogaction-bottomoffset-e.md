...
| - | - | - |  
| OFFSET\_FOR\_BAR | 0 | Distance from the bottom of the window when there is a menu bar.It sets the dialog box 88 vp away from the bottom of the window.|  
| OFFSET\_FOR\_NONE | 1 | Distance from the bottom of the window when there is no menu bar.Default value. It sets the dialog box 44 vp away from the bottom of the window.|
