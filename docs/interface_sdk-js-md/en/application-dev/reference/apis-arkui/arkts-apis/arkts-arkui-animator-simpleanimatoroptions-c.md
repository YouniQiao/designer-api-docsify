...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| curve | string | Yes | Interpolation curve. For details, see [AnimatorOptions](../../apis-default/arkts-apis/arkts-animator-animatoroptions-i.md).<br> Default value: **"ease" |
