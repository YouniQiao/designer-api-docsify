...
| Name | Description |
| --- | --- |
| [DialogTextStyleOptions](arkts-arkui-dialogtextstyleoptions-i.md) | Defines DialogTextStyleOptions in the dialog. |
| [DialogButton](arkts-arkui-dialogbutton-i.md) | Button configuration for fixed-style dialog. |
| [DialogSheet](arkts-arkui-dialogsheet-i.md) | The information of sheet item for action sheet style. |
...
| Name | Description |
| --- | --- |
| [DialogBaseOptions](arkts-arkui-dialogbaseoptions-i-sys.md) | Base options shared by all dialog types. |
<!--DelEnd-->
