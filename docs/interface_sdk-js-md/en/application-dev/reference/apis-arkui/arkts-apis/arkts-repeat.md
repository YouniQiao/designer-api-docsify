...
| Name | Description |
| --- | --- |
| [RepeatAttribute](arkts-arkui-repeatattribute-c.md) | In addition to the [drag-and-drop sorting](../../apis-ability-kit/arkts-apis/arkts-app-ability-common.md) attribute, the following attributes are supported. |
