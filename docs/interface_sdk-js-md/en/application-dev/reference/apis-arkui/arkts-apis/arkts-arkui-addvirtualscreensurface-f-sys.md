...
| surfaceRegion | [Rect](../../apis-form-kit/arkts-apis/arkts-form-rect-i.md) | No | Rectangular area of the virtual screen displayed by the surface.If the virtual screen has not bound any surface via [setVirtualScreenSurface()](arkts-arkui-setvirtualscreensurface-f.md#setvirtualscreensurface-1) or [addVirtualScreenSurface()](arkts-arkui-addvirtualscreensurface-f-sys.md#addvirtualscreensurface-1), the surfaceRegion is invalid and defaults to full screen. In mirror mode, the surfaceRegion is invalid and defaults to full screen.In independent display mode, the surfaceRegion is valid. |
