...
> initialization. The default threshold can be queried using the [SourceTool](../arkts-components/arkts-arkui-common-sourcetool-e.md).Unknown type.  
...
| Type | Description |
| --- | --- |
| [Map](../../apis-na/arkts-apis/arkts-na-lib-es2015-collection-map-i.md)<SourceTool, number> | Minimum pan distances required for different input sources to trigger the pan gesture recognizer. Unit: vp. |
...
| Type | Description |
| --- | --- |
| [PanGestureOptions](arkts-arkui-gesture-pangestureoptions-c.md) | Properties of the current pan gesture recognizer. |
