...
| Type | Description |
| --- | --- |
| [PositionWithAffinity](arkts-arkui-textcommon-positionwithaffinity-i.md) | Position and Affinity. Returning undefined indicates that the function call failed. |
...
| Type | Description |
| --- | --- |
| [PositionWithAffinity](arkts-arkui-textcommon-positionwithaffinity-i.md) | TextBlob object. |
...
| Type | Description |
| --- | --- |
| Array&lt;[TextRange](arkts-arkui-textcommon-textrange-i.md)&gt; | The range infos, first item is the range of glyphs generated by charRange. The second item, if present, specifies the actual character range that fully defines glyph range, which may match or slightly exceed the requested range. the returned Returning undefined indicates that the function call failed. |
...
| Type | Description |
| --- | --- |
| [LineMetrics](arkts-arkui-linemetrics-t.md) | The line Metrics. |
...
| Type | Description |
| --- | --- |
| Array&lt;[TextBox](arkts-arkui-textbox-t.md)&gt; | The rects for range. |
