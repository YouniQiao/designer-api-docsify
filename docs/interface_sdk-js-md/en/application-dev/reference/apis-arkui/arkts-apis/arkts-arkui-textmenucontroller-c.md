...
> [getTextMenuController()](arkts-arkui-uicontext-c.md#gettextmenucontroller-1) in **UIContext** to obtain a  
...
| --- | --- | --- | --- |
| items | [Array](../../apis-na/arkts-apis/arkts-na-array-i.md)<TextMenuItemId> | Yes | List of menu items to disable.<br>Default value: [].<br>By default, no menu item is disabled. |
