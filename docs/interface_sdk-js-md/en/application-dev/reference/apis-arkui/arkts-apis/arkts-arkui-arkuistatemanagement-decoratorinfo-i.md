...
If the V2 object uses [makeObserved](arkts-arkui-arkuistatemanagement-uiutils-c.md#makeobserved), the value is **'MakeObserved'**.

If the V2 object uses [enableV2Compatibility](arkts-arkui-arkuistatemanagement-uiutils-c.md#enablev2compatibility), the value is **'EnableV2Compatible'**.
...
**Type:** Array&lt;[ElementInfo](arkts-arkui-arkuistatemanagement-elementinfo-i.md)&gt;
