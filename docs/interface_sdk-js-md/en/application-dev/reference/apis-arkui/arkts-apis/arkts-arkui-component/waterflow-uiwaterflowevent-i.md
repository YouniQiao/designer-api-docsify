...
**Inheritance/Implementation:** UIWaterFlowEvent extends [UIScrollableCommonEvent](common-uiscrollablecommonevent-i.md)
...
| --- | --- | --- | --- |
| callback | \_\_\_MD\_LINK\_USD\_0\_\_\_ \| undefined | Yes | callback function, triggered when the WaterFlow did scroll. Passing undefined will unregister the callback. |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| callback | \_\_\_MD\_LINK\_USD\_0\_\_\_ \| undefined | Yes | callback function, triggered when start or end positions of the display change. Passing undefined will unregister the callback. |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| callback | \_\_\_MD\_LINK\_USD\_0\_\_\_ \| undefined | Yes | callback function, triggered when the WaterFlow will scroll. Passing undefined will unregister the callback. |
