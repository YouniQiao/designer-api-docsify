...
The arrow background size.The size of the arrow is three-quarters of the background size, when the background is displayed.The percentage cannot be set.\_\_\_HTML\_TAG\_DESC\_USD\_0\_\_\_Displays on either side of the navigation point:Default value: 24vp Displayed on both sides of the component:Default value: 32vp.
