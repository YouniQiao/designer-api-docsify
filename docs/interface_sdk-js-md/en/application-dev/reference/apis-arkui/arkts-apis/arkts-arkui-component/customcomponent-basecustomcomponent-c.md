...
**Inheritance/Implementation:** BaseCustomComponent extends [ExtendableComponent](extendablecomponent-extendablecomponent-c.md) and implements [CommonAttribute](../arkts-arkui-commonattribute-t.md)
