...
**Inheritance/Implementation:** ExtendableComponent implements [LifeCycle](extendablecomponent-lifecycle-i.md), [IVariableOwner](../arkts-arkui-statemanagement/decorator-ivariableowner-i.md)
