...
```TypeScript
attributeModifier(modifier: AttributeModifier<EffectComponentAttribute>
...
```TypeScript
setEffectComponentOptions(options?: EffectComponentOptions): this
```
