...
> [getDragController](arkts-arkui-arkuiuicontext-uicontext-c.md#getdragcontroller) API in
> [UIContext](arkts-arkui-arkuiuicontext-uicontext-c.md) to obtain the
> [DragController](arkts-arkui-arkuiuicontext-dragcontroller-c.md) object associated with the current UI context.
> 
