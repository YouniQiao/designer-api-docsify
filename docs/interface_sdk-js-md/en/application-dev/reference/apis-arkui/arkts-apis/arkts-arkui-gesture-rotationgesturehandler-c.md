...
| Type | Description |
| --- | --- |
| [RotationGestureHandler](arkts-arkui-gesture-rotationgesturehandler-c.md) | Rotation gesture handler object. |
...
Sets the callback for rotation gesture cancellation. This callback is triggered when a touch cancellation event occurs after successful recognition. Compared with [onActionCancel](arkts-arkui-gesture-rotationgesturehandler-c.md#onactioncancel-1), this API returns gesture event information.
