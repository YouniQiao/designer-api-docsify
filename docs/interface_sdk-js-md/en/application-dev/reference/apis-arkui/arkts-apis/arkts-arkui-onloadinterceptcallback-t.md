...
| --- | --- | --- | --- |
| event | [OnLoadInterceptEvent](arkts-arkui-atomicserviceatomicserviceweb-onloadinterceptevent-i.md) | Yes | Event triggered when resource loading is intercepted. |
