...
| [PersistenceV2](arkts-arkui-arkui-statemanagement-persistencev2-c.md) | Inherits from [AppStorageV2](arkts-arkui-arkui-statemanagement-appstoragev2-c.md#AppStorageV2). For details, see [PersistenceV2: Persisting Application State](../../../ui/state-management/arkts-new-persistencev2.md). |
