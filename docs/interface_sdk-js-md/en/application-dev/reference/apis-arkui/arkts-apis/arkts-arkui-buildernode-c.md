...
> 
> - Avoid forwarding a single event multiple times.<!--Del--> This API cannot be called by [UIExtensionComponent](../arkts-components/arkts-arkui-uiextensioncomponent-comp-sys.md#ui_extension_componentsystem-api).<!--DelEnd-->
...
> 
> - The same event can be forwarded multiple times.<!--Del--> This API cannot be called by [UIExtensionComponent](../arkts-components/arkts-arkui-uiextensioncomponent-comp-sys.md#ui_extension_componentsystem-api).<!--DelEnd-->
...
> 
> - This API cannot be called by [UIExtensionComponent](../arkts-components/arkts-arkui-uiextensioncomponent-comp-sys.md#ui_extension_componentsystem-api).
