...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| uiContext | [UIContext](arkts-arkui-arkui-uicontext-uicontext-c.md) | Yes | uiContext used to create the BuilderNode |
| options | [RenderOptions](arkts-arkui-buildernode-renderoptions-i.md) | No | Render options of the Builder Node |
