...
**Inheritance/Implementation:** ChipV2CloseIcon extends [ChipV2Accessibility](arkts-arkui-arkuiadvancedchipv2-chipv2accessibility-c.md)
...
| --- | --- | --- | --- |
| config | [ChipV2CloseConfig](arkts-arkui-arkuiadvancedchipv2-chipv2closeconfig-i.md) | Yes | config of close icon |
