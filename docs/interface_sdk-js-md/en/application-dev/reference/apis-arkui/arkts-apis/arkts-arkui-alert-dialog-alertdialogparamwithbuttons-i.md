...
Inherited from [AlertDialogParam](arkts-arkui-alert-dialog-alertdialogparam-i.md).

**Inheritance/Implementation:** AlertDialogParamWithButtons extends [AlertDialogParam](arkts-arkui-alert-dialog-alertdialogparam-i.md)
