...
| Type | Description |
| --- | --- |
| [DirectionalEdgesT](arkts-arkui-directionaledgest-i.md)&lt;double&gt; | Border width of the child component, unit is vp. If some errors occur in the internal runtime environment, returns undefined. |
...
| Type | Description |
| --- | --- |
| [DirectionalEdgesT](arkts-arkui-directionaledgest-i.md)&lt;double&gt; | Margin of the child component, unit is vp. If some errors occur in the internal runtime environment, returns undefined. |
...
| Type | Description |
| --- | --- |
| [DirectionalEdgesT](arkts-arkui-directionaledgest-i.md)&lt;double&gt; | the padding of sub component, unit is vp. If some errors occur in the internal runtime environment, returns undefined. |
