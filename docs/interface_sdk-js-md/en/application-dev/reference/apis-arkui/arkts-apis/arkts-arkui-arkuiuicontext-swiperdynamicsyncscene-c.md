...
> 
> - **SwiperDynamicSyncScene** inherits from [DynamicSyncScene](arkts-arkui-arkuiuicontext-uicontext-c.md) and represents the
> dynamic sync scene of the **Swiper** component.

**Inheritance/Implementation:** SwiperDynamicSyncScene extends [DynamicSyncScene](arkts-arkui-arkuiuicontext-dynamicsyncscene-c.md)
...
**Type:** [SwiperDynamicSyncSceneType](arkts-arkui-arkuiuicontext-swiperdynamicsyncscenetype-e.md)
