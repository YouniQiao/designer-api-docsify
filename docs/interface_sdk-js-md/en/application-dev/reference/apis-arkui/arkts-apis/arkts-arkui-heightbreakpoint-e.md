...
Enumerates the height breakpoint values corresponding to different window aspect ratio thresholds. The values are returned through [getWindowHeightBreakpoint](../../apis-default/arkts-apis/arkts-arkui-uicontext-uicontext-c.md#getwindowheightbreakpoint).
