...
| --- | --- | --- | --- |
| type | [TypeConstructorWithArgs](arkts-arkui-arkuistatemanagement-typeconstructorwithargs-i.md)&lt;T&gt; | Yes | Type. If no key is specified, the name of the type is used as the key. |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| keyOrType | string \| [TypeConstructorWithArgs](arkts-arkui-arkuistatemanagement-typeconstructorwithargs-i.md)&lt;T&gt; | Yes | Key to be removed. If a type is specified, the key to be removed is the name of that type. |
