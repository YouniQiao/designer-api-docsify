...
**Inheritance/Implementation:** ChipV2SymbolIcon extends [ChipV2Icon](arkts-arkui-arkuiadvancedchipv2-chipv2icon-c.md)
...
| --- | --- | --- | --- |
| config | [ChipV2SymbolIconConfig](arkts-arkui-arkuiadvancedchipv2-chipv2symboliconconfig-i.md) | Yes | config of chip symbol icon |
