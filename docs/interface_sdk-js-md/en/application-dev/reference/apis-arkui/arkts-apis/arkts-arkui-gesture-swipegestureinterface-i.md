...
Sets the parameters for the swipe gesture. Inherits from [GestureInterface<T>](arkts-arkui-gesture-gestureinterface-i.md).
...
| Type | Description |
| --- | --- |
| [SwipeGestureInterface](arkts-arkui-gesture-swipegestureinterface-i.md) | @syscap SystemCapability.ArkUI.ArkUI.Full@crossplatform |
...
| Type | Description |
| --- | --- |
| [SwipeGestureInterface](arkts-arkui-gesture-swipegestureinterface-i.md) | @syscap SystemCapability.ArkUI.ArkUI.Full@stagemodelonly@crossplatform@atomicservice |
