...
**Inheritance/Implementation:** ChipV2PrefixImageIcon extends [ChipV2ImageIcon](arkts-arkui-arkuiadvancedchipv2-chipv2imageicon-c.md)
...
| --- | --- | --- | --- |
| config | [ChipV2PrefixImageIconConfig](arkts-arkui-arkuiadvancedchipv2-chipv2prefiximageiconconfig-i.md) | Yes | config of prefix icon |
