...
| --- | --- | --- | --- |
| value | [BreakpointOptions](arkts-arkui-arkuicomponentscontainerreader-breakpointoptions-i.md) | No | An array of breakpoint values in vp |

**Return value:**

| Type | Description |
| --- | --- |
| [ContainerReaderAttribute](arkts-arkui-arkuicomponentscontainerreader-containerreaderattribute-c.md) |  |
