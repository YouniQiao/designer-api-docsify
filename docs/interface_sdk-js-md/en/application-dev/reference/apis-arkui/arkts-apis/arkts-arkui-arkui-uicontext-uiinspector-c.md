...
| --- | --- | --- | --- |
| id | string | Yes | ID of the target component, set using the universal attributes [id](arkts-arkui-common-commonmethod-i.md#id) or [key](arkts-arkui-common-commonmethod-i.md#key). |
