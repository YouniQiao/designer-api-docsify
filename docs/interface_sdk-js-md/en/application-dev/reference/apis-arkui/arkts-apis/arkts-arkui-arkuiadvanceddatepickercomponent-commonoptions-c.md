...
> 
> - In [DateOptions](arkts-arkui-arkuiadvanceddatepickercomponent-dateoptions-c.md), setting start, end, and selected only takes effect for the date part (year,
> month, day). In [TimeOptions](arkts-arkui-arkuiadvanceddatepickercomponent-timeoptions-c.md), setting start, end, and selected only takes effect for the time
...
**Type:** [Callback](../../apis-basic-services-kit/arkts-apis/arkts-basicservices-callback-t.md)&lt;[DatePickerComponentResult](arkts-arkui-arkuiadvanceddatepickercomponent-datepickercomponentresult-c.md)&gt;
