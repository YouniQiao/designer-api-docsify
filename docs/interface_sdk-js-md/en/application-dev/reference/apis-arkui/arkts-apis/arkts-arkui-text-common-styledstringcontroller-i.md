...
| Type | Description |
| --- | --- |
| [MutableStyledString](arkts-arkui-styled-string-mutablestyledstring-c.md) | Styled string displayed in the rich text component. |
...
| --- | --- | --- | --- |
| styledString | [StyledString](arkts-arkui-styled-string-styledstring-c.md) | Yes | Styled string to set.<br>**NOTE**<br>The child class [MutableStyledString](arkts-arkui-styled-string-mutablestyledstring-c.md) of **StyledString** can also serve as the argument. |
