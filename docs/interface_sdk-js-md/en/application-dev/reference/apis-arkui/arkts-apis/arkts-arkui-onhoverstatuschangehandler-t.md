...
| --- | --- | --- | --- |
| status | [HoverModeStatus](arkts-arkui-arkuiadvancedfoldsplitcontainer-hovermodestatus-i.md) | Yes | Callback function triggered when the foldable device enters or exits the semi-folded state. |
