...
Creates a **PictureDrawableDescriptor** object by passing a **Picture** object. This API inherits from [DrawableDescriptor](arkts-arkui-arkuidrawabledescriptor-drawabledescriptorloadedresult-i.md).

**Inheritance/Implementation:** PictureDrawableDescriptor extends [DrawableDescriptor](arkts-arkui-arkuidrawabledescriptor-drawabledescriptor-c.md)
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| config | [HdrCompositionConfig](arkts-arkui-arkuidrawabledescriptor-hdrcompositionconfig-i.md) | Yes | HDR composition configuration. |
