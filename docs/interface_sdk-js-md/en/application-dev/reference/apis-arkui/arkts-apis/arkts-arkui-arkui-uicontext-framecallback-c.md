...
Implements the API for setting the task that needs to be executed during the next frame rendering. > **NOTE：**> > - The following APIs must be used in conjunction with [postFrameCallback](../../apis-na/arkts-apis/arkts-na-arkui-uicontext-uicontext-c.md#postframecallback) and > [postDelayedFrameCallback](../../apis-na/arkts-apis/arkts-na-arkui-uicontext-uicontext-c.md#postdelayedframecallback) from [UIContext](../../apis-na/arkts-apis/arkts-na-arkui-uicontext-uicontext-c.md). > Extend this class and override either the [onFrame](../../apis-na/arkts-apis/arkts-na-arkui-uicontext-framecallback-c.md#onframe) or > [onIdle](../../apis-na/arkts-apis/arkts-na-arkui-uicontext-framecallback-c.md#onidle) method to implement specific service logic.
