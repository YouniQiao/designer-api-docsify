...
| --- | --- | --- | --- |
| context | [DrawContext](arkts-arkui-drawcontext-c.md) | Yes | Drawing context.<br>The **canvas** method of **DrawContext** obtains the canvas of the component. As such, the custom span does not extend beyond the area of the component. |
