...
Set the attribute modifier of button.
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| value | [ButtonStyleMode](arkts-arkui-button-buttonstylemode-e.md) \| undefined | Yes | button style mode |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| value | [ControlSize](arkts-arkui-button-controlsize-e.md) \| undefined | Yes | control size |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| value | [ButtonLabelStyle](arkts-arkui-button-buttonlabelstyle-i.md) \| undefined | Yes | The label style configuration on button. |
...
```TypeScript
default setButtonOptions(label: ResourceStr, options?: ButtonOptions): this
```
...
<!--Device-ButtonAttribute-default setButtonOptions(label: ResourceStr, options?: ButtonOptions): this--><!--Device-ButtonAttribute-default setButtonOptions(label: ResourceStr, options?: ButtonOptions): this-End-->
...
| options | [ButtonOptions](arkts-arkui-button-buttonoptions-i.md) | No | button constructor options |

**Return value:**

| Type | Description |
| --- | --- |
| this | Returns the instance of the ButtonAttribute. |

## setButtonOptions

```TypeScript
default setButtonOptions(options?: ButtonOptions): this
```
...
<!--Device-ButtonAttribute-default setButtonOptions(options?: ButtonOptions): this--><!--Device-ButtonAttribute-default setButtonOptions(options?: ButtonOptions): this-End-->
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| value | [ButtonType](arkts-arkui-button-buttontype-e.md) \| undefined | Yes |  |
