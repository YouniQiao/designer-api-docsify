...
This module provides APIs for system materials. Different system materials correspond to different UI effects,including the background color ([backgroundColor](../arkts-components/arkts-arkui-commonmethod-c.md#backgroundcolor)), border color ([borderColor](../arkts-components/arkts-arkui-commonmethod-c.md#bordercolor)), border width ([borderWidth](../arkts-components/arkts-arkui-commonmethod-c.md#borderwidth)),and shadow ([shadow](../arkts-components/arkts-arkui-commonmethod-c.md#shadow)).
