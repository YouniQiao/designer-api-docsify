...
| Name | Description |
| --- | --- |
| [getGlobalMaterialLevel](arkts-arkui-getglobalmateriallevel-f.md#getglobalmateriallevel-1) | Obtains the global material level, which is related to the device computing power. This configuration item is defined by the device and cannot be modified. |
...
| [LightEffectOptions](arkts-arkui-lighteffectoptions-i.md) | Provides the light sensing interaction feedback configuration for immersive materials. The configuration is used to customize the color of the light sensing feedback. |
...
| [MaterialLevel](arkts-arkui-materiallevel-e.md) | Enumerates the material levels, which indicate the computing power level of the device.Use [getGlobalMaterialLevel](arkts-arkui-getglobalmateriallevel-f.md#getglobalmateriallevel-1) to obtain the material level of the current device. |
