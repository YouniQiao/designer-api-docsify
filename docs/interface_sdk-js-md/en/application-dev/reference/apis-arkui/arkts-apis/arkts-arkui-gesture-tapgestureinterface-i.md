...
Creates a tap gesture. Inherits from [GestureInterface<T>](arkts-arkui-gesture-gestureinterface-i.md).

When triggered by keyboard or gamepad input, the gesture event's [SourceTool](../arkts-components/arkts-arkui-common-sourcetool-e.md) is **Unknown**, and [SourceType](../../apis-input-kit/arkts-apis/arkts-input-multimodalinput-touchevent-sourcetype-e.md) is **KEY** or **JOYSTICK**.
