...
**Substitutes:** [getShared](arkts-arkui-common-ts-ets-api-localstorage-c.md#getshared-1)
...
| Type | Description |
| --- | --- |
| [LocalStorage](arkts-arkui-common-ts-ets-api-localstorage-c.md) | **LocalStorage** instance. |
...
For details about the subscriber, see [delete](arkts-arkui-common-ts-ets-api-localstorage-c.md#delete-1).
...
| --- | --- | --- | --- |
| initializingProperties | [Object](../../apis-na/arkts-apis/arkts-na-lib-es5-object-i.md) | No | Properties and values used to initialize the **LocalStorage** instance. **initializingProperties** cannot be set to **undefined**. The default value is an empty object,meaning no properties are added to LocalStorage during initialization. |
...
2. Instances of [SubscribedAbstractProperty](arkts-arkui-common-ts-ets-api-subscribedabstractproperty-c-sys.md)returned by [link](arkts-arkui-common-ts-ets-api-localstorage-c.md#link-1), [prop](arkts-arkui-common-ts-ets-api-localstorage-c.md#prop-1),[setAndLink](arkts-arkui-common-ts-ets-api-localstorage-c.md#setandlink-1), or [setAndProp](arkts-arkui-common-ts-ets-api-localstorage-c.md#setandprop-1)
...
| Type | Description |
| --- | --- |
| [SubscribedAbstractProperty](arkts-arkui-common-ts-ets-api-subscribedabstractproperty-c.md)<T> | Returns the **SubscribedAbstractProperty&lt;T&gt;** instance if the given property exists in LocalStorage; returns **undefined** otherwise. |
...
| Type | Description |
| --- | --- |
| [SubscribedAbstractProperty](arkts-arkui-common-ts-ets-api-subscribedabstractproperty-c.md)<S> | Instance of **SubscribedAbstractProperty&lt;S&gt;** and one-way bound data of the given property in LocalStorage. If the given property does not exist in LocalStorage, **undefined** is returned. |
...
This API is similar to [link](arkts-arkui-common-ts-ets-api-localstorage-c.md#link-1) but does not require manually releasing the returned variable of the [AbstractProperty](arkts-arkui-common-ts-ets-api-abstractproperty-i.md) type.
...
| Type | Description |
| --- | --- |
| [AbstractProperty](arkts-arkui-common-ts-ets-api-abstractproperty-i.md)<T> | A reference to the property in LocalStorage, or **undefined** if the property does not exist. |
...
| Type | Description |
| --- | --- |
| [SubscribedAbstractProperty](arkts-arkui-common-ts-ets-api-subscribedabstractproperty-c.md)<T> | Instance of **SubscribedAbstractProperty&lt;T&gt;** and two-way bound data of the given property in LocalStorage. |
...
| Type | Description |
| --- | --- |
| [SubscribedAbstractProperty](arkts-arkui-common-ts-ets-api-subscribedabstractproperty-c.md)<S> | Instance of **SubscribedAbstractProperty&lt;S&gt;** and one-way bound data of the given property in LocalStorage. |
...
Similar to the [ref](arkts-arkui-common-ts-ets-api-appstorage-c.md#ref-1) API, returns a reference to the property corresponding to **propName** in [LocalStorage](../../../../ui/state-management/arkts-localstorage.md). If the given property does not exist, this API creates and initializes the property in LocalStorage using **defaultValue** and returns its reference.

This API is similar to [setAndLink](arkts-arkui-common-ts-ets-api-localstorage-c.md#setandlink-1) but does not require manually releasing the returned variable of the [AbstractProperty](arkts-arkui-common-ts-ets-api-abstractproperty-i.md) type.
...
| Type | Description |
| --- | --- |
| [AbstractProperty](arkts-arkui-common-ts-ets-api-abstractproperty-i.md)<T> | Instance of **AbstractProperty&lt;T&gt;**, which is a reference to the property in LocalStorage corresponding to **propName**. |
