...
Sets the parameters for the pinch gesture. Inherits from [GestureInterface<T>](arkts-arkui-gesture-gestureinterface-i.md).
...
Triggered when a touch cancellation event occurs after successful pinch gesture recognition. Compared with [onActionCancel](arkts-arkui-gesture-pinchgestureinterface-i.md#onactioncancel-1), this callback returns gesture event information.
