...
| [CHECKED](arkts-arkui-arkui-advanced-chip-accessibilityselectedtype-e.md) | 1 | Checkbox type. The chip reports its selected state to accessibility services using the [accessibilityChecked](../arkts-components/arkts-arkui-commonmethod-c.md#accessibilitychecked) attribute. Use this type for multi-select scenarios, such as tag filtering and attribute selection.|
| [SELECTED](arkts-arkui-arkui-advanced-chip-accessibilityselectedtype-e.md) | 2 | Radio type. The chip reports its selected state to accessibility services using the [accessibilitySelected](../arkts-components/arkts-arkui-commonmethod-c.md#accessibilityselected) attribute. Use this type for single-select scenarios, such as navigation bar tabs and radio buttons.|
