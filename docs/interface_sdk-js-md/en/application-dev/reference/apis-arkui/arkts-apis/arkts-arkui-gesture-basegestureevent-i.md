...
Defines the basic gesture event type. Inherits from [BaseEvent](../arkts-components/arkts-arkui-common-baseevent-i.md).

**Inheritance/Implementation:** BaseGestureEvent extends [BaseEvent](../arkts-components/arkts-arkui-common-baseevent-i.md)
