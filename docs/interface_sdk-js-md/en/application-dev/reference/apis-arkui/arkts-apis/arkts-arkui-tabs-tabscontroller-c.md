...
| --- | --- | --- | --- |
| value | int | Yes | 页签在Tabs里的索引值，索引值从0开始。&lt;br/&gt;**说明：** &lt;br/&gt;设置小于0或大于最大数量的值时，取默认值0。 |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| indices | Array&lt;int&gt; \| undefined | Yes | 需预加载的子节点的下标数组。&lt;br/&gt;默认值：空数组。&lt;br/&gt;取值为undefined时，按默认值处理。 |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| translate | [TranslateOptions](../arkts-components/arkts-arkui-translateoptions-i.md) | Yes | 设置TabBar的平移距离。 |
