...
Shows an alert dialog box. &gt; **NOTE：**&gt; &gt; Since API version 10, you can use the &gt; [showAlertDialog](arkts-arkui-arkui-uicontext-uicontext-c.md#showalertdialog) API in &gt; [UIContext](arkts-arkui-arkui-uicontext-uicontext-c.md), which ensures that the alert dialog box is shown in the intended UI &gt; instance.
