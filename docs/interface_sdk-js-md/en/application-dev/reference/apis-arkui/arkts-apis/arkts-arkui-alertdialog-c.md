...
**Substitutes:** [showAlertDialog](../../apis-na/arkts-apis/arkts-na-arkui-uicontext-uicontext-c.md#showalertdialog)
...
Shows an alert dialog box. > **NOTE：**> > Since API version 10, you can use the > [showAlertDialog](../../apis-na/arkts-apis/arkts-na-arkui-uicontext-uicontext-c.md#showalertdialog) API in > [UIContext](../../apis-na/arkts-apis/arkts-na-arkui-uicontext-uicontext-c.md), which ensures that the alert dialog box is shown in the intended UI > instance.
