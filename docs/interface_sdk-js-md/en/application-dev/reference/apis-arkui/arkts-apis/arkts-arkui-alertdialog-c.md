...
> [showAlertDialog](arkts-arkui-uicontext-c.md#showalertdialog-1) API in  
...
| --- | --- | --- | --- |
| value | AlertDialogParamWithConfirm \| AlertDialogParamWithButtons \| AlertDialogParamWithOptions | Yes | Defines and displays the **AlertDialog** component.<br>**Since:** 10 |
