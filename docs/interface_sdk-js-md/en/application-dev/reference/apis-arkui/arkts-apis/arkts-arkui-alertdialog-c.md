...
**Substitutes:** [showAlertDialog](../../apis-default/arkts-apis/arkts-arkui-uicontext-uicontext-c.md#showalertdialog)
...
> **NOTE：**
> 
> Since API version 10, you can use the &gt; [showAlertDialog](../../apis-default/arkts-apis/arkts-arkui-uicontext-uicontext-c.md#showalertdialog) API in &gt; [UIContext](../../apis-default/arkts-apis/arkts-arkui-uicontext-uicontext-c.md), which ensures that the alert dialog box is shown in the intended UI &gt; instance.
