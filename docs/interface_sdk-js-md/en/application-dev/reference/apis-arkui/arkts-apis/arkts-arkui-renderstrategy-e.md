...
it has effect only when the [clip](../arkts-components/arkts-arkui-common-comp-commonmethod-c.md#clip) attribute, [background](../arkts-components/arkts-arkui-common-comp.md#common), or [foreground color](../arkts-components/arkts-arkui-common-comp.md#common) is configured.
