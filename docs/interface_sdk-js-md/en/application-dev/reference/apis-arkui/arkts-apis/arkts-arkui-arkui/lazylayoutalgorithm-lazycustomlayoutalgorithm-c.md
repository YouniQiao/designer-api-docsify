...
**Inheritance/Implementation:** LazyCustomLayoutAlgorithm implements [LazyLayoutAlgorithm](lazylayoutalgorithm-lazylayoutalgorithm-i.md)
...
| --- | --- | --- | --- |
| option | \_\_\_MD\_LINK\_USD\_0\_\_\_ | No | set properties of lazy custom layout algorithm. |
...
| helper | \_\_\_MD\_LINK\_USD\_0\_\_\_ | No | The helper object for lazy layout algorithm, which provides layout direction and view position information. If undefined, it indicates that the current component is not used under a scrollable component and does not support lazy layout. |
