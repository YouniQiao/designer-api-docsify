...
Create ColorMetrics class using HDR color with default exposure.Create an HDR color value with default exposure (0.0 for logarithmic, 1.0 for linear).When no exposure value is specified, RGB channel values can exceed 1.0 to achieve HDR brightness.This matches iOS UIColor behavior where RGB values   
    1.0 enable HDR rendering.
...
| Type | Description |
| --- | --- |
| \_\_\_MD\_LINK\_USD\_0\_\_\_ | The color space of the ColorMetrics. Possible value: ColorSpace.SRGB, ColorSpace.DISPLAY\_\_\_ESCAPED\_UNDERSCORE\_\_\_P3, ColorSpace.BT2020. |
...
Check if ColorMetrics represents an HDR color.Returns true if color was created using createHDRColorWithXx or has RGB values   
    1.0.
