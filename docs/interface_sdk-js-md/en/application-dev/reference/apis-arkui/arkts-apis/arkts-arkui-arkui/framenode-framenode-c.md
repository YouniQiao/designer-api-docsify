...
| --- | --- | --- | --- |
| content | \_\_\_MD\_LINK\_USD\_0\_\_\_&lt;T&gt; \| ReactiveComponentContent | Yes | Newly added ComponentContent.\_\_\_HTML\_TAG\_USD\_0\_\_\_**Since:** 23 - 24 |
...
Sets the polymorphic style states supported by the component. To improve efficiency, you need to pass the states of interest and their corresponding handler functions. When the state changes, the handler function will be executed. You can update the UI style based on the current state in the callback.For certain types of control nodes, the system has default style handling for some states (e.g., the button component has default style changes for the PRESSED state). When using this method to customize state handling for such components, the system's default style changes will be applied first, followed by the custom styles.The final effect is a combination of both. You can set \_\_\_INLINE\_CODE\_DESC\_USD\_0\_\_\_ to \_\_\_INLINE\_CODE\_DESC\_USD\_1\_\_\_ to disable the system's default style handling, though this depends on system implementation.When calling this method, the provided \_\_\_INLINE\_CODE\_DESC\_USD\_2\_\_\_ function will be executed immediately. You do not need to explicitly register a handler for the NORMAL state. If you register handlers for non-NORMAL states, the system will automatically call the handler when the state reverts to NORMAL, allowing you to restore the UI style.
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| uiStates | int | Yes | The target UI states the node needs to handle. Multiple states can be combined using the OR operation, e.g., \_\_\_ESCAPED\_UNDERSCORE\_\_\_\_\_\_ESCAPED\_UNDERSCORE\_\_\_\_\_\_ESCAPED\_UNDERSCORE\_\_\_INLINE\_\_\_ESCAPED\_UNDERSCORE\_\_\_CODE\_\_\_ESCAPED\_UNDERSCORE\_\_\_DESC\_\_\_ESCAPED\_UNDERSCORE\_\_\_USD\_\_\_ESCAPED\_UNDERSCORE\_\_\_0\_\_\_ESCAPED\_UNDERSCORE\_\_\_\_\_\_ESCAPED\_UNDERSCORE\_\_\_\_\_\_ESCAPED\_UNDERSCORE\_\_\_. |
| statesChangeHandler | \_\_\_MD\_LINK\_USD\_0\_\_\_ | Yes | The handler function for UI state changes. |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| child | \_\_\_MD\_LINK\_USD\_0\_\_\_ | Yes | the target node being adopted. |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| node | \_\_\_MD\_LINK\_USD\_0\_\_\_ | Yes | The node will be added. The child node cannot be one created declaratively, which is not modifiable. Only declarative nodes obtained from a BuilderNode can be used as child nodes. If the child node does not meet the specifications, an exception is thrown. The FrameNode cannot have a parent node. Otherwise, an exception is thrown. The node cannot be adopted. Otherwise, an exception is thrown. |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| properties | \_\_\_MD\_LINK\_USD\_0\_\_\_[] | Yes | animation property types to cancel. |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| position | \_\_\_MD\_LINK\_USD\_0\_\_\_ | Yes | The point's coordinates in the current node's local coordinate system. |
| targetNode | \_\_\_MD\_LINK\_USD\_0\_\_\_ | Yes | The destination node whose coordinate system will be used for conversion. |

**Return value:**

| Type | Description |
| --- | --- |
| \_\_\_MD\_LINK\_USD\_0\_\_\_ |  The converted coordinates in the target node's local coordinate system. |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| positionByWindow | \_\_\_MD\_LINK\_USD\_0\_\_\_ | Yes | The point's coordinates in the current window's coordinate system. |

**Return value:**

| Type | Description |
| --- | --- |
| \_\_\_MD\_LINK\_USD\_0\_\_\_ |  The converted coordinates in the current node's local coordinate system. |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| positionByLocal | \_\_\_MD\_LINK\_USD\_0\_\_\_ | Yes | The point's coordinates in the current node's local coordinate system. |

**Return value:**

| Type | Description |
| --- | --- |
| \_\_\_MD\_LINK\_USD\_0\_\_\_ |  The converted coordinates in the current window's coordinate system. |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| property | \_\_\_MD\_LINK\_USD\_0\_\_\_ | Yes | enumeration of property that produces the animation. |
...
| param | \_\_\_MD\_LINK\_USD\_0\_\_\_ | Yes | param of animation. |
...
| expandMode | \_\_\_MD\_LINK\_USD\_0\_\_\_ \| undefined | No | The expand mode. Default value is ExpandMode.EXPAND. |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| countMode | \_\_\_MD\_LINK\_USD\_0\_\_\_ | No | The children count mode. Default value is ChildrenCountMode.ALL\_\_\_ESCAPED\_UNDERSCORE\_\_\_EXPAND. |
...
| Type | Description |
| --- | --- |
| \_\_\_MD\_LINK\_USD\_0\_\_\_ |  Returns the cross-language options of the target FrameNode. |
...
| Type | Description |
| --- | --- |
| \_\_\_MD\_LINK\_USD\_0\_\_\_ |  Returns the value of the custom property. |
...
1. If the uniqueId corresponds to a built-in component, the associated FrameNode is returned.2. If the uniqueId corresponds to a custom component: If the component has rendered content, its root node is returned, with the type \_\_Common\_\_; if the component has no rendered content, the FrameNode of its first child component is returned.3. If the uniqueId does not correspond to any component, null is returned.
...
| Type | Description |
| --- | --- |
| \_\_\_MD\_LINK\_USD\_0\_\_\_ |  Returns position of the node relative to unified display, in vp. |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| eventType | \_\_\_MD\_LINK\_USD\_0\_\_\_ | Yes | The interaction event type to be queried. |
...
| Type | Description |
| --- | --- |
| \_\_\_MD\_LINK\_USD\_0\_\_\_ |  Returns the offset to the parent of the FrameNode after layout, with unit PX. |
...
| Type | Description |
| --- | --- |
| \_\_\_MD\_LINK\_USD\_0\_\_\_ |  Returns the size of the FrameNode after measure, with unit PX. |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| property | \_\_\_MD\_LINK\_USD\_0\_\_\_ | Yes | animation property type to get value. |
...
Get the type of the FrameNode. The type is the name of component, for example, the nodeType of Button is "Button",and the nodeType of custom component is "\_\_Common\_\_".
...
| Type | Description |
| --- | --- |
| \_\_\_MD\_LINK\_USD\_0\_\_\_ |  Returns position of the node relative to its parent. |
...
| Type | Description |
| --- | --- |
| \_\_\_MD\_LINK\_USD\_0\_\_\_ |  Returns position of the node relative to its parent with transform. |
...
| Type | Description |
| --- | --- |
| \_\_\_MD\_LINK\_USD\_0\_\_\_ |  Returns position of the node relative to screen. |
...
| Type | Description |
| --- | --- |
| \_\_\_MD\_LINK\_USD\_0\_\_\_ |  Returns position of the node relative to screen with transform. |
...
| Type | Description |
| --- | --- |
| \_\_\_MD\_LINK\_USD\_0\_\_\_ |  Returns position of the node relative to window with transform. |
...
| Type | Description |
| --- | --- |
| \_\_\_MD\_LINK\_USD\_0\_\_\_&lt;\_\_\_MD\_LINK\_USD\_1\_\_\_&gt; |  Returns the user config border width of the FrameNode. |
...
| Type | Description |
| --- | --- |
| \_\_\_MD\_LINK\_USD\_0\_\_\_&lt;\_\_\_MD\_LINK\_USD\_1\_\_\_&gt; |  Returns the user config margin of the FrameNode. |
...
| Type | Description |
| --- | --- |
| \_\_\_MD\_LINK\_USD\_0\_\_\_&lt;\_\_\_MD\_LINK\_USD\_1\_\_\_&gt; |  Returns the user config padding of the FrameNode. |
...
| Type | Description |
| --- | --- |
| \_\_\_MD\_LINK\_USD\_0\_\_\_&lt;\_\_\_MD\_LINK\_USD\_1\_\_\_&gt; |  Returns the user config size of the FrameNode. |
...
When node attributes are modified after the current frame's build phase,the node updates will be deferred to the next frame. This function forces immediate node updates within the current frame to ensure rendering effects are applied synchronously.
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| position | \_\_\_MD\_LINK\_USD\_0\_\_\_ | Yes | The position of the node, will be used when executed the layout method. |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| constraint | \_\_\_MD\_LINK\_USD\_0\_\_\_ | Yes | The layout constraint of the node, supplied by the parent node. |
...
\_\_\_HTML\_TAG\_DESC\_USD\_0\_\_\_\_\_\_HTML\_TAG\_DESC\_USD\_1\_\_\_NOTE\_\_\_HTML\_TAG\_DESC\_USD\_2\_\_\_:\_\_\_HTML\_TAG\_DESC\_USD\_3\_\_\_Currently, only the following types of TypedFrameNode are supported for the movement operations: Stack, XComponent.\_\_\_HTML\_TAG\_DESC\_USD\_4\_\_\_
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| targetParent | \_\_\_MD\_LINK\_USD\_0\_\_\_ | Yes | The target parent node. The target parent node must not be a declaratively created node, that is, a FrameNode that is not modifiable. If it does not meet the specifications, an exception is thrown. |
| index | int | No | The index which the node is moved to. If the value is a negative number or invalid, the node is moved to the end of the target parent node. Moves to the end of the target parent node by default. If the target FrameNode has n nodes, the value range for index is [0, n). \_\_\_ESCAPED\_UNDERSCORE\_\_\_\_\_\_ESCAPED\_UNDERSCORE\_\_\_\_\_\_ESCAPED\_UNDERSCORE\_\_\_HTML\_\_\_ESCAPED\_UNDERSCORE\_\_\_TAG\_\_\_ESCAPED\_UNDERSCORE\_\_\_DESC\_\_\_ESCAPED\_UNDERSCORE\_\_\_USD\_\_\_ESCAPED\_UNDERSCORE\_\_\_0\_\_\_ESCAPED\_UNDERSCORE\_\_\_\_\_\_ESCAPED\_UNDERSCORE\_\_\_\_\_\_ESCAPED\_UNDERSCORE\_\_\_Default value: -1 |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| position | \_\_\_MD\_LINK\_USD\_0\_\_\_ | Yes | The position of the node, will be used when executed layout method. |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| constraint | \_\_\_MD\_LINK\_USD\_0\_\_\_ | Yes | The layout constraint of the node, will be used when executed measure method. |
...
Removes the registered state handlers. When all states registered via \_\_\_INLINE\_CODE\_DESC\_USD\_0\_\_\_ are removed, the corresponding \_\_\_INLINE\_CODE\_DESC\_USD\_1\_\_\_ will no longer be executed.
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| value | \_\_\_MD\_LINK\_USD\_0\_\_\_ | Yes | The cross-language options. |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| position | \_\_\_MD\_LINK\_USD\_0\_\_\_ | Yes | The position to the parent of the FrameNode after layout. |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| size | \_\_\_MD\_LINK\_USD\_0\_\_\_ | Yes | The size of the FrameNode after measure. |
