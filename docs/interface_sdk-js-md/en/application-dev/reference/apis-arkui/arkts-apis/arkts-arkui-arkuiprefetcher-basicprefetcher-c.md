...
**Inheritance/Implementation:** BasicPrefetcher implements [IPrefetcher](../../apis-default/arkts-apis/arkts-arkuiprefetcher-iprefetcher-i.md)
...
| --- | --- | --- | --- |
| dataSource | [IDataSourcePrefetching](../../apis-default/arkts-apis/arkts-arkuiprefetcher-idatasourceprefetching-i.md) | No | Prefetching-capable data source. If this parameter is not specified, the value is empty by default. You can set a data source using **setDataSource** later. |
