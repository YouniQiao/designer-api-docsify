...
Inherits from [SubscribedAbstractProperty<T>](arkts-arkui-common-ts-ets-api-subscribedabstractproperty-c-sys.md). Represents a property with two-way synchronization.
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| source | [SubscribedAbstractProperty](arkts-arkui-common-ts-ets-api-subscribedabstractproperty-c-sys.md)<T> | Yes | Data source for the two-way synchronized property. |
