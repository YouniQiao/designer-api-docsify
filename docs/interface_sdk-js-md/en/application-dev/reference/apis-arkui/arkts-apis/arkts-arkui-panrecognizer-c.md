...
| Type | Description |
| --- | --- |
| [Map](../../apis-na/arkts-apis/arkts-na-map-i.md)<SourceTool, number> | Minimum pan distances required for different input sources to trigger the pan gesture recognizer. Unit: vp. |
