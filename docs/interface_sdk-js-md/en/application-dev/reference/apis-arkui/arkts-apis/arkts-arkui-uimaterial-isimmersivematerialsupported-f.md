...
Check whether [ImmersiveMaterial]\_\_\_JSDOC\_LINK\_DESC\_USD\_0\_\_\_ is supported on the current device.If it is true, the ImmersiveMaterial object can be used in the  
[systemMaterial]\_\_\_JSDOC\_LINK\_DESC\_USD\_1\_\_\_ attribute.If it is false, setting the ImmersiveMaterial object in the systemMaterial attribute will not take effect.It is defined by the device and cannot be modified.
