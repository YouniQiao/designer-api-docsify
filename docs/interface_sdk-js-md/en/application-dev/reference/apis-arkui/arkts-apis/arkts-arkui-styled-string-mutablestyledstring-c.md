...
Inherits from the [StyledString](arkts-arkui-styled-string-styledstring-c.md) class.
...
**Inheritance/Implementation:** MutableStyledString extends [StyledString](arkts-arkui-styled-string-styledstring-c.md)
...
| --- | --- | --- | --- |
| other | [StyledString](arkts-arkui-styled-string-styledstring-c.md) | Yes | New styled string. |
...
After a style is removed, the value set for the corresponding style attribute in the [Text](../../apis-arkgraphics2d/arkts-apis/arkts-graphics-text.md) component is used. If the value is not set, the default value is used.
...
This API equally works when the styled string contains an image or [CustomSpan](arkts-arkui-styled-string-customspan-c.md).
...
| length | number | Yes | Length of the target range. |
| styledKey | [StyledStringKey](arkts-arkui-styled-string-styledstringkey-e.md) | Yes | Styled key. |
