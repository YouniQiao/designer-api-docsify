...
**Inheritance/Implementation:** ChipV2ImageIcon extends [ChipV2Icon](arkts-arkui-arkuiadvancedchipv2-chipv2icon-c.md)
...
| --- | --- | --- | --- |
| config | [ChipV2ImageIconConfig](arkts-arkui-arkuiadvancedchipv2-chipv2imageiconconfig-i.md) | Yes | config of icon common Mandatory parameter. |
