...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| other | [Matrix2D](arkts-arkui-canvaspattern-matrix2d-c.md) | No | Target matrix.<br>Invalid values **undefined** and **null** are treated as invalid inputs.<br>Default value: **null**. |
...
**Substitutes:** [rotate](arkts-arkui-matrix2d-matrix2d-c.md#rotate-1)
...
| Type | Description |
| --- | --- |
| [Matrix2D](arkts-arkui-canvaspattern-matrix2d-c.md) | - Matrix of the translation result. |
