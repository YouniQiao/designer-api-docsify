...
Defines the gesture event information. Inherits from [BaseEvent](../arkts-components/arkts-arkui-common-baseevent-i.md).

**Inheritance/Implementation:** GestureEvent extends [BaseEvent](../arkts-components/arkts-arkui-common-baseevent-i.md)
