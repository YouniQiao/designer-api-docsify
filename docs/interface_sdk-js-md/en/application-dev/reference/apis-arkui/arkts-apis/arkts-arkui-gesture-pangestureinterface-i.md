...
Creates a pan gesture. Inherits from [GestureInterface<T>](arkts-arkui-gesture-gestureinterface-i.md).
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| options | [PanGestureHandlerOptions](arkts-arkui-gesture-pangesturehandleroptions-i.md) | No | Parameters of the swipe gesture handler. |
