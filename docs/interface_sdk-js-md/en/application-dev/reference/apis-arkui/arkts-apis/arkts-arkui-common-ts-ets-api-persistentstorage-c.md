...
Performs the reverse operation of [PersistProp](arkts-arkui-common-ts-ets-api-persistentstorage-c.md#persistprop-1). Specifically, this API deletes the property corresponding to the specified key from [PersistentStorage](../../../../ui/state-management/arkts-persiststorage.md). Subsequent operations on [AppStorage](../../../../ui/state-management/arkts-appstorage.md) do not affect data in PersistentStorage.

**Since:** 7

**Deprecated since:** 10

**Substitutes:** [deleteProp](arkts-arkui-common-ts-ets-api-persistentstorage-c.md#deleteprop-1)
...
**Substitutes:** [keys](arkts-arkui-common-ts-ets-api-persistentstorage-c.md#keys-1)
...
| Type | Description |
| --- | --- |
| [Array](../../apis-na/arkts-apis/arkts-na-lib-es5-array-i.md)<string> | Returns an array of all persisted property names. |
...
**Substitutes:** [persistProp](arkts-arkui-common-ts-ets-api-persistentstorage-c.md#persistprop-1)
...
Persists multiple properties. This API is similar to [PersistProp](arkts-arkui-common-ts-ets-api-persistentstorage-c.md#persistprop-1), but allows multiple properties to be persisted at once, making it suitable for initializing during application startup.

**Since:** 7

**Deprecated since:** 10

**Substitutes:** [PersistProps](arkts-arkui-common-ts-ets-api-persistentstorage-c.md#persistprops-1)
...
Performs the reverse operation of [persistProp](arkts-arkui-common-ts-ets-api-persistentstorage-c.md#persistprop-1). Specifically, this API deletes the property corresponding to the specified **key** from [PersistentStorage](../../../../ui/state-management/arkts-persiststorage.md). Subsequent operations on [AppStorage](../../../../ui/state-management/arkts-appstorage.md) do not affect data in PersistentStorage. This operation removes the corresponding key from the persistence file. To persist the property again, you can call the [persistProp](arkts-arkui-common-ts-ets-api-persistentstorage-c.md#persistprop-1) API.
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| props | [PersistPropsOptions](arkts-arkui-common-ts-ets-api-persistpropsoptions-i.md)[] | Yes | Array of properties to persist. |
