...
| Name | Description |
| --- | --- |
| [DepthComponent](arkts-arkui-depthcomponent-depthcomponent-f-sys.md#depthcomponent) | 创建景深组件。 |
<!--DelEnd-->
...
| [DepthLightParams](arkts-arkui-depthcomponent-depthlightparams-i-sys.md) | 光照参数。 |
<!--DelEnd-->
...
| Name | Description |
| --- | --- |
| [DepthSpaceType](arkts-arkui-depthcomponent-depthspacetype-e-sys.md) | 景深空间类型枚举。 |
<!--DelEnd-->
