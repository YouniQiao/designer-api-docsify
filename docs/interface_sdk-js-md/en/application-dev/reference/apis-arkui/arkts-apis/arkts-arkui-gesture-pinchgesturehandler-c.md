...
| Type | Description |
| --- | --- |
| [PinchGestureHandler](arkts-arkui-gesture-pinchgesturehandler-c.md) | Pinch gesture handler object. |
...
Sets the callback for pinch gesture cancellation. This callback is triggered when a touch cancellation event occurs after successful recognition. Compared with [onActionCancel](arkts-arkui-gesture-pinchgesturehandler-c.md#onactioncancel-1), this API returns gesture event information.
