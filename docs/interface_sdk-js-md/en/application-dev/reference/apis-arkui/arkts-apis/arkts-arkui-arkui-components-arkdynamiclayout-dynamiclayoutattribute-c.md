...
> [sizing](../arkts-components/arkts-arkui-commonmethod-c.md#size) and [border styling](../arkts-components/arkts-arkui-commonmethod-c.md#border) attributes. The  
...
> [ignoreLayoutSafeArea](../arkts-components/arkts-arkui-commonmethod-c.md#ignorelayoutsafearea) attribute.
