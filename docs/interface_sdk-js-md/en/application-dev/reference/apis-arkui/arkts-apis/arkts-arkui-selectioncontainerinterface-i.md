...
| --- | --- | --- | --- |
| value | [SelectionContainerOptions](arkts-arkui-selectioncontaineroptions-i.md) | No | Initialization options of the component. |

**Return value:**

| Type | Description |
| --- | --- |
| [SelectionContainerAttribute](arkts-arkui-selectioncontainerattribute-c.md) | @syscap SystemCapability.ArkUI.ArkUI.Full@stagemodelonly@crossplatform@atomicservice |
