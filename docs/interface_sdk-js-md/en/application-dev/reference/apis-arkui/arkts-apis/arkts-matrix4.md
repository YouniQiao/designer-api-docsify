...
| Name | Description |
| --- | --- |
| [identity](arkts-arkui-matrix4-identity-f.md#identity) | Matrix initialization function, which can return an identity matrix object. |
| [init](arkts-arkui-matrix4-init-f.md#init) | Constructor of Matrix, which can create a fourth-order matrix based on the input parameters.The matrix is column-first. |
