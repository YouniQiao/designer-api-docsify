...
ID of the [display](arkts-arkui-displaystate-e.md) to capture. The default value is **0**. The value must be an integer greater than or equal to 0. If a non-integer is passed, a parameter error is reported.
