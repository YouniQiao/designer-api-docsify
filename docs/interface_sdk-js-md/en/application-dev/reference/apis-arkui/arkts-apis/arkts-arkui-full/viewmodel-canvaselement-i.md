...
\_\_\_HTML\_TAG\_DESC\_USD\_0\_\_\_ provides a rectangular canvas component for drawing graphics on the screen.You can control each pixel to draw on the canvas.\_\_\_HTML\_TAG\_DESC\_USD\_1\_\_\_ offers a variety of functions for drawing paths, rectangles, circles, text, and allows for adding images to it.

**Inheritance/Implementation:** CanvasElement extends [Element](viewmodel-element-i.md)
...
| options | \_\_\_MD\_LINK\_USD\_0\_\_\_ | No | use this context attributes to creating rendering context. |
