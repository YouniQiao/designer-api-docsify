...
| Type | Description |
| --- | --- |
| [Coordinate2D](arkts-arkui-units-coordinate2d-i.md) | - return the coordinates of the top-left corner of the current component based on its real-time position. |
