...
This module can be used together with [@ohos.window.floatingBall]\_\_\_JSDOC\_LINK\_DESC\_USD\_1\_\_\_.After the float view controller is bound to the floating ball controller using the  
[floatView.bind]\_\_\_JSDOC\_LINK\_DESC\_USD\_2\_\_\_ API, users can tap the floating ball to expand it as a float view, and click the minimize button in the upper left corner of the float view to collapse it back as a floating ball. This allows for seamless switching between the two window forms.
...
refined animation effect.  
 - The float view can be bound to the [floating ball]\_\_\_JSDOC\_LINK\_DESC\_USD\_3\_\_\_ for joint use,  
enabling more complex scenarios.

**Start version**: 26.0.0
    **NOTE**  
    
    - Use \_\_\_MD\_LINK\_DESC\_USD\_0\_\_\_ to check whether the device supports the  
