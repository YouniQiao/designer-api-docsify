...
Constructs a **ReactiveBuilderNode** class. When the content generated by **ReactiveBuilderNode** is embedded into another [RenderNode](../../apis-default/arkts-apis/arkts-rendernode-c.md) for display, you need to explicitly specify [selfIdealSize](../../apis-default/arkts-apis/arkts-buildernode-renderoptions-i.md) in [RenderOptions](../../apis-default/arkts-apis/arkts-buildernode-renderoptions-i.md). Otherwise, the default parent component layout constraint of the nodes in **ReactiveBuilderNode** is [0, 0]. If this API is called and **selfIdealSize** is not set, the size of the root node of the subtree in **ReactiveBuilderNode** is [0, 0].
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| uiContext | [UIContext](../../apis-default/arkts-apis/arkts-arkui-uicontext-uicontext-c.md) | Yes | UI context. For details about how to obtain it, see Obtaining UI Context. The value of **uiContext** must be valid, that is, the UI context is correct. If this parameter is invalid or not set, the creation will fail. |
| options | [RenderOptions](../../apis-default/arkts-apis/arkts-buildernode-renderoptions-i.md) | No | Optional parameter for constructing **ReactiveBuilderNode**. This parameter is used to construct the ideal size of the node and the rendering type of the node. <br>Default value: **undefined**. |
...
> event, for example, both **DOWN** and **UP** in TouchType of the touch event must be included
> to prevent undefined behavior.
> 
> [webview](../../apis-default/arkts-apis/arkts-web-webview.md) has already handled coordinate system transformation, so events can be
> dispatched.
> 
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| event | [InputEventType](../../apis-default/arkts-apis/arkts-inputeventtype-t.md) | Yes | Input event to be posted. |
...
> 
> In [Webview](../../apis-default/arkts-apis/arkts-web-webview.md), coordinate system transformations are already handled internally,
...
ReactiveBuilderNode completes the reuse event transfer between internal and external custom components through **reuse** and [recycle](../../apis-default/arkts-apis/arkts-buildernode-reactivebuildernode-c.md#recycle). For specific usage scenarios, see [Implementing Node Reuse with the BuilderNode reuse and recycle APIs](../../../ui/arkts-user-defined-arktsNode-builderNode.md#implementing-node-reuse-with-the-buildernode-reuse-and-recycle-apis).
