...
Constructs a **ReactiveBuilderNode** class. When the content generated by **ReactiveBuilderNode** is embedded into another [RenderNode](arkts-arkui-rendernode-c.md#RenderNode) for display, you need to explicitly specify [selfIdealSize](arkts-arkui-buildernode-renderoptions-i.md#RenderOptions) in [RenderOptions](arkts-arkui-buildernode-renderoptions-i.md#RenderOptions). Otherwise, the default parent component layout constraint of the nodes in **ReactiveBuilderNode** is [0, 0]. If this API is called and **selfIdealSize** is not set, the size of the root node of the subtree in **ReactiveBuilderNode** is [0, 0].
