...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| uiContext | [UIContext](arkts-arkui-arkuiuicontext-uicontext-c.md) | Yes | UI context. For details about how to obtain it, see Obtaining UI Context. The value of **uiContext** must be valid, that is, the UI context is correct. If this parameter is invalid or not set, the creation will fail. |
