...
Constructs a **ReactiveBuilderNode** class. When the content generated by **ReactiveBuilderNode** is embedded into another [RenderNode](../../apis-na/arkts-apis/arkts-na-rendernode-c.md) for display, you need to explicitly specify [selfIdealSize](../../apis-na/arkts-apis/arkts-na-buildernode-renderoptions-i.md) in [RenderOptions](../../apis-na/arkts-apis/arkts-na-buildernode-renderoptions-i.md). Otherwise, the default parent component layout constraint of the nodes in **ReactiveBuilderNode** is [0, 0]. If this API is called and **selfIdealSize** is not set, the size of the root node of the subtree in **ReactiveBuilderNode** is [0, 0].
...
| Type | Description |
| --- | --- |
| [FrameNode](../../apis-na/arkts-apis/arkts-na-framenode-c.md) \| null | FrameNode** object. If no such object is held by the **ReactiveBuilderNode** instance, **null** is returned. |
