...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| uiContext | [UIContext](../../apis-na/arkts-apis/arkts-na-arkui-uicontext-uicontext-c.md) | Yes | UI context. For details about how to obtain it, see Obtaining UI Context. The value of **uiContext** must be valid, that is, the UI context is correct. If this parameter is invalid or not set, the creation will fail. |
...
| Type | Description |
| --- | --- |
| [FrameNode](../../apis-na/arkts-apis/arkts-na-framenode-c.md) | FrameNode** object. If no such object is held by the **ReactiveBuilderNode** instance, **null** is returned. |
