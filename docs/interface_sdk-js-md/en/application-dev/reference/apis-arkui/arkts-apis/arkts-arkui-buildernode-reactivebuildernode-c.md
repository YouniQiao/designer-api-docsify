...
| options | [RenderOptions](arkts-arkui-buildernode-renderoptions-i.md) | No | Optional parameter for constructing **ReactiveBuilderNode**. This parameter is used to construct the ideal size of the node and the rendering type of the node. Default value: **undefined**. |
