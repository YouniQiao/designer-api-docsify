...
Component generator. When the return value of [.templateId()](arkts-arkui-repeat-repeatattribute-c.md#templateid-1) does not match any [.template()](arkts-arkui-repeat-repeatattribute-c.md#template-1) type (that is, the current item does not match any defined template style), the data item is processed using **.each()**.
...
>  
> - This API cannot be called within [attributeModifier](../arkts-components/arkts-arkui-common-commonmethod-c.md#attributemodifier-1).
...
| templateOptions | [TemplateOptions](arkts-arkui-repeat-templateoptions-i.md) | No | Current template configuration. |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| virtualScrollOptions | [VirtualScrollOptions](arkts-arkui-repeat-virtualscrolloptions-i.md) | No | Virtual scrolling configuration. |
