...
**Inheritance/Implementation:** ChipV2SuffixImageIcon extends [ChipV2ImageIcon](arkts-arkui-arkuiadvancedchipv2-chipv2imageicon-c.md)
...
| --- | --- | --- | --- |
| config | [ChipV2SuffixImageIconConfig](arkts-arkui-arkuiadvancedchipv2-chipv2suffiximageiconconfig-i.md) | Yes | config of suffix icon |
