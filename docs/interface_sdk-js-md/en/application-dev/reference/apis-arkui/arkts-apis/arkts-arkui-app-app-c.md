...
| Type | Description |
| --- | --- |
| [AppResponse](arkts-arkui-app-appresponse-i.md) | Application response information. |
...
| --- | --- | --- | --- |
| options | [RequestFullWindowOptions](arkts-arkui-app-requestfullwindowoptions-i.md) | No | Transition time from non-full window to full window, in milliseconds. |
