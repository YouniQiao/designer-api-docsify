...
| Type | Description |
| --- | --- |
| [LayoutManager](arkts-arkui-text-common-layoutmanager-i.md) | Layout manager object. |
...
| options | [SelectionOptions](../arkts-components/arkts-arkui-common-selectionoptions-i.md) | No | Configuration of options. The default value is inherited from [SelectionOptions](../arkts-components/arkts-arkui-common-selectionoptions-i.md). |
