...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| icon | [Resource](arkts-arkui-resource-t.md) \| undefined | Yes | Source of the icon. |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| color | Array&lt;[ResourceColor](arkts-arkui-resourcecolor-t.md)&gt; \| undefined | Yes | Color of the symbol icon. |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| strategy | [SymbolRenderingStrategy](../arkts-components/arkts-arkui-symbolrenderingstrategy-e.md) \| undefined | Yes | Rendering policy of the symbol icon. |
