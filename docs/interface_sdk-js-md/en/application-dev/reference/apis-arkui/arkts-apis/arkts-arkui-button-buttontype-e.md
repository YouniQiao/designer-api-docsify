...
> 
> - 按钮圆角通过
> [通用属性borderRadius](arkts-arkui-common-commonmethod-i.md#borderradius)设置。
> 
...
> 
> - 按钮文本通过[fontSize](fontSize)、[fontColor](fontColor)、[fontStyle](arkts-arkui-enums-fontstyle-e.md)、
> [fontFamily](fontFamily)、[fontWeight](arkts-arkui-enums-fontweight-e.md)进行设置。
> 
> - 设置[颜色渐变](../../apis-ability-kit/arkts-apis/arkts-app-ability-common.md/arkts-app-ability-common.md)需先设置[backgroundColor](arkts-arkui-common-commonmethod-i.md#backgroundcolor)为透明色。
> 
> - 在不设置borderRadius时，圆角矩形按钮的圆角大小保持默认值不变。圆角大小不会随按钮高度变化而变化，和controlSize属性有关，controlSize为NORMAL时圆角大小20vp，controlSize为
> SMALL时圆角大小14vp。
> 
> - 设置Button的[border](arkts-arkui-common-commonmethod-i.md#border)时，会有默认的
> [borderRadius](arkts-arkui-common-commonmethod-i.md#borderradius)值。如果同时使用
