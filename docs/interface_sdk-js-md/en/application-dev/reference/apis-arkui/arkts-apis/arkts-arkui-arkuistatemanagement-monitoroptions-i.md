...
Defines the optional parameters for [addMonitor](arkts-arkui-arkuistatemanagement-uiutils-c.md#addmonitor), which are used to configure the callback type and whether to enable the wildcard capability.
