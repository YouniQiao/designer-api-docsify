...
| --- | --- | --- | --- |
| event | [RawInputEventWrapper](arkts-arkui-common-rawinputeventwrapper-c.md) | Yes | Input event wrapper |

**Return value:**

| Type | Description |
| --- | --- |
| [InputEventInterceptResult](arkts-arkui-common-inputeventinterceptresult-i.md) | Event intercept result |
