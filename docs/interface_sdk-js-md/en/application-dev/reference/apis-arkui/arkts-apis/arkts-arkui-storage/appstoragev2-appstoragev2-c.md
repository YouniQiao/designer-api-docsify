...
| defaultCreator | \_\_\_MD\_LINK\_USD\_0\_\_\_&lt;T&gt; | No | the function generating the default value. If defaultCreator is not set and there is no data that matches type and key, then returns undefined. |
...
| --- | --- | --- | --- |
| ttype | \_\_\_MD\_LINK\_USD\_0\_\_\_ | Yes | class type of the stored value. |
| defaultCreator | \_\_\_MD\_LINK\_USD\_0\_\_\_&lt;T&gt; | No | the function generating the default value. If defaultCreator is not set and there is no data that matches type, then returns undefined. |
