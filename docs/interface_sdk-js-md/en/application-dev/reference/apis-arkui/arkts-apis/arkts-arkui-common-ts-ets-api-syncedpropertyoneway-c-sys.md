...
Inherits from [SubscribedAbstractProperty<T>](arkts-arkui-common-ts-ets-api-subscribedabstractproperty-c-sys.md). Represents a property with one-way synchronization.
...
| --- | --- | --- | --- |
| unsubscribeMe | [IPropertySubscriber](arkts-arkui-common-ts-ets-api-ipropertysubscriber-i-sys.md) | No | Subscriber to remove. |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| source | [SubscribedAbstractProperty](arkts-arkui-common-ts-ets-api-subscribedabstractproperty-c-sys.md)<T> | Yes | Data source for the one-way synchronized property. |
| subscribeMe | [IPropertySubscriber](arkts-arkui-common-ts-ets-api-ipropertysubscriber-i-sys.md) | No | Subscriber. |
