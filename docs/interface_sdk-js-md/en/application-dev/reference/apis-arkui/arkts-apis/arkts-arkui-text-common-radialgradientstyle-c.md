...
Displays a radial gradient. **RadialGradientStyle** inherits from [ShaderStyle](arkts-arkui-text-common-shaderstyle-c.md).

**Inheritance/Implementation:** RadialGradientStyle extends [ShaderStyle](arkts-arkui-text-common-shaderstyle-c.md)
...
| --- | --- | --- | --- |
| options | [RadialGradientOptions](../arkts-components/arkts-arkui-common-radialgradientoptions-i.md) | Yes | Options for displaying a radial gradient. |
