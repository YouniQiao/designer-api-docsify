...
When triggered by keyboard or gamepad input, the gesture event's [SourceTool](../arkts-components/arkts-arkui-sourcetool-e.md) is **Unknown**, and SourceType is **KEY** or **JOYSTICK**.
