...
When triggered by keyboard or gamepad input, the gesture event's [SourceTool](../arkts-components/arkts-arkui-sourcetool-e.md) is **Unknown**, and [SourceType](../../apis-input-kit/arkts-apis/arkts-input-sourcetype-e.md) is **KEY** or **JOYSTICK**.
