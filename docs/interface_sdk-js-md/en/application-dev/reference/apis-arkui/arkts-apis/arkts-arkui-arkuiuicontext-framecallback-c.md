...
> **NOTE：**
> 
> - The following APIs must be used in conjunction with [postFrameCallback](arkts-arkui-arkuiuicontext-uicontext-c.md#postframecallback) and
> [postDelayedFrameCallback](arkts-arkui-arkuiuicontext-uicontext-c.md#postdelayedframecallback) from [UIContext](arkts-arkui-arkuiuicontext-uicontext-c.md).
