...
The **CustomComponentContext** class provides access to component-level services, including the reuse pool. You can obtain an instance through [UIUtils.getCustomComponentContext](arkts-arkui-arkuistatemanagement-uiutils-c.md#getcustomcomponentcontext).
...
| Type | Description |
| --- | --- |
| [IReusePool](arkts-arkui-arkuistatemanagement-ireusepool-i.md) \| undefined | If a global reuse pool is configured for the current component, the reuse pool information is returned. Otherwise, **undefined** is returned. |
