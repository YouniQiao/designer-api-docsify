...
This configuration is only available for the [Text](../../apis-arkgraphics2d/arkts-apis/arkts-graphics-text.md) and [RichEditor](../arkts-components/arkts-arkui-richeditor.md) components.
