...
| [getVisibleWindowInfo](arkts-arkui-window-getvisiblewindowinfo-f-sys.md) | Obtains information about visible main windows on the current screen. Visible main windows are main windows that are not returned to the background. This API uses a promise to return the result. |
...
| [on_systemBarTintChange](arkts-arkui-window-onsystembartintchange-f-sys.md) | Subscribes to the property change event of the status bar and navigation bar. |
| [onSystemBarTintChange](arkts-arkui-window-onsystembartintchange-f-sys.md) | Subscribes to the property change event of the status bar and navigation bar. |
| [off_systemBarTintChange](arkts-arkui-window-offsystembartintchange-f-sys.md) | Unsubscribes from the property change event of the status bar and navigation bar. |
| [offSystemBarTintChange](arkts-arkui-window-offsystembartintchange-f-sys.md) | Unsubscribes from the property change event of the status bar and navigation bar. |
| [on_gestureNavigationEnabledChange](arkts-arkui-window-ongesturenavigationenabledchange-f-sys.md) | Subscribes to the gesture navigation status change event. |
| [onGestureNavigationEnabledChange](arkts-arkui-window-ongesturenavigationenabledchange-f-sys.md) | Subscribes to the gesture navigation status change event. |
| [off_gestureNavigationEnabledChange](arkts-arkui-window-offgesturenavigationenabledchange-f-sys.md) | Unsubscribes from the gesture navigation status change event. |
| [offGestureNavigationEnabledChange](arkts-arkui-window-offgesturenavigationenabledchange-f-sys.md) | Unsubscribes from the gesture navigation status change event. |
| [on_waterMarkFlagChange](arkts-arkui-window-onwatermarkflagchange-f-sys.md) | Subscribes to the watermark status change event. |
| [onWaterMarkFlagChange](arkts-arkui-window-onwatermarkflagchange-f-sys.md) | Subscribes to the watermark status change event. |
| [off_waterMarkFlagChange](arkts-arkui-window-offwatermarkflagchange-f-sys.md) | Unsubscribes from the watermark status change event. |
| [offWaterMarkFlagChange](arkts-arkui-window-offwatermarkflagchange-f-sys.md) | Unsubscribes from the watermark status change event. |
