...
| [WindowStage](arkts-arkui-window-windowstage-i-sys.md) | Implements a window manager, which manages each basic window unit, that is, [Window](@ohos.window) instance.  Before calling any of the following APIs, you must use  [onWindowStageCreate()](../../apis-ability-kit/arkts-apis/arkts-ability-app-ability-uiability-uiability-c.md#onWindowStageCreate) to create a WindowStage instance. |
...
| [PixelUnit](arkts-arkui-window-pixelunit-e.md) | Enumerates the pixel units.  You can use [px2vp](px2vp) and  [vp2px](vp2px) to convert between physical pixels and virtual pixels. |
