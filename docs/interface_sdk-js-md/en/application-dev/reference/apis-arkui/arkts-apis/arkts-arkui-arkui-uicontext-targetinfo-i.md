...
Target node for binding popups or menus.<br>**NOTE**<br>1. When **id** is a number, it corresponds to the component's **UniqueID**,whose uniqueness is guaranteed by the system.<br>2. When **id** is a string,it corresponds to the component specified by the universal attribute [id](../arkts-components/arkts-arkui-commonmethod-c.md#id). You must ensure the uniqueness of this ID,although there may be multiple instances.
