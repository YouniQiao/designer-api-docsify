...
| damping | number | Yes | Damping. It is used to describe the oscillation and attenuation of the system after being disturbed. The larger the damping, the smaller the number of oscillations of elastic motion, and the smaller the oscillation amplitude.Value range: (0, +∞) & lt;p & gt;**NOTE：**: If this parameter is set to a value less than or equal to 0, the value **1** is used. & lt;/p & gt; |
