...
[onLazyLoading]\_\_\_JSDOC\_LINK\_DESC\_USD\_1\_\_\_ to implement lazy loading.  
...
| Type | Description |
| --- | --- |
| number | Expected total number of data items to be loaded. \_\_\_ESCAPED\_UNDERSCORE\_\_\_\_\_\_ESCAPED\_UNDERSCORE\_\_\_\_\_\_ESCAPED\_UNDERSCORE\_\_\_HTML\_\_\_ESCAPED\_UNDERSCORE\_\_\_TAG\_\_\_ESCAPED\_UNDERSCORE\_\_\_DESC\_\_\_ESCAPED\_UNDERSCORE\_\_\_USD\_\_\_ESCAPED\_UNDERSCORE\_\_\_0\_\_\_ESCAPED\_UNDERSCORE\_\_\_\_\_\_ESCAPED\_UNDERSCORE\_\_\_\_\_\_ESCAPED\_UNDERSCORE\_\_\_Value range: natural numbers |
...
**totalCount**. During the scrolling of the container component, the application must ensure that subsequent data is requested before the list is about to reach the end of the data source. You need to handle error scenarios (such as network delays) for data requests until all data sources are loaded; otherwise, scrolling exceptions may occur during list scrolling. You are advised to use [onLazyLoading]\_\_\_JSDOC\_LINK\_DESC\_USD\_0\_\_\_ to implement lazy loading.

In addition to the **totalCount** attribute, you can also use the  
[onTotalCount]\_\_\_JSDOC\_LINK\_DESC\_USD\_1\_\_\_ method to set a custom method to calculate the expected total number of data items to be loaded.
