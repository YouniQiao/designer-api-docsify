...
> **NOTE：**
> 
> The **types** parameter of this API has a higher priority than that of &gt; [ImageAnalyzerConfig](arkts-arkui-imageanalyzerconfig-i.md). This means that, if both parameters are set, the value set by &gt; this API takes precedence.
> 
