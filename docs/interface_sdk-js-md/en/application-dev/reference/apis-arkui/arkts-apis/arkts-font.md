...
| Name | Description |
| --- | --- |
| [getFontByName](arkts-arkui-getfontbyname-f.md#getfontbyname-1) | Obtains information about a system font based on the font name. |
| [getSystemFontList](arkts-arkui-getsystemfontlist-f.md#getsystemfontlist-1) | Obtains this system font list.This API only takes effect on PCs/2-in-1 devices and returns an empty array on other devices.You are advised to use the [getSystemFontFullNamesByType](../../apis-arkgraphics2d/arkts-apis/arkts-arkgraphics2d-getsystemfontfullnamesbytype-f.md#getsystemfontfullnamesbytype-1) API to obtain the latest system-supported font list data. |
...
| [registerFont](arkts-arkui-registerfont-f.md#registerfont-1) | Registers a custom font with the font manager.This API is asynchronous and does not support concurrent calls. |
...
| [FontOptions](arkts-arkui-fontoptions-i.md) | Information about the custom font to register. |
