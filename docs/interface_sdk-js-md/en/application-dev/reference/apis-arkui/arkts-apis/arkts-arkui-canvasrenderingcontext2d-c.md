...
| --- | --- | --- | --- |
| settings | [RenderingContextSettings](arkts-arkui-canvas-renderingcontextsettings-c.md) | No | 用来配置CanvasRenderingContext2D对象的参数， 见[RenderingContextSettings](#renderingcontextsettings)。 &lt;br&gt;异常值undefined和null按[RenderingContextSettings](#renderingcontextsettings)的默认值处理。 |
...
| --- | --- | --- | --- |
| settings | [RenderingContextSettings](arkts-arkui-canvas-renderingcontextsettings-c.md) | No | 用来配置CanvasRenderingContext2D对象的参数， 见[RenderingContextSettings](#renderingcontextsettings)。 &lt;br&gt;异常值undefined和null按[RenderingContextSettings](#renderingcontextsettings)的默认值处理。 |
| unit | [LengthMetricsUnit](arkts-arkui-lengthmetricsunit-t.md) | No | 用来配置CanvasRenderingContext2D对象的单位模式， 配置后无法更改。 &lt;br&gt;异常值undefined、NaN和Infinity按默认值处理。 &lt;br&gt;默认值：DEFAULT。 |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| drawingContext | [DrawingRenderingContext](arkts-arkui-drawingrenderingcontext-c.md) | Yes | 一个DrawingRenderingContext类型的对象。 &lt;br&gt;异常值undefined或null按无效值处理。 |
| options | [RenderingContextOptions](arkts-arkui-renderingcontextoptions-i.md) | No | 渲染上下文的配置选项。 &lt;br&gt;异常值undefined或null按默认值处理。 &lt;br&gt;默认值：{ antialias: false } |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| type | 'onAttach' | Yes | 取消订阅CanvasRenderingContext2D与Canvas组件发生绑定的回调。 &lt;br&gt;异常值undefined或null按无效值处理。 |
| callback | [Callback](../arkts-components/arkts-arkui-callback-i.md)&lt;void&gt; | No | 为空表示取消所有订阅CanvasRenderingContext2D与Canvas组件 发生绑定后触发的回调。 非空则取消订阅发生绑定对应的回调。 &lt;br&gt;异常值undefined或null按无效值处理。 |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| type | 'onDetach' | Yes | 取消订阅CanvasRenderingContext2D与Canvas组件解除绑定的回调。 &lt;br&gt;异常值undefined或null按无效值处理。 |
| callback | [Callback](../arkts-components/arkts-arkui-callback-i.md)&lt;void&gt; | No | 为空代表取消所有订阅CanvasRenderingContext2D与Canvas组件 解除绑定后触发的回调。 非空代表取消订阅解除绑定对应的回调。 &lt;br&gt;异常值undefined或null按无效值处理。 |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| type | 'onAttach' | Yes | 订阅CanvasRenderingContext2D与Canvas组件发生绑定的回调。 &lt;br&gt;异常值undefined或null按无效值处理。 |
| callback | [Callback](../arkts-components/arkts-arkui-callback-i.md)&lt;void&gt; | Yes | 订阅CanvasRenderingContext2D与Canvas组件 发生绑定后触发的回调。 &lt;br&gt;异常值undefined或null按无效值处理。 |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| type | 'onDetach' | Yes | 订阅CanvasRenderingContext2D与Canvas组件解除绑定的回调。 &lt;br&gt;异常值undefined或null按无效值处理。 |
| callback | [Callback](../arkts-components/arkts-arkui-callback-i.md)&lt;void&gt; | Yes | 订阅CanvasRenderingContext2D与Canvas组件 解除绑定后触发的回调。 &lt;br&gt;异常值undefined或null按无效值处理。 |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| config | [ImageAnalyzerConfig](arkts-arkui-imageanalyzerconfig-i.md) | Yes | 执行AI分析所需要的入参，用于配置AI分析的类型（如主体识别、文字识别等）。详见 [ImageAnalyzerConfig](arkts-arkui-imagecommon-imageanalyzerconfig-i.md)。 &lt;br&gt;异常值undefined或null按无效值处理。 |
