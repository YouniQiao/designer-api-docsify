...
| --- | --- | --- | --- |
| x | number | Yes | 指定矩形上的左上角x坐标。&lt;br&gt;异常值undefined、null、NaN或Infinity按无效值处理，不进行绘制。&lt;br&gt;默认单位：vp |
| y | number | Yes | 指定矩形上的左上角y坐标。&lt;br&gt;异常值undefined、null、NaN或Infinity按无效值处理，不进行绘制。&lt;br&gt;默认单位：vp |
| w | number | Yes | 指定矩形的宽度。&lt;br&gt;异常值undefined、null、NaN或Infinity按无效值处理，不进行绘制。&lt;br&gt;默认单位：vp |
| h | number | Yes | 指定矩形的高度。&lt;br&gt;异常值undefined、null、NaN或Infinity按无效值处理，不进行绘制。&lt;br&gt;默认单位：vp |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| fillRule | [CanvasFillRule](arkts-arkui-canvasfillrule-t.md) | No | 指定要剪切对象的规则。&lt;br&gt;可选参数为："nonzero"，"evenodd"。&lt;br&gt;异常值undefined或null按默认值处理。&lt;br&gt;默认值："nonzero" |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| path | [Path2D](arkts-arkui-viewmodel-path2d-i.md) | Yes | Path2D剪切路径。&lt;br&gt;异常值undefined或null按无效值处理。 |
| fillRule | [CanvasFillRule](arkts-arkui-canvasfillrule-t.md) | No | 指定要剪切对象的规则。&lt;br&gt;可选参数为："nonzero"，"evenodd"。&lt;br&gt;异常值undefined或null按默认值处理。&lt;br&gt;默认值："nonzero" |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| startAngle | number | Yes | 渐变起始角度。角度测量从中心右侧水平方向开始，顺时针移动。&lt;br&gt;异常值undefined或null按0处理。NaN和Infinity按无效值处理。&lt;br&gt;单位：弧度 |
| x | number | Yes | 锥形渐变圆心的x轴坐标。&lt;br&gt;异常值undefined或null按0处理。NaN和Infinity按无效值处理。&lt;br&gt;默认单位：vp |
| y | number | Yes | 锥形渐变圆心的y轴坐标。&lt;br&gt;异常值undefined或null按0处理。NaN和Infinity按无效值处理。&lt;br&gt;默认单位：vp |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| sw | number | Yes | ImageData对象的宽度。&lt;br&gt;异常值undefined、null、NaN和Infinity按0处理。&lt;br&gt;默认单位：vp |
| sh | number | Yes | ImageData对象的高度。&lt;br&gt;异常值undefined、null、NaN和Infinity按0处理。&lt;br&gt;默认单位：vp |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| imageData | [ImageData](arkts-arkui-imagedata-c.md) | Yes | 已有的ImageData对象。&lt;br&gt;异常值undefined和null按宽高为0的ImageData处理。 |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| x0 | number | Yes | 起点的x轴坐标。&lt;br&gt;异常值undefined或null时接口返回undefined。NaN和Infinity按无效值处理。&lt;br&gt;默认单位：vp |
| y0 | number | Yes | 起点的y轴坐标。&lt;br&gt;异常值undefined或null时接口返回undefined。NaN和Infinity按无效值处理。&lt;br&gt;默认单位：vp |
| x1 | number | Yes | 终点的x轴坐标。&lt;br&gt;异常值undefined或null时接口返回undefined。NaN和Infinity按无效值处理。&lt;br&gt;默认单位：vp |
| y1 | number | Yes | 终点的y轴坐标。&lt;br&gt;异常值undefined或null时接口返回undefined。NaN和Infinity按无效值处理。&lt;br&gt;默认单位：vp |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| image | [ImageBitmap](arkts-arkui-canvas-imagebitmap-c.md) | Yes | 图源对象，具体参考ImageBitmap对象。&lt;br&gt;异常值undefined或null按无效值处理。 |
| repetition | string \| null | Yes | 设置图像重复的方式：&lt;br&gt;'repeat'：沿x轴和y轴重复绘制图像；&lt;br&gt;'repeat-x'：沿x轴重复绘制图像；&lt;br&gt;'repeat-y'：沿y轴重复绘制图像；&lt;br&gt;'no-repeat'：不重复绘制图像；&lt;br&gt;'clamp'：在原始边界外绘制时，超出部分使用边缘的颜色绘制；&lt;br&gt;'mirror'：沿x轴和y轴重复翻转绘制图像。&lt;br&gt;异常值undefined或null按无效值处理。 |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| x0 | number | Yes | 起始圆的圆心x轴坐标。&lt;br&gt;异常值undefined或null时接口返回undefined。NaN和Infinity按无效值处理。&lt;br&gt;默认单位：vp |
| y0 | number | Yes | 起始圆的圆心y轴坐标。&lt;br&gt;异常值undefined或null时接口返回undefined。NaN和Infinity按无效值处理。&lt;br&gt;默认单位：vp |
| r0 | number | Yes | 起始圆的半径，必须是非负有限数。&lt;br&gt;异常值undefined或null时接口返回undefined。NaN和Infinity按无效值处理。&lt;br&gt;默认单位：vp |
| x1 | number | Yes | 终止圆的圆心x轴坐标。&lt;br&gt;异常值undefined或null时接口返回undefined。NaN和Infinity按无效值处理。&lt;br&gt;默认单位：vp |
| y1 | number | Yes | 终止圆的圆心y轴坐标。&lt;br&gt;异常值undefined或null时接口返回undefined。NaN和Infinity按无效值处理。&lt;br&gt;默认单位：vp |
| r1 | number | Yes | 终止圆的半径，必须是非负有限数。&lt;br&gt;异常值undefined或null时接口返回undefined。NaN和Infinity按无效值处理。&lt;br&gt;默认单位：vp |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| image | [ImageBitmap](arkts-arkui-canvas-imagebitmap-c.md) \| PixelMap | Yes | 图片资源，请参考ImageBitmap或PixelMap。&lt;br&gt; 异常值undefined或null按无效值处理，不进行绘制。 |
| dx | number | Yes | 绘制区域左上角在x轴的位置。&lt;br&gt;异常值undefined或null按0处理，NaN和Infinity按无效值处理， 不进行绘制。&lt;br&gt;默认单位：vp |
| dy | number | Yes | 绘制区域左上角在y轴的位置。&lt;br&gt;异常值undefined或null按0处理，NaN和Infinity按无效值处理， 不进行绘制。&lt;br&gt;默认单位：vp |
...
| dx | number | Yes | 绘制区域左上角在x轴的位置。&lt;br&gt;异常值undefined或null按0处理，NaN和Infinity按无效值处理， 不进行绘制。&lt;br&gt;默认单位：vp |
| dy | number | Yes | 绘制区域左上角在y轴的位置。&lt;br&gt;异常值undefined或null按0处理，NaN和Infinity按无效值处理， 不进行绘制。&lt;br&gt;默认单位：vp |
| dw | number | Yes | 绘制区域的宽度。当绘制区域的宽度和裁剪图像的宽度不一致时，将图像宽度拉伸或压缩为绘制区域 的宽度。&lt;br&gt;负数、异常值undefined或null按0处理，NaN和Infinity按无效值处理，不进行绘制。&lt;br&gt;默认单位：vp |
| dh | number | Yes | 绘制区域的高度。当绘制区域的高度和裁剪图像的高度不一致时，将图像高度拉伸或压缩为绘制区域 的高度。&lt;br&gt;负数、异常值undefined或null按0处理，NaN和Infinity按无效值处理，不进行绘制。&lt;br&gt;默认单位：vp |
...
| --- | --- | --- | --- |
| image | [ImageBitmap](arkts-arkui-canvas-imagebitmap-c.md) \| PixelMap | Yes | 图片资源，请参考ImageBitmap或PixelMap。&lt;br&gt;异常值undefined或null按无效值处理，不进行绘制。 |
| sx | number | Yes | 裁剪源图像时矩形左上角的x轴坐标。&lt;br&gt;异常值undefined或null按0处理，NaN和Infinity按无效值处理，不进行绘制。&lt;br&gt;默认单位：vp |
| sy | number | Yes | 裁剪源图像时矩形左上角的y轴坐标。&lt;br&gt;异常值undefined或null按0处理，NaN和Infinity按无效值处理，不进行绘制。&lt;br&gt;默认单位：vp |
| sw | number | Yes | 裁剪源图像的目标宽度。&lt;br&gt;负数、异常值undefined或null按0处理，NaN和Infinity按无效值处理，不进行绘制。&lt;br&gt;默认单位：vp |
| sh | number | Yes | 裁剪源图像的目标高度。&lt;br&gt;负数、异常值undefined或null按0处理，NaN和Infinity按无效值处理，不进行绘制。&lt;br&gt;默认单位：vp |
| dx | number | Yes | 绘制区域左上角在x轴的位置。&lt;br&gt;异常值undefined或null按0处理，NaN和Infinity按无效值处理，不进行绘制。&lt;br&gt;默认单位：vp |
| dy | number | Yes | 绘制区域左上角在y轴的位置。&lt;br&gt;异常值undefined或null按0处理，NaN和Infinity按无效值处理，不进行绘制。&lt;br&gt;默认单位：vp |
| dw | number | Yes | 绘制区域的宽度。当绘制区域的宽度和裁剪图像的宽度不一致时，将图像宽度拉伸或压缩为绘制区域的宽度。&lt;br&gt;负数、异常值undefined或null按0处理，NaN和Infinity按无效值处理，不进行绘制。&lt;br&gt;默认单位：vp |
| dh | number | Yes | 绘制区域的高度。当绘制区域的高度和裁剪图像的高度不一致时，将图像高度拉伸或压缩为绘制区域的高度。&lt;br&gt;负数、异常值undefined或null按0处理，NaN和Infinity按无效值处理，不进行绘制。&lt;br&gt;默认单位：vp |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| fillRule | [CanvasFillRule](arkts-arkui-canvasfillrule-t.md) | No | 指定要填充对象的规则。&lt;br&gt;可选参数为："nonzero"，"evenodd"。&lt;br&gt;异常值undefined或null按默认值处理。&lt;br&gt;默认值："nonzero" |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| path | [Path2D](arkts-arkui-viewmodel-path2d-i.md) | Yes | Path2D填充路径。&lt;br&gt;异常值undefined或null按无效值处理。 |
| fillRule | [CanvasFillRule](arkts-arkui-canvasfillrule-t.md) | No | 指定要填充对象的规则。&lt;br&gt;可选参数为："nonzero"，"evenodd"。&lt;br&gt;异常值undefined或null按默认值处理。&lt;br&gt;默认值："nonzero" |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| x | number | Yes | 指定矩形左上角点的x坐标。&lt;br&gt;异常值undefined、null、NaN或Infinity按无效值处理，不进行绘制。&lt;br&gt;默认单位：vp |
| y | number | Yes | 指定矩形左上角点的y坐标。&lt;br&gt;异常值undefined、null、NaN或Infinity按无效值处理，不进行绘制。&lt;br&gt;默认单位：vp |
| w | number | Yes | 指定矩形的宽度。&lt;br&gt;异常值undefined、null、NaN或Infinity按无效值处理，不进行绘制。&lt;br&gt;默认单位：vp |
| h | number | Yes | 指定矩形的高度。&lt;br&gt;异常值undefined、null、NaN或Infinity按无效值处理，不进行绘制。&lt;br&gt;默认单位：vp |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| text | string | Yes | 需要绘制的文本内容。&lt;br&gt;异常值undefined或null按无效值处理，不进行绘制。 |
| x | number | Yes | 文本绘制起点的x轴坐标。&lt;br&gt;异常值undefined、null、NaN或Infinity按无效值处理，不进行绘制。&lt;br&gt;默认单位：vp |
| y | number | Yes | 文本绘制起点的y轴坐标。&lt;br&gt;异常值undefined、null、NaN或Infinity按无效值处理，不进行绘制。&lt;br&gt;默认单位：vp |
| maxWidth | number | No | 指定文本允许的最大宽度。&lt;br&gt;异常值null按无效值处理，不进行绘制，undefined、NaN或Infinity按默认值处理。&lt;br&gt;默认值：不限制宽度。&lt;br&gt;默认单位：vp |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| sx | number | Yes | 输出区域左上角的x轴坐标。&lt;br&gt;异常值undefined、null、NaN和Infinity按0处理。&lt;br&gt;默认单位：vp |
| sy | number | Yes | 输出区域左上角的y轴坐标。&lt;br&gt;异常值undefined、null、NaN和Infinity按0处理。&lt;br&gt;默认单位：vp |
| sw | number | Yes | 输出区域的宽度。&lt;br&gt;异常值undefined、null、NaN和Infinity按0处理。&lt;br&gt;默认单位：vp |
| sh | number | Yes | 输出区域的高度。&lt;br&gt;异常值undefined、null、NaN和Infinity按0处理。&lt;br&gt;默认单位：vp |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| text | string | Yes | 需要进行测量的文本。&lt;br&gt;传入异常值undefined或null时按"undefined"或"null"计算。 |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| imageData | [ImageData](arkts-arkui-imagedata-c.md) | Yes | 含有像素数据的ImageData对象，用于放到画布上。&lt;br&gt;异常值undefined和null按无效值处理，不进行绘制。 |
| dx | number \| string | Yes | 画布上矩形区域的x轴偏移量。&lt;br&gt;异常值undefined、null、NaN和Infinity按0处理。&lt;br&gt;默认单位：vp |
| dy | number \| string | Yes | 画布上矩形区域的y轴偏移量。&lt;br&gt;异常值undefined、null、NaN和Infinity按0处理。&lt;br&gt;默认单位：vp |
...
| dx | number \| string | Yes | 画布上矩形区域的x轴偏移量。&lt;br&gt;异常值undefined、null、NaN和Infinity按0处理。&lt;br&gt;默认单位：vp |
| dy | number \| string | Yes | 画布上矩形区域的y轴偏移量。&lt;br&gt;异常值undefined、null、NaN和Infinity按0处理。&lt;br&gt;默认单位：vp |
| dirtyX | number \| string | Yes | 源图像矩形区域左上角相对于源图像左上角的x轴偏移量。&lt;br&gt;异常值undefined、null、NaN和Infinity按0处理。&lt;br&gt;默认单位：vp |
| dirtyY | number \| string | Yes | 源图像矩形区域左上角相对于源图像左上角的y轴偏移量。&lt;br&gt;异常值undefined、null、NaN和Infinity按0处理。&lt;br&gt;默认单位：vp |
| dirtyWidth | number \| string | Yes | 源图像裁剪矩形的宽度。&lt;br&gt;异常值undefined、null、NaN和Infinity按0处理。&lt;br&gt;默认单位：vp |
| dirtyHeight | number \| string | Yes | 源图像裁剪矩形的高度。&lt;br&gt;异常值undefined、null、NaN和Infinity按0处理。&lt;br&gt;默认单位：vp |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| angle | number | Yes | 设置顺时针旋转的弧度值，可以通过 degree Math.PI / 180 将角度转换为弧度值。&lt;br&gt; API version 18之前，设置NaN或Infinity时，在该方法后执行的绘制方法无法绘制；设置null或undefined时， 当前接口不生效。API version 18及以后，设置NaN、Infinity、null或undefined时当前接口不生效， 其他传入有效参数的绘制方法正常绘制。&lt;br&gt;单位：弧度 |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| x | number | Yes | 设置水平方向的缩放值。&lt;br&gt;API version 18之前，设置NaN或Infinity时， 在该方法后执行的绘制方法无法绘制；不支持设置0和负数，设置0、负数、null或undefined时， 当前接口不生效。API version 18及以后，设置NaN、Infinity、0、负数、null或undefined时当前接口不生效， 其他传入有效参数的绘制方法正常绘制。 |
| y | number | Yes | 设置垂直方向的缩放值，不支持设置负数。&lt;br&gt;API version 18之前， 设置NaN或Infinity时，在该方法后执行的绘制方法无法绘制；不支持设置0和负数， 设置0、负数、null或undefined时，当前接口不生效。API version 18及以后， 设置NaN、Infinity、0、负数、null或undefined时当前接口不生效， 其他传入有效参数的绘制方法正常绘制。 |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| segments | number[] | Yes | 一个数字数组，指定交替绘制线和间距的距离。&lt;br&gt;异常值undefined和null按无效值处理。&lt;br&gt;默认单位：vp |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| value | [PixelMap](../arkts-components/arkts-arkui-pixelmap-t.md) | No | 含有像素值的PixelMap对象。&lt;br&gt;异常值undefined和null按无效值处理，不进行绘制。&lt;br&gt;默认值：null |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| a | number | Yes | scaleX：指定水平缩放值，支持设置负数。&lt;br&gt;API version 18之前，设置NaN或Infinity时，在该方法后执行的绘制方法无法绘制；设置null或undefined时，当前接口不生效。API version 18及以后，设置NaN、Infinity、null或undefined时当前接口不生效，其他传入有效参数的绘制方法正常绘制。 |
| b | number | Yes | skewY：指定垂直倾斜值，支持设置负数。&lt;br&gt;API version 18之前，设置NaN或Infinity时，在该方法后执行的绘制方法无法绘制；设置null或undefined时，当前接口不生效。API version 18及以后，设置NaN、Infinity、null或undefined时当前接口不生效，其他传入有效参数的绘制方法正常绘制。 |
| c | number | Yes | skewX：指定水平倾斜值，支持设置负数。&lt;br&gt;API version 18之前，设置NaN或Infinity时，在该方法后执行的绘制方法无法绘制；设置null或undefined时，当前接口不生效。API version 18及以后，设置NaN、Infinity、null或undefined时当前接口不生效，其他传入有效参数的绘制方法正常绘制。 |
| d | number | Yes | scaleY：指定垂直缩放值，支持设置负数。&lt;br&gt;API version 18之前，设置NaN或Infinity时，在该方法后执行的绘制方法无法绘制；设置null或undefined时，当前接口不生效。API version 18及以后，设置NaN、Infinity、null或undefined时当前接口不生效，其他传入有效参数的绘制方法正常绘制。 |
| e | number | Yes | translateX：指定水平移动值，支持设置负数。&lt;br&gt;API version 18之前，设置NaN或Infinity时，在该方法后执行的绘制方法无法绘制；设置null或undefined时，当前接口不生效。API version 18及以后，设置NaN、Infinity、null或undefined时当前接口不生效，其他传入有效参数的绘制方法正常绘制。&lt;br&gt;默认单位：vp |
| f | number | Yes | translateY：指定垂直移动值，支持设置负数。&lt;br&gt;API version 18之前，设置NaN或Infinity时，在该方法后执行的绘制方法无法绘制；设置null或undefined时，当前接口不生效。API version 18及以后，设置NaN、Infinity、null或undefined时当前接口不生效，其他传入有效参数的绘制方法正常绘制。&lt;br&gt;默认单位：vp |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| transform | [Matrix2D](arkts-arkui-matrix2d-c.md) | No | 变换矩阵。&lt;br&gt;异常值undefined或null按无效值处理。&lt;br&gt;默认值：null |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| path | [Path2D](arkts-arkui-viewmodel-path2d-i.md) | Yes | 需要绘制的Path2D。&lt;br&gt;异常值undefined或null按无效值处理，不进行绘制。 |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| x | number | Yes | 指定矩形的左上角x坐标。&lt;br&gt;异常值undefined、null、NaN或Infinity按无效值处理，不进行绘制。&lt;br&gt;默认单位：vp |
| y | number | Yes | 指定矩形的左上角y坐标。&lt;br&gt;异常值undefined、null、NaN或Infinity按无效值处理，不进行绘制。&lt;br&gt;默认单位：vp |
| w | number | Yes | 指定矩形的宽度。&lt;br&gt;异常值undefined、null、NaN或Infinity按无效值处理，不进行绘制。&lt;br&gt;默认单位：vp |
| h | number | Yes | 指定矩形的高度。&lt;br&gt;异常值undefined、null、NaN或Infinity按无效值处理，不进行绘制。&lt;br&gt;默认单位：vp |
...
| x | number | Yes | 文本绘制起点的x轴坐标。&lt;br&gt;异常值undefined、null、NaN或Infinity按无效值处理，不进行绘制。&lt;br&gt;默认单位：vp |
| y | number | Yes | 文本绘制起点的y轴坐标。&lt;br&gt;异常值undefined、null、NaN或Infinity按无效值处理，不进行绘制。&lt;br&gt;默认单位：vp |
| maxWidth | number | No | 需要绘制的文本的最大宽度。&lt;br&gt;异常值null按无效值处理，不进行绘制，undefined、NaN或Infinity按默认值处理。&lt;br&gt;默认单位：vp&lt;br&gt;默认值：不限制宽度。 |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| bitmap | [ImageBitmap](arkts-arkui-canvas-imagebitmap-c.md) | Yes | 需要显示的ImageBitmap对象。 |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| a | number | Yes | 变换矩阵中第一行第一列的单元格。scaleX：指定水平缩放值，支持设置负数。&lt;br&gt;API version 18之前，设置NaN或Infinity时，在该方法后执行的绘制方法无法绘制；设置null或undefined时，当前接口不生效。API version 18及以后，设置NaN、Infinity、null或undefined时当前接口不生效，其他传入有效参数的绘制方法正常绘制。 |
| b | number | Yes | 变换矩阵第二行第一列的单元格。skewY：指定垂直倾斜值，支持设置负数。&lt;br&gt;API version 18之前，设置NaN或Infinity时，在该方法后执行的绘制方法无法绘制；设置null或undefined时，当前接口不生效。API version 18及以后，设置NaN、Infinity、null或undefined时当前接口不生效，其他传入有效参数的绘制方法正常绘制。 |
| c | number | Yes | 变换矩阵第一行第二列的单元格。skewX：指定水平倾斜值，支持设置负数。&lt;br&gt;API version 18之前，设置NaN或Infinity时，在该方法后执行的绘制方法无法绘制；设置null或undefined时，当前接口不生效。API version 18及以后，设置NaN、Infinity、null或undefined时当前接口不生效，其他传入有效参数的绘制方法正常绘制。 |
| d | number | Yes | 变换矩阵第二行第二列的单元格。scaleY：指定垂直缩放值，支持设置负数。&lt;br&gt;API version 18之前，设置NaN或Infinity时，在该方法后执行的绘制方法无法绘制；设置null或undefined时，当前接口不生效。API version 18及以后，设置NaN、Infinity、null或undefined时当前接口不生效，其他传入有效参数的绘制方法正常绘制。 |
| e | number | Yes | 变换矩阵第一行第三列的单元格。translateX：指定水平移动值，支持设置负数。&lt;br&gt;API version 18之前，设置NaN或Infinity时，在该方法后执行的绘制方法无法绘制；设置null或undefined时，当前接口不生效。API version 18及以后，设置NaN、Infinity、null或undefined时当前接口不生效，其他传入有效参数的绘制方法正常绘制。&lt;br&gt;默认单位：vp |
| f | number | Yes | 变换矩阵第二行第三列的单元格。translateY：指定垂直移动值，支持设置负数。&lt;br&gt;API version 18之前，设置NaN或Infinity时，在该方法后执行的绘制方法无法绘制；设置null或undefined时，当前接口不生效。API version 18及以后，设置NaN、Infinity、null或undefined时当前接口不生效，其他传入有效参数的绘制方法正常绘制。&lt;br&gt;默认单位：vp |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| x | number | Yes | 设置水平平移量。&lt;br&gt;API version 18之前，设置NaN或Infinity时，在该方法后执行的绘制方法无法绘制；设置null或undefined时，当前接口不生效。API version 18及以后，设置NaN、Infinity、null或undefined时当前接口不生效，其他传入有效参数的绘制方法正常绘制。&lt;br&gt;默认单位：vp |
| y | number | Yes | 设置竖直平移量。&lt;br&gt;API version 18之前，设置NaN或Infinity时，在该方法后执行的绘制方法无法绘制；设置null或undefined时，当前接口不生效。API version 18及以后，设置NaN、Infinity、null或undefined时当前接口不生效，其他传入有效参数的绘制方法正常绘制。&lt;br&gt;默认单位：vp |
...
**Type:** [LengthMetrics](arkts-arkui-lengthmetrics-t.md) \| string
