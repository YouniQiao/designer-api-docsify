...
支持[通用属性](../../apis-arkui/arkts-components/arkts-arkui-common-attribute.md)。
...
| --- | --- | --- | --- |
| modifier | [AttributeModifier](../arkts-components/arkts-arkui-attributemodifier-i.md)&lt;[NavDestinationAttribute](arkts-arkui-navdestination-navdestinationattribute-i.md)&gt; \| AttributeModifier&lt;CommonMethod&gt; \| undefined | Yes | 在当前组 件上，动态设置属性方法，支持使用if/else语法。取值为undefined时，按当前组件的属性方法默认值处理。&lt;br/&gt;CommonMethod：通用属性和事件。 |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| icon | [ResourceStr](arkts-arkui-resourcestr-t.md) \| PixelMap \| SymbolGlyphModifier \| undefined | Yes | 标题栏返回键图标。&lt;br/&gt;取值为undefined时，显示返回图标。 |
| accessibilityText | [ResourceStr](arkts-arkui-resourcestr-t.md) \| undefined | No | 返回键无障碍播报内容。&lt;br/&gt;取值为undefined时，按默认值处理。&lt;/br&gt;默认值：系统语言是中文时为“返回 ”，系统语言是英文时为“back”。 |
...
绑定NavDestination组件和嵌套的可滚动容器组件（支持[List](../../apis-arkui/arkts-components/arkts-arkui-list-i)、  
[Scroll](../../apis-arkui/arkts-components/arkts-arkui-scroll-i)、[Grid](../../apis-arkui/arkts-components/arkts-arkui-grid-i)、  
[WaterFlow](../../apis-arkui/arkts-components/arkts-arkui-water_flow-i)），当滑动父组件或子组件时，会触发所有与其绑定的NavDestination组件的标题栏和工具栏的显示和隐藏动效，上滑隐藏，下滑显示。一个NavDestination可与多个嵌套的可滚动容器组件绑定，嵌套的可滚动容器组件也可与多个NavDestination绑定。使用示例参见  
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| scrollInfos | Array&lt;NestedScrollInfo&gt; \| undefined | Yes | 嵌套的可滚动容器组件的控制器。&lt;br/&gt;取值为undefined时，无控制器。 |
...
绑定NavDestination组件和可滚动容器组件（支持[List](../../apis-arkui/arkts-components/arkts-arkui-list-i)、  
[Scroll](../../apis-arkui/arkts-components/arkts-arkui-scroll-i)、[Grid](../../apis-arkui/arkts-components/arkts-arkui-grid-i)、  
[WaterFlow](../../apis-arkui/arkts-components/arkts-arkui-water_flow-i)），当滑动可滚动容器组件时，会触发所有与其绑定的NavDestination组件的标题栏和工具栏的显示和隐藏动效，上滑隐藏，下滑显示。一个NavDestination可与多个可滚动容器组件绑定，一个可滚动容器组件也可与多个NavDestination绑定。使用示例参见  
[示例1](../../../reference/apis-arkui/arkui-ts/ts-basic-components-navdestination copy.md#示例1标题栏工具栏与可滚动类组件联动)。
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| scrollers | Array&lt;[Scroller](../arkts-components/arkts-arkui-scroller-c.md)&gt; \| undefined | Yes | 可滚动容器组件的控制器。&lt;br/&gt;取值为undefined时，无控制器。 |
...
> 中调用。
> 
> - 该属性与[systemTransition](arkts-arkui-navdestination-navdestinationattribute-i.md#systemtransition)同时设置时，后设置的属性生效。
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| delegate | [NavDestinationTransitionDelegate](../arkts-components/arkts-arkui-navdestinationtransitiondelegate-t.md) \| undefined | Yes | NavDestination自定义动画的代理函数。&lt;br/&gt;取值为undefined时，不使用回 调函数。 |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| enabled | boolean \| undefined | Yes | 进入该NavDestination后，系统导航条的显示/隐藏状态。&lt;br/&gt;取值为undefined时，按默认值处理。&lt;br/&gt;true：显示导航条 。&lt;br/&gt;false：隐藏导航条。 |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| enabled | boolean \| undefined | Yes | 进入该NavDestination后，系统状态栏的显示/隐藏状态。&lt;br/&gt;取值为undefined时，按默认值处理。&lt;br/&gt;true：显示状态栏 。&lt;br/&gt;false：隐藏状态栏。 |
| animated | boolean \| undefined | No | 进入该NavDestination后，系统状态栏的显示/隐藏状态。 &lt;br&gt;取值为undefined时，按默认值处理。 默认值： false。 |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| fullScreenOverlay | boolean \| undefined | Yes | 是否以全屏覆盖模式显示。&lt;br/&gt;true：全屏覆盖模式，覆盖整个Navigation容器。&lt;br/&gt;false：普通显示模式， 遵循Navigation分栏显示规则。指定为false的STANDARD类型页面不会继承全屏显示。&lt;br/&gt;undefined：普通显示模式，遵循Navigation分栏显示规则。指定为undefined的页面会继承全屏显 示。 |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| types | Array&lt;[LayoutSafeAreaType](../arkts-components/arkts-arkui-layoutsafeareatype-e.md)&gt; \| undefined | No | 配置扩展安全区域的类型。&lt;br /&gt;取值为undefined时，按照默认值处理。&lt;br /&gt;默认值：&lt;br /&gt; [LayoutSafeAreaType.SYSTEM] |
| edges | Array&lt;[LayoutSafeAreaEdge](../arkts-components/arkts-arkui-layoutsafeareaedge-e.md)&gt; \| undefined | No | 配置扩展安全区域的方向。&lt;br /&gt;取值为undefined时，按照默认值处理。&lt;br /&gt; 默认值：&lt;br / &gt;[LayoutSafeAreaEdge.TOP, LayoutSafeAreaEdge.BOTTOM]。 |
...
[menus](../../../reference/apis-arkui/arkui-ts/ts-basic-components-navdestination copy.md#menus12)相比，新增菜单选项。使用Array<[NavigationMenuItem](arkts-arkui-navigation-navigationmenuitem-i.md)&gt; 写法时，竖屏最多支持显示3个图标，横屏最多支持显示5个图标，多余的图标会被放入自动生成的更多图标。
...
| options | [NavigationMenuOptions](../arkts-components/arkts-arkui-navigationmenuoptions-i.md) \| undefined | No | 页面右上角菜单选项。&lt;br/&gt;取值为undefined时，按NavigationMenuOptions中的默认值处理 。 |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| value | [NavDestinationMode](../arkts-components/arkts-arkui-navdestinationmode-e.md) \| undefined | Yes | NavDestination类型。&lt;br/&gt;取值为undefined时，按默认值处理。&lt;br/&gt;默认值： NavDestinationMode.STANDARD<br>**Since:** 23 - 24 |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| callback | [Callback](../arkts-components/arkts-arkui-callback-i.md)&lt;NavDestinationActiveReason&gt; \| undefined | Yes | NavDestination由非激活态变为激活态的原因。&lt;br/&gt;取值为 undefined时，不使用回调函数。 |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| callback | (() =&gt; boolean) \| undefined | Yes | 当与Navigation绑定的导航控制器中存在内容时，此回调生效。当点击返回键时，触发该回调。&lt;br/&gt;取值为undefined时，不使用回调函 数。 |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| callback | [Callback](../arkts-components/arkts-arkui-callback-i.md)&lt;VisibilityChangeReason&gt; \| undefined | Yes | 当该NavDestination页面隐藏时触发此回调。&lt;br/&gt;取值为undefined时，不使 用回调函数。&lt;br/&gt;在API version 21之前，当NavDestination页面隐藏时触发回调。&lt;br/&gt;从API version 21开始，该回调会提供入参VisibilityChangeReason以说明 onHidden触发的原因。 |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| callback | [Callback](../arkts-components/arkts-arkui-callback-i.md)&lt;NavDestinationActiveReason&gt; \| undefined | Yes | NavDestination由激活态变为非激活态的原因。&lt;br/&gt;取值为 undefined时，不使用回调函数。 |
...
[launchMode.MOVE_TO_TOP_SINGLETON](arkts-arkui-navigation-launchmode-e.md)或  
[launchMode.POP_TO_SINGLETON](arkts-arkui-navigation-launchmode-e.md)移动到栈顶时，触发该回调。

> **说明：**
> 
> -
> [replacePath](arkts-arkui-navigation-navpathstack-c.md#replacepath)
> 、[replaceDestination](arkts-arkui-navigation-navpathstack-c.md#replacedestination)不会触发该回调。
> 
> - 从API version 22开始，该接口支持在
> [attributeModifier](../../../reference/apis-arkui/arkui-ts/ts-universal-attributes-attribute-modifier.md#attributemodifier)
> 中调用。
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| callback | [Callback](../arkts-components/arkts-arkui-callback-i.md)&lt;NavDestinationContext&gt; \| undefined | Yes | 当NavDestination即将构建子组件之前会触发此回调。&lt;br/&gt;取值为undefined时 ，不使用回调函数。 |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| callback | [Callback](../arkts-components/arkts-arkui-callback-i.md)&lt;Object \| null \| undefined&gt; \| undefined | Yes | 页面返回回调，入参为 [pop](arkts-arkui-navigation-navpathstack-c.md#pop)、 [popToName](arkts-arkui-navigation-navpathstack-c.md#poptoname) 、 [popToIndex](arkts-arkui-navigation-navpathstack-c.md#poptoindex) 接口传入的result参数。如果不传该参数，入参为undefined。&lt;br/&gt;取值为undefined时，不使用回调函数。 |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| callback | [Callback](../arkts-components/arkts-arkui-callback-i.md)&lt;VisibilityChangeReason&gt; \| undefined | Yes | 当该NavDestination页面显示时触发此回调。&lt;br/&gt;取值为undefined时，不使 用回调函数。&lt;br/&gt;在API version 21之前，当NavDestination页面显示时触发回调。&lt;br/&gt;从API version 21开始，回调会提供入参VisibilityChangeReason以说明 onShown触发的原因。 |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| callback | [VoidCallback](arkts-arkui-voidcallback-t.md) \| undefined | Yes | 当该NavDestination挂载之前触发此回调。在该回调中允许修改路由栈，当前帧生效。&lt;br/&gt;取值为undefined时，不使用回 调函数。 |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| callback | [VoidCallback](arkts-arkui-voidcallback-t.md) \| undefined | Yes | 当该NavDestination卸载之前触发的生命周期(有转场动画时，在转场动画开始之前触发)。&lt;br/&gt;取值为undefined时，不 使用回调函数。 |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| callback | [VoidCallback](arkts-arkui-voidcallback-t.md) \| undefined | Yes | 当该NavDestination隐藏之前触发此回调。&lt;br/&gt;取值为undefined时，不使用回调函数。 |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| callback | [VoidCallback](arkts-arkui-voidcallback-t.md) \| undefined | Yes | 当该NavDestination显示之前触发此回调。&lt;br/&gt;取值为undefined时，不使用回调函数。 |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| orientation | [Orientation](arkts-arkui-window-orientation-e.md) \| undefined | Yes | NavDestination页面对应的Orientation。&lt;br/&gt;取值为undefined时，按当前设备的显示方向处理。 |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| recoverable | boolean \| undefined | Yes | NavDestination是否可恢复。&lt;br/&gt;取值为undefined时，按默认值处理。&lt;br/&gt;默认值：false&lt;br/&gt;true： 路由栈可恢复。&lt;br/&gt;false：路由栈不可恢复。 |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| moduleInfo | [NavDestinationModuleInfo](arkts-arkui-navdestination-navdestinationmoduleinfo-i.md) | No | NavDestination模块信息 |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| type | [NavigationSystemTransitionType](arkts-arkui-navdestination-navigationsystemtransitiontype-e.md) \| undefined | Yes | 系统转场动画类型。&lt;br/&gt;取值为undefined时，按默认值处理。&lt;br/&gt;默认值： NavigationSystemTransitionType.DEFAULT |
...
| options | [NavigationTitleOptions](../arkts-components/arkts-arkui-navigationtitleoptions-i.md) \| undefined | No | 标题栏选项。&lt;br/&gt;取值为undefined时，按NavigationTitleOptions中的默认值处理。 |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| toolbarParam | Array&lt;[ToolbarItem](../arkts-components/arkts-arkui-toolbaritem-i.md)&gt; \| CustomBuilder \| undefined | Yes | 工具栏内容。&lt;br/&gt;使用Array&lt; [ToolbarItem](arkts-arkui-navigation-toolbaritem-i.md)&gt;写法设置的工具栏有如下特性：&lt;br/&gt;-工具栏所有选项均分底部工具栏， 在每个均分内容区布局文本和图标。&lt;br/&gt;-竖屏模式最多支持显示5个图标，多余的图标会被放入自动生成的更多图标中，点击更多图标，可以展示剩余内容。横屏模式时，如果为 [Split](arkts-arkui-navigation-navigationmode-e.md)模式，仍按照竖屏模式显示，如果为 [Stack](arkts-arkui-navigation-navigationmode-e.md)模式需配合 [menus](../../../reference/apis-arkui/arkui-ts/ts-basic-components-navdestination copy.md#menus12)属性的Array&lt; [NavigationMenuItem](arkts-arkui-navigation-navigationmenuitem-i.md)&gt;使用，底部工具栏会自动隐藏，同时底部工具栏 所有选项移动至页面右上角菜单。&lt;br/&gt;使用[CustomBuilder](../../../reference/apis-arkui/arkui-ts/ts-types.md#custombuilder8)写法为用户自 定义工具栏选项，不具备以上功能。&lt;br/&gt;取值为undefined时，无内容。 |
| options | [NavigationToolbarOptions](../arkts-components/arkts-arkui-navigationtoolbaroptions-i.md) \| undefined | No | 工具栏选项。包含工具栏背景颜色、工具栏背景模糊样式及模糊选项、工具栏背景属性、工具栏布局方式、是否隐藏工具栏的 文本、工具栏更多图标的菜单选项。&lt;br/&gt;取值为undefined时，按NavigationToolbarOptions的默认值处理。 |
