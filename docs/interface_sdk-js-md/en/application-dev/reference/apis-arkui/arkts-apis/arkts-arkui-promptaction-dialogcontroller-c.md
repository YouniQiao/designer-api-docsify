...
It can be used as a member variable of **UIContext** to display custom dialog boxes. For specific usage, see the examples for [openCustomDialogWithController](arkts-arkui-arkuiuicontext-promptaction-c.md#opencustomdialogwithcontroller) and [presentCustomDialog](arkts-arkui-arkuiuicontext-promptaction-c.md#presentcustomdialog).
