...
**"no-hide-descendants"**: Neither the component nor its child components can be recognized by accessibility services.The default value is **"auto"**.If the value is **undefined**, the default value is used.  
**NOTE：**When accessibilityLevel is set to **"auto"**, the component's recognizability depends on the following factors:
