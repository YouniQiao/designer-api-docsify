...
| --- | --- | --- | --- |
| callback | [VoidCallback](arkts-arkui-voidcallback-t.md) \| undefined | Yes | The callback will be triggered when a component mounts a display. If set undefined will reset the target callback. |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| callback | [VoidCallback](arkts-arkui-voidcallback-t.md) \| undefined | Yes | The callback will be triggered when a component lose focus. If set undefined will reset the target callback. |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| callback | [VoidCallback](arkts-arkui-voidcallback-t.md) \| undefined | Yes | The callback will be triggered when component uninstallation disappears. If set undefined will reset the target callback. |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| callback | [VoidCallback](arkts-arkui-voidcallback-t.md) \| undefined | Yes | The callback will be triggered when a component get focus. If set undefined will reset the target callback. |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| callback | [HoverCallback](arkts-arkui-hovercallback-t.md) \| undefined | Yes | The callback will be triggered when has a hover event. If set undefined will reset the target callback. |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| options | [VisibleAreaEventOptions](arkts-arkui-common-visibleareaeventoptions-i.md) | Yes | The options for the visibility event. |
