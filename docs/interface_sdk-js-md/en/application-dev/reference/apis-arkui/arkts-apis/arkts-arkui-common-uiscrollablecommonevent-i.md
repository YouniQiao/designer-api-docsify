...
**Inheritance/Implementation:** UIScrollableCommonEvent extends [UICommonEvent](../arkts-components/arkts-arkui-uicommonevent-i.md/arkts-arkui-uicommonevent-i.md)
