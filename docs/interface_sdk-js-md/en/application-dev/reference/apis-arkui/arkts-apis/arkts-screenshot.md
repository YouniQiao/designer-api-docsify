...
| [save](arkts-arkui-screenshot-save-f-sys.md#save-system-api) | Obtains a screenshot. This API uses an asynchronous callback to return the result. |
| [save](arkts-arkui-screenshot-save-f-sys.md#save-system-api) | Obtains a screenshot. This API uses a promise to return the result. |
