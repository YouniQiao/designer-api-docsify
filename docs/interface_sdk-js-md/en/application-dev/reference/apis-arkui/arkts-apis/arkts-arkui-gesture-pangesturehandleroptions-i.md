...
Provides the parameters of the pan gesture handler. Inherits from [BaseHandlerOptions](arkts-arkui-gesture-basehandleroptions-i.md).
...
If a pan gesture and a [tab](../arkts-components/arkts-arkui-tabs.md) swipe occur at the same time, set **distance** to **1** to make the gesture more easily recognizable.
...
When configuring this field with [gestureModifier](../arkts-components/arkts-arkui-common-commonmethod-c.md#gesturemodifier-1), the unit is px.
