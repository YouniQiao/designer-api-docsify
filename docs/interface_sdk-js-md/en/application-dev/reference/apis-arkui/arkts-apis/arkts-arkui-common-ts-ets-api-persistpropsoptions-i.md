...
Defines a key-value pair object used to specify persistent properties and their default values, passed as a parameter to [persistProps](arkts-arkui-common-ts-ets-api-persistentstorage-c.md#persistprops-1).
