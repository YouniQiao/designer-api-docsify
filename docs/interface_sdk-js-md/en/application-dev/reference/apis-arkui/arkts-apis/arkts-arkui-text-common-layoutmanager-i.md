...
| Type | Description |
| --- | --- |
| [PositionWithAffinity](arkts-arkui-text-common-positionwithaffinity-i.md) | Glyph position. |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| charRange | [TextRange](arkts-arkui-text-common-textrange-i.md) | Yes | Character range of the text. |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| range | [TextRange](arkts-arkui-text-common-textrange-i.md) | Yes | Text range for which the drawing area is to be obtained. |
...
| Type | Description |
| --- | --- |
| [Array](../../apis-na/arkts-apis/arkts-na-lib-es5-array-i.md)<TextBox> | Array of drawing rectangles. |
