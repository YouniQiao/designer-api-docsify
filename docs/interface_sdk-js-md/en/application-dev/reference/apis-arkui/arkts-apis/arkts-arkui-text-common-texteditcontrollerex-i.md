...
Inherits [TextBaseController](arkts-arkui-text-common-textbasecontroller-i.md).

**Inheritance/Implementation:** TextEditControllerEx extends [TextBaseController](arkts-arkui-text-common-textbasecontroller-i.md)
