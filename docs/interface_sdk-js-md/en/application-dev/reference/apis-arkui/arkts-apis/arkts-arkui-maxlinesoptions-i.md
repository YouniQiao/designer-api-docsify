...
**overflowMode** can be used to set the non-inline mode for the [TextArea](./text_area) component. When the text exceeds the set value of **maxLines** (maximum number of lines), a scroll effect is enabled. This requires configuration of [textOverflow](arkts-arkui-textarea-textareaattribute-i.md#textoverflow), and **MaxLinesMode** takes effect only when  
