...
> 
> - In the following API examples, you must first use [getPromptAction()](arkts-arkui-arkuiuicontext-uicontext-c.md#getpromptaction) in
...
| --- | --- | --- | --- |
| content | ComponentContent&lt;T&gt; | Yes | Content displayed in the menu. |
| target | [TargetInfo](arkts-arkui-arkuiuicontext-targetinfo-i.md) | Yes | Information about the target component to bind. |
