...
Registers a custom font with the font manager. This API is asynchronous and does not support concurrent calls. > **NOTE：**> > - Since API version 10, you can use the > [getFont](../../../reference/apis-arkui/arkts-apis-uicontext-uicontext.md#getfont) API in > [UIContext](../../apis-na/arkts-apis/arkts-na-arkui-uicontext-uicontext-c.md) to obtain the [Font](../../apis-na/arkts-apis/arkts-na-arkui-uicontext-uicontext-c.md) object associated with > the current UI context.
