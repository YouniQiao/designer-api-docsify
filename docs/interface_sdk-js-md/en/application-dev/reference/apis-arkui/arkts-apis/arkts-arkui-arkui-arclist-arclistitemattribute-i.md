...
**Inheritance/Implementation:** ArcListItemAttribute extends CommonMethod
...
```TypeScript
attributeModifier(modifier: AttributeModifier<ArcListItemAttribute> | AttributeModifier<CommonMethod> | undefined): this
```
...
| --- | --- | --- | --- |
| modifier | AttributeModifier&lt;[ArcListItemAttribute](arkts-arkui-arkui-arclist-arclistitemattribute-i.md)&gt; \| AttributeModifier&lt;CommonMethod&gt; \| undefined | Yes |  |
...
```TypeScript
autoScale(enable: boolean | undefined): this
```
...
```TypeScript
swipeAction(options: SwipeActionOptions | undefined): this
```
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| options | SwipeActionOptions \| undefined | Yes |  |
