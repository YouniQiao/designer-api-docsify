...
- [common_ts_ets_api](arkts-common_ts_ets_api.md)
  ...
  <!--Del-->
  - [appStorage(system api)](arkts-arkui-commontsetsapi-p-sys.md)<!--DelEnd-->
...
- common<!--arkts-arkui-common-->
  ...
  - [global](arkts-global.md)
    ...
    <!--Del-->
    - [LITE(system api)](arkts-arkui-global-p-sys.md)<!--DelEnd-->
    <!--Del-->
    - [STANDARD(system api)](arkts-arkui-global-p-sys.md)<!--DelEnd-->
  - index
