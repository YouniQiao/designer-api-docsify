...
Displays a linear gradient. **LinearGradientStyle** inherits from [ShaderStyle](arkts-arkui-text-common-shaderstyle-c.md).

**Inheritance/Implementation:** LinearGradientStyle extends [ShaderStyle](arkts-arkui-text-common-shaderstyle-c.md)
...
| --- | --- | --- | --- |
| options | [LinearGradientOptions](../arkts-components/arkts-arkui-common-lineargradientoptions-i.md) | Yes | Options for displaying a linear gradient. |
