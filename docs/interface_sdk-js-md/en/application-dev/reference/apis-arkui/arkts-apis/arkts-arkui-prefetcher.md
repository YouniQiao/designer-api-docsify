...
| Name | Description |
| --- | --- |
| [IDataSourcePrefetching(Prefetching)](arkts-arkui-arkui-prefetcher-idatasourceprefetching-i.md) | Extends the [IDataSource](../arkts-components/arkts-arkui-idatasource-i.md) API to provide a data source that can be prefetched. |
