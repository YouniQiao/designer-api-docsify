...
| [getAttribute](arkts-arkui-getattribute-f.md#getattribute-1) | Obtains the attributes of a **Text** node. If the node is not created using ArkTS, cross-language access must be enabled; otherwise, **undefined** is returned. This API does not support declaratively created nodes. |
| [bindController](arkts-arkui-bindcontroller-f.md#bindcontroller-1) | Binds a [TextController](../arkts-components/arkts-arkui-textcontroller-c.md) instance to a [Text](arkts-arkui-text-t.md) node. Cross-language access must be enabled for nodes not created via ArkTS; otherwise, an exception will be thrown. This API does not support declaratively created nodes. |
| [createNode](arkts-arkui-createnode-f.md#createnode-2) | Creates a FrameNode of the **Column** type. |
| [getAttribute](arkts-arkui-getattribute-f.md#getattribute-2) | Obtains the attributes of a **Column** node. If the node is not created using ArkTS, cross-language access must be enabled; otherwise, **undefined** is returned. This API does not support declaratively created nodes. |
| [createNode](arkts-arkui-createnode-f.md#createnode-3) | Creates a FrameNode of the Row type. |
| [getAttribute](arkts-arkui-getattribute-f.md#getattribute-3) | Obtains the attributes of a **Row** node. If the node is not created using ArkTS, cross-language access must be enabled; otherwise, **undefined** is returned. This API does not support declaratively created nodes. |
| [createNode](arkts-arkui-createnode-f.md#createnode-4) | Creates a FrameNode of the **Stack** type. |
| [getAttribute](arkts-arkui-getattribute-f.md#getattribute-4) | Obtains the attributes of a **Stack** node. If the node is not created using ArkTS, cross-language access must be enabled; otherwise, **undefined** is returned. This API does not support declaratively created nodes. |
...
| [getAttribute](arkts-arkui-getattribute-f.md#getattribute-6) | Obtains the attributes of a **Swiper** node. If the node is not created using ArkTS, cross-language access must be enabled; otherwise, **undefined** is returned. This API does not support declaratively created nodes. |
| [bindController](arkts-arkui-bindcontroller-f.md#bindcontroller-2) | Binds a [SwiperController](../arkts-components/arkts-arkui-swipercontroller-c.md) instance to the [Swiper](arkts-arkui-swiper-t.md) node. Cross-language access must be enabled for nodes not created via ArkTS; otherwise, an exception will be thrown. This API does not support declaratively created nodes. |
| [createNode](arkts-arkui-createnode-f.md#createnode-9) | Creates a FrameNode of the **Progress** type. |
| [getAttribute](arkts-arkui-getattribute-f.md#getattribute-7) | Obtains the attributes of a **Progress** node. If the node is not created using ArkTS, cross-language access must be enabled; otherwise, **undefined** is returned. This API does not support declaratively created nodes. |
| [createNode](arkts-arkui-createnode-f.md#createnode-10) | Creates a FrameNode of the **Scroll** type. |
| [getAttribute](arkts-arkui-getattribute-f.md#getattribute-8) | Obtains the attributes of a **Scroll** node. If the node is not created using ArkTS, cross-language access must be enabled; otherwise, **undefined** is returned. This API does not support declaratively created nodes. |
...
| [bindController](arkts-arkui-bindcontroller-f.md#bindcontroller-3) | Binds the [Scroller](../arkts-components/arkts-arkui-scroller-c.md) to the [Scroll](arkts-arkui-scroll-t.md) node. Cross-language access must be enabled for nodes not created via ArkTS; otherwise, an exception will be thrown. This API supports declaratively created nodes since API version 26.0.0. |
| [createNode](arkts-arkui-createnode-f.md#createnode-11) | Creates a FrameNode of the **RelativeContainer** type. |
| [getAttribute](arkts-arkui-getattribute-f.md#getattribute-9) | Obtains the attributes of a **RelativeContainer** node. If the node is not created using ArkTS, cross-language access must be enabled; otherwise, **undefined** is returned. This API does not support declaratively created nodes. |
...
| [getAttribute](arkts-arkui-getattribute-f.md#getattribute-11) | Obtains the attributes of an **Image** node. If the node is not created using ArkTS, cross-language access must be enabled; otherwise, **undefined** is returned. This API does not support declaratively created nodes. |
| [createNode](arkts-arkui-createnode-f.md#createnode-17) | Creates a FrameNode of the **List** type. |
| [getAttribute](arkts-arkui-getattribute-f.md#getattribute-12) | Obtains the attributes of a **List** node. If the node is not created using ArkTS, cross-language access must be enabled; otherwise, **undefined** is returned. This API does not support declaratively created nodes. |
| [bindController](arkts-arkui-bindcontroller-f.md#bindcontroller-4) | Binds a [Scroller](../arkts-components/arkts-arkui-scroller-c.md) instance to the [List](arkts-arkui-list-t.md) node. Cross-language access must be enabled for nodes not created via ArkTS; otherwise, an exception will be thrown. This API supports declaratively created nodes since API version 26.0.0. |
...
| [getAttribute](arkts-arkui-getattribute-f.md#getattribute-13) | Obtains the attributes of a **ListItem** node. If the node is not created using ArkTS, cross-language access must be enabled; otherwise, **undefined** is returned. This API does not support declaratively created nodes. |
| [createNode](arkts-arkui-createnode-f.md#createnode-19) | Creates a FrameNode of the **TextInput** type. |
| [getAttribute](arkts-arkui-getattribute-f.md#getattribute-14) | Obtains the attributes of a **TextInput** node. If the node is not created using ArkTS, cross-language access must be enabled; otherwise, **undefined** is returned. This API does not support declaratively created nodes. |
...
| [getAttribute](arkts-arkui-getattribute-f.md#getattribute-15) | Obtains the attributes of a **Button** node. If the node is not created using ArkTS, cross-language access must be enabled; otherwise, **undefined** is returned. This API does not support declaratively created nodes. |
| [createNode](arkts-arkui-createnode-f.md#createnode-21) | Creates a FrameNode of the **ListItemGroup** type. |
| [getAttribute](arkts-arkui-getattribute-f.md#getattribute-16) | Obtains the attributes of a **ListItemGroup** node. If the node is not created using ArkTS, cross-language access must be enabled; otherwise, **undefined** is returned. This API does not support declaratively created nodes. |
| [createNode](arkts-arkui-createnode-f.md#createnode-22) | Creates a FrameNode of the **WaterFlow** type. |
| [getAttribute](arkts-arkui-getattribute-f.md#getattribute-17) | Obtains the attributes of a **WaterFlow** node. If the node is not created using ArkTS, cross-language access must be enabled; otherwise, **undefined** is returned. This API does not support declaratively created nodes. |
| [bindController](arkts-arkui-bindcontroller-f.md#bindcontroller-6) | Binds a [Scroller](../arkts-components/arkts-arkui-scroller-c.md) instance to the [WaterFlow](arkts-arkui-waterflow-t.md) node. Cross-language access must be enabled for nodes not created via ArkTS; otherwise, an exception will be thrown. This API supports declaratively created nodes since API version 26.0.0. |
...
| [getAttribute](arkts-arkui-getattribute-f.md#getattribute-18) | Obtains the attributes of a **FlowItem** node. If the node is not created using ArkTS, cross-language access must be enabled; otherwise, **undefined** is returned. This API does not support declaratively created nodes. |
...
| [getAttribute](arkts-arkui-getattribute-f.md#getattribute-19) | Obtain the attributes of an **XComponent** node. If the node is not created using ArkTS, cross-language access must be enabled; otherwise, **undefined** is returned. This API does not support declaratively created nodes. |
| [createNode](arkts-arkui-createnode-f.md#createnode-27) | Creates a FrameNode of the **Checkbox** type. |
| [getAttribute](arkts-arkui-getattribute-f.md#getattribute-20) | Obtains the attributes of a **Checkbox** node. If the node is not created using ArkTS, cross-language access must be enabled; otherwise, **undefined** is returned. This API does not support declaratively created nodes. |
...
| [getAttribute](arkts-arkui-getattribute-f.md#getattribute-21) | Obtains the attributes of a **Radio** node. If the node is not created using ArkTS, cross-language access must be enabled; otherwise, **undefined** is returned. This API does not support declaratively created nodes. |
...
| [getAttribute](arkts-arkui-getattribute-f.md#getattribute-22) | Obtains the attributes of a **Slider** node. If the node is not created using ArkTS, cross-language access must be enabled; otherwise, **undefined** is returned. This API does not support declaratively created nodes. |
| [createNode](arkts-arkui-createnode-f.md#createnode-33) | Creates a FrameNode of the **Toggle** type. |
| [getAttribute](arkts-arkui-getattribute-f.md#getattribute-23) | Obtains the attributes of a **Toggle** node. If the node is not created using ArkTS, cross-language access must be enabled; otherwise, **undefined** is returned. This API does not support declaratively created nodes. |
...
| [getAttribute](arkts-arkui-getattribute-f.md#getattribute-24) | Obtains the attributes of a **TextArea** node. If the node is not created using ArkTS, cross-language access must be enabled; otherwise, **undefined** is returned. This API does not support declaratively created nodes. |
...
| [getAttribute](arkts-arkui-getattribute-f.md#getattribute-25) | Obtains the attributes of a **Grid** node. If the node is not created using ArkTS, cross-language access must be enabled; otherwise, **undefined** is returned. This API does not support declaratively created nodes. |
| [bindController](arkts-arkui-bindcontroller-f.md#bindcontroller-8) | Binds a [Scroller](../arkts-components/arkts-arkui-scroller-c.md) instance to the [Grid](arkts-arkui-grid-t.md) node. Cross-language access must be enabled for nodes not created via ArkTS; otherwise, an exception will be thrown. This API supports declaratively created nodes since API version 26.0.0. |
...
| [getAttribute](arkts-arkui-getattribute-f.md#getattribute-26) | Obtains the attributes of a **GridItem** node. If the node is not created using ArkTS, cross-language access must be enabled; otherwise, **undefined** is returned. This API does not support declaratively created nodes. |
...
| [LoadingProgress](arkts-arkui-loadingprogress-t.md) | Represents a FrameNode of the **LoadingProgress** type. This type of node does not allow child components to be added. |
...
| [Button](arkts-arkui-button-t.md) | Represents a FrameNode of the **Button** type. When created in child component mode, this type of node allows only one child component to be added. When created in label mode, it does not child components to be added. |
| [ListItemGroup](arkts-arkui-listitemgroup-t.md) | Represents a FrameNode of the **ListItemGroup** type. Only [ListItem](../arkts-components/arkts-arkui-listitem.md) child components can be added. |
