...
| [TypedFrameNode](arkts-arkui-framenode-typedframenode-i.md) | Extends [FrameNode](../../apis-default/arkts-apis/arkts-framenode-c.md) to define a FrameNode with specific type constraints. |
...
| Name | Description |
| --- | --- |
| [UIStatesChangeHandler](arkts-arkui-uistateschangehandler-t.md) | Defines the callback triggered when the UI state changes. Defines the callback triggered on UI state changes. It receives the current [UIState](../../apis-default/arkts-apis/arkts-framenode-uistate-e.md) value when triggered. The parameter represents **UIState** enumerated values or their bitwise combinations. |
