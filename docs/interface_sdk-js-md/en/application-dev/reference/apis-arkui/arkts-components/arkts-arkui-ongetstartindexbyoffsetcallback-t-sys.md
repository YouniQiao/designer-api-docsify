...
| --- | --- | --- | --- |
| totalOffset | double | Yes | Total scrolling offset, that is, the offset between the top of the first **GridItem** in the **Grid** component and the top of the **Grid** component. \_\_\_HTML\_TAG\_USD\_0\_\_\_Unit:vp.  |
