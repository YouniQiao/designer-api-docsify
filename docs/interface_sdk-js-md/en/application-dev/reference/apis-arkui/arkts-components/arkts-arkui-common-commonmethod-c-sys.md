...
Defines how the component's content (including the content of it child components) is blended with the existing content on the canvas (possibly offscreen canvas) below. This API cannot be used with [blendMode](arkts-arkui-common-commonmethod-c.md#blendmode-1).
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| params | EdgeLightParams \| undefined | Yes | Edge light effect parameters.Defines the position, length, intensity, color, and thickness of the light effect.If params is undefined, the edge light effect is removed. |
...
Sets whether the current component and its child components are removed from the render group of the ancestor component. If this attribute is used alone, no effect is achieved. It must be used with the [renderGroup](arkts-arkui-common-commonmethod-c.md#rendergroup-2) attribute of the ancestor component.
...
> [translate](arkts-arkui-common-commonmethod-c.md#translate-1) or  
> [scale](arkts-arkui-common-commonmethod-c.md#scale-1), or the drawing content extend beyond its boundaries  
> because the current component has attributes such as  
> [shadow](arkts-arkui-common-commonmethod-c.md#shadow-1) and  
> [pixelStretchEffect](arkts-arkui-common-commonmethod-c.md#pixelstretcheffect-1), the displayed  
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| params | SpatialEffectParams \| undefined | Yes | Spatial effect parameters. |
...
Sets the system material for a component. Different system materials have different attribute effects. This API affects the background color ([backgroundColor](arkts-arkui-common-commonmethod-c.md#backgroundcolor-1)), border color ([borderColor](arkts-arkui-common-commonmethod-c.md#bordercolor-1)), border width ([borderWidth](arkts-arkui-common-commonmethod-c.md#borderwidth-1)), and shadow ([shadow](arkts-arkui-common-commonmethod-c.md#shadow-1)). You are advised not to use this API together with the aforementioned APIs. For details about the example, see [Setting the System Material](../../../../reference/apis-arkui/arkts-apis-uimaterial-sys.md#example-1-setting-the-system-material).
