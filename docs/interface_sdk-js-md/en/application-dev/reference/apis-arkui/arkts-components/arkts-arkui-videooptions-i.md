...
- Strings with the **file://** prefix, that is,[application sandbox URIs](../../apis-core-file-kit/arkts-apis/arkts-corefile-fileuri-c.md#constructor-1):**file://`<bundleName>`/`<sandboxPath>`**, are supported. They are used to access resources in the application sandbox path. Ensure that the application has the read permission to the files in the specified path.
