...
Text stroke width. If the unit value of LengthMetrics is [PERCENT](../../apis-default/arkts-apis/arkts-graphics-lengthunit-e.md), the current setting does not take effect and is processed as 0.
