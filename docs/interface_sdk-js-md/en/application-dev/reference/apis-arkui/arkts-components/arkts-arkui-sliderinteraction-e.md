...
| ------ | -- | ----------------------------- |  
| SLIDE\_AND\_CLICK | 0 | Users can drag the slider or touch the track to move the slider. The slider moves as soon as the mouse or finger is pressed.|  
| SLIDE\_ONLY | 1 | Users are not allowed to move the slider by touching the slider.|  
| SLIDE\_AND\_CLICK\_UP | 2 |Users can drag the slider or touch the track to move the slider. The slider moves when the mouse is released or finger is lifted, if the release/lift position coincides with the screen press position.|
