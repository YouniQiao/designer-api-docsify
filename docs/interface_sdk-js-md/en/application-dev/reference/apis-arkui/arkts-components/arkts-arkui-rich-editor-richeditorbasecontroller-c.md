...
**Inheritance/Implementation:** RichEditorBaseController implements [TextEditControllerEx](../arkts-apis/arkts-arkui-text-common-texteditcontrollerex-i.md)
...
| Type | Description |
| --- | --- |
| [RectResult](arkts-arkui-common-rectresult-i.md) | Relative position of the caret in the **RichEditor** component. |
...
| Type | Description |
| --- | --- |
| [LayoutManager](../arkts-apis/arkts-arkui-text-common-layoutmanager-i.md) | **LayoutManager** object.<br>If no component is bound to the controller or the component bound to the controller is released, **undefined** is returned. |
...
| Type | Description |
| --- | --- |
| [PreviewText](../arkts-apis/arkts-arkui-text-common-previewtext-i.md) | Preview text.<br>If no component is bound to the controller or the component bound to the controller is released, **undefined** is returned. |
...
| Type | Description |
| --- | --- |
| [RichEditorTextStyle](arkts-arkui-rich-editor-richeditortextstyle-i.md) | Preset typing style.<br>If no component is bound to the controller or the component bound to the controller is released, **undefined** is returned. |
...
| --- | --- | --- | --- |
| range | [TextRange](../arkts-apis/arkts-arkui-text-common-textrange-i.md) | No | The visible range.If the parameter is invalid, this method will have no effect. |
...
| options | [SelectionOptions](arkts-arkui-common-selectionoptions-i.md) | No | Configuration of options.<br>**Since:** 12 |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| styledString | [StyledString](../arkts-apis/arkts-arkui-styled-string-styledstring-c.md) | Yes | The styledString for placeholder.If the parameter is invalid, this method will have no effect. |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| style | [RichEditorParagraphStyle](arkts-arkui-rich-editor-richeditorparagraphstyle-i.md) | Yes | Preset paragraph style. |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| value | [RichEditorTextStyle](arkts-arkui-rich-editor-richeditortextstyle-i.md) | Yes | Preset typing style. |
