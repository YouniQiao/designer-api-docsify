...
> adjusting the [translate](arkts-arkui-common-commonmethod-c.md#translate-1) attribute of the child component.  
> During the pull-down process, the  
> [onAreaChange](arkts-arkui-common-commonmethod-c.md#onareachange-1) event of the child  
> component is not triggered, and any changes made to the  
> [translate](arkts-arkui-common-commonmethod-c.md#translate-1) attribute of the child component do not take  
> effect.  
>  
...
> [onAreaChange](arkts-arkui-common-commonmethod-c.md#onareachange-1) event of the child  
> component can be triggered. However, if the [position](arkts-arkui-common-commonmethod-c.md#position-1) attribute is set for the child  
