...
| --- | --- | --- | --- |
| content | string \| [Resource](../arkts-apis/arkts-arkui-resource-t.md) | No | Plain text. This parameter takes effect when the child component Span is not included and styled string is not set.Default value: **' '**   **NOTE：**Priority of displayed content: Styled string &gt; Content of the **Span** component &gt; Text content of the **Text** component. |
