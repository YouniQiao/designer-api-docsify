...
> **NOTE：**
> 
> The value of **space** can be a number greater than or equal to 0, a string that can be converted to a number, or a &gt; Resource type that can be converted to a number. Default value: **0**.
