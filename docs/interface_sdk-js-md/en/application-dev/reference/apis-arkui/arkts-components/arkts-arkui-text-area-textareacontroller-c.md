...
The controller for the **TextArea** component inherits from [TextContentControllerBase](arkts-arkui-common-textcontentcontrollerbase-c.md). The APIs involved are as follows:<!--Del--> system API [getText](arkts-arkui-common-textcontentcontrollerbase-c-sys.md#gettext-1) and other APIs like<!--DelEnd-->[getTextContentRect](arkts-arkui-common-textcontentcontrollerbase-c.md#gettextcontentrect-1),[getTextContentLineCount](arkts-arkui-common-textcontentcontrollerbase-c.md#gettextcontentlinecount-1),[getCaretOffset](arkts-arkui-common-textcontentcontrollerbase-c.md#getcaretoffset-1), [addText](arkts-arkui-common-textcontentcontrollerbase-c.md#addtext-1),[deleteText](arkts-arkui-common-textcontentcontrollerbase-c.md#deletetext-1),[getSelection](arkts-arkui-common-textcontentcontrollerbase-c.md#getselection-1),[clearPreviewText](arkts-arkui-common-textcontentcontrollerbase-c.md#clearpreviewtext-1),[setStyledPlaceholder](arkts-arkui-common-textcontentcontrollerbase-c.md#setstyledplaceholder-1), and [deleteBackward](arkts-arkui-common-textcontentcontrollerbase-c.md#deletebackward-1).

**Inheritance/Implementation:** TextAreaController extends [TextContentControllerBase](arkts-arkui-common-textcontentcontrollerbase-c.md)
...
| options | [SelectionOptions](arkts-arkui-common-selectionoptions-i.md) | No | Configuration options for text selection.<br>Default value:**MenuPolicy.DEFAULT**<br><br>**Since:** 12 |
