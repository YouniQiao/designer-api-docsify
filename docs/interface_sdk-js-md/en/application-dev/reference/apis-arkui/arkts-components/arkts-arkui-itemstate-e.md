...
This API is supported since API version 8 and deprecated since API version 22. You are advised to use [indicatorInteractive](arkts-arkui-swiper-attribute.md#indicatorinteractive) instead.
