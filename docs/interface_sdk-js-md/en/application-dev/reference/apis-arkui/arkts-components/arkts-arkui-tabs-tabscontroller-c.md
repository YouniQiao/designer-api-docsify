...
> preloading in the [onAppear](arkts-arkui-common-commonmethod-c.md#onappear-1) lifecycle of **Tabs**.  
>  
...
| Type | Description |
| --- | --- |
| [Promise](../../apis-na/arkts-apis/arkts-na-lib-es5-promise-i.md)<void> | Promise used to return the value. |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| translate | [TranslateOptions](arkts-arkui-common-translateoptions-i.md) | Yes | Translation distance of the tab bar. |
