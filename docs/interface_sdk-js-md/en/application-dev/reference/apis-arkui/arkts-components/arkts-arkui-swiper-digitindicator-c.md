...
A constructor used to create a **DigitIndicator** object. It inherits from [Indicator](arkts-arkui-swiper-indicator-c.md).
...
| Type | Description |
| --- | --- |
| [DigitIndicator](arkts-arkui-swiper-digitindicator-c.md) | Current digit-style navigation indicator. |
