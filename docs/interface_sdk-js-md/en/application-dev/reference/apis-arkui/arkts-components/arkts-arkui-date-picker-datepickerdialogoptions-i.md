...
Inherited from [DatePickerOptions](arkts-arkui-date-picker-datepickeroptions-i.md).

**Inheritance/Implementation:** DatePickerDialogOptions extends [DatePickerOptions](arkts-arkui-date-picker-datepickeroptions-i.md)
