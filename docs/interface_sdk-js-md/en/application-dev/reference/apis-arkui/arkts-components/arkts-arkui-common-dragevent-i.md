...
Sets the execution function of the custom drop animation. This parameter is valid only when [useCustomDropAnimation](arkts-arkui-common-dragevent-i.md#usecustomdropanimation) is set to **true**.
...
Obtains the ID of the screen where the current drag event occurs. This API is not supported in the [onDragEnd](arkts-arkui-common-commonmethod-c.md#ondragend-1) callback.
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| keys | [Array](../../apis-na/arkts-apis/arkts-na-lib-es5-array-i.md)<string> | Yes | Obtains the pressed status of modifier keys. For details about the error message,see the following error codes. The following modifier keys are supported: 'Ctrl' \| 'Alt' \| 'Shift'.<br>**NOTE**<br>This API is not supported in stylus scenarios. |
...
| Type | Description |
| --- | --- |
| [Rectangle](arkts-arkui-common-rectangle-i.md) | Position of the drag preview relative to the current window and the preview size, in vp. x and y indicate the window coordinates of the upper left corner of the preview, and width and height indicate the preview size. |
...
| Type | Description |
| --- | --- |
| [DragResult](arkts-arkui-common-dragresult-e.md) | Drag result. |
...
**Substitutes:** [getWindowX](arkts-arkui-common-dragevent-i.md#getwindowx-1)
...
**Substitutes:** [getWindowY](arkts-arkui-common-dragevent-i.md#getwindowy-1)
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| dragResult | [DragResult](arkts-arkui-common-dragresult-e.md) | Yes | Drag result. |
...
If this parameter is not set or is set to **false**, the default drop animation takes effect. When [setResult](arkts-arkui-common-dragevent-i.md#setresult-1)is set to **DRAG_SUCCESSFUL**, a shrink-out animation takes effect. Otherwise, an expand-out animation takes effect.
