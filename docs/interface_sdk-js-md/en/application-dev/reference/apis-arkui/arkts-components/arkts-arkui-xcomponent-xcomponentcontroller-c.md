...
| Type | Description |
| --- | --- |
| [Object](../../apis-na/arkts-apis/arkts-na-lib-es5-object-i.md) | Context of the XComponent object.The APIs contained in the context are defined by developers.The context is passed in as the first parameter of the onLoad callback. |
...
**Substitutes:** [setXComponentSurfaceRect](arkts-arkui-xcomponent-xcomponentcontroller-c.md#setxcomponentsurfacerect-1)
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| config | [ImageAnalyzerConfig](../arkts-apis/arkts-arkui-image-common-imageanalyzerconfig-i.md) | Yes | Settings of the AI image analyzer. |
