...
> [onDataAdd](arkts-arkui-lazy-for-each-datachangelistener-i.md#ondataadd-1) instead.

**Since:** 7

**Deprecated since:** 8

**Substitutes:** [onDataAdd](arkts-arkui-lazy-for-each-datachangelistener-i.md#ondataadd-1)
...
> This API is deprecated since API version 8. You are advised to use  
> [onDataChange](arkts-arkui-lazy-for-each-datachangelistener-i.md#ondatachange-1) instead.

**Since:** 7

**Deprecated since:** 8

**Substitutes:** [onDataChange](arkts-arkui-lazy-for-each-datachangelistener-i.md#ondatachange-1)
...
> This API is deprecated since API version 8. You are advised to use  
> [onDataDelete](arkts-arkui-lazy-for-each-datachangelistener-i.md#ondatadelete-1) instead.

**Since:** 7

**Deprecated since:** 8

**Substitutes:** [onDataDelete](arkts-arkui-lazy-for-each-datachangelistener-i.md#ondatadelete-1)
...
> This API is deprecated since API version 8. You are advised to use  
> [onDataMove](arkts-arkui-lazy-for-each-datachangelistener-i.md#ondatamove-1) instead.
...
**Substitutes:** [onDataMove](arkts-arkui-lazy-for-each-datachangelistener-i.md#ondatamove-1)
