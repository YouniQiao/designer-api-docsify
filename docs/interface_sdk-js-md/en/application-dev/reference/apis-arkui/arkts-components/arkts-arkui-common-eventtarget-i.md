...
Defines the type of the **target** parameter in [BaseEvent](arkts-arkui-common-baseevent-i.md).
...
Custom node [ID](arkts-arkui-common-commonmethod-c.md#id-1). Default value: **undefined**.
