...
**Type:** [KeyboardAvoidMode](arkts-arkui-common-comp-keyboardavoidmode-e.md)
...
API version 11 and later: TRANSPARENT plus [COMPONENT_ULTRA_THICK](arkts-arkui-common-comp-blurstyle-e.md)
