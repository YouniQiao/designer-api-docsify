...
Describes the focus axis event object. Inherits from [BaseEvent](arkts-arkui-common-baseevent-i.md).

**Inheritance/Implementation:** FocusAxisEvent extends [BaseEvent](arkts-arkui-common-baseevent-i.md)
