...
| --- | --- | --- | --- |
| context | \_\_\_MD\_LINK\_USD\_0\_\_\_ \| DrawingRenderingContext | No | 2D rendering context for a canvas. \_\_\_HTML\_TAG\_USD\_0\_\_\_**CanvasRenderingContext2D**: Canvases cannot share one **CanvasRenderingContext2D** object. **DrawingRenderingContext**: Canvases cannot share one **DrawingRenderingContext** object. \_\_\_HTML\_TAG\_USD\_1\_\_\_If the value is **null** or **undefined**, **context** is considered unset.  |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| context | \_\_\_MD\_LINK\_USD\_0\_\_\_ \| DrawingRenderingContext | Yes | 2D rendering context for a canvas. \_\_\_HTML\_TAG\_USD\_0\_\_\_**CanvasRenderingContext2D**: Canvases cannot share one **CanvasRenderingContext2D** object. **DrawingRenderingContext**: Canvases cannot share one **DrawingRenderingContext** object. \_\_\_HTML\_TAG\_USD\_1\_\_\_If the value is **null** or **undefined**, **context** is considered unset.  |
| imageAIOptions | \_\_\_MD\_LINK\_USD\_0\_\_\_ | Yes | AI image analysis options. You can configure the analysis type or bind an analyzer controller through this parameter. \_\_\_HTML\_TAG\_USD\_0\_\_\_If the value is **null** or **undefined**, the default value of **ImageAIOptions** is used.  |
...
Creates a **Canvas** component that does not cache commands using **CanvasParams**.The maximum allowed size cannot exceed 10000 px × 10000 px. If the size exceeds this limit,the **Canvas** component will fail to be created.
    ...
    * Scenarios where the component is not visible mainly include: the page containing the  
    ...
    [visibility]\_\_\_JSDOC\_LINK\_DESC\_USD\_0\_\_\_  
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| params | \_\_\_MD\_LINK\_USD\_0\_\_\_ | Yes | Construction parameters of the **Canvas** component.  |
