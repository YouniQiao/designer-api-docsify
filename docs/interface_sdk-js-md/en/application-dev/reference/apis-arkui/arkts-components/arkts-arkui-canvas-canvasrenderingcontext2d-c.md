...
| --- | --- | --- | --- |
| settings | [RenderingContextSettings](arkts-arkui-canvas-renderingcontextsettings-c.md) | No | Drawing attribute. For details, see [RenderingContextSettings](arkts-arkui-canvas-renderingcontextsettings-c.md). |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| callback | [VoidCallback](../arkts-apis/arkts-arkui-voidcallback-t.md) | No | Indicates the listener. |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| callback | [VoidCallback](../arkts-apis/arkts-arkui-voidcallback-t.md) | Yes | Indicates the listener. |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| config | [ImageAnalyzerConfig](../arkts-apis/arkts-arkui-imagecommon-imageanalyzerconfig-i.md) | Yes | Image analyzer config. |
