...
| Type | Description |
| --- | --- |
| [VideoAttribute](arkts-arkui-video-attribute.md) | The attribute of the Video. |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| style | [CustomBuilderT](../../apis-default/arkts-apis/arkts-custombuildert-t.md)&lt;[VideoAttribute](arkts-arkui-video-attribute.md)&gt; | Yes | the callback to set up component's attributes. |

**Return value:**

| Type | Description |
| --- | --- |
| [VideoAttribute](arkts-arkui-video-attribute.md) |  |
