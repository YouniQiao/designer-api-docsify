...
**Substitutes:** showDatePickerDialog
...
| --- | --- | --- | --- |
| options | [DatePickerDialogOptions](arkts-arkui-date-picker-datepickerdialogoptions-i.md) | No | Parameters of the date picker dialog box. |
