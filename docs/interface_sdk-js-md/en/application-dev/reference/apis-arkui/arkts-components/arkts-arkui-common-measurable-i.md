...
| Type | Description |
| --- | --- |
| [DirectionalEdgesT](../arkts-apis/arkts-arkui-units-directionaledgest-i.md)<number> | Border widths of the child component. |
...
| Type | Description |
| --- | --- |
| [DirectionalEdgesT](../arkts-apis/arkts-arkui-units-directionaledgest-i.md)<number> | Margin values of the child component. |
...
| Type | Description |
| --- | --- |
| [DirectionalEdgesT](../arkts-apis/arkts-arkui-units-directionaledgest-i.md)<number> | Padding values of the child component. |
...
| --- | --- | --- | --- |
| constraint | [ConstraintSizeOptions](../arkts-apis/arkts-arkui-units-constraintsizeoptions-i.md) | Yes | Size constraint. |
