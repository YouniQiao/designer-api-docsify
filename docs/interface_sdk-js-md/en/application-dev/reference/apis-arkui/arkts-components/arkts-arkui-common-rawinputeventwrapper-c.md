...
> not provide valid values: the trigger object [target](arkts-arkui-common-eventtarget-i.md), coordinates relative to the component  
> [x](arkts-arkui-common-mouseevent-i.md#x) and [y](arkts-arkui-common-mouseevent-i.md#y), [getCurrentLocalPosition](arkts-arkui-common-touchobject-i.md#getcurrentlocalposition-1)  
> and [stopPropagation](arkts-arkui-common-touchevent-i.md#stoppropagation) methods, [preventDefault](arkts-arkui-common-touchevent-i.md#preventdefault) and  
> [getHistoricalPoints](arkts-arkui-common-touchevent-i.md#gethistoricalpoints-1) methods of **TouchEvent**, as well as the [metaKey](arkts-arkui-common-keyevent-i.md#metakey)  
> attribute and [getModifierKeyState](arkts-arkui-common-keyevent-i.md#getmodifierkeystate-1) method of **KeyEvent**.
...
| Type | Description |
| --- | --- |
| [MouseEvent](arkts-arkui-common-mouseevent-i.md) | Mouse event object if it is a mouse event, or **null** otherwise. |
