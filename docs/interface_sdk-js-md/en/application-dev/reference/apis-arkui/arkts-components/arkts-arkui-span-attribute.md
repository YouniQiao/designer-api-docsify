...
Among universal events, only [onClick](arkts-arkui-commonmethod-c.md#onclick) click events and [onHover](arkts-arkui-commonmethod-c.md#onhover) hover events are supported.
