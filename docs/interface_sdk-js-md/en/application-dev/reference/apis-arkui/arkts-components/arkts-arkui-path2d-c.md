...
| transform | [Matrix2D](../arkts-apis/arkts-arkui-canvaspattern-matrix2d-c.md) | No | Transformation matrix of the new path.The **undefined** and **null** values are treated as invalid.Default value: **null**. |
