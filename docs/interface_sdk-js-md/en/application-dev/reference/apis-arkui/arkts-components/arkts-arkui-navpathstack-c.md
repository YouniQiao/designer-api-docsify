...
Removes the navigation destination page specified by **navDestinationId** from the routing stack.**navDestinationId** can be obtained from the [onReady](NavDestinationAttribute#onReady) callback of **NavDestination** or from [NavDestinationInfo](../arkts-apis/arkts-arkui-uiobserver-navdestinationinfo-i.md).
