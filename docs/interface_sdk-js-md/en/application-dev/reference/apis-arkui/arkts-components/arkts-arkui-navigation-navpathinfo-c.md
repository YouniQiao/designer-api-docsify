...
| onPop | import('../api/@ohos.base').Callback<PopInfo> | No | Callback returned when [pop](NavPathStack#pop(result: Object, animated?: boolean)),[popToName](arkts-arkui-navigation-navpathstack-c.md#poptoname-2), or [popToIndex](arkts-arkui-navigation-navpathstack-c.md#poptoindex-2) is called on the navigation destination page. It is triggered only when the **result** parameter is set in [pop](NavPathStack#pop(result: Object, animated?: boolean)),[popToName](arkts-arkui-navigation-navpathstack-c.md#poptoname-2), or [popToIndex](arkts-arkui-navigation-navpathstack-c.md#poptoindex-2).<br>**Since:** 11 |
...
Unique ID of the navigation destination page. This ID is system-generated and globally unique. It can be obtained using the [getPathStack](arkts-arkui-navigation-navpathstack-c.md#getpathstack-1) API and should not be manually reassigned.
...
Callback returned when [pop](NavPathStack#pop(result: Object, animated?: boolean)),[popToName](arkts-arkui-navigation-navpathstack-c.md#poptoname-2), or [popToIndex](arkts-arkui-navigation-navpathstack-c.md#poptoindex-2) is called on the navigation destination page. It is triggered only when the **result** parameter is set in [pop](NavPathStack#pop(result: Object, animated?: boolean)),[popToName](arkts-arkui-navigation-navpathstack-c.md#poptoname-2), or [popToIndex](arkts-arkui-navigation-navpathstack-c.md#poptoindex-2).
