...
| Type | Description |
| --- | --- |
| [PathAttribute](arkts-arkui-path-attribute.md) | The attribute of the Path. |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| style | [CustomBuilderT](../../apis-default/arkts-apis/arkts-custombuildert-t.md)&lt;[PathAttribute](arkts-arkui-path-attribute.md)&gt; | Yes | the callback to set up component's attributes. |

**Return value:**

| Type | Description |
| --- | --- |
| [PathAttribute](arkts-arkui-path-attribute.md) |  |
