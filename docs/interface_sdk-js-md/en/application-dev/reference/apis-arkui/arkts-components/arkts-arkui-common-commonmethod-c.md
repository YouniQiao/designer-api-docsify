...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| actions | [Array](../../apis-na/arkts-apis/arkts-na-lib-es5-array-i.md)<AccessibilityCustomAction> \| undefined | Yes | Array of custom accessibility operations, where<br>each operation contains an operation name and a callback, used for binding custom operation callbacks to<br>components by operation name.<br>**NOTE**: The array supports a maximum of 16 entries; any excess will not take effect.<br>When the value is **undefined**, no custom operations are set. |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| drawLevel | [FocusDrawLevel](../arkts-apis/arkts-arkui-enums-focusdrawlevel-e.md) | Yes | Drawing level for the accessibility focus highlight frame. |
...
| accessibilityOptions | [AccessibilityOptions](../arkts-apis/arkts-arkui-units-accessibilityoptions-i.md) | Yes | accessibilityOptions for accessibility, default value is false. |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| nextId | string | Yes | [Unique ID](arkts-arkui-common-commonmethod-c.md#id-1) of the next component to receive focus.<br>If the ID does not correspond to any component, the setting is ignored. |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| role | [AccessibilityRoleType](arkts-arkui-common-accessibilityroletype-e.md) | Yes | Role of the component as announced by screen readers (for example, button or<br>chart). You can define custom roles. |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| pageMode | [AccessibilitySamePageMode](arkts-arkui-common-accessibilitysamepagemode-e.md) | Yes | Same-page mode for the cross-process embedded component<br>and the host application. |
...
Sets the alignment mode for child elements within the container's drawing area. This attribute can be dynamically set using [attributeModifier](arkts-arkui-common-commonmethod-c.md#attributemodifier-1).
...
Sets the alignment mode for child elements within the container's drawing area. The mirroring capability is supported. This attribute can be dynamically set using [attributeModifier](arkts-arkui-common-commonmethod-c.md#attributemodifier-1).
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| alignment | Alignment \| LocalizedAlignment | Yes | Alignment mode for child elements in container drawing area.The mirroring capability is supported.The [LocalizedAlignment](../arkts-apis/arkts-arkui-enums-localizedalignment-e.md) type is effective only in the following components: [Shape](Shape),[Button](../../apis-input-kit/arkts-apis/arkts-input-multimodalinput-mouseevent-button-e.md),[GridItem](GridItem),[FlowItem](FlowItem),[ImageAnimator](ImageAnimator),[LoadingProgress](LoadingProgress),[PatternLock](PatternLock),[Progress](../../apis-core-file-kit/arkts-apis/arkts-corefile-file-fs-progress-i.md),[QRCode](QRCode),[TextClock](TextClock),[TextTimer](TextTimer),[StepperItem](StepperItem),[MenuItem](MenuItem),[Toggle](MenuItem),[Checkbox](Checkbox), and [ListItem](ListItem).For the above components, mirror switching is effective for all except the [ListItem](ListItem), component, which behaves identically to [Alignment](../arkts-apis/arkts-arkui-enums-alignment-e.md). Components where **LocalizedAlignment** is not applicable will be rendered in accordance with their default behavior.<br>Default value: **Alignment.Center**, **LocalizedAlignment.CENTER**.If an invalid value is passed, the default value will be used, indicating center alignment.<br>**NOTE**<br>The [Alignment](../arkts-apis/arkts-arkui-enums-alignment-e.md) type does not support the mirroring capability. The [LocalizedAlignment](../arkts-apis/arkts-arkui-enums-localizedalignment-e.md) type supports mirroring based on the layout direction(configurable via [direction](arkts-arkui-common-commonmethod-c.md#direction-1)) or system language. The **direction** setting takes precedence over the system language direction. When **direction** is explicitly set to any value other than **auto**, **LocalizedAlignment** mirroring follows the specified direction. If **direction** is set to **auto** or not configured, **LocalizedAlignment** mirroring adapts to the system language direction |
...
Sets the alignment rule for child components within the relative container. This attribute only takes effect when the parent container is [RelativeContainer](RelativeContainer),and supports dynamic configuration via [attributeModifier](arkts-arkui-common-commonmethod-c.md#attributemodifier-1).
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| value | [AlignRuleOption](arkts-arkui-common-alignruleoption-i.md) | Yes | Alignment rules in the relative container. |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| alignRule | [LocalizedAlignRuleOptions](arkts-arkui-common-localizedalignruleoptions-i.md) | Yes | Alignment rules in the relative container. |
...
> [renderGroup](arkts-arkui-common-commonmethod-c.md#rendergroup-1) to minimize frame freezing and improve animation  
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| modifier | [AttributeModifier](arkts-arkui-common-attributemodifier-i.md)<T> | Yes | The if/else syntax is supported. |
...
| options | [BlurOptions](arkts-arkui-common-bluroptions-i.md) | No | Grayscale parameters.<br>**Since:** 11 |
...
Applies a background blur effect to the component. You can customize the blur radius and grayscale parameters.Compared to [backdropBlur](arkts-arkui-common-commonmethod-c.md#backdropblur-1), the **radius** parameter supports the **undefined** type.
...
| options | [BlurOptions](arkts-arkui-common-bluroptions-i.md) | No | Grayscale parameters. |
...
Applies a background blur effect to the component. You can customize the blur radius and grayscale parameters.Compared with [backdropBlur<sup>18+</sup>](arkts-arkui-common-commonmethod-c.md#backdropblur-2),this API adds the **sysOptions** parameter, which allows for system adaptive adjustments.
...
| radius | [Optional](arkts-arkui-optional-t.md)<number> | Yes | Background blur effect to apply to the component. The input parameter is the blur radius. The larger the radius is, the more blurred the background is. If the value is **0**, the background is not blurred.<br>If **radius** is **undefined**, the background blur reverts to its default state(that is, no blur). |
| options | [BlurOptions](arkts-arkui-common-bluroptions-i.md) | No | Grayscale parameters. |
| sysOptions | [SystemAdaptiveOptions](arkts-arkui-common-systemadaptiveoptions-i.md) | No | System adaptive adjustment options.<br>Default value:**{ disableSystemAdaptation: false }** |
...
| options | [BackgroundOptions](arkts-arkui-common-backgroundoptions-i.md) | No |  |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| value | [BlurStyle](arkts-arkui-common-blurstyle-e.md) | Yes | Settings of the background blur style, including the blur radius, mask color, mask opacity, saturation, and brightness. |
| options | [BackgroundBlurStyleOptions](arkts-arkui-common-backgroundblurstyleoptions-i.md) | No | Background blur options.<br>This parameter cannot be used in ArkTS widgets. |
...
Defines the background material blur style. It encapsulates various blur radius, mask color, mask opacity,saturation, and brightness values through enum values. Compared to [backgroundBlurStyle<sup>9+</sup>](arkts-arkui-common-commonmethod-c.md#backgroundblurstyle-1),the **style** parameter supports the **undefined** type.
...
Defines the background material blur style. It encapsulates various blur radius, mask color, mask opacity,saturation, and brightness values through enum values. Compared with [backgroundBlurStyle<sup>18+</sup>](arkts-arkui-common-commonmethod-c.md#backgroundblurstyle-2),this API adds the **sysOptions** parameter, which allows for system adaptive adjustments.
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| params | [BackgroundBrightnessOptions](arkts-arkui-common-backgroundbrightnessoptions-i.md) | Yes | Parameters for setting the background brightness. |
...
Sets the background brightness of the component. Compared to [backgroundBrightness<sup>12+</sup>](arkts-arkui-common-commonmethod-c.md#backgroundbrightness-1),the **options** parameter supports the **undefined** type.
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| options | [BackgroundEffectOptions](arkts-arkui-common-backgroundeffectoptions-i.md) | Yes | Background effect of the component, including the blur radius,brightness, saturation, and color. |
...
Sets the background effect of the component, including the blur radius, brightness, saturation, and color. Compared to [backgroundEffect<sup>11+</sup>](arkts-arkui-common-commonmethod-c.md#backgroundeffect-1), the **options** parameter supports the **undefined** type.
...
Sets the background effect of the component, including the blur radius, brightness, saturation, and color. Compared with [backgroundEffect<sup>18+</sup>](arkts-arkui-common-commonmethod-c.md#backgroundeffect-2),this API adds the **sysOptions** parameter, which allows for system adaptive adjustments.
...
| --- | --- | --- | --- |
| options | [Optional](arkts-arkui-optional-t.md)<BackgroundEffectOptions> | Yes | Background effect of the component, including the blur radius, brightness, saturation, and color.<br>If **options** is **undefined**, the background reverts to its default state with no effect. |
| sysOptions | [SystemAdaptiveOptions](arkts-arkui-common-systemadaptiveoptions-i.md) | No |  |
...
| repeat | [ImageRepeat](../arkts-apis/arkts-arkui-enums-imagerepeat-e.md) | No |  |
...
| options | [BackgroundImageOptions](arkts-arkui-common-backgroundimageoptions-i.md) | No | config the options |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| value | [ResizableOptions](arkts-arkui-image-resizableoptions-i.md) | Yes | Indicates the resizable options. |
...
| type | [ModalTransition](arkts-arkui-common-modaltransition-e.md) | No | System transition mode of the modal.<br> Default value:**ModalTransition.DEFAULT**.<br>**NOTE**<br> This property has no effect when it is set together with **transition**. |
...
| options | [ContentCoverOptions](arkts-arkui-common-contentcoveroptions-i.md) | No | Optional attributes of the modal. |
...
| responseType | [ResponseType](../arkts-apis/arkts-arkui-enums-responsetype-e.md) | Yes | Indicates response type of context menu, Long pressing with a mouse device is not supported. |
| options | [ContextMenuOptions](arkts-arkui-common-contextmenuoptions-i.md) | No | Indicates the options of context menu. |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| content | [Array](../../apis-na/arkts-apis/arkts-na-lib-es5-array-i.md)<MenuElement> \| CustomBuilder | Yes | Indicates the content of menu.<br>**Since:** 11 |
...
| content | [Array](../../apis-na/arkts-apis/arkts-na-lib-es5-array-i.md)<MenuElement> \| CustomBuilder | Yes | Indicates the content of menu. |
| options | [MenuOptions](arkts-arkui-common-menuoptions-i.md) | No | Indicates the options of menu. |
...
| options | [SheetOptions](arkts-arkui-common-sheetoptions-i.md) | No | Optional attributes of the sheet. |
...
| options | [TipsOptions](arkts-arkui-common-tipsoptions-i.md) | No |  |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| value | [BlendMode](arkts-arkui-common-blendmode-e.md) | Yes | Blend mode.<br>Default value: **BlendMode.NONE**<br>**NOTE**<br>When **BlendMode.NONE** is used, the blend effect is **BlendMode.SRC_OVER** by default, and **BlendApplyType** does not take effect. |
| type | [BlendApplyType](arkts-arkui-common-blendapplytype-e.md) | No | Whether the blend mode is implemented offscreen.<br>Default value:**BlendApplyType.FAST**<br>**NOTE**<br>1. **BlendApplyType.FAST**: The blend mode is not implemented offscreen.<br>2. **BlendApplyType.OFFSCREEN**: An offscreen canvas of the size of the current component is created. The content of the current component (including child components) is then drawn onto the offscreen canvas, and blended with the existing content on the canvas below using the specified blend mode. This approach may cause issues with screen capture for APIs such as [linearGradientBlur&lt;sup&gt;12+&lt;/sup&gt;](arkts-arkui-common-commonmethod-c.md#lineargradientblur-1),[backgroundEffect](arkts-arkui-common-commonmethod-c.md#backgroundeffect-1),[brightness](arkts-arkui-common-commonmethod-c.md#brightness-1), and [blur](arkts-arkui-common-commonmethod-c.md#blur-1). |
...
Defines how the component's content (including the content of it child components) is blended with the existing content on the canvas (possibly offscreen canvas) below. Compared to [blendMode<sup>11+</sup>](arkts-arkui-common-commonmethod-c.md#blendmode-1), the **mode** parameter supports the **undefined** type.
...
Applies a foreground blur effect to the component. Compared to [blur](arkts-arkui-common-commonmethod-c.md#blur-1), the **blurRadius** parameter supports the **undefined** type.
...
Applies a foreground blur effect to the component. Compared to [blur<sup>18+</sup>](arkts-arkui-common-commonmethod-c.md#blur-2), this API adds the **sysOptions** parameter, which allows for system adaptive adjustments.
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| value | [BorderOptions](../arkts-apis/arkts-arkui-units-borderoptions-i.md) | Yes | - Unified border style.<br>The default value is **0**, indicating that no border is displayed.<br>Since API version 9, the parent node's border is displayed above child node content. |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| value | [BorderImageOption](arkts-arkui-common-borderimageoption-i.md) | Yes | Border image or border gradient. |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| value | Length \| BorderRadiuses \| LocalizedBorderRadiuses | Yes | Radius of the border corners. The value can be expressed as a percentage of the component's width. When combined with the [clip](arkts-arkui-common-commonmethod-c.md#clip-1)attribute, this setting clips child components to prevent them from extending beyond the component's boundaries.<br>**Since:** 12 |
...
| type | [RenderStrategy](../arkts-apis/arkts-arkui-enums-renderstrategy-e.md) | No | Rendering strategy for drawing rounded corners.<br>Default value: RenderStrategy.FAST. |
...
Applies a brightness effect to the component. If this API is not used, there will be no change by default. Compared with [brightness](arkts-arkui-common-commonmethod-c.md#brightness-1), this API supports the **undefined** type for the **brightness** parameter.
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| direction | [Axis](../arkts-apis/arkts-arkui-enums-axis-e.md) | Yes | indicates direction of the chain |
| style | [ChainStyle](arkts-arkui-common-chainstyle-e.md) | Yes | indicates style of the chain |
...
Since API version 23, dynamic configuration via [attributeModifier](arkts-arkui-common-commonmethod-c.md#attributemodifier-1) is supported
...
Sets the click feedback effect of the component. Compared with [clickEffect](arkts-arkui-common-commonmethod-c.md#clickeffect-1), this API supports the **undefined** type.
...
Sets whether to clip the areas of child components that extend beyond this component's bounds, that is, whether to perform clipping based on the edge contour of the parent container If this API is not used, the area of child components extending beyond the current component's bounds is not clipped by default. Compared with [clip<sup>12+</sup>](arkts-arkui-common-commonmethod-c.md#clip-1), this API supports the **undefined** type.
...
**Substitutes:** [clipShape](arkts-arkui-common-commonmethod-c.md#clipshape-1)
...
Clips this component according to the specified shape (which may include position information). Compared with [clipShape<sup>12+</sup>](arkts-arkui-common-commonmethod-c.md#clipshape-1),this API supports the **undefined** type.
...
Applies a color blend effect to the component. Compared with [colorBlend](arkts-arkui-common-commonmethod-c.md#colorblend-1), this API supports the **undefined** type for the **color** parameter.
...
Applies a contrast effect to the component. If this API is not used, there will be no change by default. Compared to [contrast](arkts-arkui-common-commonmethod-c.md#contrast-1), the **contrast** parameter supports the **undefined** type.
...
Sets how elements are laid out along the main axis of the container. This attribute supports dynamic configuration via [attributeModifier](arkts-arkui-common-commonmethod-c.md#attributemodifier-1).
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| value | CustomBuilder \| DragItemInfo \| string | Yes | Preview image displayed during component drag operations.It only applies to [onDragStart](arkts-arkui-common-commonmethod-c.md#ondragstart-1) drag mode.<br>If the component supports drag and drop and a preview is specified through [bindContextMenu](arkts-arkui-common-commonmethod-c.md#bindcontextmenu-1),that specified preview is displayed when the component is dragged. The priority of the background image returned in [onDragStart](arkts-arkui-common-commonmethod-c.md#ondragstart-1) is lower than that of the preview set in [dragPreview](CommonMethod#dragPreview(value: CustomBuilder \| DragItemInfo \| string)). This means that,once set, the latter will be used in place of the former. Using [CustomBuilder](../../../../reference/apis-arkui/arkui-ts/ts-types.md#custombuilder8) requires offline rendering and may increase performance overhead and latency. In light of this, you are advised to use [PixelMap](../../apis-image-kit/arkts-apis/arkts-image-image-pixelmap-i.md) in [DragItemInfo](arkts-arkui-common-dragiteminfo-i.md) instead.<br> When an ID of the string type is passed in, the snapshot of the component assigned the ID is used as the preview image. If the component assigned the ID cannot be found or its [Visibility](../arkts-apis/arkts-arkui-enums-visibility-e.md) attribute is set to **None** or **Hidden**, a snapshot of the current component is used as the preview image. Currently,snapshots do not support visual effects, such as brightness, shadow, blur, and rotation.<br>**Since:** 12 |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| preview | CustomBuilder \| DragItemInfo \| string | Yes | Preview image displayed during component drag operations. It only applies to [onDragStart](arkts-arkui-common-commonmethod-c.md#ondragstart-1) drag mode.<br>If the component supports drag and drop and a preview is specified through [bindContextMenu](arkts-arkui-common-commonmethod-c.md#bindcontextmenu-1),that specified preview is displayed when the component is dragged. The priority of the background image returned in [onDragStart](arkts-arkui-common-commonmethod-c.md#ondragstart-1) is lower than that of the preview set in [dragPreview](CommonMethod#dragPreview(value: CustomBuilder \| DragItemInfo \| string)). This means that,once set, the latter will be used in place of the former. Using [CustomBuilder](../../../../reference/apis-arkui/arkui-ts/ts-types.md#custombuilder8) requires offline rendering and may increase performance overhead and latency. In light of this, you are advised to use [PixelMap](../../apis-image-kit/arkts-apis/arkts-image-image-pixelmap-i.md) in [DragItemInfo](arkts-arkui-common-dragiteminfo-i.md) instead.<br> When an ID of the string type is passed in, the snapshot of the component assigned the ID is used as the preview image. If the component assigned the ID cannot be found or its [Visibility](../arkts-apis/arkts-arkui-enums-visibility-e.md) attribute is set to **None** or **Hidden**, a snapshot of the current component is used as the preview image. Currently,snapshots do not support visual effects, such as brightness, shadow, blur, and rotation. |
| config | [PreviewConfiguration](arkts-arkui-common-previewconfiguration-i.md) | No | Additional settings for the drag preview.<br>This parameter is effective only for previews set using [dragPreview](CommonMethod#dragPreview(value: CustomBuilder \| DragItemInfo \| string)). |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| value | [DragPreviewOptions](arkts-arkui-common-dragpreviewoptions-i.md) | Yes | Preview image processing mode and badge count during dragging. |
| options | [DragInteractionOptions](arkts-arkui-common-draginteractionoptions-i.md) | No | Interaction behavior for the floating preview image.<br>Default value:empty<br>**Since:** 12 |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| types | [Array](../../apis-na/arkts-apis/arkts-na-lib-es5-array-i.md)<SafeAreaType> | No | Types of non-safe areas to extend into. For the CUTOUT type to take effect,the Metadata item must be added to the configuration file.<br>Default value: [SafeAreaType.SYSTEM, SafeAreaType.CUTOUT, SafeAreaType.KEYBOARD].<br>Invalid values are treated as the default value. |
| edges | [Array](../../apis-na/arkts-apis/arkts-na-lib-es5-array-i.md)<SafeAreaEdge> | No | Edges for expanding the safe area.<br>Default value: [SafeAreaEdge.TOP, SafeAreaEdge.BOTTOM, SafeAreaEdge.START, SafeAreaEdge.END].<br>Invalid values are treated as the default value. The default value means to extend to all non-safe areas. |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| style | [FocusBoxStyle](../arkts-apis/arkts-arkui-focus-focusboxstyle-i.md) | Yes | System focus box style for the component.<br>**NOTE**<br>This style affects only the components that display the system focus box during focus traversal. |
...
| --- | --- | --- | --- |
| scopeId | string | Yes |  |
| priority | [FocusPriority](../arkts-apis/arkts-arkui-focus-focuspriority-e.md) | No | the default value is AUTO |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| value | [BlurStyle](arkts-arkui-common-blurstyle-e.md) | Yes | Settings of the foreground blur style. |
| options | [ForegroundBlurStyleOptions](arkts-arkui-common-foregroundblurstyleoptions-i.md) | No | Defines the foreground blur options. For details about the default value, see [ForegroundBlurStyleOptions](arkts-arkui-common-foregroundblurstyleoptions-i.md). |
...
Applies a foreground blur style to the component. Compared to [foregroundBlurStyle](arkts-arkui-common-commonmethod-c.md#foregroundblurstyle-1),the **style** parameter supports the **undefined** type.
...
Sets the foreground color of the component. Components without explicit foreground color settings inherit from their parent components by default. Compared to [foregroundColor](arkts-arkui-common-commonmethod-c.md#foregroundcolor-1), the **color** parameter supports the **undefined** type.
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| options | [ForegroundEffectOptions](arkts-arkui-common-foregroundeffectoptions-i.md) | Yes | Foreground effect settings, including the blur radius. |
...
Sets whether to freeze the component. When frozen, the component and its children are cached for repeated drawing after offscreen rendering, without updating internal attributes. Compared with [freeze](arkts-arkui-common-commonmethod-c.md#freeze-1), this API supports the **undefined** type for the **freeze** parameter.
...
| --- | --- | --- | --- |
| id | string | Yes | ID used to set up a binding relationship. Setting **id** to an empty string clears the binding relationship. The value can be changed to re-establish the binding relationship. One ID can be bound to only two components, which function as in and out components. |
| options | [GeometryTransitionOptions](arkts-arkui-common-geometrytransitionoptions-i.md) | No | Settings of the implicit shared element transition. |
...
| mask | [GestureMask](../arkts-apis/arkts-arkui-gesture-gesturemask-e.md) | No | Mask for gesture events.<br>Default value: **GestureMask.Normal**. |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| modifier | [GestureModifier](arkts-arkui-common-gesturemodifier-i.md) | Yes | for dynamically setting gestures bound to the current component. The if/else syntax is supported. |
...
Applies a grayscale effect to the component. The grayscale rendering of the upper layer will overlay that of lower-layer child components. If this API is not used, there will be no change by default. Compared to [grayscale](arkts-arkui-common-commonmethod-c.md#grayscale-1), the **grayscale** parameter supports the **undefined** type.
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| value | boolean | Yes | Whether to set the component as the default focus of the parent container. This parameter takes effect only when the container is new and obtains focus for the first time. <br>**true**: The component is the default focus of the parent container.<br>**false**: The component is not the default focus of the parent container.<br>**NOTE**<br>This parameter must be used together with [tabIndex](arkts-arkui-common-commonmethod-c.md#tabindex-1). When **tabIndex** is set for a container and **groupDefaultFocus(true)** is set for a child in the container or for the container itself, then when the container obtains focus for the first time through sequential Tab navigation, the focus automatically moves to the specified component. If **groupDefaultFocus(true)** is set for multiple components in the container (including the container itself), the first component found in the component tree in-depth traversal receives the focus. |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| value | [HitTestMode](../arkts-apis/arkts-arkui-enums-hittestmode-e.md) | Yes | Hit test mode for a component. |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| value | [HoverEffect](../arkts-apis/arkts-arkui-enums-hovereffect-e.md) | Yes | Hover effect of the component. |
...
Rotates the hue of the component. If this API is not used, there will be no change by default. Compared to [hueRotate](arkts-arkui-common-commonmethod-c.md#huerotate-1), the **rotation** parameter supports the **undefined** type.
...
> [LayoutPolicy.matchParent](arkts-arkui-common-layoutpolicy-c.md#matchparent), both its size and position  
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| types | [Array](../../apis-na/arkts-apis/arkts-na-lib-es5-array-i.md)<LayoutSafeAreaType> | No | Types of layout safe areas to expand.<br>Default value:[LayoutSafeAreaType.SYSTEM](expands to all safe areas, including the status bar, navigation bar, andcomponent-level safe area (safeAreaPadding)). navigation bar, and component-level safe area<br>Invalid values are treated as the default value. |
| edges | [Array](../../apis-na/arkts-apis/arkts-na-lib-es5-array-i.md)<LayoutSafeAreaEdge> | No | Edges of the layout safe area to expand, with mirroring capability supported.<br>Default value: [LayoutSafeAreaEdge.ALL](expands all edges of the component).<br>Invalid values are treated as the default value. |
...
Inverts an image. Compared with [invert](arkts-arkui-common-commonmethod-c.md#invert-1), this API supports the **undefined** type for the **options** parameter.
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| value | string \| FunctionKey | Yes | Character key (which can be entered through the keyboard) or [function key](../arkts-apis/arkts-arkui-enums-functionkey-e.md).<br>An empty string means to disable the keyboard shortcut.<br> |
| keys | [Array](../../apis-na/arkts-apis/arkts-na-lib-es5-array-i.md)<ModifierKey> | Yes | Modifier keys.<br>This parameter can be left empty only when **value** is set to a [function key](../arkts-apis/arkts-arkui-enums-functionkey-e.md).<br> |
...
Sets the alignment rule for child components in the **Stack** container. This API only takes effect when the parent container is **Stack**. When used with the [align](arkts-arkui-common-commonmethod-c.md#align-1) attribute, **layoutGravity** takes precedence. This attribute supports dynamic configuration via [attributeModifier](arkts-arkui-common-commonmethod-c.md#attributemodifier-1).
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| alignment | [LocalizedAlignment](../arkts-apis/arkts-arkui-enums-localizedalignment-e.md) | Yes | Alignment rule of child components in the **Stack** container.If an invalid value is passed, the default value is used. Default value: **LocalizedAlignment.CENTER**. |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| value | number \| string | Yes | Layout weight of the component.<br>When the parent container size is determined:<br>Elements without **layoutWeight** or with **layoutWeight** set to **0** take precedence in occupying space.<br>The remaining space on the main axis is then allocated proportionally among elements with a **layoutWeight** value greater than 0, ignoring their own size settings.<br>Default value: **0**<br>**NOTE**<br>This parameter is only effective in [Row](Row), [Column](Column), and [Flex](Flex) container components.<br>The value can be a number greater than or equal to 0 or a string that can be converted to a number.<br>If any child component in a container has the **layoutWeight** attribute set to a value greater than 0, then child components will no longer be laid out based on [flexShrink](arkts-arkui-common-commonmethod-c.md#flexshrink-1) and [flexGrow](arkts-arkui-common-commonmethod-c.md#flexgrow-1). |
...
Applies a light up effect to the component. Compared to [lightUpEffect<sup>12+</sup>](arkts-arkui-common-commonmethod-c.md#lightupeffect-1), the **degree** parameter supports the **undefined** type.
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| value | [LinearGradientOptions](arkts-arkui-common-lineargradientoptions-i.md) | Yes | Linear gradient.<br>**Since:** 18 |
...
Creates a linear gradient. Compared to [linearGradient](arkts-arkui-common-commonmethod-c.md#lineargradient-1), this API supports the **undefined** type for the **options** parameter.
...
| options | [LinearGradientBlurOptions](arkts-arkui-common-lineargradientbluroptions-i.md) | Yes | Linear gradient blur effect.<br>The linear gradient blur effect is defined by [fractionStops](arkts-arkui-common-lineargradientbluroptions-i.md) and [direction](arkts-arkui-common-lineargradientbluroptions-i.md). |
...
Applies a linear gradient foreground blur effect to the component. Compared with [linearGradientBlur<sup>12+</sup>](arkts-arkui-common-commonmethod-c.md#lineargradientblur-1),this API supports the **undefined** type.
...
| options | [Optional](arkts-arkui-optional-t.md)<LinearGradientBlurOptions> | Yes | Linear gradient blur effect.<br>If **options** is **undefined**, the gradient blur effect reverts to **0**.<br>The linear gradient blur effect is defined by [fractionStops](arkts-arkui-common-lineargradientbluroptions-i.md) and [direction](arkts-arkui-common-lineargradientbluroptions-i.md). |
...
Sets the anchor for element positioning. This attribute supports dynamic configuration via [attributeModifier](arkts-arkui-common-commonmethod-c.md#attributemodifier-1).
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| value | [ProgressMask](arkts-arkui-common-progressmask-c.md) | Yes | Mask to add to the component, which allows for dynamic adjustment of progress,maximum value, and color settings. |
...
Adds a mask to the component to indicate the progress. Compared with [mask<sup>12+</sup>](arkts-arkui-common-commonmethod-c.md#mask-1), this API supports the **undefined** type.
...
**Substitutes:** [maskShape](arkts-arkui-common-commonmethod-c.md#maskshape-1)
...
Adds a mask of the specified shape to the component. Compared with [maskShape<sup>12+</sup>](arkts-arkui-common-commonmethod-c.md#maskshape-1),this API supports the **undefined** type.
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| value | [MotionBlurOptions](arkts-arkui-common-motionbluroptions-i.md) | Yes | Motion blur options. |
...
Applies a motion blur effect to the component being scaled or moved. Compared with [motionBlur](arkts-arkui-common-commonmethod-c.md#motionblur-1), this API supports the **undefined** type for the **motionBlur** parameter.
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| value | [MotionPathOptions](arkts-arkui-common-motionpathoptions-i.md) | Yes | Motion path of the component. |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| value | [Array](../../apis-na/arkts-apis/arkts-na-lib-es5-array-i.md)<Rectangle> \| Rectangle | Yes | Mouse response regions, defining the position and size.<br>The default touch target is the entire component. Default value:<br>{<br>x: 0,<br>y: 0,<br>width: '100%',<br>height: '100%'<br>} |
...
Sets the offset of the component relative to its original position. When **offset** is used in combination with the [position](arkts-arkui-common-commonmethod-c.md#position-1) attribute, the **position** attribute takes precedence and the configured offset will not be applied. This attribute supports dynamic configuration via [attributeModifier](arkts-arkui-common-commonmethod-c.md#attributemodifier-1).
...
This event is not triggered for render attribute changes caused by re-rendering, such as changes to [translate](arkts-arkui-common-commonmethod-c.md#translate-1), [offset](arkts-arkui-common-commonmethod-c.md#offset-1),[markAnchor](arkts-arkui-common-commonmethod-c.md#markanchor-1), [scale](arkts-arkui-common-commonmethod-c.md#scale-1), or [transform](arkts-arkui-common-commonmethod-c.md#transform-1). In addition, if the component position is altered due to drawing changes, for example, through [bindSheet](arkts-arkui-common-commonmethod-c.md#bindsheet-1), this event is also not triggered.

> **NOTE**  
>  
> When a component is bound to both the **onAreaChange** event and the [position](arkts-arkui-common-commonmethod-c.md#position-1)  
...
> [Edges](../arkts-apis/arkts-arkui-graphics-edges-i.md) or [LocalizedEdges](../arkts-apis/arkts-arkui-units-localizededges-i.md).
...
Triggered when the component area changes. The interval at which the callback is triggered can be set using expectedUpdateInterval in [AreaChangeOptions](arkts-arkui-common-areachangeoptions-i.md). This event is triggered only in response to changes in component size or position caused by layout updates.
...
| options | [AreaChangeOptions](arkts-arkui-common-areachangeoptions-i.md) | No | Parameters related to the area change. If not specified,**expectedUpdateInterval** is treated as **0**. |
...
Triggered when this component is mounted to the component tree. Due to the following limitations, it is recommended that you use [onAppear](arkts-arkui-common-commonmethod-c.md#onappear-1) instead of this callback.
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| event | [Callback](../../apis-basic-service-kit/arkts-apis/arkts-basicservices-base-callback-i.md)<AxisEvent> | Yes | [AxisEvent](arkts-arkui-common-axisevent-i.md) object. |
...
When triggered by keyboard or gamepad input, the event's **SourceTool** is **Unknown**, and [SourceType](arkts-arkui-common-sourcetype-e.md) is **KEY** or **JOYSTICK**.
...
When triggered by keyboard or gamepad input, the event's [SourceTool](arkts-arkui-common-sourcetool-e.md) is **Unknown**, and [SourceType](arkts-arkui-common-sourcetype-e.md) is **KEY** or **JOYSTICK**.
...
Triggered when this component is unmounted from the component tree. You are advised to use [onDisAppear](arkts-arkui-common-commonmethod-c.md#ondisappear-1) instead.
...
Triggered when a dragged item enters a valid drop target. This event takes effect only when a listener for the [onDrop](arkts-arkui-common-commonmethod-c.md#ondrop-1) event is enabled.
...
Triggered when a dragged item leaves a valid drop target. This event takes effect only when a listener for the [onDrop](arkts-arkui-common-commonmethod-c.md#ondrop-1) event is enabled.
...
Triggered when a dragged item moves in a valid drop target. This event takes effect only when a listener for the [onDrop](arkts-arkui-common-commonmethod-c.md#ondrop-1) event is enabled.
...
> **NOTE**  
>  
> This API can be called in [attributeModifier](arkts-arkui-common-commonmethod-c.md#attributemodifier-1) since API version 13.
...
Triggered when a dragged item is dropped on a valid drop target. If you do not explicitly call event.[setResult](arkts-arkui-common-dragevent-i.md#setresult-1)() in **onDrop** to set the result of the drag reception, the system handles it as follows:
...
| dropOptions | [DropOptions](arkts-arkui-common-dropoptions-i.md) | No | Parameters for the drop process. |
...
For scenarios where exposure of internal gestures is not required, use the original [onGestureRecognizerJudgeBegin](arkts-arkui-common-commonmethod-c.md#ongesturerecognizerjudgebegin-1)API. Use this API with **exposeInnerGesture** set to **true** only when internal gesture exposure is necessary.
...
Triggered when the component enters a state prior to a gesture-based drag operation. For details about the state prior to the drag-and-drop operation, see [PreDragStatus](arkts-arkui-common-predragstatus-e.md). This API cannot be triggered in mouse-based drag scenarios.
...
> **NOTE**  
>  
> This API can be called within [attributeModifier](arkts-arkui-common-commonmethod-c.md#attributemodifier-1) since API version 23.
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| options | [VisibleAreaEventOptions](arkts-arkui-common-visibleareaeventoptions-i.md) | Yes | Visible area change configuration options. |
...
> [Stack](arkts-arkui-stack.md), [z-order control](arkts-arkui-common-commonmethod-c.md#zindex-1), and  
> [rotate](arkts-arkui-common-commonmethod-c.md#rotate-1) transformations.  
>  
...
>  
> - This API does not support the [scale](arkts-arkui-common-commonmethod-c.md#scale-1) attribute. To enable  
> support for the [scale](arkts-arkui-common-commonmethod-c.md#scale-1) attribute, use  
> [onVisibleAreaChange<sup>22+</sup>](arkts-arkui-common-commonmethod-c.md#onvisibleareachange-2)  
...
| measureFromViewport | boolean | Yes | Visible area calculation mode.<br>**true**: considers the parent's [clip](arkts-arkui-common-commonmethod-c.md#clip-1) attribute. If [clip](arkts-arkui-common-commonmethod-c.md#clip-1)is **false**, areas of the child component beyond the parent's bounds are counted as visible; if [clip](arkts-arkui-common-commonmethod-c.md#clip-1) is **true**, such areas are counted as invisible. **false**:ignores the parent's [clip](arkts-arkui-common-commonmethod-c.md#clip-1) attribute, treating areas beyond the parent's bounds as invisible.<br>When **measureFromViewport** is set to **true**, and an ancestor node has the [scale](arkts-arkui-common-commonmethod-c.md#scale-1) attribute set, the component's visible ratio will be correctly calculated. |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| value | [OutlineOptions](../arkts-apis/arkts-arkui-units-outlineoptions-i.md) | Yes | Outline attributes. |
...
Sets the outline color. If this API is not used, the default color black will be applied. Compared with [outlineColor](arkts-arkui-common-commonmethod-c.md#outlinecolor-1), this API supports the **undefined** type for the **color** parameter.
...
Sets the radius of the outline corners. If this API is not used, there will be no change by default. Compared with [outlineRadius](arkts-arkui-common-commonmethod-c.md#outlineradius-1), this API supports the **undefined** type for the **radius** parameter.
...
Sets the outline style. If this API is not used, a solid line is displayed by default. Compared with [outlineStyle](arkts-arkui-common-commonmethod-c.md#outlinestyle-1), this API supports the **undefined** type for the **style** parameter.
...
Sets the thickness of the outline. If this API is not used, there will be no change by default. Compared with [outlineWidth](arkts-arkui-common-commonmethod-c.md#outlinewidth-1), this API supports the **undefined** type for the **width** parameter.
...
| options | [OverlayOptions](arkts-arkui-common-overlayoptions-i.md) | No | Options for positioning the overlay.<br>**NOTE**<br>In versions earlier than API version 12, **options** is defined as follows:<br>{<br>align?: [Alignment](../arkts-apis/arkts-arkui-enums-alignment-e.md), <br>offset?: {x?: number, y?: number}<br>}<br>**Since:** 12 |
...
> [attributeModifier](arkts-arkui-common-commonmethod-c.md#attributemodifier-1)  
...
Applies a pixel stretch effect to the component. Compared to [pixelStretchEffect<sup>12+</sup>](arkts-arkui-common-commonmethod-c.md#pixelstretcheffect-1), the **options** parameter supports the **undefined** type.
...
Sets the absolute positioning, which determines the position of a child component relative to the content area of the parent component. Dynamic configuration via [attributeModifier](arkts-arkui-common-commonmethod-c.md#attributemodifier-1) is supported.
...
- The [Position](arkts-arkui-common-commonmethod-c.md#position-1) type uses the upper left corner of the parent's content area as the reference point. The [Edges](../arkts-apis/arkts-arkui-graphics-edges-i.md) type uses all four sides of the parent's content area as reference, where **top**, **left**, **right**, and **bottom** define the margins between the component and corresponding sides of the parent's content area. The [LocalizedEdges](../arkts-apis/arkts-arkui-units-localizededges-i.md) type provides the same functionality as Edges while supporting layout mirroring.  
...
- In [RelativeContainer](../../../../reference/apis-arkui/arkui-ts/ts-container-relativecontainer.md), if the child component has [alignRules](arkts-arkui-common-commonmethod-c.md#alignrules-1) set, the **position** attribute will not take effect
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| value | Position \| Edges \| LocalizedEdges | Yes | Absolute positioning that determines the child component's position relative to the parent's content area. The content area of the parent component is calculated by subtracting the [border](arkts-arkui-common-commonmethod-c.md#border-1), [padding](arkts-arkui-common-commonmethod-c.md#padding-1), and [safeAreaPadding](arkts-arkui-common-commonmethod-c.md#safeareapadding-1)values from the parent component's total size. This resulting content area defines the available layout space for child components. This attribute does not take effect when it is set to an abnormal value.<br>**Since:** 12 |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| value | [RadialGradientOptions](arkts-arkui-common-radialgradientoptions-i.md) | Yes | [since 7 - 17] |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| fitMode | [RenderFit](../arkts-apis/arkts-arkui-enums-renderfit-e.md) | Yes | Sets how the final state of the component's content is rendered during its width and height animation process. |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| value | [Array](../../apis-na/arkts-apis/arkts-na-lib-es5-array-i.md)<Rectangle> \| Rectangle | Yes | Touch target, including the position and size.<br>The default touch target is the entire component. Default value:<br>{<br>x: 0,<br>y: 0,<br>width: '100%',<br>height: '100%'<br>}<br> |
...
Sets the touch target list for the component. When this API is called, the [responseRegion](arkts-arkui-common-commonmethod-c.md#responseregion-1) and [mouseResponseRegion](arkts-arkui-common-commonmethod-c.md#mouseresponseregion-1) APIs do not take effect.
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| regions | [Array](../../apis-na/arkts-apis/arkts-na-lib-es5-array-i.md)<ResponseRegion> | Yes | Array of touch targets for the component.<br>Each touch target contains the input tool type, position, and size.<br>Default value:<br>[{<br>tool: ResponseRegionSupportedTool.ALL,<br>x: LengthMetrics.vp(0),<br>y: LengthMetrics.vp(0),<br>width: LengthMetrics.percent(1),<br>height: LengthMetrics.percent(1)<br>}] |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| options | [ReuseOptions](arkts-arkui-common-reuseoptions-i.md) | Yes | The configuration parameter for reusable custom component. |
...
Rotates the component. Compared with [rotate](arkts-arkui-common-commonmethod-c.md#rotate-1), this API supports the **undefined** type.
...
Sets the component rotation effect. Compared with [rotate](arkts-arkui-common-commonmethod-c.md#rotate-2), this API supports the **RotateAngleOptions** type for the **options** parameter.
...
Sets the safe area padding. This allows the container to add a component-level safe area for its child components to extend into. This attribute can be dynamically set using [attributeModifier](arkts-arkui-common-commonmethod-c.md#attributemodifier-1).
...
Applies a saturation effect to the component. If this API is not used, there will be no change by default. Compared to [saturate](arkts-arkui-common-commonmethod-c.md#saturate-1), the **saturate** parameter supports the **undefined** type.
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| value | [ScaleOptions](arkts-arkui-common-scaleoptions-i.md) | Yes | Scale ratio along the x-, y-, and z-axis. The default value is **1**. **centerX** and **centerY** are used to set the scale center point.<br>Default value:<br>{<br>x: 1,<br>y: 1,<br>z: 1,<br>centerX:'50%',<br>centerY:'50%'<br>} |
...
Scales the component. Compared with [scale](arkts-arkui-common-commonmethod-c.md#scale-1), this API supports the **undefined** type.
...
Converts the image to a sepia tone, reducing color intensity to create a warm, vintage image style. Compared to [sepia](arkts-arkui-common-commonmethod-c.md#sepia-1), this API supports the **undefined** type for the **sepia** parameter.
...
Applies a shadow effect to the component. Compared to [shadow](arkts-arkui-common-commonmethod-c.md#shadow-1), the **options** parameter supports the **undefined** type.
...
Applies a spherical effect to the component. Compared to [sphericalEffect<sup>12+</sup>](arkts-arkui-common-commonmethod-c.md#sphericaleffect-1), the **effect** parameter supports the **undefined** type.
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| value | [StateStyles](arkts-arkui-common-statestyles-i.md) | Yes |  |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| value | [SweepGradientOptions](arkts-arkui-common-sweepgradientoptions-i.md) | Yes | [since 7 - 17] |
...
> [nextFocus](arkts-arkui-common-commonmethod-c.md#nextfocus-1).
...
**Substitutes:** [hitTestBehavior](arkts-arkui-common-commonmethod-c.md#hittestbehavior-1)
...
Displays the matrix transformation when 2D transformation is performed. If 3D transformation is included, the [transform3D](arkts-arkui-common-commonmethod-c.md#transform3d-1) API is required.
...
Displays the matrix transformation when 2D transformation is performed. If 3D transformation is included, the [transform3D](arkts-arkui-common-commonmethod-c.md#transform3d-1) API is required. Compared with [transform](../../../../reference/apis-arkui/arkui-ts/ts-universal-attributes-transformation.md#transform), the transform<sup>18+</sup> parameter supports the undefined type.
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| value | TransitionOptions \| TransitionEffect | Yes | Transition effects used when a component is inserted or removed.<br>**NOTE**<br>For details, see [TransitionOptions](arkts-arkui-common-transitionoptions-i.md) and [TransitionEffect](arkts-arkui-common-transitioneffect-c.md). |
...
Sets the transition effects used when a component is inserted or removed. Compared with [transition](arkts-arkui-common-commonmethod-c.md#transition-1), this API provides the callback when the transition animation ends.
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| effect | [TransitionEffect](arkts-arkui-common-transitioneffect-c.md) | Yes | Transition effects used when a component is inserted or removed. |
...
Translates the component. Compared with [translate](arkts-arkui-common-commonmethod-c.md#translate-1), this API supports the **undefined** type.
...
| effectType | [EffectType](arkts-arkui-common-effecttype-e.md) | Yes | Type of effect to apply to the component, which is defined by&lt;!--Del--&gt;the parent **EffectComponent** or &lt;!--DelEnd--&gt;the window.<br>Default value: **EffectType.DEFAULT**. |
...
| effectType | [EffectType](arkts-arkui-common-effecttype-e.md) | No | Type of effect to apply to the component, which is defined by &lt;!--Del--&gt;the parent **EffectComponent** or &lt;!--DelEnd--&gt;the window.<br>Default value: **EffectType.DEFAULT**. |
...
Sets whether to render child node shadows at the same layer, enabling shadow overlap within the same layer.Compared with [useShadowBatching<sup>11+</sup>](arkts-arkui-common-commonmethod-c.md#useshadowbatching-1), this API supports the **undefined** type for the **use** parameter.
