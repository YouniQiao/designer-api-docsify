...
> 
> - This document covers static widget development only. For comprehensive widget development guidance, see the [widget development guide](../../../form/formkit-overview.md).
