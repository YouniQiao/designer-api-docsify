...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| src | [PixelMap](arkts-arkui-pixelmap-t.md) \| ResourceStr \| DrawableDescriptor \| ImageContent | Yes |  |
| reloadKey | string | No |  |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| src | [PixelMap](arkts-arkui-pixelmap-t.md) \| ResourceStr \| DrawableDescriptor | Yes |  |
