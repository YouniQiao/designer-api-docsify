...
| --- | --- | --- | --- |
| value | [BoardStyle](arkts-arkui-tab-content-boardstyle-i.md) | Yes | Background style object for the selected subtab. |

**Return value:**

| Type | Description |
| --- | --- |
| [SubTabBarStyle](arkts-arkui-tab-content-subtabbarstyle-c.md) | **SubTabBarStyle** object. |
...
Sets the [ID](arkts-arkui-common-commonmethod-c.md#id-1) of the subtab.
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| value | string | Yes | [ID](arkts-arkui-common-commonmethod-c.md#id-1) of the subtab. |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| value | [IndicatorStyle](arkts-arkui-tab-content-indicatorstyle-i.md) | Yes | Indicator style object for the selected subtab. |
...
Sets the indicator style of the selected subtab. Compared with [indicator](arkts-arkui-tab-content-subtabbarstyle-c.md#indicator-1), the image format is added. For details about the display effect of the image, see [ImageFit.Cover](../arkts-apis/arkts-arkui-enums-imagefit-e.md). It takes effect only in the horizontal layout.
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| value | [LabelStyle](arkts-arkui-button-labelstyle-i.md) | Yes | Style object for the label text and font of the subtab. |
...
| Type | Description |
| --- | --- |
| [SubTabBarStyle](arkts-arkui-tab-content-subtabbarstyle-c.md) | **SubTabBarStyle** object created. |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| value | [SelectedMode](arkts-arkui-tab-content-selectedmode-e.md) | Yes | Display mode of the selected subtab.<br>Default value: **SelectedMode.INDICATOR** |
