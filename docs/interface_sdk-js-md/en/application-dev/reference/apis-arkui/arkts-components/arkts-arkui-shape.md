...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| value | \_\_\_MD\_LINK\_USD\_0\_\_\_ | Yes | Drawing target. You can draw a shape in a specified **PixelMap** object. If this parameter is not set, the shape is drawn in the current drawing target by default.\_\_\_HTML\_TAG\_USD\_0\_\_\_The **undefined** and **null** values are treated as invalid and will not take effect.  |
