...
For details about how to set colors, see [ResourceColor](ResourceColor). Colors that are not within the types of [ResourceColor](ResourceColor) are invalid.
