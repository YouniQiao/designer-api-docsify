...
**NOTE：**For details about how to set colors, see ResourceColor. Colors that are not within the types of ResourceColor are invalid.If the color in the array is set to **undefined** or **null**, the default color is black.When using the **colors** parameter, take note of the following:
