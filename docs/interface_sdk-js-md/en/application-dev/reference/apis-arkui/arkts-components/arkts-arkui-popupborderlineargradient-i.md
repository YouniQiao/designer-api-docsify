...
**NOTE：**For details about how to set colors, see [ResourceColor](../arkts-apis/arkts-arkui-resourcecolor-t.md). Colors that are not within the types of [ResourceColor](../arkts-apis/arkts-arkui-resourcecolor-t.md) are invalid.If the color in the array is set to **undefined** or **null**, the default color is black.When using the **colors** parameter, take note of the following:
...
Direction of the linear gradient.Default value: **GradientDirection.Bottom**  
**NOTE：**When the direction is set to **GradientDirection.None**, the default value is used.
