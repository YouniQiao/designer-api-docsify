...
**Substitutes:** [STRETCH](arkts-arkui-swiper-swiperdisplaymode-e.md#stretch)
...
**Substitutes:** [AUTO_LINEAR](arkts-arkui-swiper-swiperdisplaymode-e.md#auto_linear)
...
Note: This API is supported since API version 10 and deprecated since API version 12. You are advised to use [Scroller.scrollTo](arkts-arkui-scroll-scroller-c.md#scrollto-1) instead.

**Since:** 10

**Deprecated since:** 12

**Substitutes:** [scrollTo](arkts-arkui-scroll-scroller-c.md#scrollto-1)
