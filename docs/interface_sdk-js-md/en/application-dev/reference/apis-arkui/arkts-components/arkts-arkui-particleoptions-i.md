...
Defines the ParticleOptions Interface.@interface ParticleOptions
...
**NOTE：**
**speed** indicates the acceleration speed, and **angle** indicates the acceleration direction (in angles).Default value: **{ speed:{range:[0.0,0.0]},angle:{range:[0.0,0.0]} }**
...
Particle color.  
**NOTE：**Default value: **{ range:[Color.White,Color.White] }.** Colors cannot be set for image particles.
