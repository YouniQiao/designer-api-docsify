...
The [barWidth](TabsAttribute#barWidth), [barHeight](TabsAttribute#barHeight(value: Length)),[barBackgroundColor](TabsAttribute#barBackgroundColor),[barBackgroundBlurStyle](TabsAttribute#barBackgroundBlurStyle(style: BlurStyle, options: BackgroundBlurStyleOptions)),and [barBackgroundEffect](TabsAttribute#barBackgroundEffect) attributes of **Tabs** will overwrite the [width](arkts-arkui-common-commonmethod-c.md#width-1), [height](arkts-arkui-common-commonmethod-c.md#height-1),[backgroundColor](arkts-arkui-common-commonmethod-c.md#backgroundcolor-2),[backgroundBlurStyle](arkts-arkui-common-commonmethod-c.md#backgroundblurstyle-2),and [backgroundEffect](arkts-arkui-common-commonmethod-c.md#backgroundeffect-2) attributes of **CommonModifier**.

The [align](arkts-arkui-common-commonmethod-c.md#align-1) attribute works only in [BarMode.Scrollable](TabsAttribute#barMode(value: BarMode.Scrollable, options: ScrollableBarModeOptions))mode. In addition, for a horizontal **Tabs** component, it only takes effect when [nonScrollableLayoutStyle](arkts-arkui-tabs-scrollablebarmodeoptions-i.md) is set to an invalid value or is not set.
