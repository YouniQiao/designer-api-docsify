...
[showTimePickerDialog](../../../reference/apis-arkui/arkts-apis-uicontext-uicontext.md#showtimepickerdialog) API in [UIContext](../arkts-apis/arkts-arkui-uicontext.md), which ensures that the time picker dialog box is shown in the intended UI instance.
