...
| --- | --- | --- | --- |
| dataSource | [IDataSource](../arkts-apis/arkts-arkui-lazyforeach-idatasource-i.md) | Yes | LazyForEach** data source. You need to implement related APIs. |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| dataSource | [IDataSource](../arkts-apis/arkts-arkui-lazyforeach-idatasource-i.md) | Yes |  |
| itemGenerator | (item: any, index: number) =&gt; void | Yes |  |
| keyGenerator | (item: any, index: number) =&gt; string | No |  |
| options | [LazyForEachOptions](../arkts-apis/arkts-arkui-lazyforeach-lazyforeachoptions-i.md) | No |  |
