...
| --- | --- | --- | --- |
| rhs | [AnimatableArithmetic](arkts-arkui-common-animatablearithmetic-i.md)<T> | Yes | Another data object to compare for equality with the current object. |
...
| Type | Description |
| --- | --- |
| [AnimatableArithmetic](arkts-arkui-common-animatablearithmetic-i.md)<T> | Result of the multiplication operation. |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| rhs | [AnimatableArithmetic](arkts-arkui-common-animatablearithmetic-i.md)<T> | Yes | Object for the addition operation. |

**Return value:**

| Type | Description |
| --- | --- |
| [AnimatableArithmetic](arkts-arkui-common-animatablearithmetic-i.md)<T> | Result of the addition operation. |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| rhs | [AnimatableArithmetic](arkts-arkui-common-animatablearithmetic-i.md)<T> | Yes | Object for the subtraction operation. |

**Return value:**

| Type | Description |
| --- | --- |
| [AnimatableArithmetic](arkts-arkui-common-animatablearithmetic-i.md)<T> | Result of the subtraction operation. |
