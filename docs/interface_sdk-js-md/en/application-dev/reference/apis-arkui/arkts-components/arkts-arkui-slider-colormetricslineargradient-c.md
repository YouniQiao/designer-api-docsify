...
| --- | --- | --- | --- |
| colorStops | [ColorMetricsStop](arkts-arkui-slider-colormetricsstop-i.md)[] | Yes | Array of linear gradient color stops. Each element describes a color and its stop in the gradient. |
