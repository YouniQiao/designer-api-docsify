...
Inherits [RichEditorRange](arkts-arkui-rich-editor-richeditorrange-i.md).

> **NOTE**  
>  
> Applicable scope of the API: spans involved in the specified range.

**Inheritance/Implementation:** RichEditorParagraphStyleOptions extends [RichEditorRange](arkts-arkui-rich-editor-richeditorrange-i.md)
