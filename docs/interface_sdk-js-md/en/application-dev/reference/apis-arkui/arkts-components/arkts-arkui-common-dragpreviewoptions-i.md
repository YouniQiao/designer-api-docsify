...
Use [shadow](arkts-arkui-common-commonmethod-c.md#shadow-1).

3. Background blur

Use [backgroundEffect](arkts-arkui-common-commonmethod-c.md#backgroundeffect-1) or [backgroundBlurStyle](arkts-arkui-common-commonmethod-c.md#backgroundblurstyle-1).If both are set, the latter setting takes precedence.

4. Rounded corners

Use [border](../../../../reference/apis-arkui/arkui-ts/ts-universal-attributes-border.md#border) or [borderRadius](arkts-arkui-common-commonmethod-c.md#borderradius-1). Modifier settings override mode settings.
