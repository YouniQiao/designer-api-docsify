...
This API can only be called from [MouseEvent](arkts-arkui-common-mouseevent-i.md) to obtain information about historical points of the current frame when [onMouse](arkts-arkui-common-commonmethod-c.md#onmouse-1) is triggered. The mouse event reporting frequency per frame varies across different devices. Typically, only one mouse event is reported per frame. If the number of [MouseEvent](arkts-arkui-common-mouseevent-i.md) instances received in the current frame is greater than 1, the last point of that frame is returned via [onMouse](arkts-arkui-common-commonmethod-c.md#onmouse-1), and the remaining points are treated as historical points.
...
| Type | Description |
| --- | --- |
| [Array](../../apis-na/arkts-apis/arkts-na-lib-es5-array-i.md)<MouseHistoricalPoint> | Array of all historical point information for the current frame. |
...
**Substitutes:** [windowX](arkts-arkui-common-mouseevent-i.md#windowx)
...
**Substitutes:** [windowY](arkts-arkui-common-mouseevent-i.md#windowy)
