...
> **NOTE**  
>  
> 1. This API takes effect only when [dragAnimationType](arkts-arkui-common-dragevent-i-sys.md#draganimationtype) is  
...
Sets the drag animation type. This attribute can only be set during the [onDragStart](arkts-arkui-common-commonmethod-c.md#ondragstart-1) phase and can be obtained in the [onDragStart](arkts-arkui-common-commonmethod-c.md#ondragstart-1), [onDragEnter](arkts-arkui-common-commonmethod-c.md#ondragenter-1),[onDragMove](arkts-arkui-common-commonmethod-c.md#ondragmove-1), [onDragLeave](arkts-arkui-common-commonmethod-c.md#ondragleave-1),[onDrop](arkts-arkui-common-commonmethod-c.md#ondrop-1), and [onDragEnd](arkts-arkui-common-commonmethod-c.md#ondragend-1) callbacks.
