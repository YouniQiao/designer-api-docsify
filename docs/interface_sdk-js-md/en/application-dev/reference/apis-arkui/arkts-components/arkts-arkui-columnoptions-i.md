...
\_\_\_MD\_LINK\_DESC\_USD\_0\_\_\_ is set to  
...
**NOTE**  
The value of **space** can be a number greater than or equal to 0 or a string that can be converted to a number.Default value: **0**.
