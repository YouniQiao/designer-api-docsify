...
| --- | --- | --- | --- |
| enterKey | \_\_\_MD\_LINK\_USD\_0\_\_\_ | Yes | Type of the Enter key. For details, see **EnterKeyType**.  |
| event | \_\_\_MD\_LINK\_USD\_0\_\_\_ | Yes | Submit event, which provides a method to keep the component in editing state. When **EnterKeyType** is set to **NEW\_LINE**, the editing state is retained by default.  |
