...
Default value: { type: PickerIndicatorType.BACKGROUND, borderRadius: { value:12, unit:LengthUnit.vp },backgroundColor: 'sys.color.comp\_background\_tertiary' }If the value of style is undefined, the default value is used.
