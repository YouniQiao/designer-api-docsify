...
| Type | Description |
| --- | --- |
| [LayoutManager](../arkts-apis/arkts-arkui-text-common-layoutmanager-i.md) | **LayoutManager** object. |
...
| --- | --- | --- | --- |
| value | [StyledString](../arkts-apis/arkts-arkui-styled-string-styledstring-c.md) | Yes | Styled string.<br>**NOTE**<br>The child class [MutableStyledString](../arkts-apis/arkts-arkui-styled-string-mutablestyledstring-c.md) of **StyledString** can also serve as the argument. |
...
| options | [SelectionOptions](arkts-arkui-common-selectionoptions-i.md) | No | Configuration options for text selection.<br>Default value:**MenuPolicy.DEFAULT** in **SelectionOptions** |
