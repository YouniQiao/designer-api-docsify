...
Defines the pointer style. > **NOTE：**> > Directly using **cursorControl** can lead to the issue of > [ambiguous UI context](../../../ui/arkts-global-interface.md#ambiguous-ui-context). To avoid this, obtain the > [UIContext](../../apis-na/arkts-apis/arkts-na-arkui-uicontext-uicontext-c.md) object using the **getUIContext()** API and then obtain the > **cursorControl** bound to the instance using the > getCursorController API.
