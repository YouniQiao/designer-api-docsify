...
| others | Array&lt;GestureRecognizer&gt; | Yes | Gesture recognizers of the same [GestureType](../arkts-apis/arkts-arkui-gesturetype-e.md) fromother components with higher priority in the response chain. |
