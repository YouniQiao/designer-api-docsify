...
1. Text truncation occurs when content exceeds column width.2. Invalid values are treated as the default value.3. Individual array elements can be **Undefined** or **Null**, but the entire array cannot be **Undefined[]**  
or **Null[]**.
...
\_\_\_MD\_LINK\_DESC\_USD\_0\_\_\_.2. The [Resource]\_\_\_JSDOC\_LINK\_DESC\_USD\_1\_\_\_ type is supported since API version 20.3. This parameter works only when the picker contains text only.It does not work when the picker contains images or mixed content.4. Single-column pickers: [ResourceStr]\_\_\_JSDOC\_LINK\_DESC\_USD\_2\_\_\_5. Multi-column pickers: [ResourceStr]\_\_\_JSDOC\_LINK\_DESC\_USD\_3\_\_\_[]
