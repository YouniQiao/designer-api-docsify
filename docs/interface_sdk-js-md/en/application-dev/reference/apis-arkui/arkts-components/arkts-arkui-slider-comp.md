...
Sets the accessibility text information of the step points through the [showSteps](arkts-arkui-slider-comp-attribute.md#showsteps) attribute. After it is set, the screen reader reads the set accessibility content. Since API version 20, the [showSteps](arkts-arkui-slider-comp-attribute.md#showsteps) method adds the optional parameter options.
