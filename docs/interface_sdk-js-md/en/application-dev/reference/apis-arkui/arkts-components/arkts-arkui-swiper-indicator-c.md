...
| Type | Description |
| --- | --- |
| [DigitIndicator](arkts-arkui-swiper-digitindicator-c.md) | Digit-style indicator. |
...
| Type | Description |
| --- | --- |
| [DotIndicator](arkts-arkui-swiper-dotindicator-c.md) | Dot-style indicator. |
...
Sets the distance between the navigation indicator and the right edge (in [RTL](../arkts-apis/arkts-arkui-state-management-layoutdirection-e.md) scripts) or the left edge (in [LTR](../arkts-apis/arkts-arkui-state-management-layoutdirection-e.md) scripts) of the **Swiper** component.
