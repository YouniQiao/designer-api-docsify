...
| imageAIOptions | [ImageAIOptions](../arkts-apis/arkts-arkui-imagecommon-imageaioptions-i.md) | No | Options for AI analyzer. |

**Return value:**

| Type | Description |
| --- | --- |
| [CanvasAttribute](arkts-arkui-canvas-attribute.md) | The attribute of the Canvas. |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| style_ | [CustomBuilderT](../../apis-default/arkts-apis/arkts-custombuildert-t.md)&lt;[CanvasAttribute](arkts-arkui-canvas-attribute.md)&gt; | Yes | Canvas attribute instance. |

**Return value:**

| Type | Description |
| --- | --- |
| [CanvasAttribute](arkts-arkui-canvas-attribute.md) |  |
