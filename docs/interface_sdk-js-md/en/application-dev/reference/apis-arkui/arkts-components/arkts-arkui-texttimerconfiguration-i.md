...
**true**: The timer counts down, e.g., from 30s to 0s. **false**: The timer counts up, e.g., from 0s to 30s.Default value: **false**
...
**true**: The timer has started. **false**: The timer has not started.Default value: **false**
