...
Inherited from [BindOptions](arkts-arkui-common-bindoptions-i.md).

Provides content options of the modal.

**Inheritance/Implementation:** ContentCoverOptions extends [BindOptions](arkts-arkui-common-bindoptions-i.md)
