...
| --- | --- | --- | --- |
| options | [RatingOptions](../arkts-apis/arkts-arkui-rating-ratingoptions-i.md) | No | Rating bar options.<br> The default values of the parameters in **RatingOptions** apply if this parameter is not set. |
