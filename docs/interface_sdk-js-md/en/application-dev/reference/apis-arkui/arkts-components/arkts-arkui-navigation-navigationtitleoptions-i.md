...
1. Make sure the **Navigation** component is in full screen.2. When the title bar is in [Free](arkts-arkui-navigation-navigationtitlemode-e.md) display mode or in [STANDARD](arkts-arkui-navigation-barstyle-e.md) layout style, this API has no effect.
