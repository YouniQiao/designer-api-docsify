...
Describes the axis event object. Inherits from [BaseEvent](arkts-arkui-common-baseevent-i.md).

**Inheritance/Implementation:** AxisEvent extends [BaseEvent](arkts-arkui-common-baseevent-i.md)
...
| --- | --- | --- | --- |
| axisType | [AxisType](../arkts-apis/arkts-arkui-enums-axistype-e.md) | Yes | Axis type to check for. |
