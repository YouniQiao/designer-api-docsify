...
| Type | Description |
| --- | --- |
| [RectResult](arkts-arkui-rectresult-i.md) \| undefined | Return the caret rect or undefined value. |
...
| Type | Description |
| --- | --- |
| [PreviewText](../arkts-apis/arkts-arkui-textcommon-previewtext-i.md) \| undefined | Return the PreviewText. |
...
| --- | --- | --- | --- |
| range | [TextRange](../arkts-apis/arkts-arkui-textcommon-textrange-i.md) | No | The visible range. If the parameter is invalid, this method will have no effect. |
...
| options | [SelectionOptions](arkts-arkui-selectionoptions-i.md) | No | Indicates the options of selection. |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| styledString | [StyledString](../arkts-apis/arkts-arkui-styledstring-styledstring-c.md) | Yes | The styledString for placeholder. If the parameter is invalid, this method will have no effect. |
