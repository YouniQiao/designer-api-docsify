...
Inherits from [BaseEvent](arkts-arkui-common-baseevent-i.md).
...
| Type | Description |
| --- | --- |
| [Coordinate2D](../arkts-apis/arkts-arkui-units-coordinate2d-i.md) | - return the coordinates of the top-left corner of the current component based on its real-time position. |
...
**Substitutes:** [windowX](arkts-arkui-common-clickevent-i.md#windowx)
...
**Substitutes:** [windowY](arkts-arkui-common-clickevent-i.md#windowy)
...
X coordinate of the click position in the [component coordinate system](../../../../ui/arkui-glossary.md#component-coordinate-system) based on the clicked element. After [distanceThreshold](arkts-arkui-common-commonmethod-c.md#onclick-2)is set for **onClick**, the click position is the lift-off point. If the event is triggered by a keyboard or gamepad device, the click position is the center of the clicked element.
