...
Supported since API version 10, this example uses the [showUnderline](arkts-arkui-textinput-attribute.md#showunderline), [showError](#showerror10), [showUnit](arkts-arkui-textinput-attribute.md#showunit), and [passwordIcon](#passwordicon10) attributes to demonstrate the effect of the underline in different scenarios. In addition, the underline color can be configured through [underlineColor](#underlinecolor12) (supported since API version 12).
...
This example implements the counter function through the [maxLength](#maxlength), [showCounter](#showcounter11) (available since API version 11), and [showUnderline](arkts-arkui-textinput-attribute.md#showunderline) (available since API version 10) attributes.
