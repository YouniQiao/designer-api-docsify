...
Specifies whether to enable blur optimization for the sheet. When enabled, the sheet background will be rendered using a blur snapshot. This property cannot be dynamically switched after the sheet is presented.
