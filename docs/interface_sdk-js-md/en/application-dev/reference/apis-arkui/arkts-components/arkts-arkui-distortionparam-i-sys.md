...
> is **{ x:0, y:0.7 }** and **bottomLeft** is **{ x:0, y:0.2 }**, the top-left corner is lower than the bottom-left corner, which &gt; violates the spatial logic and may cause rendering exceptions.
