...
> **NOTE**  
>  
> **ListScroller** inherits from [Scroller](arkts-arkui-scroll-scroller-c.md) and has all methods of  
> [Scroller](arkts-arkui-scroll-scroller-c.md).
...
Collapses the [list items](arkts-arkui-listitem.md) in the [EXPANDED](arkts-arkui-list-item-swipeactionstate-e.md) state and sets callback events.
...
| --- | --- | --- | --- |
| options | [CloseSwipeActionOptions](arkts-arkui-list-closeswipeactionoptions-i.md) | No | Callback events for collapsing [list items](arkts-arkui-listitem.md) in the [EXPANDED](arkts-arkui-list-item-swipeactionstate-e.md) state. |
...
| Type | Description |
| --- | --- |
| [RectResult](arkts-arkui-common-rectresult-i.md) | Size of the list item in the list item group and its position relative to the list.<br>Unit: vp |
...
| Type | Description |
| --- | --- |
| [VisibleListContentInfo](arkts-arkui-list-visiblelistcontentinfo-i.md) | Index information of a child component at the specified coordinates. |
...
| align | [ScrollAlign](arkts-arkui-scroll-scrollalign-e.md) | No | How the list item to scroll to is aligned with the container.<br>Default value:**ScrollAlign.START** |
