...
| --- | --- | --- | --- |
| gesture | [GestureHandler](../arkts-apis/arkts-arkui-gesture-gesturehandler-c.md)<T> | Yes | Gesture handler object. |
| priority | [GesturePriority](../arkts-apis/arkts-arkui-gesture-gesturepriority-e.md) | No | Priority of the bound gesture.<br>Default value: **GesturePriority.NORMAL**. |
