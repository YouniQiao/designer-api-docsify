...
| options | [FadingEdgeOptions](arkts-arkui-common-fadingedgeoptions-i.md) | No | The options of fadingEdge. |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| value | [NestedScrollOptions](arkts-arkui-common-nestedscrolloptions-i.md) | Yes | options for nested scrolling. |
...
**Substitutes:** [onDidScroll](arkts-arkui-common-scrollablecommonmethod-c.md#ondidscroll-1)
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| barState | [BarState](../arkts-apis/arkts-arkui-enums-barstate-e.md) | Yes | Scrollbar state.<br>Default value: <em>BarState.Auto</em> for the <em>List</em>, <em  >Grid</em>,and <em>Scroll</em> components and <em>BarState.Off</em> for the <em>WaterFlow</em> component |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| margin | [ScrollBarMargin](../arkts-apis/arkts-arkui-units-scrollbarmargin-i.md) | Yes | Margin of the scrollbar. |
