...
Sets the alignment of child components in the container. When both this attribute and the [align](arkts-arkui-commonmethod-c.md#align) attribute are set, whichever is set last takes effect. When this attribute and the constructor input parameters are set simultaneously, the attribute setting prevails.
