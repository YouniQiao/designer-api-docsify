...
Use [border](../../../../reference/apis-arkui/arkui-ts/ts-universal-attributes-border.md#border) or [borderRadius](arkts-arkui-commonmethod-c.md#borderradius-1). Modifier settings override mode settings.
