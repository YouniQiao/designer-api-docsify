...
| Type | Description |
| --- | --- |
| [PanDirection](arkts-arkui-tapgesture-comp-pandirection-e.md) | Pan direction. |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| value | [PanDirection](arkts-arkui-tapgesture-comp-pandirection-e.md) | Yes | Pan direction. The value supports the AND ( & ) and OR (&#124;) operations.<br>Default value: **PanDirection.All** |
