...
**Inheritance/Implementation:** BounceSymbolEffect extends [SymbolEffect](arkts-arkui-symbolglyph-symboleffect-c.md)
...
| direction | [EffectDirection](arkts-arkui-symbolglyph-effectdirection-e.md) | No | Effect direction.<br>Default value: **EffectDirection.DOWN** |
