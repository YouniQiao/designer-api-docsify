...
A constructor used to create a **DotIndicator** object. It inherits from [Indicator](arkts-arkui-swiper-indicator-c.md).
...
| Type | Description |
| --- | --- |
| [DotIndicator](arkts-arkui-swiper-dotindicator-c.md) | Current dot-style navigation indicator. |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| iconList | [Array](../../apis-na/arkts-apis/arkts-na-lib-es5-array-i.md)<IndicatorIconInfo> | Yes | Indicator items whose icons need to be set. |

**Return value:**

| Type | Description |
| --- | --- |
| [DotIndicator](arkts-arkui-swiper-dotindicator-c.md) | return the DotIndicator. |
