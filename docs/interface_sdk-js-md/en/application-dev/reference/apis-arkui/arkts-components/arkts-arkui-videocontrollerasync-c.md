...
> control commands such as [start](arkts-arkui-videocontroller-c.md#start), [pause](arkts-arkui-videocontroller-c.md#pause),
> [stop](arkts-arkui-videocontroller-c.md#stop), and [reset](#reset) are executed asynchronously. They
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| value | number | Yes | Video playback progress position. <br>Value range: [0, [duration](arkts-arkui-preparedinfo-i.md)] <br>If the **value** is greater than **duration**, the progress jumps to the end. If the **value** is less than 0, the progress does not jump. <br>Unit: s |
| seekMode | [SeekMode](arkts-arkui-seekmode-e.md) | No | Seek mode.<br>Abnormal values **undefined**, **null**, **NaN**, and **Infinity** are processed as **PreviousKeyframe**. <br>Default value: **PreviousKeyframe** |
