...
| Type | Description |
| --- | --- |
| [UnifiedData](arkts-arkui-common-comp-unifieddata-t.md) | Drag-related data. For details about the data obtaining result, see the error code description. |
...
| Type | Description |
| --- | --- |
| [Rectangle](arkts-arkui-common-comp-rectangle-i.md) | Position of the drag preview relative to the current window and the preview size, in vp. x and y indicate the window coordinates of the upper left corner of the preview, and width and height indicate the preview size. |
...
| Type | Description |
| --- | --- |
| [DragResult](arkts-arkui-common-comp-dragresult-e.md) | Drag result. |
...
| Type | Description |
| --- | --- |
| [Summary](arkts-arkui-common-comp-summary-t.md) | Summary of drag data. |
...
**Type:** [DragBehavior](arkts-arkui-common-comp-dragbehavior-e.md)
