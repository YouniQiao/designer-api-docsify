...
**Inheritance/Implementation:** ReplaceSymbolEffect extends [SymbolEffect](arkts-arkui-symbolglyph-symboleffect-c.md)
...
| --- | --- | --- | --- |
| scope | [EffectScope](arkts-arkui-symbolglyph-effectscope-e.md) | No | Effect scope.<br>Default value: **EffectScope.LAYER** |
...
| --- | --- | --- | --- |
| scope | [EffectScope](arkts-arkui-symbolglyph-effectscope-e.md) | No | Effect scope.<br>Default value: **EffectScope.LAYER** |
| replaceType | [ReplaceEffectType](arkts-arkui-symbolglyph-replaceeffecttype-e.md) | No | Replacement effect type.<br>Default value:**ReplaceEffectType.SEQUENTIAL** |
