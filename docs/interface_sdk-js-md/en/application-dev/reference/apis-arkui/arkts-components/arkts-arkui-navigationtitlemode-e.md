...
parameter of the scrollable component's [edgeEffect]\_\_\_JSDOC\_LINK\_DESC\_USD\_0\_\_\_ attribute to **true**. In the non-scrolling state, the height of the title bar is the same as in **Full** mode; in the scrolling state, the minimum height of the title bar is the same as in **Mini** mode.
