...
1. When this parameter is used as the input parameter of [bindMenu](arkts-arkui-common-commonmethod-c.md#bindmenu-2), its default value is **Placement.BottomLeft**.2. When this parameter is used as the input parameter of [bindContextMenu<sup>8+</sup>](arkts-arkui-common-commonmethod-c.md#bindcontextmenu-1) or [bindContextMenuWithResponse<sup>23+</sup>](arkts-arkui-common-commonmethod-c.md#bindcontextmenuwithresponse-1), the menu is displayed at the click position.3. When this parameter is used as the input parameter of [bindContextMenu<sup>12+</sup>](arkts-arkui-common-commonmethod-c.md#bindcontextmenu-2), its default value is **Placement.BottomLeft**.4. If the value of **placement** is **undefined**, **null**, or empty, the default value is used.
...
Preview displayed when the context menu is triggered by a long-press or by calling [bindContextMenu<sup>12+</sup>](arkts-arkui-common-commonmethod-c.md#bindcontextmenu-2).It can be a screenshot of the target component or custom content.
...
For details, see [TransitionEffect](arkts-arkui-common-transitioneffect-c.md).
