...
| --- | --- | --- | --- |
| section | [SectionOptions](arkts-arkui-water-flow-sectionoptions-c.md) | Yes | Sections to add to the end of the **WaterFlow** component. |
...
| sections | [Array](../../apis-na/arkts-apis/arkts-na-lib-es5-array-i.md)<SectionOptions> | No | Sections to add to the section list, beginning from the position specified by **start**. If no section is specified, **splice()** will only delete sections from the **WaterFlow** component. |
...
| section | [SectionOptions](arkts-arkui-water-flow-sectionoptions-c.md) | Yes | New section configuration. |
...
| Type | Description |
| --- | --- |
| [Array](../../apis-na/arkts-apis/arkts-na-lib-es5-array-i.md)<SectionOptions> | Configuration of all sections in the **WaterFlow** component. |
