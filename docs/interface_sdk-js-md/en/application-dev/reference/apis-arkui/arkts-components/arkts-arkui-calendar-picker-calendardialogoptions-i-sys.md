...
Inherits from [CalendarOptions](arkts-arkui-calendar-picker-calendaroptions-i.md).
...
**Inheritance/Implementation:** CalendarDialogOptions extends [CalendarOptions](arkts-arkui-calendar-picker-calendaroptions-i.md)
