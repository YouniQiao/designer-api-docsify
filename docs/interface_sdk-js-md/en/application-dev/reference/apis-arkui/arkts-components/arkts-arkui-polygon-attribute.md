...
| --- | --- | --- | --- |
| value | [Array](../../apis-na/arkts-apis/arkts-na-array-i.md)<any> | Yes | Vertex coordinates of the polygon. A two-dimensional array is passed, and each subarray indicates the `[x, y]` coordinates of a vertex.<br>Default value: **[]** (empty array)<br>Default unit: vp<br>The **undefined** and **null** values are invalid and treated as the default value. |
