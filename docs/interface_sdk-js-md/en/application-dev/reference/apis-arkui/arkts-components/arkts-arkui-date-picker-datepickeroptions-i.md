...
> **NOTE**  
>  
> - For details about how to use **Date**, see [TimePickerOptions](arkts-arkui-time-picker-timepickeroptions-i.md).  
>  
...
In [DatePickerDialog](./date_picker), when **showTime** in [DatePickerDialogOptions](arkts-arkui-date-picker-datepickerdialogoptions-i.md) is **true**, this parameter is ignored and the year,month, day columns are always shown.
