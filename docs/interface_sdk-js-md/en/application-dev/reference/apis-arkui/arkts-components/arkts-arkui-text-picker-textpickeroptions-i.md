...
1. Single-column pickers: string[], [Resource](../../apis-localization-kit/arkts-apis/arkts-localization-resource-resource-i.md),or [TextPickerRangeContent](arkts-arkui-text-picker-textpickerrangecontent-i.md)[]2. Multi-column independent pickers: string[][]3. Multi-column cascading pickers: [TextCascadePickerRangeContent](arkts-arkui-text-picker-textcascadepickerrangecontent-i.md)[]4. The Resource type supports only [strarray.json](../../../../quick-start/resource-categories-and-access.md#resource-group-directories).5. The type and number of columns in the range cannot be dynamically modified.
