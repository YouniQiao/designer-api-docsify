...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| modifier | ContentModifier&lt;[DataPanelConfiguration](arkts-arkui-datapanelconfiguration-i.md)&gt; | Yes | Content modifier to apply to the current component. <br>**modifier**: content modifier. You need a custom class to implement the **ContentModifier** API. |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| value | ResourceColor | Yes | Background color.<br>The value is in hexadecimal ARGB notation. The first two digits indicate transparency. Default value: **'#08182431' |
