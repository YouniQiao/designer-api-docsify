...
| options | [SelectionOptions](arkts-arkui-common-selectionoptions-i.md) | No | Configuration options for text selection.<br>Default value:**MenuPolicy.DEFAULT** |
