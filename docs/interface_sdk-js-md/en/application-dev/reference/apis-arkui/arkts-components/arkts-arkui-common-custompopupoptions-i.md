...
**Substitutes:** [mask](arkts-arkui-common-custompopupoptions-i.md#mask)
...
API version 11 and later: [TRANSPARENT](../../apis-arkgraphics3d/arkts-apis/arkts-arkgraphics3d-scenetypes-color-i.md) plus [COMPONENT_ULTRA_THICK](arkts-arkui-common-blurstyle-e.md)
