...
| Type | Description |
| --- | --- |
| [DeviceNodeInfo](arkts-distributedservice-devicenodeinfo-i-sys.md)[] | list of the obtained device information in [DeviceNodeInfo](arkts-distributedservice-devicenodeinfo-i-sys.md). |
