...
| callback | [Callback](../../apis-basic-service-kit/arkts-apis/arkts-basicservices-base-callback-i.md)&lt;MouseLocation&gt; | No | Callback for receiving reported events. &lt;br&gt; If no callback is specified, listening will be disabled for all **cooperateMouse**. &lt;br&gt; events of the device specified by **networkId**. |
