...
| --- | --- | --- | --- |
| data | T | Yes | Data of the image asset that is ready. It is of the generic type and supports the following data types: ArrayBuffer, [ImageSource](../../apis-image-kit/arkts-apis/arkts-image-imagesource-i.md),[MovingPhoto](arkts-file-photoaccesshelper.md), and boolean. |
| map | [Map](../../apis-na/arkts-apis/arkts-na-map-i.md)<string, string> | No | Additional information about the image asset, such as the image quality.Currently, only **quality** is supported.<br>**Since:** 12 |
