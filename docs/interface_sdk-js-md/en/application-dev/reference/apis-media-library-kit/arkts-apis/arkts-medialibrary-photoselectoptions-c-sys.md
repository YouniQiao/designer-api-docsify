...
To use it as a parameter of [PhotoViewPicker.select](arkts-medialibrary-photoviewpicker-c.md#select-1), request the permission **ohos.permission.INTERACT_ACROSS_LOCAL_ACCOUNTS**.
