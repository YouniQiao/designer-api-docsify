...
| --- | --- | --- | --- |
| itemInfo | [ItemInfo](../../apis-default/arkts-apis/arkts-file-photopickercomponent-iteminfo-c.md) | Yes | Type of the clicked item, which can be a thumbnail item or a camera item. |
| clickType | [ClickType](../../apis-default/arkts-apis/arkts-file-photopickercomponent-clicktype-e.md) | Yes | Enumerates the click operation types. |
