...
| map | [Map](../../apis-na/arkts-apis/arkts-na-map-i.md)<string, string> | Yes | Additional information about the image asset, such as the image quality.Currently, only **quality** is supported. |
