...
Badge configuration. Currently, the **PhotoPickerComponent** supports only one type of badge. For details, see [BadgeType](arkts-medialibrary-filephotopickercomponent-badgetype-e.md).

**Type:** [BadgeConfig](arkts-medialibrary-filephotopickercomponent-badgeconfig-c.md)
...
**Type:** [ReminderMode](arkts-medialibrary-filephotopickercomponent-remindermode-e.md)
...
**Type:** [PickerOrientation](arkts-medialibrary-filephotopickercomponent-pickerorientation-e.md)
...
**Type:** Array&lt;[PreselectedInfo](arkts-medialibrary-filephotopickercomponent-preselectedinfo-c.md)&gt;
...
**Type:** [SingleLineConfig](arkts-medialibrary-filephotopickercomponent-singlelineconfig-c.md)
