...
This parameter is supported only when [ItemType](arkts-medialibrary-filephotopickercomponent-itemtype-e.md) is set to **THUMBNAIL**. Otherwise, it is left empty.
