...
| Type | Description |
| --- | --- |
| [PhotoAccessHelper](arkts-medialibrary-sendablephotoaccesshelper-photoaccesshelper-i.md) | Instance of PhotoAccessHelper. if the operation fails, returns null. |
