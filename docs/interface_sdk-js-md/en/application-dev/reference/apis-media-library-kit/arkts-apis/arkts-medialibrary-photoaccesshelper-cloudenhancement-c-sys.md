...
| triggerMode | ArkTS-Dyn: number  <br>ArkTS-Sta：int | No | Trigger mode of the cloud enhancement task. &lt;br&gt;**- 0**: manually triggered. &lt;br&gt;**- 1**: automatically triggered. &lt;br&gt;The default value is **0**. |
