...
| Type | Description |
| --- | --- |
| Promise&lt;int&gt; | Promise used to return the operation result. The value **0** means that the operation is successful, and **1** means the opposite. |
...
| actionData | int | Yes | Behavior data. |
