...
Represents the child class of [MacSpec](arkts-cryptoarchitecture-cryptoframework-macspec-i.md). It is used as an input parameter for HMAC computation. &gt; **NOTE：**&gt; &gt; **mdName** specifies the HMAC message digest algorithm. It is mandatory.
