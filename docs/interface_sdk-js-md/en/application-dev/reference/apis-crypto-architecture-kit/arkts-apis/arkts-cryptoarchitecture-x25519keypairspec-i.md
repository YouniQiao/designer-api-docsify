...
Defines a child class of [AsyKeySpec](arkts-cryptoarchitecture-asykeyspec-i.md) used to specify full parameters of the public and private keys in the X25519 algorithm.
...
**Inheritance/Implementation:** X25519KeyPairSpec extends [AsyKeySpec](arkts-cryptoarchitecture-asykeyspec-i.md)
