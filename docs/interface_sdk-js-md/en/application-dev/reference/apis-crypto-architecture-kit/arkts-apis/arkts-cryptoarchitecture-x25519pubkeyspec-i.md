...
Defines a child class of [AsyKeySpec](arkts-cryptoarchitecture-asykeyspec-i.md) used to specify the parameters of the public key in the X25519 algorithm.
...
**Inheritance/Implementation:** X25519PubKeySpec extends [AsyKeySpec](arkts-cryptoarchitecture-asykeyspec-i.md)
