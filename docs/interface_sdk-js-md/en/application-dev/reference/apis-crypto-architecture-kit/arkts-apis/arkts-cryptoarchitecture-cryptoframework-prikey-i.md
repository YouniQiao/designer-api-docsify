...
| --- | --- | --- | --- |
| itemType | [AsyKeySpecItem](arkts-cryptoarchitecture-cryptoframework-asykeyspecitem-e.md) | Yes | 指定的密钥参数类型。 |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| format | string | Yes | 用于指定当前密钥格式。支持EC密钥，format取值支持"PKCS8"。 &lt;br&gt;从API版本26.0.0开始，支持RSA密钥，format取值支持"PKCS1"和"PKCS8"。 &lt;br&gt;从API版本26.0.0开始，支持ML-DSA和ML-KEM密钥，format取值支持"PKCS8"。 |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| format | string | Yes | 指定的获取密钥字符串的编码格式。支持RSA密钥，format取值支持"PKCS8"或"PKCS1"。 &lt;br&gt;自API版本26.0.0起，支持EC密钥，format取值支持"PKCS8"或"EC"。 &lt;br&gt;自API版本26.0.0起，支持ML-DSA和ML-KEM密钥，format取值支持"PKCS8"。 |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| format | string | Yes | 指定的获取密钥字符串的编码格式。对于RSA密钥，格式可以是"PKCS8"或"PKCS1"。 |
| config | [KeyEncodingConfig](arkts-cryptoarchitecture-cryptoframework-keyencodingconfig-i.md) | Yes | 用于加密私钥的参数。 |
