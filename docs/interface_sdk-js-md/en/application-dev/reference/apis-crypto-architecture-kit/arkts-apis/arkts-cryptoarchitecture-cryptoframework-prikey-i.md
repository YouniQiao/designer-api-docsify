...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| format | string | Yes | Format of the key. Supports EC keys, with the format value 'PKCS8' supported. Since API version 26.0.0, RSA keys are supported, with the format values 'PKCS1' and 'PKCS8' supported. Since API version 26.0.0, ML-DSA and ML-KEM keys are supported, with the format value 'X509' supported. |

**Return value:**

| Type | Description |
| --- | --- |
| [DataBlob](../../apis-device-certificate-kit/arkts-apis/arkts-devicecertificate-cert-datablob-i.md) | Private key data in DER encoding. |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| format | string | Yes | Encoding format of the key data to obtain. Supports RSA keys, with the format value'PKCS8' or 'PKCS1' supported. Since API version 26.0.0, EC keys are supported, with the format values 'PKCS8' or 'EC' supported. Since API version 26.0.0, ML-DSA and ML-KEM keys are supported, with the format value 'PKCS8' supported. |
...
| Type | Description |
| --- | --- |
| Promise & lt;Uint8Array & gt; | Promise used to return the private key data of the specified key data type. |
