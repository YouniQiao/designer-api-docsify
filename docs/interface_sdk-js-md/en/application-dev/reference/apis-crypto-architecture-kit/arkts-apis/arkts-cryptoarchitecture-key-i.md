...
Provides APIs for key operations. Before performing cryptographic operations (such as encryption and decryption),you need to construct a child class object of **Key** and pass it to [init()](arkts-cryptoarchitecture-cipher-i.md#init-4) of the [Cipher](arkts-cryptoarchitecture-cipher-i.md) instance.

Keys can be generated by a child class key generator. For details, see the child class description. The child classes include [SymKey](arkts-cryptoarchitecture-symkey-i.md), [PubKey](arkts-cryptoarchitecture-pubkey-i.md), and [PriKey](arkts-cryptoarchitecture-prikey-i.md).
...
| Type | Description |
| --- | --- |
| [DataBlob](../../apis-device-certificate-kit/arkts-apis/arkts-devicecertificate-datablob-i.md) | Key obtained. |
