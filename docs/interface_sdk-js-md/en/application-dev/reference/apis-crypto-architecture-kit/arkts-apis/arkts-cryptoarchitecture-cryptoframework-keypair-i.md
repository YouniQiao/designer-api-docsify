...
Defines an asymmetric key pair, which includes a public key and a private key.<br>The asymmetric key pair can be generated by using the asymmetric key generator [AsyKeyGenerator](arkts-cryptoarchitecture-cryptoframework-asykeygenerator-i.md) or [AsyKeyGeneratorBySpec](arkts-cryptoarchitecture-cryptoframework-asykeygeneratorbyspec-i.md).
