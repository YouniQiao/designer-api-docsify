...
| --- | --- | --- | --- |
| spec | [SM2CipherTextSpec](arkts-cryptoarchitecture-sm2ciphertextspec-i.md) | Yes | SM2 ciphertext parameters. |
...
| Type | Description |
| --- | --- |
| [DataBlob](../../apis-device-certificate-kit/arkts-apis/arkts-devicecertificate-datablob-i.md) | SM2 ciphertext in ASN.1 format. |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| cipherText | [DataBlob](../../apis-device-certificate-kit/arkts-apis/arkts-devicecertificate-datablob-i.md) | Yes | SM2 ciphertext in ASN.1 format. |
| mode | string | No | Order of the SM2 parameters in the ciphertext. Currently, only C1C3C2 is supported. If this parameter is left empty or is an empty string, the default value is used. |
...
| Type | Description |
| --- | --- |
| [SM2CipherTextSpec](arkts-cryptoarchitecture-sm2ciphertextspec-i.md) | SM2 ciphertext parameters obtained. |
