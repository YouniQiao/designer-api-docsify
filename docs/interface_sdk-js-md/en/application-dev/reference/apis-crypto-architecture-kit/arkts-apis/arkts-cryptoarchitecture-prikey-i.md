...
Provides APIs for private key operations. **PriKey** is a child class of [Key](arkts-cryptoarchitecture-key-i.md). It needs to be passed in during asymmetric decryption, signing, and key agreement.

The private key can be generated by using the asymmetric key generator [AsyKeyGenerator](arkts-cryptoarchitecture-asykeygenerator-i.md) or [AsyKeyGeneratorBySpec](arkts-cryptoarchitecture-asykeygeneratorbyspec-i.md).

**Inheritance/Implementation:** PriKey extends [Key](arkts-cryptoarchitecture-key-i.md)
...
| --- | --- | --- | --- |
| itemType | [AsyKeySpecItem](arkts-cryptoarchitecture-asykeyspecitem-e.md) | Yes | Key parameter type to obtain. |
...
| Type | Description |
| --- | --- |
| [DataBlob](../../apis-device-certificate-kit/arkts-apis/arkts-devicecertificate-datablob-i.md) | ECC private key data obtained. |
...
| config | [KeyEncodingConfig](arkts-cryptoarchitecture-keyencodingconfig-i.md) | Yes | Options (including the password and algorithm) for encoding the private key. |
...
| Type | Description |
| --- | --- |
| [Promise](../../apis-na/arkts-apis/arkts-na-promise-i.md)<Uint8Array> | Promise used to return the private key data of the specified key data type. |
...
| Type | Description |
| --- | --- |
| [Uint8Array](../../apis-na/arkts-apis/arkts-na-uint8array-i.md) | Private key data of the specified key data type. |
...
<br><br>**NOTE**<br>It is recommended to prioritize the use of asynchronous API, {@link getPubKey}. Synchronous API may take a long time and block the main thread due to system busyness, high load, and other reasons. Therefore,it is advised to invoke synchronous API within a child thread to avoid blocking the main thread.
...
| Type | Description |
| --- | --- |
| [PubKey](arkts-cryptoarchitecture-pubkey-i.md) | Public key object. |
