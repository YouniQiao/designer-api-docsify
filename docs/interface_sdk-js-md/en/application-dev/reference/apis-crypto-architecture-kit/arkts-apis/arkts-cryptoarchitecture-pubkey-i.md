...
Provides APIs for public key operations. **PubKey** is a child class of [Key](arkts-cryptoarchitecture-key-i.md). It needs to be passed in during asymmetric encryption, signature verification,and key agreement.

The public key can be generated by using the asymmetric key generator [AsyKeyGenerator](arkts-cryptoarchitecture-asykeygenerator-i.md) or [AsyKeyGeneratorBySpec](arkts-cryptoarchitecture-asykeygeneratorbyspec-i.md).

**Inheritance/Implementation:** PubKey extends [Key](arkts-cryptoarchitecture-key-i.md)
...
| --- | --- | --- | --- |
| itemType | [AsyKeySpecItem](arkts-cryptoarchitecture-asykeyspecitem-e.md) | Yes | Key parameter to obtain. |
...
| [801](../../apis-ads-kit/errorcode-ads.md#801-ad-request-failure) | This operation is not supported.<br>**Applicable version:** 12 and later |
...
> **NOTE**  
>  
> The difference between [Key.getEncoded()](arkts-cryptoarchitecture-key-i.md#getencoded-1) and this API is as follows:  
...
| Type | Description |
| --- | --- |
| [DataBlob](../../apis-device-certificate-kit/arkts-apis/arkts-devicecertificate-datablob-i.md) | Public key data obtained. |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| itemType | [AsyKeyDataItem](arkts-cryptoarchitecture-asykeydataitem-e.md) | Yes | Key data type. |

**Return value:**

| Type | Description |
| --- | --- |
| [Promise](../../apis-na/arkts-apis/arkts-na-promise-i.md)<Uint8Array> | Promise used to return the public key data of the specified key data type. |
...
<br><br>**NOTE**<br>It is recommended to prioritize the use of asynchronous API, {@link getKeyData}. Synchronous API may take a long time and block the main thread due to system busyness, high load, and other reasons. Therefore,it is advised to invoke synchronous API within a child thread to avoid blocking the main thread.
...
| Type | Description |
| --- | --- |
| [Uint8Array](../../apis-na/arkts-apis/arkts-na-uint8array-i.md) | Public key data of the specified key data type. |
