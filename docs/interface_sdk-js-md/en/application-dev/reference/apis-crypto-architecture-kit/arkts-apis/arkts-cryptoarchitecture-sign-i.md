...
Sets the specified parameter for the Sign object. Currently, only PSS_SALT_LEN in RSA and USER_ID in SM2 are supported.
...
Sets the specified parameter for the Sign object. Currently, only PSS_SALT_LEN in RSA, USER_ID in SM2, and ML_DSA_DETERMINISTIC, ML_DSA_MU, and ML_DSA_CONTEXT in ML-DSA are supported.
