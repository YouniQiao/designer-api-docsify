...
| --- | --- | --- | --- |
| asyKeySpec | [AsyKeySpec](arkts-cryptoarchitecture-cryptoframework-asykeyspec-i.md) | Yes | Key parameters. The **AsyKeyGeneratorBySpec** generates the public/private key based on the specified parameters.For details about the supported specifications, see Asymmetric Key Generation and Conversion Specifications. |
