...
Provides APIs for symmetric key operations. It is a child class of [Key](arkts-cryptoarchitecture-key-i.md).Its objects need to be passed to [init()](arkts-cryptoarchitecture-cipher-i.md#init-4) of the [Cipher](arkts-cryptoarchitecture-cipher-i.md) instance in symmetric encryption and decryption.
