...
| --- | --- | --- | --- |
| icon | [ResourceStr](../../apis-arkui/arkts-apis/arkts-arkui-resourcestr-t.md) \| [TabBarSymbol](arkts-tabcontent-tabbarsymbol-c.md) | Yes | indicates the icon of the bottom tab bar |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| style | [TabBarIconStyle](arkts-tabcontent-tabbariconstyle-i.md) | Yes | style of the label icon on the bottom tab. |

**Return value:**

| Type | Description |
| --- | --- |
| [BottomTabBarStyle](arkts-tabcontent-bottomtabbarstyle-c.md) | the style of the bottom tab bar |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| style | [TabBarLabelStyle](arkts-tabcontent-tabbarlabelstyle-i.md) | Yes | indicates the label style of the bottom tab bar |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| value | [LayoutMode](arkts-tabcontent-layoutmode-e.md) | Yes | layout mode of the images and text on the bottom tab. Default value is LayoutMode.VERTICAL. |
