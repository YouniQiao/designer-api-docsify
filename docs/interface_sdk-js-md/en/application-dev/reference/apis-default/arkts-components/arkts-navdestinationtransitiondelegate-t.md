...
| --- | --- | --- | --- |
| operation | [NavigationOperation](../../apis-arkui/arkts-components/arkts-arkui-navigationoperation-e.md) | Yes | the operation type of current Navigation animation. |
...
| Type | Description |
| --- | --- |
| (Array&lt;[NavDestinationTransition](arkts-navdestination-navdestinationtransition-i.md)&gt; \| undefined) | user-set custom navDestination transitions. |
