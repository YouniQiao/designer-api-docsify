...
Defines the client certificate request result, related to [onClientAuthenticationRequest](arkts-web-attribute.md#onclientauthenticationrequest) method.
...
| credentialTypeOrCertChainFile | [CredentialType](arkts-web-credentialtype-e.md) \| string | Yes | The type of the credential or the file that store client certificate chain. |
