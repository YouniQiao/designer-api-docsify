...
| Type | Description |
| --- | --- |
| [SurfaceRect](arkts-xcomponent-surfacerect-i.md) | The surface rectangle information. |
...
| rect | [SurfaceRect](arkts-xcomponent-surfacerect-i.md) | Yes | The rectangle information of the surface created by XComponent. |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| config | [SurfaceConfig](arkts-xcomponent-surfaceconfig-i.md) | Yes | surface config |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| rect | [SurfaceRect](arkts-xcomponent-surfacerect-i.md) | Yes | The surface rectangle information. |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| rotationOptions | [SurfaceRotationOptions](arkts-xcomponent-surfacerotationoptions-i.md) | Yes | The surface rotation options. |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| config | [ImageAnalyzerConfig](../../apis-arkui/arkts-apis/arkts-arkui-imagecommon-imageanalyzerconfig-i.md) | Yes | Image analyzer config. |
