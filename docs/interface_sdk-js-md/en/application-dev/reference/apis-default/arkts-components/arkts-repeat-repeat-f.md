...
| --- | --- | --- | --- |
| arr | [RepeatArray](arkts-repeatarray-t.md)&lt;T&gt; | Yes | The Data Source. |

**Return value:**

| Type | Description |
| --- | --- |
| [RepeatAttribute](arkts-repeat-attribute.md)&lt;T&gt; |  |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| style | [CustomBuilderT](../arkts-apis/arkts-custombuildert-t.md)&lt;[RepeatAttribute](arkts-repeat-attribute.md)&lt;T&gt;&gt; | Yes | callback to set up Repeat's attributes. |

**Return value:**

| Type | Description |
| --- | --- |
| [RepeatAttribute](arkts-repeat-attribute.md)&lt;T&gt; | The attribute of Repeat. |
