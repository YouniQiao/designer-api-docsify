...
```TypeScript
arrowModifier(modifier: SymbolGlyphModifier | undefined): this
```
...
| --- | --- | --- | --- |
| modifier | [SymbolGlyphModifier](../../apis-arkui/arkts-apis/arkts-arkui-symbolglyphmodifier-c.md) \| undefined | Yes |  |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| value | [ArrowPosition](arkts-select-arrowposition-e.md) \| undefined | Yes |  |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| modifier | [AttributeModifier](../../apis-arkui/arkts-components/arkts-arkui-attributemodifier-i.md)&lt;[SelectAttribute](arkts-select-attribute.md)&gt; \| [AttributeModifier](../../apis-arkui/arkts-components/arkts-arkui-attributemodifier-i.md)&lt;[CommonMethod](../../apis-arkui/arkts-components/arkts-arkui-commonmethod-c.md)&gt; \| undefined | Yes |  |
...
```TypeScript
avoidance(mode: AvoidanceMode | undefined): this
```
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| mode | [AvoidanceMode](arkts-select-avoidancemode-e.md) \| undefined | Yes |  |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| value | [ControlSize](../../apis-arkui/arkts-components/arkts-arkui-controlsize-e.md) \| undefined | Yes |  |
...
```TypeScript
divider(options: DividerOptions | null | undefined): this
```
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| options | [DividerOptions](arkts-textpicker-divideroptions-i.md) \| null \| undefined | Yes |  |
...
```TypeScript
dividerStyle(style: DividerStyleOptions | undefined): this
```
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| style | [DividerStyleOptions](../../apis-arkui/arkts-apis/arkts-arkui-dividerstyleoptions-i.md) \| undefined | Yes |  |
...
```TypeScript
keyboardAvoidMode(mode: MenuKeyboardAvoidMode | undefined): this
```
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| mode | [MenuKeyboardAvoidMode](../../apis-arkui/arkts-components/arkts-arkui-menukeyboardavoidmode-e.md) \| undefined | Yes |  |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| alignType | [MenuAlignType](arkts-select-menualigntype-e.md) \| undefined | Yes |  |
| offset | [Offset](../../apis-arkui/arkts-apis/arkts-arkui-offset-t.md) \| undefined | No |  |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| value | [BlurStyle](../../apis-arkui/arkts-components/arkts-arkui-blurstyle-e.md) \| undefined | Yes |  |
...
```TypeScript
menuBackgroundBlurStyleOptions(blurStyle: BackgroundBlurStyleOptions | undefined): this
```
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| blurStyle | [BackgroundBlurStyleOptions](../../apis-arkui/arkts-components/arkts-arkui-backgroundblurstyleoptions-i.md) \| undefined | Yes |  |
...
```TypeScript
menuBackgroundEffect(effect: BackgroundEffectOptions | undefined): this
```
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| effect | [BackgroundEffectOptions](../../apis-arkui/arkts-components/arkts-arkui-backgroundeffectoptions-i.md) \| undefined | Yes |  |
...
```TypeScript
menuDistortionMode(mode: DistortionMode | undefined): this
```
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| mode | [DistortionMode](../../apis-arkui/arkts-components/arkts-arkui-distortionmode-e-sys.md) \| undefined | Yes |  |
...
```TypeScript
menuEdgeLightMode(mode: EdgeLightMode | undefined): this
```
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| mode | [EdgeLightMode](../../apis-arkui/arkts-components/arkts-arkui-edgelightmode-e-sys.md) \| undefined | Yes |  |
...
```TypeScript
menuItemContentModifier(modifier: ContentModifier<MenuItemConfiguration> | undefined): this
```
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| modifier | [ContentModifier](../../apis-arkui/arkts-components/arkts-arkui-contentmodifier-i.md)&lt;[MenuItemConfiguration](arkts-select-menuitemconfiguration-i.md)&gt; \| undefined | Yes |  |
...
```TypeScript
menuOutline(outline: MenuOutlineOptions | undefined): this
```
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| outline | [MenuOutlineOptions](arkts-select-menuoutlineoptions-i.md) \| undefined | Yes |  |
...
```TypeScript
menuSystemMaterial(material: SystemUiMaterial | undefined): this
```
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| material | [SystemUiMaterial](../../apis-arkui/arkts-components/arkts-arkui-systemuimaterial-t-sys.md) \| undefined | Yes |  |
...
```TypeScript
minKeyboardAvoidDistance(distance: LengthMetrics | undefined): this
```
...
```TypeScript
onSelect(callback: OnSelectCallback | undefined): this
```
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| callback | [OnSelectCallback](arkts-onselectcallback-t.md) \| undefined | Yes |  |
...
```TypeScript
optionTextModifier(modifier: TextModifier | undefined): this
```
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| modifier | [TextModifier](../../apis-arkui/arkts-apis/arkts-arkui-textmodifier-c.md) \| undefined | Yes |  |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| value | [Dimension](../../apis-arkui/arkts-apis/arkts-arkui-dimension-t.md) \| [OptionWidthMode](../../apis-arkui/arkts-apis/arkts-arkui-optionwidthmode-e.md) \| undefined | Yes |  |
...
```TypeScript
selected(numCount: int | Resource | undefined | Bindable<int> | Bindable<Resource>): this
```
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| numCount | int \| [Resource](../../apis-arkui/arkts-apis/arkts-arkui-resource-t.md) \| undefined \| [Bindable](../arkts-apis/arkts-common-bindable-i.md)&lt;int&gt; \| [Bindable](../arkts-apis/arkts-common-bindable-i.md)&lt;[Resource](../../apis-arkui/arkts-apis/arkts-arkui-resource-t.md)&gt; | Yes |  |
...
```TypeScript
selectedOptionTextModifier(modifier: TextModifier | undefined): this
```
...
```TypeScript
setSelectOptions(optionArray: Array<SelectOption>): this
```
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| optionArray | Array&lt;[SelectOption](arkts-select-selectoption-i.md)&gt; | Yes |  |
...
```TypeScript
showDefaultSelectedIcon(show:boolean | undefined): this
```
...
```TypeScript
showInSubWindow(showInSubWindow: boolean | undefined): this
```
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| showInSubWindow | boolean \| undefined | Yes |  |
...
```TypeScript
textModifier(modifier: TextModifier | undefined): this
```
...
```TypeScript
value(resStr: ResourceStr | undefined | Bindable<string> | Bindable<Resource>): this
```
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| resStr | [ResourceStr](../../apis-arkui/arkts-apis/arkts-arkui-resourcestr-t.md) \| undefined \| [Bindable](../arkts-apis/arkts-common-bindable-i.md)&lt;string&gt; \| [Bindable](../arkts-apis/arkts-common-bindable-i.md)&lt;[Resource](../../apis-arkui/arkts-apis/arkts-arkui-resource-t.md)&gt; | Yes |  |
...
<!--Device-SelectAttribute-default--><!--Device-SelectAttribute-default-End-->
