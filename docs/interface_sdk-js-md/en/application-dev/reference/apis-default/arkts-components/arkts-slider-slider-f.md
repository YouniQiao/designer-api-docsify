...
| --- | --- | --- | --- |
| options | [SliderOptions](arkts-slider-slideroptions-i.md) | No | The options |
...
| Type | Description |
| --- | --- |
| [SliderAttribute](arkts-slider-attribute.md) |  |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| style_ | [CustomBuilderT](../arkts-apis/arkts-custombuildert-t.md)&lt;[SliderAttribute](arkts-slider-attribute.md)&gt; | Yes | slider attribute instance |
| content_ | [CustomBuilder](../arkts-apis/arkts-custombuilder-t.md) | No | container |
