...
| --- | --- | --- | --- |
| callback | [ScrollOnScrollCallback](arkts-scrollonscrollcallback-t.md) \| undefined | Yes | callback function, triggered when the Scroll did scroll. Passing undefined will unregister the callback. |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| callback | [ScrollOnWillScrollCallback](arkts-scrollonwillscrollcallback-t.md) \| undefined | Yes | callback function, triggered when the Scroll will scroll. Passing undefined will unregister the callback. |
