...
| --- | --- | --- | --- |
| start | [VisibleListContentInfo](arkts-list-visiblelistcontentinfo-i.md) | Yes | Information about the currently displayed first list item or list item group. |
| end | [VisibleListContentInfo](arkts-list-visiblelistcontentinfo-i.md) | Yes | Information about the currently displayed last list item or list item group. |
