...
| --- | --- | --- | --- |
| modifier | [AttributeModifier](../../apis-arkui/arkts-components/arkts-arkui-attributemodifier-i.md)&lt;[SwiperAttribute](arkts-swiper-attribute.md)&gt; \| [AttributeModifier](../../apis-arkui/arkts-components/arkts-arkui-attributemodifier-i.md)&lt;[CommonMethod](../../apis-arkui/arkts-components/arkts-arkui-commonmethod-c.md)&gt; \| undefined | Yes |  |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| autoPlay | boolean \| undefined | Yes |  |
| options | [AutoPlayOptions](arkts-swiper-autoplayoptions-i.md) \| undefined | Yes |  |
...
| --- | --- | --- | --- |
| count | int \| undefined | Yes |  |
| options | [CachedCountOptions](arkts-swiper-cachedcountoptions-i.md) \| undefined | Yes |  |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| value | [Curve](../../apis-arkui/arkts-apis/arkts-arkui-curve-e.md) \| string \| [ICurve](../../apis-arkui/arkts-components/arkts-arkui-icurve-i.md) \| undefined | Yes |  |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| transition | [SwiperContentAnimatedTransition](arkts-swiper-swipercontentanimatedtransition-i.md) \| undefined | Yes |  |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| value | [ArrowStyle](arkts-swiper-arrowstyle-i.md) \| boolean \| undefined | Yes |  |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| value | int \| string \| [SwiperAutoFill](arkts-swiper-swiperautofill-i.md) \| [ItemFillPolicy](../../apis-arkui/arkts-apis/arkts-arkui-itemfillpolicy-i.md) \| undefined | Yes |  |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| value | [SwiperDisplayMode](arkts-swiper-swiperdisplaymode-e.md) \| undefined | Yes |  |
...
```TypeScript
ignoreHiddenItem(enabled: boolean | undefined): this
```
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| value | int \| [Bindable](../arkts-apis/arkts-common-bindable-i.md)&lt;int&gt; \| undefined | Yes |  |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| indicator | [IndicatorComponentController](../../apis-arkui/arkts-components/arkts-arkui-indicatorcomponentcontroller-c.md) \| [DotIndicator](arkts-swiper-dotindicator-c.md) \| [DigitIndicator](arkts-swiper-digitindicator-c.md) \| boolean \| undefined | Yes |  |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| value | [SwiperNestedScrollMode](arkts-swiper-swipernestedscrollmode-e.md) \| undefined | Yes |  |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| event | [OnSwiperAnimationEndCallback](arkts-onswiperanimationendcallback-t.md) \| undefined | Yes |  |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| event | [OnSwiperAnimationStartCallback](arkts-onswiperanimationstartcallback-t.md) \| undefined | Yes |  |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| handler | [ContentDidScrollCallback](arkts-contentdidscrollcallback-t.md) \| undefined | Yes |  |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| handler | [ContentWillScrollCallback](arkts-contentwillscrollcallback-t.md) \| undefined | Yes |  |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| event | [OnSwiperGestureSwipeCallback](arkts-onswipergestureswipecallback-t.md) \| undefined | Yes |  |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| event | [Callback](../../apis-arkui/arkts-components/arkts-arkui-callback-i.md)&lt;[ScrollState](../../apis-arkui/arkts-components/arkts-arkui-scrollstate-e.md)&gt; \| undefined | Yes |  |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| controller | [SwiperController](arkts-swiper-swipercontroller-c.md) | No |  |
