...
| animationMode | [SwiperAnimationMode](arkts-swiper-swiperanimationmode-e.md) \| boolean | No | animation mode for changeIndex, true is equivalent to SwiperAnimationMode.DEFAULT_ANIMATION, false is equivalent to SwiperAnimationMode.NO_ANIMATION |
