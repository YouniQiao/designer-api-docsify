...
| options | [ScrollEdgeOptions](arkts-scroll-scrolledgeoptions-i.md) | No | Options of scrolling to edge. |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| value | [ScrollPageOptions](arkts-scroll-scrollpageoptions-i.md) | Yes |  |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| options | [ScrollOptions](arkts-scroll-scrolloptions-i.md) | Yes | scroll options |
...
| align | [ScrollAlign](arkts-scroll-scrollalign-e.md) | No | Sets the alignment mode of a specified index. |
| options | [ScrollToIndexOptions](arkts-scroll-scrolltoindexoptions-i.md) | No | Sets the options of a specified index, such as extra offset. <br>Unit: vp. Default value: 0 (unit:vp). |
