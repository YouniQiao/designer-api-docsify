...
| --- | --- | --- | --- |
| options | [TextTimerOptions](arkts-texttimer-texttimeroptions-i.md) | No | text timer options. |

**Return value:**

| Type | Description |
| --- | --- |
| [TextTimerAttribute](arkts-texttimer-attribute.md) |  |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| style | [CustomBuilderT](../arkts-apis/arkts-custombuildert-t.md)&lt;[TextTimerAttribute](arkts-texttimer-attribute.md)&gt; | Yes | TextTimer attribute instance |
