...
**Inheritance/Implementation:** DotIndicator extends [Indicator](arkts-swiper-indicator-c.md)
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| iconList | Array&lt;[IndicatorIconInfo](arkts-swiper-indicatoriconinfo-i.md)&gt; \| undefined | Yes | indicator items need to be set icon. |

**Return value:**

| Type | Description |
| --- | --- |
| [DotIndicator](arkts-swiper-dotindicator-c.md) | return the DotIndicator. |
