...
```TypeScript
attributeModifier(modifier: AttributeModifier<UnionEffectContainerAttribute>
...
| --- | --- | --- | --- |
| modifier | [AttributeModifier](../../apis-arkui/arkts-components/arkts-arkui-attributemodifier-i.md)&lt;[UnionEffectContainerAttribute](arkts-unioneffectcontainer-attribute.md)&gt; \| [AttributeModifier](../../apis-arkui/arkts-components/arkts-arkui-attributemodifier-i.md)&lt;[CommonMethod](../../apis-arkui/arkts-components/arkts-arkui-commonmethod-c.md)&gt; \| undefined | Yes |  |
...
```TypeScript
pointLight(light: PointLightStyle): this
```
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| light | [PointLightStyle](../../apis-arkui/arkts-components/arkts-arkui-pointlightstyle-i-sys.md) | Yes |  |
...
```TypeScript
setUnionEffectContainerOptions(options?: UnionEffectContainerOptions): this
```
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| options | [UnionEffectContainerOptions](arkts-unioneffectcontainer-unioneffectcontaineroptions-i-sys.md) | No |  |
...
```TypeScript
unionMode(mode: UnionMode | undefined): this
```
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| mode | [UnionMode](arkts-unioneffectcontainer-unionmode-e-sys.md) \| undefined | Yes |  |
