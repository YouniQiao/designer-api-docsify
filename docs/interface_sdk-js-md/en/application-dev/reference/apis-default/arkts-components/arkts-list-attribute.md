...
**Inheritance/Implementation:** ListAttribute extends ScrollableCommonMethod
...
| --- | --- | --- | --- |
| value | [ListItemAlign](arkts-list-listitemalign-e.md) \| undefined | Yes |  |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| modifier | [AttributeModifier](../../apis-arkui/arkts-components/arkts-arkui-attributemodifier-i.md)&lt;[ListAttribute](arkts-list-attribute.md)&gt; \| [AttributeModifier](../../apis-arkui/arkts-components/arkts-arkui-attributemodifier-i.md)&lt;[CommonMethod](../../apis-arkui/arkts-components/arkts-arkui-commonmethod-c.md)&gt; \| undefined | Yes |  |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| behavior | [ListBackPressBehavior](arkts-list-listbackpressbehavior-i.md) \| undefined | Yes |  |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| count | int \| [CacheCountInfo](../../apis-arkui/arkts-apis/arkts-arkui-cachecountinfo-i.md) \| undefined | Yes |  |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| value | [ChainAnimationOptions](arkts-list-chainanimationoptions-i-sys.md) \| undefined | Yes |  |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| value | [ChildrenMainSize](../../apis-arkui/arkts-components/arkts-arkui-childrenmainsize-c.md) \| undefined | Yes |  |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| offset | double \| [Resource](../../apis-arkui/arkts-apis/arkts-arkui-resource-t.md) \| undefined | Yes |  |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| value | [ListDividerOptions](arkts-list-listdivideroptions-i.md) \| null \| undefined | Yes |  |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| value | int \| [LengthConstrain](../../apis-arkui/arkts-apis/arkts-arkui-lengthconstrain-t.md) \| [ItemFillPolicy](../../apis-arkui/arkts-apis/arkts-arkui-itemfillpolicy-i.md) \| undefined | Yes |  |
| gutter | [Dimension](../../apis-arkui/arkts-apis/arkts-arkui-dimension-t.md) \| undefined | No |  |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| value | [Axis](../../apis-arkui/arkts-apis/arkts-arkui-axis-e.md) \| undefined | Yes |  |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| event | ((from: int, to: int) =&gt; boolean) \| undefined | Yes |  |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| event | ((start: int, end: int, center: int) =&gt; void) \| undefined | Yes |  |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| handler | [OnScrollVisibleContentChangeCallback](arkts-onscrollvisiblecontentchangecallback-t.md) \| undefined | Yes |  |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| value | [ScrollSnapAlign](arkts-list-scrollsnapalign-e.md) \| undefined | Yes |  |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| speed | [ScrollSnapAnimationSpeed](arkts-list-scrollsnapanimationspeed-e.md) \| undefined | Yes |  |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| value | [StickyStyle](arkts-list-stickystyle-e.md) \| undefined | Yes |  |
