...
The type of alignment between entry and calendar. @enum { int }

**Since:** 23

**ArkTS mode:** ArkTS-Sta since version 23.

<!--Device-unnamed-export declare enum CalendarAlign--><!--Device-unnamed-export declare enum CalendarAlign-End-->
