...
```TypeScript
attributeModifier(modifier: AttributeModifier<SideBarContainerAttribute> | AttributeModifier<CommonMethod> | undefined): this
```
...
| --- | --- | --- | --- |
| modifier | [AttributeModifier](../../apis-arkui/arkts-components/arkts-arkui-attributemodifier-i.md)&lt;[SideBarContainerAttribute](arkts-sidebarcontainer-attribute.md)&gt; \| [AttributeModifier](../../apis-arkui/arkts-components/arkts-arkui-attributemodifier-i.md)&lt;[CommonMethod](../../apis-arkui/arkts-components/arkts-arkui-commonmethod-c.md)&gt; \| undefined | Yes |  |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| value | [ButtonStyle](arkts-sidebar-buttonstyle-i.md) \| undefined | Yes |  |
...
```TypeScript
onChange(callback: ((value: boolean) => void) | undefined): this
```
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| type | [SideBarContainerType](arkts-sidebar-sidebarcontainertype-e.md) | No |  |
...
```TypeScript
showSideBarWithGesture(value: boolean | undefined): this
```
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| value | [SideBarPosition](arkts-sidebar-sidebarposition-e.md) \| undefined | Yes |  |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| value | [Length](../../apis-arkui/arkts-apis/arkts-arkui-length-t.md) \| [Bindable](../arkts-apis/arkts-common-bindable-i.md)&lt;[Length](../../apis-arkui/arkts-apis/arkts-arkui-length-t.md)&gt; \| undefined | Yes |  |
...
<!--Device-SideBarContainerAttribute-default--><!--Device-SideBarContainerAttribute-default-End-->
