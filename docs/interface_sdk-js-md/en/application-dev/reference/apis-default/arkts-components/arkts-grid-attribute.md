...
**Inheritance/Implementation:** GridAttribute extends ScrollableCommonMethod
...
| --- | --- | --- | --- |
| alignment | [GridItemAlignment](arkts-grid-griditemalignment-e.md) \| undefined | Yes |  |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| modifier | [AttributeModifier](../../apis-arkui/arkts-components/arkts-arkui-attributemodifier-i.md)&lt;[GridAttribute](arkts-grid-attribute.md)&gt; \| [AttributeModifier](../../apis-arkui/arkts-components/arkts-arkui-attributemodifier-i.md)&lt;[CommonMethod](../../apis-arkui/arkts-components/arkts-arkui-commonmethod-c.md)&gt; \| undefined | Yes |  |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| value | string \| [ItemFillPolicy](../../apis-arkui/arkts-apis/arkts-arkui-itemfillpolicy-i.md) \| undefined | Yes |  |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| value | [EdgeEffect](../../apis-arkui/arkts-apis/arkts-arkui-edgeeffect-e.md) \| undefined | Yes |  |
| options | [EdgeEffectOptions](../../apis-arkui/arkts-components/arkts-arkui-edgeeffectoptions-i.md) | No |  |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| options | [EditModeOptions](../../apis-arkui/arkts-components/arkts-arkui-editmodeoptions-i.md) | No |  |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| enabled | boolean \| [Bindable](../arkts-apis/arkts-common-bindable-i.md)&lt;boolean&gt; \| undefined | Yes |  |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| mode | [FocusWrapMode](../../apis-arkui/arkts-apis/arkts-arkui-focuswrapmode-e.md) \| undefined | Yes |  |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| value | [GridDirection](arkts-grid-griddirection-e.md) \| undefined | Yes |  |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| handler | [OnScrollCallback](../../apis-arkui/arkts-components/arkts-arkui-onscrollcallback-t.md) \| undefined | Yes |  |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| callback | [Callback](../../apis-arkui/arkts-components/arkts-arkui-callback-i.md)&lt;boolean&gt; \| undefined | Yes |  |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| event | ((event: ItemDragInfo) =&gt; void) \| undefined | Yes |  |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| event | ((event: ItemDragInfo, itemIndex: int) =&gt; void) \| undefined | Yes |  |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| event | ((event: ItemDragInfo, itemIndex: int, insertIndex: int) =&gt; void) \| undefined | Yes |  |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| event | [OnItemDragStartCallback](../../apis-arkui/arkts-components/arkts-arkui-onitemdragstartcallback-t.md) \| undefined | Yes |  |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| event | ((event: ItemDragInfo, itemIndex: int, insertIndex: int, isSuccess: boolean) =&gt; void) \| undefined | Yes |  |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| event | ((index: int, offset: double) =&gt; ComputedBarAttribute) \| undefined | Yes |  |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| event | [OnScrollFrameBeginCallback](../../apis-arkui/arkts-components/arkts-arkui-onscrollframebegincallback-t.md) \| undefined | Yes |  |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| event | ((first: int, last: int) =&gt; void) \| undefined | Yes |  |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| handler | [OnWillScrollCallback](../../apis-arkui/arkts-components/arkts-arkui-onwillscrollcallback-t.md) \| undefined | Yes |  |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| value | [BarState](../../apis-arkui/arkts-apis/arkts-arkui-barstate-e.md) \| undefined | Yes |  |
