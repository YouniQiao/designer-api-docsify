...
| --- | --- | --- | --- |
| value | [BoardStyle](arkts-tabcontent-boardstyle-i.md) | Yes | background style object for the selected subtab. |

**Return value:**

| Type | Description |
| --- | --- |
| [SubTabBarStyle](arkts-tabcontent-subtabbarstyle-c.md) | the style of the sub tab bar |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| content | [ResourceStr](../../apis-arkui/arkts-apis/arkts-arkui-resourcestr-t.md) \| [ComponentContentBase](../arkts-apis/arkts-componentcontent-componentcontentbase-c.md) | Yes | indicates the content of the sub tab bar |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| style | [SubTabBarIndicatorStyle](arkts-tabcontent-subtabbarindicatorstyle-i.md) | Yes | indicates the indicator style of the sub tab bar |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| value | [SubTabBarIndicatorStyle](arkts-tabcontent-subtabbarindicatorstyle-i.md) \| [DrawableTabBarIndicator](arkts-tabcontent-drawabletabbarindicator-i.md) | Yes | indicator style object for the selected subtab. |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| style | [TabBarLabelStyle](arkts-tabcontent-tabbarlabelstyle-i.md) | Yes | indicates the label style of the sub tab bar |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| value | [SelectedMode](arkts-tabcontent-selectedmode-e.md) | Yes | display mode of the selected subtab. Default value is SelectedMode.INDICATOR. |
