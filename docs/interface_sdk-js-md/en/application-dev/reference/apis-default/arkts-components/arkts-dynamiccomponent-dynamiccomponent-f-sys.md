...
| --- | --- | --- | --- |
| options | [DynamicOptions](arkts-dynamiccomponent-dynamicoptions-i-sys.md) | Yes | The options |

**Return value:**

| Type | Description |
| --- | --- |
| [DynamicComponentAttribute](arkts-dynamiccomponent-attribute.md) |  |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| style | [CustomBuilderT](../arkts-apis/arkts-custombuildert-t.md)&lt;[DynamicComponentAttribute](arkts-dynamiccomponent-attribute.md)&gt; | Yes | the callback to set up DynamicComponent's attributes. |

**Return value:**

| Type | Description |
| --- | --- |
| [DynamicComponentAttribute](arkts-dynamiccomponent-attribute.md) | The attribute of the DynamicComponent. |
