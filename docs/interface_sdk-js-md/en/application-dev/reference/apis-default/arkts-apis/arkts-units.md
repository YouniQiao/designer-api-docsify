...
| Name | Description |
| --- | --- |
| [ColorFilter](arkts-units-colorfilter-c.md) | Defines the ColorFilter object. |
...
| Name | Description |
| --- | --- |
| [ColorMetrics](arkts-colormetrics-t.md) | Defines ColorMetrics. |
| [Degree](arkts-degree-t.md) | Defines the angle property with number in units of deg. |
| [Dimension](arkts-dimension-t.md) | Defines the dimension property with number with units(vp\|px\|fp\|lpx\|%), and resource. |
| [DrawingCanvas](arkts-drawingcanvas-t.md) | Defines drawing canvas. |
| [EdgeWidth](arkts-edgewidth-t.md) | Defines the border width property. |
| [FP](arkts-fp-t.md) | Defines the length property with number in units of fp. |
| [Length](arkts-length-t.md) | Defines the length property with string, number and resource unit. |
| [LengthMetrics](arkts-lengthmetrics-t.md) | Defines LengthMetrics. |
| [LengthMetricsUnit](arkts-lengthmetricsunit-t.md) | Defines length metrics unit. |
| [LocalizedMargin](arkts-localizedmargin-t.md) | Defines the localized margin property. |
| [LPX](arkts-lpx-t.md) | Defines the length property with number in units of lpx. |
| [Margin](arkts-margin-t.md) | Defines the margin property. |
| [Percentage](arkts-percentage-t.md) | Defines the length property with number in units of Percentage. |
| [PX](arkts-px-t.md) | Defines the length property with number in units of px. |
| [Resource](arkts-resource-t.md) | Defines the data type of the interface restriction. |
| [ResourceColor](arkts-resourcecolor-t.md) | Defines the color which can use resource. |
| [ResourceStr](arkts-resourcestr-t.md) | Defines the string which can use resource. |
| [ResponsiveFillType](arkts-responsivefilltype-t.md) | Define a responsive item filling pattern that can be used in WaterFlow, Grid, List, and Swiper components. |
| [VoidCallback](arkts-voidcallback-t.md) | Defines VoidCallback. |
| [VP](arkts-vp-t.md) | Defines the length property with number or number in units of vp. |
