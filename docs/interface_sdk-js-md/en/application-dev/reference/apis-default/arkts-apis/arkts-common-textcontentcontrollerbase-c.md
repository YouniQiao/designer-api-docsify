...
| textOperationOptions | [TextContentControllerOptions](arkts-common-textcontentcontrolleroptions-i.md) | No | operation info. |
...
| Type | Description |
| --- | --- |
| [CaretOffset](arkts-common-caretoffset-i.md) \| undefined | index and relative position of the CaretOffset. |
...
| Type | Description |
| --- | --- |
| [RectResult](arkts-common-rectresult-i.md) \| undefined | Text content rect.The unit of the return value is pixel. |
