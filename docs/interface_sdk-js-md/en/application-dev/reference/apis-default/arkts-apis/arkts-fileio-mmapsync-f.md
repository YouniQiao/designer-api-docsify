...
> unexpectedly. You are advised to use other file access APIs such as [read](arkts-fileio-read-f.md),
> [write](arkts-fileio-write-f.md), or [Stream](arkts-fileio-stream-i.md) in this scenario.
