...
| Type | Description |
| --- | --- |
| [FileMapping](../../apis-core-file-kit/arkts-apis/arkts-corefile-filefs-filemapping-i.md) | File mapping object created. Initial state of the returned object: The value of **position** is **0**, and the values of **limit** and **capacity** are equal to the value of **size**. |
