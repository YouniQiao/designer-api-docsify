...
| --- | --- | --- | --- |
| dataType | [DataType](arkts-file-photopickercomponent-datatype-e.md) | Yes | data type |
...
| Type | Description |
| --- | --- |
| Promise&lt;[CompletedResult](arkts-file-photopickercomponent-completedresult-c.md)&gt; | Promise&lt;CompletedResult&gt; |
...
| saveMode | [SaveMode](arkts-file-photopickercomponent-savemode-e.md) | No | Mode of save |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| maxSelected | [MaxSelected](arkts-file-photopickercomponent-maxselected-c.md) | Yes | max select count data |
...
| photoBrowserRange | [PhotoBrowserRange](arkts-file-photopickercomponent-photobrowserrange-e.md) | No | photo browser slide range |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| elements | [PhotoBrowserUIElement](arkts-file-photopickercomponent-photobrowseruielement-e.md)[] | Yes | other elements on the photo browser page |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| updateConfig | [UpdatablePickerConfigs](arkts-file-photopickercomponent-updatablepickerconfigs-c.md) | Yes | Subset of PickerOptions |
