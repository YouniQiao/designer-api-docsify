...
| --- | --- | --- | --- |
| config | [ChipGroupV2ItemStyleConfig](arkts-arkuiadvancedchipgroupv2-chipgroupv2itemstyleconfig-i.md) | Yes | config of chip group item style |
