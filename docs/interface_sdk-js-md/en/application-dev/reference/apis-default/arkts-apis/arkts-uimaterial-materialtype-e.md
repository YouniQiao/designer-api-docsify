...
Immersive material type. It is used only by the **type** attribute of the [MaterialInfo](arkts-uimaterial-materialinfo-i.md) API to identify the current material type and does not map to underlying features. The actual material effect is implemented by the [ImmersiveMaterial](arkts-uimaterial-immersivematerial-c.md) class.
