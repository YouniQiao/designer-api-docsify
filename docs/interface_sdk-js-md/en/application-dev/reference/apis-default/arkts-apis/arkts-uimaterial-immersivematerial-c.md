...
Immersive material class, which inherits from [Material](arkts-uimaterial-materialtype-e.md).
...
**Inheritance/Implementation:** ImmersiveMaterial extends [Material](arkts-uimaterial-material-c-sys.md)
