...
Defines the options used in **readText()**. It inherits from [ReadOptions](arkts-file-fs-readoptions-i.md).

**Inheritance/Implementation:** ReadTextOptions extends [ReadOptions](arkts-file-fs-readoptions-i.md)
