...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| callback | [Callback](arkts-callback-t.md)&lt;[ClickEvent](arkts-common-clickevent-i.md)&gt; \| undefined | Yes | The callback about the click event. If set undefined will reset the target callback. |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| callback | [HoverCallback](arkts-hovercallback-t.md) \| undefined | Yes | The callback will be triggered when has a hover event. If set undefined will reset the target callback. |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| callback | [Callback](arkts-callback-t.md)&lt;[KeyEvent](arkts-common-keyevent-i.md)&gt; \| undefined | Yes | The callback will be triggered when has keyboard input. If set undefined will reset the target callback. |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| callback | [Callback](arkts-callback-t.md)&lt;[MouseEvent](arkts-common-mouseevent-i.md)&gt; \| undefined | Yes | The callback will be triggered when has mouse input. If set undefined will reset the target callback. |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| callback | [SizeChangeCallback](arkts-sizechangecallback-t.md) \| undefined | Yes | The callback will be triggered when the size of component changed. If set undefined will reset the target callback. |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| callback | [Callback](arkts-callback-t.md)&lt;[TouchEvent](arkts-common-touchevent-i.md)&gt; \| undefined | Yes | The callback about the touch event. If set undefined will reset the target callback. |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| options | [VisibleAreaEventOptions](arkts-common-visibleareaeventoptions-i.md) | Yes | The options for the visibility event. |
| event | [VisibleAreaChangeCallback](arkts-visibleareachangecallback-t.md) \| undefined | Yes | The callback will be triggered when the visibleArea of component changed and get close to any number in ratios defined by options. If set undefined will reset the target callback. |
