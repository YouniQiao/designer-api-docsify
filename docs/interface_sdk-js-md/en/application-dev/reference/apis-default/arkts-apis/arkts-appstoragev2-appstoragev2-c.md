...
| defaultCreator | [StorageDefaultCreator](arkts-storagedefaultcreator-t.md)&lt;T&gt; | No | the function generating the default value. If defaultCreator is not set and there is no data that matches type and key, then returns undefined. |
...
| --- | --- | --- | --- |
| ttype | [Class](../../apis-arkts/arkts-apis/arkts-arkts-class-c.md) | Yes | class type of the stored value. |
| defaultCreator | [StorageDefaultCreator](arkts-storagedefaultcreator-t.md)&lt;T&gt; | No | the function generating the default value. If defaultCreator is not set and there is no data that matches type, then returns undefined. |
