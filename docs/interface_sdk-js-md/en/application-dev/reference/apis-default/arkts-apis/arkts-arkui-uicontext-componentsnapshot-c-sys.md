...
| --- | --- | --- | --- |
| start | [NodeIdentity](arkts-nodeidentity-t.md) | Yes | the start component ID, set by developer through .id attribute or the unique ID get from FrameNode. |
| end | [NodeIdentity](arkts-nodeidentity-t.md) | Yes | the end component ID, set by developer through.id attribute or the unique ID get from FrameNode. |
