...
Defines chip group padding class.
...
The constructor of ChipGroupV2Padding
...
| --- | --- | --- | --- |
| config | [ChipGroupV2PaddingConfig](arkts-arkuiadvancedchipgroupv2-chipgroupv2paddingconfig-i.md) | Yes | config of chip group padding |
