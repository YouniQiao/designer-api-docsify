...
Set options for default close icon when 'allowClose' is true.

**Type:** [CloseOptions](arkts-arkui-advanced-chip-closeoptions-i.md)
...
**Type:** [ChipItemLabelOptions](arkts-arkui-advanced-chipgroup-chipitemlabeloptions-i.md)
...
**Type:** [ChipSymbolGlyphOptions](arkts-arkui-advanced-chip-chipsymbolglyphoptions-i.md)
...
**Type:** [ChipSuffixSymbolGlyphOptions](arkts-arkui-advanced-chip-chipsuffixsymbolglyphoptions-i.md)
