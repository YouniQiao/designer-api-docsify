...
**Inheritance/Implementation:** ExtendableComponent implements [LifeCycle](arkts-extendablecomponent-lifecycle-i.md), [IVariableOwner](arkts-decorator-ivariableowner-i.md)
...
| Type | Description |
| --- | --- |
| [UIContext](../../apis-arkui/arkts-apis/arkts-arkui-arkuiuicontext-uicontext-c.md) | The UIContext that the custom component belongs to. |
...
| --- | --- | --- | --- |
| theme | [Theme](arkts-arkuitheme-theme-i.md) | Yes | Custom theme init params. |
