...
Defines the callback of the bindable property which will be invoked when the property is changed. @readonly

**Type:** [Callback](arkts-callback-t.md)&lt;T&gt;
...
Defines value of the bindable property. @readonly
