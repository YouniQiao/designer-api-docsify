...
| --- | --- | --- | --- |
| customDropAnimation | [VoidCallback](../../apis-arkui/arkts-apis/arkts-arkui-voidcallback-t.md) | Yes | the custom drop animation function. |
...
| Type | Description |
| --- | --- |
| [UnifiedData](arkts-unifieddata-t.md) \| undefined | get dragData, undefined will be returned if the internal runtime environment is broken. |

**Error codes:**

| Error Code ID | Error Message |
| --- | --- |
| [190001](../../apis-arkui/errorcode-drag-event.md#190001-data-not-found) | Data not found. |
| [190002](../../apis-arkui/errorcode-drag-event.md#190002-data-retrieval-error) | Data error. |
...
| Type | Description |
| --- | --- |
| [Rectangle](arkts-common-rectangle-i.md) | getPreview rectangle. |
...
| Type | Description |
| --- | --- |
| [DragResult](arkts-common-dragresult-e.md) | dragResult Data. |
...
| Type | Description |
| --- | --- |
| [Summary](arkts-summary-t.md) \| undefined | get Summary Data, undefined will be returned if the internal runtime environment is broken. |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| unifiedData | [UnifiedData](arkts-unifieddata-t.md) | Yes | dragData. |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| dataLoadParams | [DataLoadParams](arkts-dataloadparams-t.md) | Yes | The data backend representation. |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| dragResult | [DragResult](arkts-common-dragresult-e.md) | Yes | the return of dragEvent. |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| options | [DataSyncOptions](arkts-datasyncoptions-t.md) | Yes | the data sync options. |
...
**Type:** [DragBehavior](arkts-common-dragbehavior-e.md)
