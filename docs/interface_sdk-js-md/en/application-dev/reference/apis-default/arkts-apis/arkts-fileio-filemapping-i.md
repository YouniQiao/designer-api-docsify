...
Defines a file mapping object. Before calling the **FileMapping** method, construct a **FileMapping** instance using [mmap()](arkts-fileio-mmap-f.md) or [mmapSync()](arkts-fileio-mmapsync-f.md).
