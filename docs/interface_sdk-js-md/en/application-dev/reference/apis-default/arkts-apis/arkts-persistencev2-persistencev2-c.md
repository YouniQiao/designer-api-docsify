...
| defaultCreator | [StorageDefaultCreator](arkts-storagedefaultcreator-t.md)&lt;T&gt; | No | the function generating the default value. |
| connectOptions | [BaseConnectOptions](arkts-persistencev2-baseconnectoptions-i.md)&lt;T&gt; | No | additional connect options. |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| params | [ConnectOptions](arkts-persistencev2-connectoptions-i.md)&lt;T&gt; | Yes | application-level storage parameters. |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| callback | [PersistenceErrorCallback](arkts-persistenceerrorcallback-t.md) \| undefined | Yes | called when error |
