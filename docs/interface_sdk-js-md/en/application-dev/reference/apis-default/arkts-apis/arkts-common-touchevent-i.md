...
| Type | Description |
| --- | --- |
| Array&lt;[HistoricalPoint](arkts-common-historicalpoint-i.md)&gt; \| undefined | return all historical points. Undefined will be returned if the internal runtime environment is broken. |
...
**Type:** [TouchObject](arkts-common-touchobject-i.md)[]
