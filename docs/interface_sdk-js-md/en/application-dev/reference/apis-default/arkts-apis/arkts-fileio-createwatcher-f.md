...
| listener | [WatchEventListener](arkts-watcheventlistener-t.md) | Yes | Callback invoked when an observed event occurs. The callback will be invoked each time an observed event occurs. |

**Return value:**

| Type | Description |
| --- | --- |
| [Watcher](arkts-watcher-t.md) | Watcher** object created. |
