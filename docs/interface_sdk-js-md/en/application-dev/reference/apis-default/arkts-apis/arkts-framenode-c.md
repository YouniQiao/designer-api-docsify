...
| statesChangeHandler | [UIStatesChangeHandler](arkts-uistateschangehandler-t.md) | Yes | The handler function for UI state changes. |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| child | [FrameNode](arkts-framenode-c.md) | Yes | the target node being adopted. |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| properties | [AnimationPropertyType](arkts-enums-animationpropertytype-e.md)[] | Yes | animation property types to cancel. |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| position | [NodePosition](arkts-nodeposition-t.md) | Yes | The point's coordinates in the current node's local coordinate system. |
| targetNode | [FrameNode](arkts-framenode-c.md) | Yes | The destination node whose coordinate system will be used for conversion. |

**Return value:**

| Type | Description |
| --- | --- |
| [NodePosition](arkts-nodeposition-t.md) | The converted coordinates in the target node's local coordinate system. |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| positionByWindow | [NodePosition](arkts-nodeposition-t.md) | Yes | The point's coordinates in the current window's coordinate system. |

**Return value:**

| Type | Description |
| --- | --- |
| [NodePosition](arkts-nodeposition-t.md) | The converted coordinates in the current node's local coordinate system. |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| positionByLocal | [NodePosition](arkts-nodeposition-t.md) | Yes | The point's coordinates in the current node's local coordinate system. |

**Return value:**

| Type | Description |
| --- | --- |
| [NodePosition](arkts-nodeposition-t.md) | The converted coordinates in the current window's coordinate system. |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| property | [AnimationPropertyType](arkts-enums-animationpropertytype-e.md) | Yes | enumeration of property that produces the animation. |
...
| expandMode | [ExpandMode](arkts-framenode-expandmode-e.md) \| undefined | No | The expand mode. Default value is ExpandMode.EXPAND. |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| countMode | [ChildrenCountMode](arkts-framenode-childrencountmode-e.md) | No | The children count mode. Default value is ChildrenCountMode.ALL_EXPAND. |
...
| Type | Description |
| --- | --- |
| [CrossLanguageOptions](arkts-framenode-crosslanguageoptions-i.md) | Returns the cross-language options of the target FrameNode. |
...
| Type | Description |
| --- | --- |
| [NodePosition](arkts-nodeposition-t.md) | Returns position of the node relative to unified display, in vp. |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| eventType | [EventQueryType](arkts-enums-eventquerytype-e.md) | Yes | The interaction event type to be queried. |
...
| Type | Description |
| --- | --- |
| [NodePosition](arkts-nodeposition-t.md) | Returns the offset to the parent of the FrameNode after layout, with unit PX. |
...
| Type | Description |
| --- | --- |
| [Size](arkts-graphics-size-i.md) | Returns the size of the FrameNode after measure, with unit PX. |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| property | [AnimationPropertyType](arkts-enums-animationpropertytype-e.md) | Yes | animation property type to get value. |
...
| Type | Description |
| --- | --- |
| [NodePosition](arkts-nodeposition-t.md) | Returns position of the node relative to its parent. |
...
| Type | Description |
| --- | --- |
| [NodePosition](arkts-nodeposition-t.md) | Returns position of the node relative to its parent with transform. |
...
| Type | Description |
| --- | --- |
| [NodePosition](arkts-nodeposition-t.md) | Returns position of the node relative to screen. |
...
| Type | Description |
| --- | --- |
| [NodePosition](arkts-nodeposition-t.md) | Returns position of the node relative to screen with transform. |
...
| Type | Description |
| --- | --- |
| [NodePosition](arkts-nodeposition-t.md) | Returns position of the node relative to window with transform. |
...
| Type | Description |
| --- | --- |
| [NodeEdges](arkts-graphics-nodeedges-i.md)&lt;[LengthMetrics](arkts-graphics-lengthmetrics-c.md)&gt; | Returns the user config border width of the FrameNode. |
...
| Type | Description |
| --- | --- |
| [NodeEdges](arkts-graphics-nodeedges-i.md)&lt;[LengthMetrics](arkts-graphics-lengthmetrics-c.md)&gt; | Returns the user config margin of the FrameNode. |
...
| Type | Description |
| --- | --- |
| [NodeEdges](arkts-graphics-nodeedges-i.md)&lt;[LengthMetrics](arkts-graphics-lengthmetrics-c.md)&gt; | Returns the user config padding of the FrameNode. |
...
| Type | Description |
| --- | --- |
| [SizeT](arkts-graphics-sizet-i.md)&lt;[LengthMetrics](arkts-graphics-lengthmetrics-c.md)&gt; | Returns the user config size of the FrameNode. |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| position | [NodePosition](arkts-nodeposition-t.md) | Yes | The position of the node, will be used when executed the layout method. |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| constraint | [LayoutConstraint](arkts-framenode-layoutconstraint-i.md) | Yes | The layout constraint of the node, supplied by the parent node. |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| targetParent | [FrameNode](arkts-framenode-c.md) | Yes | The target parent node. The target parent node must not be a declaratively created node, that is, a FrameNode that is not modifiable. If it does not meet the specifications, an exception is thrown. |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| position | [NodePosition](arkts-nodeposition-t.md) | Yes | The position of the node, will be used when executed layout method. |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| constraint | [LayoutConstraint](arkts-framenode-layoutconstraint-i.md) | Yes | The layout constraint of the node, will be used when executed measure method. |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| node | [FrameNode](arkts-framenode-c.md) | Yes | The node will be removed. |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| value | [CrossLanguageOptions](arkts-framenode-crosslanguageoptions-i.md) | Yes | The cross-language options. |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| position | [NodePosition](arkts-nodeposition-t.md) | Yes | The position to the parent of the FrameNode after layout. |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| size | [Size](arkts-graphics-size-i.md) | Yes | The size of the FrameNode after measure. |
