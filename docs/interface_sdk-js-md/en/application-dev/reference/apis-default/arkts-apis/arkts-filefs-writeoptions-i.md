...
Defines the options used in **write()**. It inherits from [Options](arkts-filefs-options-i.md).

**Inheritance/Implementation:** WriteOptions extends [Options](arkts-filefs-options-i.md)
