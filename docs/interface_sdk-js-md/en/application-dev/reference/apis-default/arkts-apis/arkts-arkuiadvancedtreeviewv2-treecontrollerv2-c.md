...
| --- | --- | --- | --- |
| nodeParam | [NodeParamV2](arkts-arkuiadvancedtreeviewv2-nodeparamv2-i.md) | No | Configuration information of the newly added node. |

**Return value:**

| Type | Description |
| --- | --- |
| [TreeControllerV2](arkts-arkuiadvancedtreeviewv2-treecontrollerv2-c.md) | ListTreeNode Tree view component proxy class. |
...
| parentSubTitle | [ResourceStr](arkts-resourcestr-t.md) | Yes | secondaryTitle of parent node. |
| currentSubtitle | [ResourceStr](arkts-resourcestr-t.md) | Yes | secondaryTitle of current node. |
