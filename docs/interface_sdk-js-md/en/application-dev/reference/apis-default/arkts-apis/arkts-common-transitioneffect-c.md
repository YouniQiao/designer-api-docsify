...
| --- | --- | --- | --- |
| value | [AnimateParam](arkts-common-animateparam-i.md) | Yes | animation parameters |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| appear | [TransitionEffect](arkts-common-transitioneffect-c.md) | Yes | the transition which will be attached when the component is appear |
| disappear | [TransitionEffect](arkts-common-transitioneffect-c.md) | Yes | the transition which will be attached when the component is disappear |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| transitionEffect | [TransitionEffect](arkts-common-transitioneffect-c.md) | Yes | transition effect which is be combined |

**Return value:**

| Type | Description |
| --- | --- |
| [TransitionEffect](arkts-common-transitioneffect-c.md) | combined transition effect |
...
| effect | [TransitionEdge](arkts-common-transitionedge-e.md) | Yes | transition options |
...
| effect | [TranslateOptions](arkts-common-translateoptions-i.md) | Yes | transition options |
...
| effect | [RotateOptions](arkts-common-rotateoptions-i.md) | Yes | transition options |
...
| effect | [ScaleOptions](arkts-common-scaleoptions-i.md) | Yes | transition options |
...
| effect | [AsymmetricTransitionOption](arkts-common-asymmetrictransitionoption-i.md) | Yes | transition options |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| edge | [TransitionEdge](arkts-common-transitionedge-e.md) | Yes | the edge that component will move to |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| options | [ScaleOptions](arkts-common-scaleoptions-i.md) | Yes | scale options |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| options | [TranslateOptions](arkts-common-translateoptions-i.md) | Yes | translate options |
