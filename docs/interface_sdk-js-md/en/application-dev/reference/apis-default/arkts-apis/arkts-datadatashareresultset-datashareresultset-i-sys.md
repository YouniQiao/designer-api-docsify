...
| Type | Description |
| --- | --- |
| [DataType](arkts-datadatashareresultset-datatype-e-sys.md) | Data type obtained. |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| offset | int | Yes | Offset relative to the current position. A negative value means to move forward, and a positive value means to move backward. |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| position | int | Yes | Position to move to, starting from 0. |
