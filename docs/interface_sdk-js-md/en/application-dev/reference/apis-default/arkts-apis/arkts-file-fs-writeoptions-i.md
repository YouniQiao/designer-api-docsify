...
Defines the options used in **write()**. It inherits from [Options](arkts-file-fs-options-i.md).

**Inheritance/Implementation:** WriteOptions extends [Options](arkts-file-fs-options-i.md)
