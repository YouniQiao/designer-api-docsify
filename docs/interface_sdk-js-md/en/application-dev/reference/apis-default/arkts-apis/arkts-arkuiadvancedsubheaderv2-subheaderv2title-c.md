...
| --- | --- | --- | --- |
| options | [SubHeaderV2TitleOptions](arkts-arkuiadvancedsubheaderv2-subheaderv2titleoptions-i.md) | Yes | Options for initializing the title. |
...
When **primaryTitle**, **secondaryTitle**, and **icon** are used simultaneously in [SubHeaderV2](arkts-arkuiadvancedsubheaderv2-subheaderv2-s.md), **primaryTitle** does not take effect.
