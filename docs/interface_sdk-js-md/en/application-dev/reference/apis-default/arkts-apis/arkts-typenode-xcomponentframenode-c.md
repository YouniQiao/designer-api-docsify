...
**Inheritance/Implementation:** XComponentFrameNode extends TypedFrameNode<XComponentAttribute>
...
| --- | --- | --- | --- |
| value | [XComponentParameters](../arkts-components/arkts-xcomponent-xcomponentparameters-i.md) | Yes | Indicates the options of the xcomponent. |
