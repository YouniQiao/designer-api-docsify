...
| options | [Options](arkts-filefs-options-i.md) | No | Options for reading the text. The options are as follows: <br>- **encoding** (string): format of the data to be encoded. <br>It is valid only when the data is of the string type. <br>The default value is **'utf-8'**, which is the only value supported. |

**Return value:**

| Type | Description |
| --- | --- |
| Promise&lt;[ReaderIterator](../../apis-core-file-kit/arkts-apis/arkts-corefile-filefs-readeriterator-i.md)&gt; | Promise used to return the **ReaderIterator** object. |
...
| --- | --- | --- | --- |
| filePath | string | Yes | Application sandbox path of the file. |
| callback | [AsyncCallback](../../apis-basic-services-kit/arkts-apis/arkts-basicservices-asynccallback-t.md)&lt;[ReaderIterator](../../apis-core-file-kit/arkts-apis/arkts-corefile-filefs-readeriterator-i.md)&gt; | Yes | Callback used to return a **ReaderIterator** object. |
...
| --- | --- | --- | --- |
| filePath | string | Yes | Application sandbox path of the file. |
| options | [Options](arkts-filefs-options-i.md) | Yes | Read options. The options are as follows: <br>- **encoding** (string): format of the data to be encoded. <br>It is valid only when the data is of the string type. <br>The default value is **'utf-8'**, which is the only value supported. |
| callback | [AsyncCallback](../../apis-basic-services-kit/arkts-apis/arkts-basicservices-asynccallback-t.md)&lt;[ReaderIterator](../../apis-core-file-kit/arkts-apis/arkts-corefile-filefs-readeriterator-i.md)&gt; | Yes | Callback used to return a **ReaderIterator** object. |
