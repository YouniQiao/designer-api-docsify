...
Accessibility description.Default value: **"Double-tap to activate"**Decorator: @Trace
...
**"no-hide-descendants"**: Neither the icon nor its child components can be recognized by accessibility services.Default value: **"yes"**Decorator: @Trace
...
Accessibility text of the icon on the right side of the subheader.Default value: **undefined**Decorator: @Trace
...
Event triggered when the item is operated. Default value: **() =&gt; void**.Decorator: @Trace
...
Content of the item in the operation area.Decorator: @Trace
...
**false**: Do not receive default focus.Default value: **false**Decorator: @Trace
