...
| --- | --- | --- | --- |
| uiContext | [UIContext](../../apis-arkui/arkts-apis/arkts-arkui-arkuiuicontext-uicontext-c.md) | Yes | uiContext used to create the ReactiveComponentContent |
| builder | CustomBuilder | Yes | Defines the builder that will be called to build ReactiveComponentContent. |
| options | [BuildOptions](arkts-buildernode-buildoptions-i.md) | No | Defines the options that will be used when building. |
