...
**Inheritance/Implementation:** LazyColumnLayoutAttribute extends CommonMethod
...
| --- | --- | --- | --- |
| value | [HorizontalAlign](arkts-enums-horizontalalign-e.md) \| undefined | Yes |  |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| modifier | [AttributeModifier](arkts-common-attributemodifier-i.md)&lt;[LazyColumnLayoutAttribute](arkts-arkui-components-arklazycolumnlayout-lazycolumnlayoutattribute-i.md)&gt; \| [AttributeModifier](arkts-common-attributemodifier-i.md)&lt;[CommonMethod](arkts-common-commonmethod-i.md)&gt; \| undefined | Yes |  |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| builder | [CustomBuilder](arkts-custombuilder-t.md) \| undefined | Yes |  |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| callback | [OnVisibleIndexesChangeCallback](arkts-onvisibleindexeschangecallback-t.md) \| undefined | Yes |  |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| space | [LengthMetrics](arkts-graphics-lengthmetrics-c.md) \| undefined | Yes |  |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| sticky | [StickyStyle](../arkts-components/arkts-list-stickystyle-e.md) \| undefined | Yes |  |
