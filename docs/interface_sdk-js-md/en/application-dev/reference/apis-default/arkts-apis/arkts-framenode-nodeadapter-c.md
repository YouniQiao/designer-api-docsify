...
| --- | --- | --- | --- |
| adapter | [NodeAdapter](arkts-framenode-nodeadapter-c.md) | Yes | Define lazy loading classes. |
| node | [FrameNode](arkts-framenode-c.md) | Yes | The bound FrameNode node. |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| node | [FrameNode](arkts-framenode-c.md) | Yes | Unbind the FrameNode node. |
...
| Type | Description |
| --- | --- |
| Array&lt;[FrameNode](arkts-framenode-c.md)&gt; | Return all valid FrameNode collections. |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| target | [FrameNode](arkts-framenode-c.md) | Yes | The bound FrameNode node. |
...
| Type | Description |
| --- | --- |
| [FrameNode](arkts-framenode-c.md) | Returns the FrameNode node that loads the node. |
...
| node | [FrameNode](arkts-framenode-c.md) | Yes | The FrameNode node that is about to be destroyed. |
...
| node | [FrameNode](arkts-framenode-c.md) | Yes | Reused FrameNode nodes. |
