...
| --- | --- | --- | --- |
| handler | [NativeMediaPlayerHandler](arkts-webview-nativemediaplayerhandler-i.md) | Yes | Object used to report the player status to the ArkWeb engine. |
| mediaInfo | [MediaInfo](arkts-webview-mediainfo-i.md) | Yes | Information about the media on the web page. |
