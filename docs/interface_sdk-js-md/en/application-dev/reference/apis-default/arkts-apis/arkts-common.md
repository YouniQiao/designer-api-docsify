...
| [TransitionEffect](arkts-common-transitioneffect-c.md) | Defines the transition effect |
...
| [BindOptions](arkts-common-bindoptions-i.md) | Overlay module options |
...
| [DismissSheetAction](arkts-common-dismisssheetaction-i.md) | Component sheet dismiss |
...
| [KeyframeAnimateParam](arkts-common-keyframeanimateparam-i.md) | Defines the overall animation parameters of the keyframe animation. |
| [KeyframeState](arkts-common-keyframestate-i.md) | Defines a keyframe state. |
...
| [SpringBackAction](arkts-common-springbackaction-i.md) | Defines sheet spring back action |
...
| [SystemAdaptiveOptions](arkts-common-systemadaptiveoptions-i.md) | Defines the SystemAdaptiveOptions interface |
...
| [DoubleLengthDetents](arkts-doublelengthdetents-t.md) | Defines the detent array of a two-length. |
...
| [Filter](arkts-filter-t.md) | Filter |
...
| [SingleLengthDetent](arkts-singlelengthdetent-t.md) | Defines the detent array of a single length. |
...
| [SystemUiMaterial](arkts-systemuimaterial-t.md) | SystemUiMaterial |
...
| [VisualEffect](arkts-visualeffect-t.md) | VisualEffect |
