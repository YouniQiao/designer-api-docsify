...
| Type | Description |
| --- | --- |
| [UIContext](../../apis-arkui/arkts-apis/arkts-arkui-arkuiuicontext-uicontext-c.md) \| undefined | object UIContext, or undefined when failed. |
...
| Type | Description |
| --- | --- |
| [UIContext](../../apis-arkui/arkts-apis/arkts-arkui-arkuiuicontext-uicontext-c.md)[] | An array containing all valid UIContext instances, returns an empty array if no contexts are available. |
...
| Type | Description |
| --- | --- |
| Nullable&lt;[AtomicServiceBar](../../apis-arkui/arkts-apis/arkts-arkui-arkuiuicontext-atomicservicebar-i.md)&gt; | The atomic service bar. |
...
| Type | Description |
| --- | --- |
| [UIContext](../../apis-arkui/arkts-apis/arkts-arkui-arkuiuicontext-uicontext-c.md) \| undefined | The UIContext for the current calling scope, or undefined if no context can be determined from the call stack. |
...
| Type | Description |
| --- | --- |
| [ComponentSnapshot](../../apis-arkui/arkts-apis/arkts-arkui-arkuiuicontext-componentsnapshot-c.md) | the ComponentSnapshot |
...
| Type | Description |
| --- | --- |
| [ComponentUtils](../../apis-arkui/arkts-apis/arkts-arkui-arkuiuicontext-componentutils-c.md) | object ComponentUtils. |
...
| Type | Description |
| --- | --- |
| [ContextMenuController](../../apis-arkui/arkts-apis/arkts-arkui-arkuiuicontext-contextmenucontroller-c.md) | object context menu controller. |
...
| Type | Description |
| --- | --- |
| [CursorController](../../apis-arkui/arkts-apis/arkts-arkui-arkuiuicontext-cursorcontroller-c.md) | object cursor controller. |
...
| Type | Description |
| --- | --- |
| [DragController](../../apis-arkui/arkts-apis/arkts-arkui-arkuiuicontext-dragcontroller-c.md) | the DragController |
...
| Type | Description |
| --- | --- |
| [FocusController](../../apis-arkui/arkts-apis/arkts-arkui-arkuiuicontext-focuscontroller-c.md) | the FocusController |
...
| Type | Description |
| --- | --- |
| [Font](../../apis-arkui/arkts-apis/arkts-arkui-arkuiuicontext-font-c.md) | object Font. |
...
| Type | Description |
| --- | --- |
| [KeyboardAvoidMode](../../apis-arkui/arkts-apis/arkts-arkui-arkuiuicontext-keyboardavoidmode-e.md) | The mode of keyboard avoid. |
...
| Type | Description |
| --- | --- |
| [UIContext](../../apis-arkui/arkts-apis/arkts-arkui-arkuiuicontext-uicontext-c.md) \| undefined | The UIContext of the last focused UI instance or undefined if no one exists. |
...
| Type | Description |
| --- | --- |
| [UIContext](../../apis-arkui/arkts-apis/arkts-arkui-arkuiuicontext-uicontext-c.md) \| undefined | The UIContext of the last foregrounded UI instance or undefined if no one exists |
...
| Type | Description |
| --- | --- |
| [Magnifier](../../apis-arkui/arkts-apis/arkts-arkui-arkuiuicontext-magnifier-c.md) | Magnifier instance obtained. |
...
| Type | Description |
| --- | --- |
| [MeasureUtils](../../apis-arkui/arkts-apis/arkts-arkui-arkuiuicontext-measureutils-c.md) | the MeasureUtils |
...
| Type | Description |
| --- | --- |
| [MediaQuery](../../apis-arkui/arkts-apis/arkts-arkui-arkuiuicontext-mediaquery-c.md) | object MediaQuery. |
...
| Type | Description |
| --- | --- |
| [OverlayManager](../../apis-arkui/arkts-apis/arkts-arkui-arkuiuicontext-overlaymanager-c.md) | object OverlayManager. |
...
| Type | Description |
| --- | --- |
| [OverlayManagerOptions](../../apis-arkui/arkts-apis/arkts-arkui-arkuiuicontext-overlaymanageroptions-i.md) | object OverlayManagerOptions. |
...
| Type | Description |
| --- | --- |
| [PageInfo](../../apis-arkui/arkts-apis/arkts-arkui-arkuiuicontext-pageinfo-i.md) | The page information of the frameNode with the target uniqueId, includes navDestination and router page information. If the frame node does not have navDestination and router page information, it will return an empty object. |
...
| Type | Description |
| --- | --- |
| [PromptAction](../../apis-arkui/arkts-apis/arkts-arkui-arkuiuicontext-promptaction-c.md) | object PromptAction. |
...
| Type | Description |
| --- | --- |
| [Router](../../apis-arkui/arkts-apis/arkts-arkui-arkuiuicontext-router-c.md) | object Router. |
...
| Type | Description |
| --- | --- |
| [SmartGestureController](../../apis-arkui/arkts-apis/arkts-arkui-arkuiuicontext-smartgesturecontroller-c.md) | object smart gesture controller. |
...
| Type | Description |
| --- | --- |
| [TextMenuController](../../apis-arkui/arkts-apis/arkts-arkui-arkuiuicontext-textmenucontroller-c.md) | object text menu controller. |
...
| Type | Description |
| --- | --- |
| [UIInspector](../../apis-arkui/arkts-apis/arkts-arkui-arkuiuicontext-uiinspector-c.md) | UIInspector** object. |
...
| Type | Description |
| --- | --- |
| [UIObserver](../../apis-arkui/arkts-apis/arkts-arkui-arkuiuicontext-uiobserver-c.md) | The UI observer. |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| frameCallback | [FrameCallback](../../apis-arkui/arkts-apis/arkts-arkui-arkuiuicontext-framecallback-c.md) | Yes | The frame callback to run on the next frame. |
...
| Type | Description |
| --- | --- |
| Array&lt;[DynamicSyncScene](../../apis-arkui/arkts-apis/arkts-arkui-arkuiuicontext-dynamicsyncscene-c.md)&gt; | The instance of SwiperDynamicSyncScene. |
...
| Type | Description |
| --- | --- |
| [ResolvedUIContext](../../apis-arkui/arkts-apis/arkts-arkui-arkuiuicontext-resolveduicontext-c.md) | ResolvedUIContext instance |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| feature | [CustomKeyboardContinueFeature](../../apis-arkui/arkts-apis/arkts-arkui-arkuiuicontext-customkeyboardcontinuefeature-e.md) | Yes | The custom keyboard continue feature. |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| value | [KeyboardAvoidMode](../../apis-arkui/arkts-apis/arkts-arkui-arkuiuicontext-keyboardavoidmode-e.md) | Yes | The mode of keyboard avoid. |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| options | [OverlayManagerOptions](../../apis-arkui/arkts-apis/arkts-arkui-arkuiuicontext-overlaymanageroptions-i.md) | Yes | Options. |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| policy | [TextSelectionClearPolicy](../../apis-arkui/arkts-apis/arkts-arkui-arkuiuicontext-textselectionclearpolicy-e.md) | Yes | The text selection clear policy. |
