...
Defines the options used in **readText()**. It inherits from [ReadOptions](arkts-filefs-readoptions-i.md).

**Inheritance/Implementation:** ReadTextOptions extends [ReadOptions](arkts-filefs-readoptions-i.md)
