...
| --- | --- | --- | --- |
| valueCallback | [MonitorValueCallback](arkts-monitorvaluecallback-t.md) \| [MonitorValueCallback](arkts-monitorvaluecallback-t.md)[] | Yes | monitored change for state variable. |
| monitorCallback | [MonitorCallback](arkts-monitorcallback-t.md) | Yes | the function triggered when state variable changes. |
| options | [MonitorOptions](arkts-utils-monitoroptions-i.md) | No | the monitor configuration. |

**Return value:**

| Type | Description |
| --- | --- |
| [IMonitorDecoratedVariable](arkts-decorator-imonitordecoratedvariable-i.md) | monitor handle. |

**Error codes:**

| Error Code ID | Error Message |
| --- | --- |
| [130000](../../apis-arkui/errorcode-stateManagement.md#130000-invalid-target-object-for-addmonitorclearmonitor) | options.owner is not ComponentV2 struct. |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| valueInfo | [MonitorValueInfo](arkts-utils-monitorvalueinfo-i.md) \| [MonitorValueInfo](arkts-utils-monitorvalueinfo-i.md)[] | Yes | monitored change for state variable. |
| monitorCallback | [MonitorCallback](arkts-monitorcallback-t.md) | Yes | the function triggered when state variable changes. |
| options | [MonitorBaseOptions](arkts-utils-monitorbaseoptions-i.md) | No | the monitor configuration. |
...
| Type | Description |
| --- | --- |
| [ObservedResult](arkts-utils-observedresult-i.md) | return result of whether a class is observable. |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| monitor | [IMonitorDecoratedVariable](arkts-decorator-imonitordecoratedvariable-i.md) | Yes | handle |
...
| Type | Description |
| --- | --- |
| [CustomComponentContext](arkts-utils-customcomponentcontext-i.md) | current custom component's context handle. |
...
| Type | Description |
| --- | --- |
| [CustomComponentLifecycle](arkts-customcomponent-customcomponentlifecycle-i.md) | the lifecycle that the custom component belong to . |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| getter | [GetterCallback](arkts-gettercallback-t.md)&lt;T&gt; | Yes | A value or a function that returns the current value of type T. |

**Return value:**

| Type | Description |
| --- | --- |
| [Binding](arkts-utils-binding-c.md)&lt;T&gt; | read-only data binding value |
...
| --- | --- | --- | --- |
| getter | [GetterCallback](arkts-gettercallback-t.md)&lt;T&gt; | Yes | A value or a function that returns the current value of type T. |
| setter | [SetterCallback](arkts-settercallback-t.md)&lt;T&gt; | Yes | A function to set a new value of type T. |

**Return value:**

| Type | Description |
| --- | --- |
| [MutableBinding](arkts-utils-mutablebinding-c.md)&lt;T&gt; | mutable data binding value |
