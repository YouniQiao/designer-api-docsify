...
| --- | --- | --- | --- |
| drawContext | [DrawContext](arkts-drawcontext-t.md) | Yes | The drawContext used to draw. |
...
Custom drawing consists of five layers: Behind, Content, Front, Foreground, and Overlay. - The Foreground and Overlay layers are drawn after child nodes. - The Overlay layer differs from Foreground in that it can draw outside the bounds of the component.
