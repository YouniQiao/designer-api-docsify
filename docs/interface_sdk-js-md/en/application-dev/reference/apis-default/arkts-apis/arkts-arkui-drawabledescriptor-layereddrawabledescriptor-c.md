...
| --- | --- | --- | --- |
| foreground | [DrawableDescriptor](arkts-arkui-drawabledescriptor-drawabledescriptor-c.md) | No | Indicates the foreground option to create LayeredDrawableDescriptor. |
| background | [DrawableDescriptor](arkts-arkui-drawabledescriptor-drawabledescriptor-c.md) | No | Indicates the background option to create LayeredDrawableDescriptor. |
| mask | [DrawableDescriptor](arkts-arkui-drawabledescriptor-drawabledescriptor-c.md) | No | Indicates the mask option to create LayeredDrawableDescriptor. |
...
| Type | Description |
| --- | --- |
| [DrawableDescriptor](arkts-arkui-drawabledescriptor-drawabledescriptor-c.md) \| undefined | Return the DrawableDescriptor object of background. |
...
| Type | Description |
| --- | --- |
| [DrawableDescriptor](arkts-arkui-drawabledescriptor-drawabledescriptor-c.md) \| undefined | Return the DrawableDescriptor object of foreground. |
...
| Type | Description |
| --- | --- |
| [DrawableDescriptor](arkts-arkui-drawabledescriptor-drawabledescriptor-c.md) \| undefined | Return the DrawableDescriptor object of mask. |
