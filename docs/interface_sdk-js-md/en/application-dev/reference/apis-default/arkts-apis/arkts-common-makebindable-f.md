...
| onChange | [Callback](arkts-callback-t.md)&lt;T&gt; | Yes | indicates the invoked callback when the property is changed. |

**Return value:**

| Type | Description |
| --- | --- |
| [Bindable](arkts-common-bindable-i.md)&lt;T&gt; | bindable property instance. |
