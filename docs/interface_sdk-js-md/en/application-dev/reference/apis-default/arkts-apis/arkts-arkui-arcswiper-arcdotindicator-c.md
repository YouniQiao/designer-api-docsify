...
| --- | --- | --- | --- |
| direction | [ArcDirection](arkts-arkui-arcswiper-arcdirection-e.md) \| undefined | Yes | the direction of arc indicator, default value is { ArcDirection.SIX_CLOCK_DIRECTION }, undefined means setting to default value. |
