...
\_\_\_HTML\_TAG\_DESC\_USD\_0\_\_\_The value is recorded in the EFSPN file of the SIM card and is irrelevant to the network with which the SIM card is currently registered.
...
| callback | \_\_\_MD\_LINK\_USD\_0\_\_\_&lt;string&gt; | Yes | Indicates the callback for getting the SPN; returns an empty string if no SIM card is inserted or no EFSPN file in the SIM card. |
