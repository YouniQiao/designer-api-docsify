...
| callback | [AsyncCallback](../../apis-basic-service-kit/arkts-apis/arkts-basicservices-asynccallback-t.md)&lt;NetworkState&gt; | Yes | Indicates the callback for getting network registration state. |
