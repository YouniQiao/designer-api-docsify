...
| --- | --- | --- | --- |
| type | [CallTransferType](arkts-telephony-calltransfertype-e-sys.md) | Yes | Type of call transfer to be obtained. |
...
| Type | Description |
| --- | --- |
| [Promise](../../apis-na/arkts-apis/arkts-na-promise-i.md)<CallTransferResult> | - Call transfer status. |
