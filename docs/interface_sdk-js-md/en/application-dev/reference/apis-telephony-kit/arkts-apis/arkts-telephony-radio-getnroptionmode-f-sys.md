...
| callback | [AsyncCallback](../../apis-basic-service-kit/arkts-apis/arkts-basicservices-asynccallback-t.md)&lt;[NROptionMode](arkts-telephony-radio-nroptionmode-e-sys.md)&gt; | Yes | Indicates the callback for getting the selection mode of NR. |
