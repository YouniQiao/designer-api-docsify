...
| --- | --- | --- | --- |
| file | number \| [File](arkts-corefile-filefs-file-i.md) | Yes | File object or open file descriptor fd that has been opened. |
...
| Type | Description |
| --- | --- |
| [FileMapping](arkts-corefile-filefs-filemapping-i.md) | FileMapping object. |
