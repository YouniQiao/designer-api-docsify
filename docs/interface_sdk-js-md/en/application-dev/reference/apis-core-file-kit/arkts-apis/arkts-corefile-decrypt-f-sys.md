...
<!--Device-encryptedVolumeManager-function decrypt(volumeId: string, passWord: string): Promise<void>--><!--Device-encryptedVolumeManager-function decrypt(volumeId: string, passWord: string): Promise<void>-End-->
