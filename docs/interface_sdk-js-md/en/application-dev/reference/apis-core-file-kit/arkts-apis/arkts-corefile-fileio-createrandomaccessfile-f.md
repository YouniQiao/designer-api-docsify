...
| --- | --- | --- | --- |
| file | string \| File | Yes | Application sandbox path of the file or an opened file object. |
| callback | [AsyncCallback](../../apis-basic-service-kit/arkts-apis/arkts-basicservices-base-asynccallback-i.md)&lt;RandomAccessFile&gt; | Yes | Callback used to return the **RandomAccessFile** object. |
