...
| options | [ListFileExtOptions](../../apis-default/arkts-apis/arkts-file-fs-listfileextoptions-i.md) | No | Options for filtering files. The files are not filtered by default. |
