...
Callback invoked when the API call is successful. **data** is [FileReadArrayBufferResponse](arkts-corefile-systemfile-filereadarraybufferresponse-depr-i.md#filereadarraybufferresponse).
