...
to provide capabilities of selecting and saving files of different types. An application can select the API as required. The APIs of this module must be called in UIAbility. Otherwise, the **FilePicker**, **AudioPicker**, or  
...
| [PhotoViewPicker](arkts-corefile-picker-photoviewpicker-c.md) | Provides APIs for selecting and saving images or videos. You are advised to use  [PhotoViewPicker of PhotoAccessHelper]\_\_\_ESCAPED\_UNDERSCORE\_\_\_\_\_\_ESCAPED\_UNDERSCORE\_\_\_\_\_\_ESCAPED\_UNDERSCORE\_\_\_JSDOC\_\_\_ESCAPED\_UNDERSCORE\_\_\_LINK\_\_\_ESCAPED\_UNDERSCORE\_\_\_DESC\_\_\_ESCAPED\_UNDERSCORE\_\_\_USD\_\_\_ESCAPED\_UNDERSCORE\_\_\_0\_\_\_ESCAPED\_UNDERSCORE\_\_\_\_\_\_ESCAPED\_UNDERSCORE\_\_\_\_\_\_ESCAPED\_UNDERSCORE\_\_\_ to select a file.Before using the APIs of **PhotoViewPicker**, you need to create a **PhotoViewPicker** instance. |
...
| Name | Description |
| --- | --- |
| [AudioSaveOptions](arkts-corefile-picker-audiosaveoptions-i.md) | Defines the options for saving audio clips. |
| [AudioSelectOptions](arkts-corefile-picker-audioselectoptions-i.md) | Defines options for selecting audio clips. |
| [DocumentSaveOptions](arkts-corefile-picker-documentsaveoptions-i.md) | Defines the options for saving documents. |
| [DocumentSelectOptions](arkts-corefile-picker-documentselectoptions-i.md) | Defines the options for selecting documents. |
