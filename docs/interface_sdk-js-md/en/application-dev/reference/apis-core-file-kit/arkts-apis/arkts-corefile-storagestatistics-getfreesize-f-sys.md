...
| --- | --- | --- | --- |
| callback | [AsyncCallback](../../apis-basic-service-kit/arkts-apis/arkts-basicservices-base-asynccallback-i.md)&lt;long&gt; | Yes | Callback used to return the available space of the built-in storage obtained. |
...
| Type | Description |
| --- | --- |
| Promise&lt;long&gt; | Promise used to return the available space of the built-in storage obtained. |
