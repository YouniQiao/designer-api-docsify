...
| callback | [AsyncCallback](../../apis-basic-service-kit/arkts-apis/arkts-basicservices-asynccallback-i.md)<number> | Yes | Called each time a change is detected. |

**Return value:**

| Type | Description |
| --- | --- |
| [Watcher](arkts-corefile-watcher-i.md) | Promise that returns the file change. |
