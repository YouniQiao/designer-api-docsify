...
| --- | --- | --- | --- |
| config | [FileSystemRequestConfig](arkts-corefile-backup-filesystemrequestconfig-i-sys.md) | Yes | Configuration parameters for garbage collection. triggerType: 0. writeSize: 0 - 2097152(MB). waitTime: 0-300(s). |
