...
| [createStream](arkts-corefile-fileio-createstream-f.md#createstream) | Creates a stream based on a file path. This API uses a promise to return the result. To close the stream, use  **close()** of [Stream](arkts-corefile-fileio-stream-i.md#Stream). |
| [createStream](arkts-corefile-fileio-createstream-f.md#createstream-1) | Creates a stream based on a file path. To close the stream, use **close()** of [Stream](arkts-corefile-fileio-stream-i.md#Stream). This API uses an asynchronous callback to return the result. |
| [createStreamSync](arkts-corefile-fileio-createstreamsync-f.md#createstreamsync) | Creates a stream based on a file path. This API returns the result synchronously. To close the stream, use  **close()** of [Stream](arkts-corefile-fileio-stream-i.md#Stream). |
...
| [fdopenStream](arkts-corefile-fileio-fdopenstream-f.md#fdopenstream) | Opens a file stream based on the file descriptor. This API uses a promise to return the result.To close the stream, use **close()** of [Stream](arkts-corefile-fileio-stream-i.md#Stream). |
| [fdopenStream](arkts-corefile-fileio-fdopenstream-f.md#fdopenstream-1) | Opens a stream based on the file descriptor. To close the stream, use **close()** of [Stream](arkts-corefile-fileio-stream-i.md#Stream).This API uses an asynchronous callback to return the result. |
| [fdopenStreamSync](arkts-corefile-fileio-fdopenstreamsync-f.md#fdopenstreamsync) | Opens a stream based on an FD. This API returns the result synchronously. To close the stream, use **close()** of  [Stream](arkts-corefile-fileio-stream-i.md#Stream). |
...
| [connectDfs](arkts-corefile-fileio-connectdfs-f.md#connectdfs) | Triggers connection. If the peer device is abnormal, [onStatus](arkts-corefile-file-fs-dfslisteners-i.md#onStatus)in DfsListeners will be called to notify the application. |
