...
Provides detailed file information. Before calling a method of the **Stat** class, use the [stat()]\_\_\_JSDOC\_LINK\_DESC\_USD\_0\_\_\_method synchronously or asynchronously to create a **Stat** instance.
