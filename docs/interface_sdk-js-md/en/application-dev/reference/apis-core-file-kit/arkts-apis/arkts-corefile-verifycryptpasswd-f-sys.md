...
<!--Device-encryptedVolumeManager-function verifyCryptPasswd(volumeId: string, passWord: string): Promise<void>--><!--Device-encryptedVolumeManager-function verifyCryptPasswd(volumeId: string, passWord: string): Promise<void>-End-->
