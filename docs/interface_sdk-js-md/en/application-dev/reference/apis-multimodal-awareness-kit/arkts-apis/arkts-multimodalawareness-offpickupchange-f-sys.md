...
| --- | --- | --- | --- |
| callback | Callback&lt;PickupEvent&gt; | No | Callback used for pick up event unsubscription.<br> If this parameter is not specified, all callbacks of the pick up event are unsubscribed from. |
