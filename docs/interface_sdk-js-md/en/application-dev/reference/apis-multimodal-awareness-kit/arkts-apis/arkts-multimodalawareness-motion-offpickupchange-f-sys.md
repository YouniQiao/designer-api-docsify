...
| --- | --- | --- | --- |
| callback | [Callback](../../apis-basic-services-kit/arkts-apis/arkts-basicservices-base-callback-i.md)&lt;[PickupEvent](arkts-multimodalawareness-motion-pickupevent-e-sys.md)&gt; | No | Callback used for pick up event unsubscription. If this parameter is not specified, all callbacks of the pick up event are unsubscribed from. |
