...
| --- | --- | --- | --- |
| callback | [Callback](../../apis-basic-service-kit/arkts-apis/arkts-basicservices-base-callback-i.md)&lt;[RotateEvent](arkts-multimodalawareness-motion-rotateevent-e-sys.md)&gt; | No | Callback used for rotate event unsubscription. <br> If this parameter is not specified, all callbacks of the rotate event are unsubscribed from. |
