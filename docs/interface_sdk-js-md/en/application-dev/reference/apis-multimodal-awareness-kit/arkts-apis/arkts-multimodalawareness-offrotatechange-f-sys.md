...
| --- | --- | --- | --- |
| callback | Callback&lt;RotateEvent&gt; | No | Callback used for rotate event unsubscription.<br> If this parameter is not specified, all callbacks of the rotate event are unsubscribed from. |
