...
| Type | Description |
| --- | --- |
| [RenderResourceFactory](arkts-arkgraphics3d-renderresourcefactory-i.md) | -- RenderResourceFactory instance |
...
| Type | Description |
| --- | --- |
| [Promise](../../apis-na/arkts-apis/arkts-na-promise-i.md)<boolean> | - Promise a boolean to show if the plugin load is successful |
