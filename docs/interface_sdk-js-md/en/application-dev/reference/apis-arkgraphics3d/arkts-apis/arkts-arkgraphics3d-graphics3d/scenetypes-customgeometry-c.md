...
**Inheritance/Implementation:** CustomGeometry extends [GeometryDefinition](scenetypes-geometrydefinition-c.md)
...
An example of creating an identical pair of triangles, given vertices = [a, b, c, d]:topology = PrimitiveTopology.TRIANGLE\_LIST indices = [0, 1, 2, 2, 1, 3]resulting triangles: abc, cbd

topology = PrimitiveTopology.TRIANGLE\_STRIP indices = [0, 1, 2, 3]resulting triangles: abc, cbd (b and c are reversed in cbd, to match the face direction of the first triangle)
