...
| Type | Description |
| --- | --- |
| [Mat4x4](arkts-arkgraphics3d-mat4x4-i.md) | -- the projection matrix of this camera |
...
| Type | Description |
| --- | --- |
| [Mat4x4](arkts-arkgraphics3d-mat4x4-i.md) | -- the view matrix of this camera |
...
| --- | --- | --- | --- |
| viewPosition | [Vec2](arkts-arkgraphics3d-vec2-i.md) | Yes | Position to cast in the normalized device coordinates. |
| params | [RaycastParameters](arkts-arkgraphics3d-raycastparameters-i.md) | Yes | Options used to execute the ray cast. |

**Return value:**

| Type | Description |
| --- | --- |
| [Promise](../../apis-na/arkts-apis/arkts-na-promise-i.md)<RaycastResult[]> | - Promise used to return an array of hit results, sorted from the closest to the farthest. The array may be empty. |
