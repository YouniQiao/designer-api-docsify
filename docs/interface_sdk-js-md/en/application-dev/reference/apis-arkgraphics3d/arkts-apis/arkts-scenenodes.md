...
| Name | Description |
| --- | --- |
| [LightType](arkts-arkgraphics3d-scenenodes-lighttype-e.md) | Enumerates the light types.@enum { number } |
| [NodeType](arkts-arkgraphics3d-scenenodes-nodetype-e.md) | Enumerates the node types.@enum { number } |
