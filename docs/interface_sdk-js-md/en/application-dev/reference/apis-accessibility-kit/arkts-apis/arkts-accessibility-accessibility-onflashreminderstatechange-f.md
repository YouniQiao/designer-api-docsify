...
Subscribes to the state changes in flash alerts mode. This API uses an asynchronous callback to return the result.
    **NOTE**  
    ...
    [accessibility.offFlashReminderStateChange]\_\_\_JSDOC\_LINK\_DESC\_USD\_0\_\_\_  
...
| --- | --- | --- | --- |
| callback | \_\_\_MD\_LINK\_USD\_0\_\_\_&lt;boolean&gt; | Yes | Callback function. Returns **true** if flash alerts mode is enabled; returns **false** otherwise. |
