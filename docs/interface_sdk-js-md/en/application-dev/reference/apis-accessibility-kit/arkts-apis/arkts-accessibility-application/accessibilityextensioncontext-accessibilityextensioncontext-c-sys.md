...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| displayId | ArkTS-Dyn: number  \_\_\_HTML\_TAG\_USD\_0\_\_\_ArkTS-Sta：long | No | Indicates the display ID. If this parameter is not provided, indicates the default displayId. |
...
[on('preDisconnect')]\_\_\_JSDOC\_LINK\_DESC\_USD\_0\_\_\_ API.If the **on('preDisconnect')** API is not called, this API does not take effect.
...
Used together with [notifyDisconnect]\_\_\_JSDOC\_LINK\_DESC\_USD\_0\_\_\_; otherwise, the accessibility extension service is automatically disconnected 30 seconds later by default.
