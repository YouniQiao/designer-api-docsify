...
Sets the parameter for a specific operation when the accessibility node element executes this operation. For details,see [AccessibilityAction]\_\_\_JSDOC\_LINK\_DESC\_USD\_0\_\_\_ (executable actions for accessibility node elements).
