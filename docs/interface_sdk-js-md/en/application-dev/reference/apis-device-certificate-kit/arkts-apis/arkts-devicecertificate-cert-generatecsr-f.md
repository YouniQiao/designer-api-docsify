...
| --- | --- | --- | --- |
| keyInfo | [PrivateKeyInfo](arkts-devicecertificate-cert-privatekeyinfo-i.md) | Yes | 包含私钥跟口令的配置参数。 |
| config | [CsrGenerationConfig](arkts-devicecertificate-cert-csrgenerationconfig-i.md) | Yes | 包含生成CSR的配置参数。 |
