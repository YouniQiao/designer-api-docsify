...
\_\_\_HTML\_TAG\_DESC\_USD\_2\_\_\_Because the system time on the device is untrusted, the certificate chain validator does not verify the certificate validity period. To check the validity period of a certificate, use the  
[checkValidityWithDate()]\_\_\_JSDOC\_LINK\_DESC\_USD\_1\_\_\_ API of the **X509Cert** class. For details about certificate specifications, see  
