...
| certType | [CertificateType](arkts-devicecertificate-certificatetype-e.md) | Yes | The type of the certificate to uninstall, only CA_CERT is supported.<br>Currently, only the CA_CERT type is supported. |
