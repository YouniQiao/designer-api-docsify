...
| --- | --- | --- | --- |
| handle | Uint8Array | Yes | 表示初始化操作返回的句柄，。 &lt;br&gt;最大长度为8。 |
| callback | [AsyncCallback](../../apis-basic-service-kit/arkts-apis/arkts-basicservices-base-asynccallback-i.md)&lt;void&gt; | Yes | 回调函数。当中止签名、验签成功时，err为null，否则为错误对象。 |
