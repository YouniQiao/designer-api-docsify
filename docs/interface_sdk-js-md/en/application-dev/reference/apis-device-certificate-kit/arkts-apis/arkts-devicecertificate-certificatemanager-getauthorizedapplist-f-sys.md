...
| Type | Description |
| --- | --- |
| Promise&lt;CMResult&gt; | Promise used to return the result, which is the value of **appUidList** in the [CMResult](arkts-devicecertificate-certificatemanager-cmresult-i.md) object. |
