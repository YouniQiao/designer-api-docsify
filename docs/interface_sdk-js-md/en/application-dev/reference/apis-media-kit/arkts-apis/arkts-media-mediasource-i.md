...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| resourceLoader | [MediaSourceLoader](arkts-media-mediasourceloader-i.md) | Yes | **MediaSourceLoader** object used to obtain media data for the player. |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| mimeType | [AVMimeTypes](arkts-media-avmimetypes-e.md) | Yes | MIME type. |
