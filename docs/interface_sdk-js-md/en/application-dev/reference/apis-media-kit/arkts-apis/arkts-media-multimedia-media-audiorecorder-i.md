...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| type | 'error' | Yes | 录制错误事件回调类型'error'。&lt;br/&gt;- 'error'：音频录制过程中发生错误，触发该事件。 |
| callback | [ErrorCallback](../../apis-basic-service-kit/arkts-apis/arkts-basicservices-base-errorcallback-i.md) | Yes | 录制错误事件回调方法。 |
...
**Substitutes:** @ohos.multimedia.media:media.AVRecorder.pause(callback:
...
**Substitutes:** @ohos.multimedia.media:media.AVRecorder.prepare(config:
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| config | [AudioRecorderConfig](arkts-media-multimedia-media-audiorecorderconfig-i.md) | Yes | 配置录音的相关参数，包括音频输出URI、编码格式、采样率、声道数、输出格式等。 |
...
**Substitutes:** @ohos.multimedia.media:media.AVRecorder.release(callback:
...
**Substitutes:** @ohos.multimedia.media:media.AVRecorder.reset(callback:
...
**Substitutes:** @ohos.multimedia.media:media.AVRecorder.resume(callback:
...
**Substitutes:** @ohos.multimedia.media:media.AVRecorder.start(callback:
...
**Substitutes:** @ohos.multimedia.media:media.AVRecorder.stop(callback:
