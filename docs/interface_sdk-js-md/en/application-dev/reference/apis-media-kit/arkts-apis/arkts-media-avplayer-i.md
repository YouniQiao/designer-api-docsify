...
| --- | --- | --- | --- |
| src | [MediaSource](arkts-media-mediasource-i.md) | Yes | Playback source to be added to the playlist. |
...
| Type | Description |
| --- | --- |
| [Promise](../../apis-na/arkts-apis/arkts-na-promise-i.md)<string> | Promise used to return the result,if success, a unique ID corresponding to the media resource will be returned. |
...
| Type | Description |
| --- | --- |
| [Promise](../../apis-na/arkts-apis/arkts-na-promise-i.md)<void> | Promise is used to return the result. |
...
| Type | Description |
| --- | --- |
| [MediaSource](arkts-media-mediasource-i.md) | current mediasource if the operation is successful; returns undefined otherwise. |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| trackType | [MediaType](../../apis-arkweb/arkts-apis/arkts-arkweb-mediatype-e.md) | Yes | specified media Type, see [MediaType](#MediaType). |

**Return value:**

| Type | Description |
| --- | --- |
| [Promise](../../apis-na/arkts-apis/arkts-na-promise-i.md)<number> | A Promise instance used to return selected track index. |
...
| Type | Description |
| --- | --- |
| [Promise](../../apis-na/arkts-apis/arkts-na-promise-i.md)<Array<Range>> | Promise used to return the list of loaded time ranges on the player.<br>The time range is represented by the **[start, end]** position on the playback timeline, in milliseconds. |
...
| Type | Description |
| --- | --- |
| [Array](../../apis-na/arkts-apis/arkts-na-array-i.md)<drm.MediaKeySystemInfo> | Array of MediaKeySystemInfo objects, each of which contains the **uuid** and **pssh** properties. If the return value is undefined, the mediaKeySystemInfoUpdate event is not triggered. |
...
| Type | Description |
| --- | --- |
| [Array](../../apis-na/arkts-apis/arkts-na-array-i.md)<MediaSource \| undefined> | array of mediasources in the playlist. |
...
| Type | Description |
| --- | --- |
| [Promise](../../apis-na/arkts-apis/arkts-na-promise-i.md)<PlaybackInfo> | Promise used to return **PlaybackInfo**. |
...
| Type | Description |
| --- | --- |
| [Promise](../../apis-na/arkts-apis/arkts-na-promise-i.md)<number> | Promise object, which returns the playback speed. |
...
| Type | Description |
| --- | --- |
| [Promise](../../apis-na/arkts-apis/arkts-na-promise-i.md)<PlaybackMetrics> | Promise used to return the playback metrics of the current AVPlayer. |
...
| Type | Description |
| --- | --- |
| [Promise](../../apis-na/arkts-apis/arkts-na-promise-i.md)<Array<Range>> | Promise used to return the list of seekable time ranges on the player.<br>The time range is represented by the **[start, end]** position on the playback timeline, in milliseconds. |
...
| Type | Description |
| --- | --- |
| [Promise](../../apis-na/arkts-apis/arkts-na-promise-i.md)<Array<number>> | Promise used to return the index array. |
...
| Type | Description |
| --- | --- |
| [Promise](../../apis-na/arkts-apis/arkts-na-promise-i.md)<Array<MediaDescription>> | Promise used to return the MediaDescription array that holds the audio and video track information. |
...
| Type | Description |
| --- | --- |
| [Promise](../../apis-na/arkts-apis/arkts-na-promise-i.md)<TrackSelectionFilter> | Promise used to return the track selection filter configured for the player. |
...
| callback | [OnAVPlayerStateChangeHandle](arkts-media-onavplayerstatechangehandle-t.md) | No | Callback invoked when the event is triggered. If this parameter is specified, only the specified callback is unregistered. Otherwise, all callbacks associated with the **stateChange** event will be unregistered.<br>**Since:** 12 |
...
| callback | [Callback](../../apis-arkui/arkts-components/arkts-arkui-callback-i.md)<number> | No | Callback used to return the result. When the call of **setSpeed** is successful, the effective speed mode is reported. For details, see [PlaybackSpeed](arkts-media-playbackspeed-e.md). If this parameter is specified, only the specified callback is unregistered. Otherwise, all callbacks associated with the **speedDone** event will be unregistered.<br>**Since:** 12 |
...
| callback | [OnPlaybackRateDone](arkts-media-onplaybackratedone-t.md) | No | Callback invoked when the event is triggered. It reports the new playback rate. If this parameter is specified, only the specified callback is unregistered. Otherwise, all callbacks associated with the **playbackRateDone** event will be unregistered. |
...
| callback | [OnBufferingUpdateHandler](arkts-media-onbufferingupdatehandler-t.md) | No | Callback invoked when the event is triggered. If this parameter is specified, only the specified callback is unregistered. Otherwise, all callbacks associated with the **bufferingUpdate** event will be unregistered.<br>**Since:** 12 |
...
| callback | [OnVideoSizeChangeHandler](arkts-media-onvideosizechangehandler-t.md) | No | Callback invoked when the event is triggered. If this parameter is specified, only the specified callback is unregistered. Otherwise, all callbacks associated with the **videoSizeChange** event will be unregistered.<br>**Since:** 12 |
...
| callback | [OnTrackChangeHandler](arkts-media-ontrackchangehandler-t.md) | No | Callback that has been registered to listen for track changes. If this parameter is specified, only the specified callback is unregistered. Otherwise, all callbacks associated with the **trackChange** event will be unregistered. |
...
| payloadTypes | [Array](../../apis-na/arkts-apis/arkts-na-array-i.md)<number> | No | Array of subscribed-to payload types of SEI messages. |
| callback | [OnSeiMessageHandle](arkts-media-onseimessagehandle-t.md) | No | Callback used to listen for SEI message events and receive the subscribed-to payload types. If this parameter is specified, only the specified callback is unregistered.Otherwise, all callbacks associated with the **seiMessageReceived** event will be unregistered. |
...
| callback | [OnSuperResolutionChanged](arkts-media-onsuperresolutionchanged-t.md) | No | Callback used to listen for super resolution status changes. If this parameter is specified, only the specified callback is unregistered. Otherwise, all callbacks associated with the **superResolutionChanged** event will be unregistered. |
...
| callback | [OnAVPlayerStateChangeHandle](arkts-media-onavplayerstatechangehandle-t.md) | Yes | Callback invoked when the event is triggered.<br>**Since:** 12 |
...
| callback | [Callback](../../apis-arkui/arkts-components/arkts-arkui-callback-i.md)<number> | Yes | Callback invoked when the event is triggered. It reports the time position requested by the user.<br>For video playback, [SeekMode](arkts-media-seekmode-e.md) may cause the actual position to be different from that requested by the user. The exact position can be obtained from the **currentTime** property. The time in this callback only means that the requested seek operation is complete. |
...
| callback | [Callback](../../apis-arkui/arkts-components/arkts-arkui-callback-i.md)<number> | Yes | Callback used to return the result. When the call of **setSpeed** is successful, the effective speed mode is reported. For details, see [PlaybackSpeed](arkts-media-playbackspeed-e.md). |
...
| callback | [OnPlaybackRateDone](arkts-media-onplaybackratedone-t.md) | Yes | Callback invoked when the event is triggered. It reports the new playback rate. |
...
| --- | --- | --- | --- |
| type | 'bufferingUpdate' | Yes | Event type, which is **'bufferingUpdate'** in this case. |
| callback | [OnBufferingUpdateHandler](arkts-media-onbufferingupdatehandler-t.md) | Yes | Callback invoked when the event is triggered.<br>**Since:** 12 |
...
| --- | --- | --- | --- |
| type | 'videoSizeChange' | Yes | Event type, which is **'videoSizeChange'** in this case. |
| callback | [OnVideoSizeChangeHandler](arkts-media-onvideosizechangehandler-t.md) | Yes | Callback invoked when the event is triggered.<br>**Since:** 12 |
...
| --- | --- | --- | --- |
| type | 'trackChange' | Yes | Event type, which is **'trackChange'** in this case. The event is triggered when the track changes. |
| callback | [OnTrackChangeHandler](arkts-media-ontrackchangehandler-t.md) | Yes | Callback invoked when the event is triggered. |
...
| --- | --- | --- | --- |
| type | 'seiMessageReceived' | Yes | Event type, which is **'seiMessageReceived'** in this case. The event is triggered when an SEI message is received. |
| payloadTypes | [Array](../../apis-na/arkts-apis/arkts-na-array-i.md)<number> | Yes | Array of subscribed-to payload types of SEI messages. Currently, only payloadType = 5 is supported. |
| callback | [OnSeiMessageHandle](arkts-media-onseimessagehandle-t.md) | Yes | Callback used to listen for SEI message events and receive the subscribed-to payload types. |
...
| --- | --- | --- | --- |
| type | 'superResolutionChanged' | Yes | Event type, which is **'superResolutionChanged'** in this case. The event is triggered when super resolution is enabled or disabled. |
| callback | [OnSuperResolutionChanged](arkts-media-onsuperresolutionchanged-t.md) | Yes | Callback used to listen for super resolution status changes. |
...
Prepares for audio and video playback. This API can be called only when the AVPlayer is in the initialized state.The state changes can be detected by subscribing to the [stateChange](arkts-media-avplayer-i.md#on-2) event. This API uses a promise to return the result.
...
Seeks to the specified playback position. This API can be called only when the AVPlayer is in the prepared,playing, paused, or completed state. You can check whether the seek operation takes effect by subscribing to the [on('seekDone')](arkts-media-avplayer-i.md#on-5) event.
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| timeMs | number | Yes | Position to seek to, in ms. The value range is [0, [duration](../../../../reference/apis-media-kit/arkts-apis-media-AVPlayer.md#properties)].<br>When the seek mode is [SEEK_CONTINUOUS](arkts-media-seekmode-e.md), you can set this parameter to **-1** to end the **SEEK_CONTINUOUS** mode. |
| mode | [SeekMode](arkts-media-seekmode-e.md) | No | Seek mode based on the video I frame. The default value is **SEEK_PREV_SYNC**.**Set this parameter only for video playback.** |
...
| mode | [SwitchMode](arkts-media-switchmode-e.md) | No | Video track mode. The default mode is **SMOOTH**. This parameter takes effect only for DASH/HLS network stream video track switching.<br>HLS network stream video is supported since API version24.<br>**Since:** 26.0.0 |
...
> [STREAM_USAGE_MUSIC](../../apis-audio-kit/arkts-apis/arkts-audio-streamusage-e.md),  
> [STREAM_USAGE_MOVIE](../../apis-audio-kit/arkts-apis/arkts-audio-streamusage-e.md), or  
> [STREAM_USAGE_AUDIOBOOK](../../apis-audio-kit/arkts-apis/arkts-audio-streamusage-e.md).
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| mediaType | [MediaType](../../apis-arkweb/arkts-apis/arkts-arkweb-mediatype-e.md) | Yes | Media type.<br>For API version 12 to 19, only **MEDIA_TYPE_AUD** is supported.<br>Since API version 20, **MEDIA_TYPE_VID** is supported. |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| src | [MediaSource](arkts-media-mediasource-i.md) | Yes | Source of the streaming media to pre-download. |
| strategy | [PlaybackStrategy](arkts-media-playbackstrategy-i.md) | No | strategy for playing the pre-downloaded streaming media. |
...
| mode | [SeekMode](arkts-media-seekmode-e.md) | No | Seek mode, which can be **SeekMode.SEEK_PREV_SYNC** or **SeekMode.SEEK_CLOSEST**.<br  >The default value is **SeekMode.SEEK_PREV_SYNC**. |
...
Sets the playback rate. This API can be called only when the AVPlayer is in the prepared, playing, paused, or completed state. The value range is [0.125, 4.0]. You can check whether the setting takes effect through the [playbackRateDone](arkts-media-avplayer-i.md#on-7) event.
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| strategy | [PlaybackStrategy](arkts-media-playbackstrategy-i.md) | Yes | Playback strategy. |
...
Sets the playback speed. This API can be called only when the AVPlayer is in the prepared, playing, paused, or completed state. You can check whether the speed setting takes effect by subscribing to the [on('speedDone')](arkts-media-avplayer-i.md#on-6) event.
...
Before calling [prepare()](arkts-media-avplayer-i.md#prepare-1), enable super resolution by using [PlaybackStrategy](arkts-media-playbackstrategy-i.md).
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| filter | [TrackSelectionFilter](arkts-media-trackselectionfilter-i.md) | Yes | Track selection filter. |
...
To take effect, this property must be set before [play()](arkts-media-avplayer-i.md#play-1) is called for the first time.
...
To take effect, this property must be set before [prepare()](arkts-media-avplayer-i.md#prepare-1) is called for the first time.
...
[Create a surface ID through XComponent](../../apis-arkui/arkts-components/arkts-arkui-xcomponentcontroller-c.md#getxcomponentsurfaceid-1).
