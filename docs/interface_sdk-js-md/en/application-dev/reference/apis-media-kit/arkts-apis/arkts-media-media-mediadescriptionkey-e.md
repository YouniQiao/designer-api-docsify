...
Track type. The corresponding key value type is number. For details, see [MediaType]\_\_\_JSDOC\_LINK\_DESC\_USD\_0\_\_\_.
...
MIME type of the track. The corresponding key value type is string. For audio and video tracks, the value is the same as that of **MD\_KEY\_CODEC\_MIME**.
