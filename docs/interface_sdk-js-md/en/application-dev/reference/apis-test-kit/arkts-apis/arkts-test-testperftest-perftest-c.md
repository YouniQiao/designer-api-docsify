...
| --- | --- | --- | --- |
| strategy | [PerfTestStrategy](arkts-test-testperftest-perfteststrategy-i.md) | Yes | Performance test strategy. |

**Return value:**

| Type | Description |
| --- | --- |
| [PerfTest](arkts-test-testperftest-perftest-c.md) | { |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| metric | [PerfMetric](arkts-test-testperftest-perfmetric-e.md) | Yes | Performance metric to query. |

**Return value:**

| Type | Description |
| --- | --- |
| [PerfMeasureResult](arkts-test-testperftest-perfmeasureresult-i.md) | Measurement result of the specified performance metric, including the measurement data value and statistical values (maximum value, minimum value, and average value) of each round. |
