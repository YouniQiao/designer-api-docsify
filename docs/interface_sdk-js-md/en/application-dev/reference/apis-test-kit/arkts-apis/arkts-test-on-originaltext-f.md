...
[accessibilityLevel]\_\_\_JSDOC\_LINK\_DESC\_USD\_0\_\_\_of a component is set to 'no' or 'no-hide-descendants',you will not be able to use \_\_\_JSDOC\_LINK\_DESC\_USD\_1\_\_\_ to match the component with the specified original text, but you can use this method to achieve it;if the component does not set the above accessibility property, this method has no difference with \_\_\_JSDOC\_LINK\_DESC\_USD\_2\_\_\_
