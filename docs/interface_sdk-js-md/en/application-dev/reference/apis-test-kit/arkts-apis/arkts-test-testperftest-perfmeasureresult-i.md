...
**Type:** [PerfMetric](arkts-test-testperftest-perfmetric-e.md)
...
Measurement data value of each round of the tested performance metric. The unit is the same as that of the corresponding [PerfMetric](arkts-test-testperftest-perfmetric-e.md). If data collection fails, the value **-1** is returned.
