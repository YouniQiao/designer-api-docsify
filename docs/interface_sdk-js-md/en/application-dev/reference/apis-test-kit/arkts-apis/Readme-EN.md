...
- [@ohos.application.testRunner](arkts-application-testrunner.md)
  - [TestRunner](arkts-test-applicationtestrunner-testrunner-i.md)
...
- [@ohos.test.PerfTest](arkts-test-perftest.md)
  ...
  - [PerfMeasureResult](arkts-test-testperftest-perfmeasureresult-i.md)
  - [PerfTestStrategy](arkts-test-testperftest-perfteststrategy-i.md)
  - [PerfMetric](arkts-test-testperftest-perfmetric-e.md)