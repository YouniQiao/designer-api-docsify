...
| --- | --- | --- | --- |
| formId | string | Yes | Indicates the form provider formId. |
| callback | [AsyncCallback](../../apis-basic-service-kit/arkts-apis/arkts-basicservices-asynccallback-t.md)&lt;formInfo.RunningFormInfo&gt; | Yes | The callback of getFormInstancesById. |
