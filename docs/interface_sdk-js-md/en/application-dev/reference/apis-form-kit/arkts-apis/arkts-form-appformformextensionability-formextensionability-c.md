...
| --- | --- | --- | --- |
| want | [Want](../../apis-ability-kit/arkts-apis/arkts-ability-appabilitywant-want-c.md) | Yes | Description of the widget state, including the bundle name, ability name, module name, and widget name. |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| newConfig | [Configuration](../../apis-ability-kit/arkts-apis/arkts-ability-appabilityconfiguration-configuration-i.md) | Yes | New configuration. |
