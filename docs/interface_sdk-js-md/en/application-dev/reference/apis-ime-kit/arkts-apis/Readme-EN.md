...
- [@ohos.inputMethod](arkts-inputmethod.md)
  ...
  <!--Del-->
  - [getCurrentInputMethod(system api)](arkts-ime-inputmethod-getcurrentinputmethod-f-sys.md)<!--DelEnd-->
  - [getCurrentInputMethodSubtype](arkts-ime-inputmethod-getcurrentinputmethodsubtype-f.md)
  <!--Del-->
  - [getCurrentInputMethodSubtype(system api)](arkts-ime-inputmethod-getcurrentinputmethodsubtype-f-sys.md)<!--DelEnd-->
  - [getDefaultInputMethod](arkts-ime-inputmethod-getdefaultinputmethod-f.md)
  <!--Del-->
  - [getDefaultInputMethod(system api)](arkts-ime-inputmethod-getdefaultinputmethod-f-sys.md)<!--DelEnd-->
  ...
  <!--Del-->
  - [getSystemInputMethodConfigAbility(system api)](arkts-ime-inputmethod-getsysteminputmethodconfigability-f-sys.md)<!--DelEnd-->
  ...
  <!--Del-->
  - [switchInputMethod(system api)](arkts-ime-inputmethod-switchinputmethod-f-sys.md)<!--DelEnd-->
  <!--Del-->
  - [switchInputMethodWithUserId(system api)](arkts-ime-inputmethod-switchinputmethodwithuserid-f-sys.md)<!--DelEnd-->
  ...
  <!--Del-->
  - [InputMethodController(system api)](arkts-ime-inputmethod-inputmethodcontroller-i-sys.md)<!--DelEnd-->
  ...
  <!--Del-->
  - [InputMethodSetting(system api)](arkts-ime-inputmethod-inputmethodsetting-i-sys.md)<!--DelEnd-->
  - [InputWindowInfo](arkts-ime-inputmethod-inputwindowinfo-i.md)
  <!--Del-->
  - [InputWindowInfo(system api)](arkts-ime-inputmethod-inputwindowinfo-i-sys.md)<!--DelEnd-->
  ...
  <!--Del-->
  - [ImeChangeWithUserIdCallback(system api)](arkts-ime-inputmethod-imechangewithuseridcallback-t-sys.md)<!--DelEnd-->
...
- [@ohos.inputMethod.ExtraConfig](arkts-inputmethod-extraconfig.md)
  - [InputMethodExtraConfig](arkts-ime-inputmethodextraconfig-inputmethodextraconfig-i.md)
  - [CustomValueType](arkts-ime-customvaluetype-t.md)
- [@ohos.inputMethod.Panel](arkts-inputmethod-panel.md)
  - [PanelInfo](arkts-ime-inputmethodpanel-panelinfo-i.md)
  - [PanelFlag](arkts-ime-inputmethodpanel-panelflag-e.md)
  - [PanelType](arkts-ime-inputmethodpanel-paneltype-e.md)
- [@ohos.inputMethodEngine](arkts-inputmethodengine.md)
  ...
  <!--Del-->
  - [EditorAttribute(system api)](arkts-ime-inputmethodengine-editorattribute-i-sys.md)<!--DelEnd-->
  ...
  <!--Del-->
  - [ImmersiveEffect(system api)](arkts-ime-inputmethodengine-immersiveeffect-i-sys.md)<!--DelEnd-->
  ...
  <!--Del-->
  - [Panel(system api)](arkts-ime-inputmethodengine-panel-i-sys.md)<!--DelEnd-->
  ...
  <!--Del-->
  - [SizeUpdateCallback(system api)](arkts-ime-inputmethodengine-sizeupdatecallback-t-sys.md)<!--DelEnd-->
  ...
  <!--Del-->
  - [FluidLightMode(system api)](arkts-ime-inputmethodengine-fluidlightmode-e-sys.md)<!--DelEnd-->
...
- [@ohos.inputMethodSystemPanelManager](arkts-inputmethodsystempanelmanager.md)<!--DelEnd-->
  ...
  <!--Del-->
  - [offSystemPanelStatusChange(system api)](arkts-ime-inputmethodsystempanelmanager-offsystempanelstatuschange-f-sys.md)<!--DelEnd-->
  <!--Del-->
  - [offSystemPrivateCommand(system api)](arkts-ime-inputmethodsystempanelmanager-offsystemprivatecommand-f-sys.md)<!--DelEnd-->
  <!--Del-->
  - [onSystemPanelStatusChange(system api)](arkts-ime-inputmethodsystempanelmanager-onsystempanelstatuschange-f-sys.md)<!--DelEnd-->
  <!--Del-->
  - [onSystemPrivateCommand(system api)](arkts-ime-inputmethodsystempanelmanager-onsystemprivatecommand-f-sys.md)<!--DelEnd-->
  <!--Del-->
  - [sendPrivateCommand(system api)](arkts-ime-inputmethodsystempanelmanager-sendprivatecommand-f-sys.md)<!--DelEnd-->
  <!--Del-->
  - [SystemPanelStatus(system api)](arkts-ime-inputmethodsystempanelmanager-systempanelstatus-i-sys.md)<!--DelEnd-->
  <!--Del-->
  - [CommandDataType(system api)](arkts-ime-inputmethodsystempanelmanager-commanddatatype-t-sys.md)<!--DelEnd-->
  <!--Del-->
  - [InputMethodInputType(system api)](arkts-ime-inputmethodsystempanelmanager-inputmethodinputtype-e-sys.md)<!--DelEnd-->