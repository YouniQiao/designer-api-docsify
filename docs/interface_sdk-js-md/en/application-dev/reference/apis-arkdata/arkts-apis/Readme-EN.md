...
<!--Del-->
- [@ohos.application.DataShareExtensionAbility(DataShare ExtensionAbility)](arkts-arkdata-application-datashareextensionability.md)<!--DelEnd-->
  <!--Del-->
...
- [@ohos.data.cloudData(Device-Cloud Service)](arkts-arkdata-data-clouddata.md)
  - [cloudData](arkts-arkdata-clouddata-n.md)
    ...
    - [sharing(system api)](arkts-arkdata-clouddata-sharing-n.md)<!--DelEnd-->
      ...
      <!--Del-->
      - [changeConfirmation(system api)](arkts-arkdata-sharing-changeconfirmation-f-sys.md)<!--DelEnd-->
      <!--Del-->
      - [changePrivilege(system api)](arkts-arkdata-sharing-changeprivilege-f-sys.md)<!--DelEnd-->
      <!--Del-->
      - [confirmInvitation(system api)](arkts-arkdata-sharing-confirminvitation-f-sys.md)<!--DelEnd-->
      <!--Del-->
      - [exit(system api)](arkts-arkdata-sharing-exit-f-sys.md)<!--DelEnd-->
      <!--Del-->
      - [queryParticipants(system api)](arkts-arkdata-sharing-queryparticipants-f-sys.md)<!--DelEnd-->
      <!--Del-->
      - [queryParticipantsByInvitation(system api)](arkts-arkdata-sharing-queryparticipantsbyinvitation-f-sys.md)<!--DelEnd-->
      <!--Del-->
      - [share(system api)](arkts-arkdata-sharing-share-f-sys.md)<!--DelEnd-->
      <!--Del-->
      - [unshare(system api)](arkts-arkdata-sharing-unshare-f-sys.md)<!--DelEnd-->
      <!--Del-->
      - [Participant(system api)](arkts-arkdata-sharing-participant-i-sys.md)<!--DelEnd-->
      <!--Del-->
      - [Privilege(system api)](arkts-arkdata-sharing-privilege-i-sys.md)<!--DelEnd-->
      <!--Del-->
      - [Result(system api)](arkts-arkdata-sharing-result-i-sys.md)<!--DelEnd-->
      <!--Del-->
      - [Role(system api)](arkts-arkdata-sharing-role-e-sys.md)<!--DelEnd-->
      <!--Del-->
      - [SharingCode(system api)](arkts-arkdata-sharing-sharingcode-e-sys.md)<!--DelEnd-->
      <!--Del-->
      - [State(system api)](arkts-arkdata-sharing-state-e-sys.md)<!--DelEnd-->
    ...
    <!--Del-->
    - [Config(system api)](arkts-arkdata-clouddata-config-c-sys.md)<!--DelEnd-->
    - [AutoSyncTriggerInfo](arkts-arkdata-clouddata-autosynctriggerinfo-i.md)
    <!--Del-->
    - [BundleInfo(system api)](arkts-arkdata-clouddata-bundleinfo-i-sys.md)<!--DelEnd-->
    <!--Del-->
    - [ClearConfig(system api)](arkts-arkdata-clouddata-clearconfig-i-sys.md)<!--DelEnd-->
    <!--Del-->
    - [DBActionInfo(system api)](arkts-arkdata-clouddata-dbactioninfo-i-sys.md)<!--DelEnd-->
    <!--Del-->
    - [DBSwitchInfo(system api)](arkts-arkdata-clouddata-dbswitchinfo-i-sys.md)<!--DelEnd-->
    <!--Del-->
    - [ExtraData(system api)](arkts-arkdata-clouddata-extradata-i-sys.md)<!--DelEnd-->
    <!--Del-->
    - [StatisticInfo(system api)](arkts-arkdata-clouddata-statisticinfo-i-sys.md)<!--DelEnd-->
    <!--Del-->
    - [SwitchConfig(system api)](arkts-arkdata-clouddata-switchconfig-i-sys.md)<!--DelEnd-->
    <!--Del-->
    - [SyncInfo(system api)](arkts-arkdata-clouddata-syncinfo-i-sys.md)<!--DelEnd-->
    - [AutoSyncTriggerMode](arkts-arkdata-clouddata-autosynctriggermode-e.md)
    <!--Del-->
    - [ClearAction(system api)](arkts-arkdata-clouddata-clearaction-e-sys.md)<!--DelEnd-->
...
- [@ohos.data.cloudExtension(Device-Cloud Sharing Extension)](arkts-arkdata-data-cloudextension.md)<!--DelEnd-->
  ...
  <!--Del-->
  - [createCloudDBStub(system api)](arkts-arkdata-cloudextension-createclouddbstub-f-sys.md)<!--DelEnd-->
  <!--Del-->
  - [createCloudServiceStub(system api)](arkts-arkdata-cloudextension-createcloudservicestub-f-sys.md)<!--DelEnd-->
  <!--Del-->
  - [createShareServiceStub(system api)](arkts-arkdata-cloudextension-createshareservicestub-f-sys.md)<!--DelEnd-->
  <!--Del-->
  - [AppBriefInfo(system api)](arkts-arkdata-cloudextension-appbriefinfo-i-sys.md)<!--DelEnd-->
  <!--Del-->
  - [AppSchema(system api)](arkts-arkdata-cloudextension-appschema-i-sys.md)<!--DelEnd-->
  <!--Del-->
  - [AssetLoader(system api)](arkts-arkdata-cloudextension-assetloader-i-sys.md)<!--DelEnd-->
  <!--Del-->
  - [CloudAsset(system api)](arkts-arkdata-cloudextension-cloudasset-i-sys.md)<!--DelEnd-->
  <!--Del-->
  - [CloudData(system api)](arkts-arkdata-cloudextension-clouddata-i-sys.md)<!--DelEnd-->
  <!--Del-->
  - [CloudDB(system api)](arkts-arkdata-cloudextension-clouddb-i-sys.md)<!--DelEnd-->
  <!--Del-->
  - [CloudInfo(system api)](arkts-arkdata-cloudextension-cloudinfo-i-sys.md)<!--DelEnd-->
  <!--Del-->
  - [CloudService(system api)](arkts-arkdata-cloudextension-cloudservice-i-sys.md)<!--DelEnd-->
  <!--Del-->
  - [Database(system api)](arkts-arkdata-cloudextension-database-i-sys.md)<!--DelEnd-->
  <!--Del-->
  - [ExtensionValue(system api)](arkts-arkdata-cloudextension-extensionvalue-i-sys.md)<!--DelEnd-->
  <!--Del-->
  - [Field(system api)](arkts-arkdata-cloudextension-field-i-sys.md)<!--DelEnd-->
  <!--Del-->
  - [LockInfo(system api)](arkts-arkdata-cloudextension-lockinfo-i-sys.md)<!--DelEnd-->
  <!--Del-->
  - [Result(system api)](arkts-arkdata-cloudextension-result-i-sys.md)<!--DelEnd-->
  <!--Del-->
  - [ServiceInfo(system api)](arkts-arkdata-cloudextension-serviceinfo-i-sys.md)<!--DelEnd-->
  <!--Del-->
  - [ShareCenter(system api)](arkts-arkdata-cloudextension-sharecenter-i-sys.md)<!--DelEnd-->
  <!--Del-->
  - [SubscribeId(system api)](arkts-arkdata-cloudextension-subscribeid-i-sys.md)<!--DelEnd-->
  <!--Del-->
  - [SubscribeInfo(system api)](arkts-arkdata-cloudextension-subscribeinfo-i-sys.md)<!--DelEnd-->
  <!--Del-->
  - [Table(system api)](arkts-arkdata-cloudextension-table-i-sys.md)<!--DelEnd-->
  <!--Del-->
  - [CloudAssets(system api)](arkts-arkdata-cloudextension-cloudassets-t-sys.md)<!--DelEnd-->
  <!--Del-->
  - [CloudType(system api)](arkts-arkdata-cloudextension-cloudtype-t-sys.md)<!--DelEnd-->
  <!--Del-->
  - [ErrorCode(system api)](arkts-arkdata-cloudextension-errorcode-e-sys.md)<!--DelEnd-->
  <!--Del-->
...
- [@ohos.data.commonType(Common Data Types)](arkts-arkdata-data-commontype.md)
...
- [@ohos.data.dataAbility(DataAbility Predicates)](arkts-arkdata-data-dataability.md)
...
- [@ohos.data.dataShare(DataShare)](arkts-arkdata-data-datashare.md)
...
- [@ohos.data.dataSharePredicates(DataShare Predicates)](arkts-arkdata-data-datasharepredicates.md)
...
<!--Del-->
- [@ohos.data.DataShareResultSet(DataShare Result Set)](arkts-arkdata-data-datashareresultset.md)<!--DelEnd-->
  <!--Del-->
...
- [@ohos.data.distributedData(Distributed Data Management)](arkts-arkdata-data-distributeddata.md)
...
- [@ohos.data.distributedDataObject(Distributed Data Object)](arkts-arkdata-data-distributeddataobject.md)
...
- [@ohos.data.distributedKVStore(Distributed KV Store)](arkts-arkdata-data-distributedkvstore.md)
  ...
  <!--Del-->
  - [DeviceKVStore(system api)](arkts-arkdata-distributedkvstore-devicekvstore-i-sys.md)<!--DelEnd-->
...
- [@ohos.data.intelligence(ArkData Intelligence Platform)](arkts-arkdata-data-intelligence.md)
...
- [@ohos.data.preferences(User Preferences)](arkts-arkdata-data-preferences.md)
...
- [@ohos.data.rdb(RDB Store)](arkts-arkdata-data-rdb.md)
...
- [@ohos.data.relationalStore(RDB Store)](arkts-arkdata-data-relationalstore.md)
  ...
  <!--Del-->
  - [CloudSyncConfig(system api)](arkts-arkdata-relationalstore-cloudsyncconfig-i-sys.md)<!--DelEnd-->
  ...
  <!--Del-->
  - [DistributedConfig(system api)](arkts-arkdata-relationalstore-distributedconfig-i-sys.md)<!--DelEnd-->
  <!--Del-->
  - [DistributedInfo(system api)](arkts-arkdata-relationalstore-distributedinfo-i-sys.md)<!--DelEnd-->
  ...
  <!--Del-->
  - [RdbStore(system api)](arkts-arkdata-relationalstore-rdbstore-i-sys.md)<!--DelEnd-->
  <!--Del-->
  - [Reference(system api)](arkts-arkdata-relationalstore-reference-i-sys.md)<!--DelEnd-->
  - [Result](arkts-arkdata-relationalstore-result-i.md)
  - [ResultSet](arkts-arkdata-relationalstore-resultset-i.md)
  <!--Del-->
  - [ResultSet(system api)](arkts-arkdata-relationalstore-resultset-i-sys.md)<!--DelEnd-->
  ...
  <!--Del-->
  - [StoreConfig(system api)](arkts-arkdata-relationalstore-storeconfig-i-sys.md)<!--DelEnd-->
  ...
  <!--Del-->
  - [DistributedField(system api)](arkts-arkdata-relationalstore-distributedfield-e-sys.md)<!--DelEnd-->
  <!--Del-->
  - [DistributedOrigin(system api)](arkts-arkdata-relationalstore-distributedorigin-e-sys.md)<!--DelEnd-->
  ...
  <!--Del-->
  - [HAMode(system api)](arkts-arkdata-relationalstore-hamode-e-sys.md)<!--DelEnd-->
...
- [@ohos.data.sendablePreferences](arkts-arkdata-data-sendablepreferences.md)
...
- [@ohos.data.storage(Lightweight Data Storage)](arkts-arkdata-data-storage.md)
...
- [@ohos.data.UdmfComponents](arkts-arkdata-data-udmfcomponents.md)
...
- [@ohos.data.unifiedDataChannel(Unified Data Channel)](arkts-arkdata-data-unifieddatachannel.md)
...
- [@ohos.data.uniformDataStruct(Uniform Data Structs)](arkts-arkdata-data-uniformdatastruct.md)
...
- [@ohos.data.uniformTypeDescriptor(Uniform Data Definition and Description)](arkts-arkdata-data-uniformtypedescriptor.md)
  ...
  <!--Del-->
  - [registerTypeDescriptors(system api)](arkts-arkdata-uniformtypedescriptor-registertypedescriptors-f-sys.md)<!--DelEnd-->
  <!--Del-->
...
- [@ohos.data.ValuesBucket(Data Set)](arkts-arkdata-data-valuesbucket.md)
  - [ValuesBucket](arkts-arkdata-valuesbucket-t.md)
  - [ValueType](arkts-arkdata-valuetype-t.md)
- [@system.storage(Data Storage)](arkts-arkdata-system-storage.md)
