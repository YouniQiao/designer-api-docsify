...
| --- | --- | --- | --- |
| instance | [AssetLoader](arkts-arkdata-assetloader-i-sys.md) | Yes | AssetLoader instance. |

**Return value:**

| Type | Description |
| --- | --- |
| [Promise](../../apis-na/arkts-apis/arkts-na-promise-i.md)<rpc.RemoteObject> | Promise used to return the rpc.RemoteObject instance of AssetLoader. |
