...
| --- | --- | --- | --- |
| valuesBucket | \_\_\_MD\_LINK\_USD\_0\_\_\_ | Yes | Data that can be passed across threads. |

**Return value:**

| Type | Description |
| --- | --- |
| \_\_\_MD\_LINK\_USD\_0\_\_\_ | Data that cannot be passed across threads. |
