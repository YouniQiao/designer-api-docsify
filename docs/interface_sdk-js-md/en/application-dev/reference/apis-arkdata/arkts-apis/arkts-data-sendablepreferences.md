...
| Name | Description |
| --- | --- |
| [MAX_KEY_LENGTH](arkts-arkdata-sendablepreferences-con.md#maxkeylength) | Maximum length of a key, which is 1024 bytes. |
| [MAX_VALUE_LENGTH](arkts-arkdata-sendablepreferences-con.md#maxvaluelength) | Maximum length of a value, which is 16 MB. |
