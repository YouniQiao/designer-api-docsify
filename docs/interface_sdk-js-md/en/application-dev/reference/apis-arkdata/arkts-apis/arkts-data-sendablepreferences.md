...
\_\_\_MD\_LINK\_DESC\_USD\_0\_\_\_directory. Before creating a preferences object, ensure that the **preferencesDir** path can be read and written. The  
[encryption level]\_\_\_JSDOC\_LINK\_DESC\_USD\_3\_\_\_ of the persistent file directory determines the access to the files. For details, see  
\_\_\_MD\_LINK\_DESC\_USD\_1\_\_\_.Sendable preferences can be passed between concurrent ArkTS instances (including the main thread and TaskPool or Worker threads) by reference. It allows for higher performance than  
[user preferences]\_\_\_JSDOC\_LINK\_DESC\_USD\_4\_\_\_. For more information, see  
