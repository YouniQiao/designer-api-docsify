...
| --- | --- | --- | --- |
| asset | \_\_\_MD\_LINK\_USD\_0\_\_\_ | Yes | Asset data that cannot be passed across threads. |

**Return value:**

| Type | Description |
| --- | --- |
| \_\_\_MD\_LINK\_USD\_0\_\_\_ | Asset data that can be passed across threads. |
