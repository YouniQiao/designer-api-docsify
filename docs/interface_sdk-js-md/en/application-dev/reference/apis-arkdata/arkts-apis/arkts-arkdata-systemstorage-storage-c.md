...
| --- | --- | --- | --- |
| options | [ClearStorageOptions](arkts-arkdata-systemstorage-clearstorageoptions-i.md) | No | Indicates the target options. |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| options | [DeleteStorageOptions](arkts-arkdata-systemstorage-deletestorageoptions-i.md) | Yes | Indicates the target options. |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| options | [GetStorageOptions](arkts-arkdata-systemstorage-getstorageoptions-i.md) | Yes | Indicates the target options. |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| options | [SetStorageOptions](arkts-arkdata-systemstorage-setstorageoptions-i.md) | Yes | Indicates the target options. |
