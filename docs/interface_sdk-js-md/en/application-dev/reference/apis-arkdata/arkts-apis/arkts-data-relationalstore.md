...
| [ValuesBucket](arkts-arkdata-relationalstore-valuesbucket-t.md) | Values in buckets are stored in key-value pairs, change {[key: string]: ValueType;} to Record & lt;string, ValueType & gt; |
