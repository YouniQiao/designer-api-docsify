...
| collections.Float32Array | The value is an array of 32-bit floating-point numbers. <br>If the field type is **collections.Float32Array**, the type in the SQL statement for creating a table must be **floatvector(128)**. |
