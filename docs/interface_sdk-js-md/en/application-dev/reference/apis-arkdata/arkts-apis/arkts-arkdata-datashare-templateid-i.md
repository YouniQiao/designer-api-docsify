...
[**addTemplate**](arkts-arkdata-datashare-datasharehelper-i.md#addTemplate) to identify a template.
...
[**addTemplate**](arkts-arkdata-datashare-datasharehelper-i.md#addTemplate).
...
[**addTemplate**](arkts-arkdata-datashare-datasharehelper-i.md#addTemplate). The ID of each subscriber must be unique.
