...
| [getTypeDescriptor](arkts-arkdata-uniformtypedescriptor-gettypedescriptor-f.md#gettypedescriptor-1) | Queries and returns the uniform type descriptor by the given uniform data type ID. |
