...
[preferences.getPreferences]\_\_\_JSDOC\_LINK\_DESC\_USD\_0\_\_\_.
...
[flush]\_\_\_JSDOC\_LINK\_DESC\_USD\_0\_\_\_ to persist the **Preferences**  
instance.
...
Deletes a KV pair from this **Preferences** instance. This API uses an asynchronous callback to return the result. You can use [flush]\_\_\_JSDOC\_LINK\_DESC\_USD\_0\_\_\_ to persist the  
...
[flushed]\_\_\_JSDOC\_LINK\_DESC\_USD\_0\_\_\_.
...
[flush]\_\_\_JSDOC\_LINK\_DESC\_USD\_0\_\_\_ in any process (including the current process) will trigger the callback in this API.This API is provided for applications that have applied for [dataGroupId]\_\_\_JSDOC\_LINK\_DESC\_USD\_1\_\_\_. Avoid using this API for the applications that have not applied for **dataGroupId** because calling it in multiple process may damage the persistent files and cause data loss.
...
Writes data to this **Preferences** instance. This API uses an asynchronous callback to return the result. You can use [flush]\_\_\_JSDOC\_LINK\_DESC\_USD\_0\_\_\_ to persist the  
**Preferences** instance.
