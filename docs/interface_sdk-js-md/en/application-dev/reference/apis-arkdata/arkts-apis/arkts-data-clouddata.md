...
| Name | Description |
| --- | --- |
| [cloudData](arkts-arkdata-clouddata-n.md) | The **cloudData** module provides APIs for implementing device-cloud synergy and device-cloud sharing, and setting the device-cloud sync strategy. |
