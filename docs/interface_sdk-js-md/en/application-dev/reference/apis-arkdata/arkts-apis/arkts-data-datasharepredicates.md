...
[RDB store](../../../apis-arkdata/js-apis-data-relationalStore-sys.md) and  
[KV store](../../../apis-arkdata/js-apis-distributedKVStore-sys.md) are called. In this scenario, use the corresponding predicate based on the database type.
