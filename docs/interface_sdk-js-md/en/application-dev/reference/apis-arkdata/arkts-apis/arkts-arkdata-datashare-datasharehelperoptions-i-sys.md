...
If the value is **true**, the [DataShareHelper](arkts-arkdata-datashare-datasharehelperoptions-i-sys.md) to be created is in proxy mode, and all operations will not open the data provider application unless the database does not exist. If the database does not exist,[createDataShareHelper](arkts-arkdata-datashare-createdatasharehelper-f-sys.md#createdatasharehelper)will start the data provider to create a database.
