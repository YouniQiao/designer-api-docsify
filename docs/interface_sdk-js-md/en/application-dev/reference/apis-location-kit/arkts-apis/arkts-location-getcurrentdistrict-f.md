...
| --- | --- | --- | --- |
| params | [DistrictRequestParams](arkts-location-districtrequestparams-i.md) | No | Indicates request parameters for obtaining the district information. |

**Return value:**

| Type | Description |
| --- | --- |
| [Promise](../../apis-na/arkts-apis/arkts-na-promise-i.md)<DistrictInfo> | Promise used to return ${DistrictInfo}. |
