...
> 
> This API does not affect the heap snapshot dumped in other scenarios. For example, it does not affect the result &gt; of [dumpJsRawHeapData](arkts-performanceanalysis-hidebug-dumpjsrawheapdata-f.md).
> 
