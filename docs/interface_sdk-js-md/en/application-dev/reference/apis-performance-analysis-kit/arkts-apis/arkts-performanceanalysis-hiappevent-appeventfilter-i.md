...
Event domain, which can be the system event domain (**hiAppEvent.domain.OS**) or the event domain of the custom event information ([AppEventInfo](arkts-performanceanalysis-hiappevent-appeventinfo-i.md)) passed through the [Write](arkts-performanceanalysis-hiappevent-write-f.md#write) API.
