...
| ------------------------------- | ------ | ---- | ---- | ------------------ |  
| USER\_ID | string | Yes | No | Custom user ID. |  
| DISTRIBUTED\_SERVICE\_NAME | string | Yes | No | Distributed service name. |  
| DISTRIBUTED\_SERVICE\_INSTANCE\_ID | string | Yes | No | Distributed service instance ID.|
