...
| [setLogLevel](arkts-performanceanalysis-hilog-setloglevel-f.md#setloglevel) | Sets the minimum log level of the current application process.  You can configure different preference strategies using the **prefer** parameter. The **PREFER\_\_\_ESCAPED\_UNDERSCORE\_\_\_CLOSE\_\_\_ESCAPED\_UNDERSCORE\_\_\_LOG** strategy has the same effect as the **setMinLogLevel()** function. |
