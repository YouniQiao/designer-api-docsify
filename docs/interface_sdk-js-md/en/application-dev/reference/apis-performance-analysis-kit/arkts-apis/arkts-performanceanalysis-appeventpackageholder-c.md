...
| --- | --- | --- | --- |
| watcherName | string | Yes | Name of the event watcher added through [addWatcher](arkts-performanceanalysis-addwatcher-f.md#addwatcher-1). If no watcher is added, no data is displayed by default. |
