...
| --- | --- | --- | --- |
| tags | long[] | Yes | Scope for trace collection. For details, see [tags](arkts-performanceanalysis-hidebug-tags-n.md). |
...
| limitSize | int | Yes | Limit on the trace file size, in bytes. The maximum size of a single file is 500 MB. |
