...
| [traceByValue](arkts-performanceanalysis-hitracemeter-tracebyvalue-f.md#tracebyvalue) | Traces the value changes of an integer variable.  Since API version 19, you are advised to use the [traceByValue<sup>19+</sup>()](arkts-performanceanalysis-hitracemeter-tracebyvalue-f.md#tracebyvalue)API to specify the trace output level |
