...
Adds a trace point for the [@ohos.hiTraceMeter (Performance Tracing)]\_\_\_JSDOC\_LINK\_DESC\_USD\_0\_\_\_logging, which is synchronous.
...
types must also be used together. Otherwise, the start and end trace points of HiTraceMeter cannot match each other.
...
| --- | --- | --- | --- |
| mode | \_\_\_MD\_LINK\_USD\_0\_\_\_ | Yes | Communication mode for the trace point. |
| type | \_\_\_MD\_LINK\_USD\_0\_\_\_ | Yes | Trace point type. |
| id | \_\_\_MD\_LINK\_USD\_0\_\_\_ | Yes | HiTraceId** instance for trace point triggering. |
