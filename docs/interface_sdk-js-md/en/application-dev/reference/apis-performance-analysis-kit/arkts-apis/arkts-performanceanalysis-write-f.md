...
| --- | --- | --- | --- |
| info | [AppEventInfo](arkts-performanceanalysis-appeventinfo-i.md) | Yes | Application event object. You are advised to avoid the conflict between the custom event name and the system event name constant defined in [Event](arkts-performanceanalysis-event-n.md#event).<br>**Since:** 11 |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| info | [AppEventInfo](arkts-performanceanalysis-appeventinfo-i.md) | Yes | Application event object. You are advised to avoid the conflict between the custom event name and the system event name constant defined in [Event](arkts-performanceanalysis-event-n.md#event). |
