...
| Name | Description |
| --- | --- |
| [Event](arkts-performanceanalysis-event-depr-n.md) | Provides constants that define the names of all predefined events.\| Name \| Type \| Readable\| Writable\| Description \| \| ------------------------- \| ------ \| ---- \| ---- \| -------------------- \| \| USER_LOGIN \| string \| Yes \| No \| User login event. \| \| USER_LOGOUT \| string \| Yes \| No \| User logout event. \| \| DISTRIBUTED_SERVICE_START \| string \| Yes \| No \| Distributed service startup event.\| |
| [Param](arkts-performanceanalysis-param-depr-n.md) | Provides constants that define the names of all predefined event parameters.\| Name \| Type \| Readable\| Writable\| Description \| \| ------------------------------- \| ------ \| ---- \| ---- \| ------------------ \| \| USER_ID \| string \| Yes \| No \| Custom user ID. \| \| DISTRIBUTED_SERVICE_NAME \| string \| Yes \| No \| Distributed service name. \| \| DISTRIBUTED_SERVICE_INSTANCE_ID \| string \| Yes \| No \| Distributed service instance ID.\| |
