...
| callback | [AsyncCallback](arkts-basicservices-asynccallback-i.md)<TaskInfo> | Yes | callback function with a `TaskInfo` argument for informations of the |
...
| Type | Description |
| --- | --- |
| [Promise](../../apis-na/arkts-apis/arkts-na-promise-i.md)<TaskInfo> | the promise returned by the function. |
