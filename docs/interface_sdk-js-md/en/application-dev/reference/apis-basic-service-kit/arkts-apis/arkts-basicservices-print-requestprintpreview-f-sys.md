...
| callback | ArkTS-Dyn: [Callback](arkts-basicservices-base-callback-i.md)&lt;number&gt;  <br>ArkTS-Sta：[Callback](arkts-basicservices-base-callback-i.md)&lt;int&gt; | Yes | Callback used to return the result. |
