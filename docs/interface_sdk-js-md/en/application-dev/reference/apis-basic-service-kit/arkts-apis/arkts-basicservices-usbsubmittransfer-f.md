...
| --- | --- | --- | --- |
| transfer | [UsbDataTransferParams](arkts-basicservices-usbdatatransferparams-i.md) | Yes | As a USB data transfer interface, it is required for a client to initiate a transfer request. |
