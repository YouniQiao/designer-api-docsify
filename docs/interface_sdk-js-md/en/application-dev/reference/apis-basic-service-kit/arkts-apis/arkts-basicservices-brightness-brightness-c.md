...
| --- | --- | --- | --- |
| options | [GetBrightnessModeOptions](arkts-basicservices-brightness-getbrightnessmodeoptions-i.md) | No | Options for obtaining the screen brightness mode. This parameter is |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| options | [GetBrightnessOptions](arkts-basicservices-brightness-getbrightnessoptions-i.md) | No | Options for obtaining the screen brightness. This parameter is |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| options | [SetKeepScreenOnOptions](arkts-basicservices-brightness-setkeepscreenonoptions-i.md) | No | Options for setting the screen to be steady on. This parameter is |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| options | [SetBrightnessModeOptions](arkts-basicservices-brightness-setbrightnessmodeoptions-i.md) | No | Options for setting the screen brightness mode. This parameter is |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| options | [SetBrightnessOptions](arkts-basicservices-brightness-setbrightnessoptions-i.md) | No | Options for setting the screen brightness. This parameter is |
