...
For details about the power key filtering strategy, see [power.PowerKeyFilteringStrategy](arkts-basicservices-powerkeyfilteringstrategy-e.md).
...
| --- | --- | --- | --- |
| strategy | [PowerKeyFilteringStrategy](arkts-basicservices-powerkeyfilteringstrategy-e.md) | Yes | Power key filtering strategy. The value must be of the enum type. |
