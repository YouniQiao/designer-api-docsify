...
1. Call [usbManager.getDevices](arkts-basicservices-getdevices-f.md#getdevices-1) to obtain the USB device list.2. Call [usbManager.requestRight](arkts-basicservices-requestright-f.md#requestright-1) to request the device access permission.
...
| --- | --- | --- | --- |
| device | [USBDevice](arkts-basicservices-usbdevice-i.md) | Yes | USB device. The **busNum** and **devAddress** parameters obtained by [usbManager.getDevices](arkts-basicservices-getdevices-f.md#getdevices-1) are used to determine a USB device. Other parameters are passed transparently. |
