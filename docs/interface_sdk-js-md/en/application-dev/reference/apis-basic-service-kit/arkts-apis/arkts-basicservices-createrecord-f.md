...
| value | [ValueType](arkts-basicservices-valuetype-t.md) | Yes | Data content of the specified type. |

**Return value:**

| Type | Description |
| --- | --- |
| [PasteDataRecord](arkts-basicservices-pastedatarecord-i.md) | A new paste data record of a specified type. |
