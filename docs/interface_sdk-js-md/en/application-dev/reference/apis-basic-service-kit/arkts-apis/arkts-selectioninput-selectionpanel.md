...
The text selection panel is an operation panel that pops up after a user selects text. This module is applicable when
 ...
 provides the attributes and types of the word selection panel. You can use [PanelInfo](arkts-basicservices-selectioninput-selectionpanel-panelinfo-i.md#PanelInfo) to set the
 position and size of the panel and use [PanelType](arkts-basicservices-selectioninput-selectionpanel-paneltype-e.md#PanelType) to specify the panel type.
