...
- For the upload task, the value is Array<[FormItem](arkts-basicservices-formitem-i.md)>. Since API version 15, a maximum of 100 files can be uploaded in a single task. This parameter is left empty by default.
