...
Note: When  
[request.agent.search]\_\_\_JSDOC\_LINK\_DESC\_USD\_0\_\_\_is used for query, this value must be within the range of [after,before] for the task ID to be obtained. For details about **before** and **after**, see  
...
- Use [request.agent.show]\_\_\_JSDOC\_LINK\_DESC\_USD\_0\_\_\_  
and [request.agent.touch]\_\_\_JSDOC\_LINK\_DESC\_USD\_1\_\_\_to query the value.
