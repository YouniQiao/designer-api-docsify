...
| controlparam | [USBControlParams](arkts-basicservices-usbcontrolparams-i.md) | Yes | Control transfer parameters. Set the parameters as required. For details, see the USB protocol. |
