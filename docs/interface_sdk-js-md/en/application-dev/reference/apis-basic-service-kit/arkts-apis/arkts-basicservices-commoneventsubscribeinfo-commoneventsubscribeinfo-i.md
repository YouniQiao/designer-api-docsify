...
Device ID, which is used to restrict the subscriber to receive only public events published by the specified device. Use [@ohos.deviceInfo](../../apis-na/arkts-apis/arkts-deviceinfo.md#ohosdeviceinfo) to obtain the UDID as the device ID of the publisher. Not supported currently.
