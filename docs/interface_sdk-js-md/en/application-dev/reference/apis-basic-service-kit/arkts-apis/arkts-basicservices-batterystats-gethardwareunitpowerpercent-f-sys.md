...
| Type | Description |
| --- | --- |
| ArkTS-Dyn: number  <br>ArkTS-Sta：double | Proportion of the power consumption of the hardware unit corresponding to the power consumption type, which ranges from 0.00 to 1.00. |
