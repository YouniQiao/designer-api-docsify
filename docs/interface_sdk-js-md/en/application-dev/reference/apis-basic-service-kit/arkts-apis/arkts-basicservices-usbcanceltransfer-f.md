...
| --- | --- | --- | --- |
| transfer | [UsbDataTransferParams](arkts-basicservices-usbdatatransferparams-i.md) | Yes | Only the [USBDevicePipe](arkts-basicservices-usbdevicepipe-i.md) and [USBEndpoint](arkts-basicservices-usbendpoint-i.md) parameters should be specified in this API. |
