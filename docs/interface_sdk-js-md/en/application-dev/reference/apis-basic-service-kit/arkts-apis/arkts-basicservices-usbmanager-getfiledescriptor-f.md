...
| Type | Description |
| --- | --- |
| ArkTS-Dyn: number  \_\_\_HTML\_TAG\_USD\_0\_\_\_ArkTS-Sta：int | Returns a file descriptor of the USB device if the operation is successful; returns an error code otherwise. The error codes are as follows: |
