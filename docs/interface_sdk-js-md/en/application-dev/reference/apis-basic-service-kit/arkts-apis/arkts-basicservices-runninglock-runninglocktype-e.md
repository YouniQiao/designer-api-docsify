...
[COMMON_EVENT_ENTER_FORCE_SLEEP](../../../reference/apis-basic-services-kit/common_event/commonEventManager-definitions.md#common_event_enter_force_sleep12)event and release this lock after receiving the event. The behavior of this lock varies with devices. For details about how to use this type of lock, see  
[Preventing the Idle System from Entering Sleep Mode](../../../basic-services/powermgr/runningLock/runningLock-dev.md).
