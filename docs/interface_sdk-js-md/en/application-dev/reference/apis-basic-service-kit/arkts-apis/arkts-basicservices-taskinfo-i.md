...
Note: When [request.agent.search](arkts-basicservices-search-f.md#search-2)is used for query, this value must be within the range of [after,before] for the task ID to be obtained. For details about **before** and **after**, see [Filter](arkts-basicservices-filter-i.md).
...
- Use [request.agent.show](arkts-basicservices-show-f.md#show-2)and [request.agent.touch](arkts-basicservices-touch-f.md#touch-2)to query the value.
