...
[finishCommonEvent]\_\_\_JSDOC\_LINK\_DESC\_USD\_0\_\_\_. After the abort,the common event is not sent to the next subscriber. This API uses an asynchronous callback to return the result.
...
Aborts an ordered common event. This API is used with  
[finishCommonEvent]\_\_\_JSDOC\_LINK\_DESC\_USD\_0\_\_\_. After the abort,the common event is not sent to the next subscriber. This API uses a promise to return the result.
...
[finishCommonEvent]\_\_\_JSDOC\_LINK\_DESC\_USD\_0\_\_\_. With the abort state, the common event is not sent to the next subscriber. This API returns the result synchronously.
...
[finishCommonEvent]\_\_\_JSDOC\_LINK\_DESC\_USD\_0\_\_\_, and the common event can be passed to the next subscriber. This API uses an asynchronous callback to return the result.
...
[finishCommonEvent]\_\_\_JSDOC\_LINK\_DESC\_USD\_0\_\_\_, and the common event can be passed to the next subscriber. This API uses a promise to return the result.
...
[finishCommonEvent]\_\_\_JSDOC\_LINK\_DESC\_USD\_0\_\_\_. After the clearance, the common event is sent to the next subscriber. This API returns the result synchronously.
