...
Device ID, which is used to restrict the subscriber to receive only public events published by the specified device. Use [@ohos.deviceInfo]\_\_\_JSDOC\_LINK\_DESC\_USD\_0\_\_\_to obtain the UDID as the device ID of the publisher. Not supported currently.
...
[getOsAccountLocalId]\_\_\_JSDOC\_LINK\_DESC\_USD\_0\_\_\_to obtain the system user ID and use it as the user ID of the publisher.
