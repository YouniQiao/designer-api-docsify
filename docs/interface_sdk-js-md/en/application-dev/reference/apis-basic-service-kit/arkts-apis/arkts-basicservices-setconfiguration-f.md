...
| config | [USBConfiguration](arkts-basicservices-usbconfiguration-i.md) | Yes | USB configuration. You can use [usbManager.getDevices](arkts-basicservices-getdevices-f.md#getdevices-1)to obtain device information and identify the USB configuration based on the ID. |
