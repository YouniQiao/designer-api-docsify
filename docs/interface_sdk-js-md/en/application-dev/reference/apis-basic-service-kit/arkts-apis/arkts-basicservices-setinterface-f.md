...
| iface | [USBInterface](arkts-basicservices-usbinterface-i.md) | Yes | USB interface. You can use [usbManager.getDevices](arkts-basicservices-getdevices-f.md#getdevices-1)to obtain device information and identify the USB interface based on its **id** and **alternateSetting**. |
