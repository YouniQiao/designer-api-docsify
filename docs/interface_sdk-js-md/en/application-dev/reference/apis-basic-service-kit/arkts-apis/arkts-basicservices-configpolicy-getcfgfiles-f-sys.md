...
**\/sys\_pod/etc/config.xml** in ascending order of priority,  
**\/system/etc/config.xml, /sys\_pod/etc/config.xml** is returned.
...
**configPolicy.FollowXMode.SIM\_DEFAULT**, the return value is  
**\/system/etc/config.xml, /sys\_pod/etc/config.xml, /sys\_pod/etc/carrier/46060/etc/config.xml**.
...
**configPolicy.FollowXMode.USER\_DEFINED**, and the custom follow rule is  
