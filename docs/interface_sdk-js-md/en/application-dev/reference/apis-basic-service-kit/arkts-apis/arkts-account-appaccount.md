...
| [AuthenticatorCallback](arkts-basicservices-authenticatorcallback-i.md) | Provides OAuth authenticator callbacks. |
...
| [OAuthTokenInfo](arkts-basicservices-oauthtokeninfo-i.md) | Defines authorization token information. |
...
| [ResultCode](arkts-basicservices-resultcode-e.md) | Enumerates the result codes. |
