...
| --- | --- | --- | --- |
| options | [GetStatusOptions](arkts-basicservices-systembattery-getstatusoptions-i.md) | No | Object that contains the API calling result. This parameter is optional and is left blank by default. |
