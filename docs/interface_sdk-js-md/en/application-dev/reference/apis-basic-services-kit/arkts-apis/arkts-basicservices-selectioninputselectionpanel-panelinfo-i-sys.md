...
Word selection panel types, which include two options. For details, see [PanelType](arkts-basicservices-selectioninputselectionpanel-paneltype-e-sys.md).

**Type:** [PanelType](arkts-basicservices-selectioninputselectionpanel-paneltype-e-sys.md)
