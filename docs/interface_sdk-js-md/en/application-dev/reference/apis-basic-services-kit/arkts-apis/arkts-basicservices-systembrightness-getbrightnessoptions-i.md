...
Called when an API call is successful. **data** is a return value of the [BrightnessResponse](arkts-basicservices-systembrightness-brightnessresponse-i.md) type.
