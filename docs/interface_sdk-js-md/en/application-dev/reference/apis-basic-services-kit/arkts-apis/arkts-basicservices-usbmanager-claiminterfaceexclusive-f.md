...
| [14400010](../errorcode-usb.md#14400010-unrecognized-error) | USB driver error. Possible causes:  1. The device is not connected using [usbManager.connectDevice](arkts-basicservices-usbmanager-connectdevice-f.md).  2. The USB device state is abnormal. |
