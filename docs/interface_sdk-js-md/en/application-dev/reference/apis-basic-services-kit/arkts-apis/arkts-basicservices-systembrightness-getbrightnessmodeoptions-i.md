...
Called when an API call is successful. **data** is a return value of the [BrightnessModeResponse](arkts-basicservices-systembrightness-brightnessmoderesponse-i.md) type.
