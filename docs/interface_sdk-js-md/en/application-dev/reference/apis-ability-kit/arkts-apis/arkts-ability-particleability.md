...
| Name | Description |
| --- | --- |
| [acquireDataAbilityHelper](arkts-ability-acquiredataabilityhelper-f.md#acquiredataabilityhelper-1) | Obtains a dataAbilityHelper object. |
...
| [connectAbility](arkts-ability-connectability-f.md#connectability-1) | Connects this ability to a ServiceAbility. |
...
| [startAbility](arkts-ability-startability-f.md#startability-1) | Starts a ParticleAbility. This API uses an asynchronous callback to return the result. |
| [startAbility](arkts-ability-startability-f.md#startability-2) | Starts a ParticleAbility. This API uses a promise to return the result. |
