...
| want | [Want](arkts-ability-appabilitywant-want-c.md) | Yes | Indicates the want info of the UI extension. |
| session | [UIExtensionContentSession](arkts-ability-appabilityuiextensioncontentsession-uiextensioncontentsession-c.md) | Yes | Indicates the session of the UI extension page. |
