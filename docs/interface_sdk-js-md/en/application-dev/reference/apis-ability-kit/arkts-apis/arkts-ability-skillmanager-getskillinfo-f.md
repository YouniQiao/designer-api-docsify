...
Obtains SkillInfo of a specified application based on bundleName, moduleName and skillName.To query information for other local accounts, the permission ohos.permission.INTERACT\_ACROSS\_LOCAL\_ACCOUNTS must additionally be granted.
