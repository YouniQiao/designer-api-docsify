...
[distribution type of the application signing certificate]\_\_\_JSDOC\_LINK\_DESC\_USD\_0\_\_\_is **enterprise\_mdm** or **enterprise\_normal**.  
...
application installation scenarios and supported since API version 23. If this field is passed during installation, the [getBundleInstallStatus]\_\_\_JSDOC\_LINK\_DESC\_USD\_1\_\_\_API can be called to obtain the installation status of the application.  
