...
| [saveAppState](arkts-ability-apprecovery-saveappstate-f.md#saveappstate) | Saves the application state. This API can be used together with the APIs of [errorManager](arkts-app-ability-errormanager.md#ohosappabilityerrormanager). |
| [saveAppState](arkts-ability-apprecovery-saveappstate-f.md#saveappstate) | Saves the ability state, which will be used for recovery. This API can be used together with the APIs of [errorManager](arkts-app-ability-errormanager.md#ohosappabilityerrormanager). |
