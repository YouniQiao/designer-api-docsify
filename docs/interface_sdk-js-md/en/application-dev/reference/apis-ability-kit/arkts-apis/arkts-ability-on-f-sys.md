...
| permissionList | [Array](../../apis-na/arkts-apis/arkts-na-array-i.md)<Permissions> | Yes | List of subscribed permission names. An empty value indicates subscription to the usage status changes of all permissions.Passing an invalid value returns error code 12100001.<br>Value constraint: The array length cannot exceed 1024. |
