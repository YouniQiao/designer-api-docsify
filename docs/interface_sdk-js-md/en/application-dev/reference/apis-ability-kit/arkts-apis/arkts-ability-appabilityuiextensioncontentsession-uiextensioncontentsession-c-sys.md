...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| data | Record&lt;string, [RecordData](../../apis-basic-services-kit/arkts-apis/arkts-basicservices-recorddata-t.md)&gt; | Yes | Indicates the data send to ui extension component. |
...
Sets the background color for the loading page of the UIExtensionAbility. This API can be used only after [loadContent()](arkts-ability-appabilityuiextensioncontentsession-uiextensioncontentsession-c.md#loadcontent) is called and takes effect.
