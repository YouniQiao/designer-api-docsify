...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| callback | [OnReleaseCallback](arkts-ability-appabilityuiability-onreleasecallback-i.md) | Yes | Callback used to return the result. |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| callback | [OnRemoteStateChangeCallback](arkts-ability-appabilityuiability-onremotestatechangecallback-i.md) | Yes | Callback used to return the result. |
