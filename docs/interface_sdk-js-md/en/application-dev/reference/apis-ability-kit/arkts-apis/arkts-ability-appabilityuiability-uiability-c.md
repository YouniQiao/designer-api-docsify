...
**Inheritance/Implementation:** UIAbility extends [Ability](arkts-ability-appabilityability-ability-c.md)
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| want | [Want](arkts-ability-appabilitywant-want-c.md) | Yes | Data passed by the caller when launching the UIAbility. |
...
| Type | Description |
| --- | --- |
| Promise&lt;void&gt; \| undefined | No return value or a Promise object that returns no result. |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| want | [Want](arkts-ability-appabilitywant-want-c.md) | Yes | Data passed by the caller when re-launching the UIAbility. |
...
> or [AbilityStage.onPrepareTermination](arkts-ability-appabilityabilitystage-abilitystage-c.md#onpreparetermination) is
...
**Type:** [Callee](arkts-ability-appabilityuiability-callee-i.md)
