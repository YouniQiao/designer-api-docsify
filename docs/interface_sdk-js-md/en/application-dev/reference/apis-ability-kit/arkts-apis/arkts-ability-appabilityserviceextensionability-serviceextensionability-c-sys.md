...
| --- | --- | --- | --- |
| newConfig | [Configuration](arkts-ability-appabilityconfiguration-configuration-i.md) | Yes | New configuration. |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| want | [Want](arkts-ability-appabilitywant-want-c.md) | Yes | Want information related to this ServiceExtensionAbility, including the ability name and bundle name. |
