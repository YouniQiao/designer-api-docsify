...
- true: The system has shown the authorization dialog. - false: The system did not show a dialog, usually because the current permission state, permission type, or system policy does not allow proceeding with the dialog authorization path.  
