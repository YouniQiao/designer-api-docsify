...
| failureCode | [AbilityStartFailureCode](arkts-ability-appabilitycompletionhandlerforabilitystartcallback-abilitystartfailurecode-e.md) | Yes | Error code of the failure cause. |
