...
Enumerates the ability states. This enum can be used together with [AbilityRunningInfo](arkts-ability-abilitymanager-abilityrunninginfo-t.md) to return the ability state.
