...
Obtains shortcut info by bundleName, moduleName, abilityName, userId and appIndex.If you need to obtains shortcut info under the current user, ohos.permission.GET\_BUNDLE\_INFO\_PRIVILEGED needs to be applied for.If you need to obtains shortcut info under other users, ohos.permission.GET\_BUNDLE\_INFO\_PRIVILEGED and ohos.permission.INTERACT\_ACROSS\_LOCAL\_ACCOUNTS need to be applied for.
...
| userId | ArkTS-Dyn: number  \_\_\_HTML\_TAG\_USD\_0\_\_\_ArkTS-Sta：int | No | Indicates the user ID. |
| appIndex | ArkTS-Dyn: number  \_\_\_HTML\_TAG\_USD\_0\_\_\_ArkTS-Sta：int | No | Indicates the index of clone app. |
