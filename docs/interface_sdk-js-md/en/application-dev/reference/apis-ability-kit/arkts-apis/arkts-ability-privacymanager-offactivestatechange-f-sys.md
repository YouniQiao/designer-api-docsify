...
> **NOTE：**
> This API is typically used in conjunction with [onActiveStateChange](arkts-ability-privacymanager-on-f-sys.md) to cancel the listening relationship created by onActiveStateChange.
