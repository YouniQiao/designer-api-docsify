...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| want | [Want](../../apis-arkui/arkts-apis/arkts-arkui-want-t-sys.md) | Yes | Data passed by the caller when launching the UIExtensionAbility. |
| session | [UIExtensionContentSession](arkts-ability-uiextensioncontentsession-c.md) | Yes | UIExtensionContentSession instance. |
