...
When **status** is **true**, the [addPermissionUsedRecord]\_\_\_JSDOC\_LINK\_DESC\_USD\_0\_\_\_ API can add usage records normally; when **status** is **false**, the  
[addPermissionUsedRecord]\_\_\_JSDOC\_LINK\_DESC\_USD\_1\_\_\_ API does not generate permission usage records, and deletes the current user's historical records.
...
When **status** is **true**, the [addPermissionUsedRecord]\_\_\_JSDOC\_LINK\_DESC\_USD\_0\_\_\_ API can add usage records normally; when **status** is **false**, the  
[addPermissionUsedRecord]\_\_\_JSDOC\_LINK\_DESC\_USD\_1\_\_\_ API does not generate permission usage records, and deletes the historical records of the specified sub-profile.
