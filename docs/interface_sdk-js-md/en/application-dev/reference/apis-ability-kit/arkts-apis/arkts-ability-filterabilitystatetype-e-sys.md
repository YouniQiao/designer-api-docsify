...
Enumerates the types of ability states to filter. It can be used with [AppStateFilter](arkts-ability-appstatefilter-i-sys.md) to filter the ability state types you want to listen for.
