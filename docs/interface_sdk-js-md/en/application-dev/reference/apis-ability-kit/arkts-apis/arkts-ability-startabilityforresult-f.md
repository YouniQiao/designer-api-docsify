...
- Normally, you can call [terminateSelfWithResult](arkts-ability-terminateselfwithresult-f.md#terminateselfwithresult-1)to terminate the ability. The result is returned to the caller.  
...
| callback | [AsyncCallback](../../apis-basic-service-kit/arkts-apis/arkts-basicservices-asynccallback-i.md)<AbilityResult> | Yes | Callback used to return the result. If the operation is successful, **err** is **undefined** and **data** is an AbilityResult object; otherwise, err is an error object. |
...
| Type | Description |
| --- | --- |
| [Promise](../../apis-na/arkts-apis/arkts-na-promise-i.md)<AbilityResult> | Promise used to return the result. |
