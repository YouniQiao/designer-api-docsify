...
| flag | wantConstant.Flags | Yes | Read or write permission on the file to grant. The options are as follows:   - **FLAG_AUTH_READ_URI_PERMISSION**: read permission.   - **FLAG_AUTH_WRITE_URI_PERMISSION**: write permission. |
