...
| [ModuleDistroInfo](arkts-ability-bundlepackinfo-moduledistroinfo-i-sys.md) | module发行版信息。 |
| [PackageConfig](arkts-ability-bundlepackinfo-packageconfig-i-sys.md) | pack.info的包信息。 |
| [PackageSummary](arkts-ability-bundlepackinfo-packagesummary-i-sys.md) | pack.info中的包摘要信息。 |
| [Version](arkts-ability-bundlepackinfo-version-i-sys.md) | 包的版本。 |
<!--DelEnd-->
