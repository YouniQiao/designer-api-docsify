...
When the screen is locked, a closed file can be opened, read, and written only if the reserved key is obtained by calling \_\_\_MD\_LINK\_DESC\_USD\_0\_\_\_. When the screen is unlocked, such a file can be opened, read, and written.
