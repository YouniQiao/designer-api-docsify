...
| callerTokenId | int | Yes | Identity of the caller application. You can obtain the value from the **ohos.aafwk.param.callerToken** field in [want](arkts-ability-appabilitywant-want-c.md). |
