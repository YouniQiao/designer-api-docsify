...
| [startAbility](arkts-ability-startability-f.md#startability-1) | Starts an ability. This API uses an asynchronous callback to return the result. |
| [startAbility](arkts-ability-startability-f.md#startability-2) | Starts an ability. This API uses a promise to return the result. |
