...
[queryOsAccountLocalIdFromProcess]\_\_\_JSDOC\_LINK\_DESC\_USD\_0\_\_\_to obtain the user ID of the current process. When a driver application is installed, uninstalled, or restored,this parameter is ignored and the operation is executed for all users.
