...
**GET\_BUNDLE\_INFO\_WITH\_HAP\_MODULE** and **GET\_BUNDLE\_INFO\_WITH\_ABILITY** to the **bundleFlags** parameter of  
...
Information about all ExtensionAbility components of the current module. The information can be obtained by passing in **GET\_BUNDLE\_INFO\_WITH\_HAP\_MODULE** and **GET\_BUNDLE\_INFO\_WITH\_EXTENSION\_ABILITY** to the **bundleFlags**  
parameter of  
[getBundleInfoForSelf]\_\_\_JSDOC\_LINK\_DESC\_USD\_0\_\_\_.
...
**GET\_BUNDLE\_INFO\_WITH\_HAP\_MODULE** and **GET\_BUNDLE\_INFO\_WITH\_MENU** to the **bundleFlags** parameter of  
[getBundleInfoForSelf]\_\_\_JSDOC\_LINK\_DESC\_USD\_0\_\_\_.
...
\_\_\_MD\_LINK\_DESC\_USD\_0\_\_\_ for the entry ability of the current module. It is the index of the icon resource file and should match the value of **icon** in the  
\_\_\_MD\_LINK\_DESC\_USD\_1\_\_\_ or  
\_\_\_MD\_LINK\_DESC\_USD\_2\_\_\_ field in the module configuration file. If no entry ability is configured, this parameter is left empty.
...
Whether the module supports the installation-free feature. Installation-free means that the module does not need to be explicitly installed through an app market. **true** if the module supports installation-free, **false**  
otherwise.
...
Label of the entry ability of the current module. It is the index of a string resource and should match the value of **label** in the \_\_\_MD\_LINK\_DESC\_USD\_0\_\_\_ or  
\_\_\_MD\_LINK\_DESC\_USD\_1\_\_\_ field in the module configuration file. If no entry ability is configured, this parameter is left empty.
...
Metadata of the current module. The information can be obtained by passing in **GET\_BUNDLE\_INFO\_WITH\_HAP\_MODULE**  
and **GET\_BUNDLE\_INFO\_WITH\_METADATA** to the **bundleFlags** parameter of  
[getBundleInfoForSelf]\_\_\_JSDOC\_LINK\_DESC\_USD\_0\_\_\_.
...
\_\_\_MD\_LINK\_DESC\_USD\_0\_\_\_. The information can be obtained by passing in **GET\_BUNDLE\_INFO\_WITH\_HAP\_MODULE** and  
**GET\_BUNDLE\_INFO\_WITH\_ROUTER\_MAP** to the **bundleFlags** parameter of  
[getBundleInfoForSelf]\_\_\_JSDOC\_LINK\_DESC\_USD\_1\_\_\_.
