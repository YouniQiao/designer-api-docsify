...
Application information. The information can be obtained by passing in **GET\_BUNDLE\_INFO\_WITH\_APPLICATION** to the  
...
Module configuration information. The information can be obtained by passing in **GET\_BUNDLE\_INFO\_WITH\_HAP\_MODULE**  
...
Permission grant state. The information can be obtained by passing in **GET\_BUNDLE\_INFO\_WITH\_REQUESTED\_PERMISSION**  
to the **bundleFlags** parameter of  
[getBundleInfoForSelf]\_\_\_JSDOC\_LINK\_DESC\_USD\_0\_\_\_.The indices of the **reqPermissionDetails** array and the **permissionGrantStates** array are in one-to-one correspondence, meaning that the authorization status of **reqPermissionDetails[2]** is  
...
**GET\_BUNDLE\_INFO\_WITH\_REQUESTED\_PERMISSION** to the **bundleFlags** parameter of  
[getBundleInfoForSelf]\_\_\_JSDOC\_LINK\_DESC\_USD\_0\_\_\_.The indices of the **reqPermissionDetails** array and the **permissionGrantStates** array are in one-to-one correspondence, meaning that the authorization status of **reqPermissionDetails[2]** is  
**permissionGrantStates[2]**.
...
Router table of the application. The table is obtained by deduplicating and combining the **routerMap** information under **hapModulesInfo** based on the **name** field in **RouterItem**. The information can be obtained by passing in **GET\_BUNDLE\_INFO\_WITH\_HAP\_MODULE** and **GET\_BUNDLE\_INFO\_WITH\_ROUTER\_MAP** to the **bundleFlags** parameter of  
[getBundleInfoForSelf]\_\_\_JSDOC\_LINK\_DESC\_USD\_0\_\_\_.
...
**GET\_BUNDLE\_INFO\_WITH\_SIGNATURE\_INFO** to the **bundleFlags** parameter of  
[getBundleInfoForSelf]\_\_\_JSDOC\_LINK\_DESC\_USD\_0\_\_\_.
