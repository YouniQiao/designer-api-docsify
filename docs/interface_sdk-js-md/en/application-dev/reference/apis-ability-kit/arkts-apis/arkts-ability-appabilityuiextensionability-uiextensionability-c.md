...
Called when a [UIExtensionContentSession](arkts-ability-appabilityuiextensioncontentsession-uiextensioncontentsession-c.md) instance is created. You can load a page through the UIExtensionContentSession instance within this callback.
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| want | [Want](arkts-ability-appabilitywant-want-c.md) | Yes | Data passed by the caller when launching the UIExtensionAbility. |
| session | [UIExtensionContentSession](arkts-ability-appabilityuiextensioncontentsession-uiextensioncontentsession-c.md) | Yes | UIExtensionContentSession instance. |
