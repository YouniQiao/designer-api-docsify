...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| connection | ArkTS-Dyn: number  <br>ArkTS-Sta：long | Yes | Connection ID returned by [connectServiceExtensionAbility](arkts-ability-appserviceextensioncontext-c.md#connectserviceextensionability). |
