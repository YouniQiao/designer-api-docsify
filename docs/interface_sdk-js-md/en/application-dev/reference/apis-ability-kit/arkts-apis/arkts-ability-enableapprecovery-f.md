...
| --- | --- | --- | --- |
| restart | [RestartFlag](arkts-ability-restartflag-e.md) | No | Whether the application is restarted upon a fault. By default, the application is restarted. |
| saveOccasion | [SaveOccasionFlag](arkts-ability-saveoccasionflag-e.md) | No | Scenario for saving the application state. By default, the state is saved when a fault occurs. |
| saveMode | [SaveModeFlag](arkts-ability-savemodeflag-e.md) | No | Application state saving mode. By default, the application state is written to the local file cache. |
