...
EmbeddableUIAbilityContext provides the context environment for the [EmbeddableUIAbility](arkts-ability-embeddableuiability-c.md). It inherits from [UIAbilityContext](arkts-ability-uiabilitycontext-c.md).
