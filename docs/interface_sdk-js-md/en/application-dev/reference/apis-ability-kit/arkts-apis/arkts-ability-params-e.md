...
You can set the sharing title using this field in the [onShare](arkts-ability-uiability-c.md#onshare-1) callback.
...
You can set the sharing abstract using this field in the [onShare](arkts-ability-uiability-c.md#onshare-1) callback.
...
You can set the URL link using this field in the [onShare](arkts-ability-uiability-c.md#onshare-1) callback.
...
If the Want contains a URI authorization flag (for example, [FLAG_AUTH_READ_URI_PERMISSION](arkts-ability-flags-e.md) or [FLAG_AUTH_WRITE_URI_PERMISSION](arkts-ability-flags-e.md)) and the **PARAMS_STREAM** field is also present, this field does not take effect.
