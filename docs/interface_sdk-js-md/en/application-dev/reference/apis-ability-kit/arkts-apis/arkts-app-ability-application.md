...
| [getAppPreloadType](arkts-ability-getapppreloadtype-f.md#getapppreloadtype-1) | Obtains the preloading type of the current application process. |
...
| Name | Description |
| --- | --- |
| [createBundleContext](arkts-ability-createbundlecontext-f-sys.md#createbundlecontext-1) | Creates the context for an application. This API uses a promise to return the result. |
| [createModuleContext](arkts-ability-createmodulecontext-f-sys.md#createmodulecontext-2) | Creates the context for a module. This API uses a promise to return the result. |
