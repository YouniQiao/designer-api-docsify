...
| --- | --- | --- | --- |
| want | \_\_\_MD\_LINK\_USD\_0\_\_\_ | Yes | Indicates the want info to connect. |
| agentId | string | Yes | The agent id to connect. |
| callback | \_\_\_MD\_LINK\_USD\_0\_\_\_ | Yes | The callback of connection. |
...
| 35600007 | The specified LOW\_\_\_ESCAPED\_UNDERSCORE\_\_\_CODE agent is already active and is not yet completed. |
