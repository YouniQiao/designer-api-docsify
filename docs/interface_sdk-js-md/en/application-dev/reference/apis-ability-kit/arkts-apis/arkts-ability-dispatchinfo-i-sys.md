...
The module provides version information about the dispatchInfo struct and dispatch API. The information can be obtained through [freeInstall.getDispatchInfo](arkts-ability-freeinstall-getdispatchinfo-f-sys.md) . &gt; **NOTE：**&gt; &gt; The APIs provided by this module are system APIs.
