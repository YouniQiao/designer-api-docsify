...
You can subscribe to changes to this environment variable in the [UIAbility](arkts-ability-appabilityuiability-uiability-c.md) and [UIExtensionAbility](arkts-ability-appabilityuiextensionability-uiextensionability-c.md), but not in the [ApplicationContext](arkts-ability-applicationcontext-c.md) or [AbilityStage](arkts-ability-appabilityabilitystage-abilitystage-c.md).
