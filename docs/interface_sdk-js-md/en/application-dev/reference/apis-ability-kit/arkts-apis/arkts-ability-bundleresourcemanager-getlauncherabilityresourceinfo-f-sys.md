...
| resourceFlags | int | No | Type of the resource information to obtain. The default value is **[ResourceFlag](arkts-ability-bundleresourcemanager-resourceflag-e-sys.md#ResourceFlag).GET_RESOURCE_INFO_ALL**. |
...
| --- | --- | --- | --- |
| bundleName | string | Yes | Bundle name of the application. |
| resourceFlags | ArkTS-Dyn: number  <br>ArkTS-Sta：int | No | Type of the resource information to obtain. The default value is **[ResourceFlag](arkts-ability-bundleresourcemanager-resourceflag-e-sys.md#ResourceFlag).GET_RESOURCE_INFO_ALL**. |
