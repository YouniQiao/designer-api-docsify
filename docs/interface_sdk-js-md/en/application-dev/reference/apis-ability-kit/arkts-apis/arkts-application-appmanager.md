...
| [getAppMemorySize](arkts-ability-getappmemorysize-depr-f.md#getappmemorysize-2) | Obtains the maximum memory (RAM allocation) available to the current application. This API uses an asynchronous callback to return the result. |
...
| [isRunningInStabilityTest](arkts-ability-isrunninginstabilitytest-depr-f.md#isrunninginstabilitytest-1) | Checks whether the system is undergoing a stability test. This API uses an asynchronous callback to return the result. |
| [isRunningInStabilityTest](arkts-ability-isrunninginstabilitytest-depr-f.md#isrunninginstabilitytest-2) | Checks whether the system is undergoing a stability test. This API uses a promise to return the result. |
