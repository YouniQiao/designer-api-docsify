...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| inState | [PacMap](arkts-ability-pacmap-i.md) | Yes | Indicates the {@code PacMap} object used for storing data and states. This parameter can not be null. |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| outState | [PacMap](arkts-ability-pacmap-i.md) | Yes | Indicates the {@code PacMap} object used for storing user data and states. This parameter cannot be null. |
