...
| --- | --- | --- | --- |
| callback | [PreloadedUIExtensionAbilityLoadedFn](arkts-ability-preloadeduiextensionabilityloadedfn-t-sys.md) | No | Callback used for unsubscription. If this parameter is not specified, all callbacks associated with the specified event in the process will be unregistered. |
