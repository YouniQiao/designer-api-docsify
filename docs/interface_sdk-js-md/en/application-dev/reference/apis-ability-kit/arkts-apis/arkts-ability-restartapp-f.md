...
In API version 10, the ability specified by [setRestartWant](arkts-ability-setrestartwant-f.md#setrestartwant-1) is started. If no ability is specified, the following rules are used:
