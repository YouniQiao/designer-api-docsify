...
LinkIntentDecoratorInfo inherits from [IntentDecoratorInfo](arkts-ability-appabilityinsightintentdecorator-intentdecoratorinfo-i.md) and describes the parameters supported by the @InsightIntentLink decorator, such as the URI information required for application redirection.

**Inheritance/Implementation:** LinkIntentDecoratorInfo extends [IntentDecoratorInfo](arkts-ability-appabilityinsightintentdecorator-intentdecoratorinfo-i.md)
...
**Type:** [LinkIntentParamMapping](../../apis-default/arkts-apis/arkts-appabilityinsightintentdecorator-linkintentparammapping-i.md)[]
