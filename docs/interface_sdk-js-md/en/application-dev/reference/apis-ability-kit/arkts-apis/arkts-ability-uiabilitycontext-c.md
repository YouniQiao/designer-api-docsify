...
| --- | --- | --- | --- |
| abilityResult | [AbilityResult](arkts-ability-abilityresult-i.md) | Yes | Result returned to the caller. |
...
| options | [ConnectOptions](arkts-ability-connectoptions-t.md) | Yes | Callback used to return the information indicating that the connection is successful, failed, or interrupted. |
...
| callback | [UIServiceExtensionConnectCallback](arkts-ability-uiserviceextensionconnectcallback-t.md) | Yes | Callback for connecting to the UIServiceExtensionAbility. |

**Return value:**

| Type | Description |
| --- | --- |
| [Promise](../../apis-na/arkts-apis/arkts-na-promise-i.md)<UIServiceProxy> | Promise used to return the result, which is a [UIServiceProxy](arkts-ability-uiserviceproxy-i.md) object. |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| proxy | [UIServiceProxy](arkts-ability-uiserviceproxy-t.md) | Yes | Proxy returned after [connectUIServiceExtensionAbility](arkts-ability-uiabilitycontext-c.md#connectuiserviceextensionability-1) is called. |
...
| options | [AtomicServiceOptions](arkts-ability-atomicserviceoptions-c.md) | No | Parameter carried in the request for starting the atomic service. |
...
| options | [OpenLinkOptions](arkts-ability-openlinkoptions-i.md) | No | Options of the URL. |
| callback | [AsyncCallback](../../apis-basic-service-kit/arkts-apis/arkts-basicservices-asynccallback-i.md)<AbilityResult> | No | Callback used to return the result. |
...
Starts a ServiceExtensionAbility that supports modal dialog boxes. After the ServiceExtensionAbility is started,the application displays a modal dialog box. You can call [setRequestResult](arkts-ability-requestcallback-i.md#setrequestresult-1) to obtain the result. This API uses an asynchronous callback to return the result. It can be called only on the main thread.
...
Starts a ServiceExtensionAbility that supports modal dialog boxes. After the ServiceExtensionAbility is started,the application displays a modal dialog box. You can call [setRequestResult](arkts-ability-requestcallback-i.md#setrequestresult-1) to obtain the result. This API uses a promise to return the result. It can be called only on the main thread.
...
| Type | Description |
| --- | --- |
| [Promise](../../apis-na/arkts-apis/arkts-na-promise-i.md)<dialogRequest.RequestResult> | Promise that returns no value. |
...
> [restartSelfAtomicService()](arkts-ability-restartselfatomicservice-f.md#restartselfatomicservice-1), or  
...
Sets whether to trigger the [onNewWant](arkts-ability-uiability-c.md#onnewwant-1) lifecycle callback when a UIAbility is started in a specific scenario. It can be called only on the main thread. This API uses a promise to return the result.

> **NOTE**  
>  
> This API is usually used within the [onCreate](arkts-ability-uiability-c.md#oncreate-1) lifecycle  
> callback. You are advised to include all the enumerated values of  
> [Scenarios](arkts-ability-scenarios-e.md) when specifying the **scenarios**  
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| scenarios | number | Yes | Scenarios. For details about the available options, see [Scenarios](arkts-ability-scenarios-e.md). |
...
| callback | [AsyncCallback](../../apis-basic-service-kit/arkts-apis/arkts-basicservices-asynccallback-i.md)<void> | Yes | Callback used to return the result. If the API call is successful, **code** in **err** is **0** and **message** is an empty string. Otherwise, **err** contains the corresponding error code and error information. |
...
| --- | --- | --- | --- |
| want | [Want](../../apis-arkui/arkts-apis/arkts-arkui-want-t-sys.md) | Yes | Mandatory information for starting the UIAbility. |
| options | [StartOptions](arkts-ability-startoptions-c.md) | Yes | Parameters used for starting the UIAbility. |
| callback | [AsyncCallback](../../apis-basic-service-kit/arkts-apis/arkts-basicservices-asynccallback-i.md)<void> | Yes | Callback used to return the result. If the API call is successful, **code** in **err** is **0** and **message** is an empty string. Otherwise, **err** contains the corresponding error code and error information. |
...
| --- | --- | --- | --- |
| want | [Want](../../apis-arkui/arkts-apis/arkts-arkui-want-t-sys.md) | Yes | Mandatory information for starting the UIAbility. |
| options | [StartOptions](arkts-ability-startoptions-c.md) | No | Parameters used for starting the UIAbility. |
...
Obtains a [Caller](arkts-ability-caller-i.md) object for communicating with a [Callee](arkts-ability-callee-i.md) object. If the specified UIAbility is not started, the UIAbility will be started in the foreground or background. This API uses a promise to return the result. It can be called only on the main thread.This API cannot be used to start the UIAbility with the launch type set to [specified](../../../../application-models/uiability-launch-type.md#specified).
...
| Type | Description |
| --- | --- |
| [Promise](../../apis-na/arkts-apis/arkts-na-promise-i.md)<Caller> | Promise used to return the Caller object. |
...
Implicitly starts a given type of [UIExtensionAbility](arkts-ability-uiextensionability-c.md). This API uses an asynchronous callback to return the result. It can be called only in the main thread and by applications running in the foreground.
...
Implicitly starts a given type of [UIExtensionAbility](arkts-ability-uiextensionability-c.md). This API uses a promise to return the result. It can be called only in the main thread and by applications running in the foreground.
...
| specifiedFlag | string | Yes | ID of the UIAbility. This ID must not duplicate that of any already running UIAbility instance; otherwise, an error is returned.<br>**NOTE**<br>When this API is used to start a UIAbility instance in [specified](../../../../application-models/uiability-launch-type.md#specified) mode, the [onAcceptWant](arkts-ability-abilitystage-c.md#onacceptwant-1) callback is not triggered. |
| options | [StartOptions](arkts-ability-startoptions-c.md) | No | Parameters used for starting the UIAbility. |
