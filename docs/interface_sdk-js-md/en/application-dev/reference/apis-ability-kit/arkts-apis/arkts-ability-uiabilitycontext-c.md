...
| --- | --- | --- | --- |
| abilityResult | [AbilityResult](arkts-ability-abilityresult-abilityresult-i.md) | Yes | 包含目标方返回给拉起方的结果。 |
| requestCode | string | Yes | 通过 [startAbilityForResult](arkts-ability-uiabilitycontext-c.md#startabilityforresult) 或[openLink](arkts-ability-uiabilitycontext-c.md#openlink)拉起目标方Ability且需要目标方返回结果时，系统生成的用于标识本次调用的requestCode。该值可以通过want中的 [CALLER_REQUEST_CODE](arkts-ability-wantconstant.md)字段获取。 |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| want | [Want](arkts-ability-app-ability-want-want-c.md) | Yes | 连接 [AppServiceExtensionAbility](../../../reference/apis-ability-kit/js-apis-app-ability-appServiceExtensionAbility.md) 的Want信息。 |
| callback | [ConnectOptions](arkts-ability-connectoptions-connectoptions-i.md) | Yes | ConnectOptions类型的回调函数，返回服务连接成功、连接失败、断开的信息。 |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| want | [Want](arkts-ability-app-ability-want-want-c.md) | Yes | 连接ServiceExtensionAbility的Want信息。 |
| options | [ConnectOptions](arkts-ability-connectoptions-connectoptions-i.md) | Yes | 回调对象，返回服务连接成功、连接失败、断开的信息。 |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| want | [Want](arkts-ability-app-ability-want-want-c.md) | Yes | 连接UIServiceExtensionAbility的必要信息。 |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| connection | ArkTS-Dyn: number  <br>ArkTS-Sta：long | Yes | 在 [connectAppServiceExtensionAbility](arkts-ability-uiabilitycontext-c.md#connectappserviceextensionability)返回的连接id。 |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| connection | ArkTS-Dyn: number  <br>ArkTS-Sta：long | Yes | 连接的ServiceExtensionAbility的标识id，即 [connectServiceExtensionAbility](arkts-ability-uiabilitycontext-c.md#connectserviceextensionability)返回的connectionId。 |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| proxy | [UIServiceProxy](arkts-ability-uiserviceproxy-i.md) | Yes | [connectUIServiceExtensionAbility](arkts-ability-uiabilitycontext-c.md#connectuiserviceextensionability)执行返回的Proxy。 |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| callback | [AsyncCallback](../../apis-basic-service-kit/arkts-apis/arkts-basicservices-base-asynccallback-i.md)&lt;void&gt; | Yes | 回调函数，当通知系统UIAbility对应的窗口内容已经绘制完成的操作成功，err中code为0；否则err会返回对应的错误码和错误信息。 |
...
| result | [AsyncCallback](../../apis-basic-service-kit/arkts-apis/arkts-basicservices-base-asynccallback-i.md)&lt;dialogRequest.RequestResult&gt; | Yes | 回调函数，当启动一个支持模态弹框的ServiceExtensionAbility成功，err中code为0， data为模态弹框请求结果；否则err会返回对应的错误码和错误信息。 |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| want | [Want](arkts-ability-app-ability-want-want-c.md) | Yes | Want类型参数，传入需要启动的UIAbility的信息，校验bundleName、abilityName。 |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| localStorage | [LocalStorage](../../apis-arkui/arkts-apis/arkts-arkui-localstorage-c.md) | Yes | 用于恢复window stage的存储数据。 |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| label | string | Yes | 新的图标标签。标签长度不超过1024字节，且不可为空字符串。 |
| icon | image.PixelMap | Yes | 新的图标。建议图标大小为512px*512px。 |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| colorMode | ConfigurationConstant.ColorMode | Yes | 设置颜色模式，包括: &lt;br&gt; - COLOR_MODE_DARK：深色模式 &lt;br&gt; - COLOR_MODE_LIGHT：浅色 模式 &lt;br&gt; - COLOR_MODE_NOT_SET：不设置（跟随系统或应用） |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| state | AbilityConstant.ContinueState | Yes | 流转状态。 |
| callback | [AsyncCallback](../../apis-basic-service-kit/arkts-apis/arkts-basicservices-base-asynccallback-i.md)&lt;void&gt; | Yes | 回调函数，当设置UIAbility任务的流转状态成功，err中code为0；否则err会返回对应的错误码和错误信息。 |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| label | string | Yes | 任务的名称。 |
| callback | [AsyncCallback](../../apis-basic-service-kit/arkts-apis/arkts-basicservices-base-asynccallback-i.md)&lt;void&gt; | Yes | 回调函数，当设置UIAbility在多任务界面中显示的名称成功，err中code为0；否则err会返回对应的错误码和错误信息。 |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| windowIcon | image.PixelMap | Yes | 在应用窗口、任务中心应用卡片、快捷栏窗口快照显示的Ability图标。图标必须为正方形，且大小不能超过128M，否则返回401参数错误。 |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| scenarios | ArkTS-Dyn: number  <br>ArkTS-Sta：int | Yes | 取值范围请参考[Scenarios](arkts-ability-contextconstant-scenarios-e.md)。 |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| enabled | boolean | Yes | 表示是否启用恢复。true表示启用，false表示不启用。 |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| want | [Want](arkts-ability-app-ability-want-want-c.md) | Yes | 启动UIAbility的必要信息。 |
| callback | [AsyncCallback](../../apis-basic-service-kit/arkts-apis/arkts-basicservices-base-asynccallback-i.md)&lt;void&gt; | Yes | 回调函数，当接口调用成功，err中code为0，message为空字符串；否则err会返回对应的错误码和错误信息。 |
...
| --- | --- | --- | --- |
| want | [Want](arkts-ability-app-ability-want-want-c.md) | Yes | 启动UIAbility的必要信息。 |
| options | [StartOptions](arkts-ability-app-ability-startoptions-startoptions-c.md) | Yes | 启动UIAbility所携带的参数。 |
| callback | [AsyncCallback](../../apis-basic-service-kit/arkts-apis/arkts-basicservices-base-asynccallback-i.md)&lt;void&gt; | Yes | 回调函数，当接口调用成功，err中code为0，message为空字符串；否则err会返回对应的错误码和错误信息。 |
...
| 201 | The application does not have permission to call the interface.<br>**Applicable version:** 10 and later |
| 401 | Parameter error. Possible causes: 1.Mandatory parameters are left unspecified. 2.Incorrect parameter types. |
| 16300003 | The target application is not the current application.<br>**Applicable version:** 12 and later |
| 801 | Capability not support.<br>**Applicable version:** 12 and later |
| 16000080 | Creating a new instance is not supported.<br>**Applicable version:** 14 and later |
| 16000018 | Redirection to a third-party application is not allowed in API version greater than 11.<br>**Applicable version:** 12 and later |
| 16000019 | No matching ability is found.<br>**Applicable version:** 12 and later |
| 16000004 | Cannot start an invisible component. |
| 16000068 | The ability is already running.<br>**Applicable version:** 12 and later |
| 16000005 | The specified process does not have the permission. |
| 16000006 | Cross-user operations are not allowed. |
| 16000071 | App clone is not supported.<br>**Applicable version:** 14 and later |
| 16000001 | The specified ability does not exist. |
...
| 16200001 | The caller has been released. |
| 16000067 | The StartOptions check failed.<br>**Applicable version:** 12 and later |
| 16000012 | The application is controlled.<br>**Applicable version:** 10 and later |
| 16000076 | The app instance key is invalid.<br>**Applicable version:** 14 and later |
| 16000013 | The application is controlled by EDM.<br>**Applicable version:** 10 and later |
| 16000077 | The number of app instances reaches the limit.<br>**Applicable version:** 14 and later |
...
| --- | --- | --- | --- |
| want | [Want](arkts-ability-app-ability-want-want-c.md) | Yes | 启动UIAbility的必要信息。 |
| options | [StartOptions](arkts-ability-app-ability-startoptions-startoptions-c.md) | No | 启动UIAbility所携带的参数。 |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| want | [Want](arkts-ability-app-ability-want-want-c.md) | Yes | 传入需要启动的UIAbility信息，包含abilityName、moduleName、bundleName、deviceId、parameters（可选）。将parameters中的' ohos.aafwk.param.callAbilityToForeground'配置为true可将UIAbility拉起到前台；否则表示将UIAbility拉起到后台。 |
...
| 16000004 | Cannot start an invisible component. |
| 401 | Parameter error. Possible causes: 1.Mandatory parameters are left unspecified. 2.Incorrect parameter types. |
| 16000005 | The specified process does not have the permission.<br>**Applicable version:** 9 and later |
| 16000006 | Cross-user operations are not allowed. |
| 16000071 | App clone is not supported.<br>**Applicable version:** 14 and later |
| 16000001 | The specified ability does not exist. |
| 16000002 | Incorrect ability type. |
| 16200001 | The caller has been released.<br>**Applicable version:** 9 and later |
| 16000012 | The application is controlled.<br>**Applicable version:** 10 and later |
| 16000076 | The app instance key is invalid.<br>**Applicable version:** 14 and later |
| 16000013 | The application is controlled by EDM.<br>**Applicable version:** 10 and later |
| 16000077 | The number of app instances reaches the limit.<br>**Applicable version:** 14 and later |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| type | string | Yes | 启动的UIExtensionAbility类型，取值详见 [通过startAbilityByType接口拉起垂类面板](../../../application-models/start-intent-panel.md#匹配规则)。 |
| wantParam | [Record](../../apis-default/arkts-apis/arkts-record-t.md)&lt;string, Object&gt; | Yes | 表示扩展参数。 |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| want | [Want](arkts-ability-app-ability-want-want-c.md) | Yes | 启动Ability的必要信息。 |
| callback | [AsyncCallback](../../apis-basic-service-kit/arkts-apis/arkts-basicservices-base-asynccallback-i.md)&lt;[AbilityResult](arkts-ability-abilityresult-abilityresult-i.md)&gt; | Yes | 回调函数，当接口调用成功，err中code为0，data为被拉起方退出时的结果码和数据；否则err会返回对应的错误码和错误信息。 |
...
| --- | --- | --- | --- |
| want | [Want](arkts-ability-app-ability-want-want-c.md) | Yes | 启动Ability的必要信息。 |
| options | [StartOptions](arkts-ability-app-ability-startoptions-startoptions-c.md) | Yes | 启动Ability所携带的参数。 |
| callback | [AsyncCallback](../../apis-basic-service-kit/arkts-apis/arkts-basicservices-base-asynccallback-i.md)&lt;[AbilityResult](arkts-ability-abilityresult-abilityresult-i.md)&gt; | Yes | 回调函数，当接口调用成功，err中code为0，data为被拉起方退出时的结果码和数据；否则err会返回对应的错误码和错误信息。 |
...
| --- | --- | --- | --- |
| want | [Want](arkts-ability-app-ability-want-want-c.md) | Yes | 启动Ability的必要信息。 |
| options | [StartOptions](arkts-ability-app-ability-startoptions-startoptions-c.md) | No | 启动Ability所携带的参数。 |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| want | [Want](arkts-ability-app-ability-want-want-c.md) | Yes | 启动 [AppServiceExtensionAbility](../../../reference/apis-ability-kit/js-apis-app-ability-appServiceExtensionAbility.md) 的Want信息。 |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| want | [Want](arkts-ability-app-ability-want-want-c.md) | Yes | 启动Ability的必要信息。只支持 [显式启动](../../../application-models/explicit-implicit-want-mappings.md#显式want匹配原理)，不支持 [隐式启动](../../../application-models/explicit-implicit-want-mappings.md#隐式want匹配原理)。 |
| specifiedFlag | string | Yes | UIAbility的ID。此ID不得与任何已运行的ID重复 - 开发者自定义的UIAbility标识。该标识不能与已启动的UIAbility标识相同，否则将返回错误。 &lt;br&gt;**说明：**&lt;br&gt;当通过该接口拉起启动模式为 [specified](../../../application-models/uiability-launch-type.md#specified启动模式)的UIAbility时，将不会触发 [onAcceptWant](arkts-ability-app-ability-abilitystage-abilitystage-c.md#onacceptwant)回调。 |
| options | [StartOptions](arkts-ability-app-ability-startoptions-startoptions-c.md) | No | 启动Ability所携带的参数。 |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| want | [Want](arkts-ability-app-ability-want-want-c.md) | Yes | 启动UIServiceExtensionAbility的必要信息。 |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| want | [Want](arkts-ability-app-ability-want-want-c.md) | Yes | 停止 [AppServiceExtensionAbility](../../../reference/apis-ability-kit/js-apis-app-ability-appServiceExtensionAbility.md) 的Want信息。 |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| callback | [AsyncCallback](../../apis-basic-service-kit/arkts-apis/arkts-basicservices-base-asynccallback-i.md)&lt;void&gt; | Yes | 回调函数，当销毁UIAbility自身成功，err中code为0；否则err会返回对应的错误码和错误信息。 |

**Error codes:**

| Error Code ID | Error Message |
| --- | --- |
| 16000004 | Cannot start an invisible component.<br>**Applicable version:** 9 and later |
| 401 | Parameter error. Possible causes: 1.Mandatory parameters are left unspecified. 2.Incorrect parameter types. |
| 16000005 | The specified process does not have the permission.<br>**Applicable version:** 9 and later |
| 16000001 | The specified ability does not exist.<br>**Applicable version:** 9 and later |
| 16000050 | Internal error. |
| 16000009 | An ability cannot be started or stopped in Wukong mode. |
| 16000011 | The context does not exist. |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| parameter | [AbilityResult](arkts-ability-abilityresult-abilityresult-i.md) | Yes | 返回给startAbilityForResult?接口调用方的相关信息。 |
| callback | [AsyncCallback](../../apis-basic-service-kit/arkts-apis/arkts-basicservices-base-asynccallback-i.md)&lt;void&gt; | Yes | 回调函数，当销毁UIAbility自身成功，err中code为0；否则err会返回对应的错误码和错误信息。 |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| parameter | [AbilityResult](arkts-ability-abilityresult-abilityresult-i.md) | Yes | 返回给startAbilityForResult?接口调用方的信息。 |
