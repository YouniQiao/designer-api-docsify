...
| requestCode | string | Yes | Request code generated by the system when the target UIAbility is started using [startAbilityForResult](#startabilityforresult) or [openLink](#openlink). The value can be obtained from the [CALLER_REQUEST_CODE](arkts-app-ability-wantconstant.md#ohosappabilitywantconstant) field in **want**. |
