...
Enumerates the callbacks to filter. It can be used with [AppStateFilter]\_\_\_JSDOC\_LINK\_DESC\_USD\_0\_\_\_ to filter the callbacks you want to listen for.
...
Corresponds to the  
\_\_\_MD\_LINK\_DESC\_USD\_0\_\_\_callback, which is executed when the application's foreground/background state changes.
...
Corresponds to the  
\_\_\_MD\_LINK\_DESC\_USD\_0\_\_\_callback, which is executed when the ability state changes.
...
Corresponds to the  
\_\_\_MD\_LINK\_DESC\_USD\_0\_\_\_callback, which is executed when a process is created.
...
Corresponds to the  
\_\_\_MD\_LINK\_DESC\_USD\_0\_\_\_callback, which is executed when a process is destroyed.
...
Corresponds to the  
\_\_\_MD\_LINK\_DESC\_USD\_0\_\_\_callback, which is executed when the process state is updated.
...
Corresponds to the  
\_\_\_MD\_LINK\_DESC\_USD\_0\_\_\_callback, which is executed when the application's first process is created.
...
Corresponds to the  
\_\_\_MD\_LINK\_DESC\_USD\_0\_\_\_callback, which is executed when the application's last process is destroyed.
