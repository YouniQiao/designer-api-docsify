...
An AbilityStage has the lifecycle callbacks [onCreate()](arkts-ability-app-ability-abilitystage-abilitystage-c.md#oncreate) and [onDestroy()](arkts-ability-app-ability-abilitystage-abilitystage-c.md#ondestroy), and the event callbacks [onAcceptWant()](arkts-ability-app-ability-abilitystage-abilitystage-c.md#onacceptwant),[onConfigurationUpdate()](arkts-ability-app-ability-abilitystage-abilitystage-c.md#onconfigurationupdate), and [onMemoryLevel()](arkts-ability-app-ability-abilitystage-abilitystage-c.md#onmemorylevel).
