...
Defines the callback function when the preloaded [UIExtensionAbility](arkts-ability-appabilityuiextensionability-uiextensionability-c.md) instance is destroyed.
