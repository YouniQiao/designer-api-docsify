...
| --- | --- | --- | --- |
| startupTask | string | Yes | Name of the [StartupTask](../../apis-na/arkts-apis/arkts-na-app-appstartup-startuptask-startuptask-c.md) or name of the .so file to be preloaded. |
