...
**Inheritance/Implementation:** WriteLock implements [Lock](arkts-na-syncprimitives-lock-i.md#lock)
...
| --- | --- | --- | --- |
| lock | [RWLock](arkts-na-syncprimitives-rwlock-c.md) | Yes | the RWLock this WriteLock is associated with. |
