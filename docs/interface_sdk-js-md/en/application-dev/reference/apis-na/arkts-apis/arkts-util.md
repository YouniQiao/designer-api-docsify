...
| [generateRandomUUID](arkts-na-util-generaterandomuuid-f.md) | Generate a random RFC 4122 version 4 UUID using a cryptographically secure random number generator. |
...
| Name | Description |
| --- | --- |
| [Base64Helper](arkts-na-util-base64helper-c.md) | Decodes a Base64 encoded String or input u8 array into a newly-allocated u8 array using the Base64 encoding scheme. |
...
| Name | Description |
| --- | --- |
| [Type](arkts-na-util-type-e.md) | The Type represents four different encoding formats for base64 |
