...
| interfaces | FixedArray&lt;[Class](arkts-na-class-c.md)&gt; | Yes | An array of `Class` objects representing the interfaces to implement. |
| handler | [InvocationHandler](arkts-na-reflect-invocationhandler-i.md) | Yes | The `InvocationHandler` to handle method and property operations. |

**Return value:**

| Type | Description |
| --- | --- |
| [Proxy](arkts-na-reflect-proxy-c.md) | A new proxy instance as an `Proxy`. |
...
| Type | Description |
| --- | --- |
| [InvocationHandler](arkts-na-reflect-invocationhandler-i.md) | The `InvocationHandler` used by this proxy. |
