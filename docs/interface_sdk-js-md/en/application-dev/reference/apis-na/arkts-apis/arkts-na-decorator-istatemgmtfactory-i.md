...
| --- | --- | --- | --- |
| computedCallback | [ComputedCallback](arkts-na-computedcallback-t.md)&lt;T&gt; | Yes | computed callback function |
...
| watchFunc | [WatchFuncType](arkts-na-watchfunctype-t.md) | No | watch type |

**Return value:**

| Type | Description |
| --- | --- |
| [IConsumeDecoratedVariable](arkts-na-decorator-iconsumedecoratedvariable-i.md)&lt;T&gt; | Consume instance |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| owner | [IVariableOwner](arkts-na-decorator-ivariableowner-i.md) | Yes | instance of the custom component where this state variable is located. |
| varName | string | Yes | state variable name. |
| provideAlias | string | Yes | provide alias. |
| watchFunc | [WatchFuncType](arkts-na-watchfunctype-t.md) | No | watch callback function type. |
| consumeOptions | [ConsumeOptions](arkts-na-decorator-consumeoptions-i.md)&lt;T&gt; | No | interface containing default value set by developer. |
...
| Type | Description |
| --- | --- |
| [IConsumerDecoratedVariable](arkts-na-decorator-iconsumerdecoratedvariable-i.md)&lt;T&gt; | Consumer instance |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| owner | [IVariableOwner](arkts-na-decorator-ivariableowner-i.md) | Yes | custom component owner. |
| envKey | [CustomEnvKey](arkts-na-decorator-customenvkey-c.md)&lt;T&gt; | Yes | custom env key. |
| varName | string | Yes | variable name that is decorated by @CustomEnv. |
| localInitValue | T | Yes | custom env variable initValue. |
| customEnvOptions | [CustomEnvOptions](arkts-na-decorator-customenvoptions-i.md)&lt;T&gt; | No | additional options for makeCustomEnv. |

**Return value:**

| Type | Description |
| --- | --- |
| [ICustomEnvDecoratedVariable](arkts-na-decorator-icustomenvdecoratedvariable-i.md)&lt;T&gt; | CustomEnv variable instance |
...
| --- | --- | --- | --- |
| owner | [IVariableOwner](arkts-na-decorator-ivariableowner-i.md) | Yes | custom component owner |
| envValue | string \| [SystemEnvKey](arkts-na-decorator-systemenvkey-c.md)&lt;T&gt; | Yes | system environment key<br>**Since:** 26.0.0 |
| varName | string | Yes | variable name that is decorated by @Env |
| envOptions | [EnvOptions](arkts-na-decorator-envoptions-i.md)&lt;T&gt; | No | additional options for makeEnv |

**Return value:**

| Type | Description |
| --- | --- |
| [IEnvDecoratedVariable](arkts-na-decorator-ienvdecoratedvariable-i.md)&lt;T&gt; | Env variable instance |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| reusePool | [ReusePoolOwnership](arkts-na-customcomponent-reusepoolownership-e.md) | Yes | reuse pool type. |
| poolAccepts | [Class](arkts-na-class-c.md)[] | Yes | custom components that reuse pool accepts. |
| owningView | [IVariableOwner](arkts-na-decorator-ivariableowner-i.md) | Yes | custom component that owns the global pool. |

**Return value:**

| Type | Description |
| --- | --- |
| [IGlobalReusePoolVariable](arkts-na-decorator-iglobalreusepoolvariable-i.md) | global reuse pool handle. |
...
| owner | [IVariableOwner](arkts-na-decorator-ivariableowner-i.md) | Yes | owner of this variable. |
| varName | string | Yes | state variable name. |
| source | [LinkSourceType](arkts-na-linksourcetype-t.md)&lt;T&gt; | Yes | state variable sync source. |
| watchFunc | [WatchFuncType](arkts-na-watchfunctype-t.md) | No | watch type |
...
| Type | Description |
| --- | --- |
| [ILinkDecoratedVariable](arkts-na-decorator-ilinkdecoratedvariable-i.md)&lt;T&gt; | PropRef instance |
...
| Type | Description |
| --- | --- |
| [ILocalStorageLinkDecoratedVariable](arkts-na-decorator-ilocalstoragelinkdecoratedvariable-i.md)&lt;T&gt; | LocalStorageLink instance |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| pathInfos | Array&lt;[IMonitorPathInfo](arkts-na-decorator-imonitorpathinfo-i.md)&gt; | Yes | monitor path to its accessor |
| monitorCallback | [MonitorCallback](arkts-na-monitorcallback-t.md) | Yes | callback when then monitor triggers |
| owner | [IVariableOwner](arkts-na-decorator-ivariableowner-i.md) | No | owner of this monitor |
...
| --- | --- | --- | --- |
| pathInfos | Array&lt;[IMonitorPathInfo](arkts-na-decorator-imonitorpathinfo-i.md)&gt; | Yes | monitor path to its accessor |
| monitorCallback | [MonitorCallback](arkts-na-monitorcallback-t.md) | Yes | callback when the monitor triggers |
| options | [MakeMonitorOptions](arkts-na-decorator-makemonitoroptions-i.md) | No | options of this monitor |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| observedObject | [IObservedObject](arkts-na-decorator-iobservedobject-i.md) \| undefined | Yes | owner of this meta. |
...
| Type | Description |
| --- | --- |
| [IObjectLinkDecoratedVariable](arkts-na-decorator-iobjectlinkdecoratedvariable-i.md)&lt;T&gt; | ObjectLink instance |
...
| Type | Description |
| --- | --- |
| [IParamDecoratedVariable](arkts-na-decorator-iparamdecoratedvariable-i.md)&lt;T&gt; | Param instance |
...
| Type | Description |
| --- | --- |
| [IParamOnceDecoratedVariable](arkts-na-decorator-iparamoncedecoratedvariable-i.md)&lt;T&gt; | Param Once instance |
...
| Type | Description |
| --- | --- |
| [IPropRefDecoratedVariable](arkts-na-decorator-iproprefdecoratedvariable-i.md)&lt;T&gt; | PropRef instance |
...
| Type | Description |
| --- | --- |
| [IProvideDecoratedVariable](arkts-na-decorator-iprovidedecoratedvariable-i.md)&lt;T&gt; | Provide instance |
...
| Type | Description |
| --- | --- |
| [IProviderDecoratedVariable](arkts-na-decorator-iproviderdecoratedvariable-i.md)&lt;T&gt; | Provider instance |
...
| Type | Description |
| --- | --- |
| [IStateDecoratedVariable](arkts-na-decorator-istatedecoratedvariable-i.md)&lt;T&gt; | State instance |
...
| Type | Description |
| --- | --- |
| [IStorageLinkDecoratedVariable](arkts-na-decorator-istoragelinkdecoratedvariable-i.md)&lt;T&gt; | StorageLink instance |
...
| Type | Description |
| --- | --- |
| [IStoragePropRefDecoratedVariable](arkts-na-decorator-istorageproprefdecoratedvariable-i.md)&lt;T&gt; | StoragePropRef instance |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| pathInfos | [IMonitorPathInfo](arkts-na-decorator-imonitorpathinfo-i.md)[] | Yes | monitor path to its accessor. |
| monitorCallback | [MonitorCallback](arkts-na-monitorcallback-t.md) | Yes | callback when the monitor triggers. |
| options | [MakeMonitorOptions](arkts-na-decorator-makemonitoroptions-i.md) | No | options of this monitor. |
