...
| defaultCreator | [StorageDefaultCreator](arkts-na-storagedefaultcreator-t.md)&lt;T&gt; | No | the function generating the default value. If defaultCreator is not set and there is no data that matches type and key, then returns undefined. |
...
| --- | --- | --- | --- |
| ttype | [Class](arkts-na-class-c.md) | Yes | class type of the stored value. |
| defaultCreator | [StorageDefaultCreator](arkts-na-storagedefaultcreator-t.md)&lt;T&gt; | No | the function generating the default value. If defaultCreator is not set and there is no data that matches type, then returns undefined. |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| keyOrType | string \| [Class](arkts-na-class-c.md) | Yes | key or class type removing |
