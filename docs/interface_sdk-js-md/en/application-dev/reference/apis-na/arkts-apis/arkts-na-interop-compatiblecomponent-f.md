...
| --- | --- | --- | --- |
| init | [CompatibleInitCallback](arkts-na-compatibleinitcallback-t.md) | Yes | the callback for initializing compatible custom component |
| update | [CompatibleUpdateCallback](arkts-na-compatibleupdatecallback-t.md) | Yes | the callback for updating compatible custom component |
| component | [ExtendableComponent](arkts-na-extendablecomponent-extendablecomponent-c.md) | No | the custom component |
