...
| --- | --- | --- | --- |
| controller | [NodeController](arkts-na-nodecontroller-c.md) | Yes | instance of NodeController. |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| style | CustomBuilderT&lt;NodeContainerAttribute&gt; | Yes | callback to set up NodeContainer's attributes. |

**Return value:**

| Type | Description |
| --- | --- |
| NodeContainerAttribute | The attribute of NodeContainer. |
