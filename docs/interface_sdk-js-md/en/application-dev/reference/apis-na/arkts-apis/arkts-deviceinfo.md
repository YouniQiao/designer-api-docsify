...
| Name | Description |
| --- | --- |
| [DeviceTypes](arkts-na-deviceinfo-devicetypes-e.md) | Enumerates device types, which can be used to verify the return value of **deviceType**. |
| [PerformanceClassLevel](arkts-na-deviceinfo-performanceclasslevel-e.md) | Enumerates the device capability levels. |
