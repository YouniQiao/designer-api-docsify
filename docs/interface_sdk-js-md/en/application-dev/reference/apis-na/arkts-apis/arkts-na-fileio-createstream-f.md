...
Creates a stream based on a file path. This API uses a promise to return the result. To close the stream, use **close()** of [Stream](arkts-na-fileio-stream-i.md).
...
Creates a stream based on a file path. To close the stream, use **close()** of [Stream](arkts-na-fileio-stream-i.md). This API uses an asynchronous callback to return the result.
