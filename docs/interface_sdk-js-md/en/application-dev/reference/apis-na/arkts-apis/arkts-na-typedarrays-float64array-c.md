# Float64Array(TypedArrays static methods declaration)
...
| Type | Description |
| --- | --- |
| IterableIterator&lt;[Double](arkts-na-double-c.md)&gt; | iterator over all elements |
...
| Type | Description |
| --- | --- |
| IterableIterator&lt;[Double](arkts-na-double-c.md)&gt; | an iterator over all elements. |
