...
| src | string \| int | Yes | Path or FD of the file to copy. |
| dest | string \| int | Yes | Destination path of the file or FD of the file created. |
| callback | [AsyncCallback](../../apis-basic-services-kit/arkts-apis/arkts-basicservices-base-asynccallback-i.md)&lt;void&gt; | Yes | Callback used to return the result. If the file is successfully copied, **err** is **undefined**; otherwise, **err** is an error object. |
