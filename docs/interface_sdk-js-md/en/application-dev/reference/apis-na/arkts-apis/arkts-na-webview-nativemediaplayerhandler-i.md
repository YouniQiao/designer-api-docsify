...
Implements a **NativeMediaPlayerHandler** object used as a parameter of the \_\_\_MD\_LINK\_DESC\_USD\_0\_\_\_ callback. The application uses this object to report the player status to the ArkWeb engine. > **NOTE** > > - The sample effect is subject to the actual device.
