...
| [ReadTextOptions](arkts-na-file-fs-readtextoptions-i.md) | Defines the options used in **readText()**. It inherits from [ReadOptions](arkts-na-file-fs-readoptions-i.md#ReadOptions). |
...
| [WriteOptions](arkts-na-file-fs-writeoptions-i.md) | Defines the options used in **write()**. It inherits from [Options](arkts-na-file-fs-options-i.md#Options). |
