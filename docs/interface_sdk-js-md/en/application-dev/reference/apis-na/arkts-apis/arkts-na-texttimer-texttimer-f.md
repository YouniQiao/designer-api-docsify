...
| --- | --- | --- | --- |
| options | [TextTimerOptions](arkts-na-texttimer-texttimeroptions-i.md) | No | text timer options. |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| style | CustomBuilderT&lt;TextTimerAttribute&gt; | Yes | TextTimer attribute instance |
