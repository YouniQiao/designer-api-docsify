...
| Type | Description |
| --- | --- |
| [SurfaceRect](arkts-na-xcomponent-surfacerect-i.md) | The surface rectangle information. |
...
| Type | Description |
| --- | --- |
| [Required](arkts-na-required-t.md)&lt;[SurfaceRotationOptions](arkts-na-xcomponent-surfacerotationoptions-i.md)&gt; | The surface rotation options result. |
...
| rect | [SurfaceRect](arkts-na-xcomponent-surfacerect-i.md) | Yes | The rectangle information of the surface created by XComponent. |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| config | [SurfaceConfig](arkts-na-xcomponent-surfaceconfig-i.md) | Yes | surface config |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| rect | [SurfaceRect](arkts-na-xcomponent-surfacerect-i.md) | Yes | The surface rectangle information. |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| rotationOptions | [SurfaceRotationOptions](arkts-na-xcomponent-surfacerotationoptions-i.md) | Yes | The surface rotation options. |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| config | [ImageAnalyzerConfig](arkts-na-imagecommon-imageanalyzerconfig-i.md) | Yes | Image analyzer config. |
...
| --- | --- |
| [110001](../../apis-arkui/arkui-ts/errorcode-image-analyzer.md#110001-ai-image-analysis-not-supported) | Image analysis feature is unsupported. |
| [110003](../../apis-arkui/arkui-ts/errorcode-image-analyzer.md#110003-ai-image-analysis-terminated) | Image analysis is stopped. |
| [110002](../../apis-arkui/arkui-ts/errorcode-image-analyzer.md#110002-ai-image-analysis-already-in-progress) | Image analysis is currently being executed. |
