...
| --- | --- | --- | --- |
| gesture | [GestureHandler](../../apis-arkui/arkts-apis/arkts-arkui-gesturehandler-c.md) | Yes | gesture indicates the gesture bound to a component. |
| priority | [GesturePriority](../../apis-arkui/arkts-apis/arkts-arkui-gesturepriority-e.md) | No | priority indicates the gesture's priority. |
| mask | [GestureMask](../../apis-arkui/arkts-apis/arkts-arkui-gesturemask-e.md) | No | mask indicates the gesture's GestureMask value. |
