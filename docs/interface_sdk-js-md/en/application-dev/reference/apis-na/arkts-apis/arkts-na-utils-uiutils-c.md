...
| --- | --- | --- | --- |
| valueCallback | [MonitorValueCallback](arkts-na-monitorvaluecallback-t.md) \| [MonitorValueCallback](arkts-na-monitorvaluecallback-t.md)[] | Yes | monitored change for state variable. |
| monitorCallback | [MonitorCallback](arkts-na-monitorcallback-t.md) | Yes | the function triggered when state variable changes. |
| options | [MonitorOptions](arkts-na-utils-monitoroptions-i.md) | No | the monitor configuration. |

**Return value:**

| Type | Description |
| --- | --- |
| [IMonitorDecoratedVariable](arkts-na-decorator-imonitordecoratedvariable-i.md) | monitor handle. |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| valueInfo | [MonitorValueInfo](arkts-na-utils-monitorvalueinfo-i.md) \| [MonitorValueInfo](arkts-na-utils-monitorvalueinfo-i.md)[] | Yes | monitored change for state variable. |
| monitorCallback | [MonitorCallback](arkts-na-monitorcallback-t.md) | Yes | the function triggered when state variable changes. |
| options | [MonitorBaseOptions](arkts-na-utils-monitorbaseoptions-i.md) | No | the monitor configuration. |
...
| Type | Description |
| --- | --- |
| [ObservedResult](arkts-na-utils-observedresult-i.md) | return result of whether a class is observable. |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| monitor | [IMonitorDecoratedVariable](arkts-na-decorator-imonitordecoratedvariable-i.md) | Yes | handle |
...
| Type | Description |
| --- | --- |
| [CustomComponentContext](arkts-na-utils-customcomponentcontext-i.md) | current custom component's context handle. |
...
| Type | Description |
| --- | --- |
| [CustomComponentLifecycle](arkts-na-customcomponent-customcomponentlifecycle-i.md) | the lifecycle that the custom component belong to . |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| getter | [GetterCallback](arkts-na-gettercallback-t.md)&lt;T&gt; | Yes | A value or a function that returns the current value of type T. |

**Return value:**

| Type | Description |
| --- | --- |
| [Binding](arkts-na-utils-binding-c.md)&lt;T&gt; | read-only data binding value |
...
| --- | --- | --- | --- |
| getter | [GetterCallback](arkts-na-gettercallback-t.md)&lt;T&gt; | Yes | A value or a function that returns the current value of type T. |
| setter | [SetterCallback](arkts-na-settercallback-t.md)&lt;T&gt; | Yes | A function to set a new value of type T. |

**Return value:**

| Type | Description |
| --- | --- |
| [MutableBinding](arkts-na-utils-mutablebinding-c.md)&lt;T&gt; | mutable data binding value |
