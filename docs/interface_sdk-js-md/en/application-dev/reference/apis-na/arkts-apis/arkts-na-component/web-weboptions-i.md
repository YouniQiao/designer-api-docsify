...
Rendering mode. RenderMode.ASYNC\_RENDER (default, cannot be dynamically adjusted): The Web component is rendered asynchronously. RenderMode.SYNC\_RENDER: The Web component is rendered synchronously within the current execution context.
