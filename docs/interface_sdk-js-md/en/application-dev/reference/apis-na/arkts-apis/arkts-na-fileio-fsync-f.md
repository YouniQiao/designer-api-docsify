...
| --- | --- | --- | --- |
| fd | int | Yes | FD of the file. |
| callback | [AsyncCallback](../../apis-basic-services-kit/arkts-apis/arkts-basicservices-base-asynccallback-i.md)&lt;void&gt; | Yes | Callback used to return the result. If the cache data of the file system is successfully written to the disk, **err** is **undefined**. Otherwise, **err** is an error object. |
