...
Callback invoked when the button is selected. Anonymous Object Rectification.
...
Whether the button is the default focus. The value true means that the button is the default focus, and false means the opposite. Anonymous Object Rectification.
...
Whether to respond when the button is clicked. The value true means to respond when the button is clicked, and false means the opposite. Anonymous Object Rectification.
...
Button style. Anonymous Object Rectification.

**Type:** [DialogButtonStyle](../../apis-arkui/arkts-apis/arkts-arkui-dialogbuttonstyle-e.md)
