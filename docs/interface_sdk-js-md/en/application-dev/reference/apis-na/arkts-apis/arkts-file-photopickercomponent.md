...
| Name | Description |
| --- | --- |
| [PhotoPickerComponent](arkts-na-file-photopickercomponent-photopickercomponent-s.md) | Declare struct PhotoPickerComponent |

### Enums

| Name | Description |
| --- | --- |
| [BadgeType](arkts-na-file-photopickercomponent-badgetype-e.md) | BadgeType. |
| [ClickType](arkts-na-file-photopickercomponent-clicktype-e.md) | ClickType. include SELECTED and DESELECTED |
| [DataType](arkts-na-file-photopickercomponent-datatype-e.md) | DataType represents the type of the data set to picker component |
| [ItemDisplayRatio](arkts-na-file-photopickercomponent-itemdisplayratio-e.md) | Enumerates the aspect ratios of the grid item display, including 1:1 and the original image's aspect ratio. |
| [ItemType](arkts-na-file-photopickercomponent-itemtype-e.md) | ItemType. include CAMERA and THUMBNAIL |
| [MaxCountType](arkts-na-file-photopickercomponent-maxcounttype-e.md) | MaxCountType. include TOTAL_MAX_COUNT, PHOTO_MAX_COUNT and VIDEO_MAX_COUNT |
| [PhotoBrowserRange](arkts-na-file-photopickercomponent-photobrowserrange-e.md) | PhotoBrowserRange. include ALL and SELECTED_ONLY |
| [PhotoBrowserUIElement](arkts-na-file-photopickercomponent-photobrowseruielement-e.md) | PhotoBrowserUIElement. include CHECKBOX and BACK_BUTTON |
| [PickerColorMode](arkts-na-file-photopickercomponent-pickercolormode-e.md) | PickerColorMode. include AUTO, LIGHT and DARK |
| [PickerOrientation](arkts-na-file-photopickercomponent-pickerorientation-e.md) | PickerOrientation. include VERTICAL and HORIZONTAL |
| [ReminderMode](arkts-na-file-photopickercomponent-remindermode-e.md) | ReminderMode, include NONE, TOAST and MASK |
| [SaveMode](arkts-na-file-photopickercomponent-savemode-e.md) | Enumeration type of save mode. |
| [SelectMode](arkts-na-file-photopickercomponent-selectmode-e.md) | SelectMode. include SINGLE_SELECT and MULTI_SELECT |
| [VideoPlayerState](arkts-na-file-photopickercomponent-videoplayerstate-e.md) | VideoPlayerState. include PLAYING, PAUSED, STOPPED, SEEK_START and SEEK_FINISH |
