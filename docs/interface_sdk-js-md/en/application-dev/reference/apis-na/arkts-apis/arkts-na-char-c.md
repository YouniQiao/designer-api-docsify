...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| lhs | [Char](arkts-na-char-c.md) | Yes | the first Char to compare. |
| rhs | [Char](arkts-na-char-c.md) | Yes | the second Char to compare. |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| other | [Char](arkts-na-char-c.md) | Yes | Char object to compare with. |
...
| Type | Description |
| --- | --- |
| [Char](arkts-na-char-c.md) | the lower case char converted from the underlying char. |
...
| Type | Description |
| --- | --- |
| [Char](arkts-na-char-c.md) | the upper case char converted from the underlying char. |
