...
| Name | Description |
| --- | --- |
| [Web](arkts-na-web-web-f.md) | Defines Web Component. |
...
| [FileSelectorParam](arkts-na-web-fileselectorparam-c.md) | Encompassed message information as parameters to [onFileSelectorShow](../../apis-arkweb/arkts-components/arkts-arkweb-web-attribute.md#onfileselectorshow) method. |
| [FileSelectorResult](arkts-na-web-fileselectorresult-c.md) | Defines the file selector result, related to [onFileSelectorShow](../../apis-arkweb/arkts-components/arkts-arkweb-web-attribute.md#onfileselectorshow) method. |
| [FullScreenExitHandler](arkts-na-web-fullscreenexithandler-c.md) | Implements the **FullScreenExitHandler** object to notify you that the **Web** component exits full screen mode. For details about the sample code, see [onFullScreenEnter](./arkts-basic-components-web-events.md#onfullscreenenter9). &gt; **NOTE：**&gt; &gt; - The sample effect is subject to the actual device. |
...
| [WebContextMenuParam](arkts-na-web-webcontextmenuparam-c.md) | Defines the context menu param, related to [WebContextMenuParam](arkts-na-web-webcontextmenuparam-c.md) method. |
| [WebContextMenuResult](arkts-na-web-webcontextmenuresult-c.md) | Defines the context menu result, related to [WebContextMenuResult](arkts-na-web-webcontextmenuresult-c.md) method. |
...
| [CameraCaptureStateChangeInfo](arkts-na-web-cameracapturestatechangeinfo-i.md) | Defines the state information of the camera before and after the callback is triggered. |
...
| [FullScreenEnterEvent](arkts-na-web-fullscreenenterevent-i.md) | Provides details about the event that the **Web** component to enter the full-screen mode. |
...
| [NativeMediaPlayerConfig](arkts-na-web-nativemediaplayerconfig-i.md) | Represents the configuration for [enabling the application to take over web page media playback](../../../reference/apis-arkweb/arkts-basic-components-web-attributes.md#enablenativemediaplayer12) . |
...
| [OnAudioStateChangedEvent](arkts-na-web-onaudiostatechangedevent-i.md) | Represents the callback invoked when the audio playback status on the web page changes. |
...
| [OnPdfLoadEvent](arkts-na-web-onpdfloadevent-i.md) | Defines the function triggered when the PDF loading is successful or fails. |
| [OnPdfScrollEvent](arkts-na-web-onpdfscrollevent-i.md) | Defines the function triggered when the PDF page is scrolled to the bottom. |
| [OnPermissionRequestEvent](arkts-na-web-onpermissionrequestevent-i.md) | Represents the callback invoked when a permission request is received. |
...
| [OnScreenCaptureRequestEvent](arkts-na-web-onscreencapturerequestevent-i.md) | Represents the callback invoked when a screen capture request is received. |
...
| [ScreenCaptureConfig](arkts-na-web-screencaptureconfig-i.md) | Provides the web screen capture configuration. |
...
| [WebMediaOptions](arkts-na-web-webmediaoptions-i.md) | Describes the web media options. |
...
| [AudioSessionType](arkts-na-web-audiosessiontype-e.md) | Enumerates the web audio types in the application. |
...
| [CameraCaptureState](arkts-na-web-cameracapturestate-e.md) | Enumerates the camera capture states. |
...
| [CredentialType](arkts-na-web-credentialtype-e.md) | Enum type supplied to [CredentialType](arkts-na-web-credentialtype-e.md) when ClientAuthenticationHandler#confirm being called. |
| [DetectedBlankScreenReason](arkts-na-web-detectedblankscreenreason-e.md) | Enum type supplied to [BlankScreenDetectionEventInfo](arkts-na-web-blankscreendetectioneventinfo-i.md) when onDetectedBlankScreen being called. |
| [FileSelectorMode](arkts-na-web-fileselectormode-e.md) | Enum type supplied to [FileSelectorParam](arkts-na-web-fileselectorparam-c.md) when onFileSelectorShow being called. |
...
| [NativeEmbedParamStatus](arkts-na-web-nativeembedparamstatus-e.md) | Enum type supplied to [NativeEmbedParamItem](arkts-na-web-nativeembedparamitem-i.md) when onNativeEmbedObjectParamChange being called. |
...
| [PdfLoadResult](arkts-na-web-pdfloadresult-e.md) | Enumerates the PDF page loading results. |
| [PinVerifyResult](arkts-na-web-pinverifyresult-e.md) | Enum type supplied to [PinVerifyResult](arkts-na-web-pinverifyresult-e.md) when VerifyPinHandler#confirm being called. |
...
| [RenderProcessNotRespondingReason](arkts-na-web-renderprocessnotrespondingreason-e.md) | Enum type supplied to [RenderProcessNotRespondingData](arkts-na-web-renderprocessnotrespondingdata-i.md) when onRenderProcessNotResponding is called. |
...
| [ViewportFit](arkts-na-web-viewportfit-e.md) | Defines the viewport-fit type, related to [ViewportFit](arkts-na-web-viewportfit-e.md). |
...
| [WebCaptureMode](arkts-na-web-webcapturemode-e.md) | Enumerates the web screen capture modes. |
...
| [OnFullScreenEnterCallback](arkts-na-onfullscreenentercallback-t.md) | Defines a callback invoked when the **Web** component enters full screen mode. |
