...
| [BackgroundBlurStyleOptions](arkts-na-common-backgroundblurstyleoptions-i.md) | Defines the options of backgroundBlurStyle |
| [BackgroundBrightnessOptions](arkts-na-common-backgroundbrightnessoptions-i.md) | Define BackgroundBrightness Options. |
| [BackgroundEffectOptions](arkts-na-common-backgroundeffectoptions-i.md) | Defines the options of BackgroundEffect |
...
| [BindOptions](arkts-na-common-bindoptions-i.md) | Overlay module options |
...
| [ClickEffect](arkts-na-common-clickeffect-i.md) | Defines the click effect. |
...
| [ContentCoverOptions](arkts-na-common-contentcoveroptions-i.md) | Component content cover options |
...
| [DismissSheetAction](arkts-na-common-dismisssheetaction-i.md) | Component sheet dismiss |
...
| [ExpectedFrameRateRange](arkts-na-common-expectedframeraterange-i.md) | Interface for ExpectedFrameRateRange. |
...
| [KeyframeAnimateParam](arkts-na-common-keyframeanimateparam-i.md) | Defines the overall animation parameters of the keyframe animation. |
| [KeyframeState](arkts-na-common-keyframestate-i.md) | Defines a keyframe state. |
...
| [MotionPathOptions](arkts-na-common-motionpathoptions-i.md) | Defines the motion path options. |
...
| [RotateAngleOptions](arkts-na-common-rotateangleoptions-i.md) | The rotation parameters containing multi-axis angle information. |
| [RotateOptions](arkts-na-common-rotateoptions-i.md) | The param of rotate. |
| [ScaleOptions](arkts-na-common-scaleoptions-i.md) | Defines the options of scale. |
...
| [SheetDismiss](arkts-na-common-sheetdismiss-i.md) | Component sheet dismiss |
| [SheetOptions](arkts-na-common-sheetoptions-i.md) | Component sheet options |
| [SheetTitleOptions](arkts-na-common-sheettitleoptions-i.md) | Component sheet title options |
...
| [SpringBackAction](arkts-na-common-springbackaction-i.md) | Defines sheet spring back action |
...
| [SystemAdaptiveOptions](arkts-na-common-systemadaptiveoptions-i.md) | Defines the SystemAdaptiveOptions interface |
...
| Name | Description |
| --- | --- |
| [BlurSnapshotOptions](arkts-na-common-blursnapshotoptions-i-sys.md) | Defines the options for blur snapshot optimization. Setting this object enables blur optimization. |
...
| [LightSource](arkts-na-common-lightsource-i-sys.md) | LightSource info |
| [PixelMapMock](arkts-na-common-pixelmapmock-i-sys.md) | pixelmap object with release function. |
| [PointLightStyle](arkts-na-common-pointlightstyle-i-sys.md) | PointLightStyle info |
| [SheetOptions](arkts-na-common-sheetoptions-i-sys.md) | Component sheet options |
...
| [AccessibilityRoleType](arkts-na-common-accessibilityroletype-e.md) | Enumerates the component role types used by screen readers. |
| [AccessibilitySamePageMode](arkts-na-common-accessibilitysamepagemode-e.md) | Enumerates the same-page modes for cross-process embedded components and their host applications. |
...
| [BlurStyle](arkts-na-common-blurstyle-e.md) | enum Blur style |
| [BlurStyleActivePolicy](arkts-na-common-blurstyleactivepolicy-e.md) | Enumerates the policies for activating the blur style. |
...
| [FinishCallbackType](arkts-na-common-finishcallbacktype-e.md) | Enum for FinishCallbackType. |
| [HapticFeedbackMode](arkts-na-common-hapticfeedbackmode-e.md) | Defines the menu haptic feedback mode. |
| [HoverModeAreaType](arkts-na-common-hovermodeareatype-e.md) | Enumerates the type of area in hover mode. |
...
| [ScrollSizeMode](arkts-na-common-scrollsizemode-e.md) | Define the scroll size mode of the sheet. |
...
| [SheetKeyboardAvoidMode](arkts-na-common-sheetkeyboardavoidmode-e.md) | Define the mode of sheet how to avoid keyboard. |
| [SheetMode](arkts-na-common-sheetmode-e.md) | Define the display mode of the sheet. |
| [SheetSize](arkts-na-common-sheetsize-e.md) | Defines sheet size type. |
| [SheetType](arkts-na-common-sheettype-e.md) | Defines the sheet type. |
...
| [EdgeLightMode](arkts-na-common-edgelightmode-e-sys.md) | Enum for edgeLight animation mode. |
| [SpatialPositionMode](arkts-na-common-spatialpositionmode-e-sys.md) | Spatial position mode. Indicates the coordinate system used by the corner positions. |
| [TransitionHierarchyStrategy](arkts-na-common-transitionhierarchystrategy-e-sys.md) | Source and target are two matched elements during the geometry transition. The animation starts at the source and ends at the target. TransitionHierarchyStrategy enumeration defines how levels of source and target elements would be changed in the hierarchy during the geometry transition. |
<!--DelEnd-->
...
| [DoubleLengthDetents](arkts-na-doublelengthdetents-t.md) | Defines the detent array of a two-length. |
...
| [Filter](arkts-na-filter-t.md) | Filter |
...
| [ICurve](arkts-na-icurve-t.md) | Interface for curve object. |
...
| [Matrix4Transit](arkts-na-matrix4transit-t.md) | Interface for matrix object. |
...
| [SingleLengthDetent](arkts-na-singlelengthdetent-t.md) | Defines the detent array of a single length. |
