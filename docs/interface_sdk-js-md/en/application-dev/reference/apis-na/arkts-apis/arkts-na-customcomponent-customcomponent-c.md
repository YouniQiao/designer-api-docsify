...
| content | CustomBuilder | No | tail closure for custom component |
...
| reuseId | string | No | reuse id for reusable. Only valid if custom component decorated with @Reusable |
| content | CustomBuilder | No | tail closure for custom component |
| options | [CustomComponentV1InvokeOptions](arkts-na-customcomponent-customcomponentv1invokeoptions-i.md) | No | additional invoke options |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| params | [ReuseObject](arkts-na-customcomponent-reuseobject-c.md) | Yes | Custom component init params. |
