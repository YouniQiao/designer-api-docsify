...
| Type | Description |
| --- | --- |
| LazyVGridLayoutAttribute | The attribute of the grid |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| style_ | CustomBuilderT&lt;LazyVGridLayoutAttribute&gt; | Yes | The style to create a LazyVGridLayout. |
...
| Type | Description |
| --- | --- |
| LazyVGridLayoutAttribute | The attribute of the LazyVGridLayout. |
