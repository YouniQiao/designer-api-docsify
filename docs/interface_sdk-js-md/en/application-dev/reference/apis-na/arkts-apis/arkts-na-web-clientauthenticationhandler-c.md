...
| credentialTypeOrCertChainFile | [CredentialType](arkts-na-web-credentialtype-e.md) \| string | Yes | The type of the credential or the file that store client certificate chain. |
