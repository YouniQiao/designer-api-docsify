...
| --- | --- | --- | --- |
| observer | [CustomComponentLifecycleObserver](arkts-na-customcomponent-customcomponentlifecycleobserver-i.md) | Yes | Custom component lifecycle observer |
...
| Type | Description |
| --- | --- |
| [CustomComponentLifecycleState](arkts-na-customcomponent-customcomponentlifecyclestate-e.md) | lifecycle state |
