...
Enumerates the material levels, which indicate the computing power level of the device. Use [getGlobalMaterialLevel](arkts-na-uimaterial-getglobalmateriallevel-f.md#getGlobalMaterialLevel) to obtain the material level of the current device.
