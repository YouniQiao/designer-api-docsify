...
**Inheritance/Implementation:** RichTextAttribute extends CommonMethod
...
```TypeScript
attributeModifier(modifier: AttributeModifier<RichTextAttribute> | AttributeModifier<CommonMethod> | undefined): this
```
...
```TypeScript
onComplete(callback: (() => void) | undefined): this
```
...
<!--Device-RichTextAttribute-default--><!--Device-RichTextAttribute-default-End-->
