...
| --- | --- | --- | --- |
| key | [CustomEnvKey](arkts-na-decorator-customenvkey-c.md)&lt;T&gt; | Yes | Keys for custom environment variables. |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| key | [WritableSystemEnvKey](arkts-na-decorator-writablesystemenvkey-c.md)&lt;T&gt; | Yes | Keys for system environment variables. |
