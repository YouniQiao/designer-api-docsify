...
| --- | --- | --- | --- |
| options | [TextClockOptions](arkts-na-textclock-textclockoptions-i.md) | No | text clock options. |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| style | CustomBuilderT&lt;TextClockAttribute&gt; | Yes | TextClock attribute instance |
