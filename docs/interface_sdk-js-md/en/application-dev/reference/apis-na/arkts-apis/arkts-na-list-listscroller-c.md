...
| --- | --- | --- | --- |
| options | [CloseSwipeActionOptions](arkts-na-list-closeswipeactionoptions-i.md) | No | Callback events for collapsing list items in the EXPANDED state. |
...
| Type | Description |
| --- | --- |
| [VisibleListContentInfo](arkts-na-list-visiblelistcontentinfo-i.md) | Index information of the child component at the specified coordinates. |
