...
| --- | --- | --- | --- |
| value | [RefreshOptions](arkts-na-refresh-refreshoptions-i.md) | Yes | value |
...
| Type | Description |
| --- | --- |
| RefreshAttribute | The attribute of the grid |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| style_ | CustomBuilderT&lt;RefreshAttribute&gt; | Yes | The style to create a Refresh. |
...
| Type | Description |
| --- | --- |
| RefreshAttribute | The attribute of the Refresh. |
