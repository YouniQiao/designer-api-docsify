...
The module defines an observer to listen for application state changes. It can be used as an input parameter in [on('applicationState')]\_\_\_JSDOC\_LINK\_DESC\_USD\_0\_\_\_ to listen for lifecycle changes of the application.
