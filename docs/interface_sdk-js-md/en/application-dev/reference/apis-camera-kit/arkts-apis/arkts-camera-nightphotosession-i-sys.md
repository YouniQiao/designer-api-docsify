...
**Inheritance/Implementation:** NightPhotoSession extends [Session](arkts-camera-session-i.md), [Flash](arkts-camera-flash-i.md), [AutoExposure](arkts-camera-autoexposure-i.md), [Focus](arkts-camera-focus-i.md), [Zoom](arkts-camera-zoom-i.md), [ColorEffect](arkts-camera-coloreffect-i-sys.md), [Beauty](arkts-camera-beauty-i-sys.md), [ColorManagement](arkts-camera-colormanagement-i.md), [ManualExposure](arkts-camera-manualexposure-i-sys.md)
