...
**Inheritance/Implementation:** PanoramaPhotoSession extends [Session](arkts-camera-session-i.md), [Focus](arkts-camera-focus-i.md), [AutoExposure](arkts-camera-autoexposure-i.md), [WhiteBalance](arkts-camera-whitebalance-i-sys.md), [ColorEffect](arkts-camera-coloreffect-i-sys.md)
