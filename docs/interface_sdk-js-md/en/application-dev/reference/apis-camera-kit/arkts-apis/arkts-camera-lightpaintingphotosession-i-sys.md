...
| Type | Description |
| --- | --- |
| [LightPaintingType](arkts-camera-lightpaintingtype-e-sys.md) | The light painting type in use. |
...
| Type | Description |
| --- | --- |
| [Array](../../apis-na/arkts-apis/arkts-na-array-i.md)<LightPaintingType> | List of light painting types. |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| type | [LightPaintingType](arkts-camera-lightpaintingtype-e-sys.md) | Yes | Light painting type to set. |
