...
| [MetadataOutput](arkts-camera-camera-metadataoutput-i-sys.md) | MetadataOutput implements metadata streams. It inherits from [CameraOutput](arkts-camera-camera-cameraoutput-i.md). |
