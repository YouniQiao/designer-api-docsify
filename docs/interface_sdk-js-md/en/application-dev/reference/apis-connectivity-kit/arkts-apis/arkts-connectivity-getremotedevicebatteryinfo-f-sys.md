...
| --- | --- | --- | --- |
| deviceId | [BluetoothAddress](arkts-connectivity-bluetoothaddress-i.md) | Yes | Indicates address of peer device. |

**Return value:**

| Type | Description |
| --- | --- |
| [Promise](../../apis-na/arkts-apis/arkts-na-promise-i.md)<BatteryInfo> | Returns the battery info. |
