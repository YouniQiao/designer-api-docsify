...
| p192Data | [OobData](arkts-connectivity-oobdata-i-sys.md) | No | The out-of-band data (P192). |
| p256Data | [OobData](arkts-connectivity-oobdata-i-sys.md) | No | The out-of-band data (P256). |
