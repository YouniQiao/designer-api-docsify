...
| [getPairedDevices](arkts-connectivity-manager-getpaireddevices-f.md#getpaireddevices) | Gets the list of devices that have been paired with the current device.If the user has the ohos.permission.GET\_\_\_ESCAPED\_UNDERSCORE\_\_\_NEARLINK\_\_\_ESCAPED\_UNDERSCORE\_\_\_PEER\_\_\_ESCAPED\_UNDERSCORE\_\_\_MAC permission, the real device address is returned.Otherwise, a random device address is returned. |
