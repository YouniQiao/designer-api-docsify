...
| callback | [Callback](../../apis-basic-service-kit/arkts-apis/arkts-basicservices-callback-t.md)&lt;number&gt; | No | the callback of off, 0: config is added, 1: config is changed, 2: config is removed. |
