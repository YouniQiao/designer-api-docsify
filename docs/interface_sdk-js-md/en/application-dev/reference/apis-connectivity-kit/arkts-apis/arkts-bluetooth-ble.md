...
| [off_advertisingStateChange](arkts-connectivity-ble-offadvertisingstatechange-f.md) | Unsubscribe from advertising state change event. |
...
| [on_advertisingStateChange](arkts-connectivity-ble-onadvertisingstatechange-f.md) | Subscribing to advertising state change event. |
