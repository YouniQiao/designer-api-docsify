...
| --- | --- | --- | --- |
| callback | Callback&lt;[PairingRequestParam](arkts-connectivity-remotedevice-pairingrequestparam-i.md)&gt; | Yes | Callback used to listen for the pairing request event. |
