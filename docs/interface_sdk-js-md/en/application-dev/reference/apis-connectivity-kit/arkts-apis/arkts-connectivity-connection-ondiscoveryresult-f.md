...
<!--Device-connection-function onDiscoveryResult(callback: Callback<Array<DiscoveryResult>>): void--><!--Device-connection-function onDiscoveryResult(callback: Callback<Array<DiscoveryResult>>): void-End-->
...
| --- | --- | --- | --- |
| callback | [Callback](../../apis-basic-service-kit/arkts-apis/arkts-basicservices-base-callback-i.md)&lt;Array&lt;[DiscoveryResult](arkts-connectivity-connection-discoveryresult-i-sys.md)&gt;&gt; | Yes | Callback used to listen for the discovering event. |
