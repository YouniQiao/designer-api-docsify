...
**Substitutes:** [ble/ble](arkts-bluetooth-ble.md#ohosbluetoothble)
...
| [on_BLEDeviceFind](arkts-connectivity-ble-onbledevicefind-f.md#onbledevicefind) | Subscribe BLE scan result. On API 10 and above, the permission required by this interface is changed from USE_BLUETOOTH to ACCESS_BLUETOOTH. |
| [off_BLEDeviceFind](arkts-connectivity-ble-offbledevicefind-f.md#offbledevicefind) | Unsubscribe BLE scan result. On API 10 and above, the permission required by this interface is changed from USE_BLUETOOTH to ACCESS_BLUETOOTH. |
