...
Unsubscribe the event of acl state changed from a remote device.If the application has ohos.permission.GET\_BLUETOOTH\_PEERS\_MAC, the type of the peer device address is real.Otherwise, the type of the peer device address is virtual.
...
| --- | --- | --- | --- |
| callback | \_\_\_MD\_LINK\_USD\_0\_\_\_&lt;AclStateResult&gt; | No | Callback used to listen. |
