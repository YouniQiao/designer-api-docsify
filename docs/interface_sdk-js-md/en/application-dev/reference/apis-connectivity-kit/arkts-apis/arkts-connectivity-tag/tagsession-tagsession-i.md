...
| --- | --- | --- | --- |
| data | number[] | Yes | Indicates the data to be written to the tag. |
| callback | \_\_\_MD\_LINK\_USD\_0\_\_\_&lt;number[]&gt; | Yes | The callback. data fails to be written to the tag. |
...
| Type | Description |
| --- | --- |
| ArkTS-Dyn: Promise&lt;number[]&gt;  \_\_\_HTML\_TAG\_USD\_0\_\_\_ArkTS-Sta：Promise&lt;int[]&gt; | Returns bytes received in response. Or bytes with a length of 0 if the data fails to be written to the tag. |
