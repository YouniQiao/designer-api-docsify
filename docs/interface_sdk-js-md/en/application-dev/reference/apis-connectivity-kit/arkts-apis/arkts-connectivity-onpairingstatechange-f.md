...
| --- | --- | --- | --- |
| callback | [Callback](../../apis-basic-service-kit/arkts-apis/arkts-basicservices-callback-i.md)<PairingStateParam> | Yes | Callback function used to listen for the pairing state event. |
