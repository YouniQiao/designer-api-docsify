...
- [@ohos.wifi](arkts-wifi.md)
  ...
  <!--Del-->
  - [off(system api)](arkts-connectivity-wifi-off-f-sys.md)<!--DelEnd-->
  - [on](arkts-connectivity-wifi-on-f.md)
  <!--Del-->
  - [on(system api)](arkts-connectivity-wifi-on-f-sys.md)<!--DelEnd-->
...
- [@system.bluetooth](arkts-bluetooth.md)
  - [Bluetooth](arkts-connectivity-bluetooth-bluetooth-c.md)
...
- tag<!--arkts-connectivitykit-tag-->
  - [tag/nfctech](arkts-tag/nfctech.md)
    - [BarcodeTag](nfctech-barcodetag-i.md)
    - [IsoDepTag](nfctech-isodeptag-i.md)
    - [MifareClassicTag](nfctech-mifareclassictag-i.md)
    - [MifareUltralightTag](nfctech-mifareultralighttag-i.md)
    - [NdefFormatableTag](nfctech-ndefformatabletag-i.md)
    - [NdefMessage](nfctech-ndefmessage-i.md)
    - [NdefTag](nfctech-ndeftag-i.md)
    - [NfcATag](nfctech-nfcatag-i.md)
    - [NfcBTag](nfctech-nfcbtag-i.md)
    - [NfcFTag](nfctech-nfcftag-i.md)
    - [NfcVTag](nfctech-nfcvtag-i.md)
  - [tag/tagSession](arkts-tag/tagsession.md)
    - [TagSession](tagsession-tagsession-i.md)