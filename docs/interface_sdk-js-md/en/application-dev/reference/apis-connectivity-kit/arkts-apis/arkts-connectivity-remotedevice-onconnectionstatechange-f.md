...
| --- | --- | --- | --- |
| callback | Callback&lt;[ConnectionStateParam](arkts-connectivity-remotedevice-connectionstateparam-i.md)&gt; | Yes | Callback used to return the result of the connection status change event. |
