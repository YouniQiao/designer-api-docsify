...
| Name | Description |
| --- | --- |
| [createCdsmClient(CDSM Capability)](arkts-connectivity-cdsm-createcdsmclient-f.md) | Creates a CDSM client instance. |
...
| [CdsmInfo(CDSM Capability)](arkts-connectivity-cdsm-cdsminfo-i.md) | Represents the CDSM information. |
| [CdsmMemberInfo(CDSM Capability)](arkts-connectivity-cdsm-cdsmmemberinfo-i.md) | Represents the information about member devices in the coordinated devices set. |

### Enums

| Name | Description |
| --- | --- |
| [CdsmConnectionState(CDSM Capability)](arkts-connectivity-cdsm-cdsmconnectionstate-e.md) | Enumerates the connection states of member devices in a coordinated device set. |
