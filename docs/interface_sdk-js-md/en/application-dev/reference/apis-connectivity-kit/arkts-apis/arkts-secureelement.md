...
| [off_stateChanged](arkts-connectivity-omapi-offstatechanged-f.md#offstatechanged) | Disables listening for service status change events. |
| [on_stateChanged](arkts-connectivity-omapi-onstatechanged-f.md#onstatechanged) | Enables listening for service status change events.Call this API to register a callback after you use [omapi.newSEService](arkts-connectivity-omapi-newseservice-f.md#newseserviceservicestate) or [omapi.createService](arkts-connectivity-omapi-createservice-f.md) to create a service. |
