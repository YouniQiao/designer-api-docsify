...
Imports keys in secure mode. This API uses an asynchronous callback to return the result. &gt; **NOTE：**&gt; &gt; Importing SE security level wrapped keys defined in [HuksKeySecurityLevel](arkts-universalkeystore-huks-hukskeysecuritylevel-e.md) &gt; requires the ohos.permission.ACCESS_SE_KEY permission.
...
Imports keys in secure mode. This API uses a promise to return the result. &gt; **NOTE：**&gt; &gt; Importing SE security level wrapped keys defined in [HuksKeySecurityLevel](arkts-universalkeystore-huks-hukskeysecuritylevel-e.md) &gt; requires the ohos.permission.ACCESS_SE_KEY permission.
