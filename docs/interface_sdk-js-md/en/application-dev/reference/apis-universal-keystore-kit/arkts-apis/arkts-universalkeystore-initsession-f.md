...
> [HuksKeySecurityLevel](arkts-universalkeystore-hukskeysecuritylevel-e.md) requires the ohos.permission.ACCESS_SE_KEY permission.
...
| options | [HuksOptions](arkts-universalkeystore-huksoptions-i.md) | Yes | Parameter set used for the **initSession** operation. |
| callback | [AsyncCallback](../../apis-basic-service-kit/arkts-apis/arkts-basicservices-asynccallback-i.md)<HuksSessionHandle> | Yes | Callback used to return the result. If the operation is successful, **err** is **undefined**, and **data** is the obtained **HuksSessionHandle**. Otherwise, **err** is an error object. The handle of **HuksSessionHandle** is the handle generated by **initSession**. |
...
| Type | Description |
| --- | --- |
| [Promise](../../apis-na/arkts-apis/arkts-na-promise-i.md)<HuksSessionHandle> | Promise that returns **HuksSessionHandle**. The handle of **HuksSessionHandle** is the handle generated by **initSession**. |
