...
| [getProperty](arkts-universalkeystore-huksexternalcrypto-getproperty-f.md#getproperty) | Obtains a property value. This API uses a promise to return the result.  The **propertyId** indicates the ID of the property to be queried. Currently, only the SKF API names defined in GMT0016-2023 can be used as property IDs. The supported IDs are as follows:  - SKF\_\_\_ESCAPED\_UNDERSCORE\_\_\_EnumDev  - SKF\_\_\_ESCAPED\_UNDERSCORE\_\_\_GetDevInfo  - SKF\_\_\_ESCAPED\_UNDERSCORE\_\_\_EnumApplication  - SKF\_\_\_ESCAPED\_UNDERSCORE\_\_\_EnumContainer |
