...
| [getProperty(External Key Management)](arkts-universalkeystore-huksexternalcrypto-getproperty-f.md) | Obtains a property value. This API uses a promise to return the result. |
