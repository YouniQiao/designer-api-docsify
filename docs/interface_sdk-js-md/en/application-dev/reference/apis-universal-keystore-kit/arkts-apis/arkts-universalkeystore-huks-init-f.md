...
**Substitutes:** [initSession(keyAlias:](arkts-universalkeystore-huks-initsession-f.md#initsession)
...
| callback | [AsyncCallback](../../apis-basic-service-kit/arkts-apis/arkts-basicservices-base-asynccallback-i.md)&lt;HuksHandle&gt; | Yes | Callback used to return the result. If the operation is successful,**err** is **undefined**, and **data** is the obtained **HuksHandle**. Otherwise, **err** is an error object.The handle of the **HuksHandle** returns the handle generated by the initialization operation. |
...
| Type | Description |
| --- | --- |
| Promise&lt;HuksHandle&gt; | Promise that returns **HuksResult**. The handle of the **HuksHandle** returns the handle generated by the initialization operation. |
