...
| options | [HuksOptions](arkts-universalkeystore-huksoptions-i.md) | Yes | Parameter set used for the **init** operation. |
| callback | [AsyncCallback](../../apis-basic-service-kit/arkts-apis/arkts-basicservices-asynccallback-i.md)<HuksHandle> | Yes | Callback used to return the result. If the operation is successful,**err** is **undefined**, and **data** is the obtained **HuksHandle**. Otherwise, **err** is an error object.The handle of the **HuksHandle** returns the handle generated by the initialization operation. |
...
| Type | Description |
| --- | --- |
| [Promise](../../apis-na/arkts-apis/arkts-na-promise-i.md)<HuksHandle> | Promise that returns **HuksResult**. The handle of the **HuksHandle** returns the handle generated by the initialization operation. |
