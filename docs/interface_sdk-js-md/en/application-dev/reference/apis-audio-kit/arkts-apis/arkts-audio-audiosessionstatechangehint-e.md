...
The hint is obtained when an [AudioSessionStateChangedEvent](arkts-audio-audiosessionstatechangedevent-i.md) is received.
...
If [enableMuteSuggestionWhenMixWithOthers](arkts-audio-audiosessionmanager-i.md#enablemutesuggestionwhenmixwithothers-1)is enabled, you can choose to mute the audio.
...
If [enableMuteSuggestionWhenMixWithOthers](arkts-audio-audiosessionmanager-i.md#enablemutesuggestionwhenmixwithothers-1)is enabled, you can unmute the audio.
