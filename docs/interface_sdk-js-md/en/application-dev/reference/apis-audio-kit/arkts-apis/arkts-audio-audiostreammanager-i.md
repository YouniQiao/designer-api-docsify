...
Before calling any API in AudioStreamManager, you must use [getStreamManager](arkts-audio-audiomanager-i.md#getstreammanager-1) to obtain an AudioStreamManager instance.
...
| --- | --- | --- | --- |
| usage | [StreamUsage](arkts-audio-streamusage-e.md) | Yes | Audio stream usage. |
| callback | [AsyncCallback](../../apis-basic-service-kit/arkts-apis/arkts-basicservices-asynccallback-i.md)<AudioEffectInfoArray> | Yes | Callback used to return the result. If the operation is successful, **err** is **undefined** and **data** is the information about the audio effect mode obtained;otherwise, **err** is an error object. |
...
| Type | Description |
| --- | --- |
| [Promise](../../apis-na/arkts-apis/arkts-na-promise-i.md)<AudioEffectInfoArray> | Promise used to return the information about the audio effect mode obtained. |
...
| Type | Description |
| --- | --- |
| [AudioEffectInfoArray](arkts-audio-audioeffectinfoarray-t.md) | Information about the audio effect mode. |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| callback | [AsyncCallback](../../apis-basic-service-kit/arkts-apis/arkts-basicservices-asynccallback-i.md)<AudioCapturerChangeInfoArray> | Yes | Callback used to return the result. If the operation is successful, **err** is **undefined** and **data** is the audio capturer information obtained;otherwise, **err** is an error object. |
...
| Type | Description |
| --- | --- |
| [Promise](../../apis-na/arkts-apis/arkts-na-promise-i.md)<AudioCapturerChangeInfoArray> | Promise used to return the audio capturer information. |
...
| Type | Description |
| --- | --- |
| [AudioCapturerChangeInfoArray](arkts-audio-audiocapturerchangeinfoarray-t.md) | Audio capturer information. |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| callback | [AsyncCallback](../../apis-basic-service-kit/arkts-apis/arkts-basicservices-asynccallback-i.md)<AudioRendererChangeInfoArray> | Yes | Callback used to return the result. If the operation is successful, **err** is **undefined** and **data** is the audio renderer information obtained;otherwise, **err** is an error object. |
...
| Type | Description |
| --- | --- |
| [Promise](../../apis-na/arkts-apis/arkts-na-promise-i.md)<AudioRendererChangeInfoArray> | Promise used to return the audio renderer information. |
...
| Type | Description |
| --- | --- |
| [AudioRendererChangeInfoArray](arkts-audio-audiorendererchangeinfoarray-t.md) | Audio renderer information. |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| sourceType | [SourceType](../../apis-arkweb/arkts-apis/arkts-arkweb-sourcetype-e.md) | Yes | Audio source type. |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| volumeType | [AudioVolumeType](arkts-audio-audiovolumetype-e.md) | Yes | Audio stream types. |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| streamInfo | [AudioStreamInfo](arkts-audio-audiostreaminfo-i.md) | Yes | reference of stream info structure to describe basic audio format. |
| usage | [StreamUsage](arkts-audio-streamusage-e.md) | Yes | stream usage type used to decide the audio device and pipe type selection result. |
...
| --- | --- | --- | --- |
| streamInfo | [AudioStreamInfo](arkts-audio-audiostreaminfo-i.md) | Yes | reference of stream info structure to describe basic audio format. |
| source | [SourceType](../../apis-arkweb/arkts-apis/arkts-arkweb-sourcetype-e.md) | Yes | stream source type used to decide the audio device and pipe type selection result. |
