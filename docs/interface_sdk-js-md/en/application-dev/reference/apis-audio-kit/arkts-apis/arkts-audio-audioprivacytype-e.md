...
For example, if the privacy policy is **PRIVACY_TYPE_PUBLIC**, audio streams of the [STREAM_USAGE_VOICE_COMMUNICATION](arkts-audio-streamusage-e.md) type cannot be recorded or screen-projected by other applications.
