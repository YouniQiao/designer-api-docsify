...
The stream ID of the \_\_\_JSDOC\_LINK\_DESC\_USD\_0\_\_\_capture stream identified by uid. This stream is the injection target for the render stream.It is valid only when the target is non-PLAYBACK.
