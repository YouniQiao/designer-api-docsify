...
| Type | Description |
| --- | --- |
| [RenderTarget](arkts-audio-rendertarget-e-sys.md) | Render target of this audio renderer. |
...
| --- | --- | --- | --- |
| target | [RenderTarget](arkts-audio-rendertarget-e-sys.md) | Yes | Render target. |
