...
| [AudioDeviceDescriptors](arkts-audio-audiodevicedescriptors-t.md) | Defines an [AudioDeviceDescriptor](arkts-audio-audiodevicedescriptor-i.md#audiodevicedescriptor) array, which is read- only. |
