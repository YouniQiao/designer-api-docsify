...
- [@ohos.security.asset(Asset Store Service)](arkts-security-asset.md)
  - [add](arkts-assetstore-asset-add-f.md)
  <!--Del-->
  - [addAsUser(system api)](arkts-assetstore-asset-addasuser-f-sys.md)<!--DelEnd-->
  ...
  <!--Del-->
  - [postQueryAsUser(system api)](arkts-assetstore-asset-postqueryasuser-f-sys.md)<!--DelEnd-->
  - [postQuerySync](arkts-assetstore-asset-postquerysync-f.md)
  - [preQuery](arkts-assetstore-asset-prequery-f.md)
  <!--Del-->
  - [preQueryAsUser(system api)](arkts-assetstore-asset-prequeryasuser-f-sys.md)<!--DelEnd-->
  - [preQuerySync](arkts-assetstore-asset-prequerysync-f.md)
  - [query](arkts-assetstore-asset-query-f.md)
  <!--Del-->
  - [queryAsUser(system api)](arkts-assetstore-asset-queryasuser-f-sys.md)<!--DelEnd-->
  ...
  <!--Del-->
  - [removeAsUser(system api)](arkts-assetstore-asset-removeasuser-f-sys.md)<!--DelEnd-->
  - [removeSync](arkts-assetstore-asset-removesync-f.md)
  - [update](arkts-assetstore-asset-update-f.md)
  <!--Del-->
  - [updateAsUser(system api)](arkts-assetstore-asset-updateasuser-f-sys.md)<!--DelEnd-->
  ...
  <!--Del-->
  - [AuthType(system api)](arkts-assetstore-asset-authtype-e-sys.md)<!--DelEnd-->
