...
Queries one or more assets in the specified user space. If user authentication is required for the access to the asset, call [asset.preQueryAsUser]\_\_\_JSDOC\_LINK\_DESC\_USD\_1\_\_\_ before this API and call  
[asset.postQueryAsUser]\_\_\_JSDOC\_LINK\_DESC\_USD\_2\_\_\_ after this API. For details about the development procedure,see \_\_\_MD\_LINK\_DESC\_USD\_0\_\_\_.This API uses a promise to return the result.
...
| query | \_\_\_MD\_LINK\_USD\_0\_\_\_ | Yes | Conditions for querying the asset, such as the asset aliases, access control attributes, and custom data. |
