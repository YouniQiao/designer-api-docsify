...
> [generateDlpFileForEnterprise](arkts-dataprotection-generatedlpfileforenterprise-f-sys.md#generatedlpfileforenterprise-1). Enterprise DLP files  
...
| --- | --- | --- | --- |
| options | [DlpFileQueryOptions](arkts-dataprotection-dlpfilequeryoptions-i.md) | No | Query options about an enterprise DLP file. This parameter is required when specific enterprise DLP files are queried by classification label. It is optional when all enterprise DLP files are queried. If this parameter is not passed or an empty string is passed, all enterprise DLP files are queried. |

**Return value:**

| Type | Description |
| --- | --- |
| [Promise](../../apis-na/arkts-apis/arkts-na-promise-i.md)<Array<string>> | Promise used to return the URI list of the target enterprise DLP files that have been opened. |
