...
| --- | --- | --- | --- |
| context | common.UIAbilityContext | Yes | 当前窗口 [UIAbility](../../apis-ability-kit/arkts-apis/arkts-ability-app-ability-uiability-uiability-c.md/arkts-ability-app-ability-uiability-uiability-c.md) 上下文。 |
| want | [Want](../../apis-ability-kit/arkts-apis/arkts-ability-app-ability-want-want-c.md) | Yes | 请求对象，必须包含uri和displayName字段。 |
