...
| --- | --- | --- | --- |
| policy | \_\_\_MD\_LINK\_USD\_0\_\_\_ | Yes | Enterprise application protection policy to be set. Access control and behavior restrictions of enterprise DLP files are implemented based on the policy. |
