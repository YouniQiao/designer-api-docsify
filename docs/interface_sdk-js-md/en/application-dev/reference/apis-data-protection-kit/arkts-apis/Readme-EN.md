...
- [@ohos.dlpPermission(DLP)](arkts-dataprotection-dlppermission.md)
  ...
  <!--Del-->
  - [getDLPGatheringPolicy(system api)](arkts-dataprotection-dlppermission-getdlpgatheringpolicy-f-sys.md)<!--DelEnd-->
  ...
  <!--Del-->
  - [installDLPSandbox(system api)](arkts-dataprotection-dlppermission-installdlpsandbox-f-sys.md)<!--DelEnd-->
...
<!--Del-->
- [@ohos.dlpSetDlpFeature(DLP)](arkts-dataprotection-dlpsetdlpfeature.md)<!--DelEnd-->
  <!--Del-->
  - [setDlpFeature(system api)](arkts-dataprotection-dlpsetdlpfeature-setdlpfeature-f-sys.md)<!--DelEnd-->
  <!--Del-->
  - [DLPFeatureInfo(system api)](arkts-dataprotection-dlpsetdlpfeature-dlpfeatureinfo-i-sys.md)<!--DelEnd-->
  <!--Del-->
