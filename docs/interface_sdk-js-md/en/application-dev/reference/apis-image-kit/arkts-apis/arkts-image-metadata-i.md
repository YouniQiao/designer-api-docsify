...
| Type | Description |
| --- | --- |
| [Promise](../../apis-na/arkts-apis/arkts-na-promise-i.md)<Metadata> | Promise used to return the metadata instance. |
...
For details about how to query the property values, see [PropertyKey](arkts-image-propertykey-e.md),[FragmentMapPropertyKey](arkts-image-fragmentmappropertykey-e.md),[GifPropertyKey](arkts-image-gifpropertykey-e.md), and [HeifsPropertyKey](arkts-image-heifspropertykey-e.md).
...
| --- | --- | --- | --- |
| key | [Array](../../apis-na/arkts-apis/arkts-na-array-i.md)<string> | Yes | Names of the properties. |
...
| Type | Description |
| --- | --- |
| [Promise](../../apis-na/arkts-apis/arkts-na-promise-i.md)<void> | Promise that returns no value. If the operation fails, an error code is returned. |
