...
Before obtaining and using a specific auxiliary picture, call [getAuxiliaryPicture](arkts-image-picture-i.md#getauxiliarypicture-1) in Picture to obtain the auxiliary picture.
...
HDR synthesis usually involves using the SDR main image, gain map, and [HDR metadata](arkts-image-pixelmap-i.md#getmetadata-1) to calculate the luminance mapping.
