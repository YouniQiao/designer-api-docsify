...
| --- | --- | --- | --- |
| bufferInfo | [BinaryBufferInfo](arkts-image-binarybufferinfo-i.md) | Yes | image buffer info. |
| options | [PackingOptionsForTiff](arkts-image-packingoptionsfortiff-i.md) | No | Options for tiff image packing. |

**Return value:**

| Type | Description |
| --- | --- |
| [Promise](../../apis-na/arkts-apis/arkts-na-promise-i.md)<ArrayBuffer> | A Promise instance used to return the compressed or packed data. |
...
| Type | Description |
| --- | --- |
| [Promise](../../apis-na/arkts-apis/arkts-na-promise-i.md)<void> | A Promise instance used to return the operation result. |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| source | [ImageSource](arkts-image-imagesource-i.md) | Yes | Image source to compress or re-encode. |
| options | [PackingOption](arkts-image-packingoption-i.md) | Yes | Encoding parameters. |

**Return value:**

| Type | Description |
| --- | --- |
| [Promise](../../apis-na/arkts-apis/arkts-na-promise-i.md)<ArrayBuffer> | Promise used to return the compressed or encoded image data. |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| source | [PixelMap](arkts-image-pixelmap-i.md) | Yes | PixelMap to compress or re-encode. |
| options | [PackingOption](arkts-image-packingoption-i.md) | Yes | Encoding parameters. |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| pixelmapSequence | [Array](../../apis-na/arkts-apis/arkts-na-array-i.md)<PixelMap> | Yes | PixelMaps to encode. |
| options | [PackingOptionsForSequence](arkts-image-packingoptionsforsequence-i.md) | Yes | Options for encoding animated images. |

**Return value:**

| Type | Description |
| --- | --- |
| [Promise](../../apis-na/arkts-apis/arkts-na-promise-i.md)<ArrayBuffer> | Promise used to return the encoded data. |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| source | [ImageSource](arkts-image-imagesource-i.md) | Yes | Image source to encode. |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| source | [PixelMap](arkts-image-pixelmap-i.md) | Yes | PixelMap to encode. |
| fd | number | Yes | File descriptor. |
| options | [PackingOption](arkts-image-packingoption-i.md) | Yes | Encoding parameters. |
| callback | [AsyncCallback](../../apis-basic-service-kit/arkts-apis/arkts-basicservices-asynccallback-i.md)<void> | Yes | Callback used to return the result. If the operation is successful,**err** is **undefined**; otherwise, **err** is an error object. |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| picture | [Picture](arkts-image-picture-i.md) | Yes | Picture to encode. |
| fd | number | Yes | File descriptor. |
| options | [PackingOption](arkts-image-packingoption-i.md) | Yes | Encoding parameters. |
...
| Type | Description |
| --- | --- |
| [Promise](../../apis-na/arkts-apis/arkts-na-promise-i.md)<void> | that returns no value. |
...
**Substitutes:** [packToData](arkts-image-imagepacker-i.md#packtodata-1)
...
| --- | --- | --- | --- |
| source | [ImageSource](arkts-image-imagesource-i.md) | Yes | Image source to compress or re-encode. |
| option | [PackingOption](arkts-image-packingoption-i.md) | Yes | Encoding parameters. |
| callback | [AsyncCallback](../../apis-basic-service-kit/arkts-apis/arkts-basicservices-asynccallback-i.md)<ArrayBuffer> | Yes | Callback used to return the result. If the operation is successful, **err** is **undefined** and **data** is the compressed or encoded image data; otherwise, **err** is an error object. |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| picture | [Picture](arkts-image-picture-i.md) | Yes | Picture to compress or re-encode. |
| options | [PackingOption](arkts-image-packingoption-i.md) | Yes | Encoding parameters. |
