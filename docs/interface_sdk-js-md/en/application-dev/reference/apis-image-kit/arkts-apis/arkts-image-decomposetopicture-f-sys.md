...
| --- | --- | --- | --- |
| hdrPixelMap | [PixelMap](arkts-image-pixelmap-i.md) | Yes | An HDR PixelMap, whose PixelMapFormat should be RGBA_F16\RGBA_1010102\YCBCR_P010\YCRCB_P010. |
| options | [HdrDecomposeOptions](arkts-image-hdrdecomposeoptions-i-sys.md) | No | The HDR decomposition configurations. |

**Return value:**

| Type | Description |
| --- | --- |
| [Promise](../../apis-na/arkts-apis/arkts-na-promise-i.md)<Picture \| undefined> | Promise used to return the Picture object. |
