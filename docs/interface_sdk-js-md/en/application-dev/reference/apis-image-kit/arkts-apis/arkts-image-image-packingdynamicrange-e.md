...
Adaptive. The [pixelmap]\_\_\_JSDOC\_LINK\_DESC\_USD\_0\_\_\_ is encoded based on the format. If the PixelMap is in HDR format, it is encoded based on the HDR content; otherwise, it is encoded based on the SDR content.
