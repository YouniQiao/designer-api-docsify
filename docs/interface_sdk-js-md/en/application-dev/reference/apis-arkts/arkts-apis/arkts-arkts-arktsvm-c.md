...
| Type | Description |
| --- | --- |
| [Promise](../../apis-na/arkts-apis/arkts-na-promise-i.md)<HeapMemoryInfo[]> | Returns a promise containing all the heap memory information from ArkTS-VMs' local heap and the shared heap. |
...
| heapMemoryThreshold | [HeapMemoryThreshold](arkts-arkts-heapmemorythreshold-i.md) | Yes | Indicates the percentage threshold of the heap memory to trigger the callback after a GC. The value range is [70, 95]. |
...
| options | [MultithreadingDetectionOptions](arkts-arkts-multithreadingdetectionoptions-i.md) | No | Optional configuration items<br>**Since:** 26.0.0 |
