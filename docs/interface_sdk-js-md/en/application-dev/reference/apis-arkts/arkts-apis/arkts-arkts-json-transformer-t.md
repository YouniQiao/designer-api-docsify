...
When used as a parameter of [JSON.stringify](arkts-arkts-json-stringify-f.md), the function is used to transfer and handle each property during serialization.
