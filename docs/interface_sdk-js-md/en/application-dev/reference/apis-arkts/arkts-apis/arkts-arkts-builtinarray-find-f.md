...
| Type | Description |
| --- | --- |
| [Byte](arkts-arkts-byte-c.md) | The value of the first element that satisfies the provided testing function; otherwise, undefined. |
...
| Type | Description |
| --- | --- |
| [Short](arkts-arkts-short-c.md) | The value of the first element that satisfies the provided testing function; otherwise, undefined. |
...
| Type | Description |
| --- | --- |
| [Int](arkts-arkts-int-c.md) | The value of the first element that satisfies the provided testing function; otherwise, undefined. |
...
| Type | Description |
| --- | --- |
| [Long](arkts-arkts-long-c.md) | The value of the first element that satisfies the provided testing function; otherwise, undefined. |
...
| Type | Description |
| --- | --- |
| [Float](arkts-arkts-float-c.md) | The value of the first element that satisfies the provided testing function; otherwise, undefined. |
...
| Type | Description |
| --- | --- |
| [Double](arkts-arkts-double-c.md) | The value of the first element that satisfies the provided testing function; otherwise, undefined. |
...
| Type | Description |
| --- | --- |
| [Char](arkts-arkts-char-c.md) | The value of the first element that satisfies the provided testing function; otherwise, undefined. |
