...
```TypeScript
putAll(from: MapOrBuiltinMap<K, V>): void
```

Updates this ArkTS map with key-value pairs from the specified map.
...
<!--Device-Map-putAll(from: MapOrBuiltinMap<K, V>): void--><!--Device-Map-putAll(from: MapOrBuiltinMap<K, V>): void-End-->
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| from | [MapOrBuiltinMap](arkts-arkts-collections-maporbuiltinmap-t.md)&lt;K, V&gt; | Yes | Map that provides key-value pairs. |
