...
| --- | --- | --- | --- |
| index | number | Yes | 要返回的Array元素的索引（从零开始），取值为整数。&lt;br/&gt; 如果为负数，则从最后一个元素开始倒数。 |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| array | [ArrayLike](arkts-arkts-arraylike-i.md)&lt;number&gt; \| ArrayBuffer | Yes | 用于构造ArkTS Uint8ClampedArray的对象。当参数类型是ArrayBuffer时buffer所占的字节数须是4的整数倍。 |
...
| length | number | No | 指定ArkTS Uint8ClampedArray的长度，默认为0。 |
...
| end | number | No | 源终止位置下标（不包含end位置的元素），如果`end < 0`，则会从`end + Uint8ClampedArray.length`位置终止。默认为ArkTS Uint8ClampedArray的长度。 |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| predicate | [TypedArrayPredicateFn](arkts-arkts-collections-typedarraypredicatefn-t.md)&lt;number, Uint8ClampedArray&gt; | Yes | 用于测试的断言函数。 |
...
| start | number | No | 开始填充的索引，如果`start < 0`，则会从`start + Uint8ClampedArray.length`位置开始。默认值为0。 |
| end | number | No | 结束填充的索引（不包括该元素），如果`end < 0`，则会到`end + Uint8ClampedArray.length`位置结束。默认为ArkTS Uint8ClampedArray的长度。 |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| predicate | [TypedArrayPredicateFn](arkts-arkts-collections-typedarraypredicatefn-t.md)&lt;number, Uint8ClampedArray&gt; | Yes | 用于元素过滤的断言函数。 |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| predicate | [TypedArrayPredicateFn](arkts-arkts-collections-typedarraypredicatefn-t.md)&lt;number, Uint8ClampedArray&gt; | Yes | 用于元素查找的断言函数。 |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| callbackFn | [TypedArrayForEachCallback](arkts-arkts-collections-typedarrayforeachcallback-t.md)&lt;number, Uint8ClampedArray&gt; | Yes | 用于对每个元素执行的回调函数。 |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| arrayLike | [ArrayLike](arkts-arkts-arraylike-i.md)&lt;number&gt; | Yes | 用于构造ArkTS Uint8ClampedArray的ArrayLike对象。 |
...
| fromIndex | number | No | 开始搜索的索引，如果`fromIndex < 0`，则会从`fromIndex + Uint8ClampedArray.length`位置开始。默认值为0。 |
...
| fromIndex | number | No | 搜索的起始下标。默认值为0。如果下标大于等于ArkTS Uint8ClampedArray的长度，则返回-1。如果提供的下标值是负数，则被当做距离数组尾部的偏移，从前到后搜索。 |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| callbackFn | [TypedArrayMapCallback](arkts-arkts-collections-typedarraymapcallback-t.md)&lt;number, Uint8ClampedArray&gt; | Yes | 回调函数，接收至多三个参数。 map方法对数组中的每个元素调用一次callbackfn函数。 |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| callbackFn | [TypedArrayReduceCallback](arkts-arkts-collections-typedarrayreducecallback-t.md)&lt;number, number, Uint8ClampedArray&gt; | Yes | 归约函数，接收至多四个参数。 reduce方法对数组中的每个元素调用一次callbackfn函数。 |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| callbackFn | [TypedArrayReduceCallback](arkts-arkts-collections-typedarrayreducecallback-t.md)&lt;U, number, Uint8ClampedArray&gt; | Yes | 归约函数，接收至多四个参数。 reduce方法对数组中的每个元素调用一次callbackfn函数。 |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| callbackFn | [TypedArrayReduceCallback](arkts-arkts-collections-typedarrayreducecallback-t.md)&lt;U, number, Uint8ClampedArray&gt; | Yes | 对Uint8ClampedArray中的每个元素调用的函数。 |
| initialValue | U | Yes | 作为回调函数首次调用的第一个参数的值。 &lt;br&gt;如果未提供初始值，则使用Uint8ClampedArray的最后一个元素， &lt;br&gt;并且回调函数将从倒数第二个元素开始调用。 |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| callbackFn | [TypedArrayReduceCallback](arkts-arkts-collections-typedarrayreducecallback-t.md)&lt;number, number, Uint8ClampedArray&gt; | Yes | 对Uint8ClampedArray中的每个元素调用的函数。 |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| start | number | No | 开始索引，如果`start < 0`，则会从`start + Uint8ClampedArray.length`位置开始。默认值为0。 |
| end | number | No | 结束索引（不包括该元素），如果`end < 0`，则会到`end + Uint8ClampedArray.length`位置结束。默认为ArkTS Uint8ClampedArray的长度。 |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| begin | number | No | 开始索引，如果`begin < 0`，则会从`begin + Uint8ClampedArray.length`位置开始。默认值为0。 |
| end | number | No | 结束索引（不包括该元素），如果`end < 0`，则会到`end + Uint8ClampedArray.length`位置结束。默认为ArkTS Uint8ClampedArray的长度。 |
