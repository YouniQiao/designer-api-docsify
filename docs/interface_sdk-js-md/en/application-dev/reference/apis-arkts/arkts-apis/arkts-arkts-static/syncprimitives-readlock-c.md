...
**Inheritance/Implementation:** ReadLock implements [Lock](syncprimitives-lock-i.md)
...
| --- | --- | --- | --- |
| lock | \_\_\_MD\_LINK\_USD\_0\_\_\_ | Yes | the RWLock this ReadLock is associated with. |
