...
**Inheritance/Implementation:** WriteLock implements [Lock](syncprimitives-lock-i.md)
...
| --- | --- | --- | --- |
| lock | \_\_\_MD\_LINK\_USD\_0\_\_\_ | Yes | the RWLock this WriteLock is associated with. |
