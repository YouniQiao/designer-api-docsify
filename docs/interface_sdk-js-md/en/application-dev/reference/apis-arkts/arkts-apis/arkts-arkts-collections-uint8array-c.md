...
| --- | --- | --- | --- |
| index | number | Yes | The zero-based index of the desired code unit.A negative index will count back from the last item. |
...
A constructor used to create an empty ArkTS Uint8Array.
...
| Error Code ID | Error Message |
| --- | --- |
| [10200012](../errorcode-utils.md#10200012-constructor-calling-failure) | The Uint8Array's constructor cannot be directly invoked. |
...
A constructor used to create an ArkTS Uint8Array of a given length.
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| length | number | Yes | Length of the ArkTS Uint8Array. |
...
A constructor that creates an ArkTS Uint8Array from an iterable object.
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| elements | Iterable & lt;number & gt; | Yes | An iterable collection of numbers used to construct an ArkTS Uint8Array object. |
...
A constructor that creates an ArkTS Uint8Array from an array-like object or ArkTS ArrayBuffer.
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| array | ArrayLike & lt;number & gt; \ | ArrayBuffer | Yes | Object used to construct the ArkTS Uint8Array. When the parameter type is ArrayBuffer, the number of bytes occupied by the buffer must be an integer multiple of 1. |
...
A constructor that creates an ArkTS Uint8Array from an ArrayBuffer.
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| buffer | ArrayBuffer | Yes | ArrayBuffer object used to construct the ArkTS Uint8Array. The number of bytes occupied by the buffer must be an integer multiple of 1. |
| byteOffset | number | No | Byte offset of the buffer, beginning at 0. The default value is **0**. |
| length | number | No | Length of the ArkTS Uint8Array. The default value is **0**. |
...
Copies elements within a given range from this ArkTS Uint8Array to another position in sequence.
...
| start | number | Yes | Start index of the range. If a negative number is passed in, it refers to the index of `start + Uint8Array.length`. |
| end | number | No | End index of the range (exclusive). If a negative number is passed in, it refers to the index of `end + Uint8Array.length`. The default value is the length of the ArkTS Uint8Array. |

**Return value:**

| Type | Description |
| --- | --- |
| Uint8Array | ArkTS Uint8Array after being modified. |
...
Returns an iterator object that contains the key-value pair of each element in this ArkTS Uint8Array.
...
Checks whether all elements in this ArkTS Uint8Array meet a given condition.
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| predicate | [TypedArrayPredicateFn](arkts-arkts-collections-typedarraypredicatefn-t.md)&lt;number, Uint8Array&gt; | Yes | Assertion function used for the test. |
...
Fills all elements in a given range in this ArkTS Uint8Array with a value.
...
| start | number | No | Start index of the range. If a negative number is passed in, it refers to the index of `start + Uint8Array.length`. The default value is **0**. |
| end | number | No | End index of the range (exclusive). If a negative number is passed in, it refers to the index of `end + Uint8Array.length`. The default value is the length of the ArkTS Uint8Array. |
...
| Type | Description |
| --- | --- |
| Uint8Array | Filled ArkTS Uint8Array. |
...
Returns a new ArkTS Uint8Array that contains all elements that meet the given condition.
...
| Type | Description |
| --- | --- |
| Uint8Array | Filtered ArkTS Uint8Array. |
...
Calls a callback function for each element in this ArkTS Uint8Array.
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| callbackFn | [TypedArrayForEachCallback](arkts-arkts-collections-typedarrayforeachcallback-t.md)&lt;number, Uint8Array&gt; | Yes | Callback function to run for each element. |
...
Creates an ArkTS Uint8Array from an array-like or iterator object.
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| arrayLike | ArrayLike & lt;number & gt; | Yes | Array-like object used to construct the ArkTS Uint8Array. |

**Return value:**

| Type | Description |
| --- | --- |
| Uint8Array | New ArkTS Uint8Array generated. |
...
Creates an ArkTS Uint8Array from an array-like object.
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| arrayLike | ArrayLike & lt;T & gt; | Yes | An array-like object to convert to an Uint8Array. |
...
Creates an ArkTS Uint8Array from an iterator object.
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| arrayLike | Iterable & lt;number & gt; | Yes | An iterable object to convert to an Uint8Array. |
...
Checks whether elements are contained in this ArkTS Uint8Array.
...
Returns the index of the first occurrence of a value in this ArkTS Uint8Array. If the value is not found, **-1** is returned.
...
| fromIndex | number | No | Index from which the search starts. The default value is **0**. If the index is greater than or equal to the length of the ArkTS Uint8Array, **-1** is returned. If a negative number is passed in, the search starts from the end of the ArkTS Uint8Array. |
...
Concatenates all elements in this ArkTS Uint8Array into a string, with a given separator.
...
Returns an iterator object that contains the key (index) of each element in this ArkTS Uint8Array.
...
Obtains the index of the last occurrence of the specified value in this ArkTS Uint8Array.
...
| --- | --- | --- | --- |
| searchElement | number | Yes | Value to search for. |
| fromIndex | number | No | Index from which the search starts. The default value is the ArkTS Uint8Array length minus 1 (i.e., starting from the end). If the index is greater than or equal to the length of the ArkTS Uint8Array, **-1** is returned. If a negative number is passed in, the search starts from the end of the ArkTS Uint8Array. |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| callbackFn | [TypedArrayMapCallback](arkts-arkts-collections-typedarraymapcallback-t.md)&lt;number, Uint8Array&gt; | Yes | A function that accepts up to three arguments. The map method calls the callbackfn function one time for each element in the array. |

**Return value:**

| Type | Description |
| --- | --- |
| Uint8Array | New ArkTS Uint8Array. |
...
Creates an ArkTS Uint8Array with a variable number of parameters.
...
| Type | Description |
| --- | --- |
| Uint8Array | New ArkTS Uint8Array instance. Possible causes: 1. Mandatory parameters are left unspecified; |
...
Applies a reduce function on each element in this ArkTS Uint8Array and returns the final reduction result.
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| callbackFn | [TypedArrayReduceCallback](arkts-arkts-collections-typedarrayreducecallback-t.md)&lt;number, number, Uint8Array&gt; | Yes | A function that accepts up to four arguments. The reduce method calls the callbackfn function one time for each element in the array. |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| callbackFn | [TypedArrayReduceCallback](arkts-arkts-collections-typedarrayreducecallback-t.md)&lt;U, number, Uint8Array&gt; | Yes | Reduce function. |
...
| initialValue | U | Yes | A value to use as the first argument to the first call of the callback. If no initial value is provided, the last element of the Uint8Array will be used, and the callback will start with the second-to-last element. |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| callbackFn | [TypedArrayReduceCallback](arkts-arkts-collections-typedarrayreducecallback-t.md)&lt;number, number, Uint8Array&gt; | Yes | A function that is called for each element in the Uint8Array. |
...
Reverses this ArkTS Uint8Array.
...
| Type | Description |
| --- | --- |
| Uint8Array | Reversed ArkTS Uint8Array. |
...
Selects a range of elements in this ArkTS Uint8Array to create an ArkTS Uint8Array.
...
Checks whether any element in this ArkTS Uint8Array meets a given condition.
...
Sorts elements in this ArkTS Uint8Array and returns the sorted ArkTS Uint8Array.
...
| Type | Description |
| --- | --- |
| Uint8Array | Sorted ArkTS Uint8Array. |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| begin | number | No | Start index of the range. If a negative number is passed in, it refers to the index of `begin + Uint8Array.length`. The default value is **0**. |
| end | number | No | End index of the range (exclusive). If a negative number is passed in, it refers to the index of `end + Uint8Array.length`. The default value is the length of the ArkTS Uint8Array. |
...
Converts an ArkTS Uint8Array into a string.
...
Returns an iterator object that contains the value of each element in this ArkTS Uint8Array.
...
Bottom-layer buffer used by an ArkTS Uint8Array.
...
Number of bytes occupied by an ArkTS Uint8Array.
...
Offset between the ArkTS Uint8Array and the start position of the ArrayBuffer.
...
Number of bytes occupied by each element in the ArkTS Uint8Array.
...
Number of elements in an ArkTS Uint8Array.
