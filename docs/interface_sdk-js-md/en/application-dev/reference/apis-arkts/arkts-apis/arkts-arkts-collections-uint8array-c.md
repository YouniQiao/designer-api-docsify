...
| Error Code ID | Error Message |
| --- | --- |
| [10200012](../../../../../../../../gitee_tmp/docs/stamaster/en/application-dev/reference/apis-arkts/errorcode-utils.md#10200012-constructor-calling-failure) | The Uint8Array's constructor cannot be directly invoked. |
...
Returns the index of the first occurrence of a value in this ArkTS Uint8Array. If the value is not found,  
**-1** is returned.
...
Applies a callback function to each element in this ArkTS Uint8Array and uses the result to create an ArkTS Uint8Array.
