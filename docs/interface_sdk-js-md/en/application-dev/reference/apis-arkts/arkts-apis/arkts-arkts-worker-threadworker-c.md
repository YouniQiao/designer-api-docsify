...
| listener | \_\_\_MD\_LINK\_USD\_0\_\_\_ | Yes | Callback to invoke when an event of the specified type occurs. |
...
| options | \_\_\_MD\_LINK\_USD\_0\_\_\_ | No | Options that can be set for the Worker instance. |
