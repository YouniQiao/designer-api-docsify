...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| elements | Iterable & lt;number & gt; | Yes | An iterable collection of numbers used to construct an ArkTS Uint32Array object. |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| array | ArrayLike & lt;number & gt; \ | ArrayBuffer | Yes | Object used to construct the ArkTS Uint32Array. When the parameter type is ArrayBuffer, the number of bytes occupied by the buffer must be an integer multiple of 4. |
...
Returns an iterator object that contains the key-value pair of each element in this ArkTS Uint32Array.
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| arrayLike | ArrayLike & lt;number & gt; | Yes | Array-like object used to construct the ArkTS Uint32Array. |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| arrayLike | ArrayLike & lt;T & gt; | Yes | An array-like object to convert to an Uint32Array. |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| arrayLike | Iterable & lt;number & gt; | Yes | An iterable object to convert to an Uint32Array. |
...
Returns the index of the first occurrence of a value in this ArkTS Uint32Array. If the value is not found, **-1** is returned.
...
Concatenates all elements in this ArkTS Uint32Array into a string, with a given separator.
...
Returns an iterator object that contains the key (index) of each element in this ArkTS Uint32Array.
...
| --- | --- | --- | --- |
| searchElement | number | Yes | Value to search for. |
| fromIndex | number | No | Index from which the search starts. The default value is the ArkTS Uint32Array length minus 1 (i.e., starting from the end). If the index is greater than or equal to the length of the ArkTS Uint32Array, **-1** is returned. If a negative number is passed in, the search starts from the end of the ArkTS Uint32Array. |
...
| initialValue | U | Yes | A value to use as the first argument to the first call of the callback. If no initial value is provided, the last element of the Uint32Array will be used, and the callback will start with the second-to-last element. |
...
Returns an iterator object that contains the value of each element in this ArkTS Uint32Array.
...
Bottom-layer buffer used by an ArkTS Uint32Array.
...
Number of bytes occupied by an ArkTS Uint32Array.
...
Offset between the ArkTS Uint32Array and the start position of the ArrayBuffer.
...
Number of bytes occupied by each element in the ArkTS Uint32Array.
...
Number of elements in an ArkTS Uint32Array.
