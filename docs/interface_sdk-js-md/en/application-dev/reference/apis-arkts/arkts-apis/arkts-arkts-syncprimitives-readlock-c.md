...
**Inheritance/Implementation:** ReadLock implements [Lock](arkts-arkts-syncprimitives-lock-i.md#Lock)
...
| --- | --- | --- | --- |
| lock | [RWLock](arkts-arkts-syncprimitives-rwlock-c.md) | Yes | the RWLock this ReadLock is associated with. |
