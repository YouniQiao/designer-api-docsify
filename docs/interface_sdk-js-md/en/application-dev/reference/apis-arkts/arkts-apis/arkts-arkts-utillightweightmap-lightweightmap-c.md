...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| map | [LightWeightMap](arkts-arkts-utillightweightmap-lightweightmap-c.md)&lt;K, V&gt; | Yes | LightWeightMap** instance to be used for comparison. |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| map | [LightWeightMap](arkts-arkts-utillightweightmap-lightweightmap-c.md)&lt;K, V&gt; | Yes | LightWeightMap whose elements are to be added to the current LightWeightMap. |
