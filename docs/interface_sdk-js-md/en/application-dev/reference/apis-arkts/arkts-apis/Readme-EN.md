...
- [@arkts.collections(Defines the collections for ArkTS)](arkts-collections.md)
...
- [@arkts.math.Decimal(Defines the Decimal for ArkTS. Decimal support arbitrary precision decimal operation.)](arkts-math-decimal.md)
...
- [@arkts.utils(Defines the utils for ArkTS)](arkts-utils.md)
