...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| elements | [Iterable](../../apis-na/arkts-apis/arkts-na-iterable-i.md)<number> | Yes | An iterable collection of numbers used to construct an ArkTS Uint16Array object. |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| array | [ArrayLike](../../apis-na/arkts-apis/arkts-na-arraylike-i.md)<number> \| ArrayBuffer | Yes | Object used to construct the ArkTS Uint16Array. When the parameter type is ArrayBuffer, the number of bytes occupied by the buffer must be an integer multiple of 4. |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| buffer | [ArrayBuffer](arkts-arkts-arraybuffer-c.md) | Yes | ArrayBuffer object used to construct the ArkTS Uint16Array. The number of bytes occupied by the buffer must be an integer multiple of 4. |
...
| Type | Description |
| --- | --- |
| [Uint16Array](../../apis-na/arkts-apis/arkts-na-uint16array-i.md) | ArkTS Uint16Array after being modified. |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| predicate | [TypedArrayPredicateFn](arkts-arkts-typedarraypredicatefn-t.md)<number, Uint16Array> | Yes | Assertion function used for the test. |
...
| Type | Description |
| --- | --- |
| [Uint16Array](../../apis-na/arkts-apis/arkts-na-uint16array-i.md) | Filled ArkTS Uint16Array. |
...
| Type | Description |
| --- | --- |
| [Uint16Array](../../apis-na/arkts-apis/arkts-na-uint16array-i.md) | Filtered ArkTS Uint16Array. |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| callbackFn | [TypedArrayForEachCallback](arkts-arkts-typedarrayforeachcallback-t.md)<number, Uint16Array> | Yes | Callback function to run for each element. |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| arrayLike | [ArrayLike](../../apis-na/arkts-apis/arkts-na-arraylike-i.md)<number> | Yes | Array-like object used to construct the ArkTS Uint16Array. |

**Return value:**

| Type | Description |
| --- | --- |
| [Uint16Array](../../apis-na/arkts-apis/arkts-na-uint16array-i.md) | New ArkTS Uint16Array generated. |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| arrayLike | [ArrayLike](../../apis-na/arkts-apis/arkts-na-arraylike-i.md)<T> | Yes | An array-like object to convert to an Uint16Array. |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| arrayLike | [Iterable](../../apis-na/arkts-apis/arkts-na-iterable-i.md)<number> | Yes | An iterable object to convert to an Uint16Array. |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| callbackFn | [TypedArrayMapCallback](arkts-arkts-typedarraymapcallback-t.md)<number, Uint16Array> | Yes | A function that accepts up to three arguments. The map method calls the callbackfn function one time for each element in the array. |

**Return value:**

| Type | Description |
| --- | --- |
| [Uint16Array](../../apis-na/arkts-apis/arkts-na-uint16array-i.md) | New ArkTS Uint16Array. |
...
| Type | Description |
| --- | --- |
| [Uint16Array](../../apis-na/arkts-apis/arkts-na-uint16array-i.md) | New ArkTS Uint16Array instance. Possible causes: 1. Mandatory parameters are left unspecified;<br>2. Incorrect parameter types; 3. Parameter verification failed. |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| callbackFn | [TypedArrayReduceCallback](arkts-arkts-typedarrayreducecallback-t.md)<number, number, Uint16Array> | Yes | A function that accepts up to four arguments.The reduce method calls the callbackfn function one time for each element in the array. |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| callbackFn | [TypedArrayReduceCallback](arkts-arkts-typedarrayreducecallback-t.md)<U, number, Uint16Array> | Yes | Reduce function. |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| callbackFn | [TypedArrayReduceCallback](arkts-arkts-typedarrayreducecallback-t.md)<U, number, Uint16Array> | Yes | A function that is called for each element in the Uint16Array. |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| callbackFn | [TypedArrayReduceCallback](arkts-arkts-typedarrayreducecallback-t.md)<number, number, Uint16Array> | Yes | A function that is called for each element in the Uint16Array. |
...
| Type | Description |
| --- | --- |
| [Uint16Array](../../apis-na/arkts-apis/arkts-na-uint16array-i.md) | Reversed ArkTS Uint16Array. |
...
| Type | Description |
| --- | --- |
| [Uint16Array](../../apis-na/arkts-apis/arkts-na-uint16array-i.md) | Sorted ArkTS Uint16Array. |
