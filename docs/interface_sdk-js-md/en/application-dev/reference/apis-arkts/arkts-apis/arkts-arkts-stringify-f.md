...
| --- | --- | --- | --- |
| value | [Object](../../apis-na/arkts-apis/arkts-na-object-i.md) | Yes | ArkTS object or array. In the case of a container, linear containers are supported, but non-linear containers are not. |
...
| --- | --- | --- | --- |
| value | [Object](../../apis-na/arkts-apis/arkts-na-object-i.md) | Yes | ArkTS object or array. In the case of a container, linear containers are supported, but non-linear containers are not. |
| replacer | [Transformer](arkts-arkts-transformer-t.md) | No | During serialization, each key of the serialized value is converted and processed by this function. The default value is undefined. |
