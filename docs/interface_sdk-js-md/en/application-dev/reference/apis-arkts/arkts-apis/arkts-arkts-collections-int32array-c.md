...
| Type | Description |
| --- | --- |
| [IterableIterator](arkts-arkts-iterator-iterableiterator-i.md)&lt;number&gt; | 迭代number的迭代器对象。 |
...
| --- | --- | --- | --- |
| index | number | Yes | 要返回的元素的索引（从零开始）。&lt;br/&gt;如果传入负数，则从末尾倒数访问。 |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| length | number | Yes | 用于指定ArkTS Int32Array的长度。 |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| elements | Iterable&lt;number&gt; | Yes | 可迭代数字集合，用于构造ArkTS Int32Array对象。 |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| array | [ArrayLike](arkts-arkts-arraylike-i.md)&lt;number&gt; \| ArrayBuffer | Yes | 用于构造ArkTS Int32Array的对象。当参数类型是ArrayBuffer时， buffer所占的字节数须是4的整数倍。 |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| buffer | ArrayBuffer | Yes | 用于构造ArkTS Int32Array的ArrayBuffer对象。buffer所占的字节数须是4的整数倍。 |
| byteOffset | number | No | 指定buffer的字节偏移，从0开始。默认值为**0**。 |
| length | number | No | 指定ArkTS Int32Array的长度。默认值为**0**。 |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| target | number | Yes | 目标起始位置的下标。如果传入负数，则表示`target + array.length`位置的下标。 |
| start | number | Yes | 源起始位置的下标。如果传入负数，则表示`start + Int32Array.length`位置的下标。 |
| end | number | No | 源终止位置的下标（不包含end位置的元素）。如果传入负数，则表示`end + Int32Array.length` 位置的下标。默认值为ArkTS Int32Array的长度。 |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| predicate | [TypedArrayPredicateFn](arkts-arkts-collections-typedarraypredicatefn-t.md)&lt;number, Int32Array&gt; | Yes | 用于测试的断言函数。 |
...
| start | number | No | 开始填充的索引。如果传入负数，则表示`start + Int32Array.length`位置的索引。默认值为**0**。 |
| end | number | No | 结束填充的索引（不包括该元素）。如果传入负数，则表示`end + Int32Array.length` 位置的索引。默认值为ArkTS Int32Array的长度。 |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| predicate | [TypedArrayPredicateFn](arkts-arkts-collections-typedarraypredicatefn-t.md)&lt;number, Int32Array&gt; | Yes | 用于元素过滤的断言函数。 |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| predicate | [TypedArrayPredicateFn](arkts-arkts-collections-typedarraypredicatefn-t.md)&lt;number, Int32Array&gt; | Yes | 用于元素查找的断言函数。 |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| callbackFn | [TypedArrayForEachCallback](arkts-arkts-collections-typedarrayforeachcallback-t.md)&lt;number, Int32Array&gt; | Yes | 用于对每个元素执行的回调函数。 |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| arrayLike | [ArrayLike](arkts-arkts-arraylike-i.md)&lt;number&gt; | Yes | 用于构造ArkTS Int32Array的ArrayLike对象。 |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| arrayLike | [ArrayLike](arkts-arkts-arraylike-i.md)&lt;T&gt; | Yes | 用于构造Int32Array的ArrayLike对象。 |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| arrayLike | Iterable&lt;number&gt; | Yes | 用于构造Int32Array的可迭代对象。 |
| mapFn | [TypedArrayFromMapFn](arkts-arkts-collections-typedarrayfrommapfn-t.md)&lt;number, number&gt; | No | 映射函数，用于对每个元素进行处理。如果省略，则不对元素进行加工处理。 |
...
| fromIndex | number | No | 搜索的起始下标。默认值为**0**。如果下标大于等于ArkTS Float32Array的长度， 则返回**-1**。如果传入负数，则从ArkTS Float32Array末尾开始搜索。 |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| separator | string | No | 分隔字符串。如果省略，则使用逗号（,）作为分隔符。 |
...
| --- | --- | --- | --- |
| searchElement | number | Yes | 待索引的值。 |
| fromIndex | number | No | 搜索的起始下标。默认值为**0**。如果下标大于等于ArkTS Int32Array的长度， 则返回**-1**。如果传入负数，则从ArkTS Int32Array末尾开始搜索。 |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| callbackFn | [TypedArrayMapCallback](arkts-arkts-collections-typedarraymapcallback-t.md)&lt;number, Int32Array&gt; | Yes | 一个最多接受三个参数的函数。 map方法对数组中的每个元素调用一次callbackfn函数。 |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| callbackFn | [TypedArrayReduceCallback](arkts-arkts-collections-typedarrayreducecallback-t.md)&lt;number, number, Int32Array&gt; | Yes | 一个最多接受四个参数的函数。 reduce方法对数组中的每个元素调用一次callbackfn函数。 |
...
| --- | --- | --- | --- |
| callbackFn | [TypedArrayReduceCallback](arkts-arkts-collections-typedarrayreducecallback-t.md)&lt;number, number, Int32Array&gt; | Yes | 一个最多接受四个参数的函数。 reduce方法对数组中的每个元素调用一次callbackfn函数。 |
| initialValue | number | Yes | 如果指定了initialValue，则将其作为开始累加的初始值。 首次调用callbackfn函数时以此值作为参数，而不是使用数组元素值。 |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| callbackFn | [TypedArrayReduceCallback](arkts-arkts-collections-typedarrayreducecallback-t.md)&lt;U, number, Int32Array&gt; | Yes | 归约函数。 |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| callbackFn | [TypedArrayReduceCallback](arkts-arkts-collections-typedarrayreducecallback-t.md)&lt;U, number, Int32Array&gt; | Yes | 对Int32Array中每个元素调用的函数。 |
| initialValue | U | Yes | 作为回调函数首次调用的第一个参数的初始值。 &lt;br&gt;如果未提供初始值，则使用Int32Array的最后一个元素作为初始值， &lt;br&gt;并且回调从倒数第二个元素开始执行。 |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| callbackFn | [TypedArrayReduceCallback](arkts-arkts-collections-typedarrayreducecallback-t.md)&lt;number, number, Int32Array&gt; | Yes | 对Int32Array中每个元素调用的函数。 |
...
| offset | number | No | 当前数组中开始写入值的位置索引。 |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| start | number | No | 开始索引。如果传入负数，则表示`start + Int32Array.length`位置的索引。默认值为**0**。 |
| end | number | No | 结束索引（不包括该元素）。如果传入负数，则表示`end + Int32Array.length`位置 的索引。默认值为ArkTS Int32Array的长度。 |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| begin | number | No | 开始索引。如果传入负数，则表示`begin + Int32Array.length`位置的索引。默认值为**0**。 |
| end | number | No | 结束索引（不包括该元素）。如果传入负数，则表示`end + Int32Array.length`位置 的索引。默认值为ArkTS Int32Array的长度。 |
