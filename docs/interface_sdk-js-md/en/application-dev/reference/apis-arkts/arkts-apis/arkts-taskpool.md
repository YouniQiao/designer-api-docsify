...
| [GenericsTask](arkts-arkts-taskpool-genericstask-c.md) | Implements a generic task. **GenericsTask** inherits from [Task](arkts-arkts-taskpool-execute-f.md). During the creation of a generic task, the passed-in parameter types and return value types of concurrent functions are verified in the compilation phase. Other behaviors are the same as those during the creation of a task. |
