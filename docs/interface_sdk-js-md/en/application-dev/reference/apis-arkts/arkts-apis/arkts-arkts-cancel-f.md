...
| --- | --- | --- | --- |
| task | [Task](../../apis-basic-service-kit/arkts-apis/arkts-basicservices-task-i.md) | Yes | Task to cancel. |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| group | [TaskGroup](arkts-arkts-taskgroup-c.md) | Yes | Task group to cancel. |
