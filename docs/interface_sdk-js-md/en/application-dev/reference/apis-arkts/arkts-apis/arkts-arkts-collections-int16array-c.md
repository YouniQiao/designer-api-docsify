...
| Type | Description |
| --- | --- |
| [IterableIterator](arkts-arkts-iterator-iterableiterator-i.md)&lt;number&gt; | 返回一个迭代器。 |
...
| --- | --- | --- | --- |
| index | number | Yes | 要返回的元素的索引（从零开始），取值为整数。 如果`index < 0`，则会访问`index + Int16Array.length`位置的元素。 |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| length | number | Yes | 用于指定ArkTS Int16Array的长度。 |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| elements | Iterable&lt;number&gt; | Yes | 可迭代数字集合，用于构造ArkTS Int16Array 对象。 |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| array | [ArrayLike](arkts-arkts-arraylike-i.md)&lt;number&gt; \| ArrayBuffer | Yes | 用于构造ArkTS Int16Array的对象。当参数类型是ArrayBuffer时， buffer所占的字节数须是4的整数倍。 |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| buffer | ArrayBuffer | Yes | 用于构造ArkTS Int16Array的ArrayBuffer对象。buffer所占的字节数须是 4的整数倍。 |
| byteOffset | number | No | 指定buffer的字节偏移，从0开始，默认为**0**。 |
| length | number | No | 指定ArkTS Int16Array的长度，默认为**0**。 |
...
| start | number | Yes | 源起始位置下标，如果`start < 0`，则会从`start + Int16Array.length`位置开始。 |
| end | number | No | 源终止位置下标（不包含end位置的元素），如果`end < 0`，则会从`end + Int16Array.length`位置终止。 默认为ArkTS Int16Array的长度。 |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| predicate | [TypedArrayPredicateFn](arkts-arkts-collections-typedarraypredicatefn-t.md)&lt;number, Int16Array&gt; | Yes | 用于测试的断言函数。 |
...
| start | number | No | 开始填充的索引，如果`start < 0`，则会从`start + Int16Array.length`位置开始。 默认值为**0**。 |
| end | number | No | 结束填充的索引（不包括该元素），如果`end < 0`，则会到`end + Int16Array.length`位置结束。 默认为ArkTS Int16Array的长度。 |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| predicate | [TypedArrayPredicateFn](arkts-arkts-collections-typedarraypredicatefn-t.md)&lt;number, Int16Array&gt; | Yes | 用于元素过滤的断言函数。 |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| predicate | [TypedArrayPredicateFn](arkts-arkts-collections-typedarraypredicatefn-t.md)&lt;number, Int16Array&gt; | Yes | 用于元素查找的断言函数。 |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| callbackFn | [TypedArrayForEachCallback](arkts-arkts-collections-typedarrayforeachcallback-t.md)&lt;number, Int16Array&gt; | Yes | 用于对每个元素执行的回调函数。 |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| arrayLike | [ArrayLike](arkts-arkts-arraylike-i.md)&lt;number&gt; | Yes | 用于构造ArkTS Int16Array的ArrayLike对象。 |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| arrayLike | [ArrayLike](arkts-arkts-arraylike-i.md)&lt;T&gt; | Yes | 用于构造ArkTS Int16Array的ArrayLike对象。 |
...
| fromIndex | number | No | 开始搜索的索引，如果`fromIndex < 0`，则会从`fromIndex + Int16Array.length`位置开始。 默认值为0。 |
...
| fromIndex | number | No | 搜索的起始下标。默认值为**0**。如果下标大于等于ArkTS Int16Array的长度， 则返回**-1**。如果提供的下标值是负数，则被当做距离数组尾部的偏移，从前到后搜索。 |
...
| --- | --- | --- | --- |
| searchElement | number | Yes | 待索引的值。 |
| fromIndex | number | No | 搜索的起始下标。默认值为**0**。如果下标大于等于ArkTS Int16Array的长度， 则返回**-1**。如果提供的下标值是负数，则被当做距离数组尾部的偏移，从后到前搜索。 |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| callbackFn | [TypedArrayMapCallback](arkts-arkts-collections-typedarraymapcallback-t.md)&lt;number, Int16Array&gt; | Yes | 回调函数。 map方法对数组中的每个元素调用一次callbackfn函数。 |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| callbackFn | [TypedArrayReduceCallback](arkts-arkts-collections-typedarrayreducecallback-t.md)&lt;number, number, Int16Array&gt; | Yes | 归约函数。 reduce方法对数组中的每个元素调用一次callbackfn函数。 |
...
| --- | --- | --- | --- |
| callbackFn | [TypedArrayReduceCallback](arkts-arkts-collections-typedarrayreducecallback-t.md)&lt;number, number, Int16Array&gt; | Yes | 归约函数。 reduce方法对数组中的每个元素调用一次callbackfn函数。 |
| initialValue | number | Yes | 如果指定了initialValue，则将其作为开始累加的初始值。 首次调用callbackfn函数时将此值作为参数传入，而不是使用数组元素。 |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| callbackFn | [TypedArrayReduceCallback](arkts-arkts-collections-typedarrayreducecallback-t.md)&lt;U, number, Int16Array&gt; | Yes | 归约函数。 |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| callbackFn | [TypedArrayReduceCallback](arkts-arkts-collections-typedarrayreducecallback-t.md)&lt;U, number, Int16Array&gt; | Yes | 对Int16Array中的 每个元素调用的函数。 |
| initialValue | U | Yes | 作为首次调用回调函数的第一个参数使用的值。 &lt;br&gt;如果未提供初始值，则使用Int16Array的最后一个元素作为初始值， &lt;br&gt;回调将从倒数第二个元素开始执行。 |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| callbackFn | [TypedArrayReduceCallback](arkts-arkts-collections-typedarrayreducecallback-t.md)&lt;number, number, Int16Array&gt; | Yes | 对Int16Array中的 每个元素调用的函数。 |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| start | number | No | 开始索引，如果`start < 0`，则会从`start + Int16Array.length`位置开始。 默认值为**0**。 |
| end | number | No | 结束索引（不包括该元素），如果`end < 0`，则会到`end + Int16Array.length`位置结束。 默认为ArkTS Int16Array的长度。 |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| begin | number | No | 开始索引，如果`begin < 0`，则会从`begin + Int16Array.length`位置开始。 默认值为**0**。 |
| end | number | No | 结束索引（不包括该元素），如果`end < 0`，则会到`end + Int16Array.length`位置结束。 默认为ArkTS Int16Array的长度。 |
