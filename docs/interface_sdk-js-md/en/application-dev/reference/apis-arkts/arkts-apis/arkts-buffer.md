...
| [from](arkts-arkts-buffer-from-f.md#from-2) | Copies the data of a passed **Buffer** object to create a new **Buffer** object and returns the new one.Creates a **Buffer** object based on the memory of a passed **Uint8Array** object and returns the new object,maintaining the memory association of the data. |
| [from](arkts-arkts-buffer-from-f.md#from-3) | Creates a **Buffer** object based on the specified object. |
| [from](arkts-arkts-buffer-from-f.md#from-4) | Creates a **Buffer** object based on a string in the given encoding format. |
