...
| callback | [AsyncCallback](../../apis-basic-services-kit/arkts-apis/arkts-basicservices-base-asynccallback-i.md)&lt;Array&lt;[GeoAddress](arkts-location-geolocation-geoaddress-i.md)&gt;&gt; | 是 | 回调函数，返回逆地理编码结果。 |
...
| 类型 | 说明 |
| --- | --- |
| Promise&lt;Array&lt;[GeoAddress](arkts-location-geolocation-geoaddress-i.md)&gt;&gt; | Promise对象，返回地理描述信息。 |
