...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| fenceRequestParams | [FusionFenceRequestParams](arkts-location-geolocationmanager-fusionfencerequestparams-i-sys.md) | 是 | Indicates the fusion fence request parameters. |
