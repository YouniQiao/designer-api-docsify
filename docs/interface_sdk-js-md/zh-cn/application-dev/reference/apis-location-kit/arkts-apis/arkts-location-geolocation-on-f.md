...
| request | [LocationRequest](arkts-location-geolocationmanager-locationrequest-i.md) | 是 | Indicates the location request parameters. |
...
| callback | [Callback](../../apis-basic-service-kit/arkts-apis/arkts-basicservices-base-callback-i.md)&lt;boolean&gt; | 是 | Indicates the callback for reporting the location result. |
...
| callback | [Callback](../../apis-basic-service-kit/arkts-apis/arkts-basicservices-base-callback-i.md)&lt;SatelliteStatusInfo&gt; | 是 | Indicates the callback for reporting the gnss status change. |
