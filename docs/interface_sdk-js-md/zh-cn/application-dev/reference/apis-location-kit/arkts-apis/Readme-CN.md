...
- [@ohos.geoLocationManager](arkts-geolocationmanager.md)
  ...
  <!--Del-->
  - [offLocatingRequiredDataChange(系统接口)](arkts-location-geolocationmanager-offlocatingrequireddatachange-f-sys.md)<!--DelEnd-->
  ...
  <!--Del-->
  - [offLocationIconStatusChange(系统接口)](arkts-location-geolocationmanager-offlocationiconstatuschange-f-sys.md)<!--DelEnd-->
  ...
  <!--Del-->
  - [onLocatingRequiredDataChange(系统接口)](arkts-location-geolocationmanager-onlocatingrequireddatachange-f-sys.md)<!--DelEnd-->
  ...
  <!--Del-->
  - [onLocationIconStatusChange(系统接口)](arkts-location-geolocationmanager-onlocationiconstatuschange-f-sys.md)<!--DelEnd-->
