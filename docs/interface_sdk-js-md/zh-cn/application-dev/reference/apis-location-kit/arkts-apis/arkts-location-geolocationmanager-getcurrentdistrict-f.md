...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| params | [DistrictRequestParams](arkts-location-geolocationmanager-districtrequestparams-i.md) | 否 | Indicates request parameters for obtaining the district information. |
