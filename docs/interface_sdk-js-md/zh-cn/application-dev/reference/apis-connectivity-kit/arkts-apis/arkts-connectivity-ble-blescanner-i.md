...
| callback | [Callback](../../apis-basic-service-kit/arkts-apis/arkts-basicservices-base-callback-i.md)&lt;ScanReport&gt; | 否 | Callback used to listen for the scan result event. |
...
| --- | --- | --- | --- |
| type | 'BLEDeviceFind' | 是 | Type of the scan result event to listen for. |
| callback | [Callback](../../apis-basic-service-kit/arkts-apis/arkts-basicservices-base-callback-i.md)&lt;ScanReport&gt; | 是 | Callback used to listen for the scan result event. |
