...
| autoConnect | boolean | 否 | Indicates whether to automatically connect to the remote device. If {@code true}, it will automatically connect when the remote device is available, default is {@code false}. |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| serviceUuid | string | 是 | Indicates the UUID of the service. |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| type | 'connectionStateChange' | 是 | Type of the connection state changed event to listen for. |
