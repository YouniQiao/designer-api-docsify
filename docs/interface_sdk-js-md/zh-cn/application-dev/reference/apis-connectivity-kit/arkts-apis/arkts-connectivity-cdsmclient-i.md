...
| 类型 | 说明 |
| --- | --- |
| [CdsmInfo](arkts-connectivity-cdsminfo-i.md) | 返回合作设备集信息。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | [Callback](../../apis-basic-service-kit/arkts-apis/arkts-basicservices-callback-i.md)<CdsmInfo> | 否 | 用于监听合作设备集信息的回调。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | [Callback](../../apis-basic-service-kit/arkts-apis/arkts-basicservices-callback-i.md)<CdsmInfo> | 是 | 用于监听合作设备集信息的回调。 |
