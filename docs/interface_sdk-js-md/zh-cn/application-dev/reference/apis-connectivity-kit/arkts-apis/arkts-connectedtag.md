...
| [off_notify](arkts-connectivity-connectedtag-offnotify-f.md#offnotify) | 取消NFC场强状态事件的注册。 |
| [on_notify](arkts-connectivity-connectedtag-onnotify-f.md#onnotify) | 注册NFC场强状态事件。 |
