...
**替代接口：** ohos.bluetoothManager/bluetoothManager.ServerResponse
...
**替代接口：** ohos.bluetoothManager/bluetoothManager.ServerResponse.deviceId
...
**替代接口：** ohos.bluetoothManager/bluetoothManager.ServerResponse.offset
...
**替代接口：** ohos.bluetoothManager/bluetoothManager.ServerResponse.status
...
**替代接口：** ohos.bluetoothManager/bluetoothManager.ServerResponse.transId
...
**替代接口：** ohos.bluetoothManager/bluetoothManager.ServerResponse.value
