...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| advertisingId | ArkTS-Dyn: number  <br>ArkTS-Sta：int | 是 | 表示广播ID &lt;br&gt;取值应为≥0的整数，取值为当前广播的广播ID。 |
...
| [36100040](../../../../../../../../gitee_tmp/docs/stamaster/zh-cn/application-dev/reference/apis-connectivity-kit/errorcode-nearlink-service.md#36100040-整数超出范围) | Invalid advertising ID. |
