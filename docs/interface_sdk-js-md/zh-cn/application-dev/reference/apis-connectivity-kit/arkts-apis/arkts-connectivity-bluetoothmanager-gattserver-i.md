...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| service | [GattService](arkts-connectivity-bluetooth-gattservice-i.md) | 是 | Indicates the service to add. |
...
| notifyCharacteristic | [NotifyCharacteristic](arkts-connectivity-bluetoothmanager-notifycharacteristic-i.md) | 是 | Indicates the local characteristic that has changed. |
...
| callback | [Callback](../../apis-basic-service-kit/arkts-apis/arkts-basicservices-base-callback-i.md)&lt;CharacteristicReadRequest&gt; | 否 | Callback used to listen for the characteristic read event. |
...
| callback | [Callback](../../apis-basic-service-kit/arkts-apis/arkts-basicservices-base-callback-i.md)&lt;CharacteristicWriteRequest&gt; | 否 | Callback used to listen for the characteristic write event. |
...
| callback | [Callback](../../apis-basic-service-kit/arkts-apis/arkts-basicservices-base-callback-i.md)&lt;DescriptorReadRequest&gt; | 否 | Callback used to listen for the descriptor read event. |
...
| callback | [Callback](../../apis-basic-service-kit/arkts-apis/arkts-basicservices-base-callback-i.md)&lt;DescriptorWriteRequest&gt; | 否 | Callback used to listen for the descriptor write event. |
...
| callback | [Callback](../../apis-basic-service-kit/arkts-apis/arkts-basicservices-base-callback-i.md)&lt;BLEConnectChangedState&gt; | 否 | Callback used to listen for the connection state changed event. |
...
| --- | --- | --- | --- |
| type | 'characteristicRead' | 是 | Type of the characteristic read event to listen for. |
| callback | [Callback](../../apis-basic-service-kit/arkts-apis/arkts-basicservices-base-callback-i.md)&lt;CharacteristicReadRequest&gt; | 是 | Callback used to listen for the characteristic read event. |
...
| --- | --- | --- | --- |
| type | 'characteristicWrite' | 是 | Type of the characteristic write event to listen for. |
| callback | [Callback](../../apis-basic-service-kit/arkts-apis/arkts-basicservices-base-callback-i.md)&lt;CharacteristicWriteRequest&gt; | 是 | Callback used to listen for the characteristic write event. |
...
| --- | --- | --- | --- |
| type | 'descriptorRead' | 是 | Type of the descriptor read event to listen for. |
| callback | [Callback](../../apis-basic-service-kit/arkts-apis/arkts-basicservices-base-callback-i.md)&lt;DescriptorReadRequest&gt; | 是 | Callback used to listen for the descriptor read event. |
...
| --- | --- | --- | --- |
| type | 'descriptorWrite' | 是 | Type of the descriptor write event to listen for. |
| callback | [Callback](../../apis-basic-service-kit/arkts-apis/arkts-basicservices-base-callback-i.md)&lt;DescriptorWriteRequest&gt; | 是 | Callback used to listen for the descriptor write event. |
...
| --- | --- | --- | --- |
| type | 'connectStateChange' | 是 | Type of the connection state changed event to listen for. |
| callback | [Callback](../../apis-basic-service-kit/arkts-apis/arkts-basicservices-base-callback-i.md)&lt;BLEConnectChangedState&gt; | 是 | Callback used to listen for the connection state changed event. |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| serverResponse | [ServerResponse](arkts-connectivity-bluetoothmanager-serverresponse-i.md) | 是 | Indicates the response parameters {@link ServerResponse}. |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| setting | [AdvertiseSetting](arkts-connectivity-ble-advertisesetting-i.md) | 是 | Indicates the settings for BLE advertising. If you need to use the default value, set this parameter to {@code null}. |
| advData | [AdvertiseData](arkts-connectivity-bluetoothmanager-advertisedata-i.md) | 是 | Indicates the advertising data. |
| advResponse | [AdvertiseData](arkts-connectivity-bluetoothmanager-advertisedata-i.md) | 否 | Indicates the scan response associated with the advertising data. |
