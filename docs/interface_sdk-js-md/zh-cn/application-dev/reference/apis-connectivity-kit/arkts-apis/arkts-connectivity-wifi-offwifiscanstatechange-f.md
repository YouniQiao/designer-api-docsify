...
## off_wifiScanStateChange('wifiScanStateChange')
...
| callback | [Callback](../../apis-basic-services-kit/arkts-apis/arkts-basicservices-callback-t.md)&lt;number&gt; | 否 | 状态改变回调函数。0:扫描失败，1:扫描成功 |
