...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| mode | [ScanMode](arkts-connectivity-bluetooth-scanmode-e.md) | 是 | Indicates the Bluetooth scan mode to set. |
| duration | ArkTS-Dyn: number  <br>ArkTS-Sta：int | 是 | Indicates the duration in seconds, in which the host is discoverable. |
