...
| --- | --- | --- | --- |
| command | number[] | 是 | The APDU command to be transmitted, as a byte array. |
| callback | [AsyncCallback](../../apis-basic-service-kit/arkts-apis/arkts-basicservices-base-asynccallback-i.md)&lt;number[]&gt; | 是 | The callback to return the response received, as a byte array. |
