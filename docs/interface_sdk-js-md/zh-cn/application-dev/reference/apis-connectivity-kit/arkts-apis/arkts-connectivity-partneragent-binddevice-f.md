...
| deviceCapability | [DeviceCapability](arkts-connectivity-partneragent-devicecapability-i.md) | 是 | The capability of partner device. |
| businessCapability | [BusinessCapability](arkts-connectivity-partneragent-businesscapability-i.md) | 是 | The business capability of application. |
