...
**替代接口：** ohos.bluetoothManager/bluetoothManager.MajorMinorClass
...
**替代接口：** ohos.bluetoothManager/bluetoothManager.MajorMinorClass.COMPUTER_UNCATEGORIZED
...
**替代接口：** ohos.bluetoothManager/bluetoothManager.MajorMinorClass.COMPUTER_DESKTOP
...
**替代接口：** ohos.bluetoothManager/bluetoothManager.MajorMinorClass.COMPUTER_SERVER
...
**替代接口：** ohos.bluetoothManager/bluetoothManager.MajorMinorClass.COMPUTER_LAPTOP
...
**替代接口：** ohos.bluetoothManager/bluetoothManager.MajorMinorClass.COMPUTER_HANDHELD_PC_PDA
...
**替代接口：** ohos.bluetoothManager/bluetoothManager.MajorMinorClass.COMPUTER_PALM_SIZE_PC_PDA
...
**替代接口：** ohos.bluetoothManager/bluetoothManager.MajorMinorClass.COMPUTER_WEARABLE
...
**替代接口：** ohos.bluetoothManager/bluetoothManager.MajorMinorClass.COMPUTER_TABLET
...
**替代接口：** ohos.bluetoothManager/bluetoothManager.MajorMinorClass.PHONE_UNCATEGORIZED
...
**替代接口：** ohos.bluetoothManager/bluetoothManager.MajorMinorClass.PHONE_CELLULAR
...
**替代接口：** ohos.bluetoothManager/bluetoothManager.MajorMinorClass.PHONE_CORDLESS
...
**替代接口：** ohos.bluetoothManager/bluetoothManager.MajorMinorClass.PHONE_SMART
...
**替代接口：** ohos.bluetoothManager/bluetoothManager.MajorMinorClass.PHONE_MODEM_OR_GATEWAY
...
**替代接口：** ohos.bluetoothManager/bluetoothManager.MajorMinorClass.PHONE_ISDN
...
**替代接口：** ohos.bluetoothManager/bluetoothManager.MajorMinorClass.NETWORK_FULLY_AVAILABLE
...
**替代接口：** ohos.bluetoothManager/bluetoothManager.MajorMinorClass.NETWORK_1_TO_17_UTILIZED
...
**替代接口：** ohos.bluetoothManager/bluetoothManager.MajorMinorClass.NETWORK_17_TO_33_UTILIZED
...
**替代接口：** ohos.bluetoothManager/bluetoothManager.MajorMinorClass.NETWORK_33_TO_50_UTILIZED
...
**替代接口：** ohos.bluetoothManager/bluetoothManager.MajorMinorClass.NETWORK_60_TO_67_UTILIZED
...
**替代接口：** ohos.bluetoothManager/bluetoothManager.MajorMinorClass.NETWORK_67_TO_83_UTILIZED
...
**替代接口：** ohos.bluetoothManager/bluetoothManager.MajorMinorClass.NETWORK_83_TO_99_UTILIZED
...
**替代接口：** ohos.bluetoothManager/bluetoothManager.MajorMinorClass.NETWORK_NO_SERVICE
...
**替代接口：** ohos.bluetoothManager/bluetoothManager.MajorMinorClass.AUDIO_VIDEO_UNCATEGORIZED
...
**替代接口：** ohos.bluetoothManager/bluetoothManager.MajorMinorClass.AUDIO_VIDEO_WEARABLE_HEADSET
...
**替代接口：** ohos.bluetoothManager/bluetoothManager.MajorMinorClass.AUDIO_VIDEO_HANDSFREE
...
**替代接口：** ohos.bluetoothManager/bluetoothManager.MajorMinorClass.AUDIO_VIDEO_MICROPHONE
...
**替代接口：** ohos.bluetoothManager/bluetoothManager.MajorMinorClass.AUDIO_VIDEO_LOUDSPEAKER
...
**替代接口：** ohos.bluetoothManager/bluetoothManager.MajorMinorClass.AUDIO_VIDEO_HEADPHONES
...
**替代接口：** ohos.bluetoothManager/bluetoothManager.MajorMinorClass.AUDIO_VIDEO_PORTABLE_AUDIO
...
**替代接口：** ohos.bluetoothManager/bluetoothManager.MajorMinorClass.AUDIO_VIDEO_CAR_AUDIO
...
**替代接口：** ohos.bluetoothManager/bluetoothManager.MajorMinorClass.AUDIO_VIDEO_SET_TOP_BOX
...
**替代接口：** ohos.bluetoothManager/bluetoothManager.MajorMinorClass.AUDIO_VIDEO_HIFI_AUDIO
...
**替代接口：** ohos.bluetoothManager/bluetoothManager.MajorMinorClass.AUDIO_VIDEO_VCR
...
**替代接口：** ohos.bluetoothManager/bluetoothManager.MajorMinorClass.AUDIO_VIDEO_VIDEO_CAMERA
...
**替代接口：** ohos.bluetoothManager/bluetoothManager.MajorMinorClass.AUDIO_VIDEO_CAMCORDER
...
**替代接口：** ohos.bluetoothManager/bluetoothManager.MajorMinorClass.AUDIO_VIDEO_VIDEO_MONITOR
...
**替代接口：** ohos.bluetoothManager/bluetoothManager.MajorMinorClass.AUDIO_VIDEO_VIDEO_DISPLAY_AND_LOUDSPEAKER
...
**替代接口：** ohos.bluetoothManager/bluetoothManager.MajorMinorClass.AUDIO_VIDEO_VIDEO_CONFERENCING
...
**替代接口：** ohos.bluetoothManager/bluetoothManager.MajorMinorClass.AUDIO_VIDEO_VIDEO_GAMING_TOY
...
**替代接口：** ohos.bluetoothManager/bluetoothManager.MajorMinorClass.PERIPHERAL_NON_KEYBOARD_NON_POINTING
...
**替代接口：** ohos.bluetoothManager/bluetoothManager.MajorMinorClass.PERIPHERAL_KEYBOARD
...
**替代接口：** ohos.bluetoothManager/bluetoothManager.MajorMinorClass.PERIPHERAL_POINTING_DEVICE
...
**替代接口：** ohos.bluetoothManager/bluetoothManager.MajorMinorClass.PERIPHERAL_KEYBOARD_POINTING
...
**替代接口：** ohos.bluetoothManager/bluetoothManager.MajorMinorClass.PERIPHERAL_UNCATEGORIZED
...
**替代接口：** ohos.bluetoothManager/bluetoothManager.MajorMinorClass.PERIPHERAL_JOYSTICK
...
**替代接口：** ohos.bluetoothManager/bluetoothManager.MajorMinorClass.PERIPHERAL_GAMEPAD
...
**替代接口：** ohos.bluetoothManager/bluetoothManager.MajorMinorClass.PERIPHERAL_REMOTE_CONTROL
...
**替代接口：** ohos.bluetoothManager/bluetoothManager.MajorMinorClass.PERIPHERAL_SENSING_DEVICE
...
**替代接口：** ohos.bluetoothManager/bluetoothManager.MajorMinorClass.PERIPHERAL_DIGITIZER_TABLET
...
**替代接口：** ohos.bluetoothManager/bluetoothManager.MajorMinorClass.PERIPHERAL_CARD_READER
...
**替代接口：** ohos.bluetoothManager/bluetoothManager.MajorMinorClass.PERIPHERAL_DIGITAL_PEN
...
**替代接口：** ohos.bluetoothManager/bluetoothManager.MajorMinorClass.PERIPHERAL_SCANNER_RFID
...
**替代接口：** ohos.bluetoothManager/bluetoothManager.MajorMinorClass.PERIPHERAL_GESTURAL_INPUT
...
**替代接口：** ohos.bluetoothManager/bluetoothManager.MajorMinorClass.IMAGING_UNCATEGORIZED
...
**替代接口：** ohos.bluetoothManager/bluetoothManager.MajorMinorClass.IMAGING_DISPLAY
...
**替代接口：** ohos.bluetoothManager/bluetoothManager.MajorMinorClass.IMAGING_CAMERA
...
**替代接口：** ohos.bluetoothManager/bluetoothManager.MajorMinorClass.IMAGING_SCANNER
...
**替代接口：** ohos.bluetoothManager/bluetoothManager.MajorMinorClass.IMAGING_PRINTER
...
**替代接口：** ohos.bluetoothManager/bluetoothManager.MajorMinorClass.WEARABLE_UNCATEGORIZED
...
**替代接口：** ohos.bluetoothManager/bluetoothManager.MajorMinorClass.WEARABLE_WRIST_WATCH
...
**替代接口：** ohos.bluetoothManager/bluetoothManager.MajorMinorClass.WEARABLE_PAGER
...
**替代接口：** ohos.bluetoothManager/bluetoothManager.MajorMinorClass.WEARABLE_JACKET
...
**替代接口：** ohos.bluetoothManager/bluetoothManager.MajorMinorClass.WEARABLE_HELMET
...
**替代接口：** ohos.bluetoothManager/bluetoothManager.MajorMinorClass.WEARABLE_GLASSES
...
**替代接口：** ohos.bluetoothManager/bluetoothManager.MajorMinorClass.TOY_UNCATEGORIZED
...
**替代接口：** ohos.bluetoothManager/bluetoothManager.MajorMinorClass.TOY_ROBOT
...
**替代接口：** ohos.bluetoothManager/bluetoothManager.MajorMinorClass.TOY_VEHICLE
...
**替代接口：** ohos.bluetoothManager/bluetoothManager.MajorMinorClass.TOY_DOLL_ACTION_FIGURE
...
**替代接口：** ohos.bluetoothManager/bluetoothManager.MajorMinorClass.TOY_CONTROLLER
...
**替代接口：** ohos.bluetoothManager/bluetoothManager.MajorMinorClass.TOY_GAME
...
**替代接口：** ohos.bluetoothManager/bluetoothManager.MajorMinorClass.HEALTH_UNCATEGORIZED
...
**替代接口：** ohos.bluetoothManager/bluetoothManager.MajorMinorClass.HEALTH_BLOOD_PRESSURE
...
**替代接口：** ohos.bluetoothManager/bluetoothManager.MajorMinorClass.HEALTH_THERMOMETER
...
**替代接口：** ohos.bluetoothManager/bluetoothManager.MajorMinorClass.HEALTH_WEIGHING
...
**替代接口：** ohos.bluetoothManager/bluetoothManager.MajorMinorClass.HEALTH_GLUCOSE
...
**替代接口：** ohos.bluetoothManager/bluetoothManager.MajorMinorClass.HEALTH_PULSE_OXIMETER
...
**替代接口：** ohos.bluetoothManager/bluetoothManager.MajorMinorClass.HEALTH_PULSE_RATE
...
**替代接口：** ohos.bluetoothManager/bluetoothManager.MajorMinorClass.HEALTH_DATA_DISPLAY
...
**替代接口：** ohos.bluetoothManager/bluetoothManager.MajorMinorClass.HEALTH_STEP_COUNTER
...
**替代接口：** ohos.bluetoothManager/bluetoothManager.MajorMinorClass.HEALTH_BODY_COMPOSITION_ANALYZER
...
**替代接口：** ohos.bluetoothManager/bluetoothManager.MajorMinorClass.HEALTH_PEAK_FLOW_MOITOR
...
**替代接口：** ohos.bluetoothManager/bluetoothManager.MajorMinorClass.HEALTH_MEDICATION_MONITOR
...
**替代接口：** ohos.bluetoothManager/bluetoothManager.MajorMinorClass.HEALTH_KNEE_PROSTHESIS
...
**替代接口：** ohos.bluetoothManager/bluetoothManager.MajorMinorClass.HEALTH_ANKLE_PROSTHESIS
...
**替代接口：** ohos.bluetoothManager/bluetoothManager.MajorMinorClass.HEALTH_GENERIC_HEALTH_MANAGER
...
**替代接口：** ohos.bluetoothManager/bluetoothManager.MajorMinorClass.HEALTH_PERSONAL_MOBILITY_DEVICE
