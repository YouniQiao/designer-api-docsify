...
| option | [SppOption](arkts-connectivity-bluetoothmanager-sppoption-i.md) | 是 | Indicates the listen parameters {@link SppOption}. |
| callback | [AsyncCallback](../../apis-basic-service-kit/arkts-apis/arkts-basicservices-base-asynccallback-i.md)&lt;number&gt; | 是 | Callback used to return a server socket ID. |
