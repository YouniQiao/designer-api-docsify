...
**替代接口：** ohos.bluetooth.connection/connection.ScanMode
...
**替代接口：** ohos.bluetooth.connection/connection.ScanMode#SCAN_MODE_NONE
...
**替代接口：** ohos.bluetooth.connection/connection.ScanMode#SCAN_MODE_CONNECTABLE
...
**替代接口：** ohos.bluetooth.connection/connection.ScanMode#SCAN_MODE_GENERAL_DISCOVERABLE
...
**替代接口：** ohos.bluetooth.connection/connection.ScanMode#SCAN_MODE_LIMITED_DISCOVERABLE
...
**替代接口：** ohos.bluetooth.connection/connection.ScanMode#SCAN_MODE_CONNECTABLE_GENERAL_DISCOVERABLE
...
**替代接口：** ohos.bluetooth.connection/connection.ScanMode#SCAN_MODE_CONNECTABLE_LIMITED_DISCOVERABLE
