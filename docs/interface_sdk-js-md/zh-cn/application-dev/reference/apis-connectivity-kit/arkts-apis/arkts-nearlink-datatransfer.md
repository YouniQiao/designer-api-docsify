...
| 名称 | 说明 |
| --- | --- |
| [connect](arkts-connectivity-datatransfer-connect-f.md) | 连接服务端。如果连接成功，则可以向服务端发送数据。 |
| [createPort](arkts-connectivity-datatransfer-createport-f.md) | 通过UUID创建可以接收数据的星闪端口。 |
| [destroyPort](arkts-connectivity-datatransfer-destroyport-f.md) | 根据UUID销毁监听端口并释放相关资源。 |
| [disconnect](arkts-connectivity-datatransfer-disconnect-f.md) | 断开或停止与服务端的连接。 |
