...
| p192Data | [OobData](arkts-connectivity-connection-oobdata-i-sys.md) \| null | 是 | The out-of-band data (P192), or null if not available. |
| p256Data | [OobData](arkts-connectivity-connection-oobdata-i-sys.md) \| null | 是 | The out-of-band data (P256), or null if not available. |
