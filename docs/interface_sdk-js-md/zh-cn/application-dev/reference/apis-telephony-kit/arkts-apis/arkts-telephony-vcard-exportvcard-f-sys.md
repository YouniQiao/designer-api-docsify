...
| options | [VCardBuilderOptions](arkts-telephony-vcard-vcardbuilderoptions-i-sys.md) | 是 | VCard版本与编码类型。 |
...
| context | Context | 是 | 应用上下文。 |
| predicates | dataSharePredicates.DataSharePredicates | 是 | 查询语句。 |
| options | [VCardBuilderOptions](arkts-telephony-vcard-vcardbuilderoptions-i-sys.md) | 否 | VCard版本与编码类型。 |
