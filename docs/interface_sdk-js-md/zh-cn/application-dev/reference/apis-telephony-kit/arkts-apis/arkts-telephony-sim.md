...
| [getSimLabel](arkts-telephony-getsimlabel-f.md#getsimlabel-2) | 获取SIM卡标签名称 |
...
| [setSimLabelIndex](arkts-telephony-setsimlabelindex-f-sys.md#setsimlabelindex-1) | 设置SIM卡标签索引。 |
...
| [SimLabel](arkts-telephony-simlabel-i.md) | 定义SIM卡标签信息。 |
