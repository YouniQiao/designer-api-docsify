...
| --- | --- | --- | --- |
| phoneNumber | string | 是 | 电话号码。 |
| options | [DialCallOptions](arkts-telephony-call-dialcalloptions-i-sys.md) | 否 | 通话参数，携带呼叫的其他配置信息。&lt;br/&gt;不填该参数则默认使用如下配置，参考 [DialCallOptions](arkts-telephony-call-dialcalloptions-i-sys.md#DialCallOptions)。&lt;br/&gt;- 帐户Id：卡槽1。 &lt;br/&gt;- 音视频类型：语音通话。 &lt;br/&gt;- 拨号场景：普通呼叫。 &lt;br/&gt;- 拨号类 型：运营商通话。 |
