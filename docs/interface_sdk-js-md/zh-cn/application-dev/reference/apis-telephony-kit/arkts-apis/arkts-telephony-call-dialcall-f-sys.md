...
| options | [DialCallOptions](arkts-telephony-call-dialcalloptions-i-sys.md) | 是 | Indicates additional information carried in the call. |
| callback | [AsyncCallback](../../apis-basic-service-kit/arkts-apis/arkts-basicservices-base-asynccallback-i.md)&lt;void&gt; | 是 | The callback of dialCall. |
...
| --- | --- | --- | --- |
| phoneNumber | string | 是 | Indicates the called number. |
| options | [DialCallOptions](arkts-telephony-call-dialcalloptions-i-sys.md) | 否 | Indicates additional information carried in the call. |
