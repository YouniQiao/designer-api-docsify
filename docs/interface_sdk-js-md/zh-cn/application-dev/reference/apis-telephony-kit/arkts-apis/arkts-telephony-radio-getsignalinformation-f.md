...
| 类型 | 说明 |
| --- | --- |
| Promise&lt;Array&lt;[SignalInformation](arkts-telephony-radio-signalinformation-i.md)&gt;&gt; | 以Promise形式返回网络信号强度[SignalInformation](arkts-telephony-radio-signalinformation-i.md)子类对象的数组。 |
