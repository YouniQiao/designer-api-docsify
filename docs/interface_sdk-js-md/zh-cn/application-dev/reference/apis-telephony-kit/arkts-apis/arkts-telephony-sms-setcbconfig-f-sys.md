...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| options | [CBConfigOptions](arkts-telephony-sms-cbconfigoptions-i-sys.md) | 是 | Indicates cell broadcast configuration options. |
| callback | [AsyncCallback](../../apis-basic-service-kit/arkts-apis/arkts-basicservices-base-asynccallback-i.md)&lt;void&gt; | 是 | The callback of setCBConfig. |
