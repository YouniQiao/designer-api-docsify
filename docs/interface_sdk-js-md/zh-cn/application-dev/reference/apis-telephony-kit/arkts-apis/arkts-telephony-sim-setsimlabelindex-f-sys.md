...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| simId | ArkTS-Dyn: number  <br>ArkTS-Sta：int | 是 | 表示来自SIM账户信息的卡的SIM ID。 &lt;br&gt;取值范围:[1,500] |
| simLabelIndex | ArkTS-Dyn: number  <br>ArkTS-Sta：int | 是 | 表示卡的SIM标签索引。 |
...
| [202](../../../../../../../../gitee_tmp/docs/stamaster/zh-cn/application-dev/reference/errorcode-universal.md#202-系统api权限校验失败) | Nonsystem applications use system APIs. |
