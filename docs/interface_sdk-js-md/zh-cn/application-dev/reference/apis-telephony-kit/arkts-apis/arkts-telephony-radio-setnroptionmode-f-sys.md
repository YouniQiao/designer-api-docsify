...
| mode | [NROptionMode](arkts-telephony-radio-nroptionmode-e-sys.md) | 是 | Indicates the nr option mode to be set. |
| callback | [AsyncCallback](../../apis-basic-services-kit/arkts-apis/arkts-basicservices-base-asynccallback-i.md)&lt;void&gt; | 是 | Indicates the callback for getting the option result. |
