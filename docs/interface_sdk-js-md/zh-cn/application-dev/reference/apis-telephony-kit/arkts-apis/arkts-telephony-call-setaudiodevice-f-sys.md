...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| device | [AudioDevice](arkts-telephony-call-audiodevice-i-sys.md) | 是 | Indicates the device of audio. |
| callback | [AsyncCallback](../../apis-basic-service-kit/arkts-apis/arkts-basicservices-base-asynccallback-i.md)&lt;void&gt; | 是 | The callback of setAudioDevice. |
