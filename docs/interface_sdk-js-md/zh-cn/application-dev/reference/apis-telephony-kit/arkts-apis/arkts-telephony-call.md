...
| off | 取消订阅callDetailsChange事件。使用callback异步回调。 |
| off | 取消订阅callEventChange事件。使用callback异步回调。 |
| off | 取消订阅callDisconnectedCause事件。使用callback异步回调。 |
| [off](arkts-telephony-call-mmicoderesult-e-sys.md) | 取消订阅mmiCodeResult事件。使用callback异步回调。 |
| off | 取消订阅audioDeviceChange事件。使用callback异步回调。 |
| off | 取消订阅拨号后延迟事件。使用callback异步回调。 |
| off | 取消订阅imsCallModeChange事件。使用callback异步回调。 |
| [off](arkts-telephony-call-callsessionevent-i-sys.md) | 取消订阅callSessionEvent事件。使用callback异步回调。 |
| off | 取消订阅peerDimensionsChange事件。使用callback异步回调。 |
| off | 取消订阅cameraCapabilitiesChange事件。使用callback异步回调。 |
...
| on | 订阅callDetailsChange事件。使用callback异步回调。 |
| on | 订阅callEventChange事件。使用callback异步回调。 |
| on | 订阅callDisconnectedCause事件。使用callback异步回调。 |
| [on](arkts-telephony-call-mmicoderesult-e-sys.md) | 订阅mmiCodeResult事件。使用callback异步回调。 |
| on | 订阅通话音频设备切换事件。使用callback异步回调。 |
| on | 订阅拨号后延迟事件。使用callback异步回调。 |
| on | 订阅imsCallModeChange事件。使用callback异步回调。 |
| [on](arkts-telephony-call-callsessionevent-i-sys.md) | 订阅callSessionEvent事件。使用callback异步回调。 |
| on | 订阅peerDimensionsChange事件。使用callback异步回调。 |
| on | 订阅cameraCapabilitiesChange事件。使用callback异步回调。 |
