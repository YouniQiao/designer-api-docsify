...
| callback | \_\_\_MD\_LINK\_USD\_0\_\_\_&lt;string&gt; | 是 | Indicates the callback for getting the MSISDN; Returns an empty string if no SIM card is inserted or no MSISDN is recorded in the EFMSISDN file. |
