...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| mainCallId | ArkTS-Dyn: number  <br>ArkTS-Sta：int | 是 | Indicates the identifier of the main call. |
| callNumberList | Array&lt;string&gt; | 是 | Indicates a call list. |
| callback | [AsyncCallback](../../apis-basic-service-kit/arkts-apis/arkts-basicservices-base-asynccallback-i.md)&lt;void&gt; | 是 | The callback of joinConference. |
