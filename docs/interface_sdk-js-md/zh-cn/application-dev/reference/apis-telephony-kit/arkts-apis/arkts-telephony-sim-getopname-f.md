...
| callback | \_\_\_MD\_LINK\_USD\_0\_\_\_&lt;string&gt; | 是 | Indicates the callback for getting the operator name; Returns an empty string if no SIM card is inserted or no operator name matched. |
