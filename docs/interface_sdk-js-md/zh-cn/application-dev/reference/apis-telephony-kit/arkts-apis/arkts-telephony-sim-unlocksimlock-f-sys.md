...
| lockInfo | \_\_\_MD\_LINK\_USD\_0\_\_\_ | 是 | Indicates customized lock type information. |
| callback | \_\_\_MD\_LINK\_USD\_0\_\_\_&lt;LockStatusResponse&gt; | 是 | Indicates the callback used to obtain a response to obtain the SIM card lock status for the specified card slot. |
