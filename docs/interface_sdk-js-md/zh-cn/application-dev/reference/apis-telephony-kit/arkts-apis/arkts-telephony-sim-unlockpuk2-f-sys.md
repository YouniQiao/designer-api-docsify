...
| newPin2 | string | 是 | Indicates to reset the SIM card password. |
| puk2 | string | 是 | Indicates the unlock password of the SIM card password. |
| callback | \_\_\_MD\_LINK\_USD\_0\_\_\_&lt;LockStatusResponse&gt; | 是 | Indicates the callback for getting the response to obtain the SIM card lock status of the specified card slot. |
