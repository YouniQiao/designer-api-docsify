...
| callback | [AsyncCallback](../../apis-basic-service-kit/arkts-apis/arkts-basicservices-base-asynccallback-i.md)&lt;PreferredNetworkMode&gt; | 是 | Indicates the callback for getting the preferred network mode to obtain. |
