...
| 名称 | 说明 |
| --- | --- |
| [cancelSession](arkts-telephony-esim-cancelsession-f-sys.md#cancelsession) | Cancel session can be used in the1.after the response to "ES9+.AuthenticateClient"2.after the response to "ES9+.GetBoundProfilePackage" |
