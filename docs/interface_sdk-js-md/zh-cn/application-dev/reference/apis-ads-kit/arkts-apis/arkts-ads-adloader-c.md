...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| adParam | [AdRequestParams](arkts-ads-adrequestparams-i.md) | 是 | 广告请求参数。 |
| adOptions | [AdOptions](arkts-ads-adoptions-i.md) | 是 | 广告配置参数。 |
| listener | [AdLoadListener](arkts-ads-adloadlistener-i.md) | 是 | 请求广告回调监听。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| adParams | [AdRequestParams](arkts-ads-adrequestparams-i.md)[] | 是 | 广告请求参数。 |
| adOptions | [AdOptions](arkts-ads-adoptions-i.md) | 是 | 广告配置参数。 |
