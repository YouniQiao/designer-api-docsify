...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| watcher | [Watcher](../../apis-core-file-kit/arkts-apis/arkts-corefile-watcher-t.md) | 是 | 事件观察者。 |
...
| 11102002 | Invalid filtering event domain. Possible causes: 1. Contain invalid characters; &lt;br&gt;2. Length is invalid. |
