...
| 名称 | 说明 |
| --- | --- |
| [check](arkts-performanceanalysis-check-f.md#check-1) | ��ȡ��ͨ��jsLeakWatcher.watchע�ᷢ��й©�Ķ����б�������GC��δ�����յĶ���ᱻ���Ϊй©�� |
...
| 名称 | 说明 |
| --- | --- |
| [LeakWatcherConfig](arkts-performanceanalysis-leakwatcherconfig-i.md) | LeakWatcherConfig�������ͣ������а�����������ڴ�й©���Ŀ��������ԡ� |

### 枚举

| 名称 | 说明 |
| --- | --- |
| [MonitorObjectType](arkts-performanceanalysis-monitorobjecttype-e.md) | ��Ҫ��ص������������ö�١� |
