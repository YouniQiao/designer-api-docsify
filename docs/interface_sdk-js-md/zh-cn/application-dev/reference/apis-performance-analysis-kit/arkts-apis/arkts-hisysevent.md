...
| 名称 | 说明 |
| --- | --- |
| [addWatcher](arkts-performanceanalysis-hisysevent-addwatcher-f-sys.md) | 订阅系统事件，接收[Watcher](arkts-performanceanalysis-hisysevent-watcher-i-sys.md)类型的对象作为事件参数。 |
| [exportSysEvents](arkts-performanceanalysis-hisysevent-exportsysevents-f-sys.md) | 批量导出系统事件，以文件格式写入应用沙箱固定目录(/data/storage/el2/base/cache/hiview/event/)。 |
| [query](arkts-performanceanalysis-hisysevent-query-f-sys.md) | 查询系统事件。 |
