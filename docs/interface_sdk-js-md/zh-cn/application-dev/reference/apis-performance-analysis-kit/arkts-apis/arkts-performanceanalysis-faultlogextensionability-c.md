...
开发者可在[onFaultReportReady](arkts-performanceanalysis-faultlogextensionability-c.md#onfaultreportready-1)中订阅并处理故障事件。
...
继承自[ExtensionContext](../../apis-ability-kit/arkts-apis/arkts-ability-extensioncontext-c.md)。
