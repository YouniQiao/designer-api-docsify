...
如果具有相同name的任务是串行执行的，则taskId可以相同。具体示例可参考[finishTrace()]\_\_\_JSDOC\_LINK\_DESC\_USD\_0\_\_\_中的示例。

从API version 19开始，建议使用[startAsyncTrace()]\_\_\_JSDOC\_LINK\_DESC\_USD\_1\_\_\_接口（需与  
[finishAsyncTrace()]\_\_\_JSDOC\_LINK\_DESC\_USD\_2\_\_\_接口配套使用），以便分级控制跟踪输出与跟踪聚类。
