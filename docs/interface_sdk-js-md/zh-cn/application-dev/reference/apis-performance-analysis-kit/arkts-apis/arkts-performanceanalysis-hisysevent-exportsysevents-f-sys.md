...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| queryArg | [QueryArg](arkts-performanceanalysis-hisysevent-queryarg-i-sys.md) | 是 | 导出需要配置的查询参数。 |
| rules | [QueryRule](arkts-performanceanalysis-hisysevent-queryrule-i-sys.md)[] | 是 | 查询规则数组，每次导出可配置多个查询规则。 |
