...
取消认证。
    **说明：**  
    ...
    使用获取到的[AuthInstance]\_\_\_JSDOC\_LINK\_DESC\_USD\_0\_\_\_对象调用该接口进行取消认证，此[AuthInstance]\_\_\_JSDOC\_LINK\_DESC\_USD\_1\_\_\_需要是正  
    在进行认证的对象。
...
[AuthEventKey]\_\_\_JSDOC\_LINK\_DESC\_USD\_0\_\_\_。
    **说明：**  
    
    需要使用已经成功订阅事件的[AuthInstance]\_\_\_JSDOC\_LINK\_DESC\_USD\_1\_\_\_对象调用该接口进行取消订阅。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| name | \_\_\_MD\_LINK\_USD\_0\_\_\_ | 是 |  |
...
[AuthEventKey]\_\_\_JSDOC\_LINK\_DESC\_USD\_0\_\_\_。  
- **callback**: 认证接口的回调函数，用于返回认证结果或认证过程中的提示信息，类型为[AuthEvent]\_\_\_JSDOC\_LINK\_DESC\_USD\_1\_\_\_。
    **说明：**  
    
    使用获取到的[AuthInstance]\_\_\_JSDOC\_LINK\_DESC\_USD\_2\_\_\_对象调用该接口进行订阅。
...
开始认证。
    **说明：**  
    ...
    使用获取到的[AuthInstance]\_\_\_JSDOC\_LINK\_DESC\_USD\_0\_\_\_对象调用该接口进行认证。
