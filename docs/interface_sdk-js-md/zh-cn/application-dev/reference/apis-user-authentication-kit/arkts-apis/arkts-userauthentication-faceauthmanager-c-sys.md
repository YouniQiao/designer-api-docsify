...
用于在录入人脸时设置人脸预览界面的Surface ID。该接口需要配合 [addCredential](../../apis-basic-service-kit/arkts-apis/arkts-basicservices-useridentitymanager-c-sys.md#addcredential-1)使用，通过 [getXComponentSurfaceId](XComponentController#getXComponentSurfaceId)组件的Surface来显示人脸预览画面。
