...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| templateId | [Uint8Array](../../apis-arkts/arkts-apis/arkts-arkts-uint8array-c.md) | 是 | 目标模板ID。要更新业务范围的模板的唯一标识，可通过[getTemplateStatus](arkts-userauthentication-statusmonitor-i-sys.md#gettemplatestatus-1)获取。 |
