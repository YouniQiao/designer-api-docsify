...
| enabledBusinessIds | ArkTS-Dyn: number[]  <br>ArkTS-Sta：int[] | 是 | 模板支持的业务ID集合。要启用的业务场景列表，如[BusinessId.DEFAULT]。不同业务ID对应不同的认证场景，应用可根据业务需求配置（厂商自定 义业务ID需 ≥ 10000）。 |
...
| [32600003](../../../../../../../../gitee_tmp/docs/stamaster/zh-cn/application-dev/reference/apis-user-authentication-kit/errorcode-useriam.md#32600003-业务id无效) | The business ID is invalid. |
