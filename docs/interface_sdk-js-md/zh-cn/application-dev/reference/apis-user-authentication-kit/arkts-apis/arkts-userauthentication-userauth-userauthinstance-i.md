...
使用以下接口前，需先通过[getUserAuthInstance]\_\_\_JSDOC\_LINK\_DESC\_USD\_0\_\_\_方法获取UserAuthInstance对象。
    **说明：**  
...
取消订阅用户身份认证的结果。该接口常用于以下场景：页面销毁或组件卸载时取消订阅；不再需要监听认证结果时释放资源。
    **说明：**  
    ...
    需要使用已经成功订阅事件的[UserAuthInstance]\_\_\_JSDOC\_LINK\_DESC\_USD\_0\_\_\_对象调用该接口进行取消订阅。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| type | 'authTip' | 是 | 取消订阅的事件类型，支持的事件为'authTip'，当[start()]\_\_\_ESCAPED\_UNDERSCORE\_\_\_\_\_\_ESCAPED\_UNDERSCORE\_\_\_\_\_\_ESCAPED\_UNDERSCORE\_\_\_JSDOC\_\_\_ESCAPED\_UNDERSCORE\_\_\_LINK\_\_\_ESCAPED\_UNDERSCORE\_\_\_DESC\_\_\_ESCAPED\_UNDERSCORE\_\_\_USD\_\_\_ESCAPED\_UNDERSCORE\_\_\_0\_\_\_ESCAPED\_UNDERSCORE\_\_\_\_\_\_ESCAPED\_UNDERSCORE\_\_\_\_\_\_ESCAPED\_UNDERSCORE\_\_\_调用完成，发起身份认 证并调用[on('authTip')]\_\_\_ESCAPED\_UNDERSCORE\_\_\_\_\_\_ESCAPED\_UNDERSCORE\_\_\_\_\_\_ESCAPED\_UNDERSCORE\_\_\_JSDOC\_\_\_ESCAPED\_UNDERSCORE\_\_\_LINK\_\_\_ESCAPED\_UNDERSCORE\_\_\_DESC\_\_\_ESCAPED\_UNDERSCORE\_\_\_USD\_\_\_ESCAPED\_UNDERSCORE\_\_\_1\_\_\_ESCAPED\_UNDERSCORE\_\_\_\_\_\_ESCAPED\_UNDERSCORE\_\_\_\_\_\_ESCAPED\_UNDERSCORE\_\_\_订阅该事件后，调用该 方法可取消订阅，不会再触发该事件。 |
...
[on('authTip')]\_\_\_JSDOC\_LINK\_DESC\_USD\_0\_\_\_接口订阅。
    **说明：**  
    
    在PC/2in1设备上，应用如果使用模应用弹窗方式发起认证（即配置用户界面参数[widgetParam]\_\_\_JSDOC\_LINK\_DESC\_USD\_1\_\_\_时传入了有效的uiContext），收到认证结果后，若需弹出其  
    他窗口，应先获取控件弹窗释放的标志消息，通过  
    [on('authTip')]\_\_\_JSDOC\_LINK\_DESC\_USD\_2\_\_\_接口订阅控件释放消息（  
    authTipInfo.tipCode = UserAuthTipCode.WIDGET\_RELEASED）。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| type | 'result' | 是 | 订阅事件类型，表明该事件用来返回认证结果，当[start()]\_\_\_ESCAPED\_UNDERSCORE\_\_\_\_\_\_ESCAPED\_UNDERSCORE\_\_\_\_\_\_ESCAPED\_UNDERSCORE\_\_\_JSDOC\_\_\_ESCAPED\_UNDERSCORE\_\_\_LINK\_\_\_ESCAPED\_UNDERSCORE\_\_\_DESC\_\_\_ESCAPED\_UNDERSCORE\_\_\_USD\_\_\_ESCAPED\_UNDERSCORE\_\_\_0\_\_\_ESCAPED\_UNDERSCORE\_\_\_\_\_\_ESCAPED\_UNDERSCORE\_\_\_\_\_\_ESCAPED\_UNDERSCORE\_\_\_调用完成，发起身份认证并完成认证 交互后，触发该事件。 |
...
订阅身份认证过程中的提示信息。通过该接口可以获取到认证过程中控件的拉起和退出提示，以及认证过程中用户的每一次认证不通过尝试。使用callback异步回调。
    **说明：**  
    ...
    在PC/2in1设备上，应用如果使用模应用弹窗方式发起认证（即配置用户界面参数[widgetParam]\_\_\_JSDOC\_LINK\_DESC\_USD\_0\_\_\_时传入了有效的uiContext），收到认证结果后，若需弹出其  
    他窗口，应先获取控件弹窗释放的标志消息，通过  
    [on('authTip')]\_\_\_JSDOC\_LINK\_DESC\_USD\_1\_\_\_接口订阅控件释放消息（  
    authTipInfo.tipCode = UserAuthTipCode.WIDGET\_RELEASED）。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| type | 'authTip' | 是 | 订阅事件类型，支持的事件为'authTip'，当[start()]\_\_\_ESCAPED\_UNDERSCORE\_\_\_\_\_\_ESCAPED\_UNDERSCORE\_\_\_\_\_\_ESCAPED\_UNDERSCORE\_\_\_JSDOC\_\_\_ESCAPED\_UNDERSCORE\_\_\_LINK\_\_\_ESCAPED\_UNDERSCORE\_\_\_DESC\_\_\_ESCAPED\_UNDERSCORE\_\_\_USD\_\_\_ESCAPED\_UNDERSCORE\_\_\_0\_\_\_ESCAPED\_UNDERSCORE\_\_\_\_\_\_ESCAPED\_UNDERSCORE\_\_\_\_\_\_ESCAPED\_UNDERSCORE\_\_\_调用完成，发起身份认证，触 发该事件。 |
