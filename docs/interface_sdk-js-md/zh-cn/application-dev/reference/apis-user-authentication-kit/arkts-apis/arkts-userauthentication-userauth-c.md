...
**替代接口：** [cancel](arkts-userauthentication-authinstance-i.md#cancel)
...
**替代接口：** [getAvailableStatus](arkts-userauthentication-getavailablestatus-f.md#getavailablestatus-1)
