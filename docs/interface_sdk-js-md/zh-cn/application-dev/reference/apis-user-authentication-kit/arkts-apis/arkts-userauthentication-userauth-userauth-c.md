...
| authTrustLevel | [AuthTrustLevel](arkts-userauthentication-userauth-authtrustlevel-e.md) | 是 | 认证信任等级。 |
| callback | [IUserAuthCallback](arkts-userauthentication-userauth-iuserauthcallback-i.md) | 是 | 回调函数。 |
