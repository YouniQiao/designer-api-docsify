...
如果要设置[Tag.IS_PERSISTENT](arkts-assetstore-tagtype-e.md)属性，需要申请ohos.permission.STORE_PERSISTENT_DATA权限，申请方式请参考[声明权限](../../../../security/AccessToken/declare-permissions.md)。
