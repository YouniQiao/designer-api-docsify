...
查询一条或多条符合条件的关键资产。若查询需要用户认证的关键资产，则需要在本函数前调用[asset.preQuery]\_\_\_JSDOC\_LINK\_DESC\_USD\_1\_\_\_接口，在本函数后调用  
[asset.postQuery]\_\_\_JSDOC\_LINK\_DESC\_USD\_2\_\_\_接口，开发步骤请参考\_\_\_MD\_LINK\_DESC\_USD\_0\_\_\_。使用Promise异步回调。
