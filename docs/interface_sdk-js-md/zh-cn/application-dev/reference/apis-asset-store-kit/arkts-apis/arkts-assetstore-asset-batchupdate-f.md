...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| sourceAttributes | Array&lt;[AssetMap](arkts-assetstore-asset-assetmap-t.md)&gt; | 是 | 待更新关键资产的搜索条件数组。 |
| destAttributes | Array&lt;[AssetMap](arkts-assetstore-asset-assetmap-t.md)&gt; | 是 | 待更新关键资产的属性集合数组。 |
...
| [24000019](../../../../../../../../gitee_tmp/docs/stamaster/zh-cn/application-dev/reference/apis-asset-store-kit/errorcode-asset.md#24000019-属性值不一致) | Each value of [GROUP_ID](arkts-assetstore-asset-tag-e.md#GROUP_ID) and [REQUIRE_ATTR_ENCRYPTED](arkts-assetstore-asset-tag-e.md#REQUIRE_ATTR_ENCRYPTED) in the array is not consistent. |
