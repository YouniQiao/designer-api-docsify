...
在指定用户空间中查询一条或多条符合条件的关键资产。若查询需要用户认证的关键资产，则需要在本函数前调用[asset.preQueryAsUser]\_\_\_JSDOC\_LINK\_DESC\_USD\_1\_\_\_接口，在本函数后调用  
[asset.postQueryAsUser]\_\_\_JSDOC\_LINK\_DESC\_USD\_2\_\_\_接口，开发步骤请参考  
