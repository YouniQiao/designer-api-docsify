...
> **说明：**
> 
> 从API version 8 开始支持，从API version 9 开始废弃，建议使用[sensor.on.PEDOMETER_DETECTION] &gt; [off](arkts-sensorservice-sensor-offsensoridcolor-f-sys.md#off_sensoridcolor) &gt; 替代。
