...
Subscribe to linear acceleration sensor data, {@code SensorId.LINEAR\_ACCELEROMETER}.
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | \_\_\_MD\_LINK\_USD\_0\_\_\_&lt;LinearAccelerometerResponse&gt; | 是 | callback linear accelerometer data. |
