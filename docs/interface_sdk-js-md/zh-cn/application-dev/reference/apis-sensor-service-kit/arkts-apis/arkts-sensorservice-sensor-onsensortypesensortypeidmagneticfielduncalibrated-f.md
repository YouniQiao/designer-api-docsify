...
> **说明：**
> 
> 从API version 8 开始支持，从API version 9 开始废弃，建议使用[sensor.on.MAGNETIC_FIELD_UNCALIBRATED] &gt; [on](arkts-sensorservice-sensor-onsensoridcolor-f-sys.md#on_sensoridcolor) &gt; 替代。
