...
**替代接口：** [getGeomagneticInfo(locationOptions:](arkts-sensorservice-sensor-getgeomagneticinfo-f.md#getgeomagneticinfo)
...
| callback | [AsyncCallback](../../apis-basic-service-kit/arkts-apis/arkts-basicservices-base-asynccallback-i.md)&lt;GeomagneticResponse&gt; | 是 | 异步返回磁场信息。 |
