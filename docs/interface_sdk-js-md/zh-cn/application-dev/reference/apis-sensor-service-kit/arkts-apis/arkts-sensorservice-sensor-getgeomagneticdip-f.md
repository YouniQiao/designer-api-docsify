...
根据倾斜矩阵计算地磁倾斜角，使用Callback异步方式返回结果。
    **说明**：  
    ...
    [sensor.getInclination]\_\_\_JSDOC\_LINK\_DESC\_USD\_0\_\_\_  
    替代。
...
| callback | \_\_\_MD\_LINK\_USD\_0\_\_\_&lt;number&gt; | 是 | 异步返回地磁倾斜角，单位为弧度。 |
...
根据倾斜矩阵计算地磁倾斜角，使用Promise异步方式返回结果。
    **说明**：  
    ...
    从API version 8 开始支持，从API version 9 开始废弃，建议使用  
    [sensor.getInclination]\_\_\_JSDOC\_LINK\_DESC\_USD\_0\_\_\_替代。
