...
**替代接口：** [getRotationMatrix(rotationVector:](arkts-sensorservice-sensor-getrotationmatrix-f.md#getrotationmatrix)
...
**替代接口：** [getRotationMatrix(gravity:](arkts-sensorservice-sensor-getrotationmatrix-f.md#getrotationmatrix)
