...
[getVibratorInfoSync]\_\_\_JSDOC\_LINK\_DESC\_USD\_0\_\_\_或[on]\_\_\_JSDOC\_LINK\_DESC\_USD\_1\_\_\_查询。
...
[getVibratorInfoSync]\_\_\_JSDOC\_LINK\_DESC\_USD\_0\_\_\_查询。不填写时默认使用马达ID为0的马达。
...
马达振动的使用场景。默认值：'unknown'。取值范围只允许在[Usage]\_\_\_JSDOC\_LINK\_DESC\_USD\_0\_\_\_提供的类型中选取。不同usage值对应不同的系统振动开关管控规则，开发者需根据实际业务场景选择合适的usage值。
