...
[CreateNativeMediaPlayerCallback](arkts-arkweb-createnativemediaplayercallback-t.md)回调函数的参数。应用通过该对象，将播放器的状态通知给 ArkWeb 内核。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| error | [MediaError](arkts-arkweb-mediaerror-e.md) | 是 | 错误类型。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| state | [NetworkState](arkts-arkweb-networkstate-e.md) | 是 | 播放器的网络状态。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| state | [ReadyState](arkts-arkweb-readystate-e.md) | 是 | 播放器的缓存状态。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| status | [PlaybackStatus](arkts-arkweb-playbackstatus-e.md) | 是 | 播放器的播放状态。 |
