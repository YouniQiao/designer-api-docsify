...
WebDownloadDelegate定义了四个下载生命周期回调： [onBeforeDownload](../../apis-default/arkts-apis/arkts-webview-webdownloaddelegate-c.md#onbeforedownload)在下载开始前触 发，应用需要在此回调中调用[WebDownloadItem.start](../../apis-default/arkts-apis/arkts-webview-webdownloaditem-c.md#start)并指定下载路径，否则下载将一直处于PENDING状态； [onDownloadUpdated](../../apis-default/arkts-apis/arkts-webview-webdownloaddelegate-c.md#ondownloadupdated)在下载过程中 触发，可获取下载进度（百分比）、已接收字节数等更新信息； [onDownloadFinish](../../apis-default/arkts-apis/arkts-webview-webdownloaddelegate-c.md#ondownloadfinish)在下载完成时触 发；[onDownloadFailed](../../apis-default/arkts-apis/arkts-webview-webdownloaddelegate-c.md#ondownloadfailed)在下载失败时 触发，可通过[WebDownloadItem.serialize](../../apis-default/arkts-apis/arkts-webview-webdownloaditem-c.md#serialize)保存失败任务以便后续恢复。
...
> **说明：**
> 
> 处于PENDING状态的下载任务会首先将文件保存至临时目录。在调用[WebDownloadItem.start](../../apis-default/arkts-apis/arkts-webview-webdownloaditem-c.md#start)并指定目标路径后，临时文件将被重命名
> 为目标文件名，未完成下载的部分将直接下载到目标路径。若希望避免在调用WebDownloadItem.start前生成临时文件，可先通过
> [WebDownloadItem.cancel](../../apis-default/arkts-apis/arkts-webview-webdownloaditem-c.md#cancel)来取消当前的下载任务，之后再使用
> [WebDownloadManager.resumeDownload](../../apis-default/arkts-apis/arkts-webview-webdownloadmanager-c.md#resumedownload)来恢复被取消的下载任务。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | [Callback](../../apis-basic-services-kit/arkts-apis/arkts-basicservices-base-callback-i.md)&lt;[WebDownloadItem](../../apis-default/arkts-apis/arkts-webview-webdownloaditem-c.md)&gt; | 是 | 下载开始前的回调。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | [Callback](../../apis-basic-services-kit/arkts-apis/arkts-basicservices-base-callback-i.md)&lt;[WebDownloadItem](../../apis-default/arkts-apis/arkts-webview-webdownloaditem-c.md)&gt; | 是 | 下载失败的回调。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | [Callback](../../apis-basic-services-kit/arkts-apis/arkts-basicservices-base-callback-i.md)&lt;[WebDownloadItem](../../apis-default/arkts-apis/arkts-webview-webdownloaditem-c.md)&gt; | 是 | 下载完成的回调。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | [Callback](../../apis-basic-services-kit/arkts-apis/arkts-basicservices-base-callback-i.md)&lt;[WebDownloadItem](../../apis-default/arkts-apis/arkts-webview-webdownloaditem-c.md)&gt; | 是 | 下载更新的回调。 |
