...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| info | [ConnectionInfo](../../apis-default/arkts-apis/arkts-webwebnativemessagingextensionability-connectioninfo-i.md) | 是 | 连接信息对象。 |
...
**类型：** [WebNativeMessagingExtensionContext](../../apis-default/arkts-apis/arkts-webwebnativemessagingextensioncontext-webnativemessagingextensioncontext-c.md)
