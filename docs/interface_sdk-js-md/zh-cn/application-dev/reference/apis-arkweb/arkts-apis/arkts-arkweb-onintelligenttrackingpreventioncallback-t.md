...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| details | [IntelligentTrackingPreventionDetails](../arkts-components/arkts-arkweb-intelligenttrackingpreventiondetails-i.md) | 是 | callback information of onIntelligentTrackingPrevention. |
