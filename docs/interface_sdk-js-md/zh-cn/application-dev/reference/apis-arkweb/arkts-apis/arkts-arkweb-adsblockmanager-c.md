...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| domainSuffixes | [Array](../../apis-arkts/arkts-apis/arkts-arkts-array-c.md)<string> | 是 | 一组域名列表，如果网页URL与列表中的某个条目匹配，则该网页将被允许使用广告拦截功能。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| domainSuffixes | [Array](../../apis-arkts/arkts-apis/arkts-arkts-array-c.md)<string> | 是 | 一组域名列表，如果网页URL与列表中的某个域名匹配，则该网页将被禁止使用广告拦截功能。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| domainSuffixes | [Array](../../apis-arkts/arkts-apis/arkts-arkts-array-c.md)<string> | 是 | 需要从允许列表中移除的域名后缀列表。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| domainSuffixes | [Array](../../apis-arkts/arkts-apis/arkts-arkts-array-c.md)<string> | 是 | 需要从禁止列表中移除的域名后缀列表。 |
