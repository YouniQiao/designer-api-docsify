...
| 类型 | 说明 |
| --- | --- |
| [Array](../../apis-arkts/arkts-apis/arkts-arkts-array-c.md)<UserAgentBrandVersion> | - Returns the current list of UserAgentBrandVersion. |
...
| 类型 | 说明 |
| --- | --- |
| [Array](../../apis-arkts/arkts-apis/arkts-arkts-array-c.md)<UserAgentFormFactor> | - Returns the form factors. |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| brandVersionList | [Array](../../apis-arkts/arkts-apis/arkts-arkts-array-c.md)<UserAgentBrandVersion> | 是 | The brandVersionList is used to generate User-Agent client hints sec-ch-ua-full-version-list. |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| formFactors | [Array](../../apis-arkts/arkts-apis/arkts-arkts-array-c.md)<UserAgentFormFactor> | 是 | The formFactors is used to generate User-Agent client hints sec-ch-ua-form-factors. |
