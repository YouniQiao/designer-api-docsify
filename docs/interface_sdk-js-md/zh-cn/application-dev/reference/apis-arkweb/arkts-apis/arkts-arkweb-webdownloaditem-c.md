...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| serializedData | [Uint8Array](../../apis-arkts/arkts-apis/arkts-arkts-uint8array-c.md) | 是 | 序列化后的下载。 |

**返回值：**

| 类型 | 说明 |
| --- | --- |
| [WebDownloadItem](arkts-arkweb-webdownloaditem-c.md) | - 从字节数组反序列化为一个WebDownloadItem对象。 |
...
| 类型 | 说明 |
| --- | --- |
| [WebDownloadErrorCode](arkts-arkweb-webdownloaderrorcode-e.md) | - 下载发生错误的时候的错误码。 |
...
| 类型 | 说明 |
| --- | --- |
| [WebDownloadState](arkts-arkweb-webdownloadstate-e.md) | - 下载的状态。 |
...
| 类型 | 说明 |
| --- | --- |
| [Uint8Array](../../apis-arkts/arkts-apis/arkts-arkts-uint8array-c.md) | - 失败的下载序列化后的字节数组。 |
