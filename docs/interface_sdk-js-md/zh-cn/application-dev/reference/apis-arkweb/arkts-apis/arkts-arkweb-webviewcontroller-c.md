...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| hostList | [Array](../../apis-arkts/arkts-apis/arkts-arkts-array-c.md)<string> | 是 | 绕过智能防跟踪功能的域名列表。 |
...
根据指定的缓存key列表清除对应的预获取资源缓存。入参中的缓存key必须是[prefetchResource](arkts-arkweb-webviewcontroller-c.md#prefetchresource-1)指定预获取到的资源缓存key。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| cacheKeyList | [Array](../../apis-arkts/arkts-apis/arkts-arkts-array-c.md)<string> | 是 | 用于后续查询预获取资源缓存的key。仅支持字母和数字，未传入或传入空则取默认值url作为key。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| configuration | [PdfConfiguration](arkts-arkweb-pdfconfiguration-i.md) | 是 | Parameters required for creating a PDF file. |
| callback | [AsyncCallback](../../apis-basic-service-kit/arkts-apis/arkts-basicservices-asynccallback-i.md)<PdfData> | 是 | Callback used to return the data stream of an online PDF file. |
...
| 类型 | 说明 |
| --- | --- |
| [Array](../../apis-arkts/arkts-apis/arkts-arkts-array-c.md)<WebMessagePort> | web消息端口列表。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| schemes | [Array](../../apis-arkts/arkts-apis/arkts-arkts-array-c.md)<WebCustomScheme> | 是 | 自定义协议配置，最多支持同时配置10个自定义协议。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| securityParams | [SecurityParams](arkts-arkweb-securityparams-i.md) | 是 | 参数表示将禁用支持的选项或项目。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| features | [BackForwardCacheSupportedFeatures](arkts-arkweb-backforwardcachesupportedfeatures-c.md) | 是 | 允许使用特定的页面进入前进后退缓存中。 |
...
| 类型 | 说明 |
| --- | --- |
| [ArkWebEngineVersion](arkts-arkweb-arkwebengineversion-e.md) | 返回由[ArkWebEngineVersion](arkts-arkweb-arkwebengineversion-e.md)所定义的当前使用的ArkWeb内核版本。 |
...
| 类型 | 说明 |
| --- | --- |
| [ControllerAttachState](arkts-arkweb-controllerattachstate-e.md) | 绑定状态 |
...
| 类型 | 说明 |
| --- | --- |
| [BackForwardList](arkts-arkweb-backforwardlist-i.md) | 当前Webview的历史信息列表。 |
...
获取页面首屏加载预测信息（详细说明见[BlanklessInfo](arkts-arkweb-blanklessinfo-i.md)），并开始本次加载过渡帧生成，应用根据此信息确定是否需要启用无白屏加载。必须与[setBlanklessLoadingWithKey](arkts-arkweb-webviewcontroller-c.md#setblanklessloadingwithkey-1)接口配套使用，并且必须在触发加载页面的接口之前或在`onLoadIntercept`中调用。需在`WebViewController`与Web组件绑定后才能使用。
...
| 类型 | 说明 |
| --- | --- |
| [BlanklessInfo](arkts-arkweb-blanklessinfo-i.md) | 页面首屏加载预测信息，主要包括首屏相似度预测值，首屏加载耗时预测值，应用需根据此信息来决策是否启用无白屏加载插帧。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | [AsyncCallback](../../apis-basic-service-kit/arkts-apis/arkts-basicservices-asynccallback-i.md)<Array<cert.X509Cert>> | 是 | 通过AsyncCallback异步返回当前网站的X509格式证书。 |
...
| 类型 | 说明 |
| --- | --- |
| [WebHitTestType](arkts-arkweb-webhittesttype-e.md) | 被点击区域的元素类型。 |
...
| 类型 | 说明 |
| --- | --- |
| [HitTestValue](arkts-arkweb-hittestvalue-i.md) | 点击区域的元素信息。 |
...
| 类型 | 说明 |
| --- | --- |
| [MediaPlaybackState](arkts-arkweb-mediaplaybackstate-e.md) | 当前网页的播放状态，具体值为NONE、PLAYING、PAUSED、STOPPED。 |
...
| 类型 | 说明 |
| --- | --- |
| [ScrollOffset](arkts-arkweb-scrolloffset-i.md) | 网页当前的滚动偏移量（不包含过滚动偏移量）。 |
...
| 类型 | 说明 |
| --- | --- |
| [ScrollOffset](arkts-arkweb-scrolloffset-i.md) | 网页当前的滚动偏移量（包含过滚动偏移量）。 |
...
| 类型 | 说明 |
| --- | --- |
| [SecurityLevel](../../apis-arkdata/arkts-apis/arkts-arkdata-securitylevel-e.md) | 当前网页的安全级别，具体值为NONE、SECURE、WARNING、DANGEROUS。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | [AsyncCallback](../../apis-basic-service-kit/arkts-apis/arkts-basicservices-asynccallback-i.md)<boolean> | 是 | 返回查找页面是否存在图像。<br> true表示页面存在图像；false表示页面不存在图像。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| resourceMaps | [Array](../../apis-arkts/arkts-apis/arkts-arkts-array-c.md)<OfflineResourceMap> | 是 | 本地离线资源配置对象，单次调用最大支持注入30个资源，单个资源最大支持10Mb。 |
...
| headers | [Array](../../apis-arkts/arkts-apis/arkts-arkts-array-c.md)<WebHeader> | 否 | URL的附加HTTP请求头。<br>默认值： []。 <br>传入undefined或null会抛出异常错误码401。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | [CreateNativeMediaPlayerCallback](arkts-arkweb-createnativemediaplayercallback-t.md) | 是 | 接管网页媒体播放的回调函数。 |
...
| ports | [Array](../../apis-arkts/arkts-apis/arkts-arkts-array-c.md)<WebMessagePort> | 是 | 要发送的消息端口。 |
...
| postData | [ArrayBuffer](../../apis-arkts/arkts-apis/arkts-arkts-arraybuffer-c.md) | 是 | 使用"POST"方法传递数据。 |
...
| cacheOptions | [CacheOptions](arkts-arkweb-cacheoptions-i.md) | 是 | 用于控制字节码缓存更新。 |
...
| additionalHeaders | [Array](../../apis-arkts/arkts-apis/arkts-arkts-array-c.md)<WebHeader> | 否 | URL的附加HTTP请求头。 |
...
| --- | --- | --- | --- |
| url | string | 是 | 预加载的URL。 |
| additionalHeaders | [Array](../../apis-arkts/arkts-apis/arkts-arkts-array-c.md)<WebHeader> | 否 | URL的附加HTTP请求头。<br>默认值： [] |
| prefetchOptions | [PrefetchOptions](arkts-arkweb-prefetchoptions-c.md) | 否 | 预取行为可以通过 prefetchOptions 进行自定义，包括忽略 Cache-Control: no-store 以及调整节流间隔。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| request | [RequestInfo](../../apis-ability-kit/arkts-apis/arkts-ability-requestinfo-i.md) | 是 | 预获取请求的信息。 |
| additionalHeaders | [Array](../../apis-arkts/arkts-apis/arkts-arkts-array-c.md)<WebHeader> | 否 | 预获取请求的附加HTTP请求头。 <br>传入undefined或null会抛出异常错误码401。 |
...
| methodList | [Array](../../apis-arkts/arkts-apis/arkts-arkts-array-c.md)<string> | 是 | The method of the application side JavaScript object participating in the registration. |
| asyncMethodList | [Array](../../apis-arkts/arkts-apis/arkts-arkts-array-c.md)<string> | 否 | The async method of the application side JavaScript object participating in the registration.<br>**起始版本：** 12 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| state | [Uint8Array](../../apis-arkts/arkts-apis/arkts-arkts-uint8array-c.md) | 是 | 页面状态历史记录序列化数据。 |
...
| --- | --- | --- | --- |
| script | string | 是 | JavaScript脚本。 |
| callback | [AsyncCallback](../../apis-basic-service-kit/arkts-apis/arkts-basicservices-asynccallback-i.md)<string> | 是 | 回调执行JavaScript脚本结果。JavaScript脚本若执行失败或无返回值时，返回null。 |
...
| --- | --- | --- | --- |
| script | string \| ArrayBuffer | 是 | JavaScript脚本。<br>**起始版本：** 10 - 11 |
| callback | [AsyncCallback](../../apis-basic-service-kit/arkts-apis/arkts-basicservices-asynccallback-i.md)<JsMessageExt> | 是 | 回调执行JavaScript脚本结果。 |
...
| 类型 | 说明 |
| --- | --- |
| [Uint8Array](../../apis-arkts/arkts-apis/arkts-arkts-uint8array-c.md) | Web access stack after serialization. |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| engineVersion | [ArkWebEngineVersion](arkts-arkweb-arkwebengineversion-e.md) | 是 | ArkWeb内核版本。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| options | [BackForwardCacheOptions](arkts-arkweb-backforwardcacheoptions-c.md) | 是 | 用来控制Web组件前进后退缓存相关选项。 |
...
| 类型 | 说明 |
| --- | --- |
| [WebBlanklessErrorCode](arkts-arkweb-webblanklesserrorcode-e.md) | 返回接口调用是否成功，具体见[WebBlanklessErrorCode](arkts-arkweb-webblanklesserrorcode-e.md)定义。 |
...
| param | [BlanklessLoadingParam](arkts-arkweb-blanklessloadingparam-i.md) | 是 | The blankless loading parameter.<br>None |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| secureDnsMode | [SecureDnsMode](arkts-arkweb-securednsmode-e.md) | 是 | 使用HTTPDNS的模式。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| pathList | [Array](../../apis-arkts/arkts-apis/arkts-arkts-array-c.md)<string> | 是 | 路径列表 |
...
| type | [ScrollType](arkts-arkweb-scrolltype-e.md) | 否 | 网页可触发的滚动类型，支持缺省配置。<br> - enable为false时，表示禁止ScrollType类型的滚动，当ScrollType缺省时表示禁止所有类型网页滚动。<br> - enable为true时，ScrollType缺省与否，都表示允许所有类型的网页滚动。<br>传入null或undefined时会抛出异常错误码401。 |
...
在Web页面场景，设置全局滚动条模式。不显式调用时，默认为[ScrollbarMode.OVERLAY_LAYOUT_SCROLLBAR](arkts-arkweb-scrollbarmode-e.md)（非常驻滚动条）。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| scrollbarMode | [ScrollbarMode](arkts-arkweb-scrollbarmode-e.md) | 是 | 滚动条模式。 |
...
| handler | [WebSchemeHandler](arkts-arkweb-webschemehandler-c.md) | 是 | Web scheme handler. |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| mode | [SiteIsolationMode](arkts-arkweb-siteisolationmode-e.md) | 是 | The site isolation mode of the application, |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| mode | [WebSoftKeyboardBehaviorMode](arkts-arkweb-websoftkeyboardbehaviormode-e.md) | 是 | The WebSoftKeyboardBehaviorMode of this web. |
...
| --- | --- | --- | --- |
| userAgent | string | 是 | The User-Agent string. |
| hosts | [Array](../../apis-arkts/arkts-apis/arkts-arkts-array-c.md)<string> | 是 | The hosts to which the User-Agent apply. |
...
| --- | --- | --- | --- |
| userAgent | string | 是 | The User-Agent string. |
| metaData | [UserAgentMetadata](arkts-arkweb-useragentmetadata-c.md) | 是 | The UserAgentMetadata for the userAgent. |
...
当没有指定端口port时，该接口等同于[setWebDebuggingAccess](arkts-arkweb-webviewcontroller-c.md#setwebdebuggingaccess-1)接口，ArkWeb会启动一个本地domain socket监听。当指定了端口port时，ArkWeb会启动一个tcp socket监听。这时可以无线调试网页。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| mode | [WebDestroyMode](arkts-arkweb-webdestroymode-e.md) | 是 | web组件销毁模式，默认NORMAL_MODE |
...
| baseName | string | 是 | 生成的离线网页存储位置，该值不能为空。 |
| autoName | boolean | 是 | 决定是否自动生成文件名。<br>false表示按baseName的文件名存储，true表示根据当前URL自动生成文件名，并按baseName的文件目录存储。 |
| callback | [AsyncCallback](../../apis-basic-service-kit/arkts-apis/arkts-basicservices-asynccallback-i.md)<string> | 是 | 返回文件存储路径，保存网页失败会返回null。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| level | [PressureLevel](arkts-arkweb-pressurelevel-e.md) | 是 | 需要清理内存的内存等级。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| info | [SnapshotInfo](arkts-arkweb-snapshotinfo-i.md) | 是 | 全量绘制结果入参。 |
| callback | [AsyncCallback](../../apis-basic-service-kit/arkts-apis/arkts-basicservices-asynccallback-i.md)<SnapshotResult> | 是 | 全量绘制回调结果。 |
