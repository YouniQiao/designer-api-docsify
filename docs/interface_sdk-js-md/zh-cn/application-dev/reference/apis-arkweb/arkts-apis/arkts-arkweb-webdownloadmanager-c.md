...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| webDownloadItem | [WebDownloadItem](arkts-arkweb-webdownloaditem-c.md) | 是 | 待恢复的下载任务。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| delegate | [WebDownloadDelegate](arkts-arkweb-webdownloaddelegate-c.md) | 是 | 用来接收下载进度的委托。 |
