...
触摸事件示例代码参考[onNativeEmbedGestureEvent](arkts-arkweb-web-attribute.md#onnativeembedgestureevent)。

鼠标事件示例代码参考[onNativeEmbedMouseEvent](arkts-arkweb-web-attribute.md#onnativeembedmouseevent)。
