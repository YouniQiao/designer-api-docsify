...
通过框架字符串获取SimpleDateTimeFormat对象。与[getSimpleDateTimeFormatByPattern]\_\_\_JSDOC\_LINK\_DESC\_USD\_0\_\_\_接口获取的对象在格式化后显示差异请参考[SimpleDateTimeFormat.format]\_\_\_JSDOC\_LINK\_DESC\_USD\_1\_\_\_的示例。
