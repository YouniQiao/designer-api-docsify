...
通过框架字符串获取SimpleDateTimeFormat对象。与[getSimpleDateTimeFormatByPattern](../../apis-default/arkts-apis/arkts-i18n-getsimpledatetimeformatbypattern-f.md)接口获 取的对象在格式化后显示差异请参考[SimpleDateTimeFormat.format](../../apis-default/arkts-apis/arkts-i18n-simpledatetimeformat-c.md#format)的示例。
...
| 类型 | 说明 |
| --- | --- |
| [SimpleDateTimeFormat](../../apis-default/arkts-apis/arkts-i18n-simpledatetimeformat-c.md) | SimpleDateTimeFormat对象。 |
...
**替代接口：** [getSimpleDateTimeFormatBySkeleton](../../apis-default/arkts-apis/arkts-i18n-getsimpledatetimeformatbyskeleton-f.md)(skeleton: string, locale?: Intl.Locale)
