...
**替代接口：** [I18NUtil](arkts-localization-i18nutil-c.md)
...
**替代接口：** [unitConvert](arkts-localization-i18nutil-c.md#unitconvert-1)
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| fromUnit | [UnitInfo](arkts-localization-unitinfo-i.md) | 是 | 要被转换的单位。 |
| toUnit | [UnitInfo](arkts-localization-unitinfo-i.md) | 是 | 要转换为的单位。 |
