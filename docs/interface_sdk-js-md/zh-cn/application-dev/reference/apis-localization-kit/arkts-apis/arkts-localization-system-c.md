...
| 类型 | 说明 |
| --- | --- |
| [WeekDay](arkts-localization-weekday-e.md) | 周起始日。 |
...
| 类型 | 说明 |
| --- | --- |
| [Array](../../apis-arkts/arkts-apis/arkts-arkts-array-c.md)<string> | language参数指定的语言下，系统支持的国家/地区列表。 |
...
| 类型 | 说明 |
| --- | --- |
| [Array](../../apis-arkts/arkts-apis/arkts-arkts-array-c.md)<string> | 系统支持的语言列表。 |
...
> [System.getSystemLocaleInstance](arkts-localization-system-c.md#getsystemlocaleinstance-1)代替。  
> 获取系统当前设置的区域。
...
**替代接口：** [getSystemLocaleInstance](arkts-localization-system-c.md#getsystemlocaleinstance-1)
...
| 类型 | 说明 |
| --- | --- |
| [TemperatureType](arkts-localization-temperaturetype-e.md) | 温度单位。 |
