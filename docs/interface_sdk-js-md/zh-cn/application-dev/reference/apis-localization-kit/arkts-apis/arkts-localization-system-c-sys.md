...
| 类型 | 说明 |
| --- | --- |
| [Map](../../apis-arkts/arkts-apis/arkts-arkts-map-c.md)<string, string> | 系统支持的排序方式及名称。其中Map的key为表示排序方式的字符串，value为表示排序方式对应名称的字符串。支持的范围和系统语言相关。 |
...
| 类型 | 说明 |
| --- | --- |
| [Map](../../apis-arkts/arkts-apis/arkts-arkts-map-c.md)<string, string> | 系统支持的度量衡及其名称。其中Map的key表示度量衡的标识，value表示度量衡的名称。支持的度量衡如下：  - metric：公制。  - uksystem：英制。  - ussystem：美制。 |
...
| 类型 | 说明 |
| --- | --- |
| [Map](../../apis-arkts/arkts-apis/arkts-arkts-map-c.md)<string, string> | 系统支持的数字格式及示例。其中Map的key表示数字格式，是千分符和小数分隔符的unicode编码，value表示数字格式对应的示例。支持的范围和系统语言地区相关。 |
...
| 类型 | 说明 |
| --- | --- |
| [Map](../../apis-arkts/arkts-apis/arkts-arkts-map-c.md)<string, string> | 系统支持的数字系统及示例。其中Map的key为表示数字系统的字符串，value为表示数字系统对应的示例。支持的范围和系统语言相关。 |
...
| 类型 | 说明 |
| --- | --- |
| [Map](../../apis-arkts/arkts-apis/arkts-arkts-map-c.md)<string, string> | 获取系统支持的数字日期格式及其示例。其中Map的key表示数字日期格式，形如dd/MM/y；value表示数字日期示例，形如18/07/2025。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| type | [WeekDay](arkts-localization-weekday-e.md) | 是 | 周期起始日。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| type | [TemperatureType](arkts-localization-temperaturetype-e.md) | 是 | 温度单位。 |
