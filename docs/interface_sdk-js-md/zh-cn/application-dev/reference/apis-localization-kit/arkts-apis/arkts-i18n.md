...
本模块提供系统相关的以及增强的[国际化](../../../internationalization/i18n-l10n.md)能力，包括区域管理、电话号码处理、日历等，相关接口为 [ECMA 402](https://dev.ecma-international.org/publications-and-standards/standards/ecma-402/)标准中未定义的补充接口。 [国际化-Intl](../../apis-default/arkts-apis/arkts-intl.md)模块提供了ECMA 402标准定义的基础国际化接口，与本模块共同使用可提供完整的国际化能力。接口中使用的名词定义如下：
...
| [getSimpleDateTimeFormatByPattern](arkts-localization-i18n-getsimpledatetimeformatbypattern-f.md) | 通过模式字符串获取SimpleDateTimeFormat对象。与[getSimpleDateTimeFormatBySkeleton](../../apis-default/arkts-apis/arkts-i18n-getsimpledatetimeformatbyskeleton-f.md)接 口获取的对象在格式化后显示差异请参考[SimpleDateTimeFormat.format](../../apis-default/arkts-apis/arkts-i18n-simpledatetimeformat-c.md#format)的示例。 |
| [getSimpleDateTimeFormatByPattern](arkts-localization-i18n-getsimpledatetimeformatbypattern-f.md) | 通过模式字符串获取SimpleDateTimeFormat对象。与[getSimpleDateTimeFormatBySkeleton](../../apis-default/arkts-apis/arkts-i18n-getsimpledatetimeformatbyskeleton-f.md)接 口获取的对象在格式化后显示差异请参考[SimpleDateTimeFormat.format](../../apis-default/arkts-apis/arkts-i18n-simpledatetimeformat-c.md#format)的示例。 |
| [getSimpleDateTimeFormatBySkeleton](arkts-localization-i18n-getsimpledatetimeformatbyskeleton-f.md) | 通过框架字符串获取SimpleDateTimeFormat对象。与[getSimpleDateTimeFormatByPattern](../../apis-default/arkts-apis/arkts-i18n-getsimpledatetimeformatbypattern-f.md)接口获 取的对象在格式化后显示差异请参考[SimpleDateTimeFormat.format](../../apis-default/arkts-apis/arkts-i18n-simpledatetimeformat-c.md#format)的示例。 |
| [getSimpleDateTimeFormatBySkeleton](arkts-localization-i18n-getsimpledatetimeformatbyskeleton-f.md) | 通过框架字符串获取SimpleDateTimeFormat对象。与[getSimpleDateTimeFormatByPattern](../../apis-default/arkts-apis/arkts-i18n-getsimpledatetimeformatbypattern-f.md)接口获 取的对象在格式化后显示差异请参考[SimpleDateTimeFormat.format](../../apis-default/arkts-apis/arkts-i18n-simpledatetimeformat-c.md#format)的示例。 |
...
| [getSystemLocale](arkts-localization-i18n-getsystemlocale-f.md) | > [System.getSystemLocale](../../apis-default/arkts-apis/arkts-i18n-system-c.md#getsystemlocaleinstance)代替。 > 获取系统区域ID。 |
...
| [ChineseCalendar](arkts-localization-i18n-chinesecalendar-c.md) | 提供农历相关的能力，包括设置农历时间、判断指定年份某月是否存在闰月。 继承自[Calendar](../../apis-default/arkts-apis/arkts-i18n-calendar-c.md)，支持[Calendar](../../apis-default/arkts-apis/arkts-i18n-calendar-c.md)的方法。 |
