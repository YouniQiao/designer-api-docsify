...
提供农历相关的能力，包括设置农历时间、判断指定年份某月是否存在闰月。 继承自[Calendar](../../apis-na/arkts-apis/arkts-na-i18n-calendar-c.md#Calendar)，支持[Calendar](../../apis-na/arkts-apis/arkts-na-i18n-calendar-c.md#Calendar)的方法。

**继承/实现关系：** ChineseCalendar extends [Calendar](../../apis-na/arkts-apis/arkts-na-i18n-calendar-c.md#Calendar)
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| chineseCalendarTime | [ChineseCalendarTime](../../apis-na/arkts-apis/arkts-na-i18n-chinesecalendartime-i.md) | 是 | 农历时间对象。 |
