...
| options | [LocaleOptions](arkts-localization-localeoptions-i.md) | 否 | 创建区域对象的配置项。<br>默认值：所有属性都取默认值时的配置项。<br>**起始版本：** 12 |
...
| 类型 | 说明 |
| --- | --- |
| [Locale](arkts-localization-locale-c.md) | 补齐完脚本、国家地区信息后的区域对象。 |
...
| 类型 | 说明 |
| --- | --- |
| [Locale](arkts-localization-locale-c.md) | 移除完脚本、国家地区信息后的区域对象。 |
