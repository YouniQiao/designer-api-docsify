...
| cert | [Uint8Array](../../apis-arkts/arkts-apis/arkts-arkts-uint8array-c.md) | 是 | 表示证书数据。 |
| property | [CertificateDialogProperty](arkts-devicecertificate-certificatedialogproperty-i.md) | 是 | 表示打开证书管理对话框的属性。 |
