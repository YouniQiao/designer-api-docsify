...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| handle | [Uint8Array](../../apis-arkts/arkts-apis/arkts-arkts-uint8array-c.md) | 是 | 表示初始化操作返回的句柄，。<br>最大长度为8。 |
| callback | [AsyncCallback](../../apis-basic-service-kit/arkts-apis/arkts-basicservices-asynccallback-i.md)<void> | 是 | 回调函数。当中止签名、验签成功时，err为null，否则为错误对象。 |
