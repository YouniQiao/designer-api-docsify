...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| cert | [Uint8Array](../../apis-arkts/arkts-apis/arkts-arkts-uint8array-c.md) | 是 | 表示CA证书数据，<br>最大长度为8196字节。 |
| certScope | [CertScope](arkts-devicecertificate-certscope-e.md) | 是 | 表示CA证书安装的位置。 |

**返回值：**

| 类型 | 说明 |
| --- | --- |
| [CMResult](arkts-devicecertificate-cmresult-i.md) | 表示CA证书的安装结果，返回值为CMResult对象中的uri属性。 |
