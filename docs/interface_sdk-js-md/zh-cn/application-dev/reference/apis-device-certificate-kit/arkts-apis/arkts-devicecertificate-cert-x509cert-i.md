...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | \_\_\_MD\_LINK\_USD\_0\_\_\_&lt;EncodingBlob&gt; | 是 | 回调函数。当获取X.509证书序列化数据成功时，err为undefined，data为 获取到的X.509证书序列化数据；否则为错误对象。 |
...
表示获取X.509证书序列号。
    **说明：**  
    ...
    [X509Cert.getCertSerialNumber()]\_\_\_JSDOC\_LINK\_DESC\_USD\_0\_\_\_替代。
