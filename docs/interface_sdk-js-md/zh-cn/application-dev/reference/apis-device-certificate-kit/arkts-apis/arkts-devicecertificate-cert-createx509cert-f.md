...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| inStream | \_\_\_MD\_LINK\_USD\_0\_\_\_ | 是 | X.509证书序列化数据。 |
| callback | \_\_\_MD\_LINK\_USD\_0\_\_\_&lt;X509Cert&gt; | 是 | 回调函数。当创建X.509证书对象成功时，err为undefined，data为获取到的 X509Cert实例；否则为错误对象。 |
