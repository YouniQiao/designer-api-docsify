...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| param | \_\_\_MD\_LINK\_USD\_0\_\_\_ | 是 | 表示校验X.509证书链的参数。 |
...
| --- | --- | --- | --- |
| param | \_\_\_MD\_LINK\_USD\_0\_\_\_ | 是 | 表示校验X.509证书链的参数。 |
| callback | \_\_\_MD\_LINK\_USD\_0\_\_\_&lt;CertChainValidationResult&gt; | 是 | 回调函数。当校验证书链成功时，err为undefined， data为获取到的证书链校验结果；否则为错误对象。 |
