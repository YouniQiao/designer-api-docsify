...
| 名称 | 说明 |
| --- | --- |
| [scanFile(Identify sensitive file)](arkts-dataprotection-identifysensitivecontent-scanfile-f.md) | 根据设置的策略，识别指定文件中的敏感内容，返回识别的结果数组，包含匹配的敏感标签、匹配内容及匹配数量。使用Promise异步回调。 |
