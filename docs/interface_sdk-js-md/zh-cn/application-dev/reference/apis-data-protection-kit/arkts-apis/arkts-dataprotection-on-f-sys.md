...
调用on注册监听后，建议在不需要监听时调用[off](arkts-dataprotection-off-f-sys.md#off-2)取消监听释放资源。
...
| listener | [Callback](../../apis-arkui/arkts-components/arkts-arkui-callback-i.md)<DLPSandboxState> | 是 | 回调函数，用于接收沙箱应用卸载事件。 |
