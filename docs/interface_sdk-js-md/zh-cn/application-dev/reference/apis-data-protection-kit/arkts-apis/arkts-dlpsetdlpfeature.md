...
| 名称 | 说明 |
| --- | --- |
| [setDlpFeature(设置数据防泄漏入口)](arkts-dataprotection-dlpsetdlpfeature-setdlpfeature-f-sys.md) | 设置DLP特性开关状态。使用Promise异步回调。调用成功后，DLP特性开关将设置为指定状态，系统将根据该状态启用或禁用DLP保护功能。 |
<!--DelEnd-->
