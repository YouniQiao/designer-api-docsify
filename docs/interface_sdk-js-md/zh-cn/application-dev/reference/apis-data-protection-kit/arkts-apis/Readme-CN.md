...
- [@ohos.dlpPermission(数据防泄露)](arkts-dataprotection-dlppermission.md)
  ...
  <!--Del-->
  - [DLPSandboxInfo(系统接口)](arkts-dataprotection-dlppermission-dlpsandboxinfo-i-sys.md)<!--DelEnd-->
  <!--Del-->
...
- [@ohos.dlpSetDlpFeature(设置数据防泄露入口)](arkts-dataprotection-dlpsetdlpfeature.md)<!--DelEnd-->
  ...
  <!--Del-->
  - [DLPFeatureInfo(系统接口)](arkts-dataprotection-dlpsetdlpfeature-dlpfeatureinfo-i-sys.md)<!--DelEnd-->
  <!--Del-->
...
- [@ohos.security.identifySensitiveContent(Identify sensitive file)](arkts-dataprotection-security-identifysensitivecontent.md)
