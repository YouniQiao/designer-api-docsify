...
当用户监听到音频会话状态变化事件（即收到[AudioSessionStateChangedEvent]\_\_\_JSDOC\_LINK\_DESC\_USD\_1\_\_\_事件）时，获取相关信息。

此类型表示根据焦点策略对音频会话执行的操作，包括暂停、调整音量等。

详情请参阅文档\_\_\_MD\_LINK\_DESC\_USD\_0\_\_\_。
...
提示音频会话暂停，暂时失去音频焦点。当焦点再次可用时，会收到 AUDIO\_SESSION\_STATE\_CHANGE\_HINT\_RESUME 事件。
...
如果已启用  
[enableMuteSuggestionWhenMixWithOthers]\_\_\_JSDOC\_LINK\_DESC\_USD\_0\_\_\_，此时可以选择执行静音操作。
...
如果已启用  
[enableMuteSuggestionWhenMixWithOthers]\_\_\_JSDOC\_LINK\_DESC\_USD\_0\_\_\_，此时可取消静音。
...
该提示仅在以下条件满足后才会收到：通过接口[setAudioSessionBehavior]\_\_\_JSDOC\_LINK\_DESC\_USD\_0\_\_\_设置参数  
[AudioSessionBehaviorFlags]\_\_\_JSDOC\_LINK\_DESC\_USD\_1\_\_\_.MUTE\_WHEN\_INTERRUPTED，并已调用  
[setAudioSessionScene]\_\_\_JSDOC\_LINK\_DESC\_USD\_2\_\_\_，且音频会话已激活。
