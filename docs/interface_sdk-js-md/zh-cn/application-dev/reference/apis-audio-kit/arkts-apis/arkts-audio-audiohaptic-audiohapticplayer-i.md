...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| type | \_\_\_MD\_LINK\_USD\_0\_\_\_ | 是 | 音振类型。 |
...
| callback | \_\_\_MD\_LINK\_USD\_0\_\_\_&lt;void&gt; | 否 | 回调函数，无返回结果。 |
...
| callback | \_\_\_MD\_LINK\_USD\_0\_\_\_&lt;audio.InterruptEvent&gt; | 否 | 回调函数，返回中断事件信息。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | \_\_\_MD\_LINK\_USD\_0\_\_\_&lt;audio.InterruptEvent&gt; | 否 | Callback used to listen for audio interrupt info. |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | \_\_\_MD\_LINK\_USD\_0\_\_\_&lt;void&gt; | 否 | Callback used to listen for the playback end of stream. |
...
| callback | \_\_\_MD\_LINK\_USD\_0\_\_\_&lt;void&gt; | 是 | 回调函数，无返回结果。 |
...
| callback | \_\_\_MD\_LINK\_USD\_0\_\_\_&lt;audio.InterruptEvent&gt; | 是 | 回调函数，返回中断事件信息。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | \_\_\_MD\_LINK\_USD\_0\_\_\_&lt;audio.InterruptEvent&gt; | 是 | Callback used to listen for audio interrupt info. |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | \_\_\_MD\_LINK\_USD\_0\_\_\_&lt;void&gt; | 是 | Callback used to listen for the playback end of stream. |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| volume | ArkTS-Dyn: number  \_\_\_HTML\_TAG\_USD\_0\_\_\_ArkTS-Sta：double | 是 | 取值范围为[0.00, 1.00]，其中1.00表示最大音量（100%）。 |
