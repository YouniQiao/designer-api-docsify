...
在使用AudioRoutingManager的接口之前，需先通过[getRoutingManager](arkts-audio-audiomanager-i.md#getroutingmanager-1)获取AudioRoutingManager实例。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| deviceTypes | [DeviceTypeArray](arkts-audio-devicetypearray-t.md) | 是 | [DeviceType](arkts-audio-devicetype-e.md)数组。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| deviceUsage | [DeviceUsage](arkts-audio-deviceusage-e.md) | 是 | 音频设备类型（根据用途分类）。 |

**返回值：**

| 类型 | 说明 |
| --- | --- |
| [AudioDeviceDescriptors](arkts-audio-audiodevicedescriptors-t.md) | 返回设备列表。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| deviceFlag | [DeviceFlag](arkts-audio-deviceflag-e.md) | 是 | 音频设备类型。 |
| callback | [AsyncCallback](../../apis-basic-service-kit/arkts-apis/arkts-basicservices-asynccallback-i.md)<AudioDeviceDescriptors> | 是 | 回调函数。当获取音频设备列表成功，err为undefined，data为获取到的音频设备列表；否则为错误对象。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| rendererInfo | [AudioRendererInfo](arkts-audio-audiorendererinfo-i.md) | 是 | 音频渲染器信息。 |
| callback | [AsyncCallback](../../apis-basic-service-kit/arkts-apis/arkts-basicservices-asynccallback-i.md)<AudioDeviceDescriptors> | 是 | 回调函数。当获取优先级最高的输出设备成功，err为undefined，data为获取到的优先级最高的输出设备信息；否则为错误对象。 |
...
| callback | [AsyncCallback](../../apis-basic-service-kit/arkts-apis/arkts-basicservices-asynccallback-i.md)<AudioDeviceDescriptors> | 是 | 回调函数。当获取优先级最高的输入设备成功，err为undefined，data为获取到的优先级最高的输入设备信息；否则为错误对象。 |
...
| 类型 | 说明 |
| --- | --- |
| [AudioDeviceDescriptors](arkts-audio-audiodevicedescriptors-t.md) | 返回优先级最高的输入设备信息。 |
...
| 类型 | 说明 |
| --- | --- |
| [AudioDeviceDescriptors](arkts-audio-audiodevicedescriptors-t.md) | 返回优先级最高的输出设备信息。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| deviceType | [CommunicationDeviceType](arkts-audio-communicationdevicetype-e.md) | 是 | 活跃音频设备类型。 |
| callback | [AsyncCallback](../../apis-basic-service-kit/arkts-apis/arkts-basicservices-asynccallback-i.md)<boolean> | 是 | 回调函数。当获取指定通信设备的激活状态成功，err为undefined，data为true表示激活，false表示未激活；否则为错误对象。 |
...
| callback | [Callback](../../apis-arkui/arkts-components/arkts-arkui-callback-i.md)<AudioDeviceDescriptors> | 否 | 回调函数，返回优先级最高的输出设备信息。 |
...
| callback | [Callback](../../apis-arkui/arkts-components/arkts-arkui-callback-i.md)<AudioDeviceDescriptors> | 否 | 回调函数，返回优先级最高的输入设备信息。 |
...
| callback | [Callback](../../apis-arkui/arkts-components/arkts-arkui-callback-i.md)<DeviceBlockStatusInfo> | 否 | 回调函数，返回麦克风被堵塞状态和设备信息。 |
...
| rendererInfo | [AudioRendererInfo](arkts-audio-audiorendererinfo-i.md) | 是 | 音频渲染器信息。 |
| callback | [Callback](../../apis-arkui/arkts-components/arkts-arkui-callback-i.md)<AudioDeviceDescriptors> | 是 | 回调函数，返回优先级最高的输出设备信息。 |
...
| capturerInfo | [AudioCapturerInfo](arkts-audio-audiocapturerinfo-i.md) | 是 | 音频采集器信息。 |
| callback | [Callback](../../apis-arkui/arkts-components/arkts-arkui-callback-i.md)<AudioDeviceDescriptors> | 是 | 回调函数，返回优先级最高的输入设备信息。 |
...
使用此功能前，请使用[isMicBlockDetectionSupported](arkts-audio-audioroutingmanager-i.md#ismicblockdetectionsupported-1)查询设备是否支持检测。应用在使用麦克风录音时，若麦克风堵塞状态发生变化，将触发该事件。目前此检测功能仅支持麦克风位于本地设备上。
...
| callback | [Callback](../../apis-arkui/arkts-components/arkts-arkui-callback-i.md)<DeviceBlockStatusInfo> | 是 | 回调函数，返回麦克风被堵塞状态和设备信息。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| deviceType | [CommunicationDeviceType](arkts-audio-communicationdevicetype-e.md) | 是 | 音频设备类型。 |
| active | boolean | 是 | 是否设置设备为激活状态。true表示激活，false表示未激活。 |
| callback | [AsyncCallback](../../apis-basic-service-kit/arkts-apis/arkts-basicservices-asynccallback-i.md)<void> | 是 | 回调函数。当设置通信设备激活状态成功，err为undefined，否则为错误对象。 |
