...
在使用AudioSessionManager的接口之前，需先通过[getSessionManager]\_\_\_JSDOC\_LINK\_DESC\_USD\_0\_\_\_获取AudioSessionManager实例。
    **说明：**  
...
清空通过[selectMediaInputDevice]\_\_\_JSDOC\_LINK\_DESC\_USD\_0\_\_\_设置的媒体输入设备。使用Promise异步回调。
...
如果启用此功能，当订阅音频会话状态更改事件后静音建议和取消静音建议提示将通过[AudioSessionStateChangedEvent]\_\_\_JSDOC\_LINK\_DESC\_USD\_1\_\_\_回调发送。收到静音建议表示其他应用程序开始播放音频，且播放的音频和本应用的音频不能混音。

此功能仅支持已设置[AudioSessionScene]\_\_\_JSDOC\_LINK\_DESC\_USD\_2\_\_\_并激活模式模式为CONCURRENCY\_MIX\_WITH\_OTHERS的音频会话使用。并且仅在激活音频会话期间生效一次，每次激活音频会话前都必须重新启用。

详细说明请参考\_\_\_MD\_LINK\_DESC\_USD\_0\_\_\_。
...
获取通过  
[setBluetoothAndNearlinkPreferredRecordCategory]\_\_\_JSDOC\_LINK\_DESC\_USD\_0\_\_\_设置的在使用蓝牙或星闪进行录音时的设备偏好分类。
...
| 类型 | 说明 |
| --- | --- |
| \_\_\_MD\_LINK\_USD\_0\_\_\_ |  在使用蓝牙或星闪进行录音时，应用程序的设备偏好分类。 |
...
获取通过[setDefaultOutputDevice]\_\_\_JSDOC\_LINK\_DESC\_USD\_0\_\_\_设置的默认发声设备。
...
| 类型 | 说明 |
| --- | --- |
| \_\_\_MD\_LINK\_USD\_0\_\_\_ |  设备类型。 \_\_\_ESCAPED\_UNDERSCORE\_\_\_\_\_\_ESCAPED\_UNDERSCORE\_\_\_\_\_\_ESCAPED\_UNDERSCORE\_\_\_HTML\_\_\_ESCAPED\_UNDERSCORE\_\_\_TAG\_\_\_ESCAPED\_UNDERSCORE\_\_\_DESC\_\_\_ESCAPED\_UNDERSCORE\_\_\_USD\_\_\_ESCAPED\_UNDERSCORE\_\_\_0\_\_\_ESCAPED\_UNDERSCORE\_\_\_\_\_\_ESCAPED\_UNDERSCORE\_\_\_\_\_\_ESCAPED\_UNDERSCORE\_\_\_仅支持以下设备：EARPIECE（听筒）、SPEAKER（扬声器）和DEFAULT（系统默认设备）。 |
...
获得通过[selectMediaInputDevice]\_\_\_JSDOC\_LINK\_DESC\_USD\_0\_\_\_设置的媒体输入设备。如果没有设置，返回一个deviceType属性为INVALID的设备。
...
| 类型 | 说明 |
| --- | --- |
| \_\_\_MD\_LINK\_USD\_0\_\_\_ |  媒体输入设备信息。 |
...
| callback | \_\_\_MD\_LINK\_USD\_0\_\_\_&lt;AudioSessionDeactivatedEvent&gt; | 否 | 回调函数，返回音频会话停用原因。 |
...
| callback | \_\_\_MD\_LINK\_USD\_0\_\_\_&lt;AudioSessionStateChangedEvent&gt; | 否 | 回调函数，返回音频会话变更提示信息。 |
...
| callback | \_\_\_MD\_LINK\_USD\_0\_\_\_&lt;CurrentOutputDeviceChangedEvent&gt; | 否 | 回调函数，用于返回当前输出设备变化的信息。 |
...
| callback | \_\_\_MD\_LINK\_USD\_0\_\_\_&lt;CurrentInputDeviceChangedEvent&gt; | 否 | 回调函数，用于返回当前输入设备变化的信息。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | \_\_\_MD\_LINK\_USD\_0\_\_\_&lt;AudioSessionDeactivatedEvent&gt; | 否 | Callback invoked for the audio session deactivated event.\_\_\_HTML\_TAG\_USD\_0\_\_\_**起始版本：** 23 |

**错误码：**

| 错误码ID | 错误信息 |
| --- | --- |
| [6800101](../errorcode-audio.md#6800101-无效入参) | Parameter verification failed.\_\_\_HTML\_TAG\_USD\_0\_\_\_**适用版本：** 23+ |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | \_\_\_MD\_LINK\_USD\_0\_\_\_&lt;AudioSessionStateChangedEvent&gt; | 否 | Callback invoked for the audio session state change event. |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | \_\_\_MD\_LINK\_USD\_0\_\_\_&lt;DeviceChangeAction&gt; | 否 | Callback used in subscribe. |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | \_\_\_MD\_LINK\_USD\_0\_\_\_&lt;CurrentInputDeviceChangedEvent&gt; | 否 | Callback used in subscribe. |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | \_\_\_MD\_LINK\_USD\_0\_\_\_&lt;CurrentOutputDeviceChangedEvent&gt; | 否 | Callback used to listen device change event. |
...
| callback | \_\_\_MD\_LINK\_USD\_0\_\_\_&lt;AudioSessionDeactivatedEvent&gt; | 是 | 回调函数，返回音频会话停用原因。 |
...
| --- | --- | --- | --- |
| type | 'audioSessionStateChanged' | 是 | 事件回调类型，支持的事件为'audioSessionStateChanged'，当音频会话状态变更时，触发该事件。 |
| callback | \_\_\_MD\_LINK\_USD\_0\_\_\_&lt;AudioSessionStateChangedEvent&gt; | 是 | 回调函数，返回音频会话变更提示信息。 |
...
| callback | \_\_\_MD\_LINK\_USD\_0\_\_\_&lt;CurrentOutputDeviceChangedEvent&gt; | 是 | 回调函数，返回当前输出设备信息。 |
...
| --- | --- | --- | --- |
| type | 'currentInputDeviceChanged' | 是 | 事件回调类型，支持的事件为'currentInputDeviceChanged'，当前输入设备发生变化时，触发该事件。 |
| callback | \_\_\_MD\_LINK\_USD\_0\_\_\_&lt;CurrentInputDeviceChangedEvent&gt; | 是 | 回调函数，返回当前输入设备信息。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | \_\_\_MD\_LINK\_USD\_0\_\_\_&lt;AudioSessionDeactivatedEvent&gt; | 是 | Callback invoked for the audio session deactivated event.\_\_\_HTML\_TAG\_USD\_0\_\_\_**起始版本：** 23 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | \_\_\_MD\_LINK\_USD\_0\_\_\_&lt;AudioSessionStateChangedEvent&gt; | 是 | Callback invoked for the audio session state change event. |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| deviceUsage | \_\_\_MD\_LINK\_USD\_0\_\_\_ | 是 | Audio device usage to filter available devices. |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | \_\_\_MD\_LINK\_USD\_0\_\_\_&lt;CurrentInputDeviceChangedEvent&gt; | 是 | Callback used to listen input device change event. |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | \_\_\_MD\_LINK\_USD\_0\_\_\_&lt;CurrentOutputDeviceChangedEvent&gt; | 是 | Callback used to listen device change event. |
...
设置媒体输入设备。使用Promise异步回调。
    **说明：**  
    ...
    - 本接口不适用于VoIP通话录音，即[SourceType]\_\_\_JSDOC\_LINK\_DESC\_USD\_0\_\_\_为SOURCE\_TYPE\_VOICE\_COMMUNICATION的场景不适用。  
    
    - 本接口调用前需要先调用[getAvailableDevices]\_\_\_JSDOC\_LINK\_DESC\_USD\_1\_\_\_接口查询到当前可用输入设备列表，从列表中选择输入  
    设备。  
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| inputAudioDevice | \_\_\_MD\_LINK\_USD\_0\_\_\_ | 是 | 媒体输入设备。 |
...
设置音频会话行为参数，支持多种标志位的组合使用。
    **说明：**  
    ...
    当音频会话在激活状态时调用此接口后，必须重新调用接口[activateAudioSession]\_\_\_JSDOC\_LINK\_DESC\_USD\_0\_\_\_使其生效。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| scene | \_\_\_MD\_LINK\_USD\_0\_\_\_ | 是 | 音频会话场景。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| category | \_\_\_MD\_LINK\_USD\_0\_\_\_ | 是 | 在使用蓝牙或星闪进行录音时，应用程序的设备偏好分类。 |
...
应用将当前音频会话内录音流的自身静音状态传递给系统音频模块。\_\_\_MD\_COMMENT\_DESC\_USD\_1\_\_\_该接口不会触发录音流静音，当前仅在部分PC/2in1设备上用于优化设备功耗。\_\_\_MD\_COMMENT\_DESC\_USD\_2\_\_\_使用Promise异步回调。
    **说明：**  
    ...
    - 若某条录音流同时调用了流级接口[AudioCapturer.setMuteHint]\_\_\_JSDOC\_LINK\_DESC\_USD\_0\_\_\_和本接口，流级接口设置优先级更高，以流级接口设置值为准。
...
设置默认发声设备。使用Promise方式进行异步回调。
    **说明：**  
    ...
    - 本接口适用于以下情况：当设置的[AudioSessionScene]\_\_\_JSDOC\_LINK\_DESC\_USD\_0\_\_\_为VoIP场景时，激活AudioSession后立即生效。若  
    [AudioSessionScene]\_\_\_JSDOC\_LINK\_DESC\_USD\_1\_\_\_为非VoIP场景，激活AudioSession时不会生效，仅在启动播放的  
    [StreamUsage]\_\_\_JSDOC\_LINK\_DESC\_USD\_2\_\_\_为语音消息、VoIP语音通话或VoIP视频通话时才生效。支持听筒、扬声器和系统默认设备。  
...
当连接其他音频外设（如蓝牙耳机或有线耳机）时，将媒体输出设备切换为内置扬声器。使用Promise异步回调。
    **说明：**  
    ...
    [CurrentOutputDeviceChangedEvent]\_\_\_JSDOC\_LINK\_DESC\_USD\_0\_\_\_事件获取当前活跃的输出设备。  
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| deviceType | \_\_\_MD\_LINK\_USD\_0\_\_\_ | 是 | 设备类型。 \_\_\_ESCAPED\_UNDERSCORE\_\_\_\_\_\_ESCAPED\_UNDERSCORE\_\_\_\_\_\_ESCAPED\_UNDERSCORE\_\_\_HTML\_\_\_ESCAPED\_UNDERSCORE\_\_\_TAG\_\_\_ESCAPED\_UNDERSCORE\_\_\_DESC\_\_\_ESCAPED\_UNDERSCORE\_\_\_USD\_\_\_ESCAPED\_UNDERSCORE\_\_\_0\_\_\_ESCAPED\_UNDERSCORE\_\_\_\_\_\_ESCAPED\_UNDERSCORE\_\_\_\_\_\_ESCAPED\_UNDERSCORE\_\_\_仅支持以下设备：SPEAKER（扬声器）和DEFAULT（系统默认设备）。 |
