...
[getSystemTonePlayer]\_\_\_JSDOC\_LINK\_DESC\_USD\_0\_\_\_创建实例。
...
调用本接口前，应该先调用[getSupportedHapticsFeatures]\_\_\_JSDOC\_LINK\_DESC\_USD\_0\_\_\_查询支持的振动风格，如果设置不支持的振动风格，则设置失败。
