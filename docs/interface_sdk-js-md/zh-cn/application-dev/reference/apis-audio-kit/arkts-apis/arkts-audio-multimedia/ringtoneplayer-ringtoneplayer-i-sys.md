...
[getRingtonePlayer]\_\_\_JSDOC\_LINK\_DESC\_USD\_0\_\_\_创建实例。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | \_\_\_MD\_LINK\_USD\_0\_\_\_&lt;audio.AudioRendererInfo&gt; | 是 | 回调函数。当获取音频渲染器信息成功，err为 undefined data为获取到的音频渲染器信息；否则为错误对象。 |
