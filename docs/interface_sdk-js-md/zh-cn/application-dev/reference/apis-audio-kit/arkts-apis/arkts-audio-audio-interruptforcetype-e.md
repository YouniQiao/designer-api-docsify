...
当用户监听到音频中断（即收到[InterruptEvent]\_\_\_JSDOC\_LINK\_DESC\_USD\_1\_\_\_事件）时，获取此信息。

此类型表示音频打断是否已由系统强制执行，具体操作信息（如音频暂停、停止等）可通过[InterruptHint]\_\_\_JSDOC\_LINK\_DESC\_USD\_2\_\_\_获取。关于音频打断策略的详细说明可参考文档  
