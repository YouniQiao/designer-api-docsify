...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | \_\_\_MD\_LINK\_USD\_0\_\_\_&lt;SystemRecordControllerChangeInfo&gt; | 否 | 订阅中使用的回调 取消订阅功能。如果不使用此参数，则当前订阅的所有回调 之前的流程将被取消订阅 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | \_\_\_MD\_LINK\_USD\_0\_\_\_&lt;SystemRecordControllerChangeInfo&gt; | 是 | 用于监听的回调 系统记录控制器面板启用状态更改事件 |
