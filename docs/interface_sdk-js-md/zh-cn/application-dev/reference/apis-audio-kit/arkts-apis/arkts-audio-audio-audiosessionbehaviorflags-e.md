...
在AudioRenderer和AudioCapturer场景下，当音频流暂停或恢复时，应用将分别收到[InterruptHint](arkts-audio-audio-interrupthint-e.md).INTERRUPT_HINT_PAUSE 与[InterruptHint](arkts-audio-audio-interrupthint-e.md).INTERRUPT_HINT_RESUME的通知。
