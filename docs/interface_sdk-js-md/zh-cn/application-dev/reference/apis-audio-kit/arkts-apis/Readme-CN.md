...
- [@ohos.multimedia.audio](arkts-multimedia-audio.md)
  ...
  <!--Del-->
  - [createGlobalAudioLoopback(系统接口)](arkts-audio-audio-createglobalaudioloopback-f-sys.md)<!--DelEnd-->
  <!--Del-->
  - [createMicInAudioCapturer(系统接口)](arkts-audio-audio-createmicinaudiocapturer-f-sys.md)<!--DelEnd-->
  <!--Del-->
  ...
  <!--Del-->
  - [ActiveStreamVolumeInfo(系统接口)](arkts-audio-audio-activestreamvolumeinfo-i-sys.md)<!--DelEnd-->
  <!--Del-->
  - [AppIdInfo(系统接口)](arkts-audio-audio-appidinfo-i-sys.md)<!--DelEnd-->
  <!--Del-->
  ...
  <!--Del-->
  - [AudioCapturerChangeInfo(系统接口)](arkts-audio-audio-audiocapturerchangeinfo-i-sys.md)<!--DelEnd-->
  <!--Del-->
  ...
  <!--Del-->
  - [AudioCapturerMicInConfig(系统接口)](arkts-audio-audio-audiocapturermicinconfig-i-sys.md)<!--DelEnd-->
  <!--Del-->
  ...
  <!--Del-->
  - [AudioCapturerOptions(系统接口)](arkts-audio-audio-audiocaptureroptions-i-sys.md)<!--DelEnd-->
  <!--Del-->
  ...
  <!--Del-->
  - [AudioEffectManager(系统接口)](arkts-audio-audio-audioeffectmanager-i-sys.md)<!--DelEnd-->
  <!--Del-->
  - [AudioEffectProperty(系统接口)](arkts-audio-audio-audioeffectproperty-i-sys.md)<!--DelEnd-->
  <!--Del-->
  ...
  <!--Del-->
  - [AudioManager(系统接口)](arkts-audio-audio-audiomanager-i-sys.md)<!--DelEnd-->
  <!--Del-->
  ...
  <!--Del-->
  - [AudioRendererChangeInfo(系统接口)](arkts-audio-audio-audiorendererchangeinfo-i-sys.md)<!--DelEnd-->
  <!--Del-->
  ...
  <!--Del-->
  - [AudioSpatialDeviceState(系统接口)](arkts-audio-audio-audiospatialdevicestate-i-sys.md)<!--DelEnd-->
  <!--Del-->
  ...
  <!--Del-->
  - [SystemRecordControllerChangeInfo(系统接口)](arkts-audio-audio-systemrecordcontrollerchangeinfo-i-sys.md)<!--DelEnd-->
  - [SystemRecordControllerConfig](arkts-audio-audio-systemrecordcontrollerconfig-i.md)
  <!--Del-->
  - [SystemVolumeFilter(系统接口)](arkts-audio-audio-systemvolumefilter-i-sys.md)<!--DelEnd-->
  <!--Del-->
  ...
  <!--Del-->
  - [AsrAecMode(系统接口)](arkts-audio-audio-asraecmode-e-sys.md)<!--DelEnd-->
  <!--Del-->
  - [AsrNoiseSuppressionMode(系统接口)](arkts-audio-audio-asrnoisesuppressionmode-e-sys.md)<!--DelEnd-->
  <!--Del-->
  - [AsrVoiceControlMode(系统接口)](arkts-audio-audio-asrvoicecontrolmode-e-sys.md)<!--DelEnd-->
  <!--Del-->
  - [AsrVoiceMuteMode(系统接口)](arkts-audio-audio-asrvoicemutemode-e-sys.md)<!--DelEnd-->
  <!--Del-->
  ...
  <!--Del-->
  - [AudioSpatialDeviceType(系统接口)](arkts-audio-audio-audiospatialdevicetype-e-sys.md)<!--DelEnd-->
  <!--Del-->
  ...
  <!--Del-->
  - [InterruptRequestResultType(系统接口)](arkts-audio-audio-interruptrequestresulttype-e-sys.md)<!--DelEnd-->
  <!--Del-->
  ...
  <!--Del-->
  - [PolicyType(系统接口)](arkts-audio-audio-policytype-e-sys.md)<!--DelEnd-->
  <!--Del-->
  - [RenderTarget(系统接口)](arkts-audio-audio-rendertarget-e-sys.md)<!--DelEnd-->
  - [SourceType](arkts-audio-audio-sourcetype-e.md)
  <!--Del-->
  - [SourceType(系统接口)](arkts-audio-audio-sourcetype-e-sys.md)<!--DelEnd-->
  <!--Del-->
  ...
  <!--Del-->
  - [StreamUsage(系统接口)](arkts-audio-audio-streamusage-e-sys.md)<!--DelEnd-->
  <!--Del-->
  - [ToneType(系统接口)](arkts-audio-audio-tonetype-e-sys.md)<!--DelEnd-->
  <!--Del-->
  - [VolumeAdjustType(系统接口)](arkts-audio-audio-volumeadjusttype-e-sys.md)<!--DelEnd-->
  <!--Del-->
