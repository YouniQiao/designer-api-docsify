...
在使用AudioVolumeManager的接口之前，需先通过[getVolumeManager]\_\_\_JSDOC\_LINK\_DESC\_USD\_0\_\_\_获取AudioVolumeManager实例。
    **说明：**  
...
| callback | \_\_\_MD\_LINK\_USD\_0\_\_\_&lt;AudioVolumeGroupManager&gt; | 是 | 回调函数。当获取音频组音量管理器实例成功，err为undefined，data为获取到的音频组音量管理器 实例；否则为错误对象。 |
