...
| 错误码ID | 错误信息 |
| --- | --- |
| [6800103](../../../../../../../../gitee_tmp/docs/stamaster/zh-cn/application-dev/reference/apis-audio-kit/errorcode-audio.md#6800103-状态不支持) | Operation not permit at running and release state. |
...
| [6800104](../../../../../../../../gitee_tmp/docs/stamaster/zh-cn/application-dev/reference/apis-audio-kit/errorcode-audio.md#6800104-参数选项不支持) | Current renderer is not supported to set target. |
