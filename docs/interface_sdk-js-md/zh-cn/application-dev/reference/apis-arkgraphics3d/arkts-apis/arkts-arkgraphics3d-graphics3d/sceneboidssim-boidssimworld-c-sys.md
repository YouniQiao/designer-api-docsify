...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| node | \_\_\_MD\_LINK\_USD\_0\_\_\_ | 是 | 要添加组件的节点 |
| param | \_\_\_MD\_LINK\_USD\_0\_\_\_ | 是 | 群组模拟参数 |
...
| --- | --- | --- | --- |
| node | \_\_\_MD\_LINK\_USD\_0\_\_\_ | 是 | 要添加组件的节点 |
| param | \_\_\_MD\_LINK\_USD\_0\_\_\_ | 是 | 引力场参数 |
...
| --- | --- | --- | --- |
| node | \_\_\_MD\_LINK\_USD\_0\_\_\_ | 是 | 要添加组件的节点 |
| param | \_\_\_MD\_LINK\_USD\_0\_\_\_ | 是 | 斥力场参数 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| node | \_\_\_MD\_LINK\_USD\_0\_\_\_ | 是 | 要查询的节点 |

**返回值：**

| 类型 | 说明 |
| --- | --- |
| \_\_\_MD\_LINK\_USD\_0\_\_\_ | 群组模拟参数，如果未找到则返回null |
...
| 类型 | 说明 |
| --- | --- |
| \_\_\_MD\_LINK\_USD\_0\_\_\_ | 引力场参数，如果未找到则返回null |
...
| 类型 | 说明 |
| --- | --- |
| \_\_\_MD\_LINK\_USD\_0\_\_\_ | 斥力场参数，如果未找到则返回null |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| node | \_\_\_MD\_LINK\_USD\_0\_\_\_ | 是 | 要移除组件的节点 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| node | \_\_\_MD\_LINK\_USD\_0\_\_\_ | 是 | 要更新的节点 |
| param | \_\_\_MD\_LINK\_USD\_0\_\_\_ | 是 | 群组模拟参数 |
