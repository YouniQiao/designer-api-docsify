...
**继承/实现关系：** Camera extends [Node](scenenodes-node-i.md)
...
| 类型 | 说明 |
| --- | --- |
| \_\_\_MD\_LINK\_USD\_0\_\_\_ |  相机的投影矩阵 |
...
| 类型 | 说明 |
| --- | --- |
| \_\_\_MD\_LINK\_USD\_0\_\_\_ |  相机的视图矩阵 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| viewPosition | \_\_\_MD\_LINK\_USD\_0\_\_\_ | 是 | 在归一化设备坐标中投射的位置. |
| params | \_\_\_MD\_LINK\_USD\_0\_\_\_ | 是 | 执行射线检测使用的选项. |

**返回值：**

| 类型 | 说明 |
| --- | --- |
| Promise&lt;\_\_\_MD\_LINK\_USD\_0\_\_\_[]&gt; |  返回命中结果数组的Promise，按从近到远排序. 数组可能为空. |
...
背景清除颜色（环境背景会覆盖此颜色,需要BACKGROUND\_NONE才能实际生效).
...
控制渲染管线.请注意，如果选择了FORWARD\_LIGHTWEIGHT管线，某些功能将不可用.
