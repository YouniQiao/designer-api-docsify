...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| reminderReq | [ReminderRequest](arkts-backgroundtasks-reminderagent-reminderrequest-i.md) | 是 | 需要发布的提醒实例。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| reminderReq | [ReminderRequest](arkts-backgroundtasks-reminderagent-reminderrequest-i.md) | 是 | Indicates the reminder instance to publish. |
