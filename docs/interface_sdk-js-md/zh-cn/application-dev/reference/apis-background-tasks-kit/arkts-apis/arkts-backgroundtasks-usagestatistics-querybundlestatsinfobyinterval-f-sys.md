...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| byInterval | \_\_\_MD\_LINK\_USD\_0\_\_\_ | 是 | 查询类型。 |
...
| callback | \_\_\_MD\_LINK\_USD\_0\_\_\_&lt;Array&lt;BundleStatsInfo&gt;&gt; | 是 | 回调函数。 当查询成功，err为undefined，data为指定时间段间隔内，应用使用时长的统计信息；否则为错误对象。 |
