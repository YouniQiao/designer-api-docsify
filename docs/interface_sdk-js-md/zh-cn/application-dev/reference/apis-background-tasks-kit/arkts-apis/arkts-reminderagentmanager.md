...
| [NotificationRequestProxy](arkts-backgroundtasks-notificationrequestproxy-i.md) | 通知请求信息。 |
...
| [TimeZoneType](arkts-backgroundtasks-timezonetype-e.md) | 时区类型。用于时区变更时，按照变更后的时区重新计算提醒的目标时间。 |
