...
应用注册分组变化监听，即用户名下的某个应用分组发生变化时，向所有已注册分组变化监听的应用返回[AppGroupCallbackInfo]\_\_\_JSDOC\_LINK\_DESC\_USD\_0\_\_\_信息。使用Callback异步回调。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| groupCallback | \_\_\_MD\_LINK\_USD\_0\_\_\_&lt;AppGroupCallbackInfo&gt; | 是 | 返回的应用分组变化信息。 |
| callback | \_\_\_MD\_LINK\_USD\_0\_\_\_&lt;void&gt; | 是 | 回调函数。 当注册监听成功，err为undefined；否则为错误对象。 |
...
注册应用分组变化监听，即用户名下的某个应用分组发生变化时，向所有已注册分组变化监听的应用返回[AppGroupCallbackInfo]\_\_\_JSDOC\_LINK\_DESC\_USD\_0\_\_\_信息。使用Promise异步回调。
