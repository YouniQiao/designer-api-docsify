...
值大于0时：如果设置了[ReminderRequest.customRingUri](arkts-backgroundtasks-reminderrequest-i.md)，则在指定的通道[ReminderRequest.ringChannel](arkts-backgroundtasks-reminderrequest-i.md)上响铃。否则使用代理提醒默认的自定义提示音。
