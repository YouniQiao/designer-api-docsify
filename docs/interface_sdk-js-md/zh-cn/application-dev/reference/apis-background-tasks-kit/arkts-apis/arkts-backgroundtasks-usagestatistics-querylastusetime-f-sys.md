...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| appInfo | ArkTS-Dyn: Record&lt;string, Array&lt;number&gt;&gt;  \_\_\_HTML\_TAG\_USD\_0\_\_\_ArkTS-Sta：Record&lt;string, Array&lt;long&gt;&gt; | 是 | 参数为map结构，key是bundleName，value是查询应用的index（可以有多个，通过Array传入）。 |
