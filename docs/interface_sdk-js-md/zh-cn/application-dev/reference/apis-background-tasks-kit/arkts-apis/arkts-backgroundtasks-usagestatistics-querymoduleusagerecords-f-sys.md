...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| maxNum | ArkTS-Dyn: number  \_\_\_HTML\_TAG\_USD\_0\_\_\_ArkTS-Sta：int | 是 | 使用记录的条数，取值范围为[1，1000]。 |
| callback | \_\_\_MD\_LINK\_USD\_0\_\_\_&lt;Array&lt;HapModuleInfo&gt;&gt; | 是 | 回调方法。 当查询成功，err为undefined，data为FA模型下各应用不用Hap包的使用记录（不超过maxNum条）；否则为错误对象。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | \_\_\_MD\_LINK\_USD\_0\_\_\_&lt;Array&lt;HapModuleInfo&gt;&gt; | 是 | 回调函数。 当查询成功，err为undefined，data为FA模型下各应用不用Hap包的使用记录（不超过1000条）；否则为错误对象。 |
