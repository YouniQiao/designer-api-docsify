...
1. 需要调用[usbManager.getDevices]\_\_\_JSDOC\_LINK\_DESC\_USD\_0\_\_\_获取设备列表；2. 调用[usbManager.requestRight]\_\_\_JSDOC\_LINK\_DESC\_USD\_1\_\_\_获取设备请求权限；3. 调用[usbManager.connectDevice]\_\_\_JSDOC\_LINK\_DESC\_USD\_2\_\_\_得到devicepipe作为参数。
