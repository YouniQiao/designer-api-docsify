...
通用回调函数，携带错误参数和异步返回值。错误参数为[BusinessError](arkts-basicservices-base-businesserror-i.md#businesserror)类型的信息。异步返回值的类型由开发者自定义，回调将返回对应类型的信息。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| err | [BusinessError](arkts-basicservices-base-businesserror-i.md)&lt;E&gt; \| null | 是 | 接口调用失败的公共错误信息。 |
