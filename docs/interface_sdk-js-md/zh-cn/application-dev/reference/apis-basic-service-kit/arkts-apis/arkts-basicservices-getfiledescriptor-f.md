...
| 类型 | 说明 |
| --- | --- |
| number | 返回设备对应的文件描述符，失败返回其它错误码如下：* - 88080486：服务初始化中，请稍后重试。* - 88080488：无设备访问权限，请先调用[usbManager.requestRight](arkts-basicservices-requestright-f.md#requestright-1)接口申请授权。* - -1：驱动异常 。 |
