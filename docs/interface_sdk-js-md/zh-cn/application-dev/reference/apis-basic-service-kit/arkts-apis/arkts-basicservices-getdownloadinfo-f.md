...
- 如果下载信息列表中能够找到指定url，返回该url对应的最新[DownloadInfo](arkts-basicservices-downloadinfo-i.md)。  
...
| 类型 | 说明 |
| --- | --- |
| [DownloadInfo](arkts-basicservices-downloadinfo-i.md) | 返回对应url的下载信息，url未记录时返回undefined。 |
