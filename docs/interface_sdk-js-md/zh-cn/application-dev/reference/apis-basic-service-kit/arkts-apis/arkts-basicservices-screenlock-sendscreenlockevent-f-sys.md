...
| parameter | ArkTS-Dyn: number  <br>ArkTS-Sta：int | 是 | operation result of the event. |
| callback | [AsyncCallback](arkts-basicservices-base-asynccallback-i.md)&lt;boolean&gt; | 是 | the callback of sendScreenLockEvent. |
