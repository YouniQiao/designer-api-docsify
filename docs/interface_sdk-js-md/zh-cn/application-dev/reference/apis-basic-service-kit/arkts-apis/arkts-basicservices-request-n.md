...
| [uploadFile](arkts-basicservices-request-uploadfile-f.md#uploadFile) | 创建并启动一个上传任务，使用callback异步回调，支持HTTP协议。通过 [on('complete'\|'fail')](arkts-basicservices-request-uploadtask-i.md#on_progress) 可获取任务上传时的成功信息或错误信息。 |
| [upload](arkts-basicservices-request-upload-f.md#upload) | 创建并启动一个上传任务，使用Promise异步回调。 |
| [uploadFile](arkts-basicservices-request-uploadfile-f.md#uploadFile) | 创建并启动一个上传任务，使用Promise异步回调，支持HTTP协议。通过 [on('complete'\|'fail')](arkts-basicservices-request-uploadtask-i.md#on_progress) 可获取任务上传时的成功信息或错误信息。 |
...
| [TaskState](arkts-basicservices-request-taskstate-i.md) | 上传任务的任务信息，是 [on('complete' \| 'fail')](arkts-basicservices-request-uploadtask-i.md#on_progress) 和 [off('complete' \| 'fail')](arkts-basicservices-request-uploadtask-i.md#off_progress) 接口的回调参数。 |
