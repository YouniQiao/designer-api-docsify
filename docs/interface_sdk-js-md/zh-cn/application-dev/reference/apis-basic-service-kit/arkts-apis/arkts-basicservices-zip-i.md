...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| dest | [ArrayBuffer](../../apis-arkts/arkts-apis/arkts-arkts-arraybuffer-c.md) | 是 | 目标缓冲区。 |
| source | [ArrayBuffer](../../apis-arkts/arkts-apis/arkts-arkts-arraybuffer-c.md) | 是 | 源数据缓冲区。 |
...
| dest | [ArrayBuffer](../../apis-arkts/arkts-apis/arkts-arkts-arraybuffer-c.md) | 是 | 目标缓冲区。 |
| source | [ArrayBuffer](../../apis-arkts/arkts-apis/arkts-arkts-arraybuffer-c.md) | 是 | 源数据缓冲区。 |
| level | [CompressLevel](arkts-basicservices-compresslevel-e.md) | 是 | 参考[CompressLevel枚举定义](arkts-basicservices-compresslevel-e.md)。 |
| sourceLen | number | 否 | 源数据长度。默认值为0。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| strm | [ZStream](arkts-basicservices-zstream-i.md) | 是 | 参考[ZStream定义](arkts-basicservices-zstream-i.md)。 |
| flush | [CompressFlushMode](arkts-basicservices-compressflushmode-e.md) | 是 | 参考[CompressFlushMode定义](arkts-basicservices-compressflushmode-e.md)。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| source | [Zip](arkts-basicservices-zip-i.md) | 是 | 参考[Zip定义](arkts-basicservices-zip-i.md)。 |
...
| --- | --- | --- | --- |
| strm | [ZStream](arkts-basicservices-zstream-i.md) | 是 | 参考[ZStream定义](arkts-basicservices-zstream-i.md)。 |
| dictionary | [ArrayBuffer](../../apis-arkts/arkts-apis/arkts-arkts-arraybuffer-c.md) | 是 | 接收压缩字典的实际内容。 |
...
| strm | [ZStream](arkts-basicservices-zstream-i.md) | 是 | 参考[ZStream定义](arkts-basicservices-zstream-i.md)。 |
| level | [CompressLevel](arkts-basicservices-compresslevel-e.md) | 是 | 参考[CompressLevel枚举定义](arkts-basicservices-compresslevel-e.md)。 |
| method | [CompressMethod](arkts-basicservices-compressmethod-e.md) | 是 | 参考[CompressMethod枚举定义](arkts-basicservices-compressmethod-e.md)。 |
| windowBits | number | 是 | 控制内存窗口的大小，并指定数据的格式（zlib、gzip、raw deflate）。取值如下：<br />zlib格式：[1, 15]。<br />gzip格式：大于15。<br />raw deflate格式：[-15, -1]。 |
| memLevel | [MemLevel](arkts-basicservices-memlevel-e.md) | 是 | 参考[MemLevel枚举定义](arkts-basicservices-memlevel-e.md)。 |
| strategy | [CompressStrategy](arkts-basicservices-compressstrategy-e.md) | 是 | 参考[CompressStrategy枚举定义](arkts-basicservices-compressstrategy-e.md)。 |
...
| --- | --- | --- | --- |
| strm | [ZStream](arkts-basicservices-zstream-i.md) | 是 | 参考[ZStream定义](arkts-basicservices-zstream-i.md)。 |
| dictionary | [ArrayBuffer](../../apis-arkts/arkts-apis/arkts-arkts-arraybuffer-c.md) | 是 | 字典数据。 |
...
| --- | --- | --- | --- |
| strm | [ZStream](arkts-basicservices-zstream-i.md) | 是 | 参考[ZStream定义](arkts-basicservices-zstream-i.md)。 |
| head | [GzHeader](arkts-basicservices-gzheader-i.md) | 是 | 从压缩数据流中提取的gzip头信息。 |
...
| --- | --- | --- | --- |
| strm | [ZStream](arkts-basicservices-zstream-i.md) | 是 | 参考[ZStream定义](arkts-basicservices-zstream-i.md)。 |
| backIn | [InflateBackInputCallback](arkts-basicservices-inflatebackinputcallback-t.md) | 是 | 一种函数，用于从末尾解压缩数据，以从输入源读取原始压缩数据。 |
| inDesc | object | 是 | 通用对象。 |
| backOut | [InflateBackOutputCallback](arkts-basicservices-inflatebackoutputcallback-t.md) | 是 | 将解压缩的数据写入目标输出。 |
...
| strm | [ZStream](arkts-basicservices-zstream-i.md) | 是 | 参考[ZStream定义](arkts-basicservices-zstream-i.md)。 |
| windowBits | number | 是 | 控制内存窗口的大小，并指定数据的格式（zlib、gzip、raw deflate）。取值如下：<br />zlib格式：[1, 15]。<br />gzip格式：大于15。<br />raw deflate格式：[-15, -1]。 |
| window | [ArrayBuffer](../../apis-arkts/arkts-apis/arkts-arkts-arraybuffer-c.md) | 是 | 预设的窗口缓冲区。 |
...
| --- | --- | --- | --- |
| strm | [ZStream](arkts-basicservices-zstream-i.md) | 是 | 参考[ZStream定义](arkts-basicservices-zstream-i.md)。 |
| dictionary | [ArrayBuffer](../../apis-arkts/arkts-apis/arkts-arkts-arraybuffer-c.md) | 是 | 接收解压缩字典的实际内容。 |
...
| --- | --- | --- | --- |
| strm | [ZStream](arkts-basicservices-zstream-i.md) | 是 | 参考[ZStream定义](arkts-basicservices-zstream-i.md)。 |
| header | [GzHeader](arkts-basicservices-gzheader-i.md) | 是 | 从压缩数据流中提取的gzip头信息。 |
