...
| iface | [USBInterface](arkts-basicservices-usbinterface-i.md) | 是 | 用于确定需要释放接口的索引，需要调用[usbManager.getDevices](arkts-basicservices-getdevices-f.md#getdevices-1)获取设备信息并通过id确定唯一接口。 |
