...
| type | 'spooler\_closed\_for\_cancelled' \| 'spooler\_closed\_for\_started' | 是 | 表示spooler关闭信息。 |
| callback | \_\_\_MD\_LINK\_USD\_0\_\_\_&lt;void&gt; | 是 | 异步将spooler关闭信息通知打印服务之后的回调。 |
