...
| 名称 | 说明 |
| --- | --- |
| [bulkTransfer](arkts-basicservices-bulktransfer-f.md#bulktransfer-1) | 批量传输。使用Promise异步回调。 |
...
| [getDevices](arkts-basicservices-getdevices-f.md#getdevices-1) | 获取接入主设备的USB设备列表。 |
...
| [releaseInterface](arkts-basicservices-releaseinterface-f.md#releaseinterface-1) | 释放claim过的通信接口。 |
...
| [setInterface](arkts-basicservices-setinterface-f.md#setinterface-1) | 设置设备接口。 |
| [usbCancelTransfer](arkts-basicservices-usbcanceltransfer-f.md#usbcanceltransfer-1) | 取消异步传输请求。 |
| [usbControlTransfer](arkts-basicservices-usbcontroltransfer-f.md#usbcontroltransfer-1) | 控制传输。使用Promise异步回调。 |
| [usbSubmitTransfer](arkts-basicservices-usbsubmittransfer-f.md#usbsubmittransfer-1) | 提交异步传输请求。 |
