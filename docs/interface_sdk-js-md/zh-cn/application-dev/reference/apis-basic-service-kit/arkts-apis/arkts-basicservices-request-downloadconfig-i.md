...
- FA模型下使用  
\_\_\_MD\_LINK\_DESC\_USD\_0\_\_\_方法获取应用存储路径。

- Stage模型下使用[Context (Stage模型的上下文基类)]\_\_\_JSDOC\_LINK\_DESC\_USD\_1\_\_\_中AbilityContext的类获取文件路径。
...
设置允许下载的网络类型，通过  
\_\_\_MD\_LINK\_DESC\_USD\_0\_\_\_的位运算方式决定允许的网络类型，支持如下几种设置方式:
