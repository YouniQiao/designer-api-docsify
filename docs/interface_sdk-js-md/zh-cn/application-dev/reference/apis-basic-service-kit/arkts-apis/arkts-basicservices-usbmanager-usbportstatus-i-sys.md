...
当前设备数据传输角色，取值参见[DataRoleType](arkts-basicservices-usbmanager-dataroletype-e-sys.md#dataroletype系统接口)。
...
当前的USB模式，取值参见[PortModeType](arkts-basicservices-usbmanager-portmodetype-e-sys.md#portmodetype系统接口)。
...
当前设备电源角色，取值参见[PowerRoleType](arkts-basicservices-usbmanager-powerroletype-e-sys.md#powerroletype系统接口)。
