...
| [setDate](arkts-basicservices-setdate-f.md#setdate-1) | 设置系统日期，使用callback异步回调。 |
| [setDate](arkts-basicservices-setdate-f.md#setdate-2) | 设置系统日期，使用Promise异步回调。 |
| [setTime](arkts-basicservices-settime-f.md#settime-1) | 设置系统时间，使用callback异步回调。 |
| [setTime](arkts-basicservices-settime-f.md#settime-2) | 设置系统时间，使用Promise异步回调。 |
| [setTimezone](arkts-basicservices-settimezone-f.md#settimezone-1) | 设置系统时区，使用callback异步回调。 |
| [setTimezone](arkts-basicservices-settimezone-f.md#settimezone-2) | 使用Promise异步回调设置系统时区。 |
