...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| mode | [DevicePowerMode](arkts-basicservices-devicepowermode-e.md) | 是 | 电源模式；该参数类型是一个枚举类。 |
| callback | [AsyncCallback](arkts-basicservices-asynccallback-i.md)<void> | 是 | 回调函数。当设置电源模式成功，err为undefined，否则为错误对象。 |
