...
| [on](arkts-basicservices-selectionmanager-on-f.md#on) | 订阅划词完成事件，与  [off('selectionCompleted')](../../apis-user-authentication-kit/arkts-apis/arkts-userauthentication-userauth-authinstance-i.md#off)搭配使用取消订阅。 |
