...
\_\_\_INLINE\_CODE\_DESC\_USD\_0\_\_\_基类提供两个关键成员：\_\_\_INLINE\_CODE\_DESC\_USD\_1\_\_\_方法与\_\_\_INLINE\_CODE\_DESC\_USD\_2\_\_\_属性。\_\_\_INLINE\_CODE\_DESC\_USD\_3\_\_\_属性类型为 StaticSubscriberExtensionContext，是扩展能力的运行上下文，继承自\_\_\_INLINE\_CODE\_DESC\_USD\_4\_\_\_，提供\_\_\_INLINE\_CODE\_DESC\_USD\_5\_\_\_方法用于在事件处理过程中拉起同应用内的其他 Ability。

**API 组合使用关系说明：**

本模块典型使用流程为"继承基类 → 重写\_\_\_INLINE\_CODE\_DESC\_USD\_6\_\_\_ → 系统拉起回调 → 读取事件数据 → 拉起目标 Ability"。需注意，\_\_\_INLINE\_CODE\_DESC\_USD\_7\_\_\_仅能拉起与当前\_\_\_INLINE\_CODE\_DESC\_USD\_8\_\_\_属于同一应用的 Ability。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| event | \_\_\_MD\_LINK\_USD\_0\_\_\_ | 是 | 静态订阅接收到的公共事件数据。 |
