...
表示设备ID，用于限制订阅者只接收来自指定设备发布的公共事件。通过[@ohos.deviceInfo]\_\_\_JSDOC\_LINK\_DESC\_USD\_0\_\_\_获取udid，作为发布者的设备ID。预留能力，暂不支持。
...
[getOsAccountLocalId]\_\_\_JSDOC\_LINK\_DESC\_USD\_0\_\_\_获取系统用户ID，作为发布者的用户ID。
