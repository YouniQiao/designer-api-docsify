...
添加有序公共事件的中止状态。当该接口与  
[finishCommonEvent]\_\_\_JSDOC\_LINK\_DESC\_USD\_0\_\_\_配合使用时，可以中止当前的有序公共事件，使该公共事件不再向下一个订阅者传递。使用callback异步回调。
...
添加有序公共事件的中止状态。当该接口与  
[finishCommonEvent]\_\_\_JSDOC\_LINK\_DESC\_USD\_0\_\_\_配合使用时，可以中止当前的有序公共事件，使该公共事件不再向下一个订阅者传递。使用Promise异步回调。
...
[finishCommonEvent]\_\_\_JSDOC\_LINK\_DESC\_USD\_0\_\_\_配合使用时，可以中止当前的有序公共事件，使该公共事件不再向下一个订阅者传递。
...
清理有序公共事件的中止状态。当该接口与  
[finishCommonEvent]\_\_\_JSDOC\_LINK\_DESC\_USD\_0\_\_\_配合使用时，可以使该公共事件继续向下一个订阅者传递。使用callback异步回调。
...
清理有序公共事件的中止状态。当该接口与  
[finishCommonEvent]\_\_\_JSDOC\_LINK\_DESC\_USD\_0\_\_\_配合使用时，可以使该公共事件继续向下一个订阅者传递。使用Promise异步回调。
...
[finishCommonEvent]\_\_\_JSDOC\_LINK\_DESC\_USD\_0\_\_\_配合使用时，可以使该公共事件继续向下一个订阅者传递。
