...
\_\_\_MD\_LINK\_DESC\_USD\_0\_\_\_。本模块提供的具体能力包括：

- 生命周期管理：通过[onConnect]\_\_\_JSDOC\_LINK\_DESC\_USD\_1\_\_\_和  
[onDisconnect]\_\_\_JSDOC\_LINK\_DESC\_USD\_2\_\_\_回调处理连接与断开逻辑。  
- 提供context属性：开发者可通过context调用  
[startAbility]\_\_\_JSDOC\_LINK\_DESC\_USD\_3\_\_\_拉起同应用内的目标Ability，或将context作为[createPanel]\_\_\_JSDOC\_LINK\_DESC\_USD\_4\_\_\_的入参创建划词面板。
    **说明：**  
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| want | \_\_\_MD\_LINK\_USD\_0\_\_\_ | 是 | 连接SelectionExtensionAbility时系统传入的Want对象，包含当前Ability的名称、Bundle名称等描述信息，用于在onConnect回调中获取 Ability连接配置，以便据此执行相应的初始化逻辑。 |
...
[destroyPanel]\_\_\_JSDOC\_LINK\_DESC\_USD\_0\_\_\_销毁已创建的面板、调用  
[off('selectionCompleted')]\_\_\_JSDOC\_LINK\_DESC\_USD\_1\_\_\_取消订阅的划词完成事件等。
...
SelectionExtensionAbility的上下文环境，继承自[ExtensionContext]\_\_\_JSDOC\_LINK\_DESC\_USD\_0\_\_\_。开发者可通过context调用  
[startAbility]\_\_\_JSDOC\_LINK\_DESC\_USD\_1\_\_\_拉起同应用内的目标Ability，或将context作为[createPanel]\_\_\_JSDOC\_LINK\_DESC\_USD\_2\_\_\_的入参创建划词面板。
