...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| printers | [Array](../../apis-arkts/arkts-apis/arkts-arkts-array-c.md)<PrinterInfo> | 是 | 表示新到达的打印机列表。 |
| callback | [AsyncCallback](arkts-basicservices-asynccallback-i.md)<void> | 是 | 异步添加打印机之后的回调。 |
