...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| printers | [Array](../../apis-arkts/arkts-apis/arkts-arkts-array-c.md)<PrinterInfo> | 是 | 表示待更新的打印机列表。 |
| callback | [AsyncCallback](arkts-basicservices-asynccallback-i.md)<void> | 是 | 异步更新打印机信息之后的回调。 |
