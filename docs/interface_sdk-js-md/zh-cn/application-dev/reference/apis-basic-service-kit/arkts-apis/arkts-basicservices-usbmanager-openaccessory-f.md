...
获取配件句柄并打开配件文件描述符。之后可以通过CoreFileKit提供的read/write接口和配件进行通信。需要调用[usbManager.getAccessoryList]\_\_\_JSDOC\_LINK\_DESC\_USD\_0\_\_\_获取配件列表，得到  
[USBAccessory]\_\_\_JSDOC\_LINK\_DESC\_USD\_1\_\_\_作为参数。
