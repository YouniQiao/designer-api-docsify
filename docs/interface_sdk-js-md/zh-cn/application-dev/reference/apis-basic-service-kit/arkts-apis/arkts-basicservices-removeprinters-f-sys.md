...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| printerIds | [Array](../../apis-arkts/arkts-apis/arkts-arkts-array-c.md)<string> | 是 | 表示需移除的打印机列表。 |
| callback | [AsyncCallback](arkts-basicservices-asynccallback-i.md)<void> | 是 | 异步移除打印机之后的回调。 |
