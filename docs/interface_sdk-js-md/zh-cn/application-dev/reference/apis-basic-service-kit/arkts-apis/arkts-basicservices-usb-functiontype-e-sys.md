...
**替代接口：** [FunctionType](arkts-basicservices-usbmanager-functiontype-e-sys.md#functiontype系统接口)
...
**替代接口：** [AUDIO_SOURCE](arkts-basicservices-usbmanager-functiontype-e-sys.md#audiosource)
