...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| accessoryHandle | [USBAccessoryHandle](arkts-basicservices-usbaccessoryhandle-i.md) | 是 | USB配件句柄。需要通过[openAccessory](arkts-basicservices-openaccessory-f.md#openaccessory-1)获取。 |
