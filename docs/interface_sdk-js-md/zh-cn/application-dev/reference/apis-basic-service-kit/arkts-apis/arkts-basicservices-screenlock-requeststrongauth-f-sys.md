...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| reasonFlag | [StrongAuthReasonFlags](arkts-basicservices-screenlock-strongauthreasonflags-e-sys.md) | 是 | The strong authentication reason flag. |
