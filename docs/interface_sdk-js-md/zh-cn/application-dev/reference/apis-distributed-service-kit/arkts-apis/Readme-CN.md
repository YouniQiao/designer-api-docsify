...
- [@ohos.cooperate](arkts-cooperate.md)<!--DelEnd-->
  ...
  <!--Del-->
  - [activateCooperate(系统接口)](arkts-distributedservice-cooperate-activatecooperate-f-sys.md)<!--DelEnd-->
  <!--Del-->
  - [activateCooperateWithOptions(系统接口)](arkts-distributedservice-cooperate-activatecooperatewithoptions-f-sys.md)<!--DelEnd-->
  <!--Del-->
  - [deactivate(系统接口)](arkts-distributedservice-cooperate-deactivate-f-sys.md)<!--DelEnd-->
  <!--Del-->
  - [deactivateCooperate(系统接口)](arkts-distributedservice-cooperate-deactivatecooperate-f-sys.md)<!--DelEnd-->
  <!--Del-->
  - [getCooperateSwitchState(系统接口)](arkts-distributedservice-cooperate-getcooperateswitchstate-f-sys.md)<!--DelEnd-->
  <!--Del-->
  ...
  <!--Del-->
  - [prepareCooperate(系统接口)](arkts-distributedservice-cooperate-preparecooperate-f-sys.md)<!--DelEnd-->
  <!--Del-->
  - [unprepare(系统接口)](arkts-distributedservice-cooperate-unprepare-f-sys.md)<!--DelEnd-->
  <!--Del-->
  - [unprepareCooperate(系统接口)](arkts-distributedservice-cooperate-unpreparecooperate-f-sys.md)<!--DelEnd-->
  <!--Del-->
  - [CooperateMessage(系统接口)](arkts-distributedservice-cooperate-cooperatemessage-i-sys.md)<!--DelEnd-->
  <!--Del-->
  - [CooperateOptions(系统接口)](arkts-distributedservice-cooperate-cooperateoptions-i-sys.md)<!--DelEnd-->
  <!--Del-->
  - [MouseLocation(系统接口)](arkts-distributedservice-cooperate-mouselocation-i-sys.md)<!--DelEnd-->
  <!--Del-->
...
- [@ohos.distributedDeviceManager](arkts-distributeddevicemanager.md)
  ...
  <!--Del-->
  - [DeviceIconInfoFilterOptions(系统接口)](arkts-distributedservice-distributeddevicemanager-deviceiconinfofilteroptions-i-sys.md)<!--DelEnd-->
  <!--Del-->
  - [DeviceIdentification(系统接口)](arkts-distributedservice-distributeddevicemanager-deviceidentification-i-sys.md)<!--DelEnd-->
...
- [@ohos.distributedHardware.deviceManager](arkts-distributedhardware-devicemanager.md)
  ...
  <!--Del-->
  - [AuthInfo(系统接口)](arkts-distributedservice-devicemanager-authinfo-i-sys.md)<!--DelEnd-->
  <!--Del-->
  - [AuthParam(系统接口)](arkts-distributedservice-devicemanager-authparam-i-sys.md)<!--DelEnd-->
  <!--Del-->
  - [DeviceInfo(系统接口)](arkts-distributedservice-devicemanager-deviceinfo-i-sys.md)<!--DelEnd-->
  <!--Del-->
  - [DeviceManager(系统接口)](arkts-distributedservice-devicemanager-devicemanager-i-sys.md)<!--DelEnd-->
  <!--Del-->
  - [PublishInfo(系统接口)](arkts-distributedservice-devicemanager-publishinfo-i-sys.md)<!--DelEnd-->
  <!--Del-->
  - [SubscribeInfo(系统接口)](arkts-distributedservice-devicemanager-subscribeinfo-i-sys.md)<!--DelEnd-->
  <!--Del-->
  - [AuthForm(系统接口)](arkts-distributedservice-devicemanager-authform-e-sys.md)<!--DelEnd-->
  <!--Del-->
  - [DeviceStateChangeAction(系统接口)](arkts-distributedservice-devicemanager-devicestatechangeaction-e-sys.md)<!--DelEnd-->
  <!--Del-->
  - [DeviceType(系统接口)](arkts-distributedservice-devicemanager-devicetype-e-sys.md)<!--DelEnd-->
  <!--Del-->
  - [DiscoverMode(系统接口)](arkts-distributedservice-devicemanager-discovermode-e-sys.md)<!--DelEnd-->
  <!--Del-->
  - [ExchangeFreq(系统接口)](arkts-distributedservice-devicemanager-exchangefreq-e-sys.md)<!--DelEnd-->
  <!--Del-->
...
- [@ohos.distributedHardware.hardwareManager](arkts-distributedhardware-hardwaremanager.md)<!--DelEnd-->
  ...
  <!--Del-->
  - [resumeDistributedHardware(系统接口)](arkts-distributedservice-hardwaremanager-resumedistributedhardware-f-sys.md)<!--DelEnd-->
  <!--Del-->
  - [stopDistributedHardware(系统接口)](arkts-distributedservice-hardwaremanager-stopdistributedhardware-f-sys.md)<!--DelEnd-->
  <!--Del-->
  - [HardwareDescriptor(系统接口)](arkts-distributedservice-hardwaremanager-hardwaredescriptor-i-sys.md)<!--DelEnd-->
  <!--Del-->
...
- [@ohos.distributedsched.abilityConnectionManager](arkts-distributedsched-abilityconnectionmanager.md)
  ...
  <!--Del-->
  - [createStream(系统接口)](arkts-distributedservice-abilityconnectionmanager-createstream-f-sys.md)<!--DelEnd-->
  - [destroyAbilityConnectionSession](arkts-distributedservice-abilityconnectionmanager-destroyabilityconnectionsession-f.md)
  <!--Del-->
  - [destroyStream(系统接口)](arkts-distributedservice-abilityconnectionmanager-destroystream-f-sys.md)<!--DelEnd-->
  ...
  <!--Del-->
  - [sendImage(系统接口)](arkts-distributedservice-abilityconnectionmanager-sendimage-f-sys.md)<!--DelEnd-->
  - [sendMessage](arkts-distributedservice-abilityconnectionmanager-sendmessage-f.md)
  <!--Del-->
  - [setSurfaceId(系统接口)](arkts-distributedservice-abilityconnectionmanager-setsurfaceid-f-sys.md)<!--DelEnd-->
  <!--Del-->
  - [startStream(系统接口)](arkts-distributedservice-abilityconnectionmanager-startstream-f-sys.md)<!--DelEnd-->
  <!--Del-->
  - [stopStream(系统接口)](arkts-distributedservice-abilityconnectionmanager-stopstream-f-sys.md)<!--DelEnd-->
  <!--Del-->
  - [updateSurfaceParam(系统接口)](arkts-distributedservice-abilityconnectionmanager-updatesurfaceparam-f-sys.md)<!--DelEnd-->
  ...
  <!--Del-->
  - [ConnectOptions(系统接口)](arkts-distributedservice-abilityconnectionmanager-connectoptions-i-sys.md)<!--DelEnd-->
  ...
  <!--Del-->
  - [EventCallbackInfo(系统接口)](arkts-distributedservice-abilityconnectionmanager-eventcallbackinfo-i-sys.md)<!--DelEnd-->
  - [PeerInfo](arkts-distributedservice-abilityconnectionmanager-peerinfo-i.md)
  <!--Del-->
  - [StreamParam(系统接口)](arkts-distributedservice-abilityconnectionmanager-streamparam-i-sys.md)<!--DelEnd-->
  <!--Del-->
  - [SurfaceParam(系统接口)](arkts-distributedservice-abilityconnectionmanager-surfaceparam-i-sys.md)<!--DelEnd-->
  ...
  <!--Del-->
  - [FlipOptions(系统接口)](arkts-distributedservice-abilityconnectionmanager-flipoptions-e-sys.md)<!--DelEnd-->
  - [StartOptionParams](arkts-distributedservice-abilityconnectionmanager-startoptionparams-e.md)
  <!--Del-->
  - [StartOptionParams(系统接口)](arkts-distributedservice-abilityconnectionmanager-startoptionparams-e-sys.md)<!--DelEnd-->
  <!--Del-->
