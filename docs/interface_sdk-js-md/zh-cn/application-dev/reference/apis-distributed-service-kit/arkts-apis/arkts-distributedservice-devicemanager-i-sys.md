...
**替代接口：** [getDeviceName](arkts-distributedservice-devicemanager-i.md#getdevicename-1)
...
**替代接口：** [getLocalDeviceNetworkId](arkts-distributedservice-devicemanager-i.md#getlocaldevicenetworkid-1)
...
**替代接口：** getAvailableDeviceList(callback:
...
**替代接口：** [getAvailableDeviceList()](arkts-distributedservice-devicemanager-i.md#getavailabledevicelist-2)
...
**替代接口：** [getAvailableDeviceListSync](arkts-distributedservice-devicemanager-i.md#getavailabledevicelistsync-1)
...
**替代接口：** [releaseDeviceManager](arkts-distributedservice-releasedevicemanager-f.md#releasedevicemanager-1)
...
**替代接口：** [replyUiAction](arkts-distributedservice-devicemanager-i-sys.md#replyuiaction-1)
...
**替代接口：** [stopDiscovering](arkts-distributedservice-devicemanager-i.md#stopdiscovering-1)
...
**替代接口：** [unbindTarget](arkts-distributedservice-devicemanager-i.md#unbindtarget-1)
