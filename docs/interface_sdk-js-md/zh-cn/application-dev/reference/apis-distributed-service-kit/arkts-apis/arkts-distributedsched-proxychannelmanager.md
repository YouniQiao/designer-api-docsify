...
| [offChannelStateChange](arkts-distributedservice-proxychannelmanager-offchannelstatechange-f.md#offchannelstatechange) | 取消订阅通道状态事件。 |
| [offReceiveData](arkts-distributedservice-proxychannelmanager-offreceivedata-f.md#offreceivedata) | 取消订阅数据接收事件，停止接收数据。 |
...
| [onChannelStateChange](arkts-distributedservice-proxychannelmanager-onchannelstatechange-f.md#onchannelstatechange) | 订阅通道状态事件，使用callback进行异步回调。 |
| [onReceiveData](arkts-distributedservice-proxychannelmanager-onreceivedata-f.md#onreceivedata) | 订阅数据接收事件，使用异步回调。 |
