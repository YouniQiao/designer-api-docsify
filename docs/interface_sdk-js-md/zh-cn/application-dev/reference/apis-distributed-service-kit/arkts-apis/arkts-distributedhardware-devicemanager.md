...
[@ohos.distributedDeviceManager]\_\_\_JSDOC\_LINK\_DESC\_USD\_0\_\_\_。本模块提供分布式设备管理能力。系统应用可调用接口实现如下功能：
...
**替代接口：** [@ohos.distributedDeviceManager:distributedDeviceManager](arkts-distributeddevicemanager.md)
