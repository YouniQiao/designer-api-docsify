...
**替代接口：** [setUsbStorageDeviceAccessPolicy](arkts-mdm-setusbstoragedeviceaccesspolicy-f.md#setusbstoragedeviceaccesspolicy-1)
...
| usbPolicy | [UsbPolicy](arkts-mdm-usbpolicy-e.md) | 是 | USB读写策略（此接口只支持READ_WRITE和READ_ONLY）。 |
