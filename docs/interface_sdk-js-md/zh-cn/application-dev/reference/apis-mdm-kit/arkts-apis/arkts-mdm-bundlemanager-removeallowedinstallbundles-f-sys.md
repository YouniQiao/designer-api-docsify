# removeAllowedInstallBundles（系统接口）
...
**替代接口：** [removeAllowedInstallBundlesSync](arkts-mdm-bundlemanager-removeallowedinstallbundlessync-f.md)
...
| 类型 | 说明 |
| --- | --- |
| Promise & lt;void & gt; | 无返回结果的Promise对象。当移除应用程序包安装允许名单失败时，会抛出错误对象。 |
