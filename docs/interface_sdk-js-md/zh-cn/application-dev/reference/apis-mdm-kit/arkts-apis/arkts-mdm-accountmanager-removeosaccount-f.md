...
移除系统账号。当前仅支持手机、平板设备使用，可以移除使用[createNormalOsAccount]\_\_\_JSDOC\_LINK\_DESC\_USD\_0\_\_\_创建的普通系统账号（normal类型）和  
[addOsAccountAsync]\_\_\_JSDOC\_LINK\_DESC\_USD\_1\_\_\_创建的系统账号（admin、normal、guest类型），不可移除默认系统账号（ID为100）。
