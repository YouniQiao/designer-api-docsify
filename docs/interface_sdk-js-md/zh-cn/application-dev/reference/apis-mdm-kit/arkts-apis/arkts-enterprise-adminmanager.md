...
|watermark_image_policy|[securityManager.setWatermarkImage](arkts-mdm-setwatermarkimage-f.md#setwatermarkimage-1)<br>[securityManager.cancelWatermarkImage](arkts-mdm-cancelwatermarkimage-f.md#cancelwatermarkimage-1)|设置水印策略，当前仅支持PC/2in1使用。<br>取消水印策略，当前仅支持PC/2in1使用。|  
