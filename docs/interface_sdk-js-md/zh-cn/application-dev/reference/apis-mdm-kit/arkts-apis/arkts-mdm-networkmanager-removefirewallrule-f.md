...
移除规则后如果不存在[Action]\_\_\_JSDOC\_LINK\_DESC\_USD\_1\_\_\_为ALLOW规则后，会将[addFirewallRule]\_\_\_JSDOC\_LINK\_DESC\_USD\_2\_\_\_添加的默认DENY规则清空。
...
| firewallRule | \_\_\_MD\_LINK\_USD\_0\_\_\_ | 否 | 移除防火墙过滤规则。值为空时，清空所有的防火墙规则。 |
