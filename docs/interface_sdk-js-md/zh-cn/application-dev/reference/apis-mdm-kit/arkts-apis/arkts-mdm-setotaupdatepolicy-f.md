...
设置升级策略。内网升级场景下，需要先调用[systemManager.notifyUpdatePackages](arkts-mdm-notifyupdatepackages-f.md#notifyupdatepackages-1)接口通知系统更新包，再调用该接口设置升级策略。
...
| policy | [OtaUpdatePolicy](arkts-mdm-otaupdatepolicy-i.md) | 是 | 升级策略。 |
