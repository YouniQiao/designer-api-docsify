...
设备打印能力。如果禁用了指定用户的设备打印能力，再启用设备打印能力（[FeatureForDevice.PRINTER]\_\_\_JSDOC\_LINK\_DESC\_USD\_0\_\_\_），该用户下的设备打印能力仍然被禁用。
...
[FeatureForDevice.MTP\_CLIENT]\_\_\_JSDOC\_LINK\_DESC\_USD\_0\_\_\_）时，再禁用某用户MTP客户端写入能力，会报策略冲突。
...
设备间分布式单向传输数据的能力（仅包含向其他设备传输数据）。当已禁用分布式管理服务（[DISTRIBUTED\_TRANSMISSION]\_\_\_JSDOC\_LINK\_DESC\_USD\_0\_\_\_），再禁用设备间分布式单向传输数据的能力，会报策略冲突。
