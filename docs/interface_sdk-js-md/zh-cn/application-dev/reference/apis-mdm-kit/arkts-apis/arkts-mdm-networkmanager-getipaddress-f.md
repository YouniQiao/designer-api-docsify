...
**替代接口：** [networkManager.getIpAddressSync](arkts-mdm-networkmanager-getipaddresssync-f.md#getipaddresssync)
...
| callback | \_\_\_MD\_LINK\_USD\_0\_\_\_&lt;string&gt; | 是 | 回调函数。当接口调用成功，err为null，data为IP地址，否则err为错误对象。 |
