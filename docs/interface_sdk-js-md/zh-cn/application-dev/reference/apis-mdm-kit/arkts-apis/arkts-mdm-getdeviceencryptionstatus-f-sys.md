...
**替代接口：** [getSecurityStatus](arkts-mdm-getsecuritystatus-f.md#getsecuritystatus-1)
...
| 类型 | 说明 |
| --- | --- |
| [DeviceEncryptionStatus](arkts-mdm-deviceencryptionstatus-i-sys.md) | 文件加密状态结构体，现只含有是否进行加密字段（bool）。 |
