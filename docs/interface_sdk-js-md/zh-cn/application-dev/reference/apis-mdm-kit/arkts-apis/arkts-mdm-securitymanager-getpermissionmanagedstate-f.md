...
获取指定应用的指定[user\_grant权限]\_\_\_JSDOC\_LINK\_DESC\_USD\_0\_\_\_的管理策略。
...
| permission | string | 是 | 需要获取管理策略的权限名称，仅支持user\_\_\_ESCAPED\_UNDERSCORE\_\_\_grant权限。 |

**返回值：**

| 类型 | 说明 |
| --- | --- |
| \_\_\_MD\_LINK\_USD\_0\_\_\_ | 应用权限的管理策略。 |
