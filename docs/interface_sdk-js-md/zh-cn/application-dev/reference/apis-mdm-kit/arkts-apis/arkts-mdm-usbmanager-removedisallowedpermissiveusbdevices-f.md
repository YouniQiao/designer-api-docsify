...
移除通过[addDisallowedPermissiveUsbDevices]\_\_\_JSDOC\_LINK\_DESC\_USD\_0\_\_\_接口禁用的USB设备类型。被移除的USB设备类型可恢复正常使用。
...
| usbDevices | Array&lt;PermissiveUsbDeviceType&gt; | 是 | 要移除的USB设备类型的数组。 |
