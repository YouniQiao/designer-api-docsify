...
**替代接口：** [setUserRestrictionForAccount](arkts-mdm-restrictions-setuserrestrictionforaccount-f.md)(admin: Want, settingsItem: SettingsForAccount, accountId: number, restricted: boolean)
