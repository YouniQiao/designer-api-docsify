...
| type | [osAccount.OsAccountType](../../apis-basic-services-kit/arkts-apis/arkts-basicservices-osaccount-osaccounttype-e.md) | 是 | 要添加的账号的类型。<br>取值范围：ADMIN、NORMAL、GUEST。<br>· ADMIN：管理员账号。<br>· NORMAL：普通账号。<br>· GUEST：访客账号。 |
