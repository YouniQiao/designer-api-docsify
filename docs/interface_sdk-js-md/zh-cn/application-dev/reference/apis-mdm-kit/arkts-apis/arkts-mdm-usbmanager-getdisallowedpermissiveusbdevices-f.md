...
获取通过[addDisallowedPermissiveUsbDevices]\_\_\_JSDOC\_LINK\_DESC\_USD\_0\_\_\_接口禁用的USB设备类型。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| admin | \_\_\_MD\_LINK\_USD\_0\_\_\_ \| null | 是 | 企业设备管理扩展组件。Want中必须包含企业设备管理扩展能力的abilityName和所在应用的bundleName。当取值为null时，表示获取当前设备禁止使用的 USB设备类型。 |
