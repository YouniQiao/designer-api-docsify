...
| keyPolicies | [Array](../../apis-arkts/arkts-apis/arkts-arkts-array-c.md)<KeyEventPolicy> | 是 | 按键策略。支持物理按键（电源键、音量加、音量减），导航键（回退、主页、最近打开）。物理键支持任意组合为组合键，导航键不支持组合。组合键事件响应详见[按键事件回调](arkts-mdm-enterpriseadminextensionability-c.md#onkeyevent-1)接口。 |
