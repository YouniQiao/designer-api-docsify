...
添加蓝牙协议至禁用名单。添加后，指定用户将无法根据指定的传输策略使用该禁用名单中的蓝牙协议。
    **说明：**  
    ...
    3. 本接口与[addDisallowedBluetoothProtocols\_\_\_HTML\_TAG\_DESC\_USD\_1\_\_\_20+\_\_\_HTML\_TAG\_DESC\_USD\_2\_\_\_]\_\_\_JSDOC\_LINK\_DESC\_USD\_0\_\_\_接口为  
...
| policy | \_\_\_MD\_LINK\_USD\_0\_\_\_ | 是 | 传输策略,用于指定蓝牙协议的禁用方式。可选值包括:SEND\_\_\_ESCAPED\_UNDERSCORE\_\_\_ONLY(禁止发送)、RECEIVE\_\_\_ESCAPED\_UNDERSCORE\_\_\_ONLY(禁止接收)、RECEIVE\_\_\_ESCAPED\_UNDERSCORE\_\_\_SEND(禁止发送和接收 )。 |
