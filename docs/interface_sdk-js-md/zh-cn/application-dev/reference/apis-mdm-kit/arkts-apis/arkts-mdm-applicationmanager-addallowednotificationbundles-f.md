...
> 2.当已经通过[setDisallowedPolicy](arkts-mdm-restrictions-setdisallowedpolicy-f.md)设置了禁用设备通知能力时，再通
...
| bundleNames | Array & lt;string & gt; | 是 | 应用包名数组，指定允许发送通知的应用。最多支持200个应用。 |
