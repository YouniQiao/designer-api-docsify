...
| [getUserRestrictedForAccount](arkts-mdm-restrictions-getuserrestrictedforaccount-f.md#getuserrestrictedforaccount-1) | 查询是否限制用户使用某用户下的特性 |
...
| [setUserRestrictionForAccount](arkts-mdm-restrictions-setuserrestrictionforaccount-f.md#setuserrestrictionforaccount-1) | 限制用户使用某用户下的特性 |
...
| [SettingsForAccount](arkts-mdm-restrictions-settingsforaccount-e.md) | 用户级设置 |
| [SettingsForDevice](arkts-mdm-restrictions-settingsfordevice-e.md) | 设备设置项 |
