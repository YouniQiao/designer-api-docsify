...
| powerScene | [PowerScene](arkts-mdm-devicesettings-powerscene-e.md) | 是 | 电源策略场景，当前只支持超时场景。 |
| powerPolicy | [PowerPolicy](arkts-mdm-devicesettings-powerpolicy-i.md) | 是 | 电源策略。 |
