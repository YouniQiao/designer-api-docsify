...
**继承/实现关系：** InvalidStoreAccessError extends [Error](arkts-arkts-error-c.md)

**起始版本：** 26.0.0

**ArkTS模式：** 仅支持ArkTS-Sta，起始版本为26.0.0。

<!--Device-unnamed-export class InvalidStoreAccessError extends Error--><!--Device-unnamed-export class InvalidStoreAccessError extends Error-End-->
...
Constructs a new InvalidStoreAccessError instance with provided message and error specific information
