...
| fill | ArkTS-Dyn: string \| [Buffer](arkts-arkts-buffer-buffer-c.md) \| number \| number \| number  <br>ArkTS-Sta：string \| [Buffer](arkts-arkts-buffer-buffer-c.md) \| int \| double \| long | 否 | 填充至新缓冲区的值。默认值：0。<br>**起始版本：** 9 - 10 |
