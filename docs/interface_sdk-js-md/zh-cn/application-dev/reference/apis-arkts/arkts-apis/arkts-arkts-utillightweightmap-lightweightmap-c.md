...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| map | [LightWeightMap](arkts-arkts-utillightweightmap-lightweightmap-c.md)&lt;K, V&gt; | 是 | 用于比较的LightWeightMap对象，判断当前实例是否包含此map中的所有元素。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| map | [LightWeightMap](arkts-arkts-utillightweightmap-lightweightmap-c.md)&lt;K, V&gt; | 是 | 提供添加元素的LightWeightMap。 |
