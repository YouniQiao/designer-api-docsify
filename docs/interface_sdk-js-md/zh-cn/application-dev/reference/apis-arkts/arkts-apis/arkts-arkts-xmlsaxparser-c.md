...
XmlSAXParser类用于以流式方式解析XML文本。适用于需要边读取边处理的场景，支持从[stream.Readable](arkts-arkts-readable-c.md) 流中读取XML数据并进行解析。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| xmlSAXHandler | [XmlSAXHandler](arkts-arkts-xmlsaxhandler-i.md) | 是 | SAX处理器对象。 |
