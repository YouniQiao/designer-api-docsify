...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| array | FixedArray&lt;byte&gt; | 是 | The array to sort. |
| cmp | (lhs: byte, rhs: byte) =&gt; int | 是 | The comparator function. |
| begin | int | 是 | The index to start sorting from. &lt;br&gt;The value should be an integer. |
| end | int | 是 | The index to end sorting at. &lt;br&gt;The value should be an integer. |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| array | FixedArray&lt;short&gt; | 是 | The array to sort. |
| cmp | (lhs: short, rhs: short) =&gt; int | 是 | The comparator function. |
| begin | int | 是 | The index to start sorting from. |
| end | int | 是 | The index to end sorting at. |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| array | FixedArray&lt;int&gt; | 是 | The array to sort. |
| cmp | (lhs: int, rhs: int) =&gt; int | 是 | The comparator function. |
| begin | int | 是 | The index to start sorting from. |
| end | int | 是 | The index to end sorting at. |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| array | FixedArray&lt;long&gt; | 是 | The array to sort. |
| cmp | (lhs: long, rhs: long) =&gt; int | 是 | The comparator function. |
| begin | int | 是 | The index to start sorting from. |
| end | int | 是 | The index to end sorting at. |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| array | FixedArray&lt;float&gt; | 是 | The array to sort. |
| cmp | (lhs: float, rhs: float) =&gt; int | 是 | The comparator function. |
| begin | int | 是 | The index to start sorting from. |
| end | int | 是 | The index to end sorting at. |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| array | FixedArray&lt;double&gt; | 是 | The array to sort. |
| cmp | (lhs: double, rhs: double) =&gt; int | 是 | The comparator function. |
| begin | int | 是 | The index to start sorting from. |
| end | int | 是 | The index to end sorting at. |
