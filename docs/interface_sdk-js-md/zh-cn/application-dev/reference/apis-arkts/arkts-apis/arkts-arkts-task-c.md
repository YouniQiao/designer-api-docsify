...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| tasks | [Task](../../apis-basic-service-kit/arkts-apis/arkts-basicservices-task-i.md)[] | 是 | 被依赖的任务数组。默认值为**undefined**。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | [CallbackFunction](arkts-arkts-callbackfunction-t.md) | 是 | 需注册的回调函数。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | [CallbackFunctionWithError](arkts-arkts-callbackfunctionwitherror-t.md) | 是 | 需注册的回调函数。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| transfer | [ArrayBuffer](arkts-arkts-arraybuffer-c.md)[] | 否 | 可传输对象是ArrayBuffer的实例对象，默认为空数组。 |
