...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| options | [ReadableOptions](arkts-arkts-readableoptions-i.md) | 是 | **Readable**构造函数中的选项。 |
...
| 类型 | 说明 |
| --- | --- |
| [Readable](arkts-arkts-readable-c.md) | 当前**Readable**对象。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| destination | [Writable](arkts-arkts-writable-c.md) | 是 | 接收数据的可写流。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| destination | [Writable](arkts-arkts-writable-c.md) | 否 | 待分离的可写流。默认值为**undefined**。 |
