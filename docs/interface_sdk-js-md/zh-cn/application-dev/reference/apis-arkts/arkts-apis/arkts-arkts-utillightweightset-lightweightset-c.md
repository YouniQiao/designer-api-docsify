...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| set | [LightWeightSet](arkts-arkts-utillightweightset-lightweightset-c.md)&lt;T&gt; | 是 | 提供添加元素的LightWeightSet。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| set | [LightWeightSet](arkts-arkts-utillightweightset-lightweightset-c.md)&lt;T&gt; | 是 | 用于判断当前容器是否包含其所有元素的目标集合。 |
