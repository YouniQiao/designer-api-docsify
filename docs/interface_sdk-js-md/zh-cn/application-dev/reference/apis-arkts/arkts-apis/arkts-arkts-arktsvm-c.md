...
| heapMemoryThreshold | [HeapMemoryThreshold](arkts-arkts-heapmemorythreshold-i.md) | 是 | 表示 GC 后触发回调的堆内存百分比阈值。取值范围为 [70, 95]。 |
...
| options | [MultithreadingDetectionOptions](arkts-arkts-multithreadingdetectionoptions-i.md) | 否 | 可选的配置项。<br>**起始版本：** 26.0.0 |
