...
> **NOTE：**
> 
> - 返回**undefined**时无法直接区分是键不存在还是键存在但值为**undefined**，可在使用本接口前先使用 &gt; **has**接口判断键是否存在，进而区分返回的**undefined**所属情况。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| from | [MapOrBuiltinMap](arkts-arkts-collections-maporbuiltinmap-t.md)&lt;K, V&gt; | 是 | 提供键值对的Map。 |
