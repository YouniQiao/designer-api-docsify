...
| 参数名 | 类型 | 必填 |
| --- | --- | --- |
| [predicate](../../apis-arkdata/arkts-apis/arkts-arkdata-relationalstore-cloudsyncconfig-i.md) | [TypedArrayPredicateFn](arkts-arkts-collections-typedarraypredicatefn-t.md)&lt;number, Int16Array&gt; | 是 |
...
| 参数名 | 类型 | 必填 |
| --- | --- | --- |
| callbackFn | [TypedArrayForEachCallback](arkts-arkts-collections-typedarrayforeachcallback-t.md)&lt;number, Int16Array&gt; | 是 |
...
| 参数名 | 类型 | 必填 |
| --- | --- | --- |
| callbackFn | [TypedArrayMapCallback](arkts-arkts-collections-typedarraymapcallback-t.md)&lt;number, Int16Array&gt; | 是 |
...
| 参数名 | 类型 | 必填 |
| --- | --- | --- |
| callbackFn | [TypedArrayReduceCallback](arkts-arkts-collections-typedarrayreducecallback-t.md)&lt;number, number, Int16Array&gt; | 是 |
...
| 参数名 | 类型 | 必填 |
| --- | --- | --- |
| callbackFn | [TypedArrayReduceCallback](arkts-arkts-collections-typedarrayreducecallback-t.md)&lt;U, number, Int16Array&gt; | 是 |
| initialValue | U | 是 |
...
返回一个新的ArkTS Int16Array对象，其包含原ArkTS Int16Array指定范围的内容。与subarray不同，slice返回的对象不会影响原数组。
...
将ArkTS Int16Array转换为字符串，各元素以逗号分隔拼接。
...
ArkTS Int16Array距离其ArrayBuffer起始位置的字节偏移。
