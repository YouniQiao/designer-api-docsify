...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| set | [LightWeightSet](arkts-arkts-lightweightset-c.md)<T> | 是 | 提供添加元素的LightWeightSet。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| set | [LightWeightSet](arkts-arkts-lightweightset-c.md)<T> | 是 | 比较对象。 |
...
| 类型 | 说明 |
| --- | --- |
| [Array](arkts-arkts-array-c.md)<T> | 返回对应数组。 |
