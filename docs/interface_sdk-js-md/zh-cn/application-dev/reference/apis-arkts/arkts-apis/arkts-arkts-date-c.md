...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| d | Date | 是 | to be converted to milliseconds. |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| year | int | 是 | to be converted to milliseconds &lt;br&gt;The value range is all integers. |
...
| --- | --- | --- | --- |
| year | int | 是 | to be converted to milliseconds &lt;br&gt;The value range is all integers. |
| month | int | 是 | to be converted to milliseconds &lt;br&gt;The value range is all integers. |
| day | int | 否 | to be converted to milliseconds &lt;br&gt;The value range is all integers. |
| hours | int | 否 | to be converted to milliseconds &lt;br&gt;The value range is all integers. |
| minutes | int | 否 | to be converted to milliseconds &lt;br&gt;The value range is all integers. |
| seconds | int | 否 | to be converted to milliseconds &lt;br&gt;The value range is all integers. |
| ms | int | 否 | to be converted to milliseconds &lt;br&gt;The value range is all integers. |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | long \| string \| Date | 是 | A value representing a date. Can be a timestamp in milliseconds (long), a date string (string), or an existing Date object (Date). |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| year | int | 是 | Year &lt;br&gt;The value range is all integers. |
| monthIndex | int | 是 | Month &lt;br&gt;The value range is all integers. |
| day | int | 否 | day &lt;br&gt;The value range is all integers. |
| hours | int | 否 | hours &lt;br&gt;The value range is all integers. |
| minutes | int | 否 | minutes &lt;br&gt;The value range is all integers. |
| seconds | int | 否 | seconds &lt;br&gt;The value range is all integers. |
| ms | int | 否 | ms &lt;br&gt;The value range is all integers. |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| ms | long | 是 | the time in milliseconds. |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | int | 是 | new day &lt;br&gt;The value range is all integers. |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | int | 是 | new year &lt;br&gt;The value range is all integers. |
...
| --- | --- | --- | --- |
| value | int | 是 | new year &lt;br&gt;The value range is all integers. |
| month | int | 是 | new month &lt;br&gt;The value range is all integers. |
...
| value | int | 是 | new year &lt;br&gt;The value range is all integers. |
| month | int | 是 | new month &lt;br&gt;The value range is all integers. |
| date | int | 是 | new date &lt;br&gt;The value range is all integers. |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | int | 是 | new hours &lt;br&gt;The value range is all integers. |
...
| --- | --- | --- | --- |
| value | int | 是 | new hours &lt;br&gt;The value range is all integers. |
| min | int | 是 | minutes &lt;br&gt;The value range is all integers. |
...
| value | int | 是 | new hours &lt;br&gt;The value range is all integers. |
| min | int | 是 | minutes &lt;br&gt;The value range is all integers. |
| sec | int | 是 | seconds &lt;br&gt;The value range is all integers. |
...
| min | int | 是 | minutes &lt;br&gt;The value range is all integers. |
| sec | int | 是 | seconds &lt;br&gt;The value range is all integers. |
| ms | int | 是 | millisecond &lt;br&gt;The value range is all integers. |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | int | 是 | new ms &lt;br&gt;The value range is all integers. |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | int | 是 | new minutes &lt;br&gt;The value range is all integers. |
...
| value | int | 是 | new minutes &lt;br&gt;The value range is all integers. |
| sec | int | 是 | seconds &lt;br&gt;The value range is all integers. |
| ms | int | 是 | milliseconds &lt;br&gt;The value range is all integers. |
...
| --- | --- | --- | --- |
| month | int | 是 | new month &lt;br&gt;The value range is all integers. |
| date | int | 是 | Dated &lt;br&gt;The value range is all integers. |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | int | 是 | new seconds &lt;br&gt;The value range is all integers. |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | long | 是 | new time in milliseconds. |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | int | 是 | The timezone offset in minutes from UTC. &lt;br&gt;The value range is all integers. |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | int | 是 | The day of the week using universal time. &lt;br&gt;The value range is all integers. |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| locales | Intl.LocalesArgument | 否 | the locale. |
| options | Intl.DateTimeFormatOptions | 否 | the format options. |
