...
**类型：** 'code' \| 'symbol' \| 'narrowSymbol' \| 'name'
...
**类型：** [Intl.BCP47LanguageTag](arkts-arkts-intl-bcp47languagetag-t.md)
...
**类型：** 'auto' \| 'never' \| 'always' \| 'exceptZero'
...
**类型：** 'decimal' \| 'percent' \| 'currency' \| 'unit'
