...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| this | \_\_\_MD\_LINK\_USD\_0\_\_\_ | 是 | 所解析的键值对所属的对象。  |
| key | string | 是 | 属性名。  |
| value | \_\_\_MD\_LINK\_USD\_0\_\_\_ \| undefined \| null | 是 | 所解析的键值对的值。  |

**返回值：**

| 类型 | 说明 |
| --- | --- |
| \_\_\_MD\_LINK\_USD\_0\_\_\_ \| undefined \| null | 返回转换结果后的ISendable对象或undefined或null。  |
