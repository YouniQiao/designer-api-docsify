...
| 类型 | 说明 |
| --- | --- |
| [ArrayList](arkts-arkts-utilarraylist-arraylist-c.md)&lt;T&gt; | 返回与原ArrayList内容相同的克隆实例，修改该克隆实例不会影响原实例。 |
...
| 类型 | 说明 |
| --- | --- |
| [ArrayList](arkts-arkts-utilarraylist-arraylist-c.md)&lt;T&gt; | 返回包含[fromIndex, toIndex)范围内元素的ArrayList子列表实例。 |
