...
**继承/实现关系：** DateTimeRangeFormatPart extends [DateTimeFormatPart](arkts-arkts-intl-datetimeformatpart-i.md)
...
**类型：** [DateTimeRangeFormatPartSource](arkts-arkts-intl-datetimerangeformatpartsource-t.md)
