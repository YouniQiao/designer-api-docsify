...
| 参数名 | 类型 | 必填 |
| --- | --- | --- |
| comparator | [TreeMapComparator](arkts-arkts-treemapcomparator-t.md)&lt;K&gt; | 否 |
...
| 参数名 | 类型 | 必填 |
| --- | --- | --- |
| callbackFn | [TreeMapForEachCb](arkts-arkts-treemapforeachcb-t.md)&lt;K, V&gt; | 是 |
