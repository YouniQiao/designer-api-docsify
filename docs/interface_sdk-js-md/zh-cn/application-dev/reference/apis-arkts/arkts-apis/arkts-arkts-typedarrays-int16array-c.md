...
| 参数名 | 类型 | 必填 |
| --- | --- | --- |
| [predicate](../../apis-arkdata/arkts-apis/arkts-arkdata-relationalstore-cloudsyncconfig-i.md) | (element: double, index: int, array: Int16Array) = & gt; boolean | 是 |
...
| 参数名 | 类型 | 必填 |
| --- | --- | --- |
| fn | (val: double, index: int, array: Int16Array) = & gt; boolean | 是 |
...
| 参数名 | 类型 | 必填 |
| --- | --- | --- |
| [predicate](../../apis-arkdata/arkts-apis/arkts-arkdata-relationalstore-cloudsyncconfig-i.md) | (value: double, index: int, obj: Int16Array) = & gt; boolean | 是 |
...
| 参数名 | 类型 | 必填 |
| --- | --- | --- |
| callbackfn | (value: double, index: int, array: Int16Array) = & gt; void | 是 |
...
| 参数名 | 类型 | 必填 |
| --- | --- | --- |
| fn | (val: double, index: int, array: Int16Array) = & gt; double | 是 |
...
| 参数名 | 类型 | 必填 |
| --- | --- | --- |
| callbackfn | (previousValue: U, currentValue: double, currentIndex: int, array: Int16Array) = & gt; U | 是 |
| initialValue | U | 是 |
...
| 参数名 | 类型 | 必填 |
| --- | --- | --- |
| callbackfn | (previousValue: double, currentValue: double, currentIndex: int,         array: Int16Array) = & gt; double | 是 |
