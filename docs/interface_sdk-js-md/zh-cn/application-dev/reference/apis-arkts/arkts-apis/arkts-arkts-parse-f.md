...
| reviver | [Transformer](arkts-arkts-transformer-t.md) | 否 | 转换函数，可用于修改解析后生成的值。默认值为undefined。 |
| options | [ParseOptions](arkts-arkts-parseoptions-i.md) | 否 | 解析选项，用于控制解析结果的类型。默认值为undefined。 |
