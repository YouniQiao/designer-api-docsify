...
| --- | --- | --- | --- |
| messageObject | Object | 是 | messageObject 发送至宿主线程的数据。 |
| options | [PostMessageOptions](arkts-arkts-postmessageoptions-i.md) | 否 | 可为postMessage设置的选项。 |
...
| --- | --- | --- | --- |
| messageObject | Object | 是 | messageObject 发送至宿主线程的数据。 |
| transfer | [ArrayBuffer](arkts-arkts-arraybuffer-c.md)[] | 是 | transfer 数组不可包含null。 |
