...
| encoding | [BufferEncoding](arkts-arkts-bufferencoding-t.md) | 否 | 字符编码格式（`value`为string才有意义）。默认值：'utf8'。传入无法识别的encoding会抛出TypeError。 |

**返回值：**

| 类型 | 说明 |
| --- | --- |
| [FastBuffer](arkts-arkts-fastbuffer-c.md) | 返回填充后的FastBuffer对象。 |
...
| encoding | [BufferEncoding](arkts-arkts-bufferencoding-t.md) | 否 | 字符编码格式。默认值：'utf8'。传入无法识别的encoding会抛出TypeError。 |
...
| encoding | [BufferEncoding](arkts-arkts-bufferencoding-t.md) | 否 | 字符编码格式。默认值：'utf8'。 |
...
| 类型 | 说明 |
| --- | --- |
| [FastBuffer](arkts-arkts-fastbuffer-c.md) | 交换之后的FastBuffer对象。 |
