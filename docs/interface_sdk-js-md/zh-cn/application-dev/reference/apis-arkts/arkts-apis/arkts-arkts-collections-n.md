...
| [ArrayOrBuiltinArray](arkts-arkts-collections-arrayorbuiltinarray-t.md) | ArkTS Array接口参数类型，表示ArkTS Array或内建Array。 |
| [MapOrBuiltinMap](arkts-arkts-collections-maporbuiltinmap-t.md) | ArkTS Map接口参数类型，表示ArkTS Map或内建Map。 |
