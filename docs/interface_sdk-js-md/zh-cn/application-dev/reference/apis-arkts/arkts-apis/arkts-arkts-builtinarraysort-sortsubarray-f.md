...
| mustPrecede | (lhs: boolean, rhs: boolean) =&gt; boolean | 是 | 用于判断前后顺序的函数。 |
...
| startIndex | int | 是 | 开始排序的索引（包含）。 <br>取值约束：应为整数。 |
| endIndex | int | 是 | 结束排序的索引（不包含）。 <br>取值约束：应为整数。 |
| mustPrecede | (lhs: byte, rhs: byte) =&gt; boolean | 是 | 用于判断前后顺序的函数。 |
...
| startIndex | int | 是 | 开始排序的索引（包含）。 <br>取值约束：应为整数。 |
| endIndex | int | 是 | 结束排序的索引（不包含）。 <br>取值约束：应为整数。 |
| mustPrecede | (lhs: short, rhs: short) =&gt; boolean | 是 | 用于判断前后顺序的函数。 |
...
| startIndex | int | 是 | 开始排序的索引（包含）。 <br>取值约束：应为整数。 |
| endIndex | int | 是 | 结束排序的索引（不包含）。 <br>取值约束：应为整数。 |
| mustPrecede | (lhs: int, rhs: int) =&gt; boolean | 是 | 用于判断前后顺序的函数。 |
...
| startIndex | int | 是 | 开始排序的索引（包含）。 <br>取值约束：应为整数。 |
| endIndex | int | 是 | 结束排序的索引（不包含）。 <br>取值约束：应为整数。 |
| mustPrecede | (lhs: long, rhs: long) =&gt; boolean | 是 | 用于判断前后顺序的函数。 |
...
| startIndex | int | 是 | 开始排序的索引（包含）。 <br>取值约束：应为整数。 |
| endIndex | int | 是 | 结束排序的索引（不包含）。 <br>取值约束：应为整数。 |
| mustPrecede | (lhs: float, rhs: float) =&gt; boolean | 是 | 用于判断前后顺序的函数。 |
...
| startIndex | int | 是 | 开始排序的索引（包含）。 <br>取值约束：应为整数。 |
| endIndex | int | 是 | 结束排序的索引（不包含）。 <br>取值约束：应为整数。 |
| mustPrecede | (lhs: double, rhs: double) =&gt; boolean | 是 | 用于判断前后顺序的函数。 |
...
| startIndex | int | 是 | 开始排序的索引（包含）。 <br>取值约束：应为整数。 |
| endIndex | int | 是 | 结束排序的索引（不包含）。 <br>取值约束：应为整数。 |
| mustPrecede | (lhs: char, rhs: char) =&gt; boolean | 是 | 用于判断前后顺序的函数。 |
...
| startIndex | int | 是 | 开始排序的索引（包含）。 <br>取值约束：应为整数。 |
| endIndex | int | 是 | 结束排序的索引（不包含）。 <br>取值约束：应为整数。 |
| mustPrecede | (lhs: T, rhs: T) =&gt; boolean | 是 | 用于判断前后顺序的函数。 |
