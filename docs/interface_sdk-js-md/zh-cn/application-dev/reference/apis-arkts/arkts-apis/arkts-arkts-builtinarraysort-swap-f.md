...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| arr | FixedArray&lt;boolean&gt; | 是 | 待交换元素的数组。 |
| i | int | 是 | 待交换的第一个元素的索引。 <br>取值约束：应为整数。 |
| j | int | 是 | 待交换的第二个元素的索引。 <br>取值约束：应为整数。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| arr | FixedArray&lt;byte&gt; | 是 | 待交换元素的数组。 |
| i | int | 是 | 待交换的第一个元素的索引。 <br>取值约束：应为整数。 |
| j | int | 是 | 待交换的第二个元素的索引。 <br>取值约束：应为整数。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| arr | FixedArray&lt;short&gt; | 是 | 待交换元素的数组。 |
| i | int | 是 | 待交换的第一个元素的索引。 <br>取值约束：应为整数。 |
| j | int | 是 | 待交换的第二个元素的索引。 <br>取值约束：应为整数。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| arr | FixedArray&lt;long&gt; | 是 | 待交换元素的数组。 |
| i | int | 是 | 待交换的第一个元素的索引。 <br>取值约束：应为整数。 |
| j | int | 是 | 待交换的第二个元素的索引。 <br>取值约束：应为整数。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| arr | FixedArray&lt;float&gt; | 是 | 待交换元素的数组。 |
| i | int | 是 | 待交换的第一个元素的索引。 <br>取值约束：应为整数。 |
| j | int | 是 | 待交换的第二个元素的索引。 <br>取值约束：应为整数。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| arr | FixedArray&lt;double&gt; | 是 | 待交换元素的数组。 |
| i | int | 是 | 待交换的第一个元素的索引。 <br>取值约束：应为整数。 |
| j | int | 是 | 待交换的第二个元素的索引。 <br>取值约束：应为整数。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| arr | FixedArray&lt;char&gt; | 是 | 待交换元素的数组。 |
| i | int | 是 | 待交换的第一个元素的索引。 <br>取值约束：应为整数。 |
| j | int | 是 | 待交换的第二个元素的索引。 <br>取值约束：应为整数。 |
