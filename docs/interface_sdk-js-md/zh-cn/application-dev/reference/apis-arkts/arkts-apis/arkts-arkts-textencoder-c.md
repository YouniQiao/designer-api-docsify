...
| 类型 | 说明 |
| --- | --- |
| [TextEncoder](arkts-arkts-textencoder-c.md) | **TextEncoder** 对象。 |
...
**替代接口：** [encodeIntoUint8Array](arkts-arkts-textencoder-c.md#encodeintouint8array-1)
...
| dest | [Uint8Array](arkts-arkts-uint8array-c.md) | 是 | 用于存储 UTF-8 编码文本的 Uint8Array 对象。 |
...
| [EncodeIntoUint8ArrayInfo](arkts-arkts-encodeintouint8arrayinfo-i.md) | 获取到的对象。**read** 表示已编码的字符数，**written** 表示已编码字符所占用的字节数。<br>**适用版本：** 11+ |
