...
| callbackfn | (previousValue: U, currentValue: boolean,      index: int, array: FixedArray&lt;boolean&gt;) =&gt; U | 是 | 最多接受四个参数的函数。reduceRight方法会按降序对稀疏数组中的 调用一次callbackfn函数。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| self | FixedArray&lt;boolean&gt; | 是 | 执行归约操作的数组。 |
| callbackfn | (previousValue: boolean, currentValue: boolean,      index: int, array: FixedArray&lt;boolean&gt;) =&gt; boolean | 是 | 最多接受四个参数的函数。reduceRight方法会按降序对稀疏数组中的 调用一次callbackfn函数。 |

**返回值：**

| 类型 | 说明 |
| --- | --- |
| boolean | 对数组所有元素应用callbackfn后得到的结果。 |
...
| callbackfn | (previousValue: U, currentValue: byte, index: int,      array: FixedArray&lt;byte&gt;) =&gt; U | 是 | 最多接受四个参数的函数。reduceRight方法会按降序对稀疏数组中的 调用一次callbackfn函数。 |
| initialValue | U | 是 | 累加器的初始值。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| self | FixedArray&lt;byte&gt; | 是 | 执行归约操作的数组。 |
| callbackfn | (previousValue: byte, currentValue: byte, index: int,      array: FixedArray&lt;byte&gt;) =&gt; byte | 是 | 最多接受四个参数的函数。reduceRight方法会按降序对稀疏数组中的 调用一次callbackfn函数。 |

**返回值：**

| 类型 | 说明 |
| --- | --- |
| byte | 对数组所有元素应用callbackfn后得到的结果。 |
...
| callbackfn | (previousValue: U, currentValue: short,      index: int, array: FixedArray&lt;short&gt;) =&gt; U | 是 | 最多接受四个参数的函数。reduceRight方法会按降序对稀疏数组中的 调用一次callbackfn函数。 |
| initialValue | U | 是 | 累加器的初始值。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| self | FixedArray&lt;short&gt; | 是 | 执行归约操作的数组。 |
| callbackfn | (previousValue: short, currentValue: short,      index: int, array: FixedArray&lt;short&gt;) =&gt; short | 是 | 最多接受四个参数的函数。reduceRight方法会按降序对稀疏数组中的 调用一次callbackfn函数。 |

**返回值：**

| 类型 | 说明 |
| --- | --- |
| short | 对数组所有元素应用callbackfn后得到的结果。 |
...
| callbackfn | (previousValue: U, currentValue: int, index: int,      array: FixedArray&lt;int&gt;) =&gt; U | 是 | 最多接受四个参数的函数。reduceRight方法会按降序对稀疏数组中的 调用一次callbackfn函数。 |
| initialValue | U | 是 | 累加器的初始值。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| self | FixedArray&lt;int&gt; | 是 | 执行归约操作的数组。 |
| callbackfn | (previousValue: int, currentValue: int,      index: int, array: FixedArray&lt;int&gt;) =&gt; int | 是 | 最多接受四个参数的函数。reduceRight方法会按降序对稀疏数组中的 调用一次callbackfn函数。 |

**返回值：**

| 类型 | 说明 |
| --- | --- |
| int | 对数组所有元素应用callbackfn后得到的结果。 |
...
| callbackfn | (previousValue: U, currentValue: long, index: int,      array: FixedArray&lt;long&gt;) =&gt; U | 是 | 最多接受四个参数的函数。reduceRight方法会按降序对稀疏数组中的 调用一次callbackfn函数。 |
| initialValue | U | 是 | 累加器的初始值。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| self | FixedArray&lt;long&gt; | 是 | 执行归约操作的数组。 |
| callbackfn | (previousValue: long, currentValue: long, index: int,      array: FixedArray&lt;long&gt;) =&gt; long | 是 | 最多接受四个参数的函数。reduceRight方法会按降序对稀疏数组中的 调用一次callbackfn函数。 |

**返回值：**

| 类型 | 说明 |
| --- | --- |
| long | 对数组所有元素应用callbackfn后得到的结果。 |
...
| callbackfn | (previousValue: U, currentValue: float,      index: int, array: FixedArray&lt;float&gt;) =&gt; U | 是 | 最多接受四个参数的函数。reduceRight方法会按降序对稀疏数组中的 调用一次callbackfn函数。 |
| initialValue | U | 是 | 累加器的初始值。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| self | FixedArray&lt;float&gt; | 是 | 执行归约操作的数组。 |
| callbackfn | (previousValue: float, currentValue: float,      index: int, array: FixedArray&lt;float&gt;) =&gt; float | 是 | 最多接受四个参数的函数。reduceRight方法会按降序对稀疏数组中的 调用一次callbackfn函数。 |

**返回值：**

| 类型 | 说明 |
| --- | --- |
| float | 对数组所有元素应用callbackfn后得到的结果。 |
...
| callbackfn | (previousValue: U, currentValue: double,      index: int, array: FixedArray&lt;double&gt;) =&gt; U | 是 | 最多接受四个参数的函数。reduceRight方法会按降序对稀疏数组中的 调用一次callbackfn函数。 |
| initialValue | U | 是 | 累加器的初始值。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| self | FixedArray&lt;double&gt; | 是 | 执行归约操作的数组。 |
| callbackfn | (previousValue: double, currentValue: double,      index: int, array: FixedArray&lt;double&gt;) =&gt; double | 是 | 最多接受四个参数的函数。reduceRight方法会按降序对稀疏数组中的 调用一次callbackfn函数。 |

**返回值：**

| 类型 | 说明 |
| --- | --- |
| double | 对数组所有元素应用callbackfn后得到的结果。 |
...
| callbackfn | (previousValue: U, currentValue: char, index: int,      array: FixedArray&lt;char&gt;) =&gt; U | 是 | 最多接受四个参数的函数。reduceRight方法会按降序对稀疏数组中的 调用一次callbackfn函数。 |
| initialValue | U | 是 | 累加器的初始值。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| self | FixedArray&lt;char&gt; | 是 | 执行归约操作的数组。 |
| callbackfn | (previousValue: char, currentValue: char,      index: int, array: FixedArray&lt;char&gt;) =&gt; char | 是 | 最多接受四个参数的函数。reduceRight方法会按降序对稀疏数组中的 调用一次callbackfn函数。 |

**返回值：**

| 类型 | 说明 |
| --- | --- |
| char | 对数组所有元素应用callbackfn后得到的结果。 |
