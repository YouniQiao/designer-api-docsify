...
使用指定的分隔字符串连接`Array`中的所有元素， 并返回新建的字符串。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| self | FixedArray&lt;boolean&gt; | 是 | 执行`join`操作的数组。 |
| sep | string | 否 | 用于分隔数组中相邻元素的字符串。如果不传入该参数，则数组 元素之间以逗号分隔。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| self | FixedArray&lt;byte&gt; | 是 | 执行`join`操作的数组。 |
| sep | string | 否 | 用于分隔数组中相邻元素的字符串。如果不传入该参数，则数组 元素之间以逗号分隔。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| self | FixedArray&lt;short&gt; | 是 | 执行`join`操作的数组。 |
| sep | string | 否 | 用于分隔数组中相邻元素的字符串。如果不传入该参数，则数组 元素之间以逗号分隔。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| self | FixedArray&lt;int&gt; | 是 | 执行`join`操作的数组。 |
| sep | string | 否 | 用于分隔数组中相邻元素的字符串。如果不传入该参数，则数组 元素之间以逗号分隔。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| self | FixedArray&lt;long&gt; | 是 | 执行`join`操作的数组。 |
| sep | string | 否 | 用于分隔数组中相邻元素的字符串。如果不传入该参数，则数组 元素之间以逗号分隔。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| self | FixedArray&lt;float&gt; | 是 | 执行`join`操作的数组。 |
| sep | string | 否 | 用于分隔数组中相邻元素的字符串。如果不传入该参数，则数组 元素之间以逗号分隔。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| self | FixedArray&lt;double&gt; | 是 | 执行`join`操作的数组。 |
| sep | string | 否 | 用于分隔数组中相邻元素的字符串。如果不传入该参数，则数组 元素之间以逗号分隔。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| self | FixedArray&lt;char&gt; | 是 | 执行`join`操作的数组。 |
| sep | string | 否 | 用于分隔数组中相邻元素的字符串。如果不传入该参数，则数组 元素之间以逗号分隔。 |
