...
| 类型 | 说明 |
| --- | --- |
| [Color](arkts-arkgraphics2d-effectkit-color-i.md) | Color实例，即图像平均的颜色值，失败时返回null。 |
...
| 类型 | 说明 |
| --- | --- |
| [Color](arkts-arkgraphics2d-effectkit-color-i.md) | Color实例，即图像饱和度最高的颜色值，失败时返回null。 |
...
| 类型 | 说明 |
| --- | --- |
| [Color](arkts-arkgraphics2d-effectkit-color-i.md) | Color实例，即图像占比最多的颜色值，失败时返回null。 |
...
| 类型 | 说明 |
| --- | --- |
| Promise&lt;[Color](arkts-arkgraphics2d-effectkit-color-i.md)&gt; | Promise对象。返回图像主色对应的颜色值，失败时返回错误信息。 |
...
| 类型 | 说明 |
| --- | --- |
| [Color](arkts-arkgraphics2d-effectkit-color-i.md) | Color实例，即图像主色对应的颜色值，失败时返回null。 |
