...
画刷需通过Canvas的[attachBrush]\_\_\_JSDOC\_LINK\_DESC\_USD\_0\_\_\_方法绑定到画布后生效，绘制完成后通过  
[detachBrush]\_\_\_JSDOC\_LINK\_DESC\_USD\_1\_\_\_方法解绑；画刷用于图形填充，画笔（Pen）用于图形描边，详见[Pen]\_\_\_JSDOC\_LINK\_DESC\_USD\_2\_\_\_。
    **说明：**  
...
构造一个新的画刷对象。默认配置：新建画刷默认抗锯齿关闭、混合模式为SRC\_OVER，且未设置颜色滤波器、蒙版滤波器、着色器效果、阴影层效果和图像滤波器。
...
| 类型 | 说明 |
| --- | --- |
| ArkTS-Dyn: number  \_\_\_HTML\_TAG\_USD\_0\_\_\_ArkTS-Sta：int | 返回画刷的透明度，取值范围为[0, 255]的整数。 |
...
| 类型 | 说明 |
| --- | --- |
| \_\_\_MD\_LINK\_USD\_0\_\_\_ | 返回画刷的颜色滤波器，用于对绘制内容进行颜色调整，如伽马校正、颜色矩阵变换等。 |
...
| 类型 | 说明 |
| --- | --- |
| \_\_\_MD\_LINK\_USD\_0\_\_\_ | 返回颜色滤波器，用于对绘制内容进行颜色调整，如伽马校正、颜色矩阵变换等。获取颜色滤波器失败时返回undefined。 |
...
获取画刷颜色的16进制ARGB格式值。与[getColor]\_\_\_JSDOC\_LINK\_DESC\_USD\_0\_\_\_的区别是返回值类型为16进制ARGB格式的32位无符号整数。
...
重置当前画刷为初始状态，清除已设置的颜色、透明度、抗锯齿、颜色滤波器、蒙版滤波器、着色器效果、阴影层效果、混合模式和图像滤波器等属性。初始状态的具体取值：抗锯齿关闭、混合模式为SRC\_OVER，且未设置颜色滤波器、蒙版滤波器、着色器效果、阴影层效果和图像滤波器。如需使用上述属性，需要重新调用对应的set接口进行设置。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| alpha | ArkTS-Dyn: number  \_\_\_HTML\_TAG\_USD\_0\_\_\_ArkTS-Sta：int | 是 | 用于表示透明度的取值范围为[0, 255]的整数，传入范围内的浮点数会向下取整。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| mode | \_\_\_MD\_LINK\_USD\_0\_\_\_ | 是 | 颜色的混合模式，用于控制绘制时源颜色与已有目标颜色的混合方式。未调用此接口设置时，系统默认的混合模式为SRC\_\_\_ESCAPED\_UNDERSCORE\_\_\_OVER。 |
...
设置画刷的颜色。与[setColor]\_\_\_JSDOC\_LINK\_DESC\_USD\_0\_\_\_的区别是支持通过16进制ARGB数值直接设置颜色。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| color | ArkTS-Dyn: number  \_\_\_HTML\_TAG\_USD\_0\_\_\_ArkTS-Sta：int | 是 | 16进制ARGB格式的颜色，以32位无符号整数表示，格式为0xAARRGGBB，其中AA为透明度通道，RR为红色通道， GG为绿色通道，BB为蓝色通道，取值范围均为0x00到0xFF，整体取值范围为[0x00000000, 0xFFFFFFFF]。 |
...
设置画刷的颜色以及标准色域。与[setColor]\_\_\_JSDOC\_LINK\_DESC\_USD\_0\_\_\_的区别是可以单独设置色域，适用于需要单独设置色域的场景。
...
| colorSpace | colorSpaceManager.ColorSpaceManager \| null | 是 | 标准色域对象，需通过 [colorSpaceManager.create()]\_\_\_ESCAPED\_UNDERSCORE\_\_\_\_\_\_ESCAPED\_UNDERSCORE\_\_\_\_\_\_ESCAPED\_UNDERSCORE\_\_\_JSDOC\_\_\_ESCAPED\_UNDERSCORE\_\_\_LINK\_\_\_ESCAPED\_UNDERSCORE\_\_\_DESC\_\_\_ESCAPED\_UNDERSCORE\_\_\_USD\_\_\_ESCAPED\_UNDERSCORE\_\_\_0\_\_\_ESCAPED\_UNDERSCORE\_\_\_\_\_\_ESCAPED\_UNDERSCORE\_\_\_\_\_\_ESCAPED\_UNDERSCORE\_\_\_方法创建，与color4f配合使 用，决定color4f颜色值的映射色域。null表示使用sRGB色域。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| filter | \_\_\_MD\_LINK\_USD\_0\_\_\_ \| null | 是 | 颜色滤波器，用于对绘制内容进行颜色调整（如伽马校正、颜色矩阵变换等）。null表示清空颜色滤波器。\_\_\_HTML\_TAG\_USD\_0\_\_\_**起始版本：** 20 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| filter | \_\_\_MD\_LINK\_USD\_0\_\_\_ \| null | 是 | 图像滤波器，用于对绘制内容进行模糊、锐化等图像处理。null表示清空图像滤波器。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| filter | \_\_\_MD\_LINK\_USD\_0\_\_\_ \| null | 是 | 蒙版滤波器，用于对绘制图形边缘进行模糊处理等场景。null表示清空蒙版滤波器。\_\_\_HTML\_TAG\_USD\_0\_\_\_**起始版本：** 20 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| shaderEffect | \_\_\_MD\_LINK\_USD\_0\_\_\_ \| null | 是 | 着色器效果对象，用于实现渐变填充、图案填充等复杂绘制效果。null表示清空着色器效果。\_\_\_HTML\_TAG\_USD\_0\_\_\_**起始版本：** 20 |
...
设置画刷的阴影层效果。当前仅在通过Canvas的[drawTextBlob]\_\_\_JSDOC\_LINK\_DESC\_USD\_0\_\_\_等方法绘制文字时生效。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| shadowLayer | \_\_\_MD\_LINK\_USD\_0\_\_\_ \| null | 是 | 阴影层对象，用于给画刷添加阴影效果。null表示清空阴影层效果。该阴影层效果仅在绘制文字时生效。\_\_\_HTML\_TAG\_USD\_0\_\_\_**起始版本：** 20 |
