...
| 名称 | 说明 |
| --- | --- |
| [createColorPicker](arkts-arkgraphics2d-createcolorpicker-f.md#createcolorpicker-1) | 通过传入的PixelMap创建ColorPicker实例，使用Promise异步回调。 |
| [createColorPicker](arkts-arkgraphics2d-createcolorpicker-f.md#createcolorpicker-2) | 通过传入的PixelMap创建选定取色区域的ColorPicker实例，使用Promise异步回调。 |
| [createColorPicker](arkts-arkgraphics2d-createcolorpicker-f.md#createcolorpicker-3) | 通过传入的PixelMap创建ColorPicker实例，使用callback异步回调。 |
| [createColorPicker](arkts-arkgraphics2d-createcolorpicker-f.md#createcolorpicker-4) | 通过传入的PixelMap创建选定取色区域的ColorPicker实例，使用callback异步回调。 |
| [createEffect](arkts-arkgraphics2d-createeffect-f.md#createeffect-1) | 通过传入的PixelMap创建Filter实例。 |
...
| 名称 | 说明 |
| --- | --- |
| [PictureComplexityDegree](arkts-arkgraphics2d-picturecomplexitydegree-e-sys.md) | 图片内容复杂度的枚举。 |
| [PictureLightDegree](arkts-arkgraphics2d-picturelightdegree-e-sys.md) | 图片颜色明亮度的枚举。 |
| [PictureShadeDegree](arkts-arkgraphics2d-pictureshadedegree-e-sys.md) | 图片颜色深浅度的枚举。 |
<!--DelEnd-->
...
| 名称 | 说明 |
| --- | --- |
| [EllipticalMaskCenter](arkts-arkgraphics2d-ellipticalmaskcenter-t-sys.md) | 定义椭圆形遮罩的中心点。 |
| [EllipticalMaskRadius](arkts-arkgraphics2d-ellipticalmaskradius-t-sys.md) | 定义椭圆形遮罩的半径。 |
<!--DelEnd-->
