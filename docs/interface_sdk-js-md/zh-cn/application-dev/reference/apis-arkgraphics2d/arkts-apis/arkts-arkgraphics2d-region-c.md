...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| region | [Region](../../apis-image-kit/arkts-apis/arkts-image-region-i.md) | 是 | 用于拷贝的区域。 |
...
| 类型 | 说明 |
| --- | --- |
| [Path](arkts-arkgraphics2d-path-c.md) | 返回当前区域边界的路径。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| other | [Region](../../apis-image-kit/arkts-apis/arkts-image-region-i.md) | 是 | 区域对象。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| region | [Region](../../apis-image-kit/arkts-apis/arkts-image-region-i.md) | 是 | 区域对象。 |
| regionOp | [RegionOp](arkts-arkgraphics2d-regionop-e.md) | 是 | 区域合并操作类型。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| region | [Region](../../apis-image-kit/arkts-apis/arkts-image-region-i.md) | 是 | 指定的区域对象。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| path | [Path](arkts-arkgraphics2d-path-c.md) | 是 | 路径对象。 |
| clip | [Region](../../apis-image-kit/arkts-apis/arkts-image-region-i.md) | 是 | 区域对象。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| region | [Region](../../apis-image-kit/arkts-apis/arkts-image-region-i.md) | 是 | 用于赋值的区域。 |
