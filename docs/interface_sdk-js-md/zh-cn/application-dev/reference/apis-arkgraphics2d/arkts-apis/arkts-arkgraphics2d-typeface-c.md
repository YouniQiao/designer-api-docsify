...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| typefaceArguments | [TypefaceArguments](arkts-arkgraphics2d-typefacearguments-c.md) | 是 | TypefaceArguments for typeface. |

**返回值：**

| 类型 | 说明 |
| --- | --- |
| [Typeface](arkts-arkgraphics2d-typeface-c.md) | 返回字体对象（异常情况下会返回空指针）。 |
...
| 类型 | 说明 |
| --- | --- |
| [Typeface](arkts-arkgraphics2d-typeface-c.md) | 返回Typeface对象。 |
...
| --- | --- | --- | --- |
| filePath | string | 是 | 表示字体资源存放的路径。应用沙箱路径和真实物理路径的对应关系请参考[应用沙箱路径和真实物理路径的对应关系](../../../../file-management/app-sandbox-directory.md#应用沙箱路径和真实物理路径的对应关系)。 |
| typefaceArguments | [TypefaceArguments](arkts-arkgraphics2d-typefacearguments-c.md) | 是 | 表示字体属性。 |
...
| 类型 | 说明 |
| --- | --- |
| [Typeface](arkts-arkgraphics2d-typeface-c.md) | 返回Typeface对象（异常情况下会返回空指针）。 |
