...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| controlPoints | [Array](../../apis-arkts/arkts-apis/arkts-arkts-array-c.md)<common2D.Point> | 是 | 12个贝塞尔形变控制点，更改控制点的位置可改变形成边缘的曲线的形状，从而扭曲图像。控制点坐标为0-1坐标系，且坐标值可大于1或小于0。 |

**返回值：**

| 类型 | 说明 |
| --- | --- |
| [Filter](../../apis-basic-service-kit/arkts-apis/arkts-basicservices-filter-i-sys.md) | - 返回挂载了贝塞尔曲线变形效果的Filter。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| param | [BlurBubblesRiseEffectParam](arkts-arkgraphics2d-blurbubblesriseeffectparam-i-sys.md) | 是 | 模糊气泡上升效果的参数。 |

**返回值：**

| 类型 | 说明 |
| --- | --- |
| [Filter](../../apis-basic-service-kit/arkts-apis/arkts-basicservices-filter-i-sys.md) | - 返回模糊气泡上升滤镜。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| colors | [Array](../../apis-arkts/arkts-apis/arkts-arkts-array-c.md)<Color> | 是 | 颜色数组，多个颜色的渐变。数组长度取值范围[0, 12], 每一个颜色值取值范围为大于等于0。数组长度等于0或大于12时无效果，colors、positions和strengths的数组长度不相等时无效果。 |
| positions | [Array](../../apis-arkts/arkts-apis/arkts-arkts-array-c.md)<common2D.Point> | 是 | 位置数组，颜色对应的分布位置。数组长度取值范围[0, 12]。数组长度等于0或大于12时无效果，colors、positions和strengths的数组长度不相等时无效果。 |
| strengths | [Array](../../apis-arkts/arkts-apis/arkts-arkts-array-c.md)<number> | 是 | 强度数组，颜色对应的扩散强度。数组长度取值范围[0, 12], 每一个强度值取值范围为大于等于0。数组长度等于0或大于12时无效果，colors、positions和strengths的数组长度不相等时无效果。 |
| alphaMask | [Mask](arkts-arkgraphics2d-mask-c-sys.md) | 否 | 遮罩alpha，颜色对应的alpha显示遮罩。不设置时，默认组件内容全部有颜色渐变效果。 |

**返回值：**

| 类型 | 说明 |
| --- | --- |
| [Filter](../../apis-basic-service-kit/arkts-apis/arkts-basicservices-filter-i-sys.md) | - 返回挂载了颜色渐变效果的Filter。 |
...
| displacementMap | [Mask](arkts-arkgraphics2d-mask-c-sys.md) | 否 | 该参数暂不生效。 |

**返回值：**

| 类型 | 说明 |
| --- | --- |
| [Filter](../../apis-basic-service-kit/arkts-apis/arkts-basicservices-filter-i-sys.md) | - 返回了具有内容光照效果的filter。 |
...
| color | [Color](../../apis-arkgraphics3d/arkts-apis/arkts-arkgraphics3d-color-i.md) | 是 | 光照颜色。 |
| intensity | number | 是 | 光照强度，非负数。 |
| mask | [Mask](arkts-arkgraphics2d-mask-c-sys.md) | 否 | 置换贴图，用于描述二维图像表面的三维细节，通过法线或高度图增强局部细节和光照反射效果，若输入为高度图，须与factor参数配合使用。默认为空，表现为全局无细节的平面光照效果。 |
...
| 类型 | 说明 |
| --- | --- |
| [Filter](../../apis-basic-service-kit/arkts-apis/arkts-basicservices-filter-i-sys.md) | - 返回挂载了由置换贴图控制的光照效果的Filter。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| displacementMap | [Mask](arkts-arkgraphics2d-mask-c-sys.md) | 是 | 指定扭曲程度。与factor相乘后共同决定扭曲程度。 |
...
| 类型 | 说明 |
| --- | --- |
| [Filter](../../apis-basic-service-kit/arkts-apis/arkts-basicservices-filter-i-sys.md) | - 返回挂载了扭曲效果的Filter。 |
...
| 类型 | 说明 |
| --- | --- |
| [Filter](../../apis-basic-service-kit/arkts-apis/arkts-basicservices-filter-i-sys.md) | - 返回挂载了透镜畸变效果的Filter。 |
...
| color | [Color](../../apis-arkgraphics3d/arkts-apis/arkts-arkgraphics3d-color-i.md) | 否 | 指定描边高光颜色，不设置时，将默认使用组件内容的原始颜色。如果有值，使用指定颜色。设置不为null时，Color中的alpha不发挥作用，仅使用rgb。 |
| mask | [Mask](arkts-arkgraphics2d-mask-c-sys.md) | 否 | 指定描边高光强度。不设置时，默认组件内容全部有描边高光效果。 |
...
| 类型 | 说明 |
| --- | --- |
| [Filter](../../apis-basic-service-kit/arkts-apis/arkts-basicservices-filter-i-sys.md) | - 返回挂载了描边高光效果的Filter。 |
...
| flyMode | [FlyMode](arkts-arkgraphics2d-flymode-e-sys.md) | 是 | 飞入飞出的场景模式。BOTTOM表示从设备底部飞入飞出形变场景。TOP表示从设备顶部飞入飞出形变场景。 |

**返回值：**

| 类型 | 说明 |
| --- | --- |
| [Filter](../../apis-basic-service-kit/arkts-apis/arkts-basicservices-filter-i-sys.md) | - 返回挂载了飞入飞出形变效果的Filter。 |
...
| 类型 | 说明 |
| --- | --- |
| [Filter](../../apis-basic-service-kit/arkts-apis/arkts-basicservices-filter-i-sys.md) | - 返回挂载了HDR提亮效果的Filter。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| param | [HeatDistortionEffectParam](arkts-arkgraphics2d-heatdistortioneffectparam-i-sys.md) | 是 | 热浪扭曲效果的参数。 |

**返回值：**

| 类型 | 说明 |
| --- | --- |
| [Filter](../../apis-basic-service-kit/arkts-apis/arkts-basicservices-filter-i-sys.md) | - 返回添加了热浪扭曲效果的Filter。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| dispersionMap | [Mask](arkts-arkgraphics2d-mask-c-sys.md) | 是 | 置换贴图，用于控制色散的强度、方向和透明度。建议使用PixelMapMask类型的置换贴图。 |
...
| 类型 | 说明 |
| --- | --- |
| [Filter](../../apis-basic-service-kit/arkts-apis/arkts-basicservices-filter-i-sys.md) | - 返回挂载了由置换贴图控制的色散效果的Filter。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| alphaMask | [Mask](arkts-arkgraphics2d-mask-c-sys.md) | 是 | 通过遮罩指定转场效果的作用区域。 |
...
| 类型 | 说明 |
| --- | --- |
| [Filter](../../apis-basic-service-kit/arkts-apis/arkts-basicservices-filter-i-sys.md) | - 返回挂载了转场效果的Filter。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| stretchSizes | [Array](../../apis-arkts/arkts-apis/arkts-arkts-array-c.md)<number> | 是 | 上下左右四个方向边缘像素扩展的百分比比例，取值范围为[-1, 1]。正值表示向外扩展，上下左右四个方向分别用指定原图比例的边缘像素填充。负值表示内缩，但是最终图像大小不变。注意四个方向对应的参数需统一为非正值或非负值。 |
| tileMode | [TileMode](arkts-arkgraphics2d-tilemode-e.md) | 是 | 边缘像素扩展的像素填充模式。 |

**返回值：**

| 类型 | 说明 |
| --- | --- |
| [Filter](../../apis-basic-service-kit/arkts-apis/arkts-basicservices-filter-i-sys.md) | - 返回挂载了边缘像素扩展效果的Filter。 |
...
| 类型 | 说明 |
| --- | --- |
| [Filter](../../apis-basic-service-kit/arkts-apis/arkts-basicservices-filter-i-sys.md) | - 返回挂载了半径线性渐变模糊效果的Filter。 |
...
| radiusMap | [Mask](arkts-arkgraphics2d-mask-c-sys.md) | 是 | 代表模糊程度的Mask对象。 |

**返回值：**

| 类型 | 说明 |
| --- | --- |
| [Filter](../../apis-basic-service-kit/arkts-apis/arkts-basicservices-filter-i-sys.md) | - 返回当前效果的Filter对象。 |
...
| rippleMode | [WaterRippleMode](arkts-arkgraphics2d-waterripplemode-e-sys.md) | 是 | 水波纹的场景模式。 |

**返回值：**

| 类型 | 说明 |
| --- | --- |
| [Filter](../../apis-basic-service-kit/arkts-apis/arkts-basicservices-filter-i-sys.md) | - 返回挂载了水波纹效果的Filter。 |
