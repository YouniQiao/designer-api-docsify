...
| 类型 | 说明 |
| --- | --- |
| [TextBlob](arkts-arkgraphics2d-textblob-c.md) | TextBlob对象。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| pos | [Array](../../apis-arkts/arkts-apis/arkts-arkts-array-c.md)<TextBlobRunBuffer> | 是 | TextBlobRunBuffer数组。 |
| font | [Font](../../apis-arkui/arkts-apis/arkts-arkui-font-c.md) | 是 | 字型对象。 |
...
| text | string | 是 | 绘制字形的文本内容。 |
| font | [Font](../../apis-arkui/arkts-apis/arkts-arkui-font-c.md) | 是 | 字型对象。 |
| encoding | [TextEncoding](arkts-arkgraphics2d-textencoding-e.md) | 否 | 编码类型，默认值为TEXT_ENCODING_UTF8。当前只有TEXT_ENCODING_UTF8生效，其余编码类型也会被视为TEXT_ENCODING_UTF8。 |
