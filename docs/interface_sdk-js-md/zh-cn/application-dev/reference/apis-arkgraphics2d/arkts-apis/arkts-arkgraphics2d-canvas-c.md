...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| brush | [Brush](arkts-arkgraphics2d-brush-c.md) | 是 | 画刷对象。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| pen | [Pen](arkts-arkgraphics2d-pen-c.md) | 是 | 画笔对象。 |
...
使用指定颜色填充画布上的裁剪区域。效果等同于[drawColor](arkts-arkgraphics2d-canvas-c.md#drawcolor-1)。
...
| clipOp | [ClipOp](arkts-arkgraphics2d-clipop-e.md) | 否 | 裁剪方式。默认为INTERSECT。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| region | [Region](../../apis-image-kit/arkts-apis/arkts-image-region-i.md) | 是 | 区域对象，表示裁剪范围。 |
| clipOp | [ClipOp](arkts-arkgraphics2d-clipop-e.md) | 否 | 裁剪方式，默认为INTERSECT。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| roundRect | [RoundRect](arkts-arkgraphics2d-roundrect-c.md) | 是 | 圆角矩形对象，表示裁剪范围。 |
| clipOp | [ClipOp](arkts-arkgraphics2d-clipop-e.md) | 否 | 裁剪方式，默认为INTERSECT。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| matrix | [Matrix](arkts-arkgraphics2d-matrix-c.md) | 是 | 矩阵对象。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| glyphIds | [Array](../../apis-arkts/arkts-apis/arkts-arkts-array-c.md)<number> | 是 | 指示字形ID的数组。 |
| glyphIdOffset | number | 是 | 指示在绘制字形Ids数组之前要跳过的元素的数量。取值限定为整数。 |
| positions | [Array](../../apis-arkts/arkts-apis/arkts-arkts-array-c.md)<common2D.Point> | 是 | 表示位置数组。 |
| positionOffset | number | 是 | 指示在绘制位置数组之前要跳过的元素的数量。取值限定为整数。 |
| glyphCount | number | 是 | 指示要绘制的字形的数目。取值限定为整数。 |
| font | [Font](../../apis-arkui/arkts-apis/arkts-arkui-font-c.md) | 是 | 指示用于绘图的字体。 |
...
| samplingOptions | [SamplingOptions](arkts-arkgraphics2d-samplingoptions-c.md) | 否 | 采样选项对象，默认为不使用任何参数构造的原始采样选项对象。<br>**起始版本：** 12 |
...
| lattice | [Lattice](arkts-arkgraphics2d-lattice-c.md) | 是 | 矩形网格对象。 |
...
| samplingOptions | [SamplingOptions](arkts-arkgraphics2d-samplingoptions-c.md) | 否 | 采样选项对象，默认为不使用任何参数构造的原始采样选项对象。 |
...
| dstRect | common2D.Rect | 是 | 矩形对象，用于指定画布上图片的绘制区域。 |
| samplingOptions | [SamplingOptions](arkts-arkgraphics2d-samplingoptions-c.md) | 否 | 采样选项对象，默认为不使用任何参数构造的原始采样选项对象。 |
| constraint | [SrcRectConstraint](arkts-arkgraphics2d-srcrectconstraint-e.md) | 否 | 源矩形区域约束类型，默认为STRICT。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| outer | [RoundRect](arkts-arkgraphics2d-roundrect-c.md) | 是 | 圆角矩形对象，表示外部圆角矩形边界。 |
| inner | [RoundRect](arkts-arkgraphics2d-roundrect-c.md) | 是 | 圆角矩形对象，表示内部圆角矩形边界。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| path | [Path](arkts-arkgraphics2d-path-c.md) | 是 | 要绘制的路径对象。 |
...
| vertices | [Array](../../apis-arkts/arkts-apis/arkts-arkts-array-c.md)<number> | 是 | 顶点数组，指定网格的绘制位置，浮点数组，大小必须为((meshWidth+1) * (meshHeight+1) + vertOffset) * 2。 |
| vertOffset | number | 是 | 绘图前要跳过的vert元素数，大于等于0的整数。 |
| colors | [Array](../../apis-arkts/arkts-apis/arkts-arkts-array-c.md)<number> \| null | 是 | 颜色数组，在每个顶点指定一种颜色，整数数组，可为null，大小必须为(meshWidth+1) * (meshHeight+1) +colorOffset。<br>**起始版本：** 20 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| points | [Array](../../apis-arkts/arkts-apis/arkts-arkts-array-c.md)<common2D.Point> | 是 | 要绘制的点的数组。长度不能为0。 |
| mode | [PointMode](arkts-arkgraphics2d-pointmode-e.md) | 否 | 绘制数组中的点的方式，默认为drawing.PointMode.POINTS。 |
...
绘制一个矩形，默认使用黑色填充。性能优于[drawRect](arkts-arkgraphics2d-canvas-c.md#drawrect-1)接口，推荐使用本接口。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| region | [Region](../../apis-image-kit/arkts-apis/arkts-image-region-i.md) | 是 | 绘制的区域。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| path | [Path](arkts-arkgraphics2d-path-c.md) | 是 | 路径对象，可生成阴影。 |
...
| flag | [ShadowFlag](arkts-arkgraphics2d-shadowflag-e.md) | 是 | 阴影标志枚举。 |
...
| font | [Font](../../apis-arkui/arkts-apis/arkts-arkui-font-c.md) | 是 | 字型对象。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| blob | [TextBlob](arkts-arkgraphics2d-textblob-c.md) | 是 | TextBlob对象。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| vertexMode | [VertexMode](arkts-arkgraphics2d-vertexmode-e.md) | 是 | 绘制顶点的连接方式。 |
| vertexCount | number | 是 | 顶点数组元素的数量，值为大于等于3的整数。 |
| positions | [Array](../../apis-arkts/arkts-apis/arkts-arkts-array-c.md)<common2D.Point> | 是 | 描述顶点位置的数组，不能为空，其长度必须等于vertexCount。 |
| texs | [Array](../../apis-arkts/arkts-apis/arkts-arkts-array-c.md)<common2D.Point> \| null | 是 | 描述顶点对应纹理空间坐标的数组。其可以为空，表明纹理空间失效；若不为空，其长度必须等于vertexCount。 |
| colors | [Array](../../apis-arkts/arkts-apis/arkts-arkts-array-c.md)<number> \| null | 是 | 描述顶点对应颜色的数组，用于在三角形中进行插值。其可以为空，表明颜色效果为用户所设置的默认色；若不为空其长度必须等于vertexCount。 |
| indexCount | number | 是 | 索引的数量。其值可以为0，且indices数组长度为0时可以画图；若不为0，则值必须为大于等于3的整数。 |
| indices | [Array](../../apis-arkts/arkts-apis/arkts-arkts-array-c.md)<number> \| null | 是 | 描述顶点对应索引的数组。其可以为空，此时将忽略indexCount的合理传值（大于等于3的整数或等于0）；若不为空其长度必须等于indexCount。 |
...
| 类型 | 说明 |
| --- | --- |
| [Matrix](arkts-arkgraphics2d-matrix-c.md) | 返回画布矩阵。 |
...
保存当前画布状态（画布矩阵和可绘制区域）到栈顶。需要与恢复接口[restore](arkts-arkgraphics2d-canvas-c.md#restore-1)配合使用。
...
保存当前画布的矩阵和裁剪区域，并为后续绘制分配位图。调用恢复接口[restore](arkts-arkgraphics2d-canvas-c.md#restore-1)将会舍弃对矩阵和裁剪区域做的更改，并绘制位图。
