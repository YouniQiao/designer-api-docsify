...
- [@ohos.graphics.common2D(2D图形通用数据类型)](arkts-graphics-common2d.md)
...
- [@ohos.graphics.displaySync(可变帧率)](arkts-graphics-displaysync.md)
...
- [@ohos.graphics.drawing(绘制模块)](arkts-graphics-drawing.md)
  ...
  - [RecordCmdUtils](arkts-arkgraphics2d-drawing-recordcmdutils-c.md)
