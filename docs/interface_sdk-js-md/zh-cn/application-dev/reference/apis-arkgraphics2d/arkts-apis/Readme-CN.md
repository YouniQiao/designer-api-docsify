...
- [@ohos.graphics.drawing](arkts-graphics-drawing.md)
  ...
  - [PathDashStyle](arkts-arkgraphics2d-drawing-pathdashstyle-e.md)
...
- common<!--arkts-arkgraphics2d-common-->
  - [webgl](arkts-webgl.md)
    ...
    - [WebGLFramebuffer](arkts-arkgraphics2d-webgl-webglframebuffer-i.md)
    - [WebGLProgram](arkts-arkgraphics2d-webgl-webglprogram-i.md)
    - [WebGLRenderbuffer](arkts-arkgraphics2d-webgl-webglrenderbuffer-i.md)
    - [WebGLRenderingContext](arkts-arkgraphics2d-webgl-webglrenderingcontext-i.md)
    - [WebGLRenderingContextBase](arkts-arkgraphics2d-webgl-webglrenderingcontextbase-i.md)
    - [WebGLRenderingContextOverloads](arkts-arkgraphics2d-webgl-webglrenderingcontextoverloads-i.md)
    - [WebGLShader](arkts-arkgraphics2d-webgl-webglshader-i.md)
    - [WebGLShaderPrecisionFormat](arkts-arkgraphics2d-webgl-webglshaderprecisionformat-i.md)
    - [WebGLTexture](arkts-arkgraphics2d-webgl-webgltexture-i.md)
    - [WebGLUniformLocation](arkts-arkgraphics2d-webgl-webgluniformlocation-i.md)
  ...
  - [webgl2](arkts-webgl2.md)
    ...
    - [WebGLQuery](arkts-arkgraphics2d-webgl2-webglquery-i.md)
    - [WebGLSampler](arkts-arkgraphics2d-webgl2-webglsampler-i.md)
    - [WebGLSync](arkts-arkgraphics2d-webgl2-webglsync-i.md)
    - [WebGLTransformFeedback](arkts-arkgraphics2d-webgl2-webgltransformfeedback-i.md)
    - [WebGLVertexArrayObject](arkts-arkgraphics2d-webgl2-webglvertexarrayobject-i.md)
