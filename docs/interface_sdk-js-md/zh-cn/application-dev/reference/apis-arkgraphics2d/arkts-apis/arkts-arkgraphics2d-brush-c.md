...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| brush | [Brush](arkts-arkgraphics2d-brush-c.md) | 是 | 待复制的画刷对象。 |
...
获取画刷的颜色，与[getColor](arkts-arkgraphics2d-brush-c.md#getcolor-1)的区别是返回值类型为浮点数，适用于需要浮点数类型的场景。
...
设置画刷的颜色。性能优于[setColor](arkts-arkgraphics2d-brush-c.md#setcolor-1)接口，推荐使用本接口。
...
设置画刷的颜色以及标准色域，与[setColor](arkts-arkgraphics2d-brush-c.md#setcolor-1)区别在于可以单独设置色域，适用于需要单独设置色域的场景。
