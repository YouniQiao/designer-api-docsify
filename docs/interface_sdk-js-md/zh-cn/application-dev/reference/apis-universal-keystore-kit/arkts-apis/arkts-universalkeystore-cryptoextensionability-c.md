...
| params | [Array](../../apis-arkts/arkts-apis/arkts-arkts-array-c.md)<huksExternalCrypto.HuksExternalCryptoParam> \| HuksCryptoExtensionParam[] | 是 | 操作属性。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| params | [Array](../../apis-arkts/arkts-apis/arkts-arkts-array-c.md)<huksExternalCrypto.HuksExternalCryptoParam> \| HuksCryptoExtensionParam[] | 否 | 操作属性 |
...
| params | [HuksCryptoExtensionParam](arkts-universalkeystore-hukscryptoextensionparam-i.md)[] | 是 | 导出公钥操作的属性参数。 |
...
| params | [HuksCryptoExtensionParam](arkts-universalkeystore-hukscryptoextensionparam-i.md)[] | 是 | 密钥生成操作的属性参数。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| params | [HuksCryptoExtensionParam](arkts-universalkeystore-hukscryptoextensionparam-i.md)[] | 是 | 获取资源ID所需的属性参数。 |
...
| params | [HuksCryptoExtensionParam](arkts-universalkeystore-hukscryptoextensionparam-i.md)[] | 是 | Indicates the needed properties for the import certificate operation. |
| certInfo | [HuksCryptoExtensionCertInfo](arkts-universalkeystore-hukscryptoextensioncertinfo-i.md) | 是 | 待导入的证书信息。需指定证书类型（purpose） |
...
| params | [HuksCryptoExtensionParam](arkts-universalkeystore-hukscryptoextensionparam-i.md)[] | 是 | 导入密钥所需的属性 |
| wrappedKey | [Uint8Array](../../apis-arkts/arkts-apis/arkts-arkts-uint8array-c.md) | 是 | 封装密钥数据，格式由密钥扩展定义。 |
...
| params | [HuksCryptoExtensionParam](arkts-universalkeystore-hukscryptoextensionparam-i.md)[] | 是 | 操作属性。 |
