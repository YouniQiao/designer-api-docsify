...
> [huks.finishSession<sup>9+</sup>](arkts-universalkeystore-finishsession-f.md#finishsession-1)  
> 替代。
...
| options | [HuksOptions](arkts-universalkeystore-huksoptions-i.md) | 是 | Finish的参数集合。 |
| callback | [AsyncCallback](../../apis-basic-service-kit/arkts-apis/arkts-basicservices-asynccallback-i.md)<HuksResult> | 是 | 回调函数。当密钥操作finish成功时，err为undefined，data为获取到的HuksResult；否则为错误对象。 |
...
>  
> 从API version 8开始支持，从API version 9开始废弃，建议使用  
> [huks.finishSession<sup>9+</sup>](arkts-universalkeystore-finishsession-f.md#finishsession-2)  
> 替代。
...
| --- | --- | --- | --- |
| handle | number | 是 | Finish操作的uint64类型的handle值。 |
| options | [HuksOptions](arkts-universalkeystore-huksoptions-i.md) | 是 | Finish操作的参数集合。 |
