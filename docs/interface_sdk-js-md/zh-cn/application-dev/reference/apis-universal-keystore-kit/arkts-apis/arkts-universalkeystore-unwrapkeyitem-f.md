...
| params | [HuksOptions](arkts-universalkeystore-huksoptions-i.md) | 是 | 用于指定导入密钥时的加密类型。 |
| wrappedKey | [Uint8Array](../../apis-arkts/arkts-apis/arkts-arkts-uint8array-c.md) | 是 | 加密导出密钥的密文。 |
