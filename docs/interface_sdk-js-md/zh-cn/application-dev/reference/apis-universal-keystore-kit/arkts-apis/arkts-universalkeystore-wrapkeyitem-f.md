...
> **说明：**  
>  
> 加密导出[HuksKeySecurityLevel](arkts-universalkeystore-hukskeysecuritylevel-e.md)中定义的SE安全级别密钥需要ohos.permission.ACCESS_SE_KEY权限。
...
| params | [HuksOptions](arkts-universalkeystore-huksoptions-i.md) | 是 | 用于指定导出密钥时的加密类型。 |
