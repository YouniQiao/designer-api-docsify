...
| --- | --- | --- | --- |
| initHandle | string | 是 | 资源句柄。 |
| params | [huks.HuksOptions](arkts-universalkeystore-huks-huksoptions-i.md) \| [HuksCryptoExtensionParams](arkts-universalkeystore-security-cryptoextensionability-hukscryptoextensionparams-i.md) | 是 | params indicates the properties of the operation<br>**适用版本：** 26.0.0 |
