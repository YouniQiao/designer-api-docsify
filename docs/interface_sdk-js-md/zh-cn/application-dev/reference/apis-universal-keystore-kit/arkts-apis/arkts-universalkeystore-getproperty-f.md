...
| params | [Array](../../apis-arkts/arkts-apis/arkts-arkts-array-c.md)<HuksExternalCryptoParam> | 否 | 需要传递给[Extension Ability](arkts-security-cryptoextensionability.md)的输入参数。非系统应用传入[HUKS_EXT_CRYPTO_TAG_UID](arkts-universalkeystore-huksexternalcryptotagtype-e.md)是非法参数。 |
