...
| options | [HuksOptions](arkts-universalkeystore-huksoptions-i.md) | 是 | updateSession的参数集合。 |
| callback | [AsyncCallback](../../apis-basic-service-kit/arkts-apis/arkts-basicservices-asynccallback-i.md)<HuksReturnResult> | 是 | 回调函数。当密钥操作update成功时，err为undefined，data为获取到的HuksReturnResult；否则为错误对象。 |
...
| options | [HuksOptions](arkts-universalkeystore-huksoptions-i.md) | 是 | Parameter set used for the **updateSession** operation. |
...
| --- | --- | --- | --- |
| handle | number | 是 | updateSession操作的uint64类型的handle值。 |
| options | [HuksOptions](arkts-universalkeystore-huksoptions-i.md) | 是 | updateSession操作的参数集合。 |
