...
| [beforeComponent](arkts-test-on-beforecomponent-f.md#beforecomponent) | 要求目标组件位于由给定[Component](arkts-test-uitest-component-c.md#component)指定的另一个组件之前 对象，用于相对于组件定位。 |
| [afterComponent](arkts-test-on-aftercomponent-f.md#aftercomponent) | 要求目标组件位于由给定[Component](arkts-test-uitest-component-c.md#component)指定的另一个组件之后 对象，用于相对于组件定位。 |
| [withinComponent](arkts-test-on-withincomponent-f.md#withincomponent) | 要求目标组件位于由给定[Component](arkts-test-uitest-component-c.md#component)指定的另一个组件的内部 对象，用于相对于组件定位。 |
