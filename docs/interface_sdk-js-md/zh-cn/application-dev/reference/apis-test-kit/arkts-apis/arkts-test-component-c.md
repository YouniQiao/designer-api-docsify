...
| 错误码ID | 错误信息 |
| --- | --- |
| [17000002](../errorcode-uitest.md#17000002-接口不支持并发调用) | 该API不支持并发调用。 |
| [17000004](../errorcode-uitest.md#17000004-目标控件窗口不可见或已销毁) | 窗口或组件不可见或已销毁。 |
...
| --- | --- |
| [401](../../apis-contacts-kit/errorcode-contacts.md#401-系统内部错误) | 参数错误。可能原因：1.必填参数未指定；2.参数类型错误；3.参数校验失败。 |
| [801](../../errorcode-universal.md#801-该设备不支持此api) | 能力不支持。由于设备能力限制，功能无法正常工作。 |
| [17000002](../errorcode-uitest.md#17000002-接口不支持并发调用) | 该API不支持并发调用。 |
| [17000004](../errorcode-uitest.md#17000004-目标控件窗口不可见或已销毁) | 窗口或组件不可见或已销毁。 |
...
| 错误码ID | 错误信息 |
| --- | --- |
| [401](../../apis-contacts-kit/errorcode-contacts.md#401-系统内部错误) | 参数错误。可能原因：1.参数类型错误；2.参数校验失败。 |
| [17000002](../errorcode-uitest.md#17000002-接口不支持并发调用) | 该API不支持并发调用。 |
| [17000004](../errorcode-uitest.md#17000004-目标控件窗口不可见或已销毁) | 窗口或组件不可见或已销毁。 |
