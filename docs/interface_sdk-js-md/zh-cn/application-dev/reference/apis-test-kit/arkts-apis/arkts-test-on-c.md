...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| com | [Component](../../apis-image-kit/arkts-apis/arkts-image-component-i.md) | 是 | 描述了目标组件在的后面。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| com | [Component](../../apis-image-kit/arkts-apis/arkts-image-component-i.md) | 是 | 目标组件前面的组件如所示。 |
...
| 类型 | 说明 |
| --- | --- |
| [On](arkts-test-on-c.md) | - 返回指定控件所属屏幕的On对象。 |
...
| 类型 | 说明 |
| --- | --- |
| [On](arkts-test-on-c.md) | - 返回指定目标控件能否被勾选状态属性的On对象。 |
...
| 类型 | 说明 |
| --- | --- |
| [On](arkts-test-on-c.md) | - 返回指定目标控件的被勾选状态属性的On对象。 |
...
| 类型 | 说明 |
| --- | --- |
| [On](arkts-test-on-c.md) | - 返回指定目标控件的可点击状态属性的On对象。 |
...
| 类型 | 说明 |
| --- | --- |
| [On](arkts-test-on-c.md) | - 返回指定目标控件description属性的On对象。 |
...
| 类型 | 说明 |
| --- | --- |
| [On](arkts-test-on-c.md) | - 返回指定目标控件的使能状态属性的On对象。 |
...
| 类型 | 说明 |
| --- | --- |
| [On](arkts-test-on-c.md) | - 返回指定目标控件的获焦状态属性的On对象。 |
...
| 类型 | 说明 |
| --- | --- |
| [On](arkts-test-on-c.md) | - 返回指定提示文本控件的On对象。 |
...
| 类型 | 说明 |
| --- | --- |
| [On](arkts-test-on-c.md) | - 返回指定目标控件id属性的On对象。 |
...
| --- | --- | --- | --- |
| id | string | 是 | 指定控件的id值。&lt;!--RP2--&gt;&lt;!--RP2End--&gt; |
| pattern | [MatchPattern](arkts-test-matchpattern-e.md) | 是 | 指定的文本匹配模式。 |
...
| 类型 | 说明 |
| --- | --- |
| [On](arkts-test-on-c.md) | - 返回指定目标控件位于给出的应用窗口内的On对象。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| on | [On](arkts-test-on-c.md) | 是 | 特征控件的属性要求。 &lt;!--RP3--&gt;&lt;!--RP3End--&gt; |

**返回值：**

| 类型 | 说明 |
| --- | --- |
| [On](arkts-test-on-c.md) | - 返回指定目标控件位于给出的特征属性控件之后的On对象。 |
...
| 类型 | 说明 |
| --- | --- |
| [On](arkts-test-on-c.md) | - 返回指定目标控件位于给出的特征属性控件之前的On对象。 |
...
| 类型 | 说明 |
| --- | --- |
| [On](arkts-test-on-c.md) | - 返回指定目标控件的可长按点击状态属性的On对象。 |
...
| 类型 | 说明 |
| --- | --- |
| [On](arkts-test-on-c.md) | - 返回指定目标控件文本属性的On对象。 |
...
| 类型 | 说明 |
| --- | --- |
| [On](arkts-test-on-c.md) | - 返回指定目标控件的可滑动状态属性的On对象。 |
...
| 类型 | 说明 |
| --- | --- |
| [On](arkts-test-on-c.md) | - 返回指定目标控件的被选中状态属性的On对象。 |
...
| pattern | [MatchPattern](arkts-test-matchpattern-e.md) | 否 | 指定的文本匹配模式，默认为[EQUALS](arkts-test-matchpattern-e.md)。<br>**起始版本：** 10 |
...
| 类型 | 说明 |
| --- | --- |
| [On](arkts-test-on-c.md) | - 返回指定目标控件的控件类型属性的On对象。 |
...
| 类型 | 说明 |
| --- | --- |
| [On](arkts-test-on-c.md) | - 返回指定目标控件位于给出的特征属性控件内的On对象。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| com | [Component](../../apis-image-kit/arkts-apis/arkts-image-component-i.md) | 是 | 描述目标组件所在的组件。 |

**返回值：**

| 类型 | 说明 |
| --- | --- |
| [On](arkts-test-on-c.md) | this {@link On}对象。 |
