...
**替代接口：** [@ohos.app.form.formBindingData:formBindingData#createFormBindingData](arkts-form-formbindingdata-createformbindingdata-depr-f.md#createformbindingdata)
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| obj | Object \| string | 否 | Data to be displayed on the JS widget. The value can be an object containing multiple key-value pairs or a string in JSON format. The image data is identified by **'formImages'**, and the content is multiple key-value pairs, each of which consists of an image identifier and image file descriptor. The final format is {'formImages': {'key1': fd1, 'key2': fd2}}. |
