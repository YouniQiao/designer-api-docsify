# offTemplateFormDetailInfoChange（系统接口）
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | formInfo.TemplateFormDetailInfoCallback | 否 | Callback function used to listen for changes in the static configuration information of template widgets. |
