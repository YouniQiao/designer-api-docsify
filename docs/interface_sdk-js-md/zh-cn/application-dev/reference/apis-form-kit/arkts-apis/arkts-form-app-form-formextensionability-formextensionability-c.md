...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| newStatus | ArkTS-Dyn: [Record](../../apis-default/arkts-apis/arkts-record-t.md)&lt;string, number&gt;  <br>ArkTS-Sta：[Record](../../apis-default/arkts-apis/arkts-record-t.md)&lt;string, int&gt; | 是 | ID and visibility status of the widget to be changed.<br>**起始版本：** 11 |
