...
| --- | --- | --- | --- |
| formProviderFilter | formInfo.FormProviderFilter | 是 | 卡片提供方应用信息。 |
| callback | [AsyncCallback](../../apis-basic-service-kit/arkts-apis/arkts-basicservices-base-asynccallback-i.md)&lt;Array&lt;formInfo.RunningFormInfo&gt;&gt; | 是 | 回调函数。返回已添加的卡片信息列表。error为undefined，data为查询到的卡片信 息列表；否则为错误对象。 |
