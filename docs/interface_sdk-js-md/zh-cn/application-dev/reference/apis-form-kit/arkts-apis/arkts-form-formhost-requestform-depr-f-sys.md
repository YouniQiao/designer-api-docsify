...
**替代接口：** [@ohos.app.form.formHost:formHost#requestForm](arkts-form-formhost-requestform-depr-f-sys.md#requestform)
...
| callback | [AsyncCallback](../../apis-basic-service-kit/arkts-apis/arkts-basicservices-base-asynccallback-i.md)&lt;void&gt; | 是 | Callback used to return the result. If the widget is updated, **error** is undefined; otherwise, **error** is an error object. |
