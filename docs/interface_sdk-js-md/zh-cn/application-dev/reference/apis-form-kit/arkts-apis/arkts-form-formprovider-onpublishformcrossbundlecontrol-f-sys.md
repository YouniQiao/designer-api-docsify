...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | formInfo.PublishFormCrossBundleControlCallback | 是 | Callback function used to return the control result on cross-bundle widget addition to the home screen. |
