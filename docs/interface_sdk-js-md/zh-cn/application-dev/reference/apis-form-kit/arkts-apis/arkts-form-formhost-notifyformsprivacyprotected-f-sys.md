...
| isProtected | boolean | 是 | Whether a widget requires privacy protection. &lt;br&gt;**true**: The widget requires privacy protection. &lt;br&gt;**false**: The widget does not require privacy protection. |
| callback | [AsyncCallback](../../apis-basic-service-kit/arkts-apis/arkts-basicservices-base-asynccallback-i.md)&lt;void&gt; | 是 | Callback used to return the result. If privacy protection is set successfully, **error** is undefined; otherwise, **error** is an error object. |
