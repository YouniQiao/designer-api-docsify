...
| callback | [AsyncCallback](../../apis-basic-service-kit/arkts-apis/arkts-basicservices-base-asynccallback-i.md)&lt;Array&lt;formInfo.FormInfo&gt;&gt; | 是 | Callback used to return the information obtained. |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| filter | formInfo.FormInfoFilter | 否 | Filter criterion. By default, no value is passed, indicating that no filtering is performed. |
