...
| callback | [Callback](../../apis-basic-service-kit/arkts-apis/arkts-basicservices-base-callback-i.md)&lt;SecurityEvent&gt; | 是 | Indicates the listener when the security event occurs. |
