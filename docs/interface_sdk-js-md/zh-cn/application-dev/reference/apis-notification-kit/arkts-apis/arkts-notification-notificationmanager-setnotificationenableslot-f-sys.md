...
| type | \_\_\_MD\_LINK\_USD\_0\_\_\_ | 是 | 指定渠道类型。 |
| enable | boolean | 是 | 使能状态（true：使能，false：禁止）。 |
| callback | \_\_\_MD\_LINK\_USD\_0\_\_\_&lt;void&gt; | 是 | 设置渠道使能回调函数。 |
...
| [1600012](../errorcode-notification.md#1600012-内存空间不足) | No memory space.\_\_\_HTML\_TAG\_USD\_0\_\_\_**适用版本：** 11+ |
...
| enable | boolean | 是 | 使能状态（true：使能，false：禁止）。 |
| isForceControl | boolean | 否 | 渠道开关是否受通知总开关影响（false：受总开关影响，true：不受总开关影响）。默认为false。\_\_\_HTML\_TAG\_USD\_0\_\_\_**起始版本：** 11 |
