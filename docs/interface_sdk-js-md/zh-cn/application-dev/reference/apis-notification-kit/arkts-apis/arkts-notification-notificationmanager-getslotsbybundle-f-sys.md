...
| callback | [AsyncCallback](../../apis-basic-services-kit/arkts-apis/arkts-basicservices-base-asynccallback-i.md)&lt;Array&lt;[NotificationSlot](arkts-notification-notificationmanager-notificationslot-t.md)&gt;&gt; | 是 | 获取通知渠道回调函数。 |
...
| 类型 | 说明 |
| --- | --- |
| Promise&lt;Array&lt;[NotificationSlot](arkts-notification-notificationmanager-notificationslot-t.md)&gt;&gt; | 以Promise形式返回获取指定应用的通知渠道。 |
