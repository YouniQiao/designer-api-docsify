...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| data | Array&lt;\_\_\_MD\_LINK\_USD\_0\_\_\_&gt; | 是 |  |
...
**替代接口：** [NotificationSubscriber#onDoNotDisturbChanged](notificationsubscriber-notificationsubscriber-i-sys.md#ondonotdisturbchanged)
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callbackData | \_\_\_MD\_LINK\_USD\_0\_\_\_ | 是 |  |
...
返回由[notificationManager.setNotificationSwitch]\_\_\_JSDOC\_LINK\_DESC\_USD\_0\_\_\_接口设置的通知开关状态变化。
