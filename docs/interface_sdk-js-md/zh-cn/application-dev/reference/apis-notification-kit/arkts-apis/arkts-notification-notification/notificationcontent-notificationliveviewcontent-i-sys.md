...
描述普通实况通知。继承自[NotificationBasicContent]\_\_\_JSDOC\_LINK\_DESC\_USD\_0\_\_\_。

**继承/实现关系：** NotificationLiveViewContent extends [NotificationBasicContent](notificationcontent-notificationbasiccontent-i.md)
