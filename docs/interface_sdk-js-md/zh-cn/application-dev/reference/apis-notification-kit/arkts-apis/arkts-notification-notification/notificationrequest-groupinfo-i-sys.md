...
是否使用该通知[NotificationRequest]\_\_\_JSDOC\_LINK\_DESC\_USD\_0\_\_\_中的smallIcon字段作为通知成组后展示的组图标。当该通知是通知组中最新的一条通知，且开发者传入smallIcon时，是否使用smallIcon作为组图标。默认值为false。
