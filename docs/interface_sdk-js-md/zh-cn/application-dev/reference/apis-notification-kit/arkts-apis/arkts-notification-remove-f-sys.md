...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| hashCodes | [Array](../../apis-arkts/arkts-apis/arkts-arkts-array-c.md)<String> | 是 | 通知唯一ID数组集合。可以通过[onConsume](arkts-notification-notificationsubscriber-i-sys.md#onconsume)回调的入参[SubscribeCallbackData](arkts-notification-subscribecallbackdata-i-sys.md)获取其内部[NotificationRequest](arkts-notification-notificationrequest-i.md)对象中的hashCode。 |
| reason | [RemoveReason](arkts-notification-removereason-e-sys.md) | 是 | 通知删除原因。 |
| callback | [AsyncCallback](../../apis-basic-service-kit/arkts-apis/arkts-basicservices-asynccallback-i.md)<void> | 是 | 删除指定通知回调函数。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| hashCodes | [Array](../../apis-arkts/arkts-apis/arkts-arkts-array-c.md)<String> | 是 | 通知唯一ID数组集合。 |
| reason | [RemoveReason](arkts-notification-removereason-e-sys.md) | 是 | 通知删除原因。 |
