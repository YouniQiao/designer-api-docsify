...
**替代接口：** [isDistributedEnabled](notificationManager.isDistributedEnabled(deviceType:)
...
| [801](../../../../../../../../gitee_tmp/docs/stamaster/zh-cn/application-dev/reference/errorcode-universal.md#801-该设备不支持此api) | Capability not supported.<br>**适用版本：** 26.0.0+ |
