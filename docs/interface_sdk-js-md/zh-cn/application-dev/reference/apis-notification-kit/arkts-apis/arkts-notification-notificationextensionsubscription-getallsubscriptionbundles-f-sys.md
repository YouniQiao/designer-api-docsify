...
获取所有具有ohos.permission.SUBSCRIBE\_NOTIFICATION权限并且实现了  
[NotificationSubscriberExtensionAbility]\_\_\_JSDOC\_LINK\_DESC\_USD\_0\_\_\_的应用列表。使用Promise异步回调。
...
| 类型 | 说明 |
| --- | --- |
| Promise&lt;BundleOption[]&gt; | Promise对象，返回所有具有 ohos.permission.SUBSCRIBE\_\_\_ESCAPED\_UNDERSCORE\_\_\_NOTIFICATION权限并且实现了 NotificationSubscriberExtensionAbility的应用列表。 |
