...
需要当前应用与其他应用存在代理关系，或者当前应用有ohos.permission.NOTIFICATION\_AGENT\_CONTROLLER权限。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| representativeBundle | \_\_\_MD\_LINK\_USD\_0\_\_\_ | 是 | 应用的包信息。 |
| id | ArkTS-Dyn: number  \_\_\_HTML\_TAG\_USD\_0\_\_\_ArkTS-Sta：int | 是 | 通知ID。 |
