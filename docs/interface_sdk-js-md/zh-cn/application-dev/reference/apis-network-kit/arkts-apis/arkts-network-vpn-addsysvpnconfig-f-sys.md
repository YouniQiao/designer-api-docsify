...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| config | [SysVpnConfig](arkts-network-vpn-sysvpnconfig-i-sys.md) | 是 | Indicates the [SysVpnConfig](arkts-network-vpn-sysvpnconfig-i-sys.md) configuration of the VPN network. |
