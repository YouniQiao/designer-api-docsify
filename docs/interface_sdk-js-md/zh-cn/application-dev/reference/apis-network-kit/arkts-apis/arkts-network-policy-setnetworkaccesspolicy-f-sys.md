...
| policy | [NetworkAccessPolicy](arkts-network-policy-networkaccesspolicy-i-sys.md) | 是 | The network access policy of application. For details, see {@link NetworkAccessPolicy}. |
| isReconfirmed | boolean | 否 | Whether this operation is reconfirmed by user or not. Default false. |
