...
| callback | [Callback](../../apis-basic-service-kit/arkts-apis/arkts-basicservices-base-callback-i.md)&lt;DiscoveryEventInfo&gt; | 否 | the callback used to return the result. |
...
| callback | [Callback](../../apis-basic-service-kit/arkts-apis/arkts-basicservices-base-callback-i.md)&lt;LocalServiceInfo&gt; | 否 | the callback used to return the result. |
...
| --- | --- | --- | --- |
| type | 'discoveryStart' | 是 | Indicates Event name. |
| callback | [Callback](../../apis-basic-service-kit/arkts-apis/arkts-basicservices-base-callback-i.md)&lt;DiscoveryEventInfo&gt; | 是 | the callback used to return the result. |
...
| --- | --- | --- | --- |
| type | 'serviceFound' | 是 | Indicates Event name. |
| callback | [Callback](../../apis-basic-service-kit/arkts-apis/arkts-basicservices-base-callback-i.md)&lt;LocalServiceInfo&gt; | 是 | the callback used to return the result. |
