...
| off | 注销网络共享状态变化事件，使用 callback 异步回调。 |
| off | 注销网卡网络共享状态变化事件，使用 callback 异步回调。 |
| off | 注销上行网络变化事件，使用 callback 异步回调。 |
| on | 注册网络共享状态变化事件，使用 callback 异步回调。 |
| on | 注册网卡网络共享状态变化事件，使用 callback 异步回调。 |
| on | 注册上行网络变化事件，使用 callback 异步回调。 |
