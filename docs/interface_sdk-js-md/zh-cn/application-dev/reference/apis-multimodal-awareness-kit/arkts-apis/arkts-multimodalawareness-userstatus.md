...
| 名称 | 说明 |
| --- | --- |
| [off](arkts-multimodalawareness-userstatus-off-f.md#offuseragegroupdetected) | 取消订阅年龄群组检测功能。 |
| [on](arkts-multimodalawareness-userstatus-on-f.md#onuseragegroupdetected) | 订阅年龄群组检测功能。 |
