...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| interval | number | 是 | Shooting interval, in units of ms, the supported range can be obtained by calling [getSupportedTimeLapseIntervalRange](arkts-camera-camera-timelapsephotosession-i-sys.md#getsupportedtimelapseintervalrange) |
