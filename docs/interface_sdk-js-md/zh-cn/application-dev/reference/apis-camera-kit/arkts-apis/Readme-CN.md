...
- [@ohos.multimedia.camera(AutoDeviceSwitch)](arkts-multimedia-camera.md)
  ...
  <!--Del-->
  - [BeautyQuery(系统接口)](arkts-camera-camera-beautyquery-i-sys.md)<!--DelEnd-->
  - [CameraConcurrentInfo](arkts-camera-camera-cameraconcurrentinfo-i.md)
  - [CameraDevice](arkts-camera-camera-cameradevice-i.md)
  <!--Del-->
  - [CameraDevice(系统接口)](arkts-camera-camera-cameradevice-i-sys.md)<!--DelEnd-->
  - [CameraInput](arkts-camera-camera-camerainput-i.md)
  <!--Del-->
  - [CameraInput(系统接口)](arkts-camera-camera-camerainput-i-sys.md)<!--DelEnd-->
  ...
  <!--Del-->
  - [ColorEffectQuery(系统接口)](arkts-camera-camera-coloreffectquery-i-sys.md)<!--DelEnd-->
  ...
  <!--Del-->
  - [ColorReservation(系统接口)](arkts-camera-camera-colorreservation-i-sys.md)<!--DelEnd-->
  <!--Del-->
  - [ColorReservationQuery(系统接口)](arkts-camera-camera-colorreservationquery-i-sys.md)<!--DelEnd-->
  - [ControlCenter](arkts-camera-camera-controlcenter-i.md)
  - [ControlCenterQuery](arkts-camera-camera-controlcenterquery-i.md)
  <!--Del-->
  - [ControlCenterSession(系统接口)](arkts-camera-camera-controlcentersession-i-sys.md)<!--DelEnd-->
  - [ControlCenterStatusInfo](arkts-camera-camera-controlcenterstatusinfo-i.md)
  <!--Del-->
  - [DeferredPhotoProxy(系统接口)](arkts-camera-camera-deferredphotoproxy-i-sys.md)<!--DelEnd-->
  <!--Del-->
  - [DeferredVideoEnhancementInfo(系统接口)](arkts-camera-camera-deferredvideoenhancementinfo-i-sys.md)<!--DelEnd-->
  <!--Del-->
  - [DepthData(系统接口)](arkts-camera-camera-depthdata-i-sys.md)<!--DelEnd-->
  <!--Del-->
  - [DepthDataOutput(系统接口)](arkts-camera-camera-depthdataoutput-i-sys.md)<!--DelEnd-->
  <!--Del-->
  - [DepthFusion(系统接口)](arkts-camera-camera-depthfusion-i-sys.md)<!--DelEnd-->
  <!--Del-->
  - [DepthFusionQuery(系统接口)](arkts-camera-camera-depthfusionquery-i-sys.md)<!--DelEnd-->
  <!--Del-->
  ...
  <!--Del-->
  - [FlashQuery(系统接口)](arkts-camera-camera-flashquery-i-sys.md)<!--DelEnd-->
  <!--Del-->
  - [FluorescencePhotoSession(系统接口)](arkts-camera-camera-fluorescencephotosession-i-sys.md)<!--DelEnd-->
  - [Focus](arkts-camera-camera-focus-i.md)
  <!--Del-->
  - [Focus(系统接口)](arkts-camera-camera-focus-i-sys.md)<!--DelEnd-->
  - [FocusQuery](arkts-camera-camera-focusquery-i.md)
  <!--Del-->
  - [FocusQuery(系统接口)](arkts-camera-camera-focusquery-i-sys.md)<!--DelEnd-->
  <!--Del-->
  - [FocusTrackingInfo(系统接口)](arkts-camera-camera-focustrackinginfo-i-sys.md)<!--DelEnd-->
  ...
  <!--Del-->
  - [HighResolutionPhotoSession(系统接口)](arkts-camera-camera-highresolutionphotosession-i-sys.md)<!--DelEnd-->
  <!--Del-->
  ...
  <!--Del-->
  - [LightPaintingPhotoSession(系统接口)](arkts-camera-camera-lightpaintingphotosession-i-sys.md)<!--DelEnd-->
  ...
  <!--Del-->
  - [PanoramaPhotoSession(系统接口)](arkts-camera-camera-panoramaphotosession-i-sys.md)<!--DelEnd-->
  ...
  <!--Del-->
  - [PortraitQuery(系统接口)](arkts-camera-camera-portraitquery-i-sys.md)<!--DelEnd-->
  <!--Del-->
  - [PrelaunchConfig(系统接口)](arkts-camera-camera-prelaunchconfig-i-sys.md)<!--DelEnd-->
  - [PreviewOutput](arkts-camera-camera-previewoutput-i.md)
  <!--Del-->
  - [PreviewOutput(系统接口)](arkts-camera-camera-previewoutput-i-sys.md)<!--DelEnd-->
  <!--Del-->
  - [ProfessionalPhotoSession(系统接口)](arkts-camera-camera-professionalphotosession-i-sys.md)<!--DelEnd-->
  <!--Del-->
  - [ProfessionalVideoSession(系统接口)](arkts-camera-camera-professionalvideosession-i-sys.md)<!--DelEnd-->
  - [Profile](arkts-camera-camera-profile-i.md)
  <!--Del-->
  - [QuickShotPhotoSession(系统接口)](arkts-camera-camera-quickshotphotosession-i-sys.md)<!--DelEnd-->
  <!--Del-->
  ...
  <!--Del-->
  - [SceneFeatureDetectionResult(系统接口)](arkts-camera-camera-scenefeaturedetectionresult-i-sys.md)<!--DelEnd-->
  - [SecureSession](arkts-camera-camera-securesession-i.md)
  - [Session](arkts-camera-camera-session-i.md)
  <!--Del-->
  - [Session(系统接口)](arkts-camera-camera-session-i-sys.md)<!--DelEnd-->
  <!--Del-->
  - [SettingParam(系统接口)](arkts-camera-camera-settingparam-i-sys.md)<!--DelEnd-->
  - [Size](arkts-camera-camera-size-i.md)
  <!--Del-->
  - [SketchStatusData(系统接口)](arkts-camera-camera-sketchstatusdata-i-sys.md)<!--DelEnd-->
  <!--Del-->
  - [SlowMotionVideoSession(系统接口)](arkts-camera-camera-slowmotionvideosession-i-sys.md)<!--DelEnd-->
  ...
  <!--Del-->
  - [TimeLapsePhotoSession(系统接口)](arkts-camera-camera-timelapsephotosession-i-sys.md)<!--DelEnd-->
  ...
  <!--Del-->
  - [AuxiliaryStatus(系统接口)](arkts-camera-camera-auxiliarystatus-e-sys.md)<!--DelEnd-->
  <!--Del-->
  - [AuxiliaryType(系统接口)](arkts-camera-camera-auxiliarytype-e-sys.md)<!--DelEnd-->
  <!--Del-->
  - [BeautyType(系统接口)](arkts-camera-camera-beautytype-e-sys.md)<!--DelEnd-->
  ...
  <!--Del-->
  - [CameraErrorCode(系统接口)](arkts-camera-camera-cameraerrorcode-e-sys.md)<!--DelEnd-->
  - [CameraFormat](arkts-camera-camera-cameraformat-e.md)
  <!--Del-->
  - [CameraFormat(系统接口)](arkts-camera-camera-cameraformat-e-sys.md)<!--DelEnd-->
  <!--Del-->
  ...
  <!--Del-->
  - [ColorEffectType(系统接口)](arkts-camera-camera-coloreffecttype-e-sys.md)<!--DelEnd-->
  <!--Del-->
  - [ColorReservationType(系统接口)](arkts-camera-camera-colorreservationtype-e-sys.md)<!--DelEnd-->
  ...
  <!--Del-->
  - [DeferredDeliveryImageType(系统接口)](arkts-camera-camera-deferreddeliveryimagetype-e-sys.md)<!--DelEnd-->
  <!--Del-->
  - [DepthDataAccuracy(系统接口)](arkts-camera-camera-depthdataaccuracy-e-sys.md)<!--DelEnd-->
  <!--Del-->
  ...
  <!--Del-->
  - [FocusDrivenType(系统接口)](arkts-camera-camera-focusdriventype-e-sys.md)<!--DelEnd-->
  - [FocusMode](arkts-camera-camera-focusmode-e.md)
  <!--Del-->
  - [FocusRangeType(系统接口)](arkts-camera-camera-focusrangetype-e-sys.md)<!--DelEnd-->
  ...
  <!--Del-->
  - [LightStatus(系统接口)](arkts-camera-camera-lightstatus-e-sys.md)<!--DelEnd-->
  - [MetadataObjectType](arkts-camera-camera-metadataobjecttype-e.md)
  <!--Del-->
  - [MetadataObjectType(系统接口)](arkts-camera-camera-metadataobjecttype-e-sys.md)<!--DelEnd-->
  ...
  <!--Del-->
  - [PolicyType(系统接口)](arkts-camera-camera-policytype-e-sys.md)<!--DelEnd-->
  <!--Del-->
  - [PortraitEffect(系统接口)](arkts-camera-camera-portraiteffect-e-sys.md)<!--DelEnd-->
  <!--Del-->
  - [PortraitThemeType(系统接口)](arkts-camera-camera-portraitthemetype-e-sys.md)<!--DelEnd-->
  ...
  <!--Del-->
  - [RestoreParamType(系统接口)](arkts-camera-camera-restoreparamtype-e-sys.md)<!--DelEnd-->
  <!--Del-->
  - [SceneFeatureType(系统接口)](arkts-camera-camera-scenefeaturetype-e-sys.md)<!--DelEnd-->
  - [SceneMode](arkts-camera-camera-scenemode-e.md)
  <!--Del-->
  - [SceneMode(系统接口)](arkts-camera-camera-scenemode-e-sys.md)<!--DelEnd-->
  - [SensorColorFilterArrangement](arkts-camera-camera-sensorcolorfilterarrangement-e.md)
  <!--Del-->
  - [SlowMotionStatus(系统接口)](arkts-camera-camera-slowmotionstatus-e-sys.md)<!--DelEnd-->
  - [SmoothZoomMode](arkts-camera-camera-smoothzoommode-e.md)
  - [SystemPressureLevel](arkts-camera-camera-systempressurelevel-e.md)
  <!--Del-->
  - [TimeLapsePreviewType(系统接口)](arkts-camera-camera-timelapsepreviewtype-e-sys.md)<!--DelEnd-->
  <!--Del-->
  - [TimeLapseRecordState(系统接口)](arkts-camera-camera-timelapserecordstate-e-sys.md)<!--DelEnd-->
  - [TorchMode](arkts-camera-camera-torchmode-e.md)
  <!--Del-->
  - [TripodStatus(系统接口)](arkts-camera-camera-tripodstatus-e-sys.md)<!--DelEnd-->
  <!--Del-->
  - [UsageType(系统接口)](arkts-camera-camera-usagetype-e-sys.md)<!--DelEnd-->
