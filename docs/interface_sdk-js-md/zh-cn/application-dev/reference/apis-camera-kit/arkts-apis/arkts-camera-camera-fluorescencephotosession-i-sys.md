...
| callback | [ErrorCallback](../../apis-arkui/arkts-components/arkts-arkui-errorcallback-t-sys.md) | 否 | Callback used to get the capture session errors. |
...
| --- | --- | --- | --- |
| type | 'error' | 是 | Event type. |
| callback | [ErrorCallback](../../apis-arkui/arkts-components/arkts-arkui-errorcallback-t-sys.md) | 是 | Callback used to get the capture session errors. |
