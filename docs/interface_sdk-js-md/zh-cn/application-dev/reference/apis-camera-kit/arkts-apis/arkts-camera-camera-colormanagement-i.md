...
ColorManagement继承自[ColorManagementQuery](arkts-camera-camera-colormanagementquery-i.md#ColorManagementQuery)。
...
应用针对不同模式使能HDR效果、设置的色彩空间以及设置相机输出流[Profile](arkts-camera-camera-profile-i.md#Profile)中的[CameraFormat](arkts-camera-camera-cameraformat-e.md#CameraFormat)一一对应关系可参考下表。例如，在录像模式下若需要选择HDR拍摄，相机预览输出流和录像输出流[Profile](arkts-camera-camera-profile-i.md#Profile)中的[CameraFormat](arkts-camera-camera-cameraformat-e.md#CameraFormat)可选择CAMERA_FORMAT_YCRCB_P010，色彩空间ColorSpace可选择设置BT2020_HLG_LIMIT。
...
| [7400102](../../../../../../../../gitee_tmp/docs/stamaster/zh-cn/application-dev/reference/apis-camera-kit/errorcode-camera.md#7400102-非法操作) | The colorSpace does not match the format. |
| [7400103](../../../../../../../../gitee_tmp/docs/stamaster/zh-cn/application-dev/reference/apis-camera-kit/errorcode-camera.md#7400103-会话未配置) | Session not config. |
