...
**说明：** 从API version 6开始支持，从API version 8开始废弃，建议使用[CodecMimeType](arkts-media-media-codecmimetype-e.md)中的AUDIO_AMR_NB替代。
...
**说明：** 从API version 6开始支持，从API version 8开始废弃，建议使用[CodecMimeType](arkts-media-media-codecmimetype-e.md)中的AUDIO_AMR_WB替代。
