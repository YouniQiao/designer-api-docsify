...
播放管理类，用于管理和播放媒体资源。在调用AVPlayer的方法前，需要先通过[createAVPlayer()](arkts-media-createavplayer-f.md#createavplayer-1)构建一个AVPlayer实例。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| trackType | [MediaType](arkts-media-mediatype-e.md) | 是 | specified media Type, see [MediaType](#MediaType). |
