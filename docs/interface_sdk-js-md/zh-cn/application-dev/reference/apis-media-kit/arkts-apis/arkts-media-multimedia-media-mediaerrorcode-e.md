...
媒体服务错误类型枚举。
    **说明：**  
        从API version 8开始支持，从API version 11开始废弃，建议使用[AVErrorCode]\_\_\_JSDOC\_LINK\_DESC\_USD\_0\_\_\_替代。
...
**替代接口：** [media.AVErrorCode](arkts-media-media-averrorcode-e.md)
