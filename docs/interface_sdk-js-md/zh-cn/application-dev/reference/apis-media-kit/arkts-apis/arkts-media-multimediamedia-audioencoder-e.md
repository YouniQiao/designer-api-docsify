...
> **说明：**
> 
> 从API version 6开始支持，从API version 8开始废弃，建议使用[CodecMimeType](arkts-media-multimediamedia-codecmimetype-e.md)替代。
...
**替代接口：** [CodecMimeType](arkts-media-multimediamedia-codecmimetype-e.md)
...
**说明：** 从API version 6开始支持，从API version 8开始废弃，建议使用[CodecMimeType](arkts-media-multimediamedia-codecmimetype-e.md)中的AUDIO_AAC替代。
...
**说明：** 从API version 6开始支持，从API version 8开始废弃，建议使用[CodecMimeType](arkts-media-multimediamedia-codecmimetype-e.md)中的AUDIO_AMR_NB替代。
...
**说明：** 从API version 6开始支持，从API version 8开始废弃，建议使用[CodecMimeType](arkts-media-multimediamedia-codecmimetype-e.md)中的AUDIO_AMR_WB替代。
