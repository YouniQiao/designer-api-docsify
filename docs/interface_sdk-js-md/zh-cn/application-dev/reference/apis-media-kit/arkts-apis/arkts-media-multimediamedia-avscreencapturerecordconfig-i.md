...
**类型：** [AVScreenCaptureFillMode](arkts-media-multimediamedia-avscreencapturefillmode-e.md)
...
**类型：** [AVScreenCaptureRecordPreset](arkts-media-multimediamedia-avscreencapturerecordpreset-e.md)
...
**类型：** [AVScreenCaptureStrategy](arkts-media-multimediamedia-avscreencapturestrategy-i.md)
