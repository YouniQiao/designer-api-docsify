...
| config | [WatermarkConfiguration](arkts-media-multimediamedia-watermarkconfiguration-i.md) | 是 | : 水印配置参数。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| config | [AVTranscoderConfig](arkts-media-multimediamedia-avtranscoderconfig-i.md) | 是 | 配置视频转码的相关参数。 <!--RP1--><!--RP1End--> |
