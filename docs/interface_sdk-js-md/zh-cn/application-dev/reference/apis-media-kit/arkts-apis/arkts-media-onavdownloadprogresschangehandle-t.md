...
<!--Device-unnamed-type OnAVDownloadProgressChangeHandle = (taskId: string, progress: double) => void--><!--Device-unnamed-type OnAVDownloadProgressChangeHandle = (taskId: string, progress: double) => void-End-->
