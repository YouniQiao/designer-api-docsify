...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| type | [MetaSourceType](arkts-media-multimediamedia-metasourcetype-e-sys.md) | 是 | 元数据源类型。 |
...
| config | [WatermarkConfig](arkts-media-multimediamedia-watermarkconfig-i-sys.md) | 是 | 水印配置。 |
