...
| requestedLength | ArkTS-Dyn: number  <br>ArkTS-Sta：long | 是 | 当前请求的长度。值为-1时，表示到达资源末尾，此时推送完成后需通过 [finishLoading](@ohos.multimedia.media:media.MediaSourceLoadingRequest.finishLoading)方法通知播放器推送结束。 |
