...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| streams | [Array](../../apis-arkts/arkts-apis/arkts-arkts-array-c.md)<MediaStream> | 是 | 可设置MediaStream数组，支持的流媒体格式：HTTP-FLV。 |

**返回值：**

| 类型 | 说明 |
| --- | --- |
| [MediaSource](arkts-media-mediasource-i.md) | 返回MediaSource，用于媒体资源设置。 |
