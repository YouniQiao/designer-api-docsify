...
**类型：** [AudioSourceType](arkts-media-multimediamedia-audiosourcetype-e.md)
...
**类型：** [FileGenerationMode](arkts-media-multimediamedia-filegenerationmode-e.md)
...
**类型：** [AVRecorderProfile](arkts-media-multimediamedia-avrecorderprofile-i.md)
...
**类型：** [VideoSourceType](arkts-media-multimediamedia-videosourcetype-e.md)
