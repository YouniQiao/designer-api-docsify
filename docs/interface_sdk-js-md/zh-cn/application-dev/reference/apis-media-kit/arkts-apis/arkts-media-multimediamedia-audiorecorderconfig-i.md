...
**类型：** [AudioEncoder](arkts-media-multimediamedia-audioencoder-e.md)
...
**类型：** [CodecMimeType](arkts-media-multimediamedia-codecmimetype-e.md)
...
**类型：** [ContainerFormatType](arkts-media-multimediamedia-containerformattype-e.md)
...
**类型：** [AudioOutputFormat](arkts-media-multimediamedia-audiooutputformat-e.md)
