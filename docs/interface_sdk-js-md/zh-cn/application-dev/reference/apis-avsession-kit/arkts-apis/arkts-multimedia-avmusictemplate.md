...
| 名称 | 说明 |
| --- | --- |
| [createAVMusicTemplate](arkts-avsession-avmusictemplate-createavmusictemplate-f.md) | 创建音频模板，返回音频模板实例。 |
...
| 名称 | 说明 |
| --- | --- |
| [createAVMusicTemplateController](arkts-avsession-avmusictemplate-createavmusictemplatecontroller-f-sys.md) | 创建音频模板控制器，返回音频模板控制器对象。 |
| [getAllAVMusicTemplateDescriptors](arkts-avsession-avmusictemplate-getallavmusictemplatedescriptors-f-sys.md) | 获取所有的音频模板描述，返回音频模板描述的集合。 |
| [offAVMusicTemplateCreate](arkts-avsession-avmusictemplate-offavmusictemplatecreate-f-sys.md) | 注销音频模板创建监听。 |
| [offAVMusicTemplateDestroy](arkts-avsession-avmusictemplate-offavmusictemplatedestroy-f-sys.md) | 注销音频模板销毁监听。 |
| [onAVMusicTemplateCreate](arkts-avsession-avmusictemplate-onavmusictemplatecreate-f-sys.md) | 注册音频模板创建的监听。使用callback异步回调。 |
| [onAVMusicTemplateDestroy](arkts-avsession-avmusictemplate-onavmusictemplatedestroy-f-sys.md) | 注册音频模板销毁监听。使用callback异步回调。 |
<!--DelEnd-->
...
| 名称 | 说明 |
| --- | --- |
| [AVMusicTemplate](arkts-avsession-avmusictemplate-avmusictemplate-c.md) | 调用[avMusicTemplate.createAVMusicTemplate](arkts-avsession-avmusictemplate-createavmusictemplate-f.md)获取实例后，可获取其ID，启动音频模板界面，并配置数据获取 方法。随后，同步数据给模板控制方，以完成后续操作。 |
...
| 名称 | 说明 |
| --- | --- |
| [AVMusicTemplateErrorCode](arkts-avsession-avmusictemplate-avmusictemplateerrorcode-e.md) | 表示错误码类型的枚举。@enum { int } |
| [AVMusicTemplateType](arkts-avsession-avmusictemplate-avmusictemplatetype-e.md) | 表示音频模板类型的枚举。@enum { string } |
| [ButtonType](arkts-avsession-avmusictemplate-buttontype-e.md) | 表示按钮类型的枚举。@enum { int } |
| [DialogType](arkts-avsession-avmusictemplate-dialogtype-e.md) | 表示对话框类型的枚举。@enum { int } |
| [DownloadStatus](arkts-avsession-avmusictemplate-downloadstatus-e.md) | 表示下载状态类型的枚举。@enum { int } |
| [EntityType](arkts-avsession-avmusictemplate-entitytype-e.md) | 表示媒体资源类型的枚举。@enum { int } |
| [MemberPurchaseType](arkts-avsession-avmusictemplate-memberpurchasetype-e.md) | 表示会员购买类型的枚举。@enum { string } |
| [PlaybackState](arkts-avsession-avmusictemplate-playbackstate-e.md) | 表示媒体资源的播放状态的枚举。@enum { int } |
| [SearchPlayInfoType](arkts-avsession-avmusictemplate-searchplayinfotype-e.md) | 表示搜播信息类型的枚举。@enum { string } |
| [SettingType](arkts-avsession-avmusictemplate-settingtype-e.md) | 表示设置类型的枚举。@enum { int } |
| [Sort](arkts-avsession-avmusictemplate-sort-e.md) | 表示查询到的列表数据排序类型的枚举。@enum { int } |
