...
## off_accountChange('accountChange')
...
取消订阅账号信息变更事件。 > **说明：** > > 从API version 7开始支持，从API version 9开始废弃。建议使用 > [off('accountChange')](#off_changechange) > 替代。

**起始版本：** 7

**废弃版本：** 9

**替代接口：** [off](#off_changechange)(type: 'accountChange', callback?: Callback&lt;Array&lt;AppAccountInfo&gt;&gt;)
...
## on_accountChange('accountChange')
...
订阅指定应用的账号信息变更事件。 > **说明：** > > 从API version 7开始支持，从API version 9开始废弃。建议使用 > [on('accountChange')](#on_changechange) > 替代。

**起始版本：** 7

**废弃版本：** 9

**替代接口：** [on](#on_changechange)(type: 'accountChange', owners: Array&lt;string&gt;, callback: Callback&lt;Array&lt;AppAccountInfo&gt;&gt;)
