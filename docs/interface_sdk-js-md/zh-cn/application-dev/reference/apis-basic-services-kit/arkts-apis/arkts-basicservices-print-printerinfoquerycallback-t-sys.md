...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| printerInfo | [PrinterInformation](arkts-basicservices-print-printerinformation-i.md) | 是 | 打印机信息打印机信息。 |
| ppdInfo | [PpdInfo](arkts-basicservices-print-ppdinfo-i.md)[] | 是 | 所有打印机ppd信息所有打印机ppd信息。 |
