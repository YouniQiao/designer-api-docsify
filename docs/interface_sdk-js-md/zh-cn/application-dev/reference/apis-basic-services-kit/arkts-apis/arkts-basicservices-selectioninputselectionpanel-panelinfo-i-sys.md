...
划词面板类型枚举，有两种面板可供选择，详见[PanelType](arkts-basicservices-selectioninputselectionpanel-paneltype-e-sys.md)。

**类型：** [PanelType](arkts-basicservices-selectioninputselectionpanel-paneltype-e-sys.md)
