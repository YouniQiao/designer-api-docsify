...
| callback | [Callback](arkts-basicservices-base-callback-i.md)&lt;boolean&gt; | 否 | 表示取消注册打印机状态变化事件是否成功。true表示成功，false表示失败。 |
...
| callback | [Callback](arkts-basicservices-base-callback-i.md)&lt;boolean&gt; | 否 | 表示取消注册打印任务状态变化事件是否成功。true表示成功，false表示失败。 |
...
| callback | [Callback](arkts-basicservices-base-callback-i.md)&lt;boolean&gt; | 否 | 表示取消注册打印扩展信息变化事件是否成功。true表示成功，false表示失败。 |
