...
> **说明：** 
> 
> - 本模块接口从API version 9开始不再维护，建议使用新接口[@ohos.systemParameterEnhance](arkts-basicservices-systemparameterenhance.md)替代。
> 
...
**替代接口：** [systemParameterEnhance](arkts-basicservices-systemparameterenhance.md)
