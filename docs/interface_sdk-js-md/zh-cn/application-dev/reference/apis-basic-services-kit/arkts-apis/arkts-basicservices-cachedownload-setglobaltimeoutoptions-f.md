...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| options | [TimeoutOptions](arkts-basicservices-cachedownload-timeoutoptions-i.md) | 否 | Task timeout configuration. Default value: Refer to the default value of TimeoutOptions. |
