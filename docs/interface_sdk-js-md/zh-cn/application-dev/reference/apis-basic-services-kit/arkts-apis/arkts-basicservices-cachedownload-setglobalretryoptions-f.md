...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| options | [RetryOptions](arkts-basicservices-cachedownload-retryoptions-i.md) | 否 | Task retry configurations. Default value: Refer to the default value of RetryOptions. |
