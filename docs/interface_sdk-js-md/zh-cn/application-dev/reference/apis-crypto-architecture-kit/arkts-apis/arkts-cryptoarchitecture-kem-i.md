...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| priKey | [PriKey](arkts-cryptoarchitecture-prikey-i.md) | 是 | 接收方的私钥。 |
| wrappedKey | [Uint8Array](../../apis-arkts/arkts-apis/arkts-arkts-uint8array-c.md) | 是 | KEM封装的密钥。 |
...
| 类型 | 说明 |
| --- | --- |
| [Uint8Array](../../apis-arkts/arkts-apis/arkts-arkts-uint8array-c.md) | 共享密钥。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| pubKey | [PubKey](arkts-cryptoarchitecture-pubkey-i.md) | 是 | 接收方的公钥。 |
