...
| encodedPoint | [Uint8Array](../../apis-arkts/arkts-apis/arkts-arkts-uint8array-c.md) | 是 | 指定的ECC椭圆曲线上的点的数据。 |

**返回值：**

| 类型 | 说明 |
| --- | --- |
| [Point](../../apis-test-kit/arkts-apis/arkts-test-point-i.md) | 返回ECC的Point对象。 |
...
| 类型 | 说明 |
| --- | --- |
| [ECCCommonParamsSpec](arkts-cryptoarchitecture-ecccommonparamsspec-i.md) | 返回ECC公共密钥参数。 |
...
| --- | --- | --- | --- |
| curveName | string | 是 | 椭圆曲线的曲线名，即相应的NID（Name Identifier）。 |
| point | [Point](../../apis-test-kit/arkts-apis/arkts-test-point-i.md) | 是 | 椭圆曲线上的Point点对象。 |
...
| 类型 | 说明 |
| --- | --- |
| [Uint8Array](../../apis-arkts/arkts-apis/arkts-arkts-uint8array-c.md) | 返回指定格式的点数据。 |
