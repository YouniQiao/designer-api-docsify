...
[createMac]\_\_\_JSDOC\_LINK\_DESC\_USD\_0\_\_\_方法创建一个Mac实例。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | \_\_\_MD\_LINK\_USD\_0\_\_\_&lt;DataBlob&gt; | 是 | 回调函数。当MAC计算成功时，err为undefined，data为获取到的Mac计算结果；否则为 错误对象。 |
...
传入消息进行Mac更新消息认证码状态。使用callback异步回调。
    **说明：**  
    ...
    HMAC算法多次调用update更新的代码示例详见\_\_\_MD\_LINK\_DESC\_USD\_0\_\_\_。
