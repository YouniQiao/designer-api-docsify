...
密钥派生函数参数[KdfSpec](arkts-cryptoarchitecture-kdfspec-i.md)的子类，作为HKDF密钥派生函数进行密钥派生时的输入。
...
**继承/实现关系：** HKDFSpec extends [KdfSpec](arkts-cryptoarchitecture-kdfspec-i.md)
