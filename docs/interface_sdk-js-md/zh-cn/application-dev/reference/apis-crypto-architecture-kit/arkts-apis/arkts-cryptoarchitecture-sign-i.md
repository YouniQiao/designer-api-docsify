...
Sign类，使用Sign方法之前需要创建该类的实例进行操作，通过[createSign(algName: string): Sign](arkts-cryptoarchitecture-createsign-f.md#createsign-1)方法构造此实例。按序调用本类中的init、update、sign方法完成签名操作。签名操作的示例代码详见[签名验签开发指导](../../../../security/CryptoArchitectureKit/crypto-rsa-sign-sig-verify-pkcs1.md)。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| itemType | [SignSpecItem](arkts-cryptoarchitecture-signspecitem-e.md) | 是 | 用于指定需要获取的签名参数。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| priKey | [PriKey](arkts-cryptoarchitecture-prikey-i.md) | 是 | 用于Sign的初始化。 |
| callback | [AsyncCallback](../../apis-basic-service-kit/arkts-apis/arkts-basicservices-asynccallback-i.md)<void> | 是 | 回调函数。当签名初始化成功，err为undefined，否则为错误对象。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| itemType | [SignSpecItem](arkts-cryptoarchitecture-signspecitem-e.md) | 是 | 用于指定需要设置的签名参数。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| itemType | [SignSpecItem](arkts-cryptoarchitecture-signspecitem-e.md) | 是 | 用于指定需要设置的签名参数类型。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| data | [DataBlob](../../apis-device-certificate-kit/arkts-apis/arkts-devicecertificate-datablob-i.md) | 是 | 待签名的数据。 |
| callback | [AsyncCallback](../../apis-basic-service-kit/arkts-apis/arkts-basicservices-asynccallback-i.md)<DataBlob> | 是 | 回调函数。当签名成功时，err为undefined，data为获取到的签名结果DataBlob；否则为错误对象。 |
...
| 类型 | 说明 |
| --- | --- |
| [DataBlob](../../apis-device-certificate-kit/arkts-apis/arkts-devicecertificate-datablob-i.md) | 返回签名结果。 |
...
必须在对[Sign](arkts-cryptoarchitecture-sign-i.md)实例使用[init](arkts-cryptoarchitecture-sign-i.md#init-1)或[initSync](arkts-cryptoarchitecture-sign-i.md#initsync-1)初始化后，才能使用本函数。
...
| callback | [AsyncCallback](../../apis-basic-service-kit/arkts-apis/arkts-basicservices-asynccallback-i.md)<void> | 是 | 回调函数。当签名更新成功，err为undefined，否则为错误对象。 |
...
在使用本函数前，必须先使用[init](arkts-cryptoarchitecture-sign-i.md#init-1)对[Sign](arkts-cryptoarchitecture-sign-i.md)实例进行初始化。
...
必须在对[Sign](arkts-cryptoarchitecture-sign-i.md)实例使用[initSync()](arkts-cryptoarchitecture-sign-i.md#initsync-1)初始化后，才能使用本函数。
