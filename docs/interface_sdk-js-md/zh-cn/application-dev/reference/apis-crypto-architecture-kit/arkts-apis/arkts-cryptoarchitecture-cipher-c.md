...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| options | [CipherAesOptions](arkts-cryptoarchitecture-cipheraesoptions-i.md) | 是 | AES 加解密参数。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| options | [CipherRsaOptions](arkts-cryptoarchitecture-cipherrsaoptions-i.md) | 是 | RSA 加解密参数。 |
