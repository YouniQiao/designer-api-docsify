...
[createKeyAgreement(algName: string): KeyAgreement]\_\_\_JSDOC\_LINK\_DESC\_USD\_0\_\_\_方法创建一个KeyAgreement实例。
...
| callback | \_\_\_MD\_LINK\_USD\_0\_\_\_&lt;DataBlob&gt; | 是 | 回调函数。当密钥协商成功时，err为undefined，data为协商的共享密钥；否则为 错误对象。 |
