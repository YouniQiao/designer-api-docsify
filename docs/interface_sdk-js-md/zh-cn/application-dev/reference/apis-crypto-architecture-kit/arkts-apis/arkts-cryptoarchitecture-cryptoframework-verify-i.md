...
<br><br>**说明：** <br>建议优先使用异步API，[verify](arkts-cryptoarchitecture-cryptoframework-verify-i.md)。同步API可能因系统繁忙、高负载等原因耗时较长而阻塞主线程。因此建议在子线程中调用同步API，以避免阻塞主线程。
