...
密钥参数[AsyKeySpec](arkts-cryptoarchitecture-asykeyspec-i.md)的子类，用于指定ECC算法中公钥包含的参数。
...
**继承/实现关系：** ECCPubKeySpec extends [AsyKeySpec](arkts-cryptoarchitecture-asykeyspec-i.md)
