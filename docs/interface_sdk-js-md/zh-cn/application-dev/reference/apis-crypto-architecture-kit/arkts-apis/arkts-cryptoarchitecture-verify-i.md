...
Verify类，使用Verify方法之前需要创建该类的实例进行操作，通过[createVerify(algName: string): Verify](arkts-cryptoarchitecture-createverify-f.md#createverify-1)方法构造此实例。按序调用本类中的init、update、verify方法完成签名操作。验签操作的示例代码详见[签名验签开发指导](../../../../security/CryptoArchitectureKit/crypto-rsa-sign-sig-verify-pkcs1.md)。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| itemType | [SignSpecItem](arkts-cryptoarchitecture-signspecitem-e.md) | 是 | 用于指定需要获取的验签参数。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| pubKey | [PubKey](arkts-cryptoarchitecture-pubkey-i.md) | 是 | 公钥对象，用于Verify的初始化。 |
| callback | [AsyncCallback](../../apis-basic-service-kit/arkts-apis/arkts-basicservices-asynccallback-i.md)<void> | 是 | 回调函数。当验签初始化成功，err为undefined，否则为错误对象。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| signatureData | [DataBlob](../../apis-device-certificate-kit/arkts-apis/arkts-devicecertificate-datablob-i.md) | 是 | 签名数据。 |
...
| 类型 | 说明 |
| --- | --- |
| [DataBlob](../../apis-device-certificate-kit/arkts-apis/arkts-devicecertificate-datablob-i.md) | 恢复的数据。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| itemType | [SignSpecItem](arkts-cryptoarchitecture-signspecitem-e.md) | 是 | 用于指定需要设置的验签参数。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| itemType | [SignSpecItem](arkts-cryptoarchitecture-signspecitem-e.md) | 是 | 用于指定需要设置的验签参数类型。 |
...
必须在对[Verify](arkts-cryptoarchitecture-verify-i.md)实例使用[init](arkts-cryptoarchitecture-verify-i.md#init-1)或[initSync](arkts-cryptoarchitecture-verify-i.md#initsync-1)初始化后，才能使用本函数。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| data | [DataBlob](../../apis-device-certificate-kit/arkts-apis/arkts-devicecertificate-datablob-i.md) | 是 | 传入的消息。 |
| callback | [AsyncCallback](../../apis-basic-service-kit/arkts-apis/arkts-basicservices-asynccallback-i.md)<void> | 是 | 回调函数。当验签更新成功，err为undefined，否则为错误对象。 |
...
必须在对[Verify](arkts-cryptoarchitecture-verify-i.md)实例使用[init()](arkts-cryptoarchitecture-verify-i.md#init-1)初始化后，才能使用本函数。
...
必须在对[Verify](arkts-cryptoarchitecture-verify-i.md)实例使用[initSync()](arkts-cryptoarchitecture-verify-i.md#initsync-1)初始化后，才能使用本函数。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| data | [DataBlob](../../apis-device-certificate-kit/arkts-apis/arkts-devicecertificate-datablob-i.md) | 是 | 待验签的数据。 |
| signatureData | [DataBlob](../../apis-device-certificate-kit/arkts-apis/arkts-devicecertificate-datablob-i.md) | 是 | 签名数据。 |
| callback | [AsyncCallback](../../apis-basic-service-kit/arkts-apis/arkts-basicservices-asynccallback-i.md)<boolean> | 是 | 回调函数。返回true表示验签通过；返回false表示验签失败。 |
...
| signatureData | [DataBlob](../../apis-device-certificate-kit/arkts-apis/arkts-devicecertificate-datablob-i.md) | 是 | 签名数据。 |
| callback | [AsyncCallback](../../apis-basic-service-kit/arkts-apis/arkts-basicservices-asynccallback-i.md)<boolean> | 是 | 回调函数。返回true表示验签通过；返回false表示验签不通过。 |
