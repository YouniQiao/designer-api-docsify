...
[init()]\_\_\_JSDOC\_LINK\_DESC\_USD\_0\_\_\_方法。

\_\_\_HTML\_TAG\_DESC\_USD\_4\_\_\_适用于需要iv等参数的对称加解密模式（对于无iv等参数的模式如ECB模式，无需构造，在  
[init()]\_\_\_JSDOC\_LINK\_DESC\_USD\_1\_\_\_中传入null即可）。
    **说明：**  
    ...
    **说明：**  
    ...
    由于[init()]\_\_\_JSDOC\_LINK\_DESC\_USD\_2\_\_\_的params  
    参数是ParamsSpec类型（父类），而实际需要传入具体的子类对象（如[IvParamsSpec]\_\_\_JSDOC\_LINK\_DESC\_USD\_3\_\_\_），因此在  
