...
[init()](arkts-cryptoarchitecture-cryptoframework-cipher-i.md#init-3)方法。

&lt;br&gt;适用于需要iv等参数的对称加解密模式（对于无iv等参数的模式如ECB模式，无需构造，在  
[init()](arkts-cryptoarchitecture-cryptoframework-cipher-i.md#init-3)中传入null即可）。
...
> **说明：**
> 
> 由于[init()](arkts-cryptoarchitecture-cryptoframework-cipher-i.md#init-3)的params
> 参数是ParamsSpec类型（父类），而实际需要传入具体的子类对象（如[IvParamsSpec](arkts-cryptoarchitecture-cryptoframework-ivparamsspec-i.md#IvParamsSpec)），因此在
