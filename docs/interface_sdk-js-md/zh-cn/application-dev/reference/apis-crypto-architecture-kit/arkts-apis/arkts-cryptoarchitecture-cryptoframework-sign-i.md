...
| itemValue | ArkTS-Dyn: number \| Uint8Array  <br>ArkTS-Sta：int \| Uint8Array | 是 | 指定签名参数的具体值。 |
...
&lt;br&gt;必须在对[Sign](#Sign)实例使用[init](#init)或  
...
&lt;br&gt;必须在对[Sign](#Sign)实例使用[initSync()](#initSync)初始化后，才能使用本函数。
