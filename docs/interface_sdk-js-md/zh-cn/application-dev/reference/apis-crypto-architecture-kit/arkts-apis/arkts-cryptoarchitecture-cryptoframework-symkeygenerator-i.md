...
[createSymKeyGenerator]\_\_\_JSDOC\_LINK\_DESC\_USD\_0\_\_\_方法创建一个SymKeyGenerator实例。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| key | \_\_\_MD\_LINK\_USD\_0\_\_\_ | 是 | 指定的对称密钥材料。 |
| callback | \_\_\_MD\_LINK\_USD\_0\_\_\_&lt;SymKey&gt; | 是 | 回调函数。当生成对称密钥成功时，err为undefined，data为获取到的SymKey；否则为 错误对象。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| key | \_\_\_MD\_LINK\_USD\_0\_\_\_ | 是 | 指定的密钥材料数据。 |
...
| 类型 | 说明 |
| --- | --- |
| \_\_\_MD\_LINK\_USD\_0\_\_\_ | 对称密钥。 |
...
\_\_\_HTML\_TAG\_DESC\_USD\_1\_\_\_目前使用OpenSSL的RAND\_priv\_bytes()作为底层能力生成随机密钥。
    **说明：**  
...
\_\_\_HTML\_TAG\_DESC\_USD\_0\_\_\_目前使用OpenSSL的RAND\_priv\_bytes()作为底层能力生成随机密钥。
...
\_\_\_HTML\_TAG\_DESC\_USD\_2\_\_\_目前使用OpenSSL的RAND\_priv\_bytes()作为底层能力生成随机密钥。
    **说明：**  
...
[convertKeySync]\_\_\_JSDOC\_LINK\_DESC\_USD\_0\_\_\_方式生成对称密钥数据。
...
| 类型 | 说明 |
| --- | --- |
| \_\_\_MD\_LINK\_USD\_0\_\_\_ | 返回对称密钥SymKey。 |
