...
参见 [readBooleanArray](#readbooleanarray)
...
| 参数名 | 类型 | 必填 |
| --- | --- | --- |
| dataIn | ArkTS-Dyn: number[]<br>ArkTS-Sta：int[] | 是 |
...
参见 [readByteArray](#readbytearray)
...
参见 [readCharArray](#readchararray)
...
| 参数名 | 类型 | 必填 |
| --- | --- | --- |
| dataIn | ArkTS-Dyn: number[]<br>ArkTS-Sta：double[] | 是 |
...
参见 [readDoubleArray](#readdoublearray)
...
参见 [readFloatArray](#readfloatarray)
...
| 参数名 | 类型 | 必填 |
| --- | --- | --- |
| dataIn | ArkTS-Dyn: number[]<br>ArkTS-Sta：long[] | 是 |
...
参见 [readLongArray](#readlongarray)
...
参见 [readRemoteObjectArray](#readremoteobjectarray)
...
参见 [readShortArray](#readshortarray)
...
参见 [readStringArray](#readstringarray)
...
| 参数名 | 类型 | 必填 |
| --- | --- | --- |
| pos | ArkTS-Dyn: number<br>ArkTS-Sta：int | 是 |
...
| 参数名 | 类型 | 必填 |
| --- | --- | --- |
| val | ArkTS-Dyn: number<br>ArkTS-Sta：int | 是 |
...
| 参数名 | 类型 | 必填 |
| --- | --- | --- |
| byteArray | ArkTS-Dyn: number[]<br>ArkTS-Sta：int[] | 是 |
...
| 参数名 | 类型 | 必填 |
| --- | --- | --- |
| charArray | ArkTS-Dyn: number[]<br>ArkTS-Sta：int[] | 是 |
...
| 参数名 | 类型 | 必填 |
| --- | --- | --- |
| val | ArkTS-Dyn: number<br>ArkTS-Sta：double | 是 |
...
| 参数名 | 类型 | 必填 |
| --- | --- | --- |
| doubleArray | ArkTS-Dyn: number[]<br>ArkTS-Sta：double[] | 是 |
...
| 参数名 | 类型 | 必填 |
| --- | --- | --- |
| floatArray | ArkTS-Dyn: number[]<br>ArkTS-Sta：double[] | 是 |
...
| 参数名 | 类型 | 必填 |
| --- | --- | --- |
| intArray | ArkTS-Dyn: number[]<br>ArkTS-Sta：int[] | 是 |
...
| 参数名 | 类型 | 必填 |
| --- | --- | --- |
| val | ArkTS-Dyn: number<br>ArkTS-Sta：long | 是 |
...
| 参数名 | 类型 | 必填 |
| --- | --- | --- |
| longArray | ArkTS-Dyn: number[]<br>ArkTS-Sta：long[] | 是 |
...
| 参数名 | 类型 | 必填 |
| --- | --- | --- |
| shortArray | ArkTS-Dyn: number[]<br>ArkTS-Sta：int[] | 是 |
