...
**替代接口：** [closeFileDescriptor(fd:](arkts-ipc-rpc-messagesequence-c.md#closefiledescriptor)
...
**替代接口：** [dupFileDescriptor(fd:](arkts-ipc-rpc-messagesequence-c.md#dupfiledescriptor)
...
**替代接口：** [readBooleanArray(dataIn:](arkts-ipc-rpc-messagesequence-c.md#readbooleanarray)
...
**替代接口：** [readByteArray(dataIn:](arkts-ipc-rpc-messagesequence-c.md#readbytearray)
...
**替代接口：** [readCharArray(dataIn:](arkts-ipc-rpc-messagesequence-c.md#readchararray)
...
**替代接口：** [readDoubleArray(dataIn:](arkts-ipc-rpc-messagesequence-c.md#readdoublearray)
...
**替代接口：** [readFloatArray(dataIn:](arkts-ipc-rpc-messagesequence-c.md#readfloatarray)
...
**替代接口：** [readIntArray(dataIn:](arkts-ipc-rpc-messagesequence-c.md#readintarray)
...
**替代接口：** [readLongArray(dataIn:](arkts-ipc-rpc-messagesequence-c.md#readlongarray)
...
**替代接口：** [readRawDataBuffer(size:](arkts-ipc-rpc-messagesequence-c.md#readrawdatabuffer)
...
**替代接口：** [readRemoteObjectArray(objects:](arkts-ipc-rpc-messagesequence-c.md#readremoteobjectarray)
...
**替代接口：** [readParcelable(dataIn:](arkts-ipc-rpc-messagesequence-c.md#readparcelable)
...
**替代接口：** [readParcelableArray(parcelableArray:](arkts-ipc-rpc-messagesequence-c.md#readparcelablearray)
...
**替代接口：** [readShortArray(dataIn:](arkts-ipc-rpc-messagesequence-c.md#readshortarray)
...
**替代接口：** [readStringArray(dataIn:](arkts-ipc-rpc-messagesequence-c.md#readstringarray)
...
**替代接口：** [rewindRead(pos:](arkts-ipc-rpc-messagesequence-c.md#rewindread)
...
**替代接口：** [rewindWrite(pos:](arkts-ipc-rpc-messagesequence-c.md#rewindwrite)
...
**替代接口：** [setCapacity(size:](arkts-ipc-rpc-messagesequence-c.md#setcapacity)
...
**替代接口：** [setSize(size:](arkts-ipc-rpc-messagesequence-c.md#setsize)
...
**替代接口：** [writeAshmem(ashmem:](arkts-ipc-rpc-messagesequence-c.md#writeashmem)
...
**替代接口：** [writeBoolean(val:](arkts-ipc-rpc-messagesequence-c.md#writeboolean)
...
**替代接口：** [writeBooleanArray(booleanArray:](arkts-ipc-rpc-messagesequence-c.md#writebooleanarray)
...
**替代接口：** [writeByte(val:](arkts-ipc-rpc-messagesequence-c.md#writebyte)
...
**替代接口：** [writeByteArray(byteArray:](arkts-ipc-rpc-messagesequence-c.md#writebytearray)
...
**替代接口：** [writeChar(val:](arkts-ipc-rpc-messagesequence-c.md#writechar)
...
**替代接口：** [writeCharArray(charArray:](arkts-ipc-rpc-messagesequence-c.md#writechararray)
...
**替代接口：** [writeDouble(val:](arkts-ipc-rpc-messagesequence-c.md#writedouble)
...
**替代接口：** [writeDoubleArray(doubleArray:](arkts-ipc-rpc-messagesequence-c.md#writedoublearray)
...
**替代接口：** [writeFileDescriptor(fd:](arkts-ipc-rpc-messagesequence-c.md#writefiledescriptor)
...
**替代接口：** [writeFloat(val:](arkts-ipc-rpc-messagesequence-c.md#writefloat)
...
**替代接口：** [writeFloatArray(floatArray:](arkts-ipc-rpc-messagesequence-c.md#writefloatarray)
...
**替代接口：** [writeInt(val:](arkts-ipc-rpc-messagesequence-c.md#writeint)
...
**替代接口：** [writeIntArray(intArray:](arkts-ipc-rpc-messagesequence-c.md#writeintarray)
...
**替代接口：** [writeInterfaceToken(token:](arkts-ipc-rpc-messagesequence-c.md#writeinterfacetoken)
...
**替代接口：** [writeLong(val:](arkts-ipc-rpc-messagesequence-c.md#writelong)
...
**替代接口：** [writeLongArray(longArray:](arkts-ipc-rpc-messagesequence-c.md#writelongarray)
...
**替代接口：** [writeRawDataBuffer(rawData:](arkts-ipc-rpc-messagesequence-c.md#writerawdatabuffer)
...
**替代接口：** [writeRemoteObject(obj:](arkts-ipc-rpc-messagesequence-c.md#writeremoteobject)
...
**替代接口：** [writeRemoteObjectArray(objectArray:](arkts-ipc-rpc-messagesequence-c.md#writeremoteobjectarray)
...
**替代接口：** [writeParcelable(val:](arkts-ipc-rpc-messagesequence-c.md#writeparcelable)
...
**替代接口：** [writeParcelableArray(parcelableArray:](arkts-ipc-rpc-messagesequence-c.md#writeparcelablearray)
...
**替代接口：** [writeShort(val:](arkts-ipc-rpc-messagesequence-c.md#writeshort)
...
**替代接口：** [writeShortArray(shortArray:](arkts-ipc-rpc-messagesequence-c.md#writeshortarray)
...
**替代接口：** [writeString(val:](arkts-ipc-rpc-messagesequence-c.md#writestring)
...
**替代接口：** [writeStringArray(stringArray:](arkts-ipc-rpc-messagesequence-c.md#writestringarray)
