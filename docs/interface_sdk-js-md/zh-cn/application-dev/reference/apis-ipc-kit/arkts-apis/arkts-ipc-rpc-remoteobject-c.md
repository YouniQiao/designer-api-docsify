...
**替代接口：** [modifyLocalInterface(localInterface:](arkts-ipc-rpc-remoteobject-c.md#modifylocalinterface)
...
**替代接口：** [onRemoteMessageRequest(code:](arkts-ipc-rpc-remoteobject-c.md#onremotemessagerequest)
