...
**替代接口：** [mapTypedAshmem(mapType:](arkts-ipc-rpc-ashmem-c.md#maptypedashmem)
...
**替代接口：** [readDataFromAshmem(size:](arkts-ipc-rpc-ashmem-c.md#readdatafromashmem)
...
**替代接口：** [setProtectionType(protectionType:](arkts-ipc-rpc-ashmem-c.md#setprotectiontype)
...
**替代接口：** [writeDataToAshmem(buf:](arkts-ipc-rpc-ashmem-c.md#writedatatoashmem)
