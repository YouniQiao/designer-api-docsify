...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| source | [ImageSource](arkts-image-image-imagesource-i.md) | 是 | 编码的ImageSource。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| pixelmapSequence | Array&lt;[PixelMap](arkts-image-image-pixelmap-i.md)&gt; | 是 | 待编码的PixelMap序列。 |
