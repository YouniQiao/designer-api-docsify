...
在获取和使用特定辅助图前，应首先调用Picture的[getAuxiliaryPicture]\_\_\_JSDOC\_LINK\_DESC\_USD\_0\_\_\_方法尝试获取该辅助图。
...
HDR合成通常需要同时使用SDR主图、增益图和HDR元数据（[getMetadata]\_\_\_JSDOC\_LINK\_DESC\_USD\_0\_\_\_）共同计算亮度映射关系。
