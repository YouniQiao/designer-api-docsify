...
AuxiliaryPicture类，用于读取或写入图像的辅助图数据以及获取图像的辅助图信息。目前支持的辅助图类型可参考[AuxiliaryPictureType]\_\_\_JSDOC\_LINK\_DESC\_USD\_0\_\_\_。

在调用AuxiliaryPicture的方法前，需要通过[image.createAuxiliaryPicture]\_\_\_JSDOC\_LINK\_DESC\_USD\_1\_\_\_或Picture的  
[getAuxiliaryPicture]\_\_\_JSDOC\_LINK\_DESC\_USD\_2\_\_\_创建一个AuxiliaryPicture实例。

由于图片占用内存较大，所以当AuxiliaryPicture对象使用完成后，应主动调用[release]\_\_\_JSDOC\_LINK\_DESC\_USD\_3\_\_\_方法及时释放对象。释放时应确保该实例的所有异步方法均执行完成，且后续不再使用该对象。
    **说明：**  
