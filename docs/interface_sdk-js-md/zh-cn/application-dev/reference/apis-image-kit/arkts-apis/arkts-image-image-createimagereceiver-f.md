...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| size | [Size](../../apis-arkui/arkts-apis/arkts-arkui-window-size-i.md) | 是 | The default {@link Size} in pixels of the Images that this receiver will produce. |
| format | [ImageFormat](arkts-image-image-imageformat-e.md) | 是 | The format of the Image that this receiver will produce. This must be one of the {@link ImageFormat} constants. |
