...
[相机服务CameraFormat中的CAMERA\_FORMAT\_RGBA\_8888]\_\_\_JSDOC\_LINK\_DESC\_USD\_0\_\_\_。
...
[相机服务CameraFormat中的CAMERA\_FORMAT\_YUV\_420\_SP]\_\_\_JSDOC\_LINK\_DESC\_USD\_0\_\_\_。
...
颜色信息由亮度分量Y和色度分量Cb与Cr组成，每个分量有效10位，实际存储时，Y平面每个像素占16位数据（10位有效），UV平面交错排列，每4个像素占32位数据（每色度分量10位有效），平均有效占15位，按照从高位到低位的顺序储存。对应[相机服务CameraFormat中的CAMERA\_FORMAT\_YCBCR\_P010]\_\_\_JSDOC\_LINK\_DESC\_USD\_0\_\_\_。
...
颜色信息由亮度分量Y和色度分量Cr与Cb组成，每个分量有效10位，实际存储时，Y平面每个像素占16位数据（10位有效），UV平面交错排列，每4个像素占32位数据（每色度分量10位有效），平均有效占15位，按照从高位到低位的顺序储存。对应[相机服务CameraFormat中的CAMERA\_FORMAT\_YCRCB\_P010]\_\_\_JSDOC\_LINK\_DESC\_USD\_0\_\_\_。
