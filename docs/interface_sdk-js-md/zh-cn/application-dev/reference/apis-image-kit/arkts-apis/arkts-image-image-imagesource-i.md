...
由于图片占用内存较大，所以当Picture对象使用完成后，应主动调用[release]\_\_\_JSDOC\_LINK\_DESC\_USD\_0\_\_\_方法，及时释放内存。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| options | \_\_\_MD\_LINK\_USD\_0\_\_\_ | 否 | 解码参数。 |
...
| [7700203](../errorcode-image.md#7700203-不支持的选项) | Unsupported options. For example, unsupported desiredPixelFormat causes a failure in converting an image into the desired pixel format.\_\_\_HTML\_TAG\_USD\_0\_\_\_**适用版本：** 24+ |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| options | \_\_\_MD\_LINK\_USD\_0\_\_\_ | 否 | Image decoding parameters. |
...
通过指定序号的图片创建Picture对象。使用Promise异步回调。
    **说明：**  
    ...
    - 支持GIF和HEIF\_\_\_HTML\_TAG\_DESC\_USD\_1\_\_\_23+\_\_\_HTML\_TAG\_DESC\_USD\_2\_\_\_图像序列格式。从API版本26.0.0开始，增加支持AVIS格式。  
...
从API version 15开始，推荐使用[createPixelMapUsingAllocator]\_\_\_JSDOC\_LINK\_DESC\_USD\_1\_\_\_，该接口可以指定输出pixelMap的内存类型[AllocatorType]\_\_\_JSDOC\_LINK\_DESC\_USD\_2\_\_\_，详情请参考  
\_\_\_MD\_LINK\_DESC\_USD\_0\_\_\_。
    **说明：**  
    
    - 该方法为非线程安全的方法，不支持在同一个ImageSource实例上并发调用。  
    
    - 由于图片占用内存较大，所以当PixelMap对象使用完成后，应主动调用[release]\_\_\_JSDOC\_LINK\_DESC\_USD\_3\_\_\_方法，及时释放内存。  
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | \_\_\_MD\_LINK\_USD\_0\_\_\_&lt;PixelMap&gt; | 是 | 回调函数，当创建PixelMap对象成功，err为undefined，data为获取到的PixelMap对象；否则为错误对象。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | \_\_\_MD\_LINK\_USD\_0\_\_\_&lt;PixelMap \| undefined&gt; | 是 | Callback used to return the PixelMap object. |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| options | \_\_\_MD\_LINK\_USD\_0\_\_\_ | 是 | 解码参数。 |
| callback | \_\_\_MD\_LINK\_USD\_0\_\_\_&lt;PixelMap&gt; | 是 | 回调函数，当创建PixelMap对象成功，err为undefined，data为获取到的PixelMap对象；否则为错误对象。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| options | \_\_\_MD\_LINK\_USD\_0\_\_\_ | 是 | Image decoding parameters. |
| callback | \_\_\_MD\_LINK\_USD\_0\_\_\_&lt;PixelMap \| undefined&gt; | 是 | Callback used to return the PixelMap object. |
...
针对动态图（如Gif、Webp），该接口会返回每帧图片数据；针对静态图，该接口会返回唯一的一帧图片数据。
    **说明：**  
    ...
    - 由于图片占用内存较大，所以当PixelMap对象使用完成后，应主动调用[release]\_\_\_JSDOC\_LINK\_DESC\_USD\_0\_\_\_方法，及时释放内存。  
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | \_\_\_MD\_LINK\_USD\_0\_\_\_&lt;Array&lt;PixelMap&gt;&gt; | 是 | 回调函数，当创建PixelMap对象数组成功，err为undefined，data为获取到的PixelMap对象数组；否 则为错误对象。 |
...
由于图片占用内存较大，所以当PixelMap对象使用完成后，应主动调用[release]\_\_\_JSDOC\_LINK\_DESC\_USD\_2\_\_\_方法，及时释放内存。

释放时应确保该对象的所有异步方法均执行完成，且后续不再使用该对象。

从API version 15开始，推荐使用[createPixelMapUsingAllocatorSync]\_\_\_JSDOC\_LINK\_DESC\_USD\_3\_\_\_，该接口可以指定输出pixelMap的内存类型[AllocatorType]\_\_\_JSDOC\_LINK\_DESC\_USD\_4\_\_\_，详情请参考  
\_\_\_MD\_LINK\_DESC\_USD\_0\_\_\_。
    **说明：**  
...
| 类型 | 说明 |
| --- | --- |
| \_\_\_MD\_LINK\_USD\_0\_\_\_ | 用于同步返回创建结果。 |
...
\_\_\_MD\_LINK\_DESC\_USD\_0\_\_\_。
    **说明：**  
    ...
    - 由于图片占用内存较大，所以当PixelMap对象使用完成后，应主动调用[release]\_\_\_JSDOC\_LINK\_DESC\_USD\_1\_\_\_方法，及时释放内存。  
...
| --- | --- | --- | --- |
| options | \_\_\_MD\_LINK\_USD\_0\_\_\_ | 否 | 解码参数。 |
| allocatorType | \_\_\_MD\_LINK\_USD\_0\_\_\_ | 否 | 用于图像解码的内存类型。默认值为AllocatorType.AUTO。 |
...
根据指定的分配器同步创建一个基于图像解码参数的PixelMap对象。接口使用详情请参考\_\_\_MD\_LINK\_DESC\_USD\_0\_\_\_。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| options | \_\_\_MD\_LINK\_USD\_0\_\_\_ | 否 | 解码参数，控制是否生成缩略图以及生成缩略图的目标尺寸。 \_\_\_ESCAPED\_UNDERSCORE\_\_\_\_\_\_ESCAPED\_UNDERSCORE\_\_\_\_\_\_ESCAPED\_UNDERSCORE\_\_\_HTML\_\_\_ESCAPED\_UNDERSCORE\_\_\_TAG\_\_\_ESCAPED\_UNDERSCORE\_\_\_DESC\_\_\_ESCAPED\_UNDERSCORE\_\_\_USD\_\_\_ESCAPED\_UNDERSCORE\_\_\_0\_\_\_ESCAPED\_UNDERSCORE\_\_\_\_\_\_ESCAPED\_UNDERSCORE\_\_\_\_\_\_ESCAPED\_UNDERSCORE\_\_\_默认表现： \_\_\_ESCAPED\_UNDERSCORE\_\_\_\_\_\_ESCAPED\_UNDERSCORE\_\_\_\_\_\_ESCAPED\_UNDERSCORE\_\_\_HTML\_\_\_ESCAPED\_UNDERSCORE\_\_\_TAG\_\_\_ESCAPED\_UNDERSCORE\_\_\_DESC\_\_\_ESCAPED\_UNDERSCORE\_\_\_USD\_\_\_ESCAPED\_UNDERSCORE\_\_\_1\_\_\_ESCAPED\_UNDERSCORE\_\_\_\_\_\_ESCAPED\_UNDERSCORE\_\_\_\_\_\_ESCAPED\_UNDERSCORE\_\_\_- 当图像有缩略图时，解码原始缩略图，返回的PixelMap对象的宽和高与原缩略图保持一致。 \_\_\_ESCAPED\_UNDERSCORE\_\_\_\_\_\_ESCAPED\_UNDERSCORE\_\_\_\_\_\_ESCAPED\_UNDERSCORE\_\_\_HTML\_\_\_ESCAPED\_UNDERSCORE\_\_\_TAG\_\_\_ESCAPED\_UNDERSCORE\_\_\_DESC\_\_\_ESCAPED\_UNDERSCORE\_\_\_USD\_\_\_ESCAPED\_UNDERSCORE\_\_\_2\_\_\_ESCAPED\_UNDERSCORE\_\_\_\_\_\_ESCAPED\_UNDERSCORE\_\_\_\_\_\_ESCAPED\_UNDERSCORE\_\_\_- 当原图文件无缩略图时，对原图进行解码后，根据解码参数options下采样生成缩略图，生成后的缩略图PixelMap对象宽和高都限制在512像素以内。 |
...
通过图片解码参数同步创建缩略图。返回创建结果对应的[PixelMap]\_\_\_JSDOC\_LINK\_DESC\_USD\_1\_\_\_对象。
...
| 类型 | 说明 |
| --- | --- |
| ArkTS-Dyn: Promise&lt;Array&lt;number&gt;&gt;  \_\_\_HTML\_TAG\_USD\_0\_\_\_ArkTS-Sta：Promise&lt;Array&lt;int&gt;&gt; | Promise对象，返回延迟时间数组。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | ArkTS-Dyn: \_\_\_MD\_LINK\_USD\_0\_\_\_&lt;Array&lt;number&gt;&gt;  \_\_\_HTML\_TAG\_USD\_2\_\_\_ArkTS-Sta：\_\_\_MD\_LINK\_USD\_1\_\_\_&lt;Array&lt;int&gt;&gt; | 是 | 回调函数，当获取图像延迟时间数组成功，err为undefined，data为获取到的图像延时时间数组；否则为错误对象。 |
...
| 类型 | 说明 |
| --- | --- |
| ArkTS-Dyn: Promise&lt;Array&lt;number&gt;&gt;  \_\_\_HTML\_TAG\_USD\_0\_\_\_ArkTS-Sta：Promise&lt;Array&lt;int&gt;&gt; | Promise对象，返回帧过渡模式数组。 |
...
| 类型 | 说明 |
| --- | --- |
| ArkTS-Dyn: Promise&lt;number&gt;  \_\_\_HTML\_TAG\_USD\_0\_\_\_ArkTS-Sta：Promise&lt;int&gt; | Promise对象，返回图像帧数。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | ArkTS-Dyn: \_\_\_MD\_LINK\_USD\_0\_\_\_&lt;number&gt;  \_\_\_HTML\_TAG\_USD\_2\_\_\_ArkTS-Sta：\_\_\_MD\_LINK\_USD\_1\_\_\_&lt;int&gt; | 是 | 回调函数，当获取图像帧数成功，err为undefined，data为获取到的图像帧数；否则为错误对象。 |
...
| callback | \_\_\_MD\_LINK\_USD\_0\_\_\_&lt;ImageInfo&gt; | 是 | 回调函数。当获取图片信息成功，err为undefined，data为获取到的图片信息；否则为错误对象。 |
...
| callback | \_\_\_MD\_LINK\_USD\_0\_\_\_&lt;ImageInfo \| undefined&gt; | 是 | Callback used to return the image information. |
...
| 类型 | 说明 |
| --- | --- |
| \_\_\_MD\_LINK\_USD\_0\_\_\_ | 同步返回获取到的图片信息。 |
...
该接口仅支持JPEG、PNG、HEIF、WEBP\_\_\_HTML\_TAG\_DESC\_USD\_0\_\_\_23+\_\_\_HTML\_TAG\_DESC\_USD\_1\_\_\_和DNG\_\_\_HTML\_TAG\_DESC\_USD\_2\_\_\_23+\_\_\_HTML\_TAG\_DESC\_USD\_3\_\_\_（不同硬件设备支持情况不同）文件，且需要包含Exif信息。
...
该接口仅支持JPEG、PNG、HEIF\_\_\_HTML\_TAG\_DESC\_USD\_0\_\_\_12+\_\_\_HTML\_TAG\_DESC\_USD\_1\_\_\_、WEBP\_\_\_HTML\_TAG\_DESC\_USD\_2\_\_\_23+\_\_\_HTML\_TAG\_DESC\_USD\_3\_\_\_和DNG\_\_\_HTML\_TAG\_DESC\_USD\_4\_\_\_23+\_\_\_HTML\_TAG\_DESC\_USD\_5\_\_\_（不同硬件设备支持情况不同）文件，且需要包含Exif信息。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| key | \_\_\_MD\_LINK\_USD\_0\_\_\_ | 是 | 图片属性名。 |
| options | \_\_\_MD\_LINK\_USD\_0\_\_\_ | 否 | 图片属性，包括图片序号与默认属性值。 |
...
该接口仅支持JPEG、PNG、HEIF\_\_\_HTML\_TAG\_DESC\_USD\_1\_\_\_12+\_\_\_HTML\_TAG\_DESC\_USD\_2\_\_\_和WEBP\_\_\_HTML\_TAG\_DESC\_USD\_3\_\_\_23+\_\_\_HTML\_TAG\_DESC\_USD\_4\_\_\_（不同硬件设备支持情况不同）文件，且需要包含Exif信息。
    **说明：**  
    
    从API version 7开始支持，从API version 11废弃，建议使用  
    [getImageProperty]\_\_\_JSDOC\_LINK\_DESC\_USD\_0\_\_\_代  
    替。
...
| --- | --- | --- | --- |
| key | string | 是 | 图片属性名。 |
| callback | \_\_\_MD\_LINK\_USD\_0\_\_\_&lt;string&gt; | 是 | 回调函数，当获取图片属性值成功，err为undefined，data为获取到的图片属性值；否则为错误对象。 |
...
| --- | --- | --- | --- |
| key | string | 是 | 图片属性名。 |
| options | \_\_\_MD\_LINK\_USD\_0\_\_\_ | 是 | 图片属性，包括图片序号与默认属性值。 |
| callback | \_\_\_MD\_LINK\_USD\_0\_\_\_&lt;string&gt; | 是 | 回调函数，当获取图片属性值成功，err为undefined，data为获取到的图片属性值；否则为错误对象。 |
...
获取图片Exif指定属性键的值，使用同步形式返回结果。
    **说明：**  
    ...
    - 该方法仅支持JPEG、PNG、HEIF、WEBP\_\_\_HTML\_TAG\_DESC\_USD\_1\_\_\_23+\_\_\_HTML\_TAG\_DESC\_USD\_2\_\_\_和DNG\_\_\_HTML\_TAG\_DESC\_USD\_3\_\_\_23+\_\_\_HTML\_TAG\_DESC\_USD\_4\_\_\_（不同硬件设备支持情况不同）文件，且需要包含Exif信息。  
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| key | \_\_\_MD\_LINK\_USD\_0\_\_\_ | 是 | Property name. |
...
该接口仅支持JPEG、PNG、HEIF和WEBP\_\_\_HTML\_TAG\_DESC\_USD\_0\_\_\_23+\_\_\_HTML\_TAG\_DESC\_USD\_1\_\_\_（不同硬件设备支持情况不同）文件，且需要包含Exif信息。
    **说明：**  
...
该接口仅支持JPEG、PNG、HEIF\_\_\_HTML\_TAG\_DESC\_USD\_0\_\_\_12+\_\_\_HTML\_TAG\_DESC\_USD\_1\_\_\_和WEBP\_\_\_HTML\_TAG\_DESC\_USD\_2\_\_\_23+\_\_\_HTML\_TAG\_DESC\_USD\_3\_\_\_（不同硬件设备支持情况不同）文件，且需要包含Exif信息。
    **说明：**  
...
该接口仅支持JPEG、PNG、HEIF\_\_\_HTML\_TAG\_DESC\_USD\_1\_\_\_12+\_\_\_HTML\_TAG\_DESC\_USD\_2\_\_\_和WEBP\_\_\_HTML\_TAG\_DESC\_USD\_3\_\_\_23+\_\_\_HTML\_TAG\_DESC\_USD\_4\_\_\_（不同硬件设备支持情况不同）文件，且需要包含Exif信息。
    **说明：**  
    ...
    [modifyImageProperty]\_\_\_JSDOC\_LINK\_DESC\_USD\_0\_\_\_代替。  
...
仅支持JPEG、PNG、HEIF\_\_\_HTML\_TAG\_DESC\_USD\_1\_\_\_12+\_\_\_HTML\_TAG\_DESC\_USD\_2\_\_\_和WEBP\_\_\_HTML\_TAG\_DESC\_USD\_3\_\_\_23+\_\_\_HTML\_TAG\_DESC\_USD\_4\_\_\_（不同硬件设备支持情况不同）文件，且需要包含Exif信息。
    **说明：**  
...
| key | string | 是 | 图片属性名。 |
| value | string | 是 | 属性值。 |
| callback | \_\_\_MD\_LINK\_USD\_0\_\_\_&lt;void&gt; | 是 | 回调函数，当修改图片属性值成功，err为undefined，否则为错误对象。 |
...
该接口仅支持JPEG、PNG、HEIF、WebP、DNG、GIF、TIFF、HEIFS、JFIF和AVIS（不同硬件设备支持情况不同）文件，且需要包含Exif信息。
    **说明：**  
    ...
    读取DNG格式图片时，该接口对部分propertyKeys有特殊处理。以下字段的字符串取值请参考[PropertyKey]\_\_\_JSDOC\_LINK\_DESC\_USD\_1\_\_\_中的值：  
    ...
    - 从API version 24开始，支持读取DNG元数据。要查询的属性的具体信息请参考[DngPropertyKey]\_\_\_JSDOC\_LINK\_DESC\_USD\_2\_\_\_。  
    
    - 从API version 24开始，支持读取HEIFS元数据。要查询的属性的具体信息请参考[HeifsPropertyKey]\_\_\_JSDOC\_LINK\_DESC\_USD\_3\_\_\_。  
    
    - 从API版本26.0.0开始，支持读取PNG元数据。要查询的属性的具体信息请参考[PngPropertyKey]\_\_\_JSDOC\_LINK\_DESC\_USD\_4\_\_\_。  
    
    - 从API版本26.0.0开始，支持读取JFIF元数据。要查询的属性的具体信息请参考[JfifPropertyKey]\_\_\_JSDOC\_LINK\_DESC\_USD\_5\_\_\_。  
    
    - 从API版本26.0.0开始，支持读取TIFF元数据。要查询的属性的具体信息请参考[TiffPropertyKey]\_\_\_JSDOC\_LINK\_DESC\_USD\_6\_\_\_。  
    
    - 从API版本26.0.0开始，支持读取GIF元数据。要查询的属性的具体信息请参考[GifPropertyKey]\_\_\_JSDOC\_LINK\_DESC\_USD\_7\_\_\_。  
    
    - 从API版本26.0.0开始，支持读取JPEG、PNG、GIF、DNG、TIFF格式图片的XMP元数据。XMP元数据的操作方法可以参考  
    \_\_\_MD\_LINK\_DESC\_USD\_0\_\_\_。  
    
    - 从API版本26.0.0开始，支持读取AVIS元数据。要查询的属性的具体信息请参考[AvisPropertyKey]\_\_\_JSDOC\_LINK\_DESC\_USD\_8\_\_\_。
...
| index | ArkTS-Dyn: number  \_\_\_HTML\_TAG\_USD\_0\_\_\_ArkTS-Sta：int | 否 | 感兴趣的索引，默认值为0。 |
...
该接口仅支持JPEG、PNG、HEIF、WebP、DNG、GIF、TIFF、HEIFS、JFIF和AVIS（不同硬件设备支持情况不同）文件。
    **说明：**  
    ...
    - 从API version 24开始，支持读取DNG元数据。要查询的属性的具体信息请参考[DngPropertyKey]\_\_\_JSDOC\_LINK\_DESC\_USD\_1\_\_\_。  
    
    - 从API version 24开始，支持读取HEIFS元数据。要查询的属性的具体信息请参考[HeifsPropertyKey]\_\_\_JSDOC\_LINK\_DESC\_USD\_2\_\_\_。  
    
    - 从API版本26.0.0开始，支持读取PNG元数据。要查询的属性的具体信息请参考[PngPropertyKey]\_\_\_JSDOC\_LINK\_DESC\_USD\_3\_\_\_。  
    
    - 从API版本26.0.0开始，支持读取JFIF元数据。要查询的属性的具体信息请参考[JfifPropertyKey]\_\_\_JSDOC\_LINK\_DESC\_USD\_4\_\_\_。  
    
    - 从API版本26.0.0开始，支持读取TIFF元数据。要查询的属性的具体信息请参考[TiffPropertyKey]\_\_\_JSDOC\_LINK\_DESC\_USD\_5\_\_\_。  
    
    - 从API版本26.0.0开始，支持读取GIF元数据。要查询的属性的具体信息请参考[GifPropertyKey]\_\_\_JSDOC\_LINK\_DESC\_USD\_6\_\_\_。  
    
    - 从API版本26.0.0开始，支持读取JPEG、PNG、GIF、DNG、TIFF格式图片的XMP元数据。XMP元数据的操作方法可以参考  
    \_\_\_MD\_LINK\_DESC\_USD\_0\_\_\_。  
    
    - 从API版本26.0.0开始，支持读取AVIS元数据。要查询的属性的具体信息请参考[AvisPropertyKey]\_\_\_JSDOC\_LINK\_DESC\_USD\_7\_\_\_。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| metadataTypes | \_\_\_MD\_LINK\_USD\_0\_\_\_[] | 否 | 元数据类型的数组。当该参数缺省时，获取全部支持的元数据。 |
| index | ArkTS-Dyn: number  \_\_\_HTML\_TAG\_USD\_0\_\_\_ArkTS-Sta：int | 否 |  |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | \_\_\_MD\_LINK\_USD\_0\_\_\_&lt;void&gt; | 是 | 回调函数，当资源释放成功，err为undefined，否则为错误对象。 |
...
| offset | ArkTS-Dyn: number  \_\_\_HTML\_TAG\_USD\_0\_\_\_ArkTS-Sta：int | 是 | 即当前buffer中的数据首地址，相对于整个图片文件首地址的偏移量。单位：字节（Byte）。\_\_\_HTML\_TAG\_USD\_0\_\_\_**起始版本：** 11 |
| length | ArkTS-Dyn: number  \_\_\_HTML\_TAG\_USD\_0\_\_\_ArkTS-Sta：int | 是 | 当前buffer的长度。单位：字节（Byte）。 |
...
| offset | ArkTS-Dyn: number  \_\_\_HTML\_TAG\_USD\_0\_\_\_ArkTS-Sta：int | 是 | 即当前buffer中的数据首地址，相对于整个图片文件首地址的偏移量。单位：字节（Byte）。\_\_\_HTML\_TAG\_USD\_0\_\_\_**起始版本：** 11 |
| length | ArkTS-Dyn: number  \_\_\_HTML\_TAG\_USD\_0\_\_\_ArkTS-Sta：int | 是 | 当前buffer的长度。单位：字节（Byte）。 |
| callback | \_\_\_MD\_LINK\_USD\_0\_\_\_&lt;void&gt; | 是 | 回调函数，当更新增量数据成功，err为undefined，否则为错误对象。 |
...
批量修改图片属性。使用Promise异步回调。
    **说明：**  
    ...
    - 调用该接口修改属性会改变属性字节长度，建议通过传入文件描述符来创建[image.createImageSource]\_\_\_JSDOC\_LINK\_DESC\_USD\_1\_\_\_实例或通过传入的uri创建  
    [image.createImageSource]\_\_\_JSDOC\_LINK\_DESC\_USD\_2\_\_\_实例。  
    
    - 该方法在内存中完成批量数据修改后会一次性写入文件，相比  
    [modifyImageProperties]\_\_\_JSDOC\_LINK\_DESC\_USD\_3\_\_\_  
    更高效。  
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| imageMetadata | \_\_\_MD\_LINK\_USD\_0\_\_\_ | 是 | 图像的元数据集。若imageMetadata中的属性值都为空，则清空所有Exif元数据。 |
...
包括：PNG、JPEG、BMP、GIF、WebP、DNG、HEIC\_\_\_HTML\_TAG\_DESC\_USD\_1\_\_\_12+\_\_\_HTML\_TAG\_DESC\_USD\_2\_\_\_、WBMP\_\_\_HTML\_TAG\_DESC\_USD\_3\_\_\_23+\_\_\_HTML\_TAG\_DESC\_USD\_4\_\_\_、HEIFS\_\_\_HTML\_TAG\_DESC\_USD\_5\_\_\_23+\_\_\_HTML\_TAG\_DESC\_USD\_6\_\_\_、TIFF\_\_\_HTML\_TAG\_DESC\_USD\_7\_\_\_23+\_\_\_HTML\_TAG\_DESC\_USD\_8\_\_\_。从API版本26.0.0开始，增加支持AVIF、AVIS格式。

部分格式的解码能力依赖于具体的设备硬件，建议在调用前使用[image.getImageSourceSupportedFormats]\_\_\_JSDOC\_LINK\_DESC\_USD\_0\_\_\_接口，动态查询当前设备上的解码能力。
