...
| 类型 | 说明 |
| --- | --- |
| Promise&lt;[Record](../../apis-arkts/arkts-apis/arkts-arkts-map-record-c.md)&lt;string, string \| null&gt;&gt; | Promise对象，返回获取到的图像元数据属性值。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| records | [Record](../../apis-arkts/arkts-apis/arkts-arkts-map-record-c.md)&lt;string, string \| null&gt; | 是 | 用户要修改的ExifMetadata对象的属性和键值对的集合。 |
