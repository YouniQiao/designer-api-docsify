...
| 类型 | 说明 |
| --- | --- |
| [SurfaceRect](arkts-na-xcomponent-surfacerect-i.md) | 获取XComponent持有Surface的显示区域。 |
...
| 类型 | 说明 |
| --- | --- |
| Required&lt;[SurfaceRotationOptions](arkts-na-xcomponent-surfacerotationoptions-i.md)&gt; | 获取XComponent持有Surface在屏幕旋转时是否锁定方向的设置。 |
...
| rect | [SurfaceRect](arkts-na-xcomponent-surfacerect-i.md) | 是 | 回调该方法的时候，绑定XComponent持有Surface的显示区域。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| config | [SurfaceConfig](arkts-na-xcomponent-surfaceconfig-i.md) | 是 | Surface配置选项，用于设置XComponent持有的Surface在渲染时是否需要被视为不透明。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| rect | [SurfaceRect](arkts-na-xcomponent-surfacerect-i.md) | 是 | XComponent持有Surface的显示区域。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| rotationOptions | [SurfaceRotationOptions](arkts-na-xcomponent-surfacerotationoptions-i.md) | 是 | 设置XComponent持有Surface在屏幕旋转时是否锁定方向。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| config | [ImageAnalyzerConfig](arkts-na-imagecommon-imageanalyzerconfig-i.md) | 是 | 执行AI分析所需要的入参，用于配置AI分析功能。 |
