...
| callback | [Callback](../../apis-basic-service-kit/arkts-apis/arkts-basicservices-base-callback-i.md)&lt;[DensityInfo](arkts-na-uiobserver-densityinfo-c.md)&gt; | 是 | The callback function to be called when the screen density is updated. |
