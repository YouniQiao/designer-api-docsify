...
| callback | [AsyncCallback](../../apis-basic-service-kit/arkts-apis/arkts-basicservices-asynccallback-t.md)&lt;void, Array&lt;[ConflictFiles](arkts-na-file-fs-conflictfiles-i.md)&gt;&gt; | 是 | Callback used to return the result. |
...
| callback | [AsyncCallback](../../apis-basic-service-kit/arkts-apis/arkts-basicservices-asynccallback-t.md)&lt;void, Array&lt;[ConflictFiles](arkts-na-file-fs-conflictfiles-i.md)&gt;&gt; | 是 | 异步移动目录之后的回调。 |
