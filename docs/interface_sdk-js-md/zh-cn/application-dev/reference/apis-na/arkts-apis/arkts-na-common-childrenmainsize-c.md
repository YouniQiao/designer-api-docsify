...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| childDefaultSize | double | 是 | default main size, in vp. If the main axis is vertical, it indicates height. If the main axis is horizontal, it indicates width. |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| start | int | 是 | Zero-based index at which to start changing the children main size. |
| deleteCount | int | 否 | Indicating the number of children main size to remove from start. |
| childrenSize | Array&lt;double&gt; | 否 | Add the new children main size, beginning from start. |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| index | int | 是 | index of child to be updated. |
| childSize | double | 是 | new section options. |
