...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | [CustomDialogControllerOptions](arkts-na-customdialogcontroller-customdialogcontrolleroptions-i.md) | 是 |  |
...
| 类型 | 说明 |
| --- | --- |
| [CustomDialogControllerExternalOptions](arkts-na-customdialogcontroller-customdialogcontrollerexternaloptions-i.md) | 返回自定义弹窗的外部选项。 |
...
| 类型 | 说明 |
| --- | --- |
| [PromptActionCommonState](arkts-na-promptactioncommonstate-t.md) | 返回对应的弹窗状态。 |
...
显示自定义弹窗内容，允许多次使用。如果弹框为SubWindow模式，弹窗可以显示在主窗口之外，此时弹框不允许再弹出SubWindow弹框。 &gt; **说明：** &gt; &gt; 不支持在输入法类型窗口中使用子窗（showInSubwindow为true）的CustomDialog，详情见输入法框架的约束与限制说明 createPanel。
