...
| options | [TextLayoutOptions](../../apis-arkui/arkts-apis/arkts-arkui-textcommon-textlayoutoptions-i.md) | 否 | 布局选项。 |
...
| 类型 | 说明 |
| --- | --- |
| [SizeOptions](arkts-na-units-sizeoptions-i.md) | width and height for text to display |
