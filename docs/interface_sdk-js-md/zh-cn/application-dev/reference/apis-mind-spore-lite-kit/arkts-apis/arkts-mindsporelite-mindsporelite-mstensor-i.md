...
| 错误码ID | 错误信息 |
| --- | --- |
| 1000013 | Failed to set MSTensor data. Possible causes: 1. The input array buffer size is incorrect.  **ArkTS模式：** 该错误码仅适用于ArkTS-Sta。 |
...
**类型：** [DataType](../../apis-media-library-kit/arkts-apis/arkts-medialibrary-file-photopickercomponent-datatype-e.md)
...
**类型：** [Format](arkts-mindsporelite-mindsporelite-format-e.md)
