...
通过[select](arkts-medialibrary-photoaccesshelper-photoviewpicker-c.md#select)接口配置此参数时，输入非法字段会抛出错误码401；通 过PhotoPickerComponent (PhotoPicker组件)配置此参数时，输入非法字段无 onPickerControllerReady回调。
