...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| computedCallback | [ComputedCallback](arkts-computedcallback-t.md)&lt;T&gt; | 是 | computed callback function |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| owner | [IVariableOwner](arkts-decorator-ivariableowner-i.md) | 是 | 状态变量的所有者 |
| varName | string | 是 | 状态变量的名字 |
| provideAlias | string | 是 | 变量别名 |
| watchFunc | [WatchFuncType](arkts-watchfunctype-t.md) | 否 | 监听函数 |

**返回值：**

| 类型 | 说明 |
| --- | --- |
| [IConsumeDecoratedVariable](arkts-decorator-iconsumedecoratedvariable-i.md)&lt;T&gt; | 状态变量实例 |
...
| provideAlias | string | 是 | 变量别名 |
| watchFunc | [WatchFuncType](arkts-watchfunctype-t.md) | 否 | 监听函数 |
| consumeOptions | [ConsumeOptions](arkts-decorator-consumeoptions-i.md)&lt;T&gt; | 否 | 包含开发者设置的初始值的接口 |
...
| 类型 | 说明 |
| --- | --- |
| [IConsumerDecoratedVariable](arkts-decorator-iconsumerdecoratedvariable-i.md)&lt;T&gt; | 状态变量实例 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| owner | [IVariableOwner](arkts-decorator-ivariableowner-i.md) | 是 | 该变量的自定义组件所有者。 |
| envKey | [CustomEnvKey](arkts-decorator-customenvkey-c.md)&lt;T&gt; | 是 | 自定义环境变量键。 |
...
| 类型 | 说明 |
| --- | --- |
| [ICustomEnvDecoratedVariable](arkts-decorator-icustomenvdecoratedvariable-i.md)&lt;T&gt; | CustomEnv变量实例。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| owner | [IVariableOwner](arkts-decorator-ivariableowner-i.md) | 是 | 自定义组件。 |
| envValue | string \| [SystemEnvKey](arkts-decorator-systemenvkey-c.md)&lt;T&gt; | 是 | 支持的环境变量类型 [APi22 - API24] |
| varName | string | 是 |  |
| envOptions | [EnvOptions](arkts-decorator-envoptions-i.md)&lt;T&gt; | 否 | makeEnv的其他选项。 |

**返回值：**

| 类型 | 说明 |
| --- | --- |
| [IEnvDecoratedVariable](arkts-decorator-ienvdecoratedvariable-i.md)&lt;T&gt; | Env变量实例。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| reusePool | [ReusePoolOwnership](arkts-customcomponent-reusepoolownership-e.md) | 是 | 复用池类型 |
| poolAccepts | [Class](../../apis-arkts/arkts-apis/arkts-arkts-class-c.md)[] | 是 | 重用池接受的自定义组件 |
| owningView | [IVariableOwner](arkts-decorator-ivariableowner-i.md) | 是 | 拥有全局池的自定义组件 |

**返回值：**

| 类型 | 说明 |
| --- | --- |
| [IGlobalReusePoolVariable](arkts-decorator-iglobalreusepoolvariable-i.md) | 全局重用池句柄。 |
...
| owner | [IVariableOwner](arkts-decorator-ivariableowner-i.md) | 是 | 状态变量的所有者 |
| varName | string | 是 | 状态变量的名字 |
| source | [LinkSourceType](arkts-linksourcetype-t.md)&lt;T&gt; | 是 | 状态变量的初始值 |
| watchFunc | [WatchFuncType](arkts-watchfunctype-t.md) | 否 | 监听函数 |
...
| 类型 | 说明 |
| --- | --- |
| [ILinkDecoratedVariable](arkts-decorator-ilinkdecoratedvariable-i.md)&lt;T&gt; | 状态变量实例 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| owner | [IVariableOwner](arkts-decorator-ivariableowner-i.md) | 是 | owner of this variable. |
...
| 类型 | 说明 |
| --- | --- |
| [ILocalStorageLinkDecoratedVariable](arkts-decorator-ilocalstoragelinkdecoratedvariable-i.md)&lt;T&gt; | 状态变量实例 |
...
| watchFunc | [WatchFuncType](arkts-watchfunctype-t.md) | 否 | watch type |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| pathInfos | Array&lt;[IMonitorPathInfo](arkts-decorator-imonitorpathinfo-i.md)&gt; | 是 | monitor path to its accessor |
| monitorCallback | [MonitorCallback](arkts-monitorcallback-t.md) | 是 | callback when then monitor triggers |
| owner | [IVariableOwner](arkts-decorator-ivariableowner-i.md) | 否 | owner of this monitor |
...
| --- | --- | --- | --- |
| pathInfos | Array&lt;[IMonitorPathInfo](arkts-decorator-imonitorpathinfo-i.md)&gt; | 是 | monitor path to its accessor |
| monitorCallback | [MonitorCallback](arkts-monitorcallback-t.md) | 是 | callback when the monitor triggers |
| options | [MakeMonitorOptions](arkts-decorator-makemonitoroptions-i.md) | 否 | options of this monitor |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| observedObject | [IObservedObject](arkts-decorator-iobservedobject-i.md) \| undefined | 是 | 此元的所有者。 |
...
| 类型 | 说明 |
| --- | --- |
| [IObjectLinkDecoratedVariable](arkts-decorator-iobjectlinkdecoratedvariable-i.md)&lt;T&gt; | 状态变量实例 |
...
| 类型 | 说明 |
| --- | --- |
| [IParamDecoratedVariable](arkts-decorator-iparamdecoratedvariable-i.md)&lt;T&gt; | 状态变量实例 |
...
| 类型 | 说明 |
| --- | --- |
| [IParamOnceDecoratedVariable](arkts-decorator-iparamoncedecoratedvariable-i.md)&lt;T&gt; | 状态变量实例 |
...
| 类型 | 说明 |
| --- | --- |
| [IPropRefDecoratedVariable](arkts-decorator-iproprefdecoratedvariable-i.md)&lt;T&gt; | 状态变量实例 |
...
| 类型 | 说明 |
| --- | --- |
| [IProvideDecoratedVariable](arkts-decorator-iprovidedecoratedvariable-i.md)&lt;T&gt; | 状态变量实例 |
...
| 类型 | 说明 |
| --- | --- |
| [IProviderDecoratedVariable](arkts-decorator-iproviderdecoratedvariable-i.md)&lt;T&gt; | 状态变量实例 |
...
| 类型 | 说明 |
| --- | --- |
| [IStateDecoratedVariable](arkts-decorator-istatedecoratedvariable-i.md)&lt;T&gt; | 状态变量实例 |
...
| 类型 | 说明 |
| --- | --- |
| [IStorageLinkDecoratedVariable](arkts-decorator-istoragelinkdecoratedvariable-i.md)&lt;T&gt; | 状态变量实例 |
...
| 类型 | 说明 |
| --- | --- |
| [IStoragePropRefDecoratedVariable](arkts-decorator-istorageproprefdecoratedvariable-i.md)&lt;T&gt; | 状态变量实例 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| pathInfos | [IMonitorPathInfo](arkts-decorator-imonitorpathinfo-i.md)[] | 是 | 到其访问器的监视器路径。 |
| monitorCallback | [MonitorCallback](arkts-monitorcallback-t.md) | 是 | 监视器触发时的回调。 |
| options | [MakeMonitorOptions](arkts-decorator-makemonitoroptions-i.md) | 否 | 此监视器的选项。 |

**返回值：**

| 类型 | 说明 |
| --- | --- |
| [IMonitorDecoratedVariable](arkts-decorator-imonitordecoratedvariable-i.md) | 监控变量实例 |
