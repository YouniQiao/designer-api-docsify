...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| start | [NodeIdentity](arkts-nodeidentity-t.md) | 是 | the start component ID, set by developer through .id attribute or the unique ID get from FrameNode. |
| end | [NodeIdentity](arkts-nodeidentity-t.md) | 是 | the end component ID, set by developer through.id attribute or the unique ID get from FrameNode. |
