...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| modifier | AttributeModifier&lt;[DynamicLayoutAttribute](../../apis-arkui/arkts-apis/arkts-arkui-arkui-components-arkdynamiclayout-dynamiclayoutattribute-c.md)&gt; \| AttributeModifier&lt;CommonMethod&gt; \| undefined | 是 |  |
