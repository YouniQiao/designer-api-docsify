...
**继承/实现关系：** ChipV2SymbolIcon extends [ChipV2Icon](../../apis-arkui/arkts-apis/arkts-arkui-arkui-advanced-chipv2-chipv2icon-c.md)
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| config | [ChipV2SymbolIconConfig](../../apis-arkui/arkts-apis/arkts-arkui-arkui-advanced-chipv2-chipv2symboliconconfig-i.md) | 是 | ChipV2符号图标配置 |
