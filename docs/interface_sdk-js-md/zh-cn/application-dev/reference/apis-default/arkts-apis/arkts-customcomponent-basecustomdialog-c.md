...
**继承/实现关系：** BaseCustomDialog extends [ExtendableComponent](arkts-extendablecomponent-extendablecomponent-c.md)
...
| content | [CustomBuilder](arkts-custombuilder-t.md) | 否 | 自定义对话框的尾随闭包 |
