...
**类型：** [AccessibilitySelectedType](arkts-arkui-advanced-chip-accessibilityselectedtype-e.md)
...
**类型：** [CloseOptions](arkts-arkui-advanced-chip-closeoptions-i.md)
...
**类型：** [LabelOptions](arkts-arkui-advanced-chip-labeloptions-i.md)
...
**类型：** [PrefixIconOptions](arkts-arkui-advanced-chip-prefixiconoptions-i.md)
...
**类型：** [ChipSymbolGlyphOptions](arkts-arkui-advanced-chip-chipsymbolglyphoptions-i.md)
...
**类型：** [ChipSize](arkts-arkui-advanced-chip-chipsize-e.md) \| SizeOptions
...
**类型：** [SuffixIconOptions](arkts-arkui-advanced-chip-suffixiconoptions-i.md)
...
**类型：** [ChipSuffixSymbolGlyphOptions](arkts-arkui-advanced-chip-chipsuffixsymbolglyphoptions-i.md)
