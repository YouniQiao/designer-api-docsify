...
> **说明：**
> 
> RowLayoutAlgorithm类对象可以作为 &gt; [DynamicLayout](../../../reference/apis-arkui/arkui-ts/ts-container-dynamiclayout.md)组件的入参指定布局算法。

@implements LayoutAlgorithm

**继承/实现关系：** RowLayoutAlgorithm implements [LayoutAlgorithm](arkts-layoutalgorithm-i.md)
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| option | [RowLayoutAlgorithmOptions](arkts-layoutalgorithm-rowlayoutalgorithmoptions-i.md) | 否 | 水平方向线性布局算法的构造入参， 设置布局算法的间距、主轴对齐方式、交叉轴对齐方式及主轴排列方向。 |
