...
| unit | [LengthUnit](arkts-graphics-lengthunit-e.md) | 否 | 长度属性的单位。 |
...
| 类型 | 说明 |
| --- | --- |
| [LengthMetrics](arkts-graphics-lengthmetrics-c.md) | LengthMetrics 类的实例。 |
...
**类型：** [LengthUnit](arkts-graphics-lengthunit-e.md)
