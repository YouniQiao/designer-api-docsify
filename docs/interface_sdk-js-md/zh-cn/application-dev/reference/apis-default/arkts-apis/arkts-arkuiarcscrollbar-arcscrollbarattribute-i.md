...
**继承/实现关系：** ArcScrollBarAttribute extends CommonMethod
...
```TypeScript
attributeModifier(modifier: AttributeModifier<ArcScrollBarAttribute> | AttributeModifier<CommonMethod> | undefined): this
```
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| modifier | AttributeModifier&lt;[ArcScrollBarAttribute](../../apis-arkui/arkts-apis/arkts-arkui-arkuiarcscrollbar-arcscrollbarattribute-c.md)&gt; \| AttributeModifier&lt;CommonMethod&gt; \| undefined | 是 |  |
