...
继承于[CommonOptions](arkts-arkuiadvanceddatepickercomponent-commonoptions-c.md)。

**继承/实现关系：** TimeOptions extends [CommonOptions](arkts-arkuiadvanceddatepickercomponent-commonoptions-c.md)
...
**类型：** [TimeFormat](arkts-arkuiadvanceddatepickercomponent-timeformat-e.md)
