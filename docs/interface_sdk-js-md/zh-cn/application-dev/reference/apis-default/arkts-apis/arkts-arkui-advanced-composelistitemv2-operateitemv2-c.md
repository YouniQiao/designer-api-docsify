...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| options | [OperateItemV2Options](arkts-arkui-advanced-composelistitemv2-operateitemv2options-i.md) | 否 | OperateItemV2的可选项 |
...
**类型：** [OperateIconV2](arkts-arkui-advanced-composelistitemv2-operateiconv2-c.md)
...
**类型：** [OperateButtonV2](arkts-arkui-advanced-composelistitemv2-operatebuttonv2-c.md)
...
**类型：** [OperateCheckV2](arkts-arkui-advanced-composelistitemv2-operatecheckv2-c.md)
