...
**继承/实现关系：** ChipV2PrefixSymbolIcon extends [ChipV2SymbolIcon](../../apis-arkui/arkts-apis/arkts-arkui-arkui-advanced-chipv2-chipv2symbolicon-c.md)
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| config | [ChipV2PrefixSymbolIconConfig](../../apis-arkui/arkts-apis/arkts-arkui-arkui-advanced-chipv2-chipv2prefixsymboliconconfig-i.md) | 是 | ChipV2前缀符号图标配置 |
