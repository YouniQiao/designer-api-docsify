...
| callback | [OnPushEventCallback](arkts-plugincomponentmanager-onpusheventcallback-t.md) \| [OnRequestEventCallback](arkts-plugincomponentmanager-onrequesteventcallback-t.md) | 是 | 对应监听回调， push事件对应回调类型为OnPushEventCallback，request事件对应回调类型为OnRequestEventCallback。 |
