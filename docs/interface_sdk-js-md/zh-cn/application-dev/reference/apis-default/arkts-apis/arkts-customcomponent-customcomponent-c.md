...
| content | [CustomBuilder](arkts-custombuilder-t.md) | 否 | tail closure for custom component |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| params | [ReuseObject](arkts-customcomponent-reuseobject-c.md) | 是 | Custom component init params. |
