...
继承自[IconOptions](arkts-arkui-advanced-chipgroup-iconoptions-i.md)。

**继承/实现关系：** SuffixImageIconOptions extends [IconOptions](arkts-arkui-advanced-chipgroup-iconoptions-i.md)
