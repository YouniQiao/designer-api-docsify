...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| options | [ArcSliderLayoutOptionsConstructorOptions](arkts-arkuiadvancedarcslider-arcsliderlayoutoptionsconstructoroptions-i.md) | 否 | ArcSliderLayoutOptions的构造信息。 |
...
**类型：** [ArcSliderPosition](arkts-arkuiadvancedarcslider-arcsliderposition-e.md)
