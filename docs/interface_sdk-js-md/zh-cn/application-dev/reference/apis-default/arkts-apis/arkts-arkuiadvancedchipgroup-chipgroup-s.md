...
设置ChipGroup的上下内边距，以控制整体高度。类型为[ChipGroupPaddingOptions](arkts-arkuiadvancedchipgroup-chipgrouppaddingoptions-i.md)。
...
**类型：** [ChipGroupPaddingOptions](arkts-arkuiadvancedchipgroup-chipgrouppaddingoptions-i.md)
...
左右内边距及Chip之间间距。参考[ChipGroupSpaceOptions](arkts-arkuiadvancedchipgroup-chipgroupspaceoptions-i.md)类型。
...
**类型：** [ChipGroupSpaceOptions](arkts-arkuiadvancedchipgroup-chipgroupspaceoptions-i.md)
...
`Chip`的`style`属性，如颜色，大小等，参考[ChipItemStyle](arkts-arkuiadvancedchipgroup-chipitemstyle-i.md)类型。
...
**类型：** [ChipItemStyle](arkts-arkuiadvancedchipgroup-chipitemstyle-i.md)
...
每个Chip的特定属性，参考 [ChipGroupItemOptions[]][ChipGroupItemOptions](arkts-arkuiadvancedchipgroup-chipgroupitemoptions-i.md)类型。

若为undefined时，ChipGroup默认为空。

**类型：** [ChipGroupItemOptions](arkts-arkuiadvancedchipgroup-chipgroupitemoptions-i.md)[]
...
支持开发者自定义builder，如需在组件最右侧显示自定义内容可配置suffix属性，使用属性suffix需引用[IconGroupSuffix](arkts-arkuiadvancedchipgroup-icongroupsuffix-s.md)接口。
