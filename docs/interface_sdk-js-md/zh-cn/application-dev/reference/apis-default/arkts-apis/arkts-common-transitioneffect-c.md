...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | [AnimateParam](arkts-common-animateparam-i.md) | 是 | 动画参数。&lt;/br&gt;该参数只用来指定动画参数，其入参AnimateParam的onFinish回调不生效。&lt;/br&gt;如果通过combine进行 TransitionEffect的组合，前一TransitionEffect的动画参数也可用于后一TransitionEffect。 |

**返回值：**

| 类型 | 说明 |
| --- | --- |
| [TransitionEffect](arkts-common-transitioneffect-c.md) | 当前动画效果。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| appear | [TransitionEffect](arkts-common-transitioneffect-c.md) | 是 | 指定出现的转场效果。<br/>如不通过asymmetric函数构造TransitionEffect，则表明该效果在组件出现和消失时均生效。 |
| disappear | [TransitionEffect](arkts-common-transitioneffect-c.md) | 是 | 指定消失的转场效果。<br/>如不通过asymmetric函数构造TransitionEffect，则表明该效果在组件出现和消失时均生效。 |

**返回值：**

| 类型 | 说明 |
| --- | --- |
| [TransitionEffect](arkts-common-transitioneffect-c.md) | 当前动画非对称的转场效果。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| transitionEffect | [TransitionEffect](arkts-common-transitioneffect-c.md) | 是 | 被组合的过渡效果。 |

**返回值：**

| 类型 | 说明 |
| --- | --- |
| [TransitionEffect](arkts-common-transitioneffect-c.md) | 组合过渡效应。 |
...
| --- | --- | --- | --- |
| type | 'move' | 是 | 转场类型。 |
| effect | [TransitionEdge](arkts-common-transitionedge-e.md) | 是 | 转场参数。 |
...
| effect | [TranslateOptions](arkts-common-translateoptions-i.md) | 是 | 转场参数。 |
...
| --- | --- | --- | --- |
| type | 'rotate' | 是 | 转场类型。 |
| effect | [RotateOptions](arkts-common-rotateoptions-i.md) | 是 | 转场参数。 |
...
| --- | --- | --- | --- |
| type | 'scale' | 是 | 转场类型。 |
| effect | [ScaleOptions](arkts-common-scaleoptions-i.md) | 是 | 转场参数。 |
...
| effect | [AsymmetricTransitionOption](arkts-common-asymmetrictransitionoption-i.md) | 是 | 转场参数。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| edge | [TransitionEdge](arkts-common-transitionedge-e.md) | 是 | 组件转场时从屏幕边缘滑入和滑出的效果，本质为平移效果，为插入时起点和删除时终点的值。 |

**返回值：**

| 类型 | 说明 |
| --- | --- |
| [TransitionEffect](arkts-common-transitioneffect-c.md) | 当前动画从屏幕边缘滑入和滑出的效果。 |
...
| 类型 | 说明 |
| --- | --- |
| [TransitionEffect](arkts-common-transitioneffect-c.md) | 当前动画透明度效果。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| options | [RotateOptions](arkts-common-rotateoptions-i.md) | 是 | 组件转场时的旋转效果，为插入时起点和删除时终点的值。<br/>-x：横向的旋转向量分量。<br/>-y：纵向的旋转向量分量。<br/>-z：竖向的旋转向量分 量。<br/>- centerX、centerY指旋转中心点，centerX和centerY默认值是"50%"，即默认以组件的中心点为旋转中心点。<br/>- 中心点为(0, 0)代表组件的左上角。<br/>- centerZ指z轴锚点，即3D旋转中心点的z轴分量，centerZ默认值是0。<br/>-perspective指视距，不支持perspective属性做转场动画。 |

**返回值：**

| 类型 | 说明 |
| --- | --- |
| [TransitionEffect](arkts-common-transitioneffect-c.md) | 当前动画旋转效果。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| options | [TranslateOptions](arkts-common-translateoptions-i.md) | 是 | 组件转场时的平移效果，为插入时起点和删除时终点的值。<br/>-x：横向的平移距离。<br/>-y：纵向的平移距离。<br/>-z：竖向的平移距离。 |

**返回值：**

| 类型 | 说明 |
| --- | --- |
| [TransitionEffect](arkts-common-transitioneffect-c.md) | 当前动画平移效果。 |
