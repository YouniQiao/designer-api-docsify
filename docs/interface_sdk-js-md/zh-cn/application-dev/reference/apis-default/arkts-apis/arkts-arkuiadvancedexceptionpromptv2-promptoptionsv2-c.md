...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| config | [PromptOptionsV2Config](../../apis-arkui/arkts-apis/arkts-arkui-arkuiadvancedexceptionpromptv2-promptoptionsv2config-i.md) | 否 | Configuration information of ExceptionPromptV2 |
...
**类型：** [MarginTypeV2](../../apis-arkui/arkts-apis/arkts-arkui-arkuiadvancedexceptionpromptv2-margintypev2-e.md)
