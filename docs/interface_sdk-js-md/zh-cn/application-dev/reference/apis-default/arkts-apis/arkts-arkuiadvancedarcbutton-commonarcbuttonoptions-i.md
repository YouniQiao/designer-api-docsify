...
**默认值：** { start: 24.0_vp, top: 10.0_vp, end: 24.0_vp, bottom: 16.0_vp }
...
弧形按钮样式模式。该样式不支持与[ArcButtonProgressConfig](../../apis-arkui/arkts-apis/arkts-arkui-arkuiadvancedarcbutton-arcbuttonprogressconfig-c.md)样式同时使用。
