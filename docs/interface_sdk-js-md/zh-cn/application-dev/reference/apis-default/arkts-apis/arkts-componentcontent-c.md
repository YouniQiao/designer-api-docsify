...
**继承/实现关系：** ComponentContent extends [ComponentContentBase](arkts-componentcontent-componentcontentbase-c.md)
...
| args | T | 是 | Parameters used to update the ComponentContent. |
| options | [BuildOptions](arkts-buildernode-buildoptions-i.md) | 是 | Defines the options that will be used when building. |
