...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| connectionId | ArkTS-Dyn: number  <br>ArkTS-Sta：long | 是 | 从 [connectServiceExtensionAbility](arkts-uiserviceextensioncontext-c-sys.md#connectserviceextensionability)接口返回的连接Id。 |
...
| wantParam | [Record](arkts-record-t.md)&lt;string, Object&gt; | 是 | Want参数。 |
...
| --- | --- | --- | --- |
| type | string | 是 | 目标ability类型。 |
| wantParam | [Record](arkts-record-t.md)&lt;string, RecordData&gt; | 是 | Want参数。 |
| abilityStartCallback | [AbilityStartCallback](../../apis-ability-kit/arkts-apis/arkts-ability-abilitystartcallback-i.md) | 是 | 拉起UIExtensionAbility执行结果的回调。 |
