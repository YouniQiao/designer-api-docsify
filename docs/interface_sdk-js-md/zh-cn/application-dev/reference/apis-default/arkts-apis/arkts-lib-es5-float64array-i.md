...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| predicate | (value: number, index: number, array: Float64Array) =&gt; unknown | 是 |  |
| thisArg | any | 否 |  |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| predicate | (value: number, index: number, array: Float64Array) =&gt; any | 是 |  |
| thisArg | any | 否 |  |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| predicate | (value: number, index: number, obj: Float64Array) =&gt; boolean | 是 |  |
| thisArg | any | 否 |  |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callbackfn | (value: number, index: number, array: Float64Array) =&gt; void | 是 |  |
| thisArg | any | 否 |  |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callbackfn | (value: number, index: number, array: Float64Array) =&gt; number | 是 |  |
| thisArg | any | 否 |  |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callbackfn | (previousValue: number, currentValue: number, currentIndex: number, array: Float64Array) =&gt; number | 是 |  |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callbackfn | (previousValue: U, currentValue: number, currentIndex: number, array: Float64Array) =&gt; U | 是 |  |
| initialValue | U | 是 |  |
