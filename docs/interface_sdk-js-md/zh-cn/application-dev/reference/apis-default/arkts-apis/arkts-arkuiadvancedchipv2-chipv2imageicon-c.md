...
**继承/实现关系：** ChipV2ImageIcon extends [ChipV2Icon](../../apis-arkui/arkts-apis/arkts-arkui-arkuiadvancedchipv2-chipv2icon-c.md)
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| config | [ChipV2ImageIconConfig](../../apis-arkui/arkts-apis/arkts-arkui-arkuiadvancedchipv2-chipv2imageiconconfig-i.md) | 是 | 图标公共配置 |
