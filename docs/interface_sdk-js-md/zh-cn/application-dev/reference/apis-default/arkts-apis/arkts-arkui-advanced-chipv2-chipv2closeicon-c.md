...
**继承/实现关系：** ChipV2CloseIcon extends [ChipV2Accessibility](../../apis-arkui/arkts-apis/arkts-arkui-arkui-advanced-chipv2-chipv2accessibility-c.md)
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| config | [ChipV2CloseConfig](../../apis-arkui/arkts-apis/arkts-arkui-arkui-advanced-chipv2-chipv2closeconfig-i.md) | 是 | 关闭图标配置 |
