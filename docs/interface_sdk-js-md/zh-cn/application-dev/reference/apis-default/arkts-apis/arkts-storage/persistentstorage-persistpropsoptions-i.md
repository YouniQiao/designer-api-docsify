...
默认值为undefined。见[FromJsonType]\_\_\_JSDOC\_LINK\_DESC\_USD\_0\_\_\_，用于反序列化。对于复杂类型（除boolean、int、double、long、string外），开发者必须实现该方法才能成功反序列化。
...
当在[PersistentStorage]\_\_\_JSDOC\_LINK\_DESC\_USD\_1\_\_\_和  
\_\_\_MD\_LINK\_DESC\_USD\_0\_\_\_中未查询到key时，使用defaultValue中。
