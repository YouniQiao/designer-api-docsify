...
| 类型 | 说明 |
| --- | --- |
| [TreeListenerManagerV2](../../apis-arkui/arkts-apis/arkts-arkui-arkuiadvancedtreeviewv2-treelistenermanagerv2-c.md) | 返回获取到的树视图组件的监听管理器单例对象。 |
...
| 类型 | 说明 |
| --- | --- |
| [TreeListenerV2](../../apis-arkui/arkts-apis/arkts-arkui-arkuiadvancedtreeviewv2-treelistenerv2-c.md) | 返回获取到的树视图监听器实例。 |
