...
Chip大小是ChipSize.NORMAL时，suffix默认值：{width: 24,height: 24}。&lt;/br&gt; 如果想动态修改size，那么必须在引入 [IconGroupSuffix](arkts-arkui-advanced-chipgroup-icongroupsuffix-s.md)时，使用 SymbolGlyphModifier 类型。

值为undefined时，按默认值处理。

**类型：** [IconOptions](arkts-arkui-advanced-chipgroup-iconoptions-i.md)
