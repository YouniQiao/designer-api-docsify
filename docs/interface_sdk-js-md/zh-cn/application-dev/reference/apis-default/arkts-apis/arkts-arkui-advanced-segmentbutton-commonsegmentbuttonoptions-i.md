...
底板颜色。默认值：\$r('sys.color.ohos_id_color_button_normal')
...
按钮未选中态的字体大小（不支持百分比设置）。默认值：\$r('sys.float.ohos_id_text_size_body2')
...
按钮未选中态的字体粗细。默认值：FontWeight.Regular
...
按钮内边距，默认值：仅图标按钮和仅文字按钮 `{ top: LengthMetrics.vp(4), end: LengthMetrics.vp(8), bottom: LengthMetrics.vp(4), start: LengthMetrics.vp(8) }`，图 标+文本按钮 `{ top: LengthMetrics.vp(6), end: LengthMetrics.vp(8), bottom: LengthMetrics.vp(6), start: LengthMetrics.vp(8) }`。

**类型：** LocalizedPadding

**默认值：** For text only / icon only buttons LocalizedPadding { top: LengthMetrics.vp(4), end: LengthMetrics.vp(8), bottom: LengthMetrics.vp(4), start: LengthMetrics.vp(8) }. For text & icon buttons LocalizedPadding { top: LengthMetrics.vp(6), end: LengthMetrics.vp(8), bottom: LengthMetrics.vp(6), start: LengthMetrics.vp(8) }.
...
按钮选中态的字体大小（不支持百分比设置）。默认值：\$r('sys.float.ohos_id_text_size_body2')
...
按钮选中态的字体粗细。默认值：FontWeight.Medium。
