...
> **说明：**
> 
> 该参数支持[!!](../../../ui/state-management/arkts-new-binding.md#系统组件参数双向绑定)双向绑定变量。绑定后组件高度断点值变化时， &gt; heightBreakpoint绑定的变量值会自动更新。
...
> **说明：**
> 
> 该参数支持[!!](../../../ui/state-management/arkts-new-binding.md#系统组件参数双向绑定)双向绑定变量。绑定后组件宽度断点值变化时， &gt; widthBreakpoint绑定的变量值会自动更新。
