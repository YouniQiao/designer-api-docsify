...
**类型：** [ModifierKeyStateGetter](arkts-modifierkeystategetter-t.md)
...
**类型：** [SourceType](arkts-common-sourcetype-e.md)
...
**类型：** [SourceTool](arkts-common-sourcetool-e.md)
...
**类型：** [EventTarget](arkts-common-eventtarget-i.md)
