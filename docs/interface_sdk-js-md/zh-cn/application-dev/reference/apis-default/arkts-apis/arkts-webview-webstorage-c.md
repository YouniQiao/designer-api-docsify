...
| --- | --- | --- | --- |
| origin | string | 是 | The origin which to be inquired. |
| callback | [AsyncCallback](../../apis-basic-services-kit/arkts-apis/arkts-basicservices-base-asynccallback-i.md)&lt;double&gt; | 是 | the callback of getOriginQuota. |
...
| --- | --- | --- | --- |
| origin | string | 是 | The origin which to be inquired. |
| callback | [AsyncCallback](../../apis-basic-services-kit/arkts-apis/arkts-basicservices-base-asynccallback-i.md)&lt;double&gt; | 是 | the callback of getOriginUsage. |
