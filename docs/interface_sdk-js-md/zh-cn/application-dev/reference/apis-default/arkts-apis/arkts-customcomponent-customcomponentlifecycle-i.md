...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| observer | [CustomComponentLifecycleObserver](arkts-customcomponent-customcomponentlifecycleobserver-i.md) | 是 | 监听自定义组件的监听器。 |
...
| 类型 | 说明 |
| --- | --- |
| [CustomComponentLifecycleState](arkts-customcomponent-customcomponentlifecyclestate-e.md) | 自定义组件当前的生命周期状态。 |
