...
文件可读流，需要先通过[fileIo.createReadStream](arkts-fileio-createreadstream-f.md)方法来构建一个ReadStream实例。ReadStream继承自数据流基类 [stream.Readable](../../apis-arkts/arkts-apis/arkts-arkts-stream-readable-c.md)。
