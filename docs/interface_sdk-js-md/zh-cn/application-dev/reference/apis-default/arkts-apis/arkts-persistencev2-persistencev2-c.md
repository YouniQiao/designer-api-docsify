...
| defaultCreator | [StorageDefaultCreator](arkts-storagedefaultcreator-t.md)&lt;T&gt; | 否 | the function generating the default value |
| connectOptions | [BaseConnectOptions](arkts-persistencev2-baseconnectoptions-i.md)&lt;T&gt; | 否 | additional connect options. |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| params | [ConnectOptions](arkts-persistencev2-connectoptions-i.md)&lt;T&gt; | 是 | application-level storage parameters. |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | [PersistenceErrorCallback](arkts-persistenceerrorcallback-t.md) \| undefined | 是 | 持久化失败时调用。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| keyOrType | string \| [Class](../../apis-arkts/arkts-apis/arkts-arkts-class-c.md) | 是 | 需要删除的key。如果传入的是Class类型，则删除的key为Class类型入参的name。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| keyOrType | string \| [Class](../../apis-arkts/arkts-apis/arkts-arkts-class-c.md) | 是 | 需要持久化的key；如果指定的是Class类型，持久化的key为Class的name。 |
