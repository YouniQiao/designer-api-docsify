...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| predicate | (value: bigint, index: number, array: BigUint64Array) =&gt; boolean | 是 |  |
| thisArg | any | 否 |  |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| predicate | (value: bigint, index: number, array: BigUint64Array) =&gt; any | 是 |  |
| thisArg | any | 否 |  |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callbackfn | (value: bigint, index: number, array: BigUint64Array) =&gt; void | 是 |  |
| thisArg | any | 否 |  |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callbackfn | (value: bigint, index: number, array: BigUint64Array) =&gt; bigint | 是 |  |
| thisArg | any | 否 |  |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callbackfn | (previousValue: bigint, currentValue: bigint, currentIndex: number, array: BigUint64Array) =&gt; bigint | 是 |  |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callbackfn | (previousValue: U, currentValue: bigint, currentIndex: number, array: BigUint64Array) =&gt; U | 是 |  |
| initialValue | U | 是 |  |
