...
支持通过传入PixelMap创建PixelMapDrawableDescriptor对象。继承自[DrawableDescriptor](arkts-arkui-drawabledescriptor-drawabledescriptorloadedresult-i.md)。

@extends DrawableDescriptor

**继承/实现关系：** PixelMapDrawableDescriptor extends [DrawableDescriptor](arkts-arkui-drawabledescriptor-drawabledescriptor-c.md)
