...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| controller | [ArcSwiperController](../../apis-arkui/arkts-apis/arkts-arkui-arkui-arcswiper-arcswipercontroller-c.md) | 否 | 给组件绑定一个控制器，用来控制组件翻页。 |
...
| 类型 | 说明 |
| --- | --- |
| [ArcSwiperAttribute](../../apis-arkui/arkts-apis/arkts-arkui-arkui-arcswiper-arcswiperattribute-c.md) |  |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| style_ | CustomBuilderT&lt;[ArcSwiperAttribute](../../apis-arkui/arkts-apis/arkts-arkui-arkui-arcswiper-arcswiperattribute-c.md)&gt; | 是 | arcSwiper属性实例 |
