...
> **说明：**
> 
> 日志收集成功时，必须在应用的EnterpriseAdminExtensionAbility中访问沙箱目录（/data/edm/log）获取日志，获取日志方式参考下列示例代码。应用取走日志后，建议调用 &gt; [systemManager.finishLogCollected](../../apis-mdm-kit/arkts-apis/arkts-mdm-systemmanager-finishlogcollected-f.md)删除已收集到的日 &gt; 志。
