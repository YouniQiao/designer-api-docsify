...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| init | [CompatibleInitCallback](arkts-compatibleinitcallback-t.md) | 是 | 初始化占位组件的回调函数。 |
| update | [CompatibleUpdateCallback](arkts-compatibleupdatecallback-t.md) | 是 | 更新占位组件的回调函数。 |
| component | [ExtendableComponent](arkts-extendablecomponent-extendablecomponent-c.md) | 否 | 当前ArkTS-Sta自定义组件。 |
