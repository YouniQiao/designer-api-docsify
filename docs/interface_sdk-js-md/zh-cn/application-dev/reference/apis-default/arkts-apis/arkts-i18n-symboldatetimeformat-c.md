...
**继承/实现关系：** SymbolDateTimeFormat extends Intl.DateTimeFormat
...
| options | [SymbolDateTimeFormatOptions](arkts-i18n-symboldatetimeformatoptions-i.md) | 否 | 自定义符号时间日期格式化的配置项。默认值：区域对象默认的符号。 |
...
| 类型 | 说明 |
| --- | --- |
| [ResolvedSymbolDateTimeFormatOptions](arkts-i18n-resolvedsymboldatetimeformatoptions-i.md) | 自定义符号时间日期格式化对象配置项的解析结果。 |
