...
若取值为[LINK](arkts-app-ability-insightintentdecorator-linkparamcategory-e.md)，系统获取paramName对应的映射名称，并以键值对形式拼接到URI末尾。若取值为[WANT](arkts-app-ability-insightintentdecorator-linkparamcategory-e.md)， 系统获取paramName对应的映射名称及其取值，通过[Want](../../apis-ability-kit/arkts-apis/arkts-ability-app-ability-want-want-c.md)的parameters字段传递。

**类型：** [LinkParamCategory](arkts-app-ability-insightintentdecorator-linkparamcategory-e.md)
