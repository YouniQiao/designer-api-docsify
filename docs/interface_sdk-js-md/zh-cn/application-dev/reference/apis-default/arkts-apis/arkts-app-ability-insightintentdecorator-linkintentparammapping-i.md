...
若取值为[LINK](../../apis-ability-kit/arkts-apis/arkts-ability-app-ability-insightintentdecorator-linkparamcategory-e.md)，系统获取paramName对应的映射名称，并以键值对形式拼接到URI末尾。若取值为[WANT](../../apis-ability-kit/arkts-apis/arkts-ability-app-ability-insightintentdecorator-linkparamcategory-e.md)， 系统获取paramName对应的映射名称及其取值，通过[Want](../../apis-ability-kit/arkts-apis/arkts-ability-app-ability-want-want-c.md)的parameters字段传递。
