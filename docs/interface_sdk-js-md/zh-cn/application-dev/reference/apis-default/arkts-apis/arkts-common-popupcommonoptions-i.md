...
**类型：** [BlurStyle](arkts-common-blurstyle-e.md)
...
**类型：** [BackgroundBlurStyleOptions](arkts-common-backgroundblurstyleoptions-i.md)
...
**类型：** [BackgroundEffectOptions](arkts-common-backgroundeffectoptions-i.md)
...
**类型：** [PopupBorderLinearGradient](arkts-common-popupborderlineargradient-i.md)
...
**类型：** [AnchoredColorMode](arkts-common-anchoredcolormode-e.md)
...
**类型：** boolean \| [PopupMaskType](arkts-common-popupmasktype-i.md)
...
**类型：** [PopupStateChangeCallback](arkts-popupstatechangecallback-t.md)
...
**类型：** [ShadowOptions](arkts-common-shadowoptions-i.md) \| [ShadowStyle](arkts-common-shadowstyle-e.md)
...
**类型：** [SystemUiMaterial](arkts-systemuimaterial-t-sys.md)
...
**类型：** [TransitionEffect](arkts-common-transitioneffect-c.md)
