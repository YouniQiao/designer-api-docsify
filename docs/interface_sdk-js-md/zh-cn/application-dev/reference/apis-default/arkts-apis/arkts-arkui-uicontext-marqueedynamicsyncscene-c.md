...
**继承/实现关系：** MarqueeDynamicSyncScene extends [DynamicSyncScene](arkts-arkui-uicontext-dynamicsyncscene-c.md)
...
**类型：** [MarqueeDynamicSyncSceneType](arkts-arkui-uicontext-marqueedynamicsyncscenetype-e.md)
