...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| transition | [ArcSwiperContentAnimatedTransition](arkts-arkuiarcswiper-arcswipercontentanimatedtransition-i.md) \| undefined | 是 |  |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| style | [ArcDotIndicator](arkts-arkuiarcswiper-arcdotindicator-c.md) \| boolean \| undefined | 是 |  |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| controller | [ArcSwiperController](arkts-arkuiarcswiper-arcswipercontroller-c.md) | 否 |  |
