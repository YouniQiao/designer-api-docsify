...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| unifiedData | [UnifiedData](arkts-unifieddata-t.md) | 是 | dragData. |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| dataLoadParams | [DataLoadParams](arkts-dataloadparams-t.md) | 是 | The data backend representation. |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| dragResult | [DragResult](arkts-common-dragresult-e.md) | 是 | the return of dragEvent. |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| options | [DataSyncOptions](arkts-datasyncoptions-t.md) | 是 | the data sync options. |
...
**类型：** [DragBehavior](arkts-common-dragbehavior-e.md)
