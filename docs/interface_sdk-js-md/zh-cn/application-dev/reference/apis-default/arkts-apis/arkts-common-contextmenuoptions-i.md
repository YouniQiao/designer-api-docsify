...
**类型：** [AvailableLayoutArea](arkts-common-availablelayoutarea-e.md)
...
**类型：** [MenuGridStyleOptions](arkts-common-menugridstyleoptions-i.md)
...
**类型：** [HapticFeedbackMode](arkts-common-hapticfeedbackmode-e.md)
...
**类型：** [MenuKeyboardAvoidMode](arkts-common-menukeyboardavoidmode-e.md)
...
**类型：** boolean \| [MenuMaskType](arkts-common-menumasktype-i.md)
...
**类型：** [ModalMode](arkts-common-modalmode-e.md)
...
**类型：** [MenuPreviewMode](arkts-common-menupreviewmode-e.md) \| [CustomBuilder](arkts-custombuilder-t.md)
...
**类型：** [ContextMenuAnimationOptions](arkts-common-contextmenuanimationoptions-i.md)
...
**类型：** [BorderRadiusType](arkts-borderradiustype-t.md)
...
**类型：** [PreviewScaleMode](arkts-common-previewscalemode-e.md)
