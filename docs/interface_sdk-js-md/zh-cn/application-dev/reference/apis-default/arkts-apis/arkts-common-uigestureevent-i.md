...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| gesture | [GestureHandler](../../apis-arkui/arkts-apis/arkts-arkui-gesturehandler-c.md) | 是 | gesture indicates the gesture bound to a component. |
| priority | [GesturePriority](../../apis-arkui/arkts-apis/arkts-arkui-gesturepriority-e.md) | 否 | priority indicates the gesture's priority. |
| mask | [GestureMask](../../apis-arkui/arkts-apis/arkts-arkui-gesturemask-e.md) | 否 | mask indicates the gesture's GestureMask value. |
