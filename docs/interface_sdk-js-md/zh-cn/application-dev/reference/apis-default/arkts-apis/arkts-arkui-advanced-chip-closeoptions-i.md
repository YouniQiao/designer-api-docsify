...
继承于[AccessibilityOptions](arkts-arkui-advanced-chip-accessibilityoptions-i.md)。

**继承/实现关系：** CloseOptions extends [AccessibilityOptions](arkts-arkui-advanced-chip-accessibilityoptions-i.md)
