...
CloseOptions用于定义Chip组件默认的关闭图标功能属性，包括无障碍功能属性，其中accessibilityText默认为"删除"。继承于[AccessibilityOptions](../../apis-arkui/arkts-apis/arkts-arkui-arkui-advanced-chip-accessibilityoptions-i.md)。
