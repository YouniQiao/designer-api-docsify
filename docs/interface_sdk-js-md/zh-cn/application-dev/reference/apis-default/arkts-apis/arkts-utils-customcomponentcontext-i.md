...
| 类型 | 说明 |
| --- | --- |
| [IReusePool](arkts-utils-ireusepool-i.md) \| undefined | Returns the recyclepool instance. |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| active | [ActiveAndInactiveCallbackType](arkts-activeandinactivecallbacktype-t.md) | 否 | 激活函数回调 默认值： 默认值：undefined。 |
| inactive | [ActiveAndInactiveCallbackType](arkts-activeandinactivecallbacktype-t.md) | 否 | in激活函数回调 默认值： 默认值：undefined。 |
