...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| type | [GestureListenerType](arkts-arkui-uicontext-gesturelistenertype-e.md) | 是 | 要监听的手势类型 |
| option | [GestureObserverConfigs](arkts-arkui-uicontext-gestureobserverconfigs-i.md) | 是 | 全局监听的选项 |
| callback | [GestureListenerCallback](arkts-gesturelistenercallback-t.md) | 是 | 监听回调函数 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | [PanListenerCallback](arkts-panlistenercallback-t.md) | 否 | 要移除的回调函数。如果未提供该参数，则将移除给定事件类型的所有回调函数。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | [ClickEventListenerCallback](arkts-clickeventlistenercallback-t.md) | 否 | 要移除的回调函数。如果未提供该参数，则将移除给定事件类型的所有回调函数。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | [GestureEventListenerCallback](arkts-gestureeventlistenercallback-t.md) | 否 | 要移除的回调函数。如果未提供该参数，则将移除给定事件类型的所有回调函数。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| nodeIdentity | [NodeIdentity](arkts-nodeidentity-t.md) | 是 | The identity of the target node |
| callback | [NodeRenderStateChangeCallback](arkts-noderenderstatechangecallback-t.md) | 否 | 要移除的回调函数。如果未提供该参数，则将移除给定事件类型的所有回调函数。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | [Callback](../../apis-basic-services-kit/arkts-apis/arkts-basicservices-base-callback-i.md)&lt;[SwiperContentInfo](arkts-arkui-uicontext-swipercontentinfo-i.md)&gt; | 否 | 需要被注销的回调函数。不传参数时，取消该Swiper上所有的监听回调。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | [PanListenerCallback](arkts-panlistenercallback-t.md) | 是 | 无感监听回调函数 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | [PanListenerCallback](arkts-panlistenercallback-t.md) | 是 | 滑动手势无感监听回调函数 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | [PanListenerCallback](arkts-panlistenercallback-t.md) | 是 | 监听滑动手势事件的无感监听回调函数 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | [ClickEventListenerCallback](arkts-clickeventlistenercallback-t.md) | 是 | 无感监听回调函数 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | [GestureEventListenerCallback](arkts-gestureeventlistenercallback-t.md) | 是 | 注册无感监听回调函数 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| nodeIdentity | [NodeIdentity](arkts-nodeidentity-t.md) | 是 | 目标节点的标识 |
| callback | [NodeRenderStateChangeCallback](arkts-noderenderstatechangecallback-t.md) | 是 | 当组件节点的渲染状态发生变化时执行的回调函数 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | [Callback](../../apis-basic-services-kit/arkts-apis/arkts-basicservices-base-callback-i.md)&lt;[SwiperContentInfo](arkts-arkui-uicontext-swipercontentinfo-i.md)&gt; | 是 | 回调函数。携带SwiperContentInfo，返回Swiper内容切换的信息。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | [ClickEventListenerCallback](arkts-clickeventlistenercallback-t.md) | 是 | 点击事件触发时的回调函数 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | [GestureEventListenerCallback](arkts-gestureeventlistenercallback-t.md) | 是 | 无感监听回调函数 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | [Callback](../../apis-basic-services-kit/arkts-apis/arkts-basicservices-base-callback-i.md)&lt;observer.WindowSizeLayoutBreakpointInfo&gt; | 是 | 当窗口大小布局断点更改时调用的回调函数。回调函数接收到一个包含当前宽度和高度断点类型的[WindowSizeLayoutBreakpointInfo](../../apis-arkui/arkts-apis/arkts-arkui-uiobserver-windowsizelayoutbreakpointinfo-c.md)对象。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| type | [GestureListenerType](arkts-arkui-uicontext-gesturelistenertype-e.md) | 是 | 要监听的事件类型 |
| callback | [GestureListenerCallback](arkts-gesturelistenercallback-t.md) | 否 | 要移除的回调函数。如果未提供该参数，则将移除给定事件类型的所有回调函数。 |
