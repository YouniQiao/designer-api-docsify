...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| params | [ComposeTitleBarV2MenuItemParams](../../apis-arkui/arkts-apis/arkts-arkui-arkuiadvancedcomposetitlebarv2-composetitlebarv2menuitemparams-i.md) | 否 | 菜单项参数对象。 |
