...
继承自[AlertDialogParam](arkts-alertdialog-alertdialogparam-i.md)。

**继承/实现关系：** AlertDialogParamWithButtons extends [AlertDialogParam](arkts-alertdialog-alertdialogparam-i.md)
...
**类型：** [AlertDialogButtonBaseOptions](arkts-alertdialog-alertdialogbuttonbaseoptions-i.md)
