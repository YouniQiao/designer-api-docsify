...
<!--Device-unnamed-export declare interface PickerDialogButtonStyle--><!--Device-unnamed-export declare interface PickerDialogButtonStyle-End-->
...
**类型：** [Length](../../apis-arkui/arkts-apis/arkts-arkui-length-t.md) \| [BorderRadiuses](../../apis-arkui/arkts-apis/arkts-arkui-borderradiuses-t.md)
...
```TypeScript
fontWeight?: FontWeight | int | string
```
...
<!--Device-PickerDialogButtonStyle-fontWeight?: FontWeight | int | string--><!--Device-PickerDialogButtonStyle-fontWeight?: FontWeight | int | string-End-->
...
**类型：** [ButtonRole](../../apis-arkui/arkts-components/arkts-arkui-buttonrole-e.md)
...
**类型：** [ButtonStyleMode](../../apis-arkui/arkts-components/arkts-arkui-buttonstylemode-e.md)
...
**类型：** [ButtonType](../../apis-arkui/arkts-components/arkts-arkui-buttontype-e.md)
