...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| options | [EditableTitleBarMenuItemV2Options](../../apis-arkui/arkts-apis/arkts-arkui-arkuiadvancededitabletitlebarv2-editabletitlebarmenuitemv2options-i.md) | 否 | 菜单项配置选项。 |
