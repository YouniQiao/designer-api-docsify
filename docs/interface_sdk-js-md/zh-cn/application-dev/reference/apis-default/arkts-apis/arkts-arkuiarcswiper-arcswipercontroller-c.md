...
翻至下一页。翻页带动效切换过程，时长通过[duration](arkts-arkuiarcswiper-arcswiperattribute-i.md#duration)指定。
...
翻至上一页。翻页带动效切换过程，时长通过[duration](arkts-arkuiarcswiper-arcswiperattribute-i.md#duration)指定。
