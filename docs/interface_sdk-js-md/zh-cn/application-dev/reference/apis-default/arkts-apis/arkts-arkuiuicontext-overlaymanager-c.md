...
> - 以下API需先使用UIContext中的[getOverlayManager()](arkts-arkuiuicontext-uicontext-c.md#getoverlaymanager)方法获取到
...
| options | [OrderOverlayOptions](arkts-arkuiuicontext-orderoverlayoptions-i.md) | 否 | Options for the overlay. |
