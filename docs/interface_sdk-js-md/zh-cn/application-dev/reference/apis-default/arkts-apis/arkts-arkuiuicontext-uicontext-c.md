...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | [AnimateParam](arkts-common-animateparam-i.md) | 是 | parameters for animation. |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| param | [AnimateParam](arkts-common-animateparam-i.md) | 是 | 设置动画效果相关参数 |
| processor | [VoidCallback](arkts-voidcallback-t.md) | 是 | 指定显示动画的处理函数，在该函数中导致的状态变化系统会自动插入过渡动画。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| tabsController | [TabsController](../arkts-components/arkts-tabs-tabscontroller-c.md) | 是 | The controller of the tabs. |
| parentScroller | [Scroller](../arkts-components/arkts-scroll-scroller-c.md) | 是 | The controller of the parent scrollable container component. |
| childScroller | [Scroller](../arkts-components/arkts-scroll-scroller-c.md) | 是 | The controller of the child scrollable container component. |
...
| --- | --- | --- | --- |
| tabsController | [TabsController](../arkts-components/arkts-tabs-tabscontroller-c.md) | 是 | The controller of the tabs. |
| scroller | [Scroller](../arkts-components/arkts-scroll-scroller-c.md) | 是 | The controller of the scrollable container component. |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| bindSheetContent | [ComponentContentBase](arkts-componentcontent-componentcontentbase-c.md) | 是 | BindSheet半模态的内容 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| options | [AnimatorOptions](../../apis-arkui/arkts-apis/arkts-arkui-animator-animatoroptions-i.md) \| [SimpleAnimatorOptions](../../apis-arkui/arkts-apis/arkts-arkui-animator-simpleanimatoroptions-c.md) | 是 | Options. |
...
| 类型 | 说明 |
| --- | --- |
| [UIContext](arkts-arkuiuicontext-uicontext-c.md) \| undefined | object UIContext, or undefined when failed. |
...
| event | [KeyEvent](arkts-common-keyevent-i.md) | 是 | The keyboard event. |
...
| eventType | [RawInputEventType](arkts-enums-rawinputeventtype-e.md) | 是 | 原始输入事件的类型。 |
...
| 类型 | 说明 |
| --- | --- |
| [UIContext](arkts-arkuiuicontext-uicontext-c.md)[] | An array containing all valid UIContext instances, returns an empty array if no contexts are available. |
...
| 类型 | 说明 |
| --- | --- |
| [Nullable](arkts-nullable-t.md)&lt;[AtomicServiceBar](arkts-arkuiuicontext-atomicservicebar-i.md)&gt; | The atomic service bar. |
...
| 类型 | 说明 |
| --- | --- |
| [UIContext](arkts-arkuiuicontext-uicontext-c.md) \| undefined | The UIContext for the current calling scope, or undefined if no context can be determined from the call stack. |
...
| 类型 | 说明 |
| --- | --- |
| [ComponentSnapshot](arkts-arkuiuicontext-componentsnapshot-c.md) | the ComponentSnapshot |
...
| 类型 | 说明 |
| --- | --- |
| [ComponentUtils](arkts-arkuiuicontext-componentutils-c.md) | object ComponentUtils. |
...
| 类型 | 说明 |
| --- | --- |
| [ContextMenuController](arkts-arkuiuicontext-contextmenucontroller-c.md) | object context menu controller. |
...
| 类型 | 说明 |
| --- | --- |
| [CursorController](arkts-arkuiuicontext-cursorcontroller-c.md) | object cursor controller. |
...
| 类型 | 说明 |
| --- | --- |
| [DialogPresenter](arkts-arkuiuicontext-dialogpresenter-c.md) | Dialog object. |
...
| 类型 | 说明 |
| --- | --- |
| [DragController](arkts-arkuiuicontext-dragcontroller-c.md) | the DragController |
...
| 错误码ID | 错误信息 |
| --- | --- |
| [100023](../../apis-arkui/errorcode-node.md#100023-参数错误) | Unable to obtain current ui context. |
...
| --- | --- |
| [100023](../../apis-arkui/errorcode-node.md#100023-参数错误) | Unable to obtain current ui context. |
| [100024](../../apis-arkui/errorcode-node.md#100024-节点没有公共祖先节点) | The parameter depth must be greater than 0. |
...
| 类型 | 说明 |
| --- | --- |
| [FocusController](arkts-arkuiuicontext-focuscontroller-c.md) | the FocusController |
...
| 类型 | 说明 |
| --- | --- |
| [Font](arkts-arkuiuicontext-font-c.md) | object Font. |
...
| 类型 | 说明 |
| --- | --- |
| [KeyboardAvoidMode](arkts-arkuiuicontext-keyboardavoidmode-e.md) | The mode of keyboard avoid. |
...
| 类型 | 说明 |
| --- | --- |
| [UIContext](arkts-arkuiuicontext-uicontext-c.md) \| undefined | The UIContext of the last focused UI instance or undefined if no one exists. |
...
| 类型 | 说明 |
| --- | --- |
| [UIContext](arkts-arkuiuicontext-uicontext-c.md) \| undefined | The UIContext of the last foregrounded UI instance or undefined if no one exists |
...
| 类型 | 说明 |
| --- | --- |
| [Magnifier](arkts-arkuiuicontext-magnifier-c.md) | Magnifier instance obtained. |
...
| 类型 | 说明 |
| --- | --- |
| [MeasureUtils](arkts-arkuiuicontext-measureutils-c.md) | the MeasureUtils |
...
| 类型 | 说明 |
| --- | --- |
| [MediaQuery](arkts-arkuiuicontext-mediaquery-c.md) | object MediaQuery. |
...
| 类型 | 说明 |
| --- | --- |
| [OverlayManager](arkts-arkuiuicontext-overlaymanager-c.md) | object OverlayManager. |
...
| 类型 | 说明 |
| --- | --- |
| [OverlayManagerOptions](arkts-arkuiuicontext-overlaymanageroptions-i.md) | object OverlayManagerOptions. |
...
| 类型 | 说明 |
| --- | --- |
| [PageInfo](arkts-arkuiuicontext-pageinfo-i.md) | The page information of the frameNode with the target uniqueId, includes navDestination and router page information. If the frame node does not have navDestination and router page information, it will return an empty object. |
...
| 错误码ID | 错误信息 |
| --- | --- |
| [120007](../../apis-arkui/errorcode-uicontext.md#120007-实例不存在) | The UIContext is not available. |
...
| 类型 | 说明 |
| --- | --- |
| [PixelRoundMode](arkts-enums-pixelroundmode-e.md) | the mode of pixel round. |
...
| 类型 | 说明 |
| --- | --- |
| [PromptAction](arkts-arkuiuicontext-promptaction-c.md) | object PromptAction. |
...
| 类型 | 说明 |
| --- | --- |
| [Router](arkts-arkuiuicontext-router-c.md) | object Router. |
...
| 类型 | 说明 |
| --- | --- |
| [LocalStorage](arkts-localstorage-localstorage-c.md) \| undefined |  |
...
| 类型 | 说明 |
| --- | --- |
| [SmartGestureController](arkts-arkuiuicontext-smartgesturecontroller-c.md) | object smart gesture controller. |
...
| 类型 | 说明 |
| --- | --- |
| [TextMenuController](arkts-arkuiuicontext-textmenucontroller-c.md) | object text menu controller. |
...
| 类型 | 说明 |
| --- | --- |
| [UIInspector](arkts-arkuiuicontext-uiinspector-c.md) | 返回UIInspector实例对象。 |
...
| 类型 | 说明 |
| --- | --- |
| [UIObserver](arkts-arkuiuicontext-uiobserver-c.md) | The UI observer. |
...
| 类型 | 说明 |
| --- | --- |
| [HeightBreakpoint](arkts-enums-heightbreakpoint-e.md) | The height breakpoint of current window. |
...
| 类型 | 说明 |
| --- | --- |
| [WidthBreakpoint](arkts-enums-widthbreakpoint-e.md) | The width breakpoint of current window. |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| param | [KeyframeAnimateParam](arkts-common-keyframeanimateparam-i.md) | 是 | overall animation parameters |
| keyframes | Array&lt;[KeyframeState](arkts-common-keyframestate-i.md)&gt; | 是 | all keyframe states |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| bindSheetContent | [ComponentContentBase](arkts-componentcontent-componentcontentbase-c.md) | 是 | The content of BindSheet. |
| sheetOptions | [SheetOptions](arkts-common-sheetoptions-i.md) | 否 | The options of sheet. |
...
| [120006](../../apis-arkui/errorcode-bindSheet.md#120006-指定的targetid对应的节点并不是page节点或navdestination节点的子节点) | The node of targetId is not a child of the page node or NavDestination node. |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| frameCallback | [FrameCallback](arkts-arkuiuicontext-framecallback-c.md) | 是 | The frame callback to run on the next frame. |
...
| 类型 | 说明 |
| --- | --- |
| Array&lt;[DynamicSyncScene](arkts-arkuiuicontext-dynamicsyncscene-c.md)&gt; | The instance of SwiperDynamicSyncScene. |
...
| 类型 | 说明 |
| --- | --- |
| [ResolvedUIContext](arkts-arkuiuicontext-resolveduicontext-c.md) | ResolvedUIContext实例 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| feature | [CustomKeyboardContinueFeature](arkts-arkuiuicontext-customkeyboardcontinuefeature-e.md) | 是 | 自定义键盘接续特性。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | [KeyboardAvoidMode](arkts-arkuiuicontext-keyboardavoidmode-e.md) | 是 | The mode of keyboard avoid. |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| options | [OverlayManagerOptions](arkts-arkuiuicontext-overlaymanageroptions-i.md) | 是 | Options. |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| mode | [PixelRoundMode](arkts-enums-pixelroundmode-e.md) | 是 | The mode of pixel round. |
...
| 错误码ID | 错误信息 |
| --- | --- |
| [100101](../../apis-arkui/errorcode-uicontext.md#100101-小于0的非法值) | The parameter is less than 0. |
| [100102](../../apis-arkui/errorcode-uicontext.md#100102-参数类型错误) | The parameter value cannot be a floating-point number. |
| [100103](../../apis-arkui/errorcode-uicontext.md#100103-调用线程错误) | The function cannot be called from a non-main thread. @static |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| policy | [TextSelectionClearPolicy](arkts-arkuiuicontext-textselectionclearpolicy-e.md) | 是 | 文本选择清除策略。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | [VoidCallback](arkts-voidcallback-t.md) | 是 | 在UI线程中执行的回调函数。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | [ActionSheetOptions](arkts-actionsheet-actionsheetoptions-i.md) | 是 | Options. |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| options | [AlertDialogParamWithConfirm](arkts-alertdialog-alertdialogparamwithconfirm-i.md) \| [AlertDialogParamWithButtons](arkts-alertdialog-alertdialogparamwithbuttons-i.md) \| [AlertDialogParamWithOptions](arkts-alertdialog-alertdialogparamwithoptions-i.md) | 是 | Options. |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| options | [DatePickerDialogOptions](../arkts-components/arkts-datepicker-datepickerdialogoptions-i.md) | 是 | Options. |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| style | [TextPickerDialogOptions](../arkts-components/arkts-textpicker-textpickerdialogoptions-i.md) \| TextPickerDialogOptionsExt | 是 | Dialog style. |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| options | [TimePickerDialogOptions](../arkts-components/arkts-timepicker-timepickerdialogoptions-i.md) | 是 | Options. |
...
| --- | --- | --- | --- |
| bindSheetContent | [ComponentContentBase](arkts-componentcontent-componentcontentbase-c.md) | 是 | The content of BindSheet. |
| sheetOptions | [SheetOptions](arkts-common-sheetoptions-i.md) | 是 | The update options of sheet. |
