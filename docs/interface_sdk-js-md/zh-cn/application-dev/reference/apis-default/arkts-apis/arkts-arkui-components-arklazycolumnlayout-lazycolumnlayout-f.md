...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| style_ | [CustomBuilderT](arkts-custombuildert-t.md)&lt;[LazyColumnLayoutAttribute](../../apis-arkui/arkts-apis/arkts-arkui-arkui-components-arklazycolumnlayout-lazycolumnlayoutattribute-c.md)&gt; | 是 | The style to create a LazyColumnLayout. |
| content_ | [CustomBuilder](arkts-custombuilder-t.md) | 否 |  |
