...
[AppServiceExtensionAbility](../../../reference/apis-ability-kit/js-apis-app-ability-appServiceExtensionAbility.md)的上下文环境，继承自[ExtensionContext](../../apis-ability-kit/arkts-apis/arkts-ability-extensioncontext-c.md#ExtensionContext)。
...
**继承/实现关系：** AppServiceExtensionContext extends [ExtensionContext](ExtensionContext)
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| connection | ArkTS-Dyn: number  <br>ArkTS-Sta：long | 是 | 在 [connectServiceExtensionAbility](#connectServiceExtensionAbility)中返回的连接id。 |
