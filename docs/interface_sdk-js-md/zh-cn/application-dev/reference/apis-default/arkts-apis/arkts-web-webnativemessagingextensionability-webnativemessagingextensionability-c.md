...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| info | [ConnectionInfo](arkts-web-webnativemessagingextensionability-connectioninfo-i.md) | 是 | 连接信息对象。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| info | [ConnectionInfo](arkts-web-webnativemessagingextensionability-connectioninfo-i.md) | 是 | Indicates connection information about new native connection. |
...
**类型：** [WebNativeMessagingExtensionContext](arkts-web-webnativemessagingextensioncontext-webnativemessagingextensioncontext-c.md)
