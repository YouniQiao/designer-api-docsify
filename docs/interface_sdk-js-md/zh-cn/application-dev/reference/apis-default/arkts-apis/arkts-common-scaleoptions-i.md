...
> **说明：**
> 
> 当组件同时设置了[rotate](arkts-common-commonmethod-i.md#rotate)和[scale](arkts-common-commonmethod-i.md#scale)属性时，centerX和centerY的取值会发生冲突，此时centerX和 &gt; centerY的值以最后设定的属性的值为准。
