...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| options | [ArcSliderOptionsConstructorOptions](arkts-arkuiadvancedarcslider-arcslideroptionsconstructoroptions-i.md) | 否 | ArcSliderOptions的构造信息。 |
...
默认值：[ArcSliderStyleOptions](arkts-arkuiadvancedarcslider-arcsliderstyleoptions-c.md)的各项子属性均取其默认值。

**类型：** [ArcSliderLayoutOptions](arkts-arkuiadvancedarcslider-arcsliderlayoutoptions-c.md)
...
**类型：** [ArcSliderChangeHandler](arkts-arcsliderchangehandler-t.md)
...
**类型：** [ArcSliderEnlargeHandler](arkts-arcsliderenlargehandler-t.md)
...
**类型：** [ArcSliderTouchHandler](arkts-arcslidertouchhandler-t.md)
...
**类型：** [ArcSliderStyleOptions](arkts-arkuiadvancedarcslider-arcsliderstyleoptions-c.md)
...
**类型：** [ArcSliderValueOptions](arkts-arkuiadvancedarcslider-arcslidervalueoptions-c.md)
