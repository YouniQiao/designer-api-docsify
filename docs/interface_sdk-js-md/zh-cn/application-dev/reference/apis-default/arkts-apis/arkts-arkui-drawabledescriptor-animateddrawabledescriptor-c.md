...
使用Image组件播放PixelMap数组或动图资源时传入 AnimatedDrawableDescriptor对象，该对象继承自[DrawableDescriptor](arkts-arkui-drawabledescriptor-drawabledescriptorloadedresult-i.md)。

@extends DrawableDescriptor

**继承/实现关系：** AnimatedDrawableDescriptor extends [DrawableDescriptor](arkts-arkui-drawabledescriptor-drawabledescriptor-c.md)
...
| options | [AnimationOptions](arkts-arkui-drawabledescriptor-animationoptions-i.md) | 否 | 动画控制选项。 |
...
| options | [AnimationOptions](arkts-arkui-drawabledescriptor-animationoptions-i.md) | 否 | 动画控制参数。 |
...
| 类型 | 说明 |
| --- | --- |
| [AnimationController](arkts-arkui-drawabledescriptor-animationcontroller-i.md) \| undefined | Return the component of animation controller. |
