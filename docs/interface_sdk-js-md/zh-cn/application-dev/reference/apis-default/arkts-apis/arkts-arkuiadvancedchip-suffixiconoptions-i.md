...
继承于[IconCommonOptions](arkts-arkuiadvancedchip-iconcommonoptions-i.md)。

**继承/实现关系：** SuffixIconOptions extends [IconCommonOptions](arkts-arkuiadvancedchip-iconcommonoptions-i.md)
