...
| propertyGetters | Map&lt;string, [BuilderParameterCallback](arkts-builderparametercallback-t.md)&gt; | 是 | getter callbacks for each property name |
| initializer | [Callback](../../apis-basic-services-kit/arkts-apis/arkts-basicservices-base-callback-i.md)&lt;T&gt; | 否 | optional callback to initialize proxied instance |
