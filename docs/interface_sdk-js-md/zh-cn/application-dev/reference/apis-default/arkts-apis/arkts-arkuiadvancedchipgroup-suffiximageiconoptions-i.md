...
继承自[IconOptions](arkts-arkuiadvancedchipgroup-iconoptions-i.md)。

**继承/实现关系：** SuffixImageIconOptions extends [IconOptions](arkts-arkuiadvancedchipgroup-iconoptions-i.md)
