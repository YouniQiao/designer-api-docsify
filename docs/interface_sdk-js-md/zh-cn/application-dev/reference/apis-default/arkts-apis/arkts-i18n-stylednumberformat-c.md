...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| numberFormat | Intl.NumberFormat \| [SimpleNumberFormat](arkts-i18n-simplenumberformat-c.md) | 是 | 用于格式化数字的对象。 |
| options | [StyledNumberFormatOptions](arkts-i18n-stylednumberformatoptions-i.md) | 否 | 指定数字格式化对象的配置项。默认值：默认的文本样式。 |
