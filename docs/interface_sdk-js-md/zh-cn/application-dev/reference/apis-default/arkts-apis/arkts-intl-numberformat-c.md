...
| options | [NumberOptions](arkts-intl-numberoptions-i.md) | 否 | 创建数字格式化对象时可设置的配置项。 <br>默认值：所有属性都取默认值时的配置项。 |
...
| 类型 | 说明 |
| --- | --- |
| [NumberOptions](arkts-intl-numberoptions-i.md) | 创建数字格式化对象时设置的配置项。 |
