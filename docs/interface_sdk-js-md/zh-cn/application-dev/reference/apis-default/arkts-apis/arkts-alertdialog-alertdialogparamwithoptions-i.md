...
**继承/实现关系：** AlertDialogParamWithOptions extends [AlertDialogParam](arkts-alertdialog-alertdialogparam-i.md)
...
**类型：** [DialogButtonDirection](arkts-alertdialog-dialogbuttondirection-e.md)
...
**类型：** Array&lt;[AlertDialogButtonOptions](arkts-alertdialog-alertdialogbuttonoptions-i.md)&gt;
