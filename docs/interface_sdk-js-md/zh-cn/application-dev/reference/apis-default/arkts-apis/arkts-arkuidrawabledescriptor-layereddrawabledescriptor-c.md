...
当传入资源id或name为包含前景和背景资源的json文件时，生成LayeredDrawableDescriptor对象。继承自 [DrawableDescriptor](arkts-arkuidrawabledescriptor-drawabledescriptorloadedresult-i.md)。

drawable.json位于项目工程entry/src/main/resources/base/media目录下。定义请参考：

@extends DrawableDescriptor

**继承/实现关系：** LayeredDrawableDescriptor extends [DrawableDescriptor](arkts-arkuidrawabledescriptor-drawabledescriptor-c.md)
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| foreground | [DrawableDescriptor](arkts-arkuidrawabledescriptor-drawabledescriptor-c.md) | 否 | 分层图标的前景图片选项。 |
| background | [DrawableDescriptor](arkts-arkuidrawabledescriptor-drawabledescriptor-c.md) | 否 | 分层图标的背景图片选项。 |
| mask | [DrawableDescriptor](arkts-arkuidrawabledescriptor-drawabledescriptor-c.md) | 否 | 分层图标的遮罩选项。 |
...
> **说明：**
> 
> DrawableDescriptor对象通过[release](arkts-arkuidrawabledescriptor-drawabledescriptor-c.md#release)释放后，本接口返回undefined。
...
| 类型 | 说明 |
| --- | --- |
| [DrawableDescriptor](arkts-arkuidrawabledescriptor-drawabledescriptor-c.md) \| undefined | Return the DrawableDescriptor object of background. |
...
| 类型 | 说明 |
| --- | --- |
| [DrawableDescriptor](arkts-arkuidrawabledescriptor-drawabledescriptor-c.md) \| undefined | Return the DrawableDescriptor object of foreground. |
...
| 类型 | 说明 |
| --- | --- |
| [DrawableDescriptor](arkts-arkuidrawabledescriptor-drawabledescriptor-c.md) \| undefined | Return the DrawableDescriptor object of mask. |
