...
获取设备的最大值、最小值和当前值，可参考[AudioVolumeGroupManager](../../apis-audio-kit/arkts-apis/arkts-audio-audio-audiovolumegroupmanager-i.md)。
...
**类型：** [AVVolumePanelParameter](arkts-multimedia-avvolumepanel-avvolumepanelparameter-c.md)
