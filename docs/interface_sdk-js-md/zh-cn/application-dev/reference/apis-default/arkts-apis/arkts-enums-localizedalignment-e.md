...
Alignment enumeration description.@enum { string }

**起始版本：** 23

**ArkTS模式：** ArkTS-Sta起始版本为23。

<!--Device-unnamed-export declare enum LocalizedAlignment--><!--Device-unnamed-export declare enum LocalizedAlignment-End-->
