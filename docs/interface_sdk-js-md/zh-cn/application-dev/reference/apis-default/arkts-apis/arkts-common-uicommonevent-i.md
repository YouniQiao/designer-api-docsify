...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | [Callback](arkts-callback-t.md)&lt;[ClickEvent](arkts-common-clickevent-i.md)&gt; \| undefined | 是 | The callback about the click event. If set undefined will reset the target callback. |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | [HoverCallback](arkts-hovercallback-t.md) \| undefined | 是 | The callback will be triggered when has a hover event. If set undefined will reset the target callback. |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | [Callback](arkts-callback-t.md)&lt;[KeyEvent](arkts-common-keyevent-i.md)&gt; \| undefined | 是 | The callback will be triggered when has keyboard input. If set undefined will reset the target callback. |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | [Callback](arkts-callback-t.md)&lt;[MouseEvent](arkts-common-mouseevent-i.md)&gt; \| undefined | 是 | The callback will be triggered when has mouse input. If set undefined will reset the target callback. |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | [SizeChangeCallback](arkts-sizechangecallback-t.md) \| undefined | 是 | The callback will be triggered when the size of component changed. If set undefined will reset the target callback. |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | [Callback](arkts-callback-t.md)&lt;[TouchEvent](arkts-common-touchevent-i.md)&gt; \| undefined | 是 | The callback about the touch event. If set undefined will reset the target callback. |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| options | [VisibleAreaEventOptions](arkts-common-visibleareaeventoptions-i.md) | 是 | The options for the visibility event. |
| event | [VisibleAreaChangeCallback](arkts-visibleareachangecallback-t.md) \| undefined | 是 | The callback will be triggered when the visibleArea of component changed and get close to any number in ratios defined by options. If set undefined will reset the target callback. |
