...
**继承/实现关系：** ReactiveComponentContent extends [ComponentContentBase](arkts-componentcontent-componentcontentbase-c.md)
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| uiContext | [UIContext](arkts-arkui-uicontext-uicontext-c.md) | 是 | 用于创建 ReactiveComponentContent 的 UIContext对象 |
