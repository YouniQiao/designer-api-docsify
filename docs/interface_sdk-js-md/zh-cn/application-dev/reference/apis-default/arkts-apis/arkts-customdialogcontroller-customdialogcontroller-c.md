...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | [CustomDialogControllerOptions](arkts-customdialogcontroller-customdialogcontrolleroptions-i.md) | 是 |  |
...
| 类型 | 说明 |
| --- | --- |
| [CustomDialogControllerExternalOptions](arkts-customdialogcontroller-customdialogcontrollerexternaloptions-i.md) | 返回自定义弹窗的外部选项。 |
...
| 类型 | 说明 |
| --- | --- |
| [PromptActionCommonState](arkts-promptactioncommonstate-t.md) | 返回对应的弹窗状态。 |
