...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| config | [ChipV2LabelConfig](../../apis-arkui/arkts-apis/arkts-arkui-arkui-advanced-chipv2-chipv2labelconfig-i.md) | 是 | 标签的配置 |
...
**类型：** [ChipV2LabelMarginConfig](../../apis-arkui/arkts-apis/arkts-arkui-arkui-advanced-chipv2-chipv2labelmarginconfig-i.md)
...
**类型：** [ChipV2LocalizedLabelMarginConfig](../../apis-arkui/arkts-apis/arkts-arkui-arkui-advanced-chipv2-chipv2localizedlabelmarginconfig-i.md)
