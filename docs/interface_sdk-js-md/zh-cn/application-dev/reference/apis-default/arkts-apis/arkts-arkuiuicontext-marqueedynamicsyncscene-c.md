...
**继承/实现关系：** MarqueeDynamicSyncScene extends [DynamicSyncScene](arkts-arkuiuicontext-dynamicsyncscene-c.md)
...
**类型：** [MarqueeDynamicSyncSceneType](arkts-arkuiuicontext-marqueedynamicsyncscenetype-e.md)
