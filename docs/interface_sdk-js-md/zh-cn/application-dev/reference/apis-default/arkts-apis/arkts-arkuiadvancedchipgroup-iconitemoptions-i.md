...
Chip大小是ChipSize.NORMAL时，suffix默认值：{width: 24,height: 24}。&lt;/br&gt; 如果想动态修改size，那么必须在引入 [IconGroupSuffix](arkts-arkuiadvancedchipgroup-icongroupsuffix-s.md)时，使用 SymbolGlyphModifier 类型。
