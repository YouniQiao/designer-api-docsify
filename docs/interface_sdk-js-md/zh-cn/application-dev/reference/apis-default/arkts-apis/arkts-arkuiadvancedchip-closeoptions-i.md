...
继承于[AccessibilityOptions](arkts-arkuiadvancedchip-accessibilityoptions-i.md)。

**继承/实现关系：** CloseOptions extends [AccessibilityOptions](arkts-arkuiadvancedchip-accessibilityoptions-i.md)
