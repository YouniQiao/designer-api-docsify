...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| options | [OperateCheckV2Options](arkts-arkui-advanced-composelistitemv2-operatecheckv2options-i.md) | 否 | OperateCheckV2的可选项 |
...
**类型：** [OnChangeCallback](arkts-onchangecallback-t.md)
