...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| options | [SubHeaderV2TitleOptions](../../apis-arkui/arkts-apis/arkts-arkui-arkuiadvancedsubheaderv2-subheaderv2titleoptions-i.md) | 是 | 标题内容信息。 |
...
当[SubHeaderV2](../../apis-arkui/arkts-apis/arkts-arkui-arkuiadvancedsubheaderv2-subheaderv2-s.md)中同时使用primaryTitle、secondaryTitle、icon属性时，设置primaryTitle属性不生效。
