...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| handler | Optional&lt;[OnSelectCallback](arkts-onselectcallback-t.md)&gt; | 是 | 回调函数类型。<br>取值为undefined时，无回调。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| info | [ArcAlphabetIndexerInitInfo](arkts-arkui-arcalphabetindexer-arcalphabetindexerinitinfo-i.md) | 是 |  |
