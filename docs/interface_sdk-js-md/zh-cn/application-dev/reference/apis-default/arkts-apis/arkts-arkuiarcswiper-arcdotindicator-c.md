...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| direction | [ArcDirection](arkts-arkuiarcswiper-arcdirection-e.md) \| undefined | 是 | 设置弧形指示器的方向。<br/>取值为undefined时，弧形指示器的方向为6点钟方向。 |

**返回值：**

| 类型 | 说明 |
| --- | --- |
| [ArcDotIndicator](arkts-arkuiarcswiper-arcdotindicator-c.md) | 提供弧形圆点指示器属性及功能。 |
