...
**说明：**
1. 仅上边缘生效：[EffectEdge](arkts-common-effectedge-e.md).START。
2. 仅下边缘生效：[EffectEdge](arkts-common-effectedge-e.md).END。
3. 双边生效：[EffectEdge](arkts-common-effectedge-e.md).START | [EffectEdge](arkts-common-effectedge-e.md).END（即数值3）。
4. 双边不生效：[EffectEdge](arkts-common-effectedge-e.md).START & [EffectEdge](arkts-common-effectedge-e.md).END（即数值0）。
...
3. 使用[openBindSheet](../../apis-arkui/arkts-apis/arkts-arkui-arkui-uicontext-uicontext-c.md#openbindsheet)启动半模态页面，若未传入有效的targetId，则不支持设置为SheetMode.EMBEDDED，默认为SheetMode.OVERLAY。
...
**说明：**: 不同系统材质对应不同的属性影响效果，该接口影响背景色 [backgroundColor](arkts-common-commonmethod-i.md#backgroundcolor)、 边框颜色[borderColor](arkts-common-commonmethod-i.md#bordercolor)、边框宽度[borderWidth](arkts-common-commonmethod-i.md#borderwidth)、阴影 [shadow](arkts-common-commonmethod-i.md#shadow)，不建议与上述接口一起使用。使用示例请参考 示例10（半模态设置系统材质）。
...
**说明：**使用[openBindSheet](../../apis-arkui/arkts-apis/arkts-arkui-arkui-uicontext-uicontext-c.md#openbindsheet)启动的半模态页面，不支持设置 、更新该属性。
