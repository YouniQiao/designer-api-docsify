...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| color | [Nullable](arkts-nullable-t.md)&lt;[Color](arkts-enums-color-e.md) \| int \| string&gt; | 是 | the color to set, undefined indicates using default. |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| color | [Nullable](arkts-nullable-t.md)&lt;[Color](arkts-enums-color-e.md) \| int \| string&gt; | 是 | the color to set to icon, undefined indicates using default. |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| font | [FontStyle](arkts-enums-fontstyle-e.md) | 是 | the font style of the bar's title. |
