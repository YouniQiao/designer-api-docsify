...
继承于[IconCommonOptions](arkts-arkui-advanced-chip-iconcommonoptions-i.md)。

**继承/实现关系：** SuffixIconOptions extends [IconCommonOptions](arkts-arkui-advanced-chip-iconcommonoptions-i.md)
