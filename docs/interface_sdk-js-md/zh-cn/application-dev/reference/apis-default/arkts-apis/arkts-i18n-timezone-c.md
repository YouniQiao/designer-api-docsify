...
| 类型 | 说明 |
| --- | --- |
| [TimeZone](arkts-i18n-timezone-c.md) | 应用使用的默认时区对象。 |
...
| 类型 | 说明 |
| --- | --- |
| [TimeZone](arkts-i18n-timezone-c.md) | 时区城市对应的时区对象。 |
...
| 类型 | 说明 |
| --- | --- |
| Array&lt;[TimeZone](arkts-i18n-timezone-c.md)&gt; | 时区对象数组，数组中对象对应的时区为该地理位置推荐的时区。 |
...
| 类型 | 说明 |
| --- | --- |
| [ZoneRules](arkts-i18n-zonerules-c.md) | 时区跳变规则，包含跳变的时间点、跳变前后的偏移量信息。 |
