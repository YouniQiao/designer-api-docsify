...
文件可写流，需要先通过[fileIo.createWriteStream](arkts-fileio-createwritestream-f.md)方法来构建一个WriteStream实例。WriteStream继承自数据流基类 [stream.Writable](../../apis-arkts/arkts-apis/arkts-arkts-stream-writable-c.md)。
...
| whence | [WhenceType](../../apis-core-file-kit/arkts-apis/arkts-corefile-filefs-whencetype-e.md) | 否 | = WhenceType.SEEK_SET] - Where to start the offset. <br>The default value is SEEK_SET, which indicates the beginning of the file. |
