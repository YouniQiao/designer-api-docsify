...
**继承/实现关系：** IDecoratedV1Variable extends [IDecoratedVariable](arkts-decorator-idecoratedvariable-i.md)
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| decoratedVar | [IDecoratedV1Variable](arkts-decorator-idecoratedv1variable-i.md)&lt;T&gt; | 是 |  |
