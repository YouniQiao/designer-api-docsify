...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| icon | [ResourceStr](../../apis-arkui/arkts-apis/arkts-arkui-resourcestr-t.md) \| [PixelMap](../../apis-arkui/arkts-components/arkts-arkui-pixelmap-t.md) \| [SymbolGlyphModifier](../../apis-arkui/arkts-apis/arkts-arkui-symbolglyphmodifier-c.md) \| undefined | 是 |  |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| scrollInfos | Array&lt;[NestedScrollInfo](arkts-navdestination-nestedscrollinfo-i.md)&gt; \| undefined | 是 |  |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| delegate | [NavDestinationTransitionDelegate](arkts-navdestinationtransitiondelegate-t.md) \| undefined | 是 |  |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| items | Array&lt;[NavigationMenuItem](../../apis-arkui/arkts-components/arkts-arkui-navigationmenuitem-i.md)&gt; \| [CustomBuilder](../arkts-apis/arkts-custombuilder-t.md) \| undefined | 是 |  |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | [NavDestinationMode](arkts-navdestination-navdestinationmode-e.md) \| undefined | 是 |  |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | [Callback](../../apis-arkui/arkts-components/arkts-arkui-callback-i.md)&lt;[NavDestinationActiveReason](arkts-navdestination-navdestinationactivereason-e.md)&gt; \| undefined | 是 |  |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | [Callback](../../apis-arkui/arkts-components/arkts-arkui-callback-i.md)&lt;[VisibilityChangeReason](arkts-navdestination-visibilitychangereason-e.md)&gt; \| undefined | 是 |  |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | [Callback](../../apis-arkui/arkts-components/arkts-arkui-callback-i.md)&lt;[NavDestinationContext](arkts-navdestination-navdestinationcontext-i.md)&gt; \| undefined | 是 |  |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| orientation | [Orientation](arkts-orientation-t.md) \| undefined | 是 |  |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| moduleInfo | [NavDestinationModuleInfo](arkts-navdestination-navdestinationmoduleinfo-i.md) | 否 |  |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| type | [NavigationSystemTransitionType](arkts-navdestination-navigationsystemtransitiontype-e.md) \| undefined | 是 |  |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | string \| [CustomBuilder](../arkts-apis/arkts-custombuilder-t.md) \| [NavDestinationCommonTitle](arkts-navdestination-navdestinationcommontitle-i.md) \| [NavDestinationCustomTitle](arkts-navdestination-navdestinationcustomtitle-i.md) \| [Resource](../../apis-localization-kit/arkts-apis/arkts-localization-resource-resource-i.md) \| undefined | 是 |  |
| options | [NavigationTitleOptions](../../apis-arkui/arkts-components/arkts-arkui-navigationtitleoptions-i.md) \| undefined | 否 |  |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| toolbarParam | Array&lt;[ToolbarItem](../../apis-arkui/arkts-components/arkts-arkui-toolbaritem-i.md)&gt; \| [CustomBuilder](../arkts-apis/arkts-custombuilder-t.md) \| undefined | 是 |  |
