...
<!--Device-unnamed-export declare enum BarStyle--><!--Device-unnamed-export declare enum BarStyle-End-->
...
将指定该模式的标题栏或工具栏设置为 [组件级安全区](../../../reference/apis-arkui/arkui-ts/ts-universal-attributes-size.md#safeareapadding14)。
