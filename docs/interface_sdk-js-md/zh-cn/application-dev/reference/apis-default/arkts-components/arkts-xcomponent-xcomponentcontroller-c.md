...
| 类型 | 说明 |
| --- | --- |
| [SurfaceRect](arkts-xcomponent-surfacerect-i.md) | 获取XComponent持有Surface的显示区域。 |
...
| 类型 | 说明 |
| --- | --- |
| Required&lt;[SurfaceRotationOptions](arkts-xcomponent-surfacerotationoptions-i.md)&gt; | 获取XComponent持有Surface在屏幕旋转时是否锁定方向的设置。 |
...
| rect | [SurfaceRect](arkts-xcomponent-surfacerect-i.md) | 是 | 回调该方法的时候，绑定XComponent持有Surface的显示区域。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| config | [SurfaceConfig](arkts-xcomponent-surfaceconfig-i.md) | 是 | Surface配置选项，用于设置XComponent持有的Surface在渲染时是否需要被视为不透明。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| rect | [SurfaceRect](arkts-xcomponent-surfacerect-i.md) | 是 | XComponent持有Surface的显示区域。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| rotationOptions | [SurfaceRotationOptions](arkts-xcomponent-surfacerotationoptions-i.md) | 是 | 设置XComponent持有Surface在屏幕旋转时是否锁定方向。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| config | [ImageAnalyzerConfig](../../apis-arkui/arkts-apis/arkts-arkui-imagecommon-imageanalyzerconfig-i.md) | 是 | 执行AI分析所需要的入参，用于配置AI分析功能。 |
...
| 错误码ID | 错误信息 |
| --- | --- |
| [110001](../../apis-arkui/arkui-ts/errorcode-image-analyzer.md#110001-ai图像分析功能不支持) | 不支持图像分析特性。 |
| [110002](../../apis-arkui/arkui-ts/errorcode-image-analyzer.md#110002-ai图像分析正在进行中) | 图像分析正在执行中。 |
| [110003](../../apis-arkui/arkui-ts/errorcode-image-analyzer.md#110003-ai图像分析已停止) | 图像分析已停止。 |
