...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| options | [PluginComponentOptions](arkts-plugincomponent-plugincomponentoptions-i-sys.md) | 是 | 定义用于构造插件组件的选项。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| style | [CustomBuilderT](../arkts-apis/arkts-custombuildert-t.md)&lt;[PluginComponentAttribute](arkts-plugincomponent-attribute.md)&gt; | 是 | 用于设置plugincomponent属性的回调。 |

**返回值：**

| 类型 | 说明 |
| --- | --- |
| [PluginComponentAttribute](arkts-plugincomponent-attribute.md) | PluginComponent的属性。 |
