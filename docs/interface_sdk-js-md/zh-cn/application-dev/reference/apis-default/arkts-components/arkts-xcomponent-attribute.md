...
| --- | --- | --- | --- |
| brightness | double \| undefined | 是 |  |
| type | [HdrType](arkts-xcomponent-hdrtype-e.md) | 否 |  |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| params | [XComponentParameters](arkts-xcomponent-xcomponentparameters-i.md) \| [XComponentOptions](arkts-xcomponent-xcomponentoptions-i.md) \| [NativeXComponentParameters](arkts-xcomponent-nativexcomponentparameters-i.md) | 是 | 用于创建XComponent的选项。 |
