...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| content_ | [CustomBuilder](../arkts-apis/arkts-custombuilder-t.md) | 否 | 支持单个子组件。<br/>**说明：**<br/>可内置系统组件和自定义组件，支持渲染控制类型（ [if/else](../../../ui/rendering-control/arkts-rendering-control-ifelse.md)、 [ForEach](../../../ui/rendering-control/arkts-rendering-control-foreach.md)和 [LazyForEach](../../../ui/rendering-control/arkts-rendering-control-lazyforeach.md)）。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| style_ | [CustomBuilderT](../arkts-apis/arkts-custombuildert-t.md)&lt;[TabContentAttribute](arkts-tabcontent-attribute.md)&gt; | 是 | tabContent属性实例 |
| content_ | [CustomBuilder](../arkts-apis/arkts-custombuilder-t.md) | 否 | 选项卡内容 |
