...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| dataSource | [IDataSource](arkts-lazyforeach-idatasource-i.md)&lt;T&gt; | 是 | 要在UI中使用的数组集合。 |
| itemGenerator | [ItemGeneratorFunc](arkts-itemgeneratorfunc-t.md)&lt;T&gt; | 是 | item生成器函数。 |
...
| 类型 | 说明 |
| --- | --- |
| [LazyForEachAttribute](arkts-lazyforeach-attribute.md) | LazyForEach组件。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| style | [CustomBuilderT](../arkts-apis/arkts-custombuildert-t.md)&lt;[LazyForEachAttribute](arkts-lazyforeach-attribute.md)&gt; | 是 | 回调来设置LazyForEach的属性 |

**返回值：**

| 类型 | 说明 |
| --- | --- |
| [LazyForEachAttribute](arkts-lazyforeach-attribute.md) | LazyForEach的属性。 |
