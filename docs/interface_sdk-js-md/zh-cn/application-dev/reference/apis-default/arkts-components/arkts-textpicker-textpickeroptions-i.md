...
[TextPickerRangeContent](arkts-textpicker-textpickerrangecontent-i.md)[]类型。
2. 多列非联动数据选择器使用string[][]类型。
3. 多列联动数据选择器使用[TextCascadePickerRangeContent](arkts-textpicker-textcascadepickerrangecontent-i.md)[]类型。
...
1. 单列数据选择器使用int类型。
2. 多列数据选择器使用int[]类型。
3. 从API version 23开始，该参数支持[\$\$](../../../ui/state-management/arkts-two-way-sync-static.md)双向绑定变量。
...
**说明：**
1. 从API version 23开始，该参数支持[\$\$](../../../ui/state-management/arkts-two-way-sync-static.md)双向绑定变量。
