...
| layoutOptions | [GridLayoutOptions](arkts-grid-gridlayoutoptions-i.md) | 否 | Grid布局选项。 |
| content_ | [CustomBuilder](../arkts-apis/arkts-custombuilder-t.md) | 否 | Grid子组件。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| style_ | [CustomBuilderT](../arkts-apis/arkts-custombuildert-t.md)&lt;[GridAttribute](arkts-grid-attribute.md)&gt; | 是 | The style to create a Grid. |
