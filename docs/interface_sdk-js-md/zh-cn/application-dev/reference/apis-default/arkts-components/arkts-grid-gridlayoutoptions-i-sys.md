...
**类型：** [OnGetStartIndexByIndexCallback](arkts-ongetstartindexbyindexcallback-t-sys.md)
...
**类型：** [OnGetStartIndexByOffsetCallback](arkts-ongetstartindexbyoffsetcallback-t-sys.md)
