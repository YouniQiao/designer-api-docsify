...
| 类型 | 说明 |
| --- | --- |
| [ContextMenuDataMediaType](arkts-web-contextmenudatamediatype-e.md) | Returns the type of context node. |
...
Returns the context editable flags [ContextMenuEditStateFlags](arkts-web-contextmenueditstateflags-e.md).
...
| 类型 | 说明 |
| --- | --- |
| [ContextMenuInputFieldType](arkts-web-contextmenuinputfieldtype-e.md) | Input field type if the context menu was invoked on an input field. |
...
| 类型 | 说明 |
| --- | --- |
| [ContextMenuMediaType](arkts-web-contextmenumediatype-e.md) | Returns the type of context node. |
