...
Define the controller to interact with a custom keyboard, related to the [onInterceptKeyboardAttach](arkts-web-attribute.md#oninterceptkeyboardattach) event.
