...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| content_ | [CustomBuilder](../arkts-apis/arkts-custombuilder-t.md) | 否 | 容器内容。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| style_ | [CustomBuilderT](../arkts-apis/arkts-custombuildert-t.md)&lt;[FlowItemAttribute](arkts-flowitem-attribute.md)&gt; | 是 | 用于创建FlowItem的样式 |
...
| 类型 | 说明 |
| --- | --- |
| [FlowItemAttribute](arkts-flowitem-attribute.md) | FlowItem的属性。 |
