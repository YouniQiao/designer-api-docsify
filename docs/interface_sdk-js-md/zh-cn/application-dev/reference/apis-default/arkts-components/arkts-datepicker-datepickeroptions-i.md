...
在DatePickerDialog中，当[DatePickerDialogOptions] (../../../reference/apis-arkui/arkui-ts/ts-methods-datepicker-dialog.md#datepickerdialogoptions)的showTime设置 为true时，此参数不生效，默认显示年、月、日三列。

**类型：** [DatePickerMode](arkts-datepicker-datepickermode-e.md)
