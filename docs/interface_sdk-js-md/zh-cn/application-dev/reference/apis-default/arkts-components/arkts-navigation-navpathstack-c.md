...
从API version 12开始，NavPathStack允许被继承，派生类对象可以替代基类NavPathStack对象使用。使用示例参见 [示例10](../../../reference/apis-arkui/arkui-ts/ts-basic-components-navigation copy.md#示例10定义导航控制器派生类)。
...
| 类型 | 说明 |
| --- | --- |
| [NavPathStack](arkts-navigation-navpathstack-c.md) \| null | Returns the parent of the current stack. If no parent, it returns null. |
...
| 类型 | 说明 |
| --- | --- |
| Array&lt;[NavPathInfo](arkts-navigation-navpathinfo-c.md)&gt; | 当前路由栈中的路由页面信息数组。 |
...
| 类型 | 说明 |
| --- | --- |
| [NavPathInfo](arkts-navigation-navpathinfo-c.md) \| undefined | Returns the top NavPathInfo if the stack is not empty, otherwise returns undefined. |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| info | [NavPathInfo](arkts-navigation-navpathinfo-c.md) | 是 | NavDestination页面的信息。 |
| animated | boolean | 否 | 是否支持转场动画。<br/>true：支持转场动画；false：不支持转场动画。<br/>默认值：true |
...
将info指定的NavDestination页面信息入栈，使用Promise异步回调返回接口调用结果，具体根据options中指定不同的[LaunchMode](arkts-navigation-launchmode-e.md)，来实现不同的行为。
...
| --- | --- | --- | --- |
| info | [NavPathInfo](arkts-navigation-navpathinfo-c.md) | 是 | NavDestination页面的信息。 |
| options | [NavigationOptions](arkts-navigation-navigationoptions-i.md) | 否 | 路由栈操作选项。 |
...
| name | string | 是 | NavDestination页面名称。 |
| param | Object | 是 | 开发者设置的NavDestination页面详细参数。 |
| onPop | [Callback](../../apis-arkui/arkts-components/arkts-arkui-callback-i.md)&lt;[PopInfo](arkts-navigation-popinfo-i.md)&gt; | 是 | Callback回调，用于页面出栈时处理返回结果。仅 [pop](#pop)、 [popToName](#poptoname)、 [popToIndex](#poptoindex)中设置result参数后触发。 |
| animated | boolean | 否 | 是否支持转场动画。<br/>true：支持转场动画；false：不支持转场动画。<br/>默认值：true |
...
将info指定的NavDestination页面信息入栈，具体根据options中指定不同的[LaunchMode](arkts-navigation-launchmode-e.md)，来实现不同的行为。
...
| name | string | 是 | NavDestination页面名称。 |
| param | Object | 是 | 开发者设置的NavDestination页面详细参数。 |
| onPop | [Callback](../../apis-arkui/arkts-components/arkts-arkui-callback-i.md)&lt;[PopInfo](arkts-navigation-popinfo-i.md)&gt; | 是 | Callback回调，用于页面出栈时触发该回调处理返回结果。仅 [pop](#pop)、 [popToName](#poptoname)、 [popToIndex](#poptoindex)中设置result参数后触发。 |
| animated | boolean | 否 | 是否支持转场动画。<br/>true：支持转场动画；false：不支持转场动画。<br/>默认值：true |
...
将路由栈内指定navDestinationId的NavDestination页面删除。navDestinationId可以在NavDestination的 [onReady](../../../reference/apis-arkui/arkui-ts/ts-basic-components-navdestination.md#onready11)回调中获取，也可以在 [NavDestinationInfo](../arkts-apis/arkts-uiobserver-navdestinationinfo-i.md)中获取。
...
替换路由栈操作。使用Promise异步回调返回接口调用结果，具体根据options中指定不同的[LaunchMode](arkts-navigation-launchmode-e.md)，来实现不同的行为。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| info | [NavPathInfo](arkts-navigation-navpathinfo-c.md) | 是 | 新栈顶页面参数信息。 |
| animated | boolean | 否 | 是否支持转场动画。<br/>true：支持转场动画；false：不支持转场动画。<br/>默认值：true |
...
替换路由栈操作，具体根据options中指定不同的[LaunchMode](arkts-navigation-launchmode-e.md)，来实现不同的行为。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| interception | [NavigationInterception](arkts-navigation-navigationinterception-i.md) | 是 | 设置Navigation跳转拦截对象。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| pathStack | Array&lt;[NavPathInfo](arkts-navigation-navpathinfo-c.md)&gt; | 是 | 设置当前路由栈中的路由页面信息数组。<br/>**说明：**<br/>数组长度无限制。 |
