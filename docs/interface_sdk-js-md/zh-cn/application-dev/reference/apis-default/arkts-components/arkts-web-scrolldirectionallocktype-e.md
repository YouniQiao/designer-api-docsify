...
Enum defining the scope of directional lock behavior in the WebView, used with [enableScrollDirectionalLock](arkts-web-attribute.md#enablescrolldirectionallock).
