...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | [ButtonStyle](arkts-sidebar-buttonstyle-i.md) \| undefined | 是 |  |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| type | [SideBarContainerType](arkts-sidebar-sidebarcontainertype-e.md) | 否 |  |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | [SideBarPosition](arkts-sidebar-sidebarposition-e.md) \| undefined | 是 |  |
