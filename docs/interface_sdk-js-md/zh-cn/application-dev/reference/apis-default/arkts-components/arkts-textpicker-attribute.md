...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| style | [TextPickerTextStyle](arkts-textpicker-textpickertextstyle-i.md) \| undefined | 是 |  |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | [PickerTextStyle](../../apis-arkui/arkts-components/arkts-arkui-pickertextstyle-i.md) \| [TextPickerTextStyle](arkts-textpicker-textpickertextstyle-i.md) \| undefined | 是 |  |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | [DividerOptions](arkts-textpicker-divideroptions-i.md) \| null \| undefined | 是 |  |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | [OnTextPickerChangeCallback](arkts-ontextpickerchangecallback-t.md) \| undefined | 是 |  |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | [TextPickerEnterSelectedAreaCallback](arkts-textpickerenterselectedareacallback-t.md) \| undefined | 是 |  |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | [TextPickerScrollStopCallback](arkts-textpickerscrollstopcallback-t.md) \| undefined | 是 |  |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| style | [PickerBackgroundStyle](arkts-textpicker-pickerbackgroundstyle-i.md) \| undefined | 是 |  |
