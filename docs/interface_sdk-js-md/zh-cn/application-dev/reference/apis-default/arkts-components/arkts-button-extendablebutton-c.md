...
**继承/实现关系：** ExtendableButton implements [ButtonAttribute](arkts-button-attribute.md#buttonattribute)
...
| options | [ButtonOptions](arkts-button-buttonoptions-i.md) | 否 | Button Component Options |
| content_ | [CustomBuilder](../arkts-apis/arkts-custombuilder-t.md) | 否 | subcomponent trailing closure |
...
| --- | --- | --- | --- |
| factory | [ConstructorT](../arkts-apis/arkts-constructort-t.md)&lt;T&gt; | 是 |  |
| options | [ButtonOptions](arkts-button-buttonoptions-i.md) | 否 |  |
