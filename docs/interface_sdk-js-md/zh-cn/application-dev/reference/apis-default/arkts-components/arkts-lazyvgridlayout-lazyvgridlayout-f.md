...
| 类型 | 说明 |
| --- | --- |
| [LazyVGridLayoutAttribute](arkts-lazyvgridlayout-attribute.md) | 返回LazyVGridLayout组件的属性。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| style_ | [CustomBuilderT](../arkts-apis/arkts-custombuildert-t.md)&lt;[LazyVGridLayoutAttribute](arkts-lazyvgridlayout-attribute.md)&gt; | 是 | 创建LazyVGridLayout的样式 |
...
| 类型 | 说明 |
| --- | --- |
| [LazyVGridLayoutAttribute](arkts-lazyvgridlayout-attribute.md) | LazyVGridLayout的属性。 |
