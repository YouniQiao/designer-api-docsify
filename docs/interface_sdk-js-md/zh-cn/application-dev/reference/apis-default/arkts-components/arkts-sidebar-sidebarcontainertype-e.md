...
组件尺寸小于[minContentWidth](arkts-sidebarcontainer-attribute.md#mincontentwidth) + [minSideBarWidth](arkts-sidebarcontainer-attribute.md#minsidebarwidth)，并且未设置showSideBar时，侧边栏自动隐藏。
