...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| icon | [ResourceStr](../../apis-arkui/arkts-apis/arkts-arkui-resourcestr-t.md) \| [TabBarSymbol](arkts-tabcontent-tabbarsymbol-c.md) | 是 | 页签内的图片内容。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| style | [TabBarIconStyle](arkts-tabcontent-tabbariconstyle-i.md) | 是 | 底部页签的label图标的样式。 |

**返回值：**

| 类型 | 说明 |
| --- | --- |
| [BottomTabBarStyle](arkts-tabcontent-bottomtabbarstyle-c.md) | 返回BottomTabBarStyle对象本身。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| style | [TabBarLabelStyle](arkts-tabcontent-tabbarlabelstyle-i.md) | 是 | 底部页签的label文本和字体的样式。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | [LayoutMode](arkts-tabcontent-layoutmode-e.md) | 是 | 底部页签的图片、文字排布的方式，具体参照LayoutMode枚举。<br/>默认值：LayoutMode.VERTICAL |
...
| 类型 | 说明 |
| --- | --- |
| [BottomTabBarStyle](arkts-tabcontent-bottomtabbarstyle-c.md) | 返回创建的BottomTabBarStyle对象。 |
