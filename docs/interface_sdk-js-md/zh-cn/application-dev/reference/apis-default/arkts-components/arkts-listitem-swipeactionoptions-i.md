...
**类型：** [SwipeEdgeEffect](arkts-listitem-swipeedgeeffect-e.md)
...
**类型：** [CustomBuilder](../arkts-apis/arkts-custombuilder-t.md) \| [SwipeActionItem](arkts-listitem-swipeactionitem-i.md)
