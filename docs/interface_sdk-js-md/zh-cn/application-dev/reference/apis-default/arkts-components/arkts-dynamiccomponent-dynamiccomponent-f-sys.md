...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| options | [DynamicOptions](arkts-dynamiccomponent-dynamicoptions-i-sys.md) | 是 | DynamicComponent的构造配置参数，用于配置要加载的Abc页面入口、运行Worker及显示选项。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| style | [CustomBuilderT](../arkts-apis/arkts-custombuildert-t.md)&lt;[DynamicComponentAttribute](arkts-dynamiccomponent-attribute.md)&gt; | 是 | 用于设置DynamicComponent属性的回调。 |

**返回值：**

| 类型 | 说明 |
| --- | --- |
| [DynamicComponentAttribute](arkts-dynamiccomponent-attribute.md) | DynamicComponent的属性。 |
