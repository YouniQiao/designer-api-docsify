...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| options | [TextClockOptions](arkts-textclock-textclockoptions-i.md) | 否 | 通过文本显示当前系统时间的组件参数。 |

**返回值：**

| 类型 | 说明 |
| --- | --- |
| [TextClockAttribute](arkts-textclock-attribute.md) |  |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| style | [CustomBuilderT](../arkts-apis/arkts-custombuildert-t.md)&lt;[TextClockAttribute](arkts-textclock-attribute.md)&gt; | 是 | TextClock属性的实例。 |
