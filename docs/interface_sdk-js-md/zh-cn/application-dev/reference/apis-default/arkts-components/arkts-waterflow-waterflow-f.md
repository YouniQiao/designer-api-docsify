...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| style_ | [CustomBuilderT](../arkts-apis/arkts-custombuildert-t.md)&lt;[WaterFlowAttribute](arkts-waterflow-attribute.md)&gt; | 是 | 创建WaterFlow的样式 |
...
| 类型 | 说明 |
| --- | --- |
| [WaterFlowAttribute](arkts-waterflow-attribute.md) | WaterFlow的属性。 |
