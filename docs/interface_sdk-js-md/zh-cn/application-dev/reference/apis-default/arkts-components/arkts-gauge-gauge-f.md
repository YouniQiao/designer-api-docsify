...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| options | [GaugeOptions](arkts-gauge-gaugeoptions-i.md) | 是 | 数据量规图表组件参数。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| style | [CustomBuilderT](../arkts-apis/arkts-custombuildert-t.md)&lt;[GaugeAttribute](arkts-gauge-attribute.md)&gt; | 是 | Gauge属性的实例。 |
