...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| content_ | [CustomBuilder](../arkts-apis/arkts-custombuilder-t.md) | 否 | 支持多个子组件。<br/>**说明：** <br/>子组件类型：系统组件和自定义组件，支持渲染控制类型（ [if/else](../../../ui/rendering-control/arkts-rendering-control-ifelse.md)、 [ForEach](../../../ui/rendering-control/arkts-rendering-control-foreach.md)和 [LazyForEach](../../../ui/rendering-control/arkts-rendering-control-lazyforeach.md)）。 |

**返回值：**

| 类型 | 说明 |
| --- | --- |
| [NavDestinationAttribute](arkts-navdestination-attribute.md) |  |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| style_ | [CustomBuilderT](../arkts-apis/arkts-custombuildert-t.md)&lt;[NavDestinationAttribute](arkts-navdestination-attribute.md)&gt; | 是 | navDestination属性实例 |
| content_ | [CustomBuilder](../arkts-apis/arkts-custombuilder-t.md) | 否 | 内容区 |
