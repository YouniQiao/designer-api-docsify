...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| fillRule | [CanvasFillRule](arkts-canvasfillrule-t.md) | 否 | 指定要剪切对象的规则。可选参数为："nonzero"，"evenodd"。 异常值undefined或null按默认值处理。默认值："nonzero" |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| path | [Path2D](arkts-canvas-path2d-c.md) | 是 | Path2D剪切路径。异常值undefined或null按无效值处理。 |
| fillRule | [CanvasFillRule](arkts-canvasfillrule-t.md) | 否 | 指定要剪切对象的规则。可选参数为："nonzero"，"evenodd"。 异常值undefined或null按默认值处理。默认值："nonzero" |
...
| 类型 | 说明 |
| --- | --- |
| [CanvasGradient](arkts-canvas-canvasgradient-c.md) | 新的CanvasGradient对象，用于在canvas上创建渐变效果。 |
...
| 类型 | 说明 |
| --- | --- |
| [ImageData](arkts-canvas-imagedata-c.md) | 新的ImageData对象。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| imageData | [ImageData](arkts-canvas-imagedata-c.md) | 是 | 现有的ImageData对象。异常值undefined和null按width和height为0的ImageData处理。 |
...
| 类型 | 说明 |
| --- | --- |
| [CanvasPattern](arkts-canvas-canvaspattern-i.md) \| null | 通过指定图像和重复方式创建图片填充的模板对象。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| image | [ImageBitmap](arkts-canvas-imagebitmap-c.md) \| [PixelMap](../../apis-arkui/arkts-components/arkts-arkui-pixelmap-t.md) | 是 | 图片资源。异常值undefined或null按无效值处理，不进行绘制。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| fillRule | [CanvasFillRule](arkts-canvasfillrule-t.md) | 否 | 指定要填充对象的规则。可选参数为："nonzero"，"evenodd"。 异常值undefined或null按默认值处理。默认值："nonzero" |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| path | [Path2D](arkts-canvas-path2d-c.md) | 是 | Path2D填充路径。异常值undefined或null按无效值处理。 |
| fillRule | [CanvasFillRule](arkts-canvasfillrule-t.md) | 否 | 指定要填充对象的规则。可选参数为："nonzero"，"evenodd"。 异常值undefined或null按默认值处理。默认值："nonzero" |
...
| 类型 | 说明 |
| --- | --- |
| [TextMetrics](arkts-canvas-textmetrics-i.md) | 文本的尺寸信息。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| imageData | [ImageData](arkts-canvas-imagedata-c.md) | 是 | 包含像素值的ImageData对象。 异常值undefined或null按无效值处理，不进行绘制。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| path | [Path2D](arkts-canvas-path2d-c.md) | 否 | 需要绘制的Path2D。异常值undefined或null按无效值处理，不进行绘制。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| bitmap | [ImageBitmap](arkts-canvas-imagebitmap-c.md) | 是 | 待显示的ImageBitmap对象。 |
