...
| itemGenerator | [ItemGeneratorFunc](arkts-itemgeneratorfunc-t.md)&lt;T&gt; | 是 | 项生成函数。 |
| keyGenerator | [KeyGeneratorFunc](arkts-keygeneratorfunc-t.md)&lt;T&gt; | 否 | 键生成函数。 |

**返回值：**

| 类型 | 说明 |
| --- | --- |
| [ForEachAttribute](arkts-foreach-attribute.md) | ForEach的属性。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| style | [CustomBuilderT](../arkts-apis/arkts-custombuildert-t.md)&lt;[ForEachAttribute](arkts-foreach-attribute.md)&gt; | 是 | 用于设置ForEach属性的回调。 |

**返回值：**

| 类型 | 说明 |
| --- | --- |
| [ForEachAttribute](arkts-foreach-attribute.md) | ForEach属性实例。 |
