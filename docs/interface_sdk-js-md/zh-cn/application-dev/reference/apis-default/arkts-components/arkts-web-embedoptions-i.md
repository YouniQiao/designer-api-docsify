...
Whether the [onNativeEmbedVisibilityChange](arkts-web-attribute.md#onnativeembedvisibilitychange) event supports display-related attributes of the embed element. <br>Default value is false. If true, the changes of the display-related attributes of the embed element will be reported through the [onNativeEmbedVisibilityChange](arkts-web-attribute.md#onnativeembedvisibilitychange) event.
