...
**类型：** [SecurityDpiFollowStrategy](arkts-securityuiextensioncomponent-securitydpifollowstrategy-e-sys.md)
...
**类型：** [ComponentContent](../arkts-apis/arkts-componentcontent-c.md)
