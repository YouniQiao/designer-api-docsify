...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| options | [DistortionComponentOptions](arkts-distortioncomponent-distortioncomponentoptions-i-sys.md) | 否 | DistortionComponent Options. |
| content_ | [CustomBuilder](../arkts-apis/arkts-custombuilder-t.md) | 否 | Subcomponents of DistortionComponent. |
