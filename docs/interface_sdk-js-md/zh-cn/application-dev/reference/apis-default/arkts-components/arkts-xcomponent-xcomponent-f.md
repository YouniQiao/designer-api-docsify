...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| params | [XComponentParameters](arkts-xcomponent-xcomponentparameters-i.md) \| [XComponentOptions](arkts-xcomponent-xcomponentoptions-i.md) \| [NativeXComponentParameters](arkts-xcomponent-nativexcomponentparameters-i.md) | 是 | 用于 创建XComponent的选项。 |

**返回值：**

| 类型 | 说明 |
| --- | --- |
| [XComponentAttribute](arkts-xcomponent-attribute.md) | XComponent的属性。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| style | [CustomBuilderT](../arkts-apis/arkts-custombuildert-t.md)&lt;[XComponentAttribute](arkts-xcomponent-attribute.md)&gt; | 是 | 用于设置XComponent属性的回调。 |
