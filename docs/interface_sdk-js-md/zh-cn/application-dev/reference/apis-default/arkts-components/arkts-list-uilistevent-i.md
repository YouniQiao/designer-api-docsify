...
设置[onScrollIndex](arkts-list-attribute.md#onscrollindex)事件的回调。方法入参为undefined时，会重置事件回调。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | [OnListScrollIndexCallback](arkts-onlistscrollindexcallback-t.md) \| undefined | 是 | onScrollIndex事件的回调函数。 |
...
设置[onScrollVisibleContentChange](arkts-list-attribute.md#onscrollvisiblecontentchange)事件的回调。方法入参为undefined时，会重置事件回调。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | [OnScrollVisibleContentChangeCallback](arkts-onscrollvisiblecontentchangecallback-t.md) \| undefined | 是 | onScrollVisibleContentChange事件的回调函数。 |
