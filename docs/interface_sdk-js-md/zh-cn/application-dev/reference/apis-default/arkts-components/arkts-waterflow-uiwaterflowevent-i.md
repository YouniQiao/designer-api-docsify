...
frameNode中getEvent('WaterFlow')方法的返回 值，可用于给WaterFlow节点设置滚动事件。
...
设置[onScrollIndex](arkts-waterflow-attribute.md#onscrollindex)事件的回调。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | [OnWaterFlowScrollIndexCallback](arkts-onwaterflowscrollindexcallback-t.md) \| undefined | 是 | onScrollIndex事件的回调函数。 |
