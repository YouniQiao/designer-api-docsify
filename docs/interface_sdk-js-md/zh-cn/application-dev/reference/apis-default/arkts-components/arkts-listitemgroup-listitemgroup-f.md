...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| style_ | [CustomBuilderT](../arkts-apis/arkts-custombuildert-t.md)&lt;[ListItemGroupAttribute](arkts-listitemgroup-attribute.md)&gt; | 是 | 创建ListItemGroup的样式 |
...
| 类型 | 说明 |
| --- | --- |
| [ListItemGroupAttribute](arkts-listitemgroup-attribute.md) | ListItemGroup的属性。 |
