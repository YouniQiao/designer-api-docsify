...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| from | [NavDestinationContext](arkts-navdestination-navdestinationcontext-i.md) \| [NavBar](arkts-navbar-t.md) | 是 | 页面跳转之前的栈顶页面信息。 <br>取值约束:参数值为navBar，则表示跳转前的页面为Navigation首页。 |
| to | [NavDestinationContext](arkts-navdestination-navdestinationcontext-i.md) \| [NavBar](arkts-navbar-t.md) | 是 | 页面跳转之后的栈顶页面信息。 <br>取值约束:参数值为navBar，则表示跳转的目标页面为Navigation首页。 |
