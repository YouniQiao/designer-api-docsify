...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| options | [ProgressOptions](arkts-progress-progressoptions-i.md) | 是 | 按进度条类型不同，设置不同属性的进度条组件参数。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| style | [CustomBuilderT](../arkts-apis/arkts-custombuildert-t.md)&lt;[ProgressAttribute](arkts-progress-attribute.md)&gt; | 是 | Progress属性实例。 |
