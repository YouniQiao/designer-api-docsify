...
继承自[TimePickerOptions](arkts-timepicker-timepickeroptions-i.md)。
...
1. acceptButtonStyle与cancelButtonStyle中最多只能有一个primary字段配置为true，如果同时设置为true，则primary字段不生效，保持 默认值false。
