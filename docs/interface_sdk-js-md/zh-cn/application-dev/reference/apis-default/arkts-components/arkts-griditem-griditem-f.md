...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | [GridItemOptions](arkts-griditem-griditemoptions-i.md) | 否 | 为GridItem提供可选参数。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| style_ | [CustomBuilderT](../arkts-apis/arkts-custombuildert-t.md)&lt;[GridItemAttribute](arkts-griditem-attribute.md)&gt; | 是 | The style to create a GridItem. |
