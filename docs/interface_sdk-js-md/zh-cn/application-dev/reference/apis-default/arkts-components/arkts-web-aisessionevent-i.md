...
**类型：** [AISessionType](arkts-web-aisessiontype-e.md)
...
**类型：** [OnCreateAISession](arkts-oncreateaisession-t.md)
...
**类型：** [OnDestroyAISession](arkts-ondestroyaisession-t.md)
...
**类型：** [OnExecuteAIAction](arkts-onexecuteaiaction-t.md)
