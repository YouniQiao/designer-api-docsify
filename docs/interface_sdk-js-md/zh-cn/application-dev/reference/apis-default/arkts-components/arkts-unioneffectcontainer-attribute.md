...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| options | [UnionEffectContainerOptions](arkts-unioneffectcontainer-unioneffectcontaineroptions-i-sys.md) | 否 |  |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| mode | [UnionMode](arkts-unioneffectcontainer-unionmode-e-sys.md) \| undefined | 是 |  |
