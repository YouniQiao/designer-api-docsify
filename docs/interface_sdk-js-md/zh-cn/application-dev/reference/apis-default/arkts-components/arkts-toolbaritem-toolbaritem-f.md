...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| options | [ToolBarItemOptions](arkts-toolbar-toolbaritemoptions-i.md) | 否 | 分栏选项 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| style | [CustomBuilderT](../arkts-apis/arkts-custombuildert-t.md)&lt;[ToolBarItemAttribute](arkts-toolbaritem-attribute.md)&gt; | 是 | 用于设置toolbaritem属性的回调。 |
| content_ | [CustomBuilder](../arkts-apis/arkts-custombuilder-t.md) | 否 | 容器。 |
...
| 类型 | 说明 |
| --- | --- |
| [ToolBarItemAttribute](arkts-toolbaritem-attribute.md) | ToolBarItem的属性。 |
