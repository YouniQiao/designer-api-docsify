...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| options | [PathOptions](arkts-path-pathoptions-i.md) | 否 | Path绘制区域。 <br>异常值undefined和null按照无效值处理，本次设置不生效。 |

**返回值：**

| 类型 | 说明 |
| --- | --- |
| [PathAttribute](arkts-path-attribute.md) |  |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| style | [CustomBuilderT](../arkts-apis/arkts-custombuildert-t.md)&lt;[PathAttribute](arkts-path-attribute.md)&gt; | 是 | the callback to set up component's attributes. |
