...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| controller | [IndicatorComponentController](arkts-indicatorcomponent-indicatorcomponentcontroller-c.md) | 否 | IndicatorComponent constructor options |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| style_ | [CustomBuilderT](../arkts-apis/arkts-custombuildert-t.md)&lt;[IndicatorComponentAttribute](arkts-indicatorcomponent-attribute.md)&gt; | 是 | indicatorComponent属性实例 |
