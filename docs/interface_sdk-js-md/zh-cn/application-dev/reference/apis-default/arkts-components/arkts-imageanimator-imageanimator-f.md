...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| style | [CustomBuilderT](../arkts-apis/arkts-custombuildert-t.md)&lt;[ImageAnimatorAttribute](arkts-imageanimator-attribute.md)&gt; | 是 | 设置组件属性的回调。 |

**返回值：**

| 类型 | 说明 |
| --- | --- |
| [ImageAnimatorAttribute](arkts-imageanimator-attribute.md) | ImageAnimator的属性。 |
