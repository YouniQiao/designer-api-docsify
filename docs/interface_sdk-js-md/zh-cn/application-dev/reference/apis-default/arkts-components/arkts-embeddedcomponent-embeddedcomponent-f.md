...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| style | [CustomBuilderT](../arkts-apis/arkts-custombuildert-t.md)&lt;[EmbeddedComponentAttribute](arkts-embeddedcomponent-attribute.md)&gt; | 是 | 用于设置embeddedcomponent属性的回调。 |

**返回值：**

| 类型 | 说明 |
| --- | --- |
| [EmbeddedComponentAttribute](arkts-embeddedcomponent-attribute.md) | EmbeddedComponent的属性。 |
