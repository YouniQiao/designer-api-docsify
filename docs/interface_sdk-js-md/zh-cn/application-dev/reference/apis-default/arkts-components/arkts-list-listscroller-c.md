...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| options | [CloseSwipeActionOptions](arkts-list-closeswipeactionoptions-i.md) | 否 | 收起EXPANDED状态的ListItem 的回调事件集合。 |
...
| 类型 | 说明 |
| --- | --- |
| [VisibleListContentInfo](arkts-list-visiblelistcontentinfo-i.md) | 入参坐标处的子组件的索引信息。 |
