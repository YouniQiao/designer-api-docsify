...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | [BoardStyle](arkts-tabcontent-boardstyle-i.md) | 是 | 选中子页签的背板风格对象。 |

**返回值：**

| 类型 | 说明 |
| --- | --- |
| [SubTabBarStyle](arkts-tabcontent-subtabbarstyle-c.md) | 返回SubTabBarStyle对象本身。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| content | [ResourceStr](../../apis-arkui/arkts-apis/arkts-arkui-resourcestr-t.md) \| [ComponentContentBase](../arkts-apis/arkts-componentcontent-componentcontentbase-c.md) | 是 | 页签内的内容。&lt;br /&gt;**说明：**&lt;br /&gt;1.自定义内容不支持labelStyle属性。&lt;br /&gt;2.自定 义内容超出页签范围，则不显示超出部分。&lt;br /&gt;3.自定义内容小于页签范围，则会居中对齐。&lt;br /&gt;4.自定义内容异常或无可用显示组件，则显示空白。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| style | [SubTabBarIndicatorStyle](arkts-tabcontent-subtabbarindicatorstyle-i.md) | 是 | 选中子页签的下划线风格对象。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | [SubTabBarIndicatorStyle](arkts-tabcontent-subtabbarindicatorstyle-i.md) \| [DrawableTabBarIndicator](arkts-tabcontent-drawabletabbarindicator-i.md) | 是 | 选中子页签的下划线风格对象。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| style | [TabBarLabelStyle](arkts-tabcontent-tabbarlabelstyle-i.md) | 是 | 子页签的label文本和字体的样式对象。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| content | [ResourceStr](../../apis-arkui/arkts-apis/arkts-arkui-resourcestr-t.md) \| [ComponentContentBase](../arkts-apis/arkts-componentcontent-componentcontentbase-c.md) | 是 | 页签内的内容。支持ComponentContentBase设置自定义内容。&lt;br /&gt;**说明：**&lt;br /&gt;1.自 定义内容不支持labelStyle属性。&lt;br /&gt;2.自定义内容超出页签范围，则不显示超出部分。&lt;br /&gt;3.自定义内容小于页签范围，则会居中对齐。&lt;br /&gt;4.自定义内容异常或无可用显示组件，则显示空白。 |

**返回值：**

| 类型 | 说明 |
| --- | --- |
| [SubTabBarStyle](arkts-tabcontent-subtabbarstyle-c.md) | 返回创建的SubTabBarStyle对象。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | [SelectedMode](arkts-tabcontent-selectedmode-e.md) | 是 | 选中子页签的显示方式。&lt;br /&gt;默认值：SelectedMode.INDICATOR |
