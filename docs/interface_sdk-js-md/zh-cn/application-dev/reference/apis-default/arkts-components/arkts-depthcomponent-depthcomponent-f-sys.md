...
| options | [DepthComponentOptions](arkts-depthcomponent-depthcomponentoptions-i-sys.md) | 否 | 景深组件配置项。默认值：`{ depthSpace: DepthSpaceType.INSTANCE }`。 |
| content_ | [CustomBuilder](../arkts-apis/arkts-custombuilder-t.md) | 否 | Subcomponents of DepthComponent. |

**返回值：**

| 类型 | 说明 |
| --- | --- |
| [DepthComponentAttribute](arkts-depthcomponent-attribute.md) | 景深组件属性配置项 |
