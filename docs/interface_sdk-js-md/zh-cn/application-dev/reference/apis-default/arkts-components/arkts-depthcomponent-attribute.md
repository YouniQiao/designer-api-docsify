...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| camera | [DepthCameraParams](arkts-depthcomponent-depthcameraparams-i-sys.md) | 是 |  |
...
| callback | [DepthMapCallback](arkts-depthmapcallback-t-sys.md) | 否 |  |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| light | [DepthLightParams](arkts-depthcomponent-depthlightparams-i-sys.md) | 是 |  |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | [DepthComponentCompleteCallback](arkts-depthcomponentcompletecallback-t-sys.md) | 是 |  |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | [DepthComponentErrorCallback](arkts-depthcomponenterrorcallback-t-sys.md) | 是 |  |
...
| options | [DepthComponentOptions](arkts-depthcomponent-depthcomponentoptions-i-sys.md) | 否 |  |
