...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| arr | [RepeatArray](arkts-repeatarray-t.md)&lt;T&gt; | 是 | The Data Source. |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| style | [CustomBuilderT](../arkts-apis/arkts-custombuildert-t.md)&lt;[RepeatAttribute](arkts-repeat-attribute.md)&lt;T&gt;&gt; | 是 | 用于设置Repeat属性的回调。 |

**返回值：**

| 类型 | 说明 |
| --- | --- |
| [RepeatAttribute](arkts-repeat-attribute.md)&lt;T&gt; | Repeat属性实例。 |
