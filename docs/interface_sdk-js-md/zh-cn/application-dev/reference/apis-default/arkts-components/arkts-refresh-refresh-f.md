...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | [RefreshOptions](arkts-refresh-refreshoptions-i.md) | 是 |  |
...
| 类型 | 说明 |
| --- | --- |
| [RefreshAttribute](arkts-refresh-attribute.md) | 返回Refresh组件的属性。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| style_ | [CustomBuilderT](../arkts-apis/arkts-custombuildert-t.md)&lt;[RefreshAttribute](arkts-refresh-attribute.md)&gt; | 是 | 创建刷新的样式。 |
...
| 类型 | 说明 |
| --- | --- |
| [RefreshAttribute](arkts-refresh-attribute.md) | Refresh的属性。 |
