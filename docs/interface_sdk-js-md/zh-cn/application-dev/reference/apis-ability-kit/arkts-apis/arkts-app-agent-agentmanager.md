...
| [disconnectAgentExtensionAbility](arkts-ability-agentmanager-disconnectagentextensionability-f-sys.md) | 断开与指定proxy的[AgentExtensionAbility](../../../reference/apis-ability-kit/js-apis-app-agent-agentExtensionAbility.md)的连接。 |
...
| [notifyLowCodeAgentComplete](arkts-ability-agentmanager-notifylowcodeagentcomplete-f-sys.md) | 通知指定的[LOW_CODE](../../../reference/apis-ability-kit/js-apis-app-agent-agentConstant-sys.md#agentconstantagentcardtype)类型的AgentCard关联的Agent生命周期已结束。 |
| [registerAgentCard](arkts-ability-agentmanager-registeragentcard-f-sys.md) | 注册AgentCard到系统中，使系统能够识别和调用对应的AgentExtensionAbility。 |
| [updateAgentCard](arkts-ability-agentmanager-updateagentcard-f-sys.md) | 更新系统中已存在的AgentCard信息，当[SemVer版本](https://semver.org/)不低于当前已存在的AgentCard时执行覆盖更新。当SemVer版本相同时，系统优先保存通过[registerAgentCard](arkts-ability-agentmanager-registeragentcard-f-sys.md)或[updateAgentCard](arkts-ability-agentmanager-updateagentcard-f-sys.md)接口调用时传入的AgentCard。 |
<!--DelEnd-->
