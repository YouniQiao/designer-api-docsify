...
[注册系统环境变化的监听](arkts-ability-applicationcontext-c.md#on_abilitylifecycleabilitylifecycle) 后，在系统环境变化时触发回调。
...
[注册系统环境变化的监听](arkts-ability-applicationcontext-c.md#on_abilitylifecycleabilitylifecycle) 后，在系统内存变化时触发回调。
