...
**类型：** [CompletionHandler](arkts-ability-appabilitycompletionhandler-completionhandler-c.md)
...
取值范围为[minWindowHeight, maxWindowHeight]，取值范围单位为vp，可参考[vp2px](../../apis-default/arkts-apis/arkts-arkuiuicontext-uicontext-c.md#vp2px)换算为对应的px值 。
...
取值范围为[minWindowWidth, maxWindowWidth]，取值范围单位为vp，可参考[vp2px](../../apis-default/arkts-apis/arkts-arkuiuicontext-uicontext-c.md#vp2px)换算为对应的px值。
