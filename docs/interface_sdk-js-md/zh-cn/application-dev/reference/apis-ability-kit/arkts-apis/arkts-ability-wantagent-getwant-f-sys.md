...
| callback | [AsyncCallback](../../apis-basic-services-kit/arkts-apis/arkts-basicservices-base-asynccallback-i.md)&lt;[Want](arkts-ability-appabilitywant-want-c.md)&gt; | 是 | 回调函数。当获取WantAgent对象want成功，err中code为0，data为获取到的Want数据；否则err会返回对应的错误码和错误信息。 |
...
| 类型 | 说明 |
| --- | --- |
| Promise&lt;[Want](arkts-ability-appabilitywant-want-c.md)&gt; | Promise对象，返回WantAgent对象的want。 |
