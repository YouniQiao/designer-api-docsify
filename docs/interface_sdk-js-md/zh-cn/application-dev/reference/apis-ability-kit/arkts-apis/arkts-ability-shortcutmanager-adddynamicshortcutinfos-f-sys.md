...
| [18100001](../errorcode-bundle.md#18100001-shortcutinfo列表中bundlename和appindex不一一对应) | A combination of bundleName and appIndex in the shortcutInfo list is different from the others. |
