...
OpenLinkOptions可以作为[openLink()]\_\_\_JSDOC\_LINK\_DESC\_USD\_0\_\_\_的入参，用于标识是否仅打开AppLinking和传递键值对可选参数。
...
表示是否必须以\_\_\_MD\_COMMENT\_DESC\_USD\_2\_\_\_\_\_\_MD\_LINK\_DESC\_USD\_0\_\_\_\_\_\_MD\_COMMENT\_DESC\_USD\_3\_\_\_的方式启动UIAbility。

- 取值为true时，如果不存在与AppLinking相匹配的UIAbility，直接返回。  
- 取值为false时，如果不存在与AppLinking相匹配的UIAbility，AppLinking会退化为  
\_\_\_MD\_LINK\_DESC\_USD\_1\_\_\_。默认值为false。
...
表示\_\_\_MD\_LINK\_DESC\_USD\_0\_\_\_找不到应用时是否显示“暂无可用打开方式”的弹窗。
...
**说明**：具体使用规则请参考[want]\_\_\_JSDOC\_LINK\_DESC\_USD\_0\_\_\_中的parameters属性。
