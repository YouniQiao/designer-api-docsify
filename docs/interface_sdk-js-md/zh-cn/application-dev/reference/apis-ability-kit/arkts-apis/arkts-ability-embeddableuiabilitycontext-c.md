...
[EmbeddableUIAbility](arkts-ability-app-ability-embeddableuiability-embeddableuiability-c.md#EmbeddableUIAbility)组件的上下文，继承自  
...
**继承/实现关系：** EmbeddableUIAbilityContext extends [UIAbilityContext](UIAbilityContext)
