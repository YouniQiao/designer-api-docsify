...
EmbeddableUIAbilityContext是[EmbeddableUIAbility](arkts-ability-embeddableuiability-c.md)组件的上下文，继承自[UIAbilityContext](arkts-ability-uiabilitycontext-c.md)。
