...
本模块提供应用信息查询能力，支持[包信息](arkts-ability-bundleinfo-depr-i.md)、[应用信息](arkts-ability-applicationinfo-depr-i.md)、[Ability组件信息](arkts-ability-abilityinfo-depr-i.md)等信息的查询，以及应用禁用状态的查询、设置等。
