...
该接口仅供[DLP]\_\_\_JSDOC\_LINK\_DESC\_USD\_0\_\_\_（Data Loss Prevention, 数据丢失防护）管理应用使用，其他应用禁止使用，DLP管理应用通过该接口通知沙箱应用另存为结果。使用callback异步回调。
    **说明：**  
...
该接口仅供[DLP]\_\_\_JSDOC\_LINK\_DESC\_USD\_0\_\_\_（Data Loss Prevention, 数据丢失防护）管理应用使用，其他应用禁止使用，DLP管理应用通过该接口通知沙箱应用另存为结果。使用Promise异步回调。
