...
[startUsingPermission]\_\_\_JSDOC\_LINK\_DESC\_USD\_0\_\_\_和  
[stopUsingPermission]\_\_\_JSDOC\_LINK\_DESC\_USD\_1\_\_\_调用触发。订阅成功后，当权限使用状态变更时，回调函数会被触发，返回[ActiveChangeResponse]\_\_\_JSDOC\_LINK\_DESC\_USD\_2\_\_\_对象，包含权限使用状态变化的详情。使用callback异步回调。
