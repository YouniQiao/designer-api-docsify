...
应用安装时指定的\_\_\_MD\_LINK\_DESC\_USD\_0\_\_\_，默认值为空，最大长度为128字节。该字段通常由操作系统运营方的应用市场指定。
...
[getOsAccountLocalId]\_\_\_JSDOC\_LINK\_DESC\_USD\_0\_\_\_获取当前进程所在用户。当安装、卸载或恢复一个驱动应用时，该参数会被忽略，会在所有用户下执行。
