...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| ticketInfo | \_\_\_MD\_LINK\_USD\_0\_\_\_[] | 是 | 远程授权包列表 |
| remoteInfo | \_\_\_MD\_LINK\_USD\_0\_\_\_ | 是 | 远端设备信息 |

**返回值：**

| 类型 | 说明 |
| --- | --- |
| Promise&lt;boolean[]&gt; | Promise用于返回\_\_\_ESCAPED\_DOLLAR\_\_\_{boolean[]}。 |
