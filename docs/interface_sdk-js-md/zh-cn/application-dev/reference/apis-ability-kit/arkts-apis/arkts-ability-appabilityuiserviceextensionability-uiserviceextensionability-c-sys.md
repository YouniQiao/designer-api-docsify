...
UIServiceExtensionAbility提供浮窗组件相关扩展能力，继承自[ExtensionAbility](arkts-ability-appabilityextensionability-extensionability-c.md). 主要用于向三方应用提供带界面的服务。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| want | [Want](arkts-ability-appabilitywant-want-c.md) | 是 | 当前 [UIServiceExtensionAbility](#uiserviceextensionability系统接口)相关的 [Want](arkts-ability-appabilitywant-want-c.md)类型信息，包括Ability名称、Bundle名称等。 |
...
UIServiceExtension的上下文环境，继承自[ExtensionContext](arkts-ability-appabilityextensionability-extensionability-c.md)。
