...
| 名称 | 说明 |
| --- | --- |
| [UpdatedCallback](arkts-ability-systemconfiguration-updatedcallback-i.md) | UpdatedCallback是监听系统环境变化的回调函数，开发者可通过  [ApplicationContext.onSystemConfigurationUpdated](./application/ApplicationContext:ApplicationContext.onSystemConfigurationUpdated)方法注册自定义的UpdatedCallback，来监听系统环境变化。 |
