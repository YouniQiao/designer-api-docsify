...
**继承/实现关系：** UIAbility extends [Ability](arkts-ability-appabilityability-ability-c.md)
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| want | [Want](arkts-ability-appabilitywant-want-c.md) | 是 | 调用方拉起该UIAbility时传递的数据。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| want | [Want](arkts-ability-appabilitywant-want-c.md) | 是 | 调用方再次拉起该UIAbility时传递的数据。 |
...
> 行。当
> [AbilityStage.onPrepareTerminationAsync](arkts-ability-appabilityabilitystage-abilitystage-c.md#onprepareterminationasync)
> 或[AbilityStage.onPrepareTermination](arkts-ability-appabilityabilitystage-abilitystage-c.md#onpreparetermination)实现时，在
...
**类型：** [Callee](arkts-ability-appabilityuiability-callee-i.md)
