...
| [17700052](../errorcode-bundle.md#17700052-非开发者模式下不允许安装调试自分发插件或调试应用) | Failed to install the HAP because debug bundle cannot be installed under non -developer mode.<br>**适用版本：** 11+ |
