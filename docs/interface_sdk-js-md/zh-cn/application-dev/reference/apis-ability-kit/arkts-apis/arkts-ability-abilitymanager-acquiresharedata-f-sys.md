...
[onShare]\_\_\_JSDOC\_LINK\_DESC\_USD\_0\_\_\_回调并返回分享数据。使用callback异步回调。
...
| callback | \_\_\_MD\_LINK\_USD\_0\_\_\_&lt;Record&lt;string, Object&gt;&gt; | 是 | 回调函数。当接口调用成功，err为undefined，data为获取到的分享数据；否则为错误对象。可进行错误处理或其他自 定义处理。\_\_\_HTML\_TAG\_USD\_0\_\_\_**起始版本：** 11 |
...
系统弹框通过该接口发起原子化服务分享，触发目标UIAbility的  
[onShare]\_\_\_JSDOC\_LINK\_DESC\_USD\_0\_\_\_回调并返回分享数据。使用Promise异步回调。
...
| Promise&lt;Record&lt;string, Object&gt;&gt; | Promise used to return the API call result and the shared data. You can perform error handling or other custom processing.\_\_\_HTML\_TAG\_USD\_0\_\_\_**适用版本：** 11+ |
