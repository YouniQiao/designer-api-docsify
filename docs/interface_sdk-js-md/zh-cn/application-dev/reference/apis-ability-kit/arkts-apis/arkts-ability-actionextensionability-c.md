...
ActionExtensionAbility是为开发者提供的自定义操作业务模板，继承自[UIExtensionAbility](arkts-ability-uiextensionability-c.md)。
...
**继承/实现关系：** ActionExtensionAbility extends [UIExtensionAbility](arkts-ability-uiextensionability-c.md)
