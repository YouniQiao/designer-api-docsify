...
> 本地WantAgent实例创建后，触发方法参见[wantAgent.triggerAsync](arkts-ability-triggerasync-f-sys.md#triggerasync-1)接口说明。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| info | [LocalWantAgentInfo](arkts-ability-localwantagentinfo-t-sys.md) | 是 | Information about the local WantAgent object to create. |
