...
本模块提供意图执行上下文，是[意图执行基类]\_\_\_JSDOC\_LINK\_DESC\_USD\_0\_\_\_和  
[@InsightIntentEntry的意图执行基类]\_\_\_JSDOC\_LINK\_DESC\_USD\_1\_\_\_的属性，为意图执行提供基础能力，例如启动本应用内的[UIAbility组件]\_\_\_JSDOC\_LINK\_DESC\_USD\_2\_\_\_。
...
设置意图执行结果的返回形式，适用于执行模式为[UI\_ABILITY\_FOREGROUND]\_\_\_JSDOC\_LINK\_DESC\_USD\_0\_\_\_的意图。
...
设置意图执行结果的返回形式，适用于执行模式为[UI\_EXTENSION\_ABILITY]\_\_\_JSDOC\_LINK\_DESC\_USD\_0\_\_\_的意图。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| want | \_\_\_MD\_LINK\_USD\_0\_\_\_ | 是 | 启动UIAbility组件的want信息。 |
...
意图实例唯一ID。用于通过  
[insightIntentProvider.sendExecuteResult接口]\_\_\_JSDOC\_LINK\_DESC\_USD\_0\_\_\_ 和  
[insightIntentProvider.sendIntentResult接口]\_\_\_JSDOC\_LINK\_DESC\_USD\_1\_\_\_返回指定意图的执行结果。
