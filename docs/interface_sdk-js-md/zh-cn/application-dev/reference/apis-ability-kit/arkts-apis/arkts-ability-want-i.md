...
**替代接口：** [Want:Want](arkts-ability-want-c.md)
...
**替代接口：** [abilityName](arkts-ability-want-c.md#abilityname)
...
**替代接口：** [action](arkts-ability-want-c.md#action)
...
**替代接口：** [bundleName](arkts-ability-want-c.md#bundlename)
...
**替代接口：** [deviceId](arkts-ability-want-c.md#deviceid)
...
**替代接口：** [entities](arkts-ability-want-c.md#entities)
...
**替代接口：** [flags](arkts-ability-want-c.md#flags)
...
**替代接口：** [parameters](arkts-ability-want-c.md#parameters)
...
**替代接口：** [type](arkts-ability-want-c.md#type)
...
**替代接口：** [uri](arkts-ability-want-c.md#uri)
