...
保存当前App状态，可以配合[errorManager](arkts-ability-app-ability-errormanager.md)相关接口使用。
...
主动保存Ability的状态，这个状态将在下次恢复启动时使用。可以配合[errorManager](arkts-ability-app-ability-errormanager.md)相关接口使用。
