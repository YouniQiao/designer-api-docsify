...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| connection | ArkTS-Dyn: number  <br>ArkTS-Sta：long | 是 | 连接的ServiceExtensionAbility的标识Id，即 [connectServiceExtensionAbility](arkts-ability-uiextensioncontext-c.md#connectserviceextensionability)返回的connectionId。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| proxy | [UIServiceProxy](arkts-ability-uiserviceproxy-i.md) | 是 | [connectUIServiceExtensionAbility](arkts-ability-uiextensioncontext-c.md#connectuiserviceextensionability)返回的Proxy。 |
...
| 16000004 | Cannot start an invisible component. |
| 16000005 | The specified process does not have the permission. |
| 16000069 | The extension cannot start the third party application.<br>**适用版本：** 12+ |
| 16000006 | Cross-user operations are not allowed. |
| 16000070 | The extension cannot start the service.<br>**适用版本：** 12+ |
