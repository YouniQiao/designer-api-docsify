...
| triggerInfo | \_\_\_MD\_LINK\_USD\_0\_\_\_ | 是 | 表示触发WantAgent实例时携带的信息，如自定义的extraInfos。 |
| callback | \_\_\_MD\_LINK\_USD\_0\_\_\_&lt;CompleteData&gt; | 否 | 主动激发WantAgent实例的回调方法。 |
