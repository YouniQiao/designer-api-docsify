...
| callback | [AsyncCallback](../../apis-basic-services-kit/arkts-apis/arkts-basicservices-base-asynccallback-i.md)&lt;[Want](arkts-ability-appabilitywant-want-c.md)&gt; | 是 | 回调函数。当获取应用的处置状态成功时，err为null，data为获取到的处置状态；否则为错误对象。 |
...
| 类型 | 说明 |
| --- | --- |
| Promise&lt;[Want](arkts-ability-appabilitywant-want-c.md)&gt; | Promise对象，返回应用的处置状态。 |
