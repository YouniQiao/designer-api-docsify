...
**继承/实现关系：** UIServiceExtensionContext extends [ExtensionContext](arkts-ability-extensioncontext-c.md)
...
连接到[UIExtensionAbility](arkts-ability-app-ability-uiextensionability-uiextensionability-c.md)，返回连接id。
...
断开与[UIExtensionAbility](arkts-ability-app-ability-uiextensionability-uiextensionability-c.md)的连接，与[connectServiceExtensionAbility](#connectserviceextensionability)功能相反。使用Promise异步回调。
...
按目标ability的类型启动[UIAbility](arkts-ability-app-ability-uiability-uiability-c.md)或[UIExtensionAbility](arkts-ability-app-ability-uiextensionability-uiextensionability-c.md)。仅支持处于前台的应用调用。使用Promise异步回调。
...
| abilityStartCallback | [AbilityStartCallback](arkts-ability-abilitystartcallback-i.md) | 是 | 拉起UIExtensionAbility执行结果的回调。 |
...
销毁[UIServiceExtension](arkts-ability-app-ability-uiserviceextensionability-uiserviceextensionability-c-sys.md)。使用Promise异步回调。
