...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| context | [AbilityStageContext](arkts-ability-abilitystagecontext-c.md) | 是 | [AbilityStage](arkts-ability-appabilityabilitystage-abilitystage-c.md)的上下文环境 |
...
| result | Object | 是 | 依赖的启动任务[init](../../apis-default/arkts-apis/arkts-appappstartupstartuptask-startuptask-c.md#init)返回的执行结果。 |
