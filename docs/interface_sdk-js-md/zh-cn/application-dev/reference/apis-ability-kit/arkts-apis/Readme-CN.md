...
- [@ohos.ability.errorCode](arkts-ability-errorcode.md)
  - [ErrorCode](arkts-ability-abilityerrorcode-errorcode-e.md)
...
- [@ohos.app.ability.Ability](arkts-app-ability-ability.md)
  - [Ability](arkts-ability-appabilityability-ability-c.md)
...
- [@ohos.app.ability.AbilityLifecycleCallback](arkts-app-ability-abilitylifecyclecallback.md)
  - [AbilityLifecycleCallback](arkts-ability-appabilityabilitylifecyclecallback-abilitylifecyclecallback-c.md)
...
- [@ohos.app.ability.ActionExtensionAbility](arkts-app-ability-actionextensionability.md)
  - [ActionExtensionAbility](arkts-ability-appabilityactionextensionability-actionextensionability-c.md)
...
- [@ohos.app.ability.ApplicationStateChangeCallback](arkts-app-ability-applicationstatechangecallback.md)
  - [ApplicationStateChangeCallback](arkts-ability-appabilityapplicationstatechangecallback-applicationstatechangecallback-c.md)
- [@ohos.app.ability.ApplicationStateChangeCallback](arkts-app-ability-applicationstatechangecallback.md)
  - [ApplicationStateChangeCallback](arkts-ability-appabilityapplicationstatechangecallback-applicationstatechangecallback-i.md)
- [@ohos.app.ability.AtomicServiceOptions](arkts-app-ability-atomicserviceoptions.md)
  - [AtomicServiceOptions](arkts-ability-appabilityatomicserviceoptions-atomicserviceoptions-c.md)
<!--Del-->
- [@ohos.app.ability.AutoFillExtensionAbility](arkts-app-ability-autofillextensionability.md)<!--DelEnd-->
  <!--Del-->
  - [AutoFillExtensionAbility(系统接口)](arkts-ability-appabilityautofillextensionability-autofillextensionability-c-sys.md)<!--DelEnd-->
- [@ohos.app.ability.ChildProcess](arkts-app-ability-childprocess.md)
  - [ChildProcess](arkts-ability-appabilitychildprocess-childprocess-c.md)
- [@ohos.app.ability.ChildProcessArgs](arkts-app-ability-childprocessargs.md)
  - [ChildProcessArgs](arkts-ability-appabilitychildprocessargs-childprocessargs-i.md)
- [@ohos.app.ability.ChildProcessOptions](arkts-app-ability-childprocessoptions.md)
  - [ChildProcessOptions](arkts-ability-appabilitychildprocessoptions-childprocessoptions-i.md)
- [@ohos.app.ability.CompletionHandler](arkts-app-ability-completionhandler.md)
  - [CompletionHandler](arkts-ability-appabilitycompletionhandler-completionhandler-c.md)
...
- [@ohos.app.ability.CompletionHandlerForAbilityStartCallback](arkts-app-ability-completionhandlerforabilitystartcallback.md)
  - [CompletionHandlerForAbilityStartCallback](arkts-ability-appabilitycompletionhandlerforabilitystartcallback-completionhandlerforabilitystartcallback-c.md)
  - [OnRequestFailureFn](arkts-ability-onrequestfailurefn-t.md)
  - [OnRequestSuccessFn](arkts-ability-onrequestsuccessfn-t.md)
  - [AbilityStartFailureCode](arkts-ability-appabilitycompletionhandlerforabilitystartcallback-abilitystartfailurecode-e.md)
- [@ohos.app.ability.CompletionHandlerForAtomicService](arkts-app-ability-completionhandlerforatomicservice.md)
  - [CompletionHandlerForAtomicService](arkts-ability-appabilitycompletionhandlerforatomicservice-completionhandlerforatomicservice-c.md)
  - [FailureCode](arkts-ability-appabilitycompletionhandlerforatomicservice-failurecode-e.md)
- [@ohos.app.ability.CompletionHandlerForAtomicService](arkts-app-ability-completionhandlerforatomicservice.md)
  - [CompletionHandlerForAtomicService](arkts-ability-appabilitycompletionhandlerforatomicservice-completionhandlerforatomicservice-c.md)
...
- [@ohos.app.ability.EmbeddableUIAbility](arkts-app-ability-embeddableuiability.md)
  - [EmbeddableUIAbility](arkts-ability-appabilityembeddableuiability-embeddableuiability-c.md)
- [@ohos.app.ability.EmbeddedUIExtensionAbility](arkts-app-ability-embeddeduiextensionability.md)
  - [EmbeddedUIExtensionAbility](arkts-ability-appabilityembeddeduiextensionability-embeddeduiextensionability-c.md)
- [@ohos.app.ability.EnvironmentCallback](arkts-app-ability-environmentcallback.md)
  - [EnvironmentCallback](arkts-ability-appabilityenvironmentcallback-environmentcallback-c.md)
- [@ohos.app.ability.ExtensionAbility](arkts-app-ability-extensionability.md)
  - [ExtensionAbility](arkts-ability-appabilityextensionability-extensionability-c.md)
- [@ohos.app.ability.InsightIntentContext](arkts-app-ability-insightintentcontext.md)
  - [InsightIntentContext](arkts-ability-appabilityinsightintentcontext-insightintentcontext-c.md)
- [@ohos.app.ability.InsightIntentDecorator](arkts-app-ability-insightintentdecorator.md)
  - [EntryIntentDecoratorInfo](arkts-ability-appabilityinsightintentdecorator-entryintentdecoratorinfo-i.md)
  - [FormIntentDecoratorInfo](arkts-ability-appabilityinsightintentdecorator-formintentdecoratorinfo-i.md)
  - [FunctionIntentDecoratorInfo](arkts-ability-appabilityinsightintentdecorator-functionintentdecoratorinfo-i.md)
  - [IntentDecoratorInfo](arkts-ability-appabilityinsightintentdecorator-intentdecoratorinfo-i.md)
  - [IntentEntityDecoratorInfo](arkts-ability-appabilityinsightintentdecorator-intententitydecoratorinfo-i.md)
  - [LinkIntentDecoratorInfo](arkts-ability-appabilityinsightintentdecorator-linkintentdecoratorinfo-i.md)
  - [LinkIntentParamMapping](arkts-ability-appabilityinsightintentdecorator-linkintentparammapping-i.md)
  - [PageIntentDecoratorInfo](arkts-ability-appabilityinsightintentdecorator-pageintentdecoratorinfo-i.md)
  - [LinkParamCategory](arkts-ability-appabilityinsightintentdecorator-linkparamcategory-e.md)
- [@ohos.app.ability.InsightIntentEntryExecutor](arkts-app-ability-insightintententryexecutor.md)
  - [InsightIntentEntryExecutor](arkts-ability-appabilityinsightintententryexecutor-insightintententryexecutor-c.md)
- [@ohos.app.ability.InsightIntentExecutor](arkts-app-ability-insightintentexecutor.md)
  - [InsightIntentExecutor](arkts-ability-appabilityinsightintentexecutor-insightintentexecutor-c.md)
- [@ohos.app.ability.InteropAbilityLifecycleCallback](arkts-app-ability-interopabilitylifecyclecallback.md)
  - [InteropAbilityLifecycleCallback](arkts-ability-appabilityinteropabilitylifecyclecallback-interopabilitylifecyclecallback-i.md)
...
- [@ohos.app.ability.OpenLinkOptions](arkts-app-ability-openlinkoptions.md)
  - [OpenLinkOptions](arkts-ability-appabilityopenlinkoptions-openlinkoptions-i.md)
<!--Del-->
- [@ohos.app.ability.ServiceExtensionAbility](arkts-app-ability-serviceextensionability.md)<!--DelEnd-->
  <!--Del-->
  - [ServiceExtensionAbility(系统接口)](arkts-ability-appabilityserviceextensionability-serviceextensionability-c-sys.md)<!--DelEnd-->
- [@ohos.app.ability.ShareExtensionAbility](arkts-app-ability-shareextensionability.md)
  - [ShareExtensionAbility](arkts-ability-appabilityshareextensionability-shareextensionability-c.md)
- [@ohos.app.ability.StartOptions](arkts-app-ability-startoptions.md)
  - [StartOptions](arkts-ability-appabilitystartoptions-startoptions-c.md)
  <!--Del-->
  - [StartOptions(系统接口)](arkts-ability-appabilitystartoptions-startoptions-c-sys.md)<!--DelEnd-->
- [@ohos.app.ability.UIAbility](arkts-app-ability-uiability.md)
  - [UIAbility](arkts-ability-appabilityuiability-uiability-c.md)
  - [Callee](arkts-ability-appabilityuiability-callee-i.md)
  - [CalleeCallback](arkts-ability-appabilityuiability-calleecallback-i.md)
  - [Caller](arkts-ability-appabilityuiability-caller-i.md)
  - [OnReleaseCallback](arkts-ability-appabilityuiability-onreleasecallback-i.md)
  - [OnRemoteStateChangeCallback](arkts-ability-appabilityuiability-onremotestatechangecallback-i.md)
...
- [@ohos.app.ability.UIExtensionContentSession](arkts-app-ability-uiextensioncontentsession.md)
  - [UIExtensionContentSession](arkts-ability-appabilityuiextensioncontentsession-uiextensioncontentsession-c.md)
  <!--Del-->
  - [UIExtensionContentSession(系统接口)](arkts-ability-appabilityuiextensioncontentsession-uiextensioncontentsession-c-sys.md)<!--DelEnd-->
  <!--Del-->
...
- [@ohos.app.ability.UIServiceExtensionAbility](arkts-app-ability-uiserviceextensionability.md)<!--DelEnd-->
  <!--Del-->
  - [UIServiceExtensionAbility(系统接口)](arkts-ability-appabilityuiserviceextensionability-uiserviceextensionability-c-sys.md)<!--DelEnd-->
- [@ohos.app.ability.Want](arkts-app-ability-want.md)
  - [Want](arkts-ability-appabilitywant-want-c.md)
- [@ohos.app.ability.abilityManager](arkts-app-ability-abilitymanager.md)
  ...
  <!--Del-->
  - [off_abilityForegroundState(系统接口)](arkts-ability-abilitymanager-offabilityforegroundstate-f-sys.md)<!--DelEnd-->
  <!--Del-->
  ...
  <!--Del-->
  - [on_abilityForegroundState(系统接口)](arkts-ability-abilitymanager-onabilityforegroundstate-f-sys.md)<!--DelEnd-->
  <!--Del-->
...
- [@ohos.app.ability.appManager](arkts-app-ability-appmanager.md)
  ...
  <!--Del-->
  - [off_abilityFirstFrameState(系统接口)](arkts-ability-appmanager-offabilityfirstframestate-f-sys.md)<!--DelEnd-->
  <!--Del-->
  - [off_appForegroundState(系统接口)](arkts-ability-appmanager-offappforegroundstate-f-sys.md)<!--DelEnd-->
  - [off_applicationState](arkts-ability-appmanager-offapplicationstate-f.md)
  <!--Del-->
  ...
  <!--Del-->
  - [on_abilityFirstFrameState(系统接口)](arkts-ability-appmanager-onabilityfirstframestate-f-sys.md)<!--DelEnd-->
  <!--Del-->
  - [on_appForegroundState(系统接口)](arkts-ability-appmanager-onappforegroundstate-f-sys.md)<!--DelEnd-->
  - [on_applicationState](arkts-ability-appmanager-onapplicationstate-f.md)
  <!--Del-->
  - [on_applicationState(系统接口)](arkts-ability-appmanager-onapplicationstate-f-sys.md)<!--DelEnd-->
  <!--Del-->
...
- [@ohos.app.ability.autoStartupManager](arkts-app-ability-autostartupmanager.md)
  ...
  <!--Del-->
  - [off_systemAutoStartup(系统接口)](arkts-ability-autostartupmanager-offsystemautostartup-f-sys.md)<!--DelEnd-->
  <!--Del-->
  - [offSystemAutoStartup(系统接口)](arkts-ability-autostartupmanager-offsystemautostartup-f-sys.md)<!--DelEnd-->
  <!--Del-->
  - [on_systemAutoStartup(系统接口)](arkts-ability-autostartupmanager-onsystemautostartup-f-sys.md)<!--DelEnd-->
  <!--Del-->
  - [onSystemAutoStartup(系统接口)](arkts-ability-autostartupmanager-onsystemautostartup-f-sys.md)<!--DelEnd-->
  <!--Del-->
...
<!--Del-->
- [@ohos.app.ability.dialogSession](arkts-app-ability-dialogsession.md)<!--DelEnd-->
  <!--Del-->
...
- [@ohos.app.ability.errorManager](arkts-app-ability-errormanager.md)
  - [off_error](arkts-ability-errormanager-offerror-f.md)
  - [off_freeze](arkts-ability-errormanager-offfreeze-f.md)
  - [off_globalErrorOccurred](arkts-ability-errormanager-offglobalerroroccurred-f.md)
  - [off_globalUnhandledRejectionDetected](arkts-ability-errormanager-offglobalunhandledrejectiondetected-f.md)
  - [off_loopObserver](arkts-ability-errormanager-offloopobserver-f.md)
  ...
  - [on_error](arkts-ability-errormanager-onerror-f.md)
  - [on_freeze](arkts-ability-errormanager-onfreeze-f.md)
  - [on_globalErrorOccurred](arkts-ability-errormanager-onglobalerroroccurred-f.md)
  - [on_globalUnhandledRejectionDetected](arkts-ability-errormanager-onglobalunhandledrejectiondetected-f.md)
  - [on_loopObserver](arkts-ability-errormanager-onloopobserver-f.md)
...
<!--Del-->
- [@ohos.app.ability.missionManager](arkts-app-ability-missionmanager.md)<!--DelEnd-->
  <!--Del-->
  ...
  <!--Del-->
  - [off_mission(系统接口)](arkts-ability-missionmanager-offmission-f-sys.md)<!--DelEnd-->
  <!--Del-->
  - [offMission(系统接口)](arkts-ability-missionmanager-offmission-f-sys.md)<!--DelEnd-->
  <!--Del-->
  - [on_mission(系统接口)](arkts-ability-missionmanager-onmission-f-sys.md)<!--DelEnd-->
  <!--Del-->
...
<!--Del-->
- [@ohos.app.ability.quickFixManager](arkts-app-ability-quickfixmanager.md)<!--DelEnd-->
  <!--Del-->
...
- [@ohos.app.agent.AgentExtensionAbility](arkts-app-agent-agentextensionability.md)
  - [AgentExtensionAbility](arkts-ability-appagentagentextensionability-agentextensionability-c.md)
  <!--Del-->
  - [AgentExtensionAbility(系统接口)](arkts-ability-appagentagentextensionability-agentextensionability-c-sys.md)<!--DelEnd-->
- [@ohos.app.agent.AgentUIExtensionAbility](arkts-app-agent-agentuiextensionability.md)
  - [AgentUIExtensionAbility](arkts-ability-appagentagentuiextensionability-agentuiextensionability-c.md)
- [@ohos.app.agent.agentConstant](arkts-app-agent-agentconstant.md)
  ...
  <!--Del-->
  - [AgentCardType(系统接口)](arkts-ability-agentconstant-agentcardtype-e-sys.md)<!--DelEnd-->
<!--Del-->
- [@ohos.app.agent.agentManager](arkts-app-agent-agentmanager.md)<!--DelEnd-->
  <!--Del-->
  - [connectAgentExtensionAbility(系统接口)](arkts-ability-agentmanager-connectagentextensionability-f-sys.md)<!--DelEnd-->
  <!--Del-->
  - [connectServiceExtensionAbility(系统接口)](arkts-ability-agentmanager-connectserviceextensionability-f-sys.md)<!--DelEnd-->
  <!--Del-->
  - [deleteAgentCard(系统接口)](arkts-ability-agentmanager-deleteagentcard-f-sys.md)<!--DelEnd-->
  <!--Del-->
  - [disconnectAgentExtensionAbility(系统接口)](arkts-ability-agentmanager-disconnectagentextensionability-f-sys.md)<!--DelEnd-->
  <!--Del-->
  - [disconnectServiceExtensionAbility(系统接口)](arkts-ability-agentmanager-disconnectserviceextensionability-f-sys.md)<!--DelEnd-->
  <!--Del-->
  - [getAgentCardByAgentId(系统接口)](arkts-ability-agentmanager-getagentcardbyagentid-f-sys.md)<!--DelEnd-->
  <!--Del-->
  - [getAgentCardsByBundleName(系统接口)](arkts-ability-agentmanager-getagentcardsbybundlename-f-sys.md)<!--DelEnd-->
  <!--Del-->
  - [getAllAgentCards(系统接口)](arkts-ability-agentmanager-getallagentcards-f-sys.md)<!--DelEnd-->
  <!--Del-->
  - [notifyLowCodeAgentComplete(系统接口)](arkts-ability-agentmanager-notifylowcodeagentcomplete-f-sys.md)<!--DelEnd-->
  <!--Del-->
...
- [@ohos.app.appstartup.StartupConfig](arkts-app-appstartup-startupconfig.md)
  - [StartupConfig](arkts-ability-appappstartupstartupconfig-startupconfig-i.md)
- [@ohos.app.appstartup.StartupConfigEntry](arkts-app-appstartup-startupconfigentry.md)
  - [StartupConfigEntry](arkts-ability-appappstartupstartupconfigentry-startupconfigentry-c.md)
- [@ohos.app.appstartup.StartupListener](arkts-app-appstartup-startuplistener.md)
  - [StartupListener](arkts-ability-appappstartupstartuplistener-startuplistener-c.md)
  - [OnCompletedFn](arkts-ability-oncompletedfn-t.md)
- [@ohos.app.appstartup.StartupTask](arkts-app-appstartup-startuptask.md)
  - [StartupTask](arkts-ability-appappstartupstartuptask-startuptask-c.md)
...
<!--Del-->
- [@ohos.app.businessAbilityRouter](arkts-app-businessabilityrouter.md)<!--DelEnd-->
  <!--Del-->
  - [queryBusinessAbilityInfo(系统接口)](arkts-ability-businessabilityrouter-querybusinessabilityinfo-f-sys.md)<!--DelEnd-->
  <!--Del-->
  - [BusinessAbilityFilter(系统接口)](arkts-ability-businessabilityrouter-businessabilityfilter-i-sys.md)<!--DelEnd-->
  <!--Del-->
  - [BusinessAbilityInfo(系统接口)](arkts-ability-businessabilityrouter-businessabilityinfo-t-sys.md)<!--DelEnd-->
  <!--Del-->
  - [BusinessType(系统接口)](arkts-ability-businessabilityrouter-businesstype-e-sys.md)<!--DelEnd-->
<!--Del-->
- [@ohos.app.cli.cliManager](arkts-app-cli-climanager.md)<!--DelEnd-->
  <!--Del-->
  - [clearSession(系统接口)](arkts-ability-climanager-clearsession-f-sys.md)<!--DelEnd-->
  <!--Del-->
  - [execCmd(系统接口)](arkts-ability-climanager-execcmd-f-sys.md)<!--DelEnd-->
  <!--Del-->
  - [execTool(系统接口)](arkts-ability-climanager-exectool-f-sys.md)<!--DelEnd-->
  <!--Del-->
  - [getToolInfoByName(系统接口)](arkts-ability-climanager-gettoolinfobyname-f-sys.md)<!--DelEnd-->
  <!--Del-->
  - [querySession(系统接口)](arkts-ability-climanager-querysession-f-sys.md)<!--DelEnd-->
  <!--Del-->
  ...
  <!--Del-->
  - [sendMessage(系统接口)](arkts-ability-climanager-sendmessage-f-sys.md)<!--DelEnd-->
  <!--Del-->
  - [subscribeSession(系统接口)](arkts-ability-climanager-subscribesession-f-sys.md)<!--DelEnd-->
  <!--Del-->
  - [CliSessionInfo(系统接口)](arkts-ability-climanager-clisessioninfo-i-sys.md)<!--DelEnd-->
  <!--Del-->
  - [ExecCmdOptions(系统接口)](arkts-ability-climanager-execcmdoptions-i-sys.md)<!--DelEnd-->
  <!--Del-->
  - [ExecOptions(系统接口)](arkts-ability-climanager-execoptions-i-sys.md)<!--DelEnd-->
  <!--Del-->
  - [ExecResult(系统接口)](arkts-ability-climanager-execresult-i-sys.md)<!--DelEnd-->
  <!--Del-->
...
- [@ohos.application.Configuration](arkts-application-configuration.md)
  - [Configuration](arkts-ability-applicationconfiguration-configuration-depr-i.md)
...
- [@ohos.application.Want](arkts-application-want.md)
  - [Want](arkts-ability-applicationwant-want-depr-c.md)
<!--Del-->
...
<!--Del-->
- [@ohos.bundle.appControl](arkts-bundle-appcontrol.md)<!--DelEnd-->
  <!--Del-->
...
<!--Del-->
- [@ohos.bundle.bundleMonitor](arkts-bundle-bundlemonitor.md)<!--DelEnd-->
  <!--Del-->
  - [off_BundleChangedEvent(系统接口)](arkts-ability-bundlemonitor-offbundlechangedevent-f-sys.md)<!--DelEnd-->
  <!--Del-->
  ...
  <!--Del-->
  - [on_BundleChangedEvent(系统接口)](arkts-ability-bundlemonitor-onbundlechangedevent-f-sys.md)<!--DelEnd-->
  <!--Del-->
...
<!--Del-->
- [@ohos.bundle.bundleResourceManager](arkts-bundle-bundleresourcemanager.md)<!--DelEnd-->
  <!--Del-->
...
<!--Del-->
- [@ohos.bundle.distributedBundleManager](arkts-bundle-distributedbundlemanager.md)<!--DelEnd-->
  <!--Del-->
...
<!--Del-->
- [@ohos.bundle.innerBundleManager](arkts-bundle-innerbundlemanager.md)<!--DelEnd-->
  - [innerBundleManager](arkts-ability-innerbundlemanager-n.md)
    ...
    <!--Del-->
    - [off_BundleStatusChange(系统接口)](arkts-ability-innerbundlemanager-offbundlestatuschange-f-sys.md)<!--DelEnd-->
    <!--Del-->
    - [on_BundleStatusChange(系统接口)](arkts-ability-innerbundlemanager-onbundlestatuschange-f-sys.md)<!--DelEnd-->
  <!--Del-->
  - [BundleStatusCallback(系统接口)](arkts-ability-bundlestatuscallback-t-sys.md)<!--DelEnd-->
<!--Del-->
- [@ohos.bundle.installer](arkts-bundle-installer.md)<!--DelEnd-->
  <!--Del-->
...
- [@ohos.bundle.shortcutManager](arkts-bundle-shortcutmanager.md)
  ...
  <!--Del-->
  - [addDynamicShortcutInfos(系统接口)](arkts-ability-shortcutmanager-adddynamicshortcutinfos-f-sys.md)<!--DelEnd-->
  <!--Del-->
  - [deleteDesktopShortcutInfo(系统接口)](arkts-ability-shortcutmanager-deletedesktopshortcutinfo-f-sys.md)<!--DelEnd-->
  <!--Del-->
  - [deleteDynamicShortcutInfos(系统接口)](arkts-ability-shortcutmanager-deletedynamicshortcutinfos-f-sys.md)<!--DelEnd-->
  <!--Del-->
...
- [@ohos.continuation.continuationManager](arkts-continuation-continuationmanager.md)
  - [off_deviceConnect](arkts-ability-continuationmanager-offdeviceconnect-f.md)
  - [off_deviceDisconnect](arkts-ability-continuationmanager-offdevicedisconnect-f.md)
  - [off_deviceSelected](arkts-ability-continuationmanager-offdeviceselected-f.md)
  - [off_deviceUnselected](arkts-ability-continuationmanager-offdeviceunselected-f.md)
  - [on_deviceConnect](arkts-ability-continuationmanager-ondeviceconnect-f.md)
  - [on_deviceDisconnect](arkts-ability-continuationmanager-ondevicedisconnect-f.md)
  - [on_deviceSelected](arkts-ability-continuationmanager-ondeviceselected-f.md)
  - [on_deviceUnselected](arkts-ability-continuationmanager-ondeviceunselected-f.md)
...
<!--Del-->
- [@ohos.distributedBundle](arkts-distributedbundle.md)<!--DelEnd-->
  <!--Del-->
...
<!--Del-->
- [@ohos.distributedMissionManager](arkts-distributedmissionmanager.md)<!--DelEnd-->
  <!--Del-->
  - [continueMission(系统接口)](arkts-ability-distributedmissionmanager-continuemission-f-sys.md)<!--DelEnd-->
  <!--Del-->
  - [off_continueStateChange(系统接口)](arkts-ability-distributedmissionmanager-offcontinuestatechange-f-sys.md)<!--DelEnd-->
  <!--Del-->
  - [offContinueStateChange(系统接口)](arkts-ability-distributedmissionmanager-offcontinuestatechange-f-sys.md)<!--DelEnd-->
  <!--Del-->
  - [on_continueStateChange(系统接口)](arkts-ability-distributedmissionmanager-oncontinuestatechange-f-sys.md)<!--DelEnd-->
  <!--Del-->
...
- [@ohos.privacyManager](arkts-privacymanager.md)
  ...
  <!--Del-->
  - [off_activeStateChange(系统接口)](arkts-ability-privacymanager-offactivestatechange-f-sys.md)<!--DelEnd-->
  <!--Del-->
  - [offActiveStateChange(系统接口)](arkts-ability-privacymanager-offactivestatechange-f-sys.md)<!--DelEnd-->
  <!--Del-->
  - [on_activeStateChange(系统接口)](arkts-ability-privacymanager-onactivestatechange-f-sys.md)<!--DelEnd-->
  <!--Del-->
...
- application<!--arkts-abilitykit-application-->
  ...
  <!--Del-->
  - [AbilityFirstFrameStateObserver](arkts-abilityfirstframestateobserver.md)<!--DelEnd-->
    <!--Del-->
  ...
  <!--Del-->
  - [AgentExtensionConnectCallback](arkts-agentextensionconnectcallback.md)<!--DelEnd-->
    <!--Del-->
    - [AgentExtensionConnectCallback(系统接口)](arkts-ability-agentextensionconnectcallback-i-sys.md)<!--DelEnd-->
  ...
  <!--Del-->
  - [AgentProxy](arkts-agentproxy.md)<!--DelEnd-->
    <!--Del-->
    - [AgentProxy(系统接口)](arkts-ability-agentproxy-i-sys.md)<!--DelEnd-->
  <!--Del-->
  ...
  <!--Del-->
  - [AutoFillPopupConfig](arkts-autofillpopupconfig.md)<!--DelEnd-->
    <!--Del-->
    - [AutoFillPopupConfig(系统接口)](arkts-ability-autofillpopupconfig-i-sys.md)<!--DelEnd-->
    <!--Del-->
  ...
  <!--Del-->
  - [AutoFillTriggerType](arkts-autofilltriggertype.md)<!--DelEnd-->
    <!--Del-->
  ...
  <!--Del-->
  - [AutoStartupCallback](arkts-autostartupcallback.md)<!--DelEnd-->
    <!--Del-->
  ...
  <!--Del-->
  - [ContinuableInfo](arkts-continuableinfo.md)<!--DelEnd-->
    <!--Del-->
    - [ContinuableInfo(系统接口)](arkts-ability-continuableinfo-i-sys.md)<!--DelEnd-->
  <!--Del-->
  - [ContinueCallback](arkts-continuecallback.md)<!--DelEnd-->
    <!--Del-->
    - [ContinueCallback(系统接口)](arkts-ability-continuecallback-i-sys.md)<!--DelEnd-->
    <!--Del-->
    - [OnContinueDoneCallback(系统接口)](arkts-ability-oncontinuedonecallback-t-sys.md)<!--DelEnd-->
  <!--Del-->
  - [ContinueDeviceInfo](arkts-continuedeviceinfo.md)<!--DelEnd-->
    <!--Del-->
    - [ContinueDeviceInfo(系统接口)](arkts-ability-continuedeviceinfo-i-sys.md)<!--DelEnd-->
  <!--Del-->
  - [ContinueMissionInfo](arkts-continuemissioninfo.md)<!--DelEnd-->
    <!--Del-->
  ...
  <!--Del-->
  - [MissionCallbacks](arkts-missioncallbacks.md)<!--DelEnd-->
    <!--Del-->
    - [MissionCallback(系统接口)](arkts-ability-missioncallbacks-missioncallback-i-sys.md)<!--DelEnd-->
    <!--Del-->
  ...
  <!--Del-->
  - [RunningAppClone](arkts-runningappclone.md)<!--DelEnd-->
    <!--Del-->
    - [RunningAppClone(系统接口)](arkts-ability-runningappclone-i-sys.md)<!--DelEnd-->
  <!--Del-->
  - [RunningMultiAppInfo](arkts-runningmultiappinfo.md)<!--DelEnd-->
    <!--Del-->
    - [RunningMultiAppInfo(系统接口)](arkts-ability-runningmultiappinfo-i-sys.md)<!--DelEnd-->
  <!--Del-->
  - [RunningMultiInstanceInfo](arkts-runningmultiinstanceinfo.md)<!--DelEnd-->
    <!--Del-->
  ...
  - [ToolEventCallback](arkts-tooleventcallback.md)<!--DelEnd-->
    <!--Del-->
    - [ToolEventCallback(系统接口)](arkts-ability-tooleventcallback-i-sys.md)<!--DelEnd-->
    <!--Del-->
    - [OnEventFn(系统接口)](arkts-ability-oneventfn-t-sys.md)<!--DelEnd-->
  <!--Del-->
  - [ToolInfo](arkts-toolinfo.md)<!--DelEnd-->
    <!--Del-->
    - [SubCommandInfo(系统接口)](arkts-ability-toolinfo-subcommandinfo-i-sys.md)<!--DelEnd-->
    <!--Del-->
    - [ToolInfo(系统接口)](arkts-ability-toolinfo-i-sys.md)<!--DelEnd-->
    <!--Del-->
    - [ToolSummary(系统接口)](arkts-ability-toolinfo-toolsummary-i-sys.md)<!--DelEnd-->
  ...
  <!--Del-->
  - [ViewData](arkts-viewdata.md)<!--DelEnd-->
    <!--Del-->
...
- bundle<!--arkts-abilitykit-bundle-->
  <!--Del-->
  - [PermissionDef](arkts-permissiondef.md)<!--DelEnd-->
    <!--Del-->
  ...
  <!--Del-->
  - [bundleInstaller](arkts-bundleinstaller.md)<!--DelEnd-->
    <!--Del-->
    - [BundleInstaller(系统接口)](arkts-ability-bundleinstaller-bundleinstaller-depr-i-sys.md)<!--DelEnd-->
    <!--Del-->
    - [InstallParam(系统接口)](arkts-ability-bundleinstaller-installparam-depr-i-sys.md)<!--DelEnd-->
    <!--Del-->
    - [InstallStatus(系统接口)](arkts-ability-bundleinstaller-installstatus-depr-i-sys.md)<!--DelEnd-->
  <!--Del-->
  - [bundleStatusCallback](arkts-bundlestatuscallback.md)<!--DelEnd-->
    <!--Del-->
  ...
  <!--Del-->
  - [launcherAbilityInfo](arkts-launcherabilityinfo.md)<!--DelEnd-->
    <!--Del-->
  ...
  <!--Del-->
  - [remoteAbilityInfo](arkts-remoteabilityinfo.md)<!--DelEnd-->
    <!--Del-->
...
- bundleManager<!--arkts-abilitykit-bundleManager-->
  ...
  <!--Del-->
  - [AppProvisionInfo](arkts-appprovisioninfo.md)<!--DelEnd-->
    <!--Del-->
  ...
  <!--Del-->
  - [BundlePackInfo](arkts-bundlepackinfo.md)<!--DelEnd-->
    <!--Del-->
    - [AbilityFormInfo(系统接口)](arkts-ability-bundlepackinfo-abilityforminfo-i-sys.md)<!--DelEnd-->
    <!--Del-->
    - [ApiVersion(系统接口)](arkts-ability-bundlepackinfo-apiversion-i-sys.md)<!--DelEnd-->
    <!--Del-->
    - [BundleConfigInfo(系统接口)](arkts-ability-bundlepackinfo-bundleconfiginfo-i-sys.md)<!--DelEnd-->
    <!--Del-->
    - [BundlePackInfo(系统接口)](arkts-ability-bundlepackinfo-i-sys.md)<!--DelEnd-->
    <!--Del-->
    - [ExtensionAbility(系统接口)](arkts-ability-bundlepackinfo-extensionability-i-sys.md)<!--DelEnd-->
    <!--Del-->
    - [ModuleAbilityInfo(系统接口)](arkts-ability-bundlepackinfo-moduleabilityinfo-i-sys.md)<!--DelEnd-->
    <!--Del-->
    - [ModuleConfigInfo(系统接口)](arkts-ability-bundlepackinfo-moduleconfiginfo-i-sys.md)<!--DelEnd-->
    <!--Del-->
    - [ModuleDistroInfo(系统接口)](arkts-ability-bundlepackinfo-moduledistroinfo-i-sys.md)<!--DelEnd-->
    <!--Del-->
    - [PackageConfig(系统接口)](arkts-ability-bundlepackinfo-packageconfig-i-sys.md)<!--DelEnd-->
    <!--Del-->
    - [PackageSummary(系统接口)](arkts-ability-bundlepackinfo-packagesummary-i-sys.md)<!--DelEnd-->
    <!--Del-->
    - [Version(系统接口)](arkts-ability-bundlepackinfo-version-i-sys.md)<!--DelEnd-->
  <!--Del-->
  - [BundleResourceInfo](arkts-bundleresourceinfo.md)<!--DelEnd-->
    <!--Del-->
    - [BundleResourceInfo(系统接口)](arkts-ability-bundleresourceinfo-i-sys.md)<!--DelEnd-->
  <!--Del-->
  - [DispatchInfo](arkts-dispatchinfo.md)<!--DelEnd-->
    <!--Del-->
  ...
  <!--Del-->
  - [LauncherAbilityResourceInfo](arkts-launcherabilityresourceinfo.md)<!--DelEnd-->
    <!--Del-->
  ...
  <!--Del-->
  - [PluginBundleInfo](arkts-pluginbundleinfo.md)<!--DelEnd-->
    <!--Del-->
  ...
  <!--Del-->
  - [RecoverableApplicationInfo](arkts-recoverableapplicationinfo.md)<!--DelEnd-->
    <!--Del-->
  ...
  <!--Del-->
  - [SharedBundleInfo](arkts-sharedbundleinfo.md)<!--DelEnd-->
    <!--Del-->
  ...
  <!--Del-->
  - [ShortcutInfo](arkts-shortcutinfo.md)<!--DelEnd-->
    <!--Del-->
