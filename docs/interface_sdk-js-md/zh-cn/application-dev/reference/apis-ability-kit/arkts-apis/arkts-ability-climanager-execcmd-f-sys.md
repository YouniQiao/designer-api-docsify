...
| execCmdOptions | [ExecCmdOptions](arkts-ability-climanager-execcmdoptions-i-sys.md) | 否 | 执行命令的可选参数。默认值：详见[ExecCmdOptions](arkts-ability-climanager-execcmdoptions-i-sys.md#ExecCmdOptions（系统接口）)的具体属性 默认值。 |
