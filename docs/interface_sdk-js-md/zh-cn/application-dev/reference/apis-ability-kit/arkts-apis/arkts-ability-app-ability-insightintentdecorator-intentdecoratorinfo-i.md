...
- 当取值为\_\_\_MD\_LINK\_DESC\_USD\_0\_\_\_时，表示图标读取本地资源。
...
表示接入的标准意图的名称。开发者\_\_\_MD\_LINK\_DESC\_USD\_0\_\_\_时，需要配置该字段，  
\_\_\_MD\_LINK\_DESC\_USD\_1\_\_\_时，无需配置该字段。标准意图列表参见  
