...
- **[SelectedResult](arkts-ability-abilityaccessctrl-selectedresult-e.md#SelectedResult)：** 设置页授权选择结果枚举，用于表示用户在权限设置弹窗中的选择结果。
...
**类型：** [CliInfo](arkts-ability-abilityaccessctrl-cliinfo-i-sys.md)
