...
LinkIntentDecoratorInfo继承自[IntentDecoratorInfo](arkts-ability-appabilityinsightintentdecorator-intentdecoratorinfo-i.md)，用于描述 @InsightIntentLink 装饰器支持的参数，例如应用间跳转需要的uri信息。

**继承/实现关系：** LinkIntentDecoratorInfo extends [IntentDecoratorInfo](arkts-ability-appabilityinsightintentdecorator-intentdecoratorinfo-i.md)
...
**类型：** [LinkIntentParamMapping](../../apis-default/arkts-apis/arkts-appabilityinsightintentdecorator-linkintentparammapping-i.md)[]
