...
| [ShowMode](arkts-ability-wantconstant-showmode-e.md) | 表示[EmbeddableUIAbility](arkts-ability-appabilityembeddableuiability-embeddableuiability-c.md)被拉起时的显示模式。 |
