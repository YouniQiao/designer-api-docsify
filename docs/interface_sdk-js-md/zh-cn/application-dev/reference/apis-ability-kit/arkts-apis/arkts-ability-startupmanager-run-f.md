...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| startupTasks | Array&lt;string&gt; | 是 | 表示准备执行的启动任务 [StartupTask](../../apis-default/arkts-apis/arkts-app-appstartup-startuptask-startuptask-c.md)的名称或预加载so名称的数组。 |
...
| --- | --- | --- | --- |
| startupTasks | Array&lt;string&gt; | 是 | 表示准备执行的启动任务 [StartupTask](../../apis-default/arkts-apis/arkts-app-appstartup-startuptask-startuptask-c.md)的名称或预加载so名称的数组。 |
| context | common.AbilityStageContext | 是 | 表示执行启动任务 [StartupTask](../../apis-default/arkts-apis/arkts-app-appstartup-startuptask-startuptask-c.md)的AbilityStage上下文，作为入参传给启动任务的 [init](../../apis-default/arkts-apis/arkts-app-appstartup-startuptask-startuptask-c.md#init)。 |
