...
调用此接口前，请确保应用已开启锁屏下敏感数据保护功能，并且先调用[acquireAccess]\_\_\_JSDOC\_LINK\_DESC\_USD\_0\_\_\_接口成功申请权限后才能使用。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| dataType | \_\_\_MD\_LINK\_USD\_0\_\_\_ | 是 | 锁屏下访问的敏感数据类型。dataType需要与acquireAccess接口使用的dataType保持一致。 |

**返回值：**

| 类型 | 说明 |
| --- | --- |
| \_\_\_MD\_LINK\_USD\_0\_\_\_ | 锁屏下敏感数据访问权限的释放状态。 |
