...
| flag | [wantConstant.Flags](arkts-ability-wantconstant-flags-e.md) | 是 | URI的读权限或写权限。支持的取值如下：   - FLAG_AUTH_READ_URI_PERMISSION：读权限。   - FLAG_AUTH_WRITE_URI_PERMISSION：写权限。 |
