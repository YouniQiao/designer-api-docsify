...
进程数据的对象定义。使用接口  
[appManager.on('applicationState')]\_\_\_JSDOC\_LINK\_DESC\_USD\_1\_\_\_注册生命周期变化监听后，当应用或组件的生命周期变化时，系统通过[ApplicationStateObserver]\_\_\_JSDOC\_LINK\_DESC\_USD\_2\_\_\_的  
\_\_\_MD\_LINK\_DESC\_USD\_0\_\_\_等方法回调给开发者。
