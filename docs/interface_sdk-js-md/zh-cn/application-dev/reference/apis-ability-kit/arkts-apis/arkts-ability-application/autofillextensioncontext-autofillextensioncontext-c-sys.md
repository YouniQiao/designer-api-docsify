...
**继承/实现关系：** AutoFillExtensionContext extends [ExtensionContext](extensioncontext-extensioncontext-c.md)
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| customData | \_\_\_MD\_LINK\_USD\_0\_\_\_ | 是 | 拉起模态页面时的自定义信息。 |
