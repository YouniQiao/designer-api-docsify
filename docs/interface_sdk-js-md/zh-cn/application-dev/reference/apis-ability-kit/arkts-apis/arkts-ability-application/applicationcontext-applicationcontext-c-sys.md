...
ApplicationContext作为应用上下文，继承自[Context]\_\_\_JSDOC\_LINK\_DESC\_USD\_0\_\_\_，提供了应用生命周期监听、进程管理、应用环境设置等应用级别的管控能力。
    **说明：**  
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| want | \_\_\_MD\_LINK\_USD\_0\_\_\_ | 是 | Indicates the want of target UIExtensionAbility. |
