...
本模块提供监听指定[UIAbility]\_\_\_JSDOC\_LINK\_DESC\_USD\_0\_\_\_生命周期状态变化的能力。开发者可以将AbilityMonitor作为  
[abilityDelegator.addAbilityMonitor]\_\_\_JSDOC\_LINK\_DESC\_USD\_1\_\_\_的入参来注册监听。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| ability | \_\_\_MD\_LINK\_USD\_0\_\_\_ | 是 |  |
