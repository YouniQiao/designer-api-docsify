...
> **说明：**  
>  
> - 只有在进程首次执行[AbilityStage.onCreate](arkts-ability-abilitystage-c.md#oncreate-1)完成之前调用该接口，才可以返回真实的预  
> 加载类型。  
>  
...
| 类型 | 说明 |
| --- | --- |
| [AppPreloadType](arkts-ability-apppreloadtype-e.md) | 应用当前进程的预加载类型。 |
