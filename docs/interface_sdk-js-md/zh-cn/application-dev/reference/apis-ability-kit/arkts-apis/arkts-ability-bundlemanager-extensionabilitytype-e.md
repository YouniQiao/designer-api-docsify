...
[BackupExtensionAbility](../../apis-core-file-kit/arkts-apis/arkts-application-backupextensionability.md)：数据备份扩展能力，提供应用数据的备份恢复能力。
...
不指定类型<!--Del-->，配合[queryExtensionAbilityInfo接口](arkts-ability-bundlemanager-queryextensionabilityinfo-f-sys.md#queryextensionabilityinfo)可以查询所有类型的ExtensionAbility<!--DelEnd-->。
