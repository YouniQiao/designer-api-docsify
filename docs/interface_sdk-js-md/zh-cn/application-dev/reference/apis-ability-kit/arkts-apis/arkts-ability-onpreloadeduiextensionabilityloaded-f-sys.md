...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | [PreloadedUIExtensionAbilityLoadedFn](arkts-ability-preloadeduiextensionabilityloadedfn-t-sys.md) | 是 | 用于接收被加载的预加载[UIExtensionAbility](arkts-ability-uiextensionability-c.md)实例ID的回调函数。 |
