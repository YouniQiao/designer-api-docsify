...
| 参数名 | 类型 | 必填 |
| --- | --- | --- |
| missionIds | ArkTS-Dyn: Array & lt;number & gt;<br>ArkTS-Sta：Array & lt;int & gt; | 是 |
...
| --- | --- | --- |
| missionIds | ArkTS-Dyn: Array & lt;number & gt;<br>ArkTS-Sta：Array & lt;int & gt; | 是 |
| topMission | ArkTS-Dyn: number<br>ArkTS-Sta：int | 是 |
| callback | AsyncCallback & lt;void & gt; | 是 |
...
| --- | --- | --- |
| missionIds | ArkTS-Dyn: Array & lt;number & gt;<br>ArkTS-Sta：Array & lt;int & gt; | 是 |
| topMission | ArkTS-Dyn: number<br>ArkTS-Sta：int | 否 |
