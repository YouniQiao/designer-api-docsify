...
创建指定模块的上下文。创建出的模块上下文中[resourceManager.Configuration]\_\_\_JSDOC\_LINK\_DESC\_USD\_1\_\_\_资源继承自入参上下文，便于开发者获取\_\_\_MD\_LINK\_DESC\_USD\_0\_\_\_。使用Promise异步回调。
    **说明：**  
