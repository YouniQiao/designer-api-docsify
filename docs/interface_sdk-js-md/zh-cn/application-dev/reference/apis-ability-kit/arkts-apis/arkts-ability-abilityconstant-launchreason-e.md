...
Ability启动原因，该类型为枚举，可配合UIAbility的[onCreate(want, launchParam)]\_\_\_JSDOC\_LINK\_DESC\_USD\_0\_\_\_方法根据launchParam.launchReason的不同类型执行相应操作。
...
通过  
[startAbility]\_\_\_JSDOC\_LINK\_DESC\_USD\_0\_\_\_接口启动Ability。
