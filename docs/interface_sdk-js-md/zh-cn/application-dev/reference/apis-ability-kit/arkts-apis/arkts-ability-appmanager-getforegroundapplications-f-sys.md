...
获取当前所有前台应用的信息。该应用信息由[AppStateData]\_\_\_JSDOC\_LINK\_DESC\_USD\_0\_\_\_定义。使用callback异步回调。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | \_\_\_MD\_LINK\_USD\_0\_\_\_&lt;Array&lt;AppStateData&gt;&gt; | 是 | 以回调方式返回接口运行结果及应用状态数据数组，可进行错误处理或其他自定义处理。 |
...
获取当前所有前台应用的信息。该应用信息由[AppStateData]\_\_\_JSDOC\_LINK\_DESC\_USD\_0\_\_\_定义。使用Promise异步回调。
