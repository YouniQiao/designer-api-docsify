...
**替代接口：** [on](ohos.app.ability.appManager/appManager#on)
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| observer | [ApplicationStateObserver](arkts-ability-applicationstateobserver-i.md) | 是 | 表示程序状态观测器，用于观测应用的生命周期变化。 |
