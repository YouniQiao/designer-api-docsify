...
定义应用启动和退出的状态监听，可以作为 [appManager.on('appForegroundState')](arkts-ability-appmanager-onapplicationstate-f.md#on_applicationstateapplicationstate) 的入参监听所有应用的启动和退出的变化。
