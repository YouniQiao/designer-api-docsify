...
| resourceFlags | int | 是 | 指定返回的LauncherAbilityResourceInfo所包含的信息，取值为 [ResourceFlag](arkts-ability-bundleresourcemanager-resourceflag-e-sys.md#resourceflag系统接口)枚举值，不支持取值 [ResourceFlag](arkts-ability-bundleresourcemanager-resourceflag-e-sys.md#resourceflag系统接口).GET_RESOURCE_INFO_WITH_SORTED_BY_LABEL和 [ResourceFlag](arkts-ability-bundleresourcemanager-resourceflag-e-sys.md#resourceflag系统接口).GET_RESOURCE_INFO_ONLY_WITH_MAIN_ABILITY。 |
