...
使能当前用户下的动态图标信息时需要申请权限ohos.permission.ACCESS\_DYNAMIC\_ICON。

使能其他用户下的动态图标信息时需要申请权限ohos.permission.ACCESS\_DYNAMIC\_ICON 和 ohos.permission.INTERACT\_ACROSS\_LOCAL\_ACCOUNTS。
