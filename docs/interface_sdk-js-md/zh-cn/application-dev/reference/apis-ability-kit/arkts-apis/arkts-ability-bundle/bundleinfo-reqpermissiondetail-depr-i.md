# ReqPermissionDetail
    ...
    **说明：**  
    ...
    从API version 7开始支持，从API version 9开始废弃，建议使用[ReqPermissionDetail]\_\_\_JSDOC\_LINK\_DESC\_USD\_0\_\_\_替代。
...
**替代接口：** [bundleInfo](../arkts-ability-bundlemanager/bundleinfo-bundleinfo-i.md)
