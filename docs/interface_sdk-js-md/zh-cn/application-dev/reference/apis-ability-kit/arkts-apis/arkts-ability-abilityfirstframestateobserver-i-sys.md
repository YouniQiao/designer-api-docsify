...
定义了Ability首帧绘制完成事件监听对象，可以作为[on](arkts-ability-on-f-sys.md#on-5)的入参，用于监听Ability首帧绘制完成事件。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| data | [AbilityFirstFrameStateData](arkts-ability-abilityfirstframestatedata-t-sys.md) | 是 | 表示首帧绘制完成时返回的数据。 |
