...
启动\_\_\_MD\_LINK\_DESC\_USD\_0\_\_\_。使用Promise异步回调。该接口在Tablet、PC/2in1中可正常调用，在其他设备类型中返回16000061错误码。
    **说明：**  
    ...
    调用该接口创建子进程成功会返回子进程pid，然后执行子进程的[ChildProcess.onStart]\_\_\_JSDOC\_LINK\_DESC\_USD\_1\_\_\_函数  
    ，[ChildProcess.onStart]\_\_\_JSDOC\_LINK\_DESC\_USD\_2\_\_\_函数执行完后子进程会自动销毁。  
