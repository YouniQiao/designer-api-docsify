...
| appIndex | number | 否 | 表示应用索引。取值范围0~5的整数，取值为0表示主应用，取值1~5表示分身应用的索引。默认值：0 |

**返回值：**

| 类型 | 说明 |
| --- | --- |
| Array&lt;[ShortcutInfo](arkts-ability-shortcutmanager-shortcutinfo-t.md)&gt; | Array形式返回指定用户下指定UIAbility的[ShortcutInfo]{ |
