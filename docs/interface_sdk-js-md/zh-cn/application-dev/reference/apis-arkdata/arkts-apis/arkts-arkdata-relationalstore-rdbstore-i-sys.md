...
| progress | [Callback](../../apis-arkui/arkts-components/arkts-arkui-callback-i.md)&lt;ProgressDetails&gt; | 是 | 用来处理数据库同步详细信息的回调函数。 |
...
| callback | [AsyncCallback](../../apis-basic-service-kit/arkts-apis/arkts-basicservices-base-asynccallback-i.md)&lt;number&gt; | 是 | 回调函数。当删除数据成功，err为undefined，data为受影响的行数量；否则为错误对象。 |
...
| callback | [AsyncCallback](../../apis-basic-service-kit/arkts-apis/arkts-basicservices-base-asynccallback-i.md)&lt;number&gt; | 是 | 回调函数。返回受影响的行数。 |
