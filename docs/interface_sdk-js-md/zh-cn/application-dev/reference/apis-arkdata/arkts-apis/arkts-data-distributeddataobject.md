...
| 名称 | 说明 |
| --- | --- |
| [create](arkts-arkdata-distributeddataobject-create-f.md) | 创建一个分布式数据对象。对象属性支持基本类型（数字类型、布尔类型和字符串类型）以及复杂类型（数组、基本类型嵌套）。 |
| [createDistributedObject](arkts-arkdata-distributeddataobject-createdistributedobject-f.md) | 创建一个分布式数据对象。 |
| [genSessionId](arkts-arkdata-distributeddataobject-gensessionid-f.md) | 随机创建一个sessionId。 |
...
| [DistributedObject](arkts-arkdata-distributeddataobject-distributedobject-i.md) | 表示一个分布式数据对象。在使用以下接口前，需调用[createDistributedObject()](arkts-arkdata-distributeddataobject-createdistributedobject-f.md)获取 DistributedObject对象。 |
