...
下列接口都需先使用[preferences.getPreferences]\_\_\_JSDOC\_LINK\_DESC\_USD\_0\_\_\_获取到Preferences实例，再通过此实例调用对应接口。
...
清除缓存的Preferences实例中的所有数据，可通过[flush]\_\_\_JSDOC\_LINK\_DESC\_USD\_0\_\_\_将Preferences实例持久化，使用callback异步回调。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | \_\_\_MD\_LINK\_USD\_0\_\_\_&lt;void&gt; | 是 | 回调函数。当清除成功，err为undefined；否则为错误对象。 |
...
清除缓存的Preferences实例中的所有数据，可通过[flush]\_\_\_JSDOC\_LINK\_DESC\_USD\_0\_\_\_将Preferences实例持久化，使用Promise异步回调。
...
清除缓存的Preferences实例中的所有数据，可通过[flush]\_\_\_JSDOC\_LINK\_DESC\_USD\_0\_\_\_将Preferences实例持久化，此为同步接口。
...
从缓存的Preferences实例中删除名为给定Key的存储键值对，可通过[flush]\_\_\_JSDOC\_LINK\_DESC\_USD\_0\_\_\_将Preferences实例持久化，使用callback异步回调。
...
从缓存的Preferences实例中删除名为给定Key的存储键值对，可通过[flush]\_\_\_JSDOC\_LINK\_DESC\_USD\_0\_\_\_将Preferences实例持久化，使用Promise异步回调。
...
从缓存的Preferences实例中删除名为给定Key的存储键值对，可通过[flush]\_\_\_JSDOC\_LINK\_DESC\_USD\_0\_\_\_将Preferences实例持久化，此为同步接口。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | \_\_\_MD\_LINK\_USD\_0\_\_\_&lt;void&gt; | 是 | 回调函数。当保存成功，err为undefined；否则为错误对象。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| key | string | 是 | 要获取的存储Key名称，不能为空，最大长度限制为 \_\_\_ESCAPED\_UNDERSCORE\_\_\_\_\_\_ESCAPED\_UNDERSCORE\_\_\_\_\_\_ESCAPED\_UNDERSCORE\_\_\_MD\_\_\_ESCAPED\_UNDERSCORE\_\_\_LINK\_\_\_ESCAPED\_UNDERSCORE\_\_\_DESC\_\_\_ESCAPED\_UNDERSCORE\_\_\_USD\_\_\_ESCAPED\_UNDERSCORE\_\_\_0\_\_\_ESCAPED\_UNDERSCORE\_\_\_\_\_\_ESCAPED\_UNDERSCORE\_\_\_\_\_\_ESCAPED\_UNDERSCORE\_\_\_。 |
| defValue | \_\_\_MD\_LINK\_USD\_0\_\_\_ | 是 | 默认返回值。 |
| callback | \_\_\_MD\_LINK\_USD\_0\_\_\_&lt;ValueType&gt; | 是 | 回调函数。当获取成功时，err为undefined，data为键对应的值；否则err为错误对象。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | \_\_\_MD\_LINK\_USD\_0\_\_\_&lt;Object&gt; | 是 | 回调函数。当获取成功，err为undefined，value为所有键值数据；否则err为错误对象。 |
...
| 类型 | 说明 |
| --- | --- |
| \_\_\_MD\_LINK\_USD\_0\_\_\_ | 返回键对应的值。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| key | string | 是 | 要检查的存储Key名称，不能为空，最大长度限制为 \_\_\_ESCAPED\_UNDERSCORE\_\_\_\_\_\_ESCAPED\_UNDERSCORE\_\_\_\_\_\_ESCAPED\_UNDERSCORE\_\_\_MD\_\_\_ESCAPED\_UNDERSCORE\_\_\_LINK\_\_\_ESCAPED\_UNDERSCORE\_\_\_DESC\_\_\_ESCAPED\_UNDERSCORE\_\_\_USD\_\_\_ESCAPED\_UNDERSCORE\_\_\_0\_\_\_ESCAPED\_UNDERSCORE\_\_\_\_\_\_ESCAPED\_UNDERSCORE\_\_\_\_\_\_ESCAPED\_UNDERSCORE\_\_\_。 |
| callback | \_\_\_MD\_LINK\_USD\_0\_\_\_&lt;boolean&gt; | 是 | 回调函数。返回Preferences实例是否包含给定Key的存储键值对，true表示存在，false表示不存在。 |
...
| callback | \_\_\_MD\_LINK\_USD\_0\_\_\_&lt;string&gt; | 否 | 需要取消的回调函数，若不填写，表示取消所有已注册的回调函数；若填写，表示只取消指定的回调函数。\_\_\_HTML\_TAG\_USD\_0\_\_\_**起始版本：** 11 |
...
本接口提供给申请了[dataGroupId]\_\_\_JSDOC\_LINK\_DESC\_USD\_0\_\_\_的应用进行使用，未申请的应用不推荐使用（监听不到数据变更），多进程操作可能会损坏持久化文件，导致数据丢失。
...
| callback | \_\_\_MD\_LINK\_USD\_0\_\_\_&lt;Record&lt;string, ValueType&gt;&gt; | 否 | 需要取消的回调函数，若不填写，表示取消所有已注册的回调函数；若填写，表示只取消指定的回调函数。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | \_\_\_MD\_LINK\_USD\_0\_\_\_&lt;string&gt; | 否 | 需要取消的回调函数，若不填写，表示取消所有已注册的回调函数；若填写，表示只取消指定的回调函数。 |
...
订阅数据变更，订阅的Key的值发生变更后，并且在执行[flush]\_\_\_JSDOC\_LINK\_DESC\_USD\_0\_\_\_方法后，触发callback回调。
    **不同订阅方法的对比：**  
    ...
    **选取建议：** 单进程应用推荐使用on('change')或on('dataChange')；多进程数据同步时使用on('multiProcessChange')；需要精确知道特定Key变化并获取新值时使用on('  
    ...
    当调用[removePreferencesFromCache]\_\_\_JSDOC\_LINK\_DESC\_USD\_1\_\_\_或  
    [deletePreferences]\_\_\_JSDOC\_LINK\_DESC\_USD\_2\_\_\_后，订阅的数据变更会主动取消订阅，在重新  
    [getPreferences]\_\_\_JSDOC\_LINK\_DESC\_USD\_3\_\_\_后需要重新订阅数据变更。
...
| --- | --- | --- | --- |
| type | 'change' | 是 | 事件类型，固定值'change'，表示数据变更。 |
| callback | \_\_\_MD\_LINK\_USD\_0\_\_\_&lt;string&gt; | 是 | 回调函数，用于接收数据变更通知，回调参数为Key字符串，表示发生变更的键名称。\_\_\_HTML\_TAG\_USD\_0\_\_\_**起始版本：** 11 |
...
[flush]\_\_\_JSDOC\_LINK\_DESC\_USD\_0\_\_\_方法，持久化文件发生变更后，触发callback回调。

本接口提供给申请了[dataGroupId]\_\_\_JSDOC\_LINK\_DESC\_USD\_1\_\_\_的应用进行使用，未申请的应用不推荐使用（监听不到数据变更），多进程操作可能会损坏持久化文件，导致数据丢失。
    **说明：**  
    
    同一持久化文件在当前进程对多进程数据变更订阅的最大数量为50次，超过最大限制后订阅会失败。建议在触发callback回调后及时取消订阅。  
    
    当调用[removePreferencesFromCache]\_\_\_JSDOC\_LINK\_DESC\_USD\_2\_\_\_或  
    [deletePreferences]\_\_\_JSDOC\_LINK\_DESC\_USD\_3\_\_\_后，订阅的数据变更会主动取消订阅，在重新  
    [getPreferences]\_\_\_JSDOC\_LINK\_DESC\_USD\_4\_\_\_后需要重新订阅数据变更。
...
| --- | --- | --- | --- |
| type | 'multiProcessChange' | 是 | 事件类型，固定值'multiProcessChange'，表示多进程间的数据变更。 |
| callback | \_\_\_MD\_LINK\_USD\_0\_\_\_&lt;string&gt; | 是 | 多进程间数据变更时触发的回调函数，回调参数为发生变更的Key字符串。\_\_\_HTML\_TAG\_USD\_0\_\_\_**起始版本：** 11 |
...
精确订阅数据变更，只有被订阅的Key值发生变更后，在执行[flush]\_\_\_JSDOC\_LINK\_DESC\_USD\_0\_\_\_方法后，触发callback回调。
    **说明：**  
...
| callback | \_\_\_MD\_LINK\_USD\_0\_\_\_&lt;Record&lt;string, ValueType&gt;&gt; | 是 | 回调函数。回调支持返回多个键值对，其中键为发生变更的订阅Key，类型为string；值为变更后的数据，类型为 [ValueType]\_\_\_ESCAPED\_UNDERSCORE\_\_\_\_\_\_ESCAPED\_UNDERSCORE\_\_\_\_\_\_ESCAPED\_UNDERSCORE\_\_\_JSDOC\_\_\_ESCAPED\_UNDERSCORE\_\_\_LINK\_\_\_ESCAPED\_UNDERSCORE\_\_\_DESC\_\_\_ESCAPED\_UNDERSCORE\_\_\_USD\_\_\_ESCAPED\_UNDERSCORE\_\_\_0\_\_\_ESCAPED\_UNDERSCORE\_\_\_\_\_\_ESCAPED\_UNDERSCORE\_\_\_\_\_\_ESCAPED\_UNDERSCORE\_\_\_。 |
...
Registers an observer to listen for the change of a \_\_\_JSDOC\_LINK\_DESC\_USD\_0\_\_\_ object.
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | \_\_\_MD\_LINK\_USD\_0\_\_\_&lt;string&gt; | 是 | 回调函数，用于接收数据变更通知，回调参数为Key字符串，表示发生变更的键名称。 |
...
| --- | --- | --- | --- |
| keys | Array&lt;string&gt; | 是 | 需要订阅的key集合。 |
| callback | \_\_\_MD\_LINK\_USD\_0\_\_\_&lt;Record&lt;string, ValueType&gt;&gt; | 是 | 回调函数。回调支持返回多个键值对，其中键为发生变更的订阅key，类型为string；值为变更后的数据，类型为\_\_\_ESCAPED\_UNDERSCORE\_\_\_\_\_\_ESCAPED\_UNDERSCORE\_\_\_\_\_\_ESCAPED\_UNDERSCORE\_\_\_MD\_\_\_ESCAPED\_UNDERSCORE\_\_\_LINK\_\_\_ESCAPED\_UNDERSCORE\_\_\_DESC\_\_\_ESCAPED\_UNDERSCORE\_\_\_USD\_\_\_ESCAPED\_UNDERSCORE\_\_\_0\_\_\_ESCAPED\_UNDERSCORE\_\_\_\_\_\_ESCAPED\_UNDERSCORE\_\_\_\_\_\_ESCAPED\_UNDERSCORE\_\_\_。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | \_\_\_MD\_LINK\_USD\_0\_\_\_&lt;string&gt; | 是 | 多进程间数据变更时触发的回调函数，回调参数为发生变更的Key字符串。 |
...
将数据写入缓存的Preferences实例中，可通过[flush]\_\_\_JSDOC\_LINK\_DESC\_USD\_0\_\_\_将Preferences实例持久化，使用callback异步回调。
    **说明：**  
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| key | string | 是 | 要修改的存储的Key，不能为空，最大长度限制为 \_\_\_ESCAPED\_UNDERSCORE\_\_\_\_\_\_ESCAPED\_UNDERSCORE\_\_\_\_\_\_ESCAPED\_UNDERSCORE\_\_\_MD\_\_\_ESCAPED\_UNDERSCORE\_\_\_LINK\_\_\_ESCAPED\_UNDERSCORE\_\_\_DESC\_\_\_ESCAPED\_UNDERSCORE\_\_\_USD\_\_\_ESCAPED\_UNDERSCORE\_\_\_0\_\_\_ESCAPED\_UNDERSCORE\_\_\_\_\_\_ESCAPED\_UNDERSCORE\_\_\_\_\_\_ESCAPED\_UNDERSCORE\_\_\_。 |
| value | \_\_\_MD\_LINK\_USD\_0\_\_\_ | 是 | 存储的新值。 |
| callback | \_\_\_MD\_LINK\_USD\_0\_\_\_&lt;void&gt; | 是 | 回调函数。当数据写入成功，err为undefined；否则为错误对象。 |
...
将数据写入缓存的Preferences实例中，可通过[flush]\_\_\_JSDOC\_LINK\_DESC\_USD\_0\_\_\_将Preferences实例持久化，使用Promise异步回调。
    **说明：**  
...
将数据写入缓存的Preferences实例中，可通过[flush]\_\_\_JSDOC\_LINK\_DESC\_USD\_0\_\_\_将Preferences实例持久化，此为同步接口。
    **说明：**  
