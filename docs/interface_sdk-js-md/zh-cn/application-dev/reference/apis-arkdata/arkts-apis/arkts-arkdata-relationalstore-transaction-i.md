...
示例代码中this.context定义见Stage模型的应用[Context](../../apis-ability-kit/arkts-apis/arkts-ability-context-t.md)。
...
此接口不支持执行查询、附加数据库和事务操作，查询可以使用[querySql](arkts-arkdata-relationalstore-transaction-i.md#querysql)、[query](arkts-arkdata-relationalstore-transaction-i.md#query)接口代替、附加数据库可以使用[attach](arkts-arkdata-relationalstore-rdbstore-i.md#attach)接口代替。
...
| 类型 | 说明 |
| --- | --- |
| [ValueType](arkts-arkdata-storage-valuetype-t.md) | 返回sql执行后的结果。 |
