...
| bundleInfos | Array&lt;[BundleInfo](arkts-arkdata-clouddata-bundleinfo-i-sys.md)&gt; | 是 | 批量查询的应用信息数组。取值范围：数组长度为[1, 30]，超过该范围返回14800001错误码。 |
...
| --- | --- | --- | --- |
| accountId | string | 是 | 已登录的云账号ID。 |
| appActions | Record&lt;string, [ClearAction](arkts-arkdata-clouddata-clearaction-e-sys.md)&gt; | 是 | 待清除数据的应用信息及各应用的清除规则，键为应用包名，值为清除规则。<br>**适用版本：** 10 |
...
| --- | --- | --- | --- |
| accountId | string | 是 | 已登录的云账号ID。 |
| appActions | Record&lt;string, [ClearAction](arkts-arkdata-clouddata-clearaction-e-sys.md)&gt; | 是 | 待清除数据的应用信息及各应用的清除规则，键为应用包名，值为清除规则。<br>**适用版本：** 11 |
...
| --- | --- | --- | --- |
| accountId | string | 是 | 已登录的云账号ID。 |
| appActions | Record&lt;string, [ClearAction](arkts-arkdata-clouddata-clearaction-e-sys.md)&gt; | 是 | 待清除数据的应用信息及各应用的清除规则，键为应用包名，值为清除规则。 |
| config | Record&lt;string, [ClearConfig](arkts-arkdata-clouddata-clearconfig-i-sys.md)&gt; | 否 | 端云协同数据库级清除规则。键为应用包名，值为该应用数据库清除规则。清除规则优先级：表级 &gt; 数据库级 &gt; 应用级。当未配置该参数时，默认使用应用级的数据清除规则。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| bundleInfo | [BundleInfo](arkts-arkdata-clouddata-bundleinfo-i-sys.md) | 是 | 应用包信息配置。BundleInfo的实例对象。 |
...
| --- | --- | --- | --- |
| accountId | string | 是 | 已登录的云账号ID。 |
| switches | Record&lt;string, boolean&gt; | 是 | 各应用的端云协同开关信息。键为应用的包名，值为该应用的开关状态，true为打开该应用端云开关，false为关闭该应用端云开关。<br>**适用版本：** 11 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| extInfo | [ExtraData](arkts-arkdata-clouddata-extradata-i-sys.md) | 是 | 透传数据，包含通知数据变更后的应用信息。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| bundleInfos | Array&lt;[BundleInfo](arkts-arkdata-clouddata-bundleinfo-i-sys.md)&gt; | 是 | 取消订阅的应用信息数组。取值范围：数组长度为[1, 30]，超过该范围返回14800001错误码。取消订阅时应用信息的storeId需要与订阅时保持一致。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| bundleInfos | Array&lt;[BundleInfo](arkts-arkdata-clouddata-bundleinfo-i-sys.md)&gt; | 是 | 订阅的应用信息数组。取值范围：数组长度为[1, 30]，超过该范围返回14800001错误码。 |
...
| 类型 | 说明 |
| --- | --- |
| Promise&lt;Record&lt;string, [SyncInfo](arkts-arkdata-clouddata-syncinfo-i-sys.md)&gt;&gt; | 返回以数据库名为键，上一次端云同步信息为值的结果集。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| bundleInfos | Array&lt;[BundleInfo](arkts-arkdata-clouddata-bundleinfo-i-sys.md)&gt; | 是 | 应用包信息配置数组。取值范围：数组长度为[1, 30]，超过该范围返回14800001错误码。 |
