 ...
 **参数：**
 | 参数名  | 类型                    | 必填 | 说明       |
 | ------- | -------------------- | ---- | ---------- |
 | options | [GetStorageOptions](arkts-arkdata-storage-getstorageoptions-i.md) | 是   | 接口配置信息。 |
 **示例：**
 ArkTS示例：
 ```js
 export default {
 ...
 **参数：**
 | 参数名  | 类型                   | 必填 | 说明       |
 | ------- | ------------------- | ---- | ---------- |
 | options | [SetStorageOptions](arkts-arkdata-storage-setstorageoptions-i.md) | 是   | 接口配置信息。 |
 **示例：**
 ArkTS示例：
 ```js
 export default {
 ...
 **参数：**
 | 参数名  | 类型                                        | 必填 | 说明           |
 | ------- | ------------------------------------------- | ---- | -------------- |
 | options | [ClearStorageOptions](arkts-arkdata-storage-clearstorageoptions-i.md) | 否   | 接口配置信息。 |
 **示例：**
 ArkTS示例：
 ```js
 export default {
 ...
 **参数：**
 | 参数名  | 类型                                          | 必填 | 说明           |
 | ------- | --------------------------------------------- | ---- | -------------- |
 | options | [DeleteStorageOptions](arkts-arkdata-storage-deletestorageoptions-i.md) | 是   | 接口配置信息。 |
 **示例：**
 ArkTS示例：
 ```js
 export default {
