...
| callback | [AsyncCallback](../../apis-basic-service-kit/arkts-apis/arkts-basicservices-asynccallback-i.md)<DataShareHelper> | 是 | 回调函数。当创建DataShareHelper实例成功，err为undefined，data为获取到的DataShareHelper实例；否则为错误对象。 |
...
| options | [DataShareHelperOptions](arkts-arkdata-datasharehelperoptions-i-sys.md) | 是 | Indicates the optional config. |
| callback | [AsyncCallback](../../apis-basic-service-kit/arkts-apis/arkts-basicservices-asynccallback-i.md)<DataShareHelper> | 是 | {DataShareHelper}: The dataShareHelper for consumer. |
