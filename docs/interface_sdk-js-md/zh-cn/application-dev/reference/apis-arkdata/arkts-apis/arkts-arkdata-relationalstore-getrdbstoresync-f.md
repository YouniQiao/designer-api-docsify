...
开发者在创建数据库时，应谨慎配置是否进行数据库加密的参数[encrypt](arkts-arkdata-relationalstore-storeconfig-i.md#StoreConfig)，数据库创建后，禁止对该参数进行修改。如果有修改参数，则会报错误码。
...
| 错误码ID | 错误信息 |
| --- | --- |
| [14800001](../../../../../../../../gitee_tmp/docs/stamaster/zh-cn/application-dev/reference/apis-arkdata/errorcode-data-rdb.md#14800001-无效的参数) | Invalid args. |
| [14800017](../../../../../../../../gitee_tmp/docs/stamaster/zh-cn/application-dev/reference/apis-arkdata/errorcode-data-rdb.md#14800017-关键配置已被更改) | Config changed. |
...
| [14800020](../../../../../../../../gitee_tmp/docs/stamaster/zh-cn/application-dev/reference/apis-arkdata/errorcode-data-rdb.md#14800020-密钥损坏或丢失) | The secret key is corrupted or lost. |
...
| [14800010](../../../../../../../../gitee_tmp/docs/stamaster/zh-cn/application-dev/reference/apis-arkdata/errorcode-data-rdb.md#14800010-数据库路径不合法) | Invalid database path. |
