...
| 名称 | 说明 |
| --- | --- |
| [Asset](arkts-arkdata-asset-i.md) | 记录资产附件（文件、图片、视频等类型文件）的相关信息。 |

### 枚举

| 名称 | 说明 |
| --- | --- |
| [AssetStatus](arkts-arkdata-assetstatus-e.md) | 描述资产附件的状态枚举。请使用枚举名称而非枚举值。 |

### 类型

| 名称 | 说明 |
| --- | --- |
| [Assets](arkts-arkdata-assets-t.md) | 表示Asset类型的数组。 |
| [ValueType](arkts-arkdata-valuetype-t.md) | 用于表示允许的数据字段类型，接口参数具体类型根据其功能而定。。 |
