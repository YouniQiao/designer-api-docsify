...
下列接口都需先使用[intelligence.getImageEmbeddingModel]\_\_\_JSDOC\_LINK\_DESC\_USD\_0\_\_\_获取到ImageEmbedding实例，再通过此实例调用对应接口。
...
该接口需先调用[loadModel]\_\_\_JSDOC\_LINK\_DESC\_USD\_0\_\_\_加载嵌入模型，加载成功后调用getEmbedding。
...
**配对调用：**  
- 调用loadModel()后，必须在使用完毕后调用\_\_\_MD\_LINK\_DESC\_USD\_0\_\_\_释放模型资源。  
