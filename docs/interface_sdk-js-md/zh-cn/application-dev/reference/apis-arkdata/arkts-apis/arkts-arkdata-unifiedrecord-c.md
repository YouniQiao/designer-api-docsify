...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| type | string | 是 | 要获取数据的类型，见[UniformDataType](arkts-arkdata-uniformdatatype-e.md)。 |
...
| 类型 | 说明 |
| --- | --- |
| string | 当前数据记录对应的具体数据类型，见[UniformDataType](arkts-arkdata-uniformdatatype-e.md)。 |
