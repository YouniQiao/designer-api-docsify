...
共享用户首选项可以在ArkTS并发实例间（包括主线程、TaskPool&Worker工作线程）传递，传递的行为是引用传递，性能优于普通的[用户首选项](arkts-data-preferences.md#preferences)，可参考[Sendable使用场景](../../../arkts-utils/sendable-guide.md)。
