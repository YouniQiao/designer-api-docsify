...
清除[setAppShareOptions](arkts-arkdata-setappshareoptions-f-sys.md#setappshareoptions-1)设置的管控信息。调用成功后，setAppShareOptions设置的管控信息被清除，应用内拖拽通道数据恢复到默认使用范围。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| intention | [Intention](arkts-arkdata-intention-e-sys.md) | 是 | 表示数据操作相关的数据通路类型，目前仅支持DRAG类型数据通道。 |
