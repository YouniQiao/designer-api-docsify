...
用户指定的页大小应为1024到65536范围内的整数，并且为2\_\_\_HTML\_TAG\_DESC\_USD\_0\_\_\_n\_\_\_HTML\_TAG\_DESC\_USD\_1\_\_\_。若指定值非整数，则向下取整。
...
迭代次数应当为大于零的整数，若非整数则向下取整，若小于零则抛出错误码401，请参见\_\_\_MD\_LINK\_DESC\_USD\_0\_\_\_。

不指定此参数或指定为零时，使用默认值10000，并使用默认加密算法AES\_256\_GCM。
