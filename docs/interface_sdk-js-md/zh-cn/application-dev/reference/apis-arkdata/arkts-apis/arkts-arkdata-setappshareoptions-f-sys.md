...
设置应用内拖拽通道数据可使用的范围[ShareOptions](arkts-arkdata-shareoptions-e.md)，目前仅支持DRAG类型数据通道的管控设置。调用成功后，应用内拖拽通道数据的使用范围被设置为指定的ShareOptions值。
...
| shareOptions | [ShareOptions](arkts-arkdata-shareoptions-e.md) | 是 | 指示[UnifiedData](arkts-arkdata-unifieddata-c.md)支持的设备内使用范围。 |
