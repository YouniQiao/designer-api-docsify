...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| options | [ClearStorageOptions](arkts-arkdata-systemstorage-clearstorageoptions-i.md) | 否 | Indicates the target options. |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| options | [DeleteStorageOptions](arkts-arkdata-systemstorage-deletestorageoptions-i.md) | 是 | Indicates the target options. |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| options | [GetStorageOptions](arkts-arkdata-systemstorage-getstorageoptions-i.md) | 是 | Indicates the target options. |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| options | [SetStorageOptions](arkts-arkdata-systemstorage-setstorageoptions-i.md) | 是 | Indicates the target options. |
