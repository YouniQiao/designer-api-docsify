...
| fullPath | string | 是 |
| attachName | string | 是 |
| waitTime | ArkTS-Dyn: number<br>ArkTS-Sta：int | 否 |
...
| --- | --- | --- |
| table | string | 是 |
| cursor | ArkTS-Dyn: number<br>ArkTS-Sta：long | 是 |
| callback | [AsyncCallback](../../apis-basic-services-kit/arkts-apis/arkts-basicservices-base-asynccallback-i.md)&lt;void&gt; | 是 |
...
| 参数名 | 类型 | 必填 |
| --- | --- | --- |
| txId | ArkTS-Dyn: number<br>ArkTS-Sta：long | 是 |
...
| mode | [SyncMode](arkts-arkdata-relationalstore-syncmode-e.md) | 是 |
| predicates | [RdbPredicates](arkts-arkdata-relationalstore-rdbpredicates-c.md) | 是 |
| callback | ArkTS-Dyn: [AsyncCallback](../../apis-basic-services-kit/arkts-apis/arkts-basicservices-base-asynccallback-i.md)&lt;Array&lt;[string, number]&gt;&gt;  <br>ArkTS-Sta：[AsyncCallback](../../apis-basic-services-kit/arkts-apis/arkts-basicservices-base-asynccallback-i.md)&lt;Array&lt;[string, int]&gt;&gt; | 是 |
