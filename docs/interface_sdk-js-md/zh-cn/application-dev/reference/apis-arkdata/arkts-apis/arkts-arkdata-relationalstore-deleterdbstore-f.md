...
删除成功后，建议将数据库对象置为null。建立数据库时，若在[StoreConfig]\_\_\_JSDOC\_LINK\_DESC\_USD\_0\_\_\_中配置了自定义路径，则调用此接口进行删库无效，必须使用  
[deleteRdbStore]\_\_\_JSDOC\_LINK\_DESC\_USD\_1\_\_\_ 接口进行删库。
...
[StoreConfig]\_\_\_JSDOC\_LINK\_DESC\_USD\_0\_\_\_中配置了自定义路径，则必须调用此接口进行删库。
