...
| [ImageEmbedding(智慧数据平台)](arkts-arkdata-intelligence-imageembedding-i.md) | 描述多模态嵌入模型的图像嵌入函数。 |
...
| [TextEmbedding(智慧数据平台)](arkts-arkdata-intelligence-textembedding-i.md) | 描述文本嵌入模型的文本嵌入函数。 |
