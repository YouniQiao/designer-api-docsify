...
| state | [State](arkts-arkdata-sharing-state-e-sys.md) | 是 | 更改邀请的状态。 |
| callback | [AsyncCallback](../../apis-basic-services-kit/arkts-apis/arkts-basicservices-base-asynccallback-i.md)&lt;[Result](arkts-arkdata-relationalstore-result-i.md)&lt;void&gt;&gt; | 是 | 回调函数。返回更改邀请状态的结果。 |
...
| 类型 | 说明 |
| --- | --- |
| Promise&lt;[Result](arkts-arkdata-relationalstore-result-i.md)&lt;void&gt;&gt; | Promise对象，返回更改共享邀请状态的结果。 |
