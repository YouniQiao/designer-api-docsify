...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| mouseEvent | [MouseEventData](arkts-input-inputeventclient-mouseeventdata-i.md) | 是 | 鼠标/触控板事件注入描述信息。此参数中[Action](arkts-input-multimodalinput-mouseevent-action-e.md#Action)属性 不支持设置为CANCEL。 |
