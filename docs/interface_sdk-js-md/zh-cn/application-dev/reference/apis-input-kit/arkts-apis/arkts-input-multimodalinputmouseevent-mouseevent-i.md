...
**继承/实现关系：** MouseEvent extends [InputEvent](arkts-input-multimodalinputinputevent-inputevent-i.md)
...
**类型：** [Action](arkts-input-multimodalinputmouseevent-action-e.md)
...
**类型：** [AxisValue](arkts-input-multimodalinputmouseevent-axisvalue-i.md)[]
...
**类型：** [Button](arkts-input-multimodalinputmouseevent-button-e.md)
...
**类型：** [KeyCode](arkts-input-multimodalinputkeycode-keycode-e.md)[]
...
**类型：** [ToolType](arkts-input-multimodalinputmouseevent-tooltype-e.md)
