...
自定义光标，开发者可使用[setCustomCursor](arkts-input-setcustomcursor-f.md#setcustomcursor-2)设置自定义光标，不支持使用[setPointerStyle](arkts-input-setpointerstyle-f.md#setpointerstyle-2)直接设置。
