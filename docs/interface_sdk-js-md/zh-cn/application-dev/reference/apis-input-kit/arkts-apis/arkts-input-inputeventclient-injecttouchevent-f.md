...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| touchEvent | [TouchEventData](arkts-input-inputeventclient-toucheventdata-i.md) | 是 | 触屏注入描述信息。此参数中[Action](arkts-input-multimodalinput-touchevent-action-e.md#Action)属性不支持设置为 CANCEL。 |
