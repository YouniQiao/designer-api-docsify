...
与[inputConsumer.on('key')](arkts-input-on-f-sys.md#on-1)现有接口的区别：
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| keyOptions | [KeyOptions](../../apis-test-kit/arkts-apis/arkts-test-keyoptions-i.md) | 是 | 组合键选项，支持triggerType参数。 |
| callback | [KeyCommandCallback](arkts-input-keycommandcallback-t-sys.md) | 是 | 回调函数，返回组合键选项和按键事件数据。 |
