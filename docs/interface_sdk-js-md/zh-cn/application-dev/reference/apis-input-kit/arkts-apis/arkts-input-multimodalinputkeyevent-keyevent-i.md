...
**继承/实现关系：** KeyEvent extends [InputEvent](arkts-input-multimodalinputinputevent-inputevent-i.md)
...
**类型：** [Action](arkts-input-multimodalinputkeyevent-action-e.md)
...
**类型：** [Key](arkts-input-multimodalinputkeyevent-key-i.md)
