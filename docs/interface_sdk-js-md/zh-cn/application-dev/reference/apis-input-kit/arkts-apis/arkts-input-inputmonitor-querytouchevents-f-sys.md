...
| 类型 | 说明 |
| --- | --- |
| Promise&lt;Array&lt;[TouchEvent](arkts-input-multimodalinputtouchevent-touchevent-i.md)&gt;&gt; | Promise对象，返回查询到的触屏输入事件。包含以下有效信息，其余均为无效信息：<br/>- actionTime：触屏输入事件发生的时间，表示系统 启动运行至今逝去的微秒数，单位为微秒（μs）。<br/>- [SourceType]{ |
