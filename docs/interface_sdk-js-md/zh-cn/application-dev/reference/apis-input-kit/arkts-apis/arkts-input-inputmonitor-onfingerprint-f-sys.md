...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| receiver | [Callback](../../apis-basic-services-kit/arkts-apis/arkts-basicservices-base-callback-i.md)&lt;[FingerprintEvent](arkts-input-multimodalinputshortkey-fingerprintevent-i-sys.md)&gt; | 是 | 回调函数，返回指纹器件手势输入事件。 |
