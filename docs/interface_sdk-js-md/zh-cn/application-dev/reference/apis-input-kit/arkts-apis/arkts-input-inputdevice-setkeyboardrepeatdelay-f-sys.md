...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| delay | ArkTS-Dyn: number  \_\_\_HTML\_TAG\_USD\_0\_\_\_ArkTS-Sta：int | 是 | 键盘按键重复延迟时间，默认值500ms，调节范围[300ms，1000ms]。 |
| callback | \_\_\_MD\_LINK\_USD\_0\_\_\_&lt;void&gt; | 是 | 回调函数。当设置键盘按键重复延迟时间成功，err为undefined，否则为错误对象。 |
