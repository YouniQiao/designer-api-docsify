...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| receiver | [Callback](../../apis-basic-services-kit/arkts-apis/arkts-basicservices-base-callback-i.md)&lt;[FourFingersSwipe](arkts-input-multimodalinputgestureevent-fourfingersswipe-i.md)&gt; | 是 | 回调函数，返回四指滑动输入事件。 |
