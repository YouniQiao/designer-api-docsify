...
**类型：** [Action](arkts-input-multimodalinputtouchevent-action-e.md)
...
**类型：** [SourceType](arkts-input-multimodalinputtouchevent-sourcetype-e.md)
...
**类型：** [Touch](arkts-input-multimodalinputtouchevent-touch-i.md)
