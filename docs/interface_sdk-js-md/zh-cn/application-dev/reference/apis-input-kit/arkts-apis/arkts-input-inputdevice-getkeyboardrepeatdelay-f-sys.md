...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | [AsyncCallback](../../apis-basic-services-kit/arkts-apis/arkts-basicservices-base-asynccallback-i.md)&lt;int&gt; | 是 | 回调函数。当获取成功，err为undefined，data为键盘按键的重复时延，单位为ms；否则为错误对象。 |
...
| 类型 | 说明 |
| --- | --- |
| Promise&lt;int&gt; | Promise对象，返回键盘按键的重复时延，单位为ms。 |
