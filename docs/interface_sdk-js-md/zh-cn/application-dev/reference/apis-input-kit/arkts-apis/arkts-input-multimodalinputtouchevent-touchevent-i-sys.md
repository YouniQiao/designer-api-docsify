...
**继承/实现关系：** TouchEvent extends [InputEvent](arkts-input-multimodalinputinputevent-inputevent-i.md)
...
**类型：** [FixedMode](arkts-input-multimodalinputtouchevent-fixedmode-e-sys.md)
