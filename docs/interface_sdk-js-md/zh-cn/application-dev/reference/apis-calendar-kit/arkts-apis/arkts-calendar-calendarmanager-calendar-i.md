...
下列API示例中需先通过  
[createCalendar()]\_\_\_JSDOC\_LINK\_DESC\_USD\_0\_\_\_、[getCalendar()]\_\_\_JSDOC\_LINK\_DESC\_USD\_1\_\_\_中任一方法获取Calendar对象，再通过此对象调用对应方法，对该Calendar下的日程进行创建、删除、修改、查询等操作。
...
| 错误码ID | 错误信息 |
| --- | --- |
| [23900001](../errorcode-calendarManager.md#23900001-参数值错误) | 参数值错误。\_\_\_HTML\_TAG\_USD\_0\_\_\_**适用版本：** 23+ |
