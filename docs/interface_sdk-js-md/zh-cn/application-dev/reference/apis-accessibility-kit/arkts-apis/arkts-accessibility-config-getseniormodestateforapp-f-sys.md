...
| appIndex | ArkTS-Dyn: number  <br>ArkTS-Sta：int | 否 | Indicates the index of clone app. &lt;br&gt;The value must be an integer greater than or equal to 0. Default value: 0. |
