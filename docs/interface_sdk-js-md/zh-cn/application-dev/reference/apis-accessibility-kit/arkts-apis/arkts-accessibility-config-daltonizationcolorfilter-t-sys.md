...
颜色滤镜功能开启时（[daltonizationState]\_\_\_JSDOC\_LINK\_DESC\_USD\_0\_\_\_设置为true)，颜色滤镜的配置(即设置的DaltonizationColorFilter的值)生效；颜色滤镜功能关闭时（[daltonizationState]\_\_\_JSDOC\_LINK\_DESC\_USD\_1\_\_\_设置为false)，显示为正常类型。
