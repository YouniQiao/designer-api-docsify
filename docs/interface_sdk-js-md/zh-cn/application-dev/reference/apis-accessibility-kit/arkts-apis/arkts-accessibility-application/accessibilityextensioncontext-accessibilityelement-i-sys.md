...
[AccessibilityExtensionContext.getAccessibilityFocusedElement()]\_\_\_JSDOC\_LINK\_DESC\_USD\_0\_\_\_或 [AccessibilityExtensionContext.getRootInActiveWindow()]\_\_\_JSDOC\_LINK\_DESC\_USD\_1\_\_\_来获取一个 **AccessibilityElement** 实例。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| action | \_\_\_MD\_LINK\_USD\_0\_\_\_ | 是 | 无障碍节点可执行的操作。 |
| parameters | \_\_\_MD\_LINK\_USD\_0\_\_\_ | 否 | 执行操作时设置的参数值，默认为空。 |
...
| 类型 | 说明 |
| --- | --- |
| Promise&lt;Array&lt;\_\_\_MD\_LINK\_USD\_0\_\_\_&gt;&gt; | Promise对象，返回满足指定查询关键字的所有节点元素。 |
...
| 类型 | 说明 |
| --- | --- |
| Promise&lt;\_\_\_MD\_LINK\_USD\_0\_\_\_&gt; | Promise对象，返回满足指定查询条件的节点元素。 |
...
| 类型 | 说明 |
| --- | --- |
| Promise&lt;Array&lt;\_\_\_MD\_LINK\_USD\_0\_\_\_&gt;&gt; | Promise对象，返回包含指定内容的元素列表。 |
...
| 类型 | 说明 |
| --- | --- |
| Promise&lt;\_\_\_MD\_LINK\_USD\_0\_\_\_&gt; |  |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| condition | \_\_\_MD\_LINK\_USD\_0\_\_\_ | 是 | 焦点方向。 |

**返回值：**

| 类型 | 说明 |
| --- | --- |
| Promise&lt;\_\_\_MD\_LINK\_USD\_0\_\_\_&gt; | Promise对象，返回指定焦点方向的元素。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| condition | ArkTS-Dyn: number  \_\_\_HTML\_TAG\_USD\_0\_\_\_ArkTS-Sta：long | 是 | 元素 ID。 |

**返回值：**

| 类型 | 说明 |
| --- | --- |
| Promise&lt;\_\_\_MD\_LINK\_USD\_0\_\_\_&gt; | Promise对象，返回指定 ID 的元素。 |
...
| 类型 | 说明 |
| --- | --- |
| Promise&lt;Array&lt;\_\_\_MD\_LINK\_USD\_0\_\_\_&gt;&gt; |  |
...
| 类型 | 说明 |
| --- | --- |
| Promise&lt;Array&lt;\_\_\_MD\_LINK\_USD\_0\_\_\_&gt;&gt; | Promise对象，返回包含指定提示文本的元素列表。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| rule | \_\_\_MD\_LINK\_USD\_0\_\_\_ | 是 | 检查当前节点及其子节点的规则。 |
| condition | \_\_\_MD\_LINK\_USD\_0\_\_\_ | 是 | 表示查询可聚焦节点方式。 |

**返回值：**

| 类型 | 说明 |
| --- | --- |
| Promise&lt;\_\_\_MD\_LINK\_USD\_0\_\_\_&gt; | Promise对象，返回查询结果对象。 |
...
| 类型 | 说明 |
| --- | --- |
| Promise&lt;Array&lt;\_\_\_MD\_LINK\_USD\_0\_\_\_&gt;&gt; | Promise对象，返回当前元素的子元素列表。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | ArkTS-Dyn: \_\_\_MD\_LINK\_USD\_0\_\_\_&lt;number&gt;  \_\_\_HTML\_TAG\_USD\_2\_\_\_ArkTS-Sta：\_\_\_MD\_LINK\_USD\_1\_\_\_&lt;int&gt; | 是 | 回调函数，表示文本组件中光标位置。 |
...
| 类型 | 说明 |
| --- | --- |
| ArkTS-Dyn: Promise&lt;number&gt;  \_\_\_HTML\_TAG\_USD\_0\_\_\_ArkTS-Sta：Promise&lt;int&gt; | Promise对象，返回当前光标所处位置。 |
...
| 类型 | 说明 |
| --- | --- |
| Promise&lt;\_\_\_MD\_LINK\_USD\_0\_\_\_&gt; | Promise对象，返回当前元素的父元素。 |
...
| 类型 | 说明 |
| --- | --- |
| Promise&lt;\_\_\_MD\_LINK\_USD\_0\_\_\_&gt; | Promise对象，返回活动窗口中的根元素。 |
