...
| 类型 | 说明 |
| --- | --- |
| [ImmersiveMode](arkts-ime-inputmethodengine-immersivemode-e.md) | 沉浸模式。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| mode | [ImmersiveMode](arkts-ime-inputmethodengine-immersivemode-e.md) | 是 | 沉浸模式。 |
...
| 错误码ID | 错误信息 |
| --- | --- |
| [201](../../errorcode-universal.md#201-api权限校验失败) | permissions check fails. |
| [401](../../errorcode-universal.md#401-函数参数数量或参数类型不匹配) | Parameter error. Possible causes: 1.Mandatory parameters are left unspecified; 2.Incorrect parameter types. |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| inputRegion | Array&lt;[window.Rect](../../apis-arkui/arkts-apis/arkts-arkui-window-rect-i.md)&gt; | 是 | 面板内接收输入事件的区域。<br>- 数组大小限制为[1, 4]。<br>- 传入的热区位置是相对于输入法面板窗口左顶点的位置。 |
