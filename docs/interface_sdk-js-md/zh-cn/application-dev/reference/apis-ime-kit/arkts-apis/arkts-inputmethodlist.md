...
| 名称 |
| --- |
| [InputMethodListDialog(输入法切换列表控件)](arkts-ime-inputmethodlist-inputmethodlistdialog-s.md) |

### 接口

| 名称 |
| --- |
| [Pattern(输入法切换列表控件)](arkts-ime-inputmethodlist-pattern-i.md) |
| [PatternOptions(输入法切换列表控件)](arkts-ime-inputmethodlist-patternoptions-i.md) |
