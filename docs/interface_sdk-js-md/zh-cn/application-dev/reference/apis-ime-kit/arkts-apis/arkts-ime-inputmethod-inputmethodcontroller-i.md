...
- **编辑框状态同步**：通过  
[updateCursor](arkts-ime-inputmethod-inputmethodcontroller-i.md#updatecursor)、[changeSelection](arkts-ime-inputmethod-inputmethodcontroller-i.md#changeselection)、[updateAttribute](arkts-ime-inputmethod-inputmethodcontroller-i.md#updateattribute)等接口向输入法同步光标、选区、属性等编辑框状态信息。  
...
**前提条件/前置操作**：需先调用[attach](arkts-ime-inputmethod-inputmethodcontroller-i.md#attach)完成绑定，且已调用showTextInput进入编辑状态。
...
**前提条件/前置操作**：需先调用[attach](arkts-ime-inputmethod-inputmethodcontroller-i.md#attach)完成绑定，否则会报12800009错误。
...
**替代接口：** [stopInputSession](arkts-ime-inputmethod-inputmethodcontroller-i.md#stopinputsession)
