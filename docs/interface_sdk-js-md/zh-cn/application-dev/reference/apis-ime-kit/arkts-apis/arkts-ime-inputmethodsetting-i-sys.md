...
- **输入法变化订阅**：通过[on('imeChange')](arkts-ime-inputmethodsetting-i.md#on-1)订阅输入法及子类型变化事件，当用户切换输入法时收到通知。  
- **输入法列表查询**：通过[getInputMethods](arkts-ime-inputmethodsetting-i.md#getinputmethods-1)查询已激活/未激活输入法列表，通过[getAllInputMethods](arkts-ime-inputmethodsetting-i.md#getallinputmethods-1)查询所有已安装输入法列表，通过[listInputMethodSubtype](arkts-ime-inputmethodsetting-i.md#listinputmethodsubtype-1)查询指定输入法的子类型列表。  
...
| enabledState | [EnabledState](arkts-ime-enabledstate-e.md) | 是 | 输入法启用状态。 |
...
| enabledState | [EnabledState](arkts-ime-enabledstate-e.md) | 是 | 要修改的启用状态。 |
...
| 类型 | 说明 |
| --- | --- |
| [Array](../../apis-arkts/arkts-apis/arkts-arkts-array-c.md)<InputMethodProperty> | 返回所有输入法列表。 |
...
| 类型 | 说明 |
| --- | --- |
| [CursorInfo](arkts-ime-cursorinfo-i.md) | 指定用户下的光标信息。 |
...
| 类型 | 说明 |
| --- | --- |
| [InputMethodProperty](arkts-ime-inputmethodproperty-i.md) | 默认输入法属性，仅保证`name`和`id`属性正确，其他属性可能为空。 |
...
| 类型 | 说明 |
| --- | --- |
| [Array](../../apis-arkts/arkts-apis/arkts-arkts-array-c.md)<InputMethodSubtype> | 返回指定输入法应用的所有子类型。 |
...
| 类型 | 说明 |
| --- | --- |
| [Array](../../apis-arkts/arkts-apis/arkts-arkts-array-c.md)<InputMethodProperty> | 返回已激活/未激活输入法列表。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| panelInfo | [PanelInfo](../../apis-basic-service-kit/arkts-apis/arkts-basicservices-panelinfo-i-sys.md) | 是 | 输入法面板的属性。 |
...
取消订阅输入法[Panel](arkts-ime-panel-i.md)固定态软键盘显示事件。
...
取消订阅输入法[Panel](arkts-ime-panel-i.md)固定态软键盘隐藏事件。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | [ImeChangeWithUserIdCallback](arkts-ime-imechangewithuseridcallback-t-sys.md) | 否 | 回调函数，返回取消订阅的输入法属性对象、子类型对象及用户ID。参数不填写时，取消订阅所有的回调事件。 |
...
订阅输入法[Panel](arkts-ime-panel-i.md)固定态软键盘显示事件。使用callback异步回调。
...
订阅输入法[Panel](arkts-ime-panel-i.md)固定态软键盘隐藏事件。使用callback异步回调。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | [ImeChangeWithUserIdCallback](arkts-ime-imechangewithuseridcallback-t-sys.md) | 是 | 回调函数，返回输入法属性对象、子类型对象及用户ID。 |
