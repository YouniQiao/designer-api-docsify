...
| 名称 | 说明 |
| --- | --- |
| [PanelInfo(输入法面板)](arkts-ime-inputmethod-panel-panelinfo-i.md) |  |

### 枚举

| 名称 | 说明 |
| --- | --- |
| [PanelFlag(输入法面板)](arkts-ime-inputmethod-panel-panelflag-e.md) |  |
| [PanelType(输入法面板)](arkts-ime-inputmethod-panel-paneltype-e.md) |  |
