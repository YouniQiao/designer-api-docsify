...
设置该类型时，需要结合[useUnionEffect](arkts-arkui-commonmethod-c-sys.md#useunioneffect-2)并设置[GravityCenterOptions](arkts-arkui-gravitycenteroptions-i-sys.md)的gravityCenter为true才能生效。
