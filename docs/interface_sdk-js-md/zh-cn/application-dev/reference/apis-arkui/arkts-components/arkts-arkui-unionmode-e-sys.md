...
设置该类型时，需要结合  
[useUnionEffect](CommonMethod#useUnionEffect(value: boolean | undefined, options?: GravityCenterOptions))并设置  
[GravityCenterOptions](GravityCenterOptions)的gravityCenter为true才能生效。
