...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| drawContext | [DrawContext](arkts-arkui-common-comp-drawcontext-t.md) | 是 | The drawContext used to draw. |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| drawContext | [DrawContext](arkts-arkui-common-comp-drawcontext-t.md) | 是 | 用来绘制的drawContext |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| drawContext | [DrawContext](arkts-arkui-common-comp-drawcontext-t.md) | 是 | 用于绘制的drawContext |
