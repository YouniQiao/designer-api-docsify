...
构造数字指示器的样式，继承自[Indicator](arkts-arkui-swiper-comp-indicator-c.md)。

> **说明：** 

> 按组翻页时，数字导航点显示的子节点数量不包括占位节点。

> 数字导航点文本最大的字体缩放倍数maxFontScale为2。
...
| 类型 | 说明 |
| --- | --- |
| [DigitIndicator](arkts-arkui-swiper-comp-digitindicator-c.md) | 返回当前数字指示器，用于支持链式调用配置其他导航点属性。 |
