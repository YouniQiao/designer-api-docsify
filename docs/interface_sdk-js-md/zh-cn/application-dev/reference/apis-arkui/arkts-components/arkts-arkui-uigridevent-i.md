...
frameNode中[getEvent('Grid')](../arkts-apis/arkts-arkui-typenode-getevent-f.md)方法的返 回值，可用于给Grid节点设置滚动事件。
...
设置[onScrollIndex](arkts-arkui-grid-attribute.md#onscrollindex)事件的回调。
