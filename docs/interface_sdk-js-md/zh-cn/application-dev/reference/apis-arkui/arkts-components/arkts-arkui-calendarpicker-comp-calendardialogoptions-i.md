...
继承自[CalendarOptions](arkts-arkui-calendarpicker-comp-calendaroptions-i.md)。
...
**继承/实现关系：** CalendarDialogOptions extends [CalendarOptions](arkts-arkui-calendarpicker-comp-calendaroptions-i.md)
...
背景效果参数，用于自定义弹窗背景的显示效果，支持配置模糊半径、饱和度、亮度、颜色等属性，实现不同的背景视觉效果。默认值请参考[BackgroundEffectOptions](arkts-arkui-common-comp-backgroundeffectoptions-i.md)。
...
**类型：** [HoverModeAreaType](arkts-arkui-common-comp-hovermodeareatype-e.md)
...
**类型：** [ShadowOptions](arkts-arkui-common-comp-shadowoptions-i.md) &#124; [ShadowStyle](arkts-arkui-common-comp-shadowstyle-e.md)
