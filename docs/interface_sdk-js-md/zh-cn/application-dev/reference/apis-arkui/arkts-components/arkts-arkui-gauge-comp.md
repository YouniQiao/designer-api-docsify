...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| options | [GaugeOptions](arkts-arkui-gauge-comp-gaugeoptions-i.md) | 是 | 数据量规图表组件参数。 |
...
| 名称 | 说明 |
| --- | --- |
| [GaugeConfiguration](arkts-arkui-gauge-comp-gaugeconfiguration-i.md) | 开发者需要自定义class实现ContentModifier接口。继承自[CommonConfiguration](arkts-arkui-common-comp-commonconfiguration-i.md)。 |
| [GaugeIndicatorOptions](arkts-arkui-gauge-comp-gaugeindicatoroptions-i.md) | 数据量规图表指针选项。 |
| [GaugeOptions](arkts-arkui-gauge-comp-gaugeoptions-i.md) | 数据量规图表选项。 |
| [GaugeShadowOptions](arkts-arkui-gauge-comp-gaugeshadowoptions-i.md) | GaugeShadowOptions继承自[MultiShadowOptions](arkts-arkui-common-comp-multishadowoptions-i.md)，具有MultiShadowOptions的全部属性。 |
