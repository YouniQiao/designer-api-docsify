...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | [BoardStyle](arkts-arkui-boardstyle-i.md) | 是 | ѡ����ҳǩ�ı�������� |

**返回值：**

| 类型 | 说明 |
| --- | --- |
| [SubTabBarStyle](arkts-arkui-subtabbarstyle-c.md) | ����SubTabBarStyle�������� |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | [IndicatorStyle](arkts-arkui-indicatorstyle-i.md) | 是 | ѡ����ҳǩ���»��߷����� |
...
����ѡ����ҳǩ���»��߷����[indicator](arkts-arkui-subtabbarstyle-c.md#indicator-1)��ȣ�������ͼƬ��ʽ���»��߷��ͼƬ����ʾЧ������[ImageFit.Cover](../arkts-apis/arkts-arkui-imagefit-e.md)����ҳǩ���»��߷�����ˮƽģʽ����Ч��
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | [LabelStyle](arkts-arkui-labelstyle-i.md) | 是 | ��ҳǩ��label�ı����������ʽ���� |
...
| 类型 | 说明 |
| --- | --- |
| [SubTabBarStyle](arkts-arkui-subtabbarstyle-c.md) | ���ش�����SubTabBarStyle���� |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| padding | [LocalizedPadding](../arkts-apis/arkts-arkui-localizedpadding-i.md) | 是 | ��ҳǩ���ڱ߾����ԡ�<br/>�쳣ֵʱȡĬ��ֵ��<br/>ȡֵ��Χ��[0, +��]<br/>�쳣ֵʱȡĬ��ֵ��<br />Ĭ��ֵ��{start:LengthMetrics.vp(8),end:LengthMetrics.vp(8),<br/>top:LengthMetrics.vp(17),bottom:LengthMetrics.vp(18)} |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | [SelectedMode](arkts-arkui-selectedmode-e.md) | 是 | ѡ����ҳǩ����ʾ��ʽ��<br />Ĭ��ֵ��SelectedMode.INDICATOR |
