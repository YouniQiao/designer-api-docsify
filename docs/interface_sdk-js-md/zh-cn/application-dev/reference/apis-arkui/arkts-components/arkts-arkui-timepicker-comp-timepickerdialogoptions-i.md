...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | [TimePickerResult](arkts-arkui-timepicker-comp-timepickerresult-i.md) | 是 |  |
...
> 默认值：请参考[PickerDialogButtonStyle](arkts-arkui-common-comp-pickerdialogbuttonstyle-i.md)。
...
**类型：** Callback&lt;[TimePickerResult](arkts-arkui-timepicker-comp-timepickerresult-i.md)&gt;
