...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| from | [NavPathInfo](../arkts-apis/arkts-arkui-navigation-navpathinfo-c.md) \| NavBar | 是 | 退场页面信息。参数值为navBar，则表示跳转前的页面为Navigation首页。 |
| to | [NavPathInfo](../arkts-apis/arkts-arkui-navigation-navpathinfo-c.md) \| NavBar | 是 | 进场页面信息。参数值为navBar，则表示跳转的目标页面为Navigation首页。 |
| pathStack | [NavPathStack](../arkts-apis/arkts-arkui-navigation-navpathstack-c.md) | 是 | 页面栈。 |
| operation | [NavigationOperation](../arkts-apis/arkts-arkui-navigation-navigationoperation-e.md) | 是 | 当前页面跳转类型。 |
