...
输入事件监听器回调函数类型。
    **说明：**  
    ...
    - RawInputEventWrapper是抽象类，开发者无法使用\_\_\_INLINE\_CODE\_DESC\_USD\_0\_\_\_运算符创建实例。  
    
    - 系统会在事件触发时自动创建实例并通过此参数传递给回调函数。  
    
    - 当前回调参数event仅会封装以下原始输入事件类型：  
    [MouseEvent]\_\_\_JSDOC\_LINK\_DESC\_USD\_1\_\_\_、[TouchEvent]\_\_\_JSDOC\_LINK\_DESC\_USD\_2\_\_\_、[KeyEvent]\_\_\_JSDOC\_LINK\_DESC\_USD\_3\_\_\_。开发者可通过  
    [asMouseEvent]\_\_\_JSDOC\_LINK\_DESC\_USD\_4\_\_\_、[asTouchEvent]\_\_\_JSDOC\_LINK\_DESC\_USD\_5\_\_\_、  
    [asKeyEvent]\_\_\_JSDOC\_LINK\_DESC\_USD\_6\_\_\_获取对应事件对象。  
