...
> [DatePickerComponent](../arkts-apis/arkts-arkui-advanced-datepickercomponent.md)。
...
在[DatePickerDialog](arkts-arkui-datepicker.md)中，当[DatePickerDialogOptions](arkts-arkui-datepickerdialogoptions-i.md)的showTime设置为true时，此参数不生效，默认显示年、月、日三列。这是为保证布局合理性，当showTime为true时会额外显示时间列。
> **说明：**  
>  
