...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| indices | [Optional](arkts-arkui-common-comp-optional-t.md)&lt;Array&lt;number&gt;&gt; | 是 | 需预加载的子节点的下标数组。<br>默认值：空数组。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| translate | [TranslateOptions](arkts-arkui-common-comp-translateoptions-i.md) | 是 | 设置TabBar的平移距离。 |
