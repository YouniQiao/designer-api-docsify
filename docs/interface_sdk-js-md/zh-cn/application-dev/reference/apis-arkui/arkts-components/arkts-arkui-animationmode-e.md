...
点击[TabBar](arkts-arkui-tabcontent-attribute.md#tabbar)页签时切换TabContent的动画形式枚举。
...
可以通过设置[animationDuration](arkts-arkui-tabs-attribute.md#animationduration)为0实现调用TabsController的changeIndex接口时不带动画。
