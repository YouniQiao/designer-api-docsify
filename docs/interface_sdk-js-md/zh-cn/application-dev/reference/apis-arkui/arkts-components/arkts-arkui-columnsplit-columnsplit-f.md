...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| style | [CustomBuilderT](../../apis-default/arkts-apis/arkts-custombuildert-t.md)&lt;[ColumnSplitAttribute](arkts-arkui-columnsplit-attribute.md)&gt; | 是 | the callback to set up component's attributes. |
