...
columnsTemplate('repeat(auto-stretch, track-size)')是设置固定列宽值为track-size，使用 [columnsGap](../../../reference/apis-arkui/arkui-ts/ts-container-lazyvgridlayout.md#columnsgap)作为最小列间距，自动计算列数和实际列间 距。
