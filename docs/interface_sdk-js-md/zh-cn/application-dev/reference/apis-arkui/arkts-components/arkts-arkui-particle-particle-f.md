...
| 类型 | 说明 |
| --- | --- |
| [ParticleAttribute](arkts-arkui-particle-attribute.md) | <br>**适用版本：** 23+ |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| style_ | [CustomBuilderT](../../apis-default/arkts-apis/arkts-custombuildert-t.md)&lt;[ParticleAttribute](arkts-arkui-particle-attribute.md)&gt; | 是 | Particle attribute instance |

**返回值：**

| 类型 | 说明 |
| --- | --- |
| [ParticleAttribute](arkts-arkui-particle-attribute.md) |  |
