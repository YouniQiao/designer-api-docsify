...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| scope | [EffectScope](arkts-arkui-effectscope-e.md) | 否 | [动效范围。具体枚举值及说明请参考EffectScope枚举说明。默认值：EffectScope.LAYER](arkts-arkui-effectscope-e.md) |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| scope | [EffectScope](arkts-arkui-effectscope-e.md) | 否 | [动效范围。默认值：EffectScope.LAYER](arkts-arkui-effectscope-e.md) |
| replaceType | [ReplaceEffectType](arkts-arkui-replaceeffecttype-e.md) | 否 | [替换动效类型。默认值：ReplaceEffectType.SEQUENTIAL](arkts-arkui-replaceeffecttype-e.md) |
