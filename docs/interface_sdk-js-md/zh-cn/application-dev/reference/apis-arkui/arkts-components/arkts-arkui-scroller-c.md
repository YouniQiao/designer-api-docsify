...
| 类型 | 说明 |
| --- | --- |
| [SizeResult](arkts-arkui-sizeresult-i.md) | 滚动组件内容总大小。主轴方向内容大小为所有子组件布局后的总大小，交叉轴方向内容大小为组件自身交叉轴方向大小减去padding和border后的大小。 |
...
| 类型 | 说明 |
| --- | --- |
| [OffsetResult](arkts-arkui-offsetresult-i.md) | 返回当前的滚动总偏移量。xOffset表示水平滚动总偏移量，yOffset表示竖直滚动总偏移量。 |
...
| 类型 | 说明 |
| --- | --- |
| [RectResult](arkts-arkui-rectresult-i.md) | 子组件的大小和相对于组件的位置。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| dx | [Length](../arkts-apis/arkts-arkui-length-t.md) | 是 | 水平方向滚动距离，不支持百分比形式。 取值范围：(-∞, +∞) |
| dy | [Length](../arkts-apis/arkts-arkui-length-t.md) | 是 | 竖直方向滚动距离，不支持百分比形式。 取值范围：(-∞, +∞) |
