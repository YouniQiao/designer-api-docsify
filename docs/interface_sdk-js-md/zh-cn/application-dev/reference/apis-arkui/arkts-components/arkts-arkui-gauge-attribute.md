...
| 参数名 | 类型 | 必填 |
| --- | --- | --- |
| [colors](#colors) | [ResourceColor](../arkts-apis/arkts-arkui-resourcecolor-t.md) \| LinearGradient \| Array & lt;[ResourceColor \ | LinearGradient, number] & gt; | 是 |
...
| 参数名 | 类型 | 必填 |
| --- | --- | --- |
| modifier | [ContentModifier](arkts-arkui-contentmodifier-i.md)&lt;[GaugeConfiguration](arkts-arkui-gaugeconfiguration-i.md)&gt; | 是 |
...
| 参数名 | 类型 | 必填 |
| --- | --- | --- |
| isPrivacySensitiveMode | [Optional](arkts-arkui-optional-t.md)&lt;boolean&gt; | 是 |
