...
定义时间滑动选择器弹窗并弹出。 &gt; **说明：** &gt; &gt; 从API version 10开始，可以通过使用[UIContext](../../apis-na/arkts-apis/arkts-na-arkui-uicontext-uicontext-c.md)中的 &gt; [showTimePickerDialog](../../apis-na/arkts-apis/arkts-na-arkui-uicontext-uicontext-c.md#showtimepickerdialog)来明确UI的执行上下文。
