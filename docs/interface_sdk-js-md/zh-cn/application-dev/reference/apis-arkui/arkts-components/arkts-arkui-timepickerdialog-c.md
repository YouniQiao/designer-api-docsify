...
> **说明：**
> 
> 从API version 10开始，可以通过使用[UIContext](../../apis-default/arkts-apis/arkts-arkui-uicontext-uicontext-c.md)中的 &gt; [showTimePickerDialog](../../apis-default/arkts-apis/arkts-arkui-uicontext-uicontext-c.md#showtimepickerdialog)来明确UI的执行上下文。

**起始版本：** 8

**废弃版本：** 18

**替代接口：** [showTimePickerDialog](../../apis-default/arkts-apis/arkts-arkui-uicontext-uicontext-c.md#showtimepickerdialog)
