...
在[RTL](arkts-arkui-layoutdirection-e.md#layoutdirection)模式下为导航点距离Swiper组件右边的距离，在[LTR](arkts-arkui-layoutdirection-e.md#layoutdirection)模式下为导航点距离Swiper组件左边的距离。
