...
设置粘贴控件的图标风格。默认值：不显示图标。\_\_\_HTML\_TAG\_DESC\_USD\_0\_\_\_若同时也不传text，控件将显示为默认样式。
...
设置粘贴控件的文本描述。默认值：不显示文本描述。\_\_\_HTML\_TAG\_DESC\_USD\_0\_\_\_若同时也不传icon，控件将显示为默认样式。
