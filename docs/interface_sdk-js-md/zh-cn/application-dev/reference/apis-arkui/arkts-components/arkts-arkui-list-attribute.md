...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | ListItemAlign | 是 | 交叉轴方向的布局方式。<br/>默认值：ListItemAlign.Start |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | ListDividerOptions \| null | 是 | ListItem分割线样式。<br/>默认值：null<br>**起始版本：** 18 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| mode | Optional&lt;FocusWrapMode&gt; | 是 | 交叉轴方向键走焦模式。<br/>默认值：FocusWrapMode.DEFAULT<br/>**说明：** <br/>异常值按默认值处理，即交叉轴方向键不能换行。 |
...
| gutter | Dimension | 否 | 列间距或行间距。<br />默认值：0 <br/>取值范围：[0, +∞)<br/>**说明：**<br/>gutter为列间距或行间距，当列数或行数大于1时生效。<br>**起始版本：** 10 |
...
| gutter | Dimension | 否 | 列间距。<br />默认值：0 <br/>取值范围：[0, +∞) |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | Callback&lt;boolean&gt; \| undefined | 是 | 编辑模式状态变化时触发的回调。<br>传入undefined会注销回调。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | BarState | 是 | 滚动条状态。<br/>默认值：API version 9及以下版本默认值为BarState.Off，API version 10及以上版本的默认值为BarState.Auto。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | ScrollSnapAlign | 是 | 列表项滚动结束对齐效果。<br/>默认值：ScrollSnapAlign.NONE |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| speed | ScrollSnapAnimationSpeed | 是 | 列表滚动限位动画速度。<br/>默认值：ScrollSnapAnimationSpeed.NORMAL |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | StickyStyle | 是 | ListItemGroup吸顶或吸底效果。<br/>默认值：StickyStyle.None |
