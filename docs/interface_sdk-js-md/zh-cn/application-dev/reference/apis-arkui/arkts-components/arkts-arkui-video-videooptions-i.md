...
<!--Device-unnamed-export declare interface VideoOptions--><!--Device-unnamed-export declare interface VideoOptions-End-->
...
**类型：** double \| string \| [PlaybackSpeed](arkts-arkui-video-playbackspeed-e.md)
...
<!--Device-VideoOptions-currentProgressRate?: double | string | PlaybackSpeed--><!--Device-VideoOptions-currentProgressRate?: double | string | PlaybackSpeed-End-->
...
**类型：** [ImageAIOptions](../arkts-apis/arkts-arkui-imagecommon-imageaioptions-i.md)
...
**类型：** string \| [PixelMap](arkts-arkui-pixelmap-t.md) \| [Resource](../../apis-localization-kit/arkts-apis/arkts-localization-resource-resource-i.md)
