...
| 参数名 | 类型 | 必填 |
| --- | --- | --- |
| timeFormat | [Optional](arkts-arkui-optional-t.md)&lt;[DateTimeOptions](arkts-arkui-datetimeoptions-t.md)&gt; | 是 |
...
| 参数名 | 类型 | 必填 |
| --- | --- | --- |
| callback | [Optional](arkts-arkui-optional-t.md)&lt;[OnTimePickerChangeCallback](arkts-arkui-ontimepickerchangecallback-t.md)&gt; | 是 |
...
| 参数名 | 类型 | 必填 |
| --- | --- | --- |
| isMilitaryTime | [Optional](arkts-arkui-optional-t.md)&lt;boolean&gt; | 是 |
