...
滑动条滑块在滑轨上显示的样式，样式说明请参考\_\_\_MD\_LINK\_DESC\_USD\_0\_\_\_。
    **说明：**  
    
    - Slider无默认padding。  
    
    - 当Slider为水平滑动条时，默认高度为40vp，宽度为父容器的宽度，滑动条居中显示，当滑动条的style为SliderStyle.OutSet时，左右间距分别为9vp，即为  
    [blockSize]\_\_\_JSDOC\_LINK\_DESC\_USD\_1\_\_\_宽度的一半，当滑动条的style为SliderStyle.InSet时，左右间距分别为6vp，若设置padding，padding不会覆盖左右  
    间距。  
