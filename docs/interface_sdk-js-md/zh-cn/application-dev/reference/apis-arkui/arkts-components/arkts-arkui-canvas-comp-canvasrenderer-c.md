...
**继承/实现关系：** CanvasRenderer extends [CanvasPath](arkts-arkui-canvas-comp-canvaspath-c.md)
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| path | [Path2D](arkts-arkui-canvas-comp-path2d-c.md) | 是 | Path2D剪切路径。<br>异常值undefined或null按无效值处理。 |
| fillRule | [CanvasFillRule](arkts-arkui-canvas-comp-canvasfillrule-t.md) | 否 | 指定要剪切对象的规则。<br>可选参数为："nonzero"，"evenodd"。<br>异常值undefined或null按默认值处理。<br>默认值："nonzero" |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| imageData | [ImageData](arkts-arkui-canvas-comp-imagedata-c.md) | 是 | 已有的ImageData对象。<br>异常值undefined和null按宽高为0的ImageData处理。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| image | [ImageBitmap](arkts-arkui-canvas-comp-imagebitmap-c.md) | 是 | 图源对象，具体参考ImageBitmap对象。<br>异常值undefined或null按无效值处理。 |
...
| 类型 | 说明 |
| --- | --- |
| [CanvasPattern](arkts-arkui-canvas-comp-canvaspattern-i.md) &#124; null | 通过指定图像和重复方式创建图片填充的模板对象。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| image | [ImageBitmap](arkts-arkui-canvas-comp-imagebitmap-c.md) &#124; [PixelMap](arkts-arkui-common-comp-pixelmap-t.md) | 是 | 图片资源，请参考ImageBitmap或PixelMap。<br>异常值undefined或null按无效值处理，不进行绘制。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| path | [Path2D](arkts-arkui-canvas-comp-path2d-c.md) | 是 | Path2D填充路径。<br>异常值undefined或null按无效值处理。 |
| fillRule | [CanvasFillRule](arkts-arkui-canvas-comp-canvasfillrule-t.md) | 否 | 指定要填充对象的规则。<br>可选参数为："nonzero"，"evenodd"。<br>异常值undefined或null按默认值处理。<br>默认值："nonzero" |
...
| 类型 | 说明 |
| --- | --- |
| [PixelMap](arkts-arkui-common-comp-pixelmap-t.md) | PixelMap对象。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| imageData | [ImageData](arkts-arkui-canvas-comp-imagedata-c.md) | 是 | 含有像素数据的ImageData对象，用于放到画布上。<br>异常值undefined和null按无效值处理，不进行绘制。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| path | [Path2D](arkts-arkui-canvas-comp-path2d-c.md) | 是 | 需要绘制的Path2D。<br>异常值undefined或null按无效值处理，不进行绘制。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| bitmap | [ImageBitmap](arkts-arkui-canvas-comp-imagebitmap-c.md) | 是 | 需要显示的ImageBitmap对象。 |
...
**类型：** [CanvasDirection](arkts-arkui-canvas-comp-canvasdirection-t.md)
...
- 类型为[CanvasPattern](../arkts-apis/arkts-arkui-canvaspattern.md)时，使用createPattern方法创建。

默认值：'#000000'（黑色）

异常值设置无效，保持设置前效果。

**类型：** string &#124; number &#124; [CanvasGradient](arkts-arkui-canvas-comp-canvasgradient-c.md) &#124; [CanvasPattern](arkts-arkui-canvas-comp-canvaspattern-i.md)
...
**类型：** [ImageSmoothingQuality](arkts-arkui-canvas-comp-imagesmoothingquality-t.md)
...
**类型：** [CanvasLineCap](arkts-arkui-canvas-comp-canvaslinecap-t.md)
...
**类型：** [CanvasLineJoin](arkts-arkui-canvas-comp-canvaslinejoin-t.md)
...
颜色格式参考ResourceColor中string类型说明。
...
**类型：** [CanvasTextAlign](arkts-arkui-canvas-comp-canvastextalign-t.md)
...
**类型：** [CanvasTextBaseline](arkts-arkui-canvas-comp-canvastextbaseline-t.md)
