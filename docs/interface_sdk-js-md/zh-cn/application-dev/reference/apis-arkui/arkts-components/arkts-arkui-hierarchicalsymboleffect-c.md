...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| fillStyle | [EffectFillStyle](arkts-arkui-effectfillstyle-e.md) | 否 | [动效模式。具体枚举值及说明请参考EffectFillStyle枚举说明。默认值：EffectFillStyle.CUMULATIVE](arkts-arkui-effectfillstyle-e.md) |
