...
默认值：EdgeLightMode.EDGELIGHT\_DISABLED
...
设置半模态弹窗偏移量。当半模态为底部弹窗时，支持设置底部间距。不支持设置半模态的[SheetOptions]\_\_\_JSDOC\_LINK\_DESC\_USD\_0\_\_\_中的detents属性。y轴设置为负数的时候不生效。
