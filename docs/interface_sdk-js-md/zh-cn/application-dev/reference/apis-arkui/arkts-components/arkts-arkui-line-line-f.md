...
| 类型 | 说明 |
| --- | --- |
| [LineAttribute](arkts-arkui-line-attribute.md) | 直线的属性。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| style | [CustomBuilderT](../../apis-default/arkts-apis/arkts-custombuildert-t.md)&lt;[LineAttribute](arkts-arkui-line-attribute.md)&gt; | 是 | 设置组件属性的回调。 |
