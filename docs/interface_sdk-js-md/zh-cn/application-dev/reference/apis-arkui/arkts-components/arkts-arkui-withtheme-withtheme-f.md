...
| content_ | [CustomBuilder](../../apis-default/arkts-apis/arkts-custombuilder-t.md) | 否 | 支持单个子组件。 |

**返回值：**

| 类型 | 说明 |
| --- | --- |
| [WithThemeAttribute](arkts-arkui-withtheme-attribute.md) |  |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| style_ | [CustomBuilderT](../../apis-default/arkts-apis/arkts-custombuildert-t.md)&lt;[WithThemeAttribute](arkts-arkui-withtheme-attribute.md)&gt; | 是 | WithTheme属性实例 |
