...
设置系统材质下弹窗的非线性动画模式。
    ...
    **说明：** 当取值为 DISTORTION\_AUTO 时，需设置  
    [ImmersiveMaterial]\_\_\_JSDOC\_LINK\_DESC\_USD\_0\_\_\_ 类型材质方可生效，并依据设备算力档位自动生效非线性效果（高中档算力设备生效，  
...
设置系统材质下弹窗的流光动画模式。
    ...
    **说明：** 当取值为 EDGELIGHT\_AUTO 时，需设置  
    [ImmersiveMaterial]\_\_\_JSDOC\_LINK\_DESC\_USD\_0\_\_\_ 类型材质方可生效，并依据设备算力档位自动生效流光效果（高档算力设备生效，  
