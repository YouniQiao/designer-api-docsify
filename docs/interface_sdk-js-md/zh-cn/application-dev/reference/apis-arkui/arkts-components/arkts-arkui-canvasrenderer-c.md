...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| image | [ImageBitmap](arkts-arkui-imagebitmap-c.md) &#124; [PixelMap](arkts-arkui-pixelmap-t.md) | 是 | 图片资源，请参考ImageBitmap或PixelMap。<br>异常值undefined或null按无效值处理，不进行绘制。 |
...
| 类型 | 说明 |
| --- | --- |
| [PixelMap](arkts-arkui-pixelmap-t.md) | PixelMap对象。 |
...
| 类型 | 说明 |
| --- | --- |
| [Matrix2D](../arkts-apis/arkts-arkui-matrix2d-c.md) | 当前被应用到上下文的转换矩阵。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | [PixelMap](arkts-arkui-pixelmap-t.md) | 否 | 含有像素值的PixelMap对象。<br>异常值undefined和null按无效值处理，不进行绘制。<br>默认值：null |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| transform | [Matrix2D](../arkts-apis/arkts-arkui-matrix2d-c.md) | 否 | 变换矩阵。<br>异常值undefined或null按无效值处理。<br>默认值：null |
...
- 类型为string时，表示设置填充区域的颜色，颜色格式参考[ResourceColor](../arkts-apis/arkts-arkui-resourcecolor-t.md)中string类型说明。

- 类型为number时，表示设置填充区域的颜色，不支持设置全透明色，颜色格式参考[ResourceColor](../arkts-apis/arkts-arkui-resourcecolor-t.md)中number类型说明。
...
颜色格式参考[ResourceColor](../arkts-apis/arkts-arkui-resourcecolor-t.md)中string类型说明。
...
- 类型为string时，表示设置线条使用的颜色，颜色格式参考[ResourceColor](../arkts-apis/arkts-arkui-resourcecolor-t.md)中string类型说明。

- 类型为number时，表示设置线条使用的颜色，不支持设置全透明色，颜色格式参考[ResourceColor](../arkts-apis/arkts-arkui-resourcecolor-t.md)中number类型说明。
