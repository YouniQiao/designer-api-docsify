...
| 类型 | 说明 |
| --- | --- |
| [PolylineAttribute](arkts-arkui-polyline-attribute.md) | 折线的属性。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| style | [CustomBuilderT](../../apis-default/arkts-apis/arkts-custombuildert-t.md)&lt;[PolylineAttribute](arkts-arkui-polyline-attribute.md)&gt; | 是 | 设置组件属性的回调。 |
