...
**图1** 设置EdgeWidths效果图!\_\_\_MD\_LINK\_DESC\_USD\_0\_\_\_
...
通过@ohos.graphics.drawing的[createImageLattice]\_\_\_JSDOC\_LINK\_DESC\_USD\_0\_\_\_接口创建Lattice类型作为入参。将图像划分为矩形网格，同时处于偶数列和偶数行上的网格图像是固定的，不会被拉伸。其他位置的网格图像会根据slice进行拉伸。

该参数对[backgroundImageResizable]\_\_\_JSDOC\_LINK\_DESC\_USD\_1\_\_\_接口不生效。
