...
文本样式选项，继承自[PickerTextStyle](arkts-arkui-common-comp-pickertextstyle-i.md)。

**继承/实现关系：** TextPickerTextStyle extends [PickerTextStyle](arkts-arkui-common-comp-pickertextstyle-i.md)
