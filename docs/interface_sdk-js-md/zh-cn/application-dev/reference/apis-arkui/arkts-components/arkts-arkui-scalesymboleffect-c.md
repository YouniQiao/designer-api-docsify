...
| direction | [EffectDirection](arkts-arkui-effectdirection-e.md) | 否 | [动效方向。具体枚举值及说明请参考EffectDirection枚举说明。默认值：EffectDirection.DOWN](../arkts-apis/arkts-arkui-flipdirection-e.md) |
