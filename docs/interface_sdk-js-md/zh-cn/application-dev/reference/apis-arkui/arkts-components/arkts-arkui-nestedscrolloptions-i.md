...
滚动组件往起始端滚动时的嵌套滚动选项。NestedScrollMode.SELF\_ONLY表示仅自身滚动，不与父组件联动；NestedScrollMode.SELF\_FIRST表示自身先滚动，自身滚动到边缘后父组件滚动；NestedScrollMode.PARENT\_FIRST表示父组件先滚动，父组件滚动到边缘后自身滚动。
...
滚动组件往末尾端滚动时的嵌套滚动选项。NestedScrollMode.SELF\_ONLY表示仅自身滚动，不与父组件联动；NestedScrollMode.SELF\_FIRST表示自身先滚动，自身滚动到边缘后父组件滚动；NestedScrollMode.PARENT\_FIRST表示父组件先滚动，父组件滚动到边缘后自身滚动。
