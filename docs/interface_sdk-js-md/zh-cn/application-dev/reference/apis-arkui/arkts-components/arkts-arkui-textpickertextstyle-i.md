...
> **说明：**当设置minFontSize和maxFontSize时，font中的size将不生效。详细规则请参考Text组件的 &gt; maxFontSize属性。
...
> **说明：**当设置minFontSize和maxFontSize时，font中的size将不生效。默认最大行数为1，自适应高度方式为MIN_FONT_SIZE_FIRST。详细 &gt; 规则请参考Text组件的minFontSize属性。
