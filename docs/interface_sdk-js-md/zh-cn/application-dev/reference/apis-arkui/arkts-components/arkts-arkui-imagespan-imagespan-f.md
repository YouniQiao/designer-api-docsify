...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | [ResourceStr](../arkts-apis/arkts-arkui-resourcestr-t.md) \| [PixelMap](arkts-arkui-pixelmap-t.md) | 是 |  |

**返回值：**

| 类型 | 说明 |
| --- | --- |
| [ImageSpanAttribute](arkts-arkui-imagespan-attribute.md) |  |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| style | [CustomBuilderT](../../apis-default/arkts-apis/arkts-custombuildert-t.md)&lt;[ImageSpanAttribute](arkts-arkui-imagespan-attribute.md)&gt; | 是 | ImageSpan属性实例。 |
