...
粒子动画的集合。每个粒子动画（[ParticleOptions](arkts-arkui-particleoptions-i.md)）包含粒子发射，同时可配置粒子的颜色、透明度、大小、速度、加速度与自旋角度，详见[ParticleOptions](arkts-arkui-particleoptions-i.md)属性说明。
