...
[bindContextMenu]\_\_\_JSDOC\_LINK\_DESC\_USD\_0\_\_\_）场景生效。
...
[bindContextMenu]\_\_\_JSDOC\_LINK\_DESC\_USD\_0\_\_\_时，仅弹出配置的自定义菜单预览。
...
表示拖拽过程中背板图是否支持多选聚拢效果。true表示支持多选聚拢效果，false表示不支持多选聚拢效果。该参数只在[Grid]\_\_\_JSDOC\_LINK\_DESC\_USD\_0\_\_\_和[List]\_\_\_JSDOC\_LINK\_DESC\_USD\_1\_\_\_组件中的  
[GridItem]\_\_\_JSDOC\_LINK\_DESC\_USD\_2\_\_\_组件和[ListItem]\_\_\_JSDOC\_LINK\_DESC\_USD\_3\_\_\_组件生效。

当一个item组件设置为多选拖拽时，该组件的子组件不可拖拽。聚拢组件预览图设置的优先级为  
[dragPreview]\_\_\_JSDOC\_LINK\_DESC\_USD\_4\_\_\_中的string，dragPreview中的PixelMap，组件自截图，不支持dragPreview中的Builder形式。

不支持组件绑定  
[bindContextMenu]\_\_\_JSDOC\_LINK\_DESC\_USD\_5\_\_\_中参数存在isShown的模式。
