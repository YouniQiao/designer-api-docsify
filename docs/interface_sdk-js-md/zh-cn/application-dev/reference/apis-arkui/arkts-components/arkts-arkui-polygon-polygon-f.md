...
| 类型 | 说明 |
| --- | --- |
| [PolygonAttribute](arkts-arkui-polygon-attribute.md) | 多边形的属性。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| style | [CustomBuilderT](../../apis-default/arkts-apis/arkts-custombuildert-t.md)&lt;[PolygonAttribute](arkts-arkui-polygon-attribute.md)&gt; | 是 | 设置组件属性的回调。 |
