...
默认值：$r('sys.color.font_primary')。当[shaderStyle](arkts-arkui-richeditor-comp-richeditorparagraphstyle-i.md)同时设置时，shaderStyle优先级高于fontColor。
...
设置字体列表，当前支持'HarmonyOS Sans'字体和[注册自定义字体](../arkts-apis/arkts-arkui-font.md)。默认字体:'HarmonyOS Sans'。
...
与[shaderStyle](arkts-arkui-richeditor-comp-richeditorparagraphstyle-i.md)同时设置时，shaderStyle不生效。
...
**类型：** [TextBackgroundStyle](arkts-arkui-span-comp-textbackgroundstyle-i.md)
...
**类型：** [ShadowOptions](arkts-arkui-common-comp-shadowoptions-i.md) &#124; Array&lt;[ShadowOptions](arkts-arkui-common-comp-shadowoptions-i.md)&gt;
