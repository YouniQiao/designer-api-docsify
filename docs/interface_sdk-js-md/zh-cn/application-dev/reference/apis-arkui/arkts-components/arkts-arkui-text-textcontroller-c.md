...
| 类型 | 说明 |
| --- | --- |
| [LayoutManager](../arkts-apis/arkts-arkui-textcommon-layoutmanager-i.md) \| undefined | 布局管理器对象。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | [StyledString](../arkts-apis/arkts-arkui-styledstring-styledstring-c.md) | 是 |  |
