...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | [TextInputOptions](arkts-arkui-textinput-comp-textinputoptions-i.md) | 否 | TextInput组件参数。默认值undefined。不设置该参数时，输入框初始化为空。 |
...
| 名称 | 说明 |
| --- | --- |
| [PasswordIcon](arkts-arkui-textinput-comp-passwordicon-i.md) | PasswordIcon对象。 |
| [SubmitEvent](arkts-arkui-textinput-comp-submitevent-i.md) | 定义用户提交事件。 |
| [TextInputOptions](arkts-arkui-textinput-comp-textinputoptions-i.md) | TextInput初始化参数。 |
| [UnderlineColor](arkts-arkui-textinput-comp-underlinecolor-i.md) | 定义下划线颜色宽度属性。 |

### 类型

| 名称 | 说明 |
| --- | --- |
| [OnContentScrollCallback](arkts-arkui-textinput-comp-oncontentscrollcallback-t.md) | 文本内容滚动回调。 |
| [OnPasteCallback](arkts-arkui-textinput-comp-onpastecallback-t.md) | 粘贴回调。 |
| [OnSubmitCallback](arkts-arkui-textinput-comp-onsubmitcallback-t.md) | 提交回调。 |
| [OnTextSelectionChangeCallback](arkts-arkui-textinput-comp-ontextselectionchangecallback-t.md) | 文本选择变化回调或光标位置变化回调。 |

### 枚举

| 名称 | 说明 |
| --- | --- |
| [ContentType](arkts-arkui-textinput-comp-contenttype-e.md) | 自动填充类型。 |
| [EnterKeyType](arkts-arkui-textinput-comp-enterkeytype-e.md) | 输入法回车键类型。 |
| [InputType](arkts-arkui-textinput-comp-inputtype-e.md) | 单行文本输入框类型。 |
| [TextInputStyle](arkts-arkui-textinput-comp-textinputstyle-e.md) | 文本输入样式。 |
