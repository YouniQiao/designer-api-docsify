...
1. 自定义路由表，开发者通过[navDestination](arkts-arkui-navigation-attribute.md#navdestination)方法传递。 2. 系统路由表，通过routerMap中的name设置，可参考[示例2](../../../reference/apis-arkui/arkui-ts/ts-basic-components-navigation.md#示例2使用导航控制器方法)。
