...
| content_ | [CustomBuilder](../../apis-default/arkts-apis/arkts-custombuilder-t.md) | 否 | The node of component. |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| style | [CustomBuilderT](../../apis-default/arkts-apis/arkts-custombuildert-t.md)&lt;[HyperlinkAttribute](arkts-arkui-hyperlink-attribute.md)&gt; | 是 | Hyperlink属性实例。 |
