...
| 参数名 | 类型 | 必填 | 说明 |  
| ------ | ------ | ---- | ---------------- |  
| from | [NavDestinationContext](NavDestinationContext) \| [NavBar](arkts-arkui-navbar-t.md#NavBar) | 是 | 页面跳转之前的栈顶页面信息。参数值为navBar，则表示跳转前的页面为Navigation首页。 |  
| to | [NavDestinationContext](NavDestinationContext) \| [NavBar](arkts-arkui-navbar-t.md#NavBar) | 是 | 页面跳转之后的栈顶页面信息。参数值为navBar，则表示跳转的目标页面为Navigation首页。 |  
...
| 参数名 | 类型 | 必填 | 说明 |  
| ------ | ------ | ---- | ---------------- |  
| mode | [NavigationMode](arkts-arkui-navigationmode-e.md#NavigationMode) | 是 | 导航页的显示模式。 |
