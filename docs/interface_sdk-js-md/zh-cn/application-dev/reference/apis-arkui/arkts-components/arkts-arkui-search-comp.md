...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| options | [SearchOptions](arkts-arkui-search-comp-searchoptions-i.md) | 否 | 搜索框组件初始化选项。当需要设置搜索框的初始值、提示文本、图标或控制器时传入此参数，不传入时使用默认配置。 |
...
| 名称 | 说明 |
| --- | --- |
| [CancelButtonOptions](arkts-arkui-search-comp-cancelbuttonoptions-i.md) | 定义清除按钮选项。 |
| [CancelButtonSymbolOptions](arkts-arkui-search-comp-cancelbuttonsymboloptions-i.md) | 定义清除按钮Symbol图标选项。 |
| [IconOptions](arkts-arkui-search-comp-iconoptions-i.md) | 定义图标选项。 |
| [SearchButtonOptions](arkts-arkui-search-comp-searchbuttonoptions-i.md) | 定义搜索按钮选项。 |
| [SearchOptions](arkts-arkui-search-comp-searchoptions-i.md) | Search初始化参数。 |

### 类型

| 名称 | 说明 |
| --- | --- |
| [SearchSubmitCallback](arkts-arkui-search-comp-searchsubmitcallback-t.md) | 点击搜索图标、搜索按钮或者按下软键盘搜索按钮时的回调事件。 |

### 枚举

| 名称 | 说明 |
| --- | --- |
| [CancelButtonStyle](arkts-arkui-search-comp-cancelbuttonstyle-e.md) | 清除按钮样式枚举。 |
| [SearchType](arkts-arkui-search-comp-searchtype-e.md) | 搜索输入框类型。 |
...
从API version 8开始，该示例通过[controller](arkts-arkui-search-comp-searchcontroller-c.md)实现了光标位置的设置与获取的功能。
