...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | [ItemAlign](../arkts-apis/arkts-arkui-itemalign-e.md) | 是 | GridRow中的GridCol交叉轴方向对齐方式。<br>默认值：ItemAlign.Start <br>非法值：按默认值处理。<br>**说明：** <br>ItemAlign支持的枚举：ItemAlign.Start、ItemAlign.Center、ItemAlign.End、ItemAlign.Stretch。 |
