...
> **说明：**
> 
> 如果出现分割线粗细不一或者消失的问题，请参考 &gt; [组件级像素取整常见问题](../../../reference/apis-arkui/arkui-ts/ts-universal-attributes-pixelRoundForComponent.md#常见问题)。
...
| 类型 | 说明 |
| --- | --- |
| [DividerAttribute](arkts-arkui-divider-attribute.md) |  |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| style | [CustomBuilderT](../../apis-default/arkts-apis/arkts-custombuildert-t.md)&lt;[DividerAttribute](arkts-arkui-divider-attribute.md)&gt; | 是 | the callback to set up component's attributes. |
