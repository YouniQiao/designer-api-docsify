...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| style | [CustomBuilderT](../../apis-default/arkts-apis/arkts-custombuildert-t.md)&lt;[VideoAttribute](arkts-arkui-video-attribute.md)&gt; | 是 | the callback to set up component's attributes. |
