...
| sections | [Array](../../apis-arkts/arkts-apis/arkts-arkts-array-c.md)<SectionOptions> | 否 | 表示要从start开始加入的分组。如果不指定，`splice()`将只从瀑布流中删除分组。 |
...
| 类型 | 说明 |
| --- | --- |
| [Array](../../apis-arkts/arkts-apis/arkts-arkts-array-c.md)<SectionOptions> | 瀑布流中所有分组配置信息。 |
