...
默认值：undefined，默认状态下配合[CheckboxGroupOptions]\_\_\_JSDOC\_LINK\_DESC\_USD\_0\_\_\_属性group信息为undefined的节点使用。

**说明：**

未配合使用[CheckboxGroup]\_\_\_JSDOC\_LINK\_DESC\_USD\_1\_\_\_组件时，此值无用。
