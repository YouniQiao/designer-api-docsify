...
| 类型 | 说明 |
| --- | --- |
| [TextInputAttribute](arkts-arkui-textinput-attribute.md) |  |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| style | [CustomBuilderT](../../apis-default/arkts-apis/arkts-custombuildert-t.md)&lt;[TextInputAttribute](arkts-arkui-textinput-attribute.md)&gt; | 是 | TextInput属性的实例。 |
