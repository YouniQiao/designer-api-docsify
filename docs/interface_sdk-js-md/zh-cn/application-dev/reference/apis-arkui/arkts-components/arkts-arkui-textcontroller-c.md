...
设置文本选择区域并高亮显示。
    **说明：**  
    ...
    当[copyOption]\_\_\_JSDOC\_LINK\_DESC\_USD\_0\_\_\_设置为CopyOptions.None时，设置setTextSelection不生效。  
    
    当[textOverflow]\_\_\_JSDOC\_LINK\_DESC\_USD\_1\_\_\_设置为TextOverflow.MARQUEE时，设置setTextSelection不生效。  
