...
长按悬浮菜单或使用[bindContextMenu<sup>12+</sup>](arkts-arkui-commonmethod-c.md#bindcontextmenu-2)显示菜单的预览内容样式，可以为目标组件的截图，也可以为用户自定义的内容。
