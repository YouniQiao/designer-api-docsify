...
[@Env](../../../reference/apis-arkui/arkui-ts/ts-env-system-property.md#env)变量参数，通过@Env(WritableEnvKey.DIRECTION)可获取[Direction](../arkts-apis/arkts-arkui-direction-e.md)枚举类型的值。
...
**类型：** WritableSystemEnvKey&lt;number&gt;
