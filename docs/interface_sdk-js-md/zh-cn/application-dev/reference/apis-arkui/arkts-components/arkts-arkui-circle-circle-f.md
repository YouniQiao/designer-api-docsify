...
| 类型 | 说明 |
| --- | --- |
| [CircleAttribute](arkts-arkui-circle-attribute.md) | Circle的属性。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| style | [CustomBuilderT](../../apis-default/arkts-apis/arkts-custombuildert-t.md)&lt;[CircleAttribute](arkts-arkui-circle-attribute.md)&gt; | 是 | Circle选项。 |
