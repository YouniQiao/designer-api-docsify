...
| counterclockwise | boolean | 否 | An optional Boolean value. If true, the arc is drawn counterclockwise, and otherwise clockwise. |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| imageData | [ImageData](arkts-arkui-imagedata-c.md) | 是 | Copy an object of the same width and height from an existing ImageData object The image itself is not allowed to be copied. |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| image | [Image](../../apis-arkgraphics3d/arkts-apis/arkts-arkgraphics3d-sceneresources-image-i.md) | 是 | The CanvasImageSource object that is the source of the duplicate image. |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| image | [Image](../../apis-arkgraphics3d/arkts-apis/arkts-arkgraphics3d-sceneresources-image-i.md) | 是 | An element drawn to the context. |
...
| counterclockwise | boolean | 否 | If true, the ellipse is drawn counterclockwise (counterclockwise) and clockwise otherwise. |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| path | [Path2D](arkts-arkui-viewmodel-path2d-i.md) | 是 | The Path2D path that needs to be populated. |
| x | number | 是 | The X coordinate of the detection point. |
| y | number | 是 | The Y coordinate of the detection point. |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| path | [Path2D](arkts-arkui-viewmodel-path2d-i.md) | 是 | Path2D path. |
| x | number | 是 | The X coordinate of the detection point. |
| y | number | 是 | The Y coordinate of the detection point. |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| imageData | [ImageData](arkts-arkui-imagedata-c.md) | 是 | An array object containing pixel values. |
