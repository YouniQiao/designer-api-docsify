...
| [PathShape](arkts-arkui-arkui-shape-pathshape-c.md) | 用于clipShape和maskShape接口的路径。 |
...
| [RoundRectShapeOptions](arkts-arkui-arkui-shape-roundrectshapeoptions-i.md) | RectShape 带有半径的构造函数参数。 |
