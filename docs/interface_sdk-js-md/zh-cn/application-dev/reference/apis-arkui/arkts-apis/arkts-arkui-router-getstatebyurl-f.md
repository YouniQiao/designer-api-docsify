...
通过url获取对应页面的状态信息。
    **说明：**  
    ...
    - 从API version 12开始支持，从API version 18开始废弃，建议使用[getStateByUrl]\_\_\_JSDOC\_LINK\_DESC\_USD\_2\_\_\_替  
    代。getStateByUrl需先通过[UIContext]\_\_\_JSDOC\_LINK\_DESC\_USD\_3\_\_\_中的  
