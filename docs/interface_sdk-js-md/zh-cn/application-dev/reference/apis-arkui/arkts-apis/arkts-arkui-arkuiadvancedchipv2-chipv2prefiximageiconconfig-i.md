...
继承自[ChipV2ImageIconConfig](arkts-arkui-arkuiadvancedchipv2-chipv2imageiconconfig-i.md)。

**继承/实现关系：** ChipV2PrefixImageIconConfig extends [ChipV2ImageIconConfig](arkts-arkui-arkuiadvancedchipv2-chipv2imageiconconfig-i.md)
