...
粒子动画的集合。每一个的粒子动画（[ParticleOptions](arkts-arkui-particle-particleoptions-i.md#ParticleOptions)）包含粒子发射，同时可配置粒子的颜色、透明度、大小、速度、加速度与旋转速度，详见  
[ParticleOptions](arkts-arkui-particle-particleoptions-i.md#ParticleOptions)属性说明。 
