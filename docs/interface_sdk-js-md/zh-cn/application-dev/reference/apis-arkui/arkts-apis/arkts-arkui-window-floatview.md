...
本模块可与[@ohos.window.floatingBall](arkts-arkui-window-floatingball.md)（闪控球）联合使用。通过[floatView.bind](arkts-arkui-floatview-bind-f.md)接口将标准悬浮窗控制器与闪控球控制器绑定后，用户点击闪控球可展开为标准悬浮窗，点击标准悬浮窗左上角的缩小按钮可收起为闪控球，实现两种窗口形态的相互切换。
...
- 标准悬浮窗支持与[闪控球](arkts-arkui-window-floatingball.md)互相绑定联合使用，实现更复杂场景。
