...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| param | [RequestParameterForStage](arkts-arkui-requestparameterforstage-i-sys.md) | 是 | stage模型的插件组件request参数。 |
| callback | [AsyncCallback](../../apis-basic-service-kit/arkts-apis/arkts-basicservices-asynccallback-i.md)<RequestCallbackParameters> | 是 | 插件组件request事件回调。 |
