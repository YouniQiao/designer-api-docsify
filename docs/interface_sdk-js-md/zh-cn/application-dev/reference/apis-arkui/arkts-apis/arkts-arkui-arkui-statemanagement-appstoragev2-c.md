...
将键值对数据存储在应用内存中。如果给定的key已经存在于\_\_\_MD\_LINK\_DESC\_USD\_0\_\_\_中，返回对应的值；否则，通过获取默认值的构造器构造默认值，并返回。
    **说明：**  
...
| defaultCreator | \_\_\_MD\_LINK\_USD\_0\_\_\_&lt;T&gt; | 否 | 获取默认值的构造器。默认值为undefined。如果数据未存储在AppStorageV2中，且没有传递默认构造器，则返回 undefined。 |
