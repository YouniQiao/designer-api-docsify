...
| 参数名 | 类型 | 必填 |
| --- | --- | --- |
| value | [Edge](arkts-arkui-edge-e.md) | 是 |
| options | [ScrollEdgeOptions](arkts-arkui-scroll-scrolledgeoptions-i.md) | 否 |
...
| 参数名 | 类型 | 必填 |
| --- | --- | --- |
| options | [ScrollOptions](arkts-arkui-scroll-scrolloptions-i.md) | 是 |
...
| value | int | 是 |
| smooth | boolean | 否 |
| align | [ScrollAlign](arkts-arkui-scroll-scrollalign-e.md) | 否 |
| options | [ScrollToIndexOptions](arkts-arkui-scroll-scrolltoindexoptions-i.md) | 否 |
