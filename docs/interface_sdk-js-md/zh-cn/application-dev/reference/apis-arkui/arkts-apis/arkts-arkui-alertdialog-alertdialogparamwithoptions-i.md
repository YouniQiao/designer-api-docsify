...
继承自[AlertDialogParam](arkts-arkui-alertdialog-alertdialogparam-i.md#AlertDialogParam)。

**继承/实现关系：** AlertDialogParamWithOptions extends [AlertDialogParam](arkts-arkui-alertdialog-alertdialogparam-i.md#AlertDialogParam)
...
**类型：** [DialogButtonDirection](arkts-arkui-alertdialog-dialogbuttondirection-e.md)
...
**类型：** Array&lt;[AlertDialogButtonOptions](arkts-arkui-alertdialog-alertdialogbuttonoptions-i.md)&gt;
