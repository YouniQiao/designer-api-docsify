...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| size | [Size](arkts-arkui-graphics-size-i.md) | 是 | 用于返回组件布局大小的宽和高，单位为vp。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| uiContext | [UIContext](arkts-arkui-arkui-uicontext-uicontext-c.md) | 是 | 回调该方法的时候，绑定[NodeContainer](node_container)的UI上下文。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| containerId | long | 是 | 回调该方法时，NodeController与NodeContainerId对应的[NodeContainer](node_container)绑定完成。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| containerId | long | 是 | 回调该方法时，NodeController与NodeContainerId对应的[NodeContainer](node_container)解绑完成。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| containerId | long | 是 | 回调该方法时，NodeController与NodeContainerId对应的[NodeContainer](node_container)即将绑定。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| containerId | long | 是 | 回调该方法时，NodeController与NodeContainerId对应的[NodeContainer](node_container)即将解绑。 |
