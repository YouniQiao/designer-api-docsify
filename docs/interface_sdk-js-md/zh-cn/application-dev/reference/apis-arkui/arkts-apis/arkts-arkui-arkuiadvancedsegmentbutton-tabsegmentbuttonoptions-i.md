...
页签类分段按钮选项。继承自[TabSegmentButtonConstructionOptions](arkts-arkui-arkuiadvancedsegmentbutton-tabsegmentbuttonconstructionoptions-i.md)。

**继承/实现关系：** TabSegmentButtonOptions extends [TabSegmentButtonConstructionOptions](arkts-arkui-arkuiadvancedsegmentbutton-tabsegmentbuttonconstructionoptions-i.md)
