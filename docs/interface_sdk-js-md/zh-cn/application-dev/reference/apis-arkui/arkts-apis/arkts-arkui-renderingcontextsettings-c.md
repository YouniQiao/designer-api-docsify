...
绘制文本默认开启抗锯齿效果，RenderingContextSettings的antialias无法影响绘制文本的抗锯齿效果，如需修改文本抗锯齿效果，请使用 [antialias&lt;sup&gt;24+&lt;/sup&gt;](../../../reference/apis-arkui/arkui-ts/ts-components-canvas-common-property.md#antialias24) 接口。
