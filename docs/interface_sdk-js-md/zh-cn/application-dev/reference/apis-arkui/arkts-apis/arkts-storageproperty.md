...
| [SubscribedAbstractProperty](arkts-arkui-storageproperty-subscribedabstractproperty-i.md) | 继承自[AbstractProperty&lt;T&gt;](arkts-arkui-abstractproperty-i.md)。 |

### 枚举

| 名称 | 说明 |
| --- | --- |
| [ColorMode](arkts-arkui-storageproperty-colormode-e.md) | 系统当前深浅色模式。 |
| [LayoutDirection](arkts-arkui-storageproperty-layoutdirection-e.md) | 系统的布局方向类型。 |
