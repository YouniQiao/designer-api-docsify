...
> **说明：**
> 
> - 以下API需先使用UIContext中的[getMagnifier()](../../apis-default/arkts-apis/arkts-arkuiuicontext-uicontext-c.md#getmagnifier)方法获取Magnifier实例，再通过此实例调用对应方法。
> 
...
请参考[getMagnifier](../../apis-default/arkts-apis/arkts-arkuiuicontext-uicontext-c.md#getmagnifier)的示例。
