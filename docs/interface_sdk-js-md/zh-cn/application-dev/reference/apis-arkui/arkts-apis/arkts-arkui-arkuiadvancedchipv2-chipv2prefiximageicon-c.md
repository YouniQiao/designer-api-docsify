...
继承自[ChipV2ImageIcon](arkts-arkui-arkuiadvancedchipv2-chipv2imageicon-c.md)。

**继承/实现关系：** ChipV2PrefixImageIcon extends [ChipV2ImageIcon](arkts-arkui-arkuiadvancedchipv2-chipv2imageicon-c.md)
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| config | [ChipV2PrefixImageIconConfig](arkts-arkui-arkuiadvancedchipv2-chipv2prefiximageiconconfig-i.md) | 是 | 前缀图标属性配置，用于设置前缀Image图标的显示属性，继承自ChipV2ImageIconConfig，包含src、size、 fillColor等配置项。 |
