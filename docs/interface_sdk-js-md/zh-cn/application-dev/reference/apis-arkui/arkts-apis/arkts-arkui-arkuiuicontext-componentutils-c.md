...
> 
> - 以下API需先使用UIContext中的[getComponentUtils()](../../apis-default/arkts-apis/arkts-arkuiuicontext-uicontext-c.md#getcomponentutils)方法获取到ComponentUtils对象，再通过该对象调用对应方法。
