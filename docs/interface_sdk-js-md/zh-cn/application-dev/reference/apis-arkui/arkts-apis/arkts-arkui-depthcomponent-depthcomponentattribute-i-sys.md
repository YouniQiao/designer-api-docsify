...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| camera | [DepthCameraParams](arkts-arkui-depthcomponent-depthcameraparams-i-sys.md) | 是 | 相机参数。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | [DepthComponentErrorCallback](arkts-arkui-depthcomponenterrorcallback-t-sys.md) | 是 | 背景资源加载失败的回调函数。 |
