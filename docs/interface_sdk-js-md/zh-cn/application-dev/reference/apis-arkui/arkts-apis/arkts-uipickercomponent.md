...
| 名称 | 说明 |
| --- | --- |
| [UIPickerComponent](arkts-arkui-uipickercomponent-uipickercomponent-f.md#uipickercomponent) | 定义UIPickerComponent组件。 |
...
| 名称 | 说明 |
| --- | --- |
| [PickerIndicatorType](arkts-arkui-uipickercomponent-pickerindicatortype-e.md) | 设置选中项指示器的类型。 |
