# trailOptimizedInterpolatingSpring（系统接口）
...
在[interpolatingSpring](arkts-arkui-curves-interpolatingspring-f.md)基础上新增尾迹优化参数，构造带尾迹优化的插值器弹簧曲线对象，生成一条从0到1的动画曲线，实际动画值根据曲线进行插值计算。动画时间由曲线参数决定，不受动画参数中的时长参数控制。
