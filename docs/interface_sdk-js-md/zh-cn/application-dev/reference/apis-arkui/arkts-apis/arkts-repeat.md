...
| 名称 | 说明 |
| --- | --- |
| [RepeatAttribute](arkts-arkui-repeatattribute-c.md) | 除支持[拖拽排序](../../apis-ability-kit/arkts-apis/arkts-app-ability-common.md)属性外，还支持以下属性。 |
...
| 名称 | 说明 |
| --- | --- |
| [Repeat](arkts-arkui-repeat-con.md#repeat) | Repeat基于数组类型数据来进行循环渲染，一般与滚动容器组件配合使用。  本文档仅为API参数说明。组件描述和使用说明见[Repeat开发者指南](../../../ui/rendering-control/arkts-new-rendering-control-repeat.md)。 |
