...
| event | [KeyEvent](../../apis-input-kit/arkts-apis/arkts-input-keyevent-i.md) | 是 | The keyboard event. |
...
| 类型 | 说明 |
| --- | --- |
| [ComponentSnapshot](arkts-arkui-componentsnapshot-c.md) | 组件快照。 |
...
| 类型 | 说明 |
| --- | --- |
| [DialogPresenter](arkts-arkui-dialogpresenter-c.md) | Dialog对象。 |
...
| 类型 | 说明 |
| --- | --- |
| [FocusController](arkts-arkui-focuscontroller-c.md) | 焦点控制器 |
...
| 类型 | 说明 |
| --- | --- |
| [Font](arkts-arkui-font-c.md) | object Font. |
...
| 类型 | 说明 |
| --- | --- |
| [KeyboardAvoidMode](arkts-arkui-keyboardavoidmode-e.md) | 返回虚拟键盘抬起时的页面避让模式。 |
...
| 类型 | 说明 |
| --- | --- |
| [Magnifier](arkts-arkui-magnifier-c.md) | Magnifier对象，可用于控制放大镜的显示和隐藏。 |
...
| 类型 | 说明 |
| --- | --- |
| [MeasureUtils](arkts-arkui-measureutils-c.md) | the MeasureUtils |
...
| 类型 | 说明 |
| --- | --- |
| [SmartGestureController](arkts-arkui-smartgesturecontroller-c.md) | 智能手势控制器对象。 |
...
| 类型 | 说明 |
| --- | --- |
| [TextMenuController](arkts-arkui-textmenucontroller-c.md) | object text menu controller. |
...
| 类型 | 说明 |
| --- | --- |
| [UIObserver](arkts-arkui-uiobserver-c.md) | 返回UIObserver实例对象。 |
...
| keyframes | [Array](../../apis-arkts/arkts-apis/arkts-arkts-array-c.md)<KeyframeState> | 是 | 所有的关键帧状态的列表。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| frameCallback | [FrameCallback](arkts-arkui-framecallback-c.md) | 是 | 下一帧需要执行的回调。 |
...
| 类型 | 说明 |
| --- | --- |
| [Array](../../apis-arkts/arkts-apis/arkts-arkts-array-c.md)<DynamicSyncScene> | The instance of SwiperDynamicSyncScene. |
...
| 类型 | 说明 |
| --- | --- |
| [ResolvedUIContext](arkts-arkui-resolveduicontext-c.md) | 返回带有解析策略的UIContext实例对象。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| feature | [CustomKeyboardContinueFeature](arkts-arkui-customkeyboardcontinuefeature-e.md) | 是 | 自定义键盘接续特性。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | [KeyboardAvoidMode](arkts-arkui-keyboardavoidmode-e.md) | 是 | 配置虚拟键盘抬起时页面的避让模式。<br />默认值：KeyboardAvoidMode.OFFSET，键盘抬起时默认避让模式为上抬。<br/>setKeyboardAvoidMode传入异常值时，该属性设置不生效。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| options | [OverlayManagerOptions](arkts-arkui-overlaymanageroptions-i.md) | 是 | Options. |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| policy | [TextSelectionClearPolicy](arkts-arkui-textselectionclearpolicy-e.md) | 是 | 文本选择清除策略。 |
