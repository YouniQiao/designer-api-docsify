...
尾部区域显示的自定义项数组，支持ChipGroupV2IconItemConfig（Image图标）、SymbolGlyphModifier（Symbol图标）或ChipGroupV2SymbolItemConfig（Symbol 图标配置）类型。

传参SymbolGlyphModifier时，不支持使用symbolEffect修改动效类型和effectStrategy设置动效。

**类型：** Array&lt;[ChipGroupV2IconItemConfig](arkts-arkui-arkuiadvancedchipgroupv2-chipgroupv2iconitemconfig-i.md) \| SymbolGlyphModifier \| [ChipGroupV2SymbolItemConfig](arkts-arkui-arkuiadvancedchipgroupv2-chipgroupv2symbolitemconfig-i.md)&gt;
