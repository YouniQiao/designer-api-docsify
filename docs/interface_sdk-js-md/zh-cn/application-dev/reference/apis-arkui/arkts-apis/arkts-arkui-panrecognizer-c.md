...
**继承/实现关系：** PanRecognizer extends [GestureRecognizer](arkts-arkui-component/gesture-gesturerecognizer-c.md)
...
| 类型 | 说明 |
| --- | --- |
| \_\_\_MD\_LINK\_USD\_0\_\_\_ | 当前滑动手势识别器的识别方向。 |
...
返回滑动手势识别器在不同输入源的情况下触发的最小滑动距离。
    **说明：**  
    ...
    仅支持对通过Pan手势初始化配置修改的设备类型进行阈值查询。对于默认滑动阈值，可通过查询[SourceTool]\_\_\_JSDOC\_LINK\_DESC\_USD\_0\_\_\_.Unknown类型获取。其他未主动设置的类型则无法获取。
...
| 类型 | 说明 |
| --- | --- |
| \_\_\_MD\_LINK\_USD\_0\_\_\_ | 当前滑动手势识别器的属性。 |
