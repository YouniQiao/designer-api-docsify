...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| monitor | [IMonitorDecoratedVariable](arkts-arkui-decorator-imonitordecoratedvariable-i.md) | 是 | 指代监听关系的句柄。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| getter | [GetterCallback](arkts-arkui-gettercallback-t.md)&lt;T&gt; | 是 | 获取值的回调函数，每次访问值时重新执行以获取最新值。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| getter | [GetterCallback](arkts-arkui-gettercallback-t.md)&lt;T&gt; | 是 | 获取值的回调函数，每次访问值时重新执行。 |
| setter | [SetterCallback](arkts-arkui-settercallback-t.md)&lt;T&gt; | 是 | 定义如何更新值，当.value被修改时调用。 |
