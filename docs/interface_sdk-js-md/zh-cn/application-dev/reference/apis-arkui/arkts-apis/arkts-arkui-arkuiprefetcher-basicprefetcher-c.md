...
**继承/实现关系：** BasicPrefetcher implements [IPrefetcher](../../apis-default/arkts-apis/arkts-arkuiprefetcher-iprefetcher-i.md)
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| dataSource | [IDataSourcePrefetching](../../apis-default/arkts-apis/arkts-arkuiprefetcher-idatasourceprefetching-i.md) | 否 | 支持预取能力的数据源。不传入时默认为空，后续可通过setDataSource方法设置数据源。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| dataSource | [IDataSourcePrefetching](../../apis-default/arkts-apis/arkts-arkuiprefetcher-idatasourceprefetching-i.md) | 是 | 支持预取能力的数据源。 |
