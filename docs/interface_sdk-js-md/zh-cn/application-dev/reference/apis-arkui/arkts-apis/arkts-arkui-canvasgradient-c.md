...
设置渐变断点值，包括偏移和颜色。支持设置rgb或argb格式颜色。支持通过传入[ColorMetrics](../../apis-na/arkts-apis/arkts-na-graphics-colormetrics-c.md#ColorMetrics)类型设置P3广色域颜色值，从API版 本26.0.0开始，新增支持BT2020广色域和HDR提亮。
