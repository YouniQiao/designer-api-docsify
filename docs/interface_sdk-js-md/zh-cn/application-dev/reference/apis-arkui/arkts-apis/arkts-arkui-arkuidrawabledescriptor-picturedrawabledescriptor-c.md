...
支持通过传入Picture对象创建PictureDrawableDescriptor对象。 继承自[DrawableDescriptor](../../apis-default/arkts-apis/arkts-arkuidrawabledescriptor-drawabledescriptorloadedresult-i.md)。

**继承/实现关系：** PictureDrawableDescriptor extends [DrawableDescriptor](../../apis-default/arkts-apis/arkts-arkuidrawabledescriptor-drawabledescriptor-c.md)
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| config | [HdrCompositionConfig](../../apis-default/arkts-apis/arkts-arkuidrawabledescriptor-hdrcompositionconfig-i.md) | 是 | HDR合成配置。 |
