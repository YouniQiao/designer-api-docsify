...
Scroll滚动时触发的回调。  
    **说明：**  
    若通过[onScrollFrameBegin]\_\_\_JSDOC\_LINK\_DESC\_USD\_1\_\_\_事件和[scrollBy]\_\_\_JSDOC\_LINK\_DESC\_USD\_2\_\_\_方法实现容器嵌套滚动，需设置子滚动节点的  
    EdgeEffect为None。如Scroll嵌套List滚动时，List组件的\_\_\_MD\_LINK\_DESC\_USD\_0\_\_\_  
