...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| gesture | [GestureHandler](arkts-arkui-gesturehandler-c.md) | 是 | gesture indicates the gesture bound to a component. |
| priority | [GesturePriority](arkts-arkui-gesturepriority-e.md) | 否 | priority indicates the gesture's priority. |
| mask | [GestureMask](arkts-arkui-gesturemask-e.md) | 否 | mask indicates the gesture's GestureMask value. |
