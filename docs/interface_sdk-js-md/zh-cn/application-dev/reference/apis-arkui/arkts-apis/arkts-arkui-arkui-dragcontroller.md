...
| [executeDrag](arkts-arkui-dragcontroller-executedrag-f.md) | Execute a drag event. |
| [executeDrag](arkts-arkui-dragcontroller-executedrag-f.md) | 主动发起拖拽能力，传入拖拽发起后跟手效果所拖拽的对象以及携带拖拽信息。使用Promise异步回调。 |
