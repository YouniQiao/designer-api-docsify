...
高亮背景颜色（实色，不透明）。&lt;/br&gt;**影响组件：** Progress、Button、Slider
...
一级背景颜色（实色，不透明）。&lt;/br&gt;**影响组件：** TextInput、QRCode
...
高亮背景。&lt;/br&gt;**影响组件：** Swiper、Toggle、Chip、&lt;/br&gt; Checkbox、CheckboxGroup、Radio
...
黑色中性高亮背景颜色。&lt;/br&gt;**影响组件：** PatternLock
...
三级背景。&lt;/br&gt;**影响组件：** [EditableTitleBar](../../apis-default/arkts-apis/arkts-arkuiadvancededitabletitlebar-editabletitlebar-s.md)、Progress、 AlphabetIndexer、&lt;/br&gt;Button、Select、 Toggle、&lt;/br&gt;Chip、TextInput、 Search。从API版本26.0.0开始，新增UIPickerComponent、 TextPicker。
...
通用分割线颜色。&lt;/br&gt;**影响组件：** [SelectDialog](arkts-arkui-arkuiadvanceddialog-selectdialog-s.md)、 PatternLock、Divider。从API版本26.0.0开始，新增 UIPickerComponent、TextPicker、MenuItem、 MenuItemGroup、Select。
...
20%高亮背景颜色。&lt;/br&gt;**影响组件：** Progress、[ProgressButton](arkts-arkui-arkuiadvancedprogressbutton-progressbutton-s.md)、 AlphabetIndexer、&lt;/br&gt;Select、Toggle
...
高亮字体颜色。&lt;/br&gt;**影响组件：** [TipsDialog](arkts-arkui-arkuiadvanceddialog-tipsdialog-s.md)、 [ConfirmDialog](arkts-arkui-arkuiadvanceddialog-confirmdialog-s.md)、 [AlertDialog](arkts-arkui-arkuiadvanceddialog-alertdialog-s.md)、&lt;/br&gt; [SelectDialog](arkts-arkui-arkuiadvanceddialog-selectdialog-s.md)、 [CustomContentDialog](arkts-arkui-arkuiadvanceddialog-customcontentdialog-s.md)、 [SubHeader](../../apis-default/arkts-apis/arkts-arkuiadvancedsubheader-subheader-s.md)、&lt;/br&gt;AlphabetIndexer、 Popup、Button、&lt;/br&gt;Select、 [ToolBar](arkts-arkui-arkuiadvancedtoolbar-toolbar-s.md)、Search、&lt;/br&gt;TimePicker、 DatePicker、TextPicker。从API版本26.0.0开始，新增RichEditor。
...
一级文本反转颜色，用于彩色背景。&lt;/br&gt;**影响组件：** [Badge](../../apis-default/arkts-components/arkts-tabcontent-tabbaroptions-i.md#badge)、Button、 Chip
...
一级文本字体颜色。&lt;/br&gt;**影响组件：** [EditableTitleBar](../../apis-default/arkts-apis/arkts-arkuiadvancededitabletitlebar-editabletitlebar-s.md)、 [LoadingDialog](arkts-arkui-arkuiadvanceddialog-loadingdialog-s.md)、 [TipsDialog](arkts-arkui-arkuiadvanceddialog-tipsdialog-s.md)、&lt;/br&gt; [ConfirmDialog](arkts-arkui-arkuiadvanceddialog-confirmdialog-s.md)、 [AlertDialog](arkts-arkui-arkuiadvanceddialog-alertdialog-s.md)、 [SelectDialog](arkts-arkui-arkuiadvanceddialog-selectdialog-s.md)、&lt;/br&gt; [CustomContentDialog](arkts-arkui-arkuiadvanceddialog-customcontentdialog-s.md)、Swiper、 Text、&lt;/br&gt;[SubHeader](../../apis-default/arkts-apis/arkts-arkuiadvancedsubheader-subheader-s.md)、 [ProgressButton](arkts-arkui-arkuiadvancedprogressbutton-progressbutton-s.md)、AlphabetIndexer、&lt;/br&gt; Popup、Select、Chip、&lt;/br&gt; [ToolBar](arkts-arkui-arkuiadvancedtoolbar-toolbar-s.md)、Menu、TextInput、&lt;/br&gt; Search、TimePicker、DatePicker、&lt;/br&gt; TextPicker、[ComposeListItem](../../apis-default/arkts-apis/arkts-arkuiadvancedcomposelistitem-composelistitem-s.md)、 [TreeView](arkts-arkui-arkuiadvancedtreeview-treeview-s.md)。从API版本26.0.0开始，新增CalendarPicker、 UIPickerComponent、RichEditor、MenuItem、 MenuItemGroup、Counter。
...
二级文本字体颜色。&lt;/br&gt;**影响组件：** [EditableTitleBar](../../apis-default/arkts-apis/arkts-arkuiadvancededitabletitlebar-editabletitlebar-s.md)、 [AlertDialog](arkts-arkui-arkuiadvanceddialog-alertdialog-s.md)、 [CustomContentDialog](arkts-arkui-arkuiadvanceddialog-customcontentdialog-s.md)、&lt;/br&gt; [SubHeader](../../apis-default/arkts-apis/arkts-arkuiadvancedsubheader-subheader-s.md)、AlphabetIndexer、 Popup、&lt;/br&gt;TextInput、Search、 [ComposeListItem](../../apis-default/arkts-apis/arkts-arkuiadvancedcomposelistitem-composelistitem-s.md)、&lt;/br&gt; [TreeView](arkts-arkui-arkuiadvancedtreeview-treeview-s.md)、TextClock。从API版本26.0.0开始，新增 MenuItem、MenuItemGroup。
...
三级文本字体颜色。&lt;/br&gt;**影响组件：** [ComposeListItem](../../apis-default/arkts-apis/arkts-arkuiadvancedcomposelistitem-composelistitem-s.md)
...
高亮图标颜色。&lt;/br&gt;**影响组件：** [ToolBar](arkts-arkui-arkuiadvancedtoolbar-toolbar-s.md)
...
四级图标颜色。&lt;/br&gt;**影响组件：** Checkbox、CheckboxGroup、Radio
...
四级图标反转颜色，用于彩色背景。&lt;/br&gt;**影响组件：** [ProgressButton](arkts-arkui-arkuiadvancedprogressbutton-progressbutton-s.md)
...
一级图标反转颜色，用于彩色背景。&lt;/br&gt;**影响组件：** Checkbox、CheckboxGroup、 Radio
...
一级图标颜色。&lt;/br&gt;**影响组件：** [EditableTitleBar](../../apis-default/arkts-apis/arkts-arkuiadvancededitabletitlebar-editabletitlebar-s.md)、Swiper、 [ToolBar](arkts-arkui-arkuiadvancedtoolbar-toolbar-s.md)、&lt;/br&gt;[TreeView](arkts-arkui-arkuiadvancedtreeview-treeview-s.md)。从API版本26.0.0开 始，新增MenuItem。
...
二级图标颜色。&lt;/br&gt;**影响组件：** [LoadingDialog](arkts-arkui-arkuiadvanceddialog-loadingdialog-s.md)、 [SubHeader](../../apis-default/arkts-apis/arkts-arkuiadvancedsubheader-subheader-s.md)、&lt;/br&gt;Popup、 Chip、Search、&lt;/br&gt; [TreeView](arkts-arkui-arkuiadvancedtreeview-treeview-s.md)。从API版本26.0.0开始，新增LoadingProgress。
...
三级图标颜色。&lt;/br&gt;**影响组件：** [SubHeader](../../apis-default/arkts-apis/arkts-arkuiadvancedsubheader-subheader-s.md)
...
通用激活交互式颜色。&lt;/br&gt;**影响组件：** [TreeView](arkts-arkui-arkuiadvancedtreeview-treeview-s.md)
...
通用点击交互式颜色。&lt;/br&gt;**影响组件：** 从API版本26.0.0开始，新增MenuItem、Select。
...
通用获焦交互式颜色。&lt;/br&gt;**影响组件：** [EditableTitleBar](../../apis-default/arkts-apis/arkts-arkuiadvancededitabletitlebar-editabletitlebar-s.md)、 Chip、[TreeView](arkts-arkui-arkuiadvancedtreeview-treeview-s.md)
...
通用悬停交互式颜色。&lt;/br&gt;**影响组件：** [EditableTitleBar](../../apis-default/arkts-apis/arkts-arkuiadvancededitabletitlebar-editabletitlebar-s.md)、 Chip、[TreeView](arkts-arkui-arkuiadvancedtreeview-treeview-s.md)。从API版本26.0.0开始，新增 RichEditor、MenuItem、Select。
...
通用按压交互式颜色。&lt;/br&gt;**影响组件：** [EditableTitleBar](../../apis-default/arkts-apis/arkts-arkuiadvancededitabletitlebar-editabletitlebar-s.md)、 Chip、[TreeView](arkts-arkui-arkuiadvancedtreeview-treeview-s.md)。从API版本26.0.0开始，新增 RichEditor。
...
通用选择交互式颜色。&lt;/br&gt;**影响组件：** [TreeView](arkts-arkui-arkuiadvancedtreeview-treeview-s.md)
...
一级警示色。&lt;/br&gt;**影响组件：** [TipsDialog](arkts-arkui-arkuiadvanceddialog-tipsdialog-s.md)、 [AlertDialog](arkts-arkui-arkuiadvanceddialog-alertdialog-s.md)、 [CustomContentDialog](arkts-arkui-arkuiadvanceddialog-customcontentdialog-s.md)、&lt;/br&gt;[Badge](../../apis-default/arkts-components/arkts-tabcontent-tabbaroptions-i.md#badge)、 Button
