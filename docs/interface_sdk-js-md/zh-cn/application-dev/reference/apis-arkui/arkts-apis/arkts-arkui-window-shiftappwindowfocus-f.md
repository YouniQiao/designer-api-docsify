...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| sourceWindowId | ArkTS-Dyn: number  <br>ArkTS-Sta：int | 是 | 源窗口id，必须是获焦状态。推荐使用 [getWindowProperties()](arkts-arkui-window-window-i.md#getWindowProperties)方法获取窗口id属性。 |
