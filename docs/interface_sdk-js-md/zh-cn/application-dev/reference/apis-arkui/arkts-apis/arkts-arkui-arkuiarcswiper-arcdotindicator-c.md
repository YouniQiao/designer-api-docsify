...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| direction | Optional&lt;[ArcDirection](../../apis-default/arkts-apis/arkts-arkuiarcswiper-arcdirection-e.md)&gt; | 是 | 设置弧形指示器的方向。<br/>默认值：ArcDirection.SIX_CLOCK_DIRECTION，6点钟方向。 |

**返回值：**

| 类型 | 说明 |
| --- | --- |
| [ArcDotIndicator](../../apis-default/arkts-apis/arkts-arkuiarcswiper-arcdotindicator-c.md) | 提供弧形圆点指示器属性及功能。 |
