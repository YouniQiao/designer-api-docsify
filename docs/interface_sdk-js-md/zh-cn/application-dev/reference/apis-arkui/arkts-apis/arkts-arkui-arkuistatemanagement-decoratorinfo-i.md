...
当V2对象使用[makeObserved](arkts-arkui-arkuistatemanagement-uiutils-c.md#makeobserved)时，值为：'MakeObserved'。

当V2对象使用[enableV2Compatibility](arkts-arkui-arkuistatemanagement-uiutils-c.md#enablev2compatibility)时，值为：'EnableV2Compatible'。
...
**类型：** Array&lt;[ElementInfo](arkts-arkui-arkuistatemanagement-elementinfo-i.md)&gt;
