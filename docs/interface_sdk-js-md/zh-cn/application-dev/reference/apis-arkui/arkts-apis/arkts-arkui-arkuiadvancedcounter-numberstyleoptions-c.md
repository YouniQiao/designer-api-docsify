...
继承于[InlineStyleOptions](../../apis-default/arkts-apis/arkts-arkuiadvancedcounter-inlinestyleoptions-c.md)，包含该接口所有属性。本节仅展示新增属性，继承属性请参见父接口。

**继承/实现关系：** NumberStyleOptions extends [InlineStyleOptions](../../apis-default/arkts-apis/arkts-arkuiadvancedcounter-inlinestyleoptions-c.md)
...
使用场景：当需要在Counter旁边显示说明文字（如'价格'、'数量'等）时传入此参数。
