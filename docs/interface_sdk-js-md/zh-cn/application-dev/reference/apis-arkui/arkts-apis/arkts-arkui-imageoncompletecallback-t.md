...
当组件的参数类型为  
[AnimatedDrawableDescriptor](@ohos.arkui.drawableDescriptor.static:AnimatedDrawableDescriptor)时该事件不触发。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| loadEvent | [ImageCompleteEvent](arkts-arkui-image-imagecompleteevent-i.md) | 否 |  |
