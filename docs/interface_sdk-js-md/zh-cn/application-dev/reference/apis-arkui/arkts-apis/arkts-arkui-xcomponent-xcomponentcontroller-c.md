...
| rect | [SurfaceRect](arkts-arkui-xcomponent-surfacerect-i.md) | 是 | 回调该方法的时候，绑定XComponent持有Surface的显示区域。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| rect | [SurfaceRect](arkts-arkui-xcomponent-surfacerect-i.md) | 是 | XComponent持有Surface的显示区域。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| rotationOptions | [SurfaceRotationOptions](arkts-arkui-xcomponent-surfacerotationoptions-i.md) | 是 | 设置XComponent持有Surface在屏幕旋转时是否锁定方向。 |
