...
**类型：** [GradientBackground](arkts-arkui-atomicserviceatomicservicenavigation-gradientbackground-i.md)
...
**类型：** [Callback](../../apis-basic-services-kit/arkts-apis/arkts-basicservices-base-callback-i.md)&lt;NavigationMode&gt;
...
**类型：** [SideBarOptions](arkts-arkui-atomicserviceatomicservicenavigation-sidebaroptions-i.md)
...
**类型：** [TitleOptions](arkts-arkui-atomicserviceatomicservicenavigation-titleoptions-i.md)
