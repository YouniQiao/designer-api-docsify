...
| parentId | ArkTS-Dyn: number  \_\_\_HTML\_TAG\_USD\_0\_\_\_ArkTS-Sta：int | 是 | Indicates parent window id. The window id is a non-negative number and exists. |
| ctx | \_\_\_MD\_LINK\_USD\_0\_\_\_ | 是 | Indicates the context on which the window depends |
| parentWindowEventListener | \_\_\_MD\_LINK\_USD\_0\_\_\_ | 是 | Indicates the event listener of parent window. |
