...
**继承/实现关系：** RectShape extends [BaseShape](arkts-arkui-arkuishape-baseshape-c.md)
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| options | [RectShapeOptions](arkts-arkui-arkuishape-rectshapeoptions-i.md) \| [RoundRectShapeOptions](arkts-arkui-arkuishape-roundrectshapeoptions-i.md) | 否 | 矩形形状参数。 |
