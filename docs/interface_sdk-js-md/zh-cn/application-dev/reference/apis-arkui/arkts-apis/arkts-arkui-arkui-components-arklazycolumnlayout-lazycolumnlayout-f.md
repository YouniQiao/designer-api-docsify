...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| style_ | [CustomBuilderT](arkts-arkui-custombuildert-t.md)&lt;[LazyColumnLayoutAttribute](arkts-arkui-arkui-components-arklazycolumnlayout-lazycolumnlayoutattribute-i.md)&gt; | 是 | The style to create a LazyColumnLayout. |
| content_ | [CustomBuilder](arkts-arkui-custombuilder-t.md) | 否 |  |
