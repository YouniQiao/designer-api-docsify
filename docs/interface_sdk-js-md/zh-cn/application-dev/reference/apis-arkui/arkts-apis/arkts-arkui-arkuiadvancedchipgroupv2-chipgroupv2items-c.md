...
ChipGroupV2Items定义了ChipGroupV2项的数组类，继承自Array&lt;[ChipGroupV2Item](arkts-arkui-arkuiadvancedchipgroupv2-chipgroupv2item-c.md)&gt;。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| items | [ChipGroupV2ItemConfig](arkts-arkui-arkuiadvancedchipgroupv2-chipgroupv2itemconfig-i.md)[] | 是 | ChipGroupV2项配置数组。 |
