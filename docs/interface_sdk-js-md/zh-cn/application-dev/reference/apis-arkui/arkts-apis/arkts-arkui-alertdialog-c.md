...
showAlertDialog需先获取[UIContext]\_\_\_JSDOC\_LINK\_DESC\_USD\_0\_\_\_实例后再进行调用。
    从API version 10开始，可以通过使用[UIContext]\_\_\_JSDOC\_LINK\_DESC\_USD\_1\_\_\_中的  
    [showAlertDialog]\_\_\_JSDOC\_LINK\_DESC\_USD\_2\_\_\_来明确UI的执行上下文。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | \_\_\_MD\_LINK\_USD\_0\_\_\_ \| AlertDialogParamWithButtons \| AlertDialogParamWithOptions | 是 | 定义并显示 AlertDialog组件。\_\_\_HTML\_TAG\_USD\_0\_\_\_**起始版本：** 10 |
