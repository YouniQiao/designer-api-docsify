...
| data | [KVObject](../../apis-default/arkts-apis/arkts-plugincomponentmanager-kvobject-t.md) | 是 | request事件中传递的数据内容，以键值对形式存储，键和值类型由业务定义。 |

**返回值：**

| 类型 | 说明 |
| --- | --- |
| [RequestEventResult](../../apis-default/arkts-apis/arkts-plugincomponentmanager-requesteventresult-i.md) | 返回request事件结果。 |
