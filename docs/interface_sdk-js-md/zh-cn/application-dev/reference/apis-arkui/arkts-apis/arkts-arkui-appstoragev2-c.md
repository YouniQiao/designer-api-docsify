...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| type | [TypeConstructorWithArgs](arkts-arkui-typeconstructorwithargs-i.md)<T> | 是 | 指定的类型，若未指定key，则使用type的name作为key。 |
...
| 类型 | 说明 |
| --- | --- |
| [Array](../../apis-arkts/arkts-apis/arkts-arkts-array-c.md)<string> | 所有AppStorageV2中的key。 |
