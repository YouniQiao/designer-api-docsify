...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| node | [FrameNode](arkts-arkui-framenode-c.md) | 是 | ListItem节点对象。 |
...
| --- | --- | --- | --- |
| node | [FrameNode](arkts-arkui-framenode-c.md) | 是 | ListItem节点对象。 |
| direction | [ListItemSwipeActionDirection](arkts-arkui-listitem-listitemswipeactiondirection-e.md) | 是 | ListItem划出菜单的展开方向。 |
