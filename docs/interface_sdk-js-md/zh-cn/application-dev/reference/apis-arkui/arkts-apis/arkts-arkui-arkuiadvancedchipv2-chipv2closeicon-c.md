...
继承自[ChipV2Accessibility](arkts-arkui-arkuiadvancedchipv2-chipv2accessibility-c.md)。

**继承/实现关系：** ChipV2CloseIcon extends [ChipV2Accessibility](arkts-arkui-arkuiadvancedchipv2-chipv2accessibility-c.md)
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| config | [ChipV2CloseConfig](arkts-arkui-arkuiadvancedchipv2-chipv2closeconfig-i.md) | 是 | 关闭图标配置，用于自定义关闭图标的大小和无障碍属性，继承自ChipV2AccessibilityConfig，包含fontSize、 accessibilityText、accessibilityDescription等配置项。 |
