...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| styledString | [StyledString](arkts-arkui-styledstring-c-sys.md) | 是 | 待序列化的属性字符串对象，包含文本内容及样式信息。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| styledString | [StyledString](arkts-arkui-styledstring-c-sys.md) | 是 | 要序列化的属性字符串对象，包含文本内容及样式信息。 |
