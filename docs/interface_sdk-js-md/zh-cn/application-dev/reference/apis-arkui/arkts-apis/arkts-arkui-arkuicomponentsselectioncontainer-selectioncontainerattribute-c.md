...
| options | Optional&lt;[SelectionContainerMenuOptions](../../apis-default/arkts-apis/arkts-arkuicomponentsselectioncontainer-selectioncontainermenuoptions-i.md)&gt; | 否 | 指示选择菜单的选项 |

**返回值：**

| 类型 | 说明 |
| --- | --- |
| [SelectionContainerAttribute](../../apis-default/arkts-apis/arkts-arkuicomponentsselectioncontainer-selectioncontainerattribute-i.md) | 返回SelectionContainerAttribute的实例。 |
...
| 类型 | 说明 |
| --- | --- |
| [SelectionContainerAttribute](../../apis-default/arkts-apis/arkts-arkuicomponentsselectioncontainer-selectioncontainerattribute-i.md) | returns the instance of the SelectionContainerAttribute. |
...
> **说明：**
> 
> 当同时为当前场景设置了[bindSelectionMenu](../../apis-default/arkts-apis/arkts-arkuicomponentsselectioncontainer-selectioncontainerattribute-i.md#bindselectionmenu)和editMenuOptions时，优先使用
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| editMenu | Optional&lt;[SelectionContainerEditMenuOptions](../../apis-default/arkts-apis/arkts-arkuicomponentsselectioncontainer-selectioncontainereditmenuoptions-i.md)&gt; | 是 | 自定义编辑菜单配置。 |
...
> **说明：**
> 
> - 回调参数为按Text组件视觉顺序拼接后的选中文本，拼接方式由[textJoinStyle](../../apis-default/arkts-apis/arkts-arkuicomponentsselectioncontainer-selectioncontainerattribute-i.md#textjoinstyle)配置决定。
> 
> - 仅当容器级[onWillCopy](../../apis-default/arkts-apis/arkts-arkuicomponentsselectioncontainer-selectioncontainerattribute-i.md#onwillcopy)返回true时，该回调才会触发。
...
> - 回调参数为按Text组件视觉顺序拼接后的选中文本，拼接方式由[textJoinStyle](../../apis-default/arkts-apis/arkts-arkuicomponentsselectioncontainer-selectioncontainerattribute-i.md#textjoinstyle)配置决定。
> 
> - 返回false时，会阻止本次跨节点复制及容器级[onCopy](../../apis-default/arkts-apis/arkts-arkuicomponentsselectioncontainer-selectioncontainerattribute-i.md#oncopy)回调触发，但不会影响各Text子组件已独立处理完成的复制事件逻辑。
...
> **说明：**
> 
> - 该配置会影响[onWillCopy](../../apis-default/arkts-apis/arkts-arkuicomponentsselectioncontainer-selectioncontainerattribute-i.md#onwillcopy)、
> [onCopy](../../apis-default/arkts-apis/arkts-arkuicomponentsselectioncontainer-selectioncontainerattribute-i.md#oncopy)、
> [bindSelectionMenu](../../apis-default/arkts-apis/arkts-arkuicomponentsselectioncontainer-selectioncontainerattribute-i.md#bindselectionmenu)相关回调中返回的文本内容。
> 
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| style | Optional&lt;[SelectionContainerTextJoinStyle](../../apis-default/arkts-apis/arkts-arkuicomponentsselectioncontainer-selectioncontainertextjoinstyle-e.md)&gt; | 是 | 聚合文本拼接方式。 |
