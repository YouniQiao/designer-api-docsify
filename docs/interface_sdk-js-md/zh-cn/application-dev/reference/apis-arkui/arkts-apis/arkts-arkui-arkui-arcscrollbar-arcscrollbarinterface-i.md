...
> **说明：** 
> 
> - 未设置宽高时，ArcScrollBar采用父组件[LayoutConstraint](arkts-arkui-framenode-layoutconstraint-i.md)中的maxSize作为尺寸。若父组件存在可滚动组件，如ArcList、List、Grid、Scroll、WaterFlow，建议设置ArcScrollBar宽高，否则尺寸可能为无穷大。
> 
