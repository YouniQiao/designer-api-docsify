...
> [enableDataDetector](arkts-arkui-richeditor-richeditorattribute-i.md#enabledatadetector)、
> [dataDetectorConfig](arkts-arkui-richeditor-richeditorattribute-i.md#datadetectorconfig)、
> [enableSelectedDataDetector](arkts-arkui-richeditor-richeditorattribute-i.md#enableselecteddatadetector)功能不会生效。
...
| options | [RichEditorBuilderSpanOptions](arkts-arkui-richeditor-richeditorbuilderspanoptions-i.md) | 否 |
...
添加图片内容。如果组件光标闪烁，插入后光标位置更新为新插入图片的后面。该接口为同步接口，在弱网环境下，直接添加网络图片可能会阻塞UI线程造成冻屏问题。不建议直接添加网络图片。当controller未绑定组件或绑定controller的组件被释放时，该接口调用无效。
...
| 参数名 | 类型 | 必填 |
| --- | --- | --- |
| value | [PixelMap](../arkts-components/arkts-arkui-pixelmap-t.md) \| [ResourceStr](arkts-arkui-resourcestr-t.md) | 是 |
| options | [RichEditorImageSpanOptions](arkts-arkui-richeditor-richeditorimagespanoptions-i.md) | 否 |
...
| options | [RichEditorSymbolSpanOptions](arkts-arkui-richeditor-richeditorsymbolspanoptions-i.md) | 否 |
...
| 参数名 | 类型 | 必填 |
| --- | --- | --- |
| content | [ResourceStr](arkts-arkui-resourcestr-t.md) | 是 |
| options | [RichEditorTextSpanOptions](arkts-arkui-richeditor-richeditortextspanoptions-i.md) | 否 |
...
| 参数名 | 类型 | 必填 |
| --- | --- | --- |
| value | [RichEditorRange](arkts-arkui-richeditor-richeditorrange-i.md) | 否 |
...
| 参数名 | 类型 | 必填 |
| --- | --- | --- |
| value | [RichEditorRange](arkts-arkui-richeditor-richeditorrange-i.md) | 是 |
...
| 参数名 | 类型 | 必填 |
| --- | --- | --- |
| value | [RichEditorParagraphStyleOptions](arkts-arkui-richeditor-richeditorparagraphstyleoptions-i.md) | 是 |
...
更新文本、图片或SymbolSpan样式。若只更新了一个Span的部分内容，则会根据更新部分、未更新部分将该Span拆分为多个Span。使用该接口更新文本、图片或SymbolSpan样式时默认不会关闭自定义文本选择菜单。当controller未绑定组件或绑定controller的组件被释放时，该接口调用无效。
