...
| counterclockwise | boolean | 否 | Whether to draw the arc counterclockwise. |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| imageData | [ImageData](arkts-arkui-imagedata-c.md) | 是 | ImageData object with the same width and height copied from the original ImageData object. |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| path | [Path2D](arkts-arkui-viewmodel-path2d-i.md) | 否 | another created Path2D object. |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| cmds | string | 否 | a string defined using the SVG path command. |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| image | [Image](../../apis-arkgraphics3d/arkts-apis/arkts-arkgraphics3d-sceneresources-image-i.md) | 是 | Source image. |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| image | [Image](../../apis-arkgraphics3d/arkts-apis/arkts-arkgraphics3d-sceneresources-image-i.md) | 是 | Image resource. |
...
| counterclockwise | number | 否 | Indicates whether to draw an ellipse counterclockwise. 0: clockwise; 1: counterclockwise. The default value is 0. |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| imageData | [ImageData](arkts-arkui-imagedata-c.md) | 是 | ImageData object with pixels to put onto the canvas. |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| path | [Path2D](arkts-arkui-viewmodel-path2d-i.md) | 是 | The object of Path2D. |
