...
> - 该组件仅可在Stage模型下使用。  
>  
> - 设置TabTitleBar的[通用属性](../../apis-arkui/arkts-components/arkts-arkui-common-attribute.md)或[通用事件](../../apis-arkui/arkts-components/arkts-arkui-common-attribute.md)时，编译工具  
