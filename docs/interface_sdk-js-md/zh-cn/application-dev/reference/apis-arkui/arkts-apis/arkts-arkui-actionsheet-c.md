...
**替代接口：** [showActionSheet](../../apis-default/arkts-apis/arkts-arkuiuicontext-uicontext-c.md#showactionsheet)
...
showActionSheet需先获取[UIContext](../../apis-default/arkts-apis/arkts-arkuiuicontext-uicontext-c.md)实例后再进行调用。

> 从API version 10开始，可以通过使用[UIContext](../../apis-default/arkts-apis/arkts-arkuiuicontext-uicontext-c.md)中的
> [showActionSheet](../../apis-default/arkts-apis/arkts-arkuiuicontext-uicontext-c.md#showactionsheet)来明确UI的执行上下文。
