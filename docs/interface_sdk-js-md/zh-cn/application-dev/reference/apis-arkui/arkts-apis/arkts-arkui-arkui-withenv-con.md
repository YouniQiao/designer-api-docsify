...
WithEnv组件用于为子组件树设置局部环境变量作用域。开发者可以通过该组件为后代组件提供自定义环境变量，或设置系统环境变量。
    **说明：**
    ...
    - 可通过[customEnv]\_\_\_JSDOC\_LINK\_DESC\_USD\_0\_\_\_设置自定义环境变量。  
    
    - 支持通过[env]\_\_\_JSDOC\_LINK\_DESC\_USD\_1\_\_\_设置的系统环境变量键，系统环境变量键存于[WritableEnvKey]\_\_\_JSDOC\_LINK\_DESC\_USD\_2\_\_\_。  
