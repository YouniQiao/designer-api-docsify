...
> - 此接口仅可在Stage模型下使用。  
>  
> - 可通过[customEnv](arkts-arkui-withenvattribute-c.md#customenv-1)设置自定义环境变量。  
>  
> - 支持通过[env](arkts-arkui-withenvattribute-c.md#env-1)设置的系统环境变量键，系统环境变量键存于[WritableEnvKey](../arkts-components/arkts-arkui-writableenvkey-c.md)。  
>  
