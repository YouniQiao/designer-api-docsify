...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | [GetItemsInShapePathParams](arkts-arkui-getitemsinshapepathparams-i-sys.md) | 是 | 获取形状路径中图像的选项。 |

**返回值：**

| 类型 | 说明 |
| --- | --- |
| [Array](../../apis-arkts/arkts-apis/arkts-arkts-array-c.md)<ImageItem> | 返回位于选定区域内的图像对象。 |
