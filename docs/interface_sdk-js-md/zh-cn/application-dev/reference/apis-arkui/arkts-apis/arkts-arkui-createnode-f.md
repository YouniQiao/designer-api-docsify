...
| 类型 | 说明 |
| --- | --- |
| [Text](../../apis-arkdata/arkts-apis/arkts-arkdata-text-c.md) | Text类型的FrameNode节点。 |
...
| 类型 | 说明 |
| --- | --- |
| [Column](arkts-arkui-column-t.md) | Column类型的FrameNode节点。 |
...
| 类型 | 说明 |
| --- | --- |
| [Row](arkts-arkui-row-t.md) | Row类型的FrameNode节点。 |
...
| 类型 | 说明 |
| --- | --- |
| [Stack](../../apis-arkts/arkts-apis/arkts-arkts-stack-c.md) | Stack类型的FrameNode节点。 |
...
| 类型 | 说明 |
| --- | --- |
| [GridRow](arkts-arkui-gridrow-t.md) | GridRow类型的FrameNode节点。 |
...
| 类型 | 说明 |
| --- | --- |
| [GridCol](arkts-arkui-gridcol-t.md) | GridCol类型的FrameNode节点。 |
...
| 类型 | 说明 |
| --- | --- |
| [Flex](arkts-arkui-flex-t.md) | Flex类型的FrameNode节点。 |
...
| 类型 | 说明 |
| --- | --- |
| [Swiper](arkts-arkui-swiper-t.md) | Swiper类型的FrameNode节点。 |
...
| 类型 | 说明 |
| --- | --- |
| [Progress](../../apis-basic-service-kit/arkts-apis/arkts-basicservices-progress-i.md) | Progress类型的FrameNode节点。 |
...
| 类型 | 说明 |
| --- | --- |
| [Scroll](arkts-arkui-scroll-t.md) | Scroll类型的FrameNode节点。 |
...
| 类型 | 说明 |
| --- | --- |
| [RelativeContainer](arkts-arkui-relativecontainer-t.md) | RelativeContainer类型的FrameNode节点。 |
...
| 类型 | 说明 |
| --- | --- |
| [Divider](arkts-arkui-divider-t.md) | Divider类型的FrameNode节点。 |
...
| 类型 | 说明 |
| --- | --- |
| [LoadingProgress](arkts-arkui-loadingprogress-t.md) | LoadingProgress类型的FrameNode节点。 |
...
| 类型 | 说明 |
| --- | --- |
| [Search](arkts-arkui-search-t.md) | Search类型的FrameNode节点。 |
...
| 类型 | 说明 |
| --- | --- |
| [Blank](arkts-arkui-blank-t.md) | Blank类型的FrameNode节点。 |
...
| 类型 | 说明 |
| --- | --- |
| [Image](../../apis-arkgraphics3d/arkts-apis/arkts-arkgraphics3d-image-i.md) | Image类型的FrameNode节点。 |
...
| 类型 | 说明 |
| --- | --- |
| [List](../../apis-arkts/arkts-apis/arkts-arkts-list-c.md) | List类型的FrameNode节点。 |
...
| 类型 | 说明 |
| --- | --- |
| [ListItem](arkts-arkui-listitem-t.md) | ListItem类型的FrameNode节点。 |
...
| 类型 | 说明 |
| --- | --- |
| [TextInput](arkts-arkui-textinput-t.md) | TextInput类型的FrameNode节点。 |
...
| 类型 | 说明 |
| --- | --- |
| [Button](arkts-arkui-button-i.md) | Button类型的FrameNode节点。 |
...
| 类型 | 说明 |
| --- | --- |
| [ListItemGroup](arkts-arkui-listitemgroup-t.md) | ListItemGroup类型的FrameNode节点。 |
...
| 类型 | 说明 |
| --- | --- |
| [WaterFlow](arkts-arkui-waterflow-t.md) | WaterFlow类型的FrameNode节点。 |
...
| 类型 | 说明 |
| --- | --- |
| [FlowItem](arkts-arkui-flowitem-t.md) | FlowItem类型的FrameNode节点。 |
...
| 类型 | 说明 |
| --- | --- |
| [XComponent](arkts-arkui-xcomponent-t.md) | XComponent类型的FrameNode节点。 |
...
| 类型 | 说明 |
| --- | --- |
| [Checkbox](arkts-arkui-checkbox-t.md) | Checkbox类型的FrameNode节点。 |
...
| 类型 | 说明 |
| --- | --- |
| [CheckboxGroup](arkts-arkui-checkboxgroup-t.md) | CheckboxGroup类型的FrameNode节点。 |
...
| 类型 | 说明 |
| --- | --- |
| [Radio](arkts-arkui-radio-t.md) | Radio类型的FrameNode节点。 |
...
| 类型 | 说明 |
| --- | --- |
| [Rating](arkts-arkui-rating-t.md) | Rating类型的FrameNode节点。 |
...
| 类型 | 说明 |
| --- | --- |
| [Select](arkts-arkui-select-t.md) | Select类型的FrameNode节点。 |
...
| 类型 | 说明 |
| --- | --- |
| [Slider](arkts-arkui-slider-t.md) | Slider类型的FrameNode节点。 |
...
| 类型 | 说明 |
| --- | --- |
| [Toggle](arkts-arkui-toggle-t.md) | Toggle类型的FrameNode节点。 |
...
| 类型 | 说明 |
| --- | --- |
| [Marquee](arkts-arkui-marquee-t.md) | Marquee类型的FrameNode节点。 |
...
| 类型 | 说明 |
| --- | --- |
| [TextArea](arkts-arkui-textarea-t.md) | TextArea类型的FrameNode节点。 |
...
| 类型 | 说明 |
| --- | --- |
| [SymbolGlyph](arkts-arkui-symbolglyph-t.md) | SymbolGlyph类型的FrameNode节点。 |
...
| 类型 | 说明 |
| --- | --- |
| [QRCode](arkts-arkui-qrcode-t.md) | QRCode类型的FrameNode节点。 |
...
| 类型 | 说明 |
| --- | --- |
| [Badge](arkts-arkui-badge-t.md) | Badge类型的FrameNode节点。 |
...
| 类型 | 说明 |
| --- | --- |
| [TextClock](arkts-arkui-textclock-t.md) | TextClock类型的FrameNode节点。 |
...
| 类型 | 说明 |
| --- | --- |
| [TextTimer](arkts-arkui-texttimer-t.md) | TextTimer类型的FrameNode节点。 |
...
| 类型 | 说明 |
| --- | --- |
| [Grid](arkts-arkui-grid-t.md) | Grid类型的FrameNode节点。 |
...
| 类型 | 说明 |
| --- | --- |
| [GridItem](arkts-arkui-griditem-t.md) | GridItem类型的FrameNode节点。 |
