...
| 名称 | 说明 |
| --- | --- |
| [DigitIndicator](arkts-arkui-swiper-digitindicator-c.md) | Define DigitIndicator, the indicator type is digit. |
| [DotIndicator](arkts-arkui-swiper-dotindicator-c.md) | Define DotIndicator, the indicator type is dot. |
| [Indicator](arkts-arkui-swiper-indicator-c.md) | Defines the indicator class. |
| [SwiperController](arkts-arkui-swiper-swipercontroller-c.md) | Provides methods for switching components. |
