...
若在builder中监听数据变化可以使用[@Link](../../../ui/state-management/arkts-link.md)或  
[@Consume](../../../ui/state-management/arkts-provide-and-consume.md)，而其他方式如  
[@Prop](../../../reference/apis-arkui/arkui-ts/ts-state-management-prop.md)、  
[@ObjectLink](../../../reference/apis-arkui/arkui-ts/ts-state-management-objectlink.md)不适用此场景。
