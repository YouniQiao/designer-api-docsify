...
继承于[CommonOptions](../../apis-default/arkts-apis/arkts-arkuiadvancedcounter-commonoptions-c.md)。

> **说明：**
> 
> 1. min应小于等于max。若min大于max，则按max处理。

**继承/实现关系：** InlineStyleOptions extends [CommonOptions](../../apis-default/arkts-apis/arkts-arkuiadvancedcounter-commonoptions-c.md)
