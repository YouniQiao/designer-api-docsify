...
\_\_\_CODE\_BLOCK\_DESC\_USD\_0\_\_\_
    **说明：**  
    ...
    面。详细用法可参考\_\_\_MD\_LINK\_DESC\_USD\_1\_\_\_。
...
自定义弹窗的构造器。
    **说明：**  
    ...
    [backgroundColor]\_\_\_JSDOC\_LINK\_DESC\_USD\_0\_\_\_、背景模糊  
    [backgroundBlurStyle]\_\_\_JSDOC\_LINK\_DESC\_USD\_1\_\_\_  
    、[尺寸设置]\_\_\_JSDOC\_LINK\_DESC\_USD\_2\_\_\_等属性，通过属性绑定的状态变量来实现动态刷新的效果。  
...
显示自定义弹窗内容，允许多次使用，但如果弹窗为SubWindow模式（showInSubWindow为true），则该弹窗不允许再弹出SubWindow模式的弹窗。
    **说明：**  
    ...
    [createPanel]\_\_\_JSDOC\_LINK\_DESC\_USD\_0\_\_\_  
    。
