...
**类型：** [GradientAlpha](arkts-arkui-atomicserviceatomicservicenavigation-gradientalpha-e.md)
...
**类型：** [BackgroundTheme](arkts-arkui-atomicserviceatomicservicenavigation-backgroundtheme-e.md)
...
**类型：** [MixMode](arkts-arkui-atomicserviceatomicservicenavigation-mixmode-e.md)
