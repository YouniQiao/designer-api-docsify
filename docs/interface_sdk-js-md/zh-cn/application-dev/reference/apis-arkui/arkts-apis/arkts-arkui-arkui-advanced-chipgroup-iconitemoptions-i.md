...
如果想动态修改size，那么必须在引入[IconGroupSuffix](arkts-arkui-arkui-advanced-chipgroup-icongroupsuffix-s.md)时，使用[SymbolGlyphModifier](../arkts-components/arkts-arkui-symbolglyphmodifier-t.md)类型。
