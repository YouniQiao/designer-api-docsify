...
继承自[CommonShapeMethod](arkts-arkui-arkuishape-commonshapemethod-c.md)。

**继承/实现关系：** PathShape extends [CommonShapeMethod](arkts-arkui-arkuishape-commonshapemethod-c.md)
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| options | [PathShapeOptions](arkts-arkui-arkuishape-pathshapeoptions-i.md) | 否 | 路径参数。 |
