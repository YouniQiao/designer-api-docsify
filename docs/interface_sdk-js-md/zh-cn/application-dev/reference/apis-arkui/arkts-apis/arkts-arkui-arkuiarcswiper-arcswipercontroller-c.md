...
翻至下一页。翻页带动效切换过程，时长通过[duration](../../apis-default/arkts-apis/arkts-arkuiarcswiper-arcswiperattribute-i.md#duration)指定。通过此方法控制翻页时，effectMode设置的回弹效果不生效。
...
翻至上一页。翻页带动效切换过程，时长通过[duration](../../apis-default/arkts-apis/arkts-arkuiarcswiper-arcswiperattribute-i.md#duration)指定。通过此方法控制翻页时，effectMode设置的回弹效果不生效。
