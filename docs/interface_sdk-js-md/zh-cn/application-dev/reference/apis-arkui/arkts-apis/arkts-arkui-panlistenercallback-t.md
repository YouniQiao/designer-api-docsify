...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| event | [GestureEvent](arkts-arkui-gesture-gestureevent-i.md) | 是 | the information of pan event |
| current | [GestureRecognizer](arkts-arkui-gesture-gesturerecognizer-c.md) | 是 | the information of panRecognizer |
