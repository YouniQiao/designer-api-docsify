...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| config | [PromptOptionsV2Config](arkts-arkui-arkuiadvancedexceptionpromptv2-promptoptionsv2config-i.md) | 否 | PromptOptionsV2的配置信息。如果不传入config，则使用默认值：marginType为MarginTypeV2 .DEFAULT_MARGIN，marginTop为0。 |
...
**类型：** [MarginTypeV2](arkts-arkui-arkuiadvancedexceptionpromptv2-margintypev2-e.md)
