...
继承自 Array\&lt;[SegmentButtonV2Item](arkts-arkui-arkuiadvancedsegmentbuttonv2-segmentbuttonv2item-c.md)&gt;
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| items | [SegmentButtonV2ItemOptions](arkts-arkui-arkuiadvancedsegmentbuttonv2-segmentbuttonv2itemoptions-i.md)[] | 是 | 分段按钮选项配置参数集合。 |
