...
| [TypedFrameNode](arkts-arkui-framenode-typedframenode-i.md) | TypedFrameNode继承自[FrameNode](../../apis-default/arkts-apis/arkts-framenode-c.md)，用于声明具体类型的FrameNode，支持Text、Image、Button、Column等多种组件类型，适用于通过代码动态创建具体类型组件节 点的场景。 |
...
| 名称 | 说明 |
| --- | --- |
| [UIStatesChangeHandler](arkts-arkui-uistateschangehandler-t.md) | 当UI状态发生变化时触发的回调。接收回调触发时的[UIState](../../apis-default/arkts-apis/arkts-framenode-uistate-e.md)状态，该参数的取值为UIState状态枚举值或其运算结果。 |
