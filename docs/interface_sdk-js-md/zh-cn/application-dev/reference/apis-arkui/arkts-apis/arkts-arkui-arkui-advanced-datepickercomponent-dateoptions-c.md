...
继承于[CommonOptions](../../apis-default/arkts-apis/arkts-arkui-advanced-datepickercomponent-commonoptions-c.md)。

**继承/实现关系：** DateOptions extends [CommonOptions](../../apis-default/arkts-apis/arkts-arkui-advanced-datepickercomponent-commonoptions-c.md)
...
- true：显示为农历，适用于需要传统农历日期的场景，如传统节日、农历生日、农历纪念日等。 - false：不显示为农历，适用于使用公历日期的场景。
...
**类型：** [DateMode](../../apis-default/arkts-apis/arkts-arkui-advanced-datepickercomponent-datemode-e.md)
