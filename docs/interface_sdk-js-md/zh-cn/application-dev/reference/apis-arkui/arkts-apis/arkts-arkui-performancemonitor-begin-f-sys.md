...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| scene | string | 是 | 用户场景id。字符串长度无限制，建议控制在255个字符以内，格式推荐字母大写且用下划线连接，例如LAUNCHER\_\_\_ESCAPED\_UNDERSCORE\_\_\_APP\_\_\_ESCAPED\_UNDERSCORE\_\_\_LAUNCH\_\_\_ESCAPED\_UNDERSCORE\_\_\_FROM\_\_\_ESCAPED\_UNDERSCORE\_\_\_ICON。 |
| startInputType | \_\_\_MD\_LINK\_USD\_0\_\_\_ | 是 | 用户场景触发模式。 |
