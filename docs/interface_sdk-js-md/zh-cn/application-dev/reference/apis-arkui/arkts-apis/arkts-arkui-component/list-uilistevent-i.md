...
frameNode中\_\_\_MD\_LINK\_DESC\_USD\_0\_\_\_方法的返回值，可用于给List节点设置滚动事件。

UIListEvent继承于[UIScrollableCommonEvent]\_\_\_JSDOC\_LINK\_DESC\_USD\_1\_\_\_。

**继承/实现关系：** UIListEvent extends [UIScrollableCommonEvent](common-uiscrollablecommonevent-i.md)
