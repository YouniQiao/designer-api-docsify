...
**继承/实现关系：** CustomComponentV2 extends [BaseCustomComponent<T_Options>](BaseCustomComponent<T_Options>)
...
| reuseId | () =&gt; string | 否 | reuse id for reusable. Only valid if custom component decorated with @ReusableV2 |
| content | \_\_\_MD\_LINK\_USD\_0\_\_\_ | 否 | tail closure for custom component |
| options | \_\_\_MD\_LINK\_USD\_0\_\_\_ | 否 | additional invoke options |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| params | T\_Options | 否 | 自定义组件成员变量的数据 |
