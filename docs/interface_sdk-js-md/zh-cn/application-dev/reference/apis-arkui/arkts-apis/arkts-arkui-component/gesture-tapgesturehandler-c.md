...
**继承/实现关系：** TapGestureHandler extends [GestureHandler](gesture-gesturehandler-c.md)
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| event | \_\_\_MD\_LINK\_USD\_0\_\_\_&lt;\_\_\_MD\_LINK\_USD\_1\_\_\_&gt; | 是 | 点击手势处理器识别成功回调。 |
