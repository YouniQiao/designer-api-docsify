...
**继承/实现关系：** RingStyleOptions extends [ScanEffectOptions](progress-scaneffectoptions-i.md), [CommonProgressStyleOptions](progress-commonprogressstyleoptions-i.md)
