...
**继承/实现关系：** CapsuleStyleOptions extends [ScanEffectOptions](progress-scaneffectoptions-i.md), [CommonProgressStyleOptions](progress-commonprogressstyleoptions-i.md)
...
文本样式。默认值：文本大小（不支持百分比设置）：12fp其他文本参数跟随[Text]\_\_\_JSDOC\_LINK\_DESC\_USD\_0\_\_\_组件的主题值。
