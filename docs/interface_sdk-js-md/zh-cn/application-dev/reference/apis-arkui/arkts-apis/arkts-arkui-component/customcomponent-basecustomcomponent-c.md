...
**继承/实现关系：** BaseCustomComponent extends [ExtendableComponent](extendablecomponent-extendablecomponent-c.md) implements [CommonAttribute](../arkts-arkui-commonattribute-t.md)
