...
**继承/实现关系：** ContentCoverOptions extends [BindOptions](common-bindoptions-i.md)

**起始版本：** 23

**ArkTS模式：** 仅支持ArkTS-Sta，起始版本为23。

<!--Device-unnamed-export declare interface ContentCoverOptions extends BindOptions--><!--Device-unnamed-export declare interface ContentCoverOptions extends BindOptions-End-->
