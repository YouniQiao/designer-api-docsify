...
使用\_\_\_INLINE\_CODE\_DESC\_USD\_0\_\_\_进行批量数据修改时，\_\_\_INLINE\_CODE\_DESC\_USD\_1\_\_\_每一个数组项需要转换为对应的类型。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| dataOperations | Array&lt;\_\_\_MD\_LINK\_USD\_0\_\_\_&gt; | 是 |  |
