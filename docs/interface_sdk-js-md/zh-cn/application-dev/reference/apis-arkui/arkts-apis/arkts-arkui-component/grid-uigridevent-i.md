...
frameNode中\_\_\_MD\_LINK\_DESC\_USD\_0\_\_\_方法的返回值，可用于给Grid节点设置滚动事件。

UIGridEvent继承于[UIScrollableCommonEvent]\_\_\_JSDOC\_LINK\_DESC\_USD\_1\_\_\_。

**继承/实现关系：** UIGridEvent extends [UIScrollableCommonEvent](common-uiscrollablecommonevent-i.md)
...
设置[onScrollIndex]\_\_\_JSDOC\_LINK\_DESC\_USD\_0\_\_\_事件的回调。
