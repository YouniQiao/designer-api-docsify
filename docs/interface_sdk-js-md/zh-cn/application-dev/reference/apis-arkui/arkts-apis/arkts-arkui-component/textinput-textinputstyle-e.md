...
\_\_\_HTML\_TAG\_DESC\_USD\_0\_\_\_内联输入是在有明显的编辑态/非编辑态的区分场景下使用，例如：文件列表视图中的重命名。\_\_\_HTML\_TAG\_DESC\_USD\_1\_\_\_不支持showError属性。\_\_\_HTML\_TAG\_DESC\_USD\_2\_\_\_内联模式下，不支持拖入文本。
