...
**继承/实现关系：** PinchGesture extends [Gesture](gesture-gesture-c.md)
...
设置捏合手势事件。继承自[Gesture]\_\_\_JSDOC\_LINK\_DESC\_USD\_0\_\_\_。
...
| value | \_\_\_MD\_LINK\_USD\_0\_\_\_ | 否 | 捏合手势处理器配置参数。 |
...
Pinch手势识别成功并接收到触摸取消事件的回调。与[onActionCancel]\_\_\_JSDOC\_LINK\_DESC\_USD\_0\_\_\_相比，该回调返回手势事件信息。
