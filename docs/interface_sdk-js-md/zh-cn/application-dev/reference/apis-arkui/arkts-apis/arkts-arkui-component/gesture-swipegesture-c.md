...
**继承/实现关系：** SwipeGesture extends [Gesture](gesture-gesture-c.md)
...
设置快滑手势事件。继承自[Gesture]\_\_\_JSDOC\_LINK\_DESC\_USD\_0\_\_\_。
...
| value | \_\_\_MD\_LINK\_USD\_0\_\_\_ | 否 | 快滑事件处理器配置参数。 |
