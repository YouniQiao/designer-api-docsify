...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| range | \_\_\_MD\_LINK\_USD\_0\_\_\_ | 否 | The visible range. If the parameter is invalid, this method will have no effect. |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| styledString | \_\_\_MD\_LINK\_USD\_0\_\_\_ | 是 | The styledString for placeholder. If the parameter is invalid, this method will have no effect. |
