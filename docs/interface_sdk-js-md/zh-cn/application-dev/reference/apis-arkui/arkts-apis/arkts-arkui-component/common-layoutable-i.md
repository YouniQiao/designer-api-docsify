...
| 类型 | 说明 |
| --- | --- |
| \_\_\_MD\_LINK\_USD\_0\_\_\_&lt;double&gt; | the borderWidth of sub component, unit is vp. If some errors occur in the internal runtime environment, returns undefined. |
...
| 类型 | 说明 |
| --- | --- |
| \_\_\_MD\_LINK\_USD\_0\_\_\_&lt;double&gt; | the margin of sub component, unit is vp. If some errors occur in the internal runtime environment, returns undefined. |
...
| 类型 | 说明 |
| --- | --- |
| \_\_\_MD\_LINK\_USD\_0\_\_\_&lt;double&gt; | Padding of the child component, unit is vp. If some errors occur in the internal runtime environment, returns undefined. |
