...
| effect | [TranslateOptions](arkts-arkui-common-translateoptions-i.md) | 是 | 转场参数。 |
...
| effect | [AsymmetricTransitionOption](arkts-arkui-common-asymmetrictransitionoption-i.md) | 是 | 转场参数。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| options | [TranslateOptions](arkts-arkui-common-translateoptions-i.md) | 是 | 组件转场时的平移效果，为插入时起点和删除时终点的值。&lt;br/&gt;-x：横向的平移距离。&lt;br/&gt;-y：纵向的平移距离。&lt;br/&gt;-z：竖向的平移距离。 |
