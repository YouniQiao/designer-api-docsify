...
| 类型 | 说明 |
| --- | --- |
| [TreeListenerManager](arkts-arkui-arkui-advanced-treeview-treelistenermanager-c.md) | 返回获取到的监听管理器单例对象。 |
...
| 类型 | 说明 |
| --- | --- |
| [TreeListener](arkts-arkui-arkui-advanced-treeview-treelistener-c.md) | 返回获取到的监听器。 |
