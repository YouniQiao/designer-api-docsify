...
智慧手势处理基类。当通过[registerMonitor](../../apis-default/arkts-apis/arkts-arkuiuicontext-smartgesturecontroller-c.md#registermonitor)接口动态自定义智慧手势行为时，其回调参数类型为具体的子类类型实例。
