...
| defaultCreator | \_\_\_MD\_LINK\_USD\_0\_\_\_&lt;T&gt; | 否 | the function generating the default value |
| connectOptions | \_\_\_MD\_LINK\_USD\_0\_\_\_&lt;T&gt; | 否 | additional connect options. |
...
将键值对数据储存在应用磁盘中。如果给定的key已经存在于\_\_\_MD\_LINK\_DESC\_USD\_0\_\_\_中，返回对应的值；否则，会通过获取默认值的构造器构造默认值，并返回。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| params | \_\_\_MD\_LINK\_USD\_0\_\_\_&lt;T&gt; | 是 | application-level storage parameters. |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | \_\_\_MD\_LINK\_USD\_0\_\_\_ \| undefined | 是 | 持久化失败时调用。 |
