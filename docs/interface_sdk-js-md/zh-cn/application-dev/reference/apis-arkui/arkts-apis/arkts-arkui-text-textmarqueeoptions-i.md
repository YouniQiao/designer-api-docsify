...
**类型：** [MarqueeUpdatePolicy](arkts-arkui-text-marqueeupdatepolicy-e.md)
...
两轮跑马灯之间的间距。如果LengthMetrics的unit值是PERCENT，当前设置不生效，按默认值处理。默认值：48.0vp
