...
> **说明：**
> 
> - 以下API需要配合[UIContext](../../apis-default/arkts-apis/arkts-arkuiuicontext-uicontext-c.md)中的[postFrameCallback](../../apis-default/arkts-apis/arkts-arkuiuicontext-uicontext-c.md#postframecallback)和
> [postDelayedFrameCallback](../../apis-default/arkts-apis/arkts-arkuiuicontext-uicontext-c.md#postdelayedframecallback)使用。开发者需要继承该类并重写
> [onFrame](../../apis-default/arkts-apis/arkts-arkuiuicontext-framecallback-c.md#onframe)或[onIdle](../../apis-default/arkts-apis/arkts-arkuiuicontext-framecallback-c.md#onidle)方法，实现具体的业务逻辑。
