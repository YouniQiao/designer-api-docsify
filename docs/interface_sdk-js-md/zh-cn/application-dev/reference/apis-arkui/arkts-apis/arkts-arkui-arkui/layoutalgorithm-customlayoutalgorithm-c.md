...
通过重写此函数，开发者可以自定义排列子组件的位置。ArkUI框架会在动态布局组件确定位置时，将该组件对应的FrameNode和布局位置通过onLayout传递给开发者。不允许在onLayout函数中改变状态变量。
    **说明：**  
    ...
    在此函数中，开发者可以调用  
    \_\_\_MD\_LINK\_DESC\_USD\_0\_\_\_的  
    \_\_\_MD\_LINK\_DESC\_USD\_1\_\_\_方法获取子组件FrameNode，  
    调用\_\_\_MD\_LINK\_DESC\_USD\_2\_\_\_的  
    \_\_\_MD\_LINK\_DESC\_USD\_3\_\_\_方法设置子组件位置，  
    参考DynamicLayout组件  
...
通过重写此函数，开发者可以自定义测量子组件的大小。ArkUI框架会在动态布局组件确定尺寸时，将该组件对应的FrameNode和布局约束通过onMeasure传递给开发者。不允许在onMeasure函数中改变状态变量。
    **说明：**  
    ...
    \_\_\_MD\_LINK\_DESC\_USD\_1\_\_\_方法获取子组件FrameNode，  
    调用\_\_\_MD\_LINK\_DESC\_USD\_2\_\_\_的  
    \_\_\_MD\_LINK\_DESC\_USD\_3\_\_\_方法测量子组件大小，  
    参考DynamicLayout组件  
    \_\_\_MD\_LINK\_DESC\_USD\_4\_\_\_。
