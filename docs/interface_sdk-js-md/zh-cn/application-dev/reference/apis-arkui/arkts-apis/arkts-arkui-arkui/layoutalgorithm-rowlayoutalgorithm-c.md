...
**继承/实现关系：** RowLayoutAlgorithm implements [LayoutAlgorithm](layoutalgorithm-layoutalgorithm-i.md)
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| option | \_\_\_MD\_LINK\_USD\_0\_\_\_ | 否 | 水平方向线性布局算法的构造入参， 设置布局算法的间距、主轴对齐方式、交叉轴对齐方式及主轴排列方向。 |
...
\_\_\_MD\_LINK\_DESC\_USD\_0\_\_\_影响，如果\_\_\_MD\_LINK\_DESC\_USD\_1\_\_\_属性生效，再做一次反转。取值为false表示子组件在水平方向上正序排列。非法值：按默认值处理。
