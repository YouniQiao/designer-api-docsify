...
遮罩的填充颜色，使用ARGB格式。默认值为\_\_\_INLINE\_CODE\_DESC\_USD\_0\_\_\_。通过fillColor的透明度和亮度生成一个仅含透明度的颜色。亮度越高，颜色越透明。然后，使用[BlendMode.SRC\_IN]\_\_\_JSDOC\_LINK\_DESC\_USD\_1\_\_\_方式与RenderNode本身的颜色混合，生成最终颜色。取值限定为整数。
...
遮罩的边框颜色，使用ARGB格式。默认值为\_\_\_INLINE\_CODE\_DESC\_USD\_0\_\_\_。通过strokeColor的透明度和亮度生成一个仅含透明度的颜色。亮度越高，颜色越透明。然后，使用[BlendMode.SRC\_IN]\_\_\_JSDOC\_LINK\_DESC\_USD\_1\_\_\_方式与RenderNode本身的颜色混合，生成最终颜色。取值限定为整数。
