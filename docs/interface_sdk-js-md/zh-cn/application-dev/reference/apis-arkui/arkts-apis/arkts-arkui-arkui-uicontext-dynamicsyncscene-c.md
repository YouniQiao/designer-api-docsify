...
| 类型 | 说明 |
| --- | --- |
| [ExpectedFrameRateRange](arkts-arkui-common-expectedframeraterange-i.md) | The range of frameRate. |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| range | [ExpectedFrameRateRange](arkts-arkui-common-expectedframeraterange-i.md) | 是 | The range of frameRate. |
