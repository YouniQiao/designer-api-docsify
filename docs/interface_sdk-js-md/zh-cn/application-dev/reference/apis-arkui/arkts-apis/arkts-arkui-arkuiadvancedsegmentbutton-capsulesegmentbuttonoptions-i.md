...
胶囊类分段按钮选项。继承自[CapsuleSegmentButtonConstructionOptions](arkts-arkui-arkuiadvancedsegmentbutton-capsulesegmentbuttonconstructionoptions-i.md)。

**继承/实现关系：** CapsuleSegmentButtonOptions extends [CapsuleSegmentButtonConstructionOptions](arkts-arkui-arkuiadvancedsegmentbutton-capsulesegmentbuttonconstructionoptions-i.md)
