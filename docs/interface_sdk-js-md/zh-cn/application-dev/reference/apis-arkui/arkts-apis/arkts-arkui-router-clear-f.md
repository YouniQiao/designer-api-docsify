...
> **说明：**
> 
> - 从API version 8开始支持，从API version 18开始废弃，建议使用[clear](../../apis-default/arkts-apis/arkts-arkuiuicontext-router-c.md#clear)替代。clear需先通过
...
**替代接口：** [clear](../../apis-default/arkts-apis/arkts-arkuiuicontext-router-c.md#clear)
