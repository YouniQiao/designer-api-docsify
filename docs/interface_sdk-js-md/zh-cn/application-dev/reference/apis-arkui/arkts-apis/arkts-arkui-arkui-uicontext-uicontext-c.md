...
获取当前UIContext所属的窗口ID。\_\_\_HTML\_TAG\_DESC\_USD\_0\_\_\_**注意**：  
如果当前UIContext处于宿主进程中运行的UIExtensionAbility内，此方法将返回宿主应用程序的顶层窗口ID。\_\_\_HTML\_TAG\_DESC\_USD\_1\_\_\_
