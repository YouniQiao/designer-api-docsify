...
继承自[ChipV2AccessibilityConfig](arkts-arkui-arkuiadvancedchipv2-chipv2accessibilityconfig-i.md)。

**继承/实现关系：** ChipV2CloseConfig extends [ChipV2AccessibilityConfig](arkts-arkui-arkuiadvancedchipv2-chipv2accessibilityconfig-i.md)
