...
**替代接口：** [combine](arkts-arkui-matrix4transit-i.md#combine-1)
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| options | [Matrix4Transit](arkts-arkui-matrix4transit-i.md) | 是 | 待叠加的矩阵对象。 |

**返回值：**

| 类型 | 说明 |
| --- | --- |
| [Matrix4Transit](arkts-arkui-matrix4transit-i.md) | 叠加后的矩阵对象。 |
