...
继承自[BaseShape](arkts-arkui-arkuishape-baseshape-c.md)。

**继承/实现关系：** CircleShape extends [BaseShape](arkts-arkui-arkuishape-baseshape-c.md)
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| options | [ShapeSize](arkts-arkui-arkuishape-shapesize-i.md) | 否 | 形状的大小。 |
