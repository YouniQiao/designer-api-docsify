...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| active | [ActiveAndInactiveCallbackType](arkts-arkui-activeandinactivecallbacktype-t.md) | 否 | 激活函数回调 默认值： 默认值：undefined。 |
| inactive | [ActiveAndInactiveCallbackType](arkts-arkui-activeandinactivecallbacktype-t.md) | 否 | in激活函数回调 默认值： 默认值：undefined。 |
