...
| 名称 | 说明 |
| --- | --- |
| [FolderStackOptions](folderstack-folderstackoptions-i.md) | FolderStack的配置项。 |
| [HoverEventParam](folderstack-hovereventparam-i.md) | 当前设备与悬停状态相关的参数，包括设备的折叠状态、悬停状态、应用方向以及窗口模式枚举。 |
| [OnFoldStatusChangeInfo](folderstack-onfoldstatuschangeinfo-i.md) | 当折叠状态改变的时候回调，仅在横屏状态下生效。 |
