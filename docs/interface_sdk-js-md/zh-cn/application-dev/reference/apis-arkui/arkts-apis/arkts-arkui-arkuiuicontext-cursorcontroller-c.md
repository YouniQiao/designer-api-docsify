...
> 
> - 以下API需先使用UIContext中的[getCursorController()](../../apis-default/arkts-apis/arkts-arkuiuicontext-uicontext-c.md#getcursorcontroller)方法获取CursorController实例，再通过此实例调用对应方法。
