...
提供通过不同的url访问不同的页面，包括跳转到应用内的指定页面、同应用内的某个页面替换当前页面、返回上一页面或指定的页面等。  
    **说明：**  
    ...
    - 以下API需先使用UIContext中的\_\_\_MD\_LINK\_DESC\_USD\_0\_\_\_方法获取  
...
获取当前在页面栈内的页面数量。  
    **说明：**  
    从API version 10开始支持，从 API version 23开始废弃，建议使用[getStackSize]\_\_\_JSDOC\_LINK\_DESC\_USD\_0\_\_\_替代。
...
[pushUrl]\_\_\_JSDOC\_LINK\_DESC\_USD\_0\_\_\_相比，新增了mode参数，即支持设置跳转页面使用的模式。
