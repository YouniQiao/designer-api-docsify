...
| 名称 | 说明 |
| --- | --- |
| [cubicBezier](arkts-arkui-cubicbezier-f.md#cubicbezier-1) | 构造三阶贝塞尔曲线对象，曲线的值必须处于0-1之间。 |
...
| [init](arkts-arkui-init-f.md#init-1) | 插值曲线的初始化函数，可以根据入参创建一个插值曲线对象。 |
...
| [spring](arkts-arkui-spring-f.md#spring-1) | 构造弹簧曲线对象。 |
...
| [steps](arkts-arkui-steps-f.md#steps-1) | 构造阶梯曲线对象。 |
