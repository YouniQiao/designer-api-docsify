...
本模块提供设置动画插值曲线功能，用于构造阶梯曲线对象、三阶贝塞尔曲线对象和弹簧曲线对象。 &gt; **说明：** &gt; &gt; - 本模块同时支持ArkTS-Dyn、ArkTS-Sta。
...
| [responsiveSpringMotion](arkts-arkui-curves-responsivespringmotion-f.md) | 构造弹性跟手动画曲线对象，是springMotion的一种特例，仅默认 参数不同，可与springMotion混合使用。 |
