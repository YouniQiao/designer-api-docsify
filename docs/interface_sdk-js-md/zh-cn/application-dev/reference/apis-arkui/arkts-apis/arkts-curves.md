...
| [responsiveSpringMotion](arkts-arkui-curves-responsivespringmotion-f.md#responsivespringmotion) | 构造弹性跟手动画曲线对象，是[springMotion](../../../reference/apis-arkui/js-apis-curve_static.md#curvesspringmotion9)的一种特例，仅默认参数不同，可与springMotion混合使用。 |
