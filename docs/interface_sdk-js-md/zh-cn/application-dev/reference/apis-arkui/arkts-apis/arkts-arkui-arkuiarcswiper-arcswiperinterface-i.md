...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| controller | [ArcSwiperController](../../apis-default/arkts-apis/arkts-arkuiarcswiper-arcswipercontroller-c.md) | 否 | Controller bound to the component to control the page turning. |
