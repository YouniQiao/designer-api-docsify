...
| color | [ResourceColor](arkts-arkui-resourcecolor-t.md) | 是 | Color of the progress mask. |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | [ResourceColor](arkts-arkui-resourcecolor-t.md) | 是 | Color of the progress mask. |
