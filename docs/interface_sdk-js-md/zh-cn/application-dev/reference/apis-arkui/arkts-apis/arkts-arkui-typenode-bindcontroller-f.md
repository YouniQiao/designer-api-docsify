...
将文本控制器[TextController]\_\_\_JSDOC\_LINK\_DESC\_USD\_0\_\_\_绑定到[Text]\_\_\_JSDOC\_LINK\_DESC\_USD\_1\_\_\_节点。若该节点非ArkTS语言创建，则需要设置是否支持跨语言访问，如果不支持跨语言访问，则抛出异常。该接口不支持声明式方式创建的节点。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| node | \_\_\_MD\_LINK\_USD\_0\_\_\_ | 是 | 绑定文本控制器的目标节点。 |
| controller | \_\_\_MD\_LINK\_USD\_0\_\_\_ | 是 | 文本控制器。 |
...
将控制器[SwiperController]\_\_\_JSDOC\_LINK\_DESC\_USD\_0\_\_\_绑定到[Swiper]\_\_\_JSDOC\_LINK\_DESC\_USD\_1\_\_\_节点。若该节点非ArkTS语言创建，则需要设置是否支持跨语言访问，如果不支持跨语言访问，则抛出异常。该接口不支持声明式方式创建的节点。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| node | \_\_\_MD\_LINK\_USD\_0\_\_\_ | 是 | 绑定控制器的目标节点。 |
| controller | \_\_\_MD\_LINK\_USD\_0\_\_\_ | 是 | Swiper容器组件的控制器。 |
...
将滚动控制器[Scroller]\_\_\_JSDOC\_LINK\_DESC\_USD\_0\_\_\_绑定到[Scroll]\_\_\_JSDOC\_LINK\_DESC\_USD\_1\_\_\_节点。若该节点非ArkTS语言创建，则需要设置是否支持跨语言访问，如果不支持跨语言访问，则抛出异常。从API version 26.0.0开始，该接口支持声明式方式创建的节点，API version 26.0.0以下版本不支持。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| node | \_\_\_MD\_LINK\_USD\_0\_\_\_ | 是 | 绑定滚动控制器的目标节点。 |
| controller | \_\_\_MD\_LINK\_USD\_0\_\_\_ | 是 | 滚动控制器。 |
...
将滚动控制器[Scroller]\_\_\_JSDOC\_LINK\_DESC\_USD\_0\_\_\_绑定到[List]\_\_\_JSDOC\_LINK\_DESC\_USD\_1\_\_\_节点。若该节点非ArkTS语言创建，则需要设置是否支持跨语言访问，如果不支持跨语言访问，则抛出异常。从API version 26.0.0开始，该接口支持声明式方式创建的节点，API version 26.0.0以下版本不支持。
...
将输入框控制器[TextInputController]\_\_\_JSDOC\_LINK\_DESC\_USD\_0\_\_\_绑定到[TextInput]\_\_\_JSDOC\_LINK\_DESC\_USD\_1\_\_\_节点。若该节点非ArkTS语言创建，则需要设置是否支持跨语言访问，如果不支持跨语言访问，则抛出异常。从API版本26.0.0开始，该接口支持声明式方式创建的节点，API版本26.0.0以下版本不支持。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| node | \_\_\_MD\_LINK\_USD\_0\_\_\_ | 是 | 绑定输入框控制器的目标节点。 |
| controller | \_\_\_MD\_LINK\_USD\_0\_\_\_ | 是 | 输入框控制器。 |
...
将滚动控制器[Scroller]\_\_\_JSDOC\_LINK\_DESC\_USD\_0\_\_\_绑定到[WaterFlow]\_\_\_JSDOC\_LINK\_DESC\_USD\_1\_\_\_节点。若该节点非ArkTS语言创建，则需要设置是否支持跨语言访问，如果不支持跨语言访问，则抛出异常。从API version 26.0.0开始，该接口支持声明式方式创建的节点，API version 26.0.0以下版本不支持。
...
将输入框控制器[TextAreaController]\_\_\_JSDOC\_LINK\_DESC\_USD\_0\_\_\_绑定到[TextArea]\_\_\_JSDOC\_LINK\_DESC\_USD\_1\_\_\_节点。若该节点非ArkTS语言创建，则需要设置是否支持跨语言访问，如果不支持跨语言访问，则抛出异常。从API版本26.0.0开始，该接口支持声明式方式创建的节点，API版本26.0.0以下版本不支持。
...
将滚动控制器[Scroller]\_\_\_JSDOC\_LINK\_DESC\_USD\_0\_\_\_绑定到[Grid]\_\_\_JSDOC\_LINK\_DESC\_USD\_1\_\_\_节点。若该节点非ArkTS语言创建，则需要设置是否支持跨语言访问，如果不支持跨语言访问，则抛出异常。从API version 26.0.0开始，该接口支持声明式方式创建的节点，API version 26.0.0以下版本不支持。
