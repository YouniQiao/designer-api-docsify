...
动画曲线。推荐以Curve或ICurve形式指定。当类型为string时，为动画插值曲线，取值参考 [AnimateParam](arkts-arkui-common-animateparam-i.md)的curve参数。默认值：Curve.Linear
...
**类型：** [MotionPathOptions](arkts-arkui-common-motionpathoptions-i.md)
...
**类型：** [SharedTransitionEffectType](arkts-arkui-sharedtransitioneffecttype-e.md)
