...
[SwiperContentTransitionProxy]\_\_\_JSDOC\_LINK\_DESC\_USD\_0\_\_\_的  
[finishTransition]\_\_\_JSDOC\_LINK\_DESC\_USD\_1\_\_\_接口通知ArcSwiper组件此页面的自定义动画已结束，组件将强制结束该页面的自定义动画，并立即在该页面节点下渲染树。单位ms，默认值为0。
