...
继承自[ChipV2SymbolIcon](arkts-arkui-arkuiadvancedchipv2-chipv2symbolicon-c.md)。

**继承/实现关系：** ChipV2PrefixSymbolIcon extends [ChipV2SymbolIcon](arkts-arkui-arkuiadvancedchipv2-chipv2symbolicon-c.md)
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| config | [ChipV2PrefixSymbolIconConfig](arkts-arkui-arkuiadvancedchipv2-chipv2prefixsymboliconconfig-i.md) | 是 | 前缀Symbol图标属性配置，用于设置前缀Symbol图标的显示属性，继承自ChipV2SymbolIconConfig，包含 normal、activated等配置项。 |
