...
| callback | Callback&lt;void&gt; | 否 | 回调函数。当点击主窗口右上角关闭按钮事件发生时的回调。该回调函数不返回任何参数。 |
...
| callback | Callback&lt;void&gt; | 是 | Callback function requires a boolean return value to determine whether to |
