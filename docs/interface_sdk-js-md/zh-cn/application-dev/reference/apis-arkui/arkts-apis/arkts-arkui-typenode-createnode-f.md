...
| 类型 | 说明 |
| --- | --- |
| [Progress](../../apis-basic-services-kit/arkts-apis/arkts-basicservices-agent-progress-i.md) | Progress类型的FrameNode节点。 |
...
| 类型 | 说明 |
| --- | --- |
| [Button](arkts-arkui-system-prompt-button-i.md) | Button类型的FrameNode节点。 |
