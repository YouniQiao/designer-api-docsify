...
**继承/实现关系：** MouseEvent extends [BaseEvent](../arkts-components/arkts-arkui-baseevent-i.md/arkts-arkui-baseevent-i.md)

**起始版本：** 23

**ArkTS模式：** 仅支持ArkTS-Sta，起始版本为23。

<!--Device-unnamed-export declare interface MouseEvent extends BaseEvent--><!--Device-unnamed-export declare interface MouseEvent extends BaseEvent-End-->
...
<!--Device-MouseEvent-default getCurrentLocalPosition(): Coordinate2D--><!--Device-MouseEvent-default getCurrentLocalPosition(): Coordinate2D-End-->
...
<!--Device-MouseEvent-default getHistoricalPoints(): MouseHistoricalPoint[] | undefined--><!--Device-MouseEvent-default getHistoricalPoints(): MouseHistoricalPoint[] | undefined-End-->
...
| 类型 | 说明 |
| --- | --- |
| [MouseHistoricalPoint](arkts-arkui-common-mousehistoricalpoint-i.md)[] | return all historical points. Undefined will be returned if the internal runtime environment is broken. |
...
**类型：** [MouseAction](arkts-arkui-mouseaction-e.md)
...
**类型：** [MouseButton](arkts-arkui-mousebutton-e.md)
