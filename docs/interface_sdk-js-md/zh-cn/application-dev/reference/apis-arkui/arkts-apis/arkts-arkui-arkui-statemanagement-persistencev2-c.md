...
> **说明：**
> 
> 由于非[\@Trace](../../../ui/state-management/arkts-new-observedV2-and-trace.md)的数据改变 &gt; 不会触发[PersistenceV2](../../../ui/state-management/arkts-new-persistencev2.md)的自动持久化，当非\@Trace的数据发生变化且需要持久化时， &gt; 可调用该接口持久化对应key的数据。
> 
