...
继承自[AppStorageV2]\_\_\_JSDOC\_LINK\_DESC\_USD\_1\_\_\_，PersistenceV2提供UI状态的持久化存储能力，支持将应用状态数据持久化到磁盘，在应用重启后恢复数据，适用于需要保留UI状态数据的场景。具体UI使用说明，详见\_\_\_MD\_LINK\_DESC\_USD\_0\_\_\_。
...
将键值对数据存储在应用磁盘中。如果给定的key已经存在于\_\_\_MD\_LINK\_DESC\_USD\_0\_\_\_中，返回对应的值；否则，会通过获取默认值的构造器构造默认值，并返回。如果通过globalConnect连接的对象是  
\_\_\_MD\_LINK\_DESC\_USD\_1\_\_\_对象，该对象  
\_\_\_MD\_LINK\_DESC\_USD\_2\_\_\_属性的变化，会触发整个关联对象的自动刷新；非\@Trace属性变化则不会自动持久化，如需持久化非\@Trace属性的变化，可调用[PersistenceV2.save]\_\_\_JSDOC\_LINK\_DESC\_USD\_5\_\_\_接口手动存储。
    **说明：**  
    ...
    5、关联\_\_\_MD\_LINK\_DESC\_USD\_3\_\_\_对象时，因为该类型的name属性未定义，  
    需要指定key或者自定义name属性。  
    ...
    9、EL5加密要想生效，需要开发者在module.json中配置字段ohos.permission.PROTECT\_SCREEN\_LOCK\_DATA，  
    使用说明见\_\_\_MD\_LINK\_DESC\_USD\_4\_\_\_。
...
\_\_\_MD\_LINK\_DESC\_USD\_9\_\_\_。注意在持久化\_\_\_INLINE\_CODE\_DESC\_USD\_6\_\_\_类型的数据时，需要调用[\_\_\_INLINE\_CODE\_DESC\_USD\_7\_\_\_]\_\_\_JSDOC\_LINK\_DESC\_USD\_10\_\_\_使返回的对象被观察到。不支持多个嵌套集合，例如不支持\_\_\_INLINE\_CODE\_DESC\_USD\_8\_\_\_的持久化。
    **说明：**  
    ...
    其他通用条件详见globalConnect\_\_\_HTML\_TAG\_DESC\_USD\_11\_\_\_18+\_\_\_HTML\_TAG\_DESC\_USD\_12\_\_\_的说明。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| type | \_\_\_MD\_LINK\_USD\_0\_\_\_&lt;T, S&gt; \| ConnectOptions&lt;T&gt; | 是 | globalConnect的配置参数，支持ConnectOptions和 ConnectOptionsCollections两种类型，包含类型、key、默认构造器、集合项构造器等配置项，详细说明见ConnectOptions和ConnectOptionsCollections参数说明。 \_\_\_ESCAPED\_UNDERSCORE\_\_\_\_\_\_ESCAPED\_UNDERSCORE\_\_\_\_\_\_ESCAPED\_UNDERSCORE\_\_\_HTML\_\_\_ESCAPED\_UNDERSCORE\_\_\_TAG\_\_\_ESCAPED\_UNDERSCORE\_\_\_DESC\_\_\_ESCAPED\_UNDERSCORE\_\_\_USD\_\_\_ESCAPED\_UNDERSCORE\_\_\_0\_\_\_ESCAPED\_UNDERSCORE\_\_\_\_\_\_ESCAPED\_UNDERSCORE\_\_\_\_\_\_ESCAPED\_UNDERSCORE\_\_\_当开发者在ConnectOptionsCollections中提供默认defaultSubCreator时，则需要同时提供默认创建器defaultCreator，如果不提供，会导致持久化失败。且集合项类型S必须与 defaultSubCreator的返回类型相同。如果返回类型不一致，编译会报错。 |
...
将指定的键值对数据持久化一次。
    **说明：**  
    ...
    由于非\_\_\_MD\_LINK\_DESC\_USD\_0\_\_\_的数据改变  
    不会触发\_\_\_MD\_LINK\_DESC\_USD\_1\_\_\_的自动持久化，当非\@Trace的数据发生变化且需要持久化时，  
    可调用该接口持久化对应key的数据。  
