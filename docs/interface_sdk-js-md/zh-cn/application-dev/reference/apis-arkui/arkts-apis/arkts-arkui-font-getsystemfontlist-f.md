...
> **说明：**
> 
> -getSystemFontList需要先通过[UIContext](arkts-arkui-arkui-uicontext-uicontext-c.md)中的 &gt; [getFont](../../../reference/apis-arkui/arkts-apis-uicontext-uicontext.md#getfont)方法获取 &gt; [Font](arkts-arkui-arkui-uicontext-uicontext-c.md)对象，然后通过该对象进行调用。且直接使用getSystemFontList可能导致 &gt; [UI上下文不明确](../../../ui/arkts-global-interface.md#ui上下文不明确)的问题。
> 
