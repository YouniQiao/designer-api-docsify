...
> **说明：**
> 
> -getSystemFontList需要先通过[UIContext](../../apis-default/arkts-apis/arkts-arkuiuicontext-uicontext-c.md)中的
> [getFont](../../../reference/apis-arkui/arkts-apis-uicontext-uicontext.md#getfont)方法获取
> [Font](../../apis-default/arkts-apis/arkts-arkuiuicontext-uicontext-c.md)对象，然后通过该对象进行调用。且直接使用getSystemFontList可能导致
