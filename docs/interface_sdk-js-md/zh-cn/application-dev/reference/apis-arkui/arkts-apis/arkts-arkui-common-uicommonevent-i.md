...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | [Callback](arkts-arkui-callback-t.md)&lt;[ClickEvent](arkts-arkui-common-clickevent-i.md)&gt; \| undefined | 是 | The callback about the click event. If set undefined will reset the target callback. |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | [Callback](arkts-arkui-callback-t.md)&lt;[KeyEvent](arkts-arkui-common-keyevent-i.md)&gt; \| undefined | 是 | The callback will be triggered when has keyboard input. If set undefined will reset the target callback. |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | [Callback](arkts-arkui-callback-t.md)&lt;[MouseEvent](arkts-arkui-common-mouseevent-i.md)&gt; \| undefined | 是 | The callback will be triggered when has mouse input. If set undefined will reset the target callback. |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | [SizeChangeCallback](arkts-arkui-sizechangecallback-t.md) \| undefined | 是 | The callback will be triggered when the size of component changed. If set undefined will reset the target callback. |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | [Callback](arkts-arkui-callback-t.md)&lt;[TouchEvent](arkts-arkui-common-touchevent-i.md)&gt; \| undefined | 是 | The callback about the touch event. If set undefined will reset the target callback. |
