...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| newValue | [Value](../../apis-arkdata/arkts-apis/arkts-arkdata-distributeddata-value-i.md) | 否 | new value |
...
**类型：** [Value](../../apis-arkdata/arkts-apis/arkts-arkdata-distributeddata-value-i.md)
