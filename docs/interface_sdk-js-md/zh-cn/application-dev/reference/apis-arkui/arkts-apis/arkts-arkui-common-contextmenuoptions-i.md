...
**类型：** [AvailableLayoutArea](arkts-arkui-common-availablelayoutarea-e.md)
...
**类型：** [HapticFeedbackMode](arkts-arkui-common-hapticfeedbackmode-e.md)
...
**类型：** [MenuKeyboardAvoidMode](arkts-arkui-common-menukeyboardavoidmode-e.md)
...
**类型：** [Margin](arkts-arkui-margin-t.md)
...
**类型：** [ModalMode](arkts-arkui-common-modalmode-e.md)
