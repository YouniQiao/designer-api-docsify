...
**继承/实现关系：** XComponentFrameNode extends [TypedFrameNode<XComponentAttribute>](TypedFrameNode<XComponentAttribute>)
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | [XComponentParameters](arkts-arkui-xcomponent-xcomponentparameters-i.md) | 是 | xcomponent节点的选项。 |
