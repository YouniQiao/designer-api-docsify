...
开发者在使用时，需要注意该方向表示[RotationChangeInfo](arkts-arkui-window-rotationchangeinfo-i.md#RotationChangeInfo)中的orientation参数。
...
开发者在使用时，需要注意该方向表示[display](arkts-arkui-display-displaystate-e.md#DisplayState)对象的orientation属性。
...
开发者在使用时，需要注意该方向表示[display](arkts-arkui-display-displaystate-e.md#DisplayState)对象的rotation属性。
