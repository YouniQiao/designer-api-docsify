...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| data | Record&lt;string, RecordData&gt; | 是 | 异步发送给被拉起的Ability的数据。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| data | Record&lt;string, RecordData&gt; | 是 | 同步发送给被拉起的Ability的数据。 |

**返回值：**

| 类型 | 说明 |
| --- | --- |
| Record&lt;string, RecordData&gt; | data - 被拉起的Ability对同步发送请求处理后返回的响应数据。 |
