...
> **说明：**
> 
> 此配置会影响以下栈操作方法的动画效果：pushPath、pushPathByName、replacePath、replacePathByName、pop、popToName、 &gt; popToIndex、moveToTop、moveIndexToTop、clear。配置立即生效，在MultiNavigation生命周期内持续有效。
...
| 类型 | 说明 |
| --- | --- |
| NavPathInfo \| undefined | 返回栈顶NavDestination页面的信息。栈为空时返回undefined。 |
