...
| [SheetInfo(ActionSheet)](arkts-arkui-sheetinfo-i.md) | 弹窗中的选项内容，每一项支持设置文本、图标以及选中的回调。 |
...
| 名称 | 说明 |
| --- | --- |
| [ActionSheetOptions(ActionSheet)](arkts-arkui-actionsheetoptions-i-sys.md) | 列表选择弹窗的样式。 |
<!--DelEnd-->
