...
当文本类组件已经显示在子窗类型的[Popup](../../../reference/apis-arkui/arkui-ts/ohos-arkui-advanced-Popup.md)、 [Dialog](../../../reference/apis-arkui/arkui-ts/ohos-arkui-advanced-Dialog.md)、 [Toast](../../../ui/arkts-create-toast.md)、 [Menu](../../../reference/apis-arkui/arkui-ts/ts-basic-components-menu.md)中时，不支持将其对应的文本选择菜单显示在独立窗口中。
