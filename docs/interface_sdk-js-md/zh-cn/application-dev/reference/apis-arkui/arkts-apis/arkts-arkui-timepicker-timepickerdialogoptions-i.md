...
时间选择器弹窗选项。继承自[TimePickerOptions](arkts-arkui-timepicker-timepickeroptions-i.md)。@extends TimePickerOptions @interface TimePickerDialogOptions
...
| 参数名 | 类型 | 必填 |
| --- | --- | --- |
| value | [TimePickerResult](arkts-arkui-timepicker-timepickerresult-i.md) | 是 |
