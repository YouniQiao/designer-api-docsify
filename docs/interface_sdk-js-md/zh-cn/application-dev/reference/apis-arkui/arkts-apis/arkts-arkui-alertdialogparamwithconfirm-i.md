...
confirm参数优先级：fontColor、backgroundColor   
    style   
    defaultFocus

**继承/实现关系：** AlertDialogParamWithConfirm extends [AlertDialogParam](arkts-arkui-component/alertdialog-alertdialogparam-i.md)
