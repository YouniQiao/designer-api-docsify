...
> **说明：**
> 
> -measureText需要先通过[UIContext](../../apis-default/arkts-apis/arkts-arkuiuicontext-uicontext-c.md)中的
> [getMeasureUtils](../../../reference/apis-arkui/arkts-apis-uicontext-uicontext.md#getmeasureutils)方法获取
> [MeasureUtils](../../apis-default/arkts-apis/arkts-arkuiuicontext-uicontext-c.md)对象，然后通过该对象进行调用。且直接使用measureText可能导致
...
> 联的[MeasureUtils](../../apis-default/arkts-apis/arkts-arkuiuicontext-uicontext-c.md)对象。
> 
...
> **说明：**
> 
> -measureTextSize需要先通过[UIContext](../../apis-default/arkts-apis/arkts-arkuiuicontext-uicontext-c.md)中的
> [getMeasureUtils](../../../reference/apis-arkui/arkts-apis-uicontext-uicontext.md#getmeasureutils)方法获取
> [MeasureUtils](../../apis-default/arkts-apis/arkts-arkuiuicontext-uicontext-c.md)对象，然后通过该对象进行调用。且直接使用measureTextSize可能导致
> [UI上下文不明确](../../../ui/arkts-global-interface.md#ui上下文不明确)的问题。
> 
> - 从API version 12开始，可以通过使用[UIContext](../../apis-default/arkts-apis/arkts-arkuiuicontext-uicontext-c.md)中的
> [getMeasureUtils](../../../reference/apis-arkui/arkts-apis-uicontext-uicontext.md#getmeasureutils)方法获取当前UI上下文关
