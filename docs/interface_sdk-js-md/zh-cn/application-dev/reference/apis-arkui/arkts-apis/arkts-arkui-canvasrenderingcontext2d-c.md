...
| 参数名 | 类型 | 必填 |
| --- | --- | --- |
| drawingContext | [DrawingRenderingContext](arkts-arkui-drawingrenderingcontext-c.md) | 是 |
| options | [RenderingContextOptions](arkts-arkui-renderingcontextoptions-i.md) | 否 |
