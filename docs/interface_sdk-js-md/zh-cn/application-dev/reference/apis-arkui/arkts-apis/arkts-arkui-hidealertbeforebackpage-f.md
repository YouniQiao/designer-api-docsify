...
> [hideAlertBeforeBackPage](arkts-arkui-router-c.md#hidealertbeforebackpage-1)替代。hideAlertBeforeBackPage需先  
...
**替代接口：** [hideAlertBeforeBackPage](arkts-arkui-router-c.md#hidealertbeforebackpage-1)
