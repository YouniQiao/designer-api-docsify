...
**继承/实现关系：** ChipV2PrefixImageIcon extends [ChipV2ImageIcon](arkts-arkui-chipv2imageicon-c.md)
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| config | [ChipV2PrefixImageIconConfig](arkts-arkui-chipv2prefiximageiconconfig-i.md) | 是 | 前缀图标配置 |
