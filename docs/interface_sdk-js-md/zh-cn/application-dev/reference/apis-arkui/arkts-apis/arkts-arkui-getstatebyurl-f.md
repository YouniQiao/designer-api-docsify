...
> **说明：**  
>  
> - 从API version 12开始支持，从API version 18开始废弃，建议使用[getStateByUrl](arkts-arkui-router-c.md#getstatebyurl-1)替  
...
| 类型 | 说明 |
| --- | --- |
| [Array](../../apis-arkts/arkts-apis/arkts-arkts-array-c.md)<RouterState> | 页面状态信息。 |
