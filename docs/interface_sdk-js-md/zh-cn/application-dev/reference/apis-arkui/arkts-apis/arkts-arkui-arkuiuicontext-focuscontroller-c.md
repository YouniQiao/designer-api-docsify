...
> **说明：**
> 
> 以下API需先使用UIContext中的[getFocusController()](../../apis-default/arkts-apis/arkts-arkuiuicontext-uicontext-c.md#getfocuscontroller)方法获取FocusController实例，再通过该实例调用对应方法。
