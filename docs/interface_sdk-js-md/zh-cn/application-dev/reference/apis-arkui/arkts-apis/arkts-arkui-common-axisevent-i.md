...
**继承/实现关系：** AxisEvent extends [BaseEvent](../arkts-components/arkts-arkui-baseevent-i.md/arkts-arkui-baseevent-i.md)

**起始版本：** 23

**ArkTS模式：** 仅支持ArkTS-Sta，起始版本为23。

<!--Device-unnamed-export declare interface AxisEvent extends BaseEvent--><!--Device-unnamed-export declare interface AxisEvent extends BaseEvent-End-->
...
<!--Device-AxisEvent-default getCurrentLocalPosition(): Coordinate2D--><!--Device-AxisEvent-default getCurrentLocalPosition(): Coordinate2D-End-->
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| axisType | [AxisType](arkts-arkui-axistype-e.md) | 是 | Indicates the axis type. |
...
**类型：** [AxisAction](arkts-arkui-axisaction-e.md)
