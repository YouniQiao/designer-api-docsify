...
**继承/实现关系：** NavDestinationAttribute extends [CommonMethod](arkts-arkui-common-commonmethod-i.md)
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| modifier | [AttributeModifier](../arkts-components/arkts-arkui-attributemodifier-i.md)&lt;[NavDestinationAttribute](arkts-arkui-navdestination-navdestinationattribute-i.md)&gt; \| AttributeModifier&lt;CommonMethod&gt; \| undefined | 是 | 在当前组 件上，动态设置属性方法，支持使用if/else语法。取值为undefined时，按当前组件的属性方法默认值处理。&lt;br/&gt;CommonMethod：通用属性和事件。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| icon | [ResourceStr](arkts-arkui-resourcestr-t.md) \| PixelMap \| SymbolGlyphModifier \| undefined | 是 | 标题栏返回键图标。&lt;br/&gt;取值为undefined时，显示返回图标。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| scrollInfos | Array&lt;NestedScrollInfo&gt; \| undefined | 是 | 嵌套的可滚动容器组件的控制器。&lt;br/&gt;取值为undefined时，无控制器。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| delegate | [NavDestinationTransitionDelegate](../arkts-components/arkts-arkui-navdestinationtransitiondelegate-t.md) \| undefined | 是 | NavDestination自定义动画的代理函数。&lt;br/&gt;取值为undefined时，不使用回 调函数。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| items | Array&lt;[NavigationMenuItem](../arkts-components/arkts-arkui-navigationmenuitem-i.md)&gt; \| CustomBuilder \| undefined | 是 |  |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | [Callback](../arkts-components/arkts-arkui-callback-i.md)&lt;NavDestinationActiveReason&gt; \| undefined | 是 | NavDestination由非激活态变为激活态的原因。&lt;br/&gt;取值为 undefined时，不使用回调函数。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | [Callback](../arkts-components/arkts-arkui-callback-i.md)&lt;VisibilityChangeReason&gt; \| undefined | 是 | 当该NavDestination页面隐藏时触发此回调。&lt;br/&gt;取值为undefined时，不使 用回调函数。&lt;br/&gt;在API version 21之前，当NavDestination页面隐藏时触发回调。&lt;br/&gt;从API version 21开始，该回调会提供入参VisibilityChangeReason以说明 onHidden触发的原因。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | [Callback](../arkts-components/arkts-arkui-callback-i.md)&lt;NavDestinationActiveReason&gt; \| undefined | 是 | NavDestination由激活态变为非激活态的原因。&lt;br/&gt;取值为 undefined时，不使用回调函数。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | [Callback](../arkts-components/arkts-arkui-callback-i.md)&lt;NavDestinationContext&gt; \| undefined | 是 | 当NavDestination即将构建子组件之前会触发此回调。&lt;br/&gt;取值为undefined时 ，不使用回调函数。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | [Callback](../arkts-components/arkts-arkui-callback-i.md)&lt;Object \| null \| undefined&gt; \| undefined | 是 | 页面返回回调，入参为 [pop](arkts-arkui-navigation-navpathstack-c.md#pop)、 [popToName](arkts-arkui-navigation-navpathstack-c.md#poptoname) 、 [popToIndex](arkts-arkui-navigation-navpathstack-c.md#poptoindex) 接口传入的result参数。如果不传该参数，入参为undefined。&lt;br/&gt;取值为undefined时，不使用回调函数。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | [Callback](../arkts-components/arkts-arkui-callback-i.md)&lt;VisibilityChangeReason&gt; \| undefined | 是 | 当该NavDestination页面显示时触发此回调。&lt;br/&gt;取值为undefined时，不使 用回调函数。&lt;br/&gt;在API version 21之前，当NavDestination页面显示时触发回调。&lt;br/&gt;从API version 21开始，回调会提供入参VisibilityChangeReason以说明 onShown触发的原因。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| orientation | [Orientation](arkts-arkui-window-orientation-e.md) \| undefined | 是 | NavDestination页面对应的Orientation。&lt;br/&gt;取值为undefined时，按当前设备的显示方向处理。 |
