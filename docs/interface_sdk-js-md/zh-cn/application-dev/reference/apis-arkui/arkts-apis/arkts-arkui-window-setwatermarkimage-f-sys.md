...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| pixelMap | image.PixelMap | 是 | 水印图片。可通过 [createPixelMap](../../apis-image-kit/arkts-apis/arkts-image-image-createpixelmap-f.md/arkts-image-image-createpixelmap-f.md#createpixelmap) 接口获取。 |
