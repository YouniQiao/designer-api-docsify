...
**继承/实现关系：** ExtendableButton implements [ButtonAttribute](arkts-arkui-button-buttonattribute-i.md#ButtonAttribute)
...
| content_ | [CustomBuilder](arkts-arkui-custombuilder-t.md) | 否 | subcomponent trailing closure |
