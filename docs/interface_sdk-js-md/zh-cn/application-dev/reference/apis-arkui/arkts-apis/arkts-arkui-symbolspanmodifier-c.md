...
**继承/实现关系：** SymbolSpanModifier extends SymbolSpanAttribute implements AttributeModifier<SymbolSpanAttribute>
...
| 参数名 | 类型 | 必填 |
| --- | --- | --- |
| attribute | [SymbolSpanAttribute](arkts-arkui-symbolspan-symbolspanattribute-i.md) | 是 |
