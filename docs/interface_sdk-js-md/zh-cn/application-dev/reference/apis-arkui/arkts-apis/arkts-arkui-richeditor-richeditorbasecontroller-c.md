...
| 参数名 | 类型 | 必填 |
| --- | --- | --- |
| style | [RichEditorParagraphStyle](arkts-arkui-richeditor-richeditorparagraphstyle-i.md) \| undefined | 是 |
...
| 参数名 | 类型 | 必填 |
| --- | --- | --- |
| value | [RichEditorTextStyle](arkts-arkui-richeditor-richeditortextstyle-i.md) | 是 |
