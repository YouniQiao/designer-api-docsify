...
通过[setUIContext()](arkts-arkui-floatviewcontroller-i.md#setuicontext-1)或[setUIContextByName()](arkts-arkui-floatviewcontroller-i.md#setuicontextbyname-1)加载的页面中，位于避让区域的组件将不响应手势事件，添加需要手势响应事件的组件时，请注意避让这些区域。
