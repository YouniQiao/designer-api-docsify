...
| 名称 | 说明 |
| --- | --- |
| [SideBarContainer](arkts-arkui-sidebar-sidebarcontainer-f.md#sidebarcontainer) | 定义侧边栏组件 |
...
| 名称 | 说明 |
| --- | --- |
| [SideBarContainerType](arkts-arkui-sidebar-sidebarcontainertype-e.md) | 容器内侧边栏样式枚举。 |
| [SideBarPosition](arkts-arkui-sidebar-sidebarposition-e.md) | 侧边栏显示位置。 |
