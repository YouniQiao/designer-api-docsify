...
**继承/实现关系：** ChipV2SuffixImageIcon extends [ChipV2ImageIcon](arkts-arkui-chipv2imageicon-c.md)
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| config | [ChipV2SuffixImageIconConfig](arkts-arkui-chipv2suffiximageiconconfig-i.md) | 是 | 后缀图标的配置 |
