...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | [AnimateParam](../arkts-components/arkts-arkui-animateparam-i.md) | 是 | Set animation effect parameters. |
| processor | [VoidCallback](arkts-arkui-voidcallback-t.md) | 是 | Specify the closure function that displays dynamic effects, and the system will automatically insert transition animations for state changes caused by the closure function. |
