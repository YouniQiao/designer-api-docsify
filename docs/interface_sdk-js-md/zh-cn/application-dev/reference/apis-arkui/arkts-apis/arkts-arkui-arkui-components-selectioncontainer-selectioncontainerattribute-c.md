...
支持\_\_\_MD\_LINK\_DESC\_USD\_0\_\_\_。

支持\_\_\_MD\_LINK\_DESC\_USD\_1\_\_\_。
    **说明：**  
    
    - 不支持\_\_\_MD\_LINK\_DESC\_USD\_2\_\_\_。  
    
    - 不支持\_\_\_MD\_LINK\_DESC\_USD\_3\_\_\_，跨节点场景中Text子组件不支持图形变换。  
    
    - 不支持\_\_\_MD\_LINK\_DESC\_USD\_4\_\_\_。
...
\_\_\_HTML\_TAG\_DESC\_USD\_0\_\_\_\_\_\_HTML\_TAG\_DESC\_USD\_1\_\_\_注意\_\_\_HTML\_TAG\_DESC\_USD\_2\_\_\_：\_\_\_HTML\_TAG\_DESC\_USD\_3\_\_\_长按手势需要的时间，bindSelectionMenu为600ms,bindContextMenu为800 ms。\_\_\_HTML\_TAG\_DESC\_USD\_4\_\_\_当bindSelectionMenu和bindContextMenu都设置了，并且都设置为长按触发手势，bindSelectionMenu首先被触发。\_\_\_HTML\_TAG\_DESC\_USD\_5\_\_\_如果自定义菜单过长，可以嵌入一个Scroll组件，防止键盘被遮挡。\_\_\_HTML\_TAG\_DESC\_USD\_6\_\_\_
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| spanType | \_\_\_MD\_LINK\_USD\_0\_\_\_&lt;\_\_\_MD\_LINK\_USD\_1\_\_\_&gt; | 是 | 选择菜单的类型。默认值为 TextSpanType.TEXT |
| content | \_\_\_MD\_LINK\_USD\_0\_\_\_&lt;\_\_\_MD\_LINK\_USD\_1\_\_\_&gt; | 是 | 指示选择菜单的内容 |
| responseType | \_\_\_MD\_LINK\_USD\_0\_\_\_&lt;\_\_\_MD\_LINK\_USD\_1\_\_\_&gt; | 是 | 选择菜单响应类型。默认值为 TextResponseType.LONG\_\_\_ESCAPED\_UNDERSCORE\_\_\_press |
| options | \_\_\_MD\_LINK\_USD\_0\_\_\_&lt;SelectionContainerMenuOptions&gt; | 否 | 指示选择菜单的选项 |

**返回值：**

| 类型 | 说明 |
| --- | --- |
| \_\_\_MD\_LINK\_USD\_0\_\_\_ | 返回SelectionContainerAttribute的实例。 |
...
设置选中文本手柄颜色。未通过该接口设置时，默认手柄颜色为'#007DFF'（蓝色）。
    **说明：**  
    ...
    - 在跨节点场景中Text子组件[caretColor]\_\_\_JSDOC\_LINK\_DESC\_USD\_0\_\_\_设置无效，始终使用SelectionContainer的配置。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| color | \_\_\_MD\_LINK\_USD\_0\_\_\_&lt;\_\_\_MD\_LINK\_USD\_1\_\_\_&gt; | 是 | 手柄颜色。 |
...
设置组件的复制粘贴配置项。未通过该接口设置时，默认为CopyOptions.InApp。
    **说明：**  
    ...
    Text子组件已显式设置[copyOption]\_\_\_JSDOC\_LINK\_DESC\_USD\_0\_\_\_时，优先使用Text子组件的配置；未设置时，使用SelectionContainer的配置。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | \_\_\_MD\_LINK\_USD\_0\_\_\_&lt;\_\_\_MD\_LINK\_USD\_1\_\_\_&gt; | 是 | 复制粘贴配置项，用于设置文本的可复制范围。具体说明请参考CopyOptions枚举。 |
...
设置选中文本后的编辑菜单选项，包括菜单文本、图标和回调等。
    **说明：**  
    ...
    当同时为当前场景设置了[bindSelectionMenu]\_\_\_JSDOC\_LINK\_DESC\_USD\_0\_\_\_和editMenuOptions时，优先使用  
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| editMenu | \_\_\_MD\_LINK\_USD\_0\_\_\_&lt;SelectionContainerEditMenuOptions&gt; | 是 | 自定义编辑菜单配置。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| isEnabled | \_\_\_MD\_LINK\_USD\_0\_\_\_&lt;boolean&gt; | 是 | 是否开启触控反馈。 \_\_\_ESCAPED\_UNDERSCORE\_\_\_\_\_\_ESCAPED\_UNDERSCORE\_\_\_\_\_\_ESCAPED\_UNDERSCORE\_\_\_HTML\_\_\_ESCAPED\_UNDERSCORE\_\_\_TAG\_\_\_ESCAPED\_UNDERSCORE\_\_\_DESC\_\_\_ESCAPED\_UNDERSCORE\_\_\_USD\_\_\_ESCAPED\_UNDERSCORE\_\_\_0\_\_\_ESCAPED\_UNDERSCORE\_\_\_\_\_\_ESCAPED\_UNDERSCORE\_\_\_\_\_\_ESCAPED\_UNDERSCORE\_\_\_true表示开启触控反馈，false表示不开启触控反馈。 |
...
长按文本内部区域弹出选择菜单后，点击选择菜单的复制按钮，触发该回调。仅支持复制文本。使用callback异步回调。
    **说明：**  
    ...
    - 回调参数为按Text组件视觉顺序拼接后的选中文本，拼接方式由[textJoinStyle]\_\_\_JSDOC\_LINK\_DESC\_USD\_0\_\_\_配置决定。  
    
    - 仅当容器级[onWillCopy]\_\_\_JSDOC\_LINK\_DESC\_USD\_1\_\_\_返回true时，该回调才会触发。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | \_\_\_MD\_LINK\_USD\_0\_\_\_&lt;Callback&lt;string&gt;&gt; | 是 | 复制回调。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | \_\_\_MD\_LINK\_USD\_0\_\_\_&lt;Callback&lt;Array&lt;string&gt;&gt;&gt; | 是 | 选中文本变化回调。 |
...
在进行复制操作前，触发该回调。使用callback异步回调。
    **说明：**  
    ...
    - 返回false时，会阻止本次跨节点复制及容器级[onCopy]\_\_\_JSDOC\_LINK\_DESC\_USD\_1\_\_\_回调触发，但不会影响各Text子组件已独立处理完成的复制事件逻辑。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | \_\_\_MD\_LINK\_USD\_0\_\_\_&lt;Callback&lt;string, boolean&gt;&gt; | 是 | 复制前检查回调，返回true表示允许复制，返回false表示不允许复制。 |
...
设置选中文本底板颜色。未通过该接口设置时，默认选中文本底板颜色为'#007DFF'（蓝色），如果未设置不透明度，默认为20%不透明度。
    **说明：**  
    ...
    - Text子组件已显式设置[selectedBackgroundColor]\_\_\_JSDOC\_LINK\_DESC\_USD\_0\_\_\_时，优先使用Text子组件的配置；未设置时，使用  
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| color | \_\_\_MD\_LINK\_USD\_0\_\_\_&lt;\_\_\_MD\_LINK\_USD\_1\_\_\_&gt; | 是 | 选中文本底板颜色。 |
...
设置SelectionContainer内聚合文本的拼接方式。未通过该接口设置时，默认为SelectionContainerTextJoinStyle.NEWLINE，表示不同文本节点之间使用换行符\n拼接。
    **说明：**  
    ...
    - 该配置会影响[onWillCopy]\_\_\_JSDOC\_LINK\_DESC\_USD\_0\_\_\_、  
    [onCopy]\_\_\_JSDOC\_LINK\_DESC\_USD\_1\_\_\_、  
    [bindSelectionMenu]\_\_\_JSDOC\_LINK\_DESC\_USD\_2\_\_\_相关回调中返回的文本内容。  
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| style | \_\_\_MD\_LINK\_USD\_0\_\_\_&lt;SelectionContainerTextJoinStyle&gt; | 是 | 聚合文本拼接方式。 |
