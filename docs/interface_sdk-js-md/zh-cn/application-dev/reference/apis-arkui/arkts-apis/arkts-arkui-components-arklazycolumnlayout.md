...
| 名称 | 说明 |
| --- | --- |
| [LazyColumnLayoutAttribute](arkts-arkui-arkuicomponentsarklazycolumnlayout-lazycolumnlayoutattribute-c.md) | 定义懒加载列布局属性。 |

### 接口

| 名称 | 说明 |
| --- | --- |
| [LazyColumnLayoutInterface](arkts-arkui-arkuicomponentsarklazycolumnlayout-lazycolumnlayoutinterface-i.md) | 定义懒加载列布局组件。 |
