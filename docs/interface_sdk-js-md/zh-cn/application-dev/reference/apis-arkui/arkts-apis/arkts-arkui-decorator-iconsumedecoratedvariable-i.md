...
| watchFunc | [WatchFuncType](arkts-arkui-watchfunctype-t.md) | 否 | watch函数类型 |
| consumeOptions | [ConsumeOptions](arkts-arkui-decorator-consumeoptions-i.md)&lt;T&gt; | 否 | 具有默认值的选项 |
