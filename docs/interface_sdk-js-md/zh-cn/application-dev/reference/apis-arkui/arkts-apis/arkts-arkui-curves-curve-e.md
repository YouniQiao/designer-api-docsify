...
| 名称 | 值 | 说明 | | ------------------- | -- | ------------------------------------------------------------ | | [Linear](#linear) | 0 | 表示动画从头到尾的速度都是相同的。 | | [Ease](#ease) | 1 | 表示动画以低速开始，然后加快，在结束前变慢，cubic-bezier(0.25, 0.1, 0.25, 1.0)。 | | [EaseIn](#easein) | 2 | 表示动画以低速开始，cubic-bezier(0.42, 0.0, 1.0, 1.0)。 | | [EaseOut](#easeout) | 3 | 表示动画以低速结束，cubic-bezier(0.0, 0.0, 0.58, 1.0)。 | | [EaseInOut](#easeinout) | 4 | 表示动画以低速开始和结束，cubic-bezier(0.42, 0.0, 0.58, 1.0)。 | | [FastOutSlowIn](#fastoutslowin) | 5 | 标准曲线，cubic-bezier(0.4, 0.0, 0.2, 1.0)。 | | [LinearOutSlowIn](#linearoutslowin) | 6 | 减速曲线，cubic-bezier(0.0, 0.0, 0.2, 1.0)。 | | [FastOutLinearIn](#fastoutlinearin) | 7 | 加速曲线，cubic-bezier(0.4, 0.0, 1.0, 1.0)。 | | [ExtremeDeceleration](#extremedeceleration) | 8 | 急缓曲线，cubic-bezier(0.0, 0.0, 0.0, 1.0)。 | | [Sharp](#sharp) | 9 | 锐利曲线，cubic-bezier(0.33, 0.0, 0.67, 1.0)。 | | [Rhythm](#rhythm) | 10 | 节奏曲线，cubic-bezier(0.7, 0.0, 0.2, 1.0)。 | | [Smooth](#smooth) | 11 | 平滑曲线，cubic-bezier(0.4, 0.0, 0.4, 1.0)。 | | [Friction](#friction) | 12 |
