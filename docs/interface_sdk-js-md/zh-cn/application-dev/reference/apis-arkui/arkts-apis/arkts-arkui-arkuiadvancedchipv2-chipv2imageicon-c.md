...
继承自[ChipV2Icon](arkts-arkui-arkuiadvancedchipv2-chipv2icon-c.md)。

**继承/实现关系：** ChipV2ImageIcon extends [ChipV2Icon](arkts-arkui-arkuiadvancedchipv2-chipv2icon-c.md)
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| config | [ChipV2ImageIconConfig](arkts-arkui-arkuiadvancedchipv2-chipv2imageiconconfig-i.md) | 是 | 图标共通属性配置，用于设置Image类型图标的基本显示属性，包含src、size、fillColor、activatedFillColor等配置 项。 |
