...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| colorSpace | [ColorSpace](arkts-arkui-colorspace-e.md) | 是 | 颜色的颜色空间。支持SRGB、Display_P3、BT2020颜色空间。 |
...
| 类型 | 说明 |
| --- | --- |
| [ColorMetrics](arkts-arkui-colormetrics-c-sys.md) | 带有HDR颜色的ColorMetrics类实例。 |
