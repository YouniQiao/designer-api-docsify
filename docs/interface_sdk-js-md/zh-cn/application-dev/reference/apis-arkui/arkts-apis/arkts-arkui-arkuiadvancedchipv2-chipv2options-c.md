...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| config | [IChipV2OptionsConfig](arkts-arkui-arkuiadvancedchipv2-ichipv2optionsconfig-i.md) | 是 | ChipV2样式配置，用于自定义ChipV2组件的外观和行为，包含label、prefixIcon、suffixIcon、allowClose、 activated、backgroundColor等配置项。 |
