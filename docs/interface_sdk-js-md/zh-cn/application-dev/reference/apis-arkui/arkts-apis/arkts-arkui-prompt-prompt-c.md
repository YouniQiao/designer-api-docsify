...
创建并显示文本提示框、对话框和操作菜单。
    **说明：**  
    ...
    - 从API version 8 开始，该接口不再维护，推荐使用新接口[@ohos.promptAction (弹窗)]\_\_\_JSDOC\_LINK\_DESC\_USD\_0\_\_\_。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| options | \_\_\_MD\_LINK\_USD\_0\_\_\_ | 是 | 定义ShowActionMenu的选项。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| options | \_\_\_MD\_LINK\_USD\_0\_\_\_ | 是 | 定义显示对话框的选项。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| options | \_\_\_MD\_LINK\_USD\_0\_\_\_ | 是 | 定义ShowToast的选项。 |
