...
> 
> - 以下API需先使用UIContext中的[getComponentSnapshot()](../../apis-default/arkts-apis/arkts-arkui-uicontext-uicontext-c.md#getcomponentsnapshot)方法获取ComponentSnapshot对象，再通过此实例调用对应方法。
> 
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| start | [NodeIdentity](../../apis-default/arkts-apis/arkts-nodeidentity-t.md) | 是 | 范围开始的组件的ID。 |
| end | [NodeIdentity](../../apis-default/arkts-apis/arkts-nodeidentity-t.md) | 是 | 范围结束的组件的ID。 |
