...
**继承/实现关系：** UIScrollableCommonEvent extends [UICommonEvent](../arkts-components/arkts-arkui-uicommonevent-i.md/arkts-arkui-uicommonevent-i.md)
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | [VoidCallback](arkts-arkui-voidcallback-t.md) \| undefined | 是 | callback function, triggered when the scrolling reaches the end position. &lt;br&gt;Passing undefined will unregister the callback. |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | [VoidCallback](arkts-arkui-voidcallback-t.md) \| undefined | 是 | callback function, triggered when the scrolling reaches the start position. &lt;br&gt;Passing undefined will unregister the callback. |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | [OnScrollFrameBeginCallback](../arkts-components/arkts-arkui-onscrollframebegincallback-t.md) \| undefined | 是 | callback function, triggered when the scrolling begin each frame. &lt;br&gt;Passing undefined will unregister the callback. |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | [VoidCallback](arkts-arkui-voidcallback-t.md) \| undefined | 是 | callback function, triggered when the scrolling started. &lt;br&gt;Passing undefined will unregister the callback. |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | [VoidCallback](arkts-arkui-voidcallback-t.md) \| undefined | 是 | callback function, triggered when the scrolling stopped. &lt;br&gt;Passing undefined will unregister the callback. |
