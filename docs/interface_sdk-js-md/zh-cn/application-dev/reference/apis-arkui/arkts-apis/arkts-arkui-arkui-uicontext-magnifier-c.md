...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| id | string | 是 | 组件id，可通过通用属性[id](../arkts-components/arkts-arkui-commonmethod-c.md#id)或[key](../arkts-components/arkts-arkui-commonmethod-c.md#key)设置。当组件id为空字符串或未找到匹配id的组件时，不显示放大镜。 |
