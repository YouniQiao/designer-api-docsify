...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| displayAttributeOption | [Array](../../apis-arkts/arkts-apis/arkts-arkts-array-c.md)<string> | 是 | 指定需要监听的屏幕属性名称，且仅限于[display属性](../../../../reference/apis-arkui/js-apis-display.md#属性)中包含的属性。 |
