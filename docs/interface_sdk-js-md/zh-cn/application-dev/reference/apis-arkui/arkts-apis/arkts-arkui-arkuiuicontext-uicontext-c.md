...
> 实例，第三种是通过UIContext类的静态方法如[getCallingScopeUIContext](../../apis-default/arkts-apis/arkts-arkuiuicontext-uicontext-c.md#getcallingscopeuicontext)获取UIContext实例。本文中
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | [AnimateParam](../../apis-default/arkts-apis/arkts-common-animateparam-i.md) | 是 | 设置动画效果相关参数。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| tabsController | [TabsController](../../apis-default/arkts-components/arkts-tabs-tabscontroller-c.md) | 是 | The controller of the tabs. |
| parentScroller | [Scroller](../../apis-default/arkts-components/arkts-scroll-scroller-c.md) | 是 | The controller of the parent scrollable container component. |
| childScroller | [Scroller](../../apis-default/arkts-components/arkts-scroll-scroller-c.md) | 是 | The controller of the child scrollable container component. |
...
| --- | --- | --- | --- |
| tabsController | [TabsController](../../apis-default/arkts-components/arkts-tabs-tabscontroller-c.md) | 是 | The controller of the tabs. |
| scroller | [Scroller](../../apis-default/arkts-components/arkts-scroll-scroller-c.md) | 是 | The controller of the scrollable container component. |
...
创建animator动画结果对象（AnimatorResult）。与[createAnimator](../../apis-default/arkts-apis/arkts-arkuiuicontext-uicontext-c.md#createanimator)相比，新增对 [SimpleAnimatorOptions](arkts-arkui-animator-simpleanimatoroptions-c.md)类型入参的支持。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| context | common.UIAbilityContext \| common.ExtensionContext | 是 | [UIAbility](../../apis-ability-kit/arkts-apis/arkts-ability-appabilityuiability-uiability-c.md)或 [ExtensionAbility](../../apis-ability-kit/arkts-apis/arkts-ability-appabilityextensionability-extensionability-c.md)所对应的上下文环境。 |

**返回值：**

| 类型 | 说明 |
| --- | --- |
| [UIContext](../../apis-default/arkts-apis/arkts-arkuiuicontext-uicontext-c.md) \| undefined | Context of the created UI instance, or **undefined** if creation fails. |
...
销毁[createUIContextWithoutWindow](../../apis-default/arkts-apis/arkts-arkuiuicontext-uicontext-c.md#createuicontextwithoutwindow)创建的UI实例。
...
| event | [KeyEvent](../../apis-default/arkts-apis/arkts-common-keyevent-i.md) | 是 | The keyboard event. |
...
| eventType | [RawInputEventType](../../apis-default/arkts-apis/arkts-enums-rawinputeventtype-e.md) | 是 | 原始输入事件的类型。 |
...
| 类型 | 说明 |
| --- | --- |
| [UIContext](../../apis-default/arkts-apis/arkts-arkuiuicontext-uicontext-c.md)[] | Array of all currently valid UIContext instances. Returns an empty array if no valid UIContext instance exists. |
...
| 类型 | 说明 |
| --- | --- |
| [Nullable](../../apis-default/arkts-apis/arkts-nullable-t.md)&lt;[AtomicServiceBar](../../apis-default/arkts-apis/arkts-arkuiuicontext-atomicservicebar-i.md)&gt; | The atomic service bar. |
...
> **说明：**
> 
> 返回的UIContext对象可能指向一个已销毁的UI实例，通常在由已销毁的实例抛出异步任务时出现。建议通过[isAvailable](../../apis-default/arkts-apis/arkts-arkuiuicontext-uicontext-c.md#isavailable)接口判断其有效性。
...
| 类型 | 说明 |
| --- | --- |
| [UIContext](../../apis-default/arkts-apis/arkts-arkuiuicontext-uicontext-c.md) \| undefined | UIContext of the current [calling scope](../../../ui/arkts-global-interface.md#basic-concepts). Returns **undefined** if the calling scope is ambiguous. |
...
| 类型 | 说明 |
| --- | --- |
| [ComponentSnapshot](../../apis-default/arkts-apis/arkts-arkuiuicontext-componentsnapshot-c.md) | 组件快照。 |
...
| 类型 | 说明 |
| --- | --- |
| [ComponentUtils](../../apis-default/arkts-apis/arkts-arkuiuicontext-componentutils-c.md) | object ComponentUtils. |
...
| 类型 | 说明 |
| --- | --- |
| [ContextMenuController](../../apis-default/arkts-apis/arkts-arkuiuicontext-contextmenucontroller-c.md) | object context menu controller. |
...
| 类型 | 说明 |
| --- | --- |
| [CursorController](../../apis-default/arkts-apis/arkts-arkuiuicontext-cursorcontroller-c.md) | object cursor controller. |
...
| 类型 | 说明 |
| --- | --- |
| [DialogPresenter](../../apis-default/arkts-apis/arkts-arkuiuicontext-dialogpresenter-c.md) | Dialog对象。 |
...
| 类型 | 说明 |
| --- | --- |
| [DragController](../../apis-default/arkts-apis/arkts-arkuiuicontext-dragcontroller-c.md) | the DragController |
...
| 类型 | 说明 |
| --- | --- |
| [FocusController](../../apis-default/arkts-apis/arkts-arkuiuicontext-focuscontroller-c.md) | 焦点控制器 |
...
| 类型 | 说明 |
| --- | --- |
| [Font](../../apis-default/arkts-apis/arkts-arkuiuicontext-font-c.md) | Font实例对象。 |
...
| 类型 | 说明 |
| --- | --- |
| [KeyboardAvoidMode](../../apis-default/arkts-apis/arkts-arkuiuicontext-keyboardavoidmode-e.md) | 返回虚拟键盘抬起时的页面避让模式。 |
...
| 类型 | 说明 |
| --- | --- |
| [UIContext](../../apis-default/arkts-apis/arkts-arkuiuicontext-uicontext-c.md) \| undefined | UIContext of the UI instance that most recently switched to the focused state. Returns **undefined** if the most recently focused instance has been destroyed or if no instance has ever been focused. |
...
| 类型 | 说明 |
| --- | --- |
| [UIContext](../../apis-default/arkts-apis/arkts-arkuiuicontext-uicontext-c.md) \| undefined | UIContext of the UI instance that most recently switched to the foreground state. Returns **undefined** if the most recently foreground UI instance has been destroyed or if no UI instance has ever been in the foreground. |
...
获取[Magnifier](../../apis-default/arkts-apis/arkts-arkuiuicontext-magnifier-c.md)对象，可控制放大镜显示和隐藏。
...
| 类型 | 说明 |
| --- | --- |
| [Magnifier](../../apis-default/arkts-apis/arkts-arkuiuicontext-magnifier-c.md) | Magnifier对象，可用于控制放大镜的显示和隐藏。 |
...
| 类型 | 说明 |
| --- | --- |
| [MeasureUtils](../../apis-default/arkts-apis/arkts-arkuiuicontext-measureutils-c.md) | 提供文本宽度、高度等相关计算。 |
...
| 类型 | 说明 |
| --- | --- |
| [MediaQuery](../../apis-default/arkts-apis/arkts-arkuiuicontext-mediaquery-c.md) | object MediaQuery. |
...
| 类型 | 说明 |
| --- | --- |
| [OverlayManager](../../apis-default/arkts-apis/arkts-arkuiuicontext-overlaymanager-c.md) | OverlayManager instance obtained. |
...
| 类型 | 说明 |
| --- | --- |
| [OverlayManagerOptions](../../apis-default/arkts-apis/arkts-arkuiuicontext-overlaymanageroptions-i.md) | object OverlayManagerOptions. |
...
| 类型 | 说明 |
| --- | --- |
| [PageInfo](../../apis-default/arkts-apis/arkts-arkuiuicontext-pageinfo-i.md) | The page information of the frameNode with the target uniqueId, includes navDestination and router page information. If the frame node does not have navDestination and router page information, it will return an empty object. |
...
| 类型 | 说明 |
| --- | --- |
| [PixelRoundMode](../../apis-default/arkts-apis/arkts-enums-pixelroundmode-e.md) | Pixel rounding mode of the current page. |
...
| 类型 | 说明 |
| --- | --- |
| [PromptAction](../../apis-default/arkts-apis/arkts-arkuiuicontext-promptaction-c.md) | PromptAction object. |
...
| 类型 | 说明 |
| --- | --- |
| [Router](../../apis-default/arkts-apis/arkts-arkuiuicontext-router-c.md) | Router object. |
...
| 类型 | 说明 |
| --- | --- |
| [LocalStorage](../../apis-default/arkts-apis/arkts-localstorage-localstorage-c.md) \| undefined | LocalStorage** instance if it exists; **undefined** if it does not exist. |
...
| 类型 | 说明 |
| --- | --- |
| [SmartGestureController](../../apis-default/arkts-apis/arkts-arkuiuicontext-smartgesturecontroller-c.md) | 智能手势控制器对象。 |
...
获取[TextMenuController](../../apis-default/arkts-apis/arkts-arkuiuicontext-textmenucontroller-c.md)对象，可通过该对象控制文本选择菜单。
...
| 类型 | 说明 |
| --- | --- |
| [TextMenuController](../../apis-default/arkts-apis/arkts-arkuiuicontext-textmenucontroller-c.md) | TextMenuController对象。 |
...
| 类型 | 说明 |
| --- | --- |
| [UIInspector](../../apis-default/arkts-apis/arkts-arkuiuicontext-uiinspector-c.md) | 返回UIInspector实例对象。 |
...
| 类型 | 说明 |
| --- | --- |
| [UIObserver](../../apis-default/arkts-apis/arkts-arkuiuicontext-uiobserver-c.md) | 返回UIObserver实例对象。 |
...
| 类型 | 说明 |
| --- | --- |
| [HeightBreakpoint](../../apis-default/arkts-apis/arkts-enums-heightbreakpoint-e.md) | 当前实例所在窗口的高宽比对应的高度断点枚举值。若窗口高宽比为0，则返回HEIGHT_SM。 |
...
> **说明：**
> 
> 若UIContext位于主应用程序进程中的[UIExtensionAbility](../../apis-ability-kit/arkts-apis/arkts-ability-appabilityuiextensionability-uiextensionability-c.md)内，则返回主应用程
> 序的顶层窗口ID。
...
| 类型 | 说明 |
| --- | --- |
| [WidthBreakpoint](../../apis-default/arkts-apis/arkts-enums-widthbreakpoint-e.md) | 当前实例所在窗口的宽度断点枚举值。若窗口宽度为 0vp，则返回WIDTH_XS。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| param | [KeyframeAnimateParam](../../apis-default/arkts-apis/arkts-common-keyframeanimateparam-i.md) | 是 | 关键帧动画的整体动画参数。 |
| keyframes | Array&lt;[KeyframeState](../../apis-default/arkts-apis/arkts-common-keyframestate-i.md)&gt; | 是 | 所有的关键帧状态的列表。 |
...
> 
> 2. 由于[updateBindSheet](../../apis-default/arkts-apis/arkts-arkuiuicontext-uicontext-c.md#updatebindsheet)和[closeBindSheet](../../apis-default/arkts-apis/arkts-arkuiuicontext-uicontext-c.md#closebindsheet)依赖
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| frameCallback | [FrameCallback](../../apis-default/arkts-apis/arkts-arkuiuicontext-framecallback-c.md) | 是 | 下一帧需要执行的回调。 |
...
| 类型 | 说明 |
| --- | --- |
| Array&lt;[DynamicSyncScene](../../apis-default/arkts-apis/arkts-arkuiuicontext-dynamicsyncscene-c.md)&gt; | The instance of SwiperDynamicSyncScene. |
...
| 类型 | 说明 |
| --- | --- |
| [ResolvedUIContext](../../apis-default/arkts-apis/arkts-arkuiuicontext-resolveduicontext-c.md) | 返回带有解析策略的UIContext实例对象。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| feature | [CustomKeyboardContinueFeature](../../apis-default/arkts-apis/arkts-arkuiuicontext-customkeyboardcontinuefeature-e.md) | 是 | 自定义键盘接续特性。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | [KeyboardAvoidMode](../../apis-default/arkts-apis/arkts-arkuiuicontext-keyboardavoidmode-e.md) | 是 | 配置虚拟键盘抬起时页面的避让模式。&lt;br /&gt;默认值：KeyboardAvoidMode.OFFSET，键盘抬起时默认避让模式为上抬。&lt;br /&gt;setKeyboardAvoidMode传入异常值时，该属性设置不生效。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| options | [OverlayManagerOptions](../../apis-default/arkts-apis/arkts-arkuiuicontext-overlaymanageroptions-i.md) | 是 | Options. |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| mode | [PixelRoundMode](../../apis-default/arkts-apis/arkts-enums-pixelroundmode-e.md) | 是 | 像素取整模式。&lt;br /&gt;默认值：PixelRoundMode.PIXEL_ROUND_ON_LAYOUT_FINISH<br/>设置异常值时，该属性为默认值。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| policy | [TextSelectionClearPolicy](../../apis-default/arkts-apis/arkts-arkuiuicontext-textselectionclearpolicy-e.md) | 是 | 文本选择清除策略。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | [ActionSheetOptions](../../apis-default/arkts-apis/arkts-actionsheet-actionsheetoptions-i.md) | 是 | Parameters of the action sheet. |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| options | [AlertDialogParamWithConfirm](../../apis-default/arkts-apis/arkts-alertdialog-alertdialogparamwithconfirm-i.md) \| [AlertDialogParamWithButtons](../../apis-default/arkts-apis/arkts-alertdialog-alertdialogparamwithbuttons-i.md) \| [AlertDialogParamWithOptions](../../apis-default/arkts-apis/arkts-alertdialog-alertdialogparamwithoptions-i.md) | 是 | Shows an AlertDialog component in the given settings. |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| options | [DatePickerDialogOptions](../../apis-default/arkts-components/arkts-datepicker-datepickerdialogoptions-i.md) | 是 | Options. |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| options | [TextPickerDialogOptions](../../apis-default/arkts-components/arkts-textpicker-textpickerdialogoptions-i.md) | 是 | Options. |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| style | [TextPickerDialogOptions](../../apis-default/arkts-components/arkts-textpicker-textpickerdialogoptions-i.md) \| TextPickerDialogOptionsExt | 是 | Dialog style. |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| options | [TimePickerDialogOptions](../../apis-default/arkts-components/arkts-timepicker-timepickerdialogoptions-i.md) | 是 | Options. |
...
| --- | --- | --- | --- |
| bindSheetContent | ComponentContent&lt;T&gt; | 是 | 半模态页面中显示的组件内容。 |
| sheetOptions | [SheetOptions](../../apis-default/arkts-apis/arkts-common-sheetoptions-i.md) | 是 | 半模态页面样式。<br/>**说明：** <br/>不支持更新SheetOptions.uiContext、SheetOptions.mode、回调函 数。 |
