...
<!--Device-typeNode-export function createRadioNode(context: UIContext, options?: FrameNodeOptions): Radio--><!--Device-typeNode-export function createRadioNode(context: UIContext, options?: FrameNodeOptions): Radio-End-->
...
| 类型 | 说明 |
| --- | --- |
| \_\_\_MD\_LINK\_USD\_0\_\_\_ |  返回 Radio 类型的 FrameNode |
