...
设置ChipGroup的上下内边距，以控制整体高度。类型为[ChipGroupPaddingOptions](../../apis-default/arkts-apis/arkts-arkui-advanced-chipgroup-chipgrouppaddingoptions-i.md)。
...
**类型：** [ChipGroupPaddingOptions](../../apis-default/arkts-apis/arkts-arkui-advanced-chipgroup-chipgrouppaddingoptions-i.md)
...
左右内边距及Chip之间间距。参考[ChipGroupSpaceOptions](../../apis-default/arkts-apis/arkts-arkui-advanced-chipgroup-chipgroupspaceoptions-i.md)类型。
...
**类型：** [ChipGroupSpaceOptions](../../apis-default/arkts-apis/arkts-arkui-advanced-chipgroup-chipgroupspaceoptions-i.md)
...
`Chip`的`style`属性，如颜色、大小等，参考[ChipItemStyle](../../apis-default/arkts-apis/arkts-arkui-advanced-chipgroup-chipitemstyle-i.md)类型。
...
**类型：** [ChipItemStyle](../../apis-default/arkts-apis/arkts-arkui-advanced-chipgroup-chipitemstyle-i.md)
...
每个Chip的特定属性，参考[ChipGroupItemOptions[]][ChipGroupItemOptions](../../apis-default/arkts-apis/arkts-arkui-advanced-chipgroup-chipgroupitemoptions-i.md)类型。

若为undefined时，ChipGroup默认为空。

**类型：** [ChipGroupItemOptions](../../apis-default/arkts-apis/arkts-arkui-advanced-chipgroup-chipgroupitemoptions-i.md)[]
...
支持开发者自定义builder，如需在组件最右侧显示自定义内容可配置suffix属性，使用属性suffix需引用[IconGroupSuffix](../../apis-default/arkts-apis/arkts-arkui-advanced-chipgroup-icongroupsuffix-s.md)接口。
