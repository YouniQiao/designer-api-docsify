...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| options | [ParallelOption](arkts-arkui-arkuiparallelize-paralleloption-i.md) \| undefined | 是 | 使用ParallelizeUI方法创建组件时选择是否开启并行化的参数，当options参数为undefined时，默认开启并行化创建。 |
