...
> **说明：**
> 
> CustomLayoutAlgorithm类对象可以赋值给LayoutAlgorithm类型变量，作为DynamicLayout组件 &gt; 的入参指定布局算法。

**继承/实现关系：** CustomLayoutAlgorithm implements [LayoutAlgorithm](../../apis-default/arkts-apis/arkts-layoutalgorithm-i.md)
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| self | [FrameNode](../../apis-default/arkts-apis/arkts-framenode-c.md) | 是 | 动态布局组件在组件树上的实体节点。 |
...
> **说明：**
> 
> 在此函数中，开发者可以调用[FrameNode](../../apis-default/arkts-apis/arkts-framenode-c.md)的 &gt; [getChild()](../../apis-default/arkts-apis/arkts-framenode-c.md#getchild)方法获取子组件FrameNode，调用 &gt; [FrameNode](../../apis-default/arkts-apis/arkts-framenode-c.md)的[measure()](../../apis-default/arkts-apis/arkts-framenode-c.md#measure)方法测量子组件大小，参考DynamicLayout组 &gt; 件 &gt; [示例1（自定义布局算法实现瀑布流布局）](../../../reference/apis-arkui/arkui-ts/ts-container-dynamiclayout.md#示例1自定义布局算法实现瀑布流布局)。
...
| --- | --- | --- | --- |
| self | [FrameNode](../../apis-default/arkts-apis/arkts-framenode-c.md) | 是 | 动态布局组件在组件树上的实体节点。 |
| constraint | [LayoutConstraint](../../apis-default/arkts-apis/arkts-framenode-layoutconstraint-i.md) | 是 | 动态布局组件进行测量时使用的布局约束。 |
