...
> [FrameNode](../../apis-default/arkts-apis/arkts-framenode-c.md)的[layout()](../../apis-default/arkts-apis/arkts-framenode-c.md#layout)方法设置子组件位置，参考DynamicLayout组件
...
> 在此函数中，开发者可以调用[FrameNode](../../apis-default/arkts-apis/arkts-framenode-c.md)的
> [getChild()](../../apis-default/arkts-apis/arkts-framenode-c.md#getchild)方法获取子组件FrameNode，调用
> [FrameNode](../../apis-default/arkts-apis/arkts-framenode-c.md)的[measure()](../../apis-default/arkts-apis/arkts-framenode-c.md#measure)方法测量子组件大小，参考DynamicLayout组
> 件
> [示例1（自定义布局算法实现瀑布流布局）](../../../reference/apis-arkui/arkui-ts/ts-container-dynamiclayout.md#示例1自定义布局算法实现瀑布流布局)。
