...
**继承/实现关系：** ArcListAttribute extends CommonMethod
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| size | ChildrenMainSize \| undefined | 是 |  |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| sensitivity | CrownSensitivity \| undefined | 是 |  |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| handler | OnScrollCallback \| undefined | 是 |  |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| handler | VoidCallback \| undefined | 是 |  |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| handler | [ArcScrollIndexHandler](arkts-arkui-arcscrollindexhandler-t.md) \| undefined | 是 |  |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| handler | OnWillScrollCallback \| undefined | 是 |  |
