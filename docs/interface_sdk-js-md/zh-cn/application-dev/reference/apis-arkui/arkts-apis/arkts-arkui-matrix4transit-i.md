...
| 类型 | 说明 |
| --- | --- |
| [Matrix4Transit](arkts-arkui-matrix4transit-i.md) | 矩阵叠加后的对象。 |
...
| 类型 | 说明 |
| --- | --- |
| [Matrix4Transit](arkts-arkui-matrix4transit-i.md) | 当前矩阵的拷贝对象。 |
...
| 类型 | 说明 |
| --- | --- |
| [Matrix4Transit](arkts-arkui-matrix4transit-i.md) | 当前矩阵的逆矩阵对象。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| options | [RotateOption](arkts-arkui-rotateoption-i.md) | 是 | 设置旋转参数。 |

**返回值：**

| 类型 | 说明 |
| --- | --- |
| [Matrix4Transit](arkts-arkui-matrix4transit-i.md) | 旋转效果后的矩阵对象。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| options | [ScaleOption](arkts-arkui-scaleoption-i.md) | 是 | 设置缩放参数。 |

**返回值：**

| 类型 | 说明 |
| --- | --- |
| [Matrix4Transit](arkts-arkui-matrix4transit-i.md) | 缩放效果后的矩阵对象。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| options | [PolyToPolyOptions](arkts-arkui-polytopolyoptions-i.md) | 是 | 映射相关的参数。 |

**返回值：**

| 类型 | 说明 |
| --- | --- |
| [Matrix4Transit](arkts-arkui-matrix4transit-i.md) | 当前矩阵变换后的对象。 |
...
| 类型 | 说明 |
| --- | --- |
| [Matrix4Transit](arkts-arkui-matrix4transit-i.md) | 倾斜效果后的矩阵对象。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| options | [TranslateOption](arkts-arkui-translateoption-i.md) | 是 | 设置平移参数。 |

**返回值：**

| 类型 | 说明 |
| --- | --- |
| [Matrix4Transit](arkts-arkui-matrix4transit-i.md) | 平移效果后的矩阵对象。 |
