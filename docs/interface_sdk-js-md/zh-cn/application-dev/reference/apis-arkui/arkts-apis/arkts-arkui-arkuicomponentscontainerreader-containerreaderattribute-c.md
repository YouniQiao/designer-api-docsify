...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | [BreakpointOptions](../../apis-default/arkts-apis/arkts-arkuicomponentscontainerreader-breakpointoptions-i.md) | 否 | 断点配置选项，包含宽度和高度的断点阈值数组。 |

**返回值：**

| 类型 | 说明 |
| --- | --- |
| [ContainerReaderAttribute](../../apis-default/arkts-apis/arkts-arkuicomponentscontainerreader-containerreaderattribute-i.md) |  |
