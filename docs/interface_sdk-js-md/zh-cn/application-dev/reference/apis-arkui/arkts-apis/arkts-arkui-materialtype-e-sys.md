...
边框颜色[borderColor](../arkts-components/arkts-arkui-commonmethod-c.md#bordercolor-1)为混合10%的透明度的theme.colors.compForegroundPrimary的[token](../../../../ui/theme_skinning.md#系统缺省token色值)值。
