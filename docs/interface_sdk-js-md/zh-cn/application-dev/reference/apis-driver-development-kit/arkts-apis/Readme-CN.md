...
- [@ohos.app.ability.DriverExtensionAbility](arkts-app-ability-driverextensionability.md)
  - [DriverExtensionAbility](arkts-driverdevelopment-appabilitydriverextensionability-driverextensionability-c.md)
...
- [@ohos.driver.deviceManager](arkts-driver-devicemanager.md)
  ...
  <!--Del-->
  - [DeviceInfo(系统接口)](arkts-driverdevelopment-devicemanager-deviceinfo-i-sys.md)<!--DelEnd-->
  <!--Del-->
  ...
  <!--Del-->
  - [USBDeviceInfo(系统接口)](arkts-driverdevelopment-devicemanager-usbdeviceinfo-i-sys.md)<!--DelEnd-->
  <!--Del-->
  - [USBDriverInfo(系统接口)](arkts-driverdevelopment-devicemanager-usbdriverinfo-i-sys.md)<!--DelEnd-->
  <!--Del-->
