...
Extension生命周期回调，会在[onCreate](../../apis-ability-kit/arkts-apis/arkts-ability-abilitystage-c.md#oncreate-1)之后回调。返回一个[RemoteObject](@ohos.rpc:rpc.RemoteObject)对象，用于客户端和服务端进行通信。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| params | [Array](../../apis-arkts/arkts-apis/arkts-arkts-array-c.md)<string> | 是 | 表示命令形式的参数。 |

**返回值：**

| 类型 | 说明 |
| --- | --- |
| [Array](../../apis-arkts/arkts-apis/arkts-arkts-array-c.md)<string> | 一个string类型的数组，用于转存客户端信息。 |
