...
| [getStorageDataDir](arkts-corefile-environment-getstoragedatadir-f-sys.md#getstoragedatadir系统接口) | 异步方法获取内存存储根目录，使用callback异步回调。 |
| [getUserDataDir](arkts-corefile-environment-getuserdatadir-f-sys.md#getuserdatadir) | 异步方法获取公共文件根目录，使用promise异步回调。 |
| [getUserDataDir](arkts-corefile-environment-getuserdatadir-f-sys.md#getuserdatadir系统接口) | 异步方法获取公共文件根目录，使用callback异步回调。 |
