...
文件流，提供流式读写文件数据的能力，使用完毕后需调用close关闭。在调用Stream的方法前，需要先通过[fileIo.createStream]\_\_\_JSDOC\_LINK\_DESC\_USD\_0\_\_\_方法或者  
[fileIo.fdopenStream]\_\_\_JSDOC\_LINK\_DESC\_USD\_1\_\_\_（同步或异步）来构建一个Stream实例。
