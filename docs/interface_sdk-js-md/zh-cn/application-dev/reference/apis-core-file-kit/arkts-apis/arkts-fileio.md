...
| [access](arkts-corefile-fileio-access-f.md#access) | 检查当前进程是否可访问某文件，使用callback异步回调。 |
| [access](arkts-corefile-fileio-access-f.md#access) | 检查当前进程是否可访问某文件，使用callback异步回调。 |
...
| [chmod](arkts-corefile-fileio-chmod-f.md#chmod) | 改变文件权限，使用callback异步回调。 |
...
| [chown](arkts-corefile-fileio-chown-f.md#chown) | 基于文件路径改变文件所有者，使用callback异步回调。 |
...
| [close](arkts-corefile-fileio-close-f.md#close) | 关闭文件，使用callback异步回调。 |
...
| [copyFile](arkts-corefile-fileio-copyfile-f.md#copyfile) | copyFile. |
| [copyFile](arkts-corefile-fileio-copyfile-f.md#copyfile) | 复制文件，使用callback异步回调。 |
...
| [createStream](arkts-corefile-fileio-createstream-f.md#createstream) | 基于文件路径打开文件流，使用callback异步回调。 |
...
| [fchmod](arkts-corefile-fileio-fchmod-f.md#fchmod) | 基于文件描述符改变文件权限，使用callback异步回调。 |
...
| [fchown](arkts-corefile-fileio-fchown-f.md#fchown) | 基于文件描述符改变文件所有者，使用callback异步回调。 |
...
| [fdatasync](arkts-corefile-fileio-fdatasync-f.md#fdatasync) | 实现文件内容数据同步，使用callback异步回调。 |
...
| [fdopenStream](arkts-corefile-fileio-fdopenstream-f.md#fdopenstream) | 基于文件描述符打开文件流，使用callback异步回调。 |
...
| [fstat](arkts-corefile-fileio-fstat-f.md#fstat) | 基于文件描述符获取文件状态信息，使用callback异步回调。 |
...
| [fsync](arkts-corefile-fileio-fsync-f.md#fsync) | 同步文件数据，使用callback异步回调。 |
...
| [ftruncate](arkts-corefile-fileio-ftruncate-f.md#ftruncate) | 基于文件描述符截断文件，使用callback异步回调。 |
| [ftruncate](arkts-corefile-fileio-ftruncate-f.md#ftruncate) | 基于文件描述符截断文件，使用callback异步回调。 |
...
| [hash](arkts-corefile-fileio-hash-f.md#hash) | 计算文件的哈希值，使用callback异步回调。 |
| [lchown](arkts-corefile-fileio-lchown-f.md#lchown) | 基于文件路径改变文件所有者，更改符号链接本身的所有者，而不是符号链接所指向的实际文件，使用Promise异步回调。 |
| [lchown](arkts-corefile-fileio-lchown-f.md#lchown) | 基于文件路径改变文件所有者，更改符号链接本身的所有者，而不是更改符号链接所指向的实际文件，使用callback异步回调。 |
...
| [lstat](arkts-corefile-fileio-lstat-f.md#lstat) | 获取链接信息，使用callback异步回调。 |
...
| [mkdir](arkts-corefile-fileio-mkdir-f.md#mkdir) | 创建目录，使用callback异步回调。 |
| [mkdir](arkts-corefile-fileio-mkdir-f.md#mkdir) | 创建目录，使用callback异步回调。 |
...
| [mkdtemp](arkts-corefile-fileio-mkdtemp-f.md#mkdtemp) | 创建临时目录，使用callback异步回调。 |
...
| [open](arkts-corefile-fileio-open-f.md#open) | 打开文件，使用callback异步回调。 |
| [open](arkts-corefile-fileio-open-f.md#open) | 打开文件，使用callback异步回调。 |
| [open](arkts-corefile-fileio-open-f.md#open) | 打开文件，使用callback异步回调。 |
...
| [opendir](arkts-corefile-fileio-opendir-f.md#opendir) | 打开文件目录，使用callback异步回调。 |
...
| [read](arkts-corefile-fileio-read-f.md#read) | 从文件读取数据，使用callback异步回调。 |
| [read](arkts-corefile-fileio-read-f.md#read) | 从文件读取数据，使用callback异步回调。 |
...
| [readText](arkts-corefile-fileio-readtext-f.md#readtext) | 基于文本方式读取文件（即直接读取文件的文本内容），使用callback异步回调。 |
...
| [rename](arkts-corefile-fileio-rename-f.md#rename) | 重命名文件，使用callback异步回调。 |
...
| [rmdir](arkts-corefile-fileio-rmdir-f.md#rmdir) | 删除目录，使用callback异步回调。 |
...
| [stat](arkts-corefile-fileio-stat-f.md#stat) | 获取文件信息，使用callback异步回调。 |
...
| [symlink](arkts-corefile-fileio-symlink-f.md#symlink) | 基于文件路径创建符号链接，使用callback异步回调。 |
...
| [truncate](arkts-corefile-fileio-truncate-f.md#truncate) | 基于文件路径截断文件，使用callback异步回调。 |
| [truncate](arkts-corefile-fileio-truncate-f.md#truncate) | 基于文件路径截断文件，使用callback异步回调。 |
...
| [unlink](arkts-corefile-fileio-unlink-f.md#unlink) | 删除文件，使用callback异步回调。 |
...
| [write](arkts-corefile-fileio-write-f.md#write) | 将数据写入文件，使用callback异步回调。 |
| [write](arkts-corefile-fileio-write-f.md#write) | 将数据写入文件，使用callback异步回调。 |
