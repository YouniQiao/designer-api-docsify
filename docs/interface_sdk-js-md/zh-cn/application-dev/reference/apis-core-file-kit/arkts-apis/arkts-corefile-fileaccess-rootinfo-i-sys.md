...
以同步方法从某个目录，基于过滤器，获取下一级符合条件的文件(夹)信息的迭代器对象FileIterator，然后通过[next]\_\_\_JSDOC\_LINK\_DESC\_USD\_0\_\_\_方法返回  
[FileInfo]\_\_\_JSDOC\_LINK\_DESC\_USD\_1\_\_\_。目前仅支持内置存储设备过滤，外置存储设备不支持过滤。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| filter | \_\_\_MD\_LINK\_USD\_0\_\_\_ | 否 | Indicates the filter of file. |
...
以同步方法从某设备根节点开始，基于过滤器，递归获取符合条件的文件信息的迭代器对象FileIterator，然后通过[next]\_\_\_JSDOC\_LINK\_DESC\_USD\_0\_\_\_方法返回  
[FileInfo]\_\_\_JSDOC\_LINK\_DESC\_USD\_1\_\_\_。目前仅支持内置存储设备。
...
| 类型 | 说明 |
| --- | --- |
| \_\_\_MD\_LINK\_USD\_0\_\_\_ | Returns the RootIterator Object. |
