...
| [File](arkts-corefile-backup-file-i-sys.md) | 文件对象，包含文件元数据、文件数据和清单文件信息。用于客户端与备份服务进行IPC。 |
...
| [IncrementalBackupData](arkts-corefile-backup-incrementalbackupdata-i-sys.md) | 一次增量备份对象，包含最后一次增量备份时间和增量清单。 |
