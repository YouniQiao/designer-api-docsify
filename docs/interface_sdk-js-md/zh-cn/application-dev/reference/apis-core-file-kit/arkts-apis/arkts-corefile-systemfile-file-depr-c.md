...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| options | [FileAccessOption](arkts-corefile-systemfile-fileaccessoption-depr-i.md) | 是 | 接口选项。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| options | [FileCopyOption](arkts-corefile-systemfile-filecopyoption-depr-i.md) | 是 | 接口选项。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| options | [FileDeleteOption](arkts-corefile-systemfile-filedeleteoption-depr-i.md) | 是 | 接口选项。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| options | [FileGetOption](arkts-corefile-systemfile-filegetoption-depr-i.md) | 是 | 接口选项。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| options | [FileListOption](arkts-corefile-systemfile-filelistoption-depr-i.md) | 是 | 接口选项。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| options | [FileMkdirOption](arkts-corefile-systemfile-filemkdiroption-depr-i.md) | 是 | 接口选项。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| options | [FileMoveOption](arkts-corefile-systemfile-filemoveoption-depr-i.md) | 是 | 文件过滤选项。默认不进行过滤。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| options | [FileReadArrayBufferOption](arkts-corefile-systemfile-filereadarraybufferoption-depr-i.md) | 是 | 接口选项。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| options | [FileReadTextOption](arkts-corefile-systemfile-filereadtextoption-depr-i.md) | 是 | 接口选项。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| options | [FileRmdirOption](arkts-corefile-systemfile-filermdiroption-depr-i.md) | 是 | 接口选项。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| options | [FileWriteArrayBufferOption](arkts-corefile-systemfile-filewritearraybufferoption-depr-i.md) | 是 | 接口选项。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| options | [FileWriteTextOption](arkts-corefile-systemfile-filewritetextoption-depr-i.md) | 是 | 接口选项。 |
