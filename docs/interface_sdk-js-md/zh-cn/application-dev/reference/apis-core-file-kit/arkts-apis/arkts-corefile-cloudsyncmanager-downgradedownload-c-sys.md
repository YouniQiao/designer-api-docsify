...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | \_\_\_MD\_LINK\_USD\_0\_\_\_&lt;DownloadProgress&gt; | 是 | 回调函数。全量下载进度，参数为DownloadProgress，返回值为void。 |
...
| callback | \_\_\_MD\_LINK\_USD\_0\_\_\_&lt;TransferProgress&gt; | 是 | 回调函数，返回搬迁进度。 |
...
停止由[startDownload]\_\_\_JSDOC\_LINK\_DESC\_USD\_0\_\_\_触发的全量下载任务，使用Promise异步回调。
