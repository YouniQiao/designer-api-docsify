...
主题色参数, 默认为空，跟随FilePicker应用颜色。当themeColor设置为特定的主题色属性 （[fontEmphasize and compBackgroundEmphasize](../../apis-arkui/arkts-apis/arkts-arkui-arkuitheme-colors-i.md)）时， 被拉起的FilePicker应用将适配传入的主题色参数的效果。
