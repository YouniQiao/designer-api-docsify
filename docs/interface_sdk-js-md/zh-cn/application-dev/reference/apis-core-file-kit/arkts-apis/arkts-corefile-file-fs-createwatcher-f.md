...
| listener | [WatchEventListener](../../apis-default/arkts-apis/arkts-watcheventlistener-t.md) | 是 | 监听事件发生后的回调。监听事件每发生一次，回调一次。 |

**返回值：**

| 类型 | 说明 |
| --- | --- |
| [Watcher](../../apis-default/arkts-apis/arkts-watcher-t.md) | 返回Watcher对象。 |
