...
| accountId | string | 是 | 账号Id。 |
| bundleName | string | 是 | 应用包名。 |
| callback | [AsyncCallback](../../apis-basic-service-kit/arkts-apis/arkts-basicservices-asynccallback-i.md)<void> | 是 | 回调函数。异步通知端云服务应用的云数据变更之后的。 |
...
| extraData | [ExtraData](arkts-corefile-extradata-i-sys.md) | 是 | 云端数据变更信息。 |
...
| userId | number | 是 | 用户Id。 |
| extraData | [ExtraData](arkts-corefile-extradata-i-sys.md) | 是 | 云端数据变更信息。 |
| callback | [AsyncCallback](../../apis-basic-service-kit/arkts-apis/arkts-basicservices-asynccallback-i.md)<void> | 是 | 回调函数。异步通知端云服务应用的云数据变更之后。 |
