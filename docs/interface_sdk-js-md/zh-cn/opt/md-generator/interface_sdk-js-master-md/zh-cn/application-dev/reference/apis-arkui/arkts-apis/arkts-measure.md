...
The **measure** module provides APIs for measuring text metrics, such as text height and width.
 ...
 > specifically [Paragraph](../../apis-arkgraphics2d/arkts-apis/arkts-arkgraphics2d-text-paragraphstyle-i.md/arkts-arkgraphics2d-text-paragraphstyle-i.md).
 >
 > - Avoid using [ApplicationContext.setFontSizeScale](../../apis-ability-kit/arkts-apis/arkts-ability-applicationcontext-c.md/arkts-ability-applicationcontext-c.md#setfontsizescale)
