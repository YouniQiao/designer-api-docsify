...
| 名称 |
| --- |
| [getLocalUpdater](arkts-basicservices-update-getlocalupdater-f-sys.md#getlocalupdater系统接口) |
| [getOnlineUpdater](arkts-basicservices-update-getonlineupdater-f-sys.md#getonlineupdater系统接口) |
| [getRestorer](arkts-basicservices-update-getrestorer-f-sys.md#getrestorer系统接口) |
<!--DelEnd-->
