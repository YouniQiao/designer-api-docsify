...
> 
> 该特性依赖设备能力，且需要和对应组件的[enableAnalyzer](ImageAttribute#enableAnalyzer)接口（例如[Image组件](../../apis-image-kit/arkts-apis/arkts-multimedia-image.md/arkts-multimedia-image.md)）搭配使用。
