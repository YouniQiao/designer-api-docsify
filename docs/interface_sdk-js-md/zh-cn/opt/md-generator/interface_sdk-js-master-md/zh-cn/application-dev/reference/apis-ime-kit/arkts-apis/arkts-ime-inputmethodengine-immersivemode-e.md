...
| 名称 | 值 | 说明 |
| ------------ | -- | ------------------ |
| [NONE_IMMERSIVE](#none_immersive) | 0 | 不使用沉浸模式。 |
| [IMMERSIVE](#immersive) | 1 | 沉浸模式，由输入法应用确定沉浸模式类型。 |
| [LIGHT_IMMERSIVE](#light_immersive) | 2 | 浅色沉浸模式。 |
| [DARK_IMMERSIVE](#dark_immersive) | 3 |
