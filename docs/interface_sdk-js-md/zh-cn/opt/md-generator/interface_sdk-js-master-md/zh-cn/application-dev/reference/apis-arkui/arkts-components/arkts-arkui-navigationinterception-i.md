...
| 参数名 | 类型 | 必填 | 说明 |
| ------ | ------ | ---- | ---------------- |
| from | [NavDestinationContext](arkts-arkui-navdestinationcontext-i.md#NavDestinationContext) \| [NavBar](arkts-arkui-navbar-t.md#NavBar) | 是 | 页面跳转之前的栈顶页面信息。参数值为navBar，则表示跳转前的页面为Navigation首页。 |
| to | [NavDestinationContext](arkts-arkui-navdestinationcontext-i.md#NavDestinationContext) \| [NavBar](arkts-arkui-navbar-t.md#NavBar) | 是 | 页面跳转之后的栈顶页面信息。参数值为navBar，则表示跳转的目标页面为Navigation首页。 |
| operation | [NavigationOperation](arkts-arkui-navigationoperation-e.md#NavigationOperation) | 是 | 当前页面跳转类型。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| ------ | ------ | ---- | ---------------- |
| mode | [NavigationMode](arkts-arkui-navigationmode-e.md#NavigationMode) | 是 |
...
| 参数名 | 类型 | 必填 | 说明 |
| ------ | ------ | ---- | ---------------- |
| from | [NavPathInfo](arkts-arkui-navpathinfo-c.md#NavPathInfo) \|[NavBar](arkts-arkui-navbar-t.md#NavBar) | 是 | 退场页面信息。参数值为navBar，则表示跳转前的页面为Navigation首页。 |
| to | [NavPathInfo](arkts-arkui-navpathinfo-c.md#NavPathInfo) \|[NavBar](arkts-arkui-navbar-t.md#NavBar) | 是 | 进场页面信息。参数值为navBar，则表示跳转的目标页面为Navigation首页。 |
| pathStack | [NavPathStack](arkts-arkui-navpathstack-c.md#NavPathStack) | 是 | 页面栈。 |
| operation | [NavigationOperation](arkts-arkui-navigationoperation-e.md#NavigationOperation) | 是 | 当前页面跳转类型。 |
| isAnimated | boolean | 是 |
