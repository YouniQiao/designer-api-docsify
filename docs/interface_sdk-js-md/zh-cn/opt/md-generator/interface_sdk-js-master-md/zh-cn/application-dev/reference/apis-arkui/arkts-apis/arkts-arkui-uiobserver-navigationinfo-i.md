...
Navigation组件的uniqueId，可以通过[queryNavigationInfo](../arkts-components/arkts-arkui-basecustomcomponent-c.md/arkts-arkui-basecustomcomponent-c.md#querynavigationinfo)获取。
