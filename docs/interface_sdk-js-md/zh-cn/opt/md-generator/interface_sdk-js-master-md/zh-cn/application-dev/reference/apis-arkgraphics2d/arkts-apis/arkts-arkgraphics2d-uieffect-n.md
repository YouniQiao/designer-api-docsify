...
| 名称 |
| --- |
| [createBrightnessBlender](arkts-arkgraphics2d-uieffect-createbrightnessblender-f-sys.md#createBrightnessBlender（系统接口）) |
| [createHdrBrightnessBlender](arkts-arkgraphics2d-uieffect-createhdrbrightnessblender-f-sys.md#createHdrBrightnessBlender（系统接口）) |
| [createHdrDarkenBlender](arkts-arkgraphics2d-uieffect-createhdrdarkenblender-f-sys.md#createHdrDarkenBlender（系统接口）) |
<!--DelEnd-->
