...
**替代接口：** [contact.queryHolders](arkts-contacts-contact-queryholders-f.md#queryholders)(context:
...
| 参数名 | 类型 | 必填 |
| --- | --- | --- |
| callback | [AsyncCallback](../../apis-basic-service-kit/arkts-apis/arkts-basicservices-base-asynccallback-i.md)&lt;Array&lt;Holder&gt;&gt; | 是 |
