...
| 名称 |
| --- |
| [offColorChange](arkts-sensorservice-sensor-offcolorchange-f-sys.md#offColorChange（系统接口）) |
| [offSarChange](arkts-sensorservice-sensor-offsarchange-f-sys.md#offSarChange（系统接口）) |
...
| [off_SensorId.SAR](arkts-sensorservice-sensor-offsensoridsar-f-sys.md#off_SensorId.SAR) |
| [onColorChange](arkts-sensorservice-sensor-oncolorchange-f-sys.md#onColorChange（系统接口）) |
| [onSarChange](arkts-sensorservice-sensor-onsarchange-f-sys.md#onSarChange（系统接口）) |
