...
| 参数名 | 类型 | 必填 |
| --- | --- | --- |
| glyphRange | [Range](../../apis-basic-service-kit/arkts-apis/arkts-basicservices-scan-range-i.md) | 是 |
| encoding | drawing.TextEncoding | 是 |
...
| 参数名 | 类型 | 必填 |
| --- | --- | --- |
| characterRange | [Range](../../apis-basic-service-kit/arkts-apis/arkts-basicservices-scan-range-i.md) | 是 |
| encoding | drawing.TextEncoding | 是 |
...
| 多行中部省略（EllipsisMode.MULTILINE_MIDDLE） |
