# FontOptions(Custom Font Registration)

注册的自定义字体信息。 > **说明：** > > 直接使用font可能导致[UI上下文不明确](../../../ui/arkts-global-interface.md#ui上下文不明确)的问题，推荐通过使用 > [UIContext](arkts-arkui-arkui-uicontext-uicontext-c.md#uicontext)中的 > [getFont](../../../reference/apis-arkui/arkts-apis-uicontext-uicontext.md#getfont)方法获取当前UI上下文关联的 > [Font](arkts-arkui-arkui-uicontext-uicontext-c.md#uicontext)对象。
