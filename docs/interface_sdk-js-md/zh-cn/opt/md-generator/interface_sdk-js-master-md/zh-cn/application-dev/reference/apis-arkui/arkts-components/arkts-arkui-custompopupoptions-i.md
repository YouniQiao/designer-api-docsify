...
API version 11及以后，默认值：透明色[TRANSPARENT](../arkts-apis/arkts-arkui-color-e.md/arkts-arkui-color-e.md)加模糊背景填充效果[COMPONENT_ULTRA_THICK](arkts-arkui-blurstyle-e.md)
