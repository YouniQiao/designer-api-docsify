...
| 名称 |
| --- |
| [createCustomizedToneAttrs](arkts-audio-systemsoundmanager-createcustomizedtoneattrs-f-sys.md#createCustomizedToneAttrs（系统接口）) |
| [getSystemSoundManager](arkts-audio-systemsoundmanager-getsystemsoundmanager-f-sys.md#getSystemSoundManager（系统接口）) |
<!--DelEnd-->
