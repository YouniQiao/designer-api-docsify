...
当前支持的分布式业务类型有：[协同业务](arkts-mdm-applicationmanager-servicetype-e.md#ServiceType)。
...
| [serviceType](../../apis-distributed-service-kit/arkts-apis/arkts-distributedservice-distributeddevicemanager-serviceprofileinfo-i-sys.md) | [ServiceType](../../apis-calendar-kit/arkts-apis/arkts-calendar-calendarmanager-servicetype-e.md) | 是 |
| accountId | number | 是 |
...
| [9201043](../../../../../../../../gitee_tmp/docs/master/zh-cn/application-dev/reference/apis-mdm-kit/errorcode-enterpriseDeviceManager.md#9201043-api调用的前置条件未满足) |
