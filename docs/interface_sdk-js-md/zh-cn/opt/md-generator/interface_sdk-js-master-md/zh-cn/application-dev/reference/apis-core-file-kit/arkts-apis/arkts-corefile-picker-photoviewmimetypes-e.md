...
**替代接口：** [PhotoViewMIMETypes](@ohos.file.photoAccessHelper:photoAccessHelper.PhotoViewMIMETypes)
...
**替代接口：** [IMAGE_TYPE](@ohos.file.photoAccessHelper:photoAccessHelper.PhotoViewMIMETypes.IMAGE_TYPE)
...
**替代接口：** [VIDEO_TYPE](@ohos.file.photoAccessHelper:photoAccessHelper.PhotoViewMIMETypes.VIDEO_TYPE)
...
**替代接口：** [IMAGE_VIDEO_TYPE](@ohos.file.photoAccessHelper:photoAccessHelper.PhotoViewMIMETypes.IMAGE_VIDEO_TYPE)
