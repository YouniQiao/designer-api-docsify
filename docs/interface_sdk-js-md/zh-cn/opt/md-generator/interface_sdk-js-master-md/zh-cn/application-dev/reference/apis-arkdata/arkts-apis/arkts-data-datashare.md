...
| 名称 |
| --- |
| [createDataShareHelper](arkts-arkdata-datashare-createdatasharehelper-f-sys.md#createDataShareHelper（系统接口）) |
| [createDataShareHelper](arkts-arkdata-datashare-createdatasharehelper-f-sys.md#createDataShareHelper（系统接口）) |
| [createDataShareHelper](arkts-arkdata-datashare-createdatasharehelper-f-sys.md#createDataShareHelper（系统接口）) |
| [disableSilentProxy](arkts-arkdata-datashare-disablesilentproxy-f-sys.md#disableSilentProxy（系统接口）) |
| [enableSilentProxy](arkts-arkdata-datashare-enablesilentproxy-f-sys.md#enableSilentProxy（系统接口）) |
<!--DelEnd-->
...
| 名称 |
| --- |
| [ChangeType](arkts-arkdata-datashare-changetype-e-sys.md) |
