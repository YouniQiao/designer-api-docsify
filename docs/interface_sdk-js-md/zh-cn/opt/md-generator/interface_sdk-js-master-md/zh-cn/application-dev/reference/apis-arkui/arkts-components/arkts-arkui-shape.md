...
## 子组件 包含Rect、Path、Circle、[Ellipse](../arkts-apis/arkts-arkui-canvaspath-c.md#ellipse)、Polyline、 Polygon、Image、Text、Column、Row和Shape子组件。
...
| 参数名 | 类型 | 必填 |
| --- | --- | --- |
| value | [PixelMap](../../apis-na/arkts-apis/arkts-na-pixelmap-t.md) | 否 |
...
| 参数名 | 类型 | 必填 |
| --- | --- | --- |
| value | [PixelMap](../../apis-na/arkts-apis/arkts-na-pixelmap-t.md) | 是 |
