...
| 类型 |
| --- |
| [DrawingCanvas](../arkts-apis/arkts-arkui-drawingcanvas-t.md) |
...
| 参数名 | 类型 | 必填 |
| --- | --- | --- |
| [canvas](../arkts-apis/arkts-arkui-canvasrenderingcontext2d-c.md) | [DrawingCanvas](../arkts-apis/arkts-arkui-drawingcanvas-t.md) | 是 |
