...
> **说明：**
> 
> -measureText需要先通过[UIContext](@ohos.arkui.UIContext)中的
> [getMeasureUtils](../../../reference/apis-arkui/arkts-apis-uicontext-uicontext.md#getmeasureutils12)方法获取
> [MeasureUtils](@ohos.arkui.UIContext)对象，然后通过该对象进行调用。且直接使用measureText可能导致
...
> 联的[MeasureUtils](@ohos.arkui.UIContext)对象。
> 
...
**替代接口：** [measureText](ohos.arkui.UIContext.MeasureUtils#measureText)
...
> **说明：**
> 
> -measureTextSize需要先通过[UIContext](@ohos.arkui.UIContext)中的
> [getMeasureUtils](../../../reference/apis-arkui/arkts-apis-uicontext-uicontext.md#getmeasureutils12)方法获取
> [MeasureUtils](@ohos.arkui.UIContext)对象，然后通过该对象进行调用。且直接使用measureTextSize可能导致
> [UI上下文不明确](../../../ui/arkts-global-interface.md#ui上下文不明确)的问题。
> 
> - 从API version 12开始，可以通过使用[UIContext](@ohos.arkui.UIContext)中的
> [getMeasureUtils](../../../reference/apis-arkui/arkts-apis-uicontext-uicontext.md#getmeasureutils12)方法获取当前UI上下文关
...
**替代接口：** [measureTextSize](ohos.arkui.UIContext.MeasureUtils#measureTextSize)
