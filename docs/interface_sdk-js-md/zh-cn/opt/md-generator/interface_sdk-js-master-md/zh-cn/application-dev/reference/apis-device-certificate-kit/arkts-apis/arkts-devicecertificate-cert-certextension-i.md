...
| 参数名 | 类型 | 必填 |
| --- | --- | --- |
| valueType | [ExtensionEntryType](arkts-devicecertificate-cert-extensionentrytype-e.md) | 是 |
...
| 参数名 | 类型 | 必填 |
| --- | --- | --- |
| valueType | [ExtensionOidType](arkts-devicecertificate-cert-extensionoidtype-e.md) | 是 |
