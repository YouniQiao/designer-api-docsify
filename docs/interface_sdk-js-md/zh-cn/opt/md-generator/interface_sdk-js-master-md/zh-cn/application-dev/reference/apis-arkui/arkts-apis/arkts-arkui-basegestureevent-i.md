...
基础手势事件类型。继承自[BaseEvent](../arkts-components/arkts-arkui-baseevent-i.md#BaseEvent)。

**继承/实现关系：** BaseGestureEvent extends [BaseEvent](../arkts-components/arkts-arkui-baseevent-i.md#BaseEvent)
