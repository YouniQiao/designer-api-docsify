...
**替代接口：** [@ohos.enterprise.securityManager:securityManager.uninstallUserCertificate](arkts-mdm-securitymanager-uninstallusercertificate-f.md#uninstallusercertificate)
