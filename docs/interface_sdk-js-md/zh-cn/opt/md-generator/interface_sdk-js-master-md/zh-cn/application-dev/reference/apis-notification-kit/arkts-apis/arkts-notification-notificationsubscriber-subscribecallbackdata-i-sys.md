...
通知分类信息。 仅在[NotificationSubscribeInfo](arkts-notification-notificationsubscribeinfo-notificationsubscribeinfo-i-sys.md#NotificationSubscribeInfo（系统接口）)中的enableClassification为true时存在。
