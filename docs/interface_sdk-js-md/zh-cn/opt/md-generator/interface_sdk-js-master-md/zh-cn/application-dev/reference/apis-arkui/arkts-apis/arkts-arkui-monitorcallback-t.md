...
参数为[IMonitor](../arkts-components/arkts-arkui-imonitor-i.md/arkts-arkui-imonitor-i.md)类型的监听回调函数。
...
| 参数名 | 类型 | 必填 |
| --- | --- | --- |
| monitorValue | [IMonitor](../arkts-components/arkts-arkui-imonitor-i.md) | 是 |
