...
| 参数名 | 类型 | 必填 |
| --- | --- | --- |
| bundlesToBackup | Array&lt;IncrementalBackupData&gt; | 是 |
...
| 参数名 | 类型 | 必填 |
| --- | --- | --- |
| bundlesToAppend | Array&lt;IncrementalBackupData&gt; | 是 |
| infos | string[] | 是 |
...
| 参数名 | 类型 | 必填 |
| --- | --- | --- |
| callbacks | [GeneralCallbacks](arkts-corefile-backup-generalcallbacks-i-sys.md) | 是 |
