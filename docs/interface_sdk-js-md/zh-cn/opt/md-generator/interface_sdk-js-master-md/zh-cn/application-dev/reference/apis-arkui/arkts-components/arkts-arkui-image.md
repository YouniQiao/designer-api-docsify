...
Image新增[ImageAIOptions](../arkts-apis/arkts-arkui-imageaioptions-i.md#imageaioptions)参数，为组件设置AI分析选项。
...
获取图片，支持通过[ImageAIOptions](../arkts-apis/arkts-arkui-imageaioptions-i.md#imageaioptions)参数设置AI分析选项。当reloadKey的值发生变化时，将不使用缓存重新加载图片。
