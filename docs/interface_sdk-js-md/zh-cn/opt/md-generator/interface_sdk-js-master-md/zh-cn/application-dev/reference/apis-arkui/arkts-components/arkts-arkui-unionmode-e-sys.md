...
引力作用下的融合形变效果。 **说明：** 设置该类型时，需要结合 [useUnionEffect](arkts-arkui-commonmethod-c-sys.md#useunioneffect)并设置 [GravityCenterOptions](arkts-arkui-gravitycenteroptions-i-sys.md#gravitycenteroptions系统接口)的gravityCenter为true才能生效。
