...
[ContextMenuAnimationOptions](../arkts-components/arkts-arkui-contextmenuanimationoptions-i.md/arkts-arkui-contextmenuanimationoptions-i.md)的hoverScaleInterruption属性以支持该行为）。
