...
使用typeNode创建[Text](../@internal/component/ets/text)、[Image](../@internal/component/ets/image)、  
[Select](../@internal/component/ets/select)、[Toggle](../@internal/component/ets/toggle)节点时，当传入的  
[UIContext](@ohos.arkui.UIContext)对应的UI实例销毁后，调用该接口会返回一个无效的FrameNode节点，无法正常挂载和显示。
