...
使用typeNode创建[Text](../../apis-arkui/arkts-components/arkts-arkui-text-i)、[Image](../../apis-arkui/arkts-components/arkts-arkui-image-i)、  
[Select](../../apis-arkui/arkts-components/arkts-arkui-select-i)、[Toggle](../../apis-arkui/arkts-components/arkts-arkui-toggle-i)节点时，当传入的  
