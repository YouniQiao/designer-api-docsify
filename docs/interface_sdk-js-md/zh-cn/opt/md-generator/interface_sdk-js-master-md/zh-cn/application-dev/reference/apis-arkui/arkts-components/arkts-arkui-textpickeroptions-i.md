...
> 4. 单列数据选择器使用[ResourceStr](../arkts-apis/arkts-arkui-resourcestr-t.md#ResourceStr)类型。
> 5. 多列非联动数据选择器使用[ResourceStr](../arkts-apis/arkts-arkui-resourcestr-t.md#ResourceStr)[]类型，数组长度与列数一致。
> 6. 多列联动数据选择器使用[ResourceStr](../arkts-apis/arkts-arkui-resourcestr-t.md#ResourceStr)[]类型，数组长度与层级数一致。
