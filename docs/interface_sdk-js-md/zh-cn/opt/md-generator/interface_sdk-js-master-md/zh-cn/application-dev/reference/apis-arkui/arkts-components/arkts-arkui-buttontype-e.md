...
> 
> - 设置[颜色渐变](../../apis-ability-kit/arkts-apis/arkts-app-ability-common.md/arkts-app-ability-common.md)需先设置[backgroundColor](arkts-arkui-commonmethod-c.md#backgroundcolor)为透明色。
> 
